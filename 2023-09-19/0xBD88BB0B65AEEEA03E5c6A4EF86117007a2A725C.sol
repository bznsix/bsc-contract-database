...
contract SwapPeriphery{
    ...
    constructor() {
        //工厂1900亿
        token_balance=190000000000*(10**18);
        //开启调式模式
        ...
        Token=0xdd56867538f5241F8F5EA482EF76022Ef8ef5430;
        //代币兑换路径
        path0.push(USDT);
        path0.push(Token);
        path1.push(Token);
        ...
        //外池信息
        system_pancake.LP=0xa0c09390977036A9ed049456d9dCd6B4862be417;
        ...
        //内池信息
        system_swap.LP=0x8E940c6A9e7F5AE167808dCD29181DE2A9cf4BdC;
        system_swap.V2Router=0xE24abfd25f96B21D0E7eCBC9a21dCd485aC4D642;
        //算力初始化
