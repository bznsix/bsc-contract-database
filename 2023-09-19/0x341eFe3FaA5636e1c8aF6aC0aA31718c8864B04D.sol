 ...
 * 
  ...
  *——————————————————
  *
  * Description: Our Mission: YOU BUY, WE BURN, YOU EARN
  * Website: https://8bit.ju.mp/
  * Twitter: https://twitter.com/8BIT_BSC
  * Telegram: https://t.me/eightbitbsc
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="8BIT";
    string private _symbol="8BIT";
    uint8  private _decimals=9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 888888888000000000;
    uint256 private _tTotalSupply = 888888888000000000;
    ...
    uint public marketingFeeonBuy=40;
    uint public marketingFeeonSell=40;

    uint public burnFeeOnBuy=20;
    uint public burnFeeOnSell=20;
    ...
    address public marketingWallet=0x95f4aEA066AA45A5eFCb9DAE921b97201cbBd26C;
    
    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=4444444440000000;
    uint256 public maxTransactionAmountSell=4444444440000000;

    
    uint256 public maxWalletAmount=44444444400000006;
    ...
    uint256 public swapTokensAtAmount=8888888880000;
    ...
    require(msg.value >= 0.3 ether, "Insufficient value for fee receiver");
        ...
        referralCommission = 0.14999999999999999 ether;
        referralWallet = 0xB02aa93dc6e62340074FEf77d5113769C5d577fb;
        payable(referralWallet).transfer(referralCommission);
      
    
    serviceFee = 0.14999999999999999 ether;
