...
import "./zil/LpDividendUSDT.sol";

contract FTBToken is LpDividendUSDT {
    uint256 total_supply = 1.4 ether * 10000_0000;
    uint256 constant lpFee = 3;
    uint256 constant burnFee = 2;

    uint256 public numTokensSellToAddToLiquidity = 100 ether;
    ...
    function swapTokensForUSDT(uint256 tokenAmount) internal lockTheSwap {
        ...
        IERC20(USDT).transferFrom(address(distributor), address(this), amount);
    }
...
import "../Uniswap/DexBaseUSDT23.sol";

abstract contract LpDividendUSDT is Owned, DexBaseUSDT23, ERC20 {
...
abstract contract DexBaseUSDT23 {
