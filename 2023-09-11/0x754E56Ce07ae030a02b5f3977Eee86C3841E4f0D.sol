...
contract MangaAI is ERC20, Ownable {
    ...
    uint256 private _startSupply = 100_000_000 * (10**18);
    uint256 private swapTokensAtAmount = 2400000000 * (10**18);
    ...
    function collectFees(
        ...
        }else if(!isSwappingFees && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
              uint256 fees;
