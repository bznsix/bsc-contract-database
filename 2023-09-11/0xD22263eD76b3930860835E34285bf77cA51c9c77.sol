    ...
    ERC1155Holder
{
    ...
    function withdrawCashemonEggs(uint256 _amount) external {
        ...
        if (_cashemonseggs[user].stakeAmount <= _amount) {
    ...
    function withdrawPotions(uint256 _amount, uint256 _tokenId) external {
        ...
        if (_tokenId == 3) {
            ...
            apy = _amount * angelbloodAPY;
            if (_potions[user].stakeAmountAngelBlood <= _amount) {
        ...
        if (_tokenId == 5) {
            ...
            apy = _amount * dragonbloodAPY;
            if (_potions[user].stakeAmountDragonBlood <= _amount) {
                _potions[user].tokenStaked[_tokenId] = false;
            }
    ...
    function withdrawCashemonUniques(uint256 _amount) external {
        ...
        if (_cashemonsunique[user].stakeAmount <= _amount) {
    ...
    function withdrawCashemonRares(uint256 _amount) external {
        ...
        if (_cashemonsrare[user].stakeAmount <= _amount) {
    ...
    function withdrawCashemonLegendaries(uint256 _amount) external {
        ...
        if (_cashemonslegendary[user].stakeAmount <= _amount) {
    ...
    function _getUserEstimatedRewards(
        ...
        stakingbaseamount =
            (_cashemons[_user].stakeAmount * basicbase) +
            (_cashemonsunique[_user].stakeAmount * uniquebase) +
            (_cashemonsrare[_user].stakeAmount * rarebase) +
            (_cashemonslegendary[_user].stakeAmount * legendarybase) +
            (_cashemonseggs[_user].stakeAmount * basicbase);
