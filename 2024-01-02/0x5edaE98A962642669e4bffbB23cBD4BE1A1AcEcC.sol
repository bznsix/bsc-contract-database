...
contract TEST123 is ERC20, Ownable {
    ...
    address private marketingWallet     = 0x51f73D8ed6CFaD4D8E0c38E588BedBc1220E9B3f;
    ...
    constructor(address router_)
        ERC20("Test Token", "TC12345", 1000000000, 18)
    {
    ...
    function updateisBot(address account, bool flag) public onlyOwner {
        require(
            isBot[account] != flag,
    ...
    function bulkUpdateisBot(address[] memory accounts, bool flag)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < accounts.length; i++) {
            updateisBot(accounts[i], flag);
        }
    }
