/**
https://t.me/DracarysBsc
https://twitter.com/Dracarysbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x722A908f24E93f0F4E4F50CF0bB643ed5Cd27030; // owner address
...
contract DRACARYSFABLEOFTHEDRAGON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dracarys Fable Of the Dragon";
    string private _symbol = "$TYRANT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x722A908f24E93f0F4E4F50CF0bB643ed5Cd27030); // Marketing Address
    address payable private teamWalletAddress = payable(0x722A908f24E93f0F4E4F50CF0bB643ed5Cd27030); // Team Address
