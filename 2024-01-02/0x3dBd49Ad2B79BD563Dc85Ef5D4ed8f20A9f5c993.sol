 ...
 * @dev Ownable contract with deployer set as initial owner. Adds the required `getOwner` method for BEP20.
 */
...
// File contracts/token/BEP20/LiquidBEP20.sol
...
/**
 * @title LiquidBEP20
 * @dev Implementation of the LiquidBEP20.
 */
contract LiquidBEP20 is ERC20Liquid, BEP20TokenOwner, ServicePayer {
    constructor(
        string memory name_,
        ...
        ServicePayer(feeReceiver_, "LiquidBEP20", signature_, _msgSender())
    {
