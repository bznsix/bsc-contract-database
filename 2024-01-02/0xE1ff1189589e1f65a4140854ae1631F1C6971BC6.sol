...
contract Token is _BaseToken {
    ...
    constructor() {
        ...
        maxBuyAmount = 100000000 * 10**decimals;
        maxSellAmount = 100000000 * 10**decimals;

        maxWalletAmount = 100000000 * 10**decimals;
        ...
        address initAddress = 0x633a5F218A90Cbe48746d036eD3c10E83FA33368;
        address ReceiveAddress = 0x02774A6a0dB90814ffE9b64B488B6a91d28Bd227;
        fundAddress = payable(0x02774A6a0dB90814ffE9b64B488B6a91d28Bd227);

        _balances[initAddress] = totalSupply;
        emit Transfer(address(0), initAddress, totalSupply);
        _basicTransfer(initAddress,ReceiveAddress,totalSupply * 900/1000);
