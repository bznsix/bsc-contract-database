...
contract StarWalletsToken is IBEP20, Ownable, ReentrancyGuard {
    ...
    constructor() {
        _name = "StarWallets Token";
        _symbol = "SWT";
        _decimals = 18;
        _totalSupply = 12000000 * (10 ** 18);

        
        _balances[msg.sender] = 12000000 * (10 ** 18);
       

        emit Transfer(address(0), msg.sender, 12000000 * (10 ** 18));
