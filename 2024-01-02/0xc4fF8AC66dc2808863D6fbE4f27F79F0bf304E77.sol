...
contract GROKDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "GROKDOGE";
    string private _symbol = "GROKDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x56827E8603E6aa7360020854A5eDE2A43EeFFd8d); // Marketing Address
    address payable public teamWalletAddress = payable(0x56827E8603E6aa7360020854A5eDE2A43EeFFd8d); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x56827E8603E6aa7360020854A5eDE2A43EeFFd8d),
            block.timestamp
        );
    }
