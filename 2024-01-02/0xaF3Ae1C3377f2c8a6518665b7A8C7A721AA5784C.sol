...
contract $DESMO is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x2aED2Da0E71F558DbC06ABbb1627B0472E671575);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0x589cBF4Df7E732F4fE2F835ce27a73Cc1BF36672;
    ...
    string private _name = "Desmo";
    string private _symbol = "$DESMO";
