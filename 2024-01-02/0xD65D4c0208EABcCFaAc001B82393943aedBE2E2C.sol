...
contract AlphaCeoToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlphaCeo";
    string private _symbol = "AlphaCeo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78988466E1eF3C9f6154913416eC7b0D205413e8); // Marketing Address
    address payable public teamWalletAddress = payable(0x78988466E1eF3C9f6154913416eC7b0D205413e8); // Team Address
