...
/**
    $FACE | NEW YEAR | MOONSHOT 
 * 📢 Telegram: https://t.me/FacePortal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x599d63AB39ff4029d3E1375F7a59383978BBbbf0; // owner address
...
contract $FACE is Context, IERC20, Ownable {
    ...
    string private _name = "FACE";
    string private _symbol = "$FACE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x22ec3b82c2Fe306806E4564fbfc11767F1071A97); // Marketing Address
    address payable private teamWalletAddress = payable(0x22ec3b82c2Fe306806E4564fbfc11767F1071A97); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 50000000 * 10**3; 
