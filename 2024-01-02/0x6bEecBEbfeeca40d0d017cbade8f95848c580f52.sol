...
TELEGRAM: https://t.me/baotokenbsc2024
...
contract BAO is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 2024 *10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1000000;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x57849F759C96C6c66113C726574Fa8F35dF51011;

    string private constant _name = "BAO TOKEN";
    string private constant _symbol = "BAO";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 4% - 1% reflection, 3% mkt
