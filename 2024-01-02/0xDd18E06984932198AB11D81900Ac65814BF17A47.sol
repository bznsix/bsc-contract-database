...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5FdFF81d81ac3fe049D6202de7375702afa8e07; // owner address
...
contract BnbTigerMoonInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bnb Tiger Moon Inu";
    string private _symbol = "Bnb Tiger Moon Inu";
    uint8 private _decimals = 9;

    address payable private marketWalletAddress = payable(0xC5FdFF81d81ac3fe049D6202de7375702afa8e07); // Marketing Address
    address payable private buybackWalletAddress = payable(0xC5FdFF81d81ac3fe049D6202de7375702afa8e07); // Team Address
    ...
    uint256 public _walletMax = 1500000 * 10**_decimals;
    ...
    constructor () {
        ...
        isExcludedFromFee[marketWalletAddress] = true;
        ...
        isWalletLimitExempt[marketWalletAddress] = true;
        isWalletLimitExempt[buybackWalletAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[marketWalletAddress] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(buybackWalletAddress, amountBNBTeam);
