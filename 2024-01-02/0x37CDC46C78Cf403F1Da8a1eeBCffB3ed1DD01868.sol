...
contract Token is Ownable, ERC20{
    TokenVesting public developmentLockToken;
    ...
    constructor(string memory name_, string memory symbol_) Ownable() ERC20(name_,symbol_){  
        ...
        developmentLockToken = new TokenVesting(msg.sender, block.timestamp + 90 days, 0 days, 300 days);
        communityLockToken = new TokenVesting(msg.sender, block.timestamp + 180 days, 0 days, 300 days);
        adLockToken = new TokenVesting(msg.sender, block.timestamp + 180 days, 0 days, 150 days);
        teamLockToken = new TokenVesting(msg.sender, 1668960000, 0 days, 0 days);
        __mint(msg.sender, 20 * 1e6 * 1e18);
        __mint(address(developmentLockToken), 10 * 1e6 * 1e18);
        __mint(address(communityLockToken), 10 * 1e6 * 1e18);
        __mint(address(adLockToken), 5* 1e6 * 1e18);
        __mint(address(teamLockToken), 5 * 1e6 * 1e18);
