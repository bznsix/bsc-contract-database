...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x94f7b440349f7a54E4aFc1f0cc0007d19214e394; // owner address
...
contract TalesOfBsc2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TALES OF BSC 2023";
    string private _symbol = "BYE23";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x94f7b440349f7a54E4aFc1f0cc0007d19214e394); // Marketing Address
    address payable private teamWalletAddress = payable(0x94f7b440349f7a54E4aFc1f0cc0007d19214e394); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 35;  // original 12
    uint256 public _totalTaxIfSelling = 40;  // original 12
    uint256 public _totalDistributionShares = 100;  // original 12

    uint256 private _totalSupply = 1000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 80000000 * 10**_decimals; 
    uint256 public _walletMax = 80000000 * 10**_decimals;
