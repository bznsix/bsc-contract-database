...
contract HoneyVault is Ownable, ReentrancyGuard {
    ...
    IRewardVault public AUTO_REWARD;
    ...
    // Settings
    IPancakeRouter01 public routerOutput;
    IPancakeRouter01 public routerReward;
    ...
    function earn() public {
        ...
        if (platformFee > 0) {
            uint256 fee = rewardTokenBalance.mul(platformFee).div(10000);
            FARM_REWARD_TOKEN.transfer(platform, fee);
        }
