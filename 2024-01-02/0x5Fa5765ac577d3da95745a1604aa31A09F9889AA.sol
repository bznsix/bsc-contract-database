...
// File @openzeppelin/contracts/token/ERC721/extensions/IERC721Metadata.sol@v4.9.5
...
// File @openzeppelin/contracts/token/ERC721/ERC721.sol@v4.9.5
...
contract NFT2024BOX is ERC721, Ownable {
    using Strings for uint256;

    uint256 private _nextTokenId;
    uint256 public constant _mintPrice = 50000000000000000; // 0.05 BNB
    uint256 public constant _burnPrice = 50000000000000000; // 0.05 BNB
    uint256 public constant _burnReward = 10000 * (10 ** 18);
    ...
    constructor()
    ERC721("2024BOX", "2024BOX")
    {
        _base = "https://2024box.com/api/token";
    }
    ...
    function burn(uint256 tokenId) external payable {
        ...
        require(msg.value >= _burnPrice, "Insufficient BNB");
        _burn(tokenId);
        payable(owner()).transfer(msg.value);
        IERC20 token = IERC20(_tokenAddress);
        token.transfer(owner(), _burnReward);
    }
}