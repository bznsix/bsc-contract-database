...
//--- Contract v3 ---//
contract CryptoFinance is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xdbc75C02d94b00E5De4223dE12e452AC88321455); // build: 0x58d73e0A09594b32BCc851c722c97D9fdEF652Ea
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Crypto Finance";
    string constant private _symbol = "CF";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0xd6E7747e673b9004c08f30dc0ce189c59712e112;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 75) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 75) / 100);
        balance[0x0f971941222BA4f236cb3781737d86D3e19967C0] = (_totalSupply * 25) / 100;
        emit Transfer(address(0), 0x0f971941222BA4f236cb3781737d86D3e19967C0, (_totalSupply * 25) / 100);
