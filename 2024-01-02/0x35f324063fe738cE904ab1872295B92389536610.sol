...
contract Token is BaseToken {
    ...
    address public buyBackToken = 0x9b9Ea2161b480CF85dFB84137eA9882127cB5772;
    ...
    constructor(
        ...
        buyBackPath = [currency,buyBackToken];
    ...
    uint256 public fundPercentage = 55;
    function setFundPercentage(
        uint256 newValue
    ) public onlyOwner{
        require(newValue <= 100,"toohigh");
        fundPercentage = newValue;
    }

    address public buyBackReceiver = address(0xdead);
    function setBuyBackReceiver(
        address newAddr
    ) public onlyOwner{
        buyBackReceiver = newAddr;
    }
    ...
    function swapTokenForFund(
        ...
        uint256 toFundAmt = (currencyBal - lpCurrency) * fundPercentage / 100;
        uint256 toBuyBack = currencyBal - lpCurrency - toFundAmt;
