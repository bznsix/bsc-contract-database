...
contract TOP_G is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, ERC20Permit, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"TOP G", unicode"TATE") 
        ERC20Permit(unicode"TOP G")
    {
        address supplyRecipient = 0x33c4d94b6e16E466A6F641512D0cdBD9b1427ccA;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x366417f54c99E549Cf0A433C516e235eD1266e88);
        marketingFeesSetup(50, 50, 0);

        developmentAddressSetup(0xfba7DF363C883e191e1402350d1e498D20892D20);
        developmentFeesSetup(50, 44, 0);

        liquidityFeesSetup(30, 30, 0);

        _deployDividendTracker(604800, 1000000 * (10 ** decimals()) / 10);

        gasForProcessingSetup(300000);
        rewardsFeesSetup(10, 10, 0);
        ...
        _transferOwnership(0x33c4d94b6e16E466A6F641512D0cdBD9b1427ccA);
    }
    ...
    */
    ...
    function getAllPending() public view returns (uint256) {
        return 0 + _marketingPending + _developmentPending + _liquidityPending + _rewardsPending;
    }
    ...
    function _transfer(
        ...
        if (!_swapping && !AMMPairs[from] && from != address(routerV2) && canSwap) {
            ...
            if (false || _marketingPending > 0 || _developmentPending > 0) {
                uint256 token2Swap = 0 + _marketingPending + _developmentPending;
                bool success = false;
