...
contract GigaBooze is Ownable, Pausable {
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    string public name = "GigaBooze";

    string public symbol = "GBNS";
    ...
    constructor() Ownable(msg.sender) Pausable(true) {
        ...
        emit ExcludedFromFeesUpdated(msg.sender, true);
        _walletState[taxRecipient] = walletState({
            isBlacklisted: false,
            isMarketPair: false,
            isExcludedFromFees: true
        });
    ...
    function setLimits(uint256 _maxBuyWad, uint256 _maxSellWad, uint256 _maxWalletWad) public onlyOwner {
        require(_maxBuyWad >= 10_000, "buy is too low");
        require(_maxSellWad >= 10_000, "sell is too low");
        require(_maxWalletWad >= 30_000, "wallet is too low");
