...
contract MiningContract is Ownable,Role {
    ...
    function getLandSlotInfo(uint256 tokenid) public view returns (uint256[] memory,uint256[] memory,bool[] memory) {
    ...
    function mineOnLand(uint256 tokenid,uint256 landid,uint256 slot) public returns (bool) {
        ...
        unixLandStamp[landid][slot] = block.timestamp + keekeeTick[level];
