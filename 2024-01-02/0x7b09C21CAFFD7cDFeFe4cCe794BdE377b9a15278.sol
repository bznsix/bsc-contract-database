...
abstract contract AbsToken is IERC20, Ownable {
    ...
    event InscriptionResponse(address indexed sender, string message);
    ...
    uint256 public _airdropBNBAmountEachTime = 10 ether / 1000;
    uint256 public _airdropTokenEachTime = 1000;
    ...
    receive() external payable {
        ...
        //发送铭文字符串
        emit InscriptionResponse(account, 'data:,{"p":"brc-20","op":"mint","tick":"tvzs","amt":"1000"}');
    }
}

contract PVZ is AbsToken {
    ...
    //SwapRouter
        ...
        21000000,
    //Receive，接收
        address(0x30D8E37f9323E2503c7D06887aDD026426047570),
    //Market，营销
        address(0x30D8E37f9323E2503c7D06887aDD026426047570)
    ) {
