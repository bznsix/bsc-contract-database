//Are you looking for the next big investment opportunity? Look no further! Grok Dollar is here to revolutionize the BSC Smartchain space. With its unique features like low tax and autoburn mechanism, this coin promises to offer immense potential for investors.

//Telegram:https://t.me/GrokDollarToken
//website:https://www.grokdollar.tech/
//Twitter:https://twitter.com/GrokDollarChat
...
contract GrokDollar is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd0b15A628e67547d000Ba4e58312f5B155b0C988); 
    address payable public Wallet_Dev = payable(0xd0b15A628e67547d000Ba4e58312f5B155b0C988);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "Grok Dollar"; 
    string private constant _symbol = unicode"Grok Dollar"; 
    ...
    constructor () {
        _owner =0xd0b15A628e67547d000Ba4e58312f5B155b0C988;
