...
contract $1LONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "$1LONG";
    string private _symbol = "$1LONG";
    ...
    address payable public marketingWalletAddress = payable(0x97a2abeE49cd2f4871D4fbCeaeCB3a19DaB7bFeb); 
    address payable public teamWalletAddr = payable(0x97a2abeE49cd2f4871D4fbCeaeCB3a19DaB7bFeb); 
