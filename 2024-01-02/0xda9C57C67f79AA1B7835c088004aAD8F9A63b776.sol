...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x5A7C3299A0CA91D83da16ED29D69672903278d7b; // owner address
...
contract PipiTheCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PipiTheCat";
    string private _symbol = "$PIPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A7C3299A0CA91D83da16ED29D69672903278d7b);
    address payable public teamWalletAddress = payable(0x5A7C3299A0CA91D83da16ED29D69672903278d7b); 
