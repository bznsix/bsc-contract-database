    ...
    TokenMigrateERC20
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("TokenERC20M");
    ...
    function initialize(
        ...
        string memory _name = TokenERC20M(__originalContract).name();
        string memory _symbol = TokenERC20M(__originalContract).symbol();
        ...
        primarySaleRecipient = TokenERC20M(__originalContract).primarySaleRecipient();
        (platformFeeRecipient, platformFeeBps) = TokenERC20M(__originalContract).getPlatformFeeInfo();
    ...
    function collectPrice(MintRequest calldata _req) internal {
        ...
        CurrencyTransferLib.transferCurrency(_req.currency, msg.sender, saleRecipient, _req.price - platformFees);
    }
