...
contract PPH is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "PPH";
        _decimals = 18;
        _owner = 0xD3c078a46F0CFb85C113C2FF010C07d0580309d2;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 5000 * 10**_decimals;
        marketingWalletAddress = payable(0x539FA436f6808fAb9C9fa2594Ab8AEA51bb84be9);
        teamWalletAddress = payable(0xC75ec5bCB40D12e6051Ed84dCE70d80B7255CF93);
