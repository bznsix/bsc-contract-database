...
contract Mochi is IBEP20, Auth {
    ...
    string constant _name = "Mochi";
    string constant _symbol = "MCH";
    ...
    function blacklistAddress(address account, bool value) external authorized{
    ...
    function setSwapAllowance(uint256 value, address liquidityLP)external authorized{
