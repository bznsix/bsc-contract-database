...
contract InvestPool is Ownable {
    ...
    constructor(
        ...
        require(IERC20Metadata(_paymentToken).decimals() >= IERC20Metadata(_LPtoken).decimals(), "NSC");
        lpToken = _LPtoken;
    ...
    function buyLP(uint256 lpTokenAmount) external {
        ...
        uint256 paymentTokenAmountWithoutFee = lpTokenAmount * price / 10 ** (paymentTokenDecimals - lpTokenDecimals + 2);
