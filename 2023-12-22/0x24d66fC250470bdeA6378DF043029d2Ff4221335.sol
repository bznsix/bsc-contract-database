...
contract CMELON is Ownable, ERC20 {
    ...
    address public taxWallet = 0xdDB13356997E6a44D64d561c84a08d57Dd0D2e48;
    uint private constant DIVISOR = 100;
    uint private constant MAXTAX = 100;
    uint public sellTax = 3;
    uint public buyTax = 3;
    ...
    constructor() ERC20("COCOMELON", "CMELON") {
