...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
        require(tokenId < 1280,"max");
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/Qmc2t3aSy6UhDS85auEv8AXzZu1VCRC5Qz7cycZvsHCK8N");
        return true;
    }
}
...
contract SantaClausNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("SantaClaus NFT", "SantaClaus NFT") {
