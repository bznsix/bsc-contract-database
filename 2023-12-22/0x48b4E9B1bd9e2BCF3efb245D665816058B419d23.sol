...
//--- Contract v3 ---//
contract bbabytest is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x1727D9045a1786f5Ea0521BaFa9cEA72486924cb); // build: 0x1727D9045a1786f5Ea0521BaFa9cEA72486924cb
    address payable private devWallet = payable(0x4222BC56373b359CcfD326C0ed03cDF11F4d9270); // build: 0x4222BC56373b359CcfD326C0ed03cDF11F4d9270
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "bbabytest";
    string constant private _symbol = "BbT";
