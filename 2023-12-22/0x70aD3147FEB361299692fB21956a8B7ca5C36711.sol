...
contract FFFtoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 330000e18;
    ...
    uint public  subAddressAmount = 3600*12 ; //减少时间 3600 *12
    address public subAddressAddress = address(0x3487634fCf78D0469368C3ed30c7d5A54c75a8A3);
    //通缩时间
    uint public _minUpdateBal = 10*1e14;
    uint public _minAllBal = 30000e18;
...
// address(0x7B852B29D6bA397B7d67D5BC7d5D09A2B84Db1C0), // USDT
// _holder  0x3487634fCf78D0469368C3ed30c7d5A54c75a8A3
    constructor (
        address _holder
          )  {
