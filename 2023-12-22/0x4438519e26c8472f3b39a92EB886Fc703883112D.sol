/**
Telegram: https://t.me/Cronixchain
...
contract CRONIXCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CRONIX CHAIN";
    string private _symbol = "CRON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x86eb0D1a15671808e6d0eDC1C3321A638d9eDB99); // Marketing Address
    address payable public teamWalletAddress = payable(0x01ae7eba2a0C2E32C2d8e62Bc30f21e32DB34cF9); // Team Address
