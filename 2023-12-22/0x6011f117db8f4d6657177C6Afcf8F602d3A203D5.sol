...
When AI becomes a Dev. Chat GPT is the co dev. 
                                                              
TG Community - https://t.me/portal_ai_inu
...
contract aiinu is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public numTokensToSwap = 1000000000 * 10**18;
    ...
    address payable private _marketingAddress = payable(0xd842ADd27329b44d12dd36abA5cD5218948041E8);
    address payable private _teamAddress = payable(0xd842ADd27329b44d12dd36abA5cD5218948041E8);
    address payable private _ecosystemAddress = payable(0xd842ADd27329b44d12dd36abA5cD5218948041E8);
