...
contract GroksToken is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable private marketingaddress = payable(0x74D389878454668a82023310Bc56702c391E8f28);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 100000 * 10**9;
    ...
    constructor () BEP20Detailed("Groks", "Groks", 9) {
      _owner = msg.sender ;
    _totalSupply = 400000000000000000 * (10**9);
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 5, "Buy fee should be less than 5%");
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 5, "Sell fee should be less than 5%");
    ...
    {
        require(_numTokensSellToFee >= 10000 * 10**18 && _numTokensSellToFee <= 10000000 * 10**18, "Threshold must be set within 10,000 to 10,000,000 tokens");
