/**
   ...
   #DOGEFATHER - #LIQ+#RFI+#SAFEMOON+DOGE, combine together to #DOGEFATHER Token. 
  
  Website: http://thedogefather.dog/
  Telegram: https://t.me/ElonTheDogeFather
   ...
   I will add 2 BNB and all the left 40% total supply to the pool
   Can you make #DOGEFATHER 1000000000000X? LOL

   1,000,000,000,000,000 total supply
   5,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
   10% tokens for Partnetships
   ...
   it's the best part of the #DOGEFATHER idea, increasing the liquidity pool automatically, 
...
contract DOGEFATHER is Context, IERC20, Ownable {
    ...
    string private _name = "The DogeFather";
