...
contract SantaElon is IBEP20, Auth {
    using SafeMath for uint256;

    address public REWARD = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTC
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    address public MKT = 0x8215c63874Ff6dE902DeB1074210a4899459c887;

    string public constant _name = "Santa Elon";
    string public constant _symbol = "SELON";
    ...
    uint256 public totalBuyFee = 100; //Fee for all buy transactions 
    ...
    uint256 public totalFee = liquidityFee.add(marketingFee).add(buybackFee).add(reflectionFee);
    ...
    function clearStuck(uint256 amountPercentage) external isAutorizer {
    ...
    function swapBack() internal swapping {
        ...
        if (totalFee > 0) {
            ...
            uint256 amountBNBStaking = amountBNB.mul(buybackFee).div(totalBNBFee);
    ...
    function setFeeDistribution(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _stakingFee) external onlyOwner {
        ...
        buybackFee = _stakingFee;

        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_stakingFee);

         emit FeeDistributionUpdated(liquidityFee,reflectionFee,marketingFee,buybackFee);
    }
