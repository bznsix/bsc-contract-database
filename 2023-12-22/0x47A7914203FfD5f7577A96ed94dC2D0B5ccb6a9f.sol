...
contract MGROK is ERC20, Ownable {
    ...
    address public  mightyCasinoWallet;
    address public  mightyDropWallet;
    ...
    constructor () ERC20("The Mighty Grockie", "MGROK") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xbF6f2ed95a536765961025083BC51b7b4f2AeF24;
        mightyCasinoWallet = 0x9e9d93c0D8b8c8BD1D1a0653Ff0F075e927d644D;
        mightyDropWallet = 0x2B32310Ad0eEf33f0b74B56Ddc2bC52C05654162;
        ...
        _mintOnce(owner(), 1e6 * (10 ** decimals()));
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        uint256 casinoAndDrop = newBalance * 2 / 11;

        payable(mightyCasinoWallet).sendValue(casinoAndDrop);
        payable(mightyDropWallet).sendValue(casinoAndDrop);
        payable(feeReceiver).sendValue(address(this).balance - initialBalance);
