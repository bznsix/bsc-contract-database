/*────────────────────────────────────────┐
  ...
  x.com/coinsultaudits | t.me/coinsult_tg
──────────────────────────────────────────┘
...
contract PepeTheGrok is ERC20, Ownable {
    ...
    event MarketingWalletTwoChanged(address marketingWalletTwo);
    ...
    constructor () ERC20("Pepe The Grok", "Pepe The Grok") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x151e0c433fA5eE855968D84B6eF6F38e16663Da6);
        ...
        marketingWallet = 0x831DE1Ff0f02c7d39DeE7302a53DcF52261083b0;
        marketingWalletTwo = 0x9958dB967501664944e8704EAdd3560a1a0DDb8A;
    ...
    function changeMarketingWalletTwo(address _marketingWalletTwo) external onlyOwner{
        require(_marketingWalletTwo != marketingWalletTwo,"Marketing wallet 2 is already that address");
        require(_marketingWalletTwo != address(0),"Marketing wallet 2 cannot be the zero address");
        marketingWalletTwo = _marketingWalletTwo;

        emit MarketingWalletTwoChanged(marketingWalletTwo);
    }
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 oneBalance = newBalance * 3 / 5;

        payable(marketingWalletTwo).sendValue(oneBalance);
