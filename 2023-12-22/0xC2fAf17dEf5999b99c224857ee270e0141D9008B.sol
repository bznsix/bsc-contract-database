...
contract FD is ERC20, Ownable {
    ...
    constructor() ERC20("FD", "FD") {
        ...
        if (block.chainid == 56) {
            manager = 0x9Ae12674D3696603567b1744b5Ce4bC9D8A9FA03;
            recieve = 0x693fE89588EC337b840fd62DFCea5E801435a72A;
            _market = 0x693fE89588EC337b840fd62DFCea5E801435a72A;
