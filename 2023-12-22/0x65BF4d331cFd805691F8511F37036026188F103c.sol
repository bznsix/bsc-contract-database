...
contract USDTFactory is ContextMixin, AccessControl, Pausable, ReentrancyGuard, NativeMetaTransaction {
    using SafeERC20 for IERC20;
    string public constant name = "Playbux USDT Factory";
    ...
    constructor(IERC20 _usdt, address _admin) {
        require(address(_usdt) != address(0), "USDT address is invalid");
    ...
    function withdraw(
        ...
        require(usdt.transfer(_receiver, _amount), "Transfer failed");
