...
contract UFCWIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0737C366330e9dE048Fc0B3f4324bFcD83953775); 
    address payable public Wallet_Dev = payable(0xD9E0C7Fa28D03F1198cd9CfEf8B8c917beE7D851);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000000 * 10**4* 10**4 * 10**_decimals;
    string private constant _name = "UFC WIN"; 
    string private constant _symbol = unicode"UFC"; 
    ...
    constructor () {
        _owner =0x0737C366330e9dE048Fc0B3f4324bFcD83953775;
