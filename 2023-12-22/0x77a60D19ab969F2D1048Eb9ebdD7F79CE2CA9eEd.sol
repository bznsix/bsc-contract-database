// Website - https://bnbduck.top
// Telegram - https://t.me/BNBDuck
// X - https://x.com/BNBDuckOfficial

// BNBDuck is not just a memecoin; it's a path to spiritual and financial growth. 
// Our community believes in the interconnectedness of all things, and we strive to create a positive impact in both the crypto world and the world at large.

//     _ __(.)<  QUACK QUACK        _ __(.)< QUACK QUACK       _ __(.)< QUACK QUACK      _ __(.)< QUACK QUACK     _ __(.)< QUACK QUACK    _ __(.)< QUACK QUACK   
//       \___)   QUACK QUACK          \___)  QUACK QUACK         \___)  QUACK QUACK        \___)  QUACK QUACK       \___)  QUACK QUACK    \___)    QUACK QUACK     
...
contract BNBDuck is ERC20, Ownable {
    ...
    constructor() payable ERC20("BNB Duck Inu", "BNBDuck") {
        ...
        marketingWallet = 0x14fD5F729bD656046C9C2bFA04053b4c180aaA6F;
        developmentWallet1 = 0x14fD5F729bD656046C9C2bFA04053b4c180aaA6F;
        developmentWallet2 = 0x14fD5F729bD656046C9C2bFA04053b4c180aaA6F;
        ...
        _mint(owner(), 1_000_000_000_000_000_000 * (10 ** 18));
