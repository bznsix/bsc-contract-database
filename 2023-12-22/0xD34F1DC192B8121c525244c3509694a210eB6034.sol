...
contract Grok_Father is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"Grok Father", unicode"GROK FATHER") 
    {
        address supplyRecipient = 0x1F93Cf6ceD9187F6b193DD8F29DedC8e1DF79fDA;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x1F93Cf6ceD9187F6b193DD8F29DedC8e1DF79fDA);
        marketingFeesSetup(900, 900, 900);
        ...
        updateMaxBuyAmount(3450000000000 * (10 ** decimals()) / 10);
        updateMaxSellAmount(3450000000000 * (10 ** decimals()) / 10);
        updateMaxTransferAmount(3450000000000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 6900000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x1F93Cf6ceD9187F6b193DD8F29DedC8e1DF79fDA);
    }
