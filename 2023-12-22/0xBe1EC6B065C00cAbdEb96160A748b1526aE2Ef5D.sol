...
// TELEGRAM : https://t.me/hashfinanceportal

// Hash Finance (HASH) is a layer 1 blockchain cryptocurrency designed
 to offer a high-performance platform and security for decentralized
  applications (dApps) and smart contracts. Its architecture is based on
   a securing data information on cryptocurrencies.
 Modified version of the Proof-of-Work (PoW) using hashing algorithm
...
contract HASHfinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HASH FINANCE";
    string private _symbol = "HASH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81D47b1732D6793c70E988444AedDe1D2A617351); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x81D47b1732D6793c70E988444AedDe1D2A617351); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (5 * 10**5 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
