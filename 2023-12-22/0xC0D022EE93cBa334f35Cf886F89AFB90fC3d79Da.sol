...
contract GrokPepeFlokiBonk is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x042ff900B6fE9a9eD09d78C4D4494f954375ee8E);

    string public _name = "GrokPepeFlokiBonk";
    string public _symbol = "GPFB";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 6969696969 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 2;
     
    uint256 private fee_totals = 12;
    uint256 public buying_fee = 6;
    uint256 public selling_fee = 6;
