...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xf4447763B163326bd7a0399959eC0b23f9a1686d;
...
contract UPCX is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xf4447763B163326bd7a0399959eC0b23f9a1686d);
    ...
    string private _name = unicode"UPCX"; 
    string private _symbol = unicode"UPC";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 780000000 * 10**18;
