...
contract Reundefy is ERC20, ERC20Burnable, Ownable, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"Reundefy", unicode"RDFY") 
    {
        address supplyRecipient = 0x0e018E03f97A120462B6B9E9BdA623761061c2f6;
        
        updateSwapThreshold(75);

        developmentAddressSetup(0x0e018E03f97A120462B6B9E9BdA623761061c2f6);
        developmentFeesSetup(200, 200, 0);
        ...
        updateMaxWalletAmount(1000000000 * (10 ** decimals()) / 10);
        ...
        _transferOwnership(0x0e018E03f97A120462B6B9E9BdA623761061c2f6);
    }
    ...
    */
    ...
    function getAllPending() public view returns (uint256) {
        return 0 + _developmentPending + _liquidityPending + _rewardsPending;
    }
