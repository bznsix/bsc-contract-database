/**
 *Submitted for verification at testnet.bscscan.com on 2023-02-14
*/
...
======================= Quick Stats ===================
    => Name        : DTSOKRAT2 Token
    => Symbol      : DTSOKRAT2
    => Max supply: 20,000,000,000 (20 Billion)
    => Decimals    : 18
----------------------------------------------------------------------------
 SPDX-License-Identifier: MIT
 Copyright (c) 2021 onwards CORE MultiChain ( https://www.coremultichain.com )
-----------------------------------------------------------------------------
*/ 
...
contract DTSOKRAT2 is Ownable, ERC165 {
    ...
    string constant private _name = "DTSOKRAT2";
    string constant private _symbol = "DTSOKRAT2";
