...
contract PEPE is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x3Fb7E637Cc99E57f60Eb21108f6F40c86707b380;
    ...
    constructor() public ERC20("PEPE GROK", "PEPE GROK") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(timeSecord)){
                ...
                super._transfer(from, _marketingWalletAddress, lpfees);
                isSw = true;
            }
        }
