...
contract LuffyG5 is ERC20, Pausable, Ownable, ReentrancyGuard {
    ...
    address public fundsWallet = address(0xf0d061c0C227FAa4c41417727dD8cCB3bA788728);
    ...
    constructor() ERC20("Luffy G5 Game", "LFG NFTs") {
        ...
        twitter     = "https://x.com/luffyg5lfg";
        telegram    = "https://luffyg5.com/";
    ...
    function buyNFT(
        ...
        //LFG
            ...
            IERC20(addressLFG).transferFrom(msg.sender, fundsToken, amount);
