...
contract XULONG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " XULONG";
    string private _symbol = "$XULONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xfd1334AA7D1bD92a23B2771F08a2C84c500609E2);
