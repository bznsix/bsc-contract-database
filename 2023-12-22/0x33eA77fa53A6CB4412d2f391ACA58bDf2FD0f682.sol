/**
Twitter : https://twitter.com/ShibonkInuBsc
Telegram: https://t.me/ShibonkInu
Website : https://www.shibonkinu.run/
 */
...
contract ShibonkInu is ERC20, Ownable {
    ...
    //Wallets
    address public marketingWallet = 0x2eb19059E017eDF44FDD97f348184EA8F77883EB ;
    ...
    constructor() ERC20("Shibonk Inu", "Shibonk Inu") {
    ...
    function setBuyTaxes(uint256 _marketingTax) external onlyOwner {
        ...
        require(_marketingTax <= 15, "Can not set buy fees higher than 15%");
