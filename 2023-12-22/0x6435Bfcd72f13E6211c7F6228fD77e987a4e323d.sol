...
contract BULLGROK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BULL GROK"; // 
    string private constant _symbol = unicode"$BullGrok";  //    
