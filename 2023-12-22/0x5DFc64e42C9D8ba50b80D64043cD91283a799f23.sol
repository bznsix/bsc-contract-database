/**
Telegram : https://t.me/santarichBSC
X : https://x.com/santarich11
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5FB19C2437503eEb110254Ede44f813C40AC4104 ; // owner address
...
contract SantaRich is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Rich";
    string private _symbol = "SantaRich";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5FB19C2437503eEb110254Ede44f813C40AC4104); // Marketing Address
    address payable private teamWalletAddress = payable(0x5FB19C2437503eEb110254Ede44f813C40AC4104); // Team Address
