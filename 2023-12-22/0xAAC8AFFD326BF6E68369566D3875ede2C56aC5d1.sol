/**
   #COINBASEMOON - #LIQ+#RFI+#SHIB, combine together to #COINBASEMOON Token. 
   ...
   I make this #COINBASEMOON to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/COINBASEMOONBSC
   ...
   I will renounce the ownership to burn addresses to transfer #COINBASEMOON to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #COINBASEMOON 10000X? 
   ...
   it's the best part of the #COINBASEMOON idea, increasing the liquidity pool automatically, 
...
contract COINBASEMOON is Context, IERC20, Ownable {
    ...
    string private _name = "COINBASE MOON";
    string private _symbol = "CBM";
