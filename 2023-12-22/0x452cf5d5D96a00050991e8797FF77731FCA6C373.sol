...
/**
   ...
   Welcome to COCOMELON
   
   This is a community token. If you want to create a telegram I suggest to name it to @COCOMELON
 ...
 10000X? 
   ...
   it's the best part of the #COCOMELON
...
contract COCOMELON is Context, IERC20, Ownable {
    ...
    string private _name = "COCOMELON";
    string private _symbol = "COCOMELON";
