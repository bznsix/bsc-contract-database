/**
            Loopium Network - Blockchain Integrated with AI

The Points that we present as the advantages of Loopium Network products, are:
    🔷 Massive Scalable
...
Social MediaL:
 ...
 Telegram    :https://t.me/LoopiumNews
 X (Twitter) :TBA
 Website     :https://www.loopium.net/
*/
...
contract LOOPIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOOPIUM";
    string private _symbol = "LPM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x884c485B9a8F11da0Fe2fBE39d5EC9c3d6F44e52);
    address payable public teamWalletAddress = payable(0x5bdC99675226a9Bf709c803F6e6Bd8e48e71e6BB);
