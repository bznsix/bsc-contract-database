...
contract QILIN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 350000000e18;
    ...
    constructor() {
        _name = "Qi Lin Coin";
        _symbol = "QILIN";
        _mint(0xd09AAA380C285d0a31F6cbB535Da909609A99CC7, initSupply);
        setWList(0xd09AAA380C285d0a31F6cbB535Da909609A99CC7, true);
