...
contract BuyNft is Ownable {
    ...
    address public receiveFee = 0x8E6814e9F12A6592d42748666F70a9B4579A092b;

    bool public stt = false;
    uint256 public totalMint = 168;
    uint256 public timeOpen = 1703088000;
    uint256 public priceNft = 0.6 * 1e18;
    ...
    function configs(address receiveFee_, uint256 priceNft_, bool _stt) public onlyOwner {
    ...
    function buyNfts() external payable {
        require((block.timestamp >= timeOpen) || (stt), "not open");
        require(totalMint > 0, "max");
