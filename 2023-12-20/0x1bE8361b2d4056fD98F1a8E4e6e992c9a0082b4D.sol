/**
Telegram : https://t.me/planetariumofficial
Website :https://planetarium-multichain.com
*/
...
contract PLANETARIUM is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02bdB728Cdfd579C6e3ba2BB118C89f903d8929a); 
    address payable private Wallet_Dev = payable(0x02bdB728Cdfd579C6e3ba2BB118C89f903d8929a);
    ...
    string private constant _name = "Planetarium "; 
    string private constant _symbol = unicode"PLANETARIUM"; 
    ...
    constructor () {
        ...
        _owner = 0x02bdB728Cdfd579C6e3ba2BB118C89f903d8929a;
