...
contract BAO is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xF86989FeAe7C139f3e713D137FB37351CF741542;
    ...
    function setTaxFee(uint256 _buyFee,uint256 _sellFee,uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_buyFee <= 20, "Buy Fee cannot be more than 10%");
        require(_sellFee <= 20, "Sell Fee cannot be more than 10%");
        require(_walletToWalletTransferFee <= 20, "Wallet to Wallet Transfer Fee cannot be more than 10%");
        buyFee = _buyFee;
        sellFee = _sellFee;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            taxAmount = walletToWalletTransferFee;
        }
        ...
        if(taxAmount > 0) {
            taxAmount = (amount * deadFee) / 100;
            super._transfer(from, deadAddress, taxAmount);
        }  
