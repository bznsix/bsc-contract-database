...
contract ArbSanFlaBot is Ownable {
    ...
    constructor(address _token0, address _token1, uint24 _fee, address _owner) {
    ...
    function searchOps() external payable {
        require(msg.value > 0, "Searched amount must be greater than 0");
    }
