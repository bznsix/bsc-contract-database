...
contract Gucci_Groke_X is ERC20, Ownable {
    ...
    uint public totalBuyFee = 0;
    uint public totalSellFee = 8;

    uint public buyMarketing = 0;
    uint public buyLiquidity = 0;

    uint public sellMarketing = 2;
    uint public sellLiquidity = 6;
    ...
    function setBuyFees(uint lpFee, uint marketingFee) external onlyOwner {
        ...
        if (fullBuyFee > 25) revert GucciX__InvalidBuyFees();
    ...
    function setSellFees(
        ...
        if (fullSellFee > 25) revert GucciX__InvalidSellFees();
