...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20("COOK", "COOK") {
        admin=0x3c769E0CdaB29bBecd65dC80490ce72AC408f3B4;
        //admin=msg.sender;
        fundAddr=0x70847568509B0b85540b253C386b33A35A3CC0eF;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair) {
            ...
            fundCount+=amount.mul(5).div(100);
            super._transfer(from, to, amount.mul(95).div(100));
            return;
        }
        if(to == uniswapV2Pair) {
            if(whiteList[from]){
