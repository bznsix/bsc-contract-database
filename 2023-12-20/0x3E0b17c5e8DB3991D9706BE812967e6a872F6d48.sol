...
contract ETBYCore is Ownable {
    ...
    constructor() {
        ...
        markets.push(Market(1,awardToken,0,101));    //0  1   1
        markets.push(Market(7,awardToken,0,108));    //1  7   8
        markets.push(Market(15,awardToken,0,118));    //2 15  18
        markets.push(Market(30,awardToken,0,138));    //3 30  38 
        markets.push(Market(90,awardToken,0,228));    //4 90  128
        markets.push(Market(180,awardToken,0,360));   //5 180 260
    }
