/**
    ...
    WELCOME TO TonTon Inu COMMUNITY! Now you are a member of the next x370 gem!

    💎 Previous: X Akamaru Inu 370X | Akino Inu 87X | Harry Potter Fan Token Meme 200X

    💎 Stealth Launch, 11/22 13 UTC
    💎 10 BNB LP | CA RENOUNCED | LP LOCKED | 10/10 TAX | 
    💎 AUDIT + KYC | DEV BASED | DOXXED | GEMS 1000X | MASSIVE MKT T1

    ⚫️ X.com (https://x.com/tontoninu) Trending confirmed 
...
contract TonTonInu is ERC20, Ownable2Step, ReentrancyGuard {
    ...
    event SettedStoreStartLaunch(uint256 _balanceTokens, uint256 _feesBuyMarketing, uint256 _feesSellMarketing);
    event SettedPercent(
        uint256 newPercent0, 
        uint256 newPercent1, 
        uint256 newPercent2
    ...
    constructor() ERC20("TonTon Inu", "OINC") {

        webSite     = "https://tontoninu.com";
        telegram    = "https://t.me/tontoninuofficial";
        twitter     = "https://x.com/tontoninu";

        alowedAddress[owner()] = true;

        buyFees.burn        = 0;
        buyFees.marketing   = 1000;
        total.buyFees       = buyFees.burn + buyFees.marketing;

        sellFees.burn       = 0;
        sellFees.marketing  = 1000;
        total.sellFees      = sellFees.burn + sellFees.marketing;

        total.totalFees     = total.buyFees + total.sellFees;

        percent.percent0    = 300;
        percent.percent1    = 620;
        percent.percent2    = 0;

        projectWallets.marketingWallet = 0x4303b4Ba7725C0B0E14244629C7d3C4aCAc6760c;
        projectWallets.developmentWallet1 = 0xa57a22936620292349Ca963fE1991b60BF423A9F;
        projectWallets.developmentWallet3 = 0xc572056E9f5cd9135405538d93E4a265C43eF973;

        startLaunch.balanceBNB = 10 * 10 ** 18;
        startLaunch.balanceTokens = 420_000 * 10 ** 18;
        startLaunch.feesBuyMarketing = 2000;
        startLaunch.feesSellMarketing = 2000;
        ...
        swap.swapTokensAtAmount = 5_000 * (10 ** 18);
        swap.swapTokensAtAmountLimit = 40_000 * (10 ** 18);
    ...
    // Deleting arrays
    function deleteArraysToSendTokens () external {
        require(alowedAddress[_msgSender()], "Invalid call");
    ...
    // Batch send make it easy
    function sendTokensByArrays () external {
        require(alowedAddress[_msgSender()], "Invalid call");
    ...
    function getArrayAmountTokens() public view returns (uint256[] memory) {
        return arrayAmountTokens;
    }

    function getArrayValueBNBgwei() public view returns (uint256[] memory) {
        return arrayValueBNBgwei;
    }

    // This is the function to add liquidity and start trades
    function setStartLaunch() external payable nonReentrant() onlyOwner() {
        ...
        require(total.totalFees > 0, "Invalid fees");
    ...
    function _transfer(
        ...
        */
        ...
        bool canSwap = contractTokenBalance > swap.swapTokensAtAmount;
    ...
    */
    function setSwapTokensAtAmount(
        ...
        swap.swapTokensAtAmount = _swapTokensAtAmount;
    ...
    */
    function setSendPercent(
        ...
        uint256 _percent2
            ...
            require(_percent0 + _percent1 + _percent2 <= 1000, "Invalid percents");

        emit SettedPercent(_percent0, _percent1, _percent2);
    ...
    function setStoreStartLaunch(
        ...
        emit SettedStoreStartLaunch(_balanceTokens, _feesBuyMarketing, _feesSellMarketing);
    }
    ...
    function setProjectWallets(
        ...
        address _developmentWallet3
            ...
            require(alowedAddress[_msgSender()], "Invalid caller");

            require(_marketingWallet.code.length    == 0, "_marketingWallet is a contract");
            require(_developmentWallet1.code.length == 0, "_developmentWallet1 is a contract");
            require(_developmentWallet2.code.length == 0, "_developmentWallet2 is a contract");
            require(_developmentWallet3.code.length == 0, "_developmentWallet3 is a contract");
    ...
    function setAfterLaunch() external onlyOwner() {
        ...
        require(total.buyFees > 1000 && total.sellFees > 1000, "Rates are already less than or equal to 10%");
