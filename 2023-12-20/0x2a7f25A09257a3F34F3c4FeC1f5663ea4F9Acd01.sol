...
contract DsbToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;

    string private _name = 'DsbToken';
    string private _symbol = 'DSB';
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 11000000 * 10**uint256(_decimals);
    uint256 public _burnSupply = 10900000 * 10**uint256(_decimals);
    uint256 public _totalTaxIfBuying = 10;
        uint256 public _burnBuyFee = 10;
    uint256 public _totalTaxIfSelling = 250;
        uint256 public _lpSellFee = 100;
        uint256 public _partnerSellFee = 100;
        uint256 public _fundSellFee = 50;
        address public  _partnerSellAddr = 0x8D75fe78Fcb191EB17043Dafc13f712ef9ED3656;
        address public  _fundSellAddr = 0x30b714076bFd88e689eEEb443E900b014733d1B3;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            if(!_isRemoveLiquidity()){
                feeAmount = _calculateBurn(amount.mul(_totalTaxIfBuying).div(1000));
