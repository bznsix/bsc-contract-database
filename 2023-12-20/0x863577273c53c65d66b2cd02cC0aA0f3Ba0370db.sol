/*
🐷 GrokPig 🐷 dirty ugly but elon like it

BSC
🐷Renounced
🐷LP LOCK
🐷Tax 2%🦓
TG: https://t.me/GrokPig
🦝 WEBSITE https://GrokPig.com/
...
abstract contract OwnableIBEP20 is Context {
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableIBEP20: caller is not the owner");
        _;
    }
...
contract GrokPig is OwnableIBEP20, IBEP20 {
    using SafeMath for uint256;
    string private _name = "GrokPig ";
    string private _symbol = "GrokPig ";
