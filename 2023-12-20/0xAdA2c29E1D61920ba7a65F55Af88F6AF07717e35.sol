...
contract Taurus is ERC20, Ownable {
    ...
    address public _market = 0xbc50D179C8368A7fb91fA5D83004feE83d890DF6;
     event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("$Taurus", "$Taurus") {
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_market] = true;
         address jsaddress = 0x82064B9B6cc19F9DeE7Fe10898Eed911F18A0929;
        _isExcludedFromFee[jsaddress] = true;
        _mint(jsaddress, _tTotal);
