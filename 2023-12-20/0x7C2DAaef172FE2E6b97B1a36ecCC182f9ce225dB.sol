...
//--- Contract v3 ---//
contract Grokpepe is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xE79167c62A67d5f6989c26E1B6726266f738BbED); // build: 0xE79167c62A67d5f6989c26E1B6726266f738BbED
    address payable private devWallet = payable(0x06C317537896ce01F26af32e74A3ba14Cda0A6E9); // build: 0x06C317537896ce01F26af32e74A3ba14Cda0A6E9
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grokpepe";
    string constant private _symbol = "$GROPE";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x2D104167E4290C4c1Ad7382927D52A4d99Ca6D52);
