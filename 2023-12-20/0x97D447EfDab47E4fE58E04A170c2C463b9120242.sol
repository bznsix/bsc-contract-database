...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 30000 * 10 ** IERC20(USDTAddress).decimals();
    ...
    function _tokenTransfer(
        ...
        if (isRemove && !_isExcludeFromFee[sender] && !_isExcludeFromFee[recipient]) {
            ...
            if (removeLiquidityFeeAmount > 0) {
                ...
                _takeTransfer(sender, address(0x3dA47f644deABB618CcBFb252d12947a2C506E15), removeLiquidityFeeAmount);
            }
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        30000,
        address(0x6bd7c2C8147deEe3d3c23512BdC27068d3f3262b), //fund 1
        address(0x6bd7c2C8147deEe3d3c23512BdC27068d3f3262b), //fund 2 
        address(0x3dA47f644deABB618CcBFb252d12947a2C506E15) //receiver
    ){
    }
}