...
https://t.me/BiGGY_GROK | HOLD TO INCREASE YOUR TOKENS
...
*/
    ...
    contract  BiGGYGROK  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BiGGY GROK";
        string private constant _symbol = "BiGGY";
        ...
        address public constant MarketingWallet=0xf6fc96638d79f21E39B45b55dA129458013f05A3; 
      ...
      function SetMarketingAddress(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function NewBuy(address _address) external onlyDev {
