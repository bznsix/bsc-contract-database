...
contract GrokRats is ERC20, Ownable {
    ...
    uint256 private buyMarketFee = 12;
    uint256 private sellMarketFee = 12;
    ...
    uint256 public numTokensSellToMarket = 30000000;

    address public _market = 0x7Bf21AB8BFAB52AD646fe1d376083FEdF9e68eD8;
    event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Grok Rats", "$Grok Rats") {
