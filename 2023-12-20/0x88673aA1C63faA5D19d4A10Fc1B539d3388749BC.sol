...
contract Xmasnetwork is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0x6D8a1B9D48B4B2556775C61C3f29614251F02D5b;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "XMAS NETWORK";
    string constant _symbol = "XNW";
