...
// Telegram: https://t.me/TerminatorGrok
...
contract TerminatorGrok is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Terminator Grok";
    string private constant _symbol = unicode"$TERGROK";
    ...
    address payable public DevWallet = payable(0xFd80023d690C53faaC8433011a1E8f6DC529Bb13);
    address payable public MarketingWallet = payable(0xFd80023d690C53faaC8433011a1E8f6DC529Bb13);
