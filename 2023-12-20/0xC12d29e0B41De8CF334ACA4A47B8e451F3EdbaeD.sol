...
contract Profiter {
    ...
    constructor(address payable ownerAddress, address payable _admin) public {
        ...
        levelPrice[3] = 10 ether;
        levelPrice[4] = 18 ether;
        levelPrice[5] = 33 ether;
        levelPrice[6] = 50 ether;
        levelPrice[7] = 100 ether;
        levelPrice[8] = 180 ether;
        levelPrice[9] = 330 ether;
        levelPrice[10] = 500 ether;
        levelPrice[11] = 1000 ether;
        levelPrice[12] = 1800 ether;
        levelPrice[13] = 3300 ether;
        levelPrice[14] = 5000 ether;
        levelPrice[15] = 10000 ether;
        levelPrice[16] = 18000 ether;
        levelPrice[17] = 33000 ether;
        levelPrice[18] = 50000 ether;
        levelPrice[19] = 100000 ether;
        levelPrice[20] = 180000 ether;
        levelPrice[21] = 330000 ether;

        nextlevelDeduction[1] = 0.5 ether;
        nextlevelDeduction[2] = 0;
        nextlevelDeduction[3] = 1 ether;
        nextlevelDeduction[4] = 1.5 ether;
        nextlevelDeduction[5] = 8 ether;
        nextlevelDeduction[6] = 0;
        nextlevelDeduction[7] = 10 ether;
        nextlevelDeduction[8] = 15 ether;
        nextlevelDeduction[9] = 80 ether;
        nextlevelDeduction[10] = 0;
        nextlevelDeduction[11] = 100 ether;
        nextlevelDeduction[12] = 150 ether;
        nextlevelDeduction[13] = 800 ether;
        nextlevelDeduction[14] = 0;
        nextlevelDeduction[15] = 1000 ether;
        nextlevelDeduction[16] = 1500 ether;
        nextlevelDeduction[17] = 8000 ether;
        nextlevelDeduction[18] = 0;
        nextlevelDeduction[19] = 10000 ether;
        nextlevelDeduction[20] = 15000 ether;
        nextlevelDeduction[21] = 80000 ether;
        owner = ownerAddress;
        admin = _admin;
    ...
    function updateO3Referrer(
        ...
        if (users[referrerAddress].activeO3Levels[level])
            sendusdtDividends(
                referrerAddress,
                userAddress,
                1,
    ...
    function sendusdtDividends(
        ...
        if (payout > 0) {
            ...
            if (!pusdContract.transfer(users[userAddress].user, userpayout)) {
                pusdContract.transfer(
    ...
    function safeWithdrawTokens() public payable {
        require(msg.sender == owner, "Permission Denied");
        pusdContract.transfer(owner, pusdContract.balanceOf(address(this)));
    }
}