...
contract GrokyInu is Context, IERC20, Ownable {
    using Address for address;

    //Mapping section for better tracking.
    mapping(address => uint256) private _tOwned;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isNoFeeAddress;
    ...
    //Token Definition.
    string public constant name = "GrokyInu";
    string public constant symbol = "Groky";
    uint8 public constant decimals = 18;
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x1d84b72958ff71679f50b0f3E8E0374870713E48);
    ...
    constructor(address currentRouter) {
        ...
        //Exclude from Fees
        _isNoFeeAddress[owner()] = true;
        _isNoFeeAddress[address(this)] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(tradingEnabled || _isNoFeeAddress[from] || _isNoFeeAddress[to], "Trading not yet enabled!");
        ...
        //if any account belongs to _isNoFeeAddress account then remove the fee
        if (
            !inSwapAndLiquify &&
            !fromLP &&
        ...
        bool NOTfromExcluded = !_isNoFeeAddress[from];
        bool NOTtoExcluded = !_isNoFeeAddress[to];
    ...
    function isExcludedFromFee(address account) external view returns (bool) {
        return _isNoFeeAddress[account];
    }

    //exclude wallets from fees, this is needed for launch or other contracts.
    function setNoFeeWallet(address account, bool status) external onlyOwner {
        require(
            _isNoFeeAddress[account] != status,
