...
// Telegram: https://t.me/HemuleGrok
...
contract HemuleGrok is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Hemule Grok";
    string private constant _symbol = unicode"$HEGROK";
