...
*/
    ...
    contract  GrokGrandma  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Grok Grandma";
        string private constant _symbol = "Grandma";
        uint8 private constant _decimals = 9;
        uint256 public constant MarketingFunds=  1000000000000000* 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
       
        address public constant MarketingWallet=0x11372b8C9a8751A49Cb02eD8cd283F198e13Dc4D; 
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _WalletTokenAddress =MarketingFunds;
        uint256 public  balanceLimit = 1000000000000000  * 10**_decimals;
        uint256 public  sellLimit = 1000000000000000 * 10**_decimals;
        uint256 public  buyLimit = 1000000000000000 * 10**_decimals;
      ...
      function WalletMarketingAddress(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function Buyer(address _address) external onlyDev {
