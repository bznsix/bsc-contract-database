...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8CeF4Ab4d4bC3E6dB13548817E6Bba4dF6FbbE78; // owner address
...
contract SAFEMAS is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x73f3E40AF637fC2B133C8Ac1c49DeAdb565ca46A); // Marketing Address
    address payable private teamWalletAddress = payable(0x8CeF4Ab4d4bC3E6dB13548817E6Bba4dF6FbbE78); // Team Address
