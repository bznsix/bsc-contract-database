...
──────────────────────────────┘
 ...
 contract CHOW is ERC20, Ownable {
     ...
     constructor () ERC20("CHOW-CHOW", "$CHOW") 
     {   
         address router;
         address pinkLock;
         ...
         marketingWallet = 0xAcF747BFD86B6C28687F5C8a6F4618CBC9678E5b;
     ...
     function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy, uint256 _burnFeeOnBuy, uint256 _burnFeeOnSell) external onlyOwner {
         ...
         require(marketingFeeOnBuy + burnFeeOnBuy <= 10, "Total Fees cannot exceed the maximum");
         require(marketingFeeOnSell + burnFeeOnSell <= 10, "Total Fees cannot exceed the maximum");
