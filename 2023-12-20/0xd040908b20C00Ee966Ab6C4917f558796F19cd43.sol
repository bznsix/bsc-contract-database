...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8cD02F24958bf65F675330fe5548dECEb96F3ea3; // owner address
...
contract KevinToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KEVIN TOKEN";
    string private _symbol = "KT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8cD02F24958bf65F675330fe5548dECEb96F3ea3); // Marketing Address
    address payable private teamWalletAddress = payable(0x8cD02F24958bf65F675330fe5548dECEb96F3ea3); // Team Address
