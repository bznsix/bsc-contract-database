...
contract LaunchX is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    constructor() ERC20("LaunchX", "LAUNCHX") {
        ...
        marketingwallet = address(0x187B5EC74A862E4d758df06D51b03C3635f0E4AA); 

        liqWallet = address(0xfee24F75A42AFeBCDEF7bf84E1132dB3D909aEE6); 
