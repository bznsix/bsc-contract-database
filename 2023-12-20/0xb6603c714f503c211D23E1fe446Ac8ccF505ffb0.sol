...
// Telegram: https://t.me/GrokmomTwo
...
contract GrokmomTwo is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Grokmom 2.0";
    string private constant _symbol = unicode"$GM2.0";
