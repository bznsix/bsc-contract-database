...
contract GrokGroks is Context, IERC20, Ownable {
    ...
    string private _name = "GROK GROKS";
    string private _symbol = "GROKS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95E9D9b623101C50C52cF1a3599B05a9B4586EAb); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x95E9D9b623101C50C52cF1a3599B05a9B4586EAb); // Development Address
    ...
    uint256 private _totalSupply = 420* 10**18 * 10**9;
    uint256 public _maxTxAmount = 9 * 10**18 * 10**9;
    uint256 public _walletMax = 9 * 10**18 * 10**9;
