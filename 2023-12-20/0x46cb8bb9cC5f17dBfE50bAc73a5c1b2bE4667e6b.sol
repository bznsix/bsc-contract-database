...
contract Gronk is Context, IERC20, Ownable {
    ...
    //Token Definition.
    string public constant name = "Gronk";
    string public constant symbol = "$Gronk";
    ...
    uint256 public minimumTokensBeforeSwap = 10_00 ether;
