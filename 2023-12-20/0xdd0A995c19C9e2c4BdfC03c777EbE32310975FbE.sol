...
contract ChildeSupportNfts is ERC721Enumerable, Ownable {
    uint256 public MAX_NFT_SUPPLY;
    uint256 public MINT_PRICE;

    uint256[] private mintedIds;

    string public baseURI = "https://www.example.com/nfts/";

    // Keep track of used token IDs
    ...
    constructor(
        ...
        // transferOwnership(0x6ceb797Aab20362aD7b9424F50Be395D547C9085);
    }
    ...
    function mintNFT(
        ...
        require(_nftIds.length == _numberOfNfts, "Invalid id array");

        require(msg.value >= (MINT_PRICE * _numberOfNfts), "Insufficient BNB");

        for (uint256 i = 0; i < _numberOfNfts; i++) {
            _mint(msg.sender, _nftIds[i]);
            mintedIds.push(_nftIds[i]);
        }
    ...
    function changeMinitingPrice(uint256 _price) external onlyOwner {
        MINT_PRICE = _price;
    }
