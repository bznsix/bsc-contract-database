...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); //SOL
...
contract SOLANAGROW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Solana Grow";
    string constant _symbol = "SOLGROW";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; //SOL

    uint256 _totalSupply = 565000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 20000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x21c9BD5bdd450Ce76184a4b4Cef5c434a8c90289;  
        teamWallet = 0x21c9BD5bdd450Ce76184a4b4Cef5c434a8c90289; 
