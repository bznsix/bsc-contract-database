...
/**
Telegram: https://t.me/FrogeInu_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf92179C39360f137b7546A0c1426719Cf918dDF3; // owner address
...
contract CRAZYGROG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CRAZY FROG";
    string private _symbol = "CRZ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf92179C39360f137b7546A0c1426719Cf918dDF3); // Marketing Address
    address payable private teamWalletAddress = payable(0xf92179C39360f137b7546A0c1426719Cf918dDF3); // Team Address
    ...
    function SetBlakcklist(address[] calldata addresses) external onlyOwner {
