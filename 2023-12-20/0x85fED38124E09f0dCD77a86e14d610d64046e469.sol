...
The first token to truly give back to it’s holders!

The concept of giving gifts during the holiday was inspired by men who brought gifts to honor the birth of Jesus. 
We intend to do the same, except honor our holders in return…

GIVING BACK TO THE COMMUNITY

Christmas gifts will be given everyday to a portion of our holders. The only requirement needed to be eligible 
for the prize is simple, to HODL for 1 day minimum all while holding the minimum amount of tokens required. 
During the first week, the minimum amount of tokens required to be held will be around $100 worth of Grok Santa 
tokens.

Our goal is to continuously increase the value of Grok Santa tokens as well as the volume and holders so that 
by Christmas time, we could be averaging a million dollars a day in volume.
...
TelegramCommunity: https://t.me/groksantaentry
**/
...
contract GROKSANTA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GROKSANTA";
    ...
    address payable public DevWallet = payable(0xD87833e675578b6bb6C38342d91fe189BbE4a679);
    address payable public MarketingWallet = payable(0x21057cB61e627e1773e58bF2025d2FF8a4fdf88f);
    ...
    function setTaxFee(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function setMaxLimit(uint256 newmaxWallet) external onlyAddress {
    ...
    function rescueAnyBEP20Tokens(uint256 value, address adr) onlyAddress public virtual {
