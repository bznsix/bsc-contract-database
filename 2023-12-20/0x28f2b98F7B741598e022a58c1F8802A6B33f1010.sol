...
contract ARR is ERC20, Ownable {
    ...
    constructor() ERC20("AURORA", "ARR") {
        address recieve = 0xb6Ce1087Cc8ea7d1b63dda880697BB498Fd96db4;
        manager = 0xb6Ce1087Cc8ea7d1b63dda880697BB498Fd96db4;
        marketA = 0x45e1e0A314b69855B8E1024aB19A8B585fD34fBa;
        marketB = 0xdD09839d0c5D7Ea056Ed54045AD33BB2681E02C1;
        ...
        isFeeExempt[marketA] = true;
        isFeeExempt[marketB] = true;
    ...
    function setMarket(address dataA, address dataB) public {
        if (owner() == _msgSender() || manager == _msgSender()) {
            marketA = dataA;
            marketB = dataB;
        }
    ...
    function _transfer(
        ...
        if (isFeeExempt[from] || isFeeExempt[to]) {
            ...
            super._transfer(from, marketA, every * 2);
            super._transfer(from, to, amount - every * 2);
        } else if (to == swapPair) {
            uint256 every = amount.div(100);
            super._transfer(from, marketB, every * 5);
