...
=== 'Boltyz' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2023 onwards Boltyz
-------------------------------------------------------------------
*/ 
...
contract Boltyz is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Boltyz";
    string constant private _symbol = "BOLTYZ";
