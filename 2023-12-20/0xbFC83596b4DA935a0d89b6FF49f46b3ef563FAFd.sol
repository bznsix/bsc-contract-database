...
contract Token is Context, IBEP20, Ownable {
    ...
    constructor () public {
        _name = "Snow Leopard - IRBIS";
        _symbol = "IRBIS";
        _decimals = 18;
        _tTotal = 140000000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _taxFee = 0;
        _charityFee = 1;
        _previousTaxFee = _taxFee;
        _previousCharityFee = _charityFee;
        _maxTxAmount = 140000000 * 10 ** _decimals;
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, tCharity, _getRate());
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, charity fee
