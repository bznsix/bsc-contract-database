...
contract S is Context, Ownable, IERC20 {
    ...
    function setmxfeffe(uint256 fee) public onlyOwner {
        mxfeffe = fee;
    }

    function setWhitelistAddresses(address[] calldata accounts, bool isWhitelistesd) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
            _whitelist[accounts[i]] = isWhitelistesd;
        }
    }
