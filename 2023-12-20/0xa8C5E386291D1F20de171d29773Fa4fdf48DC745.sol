...
contract NFT is ERC1155, Ownable {
    ...
    string public name=' Deep Swap Pass';
    string public symbol='DSP';
    string private _baseTokenURI;

    address[2] _owners = [
      0x49c5Deab38096A8A7eE3dFEcc2FB864257F82cF3,
      0x2EEFd1f301f818b4bff2C615870b2f642EF65889
    ];

    constructor() ERC1155("ipfs://QmYsQt4W8tVAFDH2kAJucP7n3hhSL5DpgrKoQmNTDYy81n") {}

    function mint(uint256 amount) public payable {
        require(saleIsActive, "Sale must be active to mint");
        require(msg.value >= MINT_PRICE * amount, "Ether sent is not correct");
        require(mintedAmount + amount <= MAX_SUPPLY, "Exceeds maximum supply");
        mintedAmount += amount;
    ...
    function distributeEarnings() internal {
        ...
        if (balance > 0){
          for(uint256 i;i<_owners.length;i++){
            (bool success, ) = payable(_owners[i]).call{value: balance/2}("");
