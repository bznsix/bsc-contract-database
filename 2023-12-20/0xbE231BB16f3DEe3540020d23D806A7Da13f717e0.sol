/**
   TG：https://t.me/GROKGO

   X：https://twitter.com/GrokGo_BSC
...
contract GOGO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x358922a43E0D3FaEB7cb5c52E6BF8cd06c202C54); // Marketing Address
    address payable private teamWalletAddress = payable(0x358922a43E0D3FaEB7cb5c52E6BF8cd06c202C54); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000 * 3 **_decimals; 
