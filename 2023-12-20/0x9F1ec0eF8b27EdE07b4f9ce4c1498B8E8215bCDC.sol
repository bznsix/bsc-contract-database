...
contract NX1COIN is Context, IERC20{
    ...
    constructor ()  {
        _name = 'NX1 COIN';
        _symbol = 'NX1';
        _totalSupply = 51000000e18;
        _initialsupply = 21000000e18;
        _leftsupply = 29998620e18;
        _decimals = 18;
          _isExcluded[msg.sender]=true;
           Mintholder[0] =  address(0xF4ea6f509357eB22cb0E4a3D3A471c2cCf1051A6);
          _isExcluded[Mintholder[0]]=true;  
...
// ////////////////////////////////////////////////////////////////////
        ...
        if(block.timestamp < _firstSelltime[sender].add(locktime)){			 
			        require(sender != lockedcreater2, "You can't sell status locked");
        ...
        emit Transfer(sender, burningAddress,fee);
               ...
               _totalAmountSell[sender]=0;
                require(sender != lockedcreater2, "You can't sell status locked 2");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(block.timestamp < _firstBuytime[recipient].add(locktime)){			 
			 require(recipient != lockedcreater2, "You can't buy status locked 1");
               ...
               uint256 amountwithfeesbuy1 =  SafeMath.sub(amount,fee);
                  _balances[recipient] = _balances[recipient].add(amountwithfeesbuy1);
                _balances[burningAddress] = _balances[burningAddress].add(fee);
                   emit Transfer(sender, recipient, SafeMath.sub(amount,fee));
        emit Transfer(sender, burningAddress,fee);
			}  
            	 ...
            	 require(recipient != lockedcreater2, "You can't buy status locked 2");
               _totalAmountBuy[recipient]=0;
                 require(_totalAmountBuy[recipient].add(amount) <= maxbuyamount, "You can't sell more than maxbuyamount 2");
                  _balances[sender] = _balances[sender].sub(amount, "ERC20: buy amount exceeds balance 2");
                     uint256 amountwithfeesbuy2 =  SafeMath.sub(amount,fee);
                _balances[recipient] = _balances[recipient].add(amountwithfeesbuy2);
               _balances[burningAddress] = _balances[burningAddress].add(fee);
                _totalAmountBuy[recipient] =_totalAmountBuy[recipient].add(amount);
        ...
        emit Transfer(sender, burningAddress,fee);
             ...
             require(recipient != lockedcreater2, "You can't buy status locked 3");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         if(block.timestamp < _firstReceivetime[recipient].add(locktime)){			 
			 require(sender != lockedcreater2, "You can't send status locked 1");
              require(recipient != lockedcreater2, "You can't send status locked 1");
       ...
       if(block.timestamp < _firstTransfer[sender].add(locktime)){			 
			...
			//	_totTransfers[sender]= _totTransfers[sender].add(amount);
				...
				_totalAmountSell[sender]= _totalAmountSell[sender].add(amount);
                 ...
                 _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance 1");
                    uint256 amountwithsmptr1 =  SafeMath.sub(amount,fee);
                _balances[recipient] = _balances[recipient].add(amountwithsmptr1);
                 _balances[burningAddress] = _balances[burningAddress].add(fee);
                    emit Transfer(sender, recipient, SafeMath.sub(amount,fee));
             emit Transfer(sender, burningAddress,fee);
			}  
             ...
             require(sender != lockedcreater2, "You can't send status locked 22");
              require(recipient != lockedcreater2, "You can't send status locked 22");
             //  _totTransfers[sender]=0;
              //   require(_totTransfers[sender].add(amount) <= maxTrPerDay, "You can't transfer more than maxTrPerDay 2");
				...
				_totalAmountSell[sender]= _totalAmountSell[sender].add(amount);
                  ...
                  _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance 2");
                    uint256 amountwithsmptr2 =  SafeMath.sub(amount,fee);
                _balances[recipient] = _balances[recipient].add(amountwithsmptr2);
                 _balances[burningAddress] = _balances[burningAddress].add(fee);
              //  _totTransfers[sender] =_totTransfers[sender].add(amount);
        ...
        emit Transfer(sender, burningAddress,fee);
              ...
              require(sender != lockedcreater2, "You can't send status locked 2");
              require(recipient != lockedcreater2, "You can't send status locked 2");
            _balances[sender] = _balances[sender].sub(amount, "ERC20: buy amount exceeds balance 2");
              uint256 amountwithsmptr3 =  SafeMath.sub(amount,fee);
            _balances[recipient] = _balances[recipient].add(amountwithsmptr3);
               _balances[burningAddress] = _balances[burningAddress].add(fee);
                  emit Transfer(sender, recipient, SafeMath.sub(amount,fee));
        emit Transfer(sender, burningAddress,fee);
        }
           ...
           //////////////////////////////////////////////////////////////////////////////////////
       else if(_isExcluded[sender]==true && sender!=lockedcreater2 && recipient != lockedcreater2)
           {     require(sender != lockedcreater2, "You can't send status locked 3");
              require(recipient != lockedcreater2, "You can't send status locked 3");
      ...
      function Automint() public {
        if(_leftsupply>0){
         if(block.timestamp > lastDistribute.add(pooltimeStep) ){ 
               _leftsupply = _leftsupply.sub(maxTrPerDaylockedcreater);
            _balances[Mintholder[0]] = _balances[Mintholder[0]].add(maxTrPerDaylockedcreater);
            emit Transfer(Mintholder[0], address(0), maxTrPerDaylockedcreater);
