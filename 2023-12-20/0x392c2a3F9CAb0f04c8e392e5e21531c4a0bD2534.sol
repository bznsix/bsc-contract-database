...
contract GDCNFT is ERC721Enumerable, Ownable {
    ...
    function setBaseUri(string memory uri, string memory suffix) external onlyOwner {
        _baseUri = uri;
        _suffix = suffix;
    }
    ...
    function ownerBalance(uint256 tokenId) public view returns (address own, uint256 balance){
        own = ownerOf(tokenId);
        balance = balanceOf(own);
    }

    constructor() ERC721("GDC Shareholder", "GDC Shareholder"){
        //
        _suffix = "";
        _baseUri = "";
        //
        _sameUri = "https://d391b93f5f62d9c15f67142e43841acc.ipfscdn.io/ipfs/bafybeigdtrm2klo3kieoe4btqtg4hv65hbuq5rpilw2q3m4vkdppohpwci/GDC.json";
    }
}