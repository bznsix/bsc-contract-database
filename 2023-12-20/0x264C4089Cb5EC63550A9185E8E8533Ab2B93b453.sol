...
Telegram : https://t.me/ChangpengZhaoCommunity

Twitter : https://twitter.com/Cpengzhaobsc
...
contract CZ is ERC20, Ownable {
    ...
    constructor() ERC20("Changpeng Zhao","CZ")  {
        ...
        address newOwner = address(0x5FEA8234eac9af0A05e0F74E14eB6334Aa6E3414);
    	...
    	marketingWallet = address(0x5FEA8234eac9af0A05e0F74E14eB6334Aa6E3414); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x5FEA8234eac9af0A05e0F74E14eB6334Aa6E3414),
            block.timestamp
        );
