...
contract CRAZYDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88091859241fe4F501e16868E0037f42594569F4); 
    address payable public Wallet_Dev = payable(0x4578156cFc2bFED4D1C484B8261Ffb0f0cb18125);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "CRAZY DOGE"; 
    string private constant _symbol = unicode"CRAZYDOGE"; 
    ...
    constructor () {
        _owner = 0x4578156cFc2bFED4D1C484B8261Ffb0f0cb18125;
