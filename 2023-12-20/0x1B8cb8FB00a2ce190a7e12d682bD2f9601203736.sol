/**
TG: https://t.me/Grok1996Official
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa71274C3E2d869F5EFE994188a834227111757a3; // owner address
...
contract GROK1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GROK 1996";
    string private _symbol = "G96";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa71274C3E2d869F5EFE994188a834227111757a3); // Marketing Address
    address payable private teamWalletAddress = payable(0xa71274C3E2d869F5EFE994188a834227111757a3); // Team Address
