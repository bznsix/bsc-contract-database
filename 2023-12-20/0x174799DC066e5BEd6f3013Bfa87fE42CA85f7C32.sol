...
//--- Contract v3 ---//
contract StarShip2 is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xBC529D4A469fDaB5F9a0ceaB225c017C1279CD8D); // build: 0xBC529D4A469fDaB5F9a0ceaB225c017C1279CD8D
    address payable private devWallet = payable(0xf618E2549D3c36b4F8277bdc4aBED7a7Da540D21); // build: 0xf618E2549D3c36b4F8277bdc4aBED7a7Da540D21
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "StarShip2.0";
    string constant private _symbol = "STARSHIP2.0";
