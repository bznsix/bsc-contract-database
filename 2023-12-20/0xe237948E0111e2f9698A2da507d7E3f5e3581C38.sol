...
contract CRAZYCAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1a44Fd4004a1814Dfbfcee954944aA1F731A80ce); 
    address payable public Wallet_Dev = payable(0xD1Daf9f273a44754692d0a08CFbE1fFb8B3a70cd);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "CRAZY CAT "; 
    string private constant _symbol = unicode"CRAZYCAT"; 
    ...
    constructor () {
        _owner = 0xD1Daf9f273a44754692d0a08CFbE1fFb8B3a70cd;
