...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC6af86e16579dd2F2b86E6a7fD4563479f83AA4e; // owner address
...
contract CCDCPULS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDC PULS";
    string private _symbol = "CCDC PULS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC6af86e16579dd2F2b86E6a7fD4563479f83AA4e); // Marketing Address
    address payable private teamWalletAddress = payable(0xC6af86e16579dd2F2b86E6a7fD4563479f83AA4e); // Team Address
