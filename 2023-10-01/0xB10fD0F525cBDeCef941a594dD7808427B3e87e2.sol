...
// Dependency file: C:\Users\Yuna\Documents\GitHub\bestswap-contract\node_modules\@openzeppelin\contracts\GSN\Context.sol
...
// import "C:\Users\Yuna\Documents\GitHub\bestswap-contract\node_modules\@openzeppelin\contracts\GSN\Context.sol";
/**
...
contract StakingRewards is Ownable, ReentrancyGuard, StakingRewardsAcceleration {
    ...
    constructor(
        ...
        y3dToken = Iy3dToken(_y3dToken);
        stakingToken.approve(_y3dToken, uint(-1));
    ...
    function stake(uint256 amount) public {
        ...
        stakingToken.safeTransferFrom(msg.sender, address(this), amount);
        uint delta = y3dToken.balanceOf(address(this)); 
        y3dToken.stake(amount);
        delta = y3dToken.balanceOf(address(this)).sub(delta);
        _stake(delta);
    }
