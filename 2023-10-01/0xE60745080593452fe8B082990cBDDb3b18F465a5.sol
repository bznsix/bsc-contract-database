/**
The newest token, $XSIMSPON, will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power. XSIMPSON is prepared to compete our way to the top of Binance Smart Chain's charts!
...
contract XSIMPSON is Context, IERC20, Ownable {
    ...
    string private constant _name = "X SIMPSON"; // 
    string private constant _symbol = "XSIMP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x4610Ca09cFdac2593dCAa1269daBda2D96B9e1Ba;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x2E4b6707c0d5107a1DcAA6Fe590B31eaf89d901B;
