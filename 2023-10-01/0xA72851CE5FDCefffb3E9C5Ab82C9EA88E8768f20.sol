...
// telegram : https://t.me/SafemoonRebornbep20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf4a9f6eD8e5BFB1b81C7e309edC081deBF18B44c ; // owner address
...
contract SafemoonReborn  is Context, IERC20, Ownable {
    ...
    string private _name = "SafemoonReborn";
    string private _symbol = "SMR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4a9f6eD8e5BFB1b81C7e309edC081deBF18B44c); 
    address payable public teamWalletAddress = payable(0xf4a9f6eD8e5BFB1b81C7e309edC081deBF18B44c);
