...
contract WallStreetBurns is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WallstreetBurns";
    string private _symbol = "WSBS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCfff92725970278A22A43764e3c608Bd43599CDB); // Marketing Address
    address payable private teamWalletAddress = payable(0xCfff92725970278A22A43764e3c608Bd43599CDB); // Team Address
