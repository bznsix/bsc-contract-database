/*
Bincentive network  developing technology that reduces the gaps between traditional and decentralized finance.Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

🟠Bincentive Network:
🟠Staking
🟠App :  https://play.google.com/store/apps/details?id=com.bcn.bcn_android
🟠NFT Marketplace
🟠Blockchain
🟠Marketing = 1
🟠Buy/Sell Tax =1

Website : www.bincentivenetwork.org
TG: https://t.me/bincentivenetwork
*/
...
contract BincentiveNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bincentive Network";
    string private constant _symbol = "Bincentive";
