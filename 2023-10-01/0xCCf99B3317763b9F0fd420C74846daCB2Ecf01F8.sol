...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22Eae131A4E30368D74459AF80141b7cF057457d; // owner address
...
contract WALLSTREETSHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WALLSTREETSHIBA";
    string private _symbol = "WSS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x22Eae131A4E30368D74459AF80141b7cF057457d); // Marketing Address
    address payable private teamWalletAddress = payable(0x22Eae131A4E30368D74459AF80141b7cF057457d); // Team Address
    ...
    uint256 public _walletMax = 40000 * 10**_decimals;
