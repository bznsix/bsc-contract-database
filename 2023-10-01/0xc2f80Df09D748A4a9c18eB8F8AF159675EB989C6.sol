...
/**
   ...
   Welcome to JOYFULLEVERET
   
   This is a community token. If you want to create a telegram I suggest to name it to @JOYFULLEVERETBSC
   ...
   I will renounce the ownership to burn addresses to transfer #JOYFULLEVERET to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #JOYFULLEVERET 10000X? 
   ...
   it's the best part of the #JOYFULLEVERET idea, increasing the liquidity pool automatically, 
...
contract JOYFULLEVERET is Context, IERC20, Ownable {
    ...
    string private _name = "JOYFUL LEVERET";
    string private _symbol = "JL";
