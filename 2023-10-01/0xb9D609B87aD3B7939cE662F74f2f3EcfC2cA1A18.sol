/*   StakingBNB - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original StakingBNB team! All other platforms with the same contract code are FAKE!
 *
 *   ────────────────────────────┐
 *   │   Website: https://stakingbnb.com                   │
 *   │   E-mail: admin@stakingbnb.com                     │
 *   └───────────────────────────
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect any supported wallet
 *   2) Choose one of the tariff plans, enter the BNB amount (0.1 BNB minimum) using our website "Stake" button
 ...
 *   - Total income: based on your tarrif plan (from 3% to 9% daily) 
...
contract StakingBNB {
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(15, 30));
        plans.push(Plan(10, 50));
        plans.push(Plan(5, 80));
        plans.push(Plan(5, 90));
	}
