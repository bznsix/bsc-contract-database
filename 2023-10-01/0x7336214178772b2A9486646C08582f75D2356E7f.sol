...
/*
   ...
   Welcome to LITTLESNOOPDOGE
   
   This is a community token. If you want to create a telegram I suggest to name it to @LITTLESNOOPDOGEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LITTLESNOOPDOGE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LITTLESNOOPDOGE 10000X? 
   ...
   it's the best part of the #LITTLESNOOPDOGE idea, increasing the liquidity pool automatically, 
...
contract LITTLESNOOPDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "LITTLESNOOPDOGE";
    string private _symbol = "LSTD";
