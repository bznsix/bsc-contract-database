...
contract TokenDeposit is ReentrancyGuard {
    ...
    uint256 public minPurchaseAmount = 10 ** 18; // You can set the initial value as per your requirement
    ...
    function buyCERT(
        ...
        // Calculate the amount of Token A needed to buy the specified certAmount of CERT tokens
        // Multiply by 100 to adjust for the 2 decimal places in buyPrices
        uint256 amount = (certAmount * 100) / buyPrices[tokenAddress]; // amount of Token A needed
        ...
        require(
            certToken.transferFrom(certWallet, msg.sender, certAmount),
    ...
    function buyCERTwithBNB(uint256 certAmount) external payable nonReentrant {
        ...
        uint256 amount = (certAmount * 100) / buyPrices[BNB_ADDRESS]; // amount of BNB needed in wei
    ...
    function calculateCertPrice(
        ...
        // Multiply by 100 to adjust for the 2 decimal places in buyPrices
        uint256 equivalentAmount = (certAmount * 100) / buyPrices[tokenAddress];
