...
contract ElonCATTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public akkdnf19;
    ...
    string private _tokenname = "Elon Cat";
    string private _tokensymbol = "ElonCAT";
