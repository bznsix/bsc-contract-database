...
contract OCTOBEAST is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAE1F460b966BEF32B9C416E910907C90EE30c4F6); 
    address payable public Wallet_Dev = payable(0xAE1F460b966BEF32B9C416E910907C90EE30c4F6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "OCTO BEAST"; 
    string private constant _symbol = unicode"$OCTOBEAST"; 
    ...
    constructor () {
        _owner =0xAE1F460b966BEF32B9C416E910907C90EE30c4F6;
