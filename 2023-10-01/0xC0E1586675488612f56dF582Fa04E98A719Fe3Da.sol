...
contract DontBeAfraidToFail is ERC20, Ownable {
    ...
    constructor() ERC20("Don't Be Afraid To Fail", "DBATF") {
        ...
        maxWallet = 3_000_000_000 * 1e18; // 3% 
        ...
        marketingWallet = address(0xf619b11b43f2F23De944Dd0d606535A9bA5FA729); // set as marketing wallet
        devWallet = address(0xf619b11b43f2F23De944Dd0d606535A9bA5FA729); // set as dev wallet
