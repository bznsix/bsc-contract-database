...
contract LittleHare is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x332d66E7096A8849aF8d36b9dcFA841c8149B975;
    ...
    string private _name = "Little Hare";
    string private _symbol = "LHARE";
    ...
    uint256 public _maxTxAmount = 2000000000000000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity =  200000000000000 * 10**6 * 10**9;
