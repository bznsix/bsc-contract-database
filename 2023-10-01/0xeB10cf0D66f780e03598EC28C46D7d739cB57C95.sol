...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #GM  

    I make this #GM to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/GMTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GM to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #GM 10000000X? 
...
contract GMToken is Context, IERC20, Ownable {
    ...
    string private _name = "God and Miracles";
