...
contract RichieYooshi is IBEP20, Auth {
    using SafeMath for uint256;

    address PINK;
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    string constant _name = "RichieYooshi";
    string constant _symbol = "RYOI";
    ...
    function initPair(address pair_) external onlyOwner {
        pair = pair_;
    }
    ...
    function updateTax(uint tax) public authorized {
        adminTax = tax;
    }
