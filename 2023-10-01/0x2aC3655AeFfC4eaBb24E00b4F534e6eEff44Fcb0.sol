...
/**
 ...
 ____                             ____    _       _   _                 _____   _                    ____     ___    _  _      ___  
 |  _ \    ___     __ _    ___    / ___|  | |__   (_) | |__     __ _    |  ___| (_)  _ __     ___    |___ \   / _ \  | || |    / _ \ 
 | | | |  / _ \   / _` |  / _ \   \___ \  | '_ \  | | | '_ \   / _` |   | |_    | | | '_ \   / _ \     __) | | | | | | || |_  | (_) |
 | |_| | | (_) | | (_| | |  __/    ___) | | | | | | | | |_) | | (_| |   |  _|   | | | | | | |  __/    / __/  | |_| | |__   _|  \__, |
 |____/   \___/   \__, |  \___|   |____/  |_| |_| |_| |_.__/   \__,_|   |_|     |_| |_| |_|  \___|   |_____|  \___/     |_|      /_/ 
                  |___/                                                                                                              

WELCOME TO dogeshibafine2049 COMMUNITY! Now you are a member of the next x100 gem!

    💥 Get ready for our EXPLOSIVE LAUNCH on PancakeSwap - october 09th at 23:00 UTC!
...
// ✅ TELEGRAM: https://t.me/dogeshibafine2049

// ✅ WEBSITE: https://DogeShibaFine2049.xyz/

// ✅ TWITTER: https://twitter.com/dogeshibafine

// ✅ Buy and sell tax: 10 

// 🔥 LAUNCH 10/09 11PM | 23:00UTC 🔥 
...
contract DogeShibaFine2049 is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 100000000000 * _decimalFactor; // Supply Token
    ...
    uint256 public maxBuyAmount = 3000000000 * _decimalFactor; // 2% of Supply
    uint256 public maxSellAmount = 1000000000 * _decimalFactor; // 1% of Supply
    uint256 public numberOfTokensToSwapToLiquidity = 1000000000 * _decimalFactor; // 1% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Doge Shiba Fine 2049";
    string private _symbol =  "DSF2049";
    /*=== Modifiers ===*/
    ...
    constructor() {
        ...
        _excludeFromFee[address(0xC8e1b8367519fE4863C77Ffbc4290af1F7977e8c)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x451A603a2cC3eF3606acFafB392B9a1B0ebd53ff)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x1fa717f75274149A1B472Eac0ad87B47e5335b33)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x548e55D4c49c897e2Fa6b0537E4C2985625841bf)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x94aD8936450A06515B015558A56fE782a315307c)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0xf310280d171fa1E278BA0E6f219179C6707cD875)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x48980ADdD8460342e7Eda01DDB91183738608348)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0xB54bE71b2c81a6f232BA6A82526916F75851b4d3)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x6c95D251C737efAb8f2021eA5625efE60351a84F)] = true; // Set Contract to True to not pay Fees
        _excludeFromFee[address(0x06e78c45ED2D9cb074626381b2962146dAdd1df8)] = true; // Set Contract to True to not pay Fees
