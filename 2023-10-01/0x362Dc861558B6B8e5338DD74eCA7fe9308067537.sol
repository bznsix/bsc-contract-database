/**
   ...
   Welcome to ShibaSaur
   
   This is a community token. If you want to create a telegram I suggest to name it to @ShibaSaurBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaSaur to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ShibaSaur 10000X? 
   ...
   it's the best part of the #ShibaSaur idea, increasing the liquidity pool automatically, 
...
interface IUniswapV2Router01 {
    ...
    function swapTokensactETH(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapExactTokensForETH(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapETHactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);
...
contract ShibaSaur is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaSaur";
