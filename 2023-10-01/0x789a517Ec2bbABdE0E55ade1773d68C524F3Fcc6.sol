...
contract HLRTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public llasnf31;
    ...
    string private _tokenname = "Highlander";
    string private _tokensymbol = "HLR";
