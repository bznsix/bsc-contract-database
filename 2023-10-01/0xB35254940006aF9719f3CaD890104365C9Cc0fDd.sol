...
contract BabypepeTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eajjnd4;
    ...
    string private _tokenname = "Babypepe";
    string private _tokensymbol = "Babypepe";
