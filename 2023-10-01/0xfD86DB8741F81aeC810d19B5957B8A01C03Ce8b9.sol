...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaB126EE4b1776e2EaA0D86131Eec2deC766E2aF0;
...
contract BNBOctober is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xaB126EE4b1776e2EaA0D86131Eec2deC766E2aF0);
    ...
    */
    ...
    string private _name = "BNBOctober"; 
    string private _symbol = "BNBOctober";  
    ...
    uint256 private maxPossibleFee = 98; 


    // Setting the initial fees
    uint256 private _TotalFee = 198;
    ...
    */
    ...
    // Max wallet holding (0.7% at launch)
    uint256 public _maxWalletToken = _tTotal.mul(7).div(1000);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (0.7% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(7).div(1000); 
