...
contract HSRToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HSR";
    string private constant _symbol = unicode"HSR";
