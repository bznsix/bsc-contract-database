...
// telegram : https://t.me/devisbased
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7B1bab98D0563D5486f486A723933B1d3284818 ; // owner address
...
contract DevIsBased  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevIsBased";
    string private _symbol = "BASED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7B1bab98D0563D5486f486A723933B1d3284818); 
    address payable public teamWalletAddress = payable(0xa7B1bab98D0563D5486f486A723933B1d3284818);
