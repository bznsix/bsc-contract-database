/**
Original Bart Simpson• $OBS
Original Bart Simpson is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens
...
TG: https://t.me/originalbartsimpson
*/
...
contract OBS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ORIGINAL BART SIMPSON"; // 
    string private constant _symbol = "OBS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x826D550d80192eadf678370B3cD1E7E0e68f5D0E;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x00ABD557F00e680c0D29eC108A44c4B17D2d9308;
