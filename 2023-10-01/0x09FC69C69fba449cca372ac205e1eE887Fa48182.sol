...
contract oxbnbBusd is ReentrancyGuard{
    ...
    address private dev2 = 0x46acb91cC860ffd0b074DA8e577E899fB5b4FE21;
    address private dev = 0x46acb91cC860ffd0b074DA8e577E899fB5b4FE21;
...
for (uint i=0; i<arrayLength2; i++) {
  ...
  if (participants[i]==ad){
    ...
    function pickwinner() internal {
        ...
        uint256 dianoBusdFee = SafeMath.div(SafeMath.mul(contractBalance,0),100);
        uint256 devFee = SafeMath.div(SafeMath.mul(contractBalance,10),100);
      
        BusdInterface.transfer(dev2,dianoBusdFee);
