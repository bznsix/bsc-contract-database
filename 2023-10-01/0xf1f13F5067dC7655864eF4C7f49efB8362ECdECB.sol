...
//Official telegram: https://t.me/OctoBeastX
//Official twitter: https://twitter.com/OctoBeastX

//The $OCTOBEAST is an enigmatic creature, shrouded in mystery and surrounded by tales of awe and wonder. 
//With its eight sinuous arms and eyes that gleam like radiant jewels, 
//it is a sight to behold. Its iridescent skin reflects the colors of the deep, from the deepest blues to the most vibrant greens.               
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7B5ea3Dd702557E382d9C1516C6136bd4705C36;
...
contract OctoberBeast is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150000000000 * 10**9;
    uint256 public _maxTxAmount = 100000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT =  100* 10**9; //
    string private constant _name = "October Beast"; // 
    string private constant _symbol = "$OCTOBEAST"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xb7B5ea3Dd702557E382d9C1516C6136bd4705C36);
