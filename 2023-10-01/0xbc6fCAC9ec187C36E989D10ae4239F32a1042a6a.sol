...
contract PEPECALTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public shhdnf17;
    ...
    string private _tokenname = "PEPECAL";
    string private _tokensymbol = "PEPECAL";
