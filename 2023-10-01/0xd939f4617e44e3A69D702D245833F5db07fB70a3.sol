...
contract SimbaCoin is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 10 / 2000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal * 5 / 100;
    uint256 public maxWalletAmount = _tTotal * 5 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3383B688520E7ad92AA0EA20C0719ebD0D6e49B9; //

    string private constant _name = "SIMBA COIN"; //
    ...
    Taxes public taxes = Taxes(3,5,2,0); //
