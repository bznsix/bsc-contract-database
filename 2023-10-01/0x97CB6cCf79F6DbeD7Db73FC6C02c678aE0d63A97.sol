...
contract PigCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x7281E54F5c496d454718d8CFa3EfC970016144E7); 

    address payable public teamAddress =
        payable(0xCac2405321aB8c91A62d549e846Edd3470A6C7C3); 

    address payable public liquidityAddress =
        payable(0x2a6DF8DC90394bB1C811a6242A35D9e383C4fA9d); 
    ...
    string private constant _name = "PigCoin";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 20 / 1000; // 1% maxWalletToken
    ...
    function enableTrading(bool _status,uint256 _deadBlocks) external onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 300 hours;
    ...
    function excludeFromWalletAmount(address updAds, bool isEx) public authorized {
    ...
    function removeBoughtEarly(address account) external authorized {
