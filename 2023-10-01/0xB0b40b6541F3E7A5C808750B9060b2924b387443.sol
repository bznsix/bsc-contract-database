...
Welcome to HYDRA FOXE’S,$HYDRA is meme coin running on bsc network.

$HYDRA
♣️🦊 No presale
🦊♣️ No team tokens
♣️🦊 Marketing On Big Platforms
🦊♣️ Safe Dev And TeaM
**/
...
contract HYDRAFOXES is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HYDRA FOXE'S";
    string private constant _symbol = unicode"$HYDRA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 68000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xaFCd0cA5E683Dd2D57dCEf22f5704C17F0540F9A);
    address payable public MarketingWallet = payable(0x603bD538Fa5cD146a2C8Ab48539a670885bd71fD);
