...
contract TOYO is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    address public reservewallet = 0x713ad39E9f2588E0A539708A6DE0d77A390CEDDB;
    address public teamwallet = 0x69e3DAF9C3e1B28f63DC277f07520850b7f39B88;
    address public marketingwallet = 0x713ad39E9f2588E0A539708A6DE0d77A390CEDDB;
    address public reinvestwallet = 0x713ad39E9f2588E0A539708A6DE0d77A390CEDDB;
    ...
    function getRewardCycleBlock() public view returns (uint256) {
     ...
     function redeemRewards(uint256 perc) isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own TOYO to claim reward');
