...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).balanceOf(address(this)) >= ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).transfer(msg.sender, ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) public {
		...
		require((ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).balanceOf(address(this)) >= ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).transfer(msg.sender, ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
...
*/
	function principalTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).balanceOf(address(this)) >= principalAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((principalAmtInBank > uint256(0))){
			ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).transfer(msg.sender, principalAmtInBank);
		}
...
*/
	function interestTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).balanceOf(address(this)) >= interestAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((interestAmtInBank > uint256(0))){
			ERC20(address(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B)).transfer(msg.sender, interestAmtInBank);
		}
...
*/
    ...
    function withdraw_coin_FIL(uint256 _amount) public onlyOwner {
		require((ERC20(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B).balanceOf(address(this)) >= _amount), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x3942e013d9497aFCfC6D8EA6dBF4Aa1C0E2b404B).transfer(msg.sender, _amount);
	}
}