...
contract PEVE is Context, IERC20, Ownable {
    ...
    string private _name = "PEVE";
    string private _symbol = "PEVE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xd1823C4A50DC2c484088015cee08eEA75a62f925); // Marketing Address
    address payable public teamWalletAddress = payable(0xd1823C4A50DC2c484088015cee08eEA75a62f925); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 100000 * 5 **_decimals; 
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xd1823C4A50DC2c484088015cee08eEA75a62f925),
            block.timestamp
        );
    }
