...
contract CDAOTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public fjjkxs34;
    ...
    string private _tokenname = "Cyber-DAO";
    string private _tokensymbol = "C-DAO";
