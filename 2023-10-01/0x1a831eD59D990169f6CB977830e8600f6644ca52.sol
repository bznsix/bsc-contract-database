...
// File contracts/PepeDaddyToken.sol
...
contract PepeDaddyToken is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("PepeDaddy", "PEPEDADDY") {
    ...
    function setRule(bool _limited, address _swapPair, uint256 _maxHoldingAmount, uint256 _minHoldingAmount) external onlyOwner {
        limited = _limited;
        swapPair = _swapPair;
