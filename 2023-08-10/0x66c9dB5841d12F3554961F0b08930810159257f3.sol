...
contract BIBIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIBIS";
    string private _symbol = "BIBIS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x599332578a9a189A33Dfce24ADEbbe12b5BE39C1);
    address payable public teamWalletAddress = payable(0x599332578a9a189A33Dfce24ADEbbe12b5BE39C1);
    address public immutable deadAddress = 0x599332578a9a189A33Dfce24ADEbbe12b5BE39C1;
