...
contract Token is IERC20, DeployVersion, Ownable {
    ...
    */
    function cnyg(address account) public view returns (uint256) {
        return _fed[account];
    }
