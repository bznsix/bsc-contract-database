...
/**
 * @title DOGEMOON ERC20 token
 * @dev  
 *      The goal of DOGEMOON is to Go Up Higher in price over time.
 *      Based on the Ampleforth protocol.
 */
contract DOGEMOON is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("DogeMoon", "DogeMoon", uint8(DECIMALS))
        public
    {
