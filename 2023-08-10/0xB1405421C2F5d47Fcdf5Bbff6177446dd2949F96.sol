...
contract Ferb is IERC20, Release, Ownable {
    using SafeMath for uint256;


    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => uint256) private _phi;
    ...
    */
    function perr(address account) public view returns (uint256) {
        return _phi[account];
    }
