...
contract BSC420 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    address private fundAddress = 0x429749cB74C2696E67e0Cf44e618d8C58552f178;
...
//            require(numberOfTokens +  walletMintCount[_msgSender()] <= maxMintAmountPerWallet, "Max mints per wallet met");
    ...
    // "https://api.bsc420.net/v1/nfts/bsc420-bluebox/" as init param
    constructor(string memory _url) ERC721A("BSC-420", "BSC-420", 100, maxSupply) {
        baseURI = _url;
    }
    ...
    {
//        require(walletMintCount[_msgSender()] < maxMintAmountPerWallet, 'Max mints per wallet met');
    ...
    function setFundAddress(address f) external onlyOwner {
        fundAddress = f;
    }
