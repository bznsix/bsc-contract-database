...
contract PIZA is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xD92e2d5be8962e09CBC0ACA0c1e38B5266a146D4;

    string private constant _name = "$PIZA";
    string private constant _symbol = "$PIZA";
