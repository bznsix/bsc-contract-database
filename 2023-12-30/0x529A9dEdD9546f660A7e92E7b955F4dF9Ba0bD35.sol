...
contract GROKMEW is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 111 *10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e11 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x90e6eD5949aE1D8D596028061a706446C3EC2fD5;

    string private constant _name = "GROKMEW";
    string private constant _symbol = "GMEW";
