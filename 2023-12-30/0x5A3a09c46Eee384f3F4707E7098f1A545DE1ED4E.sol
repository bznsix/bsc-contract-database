...
contract $HOB is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xd9ed5A0891f96b325216E3BF6551718DB6B77F6d);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0x82C24BDc879372181D9953B74D1E0678098860DF;
    ...
    string private _name = "Hobby Bobby";
    string private _symbol = "$HOB";
