...
contract SERH is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingwallet = payable(0xFa3Ca6b3a984087AF0a78ce4d3824b23bee3aB55);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
   
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**16;
    ...
    constructor () BEP20Detailed("Seraphim", "SERH", 16) {
      _owner = msg.sender ;
    _totalSupply = 1000000000000 * (10**16);
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(takeFee)
        {
            uint256 TotalSent = amount.sub((taxAmount+burnAmount));
    ...
    {
        return marketingFee.add(burnFee);
    }
