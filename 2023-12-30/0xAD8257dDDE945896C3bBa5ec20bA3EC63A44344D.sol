...
contract TwentyTwentyFourToken is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("2024 Memecoin", "2024") {
    ...
    function setRule(bool _limited, address _pancakeswapV2Pair, uint256 _maxHoldingAmount, uint256 _minHoldingAmount) external onlyOwner {
        limited = _limited;
