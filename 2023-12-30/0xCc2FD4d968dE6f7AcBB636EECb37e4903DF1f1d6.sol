...
abstract contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownable: New owner is the dead address.");
        _setOwner(newOwner);
    }
...
contract Grok2024 is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 250000000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x64868D0292672cCBFa0AAb5b1BEd8f4FC6575C05;
    address private opsWallet = 0xcC8c2e74B517B60a74fAe62FCAf81B368F26FbD1;
    address private devWallet = 0xcC8c2e74B517B60a74fAe62FCAf81B368F26FbD1;

    string private constant _name = "Grok 2024";
    string private constant _symbol = unicode"Grok 2️⃣0️⃣2️⃣4️⃣";
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0x64868D0292672cCBFa0AAb5b1BEd8f4FC6575C05] = true;
