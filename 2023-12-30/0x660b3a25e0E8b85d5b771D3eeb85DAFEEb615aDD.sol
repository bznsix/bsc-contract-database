// telegram https://t.me/LADYGROKPORTAL
...
contract LadyGROK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "LadyGrok";
    string private constant _symbol = unicode"$LGROK";
    ...
    address payable public DevWallet = payable(0xD17a8DD4F53B4B328dA23F4b1Be29BF279e51138);
    address payable public MarketingWallet = payable(0x55Ae328bEdB49c41D47523ADa187bDbA47Ddcbf5);
