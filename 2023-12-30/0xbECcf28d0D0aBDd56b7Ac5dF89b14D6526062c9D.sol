...
// Telegram: https://t.me/FlokiPokemon
...
contract FlokiPokemon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Floki Pokemon";
    string private constant _symbol = unicode"$FLOMON";
