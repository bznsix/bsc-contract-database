/*
Binance Grok $BNBGRK is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

Binance Grok Ecosystem:
🤖Renounce Contract 
🤖Lp Lock
🤖Staking
🤖Web3 Wallet
...
contract BinanceGrok is Context, IERC20, Ownable {
    ...
    string private constant _name = "Binance Grok";
    string private constant _symbol = "BNGRK";
