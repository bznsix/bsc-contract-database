...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    bool public isOpenTrading = true;
    ...
    address public D = 0x376306688D581F9B1dd036dFC6D11E86bBC9d236;  // deployer address
    address public T = 0x69929E45BD50F3AebaE800d2273E0510845908bc;  // team address
    address public P = 0x4F124F6F32cA3F8C36181Ac775547CAb92e9dF3b;  // partner address
    address public C = 0x397f84AF824Af362DF66dd18EB16C7d1C266aeA0;  // consultant address
    address public AD = 0x5597b699666B7d9BC2A15B9f2bdE63f85b0d4a14;  // airdrop address
    address public A = 0x5d170A70F8344b351AB781Da19699beb9c2795FF;  // transition address
    address public M = 0xab66d6473860961Ba2203d33A13715835029a5f5;  // market address
    ...
    function checklock() internal {
        ...
        if(
            ...
            (
                ...
                block.timestamp.sub(deployTime) >= 15    // 86400 * 30 * 12 * 5  Automatically unlock after 5 years
            )
        )
        {
            isLocked = false;
...
contract DODToken is BEP20Detailed {
    ...
    constructor() BEP20Detailed("DODV2", "DODV2", 18) public {
