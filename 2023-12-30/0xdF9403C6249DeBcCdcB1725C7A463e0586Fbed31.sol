// LINKS:
//  Telegram: https://t.me/ShikokuGrokBsc
//  X/Twitter: https://twitter.com/shikokugrok 
...
contract ShikokuGrok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Shikoku Grok";
    string private _symbol = unicode"SHIKOKU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x63d2A9443251B3f86F5B66BC79f569430EB34686);
    address payable private taxWallet2 = payable(0x63d2A9443251B3f86F5B66BC79f569430EB34686);
