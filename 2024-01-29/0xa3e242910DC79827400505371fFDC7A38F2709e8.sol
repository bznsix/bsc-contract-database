...
contract Burn is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0xA877801da389b5a5014717bDaeE2456250af2142);
    address payable public immutable marketingWallet = payable(0x9dc99A23F08FF90Ea1803B159E226776f465388C);
    address payable public immutable devWallet = payable(0xe52C984DF470EBb25Ac88CA61c05C1B540B78581);
    ...
    constructor() ERC20(" burn0.5", "burn0.5") {
