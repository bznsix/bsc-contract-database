...
contract BabyTrump is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000 * 10**_decimals;  //300 000 000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = _tTotal / 5_000;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = address(0xB9f1BCfee1E2f74626f2E3B95c0581806fBbA439);
