...
contract AONEStaking {
    ...
    /** After the lock-in period ends, the user can unstake their tokens, and any outstanding rewards will also be withdrawn */
    ...
    /** The function to harvest rewards in realtime */
    ...
    // Function to retrieve the tierId based on the specified amount.
    ...
    /** This function, exclusively callable by the owner's address, is utilized to modify the staking duration (lock-in period), with the input parameter specified in seconds. */
    ...
    /** This method is used to withdraw base currency */
