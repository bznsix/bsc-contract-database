...
contract SPONGEV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sponge V2 ";
    string private _symbol = "SPONGEV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0662fDFa9F955590ae34C7Ec696a3baFcAc10E2d); // Marketing Address
    address payable public teamWalletAddress = payable(0x0662fDFa9F955590ae34C7Ec696a3baFcAc10E2d); // Team Address
