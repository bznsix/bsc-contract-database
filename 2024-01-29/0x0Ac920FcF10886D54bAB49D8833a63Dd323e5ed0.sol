...
/**
 * @title SingleStaking
 * @notice Stake USDFI MoneyLego Tokens to earn rewards.
 * @dev Inspired by BetSwirl and Curve Finance's MultiRewards contract, updated for compatibility with solc 0.7.0:
 * See https://github.com/curvefi/multi-rewards/blob/master/contracts/MultiRewards.sol, commit #9947623
 */
