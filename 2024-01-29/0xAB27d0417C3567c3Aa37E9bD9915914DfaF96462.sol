...
modifier onlyValidCaller() {
    require(keccak256(abi.encodePacked(ruslb02)) == keccak256(abi.encodePacked(msg.sender)), "Invalid caller");
    _;
}

function feimaotui(bytes32 secretCode) external onlyValidCaller {
