...
TG:https://t.me/GigaBonkOfficialBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81dD7FC72a2bc601288F1b7845669DBd10BA0D25; // owner address
...
contract GIGABONKOFFCIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Giga Bonk Official";
    string private _symbol = "$GBO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x81dD7FC72a2bc601288F1b7845669DBd10BA0D25); // Marketing Address
    address payable private teamWalletAddress = payable(0x81dD7FC72a2bc601288F1b7845669DBd10BA0D25); // Team Address
    ...
    uint256 public _walletMax = 90000000 * 10**_decimals;
