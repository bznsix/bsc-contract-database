...
contract LaFi is ERC20, Ownable {
    ...
    address public constant RUNE = 0x256B47D750B5dc9aA8d71545973B5f9c1688d0b1;

    uint256 public numTokensSellToSwap = 210000000 * 1e18;
    ...
    function _transfer(
        ...
        if (from != uniswapV2Pair
            && lastDeflationTime != 0
            && block.timestamp - lastDeflationTime >= 1 days) {
            uint deflationAmount = balanceOf(uniswapV2Pair) * deflationFee / 100;
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        IERC20(WETH).transferFrom(address(tokenReceiver), address(this), newBalance);
    }
