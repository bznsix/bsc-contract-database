...
contract TouTiaoToken is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 21000000 * (10 ** _decimals);
   

    uint256 constant public swapThreshold = 10 * (10 ** _decimals);
    uint256 constant public buyfee = 4;
    uint256 constant public sellfee = 4;
    ...
    address payable private devWallet = payable(0x06c52f38f9F952911279178E9551Bc803F3e0322); 
    ...
    function changeWallets(address _newMarketwallet, address newDev) external onlyOwner { marketingAddress = payable(_newMarketwallet); devWallet = payable(newDev); }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns  (bool) {
        ...
        balance[from] -= amount; uint256 amountAfterFee = (takeFee) ? takeTaxes(from, IsBuy(from, to), IsSell(from, to), amount) : amount;
