...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("HNY", "HNY") {
        // 线上
        address mainCol = 0x187752ab2055b5cDc1759c2b8898C9A1dD62205b;
        _mint(mainCol, 50000000 * 1e18);
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address uAddr = 0x55d398326f99059fF775485246999027B3197955;
        
        fundWallet = 0x187752ab2055b5cDc1759c2b8898C9A1dD62205b;
    ...
    function setFundRate(uint256 _rate) public onlyOwner{
        fundRate = _rate;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (from == address(uniswapV2Pair) && to == _router){
                ...
                uint256 fundFee = amount.mul(fundRate).div(1000);
