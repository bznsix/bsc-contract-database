...
Telegram: https://t.me/magacoinbsc
*/
...
contract maga is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x8acACFbF38073810168c489cb821cB9b9a1b6F29);
    address payable public Wallet_Dev =
        payable(0x8dEE8307881F3a5fCE68919d51E547e9d2F08FaC);
    address payable public constant Wallet_Burn =
        payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 2024000000000 * 10**9;
    string private constant _name = "trump2024";
    ...
    constructor() {
        _owner = 0x8dEE8307881F3a5fCE68919d51E547e9d2F08FaC;
