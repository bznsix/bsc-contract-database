...
Website        https://babyjupiters.tech
X ( Twitter )  https://twitter.com/BabyjupiterBSC
Telegram       https://t.me/BabyJupiters
...
contract BABYJUPITER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY JUPITER";
    string private _symbol = "BJUP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE7A2c8393CE608330Bd9AC66BCf2E4aec907531A);
    address payable private DevelopmentWalletAddress = payable(0xE7A2c8393CE608330Bd9AC66BCf2E4aec907531A);
    ...
    uint256 public _walletMax = 30000000000 * 10**9;
