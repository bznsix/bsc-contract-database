...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B7b2eC15b863288E0b567dA49e93A1860224E24; // owner address
...
contract $KORRA is Context, IERC20, Ownable {
    ...
    string private _name = "$KORRA ";
    string private _symbol = " $KORRABNB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B7b2eC15b863288E0b567dA49e93A1860224E24); 
    address payable public teamWalletAddress = payable(0x1B7b2eC15b863288E0b567dA49e93A1860224E24);
