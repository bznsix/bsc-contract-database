...
//--- Contract v3 ---//
contract HONKCEO is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 444_444_444_444 * 10**8;
    ...
    address payable private marketingAddress = payable(0xd1aD8C8d4a7a48856EBB0Aa7136d5A171FEE4886); // build: 0xd1aD8C8d4a7a48856EBB0Aa7136d5A171FEE4886


    AntiBot private AX;
    bool public isContract = false;
    IRouter02 public swapRouter;
    string constant private _name = "Honk CEO";
    string constant private _symbol = "HONKCEO";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x91bDD18C288e8436007E66b669f119De5a7E3Bc8);
