...
contract OdinBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OdinBsc";
    string private _symbol = "ODIN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4436A3b3Ae3086ce536c03d6dcBb13482c148e9f); // Marketing Address
    address payable public teamWalletAddress = payable(0x55440F163ee5214162AbCdF8398F4b2948A56b06); // Team Address
