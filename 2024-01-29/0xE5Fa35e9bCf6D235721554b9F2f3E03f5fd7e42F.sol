...
contract BABYBEBE is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x2177cC172A7775f57F63Fb158fa6214B47874A56);
    address payable private _twdmkt = payable(0x2177cC172A7775f57F63Fb158fa6214B47874A56);
    
    string private constant _name = "BABYBEBE";
    string private constant _symbol = "$lilBEBE";
