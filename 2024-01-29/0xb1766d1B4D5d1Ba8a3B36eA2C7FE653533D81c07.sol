...
contract Baby_GrokFi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby GrokFi";
    string private _symbol = "GkFi";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0634bFA8f29BB577fD2341C5cd888F48053c350B);
    address payable private DevelopmentWalletAddress = payable(0xe4581c85A9F39Be967f0720bF87A6e334C92d1BB);
