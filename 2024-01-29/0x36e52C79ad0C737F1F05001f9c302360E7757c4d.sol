...
contract BaByX is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby X";
    string private _symbol   = "BaByX";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 254_000_000_000_000_000 * (10 ** _decimals);
    ...
    address public marketingWallet = 0x517397476303088B84945BF3bCf69ff29Bc73fcc; 
    ...
    {        
        ...
        marketingWallet = 0x517397476303088B84945BF3bCf69ff29Bc73fcc;
...
_isExcluded[address(0x517397476303088B84945BF3bCf69ff29Bc73fcc)] = true; 
...
_isExcluded[address(uniswapV2Pair)] = true;
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner {
        ...
        require(_marketingWallet!=address(0x517397476303088B84945BF3bCf69ff29Bc73fcc), "Marketing wallet is the dev address");
