...
contract Octopus_Finance is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"Octopus Finance", unicode"$OCP") 
    {
        address supplyRecipient = 0x8e415de82592A9c1C6E5EeE8AC48F9fa7Ce3F5F6;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x1AfBe56996EB79A5729b89a608AA1B23b760fF01);
        marketingFeesSetup(1000, 1000, 500);
        ...
        updateMaxWalletAmount(210000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 10000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x8e415de82592A9c1C6E5EeE8AC48F9fa7Ce3F5F6);
    }
