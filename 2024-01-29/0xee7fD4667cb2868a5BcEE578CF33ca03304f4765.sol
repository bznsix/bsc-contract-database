...
contract UVMiniTakeProfit is Ownable, AccessControl {
    ...
    address public PANCAKE_ROUTER_ADDRESS =
        0x10ED43C718714eb63d5aA57B78B54704E256024E; // check

    IPancakeRouter02 public pancakeRouter;
    address public fundWallet = 0x13F63b75A8E9775F68e12c64BB7bF2f7c6154495; // check
    ...
    function initialize(address _poolToken) external onlyOwner {
        pancakeRouter = IPancakeRouter02(PANCAKE_ROUTER_ADDRESS);
    ...
    function swapToken(
        ...
        TransferHelper.safeApprove(_path[0], PANCAKE_ROUTER_ADDRESS, _amountIn);
    ...
    function setSwapRouter(address _swapRouter) public onlyRole(MANAGER_ROLE) {
        PANCAKE_ROUTER_ADDRESS = _swapRouter;
        pancakeRouter = IPancakeRouter02(_swapRouter);
    }
}
// SPDX-License-Identifier: MIT
