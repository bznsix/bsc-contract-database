...
contract MYRADOGE is IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private  excludeFee;

    string private _name = "MYRA DOGE";
    string private _symbol = "MYRA";
    ...
    constructor() {    
        ...
        feeWallet = 0x2CB04514e735F0A6972beCC38626D0d31D902ff5;   //Fill your wallet receive fee
