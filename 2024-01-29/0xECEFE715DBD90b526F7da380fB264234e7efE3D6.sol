...
contract Holesky is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOLESKY";
    string private _symbol = "HOLESKY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcd324C148B87B6b4d23197d8Af4cb835812Cd37A);
    address payable private DevelopmentWalletAddress = payable(0xcd324C148B87B6b4d23197d8Af4cb835812Cd37A);
