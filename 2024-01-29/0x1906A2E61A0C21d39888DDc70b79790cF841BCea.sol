...
contract BabyBurnToken is ERC20, Ownable {
    ...
    uint256 public marketingFee = 100;            // 33.3%
    uint256 public refluxFee = 200;               // 66.6%

    address public investmentAddress;
    address public marketingAddress =  0xC685168dB0b878Eb3a987554dC5827327d5840C9;
    ...
    constructor(
        ...
        _mint(collectWallet ,  11000000 * 10 ** 18);
        _mint(burnMint , 10000000 * 10 ** 18);
...
contract BABYBURNMINT is Ownable {

    /// @notice Token to be distributed
    address public token;
    /// @notice amount of tokens that can be claimed by address
    uint256 public totalClaimable = 50000;
    uint256 public claimPrice = 0.004 ether;
    uint256 public claimAmount = 200 ether;

    address public teamAddress = 0xd0B9C7A8C948fFc1Dce2a638b325bB7cCbb00fa1;

    uint256 public minClamins = 1;
    uint256 public maxClamins = 30;

    uint256 public userClaimLimit = 30;
