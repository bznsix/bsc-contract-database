...
contract Tsuki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbb9A0b60862b63C41582FA8Dc783F214278a8D70); 
    address payable private Wallet_Dev = payable(0xDc6fd14d845962959f032525307697F014b39EDc);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 4200000000000000000 * 10**_decimals;
    string private constant _name = "Tsuki Inu"; 
    ...
    uint256 private Percent_Marketing = 75;
    uint256 private Percent_Dev = 1;
    uint256 public Percent_Burn = 12;
    uint256 private Percent_AutoLP = 12; 
    ...
    constructor () {
        ...
        _owner = 0xDc6fd14d845962959f032525307697F014b39EDc;
