...
contract UVMiniPool is ERC20, ERC20Burnable, Ownable, AccessControl {
    ...
    uint256 public maxSizePool = 50000 ether; // check
    ...
    constructor()
        ERC20(
            string.concat("Mini - ", Strings.toString(orderNumber)),
            string.concat("MINI-", Strings.toString(orderNumber))
        )
    {
    ...
    function _deposit(address _userwallet, uint256 _amount) internal {
        ...
        require(_amount >= 50 ether, "Amount must be greater than 50");
