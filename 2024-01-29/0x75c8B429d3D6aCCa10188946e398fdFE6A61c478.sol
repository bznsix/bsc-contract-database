...
contract PoolStaking is ReentrancyGuard {
    ...
    function stake(uint256 _stakeAmt) public {
		...
		ERC20(address(0xca87017707D5a28178A9153b212f545a447E6fCD)).transferFrom(msg.sender, address(this), _stakeAmt);
	...
	function unstake(uint256 _unstakeAmt) public nonReentrant {
		...
		require((ERC20(address(0xca87017707D5a28178A9153b212f545a447E6fCD)).balanceOf(address(this)) >= _unstakeAmt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((_unstakeAmt > uint256(0))){
			ERC20(address(0xca87017707D5a28178A9153b212f545a447E6fCD)).transfer(msg.sender, _unstakeAmt);
		}
