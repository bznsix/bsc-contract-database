...
//--- Contract v3 ---//
contract BMICKEY is Context, Ownable,IERC20 {
    ...
    address payable private devWallet = payable(0xfDa208AfF2419597Bb98a8ef7416FbE6408A2aFb); // build: 0xfDa208AfF2419597Bb98a8ef7416FbE6408A2aFb
    AntiBot private AX;
    ...
    string constant private _name = "Baby Mickey";
    string constant private _symbol = "BMICKEY";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xDFc1eB2731281A89aA57ccdB76F41c9B3317C6eA);
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 mktAmount = address(this).balance * 25 / 50;
        uint256 devAmount = address(this).balance * 25 / 50;
