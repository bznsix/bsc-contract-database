...
contract BNBRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBRabbit";
    string private _symbol = "$RABBIT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x628595AdFEEda8D16204deC3a1a6540EBf06D314); // Marketing Address
    address payable public teamWalletAddress = payable(0xf359Fba430dbb20b2c3A58D74cAbd38f45223c7e); // Team Address
