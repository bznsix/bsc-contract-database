...
contract BILLMILLStaking is Ownable{
    ...
    event claimEvent(address indexed from,uint256 amount,uint256 reward,uint256 unStakeTime);
    ...
    function refWalletUpdate(address account) public onlyOwner {
        refWallet = account;
    }
