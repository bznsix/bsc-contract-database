...
contract OCT5 is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xdBa7C07799e6D35a5f5d489Ad3caD7bDb641C141);
    address payable public devAddress = payable(0xdBa7C07799e6D35a5f5d489Ad3caD7bDb641C141);
    address public newOwner = 0xB7CfAb390a14d9E372Be3FAF68C26B8C916010eD;
    ...
    string private _name = "Oct5 Test";
    string private _symbol = "OCT5";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(30); //x% of total supply
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(1000).mul(10); //x% of total supply
    uint256 private minimumTokensBeforeSwap = 3 * 10**_decimals;
