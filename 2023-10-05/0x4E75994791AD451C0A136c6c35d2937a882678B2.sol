...
/**
https://t.me/OneDollarBTCBillionaire
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7F14eaff425dA3acC5e2D13CF6ae40bA2eA0451E; // owner address
...
contract OneDollarBITCOINBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1$BitcoinBillionaire";
    string private _symbol = "1$BTC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7F14eaff425dA3acC5e2D13CF6ae40bA2eA0451E); // Marketing Address
    address payable private teamWalletAddress = payable(0x7F14eaff425dA3acC5e2D13CF6ae40bA2eA0451E); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 7;  // original 12
    uint256 public _totalTaxIfSelling = 7;  // original 12
