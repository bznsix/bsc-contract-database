...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaD2e24775273431D310c80cD620D19DC1f92BD3C;
...
contract FENGSHUI is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xaD2e24775273431D310c80cD620D19DC1f92BD3C);
    ...
    */
    ...
    string private _name = "FENGSHUI"; 
    string private _symbol = "FENGSHUI";  
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(2).div(1000);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (0.6% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(6).div(1000); 
