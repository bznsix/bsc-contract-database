...
contract SquidXgame is Context, IERC20, Ownable {
    ...
    string private _name = "SQUID-X-GAME ";
    string private _symbol = "SQUIDX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xa7bd8C5d68CA57B642FD8F4A30ADa31Bb7566752);
    ...
    function setTaxFee(uint256 newBuyLiquidityFee, uint256 newBuyMarketingFee, uint256 newSellLiquidityFee, uint256 newSellMarketingFee) external onlyOwner {
    require(newBuyLiquidityFee <= 25 && newBuyMarketingFee <= 25 && newSellLiquidityFee <= 25 && newSellMarketingFee <= 25, "Fee cannot exceed 25%");
