...
contract dddc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x590FB5DCf67c91d2547504f9f527Ab74e1B20404); // Marketing Address
        
    address payable public teamAddress =
        payable(0x590FB5DCf67c91d2547504f9f527Ab74e1B20404); // Team Address
        
    address payable public liquidityAddress =
        payable(0x590FB5DCf67c91d2547504f9f527Ab74e1B20404); // Liquidity Address
    ...
    uint256 private constant _tTotal = 8 * 1e9 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    string private constant _name = "Decentralized Dragon Digital Currency";

    string private constant _symbol = "DDDC";
