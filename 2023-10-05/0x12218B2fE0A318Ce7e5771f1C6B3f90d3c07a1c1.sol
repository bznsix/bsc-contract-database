...
contract ShibaTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public sammn46;
    ...
    string private _tokenname = "Shiba Inu 2.0";
    string private _tokensymbol = "Shiba2.0";
