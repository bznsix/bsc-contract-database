...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f64f0d779d4415518f10672Eb47f62737D2513b; 
    }
...
contract YingLong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YingLong";
    string private _symbol = "YLONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f64f0d779d4415518f10672Eb47f62737D2513b); // Dev and Marketing Address
    address payable public teamWalletAddress = payable(0x7f64f0d779d4415518f10672Eb47f62737D2513b); // Team Address
