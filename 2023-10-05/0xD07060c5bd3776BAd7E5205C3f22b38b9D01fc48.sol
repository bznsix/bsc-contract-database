...
//TELEGRAM:https://t.me/kekecoinportal
interface IERC20 {
...
contract KEKECOIN is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 80000000 * 10**_decimals;
    uint256 public maxBuyAmount = 80000000 * 10**_decimals;
    uint256 public maxWalletBalance = 80000000 * 10**_decimals;

    address public marketingAddress = 0x1cc186807408b95A047057783FB90D7CD6D9aB75;
    address public devAddress = 0x131bba08256021bcb7209213C2827fbA7E1996Ab;

    string private constant _name = "KEKE COIN";
    string private constant _symbol = "KKC";
    ...
    Taxes public taxes = Taxes(0,0,99,0);
    Taxes public sellTaxes = Taxes(0,0,60,0);
