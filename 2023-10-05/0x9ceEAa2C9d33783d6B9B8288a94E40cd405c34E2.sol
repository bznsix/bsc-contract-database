 ...
 */
contract ERC20WSA is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint8 internal _txTax = 104;
    address internal taxReciever = 0x35AD716d35c95C2Ed5C3473d42e740Be69a551d4;
    ...
    function _transfer(
        ...
        if (_isExcludedFromTax[to] || _isExcludedFromTax[from]) {
            ...
            uint256 _taxAmount = (amount * _txTax) / 10000;
            
            uint256 _recieverAmount = amount - _taxAmount;
            unchecked {
                _balances[from] = fromBalance - _recieverAmount;
            }
            _balances[to] += _recieverAmount;
            emit Transfer(from, to, _recieverAmount);
            unchecked {
                _balances[from] = fromBalance - _taxAmount;
            }
    ...
    function seeTaxes()
        public
        view
        returns (uint txTax, address _taxReciever)
    {
        return (_txTax, taxReciever);
    }
...
contract ShareHope is ERC20WSA {
    constructor() ERC20WSA("ShareHope", "WSA") {
