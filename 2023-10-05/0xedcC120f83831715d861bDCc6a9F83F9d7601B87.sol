...
contract BNBcrazy is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5a54F0acd82FA942569b2758C1C4C56E82d6ace8); 
    address payable public Wallet_Dev = payable(0x5a54F0acd82FA942569b2758C1C4C56E82d6ace8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "BNBcrazy"; 
    string private constant _symbol = unicode"BNBcrazy"; 
    ...
    constructor () {
        _owner =0x5a54F0acd82FA942569b2758C1C4C56E82d6ace8;
