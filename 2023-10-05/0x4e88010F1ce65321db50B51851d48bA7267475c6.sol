...
contract BingoInu is ERC20, Ownable {
    ...
    BingoInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BingoInu", "BINU") {
        ...
        dividendTracker = new BingoInuDividendTracker(
            payable(this),
            router,
...
contract BingoInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BingoInu public BingoInuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BingoInuContract = BingoInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BingoInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BingoInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BingoInu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BingoInuContract);

            uint256 prevBalance = BingoInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = BingoInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BingoInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
