...
contract Nezuko is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Nezuko";
    string private _symbol = unicode"NEZUKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xfEc3347BA4f6A0BdE9eE77df5F1E59153AAF0c76);
    address payable public teamWalletAddress =
        payable(0x9dAe58A50E5386239d8FBF0CB4b4D2a90fCd18eF);
