...
contract BITX is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"BITX", unicode"BITX") 
    {
        address supplyRecipient = 0xBD4f565B89F570007de7d530F80eD1942ff641dF;
        
        burnAddressSetup(0x7FEFCff6382f75144F49aC0C41a5DCeD1B7E5f7e);
        burnFeesSetup(500, 500, 0);

        excludeFromFees(supplyRecipient, true);
        excludeFromFees(address(this), true); 

        _mint(supplyRecipient, 2100000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xBD4f565B89F570007de7d530F80eD1942ff641dF);
    }
    ...
    function burnFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        totalFees[0] = totalFees[0] - burnFees[0] + _buyFee;
        totalFees[1] = totalFees[1] - burnFees[1] + _sellFee;
        totalFees[2] = totalFees[2] - burnFees[2] + _transferFee;
