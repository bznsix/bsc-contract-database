...
contract EntireCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Entire Coin";
    string private _symbol = "ENTIRE";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xC27F7a36B2e806cA7A4925625032567C16FbFcdf);
    address payable public teamWalletAddress = payable(0xae07c312797195c1Fd5b4974987946cD23bE58F9);
