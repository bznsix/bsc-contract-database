...
contract SafePatrick is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x47Cc2a60D28dbb76e7236f395816e820B0855103); 
    address payable public Wallet_Dev = payable(0x47Cc2a60D28dbb76e7236f395816e820B0855103);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Safe Patrick"; 
    string private constant _symbol = unicode"SAFE PATRICK"; 
    ...
    constructor () {
        _owner = 0x47Cc2a60D28dbb76e7236f395816e820B0855103;
