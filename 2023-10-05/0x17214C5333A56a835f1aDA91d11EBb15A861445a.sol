...
Join Us on Telegram: https://t.me/chihuahuaBNB
...
contract CHIHUAHUA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10e12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 200_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 200_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 200_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 200_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xE4463C901EcA4C1de954C1AFF30065a7541851Db;
    address public devAddress = 0x8f4fB0a3334977b0F00B301B9d894C1Ec17A6CEf;

    string private constant _name = "Chihuahua";
    string private constant _symbol = "CHIHUAHUA";
    ...
    Taxes public taxes = Taxes(1,0,7,2);
    Taxes public sellTaxes = Taxes(1,0,7,2);
    ...
    // Owner cannot transfer out SNOWY from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SNOWY!");
