...
contract ElevenDollar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"11$ ";
    string private _symbol = unicode"11$";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4813cE8784cD3a578EfCBBDE7b9DcA43fDF1c373);
    address payable private taxWallet2 = payable(0x4813cE8784cD3a578EfCBBDE7b9DcA43fDF1c373);
