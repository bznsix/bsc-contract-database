...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb2431d3cc38c0fD36F360Be489cA30F98501B877; // Adresse des Tokenbesitzers
...
contract LADoge is Context, ERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xEF798738Dd219EA8204bd2Ccb2a94A22b3134cb3); // An diese Adresse gehen die Fees
    ...
    string private _name = "LA DOGE"; 
    string private _symbol = "LADOG";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _tFeeTotal;

    // Counter for liquify trigger
    uint8 private txCount = 0; // Startet mit Liquidity nach dem Deployen
    ...
    uint256 private maxPossibleFee = 100; // bedeutet 10%!! NICHT 100%!!


    // Setting the initial fees
    uint256 private _TotalFee = 60; // 6%
    uint256 public _buyFee = 30; // 3%
    uint256 public _sellFee = 30; // 3%
    ...
    */
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // BSC Router
    ...
    */
    ...
    function remove_Random_Tokens(address random_Token_Address, address send_to_wallet, uint256 number_of_tokens) public onlyOwner returns(bool _sent){
        ...
        uint256 randomBalance = ERC20(random_Token_Address).balanceOf(address(this));
        if (number_of_tokens > randomBalance){number_of_tokens = randomBalance;}
        _sent = ERC20(random_Token_Address).transfer(send_to_wallet, number_of_tokens);
    }
