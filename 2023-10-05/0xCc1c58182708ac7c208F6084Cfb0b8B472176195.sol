...
contract ELEPHANTTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public sklqjz28;
    ...
    string private _tokenname = "Elephant Money";
    string private _tokensymbol = "ELEPHANT";
