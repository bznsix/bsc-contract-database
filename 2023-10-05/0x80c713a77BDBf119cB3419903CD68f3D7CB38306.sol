...
contract Knife is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Knife Cash";
    string private constant _symbol = unicode"KNIFE";
