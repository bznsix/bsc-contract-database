...
contract cBOTTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public djjna8;
    ...
    string private _tokenname = "CypherBOT";
    string private _tokensymbol = "cBOT";
