...
contract AISHIBA is ERC20, Ownable {
    ...
    function _transfer(
        ...
        bool canSwap = balanceOf(address(this)) > 0;
    ...
    function setExcludedAddress(address _user, bool status) internal {
