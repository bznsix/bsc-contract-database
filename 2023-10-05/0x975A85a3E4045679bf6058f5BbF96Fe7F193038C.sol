...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="Hadron";
    string private _symbol="HDN";
    uint8 private _decimals=9;

    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 10000000000000000;
    uint256 private _tTotalSupply = 10000000000000000;
    ...
    uint public liquidityFeeonBuy=40;
    uint public liquidityFeeonSell=70;
    ...
    address public marketingWallet=0xA67f88173Dbe48F77b615cD5E4cEaaB7653219Ff;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=10000000000000000;
