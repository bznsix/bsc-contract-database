...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1E49C4151A8cf7eBc2BA9FfceE55942B8B941335; // owner address
...
contract UNITEDWHALES is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "UnitedWhales";
    string private _symbol = "$UTD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEfBA2F459Fb1Fe6aC74df102220eD5DEE6514DA0);
    address payable public teamWalletAddress = payable(0xEfBA2F459Fb1Fe6aC74df102220eD5DEE6514DA0);
