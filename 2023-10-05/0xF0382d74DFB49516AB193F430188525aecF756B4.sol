...
contract WEBGTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public wlamgnd2;
    ...
    string private _tokenname = "WebGlide";
    string private _tokensymbol = "WEBG";
