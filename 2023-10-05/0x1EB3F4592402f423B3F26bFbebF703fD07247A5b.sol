/**
 * Telegram: https://t.me/magicinternetcoins
*/
...
contract MagicInternetMoney is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MagicInternetMoney";
    string constant _symbol = "MIM"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x018E246627D7098EC9C2c245fa1b04eE03408D4e ;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(0x018E246627D7098EC9C2c245fa1b04eE03408D4e).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(0x018E246627D7098EC9C2c245fa1b04eE03408D4e).transfer(amountBNB * amountPercentage / 100);
    }
    
    function sSF(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee) external authorized {
