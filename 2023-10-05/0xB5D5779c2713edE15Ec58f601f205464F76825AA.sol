...
contract SBCToken is ERC20, Ownable {
    ...
    //
    constructor(address _usdtAddress, address _iUniswapV2Router02Add, address _feeAddress) public ERC20("SBC", "SBC") {
        ...
        _mint(msg.sender, 2100 * 10000 * 10 ** uint256(decimals()));
