...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xEFBE4a48E944d7C2E28f44AeeCd6D2BCc0901022; 
...
contract HyperSafeMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hyper SafeMoon";
    string private _symbol = "HyperSafe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEFBE4a48E944d7C2E28f44AeeCd6D2BCc0901022);
    address payable public teamWalletAddress = payable(0xEFBE4a48E944d7C2E28f44AeeCd6D2BCc0901022); 
