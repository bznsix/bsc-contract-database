/*
         Welcome To SexyRed Coin || The Hood Hottest Princess!! 🌙
*/
...
contract SexyyRed is Context, IERC20, Ownable {
    ...
    string private _name = "SexyyRed";
    string private _symbol = "SexyyRed";
    ...
    constructor (address BurnWallet) public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEdffF5813A533a817e23381135e38B4B2bCFBcA1); //TESTNET
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xEdffF5813A533a817e23381135e38B4B2bCFBcA1, 'We can not exclude Uniswap router.');
