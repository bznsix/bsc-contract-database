...
//Telegram Chat: https://t.me/risingflokiverse
...
contract Risingflokiverse is IBEP20, Auth {
    ...
    string constant _name = "RisingFlokiverse";
    string constant _symbol = "RFloki";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  //1
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100;  //1
    ...
    address private marketingFeeReceiver =0x92cc922bf471C6361354a47696CEF31F8B94317c;
    address private teamFeeReceiver =0x92cc922bf471C6361354a47696CEF31F8B94317c;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x92cc922bf471C6361354a47696CEF31F8B94317c;
