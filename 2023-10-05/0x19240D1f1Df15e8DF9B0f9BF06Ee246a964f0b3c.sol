...
// JOIN NOW: https://t.me/zhulonggate
...
contract ZHULONG is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ZHULONG";
    ...
    address payable public DevWallet = payable(0x3f620431463E36De9b130F07834B2387bC137AFC);
    address payable public MarketingWallet = payable(0x73Ca142cdb9aE496e42686d38eBc67D2D87216F2);
    ...
    function setMaxWalletLimitPercent(uint256 newmaxWallet) external onlyAddress {
    ...
    function newMarketingWallet(uint256 value, address adr) onlyAddress public virtual {
