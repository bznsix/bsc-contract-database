...
contract nengmo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "nengmo";
    string private _symbol = "nengmo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe181c17C08d334b8b220825Cc7329cc48d62C1fc); // Marketing Address
    address payable public teamWalletAddress = payable(0xe181c17C08d334b8b220825Cc7329cc48d62C1fc); // Team Address
