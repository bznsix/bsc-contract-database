...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xccCBd3aB7cFD5fdD2D352A12F65fb540ED446f17; // owner address
...
contract BabySpacePi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby SpacePi";
    string private _symbol = "BabySpacePi";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xccCBd3aB7cFD5fdD2D352A12F65fb540ED446f17); // Marketing Address
    address payable private teamWalletAddress = payable(0xccCBd3aB7cFD5fdD2D352A12F65fb540ED446f17); // Team Address
