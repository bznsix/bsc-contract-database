/**
// Telegram : https://t.me/longtermtoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A1584f24A2fACEDCaF505896457B5DCDd5e54b0 ; // owner address
...
contract LONGTERM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "LONG TERM";
    string private _symbol = "LONGT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8E27f555E0D1D8A1811619a185Fd160fb065C7C0); // Marketing Address
    address payable private teamWalletAddress = payable(0x5A1584f24A2fACEDCaF505896457B5DCDd5e54b0); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 8000000 * 10**3; 
