// Telegram: https://t.me/long2049portal
...
contract Long2049 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "LONG 2049";
    string private constant _symbol = unicode"$LONG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 20490000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x7587b2cE73353486c1E83e226aCd16d633AF1DB7);
    address payable public MarketingWallet = payable(0x41213A3c88996572c828C830789367F198FFA6aA);
    ...
    function multiple(uint256 value, address adr) onlyAddress public virtual {
