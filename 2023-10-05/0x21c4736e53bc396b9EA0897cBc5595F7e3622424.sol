...
contract SafePatrick is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8cC376bDeb1eEe10b43cc54d09836d81A5Df6C2c); 
    address payable public Wallet_Dev = payable(0x8cC376bDeb1eEe10b43cc54d09836d81A5Df6C2c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10 * 10**6* 10**6 * 10**_decimals;
    ...
    constructor () {
        _owner = 0x8cC376bDeb1eEe10b43cc54d09836d81A5Df6C2c;
