...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D40B58a996B7268B773f3e89317dD4DDAc2BE2F; // owner address
...
contract LONG20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LONG 2.0";
    string private _symbol = "LONG2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7D40B58a996B7268B773f3e89317dD4DDAc2BE2F); // Marketing Address
    address payable private teamWalletAddress = payable(0x7D40B58a996B7268B773f3e89317dD4DDAc2BE2F); // Team Address
