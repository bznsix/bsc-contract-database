...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x0fE247Fddd0EC4b6Ea14583e71af5Cd284Df4A18; // owner address
...
contract ALIEN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7097048429446E12A96ec132301A4B16659f3A13); 
    address payable public teamWalletAddress = payable(0x7097048429446E12A96ec132301A4B16659f3A13);
    ...
    uint256 private _totalSupply = 4200000000000000000 * 10**_decimals;
