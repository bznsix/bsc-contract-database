...
/*
TG : https://t.me/+b1fLDOilXZhhOGQ1
*/
...
contract BTCONBNB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BTC-On-BNB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x1CC9f05E13a2ddB288f0ec4000B7bA614f3009Ec;
        BuyBackWallet = 0x87Ced61b1D84a716A551cc5dB75aaFc1A8aD3C73;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newBuyBackFee, uint256 extraSellFee) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(BuyBackWallet).call{value: amountBNBBuyBack, gas: 30000}("");
