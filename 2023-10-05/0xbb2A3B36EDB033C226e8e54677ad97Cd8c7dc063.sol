...
contract TEST3 is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xB7CfAb390a14d9E372Be3FAF68C26B8C916010eD);
    address payable public devAddress = payable(0xB7CfAb390a14d9E372Be3FAF68C26B8C916010eD);
    ...
    string private _name = "OCT5 Test 3";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(20); //x% of total supply
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(1000).mul(30); //x% of total supply
    uint256 private minimumTokensBeforeSwap = 2500 * 10**_decimals;
