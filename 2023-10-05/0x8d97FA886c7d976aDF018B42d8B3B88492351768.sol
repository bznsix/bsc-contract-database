...
contract SSS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x3898f508A38aCe304323bCABf3EebC004ad82D33); // Marketing Address
        
    address payable public teamAddress =
        payable(0x3898f508A38aCe304323bCABf3EebC004ad82D33); // Team Address
        
    address payable public liquidityAddress =
        payable(0x3898f508A38aCe304323bCABf3EebC004ad82D33); // Liquidity Address
    ...
    string private constant _name = "super supply shock";
    ...
    uint256 public maxWallet = _tTotal * 1 / 500 ; // 2% at launch, 90% SUPPLY LOCKED

    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    mapping (address => bool) public automatedMarketMakerPairs;

    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 2000; // 0.25 %
