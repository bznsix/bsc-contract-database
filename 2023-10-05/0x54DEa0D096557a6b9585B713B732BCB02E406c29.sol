...
contract SFILTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ivccdf51;
    ...
    string private _tokenname = "SFIL";
    string private _tokensymbol = "SFIL";
