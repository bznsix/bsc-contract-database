...
contract KOBURA is ERC20, Ownable {
    ...
    address public marketingWallet = 0x6458348FC5C2a3b6159742d8df721c5b000b9525;
    ...
    // Supply 1 trillion
    constructor() ERC20("KOBURA COIN", "KOBURA") {
        ...
        _mint(address(0x6458348FC5C2a3b6159742d8df721c5b000b9525), _supply);
    }
    ...
    function setSwapTokensAtAmount(uint256 _percent) external onlyOwner {
        swapTokensAtAmount = (totalSupply() * _percent) / 1;
    }
