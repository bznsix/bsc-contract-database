...
/* Hellium Chain first launch on Binance Smart Chain

Hellium Chain L1 Blockchain 
Launch October 2023

https://t.me/helliumchainbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Ce4726C9e88059fad2DC1fc4D3E4f9755636c5C; // Hellium Chain Dev Wallet
...
contract HelliumChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hellium Chain";
    string private _symbol = "HELLIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf1F441c999E1b03F38eD90f52AeDD9C07c97bAC1); //  Marketing Address
    address payable public teamWalletAddress = payable(0x37e87e2ABa154108DfCf13920BbdB4b5573c4439); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 40;
