...
//https://twitter.com/XBARTOFFICIAL
//https://t.me/XBARTBSC
...
contract XBART  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x83A2D07D1ac5602208dbfC83867f13f970C14330); 
    address payable public Wallet_Dev = payable( 0x83A2D07D1ac5602208dbfC83867f13f970C14330);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 17* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "X BART"; 
    string private constant _symbol = unicode"$XBART"; 
    ...
    constructor () {
        _owner = 0x83A2D07D1ac5602208dbfC83867f13f970C14330;
