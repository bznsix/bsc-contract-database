...
contract Genixor is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"Genixor", unicode"GXR") 
    {
        address supplyRecipient = 0x5C78677E5D5D2957c84Cc4FB88151d2988AE3C72;
        
        _mint(supplyRecipient, 180000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x5C78677E5D5D2957c84Cc4FB88151d2988AE3C72);
    }
