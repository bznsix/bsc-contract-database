...
import "bsc-library/contracts/interfaces/IBEP20.sol";
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    function add(
        ...
        require(_lpToken != CAKE, "UCAKE token can't be added to farm pools");
    ...
    function updateCakeRate(
        ...
        require(
            ...
            "MasterChefV2: UCAKE rate must be greater than 0"
        );
        require(
