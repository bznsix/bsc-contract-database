...
contract ProsoftStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [7 days, 30 days, 60 days, 120 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [1500, 3500, 5500, 8000];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0x1B96B92314C44b159149f7E0303511fB2Fc4774f; //BUSD_WBNB pancake pool address
        ...
        address TKN_WBNB = 0xCc5b7b352e6775700dDC0870De0Ba37146b9A8f3; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x301074950069483Df2729efFd5E7f5B70aE27cF0); // TKN Token address 
        uint256 WBNBSUPPLYINTKN_WBNB =(WBNBTOKEN.balanceOf(TKN_WBNB));
        uint256 TKNSUPPLYINTKN_WBNB = (TKNTOKEN.balanceOf(TKN_WBNB));
        uint256 TKNUSDVAL = (((WBNBSUPPLYINTKN_WBNB.mul(1e9)).div((TKNSUPPLYINTKN_WBNB))).mul(BNBPRICE)).div(1e18);
        return TKNUSDVAL;
    }
