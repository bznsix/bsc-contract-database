...
contract Tonton is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tonton";
    string private _symbol = "TONTON";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x6460D0EFC3d26EA2Ffbe94C9c9557026C9b0eFc4); // Marketing Address
    address payable public teamWalletAddress = payable(0x6460D0EFC3d26EA2Ffbe94C9c9557026C9b0eFc4); // Team Address
