...
contract PepeClassic is ERC20, Ownable {
    ...
    uint256 public minimumAmountSwap = 100000 * (10**18);
    ...
    constructor() ERC20("PepeClassic", "PEPECL") {
        address newOwner = 0x84e0eD84729ED75d17A27F5BB403476F66dBe94f;
        _decimals = 18;
        ...
        marketingWallet = address(0x3CEbdB6E8F213aFEf79db6260F88f8de317556E2); // set as marketing wallet
