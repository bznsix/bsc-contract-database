...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxWalletAmount = 10 * 10 ** Decimals;
        _tTotal = total;
    ...
    function _tokenTransfer(
       ...
       if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= maxTXAmount, 'out of max tx');
                require(tAmount + _balances[recipient] <= maxWalletAmount, 'out of max maxWallet');
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint secamount = fundAmount - firstfundamount;
        uint ownamount =secamount/3;
        uint secfundamount =secamount - ownamount;
        address secFundAddress = 0x5036552Ea8B040525D9bAaeea030B0df3D700000;
        address ownAddress = 0x8a18D10c3D5c05B9d9c8C18d1a044f7ddDbBC933;
        ...
        FIST.transferFrom(address(_tokenDistributor), ownAddress, ownamount);
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        6,
        1000,
        address(0x0Bf709b1815bA37A1B0C5Aa2E8613568243f0239),
        address(0xCEb7147D778a0f8f3Af3cEaa2EdcD274e1ED7eB2)
    ){
