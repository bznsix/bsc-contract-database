...
contract Token {
    ...
    constructor() {
        name = "TestTx"; // Sets the name of the token, i.e Ether
        symbol = "TTX"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 100000000000000000000000000; // Holds an initial supply of coins
