...
contract ZAFITOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public vppla63;
    ...
    string private _tokenname = "ZAFI";
    string private _tokensymbol = "ZAFI";
