...
contract DarkPepeBSC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420696969696 * 10**9;
    ...
    address payable private _dev = payable(0x1716ceC8344B56Fd449d094d22C70EbE6260448e);
    address payable private _mkt = payable(0x1716ceC8344B56Fd449d094d22C70EbE6260448e);
    
    string private constant _name = "Dark Pepe";
    string private constant _symbol = "DARKPEPE";
