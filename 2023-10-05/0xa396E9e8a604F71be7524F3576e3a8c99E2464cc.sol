...
contract FINU is Context, IERC20, Ownable {
    ...
    string private _name = " FROGGY INU ";
    string private _symbol = " $FINU " ;
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x057550576562772DCd5b1EAc2D04C5d0F54F7F26); 
    address payable public teamWalletAddress = payable(0x057550576562772DCd5b1EAc2D04C5d0F54F7F26); 
