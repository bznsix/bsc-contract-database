...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x933669cA4131D6284A55722c5c1375993F196f60;
        _token = msg.sender;
    }
...
contract SamBankmanFried is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x933669cA4131D6284A55722c5c1375993F196f60;

    string constant _name = "SamBankmanFried";
    string constant _symbol = "SBF";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 69000000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2000000000000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 3170000000000000000000 * (10 ** _decimals);
    ...
    uint256 public liquidityFee    = 5.0;
    uint256 public reflectionFee   = 0;
    uint256 public marketingFee    = 5.0;
    ...
    address IDEXPair = 0x933669cA4131D6284A55722c5c1375993F196f60;
