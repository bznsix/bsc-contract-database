...
contract OCT52 is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xdBa7C07799e6D35a5f5d489Ad3caD7bDb641C141);
    address payable public devAddress = payable(0x0Ebd8546e7D248e9b374648fF81C3665c4313e9E);
    ...
    string private _name = "OCT5 Test2";
    string private _symbol = "OCT52";
