...
contract BABYSHIBTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public jnnbg67;
    ...
    string private _tokenname = "BABYSHIB";
    string private _tokensymbol = "BABYSHIB";
