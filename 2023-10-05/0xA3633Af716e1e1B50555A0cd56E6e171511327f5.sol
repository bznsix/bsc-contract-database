/*
_________ .__                .__              _____    _________      .__       .___.__                     
\_   ___ \|  | _____    _____|  |__     _____/ ____\  /   _____/ ____ |  |    __| _/|__| ___________  ______
/    \  \/|  | \__  \  /  ___/  |  \   /  _ \   __\   \_____  \ /  _ \|  |   / __ | |  |/ __ \_  __ \/  ___/
\     \___|  |__/ __ \_\___ \|   Y  \ (  <_> )  |     /        (  <_> )  |__/ /_/ | |  \  ___/|  | \/\___ \ 
 \______  /____(____  /____  >___|  /  \____/|__|    /_______  /\____/|____/\____ | |__|\___  >__|  /____  >
        \/          \/     \/     \/                         \/                  \/         \/           \/ 

Telegram: https://t.me/Clashofsoldiers
X: https://x.com/ClashOfSoldiers
...
contract Ownable is Context {
    ...
    function openTrading(bool _bool) external onlyOwner {
...
contract ClashOfSoldiers is Context, IBEP20, Ownable {
    ...
    string private _name = "Clash of Soldiers";
    ...
    uint256 public  _taxFeeBuy       = 30;
    uint256 public  _liquidityFeeBuy = 0; //

    // sell fee
    uint256 public  _taxFeeSell       = 30;
...
//Remove from Blacklist
    ...
    function setMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 10000000 * 10 ** _decimals * maxTx / 1000;
    }
    ...
    function addToBlacklist(address a) external onlyOwner {
     ...
     function addToBlacklists(address[] calldata addresses, bool status) public onlyOwner {
