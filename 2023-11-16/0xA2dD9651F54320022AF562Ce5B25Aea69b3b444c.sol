...
contract PAPA is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0x8cDb3F0D48960E41C284082ef11D10d33A74eEe9;

    uint256 public swapTokensAtAmount;  
    bool    public swapWithLimit;
    bool    private swapping;
    uint256 public maxBuyAmount = 2001 * 10**18; //
    ...
    constructor () ERC20("PAPA BEAR", "PAPA") 
    {   
        address newOwner = 0x30417B83c580Da961a795F0C1b123CACa1469d1C;
    ...
    function setWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 20, "Wallet to Wallet Transfer Fee cannot be more than 20%");
