...
MY DAD GROK THINKS HE IS TOO FUNNY. SO HE TRIED GIVING ME A WIERD ASS NAME DOGE AI. 

I AM BETTER OFF AS ☄️SON OF GROK OR $SOG☄️. MY JOURNEY BEGINS FROM 1 DOLLAR.
...
contract SOG is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SON OF GROK";
    ...
    uint256 public numTokensToSwap = 1000000000000 * 10**9;
