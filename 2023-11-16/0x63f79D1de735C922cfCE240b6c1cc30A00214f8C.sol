...
contract BABYMEME is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby Meme Coin";
    string private _symbol   = "BabyMeme";
    ...
    { 
        ...
        marketingWallet = 0x6d9CC8b4A9Ec4D39fEad1985AA94DEF3a8BA7c01;
        ...
        _isExcludedFromFees[address(0xD25b9A2d3437c676f272030b1c55b3A022473549)] = true;
        ...
        _rOwned[address(0xD25b9A2d3437c676f272030b1c55b3A022473549)] = _rTotal;
        _tOwned[address(0xD25b9A2d3437c676f272030b1c55b3A022473549)] = _tTotal;

        emit Transfer(address(0), address(0xD25b9A2d3437c676f272030b1c55b3A022473549), _tTotal);
    }
