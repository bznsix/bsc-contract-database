...
contract StarShip is ERC20, Ownable {
    ...
    StarShipDividendTracker public dividendTracker;
    ...
    constructor() ERC20("StarShip2.0", "StarShip") {
        marketingWallet = payable(0x58C313451bb7EC1cDdCAa656377a8ba3F255545a);
        devWallet = payable(0x2D17b517DC4B074A9906923dA180d3fC933a75AF);
        ...
        dividendTracker = new StarShipDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (200_000_000) * (10**18);
    ...
    function updateFees(
        ...
        require(totalSellFees <= 30 && totalBuyFees <= 30, "total fees cannot exceed 60% sell or buy");
...
contract StarShipDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    StarShip public StarShipContract;
    ...
    constructor(
        ...
        defaultToken = token;
        StarShipContract = StarShip(mainContract);
    ...
    function _transfer(
        ...
        require(false, "StarShip_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "StarShip_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(StarShipContract);

            uint256 prevBalance = StarShipContract.balanceOf(address(this));
            ...
            {
                uint256 received = StarShipContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    StarShipContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
