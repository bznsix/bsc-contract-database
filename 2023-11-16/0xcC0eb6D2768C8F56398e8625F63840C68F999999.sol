...
contract Token is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("ETCS2.0", "ETCS2.0") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
                ...
                super._transfer(from, address(this), amount.div(1000).mul(48));
    ...
    function swapAndLiquify() private {
        ...
        swapTokensForUSDT4fund(allTokenAmount.div(48).mul(10));
        swapTokensForECO4fund(allTokenAmount.div(48).mul(38));
    ...
    address ECO = address(0xEe72027058D55251BD296F8DBEcD64859a9B7777);
    
    function swapTokensForECO4fund(uint256 tokenAmount) private {
