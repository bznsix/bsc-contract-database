...
contract BSC2024 is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "Year of the Dragon 2024";
        _symbol = "2024";
        _decimals = 9;

        marketWallet = payable(0xd494e5166AfA565e787C6d1cec7185F574136f6A);

        marketingFee = 2;
        liquidityFee = 1;
        _totalTax = marketingFee + liquidityFee; 

        _totalSupply = 20240000 * 10**_decimals;
        _maxOnceEat = 20240000 * 10**_decimals;
        _maxTotalEat = 20240000 * 10**_decimals;
