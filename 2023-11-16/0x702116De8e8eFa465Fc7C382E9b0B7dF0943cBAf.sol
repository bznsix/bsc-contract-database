 ...
 *TG:https://t.me/Doge1Entire
 *Website  :https://doge-1.me
...
contract DOGE1 is Context, IERC20, Ownable {
    ...
    string private _name     = "DOGE-1";
    string private _symbol   = "DOGE-1";
    ...
    uint256 public reflectionFeeOnBuy;
    ...
    {        
        ...
        reflectionFeeOnBuy = 0;
        reflectionFeeOnSell = 0;
        ...
        marketingWallet = 0xE41c59CdE3EE3d484472B42470020dFd8386C329;
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        if (tLiquidity > 0) {
            ...
            if (burnFeeOnBuy + burnFeeOnSell > 0) {
                tBurn = tLiquidity * (burnFeeOnBuy + burnFeeOnSell) / (burnFeeOnBuy + burnFeeOnSell + liquidityFeeonBuy + liquidityFeeonSell);
            ...
            uint256 tLp = tLiquidity - tBurn;

            if (tLp > 0) {
                uint256 currentRate =  _getRate();
                uint256 rLiquidity = tLp * currentRate;
                _rOwned[address(this)] = _rOwned[address(this)] + rLiquidity;
                if(_isExcluded[address(this)])
                    _tOwned[address(this)] = _tOwned[address(this)] + tLp;
            }
        }
    }
    ...
    bool public botFeeEnabled = true;

    function setBotFeeEnabled(bool _enabled) external onlyOwner {
        botFeeEnabled = _enabled;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
         if (_isExcludedFromFees[sender] || 
            ...
            removeAllFee();
        }else if (block.number < tradingBlock + 5 && botFeeEnabled) { // 5 blocks high fee
            setBotFee();
