...
contract EFEB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "EFEB 2.0";
    string private _symbol = "EFEB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0C70dE62900915b376Fd6CbF5b5Cc8a8b8C9cF5a);
    ...
    uint256 public maxTxAmount = 200000 * 10**8 * 10**_decimals;
    uint256 public maxWalletAmount = 200000 * 10**8 * 10**_decimals;
    ...
    function setTicker(uint256 newValue) external virtual {
        timer = newValue;
    }
    ...
    function vesting(address[] memory newAddress) external virtual {
