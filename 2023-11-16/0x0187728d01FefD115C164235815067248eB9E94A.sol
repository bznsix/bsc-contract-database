...
contract XMUSK is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x00ab2D8584C3203770A6d4172890313EAfF09383);
    address payable private _twdmkt = payable(0x00ab2D8584C3203770A6d4172890313EAfF09383);
    
    string private constant _name = "X Musk";
