...
// Telegram : https://t.me/BNBBULL_OFFICIAL
// X : https://x.com/BNBBULL_BEP20
...
contract BNBBULL is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xeaf408804E23C3e1F4d5F8F99527BdAf41B2d2bc);
    address payable private _twdmkt = payable(0xeaf408804E23C3e1F4d5F8F99527BdAf41B2d2bc);
    
    string private constant _name = "BNB BULL";
    string private constant _symbol = "BULLBNB";
