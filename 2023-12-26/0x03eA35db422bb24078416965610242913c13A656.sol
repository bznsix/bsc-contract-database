...
/**
 * The interfaces exposed by a paymaster contract, who agrees to pay the gas for user's operations.
...
contract VerifyingPaymaster is BasePaymaster {
    ...
    uint256 private constant GAS_TYPE_OFFSET = 20;

    uint256 private constant VALID_PND_OFFSET = 21;

    uint256 private constant SIGNATURE_OFFSET = 149;
     ...
     * paymasterAndData[21:149] : abi.encode(validUntil, validAfter)
     * paymasterAndData[149:] : signature
     */
    function _validatePaymasterUserOp(
        UserOperation calldata userOp,
        bytes32 /*userOpHash*/,
        ...
        )
    {
        ...
        gasType = uint8(
            bytes1(paymasterAndData[GAS_TYPE_OFFSET:VALID_PND_OFFSET])
        );
    ...
    function _postOp(
        ...
        (
            ...
            address erc20Token,
            uint256 exchangeRate
        ) = abi.decode(context, (address, bytes32, uint8, address, uint256));
        //todo: currently only support native token actualTokenNeeded is equal to actualGasCost,
