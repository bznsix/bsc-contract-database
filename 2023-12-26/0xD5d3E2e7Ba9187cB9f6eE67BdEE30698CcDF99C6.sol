/**
https://t.me/KonkeBSC
Hey, it's $KONKE. I'm a cute kitty with a penchant for playful risk-taking in the crypto world
I may not always see eye to eye with everyone, but I've got a bunch of adorable friends. Sure, my playful antics might ruffle some fur, but deep down, I'm just a sweet cat. Let's embark on this digital journey together and 
create a paw-sitively delightful friendship. 🐾
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7A12cec2A8729483Ccaad1818B185FaD2e3c435; // owner address
...
contract KONKE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xf7A12cec2A8729483Ccaad1818B185FaD2e3c435); // Marketing Address
    address payable private teamWalletAddress = payable(0xf7A12cec2A8729483Ccaad1818B185FaD2e3c435); // Team Address
    ...
    uint256 public _teamShare = 0; // original 12

    uint256 public _totalTaxIfBuying = 25;  // original 12
    uint256 public _totalTaxIfSelling = 20;  // original 12
