...
contract BABYBEFE is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY BEFE";
    string private constant _symbol = "$BABYBEFE";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 100000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 100000000000 * 10**_decimals;
