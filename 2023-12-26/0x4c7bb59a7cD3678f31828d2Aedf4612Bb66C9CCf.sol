/**
            https://humanscoin.io
            https://twitter.com/HumanLifeCoin
            https://t.me/HumanLifeCoin
...
library Address{
 ...
 contract HUMAN is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 8_100_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 6_000_000 * 10**9;
    uint256 public maxBuyLimit = 162_000_000 * 10**9;
    uint256 public maxSellLimit = 162_000_000 * 10**9;
    uint256 public maxWalletLimit = 162_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x825483A4090CCD54B72e7915d223868bcfe7307A;
    address public donationWallet = 0x825483A4090CCD54B72e7915d223868bcfe7307A;
    ...
    Taxes public taxes = Taxes(1, 3, 1, 0);
    Taxes public sellTaxes = Taxes(1, 3, 1, 0);
