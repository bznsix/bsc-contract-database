...
contract EMPEROR_COIN is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x84feb596DD5C86dbAeFcF2Ef08bcd1b6A96fBf3E);

    string public _name = "EMPEROR COIN";
    string public _symbol = "ERN";
