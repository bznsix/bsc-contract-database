...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _transferFeeAddress = address(0x9A825a9906b1FF4bdb622233bCbf55EA794cAA43);
    address public _destroyAddress = address(0x9A825a9906b1FF4bdb622233bCbf55EA794cAA43);
...
contract XGROK is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000000000000,
        address(0x9A825a9906b1FF4bdb622233bCbf55EA794cAA43),
        address(0x9A825a9906b1FF4bdb622233bCbf55EA794cAA43)
    ){
