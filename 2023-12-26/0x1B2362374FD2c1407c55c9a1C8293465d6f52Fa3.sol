...
contract CateMessiahCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Cate Messiah Coin";
    string private constant _symbol = "MECOIN";
