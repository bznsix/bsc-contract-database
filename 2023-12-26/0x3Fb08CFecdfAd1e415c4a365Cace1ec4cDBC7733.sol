...
contract ORCUP is ERC20, ERC20Burnable, Ownable, Pausable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"ORCUP", unicode"ORCUP") 
    {
        address supplyRecipient = 0x0C091a642E981e2d88314534EB33D3Da4cc1210C;
        
        _mint(supplyRecipient, 10000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x0C091a642E981e2d88314534EB33D3Da4cc1210C);
    }
