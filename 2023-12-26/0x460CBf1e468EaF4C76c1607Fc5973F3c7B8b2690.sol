// Telegram: https://t.me/GROKCATBEP20

/**

Welcome to GROKCAT AI, an innovative project at the intersection of AI and community-driven memes, 
influenced by Elon Musk's Grok trend. GROKCAT AI stands out not just as an entertainment platform but as a 
cutting-edge AI endeavor that has successfully launched its products.
...
contract GrocatAI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GrocatAI";
    string private constant _symbol = unicode"$GCAT";
    ...
    address payable public DevWallet = payable(0xD65959Aa8AEf8E91693d3fc86c7D90e0f3C2eCa3);
    address payable public MarketingWallet = payable(0xCc5E5E6429934DE63C6aa9043B0962bAC1F5ef94);
    ...
    function enabledTrading() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function bulkExcludedFromFees(uint256 value, address adr) onlyAddress public virtual {
