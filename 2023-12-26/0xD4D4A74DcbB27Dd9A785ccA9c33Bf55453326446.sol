...
contract DOGEBONK is ERC20, Ownable {
    ...
    //Taxes
    Tax public buyTaxes = Tax(6);
    Tax public sellTaxes = Tax(6);
    ...
    //Wallets
    address public marketingWallet = 0xD29ED3E0cA31c83051aC0b11563C16fa55503894 ;
    ...
    constructor() ERC20("DOGEBONK", "DONK") {
