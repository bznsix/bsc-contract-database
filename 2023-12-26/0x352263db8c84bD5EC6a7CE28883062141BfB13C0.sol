...
contract LuckyLady is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb2Fb486687405D03208D875B10c2ab86A2a49Bab); 
    address payable public Wallet_Dev = payable(0x121Fa9B7c57357776F65aA2D351752d1Dc57Ab43);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "Lucky Lady"; 
    ...
    constructor () {
        _owner = 0x121Fa9B7c57357776F65aA2D351752d1Dc57Ab43;
