...
//--- Contract v3 ---//
contract BYTE is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 690_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0x6F200C40a58728fc883BDfdD1233837cd07EfF7c); // build: 0x6F200C40a58728fc883BDfdD1233837cd07EfF7c
    address payable private devWallet = payable(0x6F200C40a58728fc883BDfdD1233837cd07EfF7c); // build: 0x6F200C40a58728fc883BDfdD1233837cd07EfF7c


//--- v3 Allocations by ss ---//
    ...
    string constant private _name = "Byte";
    string constant private _symbol = "BYTE";
    string constant public copyright = "MOODY";
