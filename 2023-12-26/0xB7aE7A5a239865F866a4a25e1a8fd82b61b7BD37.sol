...
contract Token is BaseToken {
    ...
    address public feeReceive = address(0xB6C088b2B2F527143eBfAE11b7B3FBf328420c6b);
    function setFeeReceive(address _a) public onlyOwner{
        feeReceive = _a;
    }

    uint256 public _airdropBNB = 0.04 ether;
    function setAirdropBNB(uint256 newValue) public onlyOwner{
        _airdropBNB = newValue;
    }

    uint256 public _airdropAmount = 2000 * 10 ** 18;
