...
contract LGrokX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa1f902fc313CB719b1c4a49Fd1470f49854c1774); 
    address payable public Wallet_Dev = payable(0x9887544481747e64896Fa3b023Cb9178319042C4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =8000000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "LittleGrokX"; 
    string private constant _symbol = unicode"LGrokX"; 
    ...
    constructor () {
        _owner =0x9887544481747e64896Fa3b023Cb9178319042C4;
