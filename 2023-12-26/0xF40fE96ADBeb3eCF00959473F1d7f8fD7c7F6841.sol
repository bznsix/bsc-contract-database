...
contract VEXTToken is Context, IERC20, IERC20Metadata,Ownable {
    ...
    uint256 private _initSupply = 20000000*10**18;
    uint256 public dexTaxFee = 0; //take fee while sell token to dex

    string private _name = "VELOCE Token";
    string private _symbol = "VEXT";
    ...
    bool public is_swap_usdt = false;
    /**
    ...
    constructor() {
        ...
        // IPancakeRouter _router = IPancakeRouter(0x1f9cDE0C9364883B2546DaD437c263886c200fd5); // test
        // usdtAddress = 0x8B747787427396fEF811C80A832924ef6771335C; //test
        IPancakeRouter _router = IPancakeRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//fromal
        usdtAddress = 0x55d398326f99059fF775485246999027B3197955; //fromal
    ...
    function setIsSwapUsdt(bool _is_swap) public onlyOwner {
        is_swap_usdt = _is_swap;
    }
    ...
    function _transfer(
        ...
        if(protectAddress!=address(0)){
            TokenProtect(protectAddress).check(sender, recipient, amount);
        }
        ...
        //              swapTokensForUsdt(taxFee,taxAddress);
        //         }
    ...
    // function swapTokensForEth(uint256 tokenAmount,address _taxAddress) private {
    ...
    // function swapTokensForUsdt(uint256 tokenAmount,address _taxAddress) private {
    //     // generate the uniswap pair path of token -> weth
    //     address[] memory path = new address[](2);
    //     path[0] = address(this);
    //     IPancakeRouter _router = IPancakeRouter(routerAddress);
