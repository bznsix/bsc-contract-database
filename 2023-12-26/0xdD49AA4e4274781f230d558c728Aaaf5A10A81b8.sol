...
contract D1 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 140000000000 * (10**18);
    ...
    address payable public marketingWallet = payable(0xd56c18b346159Cc268A07bA99e5A7d8ce5D68E54);
