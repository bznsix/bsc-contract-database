...
contract InversePunk is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.0009 ether;
    uint256 public maxMints = 3333;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmX8ZirLjj3wMfrhMAUPt1bPFfz5j42kNGR4CTroGcUave/", Strings.toString(tokenId), ".json")
            );
    }
