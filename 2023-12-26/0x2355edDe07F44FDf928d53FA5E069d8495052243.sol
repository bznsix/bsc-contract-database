/*
// 🌐 WEBSITE: https://WhippetInu.com
// ☎️ TELEGRAM: https://t.me/WhippetInu
// 🐤 TWITTER/X: https://twitter.com/WhippetInuToken
*/
...
contract Whippet_Inu is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"Whippet Inu", unicode"WHIP") 
    {
        address supplyRecipient = 0x84846ef10E3319d9ab81C181c3d0b3549502aFC9;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x84846ef10E3319d9ab81C181c3d0b3549502aFC9);
        marketingFeesSetup(300, 300, 0);

        autoBurnFeesSetup(300, 300, 0);

        _deployDividendTracker(43200, 100000 * (10 ** decimals()) / 10);
        ...
        _transferOwnership(0x84846ef10E3319d9ab81C181c3d0b3549502aFC9);
    }
