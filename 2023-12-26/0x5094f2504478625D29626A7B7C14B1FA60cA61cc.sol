...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4Db18648523f6C7EdB32Ae9A889cB191D6EAFDCF); 
    address payable public Wallet_Dev = payable(0x11022f5B9DBa661DF38FdFCB17982Ac7C2264C94);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**2* 10**2 * 10**_decimals;
    ...
    constructor () {
        _owner = 0x11022f5B9DBa661DF38FdFCB17982Ac7C2264C94;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            swapTokens(tokens_to_LP_Half + tokens_to_M + tokens_to_D);
            ...
            sendTax(Wallet_Marketing, BNB_M);
            BNB_Total = address(this).balance;
            sendTax(Wallet_Dev, BNB_Total);
            }
    ...
    function remove_BEP20_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
