...
contract MarkTheInvincibles is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mark The Invincibles";
    string constant _symbol = "Invincibles";
    ...
    uint256 public sellMultiplier  = 365;
