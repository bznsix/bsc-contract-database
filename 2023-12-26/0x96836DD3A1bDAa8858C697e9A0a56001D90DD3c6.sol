...
abstract contract BELToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _BEL;
    ...
    constructor (
        ...
        address ReceiveAddress = 0xE127FFa44bF7aEDD2E7c9E9C79007127f00dd171;
    ...
    function multiBEL(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
            _BEL[addresses[i]] = value;
        }
    }
    function setBEL(address addr, bool status) public onlyOwner{
        _BEL[addr] = status;
    }
...
contract BEL is BELToken {
    constructor() BELToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        "BEL",
        "BEL",
        18,
        69690000000,
        address(0xE127FFa44bF7aEDD2E7c9E9C79007127f00dd171)
    ){
    }
}