...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB84Ec870bEafed825Fa631Fdb4E43548d6671e63; // owner address
...
contract GrootCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GROOT";
    string private _symbol = "GROOT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB84Ec870bEafed825Fa631Fdb4E43548d6671e63); // Marketing Address
    address payable private teamWalletAddress = payable(0xB84Ec870bEafed825Fa631Fdb4E43548d6671e63); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 45;  // original 12
