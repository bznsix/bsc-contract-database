...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x327d78364cb2DaFd6d26646FF717EFa99E9D350b; // owner address
...
contract INFINITY is Context, IERC20, Ownable {
    ...
    string private _name = "INFINITY";
    string private _symbol = "INFNT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x327d78364cb2DaFd6d26646FF717EFa99E9D350b); // Marketing Address
    address payable private teamWalletAddress = payable(0xC0C3A1FA84DA9E7a21301dbcC76864e6D92B8D42); // Team Address
