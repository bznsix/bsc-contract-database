...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xADA1E64A132FbAcB76f2CA81A6d075D403A1b62B; // owner address
...
contract $BNB is Context, IERC20, Ownable {
    ...
    string private _name = "Build N Build";
    string private _symbol = "$BNB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xADA1E64A132FbAcB76f2CA81A6d075D403A1b62B); // Marketing Address
    address payable private teamWalletAddress = payable(0xADA1E64A132FbAcB76f2CA81A6d075D403A1b62B); // Team Address
