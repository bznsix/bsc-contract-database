...
contract BABYORDITOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Babyordi";
    string private _symbol = "Babyordi";
    ...
    address payable public marketingWalletAddress = payable(0x3790F3f4e58402e816849D338FcBA675E8C223fB

);
    address payable public liquidityWalletAddress = payable(0x3790F3f4e58402e816849D338FcBA675E8C223fB
    ...
    uint256 public _walletMax = 21000000 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                //     finalAmount=amount.mul(1).div(100);
                // }
            }
