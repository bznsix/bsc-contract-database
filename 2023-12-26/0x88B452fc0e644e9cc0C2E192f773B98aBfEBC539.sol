...
Telegram: https://t.me/SolariumProtocolBSC
Twitter: https://twitter.com/SolariumBSC
Github: https://github.com/SolariumProtocol

Solarium Protocol endeavors to establish a secure, scalable, and sustainable Layer 1 blockchain that not only meets 
the demands of decentralized applications but also advances environmental consciousness within the blockchain space. 
Our mission is to set new standards for security, scalability, and sustainability, defining a blueprint for the 
...
contract SolariumProtocol is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000e6 * 10**_decimals;
    ...
    address public marketingAddress = 0xf9Ba7834D503f191002DEc4e3be5810F996f9E46;
    address public devAddress = 0xf9Ba7834D503f191002DEc4e3be5810F996f9E46;

    string private constant _name = "Solarium Protocol";
    ...
    Taxes public taxes = Taxes(0,5,3,2);
    Taxes public sellTaxes = Taxes(0,5,3,2);
