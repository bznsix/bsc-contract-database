...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbf9eBdA6904631D2Be17020282289a52C477A6EE; // owner address
...
contract EnjoyWeekend is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Enjoy Weekend";
    string private _symbol = "Weekend";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbf9eBdA6904631D2Be17020282289a52C477A6EE); // Marketing Address
    address payable private teamWalletAddress = payable(0xbf9eBdA6904631D2Be17020282289a52C477A6EE); // Team Address
