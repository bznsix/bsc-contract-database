...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 810;
    uint256 public _buyRewardFee = 860;
    uint256 public _buyLPDividendFee = 10;
    uint256 public _buyLPFee = 10;

    uint256 public _sellDestroyFee = 10;
    uint256 public _sellFundFee = 810;
    uint256 public _sellRewardFee = 860;
        ...
        if (takeFee) {
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        feeAmount += destroyAmount;
                        _takeTransfer(sender, address(0x3724661874730Bb19B950529264603baff716c38), destroyAmount);
                    }
                }
...
contract Test is AbsToken {
    constructor() AbsToken(
        ...
        18,
        420000000000000,
        address(0x88245D0B6f20396DB179c48AF3010Ba802fbd88b),
        address(0xEBEcDD601be6B087f508637d0e8f51F4c8aAbD5C),
        address(0x3724661874730Bb19B950529264603baff716c38),
        420000000000000,
        0,
        420000000000000
    ){
