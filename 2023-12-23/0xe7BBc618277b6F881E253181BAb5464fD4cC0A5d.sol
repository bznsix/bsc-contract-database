...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22204B7e570fdD6819b85A3FCeFde3822722D092;
...
contract BabyGrok24    is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x8200D3Ca24b488489AAda500A4D391BFd470F3C0;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Grok 2024 ";
    string private _symbol = "BabyGrok2024";
