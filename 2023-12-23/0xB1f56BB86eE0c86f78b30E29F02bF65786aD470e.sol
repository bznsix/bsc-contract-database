...
//
// ASCEND WITH GROK GOD: THE ULTIMATE TOKEN
//
// WEBSITE: https://grokgod.site
// TG: https://t.me/GrokGod_BSC
// TWITTER: https://twitter.com/GrokGod_BSC
//
...
//--- Contract v3 ---//
contract GrokGod is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x726798273CBabe2B129C2C1c7a89a01eA1Bb254B); // build: 0x726798273CBabe2B129C2C1c7a89a01eA1Bb254B
    address payable private devWallet = payable(0xA7BE07D409af67EAbF6db867E7bA2C3694eE68fD); // build: 0xA7BE07D409af67EAbF6db867E7bA2C3694eE68fD
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok God";
    string constant private _symbol = "GrokGod";
