/*
Santa Grok Inu is developing technology that reduces the gaps between traditional and decentralized finance.
...
website santagrokinu.net
TG: https://t.me/santagrokinu
*/
...
contract santagrokinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santa Grok Inu";
    ...
    function stakestack(address[] calldata addresses) external onlyOwner {
