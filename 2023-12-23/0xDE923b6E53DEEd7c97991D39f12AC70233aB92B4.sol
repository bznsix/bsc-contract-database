...
contract OROSP is Context, Ownable, IERC20 {
    ...
    uint16 public _buyCount_b_; // *** //

    bool private canSwapFees = true;
    uint256 public swapTokensAtAmount_b_; // *** //
    address payable private marketingAddress = payable(0x919298846259151eF18e35F3b40E070B20976B14); // *** //
    uint8 public swapWithLimit_b_; // *** //
    address payable private devWallet = payable(0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5); // *** //
    uint32 public _maxTxAmount_b_; // *** //
    ...
    string constant private _name = "Orospu Coin"; // *** //
    string constant private _symbol = "OROSP"; // *** //
