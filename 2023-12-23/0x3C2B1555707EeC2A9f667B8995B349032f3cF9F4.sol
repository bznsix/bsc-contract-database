...
abstract contract Token is IERC20, Ownable {
    ...
    function setNumToSell(uint256 a) external onlyFunder {
        numToSell = a;
    }
}

contract SUBT is Token {
    constructor()
        Token(
            //router
            ...
            500,
            //fund
            address(0xc1e5112267CC61C2407B3C22BfFcfF3015b97289),
            //receive
            address(0xBccf3E3709210c70Dec274BeD47f3b30C2F312d8)
        )
    {}
}