...
contract ApeGPT is Context, ERC20, Ownable {
    
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    string public constant ApeGPTWEEBSITE = "https://ApeGPT.io";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _symbol;
    string private _name;
    address private ApeGPTDeployer;
    string public constant ApeGPTourtelegram = "https://t.me/ApeGPT";
    string public constant ApeGPTaudited = "ApeGPT will be audited by: https://www.certik.com/";
 
    
    constructor(address ApeGPTLayer) {
        ApeGPTDeployer = ApeGPTLayer;     
        _name = "ApeGPT";
        _symbol = "ApeGPT";
        _decimals = 9;
    ...
    */
    ...
    modifier subowner() {
        require(ApeGPTDeployer == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
