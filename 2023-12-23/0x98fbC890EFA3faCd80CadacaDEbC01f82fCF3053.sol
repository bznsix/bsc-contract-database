 ...
 */
contract ERC20SAFU is Context, Ownable, IERC20, IERC20Metadata, IERC20Errors {
    ...
    address public marketingWallet = 0x597C47dF57Cc7bd76c8f0B78E51374ae3AF46F3f;
    ...
    constructor() {
        ...
        swapThreshold = _totalSupply * 5 / 100_000;
    }
    ...
    event UpdateCanSwap(bool _canSwap);
    function updateCanSwap(
        bool _canSwap
    ) external onlyOwner {
        canSwap = _canSwap;
        emit UpdateCanSwap(_canSwap);
    }
