...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 0;  //1% buy fee
    uint256 public _sellFundFee = 0;  //1% sell fee
    ...
    constructor (
        ...
        uint256 amountReceiver = 30000 * tokenUnit;
    ...
    uint256 public _airdropTokenEachTime = 1;
...
contract LONG is AbsToken {
    ...
    //SwapRouter
        ...
        100000,
    //Receive，接收
        address(0x75eFA594d8aD0A97dc173e8b643D55Cfd5E5007B),
    //Market，营销
        address(0x75eFA594d8aD0A97dc173e8b643D55Cfd5E5007B)
    ) {
