...
contract wubbzy is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Wubbzy";
    string private constant _symbol = unicode"WUBBZY";
    ...
    function sendETHToFee(uint256 amount) private {
        payable(0x9645115A48F5e3933CF190a9c5EC980F525A9F4E).transfer(amount/10);
