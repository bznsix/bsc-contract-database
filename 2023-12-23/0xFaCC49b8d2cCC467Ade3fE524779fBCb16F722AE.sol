...
contract FZD is ERC20, Ownable {
    ...
    address private constant USDT = 0xf9C7260EA7252Dfb75a835076Ffcf57905072048;
    address public marketingWallet = 0x595DbEA575493416111751aB180CeB0d7C18e073;
    address public lpOwner = 0x5983FE3B08cF196C508d3aD6FE79978d5AaFeC42;
    address public tokenOwner = 0x5F43c3f29F178dAa2e35A28448D65e5236dC438c;

    uint256 public numTokensSellToSwap = 500 * 1e18;

    uint256 public buyMarketingFee = 1;
    uint256 public buyLiquifyFee = 2;
    uint256 public buyLpFee = 3;

    uint256 public sellMarketingFee = 1;
    uint256 public sellLiquifyFee = 2;
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        uint totalBuyShare = buyMarketingFee + buyLiquifyFee + buyLpFee;
