...
contract EtherGrok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ether Grok";
    string private _symbol = "ETG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x397bbA778CC048cbb7B6B70f60Fa5b83257866C3); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x752E9041FFE073c4aFCd149c5652bc4B71Bdbda7); // Development Address
