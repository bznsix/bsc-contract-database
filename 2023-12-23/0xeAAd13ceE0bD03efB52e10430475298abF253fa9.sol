...
contract AddressRegistry {
    ...
    address public constant referralDataAddress = address(0x6248d9a3DFF17DcdA92141AA1e8F1E9d6fE1eA4A); //ReferralData
...
contract ElephantRouterProxy is Ownable {
    ...
    uint256 public constant processingFee = 85;
    uint256 public constant transferFee = 35;
    uint256 public constant referralFee = 5;
    uint256 public constant precision = 1000;

    IReferralData immutable public referralData;
    
    AddressRegistry  private registry;
    
    IERC20 immutable private coreToken;
    IUniswapV2Router02 immutable public  collateralRouter;
    ...
    constructor () public Ownable() {
        ...
        referralData = IReferralData(registry.referralDataAddress());
