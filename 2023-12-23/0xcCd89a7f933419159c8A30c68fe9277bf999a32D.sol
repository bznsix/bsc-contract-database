...
contract BreakMePlx is ERC20, Ownable {
    ...
    function Unstake1Month() public {
        require(_isStaked1Month[msg.sender] && block.timestamp >= _staked1MonthTimestamp[msg.sender] + 2 minutes,
    ...
    function Unstake3Months() public {
         require(_isStaked3Months[msg.sender] && block.timestamp >= _staked3MonthsTimestamp[msg.sender] + 4 minutes,
    ...
    function Unstake6Months() public {
         require(_isStaked6Months[msg.sender] && block.timestamp >= _staked6MonthsTimestamp[msg.sender] + 6 minutes,
