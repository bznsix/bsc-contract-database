...
// SPDX-License-Identifier: Unlicensed
 ...
 // Telegram : https://t.me/BONKYATCHCLUBBSC
...
contract BONKYATCHCLUB is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BONK YATCH CLUB";
    string private _symbol = "BYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93640B4DF605AA2DD4EeEe3C69bEB684d82C1b91); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x93640B4DF605AA2DD4EeEe3C69bEB684d82C1b91); // BuyBack Address
    ...
    uint256 public _buyBuyBackFee = 10;
