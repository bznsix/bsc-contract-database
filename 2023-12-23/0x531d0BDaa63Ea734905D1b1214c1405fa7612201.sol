...
contract DIGITALPAYToken is IBEP20 {
...
contract DIGITALPAYUSDT {
    address payable admin;
    DIGITALPAYToken public tokenContract;
    ...
    constructor(DIGITALPAYToken _tokenContract, uint256 _tokensSold)  {
