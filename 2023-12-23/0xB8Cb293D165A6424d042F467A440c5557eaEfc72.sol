...
contract burnAirdrop is Context{
    using SafeMath for uint256;
    uint256 private constant _value = 0.004 * 10**18;
    uint256 public totalDroped;
    uint256 public threshold;
    uint256 private constant _deployAmount = 0.4 * 10 ** 18;
    ...
    bool inits = false;
    constructor(){}
    function init(address burnedFiAddr,address routeAddr,address lpAddress)  public{
...
contract rats is ERC20, Ownable {
    ...
    burnRewardHold public burnHolder= burnRewardHold(0x99aC7F519f3711dEB0664963Fb53B14253375ade);
    mapping(address => bool) _excludedFees;
    uint256 public minBalanceSwapToken = 2 * 10 ** 18;
    bool swapIng;
    ...
    constructor() ERC20("rats", "rats") {
        ...
        _airdrop.init(address(this),address(_uniswapV2Router),address(burnHolder));
        ...
        _mint(address(_airdrop), 21000 * 10 ** 18);
    }
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool) {
        ...
        if (amountToBurn > 0) {
            super._transfer(uniswapPair, address(burnHolder), amountToBurn);
        }
