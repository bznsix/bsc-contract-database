...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _balances[ReceiveAddress] = 500000 * 10 ** 18;
        _balances[address(this)] = 3000000 * 10 ** 18;

        emit Transfer(address(0), ReceiveAddress, 500000 * 10 ** 18);
        emit Transfer(address(0), address(this), 3000000 * 10 ** 18);
        ...
        feeReceive = 0xCE2B08e3A76500AE73dc4a83fAe9F61fe4D04DE8;
    ...
    uint256 public _airdropAmount = 10 * 10 ** 18;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        3500000,
        address(0xB43FD1A465C2075F527B2021247De0434381D9aB),
        address(0xa4D5a14Ec22D2724914e94051F6A737E2dB3D8d6),
        address(0x9fC53feaC7B8772FC70D2A1484c58A1b473250B8)
    ){}
}