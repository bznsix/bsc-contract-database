...
contract PEPEDD is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public constant name     = "Pepe X";
    string public constant symbol   = "PEPEX";
    ...
    // sell fee
    uint256 public _taxFeeSell       = 4000; 
    uint256 public _liquidityFeeSell = 4000; 
    uint256 public _marketingFeeSell = 2000; 
