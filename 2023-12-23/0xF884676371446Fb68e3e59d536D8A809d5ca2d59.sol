...
contract BeeAirdrop {
    ...
    uint256 private constant _singleAmount = 10 * 10 ** 18; 
    uint256 private constant _deployAmount = 7 * 10 ** 18;
    uint256 private constant _poolAmount =  36000* 10 ** 18; 
    uint256 private constant _mintableAmount = 40000 * 10 ** 18;
