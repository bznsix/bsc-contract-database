//SPDX-License-Identifier: MIT
   ...
   contract UPPTC is IERC20, Ownable, ReentrancyGuard {
   
       using SafeMath for uint256;
   
       // token data
       string private constant _name = "UP PTC";
       string private constant _symbol = "upPTC";
       ...
       uint8 private _decimalAdjustment;
       ...
       constructor(address underlying_, address feeReceiver_, uint8 underlyingDecimals_) {
           require(
           ...
           // Initialize Decimal Adustment for backing token
           _decimalAdjustment =  18 - underlyingDecimals_;
       ...
       */
       ...
       function underlyingBalance() public view returns (uint256) {
            ...
            if (_decimalAdjustment > 0 ) {
                return (underlying.balanceOf(address(this)).mul(10**(_decimalAdjustment)));
            }
            else {
       ...
       /** 
           ...
           Must Be Within Bounds ( Between 0% - 20% ) 
       */
       function setFees(uint256 _mintFee, uint256 _transferFee, uint256 _sellFee, uint256 _contractFee) external onlyOwner {
           require(_mintFee >= 80000);       // capped at 20% fee
           require(_transferFee >= 80000);   
           require(_sellFee >= 80000);       
           require(_contractFee >= 80000);   
