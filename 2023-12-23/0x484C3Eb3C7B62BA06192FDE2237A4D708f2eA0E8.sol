...
contract vonk is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Vonk Clause";
    string private constant _symbol = unicode"VKS";
