...
/**
The Grinch is here for a green christmas chart!
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6c13322E9Dd0c6d76248eaC5B01f43d9afF870A3; // owner address
...
contract Grinch is Context, IERC20, Ownable {
    ...
    string private _name = "Grinch";
    string private _symbol = "GRN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB0c69Ed4aE44ff3b779A25b96fB2d0B826a0F455); // Marketing Address
    address payable private teamWalletAddress = payable(0x6c13322E9Dd0c6d76248eaC5B01f43d9afF870A3); // Team Address
