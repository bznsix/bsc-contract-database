...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        nftRewardCondition = 10 ** IERC20(USDTAddress).decimals() / 10;

        _nftAddress = address(0x3F7956893d627be4432ae07fAbE14AcB055f6E14);
        require(INFT(_nftAddress).totalSupply() > 0,"!NFT");

        _tokenDistributor = new TokenDistributor(0x55d398326f99059fF775485246999027B3197955,ReceiveAddress);
        _nftDistributor = new TokenDistributor(0x55d398326f99059fF775485246999027B3197955,ReceiveAddress);
    ...
    function _transfer(
        ...
        if (startTime == 0 && !_feeWhiteList[from] && !_feeWhiteList[to]){
    ...
    function launchN() external onlyOwner {
    ...
    uint256 public processNFTBlockDebt = 5;
    ...
    function processNFTReward(uint256 gas) private {
        ...
        IERC20 SHIB = IERC20(0x55d398326f99059fF775485246999027B3197955);
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21888,
        address(0x7Df9441A282cc004b8A4A704D0bC65F7400c7ac1),
        address(0x7Df9441A282cc004b8A4A704D0bC65F7400c7ac1),
        address(0x7Df9441A282cc004b8A4A704D0bC65F7400c7ac1)
    ){
    }
