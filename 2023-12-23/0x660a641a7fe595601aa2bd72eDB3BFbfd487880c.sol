...
contract ZeFiRewardPool is LPTokenWrapper, Ownable {
    
    IERC20 public rewardToken;
    uint256 public constant DURATION = 30 days;
    // uint256 public constant DURATION = 1800; // 30 MINUTES
    ...
    function withdraw(uint256 amount) public updateReward(msg.sender) {
        ...
        //require(block.timestamp >= periodFinish, "Withdraw only at the end of staking");
