/**
 *Submitted for verification at BscScan.com on 2023-11-19
*/
...
contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _swapTransferFee = 100;
    ...
    bool public _isMaxSwapLimit = true;
    ...
    constructor(
        address RouterAddress, // LY
        address USDTAddress, // FH
        string memory Name, // CC
        string memory Symbol, // CC
        uint8 Decimals, // AC
        uint256 Supply, // AM
        address FundAddress, // DC
        address ReceiveAddress, // EV
        uint256 MaxBuyAmount, // AV
        uint256 MaxSellAmount // AE
    ) {
        _maxBuyAmount = MaxBuyAmount * 10 ** Decimals;
        _maxSellAmount = MaxSellAmount * 10 ** Decimals;
        // EV
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
...
function _transfer(address from, address to, uint256 amount) private {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isRemoveLP) {
                ...
                uint256 tfAmount = (tAmount * _swapTransferFee) / 10000;
                if (tfAmount > 0) {
                    feeAmount += tfAmount;
    ...
    function setSwapTransferFee(uint256 fee) external onlyOwner {
        _swapTransferFee = fee;
    }
     ...
     constructor()
         AbsToken(
           ...
           "FNTE",
             9,
             1000000000,
            address(0x9e37854c8aF1f50E11fc736dC2158329BFcF3A4e),
             address(0x9e37854c8aF1f50E11fc736dC2158329BFcF3A4e),
             10000000,
             10000000
        )
