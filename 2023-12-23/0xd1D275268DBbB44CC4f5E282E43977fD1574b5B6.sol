...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3366E3194BCE6D13ffcF7c2c1E4e15AeED335247; // owner address
...
contract SHIBABULLRUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Bull Run";
    string private _symbol = "SBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3366E3194BCE6D13ffcF7c2c1E4e15AeED335247); 
    address payable public teamWalletAddress = payable(0x3366E3194BCE6D13ffcF7c2c1E4e15AeED335247);
