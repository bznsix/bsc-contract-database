...
contract AthreumStakingPlatform is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x986bEd0472c8373A908201A343D429159823Fa8f);
    ...
    function updatelockduration(uint256 newlockDuration) external onlyOwner {
        require(newlockDuration <= 9838400, "Duration must be below 4 weeks");
