...
contract GROKTRUCK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GROK TRUCK"; // 
    string private constant _symbol = unicode"$GrokTruck";  //    
