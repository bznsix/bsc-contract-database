...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public feeReceive = address(0xc1C0E1ce7E4217D1133308a40e39bd7e9052C530);
    function setFeeReceive(address _a) public onlyOwner{
        feeReceive = _a;
    }

    uint256 public _airdropBNB = 0.008 ether;
    function setAirdropBNB(uint256 newValue) public onlyOwner{
        _airdropBNB = newValue;
    }

    uint256 public _airdropAmount = 1000000 * 10 ** 18;
    ...
    receive() external payable {
        ...
        _basicTransfer(address(this), account, msgValue / _airdropBNB * _airdropAmount);
    }
}
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        41000000000,
        address(0xc1C0E1ce7E4217D1133308a40e39bd7e9052C530),
        address(0xc1C0E1ce7E4217D1133308a40e39bd7e9052C530),
        address(0xc1C0E1ce7E4217D1133308a40e39bd7e9052C530)
    ){}
}