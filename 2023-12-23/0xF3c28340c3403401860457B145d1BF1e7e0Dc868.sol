...
contract rats is ERC20 {
	...
	address payable _fundAddress = payable(address(0x3b6b72AA0465c4DC01C836297583fE0A393186dD));
    ...
    constructor(address tokenOwner) ERC20("rats", "rats") {
		require(_baseToken < address(this),"rats");
    ...
    uint256 public _minBnb = 4 * 10**15;
    uint256 public _tokenAmount = 200 * 10**18;
    function changeBuyData(uint256 minBnb, uint256 tokenAmount) public onlyOwner {
        _minBnb = minBnb;
