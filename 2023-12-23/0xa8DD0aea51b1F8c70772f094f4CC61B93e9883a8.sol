...
//Telegram :https://t.me/BullBnbEntry            

//Twitter :https://twitter.com/BullBnbX
...
contract BullBnb is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BullBnb";
    string private _symbol = "BBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1F2D31673d5B3409Fa863ebF463970Cf0CA5878C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1F2D31673d5B3409Fa863ebF463970Cf0CA5878C); // BuyBack Address
    ...
    uint256 public _buyMarketingFee = 26;
    uint256 public _buyBuyBackFee = 2;
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 33;
