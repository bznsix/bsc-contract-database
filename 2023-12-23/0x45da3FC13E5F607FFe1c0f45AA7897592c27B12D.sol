...
contract AMPERToken is Context, AccessControlEnumerable, ERC20, ERC20Burnable, ERC20Pausable {
    ...
    function adminBurn(address account, uint amount) public onlyRole(BURN_ROLE) {
        _burn(account, amount);
    }
}