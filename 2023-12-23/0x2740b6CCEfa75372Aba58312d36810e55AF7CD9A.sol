            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xB268D1043bac13e0C485Bb30E4cF8430d6Bb1f98), destroyAmount);
                    }
                }
...
contract DaddyDoge is AbsToken {
    constructor() AbsToken(
        ...
        address(0xB268D1043bac13e0C485Bb30E4cF8430d6Bb1f98),
        address(0xB268D1043bac13e0C485Bb30E4cF8430d6Bb1f98),
        420000000000000000,
        0,
        420000000000000000
