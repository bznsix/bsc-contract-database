...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    uint256 public _bbtime = 5*60;
    mapping (address=>uint) public addLPTime;

    constructor(){
            address admin;
            address router;
            admin = 0x90F7Ca5Db6f8671707c76e2bd5672d69D36eC813;
           ...
           // _intervalSecondsForSwap =  90 days;
            ...
            _symbol = "JXL";
            _decimals= uint8(18);
            _tTotal = 80000000 * (10**uint256(_decimals));
            _tOwned[admin] =  20200000* (10**uint256(_decimals));
            _tOwned[address(this)] = 59800000* (10**uint256(_decimals));
            ...
            emit Transfer(address(0x8894E0a0c962CB723c1976a4421c95949bE2D4E3), admin,  _tTotal);
   ...
   // uint public ddd = 200000e18;
    ...
    function getMintNum() internal returns(uint num){
        ...
        if(balanceOf(address(this))<=1500e18){
            num =  balanceOf(address(this));
        }else{
            num = 1500e18;
        }
    }
