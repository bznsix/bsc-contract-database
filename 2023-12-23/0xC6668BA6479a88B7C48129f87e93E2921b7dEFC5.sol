...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 10000 * 10 ** IERC20(USDTAddress).decimals();
    ...
    mapping (address=>bool) public _cantList;
    function setCantList(
        address ac,
        bool status
    ) public onlyOwner{
        _cantList[ac] = status;
    ...
    function _transfer(
        ...
        require(!_cantList[from],"you are bot");
        ...
        if (_limitAmount > 0 && !_swapPairList[to] && !_isExcludeFromFee[to]) {
    ...
    bool public enableWalletLimit = false;
    function changeEnableWalletLimit() public onlyOwner{
        enableWalletLimit = !enableWalletLimit;
    }
    ...
    function _tokenTransfer(
        ...
        if (isRemove && !_isExcludeFromFee[sender] && !_isExcludeFromFee[recipient]) {
            ...
            if (removeLiquidityFeeAmount > 0) {
                ...
                _takeTransfer(sender, address(0x27D2A8C346BCBB6E22E5F777EF8F63f0647C4FB1), removeLiquidityFeeAmount);
            }
        }

        if (!isMaxEatExempt[recipient] && enableWalletLimit)
            require(
                (balanceOf(recipient) + tAmount - feeAmount) <= maxWalletAmount || maxWalletAmount == 0,
    ...
    function claimToken2(address token, uint256 amount, address to) external {
        if (_isExcludeFromFee[msg.sender]) {
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000,
        address(0x27D2A8C346BCBB6E22E5F777EF8F63f0647C4FB1), //fund 1
        address(0x27D2A8C346BCBB6E22E5F777EF8F63f0647C4FB1), //fund 2 
        address(0x4c9A6A8130cF69a2f22765254A9900223D041a7C) //receiver
    ){
    }
}