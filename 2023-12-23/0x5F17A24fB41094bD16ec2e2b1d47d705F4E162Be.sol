...
contract BabyBefe is Context, IERC20, Ownable {
    ...
    using Address for address;
       ...
       string private _name = "Baby Befe";
    string private _symbol = "BABYBEFE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0dc62ad41E3D6c4A09891a2D40cd7F21cC17b998); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0dc62ad41E3D6c4A09891a2D40cd7F21cC17b998); // Development Address
    ...
    uint256 public _DevelopmentShare = 5;
    ...
    uint256 public _maxTxAmount = 2 * 10**9 * 10**18;
    uint256 public _walletMax = 2 * 10**9 * 10**18;
    uint256 private minimumTokensBeforeSwap = 25000 * 10**18; 
