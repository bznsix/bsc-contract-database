...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellAddLiquifyFee = 50;
    ...
    constructor (
        ...
        uint256 total = 1000000000 * tokenUnit;
        _tTotal = total;
        ...
        fundAddress = address(0xc4325B5915dB79A30481294f841a67A38b48f01f);
        fundAddress_2 = address(0xE3E307C9F20CAB40827b860F45384858997e7252);
        ...
        tokenHoldContdition = 0;

        _preFeeConfigs.push(PreFeeConfig(100, 1 days));
        _preFeeConfigs.push(PreFeeConfig(100, 10000 days));
    }
...
contract BTF is AbsToken {
    ...
    //Receive
        address(0xf1F05af6145A913ce48A619B4F162C04962c44bb)
    ){
