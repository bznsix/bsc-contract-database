...
contract VODYA is Context, Ownable, IERC20 {
    ...
    uint64 public _buyCount_b_; // *** //

    bool private canSwapFees = true;
    uint32 public swapTokensAtAmount_b_; // *** //
    address payable private marketingAddress = payable(0xc5c00b458410FDE52c6AcD2581A31c3F0935a4D4); // *** //
    uint128 public swapWithLimit_b_; // *** //
    ...
    string constant private _name = "Vodyanoy Token"; // *** //
    string constant private _symbol = "VODYA"; // *** //
