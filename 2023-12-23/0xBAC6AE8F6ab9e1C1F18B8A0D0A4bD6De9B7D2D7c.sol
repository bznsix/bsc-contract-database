...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDF96917e247Bf561942b822f2306eE06190E0105; // owner address
...
contract $TOTO is Context, IERC20, Ownable {
    ...
    string private _name = "TOTO Coin";
    string private _symbol = "$TOTO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe80EEBFeA656a380DAaB8Fd96C83C0f3833e4Cc5); // Marketing Address
    address payable private teamWalletAddress = payable(0xDF96917e247Bf561942b822f2306eE06190E0105); // Team Address
