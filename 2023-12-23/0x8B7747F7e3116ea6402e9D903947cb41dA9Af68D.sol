...
contract MetaTest is IBEP20, Auth {
    ...
    string constant _name = "MetaRealm";
    string constant _symbol = "MCREDIT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_00 * (10 ** _decimals);
    ...
    uint256 operationsFee = 100; // Ingame Operations / Buybacks
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setFees(uint256 _liquidityFee, uint256 _operationsFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        operationsFee = _operationsFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_operationsFee).add(_reflectionFee).add(_marketingFee);
