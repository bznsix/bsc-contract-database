...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        walletLimit =  100000000000000000 * 10** Decimals;
        ...
        holderRewardCondition = 0 ** IERC20(FISTAddress).decimals();
    ...
    function setMaxAmount(uint256 _maxTxAmount) public onlyOwner{
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 98 / 100;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= maxTxAmount,"over max buy amount");
            } else {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress2, fundAmount_B);
...
contract Grok is AbsToken {
    constructor() AbsToken(
        ...
        6,
        10000000000,
        address(0x23064468185C62C373907c1780a92E0D8A0fd42B),
        address(0x23064468185C62C373907c1780a92E0D8A0fd42B),
        address(0x3D00b66B50B458F6896f49457481960d67C72664)
    ){}
