 ...
 *
 * Works in tandem with a EthlasProxyBasedOFT.sol. For use on NON-BASE chains.
 * It burns tokens on send(), and mints on receive tokens form other chains.
 *
 */
contract ElsOFT is OFT, RegistryClient {
    ...
    ) public payable virtual override(IOFTCore, OFTCore) {
