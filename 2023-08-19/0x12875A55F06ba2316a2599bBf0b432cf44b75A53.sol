...
/**
 // Telegram : https://t.me/FixedBSC
This contract is made to help developers add liquidity providers. Please check the telegram channel for information and how to use it
...
contract FixedAddLP {
    address payable public feeRecipient = 0x4f57B1aEC284CF08C9Fd219B550f988230E9C4E5;
    uint256 public feeAmount = 0.03 ether;  // 0.03 BNB fee, using the ether unit for simplicity in Solidity.
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function FixedAddLiquidity (address _tokenA, uint256 _amountTokenA) external payable {
