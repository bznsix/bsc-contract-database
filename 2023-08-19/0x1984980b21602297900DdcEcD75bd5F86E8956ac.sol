...
Telegram https://t.me/exabytebsc
Website 
*/
...
contract exabyte is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EXABYTE";
    string private _symbol = "$XBT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8c40Bbd1710fA16A1Ac0ABeA8a4f57F4042c5023); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8c40Bbd1710fA16A1Ac0ABeA8a4f57F4042c5023); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 200 * 10**4 * 10**9;
