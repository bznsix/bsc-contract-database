...
Grokzilla is an BEP20 token built on the Binance Smart Chain that draws inspiration from the concept of "grok” 
and from the dragon robot built by Elon Musk.
...
contract GROKZILLA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GROKZILLA";
    string private constant _symbol = unicode"$GZILLA";
    ...
    address payable public DevWallet = payable(0xCA766Cd0EAB2f13F69fc9c31db6a507c22d3Ea1F);
    address payable public MarketingWallet = payable(0x3ebcFbf50C9beDba9712b9c6dCc8910A18983400);
    ...
    function setTax(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
