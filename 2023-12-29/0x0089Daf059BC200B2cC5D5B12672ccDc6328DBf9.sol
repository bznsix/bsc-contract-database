...
contract BNBFISH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB FISH";
    string private _symbol = "BNBFISH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x779e744EafA37468BbE95C2cBca781A39DB49893); // Marketing Address
    address payable public teamWalletAddress = payable(0x779e744EafA37468BbE95C2cBca781A39DB49893); // Team Address
