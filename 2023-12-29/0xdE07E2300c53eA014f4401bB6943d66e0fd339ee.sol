...
contract HashToken is ERC20, Ownable {
    ...
    uint8 decimal = 18;
    uint256 private _totalSupply = 300000 * 10 ** decimal; //发币总量
    uint256 private mintTotalSupply = 2099800000 * 10 ** decimal;
   ...
   function _transfer(address from,address to,uint256 amount) internal virtual override {
        ...
        if(!_isExcludedFromFees[to] && !_isExcludedFromFees[from]){
            ...
            if(from == pairContractAddress ){ //买入
                require(num >= 5000 , "Insufficient currency holding address, unable to purchase");
