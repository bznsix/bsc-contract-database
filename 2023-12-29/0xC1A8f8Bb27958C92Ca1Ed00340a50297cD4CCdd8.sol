...
contract GrokBank is ERC20, Ownable {
    ...
    uint256 constant public buyfee = 5;
    ...
    address public marketingAddress = address(0x9B17F5619e68fad475fC53Eae65a44E853b892D2);
    ...
    constructor() payable ERC20("Grok Bank", "GrokBank") {
    ...
    function _transfer(
        ...
        if(canSwap && !swapping && to == lpPair && buyfee + sellfee > 0
            ...
            if(contractTokenBalance > 0) {
                swapAndLiquify(contractTokenBalance * 125 / 1_000);
                ...
                try swapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
                    ...
                    block.timestamp) {}
                        ...
                        uint256 mkt = address(this).balance * 3 / 5;
                        uint256 USDTRewards = address(this).balance * 2 / 5;
                        bool success;
                        if(mkt > 0) {(success,) = marketingAddress.call{value: mkt, gas: 35000}("");}
                        if(USDTRewards > 0) {swapAndSendDividends(USDTRewards);}
            }
