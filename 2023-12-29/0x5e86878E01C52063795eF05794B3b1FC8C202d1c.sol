...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a1524aba128C02847a39Fe004BdF520FF6C38F4; // owner address
...
contract LONGYUE24 is Context, IERC20, Ownable {
    ...
    string private _name = "LONGYUE24";
    string private _symbol = "$LY24";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x173b7627BdD2B8cA081987Ea0C853c2f61cDe17d); 
    address payable public teamWalletAddress = payable(0x4e19750f8E32D10cA820C220EFB134b3bf925BE7);
