...
contract CloudPOWNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("CloudPOW", "CloudPOW") {
       
    }
	
	function admintBurn(address user, uint256 tokenId) public onlyMinter returns(bool){
        _burn(user,tokenId);
        return true;
    }
}