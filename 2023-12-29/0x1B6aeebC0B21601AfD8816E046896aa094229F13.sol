...
contract MTFPresale is Ownable {
    ...
    address public wallet = payable(0x71c72ab6268979eDC9716257F560eE746233e0f0);

    // How many token units a buyer gets per BNB & USDT
    uint256 private bnbRate = 115000;
    uint256 private usdtRate = 500;
    ...
    function buyTokens() public payable {
        ...
        require(msg.value >= 0.005 ether, "cant buy less with than 0.005 BNB");
        require(20 ether >= msg.value, "cannot buy with more than 20 BNB");
    ...
    function claimTokens() public {
        ...
        uint256 bonus = Customer[msg.sender].referrerBonus;

        uint256 finalAmount = amount.add(bonus);

        token.safeTransfer(msg.sender, finalAmount);

        Customer[msg.sender].tokensBought = 0;
        Customer[msg.sender].referrerBonus = 0;
    }
    ...
    function changeReferralBonus(uint256 amount) public onlyOwner {
