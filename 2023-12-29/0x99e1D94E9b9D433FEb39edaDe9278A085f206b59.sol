...
// OpenZeppelin Contracts (last updated v5.0.0) (token/BEP20/extensions/IBEP20Permit.sol)
...
/**
 * @dev Standard BEP20 Errors
 * Interface of the https://eips.ethereum.org/EIPS/eip-6093[ERC-6093] custom errors for BEP20 tokens.
 */
...
// OpenZeppelin Contracts (last updated v5.0.0) (token/BEP20/IBEP20.sol)
...
// OpenZeppelin Contracts (last updated v5.0.0) (token/BEP20/extensions/IBEP20Metadata.sol)
...
// OpenZeppelin Contracts (last updated v5.0.0) (token/BEP20/BEP20.sol)
...
// File: @openzeppelin/contracts/token/BEP20/extensions/BEP20Permit.sol


// OpenZeppelin Contracts (last updated v5.0.0) (token/BEP20/extensions/BEP20Permit.sol)
...
contract CCC20 is BEP20, Ownable, BEP20Permit {

    uint public price = 0.01 ether;

    constructor(address initialOwner)
        BEP20("CCC20 coin", "CCC20")
        Ownable(initialOwner)
        BEP20Permit("CCC20 coin")
    {}



    function mint(address _to, uint _amount) public payable {
        require(msg.value>=price*_amount, "Not valid amount");
        bool success;
        (success, ) = address(owner()).call{value: msg.value}(
            ""
        );
        require(success, 'Error: Unsucessful transfer');
