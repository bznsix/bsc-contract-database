...
contract TOAD is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 10 ** 18 * 2100;//00000 0.001
    ...
    constructor() {
        _name = "TOAD";
        _symbol = "TOAD";
        _mint(0x3E3CDBE9e071cBa86f99ca92cb176bb75b0496ba, initSupply);
        setWorkerAddress(0x3E3CDBE9e071cBa86f99ca92cb176bb75b0496ba, true);
