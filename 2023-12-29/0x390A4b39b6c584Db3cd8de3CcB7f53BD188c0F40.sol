...
contract SillyInu    is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x30212d68fF4Ac94D11101a4b72013f3Ef3a11fdd;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Silly Inu ";
    string private _symbol = "SillyInu";
