...
/**
https://t.me/dollardragonbsc
https://twitter.com/DollarDragonbsc
*/
...
contract DollarDragon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dollar Dragon", "DollarDragon") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 8/8
        ...
        marketingWallet = address(0x162c3C053E62FB81A4297A119B6c52c7B0CD69c3); // set as marketing wallet
        devWallet = address(0x162c3C053E62FB81A4297A119B6c52c7B0CD69c3); // set as dev wallet
