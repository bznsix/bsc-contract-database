/**
Telegram: https://t.me/Ponke2
Ponke 2.0 will follow the foot steps of Ponke
*/
...
contract Ponke2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ponke 2.0";
    string private _symbol = "PONKE2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2db3cc0279c947141E9cA338618daC1efA2bD411); // Marketing Address
    address payable public teamWalletAddress = payable(0x2db3cc0279c947141E9cA338618daC1efA2bD411); // Team Address
