...
contract KaliumNetwork is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kalium Network", "KALI") {

        address _owner = msg.sender;

        _decimals = 18;

        uint256 totalSupply = 1000000 * (10**_decimals);
        ...
        marketingWallet = address(0x03b40Ff4d1361bAaF175f778Fa17c2a2048BEDC2); // set as marketing wallet
