/**
https://t.me/BullmasBSC

PRIVATE: https://t.me/+Wyns_HuJv5djYmY1
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5BF695021ddE474b5152BE3d5b7b47B7b3aB685d; // owner address
...
contract BULLMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bullmas";
    string private _symbol = "$BULLMAS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5BF695021ddE474b5152BE3d5b7b47B7b3aB685d); // Marketing Address
    address payable private teamWalletAddress = payable(0x5BF695021ddE474b5152BE3d5b7b47B7b3aB685d); // Team Address
