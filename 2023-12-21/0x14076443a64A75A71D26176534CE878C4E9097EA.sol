...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEc37eFe72AD1B54B1B5995c1551026acc5e382F5; // owner address
...
contract DUNGZILLABSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DUNGZILLA";
    string private _symbol = "$DUNGZ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xEc37eFe72AD1B54B1B5995c1551026acc5e382F5); // Marketing Address
    address payable private teamWalletAddress = payable(0xEc37eFe72AD1B54B1B5995c1551026acc5e382F5); // Team Address
