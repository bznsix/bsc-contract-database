/**
    TG:https://t.me/GrokBoyGlobal
    Website:https://grokboy.co/
    Twitter:https://twitter.com/BoyGrok

    GrokBoy - THE CUTEST GROK IS HERE , THE NEXT 1000X GEM
    /Safu Audit By Coinsult.           
...
contract GrokBoy is ERC20, Ownable {
    ...
    {   
        ...
        liquidityFeeOnBuy  = 150;
        liquidityFeeOnSell = 150;
        ...
        marketingWallet = 0x97a2dd8Fd941abC261EB8dcb7e92600F9FBa93B4;
        ...
        maxTransactionAmountBuy     = totalSupply() * 100 / 1000; //Max tx is set at 10% for buy and sell
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy <= 250, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_totalFeesOnSell <= 250, "Total Fees cannot exceed the maximum");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 250, "Wallet to Wallet Transfer Fee cannot exceed the maximum");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if(from == uniswapV2Pair && block.number < (launchBlock + 1) && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
