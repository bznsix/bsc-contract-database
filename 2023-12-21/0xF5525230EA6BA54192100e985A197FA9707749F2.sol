...
contract ALPHATOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlphaCoin";
    string private _symbol = "ALPHA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa76EB01E081b4B2F944Da742792b7F1B818F92a9); // Marketing Address
    address payable public teamWalletAddress = payable(0xa76EB01E081b4B2F944Da742792b7F1B818F92a9); // Team Address
