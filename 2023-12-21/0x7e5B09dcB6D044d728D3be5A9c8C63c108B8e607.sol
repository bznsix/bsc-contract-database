// __    __  ________  __    __  ________   ______   _______    ______   __       __ 
//|  \  /  \|        \|  \  /  \|        \ /      \ |       \  /      \ |  \  _  |  \
//| $$ /  $$| $$$$$$$$| $$ /  $$| $$$$$$$$|  $$$$$$\| $$$$$$$\|  $$$$$$\| $$ / \ | $$
//| $$/  $$ | $$__    | $$/  $$ | $$__    | $$ __\$$| $$__| $$| $$  | $$| $$/  $\| $$
//| $$  $$  | $$  \   | $$  $$  | $$  \   | $$|    \| $$    $$| $$  | $$| $$  $$$\ $$
...
// \$$   \$$ \$$$$$$$$ \$$   \$$ \$$$$$$$$  \$$$$$$  \$$   \$$  \$$$$$$  \$$      \$$
                                      ...
                                      //(BSC) 
                        // WEBSITE: https://kekegrow.com                                         
                       // TELEGRAM: https://t.me/KEKE_GROW
                       // TWITTER(X): https://twitter.com/KEKE_GROW 
                       // 0% BUY TAX - 3% SELL TAX                                                        
...
contract KEKEGROW is ERC20, Ownable {
    ...
    constructor () ERC20("KEKEGROW", "KKG") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x3c6AFc7549010C1b20094B8Ff845c0C997dd356f;
        ...
        _mint(owner(), 4_000_000_000 * (10 ** decimals()));//4B
        swapTokensAtAmount = totalSupply() / 5_000;

        maxTransactionAmountBuy = (totalSupply() * 3) / 100;//3%
        maxTransactionAmountSell = (totalSupply() * 3) / 100;//3%
