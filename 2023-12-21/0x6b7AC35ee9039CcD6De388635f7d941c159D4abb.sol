...
contract LUNF is Context, IERC20, Ownable {
    ...
    string private _name = "Lunc Fire";
    string private _symbol = "LUNF";
    ...
    address payable public marketingWallet = payable(0xE39B2CAf019B5cACe6B0EB1007974CB3e05e46Eb);
