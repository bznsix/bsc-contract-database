/*
Meme Capital Corp $MEMEcc   
🔰0% TAX LOCKED🔰RENOUNCED🔰lp locked 🔰
https://t.me/MemeCapitalCorp
...
contract MEMEccToken is MEMEccDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MEMEccTeam;
    address private CharityMEMEcc;
    ...
    string public override name = "Meme Capital Corp";
    string public override symbol = "MEMEcc";
    string public constant MEMEccourwebsitesteps = "https://MEMEcc.ai/";
    string public constant MEMEccthethetelegram = "https://t.me/MemeCapitalCorp";
    string public constant MEMEccaudited = "MEMEcc is audited by: https://www.certik.com/";
    ...
    constructor(uint totalSupplyValue, address MEMEccTeamAddress, address CharityMEMEccAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MEMEccTeam = MEMEccTeamAddress;
        CharityMEMEcc = CharityMEMEccAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MEMEccTeam] =  totalSupply * 1 / 100;
        balances[CharityMEMEcc] = totalSupply * 1 / 100;
    ...
    // Get the address of the token's MEMEccTeam pot
