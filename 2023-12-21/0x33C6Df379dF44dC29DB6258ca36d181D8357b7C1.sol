/**
//
TG:https://t.me/MerryXmasBSCofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e4EF339492c481716966c9B1C4366098f29324B; // owner address
...
contract MerryXMas is Context, IERC20, Ownable {
    ...
    string private _name = "Merry X Mas";
    string private _symbol = "MXMAS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0e4EF339492c481716966c9B1C4366098f29324B); // Marketing Address
    address payable private teamWalletAddress = payable(0x0e4EF339492c481716966c9B1C4366098f29324B); // Team Address
