...
// PinkySwear LinkTree https://linktr.ee/pinkysweartoken
...
contract PSWEAR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pinky Swear", "PSWEAR"){

        address newOwner = address(0x1818c8ad52a34f2f025C48209e10eADb1001884b);
        ...
        marketingWallet = address(0x55B5A7a52e7F5D42967AC632fe9b21e20Fa0cf57);
        ...
        IUniswapV3Router02 _uniswapV3Router = IUniswapV3Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
function _transfer(
    ...
    function recoverContractBNB() external onlyOwner {
        (bool success,) = address(msg.sender).call{value: address(this).balance}("Stuck BNB balance from contract address recovered");
