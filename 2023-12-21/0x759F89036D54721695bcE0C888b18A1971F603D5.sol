...
contract CANA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CANA";
    string private _symbol = "CannaGrow";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x21073d01D1E3C2bEC1233e01bD9F9ca50DA81C63); // Marketing Address
    ...
    uint256 private _totalSupply = 42_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 42_000_000 * 10**_decimals;
    uint256 public _walletMax = 42_000_000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 42_000 * 10**_decimals;
    ...
    function stopCheckBotAction() public onlyOwner {
        checkBot = false;
    }

    function setIsNotBot(address[] memory _address) public onlyOwner {
        for (uint256 i =0; i < _address.length; i++) {
            bot[_address[i]] = false;
        }
    }
