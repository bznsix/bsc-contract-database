...
contract DragonX is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "DragonX";
    ...
    constructor(address _marketing, address _team) {
        ...
        totalFee = marketingFee.add(rewardsFee).add(teamFee);
    ...
    function changeFees(
        ...
        totalFee = marketingFee.add(rewardsFee).add(teamFee);
        totalFeeIfSelling = totalFee + extraSell;
    }
