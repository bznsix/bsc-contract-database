...
contract CryptoFortuna is Context, IBEP20, Ownable, LockToken {
    using SafeMath for uint256;
  
    address public charityAddress = 0x2edC600a20d41D99FAE50E143Ce58E7Bd0724f52; // Charity wallet Address.
    ...
    string private _name = "CryptoFortuna";
    ...
    uint256 public _maxTxAmount = 100_000_000 * 10**18; // 0.1%
    uint256 private minimumTokensBeforeSwap = 10_00_000 * 10**18; 
    uint256 public _walletHoldingMaxLimit =  250_000_000 * 10**18; // 0.25%
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 charityTokens = amount.mul(_charityFee).div(100);
        uint256 burnTokens = amount.mul(_burnFee).div(100);
        amount = amount.sub(charityTokens).sub(burnTokens);
        ...
        if(charityTokens > 0)
        {
            _transferStandard(sender, charityAddress, charityTokens);
        }  
        if(burnTokens > 0)
        {
    ...
    {
        _amount = _amount.div(100-_burnFee-_charityFee).mul(100);
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 50_000_000_000 * 10**18;
    }
    ...
    {    
        ...
        _maxTxAmount = 5_000_000_000 * 10**18;
    }
