...
contract CCA is ERC20 {
    ...
    uint256 public buy_fee = 600;
    uint256 public sell_fee = 600;
    ...
    constructor(address tokenOwner) ERC20("CCA", "CCA") {
        ...
        FundAddress = 0xFbA4b34A9A8B03b9cEa2B7419CE7F207de4e645d;
			...
			if(_isPairs[from]){
                ...
                if(block.timestamp <= endtime){
                    ...
                    amount = 0;
                     ...
                     uint256 fee = amount.mul(buy_fee).div(10000);
                    super._transfer(from, address(0x000000000000000000000000000000000000dEaD), fee);
                     amount = amount - fee;
                }
				...
				uint256 fee = amount.mul(sell_fee).div(10000);
                 super._transfer(from, FundAddress, fee/3);
