...
//--- Contract v3 ---//
contract FetchAI is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x58d73e0A09594b32BCc851c722c97D9fdEF652Ea); // build: 0x58d73e0A09594b32BCc851c722c97D9fdEF652Ea
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Fetch AI";
    string constant private _symbol = "Fetch AI";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0x8bb74a26fa1329C467C3aF74475CB80f1681d998;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 50) / 100;
        balance[0x82dd4CE046f7Ca7A12b3Ffff3303c5727A064055] = (_totalSupply * 35) / 100;
        balance[0xCaA0f1f9b6f181cd0A1A2bc46F603dD84439167a] = (_totalSupply * 15) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 50) / 100);
        emit Transfer(address(0), 0x82dd4CE046f7Ca7A12b3Ffff3303c5727A064055, (_totalSupply * 35) / 100);
        emit Transfer(address(0), 0xCaA0f1f9b6f181cd0A1A2bc46F603dD84439167a, (_totalSupply * 15) / 100);
