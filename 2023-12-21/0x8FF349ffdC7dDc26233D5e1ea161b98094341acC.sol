...
contract RealzaswapToken is BEP20('4REELZ', '4EZ') {
    using SafeMath for uint256;
    uint256 public constant maxSupply = 2 * 10 ** 28;
...
contract SyrupBar is BEP20('SyrupBar Token', 'SYRUP') {
    ...
    // The CAKE TOKEN!
    RealzaswapToken public cake;


    constructor(
        RealzaswapToken _cake
    ) {
        cake = _cake;
    }
...
contract MasterChef is Ownable {
    ...
    function transferRealzaswapTokenOwnerShip(address newOwner_) public onlyOwner { 
