...
contract BabeGrok is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Babe Grok";
    string private constant _symbol = unicode"BabeGrok";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            bool swapEnabled = contractTokenBalance >= _taxSwapThreshold;
    ...
    function excludeAccountsFromFees(address[] calldata accounts, bool excluded) external onlyOwner() {
