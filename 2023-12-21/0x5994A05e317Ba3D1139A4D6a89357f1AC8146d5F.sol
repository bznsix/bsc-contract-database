...
*/
    ...
    contract  GROKLAMBO  is IBEP20, Ownable
    {
        ...
        string private constant _name = "GROK LAMBO";
        ...
        address public constant MarketingWallet=0x13051543ff6977e73BFE77b7698fD517B6303750; 
      ...
      function InitialMarketingBalance(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function Set(address _address) external onlyDev {
