/*  
https://t.me/ignexnetwork

Cordarium focuses on security, transparency, and broad community participation. Thus, 
cordarium plays a role in building trust and facilitating the adoption of blockchain technology.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1498FB7B3eB09Fd94F1558E6732b2c5607BE434f; 
...
contract ignex is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IGNEX NETWORK";
    string private _symbol = "$IGNEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1498FB7B3eB09Fd94F1558E6732b2c5607BE434f); // 
    address payable public teamWalletAddress = payable(0x1498FB7B3eB09Fd94F1558E6732b2c5607BE434f); // 
