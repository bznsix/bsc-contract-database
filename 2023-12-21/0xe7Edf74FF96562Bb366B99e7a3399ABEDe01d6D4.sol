...
/**
 * CelebVoice AI is connecting between degens and celeb's AI voice. 
 * Step into the future of voice synthesis with CelebVoice AI, where every word echoes excellence, and every voice is a testament to the extraordinary. 
 * Join us on this transformative journey, and let your content resonate with the unmatched allure of celebrity voices.
 * 
 * Telegram: https://t.me/celebvoiceai_portal
 * Twitter/X: https://twitter.com/celebvoiceai
 * Website: https://celebvoiceai.tech
 *
 * Final taxes: 5/5 
 * LP Locked
 * Ownership renounced
...
//--- Contract v3 ---//
contract CelebVoiceAI is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xcF99f43ff08c87959d881e30c7ba0118e0E17705); // build: 0xccc9Eb205e6227E1f3e0feD504c9b693177Cc3b0
    address payable private devWallet = payable(0xcF99f43ff08c87959d881e30c7ba0118e0E17705); // build: 0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Celeb Voice AI";
    string constant private _symbol = "VoiceAI";
    ...
    function setFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 250, "Buy fee must be less than 25%");
        require(newSellFee <= 450, "Sell fee must be less than 45%");
        buyfee = newBuyFee;
        sellfee = newSellFee;
        emit _changeFees(newBuyFee, newSellFee);
    }
