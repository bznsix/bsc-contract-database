...
contract DJ is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "DJ";
        _decimals = 18;
        _owner = 0xbE4C200FdABAD4ea483479d7451CB0e547c1Ea38;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 10000 * 10**_decimals;
        marketingWalletAddress = payable(0xbb123969B72dC41cE1525Ef592BAD6f4E764d414);
        teamWalletAddress = payable(0x269BE3cBB3e351466096Ac28047a64B674a1005B);
