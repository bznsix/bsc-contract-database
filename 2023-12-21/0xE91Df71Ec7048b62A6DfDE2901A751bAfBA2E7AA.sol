...
PePe Santa is tired of watching everyone play “Santa Claus” with endless derivative Christmas coins. 
Claus goes about his day. It's time for the world's most recognized meme to assume his reign as the king of 
memes at the sweetest time of the year.

PePe Santa is here to make Memecoin Christmas great again. Fairly launched, 5% buy&sell tax, LP locked and 
contracts cancelled, $SPEPE is the coin for the people, every year at Christmas it will return. Fueled by 
pure picking power, let $SPEPE show you the way under the Christmas tree.
...
JoinNow: https://t.me/+nIb2YCA0ReFjOWM1
...
contract PEPESANTA is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x02F797dE43DeDD579C1b0dB1F48A2Ce438f17BCD);
    address payable public MarketingWallet = payable(0xdD67fb08FA4910148CC8a09b9fEB357DE7BA1f6f);
    ...
    function setFee(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function setMaxWalletLimit(uint256 newmaxWallet) external onlyAddress {
