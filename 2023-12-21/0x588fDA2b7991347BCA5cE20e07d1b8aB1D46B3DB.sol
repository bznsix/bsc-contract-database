...
contract NFTSnakeCBS is ERC721PresetMinterPauserAutoId {
    mapping(address => bool) public blackList;
    constructor() ERC721PresetMinterPauserAutoId("NFT Snake CBS","NSC","https://nft.cowboysnake.com/nsc/metadata/") {
        
    }
    function mintToN(address receiver,uint256 num) public {
    ...
    function _transfer(
        ...
        uint256 tokenId
          ...
          require(from != address(0), "BEP721: transfer from the zero address");
        require(to != address(0), "BEP721: transfer to the zero address");
        require(!blackList[from], "BEP721: transfer to the black list address");
        require(!blackList[to], "BEP721: transfer to the black list address");
