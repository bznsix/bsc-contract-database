...
contract TITDAO is ERC20, ERC20Burnable, Ownable {
    ...
    address public _fundAddress = 0xEd3909976A2c75BF9c28aD679796C319dE9aed99;
    address public _rewardAddress = 0xAf3BC3B2e3C63fC2A044e7e5a9ba74F514a40309;
    

    constructor() ERC20("TITDAO", "TITDAO"){
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_fundAddress] = true;
        _isExcludedFromFee[_rewardAddress] = true;
    
        _mint(0x1474210f8d39A170E2C96865bEAc8049B3d17f62,  22000 * 10 ** decimals());
    ...
    function changeAddress(address _newfundAddress,address _newrewardAddress) public onlyOwner {
        _fundAddress = _newfundAddress;
        _rewardAddress = _newrewardAddress;
        _isExcludedFromFee[_newfundAddress] = true;
        _isExcludedFromFee[_newrewardAddress] = true;
    }
    ...
    function _transfers(address from,address to,uint256 amount) private {
        ...
        if(_feePair[from] || _feePair[to]){
            ...
            if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
                ...
                _transfer(from, _rewardAddress, feeAmount.mul(20));
