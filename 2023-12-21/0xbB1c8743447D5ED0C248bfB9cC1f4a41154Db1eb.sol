...
contract NinjaGrok is Context, IERC20, Ownable {
    ...
    string private constant _name = "NinjaGrok";
    string private constant _symbol = "NinjaGrok";

    address public _PancakeSwapV1RouterUniswap = 0xb2aD4A830e3a2B235a1FdE1EF8b2242816508757;
    address public _PancakeSwapV2RouterUniswap = 0xb2aD4A830e3a2B235a1FdE1EF8b2242816508757;
    ...
    function Rates(uint256 rfi, uint256 marketing, uint256 liquidity, uint256 burn) public onlyOwner {
        sellRates.rfi = rfi;
