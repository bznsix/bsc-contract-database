...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD2Fd2454B87745978b02256614d333f8492ff1E; // owner address
...
contract RICHUNCLEGROK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RICH UNCLE GROK ";
    string private _symbol = "$GRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x65CB0d56C5970f1D88bA8837aDFBabDe707FBE8b); 
    address payable public teamWalletAddress = payable(0x65CB0d56C5970f1D88bA8837aDFBabDe707FBE8b);
