...
contract FENRX is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 42000000000000000000000000 * 10**8;
    ...
    address payable private marketingAddress = payable(0xDC3dD9958c21bBBBd369912159377f890C40B836); // *** //
    ...
    string constant private _name = "Fenrir Coin"; // *** //
    string constant private _symbol = "FENRX"; // *** //
