/**
https://t.me/MerryBitmasOfficialBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE391EE15f3cAC84f94a66345e499bdd0D56AB010; // owner address
...
contract MERRYBITMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Merry Bitmas";
    string private _symbol = "MB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE391EE15f3cAC84f94a66345e499bdd0D56AB010); // Marketing Address
    address payable private teamWalletAddress = payable(0xE391EE15f3cAC84f94a66345e499bdd0D56AB010); // Team Address
