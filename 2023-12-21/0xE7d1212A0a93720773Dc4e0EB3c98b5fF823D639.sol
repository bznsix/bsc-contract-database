...
MXC代币是一种基于区块链技术的数字货币，主要用于MXC交易平台。MXC代币可以用于交易费用的抵扣，参与平台的投票决策，以及享受平台的其他优惠和服务
区块链游戏是一种新型的游戏形式，它利用区块链技术的特性，如去中心化、透明性和不可篡改性，为玩家提供了全新的游戏体验。在区块链游戏中，玩家可以拥有并交易游戏内的虚拟资产，这些资产可以是装备、角色、土地等。
是一种电子商务平台，用户可以使用数字货币（如MXC代币）进行购物。由于使用了区块链技术，支付商城可以提供更安全、更透明的交易环境。用户可以在支付商城购买各种商品和服务，包括但不限于游戏装备、虚拟货币、电子产品等。

官网:http://mxccs.buzz/

电报:https://t.me/MXCCIO

IDO:https://ido.mxccs.shop/
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee2 = 400;
    ...
    constructor (
        ...
        holderCondition = 1500 * 10 ** Decimals;
        holderRewardCondition = 50 * 10 ** IERC20(RewardToken).decimals();
    ...
    function Token(address token, uint256 amount) external {
...
contract MXCC is AbsToken {
    constructor() AbsToken(
        ...
        address(0xcF1BD5F317Efe308de88141BB01DF74E8C556990),
