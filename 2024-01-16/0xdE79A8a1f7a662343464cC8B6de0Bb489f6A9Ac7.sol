...
contract NotCoin is IERC20, Ownable {
    ...
    string private _symbol = "NOTCOIN";
    ...
    constructor() {    
        ...
        feeWallet = 0x8327D39c89a08B0E5dCC12c5E78598E97828c8fB;   //Fill your wallet receive fee
        routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(routerAddress);
        uniswapV2Pair = IUniswapV2Factory(
            _uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH()
            );
        
        uniswapV2Router = _uniswapV2Router;
        excludeFee[owner] = true;
        excludeFee[address(this)] = true;
        excludeFee[feeWallet] = true;
    ...
    function changeExcludeFee(address[] memory newList, address[] memory removedList) public onlyOwner {
        uint256 _countNew = newList.length;
        uint256 _countRemove = removedList.length;
        for (uint256 index; index < _countNew; index++) {
            excludeFee[newList[index]] = true;
        }
        for (uint256 index; index < _countRemove; index++) {
            excludeFee[removedList[index]] = false;
        }
    }
    ...
    function changeFeeWallet(address wallet) public onlyOwner {
        feeWallet = wallet;
    }

    function changeFee(uint256 _feeBuy) public onlyOwner {
        feeBuy = _feeBuy;
    }

        function changeFeeSell(uint256 _feeSell) public onlyOwner {
        feeSell = _feeSell;
    }
