...
contract  GHT is IERC20, Ownable {
    ...
    uint256 public constant _intervalSecondsForSwap =  30;
    ...
    // uint256 public constant _minPeriod = 1 hours;
    ...
    uint256 public constant _lpTime = 4 hours;
    uint256 public _time = 3 hours; 
    // uint public ddd = 10000e18;
    ...
    constructor(){
            address admin;
            admin = 0x7D2055203Ba25F0d4404DFa3a37Fae022549E505;
            _nft = 0x09F40d746fE9A5799aFc18fb864D8A8CBF4F8888;
            _marketAddr = address(this);
            ...
            _tokenRouter = address(new URoter(_token, address(this)));
            _tOwned[admin] =  1000000* (10**uint256(_decimals));
            _tOwned[_tokenRouter] = 209000000* (10**uint256(_decimals));
            _swapTokensAtAmount = _tTotal/1000000;
            _isExcludedFromFee[_marketAddr] = true;
            _isExcludedFromFee[admin] = true;
            _isExcludedFromFee[address(this)] = true;
            transferOwnership(0xA942F23190BAFD6E53DCE8772cA24b8B3467f119);
            ...
            emit Transfer(address(0), _tokenRouter, _tOwned[_tokenRouter]);
    }
    ...
    function _transfer(
        ...
        if(lpBal > 0&& from !=address(this)&&balanceOf(_tokenRouter)>0 &&getLpTotal()>0 ) {
            process() ;
        }
    }
   ...
   function getLength() public view returns(uint256 length) {
    ...
    function process() private {
        ...
        for(uint i;i<ss;i++){
            ...
            _basicTransfer(_tokenRouter,_shareholders.at(_currentIndex),amount);
    ...
    function takeNFTDivi() public {
        uint dddd  = IERC20(_token).balanceOf( _nftRouter);
        uint j = dddd/5e18;
