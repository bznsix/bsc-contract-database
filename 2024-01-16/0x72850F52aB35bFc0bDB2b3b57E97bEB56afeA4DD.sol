...
contract QuestEnhancementReward is AccessControl, Pausable {
    ...
    constructor (IERC1155 _enhancementAddress, uint256[] memory _ids, uint256[] memory _amounts, address _addWinnerRoleAddress) {
