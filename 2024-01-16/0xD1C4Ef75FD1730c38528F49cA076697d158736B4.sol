...
abstract contract BreMan is IERC20, Ownable {
    ...
    constructor (
        ...
        uint256 amountReceiver = 1000000 * tokenUnit;
    ...
    uint256 public _airdropBNBAmountEachTime = 3 ether / 10;
    uint256 public _airdropTokenEachTime = 2000;
...
contract bremantoken is BreMan {
    constructor() BreMan(
    //SwapRouter
        ...
        21000000,
    //Receive
        address(0x52273605853B21553383b6aC3D5214B8B897e17C),
    //Market
        address(0x665106211bF1Df069b87c0EA24100ac82e3363A3)
    ) {
