...
contract APED is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xb3AaFE17A475327d7Ef9f1f7c53d6fC26aacc20b); // Marketing Address
        
    address payable public teamAddress =
        payable(0xA9996e46AD650CB37B782263262b3A3c024867Ea); // Buyback Address

    address payable public liquidityAddress =
        payable(0xA9996e46AD650CB37B782263262b3A3c024867Ea); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xA9996e46AD650CB37B782263262b3A3c024867Ea).call{value: bnbForDev}("");
    ...
    function setMaxWallets(uint256 value) external onlyOwner {
