...
contract TRUMP2024 is ERC20, Ownable {
    ...
    address public marketingvWallet = 0xd4E3A1eD29E679793B2adB42D36dDC6BDad3Bbcb;
    address public devWallet = 0xd4E3A1eD29E679793B2adB42D36dDC6BDad3Bbcb;
    ...
    constructor() ERC20("TRUMP2024", "TRUMP2024") {
        ...
        exemptFee[marketingvWallet] = true;
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketingv + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.marketingv + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 marketingvAmt = unitBalance * 2 * swapTaxes.marketingv;
            if (marketingvAmt > 0) {
                payable(marketingvWallet).sendValue(marketingvAmt);
            }
