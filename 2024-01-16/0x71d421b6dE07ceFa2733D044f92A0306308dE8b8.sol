...
contract BNBLION is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x815E99f69104075A937A9dC175311CD0b85Ba46e); 
    address payable public Wallet_Dev = payable(0x7D5D74Cf91730a6DF2187EE24442e255865472C5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "BNB LION"; 
    string private constant _symbol = unicode"BNBLION"; 
    ...
    constructor () {
        _owner = 0x7D5D74Cf91730a6DF2187EE24442e255865472C5;
