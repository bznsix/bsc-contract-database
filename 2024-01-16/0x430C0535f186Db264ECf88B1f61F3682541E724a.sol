...
contract GD is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xdfb352d81ba1826334FEbC5029D10049935BB399;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public buyFee = 5;
    uint256 public sellFee = 25;
    uint256 public times;
    constructor() public ERC20("GoldenDragon", "GD") {
        ...
        _mint(owner(), 202400000000 * (10**18));
    }
    ...
    function setmarik(address value) external onlyOwner{
        _marketingWalletAddress = value;
    }
    function settimes222(uint256 t) external onlyOwner{
        times = t;
    }
    ...
    function multipleExcludedAddress(address[] calldata accounts, bool value) public onlyOwner {
