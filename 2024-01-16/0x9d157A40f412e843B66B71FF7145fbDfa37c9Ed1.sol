...
contract EpicFi is ERC20, Ownable {
    ...
    constructor() payable ERC20("EpicFi", "EPIC") {
        ...
        marketingWallet = 0x12dBb5f79DF283FFBaA77673e4A1F8A9Ea8039fe;

        dividendTracker = new DividendTracker(50 * 10**5, rewardToken);
        ...
        _mint(owner(), 50 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 420;
    }
