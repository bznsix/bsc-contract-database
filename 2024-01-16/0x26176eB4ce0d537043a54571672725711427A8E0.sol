...
contract BabyTroll is IERC20, Ownable {
    ...
    uint256 public _totalBuyFee = 10;
    uint256 public _totalSellFee = 10;
    ...
    constructor() {
        ...
        uint256 total = 1000000000000 * 10 ** _decimals;
        maxTXAmount = 1000000000000 * 10 ** _decimals;
        maxWalletAmount = 1000000000000 * 10 ** _decimals;
        minimumTokensBeforeSwap = 100000000 * 10 ** _decimals;
        ...
        MarketingAddress = 0x977e38D78211D888CcDa3E39c86e882a93eC0F77;
        _feeWhiteList[MarketingAddress] = true;
        _feeWhiteList[address(this)] = true;
        _feeWhiteList[address(swapRouter)] = true;
        _feeWhiteList[msg.sender] = true;

        _totalBuyFee = _buyMarketingFee;
        _totalSellFee = _sellMarketingFee;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                require(swapEnabled, "prohibited transaction");
                if (_swapPairList[to]) {
                    if (!inSwap) {
