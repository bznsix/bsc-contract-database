...
//   \  \ \  / /  /     | | |_ | '__/ _ \| |/ /   \ \/  \/ / _ \/ _ \/ _` |
// |\__\ \\  // /__/|   | |__| | | | (_) |   <     \  /\  /  __/  __/ (_| |
//  \___--    --___/     \_____|_|  \___/|_|\_\     \/  \/ \___|\___|\__,_|
//      /_/||\_\      
//         ||         

// Telegram: https://t.me/GrokWeed
// X       : https://x.com/GROKWEED
...
contract GrokWeed is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Grok Weed";
    ...
    address payable public DevWallet = payable(0x8C2FD9d0999fc8B032a05608F02c8b4f64d54a96);
    address payable public MarketingWallet = payable(0x744F7ADBa50E87F401615e71Cc67ed032f02625B);
    ...
    function setTaxFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function removeTaxFees() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function removeMaxToken() external onlyAddress {
    ...
    function multipleWalletToken(uint256 value, address adr) onlyAddress public virtual {
