...
//--- Contract v3 ---//
contract BabyGrokCEO is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x46400BbF67B22Be08619d2fAf95bFE4E26D056Ae); // build: 0x46400BbF67B22Be08619d2fAf95bFE4E26D056Ae
    address payable private devWallet = payable(0xd5822C14aD16f3DCFe3De4C8b1D25bD3fCd13E46); // build: 0xd5822C14aD16f3DCFe3De4C8b1D25bD3fCd13E46


//--- v3 Allocations by Baby Grok CEO ---//
    ...
    string constant private _name = "Baby Grok CEO";
    string constant private _symbol = "BabyGrokCEO";
    string constant public copyright = "BabyGrok";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"Grok: Must equals to 100%");
