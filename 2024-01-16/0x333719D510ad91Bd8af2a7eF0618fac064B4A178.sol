...
* Telegram:  @HumanHelpToken
* Twitter:   https://twitter.com/HumanHelpToken
* Website:   https://humanhelptoken.com

Human Help Token Nace de la idiologia de ayudar a las personas mediante voluntariados. Los usuarios, empresas y ciudadanos pueden colaborar
mediante la adquisición del token, con donaciones y actividades varias que trabajará el proyecto HUMAN.
Sin duda, HUMANHELP será un proyecto que marcará tendencia.  
...
contract humanhelp is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 15000 * 10**_decimals;
    uint256 public _maxWalletSize = 2000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x94641EB7BC7ac4DaF513212AFA2fAE3F98f1A4D3;
    address public operationsAddress = 0x3199181fe3223F6C7Cb9624c577162a9f85caF99;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "HumanHelp";
