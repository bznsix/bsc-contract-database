...
contract HEYI is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "HEYI";
        _decimals = 18;
        _owner = 0x4e0b4C81dfE306652AaC04398D6d99F367541D3F;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 10000 * 10**_decimals;
        marketingWalletAddress = payable(0x8f30cFd00727d3A199b68758C9294998b4B485Bf);
        teamWalletAddress = payable(0x1b69988389CCD0d3274548eFab5AB9b5cDA2ec88);
