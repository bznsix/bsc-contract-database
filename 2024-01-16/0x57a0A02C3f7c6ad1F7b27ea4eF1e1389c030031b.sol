/**
Telegram: https://t.me/newkoinecosystem
Website: https://newkoin.com
twitter: https://twitter.com/newkoinecosystem
*/
...
contract NewkoinToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NewkoinTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Newkoin", "NKN") {
        marketingWallet = payable(0x7961502f60D65BE104c77D73BaBb163F551025e1);
        devWallet = payable(0x38ED611b23194DbF7A3f2B8B45990f6675ad9eD6);
        ...
        dividendTracker = new NewkoinTokenDividendTracker(
            payable(this),
            router,
        ...
        swapTokensAtAmount = totalTokenSupply / 300000; // 0.05%;
...
contract NewkoinTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    NewkoinToken public NewkoinTokenContract;
    ...
    constructor(
        ...
        defaultToken = token;
        NewkoinTokenContract = NewkoinToken(mainContract);
    ...
    function _transfer(
        ...
        require(false, "NewkoinToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "NewkoinToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(NewkoinTokenContract);

            uint256 prevBalance = NewkoinTokenContract.balanceOf(address(this));
            ...
            {
                uint256 received = NewkoinTokenContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    NewkoinTokenContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
