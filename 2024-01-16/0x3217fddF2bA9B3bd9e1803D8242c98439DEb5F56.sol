//SHJW WIKUXD IOWUISI OISOWSWOPK 
// dhud ekidiom douideopdk ooidoedm  eoiuiod oieuio 
//CJUIKDKJ DIUIDJ EDIUEIL EDIUED O)EUIE EOIO§KM EIUZEI 
//KEUIDOUE EO)WO EP=)W P?EE ED()=E EP)IU P=WE)(E)  
// DHZD DIUoiuw diuei diuiem  ou789wope ep08edzui03 p03e9udi+3oiudj 



//WEB:SZUSN ISDUI OEI M
//KSJDUDJ:ISUD IUDUIOODI NSUZU 
//GSHUDGZUH:ZZZZZZZZPOIUZHZ
...
contract WARIO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd079047400AfC25B75a426a32767Bcce4FE38dcE); 
    address payable public Wallet_Dev = payable(0xd079047400AfC25B75a426a32767Bcce4FE38dcE);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "siba"; 
    string private constant _symbol = unicode"SIBA"; 
    ...
    constructor () {
        _owner =0xd079047400AfC25B75a426a32767Bcce4FE38dcE;
