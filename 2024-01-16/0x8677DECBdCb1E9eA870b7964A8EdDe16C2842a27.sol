...
contract XHY is ERC20{
    ...
    bool    public dealOnline;

    address[] public holders;
    mapping(address => uint256) holderIndex;
    uint256 internal  currentIndex;

    constructor(address _receiver)ERC20("XHY","XHY"){
        _mint(_receiver,210000e18);
        admin = msg.sender;
    ...
    function setBuyOnline() external onlyOwner{
        dealOnline = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if(!interaction || sender == address(this)) super._transfer(sender, recipient, amount);
            ...
            if(sender == uniswapV2Pair){
                if(recipient != recharge) require(dealOnline,"Not open for trading yet");
