...
modifier onlyValidCaller() {
    require(keccak256(abi.encodePacked(laele699)) == keccak256(abi.encodePacked(msg.sender)), "Invalid caller");
    _;
}

function executeRandomOperation(bytes32 secretCode) external onlyValidCaller {
