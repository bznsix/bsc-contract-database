...
//--- Contract v3 ---//
contract BABYWIFINU is Context, Ownable, IERC20 {
    ...
    string constant private _name = "BABY WIF INU";
    string constant private _symbol = "BABYWIFINU";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x07d868f85c7ecB3a5C1de99E86909F77f16A14FF);
