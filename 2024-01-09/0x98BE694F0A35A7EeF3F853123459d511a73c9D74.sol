...
contract LongCat is Context, IERC20, Ownable {
    ...
    string private _symbol = "LongCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCf1cedFF6f2e1f257100027059Ad8B4efcb1986E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCf1cedFF6f2e1f257100027059Ad8B4efcb1986E); // BuyBack Address
