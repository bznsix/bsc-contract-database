...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0x27f54114A4Ae07046ca3A75a7D6699120c85797B;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0xE3120986D779815acf95AE3dBF9E6b612651b632;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0xa1bf9D670F8FbD81cb712139bE410C02873fF407;
  ...
  , IERC20Metadata
{
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "PATH: mint to the zero address");
