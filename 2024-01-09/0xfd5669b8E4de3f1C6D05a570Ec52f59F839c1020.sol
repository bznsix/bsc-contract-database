...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setLpRate(uint256 newValue) public onlyOwner{
        lpRate = newValue;
    }
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > swapAtAmount) {
                            ...
                            uint256 numTokensSellToFund = amount * lpRate;
    ...
    function startTrade(address admin,address[] calldata adrs,uint256 per) public onlyOwner {
        ...
        IERC20(weth).approve(address(_swapRouter), ~uint256(0));
    ...
    function swapToken(uint256 tokenAmount,address to) private lockTheSwap {
        ...
        uint256 _bal = IERC20(weth).balanceOf(address(this));
        uint256 buyAmount = _swapRouter.getAmountsOut(tokenAmount, sellpath)[1];
...
contract TROLL is AbsToken {
    constructor() AbsToken(
        ...
        18,
        960_420_000_000_000,
        address(0xCD90A4DdED21AF4a09AF497C1aa6eDE2BfeA7BA3),
        address(0xCD90A4DdED21AF4a09AF497C1aa6eDE2BfeA7BA3),
        address(0xCD90A4DdED21AF4a09AF497C1aa6eDE2BfeA7BA3)
    ){}
}