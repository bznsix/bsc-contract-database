...
contract PNPToken is ERC20, Ownable {
    ...
    constructor(
        ...
        _mint(address(_rec), 21000000 * 10 ** 18);
    }
    ...
    function feeToFundsPool(address to, uint256 balance) external {
        require(msg.sender == address(fundsPool), "only burns");
