...
LONG symbolizes mystery, auspiciousness and nobility, so the Year of the Dragon is often 
regarded as an auspicious year. Launch very soon!

Long Token Community:
https://t.me/longyearofdragon
Long Token Twitter:
https://twitter.com/Longtokenbep20
Long Token Website:
https://longtokenbsc.xyz/
**/
...
contract LONG is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "LONG";
    ...
    address payable public DevWallet = payable(0xe32F018a93c70364CF056AdC2eBD4c9F9bc1e524);
    address payable public MarketingWallet = payable(0xF907F49c6cCD55112d162BbDF790DeBAd5C6E15E);
    ...
    function setNewMaxWallet(uint256 newmaxWallet) external onlyAddress {
