...
/**
 *Sitted for verification at BscScan.com on 2024-01-09
*/
...
Telegram: https://t.me/BaggeBSC

Twitter: https://x.com/BaggeBSC

Website: https://sites.google.com/view/baggetoken
...
contract BAGGE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5_000_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 420_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 420_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 420_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x737c0701bf5069d7eD4131E65E3D1a63A882876E;
    address public devAddress = 0x737c0701bf5069d7eD4131E65E3D1a63A882876E;

    string private constant _name = "BAGGE";
    string private constant _symbol = "$BAGGE";
    ...
    Taxes public taxes = Taxes(0,0,1,0);
    Taxes public sellTaxes = Taxes(0,0,1,0);
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        uint256 marketingAmt = unitBalance * 1 * sellTaxes.marketing;
        if(marketingAmt > 0){
            payable(marketingAddress).transfer(marketingAmt);
        }
        
        uint256 devAmt = unitBalance * 1 * sellTaxes.dev;
        if(devAmt > 0){
