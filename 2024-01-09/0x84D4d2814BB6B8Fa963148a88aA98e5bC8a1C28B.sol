...
$₿TG - ₿ITLONG🐉 Is Here To Take Over BSC💰Team Is Safe Knows How To Moon A Project Dev Is a Chad Don't Miss This 100x Moonshot On Binance Smart Chain



WB : https://bitlong.online
TG : https://t.me/BitLongChannel
TW : https://twitter.com/BitlongBep20
...
contract BITLONG is Context, IERC20, Ownable {
    ...
    string private _name = "BITLONG";
    string private _symbol = "$BTG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x02a61D54B7B237F27D8E959dB350d2fC5acfD412);
    address payable private DevelopmentWalletAddress = payable(0x02a61D54B7B237F27D8E959dB350d2fC5acfD412);
    ...
    uint256 private _totalSupply = 88000000000 * 10**9;
    uint256 public _maxTxAmount = 1760000000 * 10**9;
    uint256 public _walletMax = 88000000000 * 10**9;
