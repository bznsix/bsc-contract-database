...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBf653864ceA9cA82e3Cca15E9f9F23343Ff6Fc3b; // owner address
...
contract TRENDME is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrendME";
    string private _symbol = "TRENDME";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xBf653864ceA9cA82e3Cca15E9f9F23343Ff6Fc3b); // Marketing Address
    address payable private teamWalletAddress = payable(0xBf653864ceA9cA82e3Cca15E9f9F23343Ff6Fc3b); // Team Address
