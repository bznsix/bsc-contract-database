...
// https://t.me/GrokeyCoin
// https://twitter.com/GrokMonkeyCoin
// https://grokmonkey.net
...
contract GROKMONKEY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Grok Monkey"; // 
    string private constant _symbol = unicode"$GROKEY";  //    
