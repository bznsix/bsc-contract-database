...
contract Heartemoji is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HeartemojiDividendTracker public dividendTracker;
    ...
    constructor() ERC20(unicode"❤️", "Heartemoji") {
        marketingWallet = payable(0x1E0EA1F542104010491BCEB9aFaEaD73cf3A99Fc);
        devWallet = payable(0x1E0EA1F542104010491BCEB9aFaEaD73cf3A99Fc);
        ...
        dividendTracker = new HeartemojiDividendTracker(
            payable(this),
            router,
...
contract HeartemojiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Heartemoji public HeartemojiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HeartemojiContract = Heartemoji(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Heartemoji_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Heartemoji_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Heartemoji contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HeartemojiContract);

            uint256 prevBalance = HeartemojiContract.balanceOf(address(this));
            ...
            {
                uint256 received = HeartemojiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HeartemojiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
