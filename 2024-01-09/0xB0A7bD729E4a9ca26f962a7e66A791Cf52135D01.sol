/**
https://t.me/BuymefornoreasonBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6dC820C52c6b6bfbE4C2488cF3C61dae4F492d0; // owner address
...
contract BUYMEFORNOREASON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buy Me For No Reason";
    string private _symbol = "BUYME";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE6dC820C52c6b6bfbE4C2488cF3C61dae4F492d0); // Marketing Address
    address payable private teamWalletAddress = payable(0xE6dC820C52c6b6bfbE4C2488cF3C61dae4F492d0); // Team Address
