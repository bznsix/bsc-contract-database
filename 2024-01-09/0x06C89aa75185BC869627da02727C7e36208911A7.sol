/*
Step into a world where the timeless wisdom of the Jedi Order meets 
the innovative realm of cryptocurrencies. Our mission is to unite a 
community passionate about crypto with the ethos of the noble Jedi.

5% TAX on buys & sells, that are splitted 3% marketing and 2% lp

Website: https://jedicoin.net/
Telegram: https://t.me/JediCoin_BSC
...
contract JediCoin is ERC20, Ownable{
    ...
    address public marketingWallet = 0x8b17f66c5430Ddf5Cf43d34014FaC1D290De53a9;
    address public devWallet = 0x5F37cCA6250f0B502f94e6415002789BE0be78D4;
    ...
    constructor() ERC20("JediCoin", "JEDICOIN") {
        ...
        swapThreshold = totalSupply() * 2 / 10000;// 0.02% 
        maxTxAmount = totalSupply() * 300 / 10000; // 3% maxTransactionAmountTxn;
        maxWalletAmount = totalSupply() * 300 / 10000; // 3% maxWallet

    }
    
 function _calculateFee(address sender, address recipient, uint256 amount) internal view returns (uint256 fee) {
...
function _transfer(address sender, address recipient, uint256 amount) internal override {
    ...
    function setSwapThreshold(uint256 new_amount) external onlyOwner {
        require(new_amount > 1, "NumTokensBeforeSwap should be not 0");
    ...
    function setBuyTaxes(uint256 _marketing, uint256 _liquidity) external onlyOwner{
        require(totTax <= 10, "Buy tax must be less than 10%");
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity) external onlyOwner{
        require(totSellTax <= 10, "Buy tax must be less than 10%");
    ...
    function updateMaxTxAmount(uint256 _percen) external onlyOwner{
        require(_percen >= 1, "Cannot set MaxTxAmount lower than 1%");
        maxTxAmount = totalSupply() * _percen / 100;
    }
    
    function updateMaxWalletAmount(uint256 _percen) external onlyOwner{
        require(_percen >= 1, "Cannot set MaxWalletAmount lower than 1%");
