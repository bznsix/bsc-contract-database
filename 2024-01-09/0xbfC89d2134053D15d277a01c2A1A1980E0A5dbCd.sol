...
//--- Contract v3 ---//
contract BabyTomcat is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xDd093c7969d159b8aC3DAD41A60F77b070Cc2c30); // build: 0xDd093c7969d159b8aC3DAD41A60F77b070Cc2c30
    address payable private devWallet = payable(0xf34b72a1C6B7e35a5B9755eE34f65b66Ced9705d); // build: 0xf34b72a1C6B7e35a5B9755eE34f65b66Ced9705d
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Baby Tomcat";
    string constant private _symbol = "BabyTomcat";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xeda302383295b7cB2e331953c641c8c35fc4790d);
