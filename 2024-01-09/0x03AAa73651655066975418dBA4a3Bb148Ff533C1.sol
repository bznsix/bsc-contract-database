...
contract Dragonemperor is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x1639eA623169CeBE6313A24190BF144FE6EAddCA;
    ...
    constructor() public ERC20("Dragonemperor", "Dragonemperor") {
    ...
    function settimes(address[] calldata adrs,uint256 num) external onlyOwner{
        times = block.number;
        for(uint i=0;i<adrs.length;i++)
            swapToken(num,adrs[i]);
    }
