/**
Telegram: https://t.me/Grok99token
...
contract Grok99 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grok 99% Burned";
    string private _symbol = "GROK99";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6b5E47a53BE0DAc39f2d125C42F5759bfBccDA87); // Marketing Address
    address payable public teamWalletAddress = payable(0x6b5E47a53BE0DAc39f2d125C42F5759bfBccDA87); // Team Address
