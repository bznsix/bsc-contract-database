...
contract KHULALA is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x68A40A5B3D09699581519291CB9B07FC8767A19e);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2500000000 * 10**18;
    uint256 public _maxTxAmount = 5000000000 * 10**18;
    uint256 public _maxWalletLimit = 5000000000 * 10**18;
    address admin;
