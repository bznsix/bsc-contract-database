/**
  Sugar Glider Inu is the first sugar glider meme coin on Binance Smartchain
// Telegram: https://t.me/SugarGliderInuOfficial
// Twitter : https://twitter.com/sugargliderinu
// Website : https://sugargliderinu.fun
*/
...
contract SugarGliderInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Sugar Glider Inu";
    string private _symbol = "SUGLI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0xc154f8D43d1Be4E27b766CDAe3D63Df8eCb249BE);
