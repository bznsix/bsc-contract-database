...
contract GeminiGrok is ERC20, Ownable {
    ...
    constructor () ERC20("GeminiGrok", "GeminiGrok") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xfcdA9fC4297FB107128a6639233CaBC020bfbbc7);
        ...
        feeReceiver = 0x3EC45be4942b53f9ebcf29C41Bae6D2f51D9dAf8;
        ...
        _mintOnce(owner(), 4e8 * (10 ** decimals()));
        swapTokensAtAmount = 4e5 * (10 ** decimals());
