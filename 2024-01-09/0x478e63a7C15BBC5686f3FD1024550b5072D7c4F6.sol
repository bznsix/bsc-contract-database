// SPDX-License-Identifier: GPL-3.0
  /**
   * @title IndiaOnIT
   * @dev Its just for test we will change this later on
...
contract Token {
    ...
    constructor() {
        name = "GROWSHU"; // Sets the name of the token, i.e Ether
        symbol = "GROWSHU"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 initialTotalCoin = 1000000000000000000;
        uint256 _initialSupply = 1000000000 * initialTotalCoin; // Holds an initial supply of coins
