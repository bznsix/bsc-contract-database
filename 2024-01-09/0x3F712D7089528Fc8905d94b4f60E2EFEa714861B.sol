/**
 *Telegram: https://t.me/dragonsdentoken
 Website: https://dragonsdentoken.com/
 Twitter: https://twitter.com/DragonsDenToken
 */
...
contract DragonsDenToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public RewardToken =
        address(0xb1957BDbA889686EbdE631DF970ecE6A7571A1B6); //DTG RewardToken

    uint256 public swapTokensAtAmount = 1 * 10**2 * (10**18);
    uint256 public maxBuyAmount = 100 * 10**3 * 10**18;
    uint256 public maxSellAmount = 100 * 10**3 * 10**18;
    uint256 public maxWalletAmount = 250 * 10**3 * 10**18;

    uint256 internal constant maxSupply = 5 * 10**6 * 10**18; //5 Million

    address public marketingWallet =
        address(0x802DE1C02472fc57311f5EADA4Ea9aeAA538711c);
    address public buybackWallet =
        address(0x444a19f138C2eF3Fd61071d52e9488c3C83DF316);
    ...
    constructor() ERC20("Dragons Den Token", "DDT") {
        dividendTracker = new TOKENDividendTracker(RewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E  //- Mainnet= 0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
    ...
    function swapAndSendToFee(uint256 tokens, uint16 fees) private {
        ...
        uint256 buybackShare = newBalance
            .mul(buyFee.buyback + sellFee.buyback)
            .div(fees);

        (bool status, ) = marketingWallet.call{
            value: marketingShare,
            gas: 30000
        }("");
        require(status, "Transfer to marketingWallet failed");

        (status, ) = buybackWallet.call{value: buybackShare, gas: 30000}("");
        require(status, "Transfer to buybackWallet failed");
    }
