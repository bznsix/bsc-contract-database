...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        excludeHolder[0xc9f4f8FB75F1960685936129F386C8f3FA712222] = true;//Pancake ADDRESS
        ...
        if (takeFee) {
            ...
            if (isRemove) {
                if (_releaseLPStartTime > 0) {
                    ...
                    uint removeFeeAmount = tAmount * (0 + times) * _releaseLPDailyRate / 10000;
                    ...
                    uint removeFeeAmount = tAmount * 300 / 10000 ;
                    if (removeFeeAmount > 0) {
                        feeAmount += removeFeeAmount;
                        _takeTransfer(sender, fundAddress, removeFeeAmount);
                    }
                ...
                if (_swapPairList[sender]){
                    ...
                    uint256 currentTotal = totalSupply() - _balances[address(0)] - _balances[address(0x000000000000000000000000000000000000dEaD)];
                    ...
                    _takeInviterFeeKt(tAmount.div(1000000));                     
...
contract XAI  is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000000000000,
        address(0x17Ff87eD94af7aD172d5e4B0e9F9e833cf6Af5F7),
        address(0x17Ff87eD94af7aD172d5e4B0e9F9e833cf6Af5F7),
        0
    ){
