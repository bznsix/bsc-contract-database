...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "CyberDoge";
        _symbol = "CDOGE";
        uint256 supply  =  142530000000 ether;
    ...
    function gettrade() public view virtual returns (bool) {        
        return _trade;
    }
    ...
    function updateTrade(bool trade) public onlyOwner {
        _trade = trade;
    }
    ...
    function recoverETH(address tokenAddress, uint256 tokenAmount) public onlyOwner {
