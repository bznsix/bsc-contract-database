 ...
 * 
  ...
  *
  * Description: X369
  * Website: www.x369.online
  * Twitter: N/A
  * Telegram: https://t.me/X369_TG
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="X369";
    string private _symbol="X369";
    uint8  private _decimals=9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 369000000000000000;
    uint256 private _tTotalSupply = 369000000000000000;
    ...
    address public marketingWallet=0xD72Ce30b6b3ce194fF5fA802788E982D43A4482f;
    
    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=369000000000000000;
    uint256 public maxTransactionAmountSell=369000000000000000;

    
    uint256 public maxWalletAmount=922500000000000;
    ...
    uint256 public swapTokensAtAmount=3690000000000;
