/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @geeksignals
   ...
   I will renounce the ownership to burn addresses to transfer #INUBNB to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #INUBNB 10000X? 
...
contract INUBNB is Context, IERC20, Ownable {
    ...
    string private _name = "INUBNB";
    string private _symbol = "INUBNB";
