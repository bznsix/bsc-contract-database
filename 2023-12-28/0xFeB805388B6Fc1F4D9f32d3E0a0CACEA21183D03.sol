...
/**
Supertato: Crypto's Tastiest Hero!

Telegram  : https://t.me/SupertatoToken
Twitter   : https://twitter.com/SupertatoToken
Website   : https://Supertato.xyz/
...
contract SupertatoMemeToken is Context, IBEP20, Ownable {
    ...
    address payable private SupertatoTaxWallet;
    ...
    string private constant _name = unicode"Supertato";
    string private constant _symbol = unicode"SUPERTATO";
    ...
    constructor () {
        SupertatoTaxWallet = payable(0x1aA06AAeB94166b13F29367424c796D6bc567f88);
        balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[SupertatoTaxWallet] = true;
   ...
   function approve(address spender, uint256 amount) public override returns (bool) {
    ...
    function sendETHToFee(uint256 amount) private {
        SupertatoTaxWallet.transfer(amount);
    }
    ...
    function manualSwap() external {
        require(_msgSender()==SupertatoTaxWallet);
