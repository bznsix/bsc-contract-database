...
//Telegram:https://t.me/WefeToken
//Twitter:https://x.com/WefeToken
//WEBSITE:http://wefetoken.com/
...
contract WEFE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdE9C51382E9771cE959f3fb826b1B450598B7E9d); 
    address payable public Wallet_Dev = payable(0xdE9C51382E9771cE959f3fb826b1B450598B7E9d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "WEFE"; 
    string private constant _symbol = unicode"WEFE"; 
    ...
    constructor () {
        _owner =0xdE9C51382E9771cE959f3fb826b1B450598B7E9d;
