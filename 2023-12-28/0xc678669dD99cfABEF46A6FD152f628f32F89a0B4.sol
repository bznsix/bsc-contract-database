...
// Telegram: https://t.me/Shitmasportal
// x https://x.com/Shitmas
...
contract Shitmas is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "$Shitmas";
    string private constant _symbol = unicode"$Shitmas";
