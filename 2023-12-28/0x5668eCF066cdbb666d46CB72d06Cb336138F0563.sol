...
contract LAPAProtocol is ERC20, ERC20Burnable, ERC20Pausable, AccessControl, ERC20Permit {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant LOCKED_ROLE = keccak256("LOCKED_ROLE");

    constructor(address defaultAdmin, address pauser)
        ERC20("LAPA Protocol", "LAPA")
        ERC20Permit("LAPA Protocol")
    {
    ...
    {
        require(hasRole(LOCKED_ROLE, from) == false, "account locked!");
