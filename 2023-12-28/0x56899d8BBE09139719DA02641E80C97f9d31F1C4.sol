...
$ZEE - PARTY WITH $ZEE- KYC TEAM 

ZEEPO Social:
TG: https://t.me/Zeepocoin
Twitter : https://t.me/Zeepocoin
Website : https://zeepo.tech
...
contract ZEEPO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZEEPO";
    string private _symbol = "$ZEE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc5e23cCd60ABd9d90ebA39AfAA6fF4213EA4dE41);
    address payable private DevelopmentWalletAddress = payable(0xc5e23cCd60ABd9d90ebA39AfAA6fF4213EA4dE41);
    ...
    uint256 private _totalSupply = 4069000000 * 10**9;
    uint256 public _maxTxAmount = 4069000000 * 10**9;
    uint256 public _walletMax = 4069000000 * 10**9;
