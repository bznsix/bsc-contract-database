...
contract MiniBonk is ERC20, Ownable {
    ...
    address public marketingWallet = 0x2689CaC91059151f7dF5A34F207057f0f100503c;
    ...
    constructor () ERC20("MiniBonk", "MiniBonk") 
    {   
        ...
        _mint(owner(), 426900000 * 1e6 * (10 ** 18));
