...
/**
TG: https://t.me/Solnereumnetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4990fA27De47b2bb9C118271B8ba2026cc67518c; // owner address
...
contract SolnereumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SOLNEREUM NETWORK";
    string private _symbol = "SOLNET";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4990fA27De47b2bb9C118271B8ba2026cc67518c); // Marketing Address
    address payable private teamWalletAddress = payable(0x4990fA27De47b2bb9C118271B8ba2026cc67518c); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 30;  // original 12
    uint256 public _totalTaxIfSelling = 30;  // original 12
