...
/**
Telegram  : https://t.me/SlinkmanToken
**/
...
contract SlinkmanMemeToken is Context, IBEP20, Ownable {
    ...
    address payable private SlinkmanTaxWallet;
    ...
    string private constant _name = unicode"Slinkman";
    string private constant _symbol = unicode"SLINKMAN";
    ...
    constructor () {
        SlinkmanTaxWallet = payable(0xAEf0a449022B9391b6eDf06E165d42EC08942189);
        balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[SlinkmanTaxWallet] = true;
   ...
   function approve(address spender, uint256 amount) public override returns (bool) {
    ...
    function sendETHToFee(uint256 amount) private {
        SlinkmanTaxWallet.transfer(amount);
    }
    ...
    function manualSwap() external {
        require(_msgSender()==SlinkmanTaxWallet);
