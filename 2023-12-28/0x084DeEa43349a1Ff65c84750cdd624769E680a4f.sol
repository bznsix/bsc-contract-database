...
//--- Contract v3 ---//
contract BananaCoin is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x5671511e998b3C29C754bE976388d6A2cf4f93F4); // build: 0x5671511e998b3C29C754bE976388d6A2cf4f93F4
    address payable private devWallet = payable(0xa32632ae4aD110b82C0dA23594B564044700e3ce); // build: 0xa32632ae4aD110b82C0dA23594B564044700e3ce
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "BananaCoin";
    string constant private _symbol = "Banana";
