/*
Telegram: https://t.me/dragondawnlabs
Twitter: https://twitter.com/dragondawnlabs
Website: dragondawn.io
Email: team@dragondawn.io
Contract: 0xd480f7982f26329abc38e3299f86da6c1b1d5711
*/
...
contract Dragon is ERC721Enumerable, Ownable {
    ...
    address private devAddress = 0x5B9180df1a080F11A809a677431CA7C8b53F0799;
    event Lock();
    ...
    constructor(
        ...
        require((_maxSupply == 200) || (_maxSupply == 1000) || (_maxSupply == 10000), "Operations: Wrong max supply");
