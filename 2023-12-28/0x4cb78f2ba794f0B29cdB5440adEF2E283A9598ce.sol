/*
Shida Inu is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens

Baby Ponke Ecosystem:
🐵Staking
🐵Web3 Wallet
🐵Swap/Dex
🐵NFT Marketplace
...
contract Babyponke is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BYPONK";
