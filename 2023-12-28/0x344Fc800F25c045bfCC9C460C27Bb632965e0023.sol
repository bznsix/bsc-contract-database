...
contract TecnoCat is ERC20, Ownable {
    ...
    constructor () ERC20("TecnoCat", "TEC") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x91CCA8cF03FDF510dAde6649a25cC5eA6FC9BFB0);
        ...
        feeReceiver = 0x91CCA8cF03FDF510dAde6649a25cC5eA6FC9BFB0;
        ...
        _mintOnce(owner(), 1e7 * (10 ** decimals()));
