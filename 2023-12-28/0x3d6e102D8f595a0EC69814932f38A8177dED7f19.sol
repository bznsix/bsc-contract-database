...
contract AISHIBA is ERC20, Ownable {
    ...
    constructor(
        ...
        _transferOwnership(0x719E4f51ccecf92739Ad29437f08153043278c0f);
        _mint(owner(), MAX_SUPPLY);

        marketingWallet = payable(0xfFD9B770C14058a0e52E80fC9ACe93cAe8913F2A);
        lpWallet = payable(0x43706357199Ba44Ef6aB65019508E4211ec5c003);
        bbbWallet = payable(0x43706357199Ba44Ef6aB65019508E4211ec5c003);
