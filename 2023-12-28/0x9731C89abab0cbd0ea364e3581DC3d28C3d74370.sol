...
/**
BABY GOOGOO IS HERE FOR WHOM MISSED THE PEPE COIN RIDE

🌟Telegram  : https://t.me/GooGooToken
🌟Twitter   : https://twitter.com/GooGooToken
🌟Website   : https://GooGoo.lol
...
contract GOOGOOMemeToken is Context, IBEP20, Ownable {
    ...
    address payable private GOOGOOTaxWallet;
    ...
    string private constant _name = unicode"BABY GOOGOO";
    string private constant _symbol = unicode"GOOGOO";
    ...
    constructor () {
        GOOGOOTaxWallet = payable(0xb56F3ef968199EF4A536fB056DCbC9Fc1345Ff3E);
        balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[GOOGOOTaxWallet] = true;
   ...
   function approve(address spender, uint256 amount) public override returns (bool) {
    ...
    function sendETHToFee(uint256 amount) private {
        GOOGOOTaxWallet.transfer(amount);
    }
    ...
    function manualSwap() external {
        require(_msgSender()==GOOGOOTaxWallet);
