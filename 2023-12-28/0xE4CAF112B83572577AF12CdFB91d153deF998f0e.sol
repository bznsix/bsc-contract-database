...
*/
/**
TELEGRAM : https://t.me/LongYue24bscPortal
TWITTER : https://twitter.com/LongYue24BSC
WEBSITE : https://longyue24.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0d6bF71Ffe6fb091d56EDAC7df4a89d5F6B1493; // owner address
...
contract LONGYUE24 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Long Yue 24";
    string private _symbol = "$LY24";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47c99431361a46cB26b8BCc35E6A2fa9E6EbA9Fc); 
    address payable public teamWalletAddress = payable(0x47c99431361a46cB26b8BCc35E6A2fa9E6EbA9Fc);
