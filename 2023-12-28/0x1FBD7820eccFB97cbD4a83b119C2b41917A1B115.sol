/**
Telegram : https://t.me/zeusdog_official
website : https://zeusdog.xyz/
*/
...
contract ZEUSDOG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZEUS DOG";
    string private _symbol = "$ZEUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd2C64635DC9a501ef127C505cac91ACeAB54857E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1d847Ea4293cead755ce910F680b816a02B250a5); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 150 * 10**5 * 10**9;
    uint256 public _walletMax = 300 * 10**5 * 10**9;
