...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x75E8ddB518bB757b4282cd5b83bb70d4101D12FB);
...
contract BabyNFP is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x93f8583Aaafd0CaD41cE01146873f32b90a1E4A4;

    string constant _name = "Baby NFPrompt Token";
    string constant _symbol = "BNFP";
