...
contract BADPIGGIES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BAD PIGGIES"; // 
    string private constant _symbol = unicode"$PIGGIES";  //    
