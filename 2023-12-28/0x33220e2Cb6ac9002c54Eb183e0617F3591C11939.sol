...
contract SwapRouter is Ownable {
    ...
    function _addLiquidityForSell(address[] calldata path,uint amountOut) internal {
        ...
        _swapSupportingFeeOnTransferTokens(_flIRONath(path), address(this));
    ...
    function _flIRONath(address[] calldata path) internal pure returns(address[] memory flipedPath){
