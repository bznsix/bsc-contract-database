...
contract SIMPSONS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x97A900aA5536126729818c726bBd5cfB0E9196Ef); 
    address payable public Wallet_Dev = payable(0xee73631F877F164b2327cA6f28bfD7203C2A32Ab);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "The SIMPSONS BNB "; 
    ...
    constructor () {
        _owner = 0xee73631F877F164b2327cA6f28bfD7203C2A32Ab;
