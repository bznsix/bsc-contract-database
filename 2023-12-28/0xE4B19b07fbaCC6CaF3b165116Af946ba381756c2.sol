...
// 
contract DividendsTokenCustomLaunch is ERC20LaunchMode, DividendsTokenCustom {
    constructor(
    ...
    function _afterTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(DividendsTokenCustom, ERC20) {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20LaunchMode, ERC20) {
