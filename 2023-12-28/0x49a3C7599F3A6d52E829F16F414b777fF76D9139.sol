...
contract BEEGROK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BEEGROK";
    string private constant _symbol = unicode"$BEEGROK";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 1200000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x6dcF500C7b41c0479BEF873F05Ee6a08b1130d36);
    address payable public MarketingWallet = payable(0xb41F24fb0Faefd073C4A4d12a966Ca129B322559);
