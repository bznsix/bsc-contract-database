...
import "../libraries/BEP20Capped.sol";
import "../libraries/BEP20Mintable.sol";
import "../libraries/Recoverable.sol";

/**
 * @dev BEP20Token implementation with Mint, Cap, Recover capabilities
 */
contract FRToken is BEP20Base, BEP20Mintable, BEP20Capped, Ownable, Recoverable {
    constructor(
        ...
        payable
        BEP20Base("ferscoin", "FR", 18, 0x312f313639393032322f4f2f4d2f432f52)
