...
contract Token is ERC20 ,Ownable{
    ...
    uint256 public swapAt =40000000000 * 1e18;
    uint256 public processGas = 200000;

    TaxRates public buyTax = TaxRates(0, 400, 0, 0);
    TaxRates public sellTax = TaxRates(0, 400, 0, 0);
    ...
    constructor() ERC20("fomo", "fomo") {
        ...
        marketingWallet = 0x4612AC8e230f826b1220481be30cBDee3AD316E8;
        ...
        _mint(msg.sender, 550000000000000 * 10 ** decimals());
        maxWalletBalance = 550000000000000 * 10 ** decimals();
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(sender == mainPair && launchBlock + 0 > block.number){
