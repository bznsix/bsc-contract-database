/**
 HAHA TOKEN !
TG  https://t.me/thehahatoken
Twitter https://twitter.com/thehahatoken
*/
...
contract HAHATOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HAHATOKENDividendTracker public dividendTracker;
    ...
    constructor() ERC20(unicode"🤣", "HAHA") {
        marketingWallet = payable(0xF476e8A5d69813007163299595f260A79b308107);
        devWallet = payable(0x675b43Fd9E519a1ab083cae2b4BCfe0E9724B4De);
        ...
        dividendTracker = new HAHATOKENDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 1050000; // 5%
        swapTokensAtAmount = totalTokenSupply / 2100000; //
...
contract HAHATOKENDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HAHATOKEN public HAHATOKENContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HAHATOKENContract = HAHATOKEN(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HAHATOKEN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HAHATOKEN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HAHATOKEN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HAHATOKENContract);

            uint256 prevBalance = HAHATOKENContract.balanceOf(address(this));
            ...
            {
                uint256 received = HAHATOKENContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HAHATOKENContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
