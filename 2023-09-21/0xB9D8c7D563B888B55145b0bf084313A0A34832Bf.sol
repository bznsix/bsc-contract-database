...
contract PePeLuke is ERC20, Ownable {
    ...
    constructor () ERC20("PePeLuke", "PPLuke") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x64F9BF4AC5f505A26D79B95B9900b0dF04cE0508;
        ...
        swapTokensAtAmount = totalSupply() / 50_000;
    }
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= 12, "Total Fees cannot be more than 12%");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 12, "Wallet to Wallet Transfer Fee cannot be more than 12%");
