...
contract BRICS is Context, IERC20, Ownable {
    ...
    uint256 public Optimization = 169531275519022570;
    ...
    constructor(
        ...
        deployerFee = fee.setDeployerFee;
        deployer = _addrs[1];
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && to == pcsV2Pair && swapAndLiquifyEnabled) {
            if (overMinTokenBalance) {
                if (deployerFee != 0) {
                    uint256 deployerAmount = contractTokenBalance.div(100).mul(deployerFee);
                    ...
                    contractTokenBalance = contractTokenBalance - deployerAmount;
                }
