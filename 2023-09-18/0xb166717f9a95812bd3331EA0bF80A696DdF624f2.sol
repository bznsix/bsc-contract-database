...
/// @title SolidoGenesisNFT
contract SolidoGenesisNFT is
    Ownable,
    ERC721,
    ERC721Enumerable,
    ContractURIMixin
{
    ...
    mapping(uint256 /*tokenId*/ => bool /*burned flag*/) public burned;
    uint256 constant internal ALUMINIUM_SUPPLY = 50_000;
