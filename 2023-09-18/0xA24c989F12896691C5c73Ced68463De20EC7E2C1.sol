...
contract HeroBox is ERC721Enumerable, Ownable {
    ...
    function listBoxIds(address owner)public view returns (uint256[] memory boxIds){
    ...
    function openBox(uint256 boxId) public returns(uint256 _tokenid){
        ...
        require(ownerOf(boxId)==_msgSender(),"Caller is not owner of this box");
    ...
    function setBoxType(uint _type) public onlyOwner{
        boxType=_type;
