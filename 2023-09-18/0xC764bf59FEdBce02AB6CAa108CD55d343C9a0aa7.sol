...
contract Blud is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x14Fe23906b1ea0c9E8328e0f8dBfBF3799F0FbC8;
    ...
    function updateFees(uint256 _marketingFeeOnSell) external onlyOwner {
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner{
        ...
        // Prevent honeypot
        _isExcludedFromMaxTxLimit[_marketingWallet] = true;
