...
contract FishingTunaTESTV2 is Ownable, ReentrancyGuard {
    ...
    {
        uint256 RewardTime = (block.timestamp - user[account].timestamp) / 60; // TEST-MODE - 86400
        // TEST MODE: // RewardTime = (RewardTime > 1) ? 1 : 0; 
    ...
    function _updateprePayment(address account) internal 
    {
        ...
        // WorkDays counter
        uint256 newCounter = (block.timestamp - startTime) / 60; // TEST-MODE - 86400
