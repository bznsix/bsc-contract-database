...
contract MegaMemeChain is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 21e3 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 0;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x4D3e190bD42d01B54d206371B8eCfa2fc84Bd777;
    ...
    constructor() BEP20("MegaMemeChain", "MegaMemeChain") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount >= 21e2,"Swap threshold amount should be upper or equal to 0.01% of tokens");
        require(new_amount <= 21e4,"Swap threshold amount should be lower or equal to 1% of tokens");
    ...
    function AddExemptFee(address[] memory accounts)
        external
        onlyOwner
    {
    ...
    function RemoveExemptFee(address[] memory accounts)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < accounts.length; i++) {
