...
contract ERROLMUSK is ERC20, Ownable {
    ...
    constructor() payable ERC20("ERROL MUSK", "$ERROLMUSK") {
        ...
        marketingWallet = 0xBB972a6aBE762C98304766B58527B466132Aa57a;

        dividendTracker = new DividendTracker(39 * 10**5, rewardToken);
