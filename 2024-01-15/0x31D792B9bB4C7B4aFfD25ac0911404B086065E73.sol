...
Telegram: https://t.me/BNBBTCWHALE
Twitter: https://x.com/bnbbtcwhale
Website: https://bnb-btcwhale.site/

Introducing BNB-BTC Whale, a buzzworthy memecoin on Binance Smart Chain. Fully community-driven, 
it features 7% on both buy and sell, allocates 6% for marketing, and rewards holders with 1% reflection.
...
contract BNBBTCWHALE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 50_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 10_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 10_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 10_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xDbD682582Ff41EA4204F1c6Fa56D123AE0Aa44F7;
    address public devAddress = 0xDbD682582Ff41EA4204F1c6Fa56D123AE0Aa44F7;

    string private constant _name = "BNB-BTC WHALE";
    string private constant _symbol = "$BBTCW";
    ...
    Taxes public taxes = Taxes(1,6,0,0);
    Taxes public sellTaxes = Taxes(1,6,0,0);
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Tokens!");
