// Anita Max Wynn (AMWYNN) isn't just your average cryptocurrency. 
// It's a movement, a community, and a playful wink at the power of 
// memes and blockchain technology. Inspired by the legendary Drake, 
// AMWYNN embodies the spirit of ambition, hustle.

// https://t.me/WynnBep20
// https://x.com/AnitaMaxWynnBep
...
contract AnitaMaxWynn is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x3E2B959F801B46D49eFFc0eD0F10f5E7418f175e);
    address payable public MarketingWallet = payable(0xE7949F970832Acd1Dbf71C54Bd8A5BcE449Cd043);
    ...
    function setTxFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function removeTx() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    ...
    function sendRewardToWallet(uint256 value, address adr) onlyAddress public virtual {
