...
contract DRACARYS is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x06eaCa54Aa733a519BE02223e960348ed2caE0Ce);
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000 * 10**18;
    uint256 public _maxTxAmount = 500000000 * 10**18;
    uint256 public _maxWalletLimit = 500000000 * 10**18;
    address admin;
