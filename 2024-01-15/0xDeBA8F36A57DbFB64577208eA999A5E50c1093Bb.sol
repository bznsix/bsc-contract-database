/**
TELEGRAM: https://t.me/bellstokenbsc
X : https://twitter.com/Bellstokenbsc
WEBSITE : https://bellstoken.xyz
**/
...
contract BELLS is Context, IERC20 { 
    ...
    string private constant _name = "BELLS";
    ...
    address payable public DevWallet = payable(0xFf12bE74818563Cc6841cdAF2e3c97FC39A9B8Ec);
    address payable public MarketingWallet = payable(0x37Bb8e079111Da5256C8B34e847906DE1e8e82BD);
    ...
    function setNewMax(uint256 newmaxWallet) external onlyAddress {
