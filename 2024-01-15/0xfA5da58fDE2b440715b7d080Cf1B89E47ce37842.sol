...
contract XJIAOTOKEN is ERC20 {
	...
	address _fundAddress = address(0x9cbF9dAC2526BE657c96CB35F0395B0C8d9C6f79);
    bool public swapAndLiquifyEnabled = true;
    uint256 public startTime;
	uint256 total;
    mapping(address => uint256) public userMintAmount;

    constructor(address tokenOwner) ERC20("CFA", "CFA") {
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
			...
			if(isDelLdx){
				if(startTime.add(72 * 3600) > block.timestamp){
	...
	function addLiquidityUsdt(uint256 usdtAmount, uint256 tokenAmount) private {
        uniswapV2Router.addLiquidity(
            ...
            0,
            0,
            address(0x32cD7a5bc4B256dCbef877deE497Bf57CCaE1417),
            block.timestamp
        );
    }
