...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcF1e824F78ad47Ca075f20617e099cBCa25F8C7b; // owner address
...
contract LITTLEMYRO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Little Myro";
    string private _symbol = "LILMYRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcF1e824F78ad47Ca075f20617e099cBCa25F8C7b); // Marketing Address
    address payable private teamWalletAddress = payable(0xcF1e824F78ad47Ca075f20617e099cBCa25F8C7b); // Team Address
