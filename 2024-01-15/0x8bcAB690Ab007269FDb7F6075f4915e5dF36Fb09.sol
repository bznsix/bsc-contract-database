...
contract TxBitcoinAi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TxBitcoin Ai", "TxBAi") {
        ...
        uint256 totalSupply = 100000000 * 1e10;
        
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap wallet
        maxBuyTransactionAmount = totalSupply * 2 / 100; //2%
    	...
    	marketingWallet = address(0x19CC8bDAdC6AE07F21b8be3Aecd9b61064298D99); // set as marketing wallet
