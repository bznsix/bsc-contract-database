...
//--- Contract v3 ---//
contract SAFEDRAGON is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xf77F80D79c1671F3a04e54980fBD83bF3f44D07B); // build: 0xf77F80D79c1671F3a04e54980fBD83bF3f44D07B
    AntiBot private AX;


//--- v3 Allocations by Freddy analytixaudit.com ---//
    uint256 private buyAllocation = 33;
    uint256 private sellAllocation = 33;
    uint256 private liquidityAllocation = 34;


    IRouter02 public swapRouter;
    string constant private _name = "SAFEDRAGON";
    string constant private _symbol = "SAFEDRAGON";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xB0433F9345b4B59bAB98ffC86D8Df1C40722dE1e);
