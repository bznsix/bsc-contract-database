...
——————————
After enable trending :

0% BUY | 10% SELL | 15 minutes after launch
0% BUY | 8% SELL  | 30 minutes after launch
5% BUY | 5% SELL  | Original TAX

WEBSITE: WWW.BABYPOLKIN.COM
──────────────────────────────┘
...
contract BabyPolkin is ERC20, Ownable {
    ...
    constructor () ERC20("BabyPolkin", "BabyPolkin") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xbB5c9a95DFFCc4018A2191115a8A276e4047b0f4);
        ...
        feeReceiver = 0x3Ea0d8B81650918C6F571002BEf7347826aC2ECa;
