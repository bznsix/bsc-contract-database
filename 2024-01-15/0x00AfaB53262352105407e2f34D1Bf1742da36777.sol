...
contract DragonUni is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DragonUni";
    string private _symbol = "DragonUni ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF5fde491D2B82a7E6b13B20Ec5d925ce95dd03Da); // Marketing Address
    address payable public teamWalletAddress = payable(0xF5fde491D2B82a7E6b13B20Ec5d925ce95dd03Da); // Team Address
