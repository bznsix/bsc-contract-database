...
contract Staking is ReentrancyGuard {
    ...
    uint[3] public referralLevelRewards = [5, 3, 2];
    ...
    function stakeTokens(uint256 tokenAmount, uint256 stakingDuration, address referrer) public nonReentrant notBlacklisted(msg.sender) {
        require(stakingDuration == 30 || stakingDuration == 45 || stakingDuration == 60 || stakingDuration == 75, "Invalid staking duration");
    ...
    function withdraw(uint256 _index) public nonReentrant notBlacklisted(msg.sender) whitelisted (msg.sender) {
