...
contract BUFFALOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buffalo Inu";
    string private _symbol = "BUFFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x457549FD1e42dbEBffB1184804ed23f66DcBf54F); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x457549FD1e42dbEBffB1184804ed23f66DcBf54F); // BuyBack Address
