/**
 *Submitted for verification at Etherscan.io on 202-01-14
*/
...
contract BreakerCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCbd4D20911CF8E7eb695f66De5ff2C87ae50D0eE); 
    address payable public Wallet_Dev = payable(0x549021e66cF4caC4239673747d56C6c6415c1B77);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =1000000000000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Breaker Coin"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 75 / 100;
    ...
    constructor () {
        _owner =0xCbd4D20911CF8E7eb695f66De5ff2C87ae50D0eE;
