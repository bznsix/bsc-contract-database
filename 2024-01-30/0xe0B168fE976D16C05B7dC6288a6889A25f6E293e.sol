...
contract SLRToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 365055575557e18;
    ...
    constructor() {
        ...
        _mint(0x437569bCB8e46369FF2ceFb9c20F53eFF3e9AFC5, initSupply);
        setWList(0x437569bCB8e46369FF2ceFb9c20F53eFF3e9AFC5, true);
    ...
    function _transfer(
        ...
        //         require(wList[to], "Swap trade failed.");
        //     }
        // }
