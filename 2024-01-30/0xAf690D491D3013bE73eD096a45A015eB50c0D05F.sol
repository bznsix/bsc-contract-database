...
contract Nikkycat is IBEP20, Auth {
    ...
    string constant _name = "Nikkycat TOKEN";
    string constant _symbol = "NIKCAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 9) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100; 
    ...
    address public marketingFeeReceiver = 0xEf2DFc9A9A2Aca8fCa29f191134E0FDfb56277e5;
    address public devFeeReceiver = 0x27a0D8cb6976aFdA82D381aeDec11Ade50e02A34;
