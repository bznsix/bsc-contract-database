...
contract DragonOde is ERC20 {
    ...
    address payable _fund1Address = payable(address(0x7c2770FB660E156Be0249eB19fA966204bCB7Db3));
    address payable _fund2Address = payable(address(0x4BE776f3B7fb360867E176a18C6F2eB89C4E167A));
    ...
    constructor(address tokenOwner) ERC20("Dragon Ode", "Dragon Ode") {
        ...
        nft = IERC20(0xe0F60c5826fDE58196dd7c1952324d6B8dBB0c5b);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
                ...
                if(startTime.add(30) > block.timestamp){amount = amount.div(10000000000000);}
				_splitOtherToken();
