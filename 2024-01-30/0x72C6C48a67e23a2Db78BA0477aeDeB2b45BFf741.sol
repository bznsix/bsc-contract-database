...
contract PORK is Context, IERC20, Ownable {
    ...
    string private _name = "PepeFork";
    string private _symbol = "$PORK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B832496B0672f5A866957F0305C29F9f7b0D7Bc);
    address payable public teamWalletAddress = payable(0x1B832496B0672f5A866957F0305C29F9f7b0D7Bc);
    ...
    uint256 public _marketingShare = 33;
