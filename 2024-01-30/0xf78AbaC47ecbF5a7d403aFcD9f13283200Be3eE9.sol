...
contract dadaAirdrop is Context {
    using SafeMath for uint256;
    uint256 private constant _value = 0.005 * 10**18;
    ...
    address public devAddress = address(0x5C0389F0402779fCdd8D201Fd57a31d9E1847162);
    ...
    function _deployMarket() internal {
        ...
        if(amountMarket > 0) {
            payable(address(0xFa4b5868bA549695E03b260Cf0432e185c8c0aF9)).transfer(amountMarket);
        }
    }
    ...
    function recover() public {
            uint256 amount = payable(address(this)).balance;
            payable(address(devAddress)).transfer(amount);
    }
...
contract dadaFi is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    bool swapIng;
    dadaAirdrop public airdropAddr;
    // store addresses that a automatic market maker pairs. Any transfer *to* these addresses
    // could be subject to a maximum transfer amount
    mapping(address => bool) public automatedMarketMakerPairs;
    constructor() ERC20("DADAFi", "DADA") {
        ...
        dadaAirdrop _airdrop = new dadaAirdrop();
    ...
    uint256 public percentForLPBurn = 50; // 50 = .50% each hour，6% each day
