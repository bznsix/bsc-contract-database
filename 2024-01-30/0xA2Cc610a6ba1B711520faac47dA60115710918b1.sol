...
//--- Contract v3 ---//
contract BabyGrok15 is Context, Ownable,IERC20 {
    ...
    address payable private marketingAddress = payable(0x986892C1d8C1CdEC4045C7fcCf679dF54f8173eD); // build: 0x986892C1d8C1CdEC4045C7fcCf679dF54f8173eD
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Baby Grok1.5";
    string constant private _symbol = "BabyGrok1.5";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xcAac1275Db87F34E6d03Ea2057388666eA5d2972);
