/*
########################################
Token generated by PT VSHA UTAMA DIGITAL
########################################
*/
...
contract VSHA_GOLD_COIN is ERC20, ERC20Burnable, Ownable2Step, Mintable, Initializable {
    ...
    constructor()
        ERC20(unicode"VSHA GOLD COIN", unicode"VGC") 
        Mintable(10000000)
    {
        address supplyRecipient = 0x02AA326c38aC8a1251F6fb3B35284176685E5E77;
        
        ownerAddressSetup(0x02AA326c38aC8a1251F6fb3B35284176685E5E77);
        ownerFeesSetup(0, 1000, 0);
        ...
        updateMaxWalletAmount(100000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 500000 * (10 ** decimals()) / 10);
        _transferOwnership(0x02AA326c38aC8a1251F6fb3B35284176685E5E77);
    }
    ...
    */
    ...
    function ownerFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        totalFees[0] = totalFees[0] - ownerFees[0] + _buyFee;
        totalFees[1] = totalFees[1] - ownerFees[1] + _sellFee;
        totalFees[2] = totalFees[2] - ownerFees[2] + _transferFee;
    ...
    function _transfer(
        ...
        if (!_swapping && amount > 0 && to != address(routerV2) && !isExcludedFromFees[from] && !isExcludedFromFees[to]) {
            ...
            if (txType < 3) {
                ...
                if (ownerFees[txType] > 0) {
                    ownerPortion = fees * ownerFees[txType] / totalFees[txType];
                    _sendInTokens(from, ownerAddress, ownerPortion);
                    emit ownerFeeSent(ownerAddress, ownerPortion);
                }

                _liquidityPending += fees * liquidityFees[txType] / totalFees[txType];

                fees = fees - ownerPortion;
            }
