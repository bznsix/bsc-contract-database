// Telegram: https://t.me/honkabsc
// Website: https://honkaonbsc.fun
...
contract HONKA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HONKA";
    string private constant _symbol = unicode"$HONKA";
    ...
    address payable public DevWallet = payable(0x69AC728641599D18bfA1A7Ef4eC670E90b412489);
    address payable public MarketingWallet = payable(0x406BEE552E9f89AC8aA54f6566f27aFeA1712672);
    ...
    function tradingEnable() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
