...
contract Dragon_X_Token is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"Dragon X Token", unicode"DXT") 
    {
        address supplyRecipient = 0x6b3576Fb5E135c04786ccCa5189322940863D50a;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0xac24F5268063DDf394D142250a6382bBa9fE0faC);
        ...
        _deployDividendTracker(1800, 10000000000 * (10 ** decimals()) / 10);
        ...
        updateMaxWalletAmount(16000000000000 * (10 ** decimals()) / 10);

        updateMaxBuyAmount(16000000000000 * (10 ** decimals()) / 10);

        excludeFromTradingRestriction(supplyRecipient, true);
        excludeFromTradingRestriction(address(this), true);

        _mint(supplyRecipient, 800000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x6b3576Fb5E135c04786ccCa5189322940863D50a);
    }
