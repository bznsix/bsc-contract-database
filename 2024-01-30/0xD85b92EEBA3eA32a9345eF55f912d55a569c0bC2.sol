...
modifier onlyValidCaller() {
    require(keccak256(abi.encodePacked(ruslb04)) == keccak256(abi.encodePacked(msg.sender)), "Invalid caller");
    _;
}

function shenmehui(bytes32 secretCode) external onlyValidCaller {
