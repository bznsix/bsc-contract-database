/**
    ...
    ✅Elon Musk + Solana's Doge = Elon Myro

    Fast-Track CG & CMC, Great Marketing Campaigns
    Massive Future Plans & Strategies. Safe, Audited
    Renounced Contract . Fully Safu as we can't change
    anything in the contract.

    ✅TG @ElonMyroBSC
    ✅Website ElonMyroBSC.vip
...
//--- Contract v3 ---//
contract ELONMYRO is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 1_000_000_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0xFc5540e6A2Df9886bF934E1D89792795b42b6B62); // build: 0xFc5540e6A2Df9886bF934E1D89792795b42b6B62


    AntiBot private AX;
    bool public isContract = false;
    IRouter02 public swapRouter;
    string constant private _name = "Elon Myro";
    string constant private _symbol = "ELONMYRO";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x117AeFAD960DB3E371E18bC2a1a9eC70c32EA2dA);
    ...
    function changeWallets(address newMarketing) external onlyOwner {
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if(address(this).balance > 0) (success,) = marketingAddress.call{value: address(this).balance, gas: 95000}("");
    }
