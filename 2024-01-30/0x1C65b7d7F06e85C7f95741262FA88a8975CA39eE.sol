...
StrAVAX 
- $SVAX
Stravax is not just a project; it's a community-driven initiative fueled by the vision of Dr. Stranger. 
Our mission is to redefine the way rewards are distributed, and AVAX tokens are at the heart of it all.
 
Website  : https://stravax.tech
Telegram : https://t.me/StrAvax
Twitter  : https://twitter.com/StrAvaxbsc
...
contract StrAvax is ERC20, Ownable {
    ...
    constructor() payable ERC20("strAvax", "SVAX") {

        rewardToken = 0x1CE0c2827e2eF14D5C4f29a091d735A204794041;
        ...
        marketingWallet = 0xD017eF66a846C24755442424eB6b8048BeD88e4e;

        dividendTracker = new DividendTracker(41 * 10**5, rewardToken);
