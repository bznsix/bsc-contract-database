...
Telegram: https://t.me/CryptoCanvasAI
Twitter: https://twitter.com/CryptoCanvasBot
Website: https://cryptocanvas.cc
...
library Address{
 ...
 contract CryptoCanvas is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf47B374056dcC45f69dDd47D0c232E87b4A4d29d;
    address public developmentWallet = 0x88Adf9F9921d647eb790cdC8c7F960d38ff5f49D;

    string private constant _name = "CryptoCanvas";
    ...
    Taxes public taxes = Taxes(0, 1, 2, 0);
    Taxes public sellTaxes = Taxes(0, 1, 2, 0);
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(developmentWallet).sendValue(donationAmt);
        }
    }
