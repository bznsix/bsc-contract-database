...
contract NUAN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NUAN";
    string private _symbol = "NUAN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x851A533E512D1DF3d1f42C2180a10157147eAA93);
