...
/**
Telegram: https://t.me/ponkepizzaportal
twitter: https://twitter.com/ponke_pizza
*/
...
contract PonkePizza is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PonkePizzaDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Ponke Pizza", "PP") {
        marketingWallet = payable(0xA362f8f20EE10B26343E31ba8Df20796308e7C00);
        devWallet = payable(0x71a3b955dd632e33aE0150B0920d50eF8f2FD449);
        ...
        dividendTracker = new PonkePizzaDividendTracker(
            payable(this),
            router,
...
contract PonkePizzaDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        PonkePizzaContract = PonkePizza(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PonkePizza_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PonkePizza_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PonkePizzaContract);

            uint256 prevBalance = PonkePizzaContract.balanceOf(address(this));
            ...
            {
                uint256 received = PonkePizzaContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PonkePizzaContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
