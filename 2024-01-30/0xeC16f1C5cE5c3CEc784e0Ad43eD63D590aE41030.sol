...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyDestroyFee = 60;
    ...
    uint256 public _sellDestroyFee = 60;
        ...
        if (takeFee) {
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        feeAmount += destroyAmount;
                        _takeTransfer(sender, address(0xa2De09FE3b0Bed70e320afEC490149fD9314da1a), destroyAmount);
                    }
                }
...
contract WEB is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000000000,
        address(0xc9AC593aa4516f4adE8Fa7BD86d93163656b0032),
        address(0x25FbeF16dfE64Baf329B7AD54e19B0547a211540),
        address(0xa9f248EAB06269E519D9aeEFa8AE353187Ff6477),
        address(0xa2De09FE3b0Bed70e320afEC490149fD9314da1a),
        1000000000000,
        0,
        1000000000000
    ){
