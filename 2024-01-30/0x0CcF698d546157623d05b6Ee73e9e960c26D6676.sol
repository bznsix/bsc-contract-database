...
contract ShaoJi6676 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShaoJi6676";
    string private _symbol = "ShaoJi";
    uint8  private _decimals = 18;
    uint256 private _totalSupply = 667666766676 * 10**_decimals;
