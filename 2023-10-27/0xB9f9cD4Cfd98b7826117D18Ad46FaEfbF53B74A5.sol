        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1DE49BA7839ADc7EB92185866DAdB8422FbB11be), block.timestamp
                );
            }
        }
    }
...
contract LongT is AbsToken {
    constructor() AbsToken(
        ...
        address(0xdE4C6bb39E73b2261b116486cD4Bc66A807f8eE1),//FundAddress
        address(0x1DE49BA7839ADc7EB92185866DAdB8422FbB11be)//ReceiveAddress
    ){
    }
}