...
contract HALLOWEEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x97D5C582D0b17b3F90c616B00230549b32E404C0); 
    address payable public Wallet_Dev = payable(0xe117080B4223fD70F9c15615Dafd81ACD250E6B2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "HALLOWEEN BSC "; 
    ...
    constructor () {
        _owner = 0xe117080B4223fD70F9c15615Dafd81ACD250E6B2;
