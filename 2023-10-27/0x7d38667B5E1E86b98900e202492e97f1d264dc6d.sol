...
contract TheThreeBodyProblem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xaA0FDf574fD0C41B14fe6955cFD6eC2bE4359065); 
    ...
    uint256 private _tTotal = 900000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TheThreeBodyProblem";
    string private _symbol = "2TBP";
    ...
    uint256 private marketingDivisor = 90;
    
    uint256 public _maxTxAmount = 500000  * 10**9;
    uint256 private minimumTokensBeforeSwap = 40  * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**19;

    // LookBack into historical sale data
    SellHistories[] public _sellHistories;
    bool public _isAutoBuyBack = false;
    uint256 public _buyBackDivisor = 6;
