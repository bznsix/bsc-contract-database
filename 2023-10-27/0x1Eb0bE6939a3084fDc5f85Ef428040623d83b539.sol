...
contract ROEE is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x661eF6Ed7f72039fBaCEDd7F4A33F18862f54589);
    address payable private _twdmkt = payable(0x661eF6Ed7f72039fBaCEDd7F4A33F18862f54589);
    
    string private constant _name = "ROE IS JOE ANGRY VERSION";
    string private constant _symbol = "$RJoe";
