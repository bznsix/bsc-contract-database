...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                ...
                if (_swapPairList[from] && block.number < startBlock + killbatch){
    ...
    uint256 public killbatch=100;
    function setKillbatch(uint256 newValue) public onlyOwner{
        killbatch = newValue;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        9999,
        address(0xB6471A1949BAA80fE6A960757E70ab07F450Cf3F),
        address(0xB6471A1949BAA80fE6A960757E70ab07F450Cf3F),
        address(0xB405832F174B92400b50b46b7cc57Bc5DE08EC6d)
    ){
    }
}