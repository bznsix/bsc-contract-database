...
contract EXngToken is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 2000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 2000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 2000000000 * 10**_decimals;

    address public marketingAddress = 0x863C1874940Bad7eeA3cEa4e5E95A5B77bD4B246;
    address public devAddress = 0x863C1874940Bad7eeA3cEa4e5E95A5B77bD4B246;

    string private constant _name = "EXng Token";
    string private constant _symbol = "EXng";
