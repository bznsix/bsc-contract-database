...
contract XAPE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf30DC37740C6B93f10dc754d8d242CE154F93e9F);
    address payable public burnedWalletAddress = payable(0xf30DC37740C6B93f10dc754d8d242CE154F93e9F);
    ...
    function setTaxFee(
        ...
        require(
            newBuyLiquidityFee <= 30 && newBuyMarketingFee <= 30 &&
            newSellLiquidityFee <= 30 && newSellMarketingFee <= 30,
            "Fee cannot exceed 30% SAFE FOR investor"
        );
