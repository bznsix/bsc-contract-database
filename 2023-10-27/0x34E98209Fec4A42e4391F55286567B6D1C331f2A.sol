...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "YL";
    string private _symbol = "YL";
    ...
    address public ownerAddres = address(0x8f76d5F48B3190cb690c884C94a05A1f78002dB8);
    address public devAddress = address(0x63C1C9b67b0ab19124705C34af6048E5ff06188d);
    ...
    uint256 public _maxTxAmount = 6000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 6 * 10 ** 18;
    ...
    constructor () public {
        ...
        IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d);
        // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), fistToken);
