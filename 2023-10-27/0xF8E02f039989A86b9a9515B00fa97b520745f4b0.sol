...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x3709b9D582a59310ad6A75179Ed01Eb0665BeAa1;
    uint8 public marketingTax = 12;
    ...
    {
        require(tax <=12,"Cannot set the fee more than 12%");
        marketingTax = tax;
    }
...
contract Bomb is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Bomb", unicode"💣", 9) {
    _owner = msg.sender;
