...
Website  : https://pokepink.online
Medium   : https://medium.com/@pokepink
Twitter  : https://twitter.com/PokePinkBsc
Telegram : https://t.me/PokePink
...
contract POKEPINK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "POKEPINK";
    string private _symbol = "$POPINK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA671295611Cb091b20a3aCba4723732e3e1656a3); // Marketing Address
    address payable private teamWalletAddress = payable(0xA671295611Cb091b20a3aCba4723732e3e1656a3); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 25;  // original 12
