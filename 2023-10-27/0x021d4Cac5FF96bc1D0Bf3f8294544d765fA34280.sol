...
contract WhiteBnbTiger is Context, IERC20, Ownable {
    ...
    string private constant _name = "WHITE BNB TIGER"; // 
    string private constant _symbol = "$WBNBT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xE11999C9b47c09D44526dDbac78B6fc75E04EEF3;
