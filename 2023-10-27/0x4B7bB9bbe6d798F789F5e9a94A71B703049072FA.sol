...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB56054692945b4ff1310764F3FA26524C9ae071a; 
...
contract Tokenfi2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "TOKENFI 2.0";
    string private constant _symbol = unicode"TOKEN2";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0xB56054692945b4ff1310764F3FA26524C9ae071a); // Marketing Address
    address payable public teamWalletAddress = payable(0xB56054692945b4ff1310764F3FA26524C9ae071a); // Team Address
