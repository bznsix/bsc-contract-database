...
Max Cap 200,000,000 Tokens
400,000 tokens trading limit per transaction

10% Trading Fee
1. 3% Allocate to All Holders
2. 5% Add to LP
3. 2% Marketing and Operational Expenses & Burn
**/
...
contract NFA is Context, IERC20, Ownable {
    ...
    address public constant TEAM_ADDRESS =
        0xC321008D0AE076cA1312C76FC4543cce42eD5fdb;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "NFA::transfer: Mkt value invalid"
            );
