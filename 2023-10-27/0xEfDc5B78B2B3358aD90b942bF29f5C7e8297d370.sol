...
contract RUG_2023 is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "RUG2023";
    string constant _symbol = "RUG2023";
    ...
    uint256 public _maxTxAmount = 2500000000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 4000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0FB1A4ed9DC94654DEC5C5f55A35B309075e518a;
        devWallet = 0x6398f7949Ca5dE4E7e28b76DC023BDa48e9E15A9;
