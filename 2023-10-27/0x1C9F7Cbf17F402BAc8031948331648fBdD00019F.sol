...
contract StonkMemeMan is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69 * (10**10) * (10**9);
    ...
    string private constant _name = "StonkMemeMan";
    string private constant _symbol = "Stonks";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0xC2690052d49F4ed8977AAd93b70dE19C9a94DB2A);
    address payable private _marketing2Address = payable(0xae8539523bf582B8ED14305b71F49bb757823b56);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        uint256 mkt2Amount = amount.sub(mktAmount);
