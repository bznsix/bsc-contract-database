...
import {Address} from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
...
contract Token is ERC20, ERC20Burnable, MktCap {
    ...
    uint public minDistribution = 1e9;
    ...
    function deposit(uint amountB) internal override {
        IERC20(_baseToken).transferFrom(_msgSender(), address(this), amountB);

        // swapToReward
        uint amountIn = IERC20(_baseToken).balanceOf(address(this));
