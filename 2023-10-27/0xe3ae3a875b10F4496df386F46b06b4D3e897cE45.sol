...
contract SocialInu is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x6AC901450adfeAC7bc8Db6BD46A98ad377A11e59;
 
    string constant _name = "Social Inu";
    string constant _symbol = "SOCI";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //1% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 1) / 100;  //2% max wallet
    ...
    function setTxLimit(uint256 amountPercent) external authorized {
   ...
   function setWalletLimit(uint256 amountPercent) external authorized {
    ...
    function setBlacklistMode(bool _status) external authorized {
        blacklistMode = _status;
    }
 
    function blacklistAddress(address[] calldata addresses, bool _value) external authorized {
        for (uint256 i; i <addresses.length; ++i) {
            isBlacklisted[addresses[i]] = _value;
