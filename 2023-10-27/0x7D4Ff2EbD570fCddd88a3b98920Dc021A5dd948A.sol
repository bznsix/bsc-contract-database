...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8f45e9EDDC12B42ab960bE6d1c15f8AbB01aBF8 ; // owner address
...
contract BEBEFINN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BEBEFINN";
    string private _symbol = "BF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa8f45e9EDDC12B42ab960bE6d1c15f8AbB01aBF8); // Marketing Address
    address payable private teamWalletAddress = payable(0xa8f45e9EDDC12B42ab960bE6d1c15f8AbB01aBF8); // Team Address
