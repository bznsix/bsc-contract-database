...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xab78C7a7DCeBb347ff7d4cA8c033da88617C52aB; // owner address
...
contract HLB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HallowBurn";
    string private _symbol = "$HLB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xab78C7a7DCeBb347ff7d4cA8c033da88617C52aB); // Marketing Address
    address payable private teamWalletAddress = payable(0xab78C7a7DCeBb347ff7d4cA8c033da88617C52aB); // Team Address
