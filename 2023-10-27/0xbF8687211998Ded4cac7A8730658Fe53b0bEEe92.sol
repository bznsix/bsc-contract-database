...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x928E6eFd5f9919D6b3a7A67f7c184598D2349E52; // owner address
...
contract LongWangZhou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LONGWANG Zhou";
    string private _symbol = "LWZ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x928E6eFd5f9919D6b3a7A67f7c184598D2349E52); // Marketing Address
    address payable private teamWalletAddress = payable(0x928E6eFd5f9919D6b3a7A67f7c184598D2349E52); // Team Address
    ...
    uint256 private _totalSupply = 666 * 10**_decimals;
    uint256 public _maxTxAmount = 6 * 10**_decimals; 
    uint256 public _walletMax = 6 * 10**_decimals;
