/**
Telegram https://t.me/HITMEUPBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8536B2b6377cd7F0096f722e6156BcdfD8cD82B3;
...
contract HITMEUP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HitMeUp";
    string private _symbol = "BTC-ETH-BNB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb71aE892EAA00d6aE435437b71FC9FeF30454c97);
    address payable public teamWalletAddress = payable(0xb71aE892EAA00d6aE435437b71FC9FeF30454c97);
