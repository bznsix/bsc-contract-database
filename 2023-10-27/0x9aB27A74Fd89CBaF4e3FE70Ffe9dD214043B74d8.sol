...
// Root file: contracts/v5/games/CryptoDropTwoWinV5.sol
...
/// @notice CryptoDrop Two Win V5
contract CryptoDropTwoWinV5 is BinanceVRFElementIdBytes16 {
    using SafeERC20 for IERC20;
    using Address for address;

    uint256 internal constant BET_SIZE = 0.001 ether;
    uint256 internal constant PRECISION = 1 ether;
    uint256 internal constant WIN_SIZE = 0.02 ether; //2% or 0.02
    ...
    uint256 internal constant WIN_MATCHES = 2;
    ...
    function _processBetWithRandomness(RandomnessRequestData storage _data, uint256 _randomness) internal virtual override {
        ...
        for (uint8 j = 5; j > 5 - WIN_MATCHES; j--) {
