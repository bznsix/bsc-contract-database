...
/**
https://t.me/MicroLiquidityToken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9b0B2a4CfF50172Ff92A1D54B95043881D693742; // owner address
...
contract MicroLiquidity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Micro Liquidity";
    string private _symbol = "ML";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9b0B2a4CfF50172Ff92A1D54B95043881D693742); // Marketing Address
    address payable private teamWalletAddress = payable(0x9b0B2a4CfF50172Ff92A1D54B95043881D693742); // Team Address
    ...
    uint256 public _maxTxAmount = 99 * 10**_decimals; 
    uint256 public _walletMax = 198 * 10**_decimals;
