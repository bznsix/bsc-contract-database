...
/*
Telegram: https://t.me/XrpConnect
Twitter: https://twitter.com/XrpConnect
*/
...
contract XrpConnect is BEP20, Ownable {
    ...
    uint256 public constant totSupply =  1000000 * 10**9;
    ...
    constructor() BEP20("XrpConnect", "XrpConnect") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= (1 * 10**8) / 1000, "Swap threshold amount should be lower or equal to 1");
