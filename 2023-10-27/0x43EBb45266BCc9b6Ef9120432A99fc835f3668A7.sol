//Telegram: https://t.me/grimacebsc
...
contract GrimAceBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Grim Ace";
    string private _symbol = unicode"$grim(BSC)ace";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xDA9831219e7986F3ABC2558Fe50c89Cf17449056);
    address payable private taxWallet2 = payable(0xDA9831219e7986F3ABC2558Fe50c89Cf17449056);
    ...
    uint256 public _marketingShares = 50;
    uint256 public _developmentShares = 50;

    uint256 public _totalTaxIfBuying = 15; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 30; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 9;

    uint256 private _totalSupply = 666_969_999 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*666969999/666969999;
    uint256 public _walletMax = _totalSupply*666969999/666969999;
    uint256 private minimumTokensBeforeSwap = _totalSupply*666969999/666969999; 
