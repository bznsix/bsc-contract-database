        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x61EDF29Abcf7e24D932937f84A61B2De5015401F), block.timestamp
                );
            }
        }
    }
...
contract  YYDSLONG is AbsToken {
    constructor() AbsToken(
        ...
        address(0x61EDF29Abcf7e24D932937f84A61B2De5015401F)//ReceiveAddress
    ){
    }
}