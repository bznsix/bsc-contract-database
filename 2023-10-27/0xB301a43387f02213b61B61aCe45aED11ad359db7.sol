...
contract FOX2 is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 10000000000 * 10e9;
    
    address public marketingWallet = 0x091a7e27c1604a4983a80Dc19C93237B20293CcD;
    ...
    constructor() ERC20("FOX2.0", "FOX2.0") {
    ...
    function setTaxes(uint256 _marketing, uint256 _liquidity) external onlyOwner{
