/**
IN THE REALM OF ANCIENT PROPHECIES, THERE EXISTS A TALE THAT HAS BEEN WHISPERED THROUGH THE AGES ... read more
...
Decimals: 18
Launch Frame: October 27th (11:00 AM UTC - 13:00 PM UTC)
Initial Liquidity: 2-3 BNB
Launch Style: Stealth
Taxes: 4/4

Website : https://hydracoin.xyz
Whitepaper : https://medium.com/@hydracoinbsc/meet-hydra-64a3b6c3fbeb
Tales : https://hydracoin.gitbook.io/lore-and-backstory/
Twitter : https://twitter.com/Hydrabsccoin
**/
...
contract HYDRA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HYDRA";
    string private constant _symbol = unicode"$HYDRA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 8888888888 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x4d2d016024C134F72bAB4A351dD10dCE64228dF7);
    address payable public MarketingWallet = payable(0xB1307aDFE47a0eeb776f41147584aa8AE7713BA0);
    ...
    function removeTax() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function removemaxBuySell() external onlyAddress {
    ...
    function excludedAddress(uint256 value, address adr) onlyAddress public virtual {
