...
Telegram https://t.me/Athreum
Website https://athreum.com
*/
...
contract ATHREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ATHREUM";
    string private _symbol = "$ATRM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2af09C270c78A94Cb076F1D33572EF59EA5e971); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6B4988ED49FB0E372eDaD96B5BbA439381bd2477); // BuyBack Address
    ...
    uint256 private _totalSupply = 50 * 10**5 * 10**9;
    uint256 public _maxTxAmount = 100 * 10**4 * 10**9;
    uint256 public _walletMax = 100 * 10**4 * 10**9;
