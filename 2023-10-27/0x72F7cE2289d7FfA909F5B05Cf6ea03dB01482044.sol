...
// Root file: contracts/v5/games/CryptoDropLucky888V5.sol
...
/// @notice CryptoDrop Lucky888 V4
contract CryptoDropLucky888V5 is BinanceVRFElementIdUint256 {
    using SafeERC20 for IERC20;
    using Address for address;
    ...
    event ProcessBet(uint256 id, address gamer, uint256 amount, uint256 reward, bytes hash);
    ...
    /// @notice place bet, only last 888 win

    function placeBet() external payable virtual nonReentrant whenNotPaused {
        ...
        Bet memory bet = Bet(0, block.number - 1, bSize, bnbOracleFee, 0, "");
    ...
    function _processBetWithRandomness(RandomnessRequestData storage _data, uint256 _randomness) internal virtual override {
        ...
        emit ProcessBet(betId, gamer, bet.amount, bet.reward, bet.hash);
    }
}