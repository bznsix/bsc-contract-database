...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5Bdd298099A6E8f12B73f97B5c8Fddc73DE24E68; // owner address
...
contract FlokiChain is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Chain";
    string private _symbol = "FC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D01f35968D2ec0e375a471A396abB648C56454a); // Marketing Address
    address payable public teamWalletAddress = payable(0x50bcaACC88cA5CBCD4c43911a33f54F761FDA325); // Team Address
    ...
    uint256 public _teamShare = 5; // original 12

    uint256 public _totalTaxIfBuying = 10;  // original 12
    uint256 public _totalTaxIfSelling = 10;  // original 12
    uint256 public _totalDistributionShares = 16;  // original 12

    uint256 private _totalSupply = 100000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 300000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 3000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 200000000000000000 * 10**_decimals; 
