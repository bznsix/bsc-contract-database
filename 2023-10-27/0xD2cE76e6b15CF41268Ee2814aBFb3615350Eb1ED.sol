...
// Csdoge Marketplace NFT Mint contract
...
contract CsdogeNFTMint is ERC721Enumerable, ERC721URIStorage, Ownable {
    // paused
    ...
    modifier notPaused() {
        require(paused == false, "Action is paused");
        _;
    }

    constructor() ERC721("Csdoge NFT Collection", "CNC") {}
    ...
    function mint(
        ...
        require(mintingFee == msg.value, "Invalid msg value");
