...
contract LoveFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LoveFloki";
    string private _symbol = "LoveFloki";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x12ec292a1dB2CF630B3F6f28Af505e5d3Dc5fF73);
    address payable public lpWallet = payable(0x12ec292a1dB2CF630B3F6f28Af505e5d3Dc5fF73);
    ...
    uint256 public _totalTax = _marketingFee.add(_lpFee);

    uint256 private _totalSupply = 100000000 * 10 ** _decimals;
    uint256 private minimumTokensBeforeSwap = 2000 * 10 ** _decimals; 
    ...
    constructor () {
        ...
        _totalTax = _marketingFee.add(_lpFee);
