...
contract sucdogezilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sucdogezilla";
    string private _symbol = "sucdogezilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x8ede87415769d744E634c9C7faC905aE4f19b4B8); 
    address payable public ttWal = payable(0x8ede87415769d744E634c9C7faC905aE4f19b4B8); 
    ...
    constructor (address PancakeRouterAddress) {
        ...
        isWalletLimitExempt[ttWal] = true;
        
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[ttWal] = true;
    ...
    function setttWal(address newAddress) external onlyOwner() {
        ttWal = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(ttWal, amountBNBTeam);
