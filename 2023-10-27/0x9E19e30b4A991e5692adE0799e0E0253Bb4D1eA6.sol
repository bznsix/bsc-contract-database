...
import "@openzeppelin/contracts@4.8.2/utils/Context.sol";
...
contract HopiumToken is ReentrancyGuard, ERC20, AccessControl, Taxable {
    ...
    constructor(
        ...
        Taxable(true, __thetax, __maxtax, __mintax, __owner)
    {
        ...
        _mint(__owner, __mintammount * 10 ** decimals());
    }
