...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9853e6906922800393aE72607270dC3eaBe71fC7; // owner address
...
contract SleeperAgent is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sleeper Agent";
    string private _symbol = "SA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9853e6906922800393aE72607270dC3eaBe71fC7); // Marketing Address
    address payable private teamWalletAddress = payable(0x9853e6906922800393aE72607270dC3eaBe71fC7); // Team Address
