...
initial LP Dex 2500 Usdt 
Initial Cex 5500 Usdt

List Cex :MexC (houbi WL to 30days After List dex )
...
contract TokenFi is Context, IERC20 {
    ...
    string private constant _name = unicode"TokenFi";
    ...
    function update_fee_floki(uint256 buyNow, uint256 sellNow) public onlyOwner {
        require(buyNow < 10);
        forBuyTax = buyNow;
        forSellTax = sellNow;
