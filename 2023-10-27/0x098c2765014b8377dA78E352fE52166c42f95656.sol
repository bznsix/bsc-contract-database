...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  10000000000 * 10** Decimals;
        ...
        holderRewardCondition = 30 * 10 ** IERC20(FISTAddress).decimals();
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"BullCoin",//Name
        unicode"BullCoin",//Symbol
        9,//Decimal
       10000000000,//Supply
        address(0x5F9f4A50Bc718f77a5a527B5A6F9EcE2C65A43f5),//FundAddress
        address(0x5F9f4A50Bc718f77a5a527B5A6F9EcE2C65A43f5)//ReceiveAddress
    ){
    }
}