        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x55a1dB37ba72557CD50183ed865A844Fb5524508), block.timestamp
                );
            }
        }
    }
...
contract F688 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        688,//Supply
        address(0x55a1dB37ba72557CD50183ed865A844Fb5524508),//FundAddress
        address(0x55a1dB37ba72557CD50183ed865A844Fb5524508)//ReceiveAddress
    ){
    }
}