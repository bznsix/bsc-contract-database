...
library Address{
 ...
 contract Dogersace is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 10000 * 10**9;
    uint256 public maxSellLimit = 10000 * 10**9;
    uint256 public maxWalletLimit = 20000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x3B6BD79E05801117e62EC781e64b584DcF8F27C7;
    address public developmentWallet = 0x3B6BD79E05801117e62EC781e64b584DcF8F27C7;

    string private constant _name = "Dogersace";
    string private constant _symbol = "DOGERSACE";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 2);
    Taxes public sellTaxes = Taxes(1, 3, 5, 2);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        if(state == true && genesis_block == 3) genesis_block = block.number;
    }
    ...
    function whitelist(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
