...
This is just a test, do not buy!
...
contract BitcoinBunnyTest is ERC20, Ownable {
    ...
    uint256 public liquidityTaxOnBuy;
    uint256 public liquidityTaxOnSell;

    uint256 public  marketingTaxOnBuy;
    uint256 public  marketingTaxOnSell;
    ...
    constructor () ERC20("BitcoinTest", "BITCOIN") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        liquidityTaxOnBuy  = 5;
        liquidityTaxOnSell = 5;

        marketingTaxOnBuy  = 5;
        marketingTaxOnSell = 5;

        _totalFeesOnBuy    = liquidityTaxOnBuy  + marketingTaxOnBuy;
        _totalFeesOnSell   = liquidityTaxOnSell + marketingTaxOnSell;

        marketingWallet = 0xC84E370914E6a98D5b0dB230d5E17FBc16F3DDd1;
        donationsWallet = 0xC84E370914E6a98D5b0dB230d5E17FBc16F3DDd1;

        maxTransactionLimitEnabled = true;

        transferOwnership(0x32F69f36BB872BdE9d4d2a3BE43DE7B0F37Bd918);
        ...
        maxTransactionAmountBuy = 201000 * (10**uint256(decimals()));
        maxTransactionAmountSell = 200000 * (10**uint256(decimals()));
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 liquidityShare =liquidityTaxOnBuy + liquidityTaxOnSell;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(donationsWallet).sendValue(newBalance - marketing);
