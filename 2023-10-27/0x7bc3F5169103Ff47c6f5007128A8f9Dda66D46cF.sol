...
// telegram : https://t.me/ShibaGhostPortal

// twitter : https://twitter.com/ShibaGh0st

// website : https://shibaghost.space
...
contract ShibaGhost is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "SGT";
        _decimals = 12;
        _totalSupply =  31000000 * 10**_decimals;
        minimumTokensBeforeSwap = 10000 * 10**3; 
        ...
        marketingAddress = payable(0x7dD44a7Fe13a3E97bF77e7C78a6786aF4BEF062e);
        ...
        _totalTaxIfBuying = 10;
        _totalTaxIfSelling = 10;
        _totalDistributionShares =10;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external Authorized() {
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external Authorized() {
