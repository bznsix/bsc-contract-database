...
contract BabyTOKENFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Baby Token Fi";
    string private _symbol = unicode"$BabyTFI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xA36E4b3EE7f524b6C05fD69D068719EC41f4590F);
    address payable private taxWallet2 = payable(0xA36E4b3EE7f524b6C05fD69D068719EC41f4590F);
    ...
    uint256 public _maxTxAmount = _totalSupply*10000000/10000000;
    uint256 public _walletMax = _totalSupply*10000000/10000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*10000000/10000000; 
