...
Check our Telegram : https://t.me/ZyzzPump
1 Q Supply with 2% max transaction
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MARKETING_ADDRESS = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ZyzzPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ZyzzPump";
    string constant _symbol = "$ZyzzPump";
    uint8 constant _decimals = 9;

   
    uint256 _totalSupply = 1 * 10**15 * (10 ** _decimals); 
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; 
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; 
