...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public airDropNumbs = 10; //自动空投数量
    ...
    constructor (
        ...
        holderRewardCondition = 20 ** IERC20(FISTAddress).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xa64e3BE732c657F1a2Fc47aAa06C21aEB8743A92;
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x609fF13095ED7693C39C8Eb42B4Ef20D0675Dba8),
