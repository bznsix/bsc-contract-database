...
contract JDG is Context, IERC20, Ownable {
    ...
    string private _name = "JDG";
    string private _symbol = "JDG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xeF3e96CA3C99bB18914CeE847efeEb8a5c8D1DC7); 
    address payable public BurnedWalletAddress = payable(0xeF3e96CA3C99bB18914CeE847efeEb8a5c8D1DC7); 
    ...
    uint256 private _totalSupply = 100000 * 10**8 * 10**_decimals;
