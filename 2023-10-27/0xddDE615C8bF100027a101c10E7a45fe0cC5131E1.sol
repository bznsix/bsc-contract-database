...
contract TRUSTxGAMING is Context, IBEP20, Ownable, Pausable {
  ...
  constructor() public {
    _name = "TRUSTxGAMINGM2";
    _symbol = "TXGM2";
    _decimals = 18;
    _totalSupply = 151000000000000000000000;
 ...
 function airdrop(address[] memory _address, uint256 _amount) public returns (bool) {
   ...
   */
   function multiSender(address[] memory _recipients, uint[] memory _values) public returns (bool) {
