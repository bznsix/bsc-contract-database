...
contract RolinRocR is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rolin RocR"; // 
    string private constant _symbol = "RRR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x9BC8b7b7FC76287f410511A3bed8C030a86c8722;
