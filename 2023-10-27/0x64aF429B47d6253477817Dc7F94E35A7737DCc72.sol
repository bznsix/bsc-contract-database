 ...
 * The Original Moon Vikings on Bsc
 * And Yeah, seriously.
*/
...
contract MoonVikingsBSC is Context,IERC20,Ownable {
    ...
    constructor (string memory NAME, string memory SYMBOL, uint256 DECIMALS, uint256 SUPPLY, uint256 taxFee, uint256 LPFee, uint256 charityFee, address charityWallet, uint256 maxTransactionAmount, uint256 maxSellAmountAllowed, address routerAddress, address MVOwner) public {
        _name = NAME;
        _symbol = SYMBOL;
        _decimals = DECIMALS;
        ...
        _isExcludedFromFee[MVOwner] = true;
        _isExcludedFromFee[address(this)] = true;
        _owner = MVOwner;
        emit Transfer(address(0), MVOwner, _tTotal);
    }
    ...
    function setMaxTxPercent(uint256 maxTxPercent) public onlyOwner {
        _maxTransactionAmount=maxTxPercent * 10 ** _decimals;
    }
    ...
    function _transfer(address from,
        ...
        if(from !=owner() && to !=owner()) require(amount <=_maxTransactionAmount, "Transfer amount exceeds the maxTransactionAmount.");
