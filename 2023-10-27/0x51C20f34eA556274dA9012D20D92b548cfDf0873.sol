...
TG: https://t.me/NewCommunityDecentraworld
...
contract NewCommunityDecentraworld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "NewCommunity Decentra world";

    string private _symbol = "$NDEWO";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0x99E763ABDA75CeBf4A295ffE27755403E752505e;
