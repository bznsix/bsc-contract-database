...
// telegram:      https://t.me/Bnbblacktigerbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xceb0631541aaC2c95a445aE1e4820B85b2100749  ; // owner address
...
contract  BnbBLACKTIGER  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "  Bnb BLACK Tiger";
    string private _symbol = "BNBBLACKTIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xceb0631541aaC2c95a445aE1e4820B85b2100749); 
    address payable public teamWalletAddress = payable(0xceb0631541aaC2c95a445aE1e4820B85b2100749);
