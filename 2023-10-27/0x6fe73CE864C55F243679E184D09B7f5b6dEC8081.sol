...
ScarySmurfCat (SCARY)
Telegram: https://t.me/scarysmurfcatbsc
...
contract ScarySmurfCat is Context, IERC20, Ownable {
    string private _name = "ScarySmurfCat";
    string private _symbol = "SCARY";
    ...
    uint256 public minTokenToSwap = (_totalSupply * 10) / (10000); // this amount will trigger swap and distribute
    uint256 public maxHoldLimit = (_totalSupply * 10) / (100); // this is the max wallet holding limit
    ...
    constructor() {
        ...
        marketingWallet = address(0x78d6d445aaFD64031A7D6d14f011655a7B02d3D3);
