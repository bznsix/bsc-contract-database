...
contract SonOfBleufi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfBleufi";
    string constant _symbol = "SonOfBleufi";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 50;
    uint256 public _maxWalletToken = _totalSupply / 25;
