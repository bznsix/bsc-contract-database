...
contract PikachuCheems is IBEP20, Auth {
    ...
    string constant _symbol = "Pikachu";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50 / 1000;
    ...
    uint256 public swapThreshold = _totalSupply * 75 / 10000; // 0.075% of supply
    bool inSwap;
