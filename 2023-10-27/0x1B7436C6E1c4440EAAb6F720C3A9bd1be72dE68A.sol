...
//TELEGRAM: https://t.me/y00tsBep20
interface IERC20 {
...
contract y00ts is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xEE5d0388926476087C85eF4Fe3A3328f5437de41;
    address public devAddress = 0x131bba08256021bcb7209213C2827fbA7E1996Ab;

    string private constant _name = "y00ts";
    string private constant _symbol = "YTS";
    ...
    Taxes public taxes = Taxes(0,0,23,2);
    Taxes public sellTaxes = Taxes(0,0,24,2);
