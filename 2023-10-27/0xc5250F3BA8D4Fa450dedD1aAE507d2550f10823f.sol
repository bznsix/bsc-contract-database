...
contract MangoLoco is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mango Loco"; // 
    string private constant _symbol = unicode"MANGO";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2294f2EC3D9211553f4Ae4A3fDfD6Dae2Ed6f72F;
