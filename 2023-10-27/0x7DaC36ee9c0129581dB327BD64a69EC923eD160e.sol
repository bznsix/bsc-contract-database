...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x042EB02933cB6cc9B93D2A672709Bf0E7f2ac2df; // owner address
...
contract TokenFiV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TokenFi 2.0";
    string private _symbol = "TF2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x042EB02933cB6cc9B93D2A672709Bf0E7f2ac2df); // Marketing Address
    address payable private teamWalletAddress = payable(0x042EB02933cB6cc9B93D2A672709Bf0E7f2ac2df); // Team Address
