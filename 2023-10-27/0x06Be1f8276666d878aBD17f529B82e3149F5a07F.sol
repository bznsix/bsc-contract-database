/**
TG: https://t.me/communityachtclub
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    //SETMEUP, change this to 1 hour instead of 15mins
...
contract communityyachtclub is IBEP20, Auth {
    using SafeMath for uint256;

    address BNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // BNB
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "community yacht club";
    string constant _symbol = "cyc";
    ...
    uint256 public swapThreshold = _totalSupply * 391 / 100000; //Token sold for true trade
    bool inSwap;
