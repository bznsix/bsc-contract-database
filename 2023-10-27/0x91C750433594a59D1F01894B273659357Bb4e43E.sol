...
contract PowerLevel is IERC20, Ownable {
    using Address for address;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Power Level ";
    string constant _symbol = "PL";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 64_000_000 * (10 ** _decimals);
    ...
    uint256 antiDumpPeriod = 45 minutes;
