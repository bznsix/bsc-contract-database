...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e9f005E36F5117fF296a1A90267DD189e3DAd56;
...
contract BnbBabyTigerinu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xbe548FB0AC55d1b37bC6926bB0A6aB7723BE76C9;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Bnb Baby Tiger Inu";
    string private _symbol = "BNBBabyTiger";
    ...
    uint256 public _maxTxAmount = 420000000000000 * 10**6 * 10**9;
