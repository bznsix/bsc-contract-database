...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02898D42d53c182756210b7DBE863f0f6a02a30c; // owner address
...
contract CCYGDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCYGDS";
    string private _symbol = "CCYGDS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x02898D42d53c182756210b7DBE863f0f6a02a30c); // Marketing Address
    address payable private teamWalletAddress = payable(0x02898D42d53c182756210b7DBE863f0f6a02a30c); // Team Address
