...
contract Rollex is IBEP20, Ownable {
  ...
  constructor(address token_address) {
    ...
    levelPercentages[1] = 0 ether;
    levelPercentages[2] = 0.0000001 ether;
    levelPercentages[3] = 0.0000002 ether;
    levelPercentages[4] = 0.0000003 ether;
    levelPercentages[5] = 0.0000004 ether;
    levelPercentages[6] = 0.0000005 ether;
    levelPercentages[7] = 0.0000006 ether;
    levelPercentages[8] = 0.0000007 ether;
    levelPercentages[9] = 0.0000008 ether;
    levelPercentages[10] = 0.0000009 ether;
    levelPercentages[11] = 0.00000010 ether;
    levelPercentages[12] = 2.4 ether;
    levelPercentages[13] = 2.6 ether;
    levelPercentages[14] = 2.8 ether;
    levelPercentages[15] = 3 ether;
    levelPercentages[16] = 3.2 ether;
    levelPercentages[17] = 3.4 ether;
    levelPercentages[18] = 3.6 ether;
    levelPercentages[19] = 3.8 ether;
    levelPercentages[20] = 4 ether;
    levelPercentages[21] = 4.2 ether;
    levelPercentages[22] = 4.4 ether;
    levelPercentages[23] = 4.6 ether;
    levelPercentages[24] = 4.8 ether;
    levelPercentages[25] = 5 ether;
  }
  ...
  function BuyRolex () payable public returns (uint256 id) {
    ...
    for (uint256 i = 1; i < distribute_level; i++) {
      ...
      if (currentReferrer == address(0)) {}
          ...
          if(getTotalLevelIncome(currentReferrer) >= 0.24 ether)
          {
            uint256 refer_per = refer_amt.mul(levelPercentages[i]).div(100).div(1 ether);
...
function sellRolex(uint256 tokenAmount) public returns (uint256 id) {
    ...
    uint256 adminServiceCharge = bnbAmount.mul(10).div(100); // 10% of bnbAmount
    ...
    require(bnbAmount >= 0.00000001 ether, "Minimum BNB withdraw limit is 0.01");
