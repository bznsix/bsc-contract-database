...
contract sunboy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sun Boy";
    string private _symbol = "$SUNBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6605D6b4EF0Bd764470630cae4E8eEb60647f9eF);
    address payable public teamWalletAddress = payable(0x6605D6b4EF0Bd764470630cae4E8eEb60647f9eF);
