...
abstract contract Project {
    address public marketingWallet = 0xd5545a446dde09eD5118EFfaf4071c1F7e758AB0;
    address public treasuryWallet = 0xd5545a446dde09eD5118EFfaf4071c1F7e758AB0;

    string constant _name = "Baby BNB Tiger Inu";
    string constant _symbol = "BabyBNBTiger";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // (_totalSupply * 5) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 2; //

    uint256 public buyBurnFee         = 2;
    uint256 public buyTotalFee        = 14 ;

    uint256 public swapLpFee          = 0;
    uint256 public swapRewardFee      = 5;
    uint256 public swapMarketing      = 22;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x850606B482A9D5E1bE25a89D988A7eB05b613CC2);
...
contract BabyBNBTiger is Project, IBEP20, Auth {
    using SafeMath for uint256;
