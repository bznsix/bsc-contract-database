...
contract SPACELION is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf3156150896C716f0cA1fA23205Fe3B8e92287E3); 
    address payable public Wallet_Dev = payable(0x1F04574FD91a0262def255bf17B32e00218B6bE5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SPACE LION"; 
    ...
    constructor () {
        _owner = 0x1F04574FD91a0262def255bf17B32e00218B6bE5;
