...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x53f7c1948035354347d700999e2dC348f9cF3eB6; // owner address
...
contract Donke  is Context, IERC20, Ownable {
    ...
    string private _name = "Donke Coin";
    string private _symbol = "$DONKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53f7c1948035354347d700999e2dC348f9cF3eB6);
    address payable public teamWalletAddress = payable(0x53f7c1948035354347d700999e2dC348f9cF3eB6); 
