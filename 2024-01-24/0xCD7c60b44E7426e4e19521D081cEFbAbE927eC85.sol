...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06c321E0e268417959F8Ab48d9D9b7356b83e74C;
...
contract smolcat is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf25ceD668b26d565059052328d75808D4E991a8b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "smol cat";
    string private _symbol = "smolcat";
