...
contract SmurfCraft is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Smurf Craft";
    string private _symbol = "Smurf Craft";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd94Ec44594C724E07656f9c657690ee5714c8d8A); // Marketing Address
    address payable public teamWalletAddress = payable(0xd94Ec44594C724E07656f9c657690ee5714c8d8A); // Team Address
    ...
    uint256 public _marketingShare = 99;
