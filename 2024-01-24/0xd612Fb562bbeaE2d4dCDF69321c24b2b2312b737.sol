...
contract BabyCaptain is ERC20, Ownable, ReentrancyGuard {
    ...
    TaxRates public taxRates = TaxRates(200, 100, 200);
    ...
    constructor() ERC20("BABY CAPTAIN", "BABYCAPTAIN") Ownable(msg.sender) {
