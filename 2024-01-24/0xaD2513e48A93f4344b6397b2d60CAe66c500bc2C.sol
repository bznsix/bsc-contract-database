...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
        require(tokenId < 200,"max");
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmX3wKBsjwAL4ooYMnvEhAtezYBzhDQuzeA65LQdSwUKwt");
        return true;
    }
}
...
contract LXDDNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("LXDD NFT", "LXDD NFT") {
