...
contract FlokiSniper is Context, IERC20, Ownable {
    ...
    string private _name = "Floki The Sniper";
    string private _symbol = "SNFL";
    ...
    address public marketingWallet = 0x9554941f9c9C35F70B723A4f06eF9f56F3A7aDf2;
    ...
    uint256 private numTokensSellToAddToLiquidity = 20000000000000 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 1000000000000000 * 10**9){
