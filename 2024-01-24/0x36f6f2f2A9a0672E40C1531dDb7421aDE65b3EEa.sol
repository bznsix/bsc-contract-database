...
/*────────────────────────────────────┐
│             Burnify.AI              │
│  t.me/BurnifyAI    x.com/BurnifyAI  │
│-------------------------------------│
│ Developed by                        │
│ ____                   Dexonomy.com │
...
contract BurnifyAIToken is ERC20, Ownable {
    /* Structs */
    struct Tax {
        uint256 buy;
        uint256 sell;
    ...
    /* Constructor */
    constructor() ERC20("BurnifyAI", "BurnifyAI") {
        marketingWallet = msg.sender;
        burnifyAI = 0xE7bEB458499AFBD56EbAE70CC6114A68Ce26529a;
        ...
        _isExcludedFromFees[burnifyAI] = true;
    ...
    function updateBurnifyAI(address _burnifyAI) external onlyOwner {
        require(_burnifyAI != burnifyAI, "BurnifyAI is already that address");
        require(
            _burnifyAI != address(0),
            "BurnifyAI cannot be the zero address"
        );

        burnifyAI = _burnifyAI;

        emit UpdateBurnifyAI(burnifyAI);
    }
    ...
    function _swapFees() private lockSwap {
        ...
        uint256 ethForBurnifyAI = (ethRecieved * 40) / 100;
        uint256 ethForMarketing = ethRecieved - ethForBurnifyAI;

        payable(burnifyAI).call{value: ethForBurnifyAI}("");
