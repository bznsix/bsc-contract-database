...
contract DOMO is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "DOMO";
        _decimals = 18;
        _owner = 0x696440C67BfB4BFdD36bcf63186f9408BA1df14a;
        _totalSupply = 3000000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 3000 * 10**_decimals;
        marketingWalletAddress = payable(0x9ADc61E717608454811BeEc81b03B45ED9D60190);
        teamWalletAddress = payable(0xf8C6CFD7C70c9Ead4dc84B43e674605c96c42e6D);
