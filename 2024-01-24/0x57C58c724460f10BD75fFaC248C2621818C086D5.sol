...
//--- Contract v3 ---//
contract JOKER is Context, Ownable, IERC20 {
    ...
    uint256 constant public swapThreshold = _totalSupply / 2_100;
    ...
    address payable private marketingAddress = payable(address(0x73Bf65B71619BD563ce21D022835B80e4472d6f4));


    IRouter02 public swapRouter;
    string constant private _name = "JOKER";
    string constant private _symbol = "JOKER";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x0090474392e8b161382aa16C2A2b63Eb4ACDf6B2);
    ...
    function _transfer(address from, address to, uint256 amount) internal returns  (bool) {
        ...
        if (isLimitedAddress(from,to)) {
            require(isTradingEnabled,"Trading is not enabled");
                    if(!isLpPair[to] && from != address(this) && to != address(this) || is_transfer(from,to) && !avoidMaxTxLimits)  { require(balanceOf(to) + amount <= maxWallet,"maxWallet is 0.5%"); }}
