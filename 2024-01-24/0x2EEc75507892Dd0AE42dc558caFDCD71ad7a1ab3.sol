// JIN JING 
// WWW.JINGJINGCOIN.SITE
// ROARINGKITTYSAFEOPAL 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x13cCDBA9A290655F388EA6406F82a4a8925c5D01; // owner address
...
contract JINGJING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jing Jing ";
    string private _symbol = " Jing Jing ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64eb31a0ff352C1F923bbCf2CBd350178F0E2bc0); 
    address payable public teamWalletAddress = payable(0x038C48F6877850093240b43209cb7Fc0d7F94690);
