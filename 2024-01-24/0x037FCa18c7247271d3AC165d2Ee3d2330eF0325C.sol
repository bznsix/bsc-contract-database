...
contract BabySuca800A is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabySuca800ADividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabySuca800A", "BABYSUCA") {
        marketingWallet = payable(0x6C64A1DF2D8988b8fD992518c0518049D9A474DB);
        devWallet = payable(0x6C64A1DF2D8988b8fD992518c0518049D9A474DB);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // PCS Mainnet
        ...
        dividendTracker = new BabySuca800ADividendTracker(
            payable(this),
            router,
            0x1FAA0C09a71E2842b2305C16c8c570FDC6d35B95, // reward token Suca800A 
            "BabySuca800ATRACKER",
            "BabySuca800ATRACKER"
        );
        ...
        uint256 totalTokenSupply = (1000000000) * (10**18);
        ...
        swapTokensAtAmount = totalTokenSupply; 
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 1, "max wallet cannot be set to less than 0.05%");
        maxWallet = value;
    }
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 1, "transfer fee cannot exceed 1%");
...
contract BabySuca800ADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabySuca800A public BabySuca800AContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabySuca800AContract = BabySuca800A(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabySuca800A_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabySuca800A_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabySuca800A contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabySuca800AContract);

            uint256 prevBalance = BabySuca800AContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabySuca800AContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabySuca800AContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
