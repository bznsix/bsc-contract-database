...
/*
https://t.me/burnreflect
auto burning every transaction 
auto rewarding every transaction
burn and earn with $burnrfi
*/
interface IBEP20 {
...
contract burnreflect is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000000000000000000 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x463Cc9Fd401D7222Ce9794DaAb36805f5C309531;

    string private constant _name = "BurnReflect";
    string private constant _symbol = "burnrfi";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 2% reflections, 2% marketing
