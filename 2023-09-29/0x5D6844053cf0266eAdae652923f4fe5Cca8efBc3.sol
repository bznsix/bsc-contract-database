...
import {IMagpieStargateBridgeV2} from "./interfaces/IMagpieStargateBridgeV2.sol";
...
contract MagpieStargateBridgeV2 is IMagpieStargateBridgeV2, Ownable {
...
interface IStargateRouter {
    ...
    function cachedSwapLookup(uint16, bytes calldata, uint256) external view returns (CachedSwap memory);
