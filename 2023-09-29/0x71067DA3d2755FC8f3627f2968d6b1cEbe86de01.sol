...
contract XNOW is ERC20, Ownable {
  struct Tax {
    uint256 marketingTax;
    uint256 liquidityTax;
  }

  uint256 private constant _totalSupply = 1_000_000_000_000 * 1e9;
  ...
  //Wallets
  address public marketingWallet = 0xc7746664026c8CdC000a7164fbCd18E940f5827E;
  ...
  constructor() ERC20("X-NOW", "XNOW") {
    ...
    address newOwner = 0x61dEfe4a66A64D73ABcE790bDa96825705c78e20;
  ...
  function setBuyTaxes(
    ...
    require(totalBuyFees <= 2, "Can not set buy fees higher than 2%");
  }
  ...
  function setSellTaxes(
    ...
    require(totalSellFees <= 4, "Can not set buy fees higher than 4%");
  }

  function setSwapTokensAtAmount(uint256 _newAmount) external onlyOwner {
    require(
      _newAmount > 10 ** decimals() && _newAmount <= (_totalSupply * 1) / 100,
  ...
  function internalSwap(uint256 taxAmount) internal {
    if (taxAmount == 0) {
      return;
    }
    ...
    uint256 marketingPortion = balanceOf(address(this)) - lpPortion;
