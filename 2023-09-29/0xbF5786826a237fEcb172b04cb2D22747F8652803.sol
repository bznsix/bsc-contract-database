...
contract ComptrollerErrorReporter {
    ...
    enum FailureInfo {
        ...
        SET_NEW_MARKET_OWNER_CHECK,
        SET_FACTORY_OWNER_CHECK,
        SET_COMP_SPEED_OWNER_CHECK,
        SET_COLLATERAL_MODEL_OWNER_CHECK,
        SET_TOGGLE_CREATE_MARKET_OWNER_CHECK
    }
...
contract CTokenStorage {
     ...
     */
    uint public reserveFactorMantissa = 0.1e18; //0.1
 ...
 */
contract Unitroller is ComptrollerTadpoleStorage, ComptrollerErrorReporter {
