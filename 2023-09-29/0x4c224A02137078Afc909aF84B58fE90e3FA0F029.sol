...
import "./base/AppleSwap.sol";

contract AppleSwapBSC is AppleSwap {
    ...
    function UNISWAP_V2_ROUTER() internal pure override returns (IUniswapV2Router02) {
        return IUniswapV2Router02(0x463eDb44dEA95B0C140fc91A4A713866965EbD4f);
    }

    function UNISWAP_FACTORY() internal pure override returns (IUniswapV2Factory) {
        return IUniswapV2Factory(0xD9381F3f3C88bd6655B781722d4774399Ec37be6);
    }
}
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;
...
abstract contract AppleSwap is Ownable {
    address internal immutable WETH;
    uint256 public teamFee;
    address public teamWalletAddress;
    address public dexToken = address(0);
    uint256 public amountGetFreeTax = 200 * 10 ** 9;
    ...
    function swapExactTokensForTokens(
        ...
        uint256 _realAmountIn = ERC20(tokenIn).balanceOf(address(this)); // handle fee on transfer tokens
    ...
    function swapTokensForExactTokens(
        ...
        uint256 adjustedAmountIn = ERC20(tokenIn).balanceOf(address(this)); // handle fee on transfer tokens
