...
import "@openzeppelin/contracts/utils/Address.sol";  // Update this import
...
contract GasFeeThrottler {
    ...
    address public gasprice = address(0xA728d105f83DBafc2C14fea7A6c4e7eA0C4ec572);
...
contract StrategyMoonFiMaxSolidly is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    event ChargedFees(uint256 callFees, uint256 moonfiFees, uint256 strategistFees);
...
contract StratFeeManagerInitializable is OwnableUpgradeable, PausableUpgradeable {
    ...
    struct CommonAddresses {
        ...
        address keeper;
        address strategist;
        address moonfiFeeRecipient;
        address moonfiFeeConfig;
    }
    ...
    address public moonfiFeeRecipient;
    IFeeConfig public moonfiFeeConfig;
    ...
    event SetMoonFiFeeRecipient(address moonfiFeeRecipient);
    event SetMoonFiFeeConfig(address moonfiFeeConfig);
    ...
    function __StratFeeManager_init(CommonAddresses calldata _commonAddresses) internal onlyInitializing {
        ...
        moonfiFeeRecipient = _commonAddresses.moonfiFeeRecipient;
        moonfiFeeConfig = IFeeConfig(_commonAddresses.moonfiFeeConfig);
        withdrawalFee = 10;
    }
    ...
    function getFees() internal view returns (IFeeConfig.FeeCategory memory) {
        return moonfiFeeConfig.getFees(address(this));
    }
    ...
    function getStratFeeId() external view returns (uint256) {
        return moonfiFeeConfig.stratFeeId(address(this));
    }

    function setStratFeeId(uint256 _feeId) external onlyManager {
        moonfiFeeConfig.setStratFeeId(_feeId);
    ...
    // set new moonfi fee address to receive moonfi fees
    function setMoonFiFeeRecipient(address _moonfiFeeRecipient) external onlyOwner {
        moonfiFeeRecipient = _moonfiFeeRecipient;
        emit SetMoonFiFeeRecipient(_moonfiFeeRecipient);
    }

    // set new fee config address to fetch fees
    function setMoonFiFeeConfig(address _moonfiFeeConfig) external onlyOwner {
        moonfiFeeConfig = IFeeConfig(_moonfiFeeConfig);
        emit SetMoonFiFeeConfig(_moonfiFeeConfig);
    }
