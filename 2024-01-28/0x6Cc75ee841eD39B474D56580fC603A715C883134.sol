...
import "../libraries/BEP20Mintable.sol";
import "../libraries/BEP20Pausable.sol";
import "../libraries/Recoverable.sol";

/**
 * @dev BEP20Token implementation with AccessControl, Mint, Burn, Pause, Recover, AntiWhale capabilities
 */
contract CAXToken is
    BEP20Base,
    AntiWhaleToken,
    BEP20Burnable,
    BEP20Mintable,
    ...
    Recoverable
{
    ...
    constructor(
        ...
        payable
        BEP20Base("cashX", "CAX", 18, 0x312f313730363433382f412f4d2f422f522f502f57)
     ...
     * @dev Mint new tokens
     */
    function _mint(address account, uint256 amount) internal virtual override(BEP20, BEP20Mintable) {
...
/**
 * @title TokenRecover
 * @dev Allow to recover any BEP20 and ETH sent to the contract
 */
contract Recoverable {
    ...
    function _recoverTokens(address tokenAddress, address to, uint256 tokenAmount) internal {
        require(IBEP20(tokenAddress).balanceOf(address(this)) >= tokenAmount, "Invalid amount");
