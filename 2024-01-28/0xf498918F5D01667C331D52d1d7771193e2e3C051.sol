...
contract WENNetwork is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0x6b8b0e99f84104E2b60256B4A18c1d5cc55BE8FE);
    address payable private _marketing = payable(0x6b8b0e99f84104E2b60256B4A18c1d5cc55BE8FE);
    
    string private constant _name = "WEN Network";
    string private constant _symbol = "WEN-NET";
