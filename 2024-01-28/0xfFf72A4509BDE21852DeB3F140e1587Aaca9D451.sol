...
contract burnAirdrop is Context{
    ...
    uint256 private constant _singleAmount = 100 * 10 ** 18;
     address private devAddress = 0x65845413e4AfBEB4E5806C1aF7C30472082a224a;
    uint256 public _block;
    uint256 public _countBlock;
    ...
    bool inits = false;
     modifier onlyDev() {
        require(
            ...
            "Only the devAddress can call this function"
        );
        _;
    }
    constructor(){}
...
contract LFG is ERC20, Ownable {
    ...
    address public devAddress =0x65845413e4AfBEB4E5806C1aF7C30472082a224a;
    address public marketingAddress = 0xb1BC433d93B6Dad4c5E4cE4432e064F630bbe7cC;
    constructor() ERC20("LFG", "LFG") {
        ...
        _excludedFees[marketingAddress] = true;
        ...
        _mint(address(_airdrop), 10000000 * 10 ** 18);
       // _mint(devAddress, 5000000 * 10 ** 18);
    }
