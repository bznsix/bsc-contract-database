...
contract BToken is ReentrancyGuard, BTokenBase  {
    ...
    string  private _name     = "TRYwBNB";
    string  private _symbol   = "TRYwBNBLP";
...
contract TRYBNB is ReentrancyGuard, BBronze, BToken, BMath, WhitelistAdminRole {
    using Roles for Roles.Role;
    struct Record {
        bool bound;   
        uint index;   
        ...
        _lock_
    {
        ...
        _pushPoolShare(TRY, INIT_POOL_SUPPLY);
    }
