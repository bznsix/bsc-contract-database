...
contract DUCKE is Context, IERC20, Ownable {
    ...
    string private constant _name = "DUCKE";
    string private constant _symbol = "$DUCKE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9F98E060F803323CC81c4bAef9289A273a1EC80d);
    address payable private _marketingAddress = payable(0x9F98E060F803323CC81c4bAef9289A273a1EC80d);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 15, "Redis cannot be more than 5.");
	    require(redisFeeOnSell < 15, "Redis cannot be more than 5.");
	    require(taxFeeOnBuy < 15, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 15, "Tax cannot be more than 5.");
