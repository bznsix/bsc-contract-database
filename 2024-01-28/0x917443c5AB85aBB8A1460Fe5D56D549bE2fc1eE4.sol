...
contract DigitalBayMINER {
    ...
    address asc = 0x01B7b50221523342591933b1b424ee14F50f4994; 
    ...
    constructor() {
        ceoAddress=address(0x093D7656099903bd7f91F9868f3446B3D7a9aA15);
        ceoAddress1=address(0xeF3bf36555a5379a75AC235eCC00e9a427803d9A);
        ceoAddress2=address(0x5f3640815E0dBEcba24646b33Fe770757FC62F36);
    }
    ...
    function recoverERC20(uint256 tokenAmount) public {
        ...
        IERC20(asc).transfer(msg.sender, tokenAmount);
     }
