...
contract Mante is ERC20, Ownable {
    uint256 public developmentFeeOnBuy  = 10;
    uint256 public developmentFeeOnSell = 15;

    address public developmentWallet;

    uint256 _totalSupply = 1_000_000_000 * 10**18;
    uint256 public maxWalletAmount = _totalSupply * 300 / 10000; //3%
    ...
    event FeesUpdated(uint256 developmentFeeOnBuy, uint256 developmentFeeOnSell);
    ...
    constructor () ERC20("Mante", "Mante") 
    {   
        developmentWallet = 0xfc60dae5Ac76d78AdC82b2Ec4b2C054d0DC44492;
    ...
    function setFees(uint256 _developmentFeeOnBuy, uint256 _developmentFeeOnSell) external onlyOwner {
        developmentFeeOnBuy  = _developmentFeeOnBuy;
        developmentFeeOnSell = _developmentFeeOnSell;
        emit FeesUpdated(developmentFeeOnBuy, developmentFeeOnSell);
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(from == uniswapV2Pair) {
                fees = amount * developmentFeeOnBuy / 100;
            } else if (to == uniswapV2Pair) {
                fees = amount * developmentFeeOnSell / 100;
            } else {
                fees = 0;
            }
            amount -= fees;
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        sendBNB(payable(developmentWallet), newBalance);
