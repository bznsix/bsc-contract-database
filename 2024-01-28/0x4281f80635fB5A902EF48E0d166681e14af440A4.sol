...
contract BNBSnake is ERC20, Ownable {
    ...
    constructor() ERC20("BNBSnake", "BNBSnake") {
        ...
        maxTransactionAmount = 750_000_000 * 1e18; // 
        maxWallet = 1_500_000_000 * 1e18; // 1.5% 
        swapTokensAtAmount = 100_000_000 * 1e18; // 
        ...
        marketingWallet = address(0x5214D02D8E0C1bF8ba457A41A59f3c5739bd47cc); // set as marketing wallet
        devWallet = address(0x5214D02D8E0C1bF8ba457A41A59f3c5739bd47cc); // set as dev wallet
