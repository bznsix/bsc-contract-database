...
//--- Contract v3 ---//
contract BIDEN2024 is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 811_942_112_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0x740C6983eD851910c471Cc752B8540Bf8e868369); // build: 0x740C6983eD851910c471Cc752B8540Bf8e868369
    address payable private devWallet = payable(0x78f362de625894D9EC815Fb72f231D5b0a3334A6); // build: 0x78f362de625894D9EC815Fb72f231D5b0a3334A6


//--- v3 Allocations by Biden joebiden2024meme.org ---//
    ...
    string constant private _name = "Joe Biden";
    string constant private _symbol = "BIDEN2024";
    string constant public copyright = "";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"Biden: Must equals to 100%");
    ...
    function changeWallets(address newBuy, address newDev) external onlyOwner {
        require(newBuy != address(0),"Biden: Address Zero");
        require(newDev != address(0),"Biden: Address Zero");
