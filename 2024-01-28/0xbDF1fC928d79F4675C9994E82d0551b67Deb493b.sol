...
contract Psychadelic_Pigz is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string private baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public revealedTo = 150;
  ...
  constructor(string memory _baseUri, string memory _hiddenUri) ERC721("Psychedlic Pigz", "PIGZ") {
    setBaseURI(_baseUri);
  ...
  function setMaxSupply(uint256 newMaxSupply) external onlyOwner {
    require(newMaxSupply >= totalSupply() && newMaxSupply <= 1500, "Invalid max supply");
    maxSupply = newMaxSupply;
    }


   function setRevealed(uint256 to) external onlyOwner {
    revealedTo = to;
    }
