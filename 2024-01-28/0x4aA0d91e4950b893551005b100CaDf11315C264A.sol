...
contract QILIN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 210000000e18;
    ...
    constructor() {
        _name = "ORE";
        _symbol = "ORE";
        _mint(0x0B82a076B9Be8c3A3ddD3373f9207aBBD2b2E9AB, initSupply);
        setWList(0x0B82a076B9Be8c3A3ddD3373f9207aBBD2b2E9AB, true);
