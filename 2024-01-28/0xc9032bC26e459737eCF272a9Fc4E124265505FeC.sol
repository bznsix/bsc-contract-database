...
contract energy is ERC20 {
    ...
    address _USDTAAddress = address(0x53FD6Faf20610553067c0c320B1ca091BeF8dB32);
    address _USDTBAddress = address(0x5F78B52EbAd166bBBc9eE09B579AAAb1f953C736);
    address _USDTCAddress = address(0xcCB9d8cD23008AA4340d08B115B5bD6e331F33eD);
    ...
    constructor(address tokenOwner) ERC20("energy", "energy") {
        require(_baseToken < address(this),"energy small");
