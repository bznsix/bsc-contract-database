...
contract BabyBurnedFi is ERC20, Ownable {
    ...
    constructor() payable ERC20("Baby BurnedFi", "burned") {

        rewardToken = 0x19c018e13CFf682e729CC7b5Fb68c8A641bf98A4;
        ...
        marketingWallet = 0x9b4623c73792B6de7Aa978B84D3e3407a2aA626b;

        dividendTracker = new DividendTracker(888 * 10**5, rewardToken);
        ...
        _mint(owner(), 888 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 300;
    }
