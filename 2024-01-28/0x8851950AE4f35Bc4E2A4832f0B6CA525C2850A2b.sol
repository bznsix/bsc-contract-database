...
contract DAO is Ownable,ReentrancyGuard {
    ...
    function tokenSend(
        ...
        require(_tokenSend(_token,_to,_amount),"DAO::extract fail");
    }
    ...
    function _trust(
        ...
        require(!expired[signature],"DAO::certificate expired");
        address prove = ECDSA.recover(hashMsg(signType,token,amount,deadline), signature);
        require(signer == prove,"DAO::invalid certificate");	
    ...
    function withdrawal(
        ...
        require(block.timestamp < deadline,"DAO::Order Expiration");
    }
	...
	function _verifySign(
		...
		require(_signer != address(0),"DAO::invalid signing address");
		signer = _signer;
	}
}
// SPDX-License-Identifier: MIT
