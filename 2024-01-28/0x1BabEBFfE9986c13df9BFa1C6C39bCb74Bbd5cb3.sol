...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF13DC9AF22C73e2B32B54a4cebcCbD9e7FF0Bd54; // owner address
...
contract BONKFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BonkFi";
    string private _symbol = "BONKFI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF13DC9AF22C73e2B32B54a4cebcCbD9e7FF0Bd54); // Marketing Address
    address payable private teamWalletAddress = payable(0xF13DC9AF22C73e2B32B54a4cebcCbD9e7FF0Bd54); // Team Address
