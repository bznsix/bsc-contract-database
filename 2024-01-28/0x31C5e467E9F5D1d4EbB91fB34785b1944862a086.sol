...
contract MASTER is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0xC50ADC8a370Bcdc94498a327d57D3E18b2AaebCC);
    ...
    string public constant symbol = "TRUCK";
    ...
    uint256 public minimumTokensBeforeSwap = 100_0000 ether;
...
//What is my router and exclude pinksale locker.
        ...
        if (block.chainid == 56) {
            ...
            _isExcludedFromFee[0xC50ADC8a370Bcdc94498a327d57D3E18b2AaebCC] = true;
