...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95EC6A31671ae4ec3c657F3687ef5381D6214908; // owner address
...
contract SMORF is Context, IERC20, Ownable {
    ...
    string private _name = "Smorf";
    string private _symbol = "SMORF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x95EC6A31671ae4ec3c657F3687ef5381D6214908); // Marketing Address
    address payable private teamWalletAddress = payable(0x95EC6A31671ae4ec3c657F3687ef5381D6214908); // Team Address
