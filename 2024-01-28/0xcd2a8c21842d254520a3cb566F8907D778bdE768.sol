...
contract NYROMYROSTWIN is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x25a632CB913260288F92A5Ad2258Aa78679b7fbA);
    address payable private _twdmkt = payable(0x25a632CB913260288F92A5Ad2258Aa78679b7fbA);
    
    string private constant _name = "NYROMYROSTWIN";
    string private constant _symbol = "$LILBRO";
