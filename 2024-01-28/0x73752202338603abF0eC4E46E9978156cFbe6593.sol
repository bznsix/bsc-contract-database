...
🅽🅰🅽🅾 🅱🆄🆁🅽
🅽🅰🅽🅾 🅱🆄🆁🅽
TG https://t.me/NanoBurnBep
X  https://twitter.com/NanoBurnBep
...
contract NanoBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"NANO BURN";
    string private _symbol = unicode"NBURN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xf7838e02E44a25F8af7ac61Fd6107bE0e7B24d2B);
    address payable private taxWallet2 = payable(0xf7838e02E44a25F8af7ac61Fd6107bE0e7B24d2B);
