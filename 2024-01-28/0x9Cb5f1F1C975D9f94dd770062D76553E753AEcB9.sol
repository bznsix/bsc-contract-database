...
*/
/*
// https://babykimcrypto.com
// https://t.me/babykim_portal
// https://twitter.com/baby_kim_coin
...
contract BabyKim is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Kim", "BabyKim") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x17C15D698d90c11f19e5B0953a759d767D8C866c);
        ...
        feeReceiver = 0x02FFFB04b645f7E9bD39827d2a7B5D0B37947ad3;
        ...
        _mintOnce(owner(), 10_000_000 * (10 ** decimals()));
    ...
    function creator() public pure returns (string memory) {
        return "0x17C15D698d90c11f19e5B0953a759d767D8C866c";
    }
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _feeOnTransfer) external onlyOwner {
        ...
        require(feeOnBuy <= 6, "CSLT: Total Fees cannot exceed the maximum");
        require(feeOnSell <= 6, "CSLT: Total Fees cannot exceed the maximum");
