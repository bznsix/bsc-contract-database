/**
https://t.me/CatClassicOfficialBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2E88B88B31ac1511B3C99Bb27EeD3E4544758Ac3; // owner address
...
contract CATCLASSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Classic";
    string private _symbol = "CC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2E88B88B31ac1511B3C99Bb27EeD3E4544758Ac3); // Marketing Address
    address payable private teamWalletAddress = payable(0x2E88B88B31ac1511B3C99Bb27EeD3E4544758Ac3); // Team Address
