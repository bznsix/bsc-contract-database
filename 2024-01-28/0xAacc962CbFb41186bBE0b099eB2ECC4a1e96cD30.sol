...
contract Ziyao is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("ZIYAO", "ZY") {
        ...
        marketingWallet = 0x82e35957abe7b0528F20B02EB04d43C11ddB1F5e;
        treasuryWallet = 0xBE094073403608c942Af7B806A4d9B5de5d26224;
    ...
    function updateMaxTxAmount(uint256 newAmount) external onlyOwner {
        require(newAmount >= totalSupply() * 10 / 1000, "MaxTxAmount must be greater than 0.01% of total supply");
    ...
    function _initializeMainnet() internal {
        ...
        if(id == 56 || id == 1){
            transferOwnership(0xe254dCEaE21bc7f305Ebc7A63adD4193AeF3a757);
        }
    }
