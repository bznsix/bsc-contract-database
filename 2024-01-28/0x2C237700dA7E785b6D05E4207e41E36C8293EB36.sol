...
contract BTXJStaking {
	...
	function withdrawReferral(uint256 _amt) public {
		...
		require((ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).balanceOf(address(this)) >= _amt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((_amt > uint256(0))){
			ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).transfer(msg.sender, _amt);
		}
	}
    ...
    function stake1(uint256 _stakeAmt) public {
		...
		ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).transferFrom(msg.sender, address(this), _stakeAmt);
    ...
    function unstake1(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).balanceOf(address(this)) >= (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if (((((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))) > uint256(0))){
			ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).transfer(msg.sender, (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))));
		}
	...
	function interestTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).balanceOf(address(this)) >= interestAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((interestAmtInBank > uint256(0))){
			ERC20(address(0x4c3952FAE86dF0450dF573d803e2639083cC25C6)).transfer(msg.sender, interestAmtInBank);
		}
