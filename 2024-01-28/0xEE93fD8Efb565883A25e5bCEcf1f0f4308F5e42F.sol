...
/**
Twitter: https://twitter.com/tweetycoinbnb

Telegram: https://t.me/tweetycoinbnb
*/
...
contract tweety is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xC92A367e3E190431398FA45AFeA9590C7aC7fc2f);
    address payable public Wallet_Dev =
        payable(0x96247624A8Ef72b46B277e5371Bc67b616353529);
    address payable public constant Wallet_Burn =
        payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 365000000000000 * 10**9;
    ...
    uint256 public _maxWalletToken = (_tTotal * 11) / 100;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = (_tTotal * 11) / 100;
    ...
    constructor() {
        _owner = 0x96247624A8Ef72b46B277e5371Bc67b616353529;
