...
// File @openzeppelin/contracts-upgradeable/token/ERC20/extensions/IERC20MetadataUpgradeable.sol@v4.9.5
...
// File @openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol@v4.9.5
...
// File @openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol@v4.9.5
...
// File @openzeppelin/contracts/proxy/transparent/TransparentUpgradeableProxy.sol@v4.9.5
...
// File @openzeppelin/contracts/proxy/transparent/ProxyAdmin.sol@v4.9.5
...
contract HodlAirdrop is Context, Ownable {
    ...
    HodlAbi public _HODL;
    IUniswapV2Router02 public uniswapRouter;

    function init(address HODLAddr, address routeAddr) public onlyOwner {
        _HODL = HodlAbi(HODLAddr);
    ...
    function _drop() internal {
        ...
        require(msg.value.mod(_value) == 0, "Invalid value");
        uint256 mintCount = msg.value.div(_value);
        require(mintCount >= 1, "Invalid mint count");

        if (!_HODL.launch() && _msgSender != address(this)) {
            ...
            for (uint256 i = 0; i < mintCount; i++) {
                ...
                IERC20 token = IERC20(address(_HODL));
            ...
            if (totalDroped >= 150000) {
                ...
                payable(address(_HODL)).transfer(amount);
            }
        }
    }
...
contract HODL is Initializable, OwnableUpgradeable, ERC20Upgradeable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    function mint(address to) public onlyOwner {
        _mint(address(to), 21000000 * 10 ** 18);
    }
