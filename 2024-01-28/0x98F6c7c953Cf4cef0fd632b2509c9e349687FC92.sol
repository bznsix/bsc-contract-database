...
contract Treasury is Whitelist {
    ...
    function withdraw(address _to, uint256 _amount, bool _force) onlyWhitelisted public {
    ...
    function withdrawToken(address _to, address _tokenAddress, uint256 _amount, bool _force) onlyWhitelisted public {
