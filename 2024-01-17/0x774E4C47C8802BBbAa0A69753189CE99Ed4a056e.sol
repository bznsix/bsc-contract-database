...
X https://x.com/BabyBorkbsc
T https://t.me/babyborkbsc
W http://www.babybork.io/
...
contract BabyBork is ERC20, Ownable {
    ...
    uint256 constant maxSwapAmount = 1_000_000 * 1e18; // Set the maximum swap amount at 0,1% of totalSupply
    ...
    constructor() payable ERC20("Baby Bork", "BBork") {

        rewardToken = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; // SOL
    marketingFeeOnBuy = 4;
    rewardsFeeOnBuy = 1;
    ...
    totalSellFee = marketingFeeOnSell + rewardsFeeOnSell;
        ...
        swapTokensAtAmount = totalSupply() / 100_000; //after 0.001% of total supply, swap them
    }
    ...
    function updateBuyFees( uint256 _marketingFeeOnBuy, uint256 _rewardsFeeOnBuy) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
...
function _transfer(
    ...
    if (canSwap &&
        ...
        uint256 swapAmount = contractTokenBalance <= maxSwapAmount ? contractTokenBalance : maxSwapAmount;
        ...
        if (contractTokenBalance > 0 && totalShare > 0) {
            ...
            if ((marketingFeeOnBuy + marketingFeeOnSell) > 0) {
                ...
                if (!success) {
                    emit TransferFailed(marketingWallet, marketingShare);
                }
            }
    ...
    if (!swapping) {
        ...
        try dividendTracker.process(gas) returns (uint256 iterations, uint256 claims, uint256 lastProcessedIndex) {
            ...
            // Handle error if dividend processing fails
        }
    }
}
