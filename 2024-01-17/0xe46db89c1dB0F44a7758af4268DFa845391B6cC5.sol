...
//--- Contract v3 ---//
contract AILONG is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(address(0xee3567dF1B6e18c77786A8Ab62Aa3fDda051C15A));


    IRouter02 public swapRouter;
    string constant private _name = "AILONG";
    string constant private _symbol = "AILONG";
