...
contract DogeETF is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 300_000_000 * 10**_decimals;  //300 000 000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = _tTotal / 5_000;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = address(0x17dc2990582Fede00244343C955617cbE6eb2BbF);

    string private constant _name = "DOGE ETF";
    string private constant _symbol = "DOGETF";
