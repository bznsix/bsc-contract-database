...
contract EGoldTokenV2 is AccessControl, ERC20Snapshot, Pausable, ReentrancyGuard {
    ...
    constructor(string memory name_, string memory symbol_ , address _to) AccessControl() ERC20Snapshot() ERC20(name_, symbol_) {
    ...
    function mint( address _to , uint256 _value) external onlyRole(MINT_ROLE) returns (bool) {
        _mint(_to, _value);
        return true;
    }
