...
contract ERC20 is IERC20, Owner{
	...
	uint256 public _initialSupply = 21000000 * 10 ** 18;
    ...
    address public saleProfitAddress = address(0x9873ceD937acD106967A2d555525aDD872DA434a);
	address public burnProfitAddress = address(0xc6F97F86b2cD46a19FfB43db83d4596351960623);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
		...
		if(recipient == address(0)){
            ...
            _transfer(msg.sender, burnProfitAddress, amount.mul(5).div(100));
		} else {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(isSwapMainAddress(recipient)){
            ...
            uint profitAmount = amount.mul(8).div(100);
            ...
            _balances[saleProfitAddress] = _balances[saleProfitAddress].add(profitAmount);
            emit Transfer(sender, recipient, actAmount);
            emit Transfer(sender, saleProfitAddress, profitAmount);
        } else {
...
contract KICToken is ERC20 {
    constructor () 
        ERC20("King INternational coin", "KIC", 18) {
