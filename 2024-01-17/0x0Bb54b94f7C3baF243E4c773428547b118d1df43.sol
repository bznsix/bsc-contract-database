...
contract CyberTrees is ERC20, Ownable {
    ...
    constructor () ERC20("CyberTrees", "TREE") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xCd4B6dec92B25cD150BB2A924453E48638f42D66;
        ...
        _mintOnce(owner(), 69e6 * (10 ** decimals()));
