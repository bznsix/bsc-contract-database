...
contract KanalPresale is Ownable {
    ...
    IERC20 public immutable token = IERC20(0x6323d7A0F72aBF7A87A3Afcf9652dF1834a4Fc73);
    ...
    address public wallet = payable(0xe34009FdCe0683B9839203d560c276c2c6080eE0);

    // How many token units a buyer gets per BNB & USDT
    uint256 public tokenPriceUSD = 5;
    uint256 public bnbDivider = 1000;
