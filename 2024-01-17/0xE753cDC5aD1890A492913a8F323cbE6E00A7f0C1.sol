...
contract GERONIMO is ERC20, Ownable {
    ...
    constructor() payable ERC20("GERONIMO", "$GNIMO") {
        ...
        dividendTracker = new DividendTracker(30 * 10**5, rewardToken);
