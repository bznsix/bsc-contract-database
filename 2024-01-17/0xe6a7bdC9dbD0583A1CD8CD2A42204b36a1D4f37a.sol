...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08C7d4EFF81A88Ed590cfe302037AF3B27e047df; // owner address
...
contract SnoopDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snoop $DOG";
    string private _symbol = "$DOG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x08C7d4EFF81A88Ed590cfe302037AF3B27e047df); // Marketing Address
    address payable private teamWalletAddress = payable(0x08C7d4EFF81A88Ed590cfe302037AF3B27e047df); // Team Address
