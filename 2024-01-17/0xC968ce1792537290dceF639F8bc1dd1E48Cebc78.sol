...
contract CzodiacTokenTemplate is
    ...
    ERC20PresetFixedSupply
{
    ...
    constructor(
        ...
        uint256 totalSupply
    ) ERC20PresetFixedSupply(name, ticker, totalSupply, msg.sender) {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MANAGER_ROLE, msg.sender);
        _grantRole(MANAGER_ROLE, taxWallet);
    ...
    function _transfer(
        ...
        if (taxWad > 0) super._transfer(sender, taxWallet, taxWad);
    ...
    function settaxWallet(address _to) public onlyRole(MANAGER_ROLE) {
        setIsExempt(taxWallet, false);
