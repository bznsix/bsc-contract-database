...
contract CAT2024 is ERC20, Ownable {
    ...
    constructor () ERC20("CATE COIN 2024", "CAT2024") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xD35D56E5A48E4dEfc7dbDf6dEA5c11BA64CfFa04;
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _feeOnTransfer) external onlyOwner {
        ...
        require(feeOnTransfer <= 3, "CSLT: Total Fees cannot exceed the maximum");
