...
contract BABYSHARK is Ownable, ERC20 {
    ...
    constructor()
        Ownable(0x3a31064c8e9788F8490e447155C7E400D1Ef329d)
        ERC20("Baby Shark", "BABYSHARK")
    {
        _mint(owner(), 420_690_000_000_000_000 * (10 ** 9));

        liquidityTaxBuy = 100;
        liquidityTaxSell = 100;

        marketingTaxBuy = 399;
        marketingTaxSell = 399;
        ...
        marketingWallet = 0x3a31064c8e9788F8490e447155C7E400D1Ef329d;
    ...
    function setBuyTax(
        ...
        require(
            _liquidityTaxBuy + _marketingTaxBuy + _reflectionTaxBuy <= 1000,
    ...
    function setSellTax(
        ...
        require(
            _liquidityTaxSell + _marketingTaxSell + _reflectionTaxSell <= 1000,
    ...
    function _update(
        ...
        if (takeFee) {
            ...
            if (_isAutomatedMarketMakerPair[from]) {
                ...
                reflectionTax = (reflectionTaxBuy * value) / denominator;
                ...
                reflectionTax = (reflectionTaxSell * value) / denominator;
            }

            marketingTaxAmount += marketingTax;
            liquidityTaxAmount += liquidityTax;
            reflectionTaxAmount += reflectionTax;
            ...
            if (reflectionTax > 0) {
                value -= reflectionTax;
                super._update(from, address(dividendTracker), reflectionTax);
            }

            if (reflectionTaxAmount > 0 && dividendTracker.totalSupply() > 0) {
                try
                    dividendTracker.distributeCAKEDividends(reflectionTaxAmount)
                {
                    emit SendDividends(reflectionTaxAmount);
                    reflectionTaxAmount = 0;
                } catch {}
            }
        }
