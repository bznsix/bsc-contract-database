...
contract SAFEX is IBEP20, Auth {
    ...
    address DEV = 0x4d0C96477ea68E6D0950e5C4E1D6fE62CeEfF3Dc;
    ...
    // Name and symbol
    string constant _name = "SAFEX";
    string constant _symbol = "$SFX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 20mill

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch or 2B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 1% or 1B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 2% or 2B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4E44566D79e6aFCD4426B68394fd4e3CAF483211;
