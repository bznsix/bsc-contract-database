...
contract Buddy is Context, IERC20, Ownable {
    ...
    string private _name = "Buddy";
    string private _symbol = "$Buddy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f63047f4e87d4dD183A3209Ae1389b0DcB9e47a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1506e4bc08f751D6c8FB6Aa5D397Fa2a8EC1B231); // BuyBack Address
