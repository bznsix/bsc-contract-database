...
// import {Game} from "./Game.sol"; // For Arbitrum
import {Game} from "./old/Game-v4.sol"; // For BNB, Polygon
...
contract Keno is Game {
    ...
    function _countNumbers(
        ...
        count = ((numbers * POPCNT_MULT) & POPCNT_MASK) % POPCNT_MODULO;
    }
    ...
    function getNumbersOutOfRandomWord(
        ...
        while (i < config.maxNumbersPlayed) {
            uint256 num = randomWord % config.biggestNumber;
            uint256 bitmask = 1 << num;
...
import {IBank} from "../../bank/old/IBank-v4.sol";
    ...
    ReentrancyGuard
{
    ...
    function _newBet(
        ...
        if (!bank.isAllowedToken(tokenAddress) || token.houseEdge == 0) {
