...
contract DHJ is ERC20, Ownable {
    ...
    address public marketingAddress = 0x63bC0EFc6fb63d3FCc437c7Fdd438a790ecCcc25;
    address public xhjToken = 0x657a998FFd60B9d828a86D68A054B1121C5d7055;
    ...
    constructor() ERC20("DHJ", "DHJ") {
        uint256 totalSupply = 3060 * (10**18);
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if (MarketingFeeAmount > 0) {
                _swapToken(MarketingFeeAmount, marketingAddress);
