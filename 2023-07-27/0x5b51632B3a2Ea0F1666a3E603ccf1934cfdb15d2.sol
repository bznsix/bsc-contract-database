...
Tax explained:
✅ 2% going to BUSD rewards.
✅ 3% going to marketing.

Transaction limits :
✅ 3% max buy/sell.
✅ 3% max wallet.

https://t.me/BlueXtoken
...
contract bluex is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BLUE X";
    string constant _symbol = "BLUE X";
    ...
    uint256 public _maxTxAmount = 3 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 3 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x749570Cb80db5e74237cB574502774a8Bb827af0;
        marketingWallet = 0x749570Cb80db5e74237cB574502774a8Bb827af0;
        devWallet = 0x749570Cb80db5e74237cB574502774a8Bb827af0;
