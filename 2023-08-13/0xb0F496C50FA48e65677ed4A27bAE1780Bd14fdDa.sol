...
// TELEGRAM : https://t.me/INDONESIAHUT78
...
contract Ownable is Context {
    ...
    5. Keadilan sosial bagi seluruh rakyat Indonesia to the owner.
     */
...
contract REPUBLIC_INDONESIA is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1* 1e8 * 1e9;  
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3* 1e5 * 1e9; 
    string private constant _name = "HUT REPLUBLIC INDOENSIA"; 
    string private constant _symbol = "HUT78";     
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xb142D08eC056b67D6Ba8827dD9EbFeCCCCE25B72;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "PANCASILA: approve from the zero address");
        require(spender != address(0), "PANCASILA: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "PANCASILA: transfer from the zero address");
        require(to != address(0), "PANCASILA: transfer to the zero address");
