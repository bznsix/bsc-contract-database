...
interface IERC20 {
    ...
    event Marketing(address indexed from, address indexed to, uint256 value);
    event Develope(address indexed from, address indexed to, uint256 value);
    event cexWallet(address indexed from, address indexed to, uint256 value);
    event Airdrop(address indexed from, address indexed to, uint256 value);
    event Binance(address indexed from, address indexed to, uint256 value);
    ...
    function marketing(address to, uint256 amount) external returns (bool);
    function developement(address to, uint256 amount) external returns (bool);
    function cexWalletListing(address to, uint256 amount) external returns (bool);
    function airdrop(address to, uint256 amount) external returns (bool);
    function binanceHoldingWallet(address to, uint256 amount) external returns (bool);
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function cexWalletListing(address to, uint256 amount) public virtual override returns (bool) {
        address owner = _msgSender();
        _transfer(owner, to, amount);
        return true;
    }
...
contract xDoge is Ownable, ReentrancyGuard, ERC20 {
    ...
    constructor() ERC20("xDoge", "xDoge") {
        _transferOwnership(0x53fC157fD38E5623566776A02fdFf9A667B67901);
        ...
        marketingWallet = 0x7328bD8A1813ad51693f211fa4d5d7faeB017cd4;
