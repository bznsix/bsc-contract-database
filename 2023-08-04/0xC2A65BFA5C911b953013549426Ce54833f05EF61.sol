...
contract CATDOG_NFT_STAKE is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x3962eaE59Ba15910eA2ACeD462b05696B9A5435A); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [500, 0, 0, 0, 0];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 10000000000000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
