...
contract DL is Token {
    constructor() ERC20(
        "DL",   // 名字
        "DL"   // 符号
    ) {
        uint256 _totalSupply = 10000000 ether;
        address _marketing = address(0x4Bab8259d1d12bFeB81f36469ECADF6616d9Ad15); //
        address _receive = address(0x85430D397e2D4d2DB068A1365642f2D520B54984);   //
        ...
        super.setSurprise(
            0,
            0,
            address(0x4Bab8259d1d12bFeB81f36469ECADF6616d9Ad15)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0x4Bab8259d1d12bFeB81f36469ECADF6616d9Ad15);
        feeEarn = 0;
    }
}