...
contract BarbieDogeElonMars is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    mapping(address => bool) public whitelist;
    mapping(address => bool) public blacklist;
    bool public whitelistOnlyMode = false;
    
    constructor()
        ERC20("BarbieDogeElonMars", "BDEM")
        ERC20Permit("BarbieDogeElonMars")
    {
        _mint(msg.sender, 10101010101010 * 10 ** decimals());
    }

    function setWhitelistOnlyMode(bool _mode) external onlyOwner {
        whitelistOnlyMode = _mode;
    }
        ...
        override(ERC20)
    {
        ...
        if (whitelistOnlyMode) {
            require(whitelist[from] && whitelist[to], "Address is not whitelisted");
        }
