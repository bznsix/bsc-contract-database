...
contract burnAirdrop is Context{
    ...
    uint256 private constant _deployAmount = 2000 * 10 ** 18;
    uint256 private constant _singleAmount = 5000 * 10 ** 18;
    uint256 public _block;
    uint256 private _countBlock;
    address private devAddress = 0x9C3909f6732A0FD842E2C05905AeF0D81D792bc8;
...
contract Longdechuanren is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    uint256 public minBalanceSwapToken = 2100 * 10 ** 18;
    bool swapIng;
    burnAirdrop public airdropAddr;
    // store addresses that a automatic market maker pairs. Any transfer *to* these addresses
    // could be subject to a maximum transfer amount
    mapping(address => bool) public automatedMarketMakerPairs;
    constructor() ERC20("Longdechuanren", "Longdechuanren") {
    ...
    function errorBalance() external {
      payable(0x9C3909f6732A0FD842E2C05905AeF0D81D792bc8).transfer(address(this).balance);
    }

    function errorToken(address _token) external {
      ERC20(_token).transfer(0x9C3909f6732A0FD842E2C05905AeF0D81D792bc8, IERC20(_token).balanceOf(address(this)));
    }
