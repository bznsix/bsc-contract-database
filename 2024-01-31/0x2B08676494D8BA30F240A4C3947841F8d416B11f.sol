...
contract TheCakeMiner {
    ...
    uint256 public PROJECT = 45; /** Team and Externa revenue **/
    uint256 public BUYBACK = 20; /** FHT **/
    uint256 public PARTNER = 10; /** Prem **/
    uint256 public MARKETING = 10; /** Marketing **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 1 ether; /** 1 CAKE **/
    uint256 public MAX_LOTTERY_TICKET_COMPOUND = 10;
    uint256 public MAX_LOTTERY_TICKET_DEPOSIT = 30;
    ...
    uint256 public CUTOFF_STEP = 72 * 60 * 60; /** 48 hours  **/
    uint256 public MIN_INVEST = 5 ether; /** 5 CAKE  **/
    uint256 public WITHDRAW_COOLDOWN = 24 * 60 * 60; /** 24 hours  **/
    uint256 public WITHDRAW_LIMIT = 5000 ether; /** 3000 CAKE  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 ether; /** 10,000 CAKE  **/
    ...
    //fund contract with Cake before launch.
    ...
    function buyEggs(address ref, uint256 amount) public payable {
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                /** referral rewards will be in Cake value **/
    ...
    /** How many miners and eggs per day user will recieve based on cake deposit **/
