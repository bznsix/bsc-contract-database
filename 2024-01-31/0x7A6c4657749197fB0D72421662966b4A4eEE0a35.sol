...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd82Df70232562F7479b185efdd9317be24588232;
...
contract JNGV3 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x472f42881404BBD0173b33cfBC2E7064C8901909;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Jungle V3";
    string private _symbol = "JNGV3";
