...
// Telegram Group : https://t.me/swoopsbsctoken 
...
contract SwoopsBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Swoops Bsc";
    string private _symbol = "$SWOOPS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4DC10523CCe0eadcdfbF0948c3D5F7fC6bB2C488); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x3E2777968a47E4990268779e8D25cE5Acd75643E); // Development Address
