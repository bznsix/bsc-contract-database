...
contract Myrok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Myrok";
    string private _symbol = "MYK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5680C0595b84b837851491af904aa5Fd2a69c742);
    address payable private DevelopmentWalletAddress = payable(0x020A8502E14c7D4b2e6A985De7889F9d7b9acd30);
