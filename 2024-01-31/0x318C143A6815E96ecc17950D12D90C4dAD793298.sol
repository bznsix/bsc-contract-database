...
//--- Contract v3 ---//
contract ASS is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x14fF78dD66249D20a0e322BD7cfa823e1660b15C); // build: 0x14fF78dD66249D20a0e322BD7cfa823e1660b15C
    address payable private devWallet = payable(0xCE507885E38402581662731b8EE77B90359039FB); // build: 0xCE507885E38402581662731b8EE77B90359039FB


//--- v3 Allocations by ASS https://assonbsc.com ---//
    ...
    string constant private _name = "ASS";
    string constant private _symbol = "$ASS";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"ASS: Must equals to 100%");
    ...
    function changeWallets(address newBuy, address newDev) external onlyOwner {
        require(newBuy != address(0),"ASS: Address Zero");
        require(newDev != address(0),"ASS: Address Zero");
