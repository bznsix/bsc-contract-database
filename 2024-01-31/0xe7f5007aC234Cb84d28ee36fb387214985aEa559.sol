...
contract OG_Token is Context, IERC20, Ownable {
    ...
    event UpdateBlacklistAddress(address wallet, bool status);
    ...
    // Future Burn Wallet 0x026751D71D35790eE969e98f61D4001E4CAA47C3                    
    // Team Wallet 0x4d26fffb6841E87e9f5b9cD320cB961C1189FD23                              
    // Marketing Wallet 0xe4B1FaeBd9dfdbAf4AFe67c476a2969f354d7038                          
    // Development Wallet 0x8aeeE5DCFdb43018e0cB38590603daf2986ef2d0                        
   
    constructor (address _BUSD)  {
        _rOwned[owner()] = _rTotal;

        wallets = [0x026751D71D35790eE969e98f61D4001E4CAA47C3,0x4d26fffb6841E87e9f5b9cD320cB961C1189FD23,0xe4B1FaeBd9dfdbAf4AFe67c476a2969f354d7038,
            0x8aeeE5DCFdb43018e0cB38590603daf2986ef2d0];
        ...
        buybackWallet = 0xB71b240B0AC3cF5AC537639658BD481031D911DF;
    ...
    function setBlacklistAddress(address _walletAddress, bool _status) external onlyOwner{
        require(_walletAddress != address(0), "Null Address cannot be Blacklisted!");
        _blacklistAddress[_walletAddress] = _status;
        emit UpdateBlacklistAddress(_walletAddress, _status);
    }
    ...
    function setSellFeePercent(uint256[5] calldata _fees) external onlyOwner() {
        ...
        require(totalSellFee < 201 ,"Total Sell Fee cannot be more than 20%");
    ...
    function setBuyFeePercentage(uint256[5] calldata _fees) external onlyOwner() {
        ...
        require(totalBuyFee < 201, "Total Buy Fee cannot be more than 20%");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_blacklistAddress[from], "Blacklist Address Cannot Transfer");
        require(!_blacklistAddress[to], "Cannot Transfer to Blacklist Address");
    ...
    function Burn(uint256 tAmount) external {
    	require(msg.sender == futureBurnWallet, "Cannot burn from other wallet!");
        _transfer(msg.sender, deadWallet, tAmount);
