...
contract PROFEBENADIZToken is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority)
    ERC20("NADIZ COIN", "NDC", 18)
    ERC20Permit("NADIZCOIN")
    OlympusAccessControlled(IOlympusAuthority(_authority)) {

        _mint(_authority, 1000000000000000000000000000);
