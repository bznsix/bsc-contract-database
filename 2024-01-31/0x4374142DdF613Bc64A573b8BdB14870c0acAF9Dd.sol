 ...
 */
contract BLACKROCK_SAFU is Context, Ownable, IERC20, IERC20Metadata, IERC20Errors {
    mapping(address => uint256) private _balances;
    mapping(address  => mapping(address  => uint256)) private _allowances;
    uint256 private _totalSupply;

    string private _name = "BlackRock";
    string private _symbol = "BLACKROCK";
    ...
    address public marketingWallet = 0x7b4A6Fe5CEc502f28b75e0fC2182ff5E20C8ef2F;
