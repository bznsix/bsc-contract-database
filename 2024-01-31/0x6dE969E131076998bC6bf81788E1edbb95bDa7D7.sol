...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04E178629D2E3F602300012480B471983c2bBcF9; // owner address
...
contract PONKEFORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ponke Fork";
    string private _symbol = "$PORK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x04E178629D2E3F602300012480B471983c2bBcF9); // Marketing Address
    address payable private teamWalletAddress = payable(0x04E178629D2E3F602300012480B471983c2bBcF9); // Team Address
