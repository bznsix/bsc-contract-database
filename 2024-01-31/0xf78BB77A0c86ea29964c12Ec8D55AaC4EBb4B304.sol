...
contract SUPERDRAGON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x981A29E512512C009bd6Bc5FDA547433172B9cd8); 
    address payable public Wallet_Dev = payable(0xAcD0c1e513b0D7e003204Ff70aCf3aF3F70b5C6F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SUPER DRAGON"; 
    ...
    constructor () {
        _owner = 0xAcD0c1e513b0D7e003204Ff70aCf3aF3F70b5C6F;
