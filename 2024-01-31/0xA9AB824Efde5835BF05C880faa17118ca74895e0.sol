...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDdbCc19715C76D1e55C68f3C880233587c3c66ab; // owner address
...
contract  Madmonkey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Madmonkey";
    string private _symbol = "MM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1172BB7fBEE1EbF013012F08A32530FeA784b9fe); // Marketing Address
    address payable public teamWalletAddress = payable(0x1172BB7fBEE1EbF013012F08A32530FeA784b9fe); // Team Address
