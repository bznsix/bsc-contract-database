...
Telegram: https://t.me/MuskCatglobal
Website: https://www.muskcat.org 
Twitter: https://twitter.com/muskcatOfficial
...
contract MuskCat is Context, IERC20, Ownable {
   ...
   uint8 private constant _decimals = 18; // Assuming 18 decimals for a trillion supply
   uint256 private constant MAX = ~uint256(0);

   uint256 private _tTotal = 1e12 * 10**_decimals; // 1 trillion with 18 decimals
   uint256 private _rTotal = (MAX - (MAX % _tTotal));

   uint256 public swapTokensAtAmount = 1_000_000 * 10**_decimals;

   uint256 public maxSellAmount = 6_000_000 * 10**_decimals;
   uint256 public maxBuyAmount = 6_000_000 * 10**_decimals;
   uint256 public maxWalletBalance = 6_000_000 * 10**_decimals;


    address public marketingAddress = 0x48cE4c7e8Fe87778Bfb3Ebd1bA58b4b97E9Ef5c4;
    address public devAddress = 0x4ca1ba0b8a50289Db3CE7f274A92E6b277276812;

    string private constant _name = "MUSKCAT";
