...
contract NFTToken is ERC20, Ownable {
    ...
    address internal fundsAddress = address(0xFf0285d97d692e81fdc8FE55c5c6560751409506);
    address public usdtAddress;
    address internal Addmint = address(0x82b671B69a4a59648c84437f1F30943268cc1DF0);
    uint256 internal buyFee = 150;
    uint256 internal sellFee = 200;
    uint256 internal transferFee = 120;
    // uint256 internal buyFee = 40;
    uint256 internal buyFundFee = 0;
    // uint256 internal sellFee = 60;
    uint256 internal sellFundFee = 0;
    // uint256 internal transferFee = 10;

    uint256 public swapTokensAtAmount = 310000 * 10 ** 18; 
    mapping (address => uint256) public addLPTimes;
    uint256 public lockTimeInterval = 900 days;
    ...
    constructor( 
        ...
        _isExcludedFromFees[fundsAddress] = true;
        _mint(Addmint, 31000000 * 10 ** 18);
    }
    ...
    function setFeeAmount(uint256 _sellFee, uint256 _buyFee, uint256 _transferFee) public onlyOwner {
        sellFee = _sellFee;
        buyFee = _buyFee;
    ...
    function _transfer(
        ...
        if(to == pancakePair || from == pancakePair) {
            if(takeFee) {
                ...
                super._transfer(from, address(fundsAddress), totalFee);
            }
        } else {
            if(takeFee) {
