...
contract MON is ERC20, ERC20Burnable, Pausable, TwoPhaseOwnable {

    uint256 private maxSupply = 1000000000 * (10 ** uint256(decimals()));

    mapping (address => bool) blacklisted;

    constructor() ERC20("MON", "MON", maxSupply ) {
    }
