...
contract AIOToken is IERC20, Ownable {
    string private _name = "AiO";
    string private _symbol = "AiO";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000000000 * 10**uint256(_decimals);
    uint256 private _taxFee = 2; // 2% tax fee
    ...
    function setTaxFee(uint8 _newTaxFee) public onlyOwner {
        require(_newTaxFee <= 10, "Tax fee percentage must be less than or equal to 10");
        _taxFee = _newTaxFee;
    }
