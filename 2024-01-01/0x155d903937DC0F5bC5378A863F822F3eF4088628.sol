...
contract FLOKIX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x03d890D598d20F2B89e80F2b31FF37C29270eFB3); 
    address payable public Wallet_Dev = payable(0xb9b8afB0Acd4A4AF76a5E88fAFBd852E3a3c87a3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 1**4* 10**4 * 1**_decimals;
    string private constant _name = "FLOKI X"; 
    ...
    constructor () {
        _owner =0xb9b8afB0Acd4A4AF76a5E88fAFBd852E3a3c87a3;
