...
interface IGRC20 {
  ...
  */
  ...
  /**
   * @dev Returns the grc token owner.
   */
...
contract GRC20Token is Context, IGRC20, Ownable {
  ...
  constructor(address payable _address) public {
    _name = "Fedral Gold Coin";
    _symbol = "FGC";
    _decimals = 18;
    _totalSupply = 90000000000000000000000000; //9 Cr
    _balances[_address] = _totalSupply;
  ...
  */
  ...
  /**
   * @dev See {GRC20-transferFrom}.
   *
   * Emits an {Approval} event indicating the updated allowance. This is not
   * required by the EIP. See the note at the beginning of {GRC20};
   *
   * Requirements:
   ...
   * problems described in {GRC20-approve}.
   *
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "GRC20: transfer from the zero address");
    require(recipient != address(0), "GRC20: transfer to the zero address");
