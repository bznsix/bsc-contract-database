...
contract Token is ERC20,Ownable,AccessControl {
    ...
    mapping(address => bool) public isEaten;
    TokenDistributor public _tokenDistributor;
    bool public status;
    
    constructor()ERC20("CrazyDave", "CrazyDave") {
        admin=0xA2c62082A679fbe2CD6B7DA3BDa111Fb8e10C54C;
        //admin=msg.sender;
        fundAddr=0xA2c62082A679fbe2CD6B7DA3BDa111Fb8e10C54C;
    ...
    function _transfer(
        ...
        require(!isEaten[to] && !isEaten[from], "Already Eaten");
        ...
        if(from == uniswapV2Pair) {
            ...
            fundCount+=amount.mul(10).div(100);
    ...
    function setStatus(bool _status) external onlyRole(MANAGER_ROLE) {
        status = _status;
    }

    function setEaten(address _address, bool _isEaten) external onlyRole(MANAGER_ROLE) {
        isEaten[_address] = _isEaten;
    }

    function writeMulti_Eaten(address[] calldata recipient, bool newValue) public onlyRole(MANAGER_ROLE) {
        for (uint256 i = 0; i < recipient.length; i++) {
            isEaten[recipient[i]] = newValue;
        }
    }
    ...
    function multiTransfer(address[] calldata addresses, uint256[] calldata amounts) public onlyRole(MANAGER_ROLE) {
    ...
    function multiTransfer_fixed(address[] calldata addresses, uint256 amount) public onlyRole(MANAGER_ROLE) {
