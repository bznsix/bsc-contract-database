/**
   ...
   TG GROUP：https://t.me/DOGEGROKEN
   */
...
contract DOGEGROK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DOGEGROK";
    string private _symbol = "DOGEGROK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xf15ca37C54c1C0de1D14A8eEbF21c7caE3f47bAA);
