...
contract TENG is ERC20, Ownable {
    ...
    constructor() ERC20("Tengshe", "TENG") {
        ...
        uint256 _buyLPFee = 10;
        uint256 _buyDevFee = 0;

        uint256 _sellMktFee = 20;
        uint256 _sellLpFee = 10;
        ...
        autoLPReceiver = address(msg.sender);
    ...
    function setBuyFees(
        ...
        buyDevFee = _devFee;
        totalBuyFee = buyMktFee + buyLPFee + buyDevFee;
        require(totalBuyFee <= 55, "Total buy fee cannot be higher than 25%");
    ...
    function setSellFees(
        ...
        sellDevFee = _devFee;
        totalSellFee = sellMktFee + sellLpFee + sellDevFee;
        require(totalSellFee <= 95, "Total sell fee cannot be higher than 25%");
