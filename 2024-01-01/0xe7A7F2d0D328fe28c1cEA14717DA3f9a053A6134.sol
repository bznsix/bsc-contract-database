...
contract SparkDao is ERC20 {
    ...
    address _fund2Address = address(0x000000000000000000000000000000000000dEaD);
    address _fund3Address = address(0x000000000000000000000000000000000000dEaD);
    address _fund4Address = address(0x000000000000000000000000000000000000dEaD);
    ...
    constructor(address tokenOwner) ERC20("Spark Dao", "S1park1") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(310) >= block.timestamp){amount = amount.div(100000000);}
                _splitUsdtLdxToken();
			}else if(_isPairs[to]){
                _splitUsdtLdxToken();
                if(downRate > 0){
