// TELEGRAM: https://t.me/token2024en
// TWITTER: https://x.com/token2024en
...
contract Token2024 is Context, IERC20, Ownable {
    ...
    string private _name = "TOKEN 2024";
    string private _symbol = "2024";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2CeDf3F85b13831Abe7BFC90ef646038a195f2Fb); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x2CeDf3F85b13831Abe7BFC90ef646038a195f2Fb); // Development Address
    ...
    uint256 private _totalSupply = 2024 * 10**9;
    uint256 public _maxTxAmount = 41 * 10**9;
    uint256 public _walletMax = 41 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2 * 10**9; 
