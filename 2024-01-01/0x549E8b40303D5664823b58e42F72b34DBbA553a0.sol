...
error GucciX2__InvalidBuyFees();
error GucciX2__InvalidSellFees();
error GucciX2__InvalidtransferFees();
error GucciX2__UnableToTransfer();

contract Gucci_Groke_X_v_2 is ERC20, Ownable {
    ...
    uint public buyLiquidity = 7;
    uint public totalBuyFee = 10;


    uint public sellMarketing = 3;
    uint public sellLiquidity = 17;
    uint public totalSellFee = 20;

     uint public transferMarketing = 3;
    uint public transferLiquidity = 7;
    ...
    uint public threshold = 426000 ether;
    uint public maxLimit=1000000 ether;

    uint public constant MAX_SUPPLY = 1_000_000_000 ether;
    ...
    ) ERC20("Gucci Groke X v-2", "GucciX2") {
    ...
    function setBuyFees(uint lpFee, uint marketingFee) external onlyOwner {
        ...
        if (fullBuyFee > 45) revert GucciX2__InvalidBuyFees();
    ...
    function setSellFees(
        ...
        if (fullSellFee > 45) revert GucciX2__InvalidSellFees();
        ...
        if (fulltransferFee > 45) revert GucciX2__InvalidtransferFees();
    ...
    function claimLeftoverBNB() external onlyOwner {
        ...
        if (!succ) revert GucciX2__UnableToTransfer();
    }
