...
*/
    ...
    contract zkFarmersNFT3 is ERC721, Ownable,  ERC2981, ReentrancyGuard  , DefaultOperatorFilterer
  ...
  
  {
       ...
       uint256 public ServiceFee = 0.003135877575339459 ether  ;
            ...
            bytes32 public MerkleGroupRoot1stADT = 0xf031f79196774b2e0bf1d151438b19bb0c6960b8b1c4124a79a9c085c0ec5f1c;
            uint256 public MerklePrice1stADT = 0.001 ether;
            uint256 public MerkleMaxWallet1stADT = 5;
            
            bytes32 public MerkleGroupRoot2ndADT = 0xf031f79196774b2e0bf1d151438b19bb0c6960b8b1c4124a79a9c085c0ec5f1c;
            uint256 public MerklePrice2ndADT = 0.002 ether;
            uint256 public MerkleMaxWallet2ndADT = 3;
            
            bytes32 public MerkleGroupRoot3rdWave = 0xf031f79196774b2e0bf1d151438b19bb0c6960b8b1c4124a79a9c085c0ec5f1c;
            uint256 public MerklePrice3rdWave = 0.003 ether;
            uint256 public MerkleMaxWallet3rdWave = 2;
            
            bytes32 public MerkleGroupRoot4thWave = 0xf031f79196774b2e0bf1d151438b19bb0c6960b8b1c4124a79a9c085c0ec5f1c;
            uint256 public MerklePrice4thWave = 0.004 ether;
            uint256 public MerkleMaxWallet4thWave = 1;
        ...
        constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721("zkbNo Smoking Zone", "ZKBNS") {
            baseURL = _initBaseURI;
            price = _price;
            _maxSupply = __maxSupply;
            maxMintAmountPerTx = _maxMintAmountPerTx;
            maxMintAmountPerWallet = _maxMintAmountPerWallet;
             _setDefaultRoyalty(0xa553e204031C38e62563d9A60327131EcBb41a1B, 500); 
        ...
        /// @param _mintAmount  the amount of tokens to WL mint
        /// @param _merkleProof user merkletree proof to mint
    ...
    /// @param _mintAmount the amount of tokens to mint
     ...
     require(publicMintStatus, "Public Mint is not open!");
          ...
          multiMint(msg.sender, _mintAmount);
           ...
           if(MerkleProof.verify(_merkleProof, MerkleGroupRoot2ndADT, leaf)) return true;
           if(MerkleProof.verify(_merkleProof, MerkleGroupRoot3rdWave, leaf)) return true;
           if(MerkleProof.verify(_merkleProof, MerkleGroupRoot4thWave, leaf)) return true;
            ...
            function checkPricePerUser(bytes32[] memory _merkleProof, bytes32 leaf) view public returns (uint256){
             ...
             if(MerkleProof.verify(_merkleProof, MerkleGroupRoot2ndADT, leaf)) return MerklePrice2ndADT ;
             if(MerkleProof.verify(_merkleProof, MerkleGroupRoot3rdWave, leaf)) return MerklePrice3rdWave ;
             if(MerkleProof.verify(_merkleProof, MerkleGroupRoot4thWave, leaf)) return MerklePrice4thWave ;
            ...
            function checkMaxMintPerUser(bytes32[] memory _merkleProof, bytes32 leaf, uint256 amount) view public returns (bool){
              ...
              if(MerkleProof.verify(_merkleProof, MerkleGroupRoot1stADT, leaf)) {
                 ...
                 if(MerkleProof.verify(_merkleProof, MerkleGroupRoot2ndADT, leaf)) {
                  if(balance <= MerkleMaxWallet2ndADT) return true;
                  else return false;
                }
                 if(MerkleProof.verify(_merkleProof, MerkleGroupRoot3rdWave, leaf)) {
                  if(balance <= MerkleMaxWallet3rdWave) return true;
                  else return false;
                }
                 if(MerkleProof.verify(_merkleProof, MerkleGroupRoot4thWave, leaf)) {
                  if(balance <= MerkleMaxWallet4thWave) return true;
                  else return false;
                }
            ...
            function updateHashRootForAll(bytes32[] memory hashRootArray, uint256[] memory PriceArray, uint256[] memory  MaxMintArray)  public { 
              require(hashRootArray.length <= 4, "Too many inputs on the hash root!");
              require(PriceArray.length <= 4, "Too many inputs on the Price!");
              require(MaxMintArray.length <= 4, "Too many inputs on the Max mint amount!");
                  ...
                  MerkleGroupRoot2ndADT = hashRootArray[1];
                  MerklePrice2ndADT = PriceArray[1];
                  MerkleMaxWallet2ndADT = MaxMintArray[1];
                  
                  MerkleGroupRoot3rdWave = hashRootArray[2];
                  MerklePrice3rdWave = PriceArray[2];
                  MerkleMaxWallet3rdWave = MaxMintArray[2];
                  
                  MerkleGroupRoot4thWave = hashRootArray[3];
                  MerklePrice4thWave = PriceArray[3];
                  MerkleMaxWallet4thWave = MaxMintArray[3];
        ...
        function withdraw() public onlyOwner nonReentrant{
            uint _balance = address(this).balance;
                    ...
                    payable(0xeb889374e62855Cf57128F7a23eB87b780FdBDf4).transfer(_balance * 20 / 100);
                    
                    
                    payable(0x4b7ba98137C6aCfFf52B3C1578541e0539B0C417).transfer(_balance * 30 / 100);
                    
                    
                    payable(0xc98Bca1441AaB26174C087D247a350e5DCC4602e).transfer(_balance * 50 / 100);
