...
contract AiSuperWallet is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 21e3 * 10**18; // 0.1%

    uint256 public genesis_block;
    uint256 private deadline = 0;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x4e9a9eE4265E9525f4353E1A3E8702A12441dBe7;
    address public devWallet = 0x4e9a9eE4265E9525f4353E1A3E8702A12441dBe7;
    ...
    constructor() ERC20("Ai Super Wallet", "Ai Super Wallet") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount >= 21e2,"Swap threshold amount should be lower or equal to 0.01% of tokens");
