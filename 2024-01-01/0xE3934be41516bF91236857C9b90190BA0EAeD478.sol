...
contract GOKUSWAP is BEP20 {
    ...
    constructor() public BEP20("GOKUSWAP", "GOKUSWAP") {
        sellTax = 2;
        buyTax = 2;
        _operator = _msgSender();
        emit OperatorTransferred(address(0), _operator);

        mint(_msgSender(), 1000000000 * 1 ether);      
    }
    ...
    function setLiquidityPoolStatus(address _lpAddress, bool _status) public onlyOperator {
    ...
    function setTaxes(uint8 _sellTax, uint8 _buyTax) public onlyOperator {
        require(_sellTax < 10);
        require(_buyTax < 10);
        sellTax = _sellTax;
        buyTax = _buyTax;
