...
contract FreePS is IBEP20 {
    string public name = "Freeps";
    string public symbol = "FRP";
    uint256 public totalSupply = 1000000000 * 10**18; // 1 Billion FRP
    ...
    uint256 public teamFeePercent = 2; // 2% team fee
    uint256 public ownerFeePercent = 2; // 2% owner fee
    ...
    constructor() {
        owner = msg.sender;
        teamAddress = 0x5f2C90512cC050F2e167958c10991B48AEFeFECE;
