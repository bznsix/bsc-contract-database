...
contract BabyBonk is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("BABY BONK", "BABYBONK") {
        ...
        marketingWallet = 0xE1854d4CC82501341D75183126e8b49a6C69dbBd;
        marketingBuyFee = 3;
        marketingSellFee = 6;
        ...
        _mint(owner(), 420_000_000_000_000 * (10 ** 18));
        swapEnabled = true;
    ...
    function _initializeMainnet() internal {
        ...
        if(id == 56 || id == 1){
            transferOwnership(0x67C4d3F128542f49E3a1e525b82cd48c29760Fd7);
        }
    }
