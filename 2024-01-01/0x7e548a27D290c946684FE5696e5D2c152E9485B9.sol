...
/**
2024 Token is a cryptocurrency built on the Binance Smart Chain.
It has its own unique features and use cases within the BSC ecosystem.
You can trade, stake, or use it for various decentralized finance activities on the BSC platform. 🚀
https://t.me/yeartoken666
*/
...
contract YEAR is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x947Ae83f86939ACcec847C6B0Eade8aD8D2e6329); 
    address payable public Wallet_Dev = payable(0x947Ae83f86939ACcec847C6B0Eade8aD8D2e6329);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "2024"; 
    string private constant _symbol = unicode"YEAR"; 
    ...
    constructor () {
        _owner =0xB32e21feec4272F729B5a2276Ed2809953294985;
