...
/*
=== 'Players Gaming Token' Token contract with following features ===
    => BEP20 Compliance
...
contract PlayersGaming_token is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Players Gaming Token";
    string constant private _symbol = "PGT";
