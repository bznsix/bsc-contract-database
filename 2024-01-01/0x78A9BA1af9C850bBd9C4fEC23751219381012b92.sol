...
// Telegram Group : https://t.me/newyearbonkbsc
...
contract NEWYEARBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewYearBonk";
    string private _symbol = "$NYB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb40d8916B9d97f0f1D8E14EF3eB044689edf8Cf7); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xb40d8916B9d97f0f1D8E14EF3eB044689edf8Cf7); // Development Address
    ...
    uint256 public _DevelopmentShare = 4;
