...
/*
TG : https://t.me/bixiofficial
Twitter : https://twitter.com/bixitoken
Website : https://bixitoken.xyz/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); //XRP
...
contract BIXI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BIXI";
    string constant _symbol = "$BIXI";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //XRP
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xe105BCBd3A597C475D62F7f6Aec32bC20f6C4D07;
        devWallet = 0x78544294380DD81Bb4b866745AB94800D47695e3;
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(devFee));
        totalFeeIfSelling = totalFee + 0;
