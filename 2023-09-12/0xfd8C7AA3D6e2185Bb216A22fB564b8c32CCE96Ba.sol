...
contract CoolJUICE is ERC20Permit, Ownable {
    ...
    constructor() ERC20("CoolJUICE", "CoolJUICE", 9) ERC20Permit() {
    ...
    /**
        @notice increases CoolJUICE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess CoolJUICE
