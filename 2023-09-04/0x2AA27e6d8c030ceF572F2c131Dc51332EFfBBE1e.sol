...
contract Tether is ERC20, ERC20Burnable, Ownable, Mintable, TokenRecover {
    ...
    constructor()
        ...
        Mintable(99999999999990)
    {
        address supplyRecipient = 0x58A11A58607bF66C81e23aC5BcC8298144d143e7;
        ...
        updateTradeCooldownTime(0);

        _mint(supplyRecipient, 10000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x58A11A58607bF66C81e23aC5BcC8298144d143e7);
    }
