...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0xA349374011d821186b8B61A6491C5D332cbC873E);
...
contract PUMPIT is Ownable, IBEP20 {
    ...
    uint256 public constant _totalSupply = 500 * 10**6 * 10**_decimals;
    ...
    address payable public MarketingWalletAddress =
        payable(0xA349374011d821186b8B61A6491C5D332cbC873E);
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**5 * 10**_decimals;
    uint256 public _maxWalletHoldingLimit = 15 * 10**6 * 10**_decimals;
