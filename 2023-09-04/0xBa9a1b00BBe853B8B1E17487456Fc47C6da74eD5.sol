/*
Contract Created in EASYTOKEN.APP
TRY EASYTOKEN BOT - Create tokens in Telegram
...
/*
       $$$$$                                                                    
       $:::$                                                                    
   $$$$$:::$$$$$$ PPPPPPPPPPPPPPPPP   HHHHHHHHH     HHHHHHHHHZZZZZZZZZZZZZZZZZZZ
 $$::::::::::::::$P::::::::::::::::P  H:::::::H     H:::::::HZ:::::::::::::::::Z
$:::::$$$$$$$::::$P::::::PPPPPP:::::P H:::::::H     H:::::::HZ:::::::::::::::::Z
$::::$       $$$$$PP:::::P     P:::::PHH::::::H     H::::::HHZ:::ZZZZZZZZ:::::Z 
$::::$              P::::P     P:::::P  H:::::H     H:::::H  ZZZZZ     Z:::::Z  
$::::$              P::::P     P:::::P  H:::::H     H:::::H          Z:::::Z    
$:::::$$$$$$$$$     P::::PPPPPP:::::P   H::::::HHHHH::::::H         Z:::::Z     
 $$::::::::::::$$   P:::::::::::::PP    H:::::::::::::::::H        Z:::::Z      
   $$$$$$$$$:::::$  P::::PPPPPPPPP      H:::::::::::::::::H       Z:::::Z       
            $::::$  P::::P              H::::::HHHHH::::::H      Z:::::Z        
            $::::$  P::::P              H:::::H     H:::::H     Z:::::Z         
$$$$$       $::::$  P::::P              H:::::H     H:::::H  ZZZ:::::Z     ZZZZZ
$::::$$$$$$$:::::$PP::::::PP          HH::::::H     H::::::HHZ::::::ZZZZZZZZ:::Z
$::::::::::::::$$ P::::::::P          H:::::::H     H:::::::HZ:::::::::::::::::Z
 $$$$$$:::$$$$$   P::::::::P          H:::::::H     H:::::::HZ:::::::::::::::::Z
      $:::$       PPPPPPPPPP          HHHHHHHHH     HHHHHHHHHZZZZZZZZZZZZZZZZZZZ
      $$$$$                                                                     
*/          
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public $ZCore = IBEP20(0x2E40565771cf2BF8622C41CDd85701519F22418A);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = $ZCore.balanceOf(address(this));
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address($ZCore);
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: msg.value
        }(0, path, address(this), block.timestamp);
        uint256 amount = $ZCore.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            $ZCore.transfer(shareholder, amount);
...
contract $PHZ is IBEP20, Auth {
    ...
    string constant _name = "Pepe_Hold_ZCore";
    string constant _symbol = "$PHZ";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1000000000 * (10**_decimals);
    uint256 public _maxWalletToken = _totalSupply / 1;
    uint256 public _maxTxBuyAmount = _totalSupply / 1; 
    uint256 public _maxTxSellAmount = _totalSupply / 1;
    ...
    address public pair;
    address ts_Project = 0x11e17604825407Bc5E9A08c195157b6ED5B1A702;
    ...
    uint256 public swapThreshold = _totalSupply / 100; // Swap for distribuition 
    bool inSwap;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0x11e17604825407Bc5E9A08c195157b6ED5B1A702;
    ...
    function setTxLimit(uint256 BuyAmount, uint256 SellAmount) external onlyOwner {
        _maxTxBuyAmount = BuyAmount;
    ...
    function checkTxLimit(address sender, address receiver, uint256 amount) internal view {
        if(receiver == pair){
        require(amount <= _maxTxSellAmount || isTxLimitExempt[sender], "TX Limit Exceeded");} 
        else {
