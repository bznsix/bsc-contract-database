    ...
    ReentrancyGuard
{
    ...
    //Basic Settings
    uint256 public maxSupply = 200  ; //Collection supply - change to 888
    ...
    bytes32 public merkleRoot = 0x4314b2d3560a0929555ddcedb6d0932722434edbae4278bafd4ee0296002e15a;
    ...
    //BURN Settings
    IERC20 public burnToken =  IERC20(0xf382A28AAb0320e48D3D751f696f935B014B49BD);
    uint256 public burnFee = 50000 ether;


    constructor() ERC721A("PTC OG COIN", "GEN1") {
    ...
    function whitelistMint(
        ...
        uint256 burnAllowance = token.allowance(msg.sender, address(this));
        require(
            burnAllowance >= burnFee,
            "You must have enough token allowance to cover the burn fee"
        );
        require(
            token.transferFrom(msg.sender, address(this), burnFee),
            "Burn fee transfer failed"
        );
    ...
    function changeDependencyToken(address dependencyToken) public onlyOwner {
        burnToken = IERC20(dependencyToken);
    }
