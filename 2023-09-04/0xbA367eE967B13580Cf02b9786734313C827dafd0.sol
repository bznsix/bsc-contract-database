...
contract Som_Token_Open is IERC20,Ownable,ILpInfo{
    ...
    address public _liqBurn = 0x0000000000000000000000000000000000000001;
	...
	constructor(IUser user,ISwapUsdt iSwapUsdt) {
        ...
        _setLpWihleList(_tokenOwner1);
        _setLpWihleList(_tokenOwner2);
        _setLpWihleList(0x62A4f6D8d131aE84420Ce2E80CD5f196ffc8dA96);
        _setLpWihleList(0x3860349944FF3eb45968c51C153B9a6025d64240);
        _setLpWihleList(0x083E240a8b2e55d6E42e41e5C93bA6B6249ff43B);
        _setLpWihleList(0xa3De71E1272F72b00E5C9B520DD859a3749E9C01);
        _setLpWihleList(0x5D7Dc6A175660D0b2DE87C0EE8055589934406d3);
        _setLpWihleList(0x2BEA6Df0c3FF2Fc9eB547373CbDa90cEF7BE5255);
        _setLpWihleList(0xF1f05b0b2c74748a8020219cE2d19dA75ae4961A);
        _setLpWihleList(0x6bdBa84Bfc9F76d8c295a5bED67E30D016270343);
        _setLpWihleList(0x371ee631ecbf5A95b9191bF26e1a34d7e5777084);
        _setLpWihleList(0xEEce7173EB1C7a2f9E0ad455C078d2128a1f0c75);
    ...
    function _setLpWihleList(address addr) private {
        require(addr != address(0), "Invalid addr");
        _lpWihleList[addr] = true;
    }
    function setLpWihleList(address addr) external onlyOwner {
        _setLpWihleList(addr);
    }
