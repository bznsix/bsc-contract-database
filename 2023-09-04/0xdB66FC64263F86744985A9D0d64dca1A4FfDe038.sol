...
abstract contract Ownable is Context {
    ...
    /**
     *  Accept the ownership transfer. This is to make sure that the contract is
 ...
 */
contract SGPT is Context, Ownable, Pausable, IERC20 {
    ...
    */
    ...
    /**
     *  Issues `amount` tokens to the designated `address`.
     *
     * Can only be called by the current owner.
     * - Call to _mint()
     */
    ...
    /**
     *  Disable the {transfer}, {mint} and {burn} functions of contract.
     *
     * Can only be called by the current owner.
     * The contract must not be frozen.
     */
    ...
    /**
     *  Enable the {transfer}, {mint} and {burn} functions of contract.
     *
     * Can only be called by the current owner.
     * The contract must be frozen.
     */
