/**
  ...
  Telegram : https://t.me/QuAdDrIlLiAnT

 
 Thanks Clown https://t.me/AlphabetCalls
*/
...
contract QuAdDrIlLiAnT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    QuAdDrIlLiAnTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("QuAdDrIlLiAnT", " QuAd RiSe") {
        marketingWallet = payable(0xA19a7bCF1C1C35E9e8DD3B381038D177aDc7BC60);
        devWallet = payable(0x8AefeF3FBFdB85a92d4D1C29199Ddb8274c1B3E7);
        ...
        dividendTracker = new QuAdDrIlLiAnTDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "QuAdDrIlLiAnTTRACKER",
            "QuAdDrIlLiAnTTRACKER"
        );
        ...
        uint256 totalTokenSupply = (500_000_000) * (10**18);
        _mint(owner(), totalTokenSupply); // only time internal mint function is ever called is to create supply
        maxWallet = totalTokenSupply / 1000; // 0.10%
        swapTokensAtAmount = totalTokenSupply / 250; // 0.10%;
...
contract QuAdDrIlLiAnTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    QuAdDrIlLiAnT public QuAdDrIlLiAnTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        QuAdDrIlLiAnTContract = QuAdDrIlLiAnT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "QuAdDrIlLiAnT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "QuAdDrIlLiAnT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main QuAdDrIlLiAnT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(QuAdDrIlLiAnTContract);

            uint256 prevBalance = QuAdDrIlLiAnTContract.balanceOf(address(this));
            ...
            {
                uint256 received = QuAdDrIlLiAnTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    QuAdDrIlLiAnTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
