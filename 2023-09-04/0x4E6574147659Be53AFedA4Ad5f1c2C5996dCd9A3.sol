...
//https://t.me/xflokibscoffcial
//https://twitter.com/xflokibsc2023
interface IERC20 {
...
contract XFLOKI  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x92043855Da2fF177C54265D514f6263402b2C27e); 
    address payable public Wallet_Dev = payable( 0x92043855Da2fF177C54265D514f6263402b2C27e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner = 0x92043855Da2fF177C54265D514f6263402b2C27e ;
