...
Join the fun of a Purrrfect MEME Community
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 2184 hours;
...
contract FourEyesCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Four Eyes Coin";
    string constant _symbol = "IIII";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 469_000_000_000 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xa0ABd9B658F8f4F29e5994fB1D93651098E9DE7f;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setReward(address _BUSD) external authorized {
	    BUSD = _BUSD;
    }

    function depositRewards(uint256 _rewards) external authorized {
         uint256 rewards;
         rewards = _rewards;
         try distributor.deposit{value: rewards}() {} catch {}
