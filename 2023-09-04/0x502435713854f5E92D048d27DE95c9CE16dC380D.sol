...
contract xai is ERC20, ERC20Burnable, Ownable {
        ...
        ERC20(unicode"xai", unicode"xai") 
    {
        ...
        taxwalletFeesSetup(200, 200, 200);
        ...
        excludeFromLimits(taxwalletAddress, true);
    ...
    function taxwalletFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + taxwalletFees[0];
        totalFees[1] = 0 + taxwalletFees[1];
        totalFees[2] = 0 + taxwalletFees[2];
        ...
        if (!_swapping && !AMMPairs[from] && canSwap) {
            ...
            if (false || _taxwalletPending > 0) {
                ...
                if (taxwalletPortion > 0) {
                    (success,) = payable(address(taxwalletAddress)).call{value: taxwalletPortion}("");
