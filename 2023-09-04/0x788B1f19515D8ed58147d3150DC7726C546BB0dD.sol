...
contract VTFI is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {

    mapping (address => bool) whitelistedAddresses;
    bool public whitelistEnabled = true;

    constructor() ERC20("Value Token Fix Idendity", "VTFI") ERC20Permit("VTFI") {
        whitelistedAddresses[msg.sender] = true;
        whitelistedAddresses[address(0)] = true;
        _mint(msg.sender, 3600000 * 10 ** 18);
    }
    ...
    modifier isWhitelisted(address _address) {
        require(
            ...
            //if whitelist enabled and _msdSender is not the owner, tx allowd only if the sender address is whitelisted
