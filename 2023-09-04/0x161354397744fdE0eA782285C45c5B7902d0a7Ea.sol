...
contract TOken is Ownable, AccessControl, ERC20 {
  ...
  function _splitFeesFromTransfer(
    uint256 amount
  ) internal view returns (uint256 forHolders, uint256 forPools, uint256 forTaxCollector) {
  ...
  function retrieveERC20(address token, address to, uint256 amount) external onlyOwner {
