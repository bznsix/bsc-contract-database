//https://t.me/EthereumXOFC
//https://twitter.com/EthereumXBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
/* Token contract */
contract ETHEREUMX is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1f2a6435606979307080112Cda433261D3fa5DaD;
    ...
    // Name and symbol
    string constant _name = "Ethereum X";
    string constant _symbol = "ETHX";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 5.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 2% or 2M tokens
