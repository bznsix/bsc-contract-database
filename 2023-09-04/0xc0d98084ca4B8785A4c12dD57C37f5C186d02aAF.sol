...
contract XDCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = unicode"𝕏Ð";
    string private _symbol = unicode"𝕏Ð";
    uint8 private _decimals = 18;
    address payable public marketingWalletAddress = payable(0x57C806c27a5365ad65168C2850b7628d26Ef9Af4); 
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
        require(newLiquidityTax.add(newMarketingTax) <= 5, "Total tax cannot exceed 5%");
