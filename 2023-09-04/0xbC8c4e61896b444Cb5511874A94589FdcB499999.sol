...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 100; // 营销
    uint256 public _buyLPFee = 0; //回流
    uint256 public _buyLPDividendFee = 100; //lp分红
    uint256 public _buy_BackFee = 100; // 回购

    uint256 public _sellFundFee = 100; // 营销
    uint256 public _sellLPFee = 10;// 回流
    uint256 public _sellLPDividendFee = 100; // lp分红
    uint256 public _sell_BackFee = 90; // 回购


    uint256 public airDropNumbs = 0; //自动空投数量
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xFD8503cc2132Eb922a4DDBa81a6D6AAB7C079A1b;
...
contract ETHCoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0xc603565e3eaB936233823815Aff0341abD7B5bC6), // 营销钱包
    
        address(0x61aA95387DB8E0aFA783F8Be71b34F3b66B9a7Fb), // 收币钱包
