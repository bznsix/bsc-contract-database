...
// Website: https://kentoken.wixsite.com/kentoken
// Telegram: https://t.me/kentoken777
...
contract KenToken is ERC20, Ownable {
    ...
    constructor() ERC20("KenToken", "$KEN") {
        uint256 totalSupply = 777000000000 * 10 ** decimals();
        _mint(msg.sender, totalSupply); //The normal initial token creation
    }
