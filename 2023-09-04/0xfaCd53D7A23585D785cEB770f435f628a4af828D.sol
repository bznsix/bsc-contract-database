...
Telegram: https://t.me/ShiboshiBSC
...
contract Shiboshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiboshi";
    string private _symbol = "Shiboshi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xCeDD8c14C760FcA1Cab6B9452A53f45f1FFa6253);
    address payable public teamWalletAddress =
        payable(0xF2D3Effe1E5F25A15794A23c023a1485AcfEd133);
    ...
    mapping(address => bool) public isFloor;

    uint256 public _buyFloorFee = 35;
