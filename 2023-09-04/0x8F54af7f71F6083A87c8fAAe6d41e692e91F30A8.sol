...
contract BaseRegistrarImplementation is ERC721, IBaseRegistrar, Ownable {
    ...
    constructor(PID _pid, bytes32 _baseNode) ERC721("PIDT", "PIDT") {
        pid = _pid;
        baseNode = _baseNode;
    }
...
contract PidRegistrarController is Ownable, ReentrancyGuard {
    ...
    // @param owner is the owner of the name
    // @param secret is the secret to commit to, in order to prevent front running
