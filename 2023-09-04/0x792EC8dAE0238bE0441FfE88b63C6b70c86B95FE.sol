...
contract TXY is Token {
    constructor() ERC20(
        "TXY",   // 名字
        "TXY"   // 符号
    ) {
        uint256 _totalSupply = 1200 ether; 
        address _marketing = address(0x3BAa92Db31508C20dc30Dc47f8ea372eB2F85Ee3); // 
        address _receive = address(0x390eB321AeB6AdA0a291CF5f2ca97b58c0A50442);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x3BAa92Db31508C20dc30Dc47f8ea372eB2F85Ee3)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(15 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0xf8b9c50fC624870f529D3bc4574036F75F6f7aCe);   
        feeEarn = 1500; 
    }
}