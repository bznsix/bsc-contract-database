...
// Built by OSEAN DAO based on Thirdweb DropERC721
...
import "./lib/TokenURILib.sol";

contract OseanNFT is Initializable, 
    ContractMetadata, 
    Royalty, 
    PrimarySale, 
    Ownable, 
    ...
    using StringsUpgradeable for uint256;
    using TokenURILib for OseanNFT;
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return TokenURILib.generateTokenURI(_tokenId, batchId, batchUri);
    }
 ...
 * _Available since v4.5._
 */
abstract contract ERC721VotesUpgradeable is Initializable, ERC721AUpgradeable, VotesUpgradeable {
...
library TokenURILib {
    ...
    function generateTokenURI(uint256 tokenId, uint256 batchId, string memory baseURI) internal pure returns (string memory) {
        if (batchId == 0) {
