...
contract Letsmakememegreatagainnnn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Lets Make Meme Great Againnnn ";
    string private _symbol = " $MEME ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2f40940F6e273EE5c726ebE1B41fc523b842c8DE);
    address payable private DevelopmentWalletAddress = payable(0x2f40940F6e273EE5c726ebE1B41fc523b842c8DE);
