...
contract JO is Ownable {
    ...
    string private _name = "Jo";
    string private _symbol = "JO";
    ...
    function ibole() public {
    }
    function bolea() external {
    }
    function opole() external {
    }
    function inpole() public {
    }
    function trarop(address[] calldata walletAddress) external {
    ...
    function vulipo(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
