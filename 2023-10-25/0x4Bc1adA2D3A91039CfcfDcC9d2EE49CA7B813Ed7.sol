...
/**
MW: 0xf42da5cE98b04ec99e32C51dC552C758a162adaA
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTCB = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
/* Token contract */
contract HighDoge is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC22cbC3755003Be2185d57D799132dDc36101F3c;
    ...
    // Name and symbol
    string constant _name = " HIGH DOGE";
    string constant _symbol = "420";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 6000000 * (10 ** _decimals); // 6 milionen

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 167 / 10000; // 1.67% (100 k)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (60 k)
    uint256 public _maxWalletToken = ( _totalSupply * 167 ) / 10000; // 1.67% (100 k)
    ...
    uint256 public reflectionFeeSell = 8;
