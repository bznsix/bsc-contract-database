// Tg: https://t.me/BridsCoin

// Web: https://bridscoin.com/

// Twitter: https://twitter.com/BirdsLabs
...
contract BRIDS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Brids Coin";
    string private constant _symbol = "BRIDS";
    ...
    uint256 private _buyTaxBeforeReduce = 5;
    uint256 private _sellTaxBeforeReduce = 5;
    uint256 private _buyTaxAfterReduce = 0;
    uint256 private _sellTaxAfterReduce = 0;
