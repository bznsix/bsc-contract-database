...
contract Lottery {
    ...
    uint256 public duration = 3 minutes; // The duration set for the lottery
    ...
    function BuyTickets() public payable {
     ...
     function DrawWinnerTicketWithData(uint256 _time, uint256  _ticketPrice, uint256 _ticketCommission ) public isOperator {
        ...
        ticketCommission = _ticketCommission;
        expiration = block.timestamp + _time;
    }
    ...
    function DrawWinnerTicket() public isOperator {
     ...
     function restartDrawWithData(uint256 _time, uint256  _ticketPrice, uint256 _ticketCommission) public isOperator {
