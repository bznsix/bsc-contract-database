...
contract BTCS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 21_000 * 10 ** _decimals;
    string private constant _name = "BTCS";
    string private constant _symbol = "BTCS";
