// 🎯Telegram: https://t.me/cookie_bsc
// WE ARE ONE TEAM , ONE VISION , ONE GOAL

/**
TOKEN DETAILS
- TOKEN NAME: COOKIE MONSTER -
- SYMBOL: $COOKIE -
...
contract CookieMonster is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "COOKIE";
    ...
    uint256 public _tax_On_Buy = 5; //Tax cannot be more than 20%
    uint256 public _tax_On_Sell = 5; //Tax cannot be more than 20%
    uint256 public _maxTxAmount = _tTotal * 100 / 100;
    uint256 public _maxWalletToken = _tTotal * 100 / 100;

    address payable public DevWallet = payable(0x1EC131ED0EF0d09d0Fbbaa049a835Ea33D627431);
    address payable public MarketingWallet = payable(0x7DB62c42bf7E213B040CE84C267Fa6D82A0B8252);
    ...
    function ChangeFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax; //Tax cannot be more than 20%
        _tax_On_Sell = selltax; //Tax cannot be more than 20%
    }
