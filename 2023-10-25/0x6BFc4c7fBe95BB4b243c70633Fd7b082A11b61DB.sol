...
contract KarmaCats is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function withdraw() external nonReentrant {
        ...
        payable(wallet1).transfer((balance * 75) / 100); // 75%
        payable(wallet2).transfer((balance * 20) / 100); // 20%
        payable(dev).transfer((balance * 5) / 100); // 5%
    }
}
// SPDX-License-Identifier: MIT
