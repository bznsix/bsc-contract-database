...
contract DAOETTOKEN is Ownable {
    uint256 tokenamount = 2500*10**decimals();
    address public DAOFB556;
    ...
    string private _tokenname = "DAOion2.0";
    string private _tokensymbol = "DAO";
