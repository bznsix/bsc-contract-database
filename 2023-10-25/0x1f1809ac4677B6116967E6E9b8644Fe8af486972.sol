...
contract TG1C is Ownable, IERC20 {
    ...
    string constant private _name = "2Girls1Cup";
    string constant private _symbol = "2GIRLS1CUP";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x4d492d90F20108D10d52B5fCC1DB5d89101d4416;
        betWallet = 0x4d492d90F20108D10d52B5fCC1DB5d89101d4416;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (tmpSuccess1,) = payable(betWallet).call{value : amountETHDev, gas : 30000}("");
        tmpSuccess1 = false;
