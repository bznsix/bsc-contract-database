...
contract Doge1Mission is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge1Mission";
    string private _symbol = "DOGE1";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x33CE282840fF544C0c3dB5cF0ca223d9b22CF2Bd); // Marketing Address
    address payable public teamWalletAddress = payable(0x33CE282840fF544C0c3dB5cF0ca223d9b22CF2Bd); // Team Address
