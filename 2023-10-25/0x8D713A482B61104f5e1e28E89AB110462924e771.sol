...
contract firstdao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "firstdao";
    string private _symbol = "firstdao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35165AeCBBeE063095443880Fd0F27d3077dCB4E); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7a5F090cEF9c82d52F2b3894D5e2Ae1ae0B9AC99); // buyback Address
    ...
    uint256 private _totalSupply            = 100000000000000000 * 10**9 ;
    uint256 public _maxTxAmount             = 10000000000000000 * 10**9;
    uint256 public _walletMax               = 100000000000000000 *  10**9;
    uint256 private minimumTokensBeforeSwap = 250000000 * 10**9; 
