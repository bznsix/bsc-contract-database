...
contract babytige is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babytige";
    string private _symbol = "babytige";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb60A5f7FA564810c573eABfa54CD0FDD58006A29); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9bEDC25CF30b4fC11D9A9AdE258E66E34d2eBdcD); // buyback Address
    ...
    uint256 public _walletMax               = 200000000000000000 *  10**9;
    uint256 private minimumTokensBeforeSwap = 250000000000 * 10**9; 
