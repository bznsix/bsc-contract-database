...
abstract contract V2SwapRouter is IV2SwapRouter, ImmutableState, PeripheryPaymentsWithFeeExtended {
    ...
    function swapTokensForExactTokens(
        ...
        address[] calldata path,
        address to
    ) public payable override returns (uint256 amountIn) {
...
abstract contract V3SwapRouter is IV3SwapRouter, PeripheryPaymentsWithFeeExtended, OracleSlippage {
    ...
    /// @inheritdoc IV3SwapRouter
    function exactInput(ExactInputParams memory params) public payable override returns (uint256 amountOut) {
        // use amountIn == Constants.CONTRACT_BALANCE as a flag to swap the entire balance of the contract
        bool hasAlreadyPaid;
        if (params.amountIn == Constants.CONTRACT_BALANCE) {
            hasAlreadyPaid = true;
    ...
    /// @inheritdoc IV3SwapRouter
    function exactOutput(ExactOutputParams memory params) public payable override returns (uint256 amountIn) {
