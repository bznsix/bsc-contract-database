/**
    ...
    WELCOME TO Clash of Soldiers Inu COMMUNITY! Now you are a member of the next x500 gem!

    The gaming landscape is evolving rapidly, and Clash of Soldiers 
    ...
    core features, mechanics, and vision behind Clash of Soldiers, poised 
...
contract ClashOfSoldiers is ERC20, Ownable {
    ...
    constructor() ERC20("Clash of Soldiers", "CLASH") {

        webSite     = "https://clashofsoldiers.com";
        telegram    = "https://t.me/Clashofsoldiers";
        ...
        transferFees.burn       = 0;
        transferFees.marketing  = 1000;

        totalTransferFees       = transferFees.burn + transferFees.marketing;

        totalFees               = totalBuyFees + totalSellFees + totalTransferFees;

        percent.percent0 = 100;
        percent.percent1 = 400;
        percent.percent2 = 100;
        percent.percent3 = 400;

        projectWallets.marketingWallet = 0x13659Bc8aaA6BA839e6d3835C10003819D0A498d;
        projectWallets.developmentWallet1 = 0xa3c5E474aF2AB2031d03BDA0fc0BA844057b11e1;
        projectWallets.developmentWallet2 = 0x3006617dbd14b9c1188C5d856EC41C38735b2442;
        projectWallets.developmentWallet3 = 0x4B5F492A16C23eb30BEE38596DCae480ca3d0fa4;
    ...
    function _transfer(
        ...
        */
        ...
        if( canSwap &&
            ...
            if ((buyFees.burn + sellFees.burn + transferFees.burn) != 0) {
                uint256 burnTokens;

                // If burn rates are greater than zero, totalFees is never zero
                burnTokens = contractTokenBalance * (
                    buyFees.burn + sellFees.burn + transferFees.burn
                    ) / totalFees;
    ...
    function setFees(uint256 feesBurn, uint256 feesMarketing) public onlyOwner{
        ...
        require(totalBuyFees <= 1000 && totalSellFees <= 1000, "Invalid fees");

    }
    
    // Contract will be renounced after launch
    function setFeesTransfer(uint256 feesBurn, uint256 feesMarketing) public onlyOwner{

        transferFees.burn       = feesBurn;
        transferFees.marketing  = feesMarketing;

        totalTransferFees       = transferFees.burn + transferFees.marketing;

        totalFees               = totalBuyFees + totalSellFees + totalTransferFees;

        require(totalTransferFees <= 1000, "Invalid fees");
