/**
https://t.me/WitchPepeBSC
https://twitter.com//WitchPepeBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58105F6e8B95e1640186909640A82E4D665ceFec; 
...
contract WitchPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WITCH PEPE";
    string private _symbol = "WPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58105F6e8B95e1640186909640A82E4D665ceFec); 
    address payable public teamWalletAddress = payable(0x58105F6e8B95e1640186909640A82E4D665ceFec); 
    ...
    uint256 private _totalSupply = 800000 * 10**_decimals;
    uint256 public _maxTxAmount = 8000 * 10**_decimals; 
    uint256 public _walletMax = 24000 * 10**_decimals;
