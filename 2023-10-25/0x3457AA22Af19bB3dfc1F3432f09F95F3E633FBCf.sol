...
/*
   ___ ___             _______   ______    _______            _______   _______   _______   ___   _______   _______   ___     
  (   Y   )   ______  |   _   | |   _  \  |   _   |  ______  |   _   | |   _   | |   _   | |   | |       | |   _   | |   |    
   \  1  /   |______| |.  |   | |.  |   | |.  1___| |______| |.  1___| |.  1   | |.  1   | |.  | |.|   | | |.  1   | |.  |    
   /  _  \            |.  |   | |.  |   | |.  __)_           |.  |___  |.  _   | |.  ____| |.  | `-|.  |-' |.  _   | |.  |___ 
  /:  |   \           |:  1   | |:  |   | |:  1   |          |:  1   | |:  |   | |:  |     |:  |   |:  |   |:  |   | |:  1   |
 (::. |:.  )          |::.. . | |::.|   | |::.. . |          |::.. . | |::.|:. | |::.|     |::.|   |::.|   |::.|:. | |::.. . |
  `--- ---'           `-------' `--- ---' `-------'          `-------' `--- ---' `---'     `---'   `---'   `--- ---' `-------'
 withdrawals X_ONE_CAPITAL
*/
...
contract XOneCapitalWithdrawals is ReentrancyGuard, Ownable, Authorized {
 ...
 function XOneCapitalTokenWithdrawals(
    uint256 totalPay,
    uint256 totalPayUS,
    uint256[] memory amount,
    address[] memory holders,
    uint256[] memory amountUS,
    address[] memory holdersUS
    ...
    if (totalPayUS > 0) {
        //Get Amount to pay holdersUS
        IERC20(_Usdt).transferFrom(msg.sender, address(this), totalPayUS);
        //Distribute
        for (uint i = 0; i < holdersUS.length; i++) {
        IERC20(_Usdt).transfer(address(holdersUS[i]), amountUS[i]);
        }
    }
  ...
  function getTotalUsdtBalance () public view returns (uint) { return IERC20(_Usdt).balanceOf(address(this));  }
