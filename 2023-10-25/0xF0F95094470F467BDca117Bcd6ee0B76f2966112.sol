...
contract KUKU is Context, IBEP20, Ownable {
    ...
    string private _name = "KUKU"; // token name
    string private _symbol = "$KU"; // token ticker
    ...
    uint256 public minTokenToSwap = 500000 * 1e9;
    uint256 public maxHoldingAmount = 2000000 * 1e9;
    uint256 public minBuyLimit = 2000000 * 1e9;
