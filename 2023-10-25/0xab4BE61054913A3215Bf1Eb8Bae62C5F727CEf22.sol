...
contract ELves is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELves";
    string private _symbol = "ELves";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83F3aFf879ab3924E071D730361149C1325dE4F1); // Marketing Address
    address payable public teamWalletAddress = payable(0x3df4a6155003f1ED6F1B876b8B42b5C3F51d411B); // Team Address
