...
contract DFL is ERC20, Ownable {
    ...
    address public _market = 0x2906237b521DF60cDC9d0E46b6826E0E945ce6a3;
     event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("DFL", "DFL") {
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_market] = true;
        _isExcludedFromFee[0x99de9ec1a49f45502347562d4bD8a7531c733A23] = true;
        _mint(0x99de9ec1a49f45502347562d4bD8a7531c733A23, _tTotal);
