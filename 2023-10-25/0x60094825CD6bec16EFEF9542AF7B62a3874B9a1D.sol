//Telegram: https://t.me/maestro500krefunds
...
contract Maestro500KRefunds is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"500K Refunds";
    string private _symbol = unicode"$M500KR";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xFe12498d7D8ab3b28ECC732613C1eFaB99266201);
    address payable private taxWallet2 = payable(0xFe12498d7D8ab3b28ECC732613C1eFaB99266201);
    ...
    uint256 public _marketingShares = 5;
    uint256 public _developmentShares = 5;

    uint256 public _totalTaxIfBuying = 20; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 20; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 20;

    uint256 private _totalSupply = 21_696_696 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*21696696/21696696;
    uint256 public _walletMax = _totalSupply*21696696/21696696;
    uint256 private minimumTokensBeforeSwap = _totalSupply*21696696/21696696; 
