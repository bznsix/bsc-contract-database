//Telegram: https://t.me/blacklayernano
...
contract BLackLayerNano is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BLack Layer Nano";
    string private _symbol = unicode"BLCN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xa46fed454F1EF29b4d1877E3FAB6CAFC81ABbF99);
    address payable private taxWallet2 = payable(0xa46fed454F1EF29b4d1877E3FAB6CAFC81ABbF99);
    ...
    uint256 public _sellLiquidityFees = 6;
    uint256 public _sellMarketingFees = 6;
    uint256 public _sellDevelopmentFees = 3;

    uint256 public _liquidityShares = 15;
    uint256 public _marketingShares = 15;
    uint256 public _developmentShares = 15;

    uint256 public _totalTaxIfBuying = 15; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 15; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 15;

    uint256 private _totalSupply = 121_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*121000000/121000000;
    uint256 public _walletMax = _totalSupply*121000000/121000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*121000000/121000000; 
    ...
    function setSellFee(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        ...
        require (_totalTaxIfSelling <= 100);
    }
