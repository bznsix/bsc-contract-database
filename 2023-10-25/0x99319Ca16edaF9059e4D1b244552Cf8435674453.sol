...
contract Super is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x0DAd1c9FC5151AE58Ac1e5DFc59559c3D5BFDD4B); // Marketing Address
        
    address payable public teamAddress =
        payable(0x96334B1bAD1d51ffceFe41d092E90eA64Afb1e81); // Team Address
        
    address payable public liquidityAddress =
        payable(0x2314710b6F22Bdb3cf743868974788156F23316f); // Liquidity Address
    ...
    uint256 private constant _tTotal = 2 * 1e9 * 1e18;
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 5, "Must keep taxes below 5%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 5, "Must keep taxes below 5%");
