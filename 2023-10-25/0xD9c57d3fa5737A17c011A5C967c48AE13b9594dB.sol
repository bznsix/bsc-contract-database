...
contract TWOPOINT is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 1000000 * 10**_decimals; //
    uint256 public maxBuyAmount = 1000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 5000 * 10**_decimals; //

    address public marketingAddress = 0xEc6021E139D5693Efa5B41833594b442C4A9A4a3; //
    address public devAddress = 0xEc6021E139D5693Efa5B41833594b442C4A9A4a3; //

    string private constant _name = "2.0"; //
    ...
    Taxes public taxes = Taxes(0,5,10,0); //
    Taxes public sellTaxes = Taxes(0,10,20,0); //
    ...
    // Owner cannot transfer out 2.0 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out 2.0");
