...
contract SuperLayerNetwork is ERC20, Ownable {
    ...
    constructor() ERC20("Super Layer Network", "SUPLA") {
        ...
        maxWallet = 2_000_000_000 * 1e18; // 2% 
        ...
        marketingWallet = address(0xa887cba5ceeADD6f14a29B253c2f8692d6afd686); // set as marketing wallet
        devWallet = address(0xa887cba5ceeADD6f14a29B253c2f8692d6afd686); // set as dev wallet
