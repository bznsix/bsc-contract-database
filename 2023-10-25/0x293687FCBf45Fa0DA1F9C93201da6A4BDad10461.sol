...
contract WhiteRabbit is Context, IERC20, Ownable {
    ...
    string private _name = unicode"WHITE RABBIT";
    string private _symbol = unicode"WRABBIT";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xEad24AF109ca3D03701b6dD0078BDD9A060D26E3);
    address payable private taxWallet2 = payable(0xEad24AF109ca3D03701b6dD0078BDD9A060D26E3);
