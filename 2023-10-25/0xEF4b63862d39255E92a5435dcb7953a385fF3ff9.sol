...
//https://t.me/WarioCoinCommunity
//https://twitter.com/WarioCoinBsc
interface IERC20 {
...
contract Cyber is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7fF2aE9D3F4F9c5E9BFF0fC0790f937505b57600); 
    address payable public Wallet_Dev = payable(0x7fF2aE9D3F4F9c5E9BFF0fC0790f937505b57600);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Cyber Crate Shop"; 
    string private constant _symbol = unicode"CCS"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 1; 
    uint256 public _Tax_On_Buy = 1;
    uint256 public _Tax_On_Sell = 25;
    ...
    constructor () {
        _owner =0x7fF2aE9D3F4F9c5E9BFF0fC0790f937505b57600;
