...
/*
    Telegram: https://t.me/joecoin_me
    Twitter: https://twitter.com/joecoin_me
    Website: https://www.joecoin.me
    Email:   joe@joecoin.com
    Medium:  https://medium.com/@joecoin_me
...
contract JOECOIN is BEP20, Ownable {
    ...
    bool public JOEING = false;

    uint256 public constant totSupply =  1 * 10**8 * 10**9; // 100 MIO
    ...
    Taxes public buyTaxes = Taxes(9, 9);
    Taxes public sellTaxes = Taxes(9, 9);
    Taxes public transferTaxes = Taxes(9, 9);
    ...
    constructor() BEP20("Joe Coin", "JOE") {
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
            require(JOEING, "it's not JOEING yet");
        }
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= (1 * 10**8) / 100, "Swap threshold amount should be lower or equal to 1%");
        tokenLiquidityThreshold = new_amount * 10**decimals();
    }

    function startJoe() external onlyOwner {
        require(!JOEING, "it's already started");
        JOEING = true;
        providingLiquidity = true;
        genesis_block = block.number;
    }

    function afterStartJoe() external onlyOwner {

        buyTaxes = Taxes(0, 0);
        sellTaxes = Taxes(0, 0);
        transferTaxes = Taxes(0, 0);
    }
