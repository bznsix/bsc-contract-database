/**
https://t.me/BNBWhalesPUMP
https://twitter.com/BNBWhalesPUMP
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29f0AE739D4EBea1e3bB898cEC6865F08F7F6C40; 
...
contract BNBWhalePUMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB WHALE PUMP";
    string private _symbol = "BNBWHALE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29f0AE739D4EBea1e3bB898cEC6865F08F7F6C40); 
    address payable public teamWalletAddress = payable(0x29f0AE739D4EBea1e3bB898cEC6865F08F7F6C40); 
    ...
    uint256 private _totalSupply = 555000000 * 10**_decimals;
    uint256 public _maxTxAmount = 3885000 * 10**_decimals; 
    uint256 public _walletMax = 11655000 * 10**_decimals;
