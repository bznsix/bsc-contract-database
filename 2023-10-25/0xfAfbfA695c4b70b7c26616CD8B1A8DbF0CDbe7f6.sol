    ...
    Initializable // Initializable contract
{
    ...
    function executeTransition(
        ...
        // If permission is invalid or flow rate allownace is not enough or
        // If contract owner has no balance, end locker flow and delete schedule
        if (
            ...
            // Call Locking Scheduler to execute transition
