...
contract DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "SEX DOGE";
    string private _symbol = "SEXDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x03c718E914f9e7AE123A7eCd9C194931C89CaB70); // Marketing Address
    ...
    address payable private teamWalletAddress = payable(0xD3a7816124895107f7E4a0d72bF804F476238686); // Team Address
