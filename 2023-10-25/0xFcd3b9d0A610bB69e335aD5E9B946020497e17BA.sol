    ...
    SuperAppBase
{
    ...
    function createFlowSchedule(
        ...
        nonZeroVariable(uint256(int(flowRate)))
    ...
    function deleteFlowSchedule(
        ...
        address receiver,
        bytes memory ctx
    ) external nonZeroAddress(receiver) returns (bytes memory newCtx) {
        newCtx = ctx;
        address sender = _getSender(ctx);
    ...
    function modifyFlowSchedule(
        ...
        returns (bytes memory newCtx)
    {
        if (endDate == 0 && startDate == 0) revert ZeroVariableProvided();
        newCtx = ctx;
        address sender = _getSender(ctx);
    ...
    function _createSenderFlowTasks(
        ...
        // TODO can delete this validation as flow scheduler handles this or deletes the schedule if all dates are zero
...
interface IFlowSchedulerAutomation {
    /* ========== ERRORS ========== */
