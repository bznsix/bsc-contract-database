        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x2222ce88Fc82cC0a6154cffAD17E86Afaba92769), block.timestamp
                );
            }
        }
    }
...
contract LONGX is AbsToken {
    constructor() AbsToken(
        ...
        address(0x2222ce88Fc82cC0a6154cffAD17E86Afaba92769)//ReceiveAddress
    ){
    }
}