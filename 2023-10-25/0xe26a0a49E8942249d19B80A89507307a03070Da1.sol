...
// telegram : https://t.me/bullcoming
// X : https://x.com/bullcomingbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x736fc39d33F4C7c45855bE7310FD8fa9083e39b2 ; // owner address
...
contract BullComing  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BullComing";
    string private _symbol = "BULLCOM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x736fc39d33F4C7c45855bE7310FD8fa9083e39b2); 
    address payable public teamWalletAddress = payable(0x736fc39d33F4C7c45855bE7310FD8fa9083e39b2);
