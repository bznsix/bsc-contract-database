...
contract Dogdays is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogdays";
    string private _symbol = "Dd";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC14d5CA06C6193007C5ebAd9Af785fC0FE64C110);
    address payable public teamWalletAddress = payable(0xC14d5CA06C6193007C5ebAd9Af785fC0FE64C110);
    ...
    constructor () {
        ...
        emit Transfer(address(0x53b3338E3345758aE88b930e3d9759A95C5cE05c), _msgSender(), _totalSupply);
    }
