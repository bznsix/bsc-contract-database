...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC6EC2bDd8a3d056e8fBE695d1F27196bcECEDbaa; // owner address
...
contract JOE is Context, IERC20, Ownable {
    ...
    string private _name = "Joe Classic";
    string private _symbol = "$JOEC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC6EC2bDd8a3d056e8fBE695d1F27196bcECEDbaa); // Marketing Address
    address payable private teamWalletAddress = payable(0xC6EC2bDd8a3d056e8fBE695d1F27196bcECEDbaa); // Team Address
