...
contract BabyGrimaceCat is Context, IBEP20, Ownable {
    ...
    address private _BuyBackandBurnwallet;
    ...
    string private constant _name     = "Baby Grimace Cat";
    string private constant _symbol   = "BGCAT";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 3500;
    uint256 private  _percentageOfLiquidityForMarketing = 3500;
    uint256 private  _percentageOfLiquidityForBBandBurn = 1000;
    ...
    uint256 public  _liquidityFeeSell = 18;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 200 / 10000; // 1.5% of total supply

    event TeamSent(address to, uint256 bnbSent);
    event MarketingSent(address to, uint256 bnbSent);
    event BBandBurnSent(address to, uint256 bnbSent);
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0xAb13953502cF662A6E103287a645F48Dd6507918;
        _marketingWallet = 0x922CEd81Ee80367719434EBecd873AA785902323;
        _BuyBackandBurnwallet = 0x4fAC6A80a2eD2BBC7E1f2250F1e1abb0BD44Db59;
        ...
        _isExcludedFromAntiWhale[address(0xF8fFDdA22B7A089aFa30e51ff148ef0749440935)]            = true;
        _isExcludedFromAntiWhale[address(0x4fAC6A80a2eD2BBC7E1f2250F1e1abb0BD44Db59)]            = true;

        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0xF8fFDdA22B7A089aFa30e51ff148ef0749440935)] = true;
        _isExcludedFromMaxTx[address(0x4fAC6A80a2eD2BBC7E1f2250F1e1abb0BD44Db59)] = true;
    ...
    function setAddresses(address teamWallet, address marketingWallet, address BuyBackandBurnwallet) external onlyOwner {
        _teamWallet       = teamWallet;
        _marketingWallet = marketingWallet;
        _BuyBackandBurnwallet = BuyBackandBurnwallet;
    }

    function setLiquidityPercentages(uint256 teamFee, uint256 marketingFee, uint256 BBandBurnFee) external onlyOwner {
        _percentageOfLiquidityForTeam        = teamFee;
        _percentageOfLiquidityForMarketing  = marketingFee;
        _percentageOfLiquidityForBBandBurn = BBandBurnFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbForBBandBurn = newBalance / 10000 * _percentageOfLiquidityForBBandBurn;
        uint256 bnbForLiquidity = newBalance - bnbForTeam - bnbForMarketing - bnbForBBandBurn;
        ...
        if ( bnbForBBandBurn != 0 ) {
            emit BBandBurnSent(_BuyBackandBurnwallet, bnbForBBandBurn);
            payable(_BuyBackandBurnwallet).transfer(bnbForBBandBurn);
        }
