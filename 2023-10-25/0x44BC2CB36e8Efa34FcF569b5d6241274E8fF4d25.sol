...
THIS DEPLOYMENT IS FOR TESTING PURPOSED ONLY. 

DO NOT INTERACT WITH THIS CONTRACT IF SEEN LIVE. 
...
contract Test1 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 30 / 2000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal * 3 / 100;
    uint256 public maxWalletAmount = _tTotal * 3 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x4Bb025493854373f9659B3F388a05aA361db1275; //
    ...
    Taxes public taxes = Taxes(2,6,2,0); //
    ...
    function updateMaxTxAmount(uint256 amount) external onlyOwner{
        maxTxAmount = _tTotal * amount / 300; // MAXTX: 1 = 0.1%
    }

    function updateMaxWalletBalance(uint256 amount) external onlyOwner{
        maxWalletAmount = _tTotal * amount / 300; // MAXWALLET: 1 = 0.1% 
    }

    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner{
        swapTokensAtAmount = _tTotal * amount / 25; // THRESHOLD : 1 = 0.1% 
    }
