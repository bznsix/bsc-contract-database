...
Empowering Conversations with an AI-Powered Personal 
Assistant Emulating Elon Musk

"Unleash the Power of Conversation, 
Connecting You to the Visionary Mindscape 
of Elon Musk!
    
Telegram Official News : https://t.me/ElonXTalk
...
contract ElonXTalk is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ElonXTalk", "EXT") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 9/11
        ...
        marketingWallet = address(0x699ac2f33C046243B4449B23D94Ed4f18E765E9B); // set as marketing wallet
        devWallet = address(0x699ac2f33C046243B4449B23D94Ed4f18E765E9B); // set as dev wallet
