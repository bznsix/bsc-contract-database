...
contract Gay is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x640dfe2CD824Dc26552ceDCcf06FFA6ec14BA70E);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0x640dfe2CD824Dc26552ceDCcf06FFA6ec14BA70E;
    ...
    uint256 private minimumTokensBeforeSwap = 125000000 * 10**_decimals;
