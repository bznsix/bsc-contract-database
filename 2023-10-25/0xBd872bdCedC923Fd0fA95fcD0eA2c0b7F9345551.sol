...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8)); // ETH - 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
...
contract ETHERMOON is ERC20, Ownable {
    ...
    constructor() ERC20("ETHERMOON", "ETHERMOON") {
    	...
    	operationsWallet = address(0xB879AC0D6688c49F417616C634F6ECEd3699BED9); // set as operations wallet
        ...
        _createInitialSupply(address(0xB879AC0D6688c49F417616C634F6ECEd3699BED9), (totalSupply * 20) / 100);        
        _createInitialSupply(address(0xB879AC0D6688c49F417616C634F6ECEd3699BED9), (totalSupply * 1) / 100);        
    }
