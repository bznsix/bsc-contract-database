...
contract TEST1 is ERC20, Ownable {
    ...
    constructor() payable ERC20("TEST1", "TST") {
        webSite = "";
        telegram = "";
        twitter = "";
        ...
        buyFees.burn = 0;
        buyFees.marketing = 250;

        totalBuyFees = buyFees.burn + buyFees.marketing;

        sellFees.burn = 0;
        sellFees.marketing = 250;
        ...
        marketingWallet = 0xC84F932eE46b70ED5D9e0360b34c6bE052B7a9D7;
        developmentWallet1 = 0x0392C87F01432D05074Bb594904DD8Bf740AF56E;
        developmentWallet2 = 0x6B86f9Ef7df3b8D5Dc5151894BfB63ba5FA3d42D;
    ...
    function sendTokens(address[] memory addresses, uint256[] memory tokens)
        external
    {
        ...
        require(
            ...
            "Insufficient balance for shipments"
        );
    ...
    function setInitLaunch(
        ...
        uniswapV2Router.addLiquidityETH{value: msgValue}(
            address(this),
            balanceOfTokens,
            0,
            0,
    ...
    function _transfer(
        ...
        */
        ...
        if (canSwap && !swapping && automatedMarketMakerPairs[to]) {
            ...
            burnTokens =
                (contractTokenBalance * (buyFees.burn + sellFees.burn)) /
                totalFees;
            ...
            payable(developmentWallet1).transfer(
                (newBalance * percent1) / 1000
            );
