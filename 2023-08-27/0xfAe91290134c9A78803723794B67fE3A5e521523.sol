...
//--- Contract v2 ---//
contract GU is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x864b1478b32F833b1f2a1F45584D6bBD05e0025c);


    IRouter02 public swapRouter;
    string constant private _name = "Garden Universe";
    string constant private _symbol = "GU";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function enableTrading() external onlyOwner {
            ...
            swapThreshold = (balanceOf(lpPair)) / 10_000;
