/**
   ...
   Welcome to BLUEBERRYCHEESECAKE
   
   This is a community token. If you want to create a telegram I suggest to name it to @BLUEBERRYCHEESECAKEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BLUEBERRYCHEESECAKE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BLUEBERRYCHEESECAKE 10000X? 
   ...
   it's the best part of the #BLUEBERRYCHEESECAKE idea, increasing the liquidity pool automatically, 
...
contract BLUEBERRYCHEESECAKE is Context, IERC20, Ownable {
    ...
    string private _name = "BLUEBERRYCHEESECAKE";
