...
contract HardHitNFT is UniversalONFT721 {
    constructor(uint256 _minGasToStore, address _layerZeroEndpoint, uint _startMintId, uint _endMintId, uint _fees) UniversalONFT721("HardHitNFT", "HIT", _minGasToStore, _layerZeroEndpoint, _startMintId, _endMintId, _fees) {}
}
