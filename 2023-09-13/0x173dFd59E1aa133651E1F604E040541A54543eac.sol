...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    address public xcbContract = 0x9dCD6ab0511b2e72Af3d088538D678bae9bBF552;
    address public btcbContract = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
    //address public xcbContract = 0xFA5c9A4F501a50d00531003fA9eFdE8eC9Bbda1C; // TESTNET
    //address public btcbContract = 0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8; // TESTNET
    IERC20 public rewardsToken1 = IERC20(xcbContract);
    IERC20 public rewardsToken2 = IERC20(btcbContract);
    IERC20 public stakingToken = IERC20(xcbContract);
    address public nftContract = 0x3E31F70912c00AEa971A8b2045bd568D738C31Dc;
    //address public nftContract = 0x2a86186F634f5f6764Cb5fc66f5cF615f881a3a3; // TESTNET
    IERC1155 public nftInterface = IERC1155(nftContract);
    ...
    function stake(uint256 amount) external override nonReentrant updateRewards(msg.sender) {
        require(nftInterface.balanceOf(msg.sender, nftId) > 0, "NFT not found");
    ...
    function getRewards() public override nonReentrant {
        require(nftInterface.balanceOf(msg.sender, nftId) > 0, "NFT not found");
        getReward1();
        getReward2();
    ...
    function exit() external override {
        ...
        if(nftInterface.balanceOf(msg.sender, nftId) > 0) {
            getReward1();
            getReward2();
        }
    }
