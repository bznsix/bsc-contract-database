...
contract CTC is IERC20 , Ownable{

    //项目方地址
    address public constant ItemAddress = 0xEeCddf92dec25C50e95d98f24AB77Ca3dAbA4097;
    ...
    //0x9f37055A4BA925E0678E7447e2164CD833bf3F18 测试网络
    //0xaFcB1E163926B50ec4F534FdE087d06d90C7D0B1 正式网测试
    ...
    //收手续费地址
    address public address_1 = 0x514d5AEace9594CAad0Bc8c23c8d23C7711ED816;
    address public address_2 = 0x4af0172AC3EA1Fa2069e81C789783F8258540D04;
    address public address_3 = 0x10864C097Bc44638Cbde0C5D6ca36483F3Ce9741;
    ...
    function node_reward(address user , uint256 amount)internal {
        ...
        //     uint256 level ;
        //     if(small_node[first_address]){
        //         level = 1;
        //     }else if(middle_node[first_address]){
        //         level = 2;
        //     }else if(big_node[first_address]){
        //         level = 3;
        //     }else{
        ...
        //             _balances[first_address] = _balances[first_address] +  reward_amount / 2;
        //             emit Transfer(second_reward_address, first_address, reward_amount / 2); 
        //             //Ipool(second_reward_address).invite_reward(first_address, reward_amount);
        //         }
        //     }
        // }
        // if(second_address != blackAddress){
        //     uint256 lp_amount = group_lp[second_address];
        //     uint256 level ;
        //     if(small_node[second_address]){
        //         level = 1;
        //     }else if(middle_node[second_address]){
        //         level = 2;
        //     }else if(big_node[second_address]){
        //         level = 3;
        //     }else{
        //         level = getNodeRewardLevel(lp_amount);
        //     }
        ...
        //             _balances[second_address] = _balances[second_address] + reward_amount / 2;
        //             emit Transfer(second_reward_address, second_address, reward_amount / 2); 
        //             //Ipool(second_reward_address).invite_reward(second_address, reward_amount);
        //         }
        //     }
        // }
    ...
    function dividend_usdt(uint256 amount)internal{
        ...
        // usdt_amount = IERC20(usdtAddress).balanceOf(address(this));
        // if (usdt_amount > 0){
        //     uint256 u = usdt_amount / 3;
        //     IERC20(usdtAddress).transfer(address_1, u);
        //     IERC20(usdtAddress).transfer(address_2, u);
        //     //粉末给最后一个地址
        //     IERC20(usdtAddress).transfer(address_3, usdt_amount - 2 * u);
        // }
    }
    ...
    function getRewardLevel(uint256 amount)public pure returns(uint256){
        ...
        else if(amount < 150 * 10**18){
            return 2;
        }
        else if(amount < 200 * 10**18){
            return 3;
        }
        else if(amount < 250 * 10**18){
            return 4;
        }
        else if(amount < 300 * 10**18){
            return 5;
        }
        else if(amount < 350 * 10**18){
            return 6;
        }
        else if(amount < 400 * 10**18){
            return 7;
        }
        else if(amount < 450 * 10**18){
            return 8;
