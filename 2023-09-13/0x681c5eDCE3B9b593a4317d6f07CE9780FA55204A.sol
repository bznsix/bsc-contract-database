 ...
 * 
  ...
  *——————————————————
  *
  * Description: When airdrop?  When marketing?  When pump?  When moon?  WhenCoin will answer all of these questions and more!
  * Website: N/A
  * Twitter: https://twitter.com/whencoinbsc
  * Telegram: N/A
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    address public marketingWallet=0x87e452E263B753c332b66c4828530d84758d8b07;
    
    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=5000000000000000000;
    uint256 public maxTransactionAmountSell=5000000000000000000;

    
    uint256 public maxWalletAmount=20000000000000000000;
    ...
    uint256 public swapTokensAtAmount=1000000000000000;
