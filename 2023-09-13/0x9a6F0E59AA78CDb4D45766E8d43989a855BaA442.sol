...
contract UniswapV3LiquidityManager is StrategyBase, ReentrancyGuard, IPancakeV3MintCallback {
    using SafeMath for uint256;
    ...
    function pancakeV3MintCallback(
        ...
        if (decoded.payer == address(this)) {
            ...
            // take and transfer tokens to Pancake V3 pool from the user
            if (amount0 > 0) {
...
library OracleLibrary {
     ...
     * @notice _pool Address of the Pancake V3 pool
     */
...
import "./pancake-v3/IPancakeV3Pool.sol";
import "./pancake-v3/IPancakeV3Factory.sol";
import "@chainlink/contracts/src/v0.7/interfaces/FeedRegistryInterface.sol";
