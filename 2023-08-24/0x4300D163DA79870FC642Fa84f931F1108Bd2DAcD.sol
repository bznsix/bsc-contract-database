...
contract Divitest is ERC20, Ownable {
    using Address for address payable;

    uint256 private initialSupply = 10_000_000_000 * (10 ** 18);
    ...
    DivitestDividendTracker public dividendTracker;
    ...
    constructor(address _treasuryWallet, address _devWallet) ERC20("Divitest", "DIV") {
        ...
        dividendTracker = new DivitestDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        DivitestDividendTracker newDividendTracker = DivitestDividendTracker(payable(newAddress));
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        // require(_isExcludedFromFees[account] != excluded, "Divitest: Account is already the value of 'excluded'");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "Divitest: Automated market maker pair is already set to that value");
...
contract DivitestDividendTracker is Ownable, DividendPayingToken {
    using Address for address payable;
    ...
    constructor()  DividendPayingToken("Divitest_Dividen_Tracker", "Divitest_Dividend_Tracker") {}
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "Divitest_Dividend_Tracker: No transfers allowed");
    }
