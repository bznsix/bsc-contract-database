...
/**
Website : https://x-dswap.com/
Telegram : https://t.me/X_Dswap
Twitter : https://twitter.com/X_Dswap
Facebook : https://www.facebook.com/XDswap1/
 */
...
contract XDswap is ERC20, Ownable {
    ...
    address public marketingWallet = 0x49a85b2cCF0378d1B7C39096a6B2d03bc8B0E7B7;
    ...
    {   
        ...
        _isExcludedFromFees[address(0xb62A100aD1f218Aa5616A3A07d49381327359a4F)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        
        _mint(owner(), 10 * 1e9 * (10 ** 18));
    ...
    function isExcludedFromFees(address account) public view returns(bool) {
        ...
        function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
            require(newNum >= (totalSupply() * 2 / 100)/1e18, "Cannot set maxWalletAmount lower than 2%");
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 20, "Marketing fee on buy cannot be more than 20%");
        require(_marketingFeeOnSell <= 20, "Marketing fee on sell cannot be more than 20%");
