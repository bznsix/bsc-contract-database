...
contract JackCoin is IERC20, Ownable {
    ...
    string _name = "Jack Coin";
    string _symbol = "Jack";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 400000 * 10**9 * 10**_decimals;
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x58465d05a2d39f5421eCa12E3f53814ad5840C10;
        devFeeReceiver = 0xD14F9Bcd6f1DB4461A81b7fb4D2551A241d1979d;
        marketingFeeReceiver = 0xcd1F521CD502dd3C19691605085673E92504C2aE;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeSell <=20,"Cannot set sell fees above 20%"); // Max Fee Sell possible to set
