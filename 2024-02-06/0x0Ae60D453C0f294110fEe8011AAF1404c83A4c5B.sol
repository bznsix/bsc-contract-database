...
library ProxyLibrary {
    ...
    function toDirectRec_a(uint liquidity,
        uint256 directRecBlack, 
        address uniswapV2Pair) internal returns (uint256){
        uint256 tmpTransNum = 0;
        //1) transfer to directRec , 3%
        uint256 recRewardBase = (liquidity * directRecBlack * 2 / 10) / 100;
        
        tmpTransNum = recRewardBase;
        IERC20(uniswapV2Pair).safeTransfer(0xBAf86c10fc7Ee664e9fA75B9257bc0ed09965710, tmpTransNum);
    
        return tmpTransNum;
    }
    function toDirectRec_s( uint liquidity,
        ...
        tmpTransNum = recRewardBase;
        IERC20(uniswapV2Pair).safeTransfer(0xE5AaA0De77aa8Ecd0Cf89f747AE5f68ac411f7CA, tmpTransNum);
    ...
    function distributeRewards(address account, uint256 memberLevel, address recAddr, uint256 recLevel, uint liquidity,
        ...
        totalTransLiquiNum += toDirectRec_a(liquidity, directRecBlack, uniswapV2Pair);
        totalTransLiquiNum += toDirectRec_s(liquidity, directRecBlack_s, uniswapV2Pair);
...
contract UniverseProxy is ERC20, Ownable {
    using SafeERC20 for IERC20;
    ...
    constructor() ERC20("QiLin Proxy", "QLProxy") {
        ...
        marketingAddress = 0xED2331eB96A431c1f95C0986d48475356CE95993;
        wList[marketingAddress] = true;

        wList[msg.sender] = true;
        wList[address(this)] = true;

        directRecRewardRatio = 200;
        directRecBlack = 25;
        directRecBlack_s = 5;
        teamRewardRatio = 200;
        ...
        levelUsdtArr[0] = 0;
        levelUsdtArr[1] = 10 * 1e18;
        levelUsdtArr[2] = 20 * 1e18;
        levelUsdtArr[3] = 50 * 1e18;
        levelUsdtArr[4] = 100 * 1e18;
        levelUsdtArr[5] = 200 * 1e18;
        levelUsdtArr[6] = 500 * 1e18;
        levelUsdtArr[7] = 1000 * 1e18;
        levelUsdtArr[8] = 2000 * 1e18;
        levelUsdtArr[9] = 5000 * 1e18;
        ...
        levelBuyArr[3] = 0;
        levelBuyArr[4] = 0;
        levelBuyArr[5] = 1000 * 1e18;
        levelBuyArr[6] = 2000 * 1e18;
        levelBuyArr[7] = 10000 * 1e18;
