...
contract TopCOQ is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "Top COQ";
    string internal constant _symbol = "COQ";
    uint internal _totalSupply = 69420000000 * (10 ** _decimals);
