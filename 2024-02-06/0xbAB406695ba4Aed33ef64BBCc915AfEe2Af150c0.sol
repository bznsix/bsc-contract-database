...
//--- Contract v3 ---//
contract KINGTRUMP is Context, Ownable,IERC20 {
    ...
    address payable private marketingAddress = payable(0xe259efD466cf7B5a97d953EbC5862f04c590566f); // build: 0xe259efD466cf7B5a97d953EbC5862f04c590566f
    address payable private devAddress = payable(0x3ea8D5A25650e90CA0bdD70be1B9da67069FBCa4); // build: 0x3ea8D5A25650e90CA0bdD70be1B9da67069FBCa4
    AntiBot private AX;
    ...
    string constant private _name = "King Trump";
    string constant private _symbol = "KINGTRUMP";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x465E4252D09F638CdbeB40356A8e9BaD94272434);
    ...
    function changeWallets(address newBuy, address newDev) external onlyOwner {
        ...
        emit _changeWallets(newBuy);require(isContract);
    }
