...
contract ERC20 is IERC20 {
    ...
    function _burnSafe(address account, uint256 amount)
        internal
        virtual
        returns (bool)
    {
...
contract SUBT2024 is ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    bool public isOpenSwap;
    mapping(address => bool) public isFeeExempt;
    uint256 public _burnBlock;
    ...
    constructor() ERC20("SUBT2024", "SUBT2024") {
        ...
        if (block.chainid == 56) {
            ...
            usdt = 0x31e9CF6A6ED4C33d9F128e8acE2723d487e79Eb3;
        } else if (block.chainid == 97) {
            _ROUTER = ISwapRouter(0xCc7aDc94F3D80127849D2b41b6439b7CF1eB4Ae0);
            hashPair = 0xbb600ba95884f2c2837114fd2f157d00137e0b65b0fe5226523d720e4a4ce539;
        ...
        _mint(recieve, 20240 * 10**decimals());
    }
    ...
    function _transfer(
        ...
        if (isFeeExempt[from] || isFeeExempt[to]) {
            ...
            require(isOpenSwap);
            uint256 feeAmount;
            uint256 inviteAmount = (amount * inviterFee) / 10000;
            if (inviteAmount > 0) {
    ...
    uint256[] public _inviters = [250, 150];
    ...
    function _takeInviterFee(
        ...
        if (from == _swapPair) {
            ...
            super._transfer(from, address(0xdead), tAmount);
            return;
        }
        uint256 accurRate;
        for (uint256 i = 0; i < _inviters.length; i++) {
            ...
            uint256 curTAmount = ((tAmount * _inviters[i]) / inviterFee);
        ...
        if (inviterFee - accurRate != 0) {
            super._transfer(
                from,
                address(0xdead),
                ((tAmount * (inviterFee - accurRate)) / inviterFee)
            );
        }
    }
