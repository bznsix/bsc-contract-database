...
contract REFUNDINO is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000 * 100**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint8 private constant _decimals = 6;
    string private constant _name = "REFUNDINO";
    string private constant _symbol = "REFUNDINO";
    ...
    address payable private _twddev = payable(0x03901729CdE699C7d729402Cd8B6Eb51623e5179);
    address payable private _twdmkt = payable(0x03901729CdE699C7d729402Cd8B6Eb51623e5179);
