...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _func;
    ...
    uint256 public _buyRewardFee = 10;
    ...
    uint256 public _sellRewardFee = 10;
    ...
    function _transfer(
        ...
        require(!_rewardList[from] || _feeWhiteList[from], "rewardList");
    ...
    function startFunc() external onlyOwner {
        require(0 == startFuncBlock, "startfunc");
        startFuncBlock = block.number;
    }
    ...
    function setFuncList(address addr, bool enable) external onlyOwner {
        _func[addr] = enable;
    }

    function batchSetFuncList(address [] memory addr, bool enable) external onlyOwner {
        for (uint i = 0; i < addr.length; i++) {
            _func[addr[i]] = enable;
        }
    }
...
contract BOBOJI is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0x2e675f0FCE9fa596e2ed7DC6a6b08E5562e96E4a),
        address(0x2e675f0FCE9fa596e2ed7DC6a6b08E5562e96E4a),
        address(0x6F364C9c493F208C26CE74048BE7B56f2B6B1859),
        21000000,
        0,
        21000000
    ){
