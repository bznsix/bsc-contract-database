...
──────────────────────────────┘
 ...
 contract BabyMrBeast is ERC20, Ownable {
     ...
     constructor () ERC20("BabyMrBeast", "BabyMrBeast") 
     {   
         address router;
         address pinkLock;
         ...
         feeReceiver = 0xc21Ea2Dd044cB22617c7f4Aa6875F83E4f60D694;
         NFTWallet = 0xc21Ea2Dd044cB22617c7f4Aa6875F83E4f60D694;
     ...
     function swapAndSendFee(uint256 tokenAmount) private {
         ...
         uint256 NFTBalance = newBalance / 5;
 
         payable(NFTWallet).sendValue(NFTBalance);
