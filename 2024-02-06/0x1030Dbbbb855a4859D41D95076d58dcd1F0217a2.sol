...
contract GAMERFI is ERC20, Ownable {
    ...
    constructor () ERC20("GamerFI", "GAMERFI") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xCA95d0d784eA147e04640bcb45A9F1b46f34dcb0);
        ...
        feeReceiver = 0x1A9b67d10909DEE86960097A82BF39f8Ad7021Ed;
        buybackWallet = 0xe2d1Fdd277B63a1864Cd6032458fB8F2cD303B87;
        ...
        _mintOnce(owner(), 1e8 * (10 ** decimals()));
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        uint256 oneThird = newBalance / 3;

        payable(buybackWallet).sendValue(oneThird);
