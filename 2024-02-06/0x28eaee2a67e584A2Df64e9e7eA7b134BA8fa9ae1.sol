...
contract BB is Context, IERC20, Ownable {
    ...
    string private _name = "BabyBurns";
    string private _symbol = "BabyBurns";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe8334A8363FE9896989532f172898399150f8eA5); // Marketing Address
    address payable private teamWalletAddress = payable(0xe8334A8363FE9896989532f172898399150f8eA5); // Team Address
