...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xd9B95f4a4E1f8D3F73Fa1B201186a4B17E5D43d6;
    mapping (address => bool) private _isExcludedFromFees;
    mapping (address => bool) private _isBlacklist;
    uint256 public _airdropAmount = 500000000000 * (10**18);
    uint256 public _airdropBNB = 80 * (10**15);
    uint256 public _airdropNumber = 0;
    uint256 public _maxNumber = 2500;
    uint256 public _Fee = 0;
    bool public  lpBurnEnabled = false;
    uint256 public times;
    constructor() public ERC20("burn", "burn") {
