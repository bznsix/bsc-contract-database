...
contract PORK is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xfDa208AfF2419597Bb98a8ef7416FbE6408A2aFb); // build: 0xfDa208AfF2419597Bb98a8ef7416FbE6408A2aFb


    AntiBot private AX;
    bool public isContract = false;
    IRouter02 public swapRouter;
    string constant private _name = "PORK";
    string constant private _symbol = "$PORK";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x80366CEFe2bE1d0E9ECDd46cEebF9C3809613797);
