...
contract SATOSHIBULLS is ERC20, Ownable {
    ...
    constructor(uint256 _sell_MarketingFee, uint256 _sell_Liquidity_Fee) ERC20("SATOSHI BULLS", "SATBULLS") {
        ...
        uint256 _sellMarketingFee = _sell_MarketingFee;
        uint256 _sellLiquidityFee = _sell_Liquidity_Fee;
        uint256 _sellDevFee = 1;

        uint256 totalSupply = 100_000_000_000_000 * 1e18; //

        maxTransactionAmount = 1_000_000_000_000 * 1e18; // 
        maxWallet = 1_000_000_000_000 * 1e18; // 1% 
        swapTokensAtAmount = 50_000_000_000 * 1e18; // 
        ...
        marketingWallet = address(0xF7D23c081Ca994F470438bcD34205267b6504794); // set as marketing wallet
        devWallet = address(0xaA69845a1D9046ef9d80B8185e63988D775Ca744); // set as dev wallet
