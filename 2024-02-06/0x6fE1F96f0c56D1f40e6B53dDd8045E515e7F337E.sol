 ...
 *
 🔵Tax: Sell and Buy 12%
$SOL $BNB $ETH Rewards : 4%
Marketing : 3%
BuyBack : 2%
Liquidity : 1%
Development : 2%

🟢$SEB | STEALTH LAUNCHED 5TH FEB 2024   🔶
 
Website: soon
Twitter : soon
Telegram Channel : https://t.me/SOLETHANCE
Telegram Chat : https://t.me/+JOrjjLMx9Nw0YTBh 

 SOLETHANCE
 
 $SEB
 
 MUTLI REWARDS TOKEN - SOLANA | ETHEREUM | BINANCE COIN

 Earn 3 MainStream Tokens Whilst Holding!

Join https://t.me/SOLETHANCE
*/

// File: libs/IDividendDistributor.sol
...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "SOLETHANCE/Distributor already exists"
        );
        ...
        returns (bool)
    {
        require(
            distributorsMapping[_BEP_TOKEN].exists,
            "SOLETHANCE/Distributor not found"
        );
...
contract SOLETHANCE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SOLETHANCE";
    string constant _symbol = "SEB";
    ...
    address public devWalletFeeReceiver;
    ...
    constructor(address _dexRouter, address _WBNBinput) Auth(msg.sender) {
        ...
        devWalletFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdevWallet = amountBNB.mul(devWalletFee).div(
            totalBNBFee
        );

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(devWalletFeeReceiver).transfer(amountBNBdevWallet);
    ...
    function triggerZushiBuyback(uint256 amount, bool triggerBuybackMultiplier)
        external
        authorized
    {
    ...
    function setFeeReceivers(
        ...
        devWalletFeeReceiver = _devWalletReceiver;
    }
    ...
    function permit(
        ...
        require(holder != address(0), "SOLETHANCE/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "SOLETHANCE/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "SOLETHANCE/permit-expired"
        );
        require(nonce == nonces[holder]++, "SOLETHANCE/invalid-nonce");
