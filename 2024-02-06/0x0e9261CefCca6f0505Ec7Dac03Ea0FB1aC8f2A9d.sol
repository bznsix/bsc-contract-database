...
contract NFT is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    mapping(address => uint256) public isMinted;
    ...
    uint256[] public MAX_SUPPLY = [0, 2000, 2000, 2000];
    ...
    function setSingleAmount(uint256 number) external onlyOwner {
        singleAmount = number;
    }
    ...
    function mint(
        ...
        require(token.balanceOf(address(this)) >= singleAmount, "Droped out");

        token.transfer(msg.sender, singleAmount);
