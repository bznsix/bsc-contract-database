...
contract WHITEDRAGON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3397AB0F6D6650Bad3d2210291768baa851f4059); 
    address payable public Wallet_Dev = payable(0x695e24eEeB1B53AbE1704D1FBdE7a793CfbC31C7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "WHITE DRAGON"; 
    ...
    constructor () {
        _owner = 0x695e24eEeB1B53AbE1704D1FBdE7a793CfbC31C7;
