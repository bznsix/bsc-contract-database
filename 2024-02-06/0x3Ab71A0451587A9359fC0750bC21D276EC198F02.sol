...
/**
---------------------------------------------------------------------------------------------------
 Contract Developed by Anoop [Developed over 350+ contracts]: 
 https://t.me/AnoopSafuDeveloper
...
contract InfiCloud is Context, IERC20, Ownable {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    uint8 private  constant _decimals = 9;
    uint256 private  constant _tTotal = 1e10 * 10**_decimals;
    string private  constant _name = "InfiCloud";
    string private  constant _symbol = "InfiCloud";
  ...
  function addExcludeFee(address _address) external onlyOwner {
   ...
   function ClearStuckBEP20(address _tokenAddy, uint256 _amount) external onlyOwner {
