...
//--- Contract v3 ---//
contract BSCWIF is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xA726807E2a712998c7894150327A5B4C5f6b45b4); // build: 0xA726807E2a712998c7894150327A5B4C5f6b45b4
    address payable private devWallet = payable(0xA726807E2a712998c7894150327A5B4C5f6b45b4); // build: 0xA726807E2a712998c7894150327A5B4C5f6b45b4


//--- v3 Allocations by DOGWIFHAT https://dogwifhat.website ---//
    ...
    string constant private _name = "DOGWIFHAT";
    string constant private _symbol = "DOGWIFHAT";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"DOGWIFHAT: Must equals to 100%");
    ...
    function changeWallets(address newBuy, address newDev) external onlyOwner {
        require(newBuy != address(0),"DOGWIFHAT: Address Zero");
        require(newDev != address(0),"DOGWIFHAT: Address Zero");
