...
contract BABYBINANCE is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Binance", "BABYBINANCE") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x049d5cB9a6F5c8635A74F961770460688Df06510);
        ...
        feeReceiver = 0x34cBd0b04C7bd6B22273d978da7B22dB31A34A2e;
        ...
        _mintOnce(owner(), 420e15 * (10 ** decimals()));
