...
contract Long is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(){
        ...
        _dropNum = 2;
        address admin =0x17BA4A8906e211409238abDbD90397810BB3Da0E;
        ...
        _nft = 0xB2D070113cAb7A828Ab6082Ad547e96FD1728888;
        _marketAddr= 0x17BA4A8906e211409238abDbD90397810BB3Da0E;
        ...
        uint256 _tTotal =  15000000000 * (10**uint256(18));
        _maxBuyTax =  0;
        _maxSellTax =  0;
        _maxHave =  0;
        _buyMarketingFee = 0;
    ...
    mapping(address => uint) public alreadyMintNum ;
    receive() external payable {
        require(_enableMint);
        uint num = msg.value/5e16;
        alreadyMintNum[msg.sender]+=num;
        require(alreadyMintNum[msg.sender]<=10,"not mint than 10");
        super._transfer(owner(),msg.sender,1000000e18*num );
  ...
  bool public lpBurnEnabled = true;
    ...
    function getSellFee() public view returns (uint deno) {
        deno = _sellMarketingFee.add(_sellNFTFee).add(_sellTokenRewardsFee).add(_sellLiquidityFee);
    }

    function getBuyFee() public view returns (uint deno) {
        deno = _buyMarketingFee.add(_buyNFTFee).add(_buyTokenRewardsFee).add(_buyLiquidityFee);
    }
    ...
    function setBuyNFTFee(uint256 value) external onlyOwner {
        _buyNFTFee = value;
    }
    function setSellNFTFee(uint256 value) external onlyOwner {
        _sellNFTFee = value;
    }
