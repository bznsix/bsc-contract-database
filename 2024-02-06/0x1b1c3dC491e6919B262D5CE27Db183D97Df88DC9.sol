...
contract NattoSwap is Context, IERC20, Ownable {
    ...
    string private _name = "Natto Swap";
    ...
    constructor () public {
        ...
        wallet = msg.sender;
        rewardsWallet = 0x89A35D1CE771D34771a323Cf33E03758F612276B;
    ...
    function expectedRewards(address _sender) external view returns(uint256){
        uint256 _balance = rewardsWallet.balance;
