...
Telegram: https://t.me/FUCK_SOLANA_BSC

Welcome

I’ve hacked Solana chain.
That’s the only way I can bring back our chads to BSC.
...
contract FuckYouSolana is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fuck You Solana";
    string private _symbol = "$FuckUSolana";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5c487ED2D50Fb8fF0ebfC3E4622Ed27f5645583); // Marketing Address
    address payable public teamWalletAddress = payable(0xa5c487ED2D50Fb8fF0ebfC3E4622Ed27f5645583); // Team Address
