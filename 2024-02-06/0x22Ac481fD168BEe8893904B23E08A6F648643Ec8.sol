...
contract LIGHTSPEEDCAT is Context, IERC20 {   

    // Contract Wallets
    address private _owner = payable (0x39499a6453228B09C8281E9510aAbBB876255625);
    ...
    // Token Info
    string private constant  _name = "Light Speed Cat";
    string private constant  _symbol = "LSCat";

    uint256 private constant _decimals = 9;
    uint256 private _tTotal = 110_000_000 * 10**_decimals;
