...
// File contracts/distribution/BShareRewardPool.sol
...
contract BShareRewardPool {
    ...
    uint256 public tSharePerSecond = 0.000964506 ether; // 15000 b2share / (180 days * 24h * 60min * 60s)
    uint256 public runningTime = 180 days; // 370 days
    uint256 public constant TOTAL_REWARDS = 15000 ether;
