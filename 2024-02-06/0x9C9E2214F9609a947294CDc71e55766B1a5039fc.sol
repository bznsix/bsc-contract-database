/*
 ___    ___    ___   _  _     _  _     _   __   __ _  _  
) __(  )_ _(  (  _( ) () (   ) () (   )_\  ) (_) () |) / 
| _)   _| |_  _) \  | -- |   | -- |  /( )\ \  _  /| ( (  
)_(   )_____()____) )_()_(   )_()_( )_/ \_( )/ \( )_|)_\ 
１００％ ＬＰ ＬＯＣＫ ＦＯＲＥＶＥＲ － ＦＲＯＭ ＨＯＮＥＳＴ ＤＥＶＥＬＯＰＥＲ ＴＯ ＳＭＡＲＴ ＴＲＡＤＥＲＳ

Do Your Own Research (DYOR) | BEFORE BUYING ANY BSC TOKEN 
...
contract FishHawk is IBEP20 {
    ...
    string public override name = "Fish Hawk";
    string public override symbol = "SHAWK";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 8 / 100;
