...
\ \/\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ `'\ \/ /
 ...
 / /\                                                                                    / /\ 
/ /\ \ __        __   _                            _           ____           _         / /\ \
\ \/ / \ \      / /__| | ___ ___  _ __ ___   ___  | |_ ___    / ___|_ __ ___ | | _____  \ \/ /
 \/ /   \ \ /\ / / _ \ |/ __/ _ \| '_ ` _ \ / _ \ | __/ _ \  | |  _| '__/ _ \| |/ / __|  \/ / 
 / /\    \ V  V /  __/ | (_| (_) | | | | | |  __/ | || (_) | | |_| | | | (_) |   <\__ \  / /\ 
/ /\ \  _ \_/\_/ \___|_|\___\___/|_| |_| |_|\___|  \__\___/  _\____|_|  \___/|_|\_\___/ / /\ \
\ \/ / | |    __ _| |__   ___  _ __ __ _| |_ ___  _ __ _   _| |                         \ \/ /
 \/ /  | |   / _` | '_ \ / _ \| '__/ _` | __/ _ \| '__| | | | |                          \/ / 
 / /\  | |__| (_| | |_) | (_) | | | (_| | || (_) | |  | |_| |_|                          / /\ 
/ /\ \ |_____\__,_|_.__/ \___/|_|  \__,_|\__\___/|_|   \__, (_)                         / /\ \
\ \/ /                                                 |___/                            \ \/ /
 \/ /                                                                                    \/ / 
 / /\.--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--..--./ /\ 
/ /\ \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \.. \/\ \
...
/*
  ...
  network: BNB
               ...
               TAX's
  ON BUY: 2% Auto Liquidity -3 % Marketing
  ON SELL: 5% Auto Liquidity - 5% Marketing

               SOCIAL LINKS
 
  Website ------> : https://GrokLabs.vercel.app/
  Telegram ----->: https://t.me/GrokLabsOfficial
  NFTs -----> : https://opensea.io/GroksLaboratory
  Twitter -----> : https://twitter.com/GrokLabsOffical


  Verify | 
  Doxxed Developer -----> : https://t.me/GrokLabsDev
...
contract GroksLaboratory is ERC20, Ownable {
    ...
    constructor () ERC20("Groks Laboratory", "GrokLabs") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x4ae6193c29651318E7220e66142a433Cc8c5f698; // Marketing Wallet
        ...
        _isExcludedFromFees[pinkLock] = true;
         ...
         _mintOnce(owner(), 1e6 * (10 ** decimals())); // 1 million tokens total supply minted
               swapTokensAtAmount = totalSupply() / 10_000_000_000; // Set threshold to 0.0000001% of total supply
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy) external onlyOwner {
        ...
        require(feeOnSell <= 10, "CSLT: Total Fees cannot exceed the maximum");
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 10_000_000_000, "CSLT: SwapTokensAtAmount must be greater than 0.0000001% of total supply");
