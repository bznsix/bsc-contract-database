...
contract GOLDENJACKPOT is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOLDEN JACKPOT";
    string private constant _symbol = "$JACKPOT";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xb649bb98E3F6E3139c1B0a06B3B6bA2F3BFE8A05);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xff248eb7A1B1AD3bFDC4B530F617F501F9528c2a] = true;
