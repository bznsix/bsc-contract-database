...
contract RoboBonk is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 5;
    uint256 public marketingFeeOnSell = 5;

    address public marketingWallet = 0x0a837E0F8E4751E2A78E39935A2498CE5973F9d2;
    ...
    constructor () ERC20("RoboBonk", "RoboBonk") 
    {   
        ...
        _mint(owner(), 420000000 * 1e6 * (10 ** 18));
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 10, "Marketing fee on buy cannot be more than 10%");
        require(_marketingFeeOnSell <= 10, "Marketing fee on sell cannot be more than 10%");
