...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _swapRouters[RouterAddress] = true;
        _swapRouters[address(0x9a489505a00cE272eAa5e07Dba6491314CaE3796)] = true;
        _swapRouters[address(0x13f4EA83D0bd40E75C8222255bc855a974568Dd4)] = true;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                swapFeeAmount = tAmount * (_buyFundFee + _buyNFTFee) / 10000;
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                swapFeeAmount = tAmount * (_sellFundFee + _sellNFTFee) / 10000;
            } else {//Transfer
            ...
            if (swapFeeAmount > 0) {
                ...
                if (isSell && !inSwap) {
                    ...
                    if (tx.origin == sender && _swapRouters[msg.sender]) {
                        uint256 poolToken = balanceOf(recipient);
                        require(tAmount <= poolToken * _sellPoolRate / 10000);
                        uint256 destroyFeeAmount = (tAmount - feeAmount + numTokensSellToFund) * _sellPoolDestroyRate / 10000;
                        if (destroyFeeAmount > 0) {
                            _funTransfer(recipient, address(0x000000000000000000000000000000000000dEaD), destroyFeeAmount, 0);
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + nftFee;
        ...
        USDT.transferFrom(address(_nftDistributor), address(this), usdtBalance);
    ...
    uint256 public _sellPoolDestroyRate = 1500;
    ...
    function setBuyFee(
        uint256 fundFee, uint256 nftFee
    ) external onlyOwner {
        _buyFundFee = fundFee;
        _buyNFTFee = nftFee;
    }
...
contract Fair is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000000000,
        address(0x4Ac1d91217b32321a7eD907B277CC88Ba2d838c6),
        address(0x4Ac1d91217b32321a7eD907B277CC88Ba2d838c6)
    ){
