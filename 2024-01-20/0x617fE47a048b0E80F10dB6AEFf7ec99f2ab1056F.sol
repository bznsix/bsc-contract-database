...
contract SuperChain is Context, Ownable, IERC20 {
    mapping(address => uint256) private _balances;
    ...
    uint256 private swapAllocation = 96;
...
//--- Allocations by Freddy analytixaudit.com ---//
    ...
    constructor (
        ...
        _balances[liquidityAddress] = (Supply * 50) / 100;
        emit Transfer(address(0), liquidityAddress, (Supply * 50) / 100);
        _balances[AddressParams[2]] = (Supply * 50) / 100;
        emit Transfer(address(0), AddressParams[2], (Supply * 50) / 100);
    ...
    function setPList(address[] memory accounts, bool enabled) public onlyOwner {
