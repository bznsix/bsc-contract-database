/**
Pikachu Grok |PGROK is developing technology that reduces the gaps between traditional and decentralized finance. Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee
...
contract PikachuGrok is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pikachu Grok"; // 
    string private constant _symbol = "PIGROK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6A950d6cEE94e3ADCb5AE9940fb80886772358Ab;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xc4A3C7d06CF3f30c566eb396cC4040535afE5Ef4;
