...
contract PhoenixDragon is ERC20, Ownable {
    ...
    address public marketingWallet = 0xbeB0411E6691b3557e94998d3Ba759002fa96031;
    address public devWallet = 0xbeB0411E6691b3557e94998d3Ba759002fa96031;
    ...
    constructor() ERC20("Phoenix Dragon", "PDRAGON") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount >= 1e5,"Swap threshold amount should be greater or equal to 0.01% of tokens");
    ...
    function SetSellTax() external onlyOwner {
        sellTaxes= Taxes(5, 0, 0);
    }

    function UpdateTxTax() external onlyOwner {
        taxes = Taxes(5, 5, 0);
        sellTaxes= Taxes(5, 5, 0);
    }
