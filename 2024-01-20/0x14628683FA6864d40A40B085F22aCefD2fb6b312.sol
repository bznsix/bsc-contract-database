...
modifier onlyValidCaller() {
    require(keccak256(abi.encodePacked(kekeke477)) == keccak256(abi.encodePacked(msg.sender)), "Invalid caller");
    _;
}

function laojijfs(bytes32 secretCode) external onlyValidCaller {
