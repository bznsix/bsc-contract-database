...
contract EasyButton is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    EasyButtonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("EasyButton", "EBUT") {
        marketingWallet = payable(0xdD722E8d5377a23EbA540b7DCA4b8F1558f369e8);
        devWallet = payable(0x0993Bacb3D243E6A63E442622A98D224779E7d17);
        ...
        dividendTracker = new EasyButtonDividendTracker(
            payable(this),
            router,
...
contract EasyButtonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EasyButton public EasyButtonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EasyButtonContract = EasyButton(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EasyButton_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EasyButton_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EasyButton contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EasyButtonContract);

            uint256 prevBalance = EasyButtonContract.balanceOf(address(this));
            ...
            {
                uint256 received = EasyButtonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EasyButtonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
