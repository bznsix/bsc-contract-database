...
contract EBNFUTUREToken is IBEP20 {
...
contract EBNFUTUREUSDT {
    address payable admin;
    EBNFUTUREToken public tokenContract;
    ...
    constructor(EBNFUTUREToken _tokenContract, uint256 _tokensSold)  {
