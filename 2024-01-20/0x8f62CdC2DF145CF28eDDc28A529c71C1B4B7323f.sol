 ...
 *Submitted for verification at BscScan.com on 2023-12-04
 https://dailyminer.xyz/
 *
    Dailyminer is
    is an NFT game that comes in Click To Earn and works on the BNB Smart Chain investors can buy miners to search for DICOIN ore while making money.
...
$$ |  $$ |$$  __$$ |$$ |$$ |$$ |  $$ |$$ | $$ | $$ |$$ |$$ |  $$ |$$   ____|$$ |      
$$$$$$$  |\$$$$$$$ |$$ |$$ |\$$$$$$$ |$$ | $$ | $$ |$$ |$$ |  $$ |\$$$$$$$\ $$ |      
\_______/  \_______|\__|\__| \____$$ |\__| \__| \__|\__|\__|  \__| \_______|\__|      
                            $$\   $$ |                                                
                            \$$$$$$  |                                                
                             \______/       
https://dailyminer.xyz/
...
contract DICOIN is ERC20, Ownable {
    ...
    // TOKENOMICS START
    string private _name = "Dailyminer Coin";
    string private _symbol = "DICOIN";
    uint8 private _decimals = 18;
    uint256 private _supply = 100_000_000_000;
    uint256 public taxBuyForLiquidity = 0;
    uint256 public taxBuyForMarketing = 1;
    uint256 public taxSellForLiquidity = 0;
    uint256 public taxSellForMarketing = 90;
    uint256 public maxTxAmount = 2_000_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 2_000_000_000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 200_000_000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 200_000_000 * 10**_decimals;
    address public marketingWallet = 0xB148920a3Ca70f88a2908193beD30Ecbd96958B6;
    // TOKENOMICS END
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxBuyForLiquidity, uint256 _taxBuyForMarketing, uint256 _taxSellForLiquidity, uint256 _taxSellForMarketing)
        ...
        returns (bool)
    {
        require((_taxBuyForLiquidity+_taxBuyForMarketing) <= 99, "ERC20: total tax must not be greater than 20");
        require((_taxSellForLiquidity+_taxSellForMarketing) <= 99, "ERC20: total tax must not be greater than 20");
    ...
    function changeMaxTxAmount(uint256 _maxTxAmount)
        ...
        returns (bool)
    {
        require(_maxTxAmount >= 100_000_000, "ERC20: maxTxAmount must not be less than 0.1% total supply");
    ...
    function changeMaxWalletAmount(uint256 _maxWalletAmount)
        ...
        returns (bool)
    {
        require(_maxWalletAmount >= 100_000_000, "ERC20: maxWalletAmount must not be less than 0.1% total supply");
