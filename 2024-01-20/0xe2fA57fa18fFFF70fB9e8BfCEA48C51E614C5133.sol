...
contract BobaInu is IERC20, Ownable {
    ...
    string private _name = "Boba Inu";
    string private _symbol = "BONU";
    uint8 private _decimals = 18;
    
    address payable public marketingWalletAddress = payable(0xbD0Ae173AD1D9a9E1E2F5fcCDc822a5D7c3116cD); // Marketing Address
    address payable public teamWalletAddress = payable(0xbD0Ae173AD1D9a9E1E2F5fcCDc822a5D7c3116cD); // Team Address
    ...
    uint256 public _maxTxAmount =   1000000000000000000000000 * 10**_decimals;     
    uint256 public _walletMax =     2000000000000000000000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 100000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
