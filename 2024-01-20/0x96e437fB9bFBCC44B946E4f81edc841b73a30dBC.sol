// Official Telegram Chat: https://t.me/BabyGrokswap
// Official Twitter Handle: https://x.com/BabyGrokSwap
...
contract BabyGrokSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Baby Grok Swap";
    string private _symbol = unicode"BGS";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC2cFdc69AC8A2C335D06e47Ab1BF005B587249fA);
    address payable private taxWallet2 = payable(0xC2cFdc69AC8A2C335D06e47Ab1BF005B587249fA);
