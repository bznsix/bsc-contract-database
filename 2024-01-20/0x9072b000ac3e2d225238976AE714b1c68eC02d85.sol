/**
 *Telegram https://t.me/eig_bsc
 Twitter https://x.com/eig_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEC064A15d18Cd77f13eD3D14F380aa33857e1b89; // owner address
...
contract EIG is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "EIG";
    string private _symbol = "EIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEC064A15d18Cd77f13eD3D14F380aa33857e1b89);
    address payable public teamWalletAddress = payable(0xEC064A15d18Cd77f13eD3D14F380aa33857e1b89);
