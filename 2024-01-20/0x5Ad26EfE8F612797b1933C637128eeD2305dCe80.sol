...
contract BORKCoin is Context, IBEP20, Ownable {	
    ...
    uint public _lottoDrawCount = 0;
   	...
   	uint256 private _minLottoBalance = 3000000000 * 10**9;
    ...
    uint256 private numTokensSellToAddToLiquidity = 200 * 10**9 * 10**9;	
    uint256 public lotteryThreshold = 10000000000 * 10**9;	
    // anti whale
    bool    public _isAntiWhaleEnabled = false;
    uint256 public _antiWhaleThreshold = 100000000000000 * 10**9;
