...
contract BabyIce is ERC20, Ownable {
    ...
    constructor() payable ERC20("Baby Ice", "$BICE") {
        ...
        marketingWallet = 0xF34F62c962a6C98571E7A2A31C4dc06dC216Ee29;

        dividendTracker = new DividendTracker(33 * 10**5, rewardToken);
