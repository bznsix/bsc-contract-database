...
contract BABYBONKGROK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Bonk Grok"; // 
    string private constant _symbol = unicode"$BBGROK";  //    
