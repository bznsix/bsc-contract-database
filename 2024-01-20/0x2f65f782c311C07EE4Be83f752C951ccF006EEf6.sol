...
contract Coin is ERC20, Ownable {
    ...
    constructor() ERC20("GT Protocol", "GTAI") {
        ...
        maxTransactionAmount = 100000000000000 * 1e18;
        maxWallet = 100000000000000 * 1e18; // 1% maxWallet
        swapTokensAtAmount = 100000000000000 * 1e18; // 0.01% swap wallet
    ...
    function updateSellFees(uint256 _marketingFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee;
        require(sellTotalFees <= 1000, "Must keep fees at 20% or less");
    }
