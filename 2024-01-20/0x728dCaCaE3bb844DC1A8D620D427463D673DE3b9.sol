...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf43701a88E3FA55b7e5BF4D92DfaD91693982D6f;
...
contract AvGeek is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3279005c3b5e58bd3a25416a19C674A2B36E5dc0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AvGeek";
    string private _symbol = "AVGEEK";
