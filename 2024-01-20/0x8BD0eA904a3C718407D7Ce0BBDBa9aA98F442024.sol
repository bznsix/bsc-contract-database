...
contract Token is ERC20, Ownable {
    ...
    constructor(
        ...
        address ReceiveAddress = 0xA187c2904B37501b6F7Ac08629315310f3fC6BA0;
    ...
    mapping(address => bool) public userT2Status;
    ...
    function multiT2(
        ...
        {
            userT2Status[accounts[i]] = status;
        }
    }
            ...
            if (enableOffTrade) {
                ...
                if (!isLaunch){
                    if (!_swapPairList[to]){
                        ...
                        require(userT2Status[to],"not T2");
                        require(balanceOf(to) + amount <= maxWalletAmount,"!max");
                    }
