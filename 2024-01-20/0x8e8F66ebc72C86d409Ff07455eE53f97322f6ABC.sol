...
contract UnityMetaToken is Context, IBEP20, Ownable {
  ...
  constructor()  {
        _name = 'entertainment coin';
        _symbol = 'ENC';   
        _decimals = 18;
		_totalSupply = 100000000 * 10 ** _decimals;
        _maxBurning = 36000000 * 10 ** _decimals; 
        maxBuyLimit = 10000000 * 10 ** _decimals; 
        maxSellLimit = 10000000 * 10 ** _decimals; 
        maxWalletLimit = 10000000 * 10 ** _decimals; 
