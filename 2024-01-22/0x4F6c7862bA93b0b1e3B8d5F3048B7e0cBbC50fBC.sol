...
contract SwitchContractCallStargateSender is Switch {
        ...
        nonReentrant
    {
        ...
        uint256 amountAfterFee = _getAmountAfterFee(IERC20(callArgs.srcSwap.srcToken), callArgs.amount, callArgs.partner, callArgs.partnerFeeRate);
        ...
        require(returnAmount >= callArgs.minSrcReturn, 'The return amount is too small');
