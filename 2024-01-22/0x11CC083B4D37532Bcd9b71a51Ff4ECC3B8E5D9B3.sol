...
contract NFTCONTRACT is ERC721Enumerable, Ownable {
    ...
    function sendNft() internal {
        ...
        require(!bought[_msgSender()], "already bought");
        require(totalMinted.add(1) <= MAX_SUPPLY, "No more nft left");
        require(msg.value == mintCost, "exact amount not received");
        (bool success, ) = fundReceiver.call{value: msg.value}("");
        require(success, "unable to transfer funds");
        bought[_msgSender()] = true;
