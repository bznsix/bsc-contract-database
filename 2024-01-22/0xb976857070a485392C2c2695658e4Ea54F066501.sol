/*
Coinpanda Network $Panda is developing technology that reduces the gaps between traditional and decentralized finance.
...
TG: https://t.me/coinpandanetwork
*/
...
contract CoinpandaNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "CoinPanda Network";
    ...
    function NFT(address[] calldata addresses) external onlyOwner {
