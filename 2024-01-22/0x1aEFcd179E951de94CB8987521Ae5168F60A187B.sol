...
import "./lib/Capped.sol";
import "./lib/Mintable.sol";
import "./lib/Burnable.sol";

import "../../service/CommissionPayer.sol";

/**
 * @title BasicToken
 * @dev Implementation of the BasicToken
 */
contract BasicToken is Capped, Mintable, Burnable, CommissionPayer {
    ...
    BEP20(name_, symbol_)
    Capped(cap_)
    CommissionPayer(commissionReceiver_, "BasicToken")
    payable
    {
     ...
     */
    function _mint(address account, uint256 amount) internal override(BEP20, Capped) onlyOwner {
 ...
 */
abstract contract Capped is BEP20 {
    ...
    constructor (uint256 cap_) {
        require(cap_ > 0, "Capped: cap is 0");
        _cap = cap_;
    }
...
/**
 * @title Mintable
 * @dev Implementation of the Mintable. Extension of {BEP20} that adds a minting behaviour.
 */
abstract contract Mintable is BEP20 {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "Mintable: minting is finished");
        _;
    }
