...
contract MintReqWojakV1 is Ownable {
    ...
    uint public priceBUSD = 500000000000000000000;
    uint public priceWUSD = 1000000000000;
    uint public priceEveryNFT = 1500;
    ...
    function mintReqOptional(uint _nftCount,uint _busd , uint _wusd) public {
        ...
        if (_busd > 0) {
            ...
            require(BUSDToken.balanceOf(msg.sender) >= _busd*10**18, "Insufficient USDT balance");
