...
//--- Contract v3 ---//
contract COSMOS is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x0Cf4881aCBBa5ec18844fdD1FBF45061B9BC6632); // build: 0x0Cf4881aCBBa5ec18844fdD1FBF45061B9BC6632
    

//--- v3 Allocations by Freddy analytixaudit.com ---//
    uint256 private buyAllocation = 48;
    uint256 private sellAllocation = 48;
    uint256 private liquidityAllocation = 4;


    IRouter02 public swapRouter;
    string constant private _name = "COSMOS";
    string constant private _symbol = "COSMOS";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0x53d617091Aebb21E0452B453e7ECd4906c951756;
    address constant private presaleAddress = 0x9b6dD50Fa9c00ddaFF1EcB8cf4dc2D48E68AeD7F;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 55) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 55) / 100);
        balance[presaleAddress] = (_totalSupply * 45) / 100;
        emit Transfer(address(0), presaleAddress, (_totalSupply * 45) / 100);
