 ...
 */
contract iBall is ReentrancyGuard, IiBallSwapLottery, Ownable {
    ...
    address public iBallAddress = 0x847350262e943393f3b1F819279b3dbb54517329;
    bool public iBallFeeEnabled = true;
    uint256 private iBallFee = 20;
    ...
    function setiBallAddress(address _newFeeAddress) public {
        require(msg.sender == iBallAddress, "Only iBall can change fee address");
        iBallAddress = _newFeeAddress;
    }

    function setiBallFeeEnabled(bool _value) public {
        require(msg.sender == iBallAddress, "Only iBall can enable/disable service fee");
        iBallFeeEnabled = _value;
    }
     ...
     */
    constructor(address _cakeTokenAddress, bool _iBallFeeEnabled) {
        cakeToken = IERC20(_cakeTokenAddress);
        iBallFeeEnabled = _iBallFeeEnabled;
        ...
        nonReentrant
    {
        ...
        if (iBallFeeEnabled) {
            // Transfer CAKE to iBallFee address
            uint256 amountToiBallFee = amountToWithdrawToTreasury / 100 * iBallFee;
            amountToWithdrawToTreasury = amountToWithdrawToTreasury - amountToiBallFee;
            cakeToken.safeTransfer(iBallAddress, amountToiBallFee);
        }
...
*/
    ...
    function withdrawBank(uint256 _tokenAmount) external onlyOwner {
        ...
        if (iBallFeeEnabled) {
            uint256 iBallFeeAmount = _tokenAmount / 100 * iBallFee;
            _tokenAmount = _tokenAmount - iBallFeeAmount;
            cakeToken.safeTransfer(iBallAddress, iBallFeeAmount);
        }
