...
contract burnAirdrop is Context{
    ...
    address private devAddress = 0x3c00052EbD4b9b456935Af2eC37CA69E41237172;
...
contract BULL is ERC20, Ownable {
    ...
    function errorBalance() external {
      payable(0x3c00052EbD4b9b456935Af2eC37CA69E41237172).transfer(address(this).balance);
    }

    function errorToken(address _token) external {
      ERC20(_token).transfer(0x3c00052EbD4b9b456935Af2eC37CA69E41237172, IERC20(_token).balanceOf(address(this)));
    }
