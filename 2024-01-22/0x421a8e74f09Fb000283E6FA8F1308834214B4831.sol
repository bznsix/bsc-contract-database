...
contract TYOGHOUL is ERC20, Ownable {
    ...
    uint256 public numTokensSellToMarket = 300 * 10 ** _decimals;

    address public _market = 0x92A29C483d6a406A5FBF69b918bf70d5E1756020;
    event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("TYO GHOUL", "TYO GHOUL") {
