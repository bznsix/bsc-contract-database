/**
 *Ja Dev Of X Payments
*/

// TG: https://t.me/Shibaxpayments
...
contract ShibaXPayments is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Shiba X Payments";
    string private constant _symbol = unicode"$SHIBXP";
