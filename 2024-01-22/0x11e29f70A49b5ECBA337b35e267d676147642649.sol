...
contract FluxioContract is Ownable {
    ...
    uint256 constant public ADVERTISING_FEE = 500;
    ...
    function invest(address referrer, uint256 _amount, address _to, bool _partner) public payable {
        ...
        if(!_partner) {
            ...
            uint256 marketingFee = investAmount.mul(ADVERTISING_FEE).div(PERCENTS_DIVIDER);
            uint256 promotionFee = investAmount.mul(ADVERTISING_FEE).div(PERCENTS_DIVIDER);
