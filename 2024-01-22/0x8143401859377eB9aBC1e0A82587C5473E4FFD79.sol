/*
────────────────────────────┐
Name: CryptoPlanes Reborn
Symbol: CPANR
Decimals: 9                                                            .:..               
Total supply: 100.000.000                                             --::::-.            
Network: BSC                                                         ====----=.           
                                                                    -:::....:::           
t.me/pegasusteamblockchain                                         ++=====+***=           
────────────────────────────┘           .:-===::::....            .*+=+==*=****-           
                                     .--....-=-......=-.        .*+==+-+==****-           
                                    --:... ..=+:.....:+==:     .*+=+++*+++****-           
       .::::::...:-:::::....    .::-=-::.....:+=......++++=-. .++=+=====-*****:           
...
contract CryptoPlanesReborn is ERC20, Ownable {
    ...
    constructor () ERC20("CryptoPlanes Reborn", "CPANR") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xf73089Ba0A567d39A80765A4842F56075dE81Bc5);
        ...
        feeReceiver = 0x6D9Ba75E6eB1278Fe9A56aAade3DE69F001C991A;
    ...
    function creator() public pure returns (string memory) {
        return "tg.me/pegasusteamblockchain";
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            if (block.timestamp > tradingTime + 20 minutes){
                _totalFees = feeOnBuy;
            } else {
                _totalFees = 0;
            }
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 100_000_000_000, "CSLT: SwapTokensAtAmount must be greater than 0.0001% of total supply");
