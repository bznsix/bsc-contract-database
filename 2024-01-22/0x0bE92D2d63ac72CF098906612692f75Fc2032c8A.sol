//Telegram https://t.me/Baby_dogElonmoon
...
contract BABYDOGELON is ERC20, Ownable {
    ...
    constructor () ERC20("Baby DogElon", "BabyDogElon") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x8Ca81715Fd19e377e7E01Db375a70c69f2eF4004;
        ...
        _mintOnce(owner(), 420e9 * (10 ** decimals()));
    ...
    function claimStuckTokens(address token) external onlyOwner {
        require(token != address(this), "BEP20: Owner cannot claim contract's balance of its own tokens");
    ...
    function enableTrading() external onlyOwner{
        require(!tradingEnabled, "BEP20: Trading already enabled.");
        tradingEnabled = true;
        swapEnabled = true;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        require(tradingEnabled || _isExcludedFromFees[from] || _isExcludedFromFees[to], "BEP20: Trading not yet enabled!");
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 420_000_000_000, "BEP20: SwapTokensAtAmount must be greater than 0.0001% of total supply");
