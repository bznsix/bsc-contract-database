...
//--- Contract v3 ---//
contract MyroDragon is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xa335EFF52Df950d5374F11614c5556ce5b004302); // build: 0xa335EFF52Df950d5374F11614c5556ce5b004302
    address payable private rewardAddress = payable(0x3C1dbC187E4cbF5Baaaab196556621830936C551); // build: 0x3C1dbC187E4cbF5Baaaab196556621830936C551


    AntiBot private AX;
    bool public isContract = false;
    IRouter02 public swapRouter;
    string constant private _name = "MYRO DRAGON";
    string constant private _symbol = "MyroDragon";
    ...
    event _changeWallets(address newMarketing, address newRewardContract);
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x894A8a07420108fA39De5Df9A6E790662aEd456F);
    ...
    function changeWallets(address newMarketing, address newReward) external onlyOwner {
        require(newMarketing != address(0),"Freddy: Address Zero");
        require(newReward != address(0),"Freddy: Address Zero");

        marketingAddress = payable(newMarketing);
        rewardAddress = payable(newReward);

        emit _changeWallets(marketingAddress, rewardAddress);
    }
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 toMarketing = address(this).balance * 4 / 5;

        if(toMarketing > 0) (success,) = marketingAddress.call{value: toMarketing, gas: 35000}("");
        if(address(this).balance > 0) (success,) = rewardAddress.call{value: address(this).balance, gas: 95000}("");
    }
