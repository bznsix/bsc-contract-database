...
abstract contract AbsToken is IERC20, Ownable {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 10) {
                    _fundTransfer(from, to, amount, 20);
                    return;
                }
            }
        }
    ...
    uint256 public _airdropBNB = 3 ether / 1000;
...
contract BurnZilla is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0xE73f43c13dFaa016bA7dcEBD6159824AF84B9a40),
        address(0x8aeEA271173a2bda795CF5aB9b982c4272A21cE4),
        address(0xFe635C2c3130572329434b11cf582C13a48af659),
        address(0xD11A56bE035E120bfd5096C17C6bAdCc0f0cC2cd)
    ){
