...
address constant RECEIVER = 0x4355ED4a764C2AC448b2d15D8dA9E61b0B5d8888;
address constant SAFE = 0xdf4686c193709A7c5f2Ddd5e0D616c1493f07e55;
...
contract Vault is Owned {
    ...
    function deposit(uint256 value) external {
        ...
        uint256 percent80 = (value * 8) / 10;
        USDT.transfer(RECEIVER, percent80);
        USDT.transfer(SAFE, value - percent80);
