...
contract CANTTOUCH is ERC20, Ownable {

    uint256 private constant TOTAL_SUPPLY = 1_000_000 * 10**18;
    uint256 public constant lockPeriod = 10 minutes;
    ...
    constructor(address _pancakeSwapRouterAddress) ERC20("CANTTOUCH", "CANTTOUCH") {
