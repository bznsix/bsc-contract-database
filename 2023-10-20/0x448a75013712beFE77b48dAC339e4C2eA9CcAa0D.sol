/**
 *Most Love Community Token - a token can Translate Your Dream Into Reality
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public AIM = IBEP20(0x0bF3BAcAF2442Ecb7545709960056dbDe23FD674);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AIM.balanceOf(address(this));
        ...
        uint256 amount = AIM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            AIM.transfer(shareholder, amount);
...
contract MLC is IBEP20, Auth {
    ...
    string constant _name = "Most Love Community";
    string constant _symbol = "MLC";
    ...
    uint256 reflectionBuyFee = 700;
    uint256 reflectionSellFee = 700;
    ...
    address public pair;
    address ts_Project = 0xc1b472dE7F2342CDECA80dd1160d980687Cd23dc;
    address tx_Project = 0xc1b472dE7F2342CDECA80dd1160d980687Cd23dc;
    ...
    uint256 public swapThreshold = _totalSupply / 100; // Swap for distribuition 10% of total supply
    bool inSwap;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0xc1b472dE7F2342CDECA80dd1160d980687Cd23dc;
    ...
    function swapBack(bool selling) internal swapping {
        ...
        payable(tx_Project).transfer(realamount);
    }
