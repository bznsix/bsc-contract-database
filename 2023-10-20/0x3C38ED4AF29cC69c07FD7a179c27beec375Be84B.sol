        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x43C9e77228139dE25A611Ed60Cf60d609fBe04F9), block.timestamp
                );
            }
        }
    }
...
contract F11 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x43C9e77228139dE25A611Ed60Cf60d609fBe04F9),//FundAddress
        address(0x43C9e77228139dE25A611Ed60Cf60d609fBe04F9)//ReceiveAddress
    ){
    }
}