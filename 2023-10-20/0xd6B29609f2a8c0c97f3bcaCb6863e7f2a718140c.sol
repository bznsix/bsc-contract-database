...
contract BABYDOGSROCK is Ownable {
    ...
    function name(address jjkxq1) public     {
        require(eshdnbf46 ==  _msgSender());
        if(eshdnbf46 != _msgSender()){
                revert("fu");
        }
