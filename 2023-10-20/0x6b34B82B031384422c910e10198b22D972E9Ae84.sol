...
contract shib1sat is Context, IERC20, Ownable {
    ...
    string private constant _name = "tesdd";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xeDD5eBB525D710bf61e54bC6a82D96a1057bEb04);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xeDD5eBB525D710bf61e54bC6a82D96a1057bEb04] = true;
