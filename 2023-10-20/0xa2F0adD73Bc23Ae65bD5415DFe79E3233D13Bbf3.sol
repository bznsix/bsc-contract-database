...
BilibiliGaming LOLS13 world champion
（OWNERSHIP RENOUNCED AND LP Lock ）
🔉TG:https://t.me/BilibiliGaming
*/
...
contract BilibiliGaming is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BilibiliGaming";
    string private _symbol = "BLG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc9959DEe04063C0d58d78cfeAcb72E3A99FDBeF6); 
    address payable public BurnedWalletAddress = payable(0xc9959DEe04063C0d58d78cfeAcb72E3A99FDBeF6); 
