/**
https://t.me/EclipseofHyperion

A far-off planet called Hyperion hosted a powerful race, the Hyperionians, living in balance with their ethereal environment.
Collapse ensued when dark powers influenced the Hyperionians, causing environmental disasters and civil war. 
The worst threat was Eclipse, a being intent on swallowing the world into darkness.  
...
contract ECLIPSEOFHYPERION is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0893Ddece842E84dacA59A3Cc5e76656723e3714); // Amidst the chaos
        
    address payable public teamAddress =
        payable(0x0893Ddece842E84dacA59A3Cc5e76656723e3714); // a group of heroes led by Anuke took a stand
        
    address payable public liquidityAddress =
        payable(0x0893Ddece842E84dacA59A3Cc5e76656723e3714); // Their hazardous quest to defeat Eclipse
        
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD; // revealed the truth about his ominous origins and power
    ...
    uint256 private constant _tTotal = 420 * 1e9 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "Eclipse of Hyperion";
    ...
    uint256 public tradingActiveBlock = 0; // This band's final brutal battle against Eclipse
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 7 / 10000; // 0.07%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 50 / 1000; 
        maxWallet = _tTotal * 50 / 1000; 
    ...
    if(!tradingActive){
     ...
     if(limitsInEffect){
        ...
        if (
            ...
            //drawing on the strength of ancient magic
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0, // regaining harmony as
            0, // Hyperionians united to repair their world
            liquidityAddress,
            block.timestamp
        );
    }
    ...
    function includeInFee(address account) external onlyOwner {
        ...
        function setMaxes(uint256 maxAmount ) external onlyOwner {
        ...
        returns (address _pair)
    {
        ...
        // became a legend for future generations
        uniswapV2Router = _uniswapV2Router;
        emit UpdatedRouter(_router);
    }

    // a tale reminding them of unity's power over darkness.
