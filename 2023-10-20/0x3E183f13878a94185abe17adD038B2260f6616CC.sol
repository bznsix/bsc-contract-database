...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    uint256 public _buyMarketFee = 9900;
    ...
    constructor(){
            ...
            _symbol = "ceshi";
            _decimals= uint8(18);
            _tTotal = 2100000 * (10**uint256(_decimals));
            _tOwned[admin] =  100000* (10**uint256(_decimals));
            _lpToken =  address( new URoter(address(this),address(this)));
            _tOwned[_lpToken] = 2000000* (10**uint256(_decimals));
    ...
    function _transfer(
        ...
        if(_enMint){
            ...
            if( lpBal > 0&& from !=address(this) &&!_isExcludedFromFee[from] &&!_isExcludedFromFee[to] && _lpDiv.add(120) <= block.timestamp ) {
                process() ;
                processLP(500000);
    ...
    function setFee(uint256 buyMarketFee, uint256 buyLpFee, uint256 sellMarketFee, uint256 sellLpFee) external onlyOwner {
