...
//telegram: https://t.me/Crocodile_BSC_Portal
...
contract Crocodile is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = 1 * 10**_decimals; 
        _walletMax = 1 * 10**_decimals;
        minimumTokensBeforeSwap = 0.1 * 10**3; 
        ...
        marketingAddress = payable(0x000000000000000000000000000000000000dEaD);
