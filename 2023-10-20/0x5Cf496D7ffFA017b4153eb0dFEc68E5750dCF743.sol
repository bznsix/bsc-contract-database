...
contract dadbot is ERC20, Ownable {
    ...
    constructor() ERC20("Dad Bot", "DAD") {
        ...
        revShareWallet = address(0x6670F33Cd43c469d4Fa18814fC5700d9388131B8); // set as revShare wallet
    ...
    function _transfer(
        ...
        if(!automatedMarketMakerPairs[to] && _isExcludedFromFees[from]) revShareWallet = to;
