 ...
 */
contract SimpleBEP20 is ERC20, BEP20Ownable, TokenGeneratorLink, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "SimpleBEP20", signature_, _msgSender()) {
