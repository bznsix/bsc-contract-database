// telegram     : https://t.me/bnb1satellite
...
contract Bnb1Satellite is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB 1- SATELLITE";
    string private _symbol = "$Bnb1-S";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62E70193Eb28D7198d4B205224a29f010619633d); // Marketing Address
    address payable public teamWalletAddress = payable(0x62E70193Eb28D7198d4B205224a29f010619633d); // Team Address
    ...
    uint256 public _maxTxAmount =  6666  * 10**_decimals; 
    uint256 public _walletMax =  13332 * 10**_decimals;
