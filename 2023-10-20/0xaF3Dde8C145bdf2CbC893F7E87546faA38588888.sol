...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        highblock = 600; 
        startTax = 3000; //30%
        _Coin = 0x48de84765F831b0Ceda6d6366d735e6eDAcd0BD1; 
    ...
    function _swapAndDestroy(uint256 balance) internal{
        ...
        Coin.transfer(DeadAddress, tokenbalance);
    }
    ...
    function setMaxlimit(bool enable, uint256 num) external onlyFunder{
        maxHold = num;
        maxlimit = enable;
    }
...
contract BSCToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x55d398326f99059fF775485246999027B3197955),    //0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
        "Riches crab",
        "RIC",
        18,
        141319,
        ...
        address(0xC0fE3e68C9308917feecDe914C4e1996Be80B96C),  
        address(0xC0fE3e68C9308917feecDe914C4e1996Be80B96C)   
    ){}
}