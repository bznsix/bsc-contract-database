...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x0000a1C6219D6C4e663cdAd9523d576411eCB960);
    address public fundAddress1 = address(0x0000a1C6219D6C4e663cdAd9523d576411eCB960);
    address public addAddress;
    string private _name = "Catwoman";
    string private _symbol = "Catwoman";
    ...
    function _transfer(
        ...
        if (_limitAmount > 0 && !_feeWhiteList[to]) {
