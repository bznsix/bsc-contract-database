...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x3356e4800759dc82Ecdb1726c93A7353769aD33E; // owner address
...
contract BTC is Context, IERC20, Ownable {
    ...
    string private _name = "BITCOIN CITY";
    string private _symbol = "BTC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3356e4800759dc82Ecdb1726c93A7353769aD33E); // Marketing Address
    address payable private teamWalletAddress = payable(0x3356e4800759dc82Ecdb1726c93A7353769aD33E); // Team Address
