...
contract GOXRP is ERC20, Ownable {
    ...
    constructor() payable ERC20("Gold XRP", "GOXRP") {

        rewardToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //bscXRP
        ...
        treasuryWallet = 0x36381331b52b72F2a17B403e4465C90E4E75F8FD;

        dividendTracker = new DividendTracker(100_000_000, rewardToken);
        ...
        swapTokensAtAmount = totalSupply() / 50000;
    }
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy, uint256 _buybackFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 15, "Buy fee cannot be more than 10%");
    ...
    function buyBackAndBurn(uint256 amount) private{
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: half}(
            0,
            path,
            address(DEAD), //ex DEAD
            block.timestamp
        );
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: otherHalf}(
            0,
            path,
            address(DEAD), //ex DEAD
            block.timestamp
