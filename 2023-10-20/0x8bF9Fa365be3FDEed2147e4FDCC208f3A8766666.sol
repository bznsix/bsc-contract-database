...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private constant _buyFundFee = 180;
    uint256 private constant _buyRootFee = 150;
    uint256 private constant _sellFundFee = 180;
    uint256 private constant _sellRootFee = 150;
    ...
    uint256 public _startMintLPHolderNum = 50;
    ...
    constructor (
        ...
        _maxInviteLPUsdt = 3000 * usdtUnit;

        _nodeSelfLPCondition = 3000 * usdtUnit;
        _nodeInviteLPCondition = 10000 * usdtUnit;
...
contract DBC is AbsToken {
    ...
    18,
    10000000000,
    address(0x0dc02c9d783e7914A298449EBE4A279ad2D69506),
    address(0x3db58f26fFA2daf4464888E9c4744d6be1B2B701)
    ){
