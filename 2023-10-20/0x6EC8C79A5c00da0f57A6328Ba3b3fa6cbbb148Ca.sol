...
contract BAMSTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public rhbfcd34;
    ...
    string public _tokenname = "BAMS";
    string public _tokensymbol = "BAMS";
