...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTxAmount = 5 * 10 ** Decimals;
        _tTotal = total;
        swapAtAmount = total / 1000 * 2;
    ...
    //     {
    //         userMaxWalletAmount[accounts[i]] = amount * 10 ** 18;
    //     }
    // }
    ...
    function _transfer(
        ...
        // if (startTime == 0 && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
        ...
        //             require(0 < goAddLPBlock && isAdd,"!add");
        //         }else{
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                ...
                if (_swapPairList[from] && _maxWalletAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundAmount > 0){
            ...
            IWBNB(_usdt).withdraw(fundAmount);
        ...
        uint256 wbnbBal = FIST.balanceOf(address(this));
        if (wbnbBal > 0){
            address[] memory buyRewardPath = new address[](2);
            buyRewardPath[0] = address(_usdt);
            buyRewardPath[1] = address(0x55d398326f99059fF775485246999027B3197955);
            try _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                wbnbBal,
                0,
                buyRewardPath,
    ...
    function processReward(uint256 gas) private {
        ...
        IERC20 FIST = IERC20(0x55d398326f99059fF775485246999027B3197955);
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0x94970dc167101a062c6b8F226a81d92C27A4b474),
        address(0x94970dc167101a062c6b8F226a81d92C27A4b474),
        address(0x7E5B5EC52627D220ccAb3FCcC7b6f18347A3E0DB)
    ){
    }
}