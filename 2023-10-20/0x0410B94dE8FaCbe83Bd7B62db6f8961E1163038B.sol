...
/**
	@title Paysenger distributor of ERC721 tokens 
	@author OIS Solutions <https://www.ois.dev/>
	@author Barinov Nikita
	
	This contract is a distributor of ERC721 tokens.
*/
contract DistributorERC721 is AccessControl, ERC721Holder, AcceptedTokenList {
     ...
     */
    constructor(address admin, address _validator) {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(ADMIN_ROLE, address(0xf85bbA97CffFa84af06da50e1351B40F60b9aa92));
     ...
     * @param _erc721Token address of ERC271 token contract,
