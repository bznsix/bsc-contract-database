...
contract UPSHIB is IERC20, Ownable {
    ...
    string _name = "UP SHIBA";
    string _symbol = "UPSHIB";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x106d18044F35541C3b0cad4961D5e6e3Fe4DD836;
        marketingFeeReceiver = 0x106d18044F35541C3b0cad4961D5e6e3Fe4DD836;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeSell <=75,"Cannot set sell fees above 75%"); // set max fees you can set to here
