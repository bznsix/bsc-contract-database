...
contract Feline is Context, IBEP20, Ownable {
 ...
 //SPDX-License-Identifier: MIT
  ...
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "CAT: burn from the zero address");

    _balances[account] = _balances[account].sub(amount, "CAT: burn amount exceeds balance");
