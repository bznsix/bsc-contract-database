...
contract M1905 is Token {
    constructor() ERC20(
        "1905",   // 名字
        "1905"   // 符号
    ) {
        uint256 _totalSupply = 1500000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x107fe8d96E74EED3605eA5E351028A5bc5b9559C); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x107fe8d96E74EED3605eA5E351028A5bc5b9559C)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xa5290a3180003597eF753Cecc1B9520B666b13Be);
        feeEarn = 1000;
        isLiquified = true;
    }
}