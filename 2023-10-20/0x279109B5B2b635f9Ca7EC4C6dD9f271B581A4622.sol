...
contract floki1satellite is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI-1 SATELLITE";
    string private _symbol = "$FLOKI1";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC79A176198AC7f09Cfab21D5A3656cF38cCA5243);
    address payable private DevelopmentWalletAddress = payable(0xC79A176198AC7f09Cfab21D5A3656cF38cCA5243);
    ...
    uint256 public _maxTxAmount = 25 * 10**9;
    uint256 public _walletMax = 25 * 10**9;
