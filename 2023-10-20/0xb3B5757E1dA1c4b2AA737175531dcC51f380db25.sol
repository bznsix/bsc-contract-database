...
contract Token is ERC20 ,Ownable{
    ...
    TaxRates public buyTax = TaxRates(0, 200, 0, 200);
    TaxRates public sellTax = TaxRates(0, 200, 0, 200);
    ...
    constructor() ERC20("2021", "2021") {
        require(usdt < address(this), "usdt must be token0");
        marketingWallet = 0x9c4bBf60577e8EAA3d536B084c6e4133E604F263;
        ...
        maxWalletBalance = 10 * 10 ** decimals();
