    ...
    function addDistributor(
        ...
        require(
            !distributorsMapping[_BEP_TOKEN].exists,
             "T66/Distributor already exists"
        );
...
contract T66 is IBEP20, Auth {
    ...
    string constant _name = "test66";
    string constant _symbol = "t66";
    ...
    function permit(
        ...
        require(holder != address(0), "T66/invalid-address-0");
        require(
        ...
        require(nonce == nonces[holder]++, "T66/invalid-nonce");
