...
/**
 * @dev BEP20Token implementation with Burn, Recover capabilities
 */
contract STOToken is BEP20Base, BEP20Burnable, Ownable, Recoverable {
    constructor(
        uint256 initialSupply_,
        address feeReceiver_
    ) payable BEP20Base("Stellar Uno", "STO", 18, 0x312f313639373639312f4f2f422f52) {
