...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setMarketAddr(address market) public onlyOwner {
    ...
    function _transfer(
        ...
        if (_swapPairList[to]) {
            if (isAdd){
                ...
                _tokenTransfer(from, marketAddress, amount*8/100, 0);
            ...
            if (isDel){
                ...
                _tokenTransfer(from, marketAddress, amount*4/100, 0);
