...
contract EZ is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0xe6C7243e5365a73c773fbcEA617e22731075D2E9;
        _totalSupply = supply  * 10 ** _decimals;
        marketingWalletAddress = payable(0xe6C7243e5365a73c773fbcEA617e22731075D2E9);
        teamWalletAddress = payable(0xe6C7243e5365a73c773fbcEA617e22731075D2E9);
    ...
    function _isRemoveLiquidity_2(uint256 amount) internal view returns (uint256 liquidity){
        ...
        //isRemoveLP
        if (balanceOther <= rOther) {
            liquidity = (amount * ISwapPair(uniswapPair).totalSupply() + 1) /
