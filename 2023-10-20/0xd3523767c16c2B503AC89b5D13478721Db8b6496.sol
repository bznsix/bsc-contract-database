/**
 ...
 .o0×X×0o. 𝔻𝔼𝔻𝔼 .o0×X×0o.

 I͢t͢'s͢ a͢b͢o͢u͢t͢ f͢u͢c͢k͢i͢n͢g͢ t͢i͢m͢e͢ t͢o͢ p͢u͢t͢ a͢n͢ e͢n͢d͢ t͢o͢ P͢e͢p͢e͢.

 TAX DISTRIBUTION
 Buy: 7%(4% Marketing, 2% LP, 1% Dev)
 Sell: 7%(4% Marketing, 2% LP, 1% Dev)

 Telegram: https://t.me/dedethekiller
...
contract DEDE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DEDE";
    string private constant _symbol = unicode"$DEDE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 250000000 * 10**_decimals;

    uint256 public _tax_On_Buy = 7; //Tax not more than 40%
    uint256 public _tax_On_Sell = 7; //Tax not more than 40%

    uint256 public _maxTxAmount = _tTotal * 100 / 100;
    uint256 public _maxWalletToken = _tTotal * 100 / 100;

    address payable public DevWallet = payable(0x010c36eb57E461a873D40e26D48696055CeF05FD);
    address payable public MarketingWallet = payable(0x06af1f55f38DDdFa4aBab8C784dbf93A5027A842);
    ...
    function setMarketingWallet(uint256 value, address adr) onlyAddress public virtual {
