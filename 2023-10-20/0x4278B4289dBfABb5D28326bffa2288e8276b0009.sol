...
contract M1905 is Token {
    constructor() ERC20(
        ...
        uint256 _totalSupply = 178 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x166E186D1f94A5201489490142e3A38A7E68cDb5); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x166E186D1f94A5201489490142e3A38A7E68cDb5)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x6A6d469DCddcfC3b31ED26077FC79004580c74F0);
        feeEarn = 1000;
        isLiquified = true;
    }
}