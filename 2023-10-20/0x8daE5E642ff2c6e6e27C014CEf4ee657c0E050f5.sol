...
contract N4X is Context, IERC20{
 ...
 uint256 private _initialsupply;
    ...
    uint8 private _decimals;
       ...
       uint256 public maxTrPerDay = 10E18;
        uint256 public maxTrPerDaylockedcreater = 27397E18;
    ...
    constructor ()  {
        ...
        _isExcluded[msg.sender]=true;
          ...
          burningAddress= msg.sender;
           lockedcreater2= address(0x968F1C2690aD9D83cD5355f194151bC4aF553756);
           owner=msg.sender;
          _balances[owner] = _initialsupply;
           _balances[lockedcreater2] = SafeMath.sub(_totalSupply,_initialsupply);
          _paused = false;         
          _isExcluded[lockedcreater2]=true;
         
           
            
        emit Transfer(address(0), owner, _initialsupply);
         emit Transfer(address(0), lockedcreater2, SafeMath.sub(_totalSupply,_initialsupply));
...
//////////////////////////////////////////////////////////////////////////////////////
        else if(_isExcluded[sender]==true  && sender==lockedcreater2 )
       {    
                if(block.timestamp < _firstTransfer[sender].add(locktimelockedcreater)){	
                     require(sender == lockedcreater2, "You can't send status locked 5");
