...
contract NovisPresale is Ownable {
    ...
    address public wallet = payable(0x89d1a7d89198ee7Eb6f03830247B79bE36D5cd36);

    // How many token units a buyer gets per BNB & USDT
    uint256 private bnbRate = 4200000000;
    uint256 private usdtRate = 20000000;

    //Referral bonus
    uint256 referralBonus = 2;
