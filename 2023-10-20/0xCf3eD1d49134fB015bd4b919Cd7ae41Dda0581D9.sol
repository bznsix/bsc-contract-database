...
//Rescue the art, preserve the hIstory, and shape the future. The pearl Is In your possessIon, the value Is In the blockchaIn!
//https://t.me/pepearl_portal
//https://twitter.com/PEPEARL_BSC
//pepearl.fun
...
contract PEPEARL is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xe3935014ee071eD8E579F858f146076370a3CD45;
    address public opsWallet = 0x1b7963FdD0f57ED7A12570d4B260d19401A3e9B4;
    address public devWallet = 0x1b7963FdD0f57ED7A12570d4B260d19401A3e9B4;

    string private constant _name = "PEPE WITH PEARL EARRING";
    string private constant _symbol = "PEPEARL";
    ...
    Taxes public taxes = Taxes(0, 3, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 3, 0, 0, 0);
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 1000000, "Cannot set swap threshold amount higher than 1% of tokens");
