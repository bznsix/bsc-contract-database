...
contract taxbuy is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 public constant MAX = ~uint256(0);

    address payable public _fundAddress = payable(0x81Db07bb9D2388713EE8a3C2b3609d8f57dFF277);
    address public _currency;
    address public _creatorAddress;

    uint256 public _buyFee = 5000; // 10%
    uint256 public _sellFee = 5000; // 10%
    ...
    constructor() ERC20("taxbuy", "taxbuy") payable  {
