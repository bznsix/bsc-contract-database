...
contract DRAGONMOON is IERC20, Ownable {
    ...
    uint256 public _totalBuyFee = 7;
    uint256 public _totalSellFee = 99;
    ...
    constructor() {
        ...
        maxTXAmount = 1000000 * 10 ** _decimals;
        maxWalletAmount = 1000000 * 10 ** _decimals;
 
        minimumTokensBeforeSwap = 1000 * 10 ** _decimals;
        ...
        MarketingAddress = 0xB661Dd8283Dca06919cFD684840c9F2B601F5007;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_hasLiqBeenAdded) {
            ...
            require(trading, "trading not open");
    ...
    function setTrading(bool val) external onlyOwner {
         trading = val;
         startTradeBlock = block.number; 
    }
