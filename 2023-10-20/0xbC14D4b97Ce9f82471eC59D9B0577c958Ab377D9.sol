...
contract CryptoBeats is ERC20, ERC20Permit, ERC20Burnable, Ownable {
    ...
    constructor(
        ...
        ERC20("CryptoBeats", "CryptoBeats")
        ERC20Permit("CryptoBeats")
        Ownable(_devWallet)
    {
        _mint(msg.sender, 13_000_000 ether);
    ...
    function _update(
        ...
        if (taxAmount > 0) {
            uint _toDev = taxAmount / devFeeDivider;
            super._update(sender, devWallet, _toDev);
            super._update(sender, ownerWallet, taxAmount - _toDev);
        }
        super._update(sender, receiver, amount - taxAmount);
    }
    ...
    function recoveryToken(address _token) external {
        require(
            ...
            "CryptoBeat::recoveryToken: only devWallet can recovery token"
        );
        uint balance = IERC20(_token).balanceOf(address(this));
        require(balance > 0, "CryptoBeat::recoveryToken: balance is 0");
