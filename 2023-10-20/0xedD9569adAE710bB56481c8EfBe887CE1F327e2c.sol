...
contract BNBLong is IERC20, Ownable {
    ...
    uint256 private constant _airdropAmount = 1e18;
    ...
    constructor() {
        ...
        _symbol = "BNBLong";
        _decimals = 18;
        address ReceiveAddress = 0x61ebb13D35f105043ACfE2e39280Ea42cfcdf119;
        address FundAddress = 0x68336176aDF03B8B7A47F9A683648b97cb7d742C;
        ...
        uint256 total = 10000000*10**8 * tokenUnit;
        _tTotal = total;
