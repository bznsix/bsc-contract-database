...
contract WolverineChibi is Context, IERC20, Ownable {
    ...
    string private constant _name = "WOlverine Chibi";
    string private constant _symbol = "$WOLC";
    ...
    address payable private _twddev = payable(0xd4b743b764eAc979c799a91c446C05698635FB5E);
    address payable private _twdmkt = payable(0xd4b743b764eAc979c799a91c446C05698635FB5E);
