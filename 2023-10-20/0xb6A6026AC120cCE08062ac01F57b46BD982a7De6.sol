...
contract POOCHIE is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x2602Aa80f407C21cB9b5FB5cCa7ffd1fA8Fa076D;

    string private constant _name = "POOCHIE";
    string private constant _symbol = "$POOCHIE";
