...
contract YOGE is ERC20, Ownable {
    ...
    constructor() ERC20("YOGE", "YOGE") {
        ...
        maxTransactionAmount = (totalSupply * 25) / 1000; // 1.5% of total supply
        ...
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferDevFee;

        marketingWallet = address(0xdA1A84a74c0b8eE0b9C9464Cdc87dF90eBd1Fdf5); 
        devWallet = address(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        lpWallet = msg.sender;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on transfer
                ...
                tokensForDev += (fees * transferDevFee) / totalFeesTransfer;
