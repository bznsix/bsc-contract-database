...
contract FLYDOGE  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0xE7c78E94FF82945FFb644B3cEA13B0759eb7C13F); // Marketing Address
        
    address payable private liquidityAddress =
        payable(0xD3a7816124895107f7E4a0d72bF804F476238686); // Liquidity Address
    ...
    string private constant _name = "Fly Doge";
    string private constant _symbol = "FlyDoge";
    ...
    constructor() {
        address newOwner = address(0xD3a7816124895107f7E4a0d72bF804F476238686);
        ...
        _maxBuyTxAmount = _tTotal * 100 / 100;
        _maxSellTxAmount = _tTotal * 100 / 100;
