...
contract MXTT is ERC20, Ownable, Payable {
    ...
    constructor(address swapRouter, address usdtToken) ERC20("MXTT", "MXTT") {
    ...
    function addToUniswap(uint256 usdtAmount, uint256 selfAmount) public onlyOwner {
        ...
        require(balanceOf(address(this)) >= selfAmount, "MXTT amount exceeds balance");
