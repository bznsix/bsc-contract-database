...
contract TheMillionaireJourney is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 952000000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "The Millionaire Journey";
    string private _symbol = "TMJ";
    ...
    address payable public marketingWallet = payable(0x03f892B0880DE94B81c7bB5C56b68f45a2d87458);
    ...
    uint256 public numTokensSellToAddToLiquidity = 14280000000 * 10**18;
    uint256 public _maxTxAmount = 4760000000 * 10**18;
    uint256 public _maxWalletLimit = 14280000000 * 10**18;
    address admin;
