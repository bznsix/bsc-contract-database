...
/**
	@title Paysenger Offers
	@author OIS Solutions <https://www.ois.dev/>
	@author Barinov Nikita
	
	This contract allows you to offer an ERC721 token. 
*/
contract OffersERC721 is AccessControl, ERC721Holder, AcceptedTokenList {
    /**
	...
	*/
     ...
     */
    constructor(uint256 _feePercent, address _token) {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(DEFAULT_ADMIN_ROLE, address(0x4d68D5025b6B339e53a71D9f1D2880078CDbf7b1));
        _setupRole(ADMIN_ROLE, address(0x4fc9f47c210E792bDd31A9aaf997b18860e1B8E0));
    ...
    function makeOffer(
        ...
        require(
            (IERC20(_erc20Token).allowance(msg.sender, address(this)) >= _amount && Side.Buy == _side) ||
                (IERC721(_erc721Token).isApprovedForAll(msg.sender, address(this)) &&
                    Side.Sell == _side &&
                    IERC721(_erc721Token).ownerOf(_tokenId) == msg.sender),
        ...
        emit OfferMade(_side, _erc721Token, _tokenId, _erc20Token, _amount, _deadline, offers[msg.sender].length - 1);
    }
