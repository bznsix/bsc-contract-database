...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5e241EA40E3cC554CD0F5e852c214FF759c16612; // owner address
...
contract PIXIE is Context, IERC20, Ownable {
    ...
    string private _name = "PIXIE";
    string private _symbol = "$PXI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5e241EA40E3cC554CD0F5e852c214FF759c16612); // Marketing Address
    address payable private teamWalletAddress = payable(0x5e241EA40E3cC554CD0F5e852c214FF759c16612); // Team Address
