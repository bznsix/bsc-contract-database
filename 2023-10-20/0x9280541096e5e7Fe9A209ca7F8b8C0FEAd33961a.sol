//YAKKO COIN  AUTO BURN MECHANISM Introducing Yakko Coin,
//the revolutionary cryptocurrency with an Auto Burn Mechanism that combines meme utility and crypto innovation. 
//Say goodbye to boring transactions and hello to a coin that dynamically reduces its supply while spreading viral memes throughout the crypto space
...
//Communty:https://t.me/YakkoCoinBsc
//Website:https://yakkocoin.site
//Twitter:https://twitter.com/YakkoCoin
interface IERC20 {
...
contract Yakko is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc9Af9Fe327b50b9C54158cbBFB375E52251Cb0AB); 
    address payable public Wallet_Dev = payable(0xc9Af9Fe327b50b9C54158cbBFB375E52251Cb0AB);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "YAKKO COIN"; 
    string private constant _symbol = unicode"$YAKKO"; 
    ...
    constructor () {
        _owner =0xc9Af9Fe327b50b9C54158cbBFB375E52251Cb0AB;
