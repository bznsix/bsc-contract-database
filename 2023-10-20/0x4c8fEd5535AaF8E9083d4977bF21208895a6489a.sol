...
contract InternalSwap is Ownable {
    ...
    function buyToken(uint256 _values) external {
        ...
        if (amountTokenDecimal != 0) {
            ...
            require(ERC20(currency).allowance(msg.sender, address(this)) >= usdtValue, "SWAP: MUST APPROVE FIRST");
    ...
    function sellToken(uint256 _values) external {
        ...
        if (amountUsdtDecimal != 0) {
            ...
            require(ERC20(tokenAddress).transferFrom(msg.sender, address(this), tokenValue), "SWAP: FAIL TO SWAP");
            if (amountSellFee != 0) {
