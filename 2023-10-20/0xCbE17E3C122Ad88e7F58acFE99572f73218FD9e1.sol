/**
Telegram : https://t.me/FroggyInu_BSC
Twitter : https://twitter.com/FroggyInuBSC
*/
...
contract froggyinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "FROGGY INU";
    string private constant _symbol = "FROI";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x165c4C2015CF9E7B16fCd66735Ca99948435791C);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x165c4C2015CF9E7B16fCd66735Ca99948435791C] = true;
