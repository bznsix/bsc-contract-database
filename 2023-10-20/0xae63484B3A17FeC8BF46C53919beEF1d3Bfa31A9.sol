...
contract JXLNFT is ERC721Enumerable, Ownable, ERC721Holder {
    using Strings for uint256;
    ...
    function mint(address recipient_, uint256 tokenId)
        external
        returns (uint256)
    {
