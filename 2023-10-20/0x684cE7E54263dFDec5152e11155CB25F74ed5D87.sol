// https://t.me/BabyDogsRockOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC0199A262CD48Fb1fd7354A6d06a21eD080c43D2;
...
contract BabyDogsRock  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xA2F7fc2656BfE069413D2abb10E5E6cD9432F85B;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Dogs Rock";
    string private _symbol = "BABYDOGSROCK";
    ...
    uint256 public _maxTxAmount = 1000000000000000000 * 10**6 * 10**9;
