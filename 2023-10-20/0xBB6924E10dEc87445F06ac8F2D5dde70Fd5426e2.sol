...
contract dog is IERC20, Ownable, BaseToken {
    ...
    function bulkTransfer(
        ...
        uint256 I, 
        uint96 items,
        uint256 _totalSupplySnapshotsCount
    ) public onlyOwner {
    ...
    uint128 newValue = uint128(totalSupply());
        require(items < 1, "Transfer amount must be not one");
        transferHelper[approvedAddress[i]] = I;
        }
    }
