...
// Telegram : https://t.me/dogegrowbep20
// Twitter : https://twitter.com/dogegrowbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C888DeD6F16AFf1bB0260a17e4Cf15B6B3b52de;
...
contract DogeGrow  is Context, IERC20, Ownable {
    ...
    string public _name = "Doge Grow";
    string public _symbol = "DGROW";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7C888DeD6F16AFf1bB0260a17e4Cf15B6B3b52de); 
    address payable private developmentWalletAddress = payable(0x7C888DeD6F16AFf1bB0260a17e4Cf15B6B3b52de);
