...
contract ArmyCatToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x63d33Eb1B5508Ea3A6AaB778c3d461561e99470e); 
    address payable public Wallet_Dev = payable(0x63d33Eb1B5508Ea3A6AaB778c3d461561e99470e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10 * 10**4* 10**4 * 10**_decimals;
    string private constant _name = "Army Cat"; 
    string private constant _symbol = unicode"A-CAT"; 
    ...
    constructor () {
        _owner =0x63d33Eb1B5508Ea3A6AaB778c3d461561e99470e;
