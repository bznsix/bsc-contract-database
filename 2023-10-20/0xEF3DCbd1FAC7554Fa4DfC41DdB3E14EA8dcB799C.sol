...
//Telegram:https://t.me/GhostBustersCommunity

//Website:https://ghostbusters.finance

//Twitter:https://x.com/GhostBustersBsc
...
contract GBS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3a76A2A98Fa6F0a41cb03F2d4Ed913d80F62e467); 
    address payable public Wallet_Dev = payable(0x3a76A2A98Fa6F0a41cb03F2d4Ed913d80F62e467);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =2500 * 10**4* 10**4 * 10**_decimals;
    string private constant _name = "GHOST BUSTERS"; 
    string private constant _symbol = unicode"$GBS"; 
    ...
    constructor () {
        _owner =0x3a76A2A98Fa6F0a41cb03F2d4Ed913d80F62e467;
