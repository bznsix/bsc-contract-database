...
contract XOT is ERC20 {
    ...
    address _KOLAddress = address(0x62427343b059e9Dc2A0F0a22356c86eC89A2A7c5);
    address _fundAddress = address(0x24b7d57a36b7eFC5C498A76F12B4DA53C5b0Fd37);
    ...
    function _transfer(
		...
		}else if(balanceOf(_KOLAddress) > swapTokensAtAmount){
			if (
				!swapping &&
				_tokenOwner != from &&
				_tokenOwner != to &&
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){//buy
				...
				super._transfer(from, _KOLAddress, amount.div(100));
    ...
    function swapAndLiquify2() external onlyOwner{
        swapAndLiquify();
    }
    ...
    function swapAndLiquifyKOL2() external onlyOwner{
        swapAndLiquifyKOL();
    }
