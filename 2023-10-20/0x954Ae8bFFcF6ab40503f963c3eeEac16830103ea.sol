...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function _beforeTokenTransfer(
        ...
        require(to != address(0), "pls to dead");
        if (to == address(0)) {
...
contract DRWNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public immutable _maxTotal;
    ...
    constructor() ERC721("DRW NFT", "DRW NFT"){
        ...
        //
        _sameUri = "https://cloudflare-ipfs.com/ipfs/QmXjUGukkYnQAbc6TXvw4FuMLy96RRZ85q3pDBQdwSQpA8";
    }
}