...
contract TigerLong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Tiger Long";
    string private _symbol = "$TIGERLONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f00BeF884646481948C0677aD199146133F753c); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f00BeF884646481948C0677aD199146133F753c); // Team Address
