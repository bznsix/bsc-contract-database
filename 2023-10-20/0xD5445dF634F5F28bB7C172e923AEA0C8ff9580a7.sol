...
contract PIKACHU is ERC20, Ownable {
    ...
    address public _market = 0x9EA184491998993F522aE109bdcF334B06E3B2cB;
     event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("PIKACHU", "$PKU") {
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_market] = true;
        _isExcludedFromFee[0x89b9E914CbCa4f3D2520f70C197C1d4ffC212F2b] = true;
        _mint(0x89b9E914CbCa4f3D2520f70C197C1d4ffC212F2b, _tTotal);
