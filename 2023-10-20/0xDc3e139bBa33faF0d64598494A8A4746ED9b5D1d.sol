...
contract Saitanatwo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name ="Saitana 2.0"; 
    string constant _symbol = "Saitana 2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =
0xA89a19BDAbCd4C8C5F07498BD3Bb06674E137905;
