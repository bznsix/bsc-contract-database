...
contract PEPE777 is BEP20 {
    ...
    address private marketing = 0xbE7435DeF73C79b2E20Da14a651fca645b04a4a3;
    address private pool = 0x2aBc519AEB07dD92020df4bA878c4B14763e3544;

    uint8 private constant _decimals = 9;
    uint256 private supply = 420690 * (10**9) * (10**9);
    uint256 private swapThreshold = supply * 5 / 10000; // 0.05%
    uint256 private swapMax = supply * 15 / 1000;

    uint256 public fee = 6;
    uint256 public pShare = 4;
    uint256 public mShare = 2;
    uint256 private startBlock;
    bool private starting;

    mapping(address => bool) public isExcludedFromFee;

    constructor() BEP20("PEPE777", "PEPE777") {
    ...
    function _swapAndTransferFee(uint256 amount) private {
        uint256 swapAmount = amount.mul(mShare).div(mShare.add(pShare));
        uint256 poolAmount = amount.sub(swapAmount);
        _swapForETH(swapAmount);
        payable(marketing).sendValue(address(this).balance);
        super._transfer(address(this), pool, poolAmount);
    }
