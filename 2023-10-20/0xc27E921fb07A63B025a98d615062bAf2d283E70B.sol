...
contract REKTUM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69_000_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 13_800_000_000_001 * 10**9;
    uint256 public maxBuyLimit = 1_380_000_000_001  * 10**9;
    uint256 public maxSellLimit = 1_380_000_000_001 * 10**9;
    uint256 public maxWalletLimit = 690_000_000_001 * 10**9;
    ...
    uint256 gweiLimit = 1 * (10 ** 9);
    uint256 gweiLimitBlocksAffected = 3;
    
    address public MarketingWallet = 0x3ED5AEF88119164155f9294cAA9f6D8ef114FE29;
    address public TeamWallet = 0x3ED5AEF88119164155f9294cAA9f6D8ef114FE29;
    address public DevWallet = 0x3ED5AEF88119164155f9294cAA9f6D8ef114FE29;

    string private constant _name = "REKTUM";
    ...
    Taxes public buyTaxes = Taxes(1, 18, 1, 0, 0);
    Taxes public sellTaxes = Taxes(1, 28, 1, 0, 0);
    ...
    function setBuyTaxes(uint256 _Reflections, uint256 _Marketing, uint256 _Liquidity, uint256 _Team, uint256 _Dev) public onlyOwner {
       require(_Reflections+(_Marketing)+(_Liquidity)+(_Team)+(_Dev) <=12, "Buy Taxes cannot be higher than 12%");
    ...
    require(_Reflections+(_Marketing)+(_Liquidity)+(_Team)+(_Dev) <=12, "Sell Taxes cannot be higher than 12%");
