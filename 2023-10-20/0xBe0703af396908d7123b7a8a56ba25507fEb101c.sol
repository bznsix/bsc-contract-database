...
contract MBGA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Make BNB Great Again";
    ...
    uint256 public maxWalletSize = 2000000 * 10**_decimals; 
    uint256 private buyTaxes = 35;
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0xE0304493cFA96169F08c8704705ccfB525461102);
   ...
   function updateSwapBackSetting(bool state) external onlyOwner {
    ...
    function rescueBEP20FromContract(address _tokenAddy, uint256 _amount) external onlyOwner {
