...
contract XY is IERC20, Ownable {
    ...
    string private _name = "XY";
    string private _symbol = "XY";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 500000 * 10 ** _decimals;
    ...
    constructor() {
        project = 0x20FA89F2f2b60196Cd5445CcA2D1e85F947Ec1cb;
    ...
    function _tokenTransfer(
        ...
        uint256 recipientAmount = amount.sub(projectFee);
    ...
    function setAddr(address _project) external onlyOwner {
        project = _project;
    }
