...
/**
 * @dev BEP20Token implementation with Tax capabilities
 */
contract SLUMDOGEToken is BEP20Base, Ownable, TaxableToken {
    constructor(
        ...
        payable
        BEP20Base("SlumDogeMillionaire", "SLUMDOGE", 18, 0x312f313639363835392f4f2f54)
