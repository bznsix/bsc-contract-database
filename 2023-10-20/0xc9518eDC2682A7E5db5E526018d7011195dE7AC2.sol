...
contract test_test is ERC20, ReentrancyGuard, Ownable {
    ...
    constructor(address _routerAddr) ERC20("BTST", "BTST") {
    ...
    function _beforeTokenTransfer(
        ...
        if (!isTransferEnabled && from != address(0) && to != nft) {
    ...
    function _transfer(
        ...
        if (from == pairAddress && takeFee) {
            ...
            if (dexTaxFee > 0) {
                ...
                super._transfer(from, address(this), taxFee);
            }
        }
    ...
    function setProtection(address _protection) external onlyOwner {
