...
contract DOWG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DOWG";
    string private constant _symbol = unicode"DG";
    uint256 public _maxTxAmount =   100000000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 100000000000000000 * 10**_decimals;
