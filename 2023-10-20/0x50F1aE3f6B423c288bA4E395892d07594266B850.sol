...
contract KTPAYTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public sahgbs18;
    ...
    string public _tokenname = "Kevatpay";
    string public _tokensymbol = "KTPAY";
