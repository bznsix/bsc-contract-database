...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x06Dc293c250e2fB2416A4276d291803fc74fb9B5);
...
contract MART is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV  =  0xBDed6844eaBF5C58d6DEb00A75f9fcd76E3A291C;

    string constant _name = "Martian Protocol";
    string constant _symbol = "MART";
    ...
    address public autoLiquidityReceiver = (0xBDed6844eaBF5C58d6DEb00A75f9fcd76E3A291C);
    address public marketingFeeReceiver = (0x2B2C80f4D16362336084d0034FA895AA7579249d);
    address public devFeeReceiver = (0xBDed6844eaBF5C58d6DEb00A75f9fcd76E3A291C);
    ...
    // Max tx and tax variables
    uint256 public maxWallet = 20;
    uint256 public sellRewardsFee = 1;
    uint256 public sellDeadFees = 0;
    uint256 public sellMarketingFees = 7;
    uint256 public sellLiquidityFee = 2;
    uint256 public buyDeadFees = 0;
    uint256 public buyMarketingFees = 1;
    uint256 public buyLiquidityFee = 1;
    uint256 public buyRewardsFee = 1;
