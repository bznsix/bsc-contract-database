...
contract Unlimited is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"UNLIMITED";
    string private constant _symbol = unicode"UNLIMITED";

    uint256 private _buyTax = 8;
    uint256 private _sellTax = 8;
