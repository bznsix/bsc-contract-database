...
contract NMC is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 public transactionFeeRate = 2; 
    address public marketingWallet = 0xB88D41c154d0Ce6294db73b64E3b1D8F9358c4c4;
    uint256 public maxWalletLimit = 29400000000000 * 10 ** decimals();
    mapping (address => bool) public _isWhiteListedFromFee;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("NomemeCoin", "NMC") {
        ...
        _isWhiteListedFromFee[marketingWallet] = true;
    }
    ...
    function changeMarketingWallet(address account) public onlyOwner {
