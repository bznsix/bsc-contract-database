...
abstract contract ABCToken is ERC20, Ownable {
    ...
    uint256 private tokenSwapForFund = 4000 * 10**18;
    ...
    constructor(
        ...
        address LPAddress,
        address FundAddress,
        address PledgePoolAddress,
        address ERC19Address
    ) ERC20(Name, Symbol) {
        baseToken = BaseToken;

        fundAddress = FundAddress;
        pledgePoolAddress = PledgePoolAddress;
        ...
        _mint(PresaleAddress, (Supply * 30) / 100);
        _mint(LPAddress, (Supply * 70) / 100);
    ...
    function _tokenTransfer(
        ...
        if (takeSwapFee) {
            ...
            super._transfer(sender, pledgePoolAddress, repoFees);
...
contract PTAHDAO is ABCToken {
    constructor()
        ABCToken(
            ...
            "PTAH-DAO", //Name
            "PTAH", //Symbol
            10000000 * 10**18, //Supply
            address(0xD2bEdf98d632017e6Fdee4B51fd495b12DfCEa9D), //PresaleAddress
            address(0x3Bb5Fa875e623B53DF587327D437c00CAB4D317d), //LPAddress
            address(0xb10aA0Fcbe27423272c02d4DF639D47bDB0A757F), //FundAddress
            address(0xE6D53a0D582DB917B6139C3d7A67875b3842E4e8), //PledgePoolAddress
