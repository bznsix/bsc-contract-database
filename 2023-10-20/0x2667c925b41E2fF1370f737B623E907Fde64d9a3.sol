...
contract ADMOTOKEN is Ownable {
    uint256 tokenamount = 500*10**decimals();
    address public ADMO777;
    ...
    string private _tokenname = "HKNGion";
    string private _tokensymbol = "HG";
