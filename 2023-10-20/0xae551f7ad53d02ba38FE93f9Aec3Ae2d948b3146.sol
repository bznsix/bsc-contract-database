...
// Loox Network-LOOX // Blockchain Project

   //https://t.me/looxnetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51a697211468933b07953a9785e44a008915A08e;
...
contract LooxNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x51a697211468933b07953a9785e44a008915A08e);
    ...
    */
    ...
    string private _name = "LooxNetwork"; 
    string private _symbol = "LOOX"; 
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/2000000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/2000000;
    }
