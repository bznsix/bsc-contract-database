...
contract ShibAI is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xbc91Fa5df20AD7DbAaC765e4cF6823d71245be04);
    address payable private _mkt = payable(0xcD315746f7C2399bBc32C26048285C04F2d39D78);
    
    string private constant _name = "ShibAI";
