...
contract SHIBA1SATELLITE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SHIBA-1 SATELLITE"; // 
    string private constant _symbol = unicode"SHIB-1 SAT";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xCE3ea243241f6Fd61c947aa24EE4b3A112230599;
