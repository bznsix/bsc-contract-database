...
contract XUANWU is ERC20, Ownable {
    ...
    address public tokenAddress = 0xc8370B71329a6B716B867E875667C33488b4A44A;
    ...
    uint256 public startAt = 1696981200;
    ...
    constructor() ERC20("XW", "XW") {
        uint256 totalSupply = 120000 * (10**18);
        ...
        kAddress = 0x4A244946dB9a0221F4b3800FeFee480a32d1B13b;
    ...
    function setToken(address _o) public onlyOwner {
        tokenAddress = _o;
    }

    // function startTrade() public onlyOwner {
    //     require(startAt == 0,"stated");
