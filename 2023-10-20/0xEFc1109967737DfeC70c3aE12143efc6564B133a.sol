...
//TELEGRAM: https://t.me/charizardbscportal
interface IERC20 {
...
contract CHARIZARDINU is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 60000000 * 10**_decimals;
    uint256 public maxBuyAmount = 60000000 * 10**_decimals;
    uint256 public maxWalletBalance = 60000000 * 10**_decimals;

    address public marketingAddress = 0xd484ba442FBB90cF0296a6151F50657BF59df0A4;
    address public devAddress = 0xc4c9fD0e98FA899e4E8b2920461152D965942Bd9;

    string private constant _name = "CHARIZARD INU";
    string private constant _symbol = "CHZINU";
    ...
    Taxes public sellTaxes = Taxes(0,0,25,0);
