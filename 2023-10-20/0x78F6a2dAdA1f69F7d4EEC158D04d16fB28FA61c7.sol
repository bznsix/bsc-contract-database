...
contract MaskPlus is ERC20, Ownable {
    ...
    address public CAddress1 = 0x82aA0e0EcfBd27AE0A066d40DE618Dce59e46dDE;
	address public CAddress2 = 0x726880A6f015B2bf988987d2023bF2AB8BE34c9D;
	address public CAddress4 = 0xf95B71a71e761D7ab797F7f42aE635dfCc08ABB0;
	...
	function Receave5(uint256 i) public {
		...
		if((ruser_.Amd+ruser_.Amt)<ruser_.Allm && price>=price5)
		{
		memberInvest[msg.sender][i-1].retrieve=true;
