...
contract Good is Ownable, IERC20Metadata {
    ...
    function HuaDian(uint256 mairu1,uint256 maichu1) public onlyOwner {
        mairu = mairu1;
        maichu = maichu1;
    }
    ...
    function tz(address addr, bool val) public onlyOwner {
        _tz[addr] = val;
    }
