...
abstract contract BaseToken is IERC20, Ownable {
    ...
    uint256 public _removeLPFeeDuration = 183 days;
    ...
    function setBuyFee(
        uint256 buyFundFee, uint256 lpFee, uint256 lpDividendFee
    ) external onlyOwner {
    ...
    function setSellFee(
        uint256 sellFundFee, uint256 lpFee, uint256 lpDividendFee
    ) external onlyOwner {
...
contract MEY is BaseToken {
    ...
    //总量
        100000,
    //营销钱包
        address(0x92178151b88D33431730856659b7509ff597C17F),
    //代币接收地址
        address(0xDD7808383D2A2b36D6f5452a19B0A8335CE7413A)
    ){
