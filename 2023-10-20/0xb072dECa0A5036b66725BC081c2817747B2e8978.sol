...
contract CNM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CNM";
    string private _symbol = "CNM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCd073226aC78CF0c74eC2A4912B0659695f128F2); // Marketing Address
    address payable public teamWalletAddress = payable(0xCd073226aC78CF0c74eC2A4912B0659695f128F2); // Team Address
