...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa4956847c319e8c20812e72Be6814FCCCB6e4723;
...
contract SHIBAMERGE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4c69f62D4c30925772806D6f2FE9Bad10D55C6d4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SHIBA MERGE";
    string private _symbol = "ShibaMerge";
