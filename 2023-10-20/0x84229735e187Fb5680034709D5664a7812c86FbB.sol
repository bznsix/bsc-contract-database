...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63Eb2A7805BBF59579Db11B197e5fb62C37699C5; // owner address
...
contract MVR is Context, IERC20, Ownable {
    ...
    string private _name = "MemeVember";
    string private _symbol = "$MVR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x63Eb2A7805BBF59579Db11B197e5fb62C37699C5); // Marketing Address
    address payable private teamWalletAddress = payable(0x63Eb2A7805BBF59579Db11B197e5fb62C37699C5); // Team Address
