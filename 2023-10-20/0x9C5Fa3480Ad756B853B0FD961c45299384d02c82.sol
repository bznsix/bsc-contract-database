...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5CcfD32f441f2C14f8b725A5589D1474f5CEadf0; // owner address
...
contract Astracoin is Context, IERC20, Ownable {
    ...
    string private _name = "Astra Coin";
    string private _symbol = "AC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDdbCc19715C76D1e55C68f3C880233587c3c66ab); // Marketing Address
    address payable public teamWalletAddress = payable(0xDdbCc19715C76D1e55C68f3C880233587c3c66ab); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 46;  // original 12
