...
contract  FSLong is Token {
    constructor() ERC20(
        " FSLong",   // 名字
        " FSLong"   // 符号
    ) {
        uint256 _totalSupply = 1000000000000 ether; 
        address _marketing = address(0xEf7258eEFd8bfFcDb3Dd1e7cc32FF8494e441E2A); // 
        address _receive = address(0x5d9594ECa4bDF837C3270f53d676C536E382e5f8);   //
        ...
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x6FA587aFbeA4A174Da5A027Dd9B6cCe633F59917);   
        feeEarn = 500; 
    }
}