...
contract PONZI is ERC20, Ownable {
  ...
  PONZIDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PONZINOMICS", "PONZI") {
        marketingWallet = payable(0x216E8BD5E9F22E90584a4578c3533040f3B92249);
        devWallet = payable(0x77d2d3361d0D5867CdA48a19427588A6E3521618);
        ...
        dividendTracker = new PONZIDividendTracker(
            payable(this),
            router,
...
contract PONZIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        PONZIContract = PONZI(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PONZI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PONZI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PONZIContract);

            uint256 prevBalance = PONZIContract.balanceOf(address(this));
            ...
            {
                uint256 received = PONZIContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PONZIContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
