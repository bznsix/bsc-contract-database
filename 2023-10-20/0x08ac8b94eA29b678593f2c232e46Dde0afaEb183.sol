...
// Presented by an Anonymous team with millions of market cap.

// How far are you willing to go to secure your own profits? 
// Get in early, tell others to invest & watch your profits grow. 
// This is the PONZI. ZERO Tax. No Bullshit. Straight Trading.

// https://t.me/ponzischemebsc
...
contract PONZI is ERC20, Ownable {
    ...
    address public marketingWallet = 0x5312882cd88A8421492Daa6102d3ef559Ffb3d55;
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 10, "Marketing fee on buy cannot be more than 3%");
        require(_marketingFeeOnSell <= 10, "Marketing fee on sell cannot be more than 3%");
