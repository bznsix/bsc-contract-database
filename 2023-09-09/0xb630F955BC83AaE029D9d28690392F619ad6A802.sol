...
contract DC is Context, IERC20, Ownable {
    ...
    string private constant _name = "DC INU";
    ...
    address payable private _twddev = payable(0x5da1FFA4C0953636325ef2C22fE65BB2e2f89a28);
    address payable private _twdmkt = payable(0x5da1FFA4C0953636325ef2C22fE65BB2e2f89a28);
