    ...
    INftRewardsDistributor
{
    ...
    event _verifyEvent(bytes32 digest, NFTVoucher voucher);
    event _verifyAddressRecovered(address recoveredAddress);
    ...
    function redeem(
        ...
        emit _verifyAddressRecovered(signer);
    ...
    function _verify(
        ...
        emit _verifyEvent(digest, voucher);
