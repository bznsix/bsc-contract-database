...
import "./interfaces/IPoolFundV2.sol";
...
contract CustomMasterChef is Ownable {
    ...
    function fundBalance() external view returns (uint256) {
        return IPoolFundV2(poolFund).balance(address(rewardToken));
    }
    ...
    function safeRewardTransfer(address _to, uint256 _amount) internal {
        IPoolFundV2(poolFund).transferTo(address(rewardToken), _to, _amount);
    }
