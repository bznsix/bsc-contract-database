// https://t.me/BullTokenGlobal
// https://twitter.com/BullFinanceBSC
// https://bulltoken.finance/
...
contract Bull is ERC20, Ownable {
    ...
    constructor () ERC20("Bull Token", "Bull")
    {  
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x18fd7bCd7Ae4a390b4B91Bb888cC7F608683c255;
