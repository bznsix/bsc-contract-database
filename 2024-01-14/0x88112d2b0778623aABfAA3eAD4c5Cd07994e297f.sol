...
contract Ownable is Context {
    ...
    constructor() {
        address msgSender = 0x8ab98a40263eB869975605E8Ac719446997647EC;
        _owner = msgSender;
...
contract Abrcoin is Context, IBEP20, Ownable {
    using SafeMath
    for uint256;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(BlackListedAddresses[sender] == false, "The sender is blacklisted");
        require(BlackListedAddresses[recipient] == false, "The recepient is blacklisted");
