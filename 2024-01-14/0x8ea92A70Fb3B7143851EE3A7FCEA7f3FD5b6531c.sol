...
* ____                 _      _____                           _ 
*|  _ \               | |    / ____|                         | |
*| |_) |  ___   _ __  | | __| (___    __ _  _   _   __ _   __| |
*|  _ <  / _ \ | '_ \ | |/ / \___ \  / _` || | | | / _` | / _` |
*| |_) || (_) || | | ||   <  ____) || (_| || |_| || (_| || (_| |
*|____/  \___/ |_| |_||_|\_\|_____/  \__, | \__,_| \__,_| \__,_|
*                                       | |                     
*                                       |_|                     
*/
...
contract BonkSquad is Ownable, ERC20 {
    bool public limited;
    ...
    constructor() ERC20("BonkSquad", "BONKSQUAD") {
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklists[to] && !blacklists[from], "Account blacklisted");
