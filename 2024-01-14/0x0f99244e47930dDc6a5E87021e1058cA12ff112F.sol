...
contract XRGE is ERC20, Ownable {
    ...
    constructor () ERC20("RougeCoin", "XRGE") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x2643c9E48C2f11c2147179306CDEd26040C8a31F;
    ...
    _mintOnce(owner(), 18e9 * (10 ** decimals())); //  18 billion tokens
