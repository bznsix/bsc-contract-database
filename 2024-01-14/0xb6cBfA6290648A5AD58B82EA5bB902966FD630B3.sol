// NANOPLAY - LP BURN & RENOUNCE
// tg : https://t.me/whensirwhenbsc
...
contract WhenSirWhen is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x6299f537E6fef88665679402E4E5295Ff992Bb4C);
    address payable private _twdmkt = payable(0x6299f537E6fef88665679402E4E5295Ff992Bb4C);
    
    string private constant _name = "WHEN SIR WHEN";
    string private constant _symbol = "$WSIRW";
