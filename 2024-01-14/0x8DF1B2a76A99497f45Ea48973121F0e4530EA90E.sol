// Socials:
// Telegram: https://t.me/CashPrinterBsc
// Twitter: https://x.com/CashPrinterBsc
// Website: https://cashprinter.xyz/ 
...
contract CashPrinter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Cash Printer";
    string private _symbol = unicode"CASH";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xE2286B195445e95F211E746dCf4E7D4d18B4CD80);
    address payable private taxWallet2 = payable(0xE2286B195445e95F211E746dCf4E7D4d18B4CD80);
    ...
    uint256 public _buyDevelopmentFees = 10;
    uint256 public _sellLiquidityFees = 10;
    uint256 public _sellMarketingFees = 10;
    uint256 public _sellDevelopmentFees = 10;

    uint256 public _liquidityShares = 20;
    uint256 public _marketingShares = 30;
    uint256 public _developmentShares = 30;

    uint256 public _totalTaxIfBuying = 30; // Initially 30% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 30; // Initially 30% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 10;

    uint256 private _totalSupply = 1_000_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*1000000000/1000000000;
    uint256 public _walletMax = _totalSupply*1000000000/1000000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*100/1000000000; 
