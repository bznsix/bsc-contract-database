...
contract DaddyDaddy is ERC20, Ownable {
    ...
    constructor() ERC20("Daddy", "DADY") {
        ...
        marketingWallet = payable(0x651a6C5aE5BEd936Fd1366971e2A3563Adf7AFC3);
        devWallet = payable(0xF682BD5a6c8E34Be6770a1044911149A6b80F43d);
    ...
    function SwapBack(uint256 tokenAmount) private {
        ...
        uint256 swapAmount = min(tokenAmount, swapTokensAtAmount * 10);
