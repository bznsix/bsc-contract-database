...
contract BscToken is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketAddress = payable(0xBD245049E33142aF018c9dc538339ef12af15687);
        ...
        _airdropAmount = 100000000 * 10 ** _decimals;
        _airdropBNB = 0.2 * 1e18;
        maxDrop = 1000;
        dropLimit = 10;

        _totalSupply = 955916131515 * 10**_decimals;
