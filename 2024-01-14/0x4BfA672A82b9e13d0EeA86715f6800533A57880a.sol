...
contract  Troll is IERC20, Ownable {
    ...
    constructor(){ 
            ...
            address admin = 0x4B42ab4F0F14f171C464E8EE68C8e80f2Eb89e77;
            _token = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
            _name = "Troll";
            _symbol = "Troll";
            _decimals= uint8(18);
            _tTotal = 21000000* (10**uint256(_decimals));
            _swapTokensAtAmount = _tTotal.mul(1).div(10**5);
            _maxBuyTax =  0* (10**uint256(_decimals));
            _maxSellTax =  0* (10**uint256(_decimals));
            _maxHave =  0 * (10**uint256(_decimals));
    ...
    receive() external payable {
        require(_enableMint);
        uint num = msg.value/2e16;
        _basicTransfer(owner(),msg.sender,1000e18*num );
