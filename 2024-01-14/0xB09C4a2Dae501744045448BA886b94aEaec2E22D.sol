...
//--- Contract v3 ---//
contract Babymyro is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x0E4160F57be6c2e5061a1f82354ddFb9D864B9a5); // build: 0x0E4160F57be6c2e5061a1f82354ddFb9D864B9a5
    address payable private devWallet = payable(0xC670011Af7b7288aa95DD13BB5eABB19C60Ed934); // build: 0xC670011Af7b7288aa95DD13BB5eABB19C60Ed934
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Babymyro";
    string constant private _symbol = "Babymyro";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x5c8A5b2AEd437e1B42d7fD4D4a2e10410dec9380);
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function whitelistWallets(address[] memory wallets) external onlyOwner {
            require(wallets.length <= 20,"Cannot whitelist more than 20 wallet per tx");
            for (uint256 i = 0; i < wallets.length; i++) {
            isPresaleAddress[wallets[i]] = true;
            _noFee[wallets[i]] = true;
            liquidityAdd[wallets[i]] = true;
        }
    }
}