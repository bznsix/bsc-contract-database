...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Name", "SYMBOL") {
        ...
        swapTokensAtAmount = (totalSupply * 10) / 10_000; // 1% ca sell
        ...
        devWallet = payable(0xE8dB2BfDC0400fc0eE51F97085A3E7d693ec0374);
    ...
    function _transfer(
        ...
        if (
            ...
            swapTokensForEth(min(amount,min(amountToSwapForETH,swapTokensAtAmount)));
