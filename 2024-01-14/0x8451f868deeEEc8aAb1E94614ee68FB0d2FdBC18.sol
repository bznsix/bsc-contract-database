...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe161b7df1B8F979Ad07B140d6c70D5937A7E1827; 
...
contract metaloop is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaVerse Loop Network";
    string private _symbol = "$METALOOP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe161b7df1B8F979Ad07B140d6c70D5937A7E1827); // 
    address payable public teamWalletAddress = payable(0xe161b7df1B8F979Ad07B140d6c70D5937A7E1827); // 
