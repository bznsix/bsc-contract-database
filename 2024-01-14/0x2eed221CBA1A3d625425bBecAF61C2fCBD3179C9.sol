...
████──█──█─████────█───████──███─████─█──█─────█──███
  ...
  network: BNB
  Website : https://babybbuck.vercel.app/
  Telegram : https://t.me/BabyBuckOfficial
...
contract BBUCKv3 is ERC20, Ownable {
    ...
    constructor () ERC20("BabyBuck", "BBUCK") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x6A2e905146bb234364C0fc9C071ba3135E802c9b;
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy) external onlyOwner {
        ...
        require(feeOnSell <= 8, "CSLT: Total Fees cannot exceed the maximum");
