...
contract LCOM is ERC20, Ownable {
    ...
    address public taxWallet = 0xDC71FC294259B5C6D5db4A0a86200AdDdB2efc47;

    struct Taxes {
        uint256 tax;
    }

    Taxes public buyTaxes = Taxes(3);
