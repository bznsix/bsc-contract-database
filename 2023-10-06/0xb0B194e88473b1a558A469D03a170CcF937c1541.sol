...
/* Token contract */
contract NewCommunityHotBit is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x0936D0C7BB578F11f5c115aaa4075a92ba4da3A8;
 
    // These are owner by default
    address private autoLiquidityReceiver; 
    address private marketingFeeReceiver = 0x41ab390400BFc31965e156CB87Aa10E71f705fA2;
 
    // Name and symbol
    string constant _name = "NewCommunityHotBit";
    string constant _symbol = "cHotBit";
    uint8 constant _decimals = 18;
 
    // Total supply
    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 1m 
 
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 1% (200 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (200 mil)
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 7; 
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (sender != owner && recipient != owner && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != DEV){
    ...
    // Enable GREED
    function enableGREED(uint256 _seconds) public onlyOwner {
