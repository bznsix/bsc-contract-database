...
contract BNB2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB2049";
    string private _symbol = "BNB2049";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFeBd6db2405F5055E4927c3345Fcd5eD5d0d1211); 
    address payable public teamWalletAddress = payable(0xFeBd6db2405F5055E4927c3345Fcd5eD5d0d1211);
