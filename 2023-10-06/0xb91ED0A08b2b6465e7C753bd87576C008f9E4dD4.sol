...
contract SWIFFTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public fvcdcx47;
    ...
    string private _tokenname = "Swiff Token";
    string private _tokensymbol = "SWIFF";
