...
contract NASADOGE is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 200000 * 10**_decimals; 
    uint256 public maxTxAmountSell = 200000 * 10**_decimals; 
    uint256 public maxWalletAmount = 200000 * 10**_decimals; // 2% of supply
    ...
    string private constant _name = "MarsDoge";
    ...
    function setMaxWalletAmountExceptElon(uint256 _maxWalletAmountPct) external onlyOwner {
...
//After setting trading open, cannot be closed
   function enableTrading() external onlyOwner {
    ...
    function rescueAnyElonsTokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function fullWhitelistMaye(address _address) public onlyOwner{
        _isExcludedFromFee[_address] = true;
        _isExcludedFromMaxWallet[_address] = true;      
    }

    function excludeElonFromMaxWallet(address account, bool excluded)
        external
        onlyOwner
    {
        require(
