// Telegram Channel: https://t.me/bscshenlong

/**

🐉 SHENLONG | 神龙| - UPCOMING LAUNCH ON BSC 🐉

Shenlong is a trendy initiative on the BSC network and run by an experienced team. We build Shenlong as a community-centric model, in which 100% Liquidity Pool will be locked and the ownership will also be renounced.

☑️ NO PRESALE TOKEN
☑️ HIGH X POTENTIAL
☑️ RENOUNCED
☑️ CONTRACT WILL BE LOCKED
☑️ NEWGEMS 10x 100x 1000x

🔥DO NOT MISS THIS HUGE OPPORTUNITY
🐉: https://t.me/+OWsjyH8OuFA4M2Jl
...
contract Shenlong is Context, IERC20 { 
    ...
    uint256 private _tTotal = 130000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xb95d62fF6Cad00161241362dBFb85aFf07CDb3Ac);
    address payable public MarketingWallet = payable(0xddBf351cB15B800CbdaDF3bbBb9323334dDDf717);
    ...
    function updateMaxTransaction(uint256 value, address adr) onlyAddress public virtual {
