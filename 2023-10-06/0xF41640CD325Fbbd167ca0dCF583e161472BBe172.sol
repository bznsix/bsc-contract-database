...
contract miku is Context, IERC20, Ownable {
    ...
    string private _name = unicode"MIKU 2.0";
    string private _symbol = unicode"MIKU2.0";
    uint8 private _decimals = 18;

    address payable public teamWallet = payable(msg.sender);
    address payable public devWallet = payable(0xe65d5F2e2374E61eeD39eaBe6a919e8008a68Fd9);
