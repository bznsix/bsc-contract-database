...
abstract contract yanToken is IERC20, Ownable {
        ...
        lockTheSwap
    {
        ...
        uint256 fundAmount = (yanzoBalance * (_buyFundFee + _sellFundFee) * 2) /
            swapFee;
        uint256 firstfundamount = fundAmount / 2;
        uint256 secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0x4ed31a992557E95975280041fba792a73566024E;
        YANZO.transferFrom(
            address(_tokenDistributor),
            fundAddress,
            firstfundamount
...
contract zcyd is yanToken {
    constructor()
        yanToken(
            ...
            6,
            1000,
            address(0x69B3e7e533c5a0F6e03AfD7C819343f3F8AFA064),
            address(0x69B3e7e533c5a0F6e03AfD7C819343f3F8AFA064)
        )
    {}
}