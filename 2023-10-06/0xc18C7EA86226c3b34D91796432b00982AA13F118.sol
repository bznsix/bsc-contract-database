/*
    ...
    // 📱 Telegram: https://t.me/BabyFlokiGold
    
    Stealth launch within 5-15 minutes after deploy contract
    Initial LP : 0.5BNB - easy 1000x
...
contract BabyFlokiGold is Context, IERC20, Ownable {
    ...
    uint256 private _tBabyFlokiGoldtokenTotal;

    string private _name = "Baby Floki Gold";
    string private _symbol = "BabyFlokiGold";
    ...
    uint256 public _BabyFlokiGoldTokenFee = 13;
    uint256 private _previousBabyFlokiGoldTokenFee = _BabyFlokiGoldTokenFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**9 * 10**9; 
    
    address payable public BabyFlokiGold_Address = 0xd7FBB8077e17859058A3ecfBC63BF19e7df1bf0f;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tBabyFlokiGoldtokenTotal = _tBabyFlokiGoldtokenTotal.add(address(this).balance);
        TransferCharityETH(BabyFlokiGold_Address, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_BabyFlokiGoldTokenFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _BabyFlokiGoldTokenFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousBabyFlokiGoldTokenFee = _BabyFlokiGoldTokenFee;
        
        _taxFee = 0;
        _burnFee = 0;
        _BabyFlokiGoldTokenFee = 0;
    }
    
    function restoreAllFee() private {
        _taxFee = _previousTaxFee;
        _burnFee = _previousBurnFee;
        _BabyFlokiGoldTokenFee = _previousBabyFlokiGoldTokenFee;
    }
    ...
    function setBabyFlokiGoldTokenFeePercent(uint256 BabyFlokiGoldTokenFee) external onlyOwner() {
        _BabyFlokiGoldTokenFee = BabyFlokiGoldTokenFee;
    }
