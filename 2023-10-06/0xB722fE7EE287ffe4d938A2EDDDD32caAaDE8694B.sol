...
contract ZHENLONG is ERC20, Ownable {
    ...
    constructor() ERC20("Zhenlong", unicode"ZLONG振龙") {
        ...
        maxTransactionAmount = 5 * 1e6 * 1e18; 
        maxWallet = 5 * 1e6 * 1e18; 
        swapTokensAtAmount = (totalSupply * 10) / 5000; 
        ...
        devWallet = address(0xEeD7Fe3eeb34b078Ad8E49dD5F475DFD847e4e71); 
