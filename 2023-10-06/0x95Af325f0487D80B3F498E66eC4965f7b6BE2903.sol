...
// RELAUNCH!!
//BabyShiba 2.0 is not just a meme coin. It was built to spark social impact in the crypto world, especially NFT holders. 
//The growth of the project does not only depend on the developers, but also on community engagement and involvement. 
//BabyShiba2.0 moon🌕🌕
//TELEGRAM:https://t.me/babyshiba2official
//Website:https://www.babyshib2.vip/
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Fb5704AE0180f014b476c51597EF7e0412DA39A;
...
contract BabyShiba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420000000000 * 10**9;
    uint256 public _maxTxAmount = 420000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT =  100* 10**9; //
    string private constant _name = "BabyShiba 2.0"; // 
    string private constant _symbol = "BABYSHIBA 2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x0Fb5704AE0180f014b476c51597EF7e0412DA39A);
