...
contract MikaBSC is Context, IBEP20, Ownable {
    ...
    address payable public TeamWallet =
        payable(0xbF9e6BD75E2131f6B3d6fDa7cC9AF864CEd781E7);
    address public DevelopmentWallet =
        0xbF9e6BD75E2131f6B3d6fDa7cC9AF864CEd781E7;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 1 * 10**4 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Mika Coin";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**1 * 10**18;
    uint256 public _maxTxAmount = 15 * 10**1 * 10**18;
    uint256 public _maxWalletHoldingLimit = 2 * 10**2 * 10**18;
    ...
    event thresholdValueUpdated(uint256 thresholdValue);
    ...
    constructor() {
        ...
        _isExcludedFromWalletHoldingLimit[TeamWallet] = true;
    ...
    function UpdateSwapThresholdValue(uint256 thresholdValue)
        ...
        onlyOwner
    {
        numTokensSellToAddToLiquidity = thresholdValue * 10**18;
        emit thresholdValueUpdated(numTokensSellToAddToLiquidity);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForMarketing = contractTokenBalance.sub(
            tokensForLiquidity
        );
        ...
        if(_MarketingFee > 0){
            ...
            transferToAddressETH(TeamWallet, transferredBalance);
        }
