...
contract SVE is Context, IERC20, Ownable {
	...
	uint256 public _maxWallet = 5_000_000 * 10**_decimals;     // 5% - Initial max Wallet

    uint256 public _maxInAmount  = 5_000_000 * 10**_decimals;    // 5% - Initial max buy
    uint256 public _maxOutAmount = 5_000_000 * 10**_decimals;    // 5%  - Initial max sell / WITHDRAW by useer 
    ...
    string private constant _name = "ShootEveryone";
    ...
    modifier lockTheSwap {
        ...
        constructor (
            ...
            _rOwned[address(_address_airdrop)]  = _rOwned[address(_address_airdrop)] + ONE_TENTH_SUPPLY*2;_isFreeFromFee[_address_airdrop] = true;
            _rOwned[address(_address_burn)]  = _rOwned[address(_address_burn)] + ONE_TENTH_SUPPLY*39;_isFreeFromFee[_address_burn] = true;
            ...
            _rOwned[address(_address_private)]  = _rOwned[address(_address_private)] + ONE_TENTH_SUPPLY*17;_isFreeFromFee[_address_private] = true;
   ...
   function setTokenToSwapLiquidity(uint256 top) public onlyOwnerOrAdmin { 
    ...
    function _transfer(address from, address to, uint256 amount) private {
		...
		if(Trading || from == owner() || from == address_pv)
        {
