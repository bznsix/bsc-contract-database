/**
https://t.me/Squiba_Inu                                                                                            

The combined hype of the Inu and Squid fads!
...
contract SQUIBAINU is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SQUIBA INU';
    ...
    //DevWallets
    address public Development=payable(0x29d9697659E77596E761dd4B1493867e1B1d4f57);
    address public Marketing=payable(0x8B226d59e104b7017140c0FaE3130d4d0634B507);
    //MainNet
	...
	uint256 private MaxBuy = 2000000 * 10**_decimals;
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD Rewards
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 385000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingETH() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Development).transfer((amount*15) / 100);
        payable(Marketing).transfer((amount*85) / 100);
    } 
