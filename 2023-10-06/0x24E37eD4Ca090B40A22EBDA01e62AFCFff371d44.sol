// BBFLOKI is the currency that rewards holders with passive income (10% of daily volume as a form of ADA will be distributed to holders depending on their shares)
// As we are aiming to use the token to pay for our services that will be available along our way (play to earn games, sports bets, lottery)
// We have a team of the best guys in the sector that can have strong hands achieving project vision.
//Liquidity will be locked for 20 years / Also we are having Multisig Wallet for funds security (marketing and reserve token that will be burned along the way) 
// We will make burns of 10,000,000,000 ADACASH every week for 10 years...
//                                               💎    WELCOME TO BOSS BABY FLOKI INU   💎
//Telegram: t.me/bbfloki_official
//Website: wwww.bbfloki.com
...
contract bbfloki is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BBFLOKI";
  string private _name = "BOSS BABY FLOKI INU";
