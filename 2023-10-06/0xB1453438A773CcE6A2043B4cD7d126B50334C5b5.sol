...
contract PPEPETOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ynnxa3;
    ...
    string private _tokenname = "Pinkpepe";
    string private _tokensymbol = "PPEPE";
