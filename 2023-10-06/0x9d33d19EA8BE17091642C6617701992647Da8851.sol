...
Telegram https://t.me/NewCommunityChihuahua
website https://NewcommunityChihuahua.net
*/
...
contract NcChihuahua is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community CHIHUAHUA";
    string private _symbol = "NC.CHIHUAHUA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x242Cabec314905Cb4F73dd75087abCAD7d4a02f2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF9ed6c951007075d466C2Dedd471757676f22042); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**8 * 10**9;
