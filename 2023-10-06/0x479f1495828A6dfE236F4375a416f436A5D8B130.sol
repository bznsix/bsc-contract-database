...
contract SQUIDINU is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000000 * 10**4 * 10**5;
    ...
    address payable private _developmentAddress = payable(0x84F9139B67a80D6488357AcAABF852580Bb55f1a);
    address payable private _marketingAddress = payable(0xFA6f1Db52c231C74A1697A072a461366E4bDCf88);
