...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFDa4E6449f3bA58a39085Eb522ce195DAa026852;
...
contract SbibaGem is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFDa4E6449f3bA58a39085Eb522ce195DAa026852;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shiba Gem";
    string private _symbol = "SHIBG";
    ...
    uint256 public swapLimit; // Declare swapLimit as a state variable
    ...
    constructor () {
     ...
     function setSwapLimit(uint256 _newLimit) external onlyOwner {
        swapLimit = _newLimit;}
