/**
   ...
   Welcome to BabyStellar
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyStellarCommunity
...
contract BabyStellar is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Stellar";
    string private _symbol = "BABYXLM";
