...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd55040da0dA77357b9124CEcced3DCba34c5Bebf; //  Dev Wallet
...
contract Pepecula is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepecula";
    string private _symbol = "PEPECULA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd55040da0dA77357b9124CEcced3DCba34c5Bebf); //  Marketing Address
    address payable public teamWalletAddress = payable(0xd55040da0dA77357b9124CEcced3DCba34c5Bebf); // Team Address
