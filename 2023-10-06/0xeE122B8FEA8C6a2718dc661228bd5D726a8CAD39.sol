...
contract SpaceMoon is Context, IERC20, Ownable {
    ...
    string private _symbol = "SpaceMoon";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x239C1ed2Ee06348943A5bD9a1844AdA855224a87); // Marketing Address
    address payable public teamWalletAddress = payable(0x969A6135a8A5CD840b4D84930AD3512bf71E0Eab); // Team Address
