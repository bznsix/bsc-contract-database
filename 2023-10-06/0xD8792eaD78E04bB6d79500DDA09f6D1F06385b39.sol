...
contract Duckcoin is Ownable, AccessControl, ERC20, ReentrancyGuard {
  ...
  uint8 public liquidityPercentageForEcosystem = 5;
  ...
  function _swapAndLiquify(uint256 amount) private lockswap nonReentrant {
  ...
  function setTaxCollector(address _taxCollector) external onlyOwner nonReentrant {
  ...
  function retrieveEther(address to) external onlyOwner nonReentrant {
