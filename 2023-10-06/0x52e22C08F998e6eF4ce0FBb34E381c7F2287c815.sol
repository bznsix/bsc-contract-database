...
contract ETSUKO is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x7db5F6029407d7D7511bE4fc35E94C92c3D71D05)); // MarketingWallet
    ...
    constructor() ERC20("Etsuko Inu", "ETSUKO") {
