...
contract Vault {
    ...
    function lockTokens(address token, address stable, uint256 amount) external {
        ...
        SafeERC20.safeTransferFrom(IERC20(vaults[token].stable), msg.sender, address(this), amount);
    }
