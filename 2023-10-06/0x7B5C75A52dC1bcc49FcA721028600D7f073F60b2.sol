...
contract LONG is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "LONG3.0";
        _decimals = 18;
        address ReceiveAddress = 0x3399b7D96e6F2298BAFfbD6af52D117E2B50a6D9;
        address FundAddress = 0xF8F7fD6D1a2fa39B937AEE7f403E001D1Ec3D197;
        address Fund2Address= 0xF8F7fD6D1a2fa39B937AEE7f403E001D1Ec3D197;
    ...
    function _calPreList() private {
        ...
        path[1] = address(this);
        uint256 balance = IERC20(_wbnb).balanceOf(address(this));
    ...
    function _transfer(
        ...
        if (_mainPair == address(0)) {
            ...
            address usdtPair = swapFactory.getPair(address(this), _wbnb);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                swapFeeAmount =
                    (tAmount * (_buyFundFee+_buyFund2Fee + _buyLPDividendFee + _buyLPFee)) /
                    10000;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee+fund2Fee + lpDividendFee + totalLPFee;
        ...
        uint256 fundUsdt = (bnbBalance * fundFee * 2) / totalFee;
        if (fundUsdt > 0) {
            (bool success, ) = fundAddress.call{value: fundUsdt}("");
            require(success, "Transfer failed");
        }
        uint256 fundUsdt2 = (bnbBalance * fund2Fee * 2) / totalFee;
        if (fundUsdt2 > 0) {
            (bool success, ) = fund2Address.call{value: fundUsdt2}("");
            require(success, "Transfer failed");
        }
        uint256 lpUsdt = (bnbBalance * totalLPFee) / totalFee;
        if (lpUsdt > 0) {
