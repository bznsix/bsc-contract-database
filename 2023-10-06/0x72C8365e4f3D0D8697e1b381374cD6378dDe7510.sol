...
contract WSPTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public fxczv5;
    ...
    string private _tokenname = "Wall Street Pepes";
    string private _tokensymbol = "WSP";
