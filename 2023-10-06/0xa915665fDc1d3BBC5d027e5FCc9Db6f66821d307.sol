/************************************
 * Not sure if this will be a thing yet, actively blacklisting all the things and everything that shouldnt be here will be blacklisted
 * dont come crying that you cant sell because, the only reason you wont be able to sell is you buy this when you shouldmt. Like, before
 * a launch, if in fact that's what we will be doing. Who knows, life is fun like that. Have some patience and see what comes and then you 
 * might be surprised. 
 ************************************/
...
contract SquidgemonBro is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squidgemon Bro";
    string constant _symbol = "Squidge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // (_totalSupply * 10) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 1; // 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9cC3A5A6E803b5DB47A9745c02e7E11C9E01cC0B;
        devFeeReceiver = 0x92E426E78fdcF107680E62c7Bf22026b5b25146a;
