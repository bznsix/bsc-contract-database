...
contract SAFEREUMTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public iaqzx12;
    ...
    string private _tokenname = "Safereum";
    string private _tokensymbol = "SAFEREUM";
