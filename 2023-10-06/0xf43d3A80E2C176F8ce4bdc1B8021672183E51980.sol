...
contract SpookyMario is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Mario";
    string private constant _symbol = "SPKYMARIO";
