...
https://t.me/Jiggybsc
https://twitter.com/Jiggybsc
$USDT Reward Token - 11% $$$
381Q Jiggies Total
*/
...
contract Jiggy is ERC20, Ownable {
    ...
    mapping (address => bool) private _isJiggyExcluded;
    mapping (address => bool) private _isJiggiesExcluded;
    ...
    constructor() payable ERC20 ("Jiggy", "JIGGY") {
        ...
        marketingWallet =  0x239F6869b86fC6Eff1759B4c76953313235983B9;

        dividendTracker = new DividendTracker(381 * 10**5, rewardToken);
        ...
        _isWalletExcluded[0x239F6869b86fC6Eff1759B4c76953313235983B9] = true;
    
        _mint(owner(), 381 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 420000 * 381;
    }
