...
contract DAMON is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DAMON";
    string constant _symbol = "$DAMON";
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xCD429360f2BF79669Af865984715a6674d848b99 ;
