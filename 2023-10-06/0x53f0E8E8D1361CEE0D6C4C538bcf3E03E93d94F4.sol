...
contract WenMoonSer is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WenMoonSerDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WenMoonSer", "Wen") {
        marketingWallet = payable(0x8AE1A86050660956F7e76de4aC4dbdeE5660aEA1);
        devWallet = payable(0x5596F272cb80B9B388bCb9d3F5f03BFeffDf1E53);
        ...
        dividendTracker = new WenMoonSerDividendTracker(
            payable(this),
            router,
...
contract WenMoonSerDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WenMoonSer public WenMoonSerContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WenMoonSerContract = WenMoonSer(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WenMoonSer_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WenMoonSer_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WenMoonSer? contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WenMoonSerContract);

            uint256 prevBalance = WenMoonSerContract.balanceOf(address(this));
            ...
            {
                uint256 received = WenMoonSerContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WenMoonSerContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
