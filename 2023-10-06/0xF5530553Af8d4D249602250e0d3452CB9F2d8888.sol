...
contract FCL is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "FCL";       //Full name
    string public symbol_ = "FCL";      //abbreviation

    uint256 public deadFee = 5;       //Destroyed
    uint256 public liquidityFee = 10;      //LP reflow
    uint256 public marketingFee = 5;      //marketing
    uint256 public foundationFee = 5;      //Buyback pull order
    uint256 public lpRewardFee = 10;       //Add LP dividends
    address public lpRewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;      //Dividend tokens

    uint256 public maxburn = 888887 * (10**18); //max burn

    uint256 private AmountLiquidityFee;  
    uint256 private AmountLpRewardFee;
    uint256 private AmountmarketingWalletFee;
    uint256 private AmountfoundationWalletFee;


    address public marketingWalletAddress = 0x154f5C889373ed4ccDf1d3201fFb101fC5F62e51;  //Marketing address
    address private foundationWalletAddress = 0x154f5C889373ed4ccDf1d3201fFb101fC5F62e51;  //Buyback Guard
    address private liquidityReceiveAddress = 0x154f5C889373ed4ccDf1d3201fFb101fC5F62e51;   // burn
    address public deadWallet = 0x154f5C889373ed4ccDf1d3201fFb101fC5F62e51;    // burn
    ...
    constructor(
        ...
        uint256 totalSupply = 888888 * (10**18);       //Supply
        swapTokensAtAmount = totalSupply.mul(1).div(50000); // 0.00001
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function _transfer(
        ...
        if((_isExcludedFromFees[from] || _isExcludedFromFees[to]) ||
            (balanceOf(deadWallet) >= maxburn)) {
            takeFee = false;
        }

        if(takeFee) {
            if(from != uniswapV2Pair){
                uint256 minHolderAmount = balanceOf(from).mul(10000).div(10000);
