...
/**
   ...
   Welcome to CROWNCOIN
   
   This is a community token. If you want to create a telegram I suggest to name it to @CROWNCOINBSC
   ...
   I will renounce the ownership to burn addresses to transfer #CROWNCOIN to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #CROWNCOIN 10000X? 
   ...
   it's the best part of the #CROWNCOIN idea, increasing the liquidity pool automatically, 
...
contract CROWNCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "CROWNCOIN";
