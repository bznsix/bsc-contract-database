...
// Tax %10 - All will be used for marketing

// https://t.me/LokiCoinBSC_Chat
// https://twitter.com/LokiCoinBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a79Db3C36207caF4C2badd1BA8B22A1DF0Cb359;
...
contract LOKI is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x7A1EC41b719Ca813a906a9a0d3420f6E5CE6Ccfd);
    ...
    string private _name = "LOKI SEASON 2"; 
    ...
    // This includes the buy AND the sell fee! 100 is equal to 10%
    uint256 private maxPossibleFee = 180; 


    // Setting the initial fees - These are Equal to Same % as seen
