...
contract BinanceDog is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Binance Dog";
    string private _symbol = unicode"WFH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x2a4E847973573C86a84caeAcF48bebF31A442AEE);
    address payable public teamWalletAddress =
        payable(0xCc0b815692C19a1650e7cccEaFA611b51f98808f);
