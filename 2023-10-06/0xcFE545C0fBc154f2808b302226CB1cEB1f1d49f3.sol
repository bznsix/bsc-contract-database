...
contract TmntToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 1288 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 3 * 10**_decimals;

        fundAddress = 0xfB0eF5eD70008849753FCf900493d18220F1d9BA;
        devAddress = 0xfB0eF5eD70008849753FCf900493d18220F1d9BA;
