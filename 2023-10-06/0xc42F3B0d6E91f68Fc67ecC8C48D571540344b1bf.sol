...
contract PresaleLUPI is Claimable {
    event Claim(address to, uint256 amount);

    IERC20 public token;

    uint256 preSaleAmount = 50550 * 10**18;
    uint256 feeAmount = 0.05 * 10**18;
    ...
    function presale() public payable{
        ...
        require(token.transfer(msg.sender, preSaleAmount), "presale failed");
