...
Telegram - https://t.me/Waterdoxed
...
/* Token contract */
contract WaterDoxed is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xEe1B0685aC0c77f2A66931DB00CD7b57100cf577;
    ...
    // Name and symbol
    string constant _name = "Water Doxed";
    string constant _symbol = "$DOXWater";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000 * (10 ** _decimals); // 1m 
    ...
    uint256 public marketingFeeBuy = 11;
    uint256 public devFeeBuy = 0;
    uint256 public totalFeeBuy = 13;
