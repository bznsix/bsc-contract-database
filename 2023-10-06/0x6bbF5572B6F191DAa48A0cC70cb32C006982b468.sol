...
contract SafeGoku is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Goku";
    ...
    address payable public marketingWallet = payable(0x0Ce69983D0cf0eFBbe36F1dcf2DBA262B414C812);
    ...
    uint256 public numTokensSellToAddToLiquidity = 3500000 * 10**18;
    uint256 public _maxTxAmount = 3500000 * 10**18;
    uint256 public _maxWalletLimit = 3500000 * 10 ** 18;
