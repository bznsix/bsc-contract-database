...
contract PIKO is Context, IERC20, Ownable {
    ...
    string private _name = "PIKO";
    string private _symbol = "PIKO";
    ...
    constructor () public {
        ...
        _marketingWallet = 0x58d52335E659D40BE715Acf9aC9d48B2dFA5f92e;
        
        _charityWallet = 0x58d52335E659D40BE715Acf9aC9d48B2dFA5f92e;
    ...
    function setFees (uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee) external onlyOwner {
        _taxFee = taxFee;
    ...
    function _transfer(
        ...
        uint256 charityFee = amount * _charityFee / 100;
        ...
        _tokenTransfer(from,to,amount .sub(marketingFee) .sub(charityFee),takeFee);
