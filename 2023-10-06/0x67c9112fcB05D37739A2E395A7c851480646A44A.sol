...
contract Minerval is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 29_999_999_999 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 22_000_000 * 10**9;
    uint256 public maxBuyLimit = 299_000_000 * 10**9;
    uint256 public maxSellLimit = 299_000_000 * 10**9;
    uint256 public maxWalletLimit = 299_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public CallWallet = 0x0C54Cf7e958581cAA9704A651210c4d5946cEf88;
    address private devWallet = 0x0C54Cf7e958581cAA9704A651210c4d5946cEf88;
    address public buyBurnAddLiQ = 0x05206c14c51e0D76f1DB415b07B0A1c9BAeA5fdE;

    string private constant _name = "Minerval";
    string private constant _symbol = "MNRVL";
    ...
    Taxes public taxes = Taxes(0, 0, 5, 0, 10);
    Taxes public sellTaxes = Taxes(0, 0, 5, 0, 10);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[buyBurnAddLiQ] = true;
        ...
        allowedTransfer[buyBurnAddLiQ] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(buybackAmt > 0){
            payable(buyBurnAddLiQ).sendValue(buybackAmt);
        }
    ...
    function updatebuyBurnAddLiQ(address newWallet) external onlyOwner{
        buyBurnAddLiQ = newWallet;
    }
