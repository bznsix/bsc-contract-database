...
/* Gamified Coin Binance launch Pad- BNB Reward Token

website: dragondefiland.com
...
contract dragondefiland is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc6400996AD4015c5B0345010E25Cc97dA38Ab489); // Marketing Address
    address payable public charityAddress = payable(0xc6400996AD4015c5B0345010E25Cc97dA38Ab489); // Charity/Dev Address
    ...
    string private _name = "Dragon Defi Land";
    string private _symbol = "REA";
    ...
    uint256 public _maxTxAmount = 8000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 8000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   6000000000000000; //0.002 BNB Airdrop fee
    uint256 private _airdropToken = 50000000000000000000; // 50; token will be given on airdrop
    ...
    uint256 private salePrice = 80000;// 0.01*800 token for 0.01 bnb (set as per requirements)
