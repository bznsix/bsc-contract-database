...
contract AXIOMSPACE is Context, IERC20, Ownable {
    ...
    string private _name = "AXIOMSPACE";
    string private _symbol = "AXIOMSPACE";
    ...
    uint256 public _fnftFee = 6;
    uint256 private _previousfnftFee = _fnftFee;
    
    uint256 public _maxTxAmount = 100 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 3 * 10**5 * 10**9; 
    
    address payable private fnftWallet = 0xffc3c319aef8FDe8815fD214A9C8ddFE7Ac664f4; 
