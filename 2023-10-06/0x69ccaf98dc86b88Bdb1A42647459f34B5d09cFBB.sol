...
/* Token contract */
contract TOKENNAME is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd5adBCdAF2289a9Fe0e824503bc9DAD8e31E88a1;
    ...
    // Name and symbol
    string constant _name = "Mikunomics";
    string constant _symbol = "$MIKUN";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 5000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x00b5e2900E3df9E06D82C9Da34fDa6C705F4b922;
