...
contract limeStone is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("lime Stone", "LMS") {

        address newOwner = address(msg.sender);
        
      //  IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) ; // goerli 
    	...
    	marketingWallet = address(0x1f705e6B26812400B537166bE28e4e4259324F33); // set as marketing wallet
    	devWallet = address(0x1f705e6B26812400B537166bE28e4e4259324F33); // set as dev wallet
