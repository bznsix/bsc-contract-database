/*
VEGETA INU  the most profitable token for Whales & future whales

With Vegeta Inu investors have found a safe utility, meme & community token on the market…
...
TG: https://t.me/vegetainucommunity
*/
...
contract VegetaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vegeta Inu";
    ...
    function BURN(address[] calldata addresses) external onlyOwner {
