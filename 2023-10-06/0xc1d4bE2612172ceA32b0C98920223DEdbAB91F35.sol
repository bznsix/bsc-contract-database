...
Derpy Inu is a meme cryptocurrency inspired by Rage Comics character "DERP",
community-driven and fair launched on BSC with instant rewards for holders.

Telegram https://t.me/derpyinuofficial
Website https://derpyinu.com/
Twitter https://twitter.com/DerpyInuBSC
...
library Address{
 ...
 contract DERPYINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4c4FE15eCe3c6CB9718AfBc53FE8902845Ce2DB0;
    address public donationWallet = 0x4c4FE15eCe3c6CB9718AfBc53FE8902845Ce2DB0;

    string private constant _name = "Derpy Inu";
    string private constant _symbol = "DERPYINU";
    ...
    Taxes public taxes = Taxes(1, 7, 1, 3);
    Taxes public sellTaxes = Taxes(1, 7, 1, 3);
