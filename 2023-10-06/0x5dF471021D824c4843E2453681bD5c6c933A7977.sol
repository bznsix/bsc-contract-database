...
contract FARMYTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public jbbcf5;
    ...
    string private _tokenname = "FINE ARMY";
    string private _tokensymbol = "FARMY";
