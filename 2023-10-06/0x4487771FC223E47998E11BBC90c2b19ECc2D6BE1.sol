...
contract AmericanShiba is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 50; 
    ...
    string private constant _name = "American Shiba";
    string private constant _symbol = "$AMS";
    ...
    constructor() {
        ...
        treasuryAddress = payable(0x8CD2C9bAC0428eF24229258c160B2FB8DAEd50E2);
        devAddress = payable(0x8CD2C9bAC0428eF24229258c160B2FB8DAEd50E2);
        wAddress = payable(0x8CD2C9bAC0428eF24229258c160B2FB8DAEd50E2);
    ...
    function blacklistSniper(address botAddress, bool status) external onlyOwner {      
