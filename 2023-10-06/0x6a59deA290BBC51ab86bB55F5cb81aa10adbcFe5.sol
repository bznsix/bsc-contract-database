...
contract DODTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public iggfh7;
    ...
    string private _tokenname = "DOD";
    string private _tokensymbol = "DOD";
