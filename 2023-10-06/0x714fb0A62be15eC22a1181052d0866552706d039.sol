/**
    ...
    I make this token to hand it over to the community.
    Create the community by yourself if you are interested.   
    I will renounce the ownership to burn addresses to transfer this token to the community.
    I suggest a telegram group name for you to create: https://t.me/SUPERTOKENBSC
    ...
    5,000,000,000,000 tokens limitation per trade.
    ...
    it's the best part of the tokenidea, increasing the liquidity pool automatically, 
...
contract SUPERTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "SUPERTOKEN";
    string private _symbol = "SUPERTOKEN";
