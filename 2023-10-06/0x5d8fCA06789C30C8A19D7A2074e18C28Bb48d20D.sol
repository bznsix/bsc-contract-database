...
contract EggshellCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eggshell Coin";
    string private _symbol = "Eggshell";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x3728EFcEc75a1EaA47b13D4b33475D3fee52f501); // Marketing Address
    address payable public teamWalletAddress = payable(0xdbEC820B6cD178ED7f2Fc016D8D5f35d8ac09442); // Team Address
