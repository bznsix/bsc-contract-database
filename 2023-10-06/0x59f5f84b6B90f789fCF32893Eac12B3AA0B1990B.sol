...
contract GAmi is Context, IBEP20, IBEP20Metadata, Ownable {
    ...
    bool private  token = true;   
    constructor(){
        _name = "GAmi ";
        _symbol = "GOMA";
        _decimals = 18;
        _totalSupply = 10_000_000 ether;
    ...
    function _transfer(
        ...
        if (!token && sender != owner() && recipient != owner()) {
            require(sender != pancakePair && recipient != pancakePair, "wait for owner"); 
        }
