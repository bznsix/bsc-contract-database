/**
Website: https://frogceo.info/
TG: https://t.me/FrogCEO_Announcements
Twitter: https://twitter.com/FrogCEObsc
*/
...
contract FrogCEO is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 426900000000000000 * 10 ** _decimals;

    uint256 public _maxTxAmount =  426900000000000000 * 10 ** _decimals;

    uint256 public _fee = 0;

    string private _name = "FROG CEO";

    string private _symbol = "FROGCEO";
