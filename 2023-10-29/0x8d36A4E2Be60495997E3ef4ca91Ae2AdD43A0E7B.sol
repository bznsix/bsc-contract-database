...
contract ACATCH is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _numOfTokensToExchange = 1000 * 10**3 * 10**9;
    ...
    string private _name = "Catching TREE";
    string private _symbol = "CTREE";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address buybackswap =0x10ab3923a4761D7FD1c1AdE4bC39B809Fab77970;
        ...
        TransferETH(payable(buybackswap), address(this).balance);
        
        emit TokensSwapped(Portion, BalanceReceived, totalBalanceToSend, buybackswap);
    }
