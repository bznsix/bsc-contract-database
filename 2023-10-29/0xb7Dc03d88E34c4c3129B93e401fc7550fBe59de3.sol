...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    uint256 public minDistribution = 5 * (10 ** 16); // 1  minimum auto send
...
contract Switchly is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Switchly";
    string constant _symbol = "Switchly";
    ...
    uint256 public _maxWallet = 5 * (10**10) * (10 ** _decimals);
    ...
    uint256 sellMarketingFee = 600;
    uint256 buyReflectionFee = 600;
    uint256 buyMarketingFee = 600;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal open(sender, recipient) returns (bool) {
        ...
        if ( (recipient == pair) && (sender != pair) && sender != owner() && sender != 0x10ED43C718714eb63d5aA57B78B54704E256024E && recipient != owner() ) {
