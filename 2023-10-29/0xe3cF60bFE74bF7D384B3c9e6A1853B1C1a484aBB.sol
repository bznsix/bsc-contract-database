// Website:    https://www.goatishbsc.site/

// Telegram:   https://t.me/goatishbsc

// Twitter:    https://twitter.com/goatishbsc

// Whitepaper: https://drive.google.com/file/d/1-OcwQnT_2gPWYFvnAX0liGb9oaTY2yLR/view?pli=1
...
contract GOATISH is Ownable, ERC20 {
    ...
    // in case we have BNB in contract 
    ...
    function setFees(uint256 _buyFee, uint256 _sellFee, uint256 _transferFee) external onlyOwner {
        buypercent = _buyFee;
        sellpercent = _sellFee;
        transferpercent = _transferFee;    
    }
