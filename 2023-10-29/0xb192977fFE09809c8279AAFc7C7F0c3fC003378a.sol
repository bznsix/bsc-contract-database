...
contract XFatherBot is ERC20, Ownable {
    ...
    constructor() ERC20("XFather Bot", "XFBOT") {
        ...
        revShareWallet = address(0x049434E848079B1F1AaB6e096b60c7C931e8f081); // set as revShare wallet
    ...
    function withdrawStuckXFather() external onlyOwner {
