...
// telegram : https://t.me/DevsmachmywifeBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9054C7e2377bC03dee09cd0dF24Bdd9a20B03586 ; // owner address
...
contract DevSmashedMyWife  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevSmashedMyWife";
    string private _symbol = "giggidygiggidgygiggidygiggidygiggiggiggidygiggidy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9054C7e2377bC03dee09cd0dF24Bdd9a20B03586); 
    address payable public teamWalletAddress = payable(0x9054C7e2377bC03dee09cd0dF24Bdd9a20B03586);
