...
contract MLOWEEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MLOWEEN";
    string private _symbol = "MOW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6D591BAA51523F060c78A294b2DF9426BC58fccb);
    address payable private DevelopmentWalletAddress = payable(0xFC7b5d72363ae4C4436625A93bb230c9DbE8eF02);
    ...
    uint256 private _totalSupply = 77000000000 * 10**9;
    uint256 public _maxTxAmount = 2310000000 * 10**9;
    uint256 public _walletMax = 2310000000 * 10**9;
