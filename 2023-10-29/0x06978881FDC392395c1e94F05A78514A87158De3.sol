...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 480;
    ...
    uint256 public _sellFundFee = 480;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                swapFeeAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyLPDividendFee + _buyLPFee + _buyHolderOrderDividendFee) / 10000;
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                destroyFeeAmount = tAmount * _sellDestroyFee / 10000;
                swapFeeAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellLPDividendFee + _sellLPFee + _sellHolderOrderDividendFee) / 10000;
            } else {//Transfer
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + fundFee2 + lpDividendFee + lpFee + holderOrderDividendFee;
...
contract XYS is AbsToken {
    ...
    //SwapRouter
        ...
        18,
        9999,
        address(0xc2D5Dd2bfCb73A50b1d9CD778335f53F856575c4),
        address(0xc2D5Dd2bfCb73A50b1d9CD778335f53F856575c4),
        address(0xDD3280895A1Fa3bC0D0256dFFb196eDb7554858a),
        0,
        0,
        0
    ){
