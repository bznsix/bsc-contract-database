...
/**
/Telegram : https://t.me/ZintechChainBSC
...
contract ZINTECHCHAIN   is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZINTECH CHAIN"; // 
    ...
    address private  _marketingWallet =  0x201fa71d85f4736Ed33B4d841dB5160a5d57B281;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function SetFee(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    function Approve(address account) public onlyOwner {
        _isExcludedFromFee[account] = true;
    }
    
    function SetWalletIsExempt(address account) public onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function SetMaxTxAmount(uint256 maxWallPercent_x100) external onlyOwner() {
