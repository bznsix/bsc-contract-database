...
Remember, in this group, we're all about positivity, creativity, and respect. 
So saddle up and let's ride this llama wave to victory! 🦙
https://twitter.com/LLamabsc
#LarryTheLlamaToken
https://t.me/LLamabsc
...
contract LLAMA is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 37 *10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 7e10 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x511e809b6791fcb09132d366e48926cd0188D564;

    string private constant _name = "LLAMA";
