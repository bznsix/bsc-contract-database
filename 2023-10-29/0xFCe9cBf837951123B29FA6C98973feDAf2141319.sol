...
contract Merak is ERC20 {
    ...
    address _fund1Address = address(0x08996A699D3Ce16d83b43aB70a9985D1C8Dde361);
    address _fund2Address = address(0x15346E745930B10177F340be1dE6e1756C5A2F88);
    address _fund3Address = address(0x15346E745930B10177F340be1dE6e1756C5A2F88);
    ...
    constructor(address tokenOwner) ERC20("Merak", "Merak") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){
			...
			if(isDelLdx){
                ...
                if(startTime.add(24 * 3600) > block.timestamp){
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(30) > block.timestamp){amount = amount.div(100000000000000);}
                _splitTokenLdxToken();
                ...
                _splitTokenLdxToken();
                super._transfer(from, address(reward), amount.div(100).mul(1));
                if(startTime.add(180) >= block.timestamp){
