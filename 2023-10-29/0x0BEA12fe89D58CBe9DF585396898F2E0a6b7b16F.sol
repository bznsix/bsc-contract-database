...
contract Marketplace is ERC1155, Ownable {
    ...
    constructor(address _admin, address _gameManager, string memory collectionName, string memory collectionSymbol) ERC1155("https://triibes.vemp.xyz/api/item/{id}.json") {
        admin = _admin;
    ...
    /// @param reciever the wallet address against which the token needs to be minted
    ...
    function mint(address reciever, uint256 id, string memory tokenURI) external onlyMangers {
        _mint(reciever, id, 1, "");
