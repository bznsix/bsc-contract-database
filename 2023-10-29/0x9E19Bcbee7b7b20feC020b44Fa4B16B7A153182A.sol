...
contract tiandao   is Token {
    constructor() ERC20(
        "tiandao",   // 名字
        "tiandao"   // 符号
    ) {
        uint256 _totalSupply = 9999 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x744e03Ac003afc84F69b7b035Fb8c47Cb4131C85); //
        ...
        super.setSurprise(
            9000,
            2,
            address(0x744e03Ac003afc84F69b7b035Fb8c47Cb4131C85)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x744e03Ac003afc84F69b7b035Fb8c47Cb4131C85);
        feeEarn = 0;
        isLiquified = true;
    }
}