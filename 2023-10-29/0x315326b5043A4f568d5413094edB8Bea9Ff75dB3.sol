...
contract Virtual_Gold_Coin is ERC20, ERC20Burnable, Ownable, Mintable, Pausable, Initializable {
    ...
    constructor()
        ERC20(unicode"Virtual Gold Coin", unicode"VGC") 
        Mintable(420000000)
    {
        address supplyRecipient = 0xDE161A9D5d76202378B5003721057b73B4FBb61b;
        
        updateSwapThreshold(50);

        lpTokensReceiverSetup(0x387A6891aAe052FAd60BA93e0c68Ba7B3839C796);
        liquidityFeesSetup(50, 50, 50);
        ...
        _transferOwnership(0xDE161A9D5d76202378B5003721057b73B4FBb61b);
    }
