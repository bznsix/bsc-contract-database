...
contract USTC is Context, IERC20, Ownable {
    ...
    string private constant _name = "USTC";
    string private constant _symbol = "USTC";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9D0532B7981Af3A74F64777Aa51B0cC8375a4BCA);
    address payable private _marketingAddress = payable(0x422d31B9c4acE5a6289524d3ae26AAA635BF1131);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 2, "Redis cannot be more than 4.");
	    require(redisFeeOnSell < 2, "Redis cannot be more than 4.");
	    require(taxFeeOnBuy < 2, "Tax cannot be more than 2.");
	    require(taxFeeOnSell < 2, "Tax cannot be more than 2.");
