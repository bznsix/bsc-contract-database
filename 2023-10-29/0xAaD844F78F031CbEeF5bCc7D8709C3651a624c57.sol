/**
 * RiseProtocol is a Hyper Deflationary Token which Auto Buy Backs and also rewards its holders in RISE.
 *
 * 
 * #___Social Media___
 * Website  :  https://www.riseprotocoltoken.com
 * Telegram  :  https://t.me/riseprotocoltoken
 * Twitter   :  https://twitter.com/riseprotocoloff
 * 
 * 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RISE = IBEP20(0xC7D43F2B51F44f09fBB8a691a0451E8FFCF36c0a);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RISE.balanceOf(address(this));
        ...
        uint256 amount = RISE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RISE.transfer(shareholder, amount);
...
contract RiseProtocol is IBEP20, Auth {
    using SafeMath for uint256;

    address RISE = 0xC7D43F2B51F44f09fBB8a691a0451E8FFCF36c0a;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Rise Protocol";
    string constant _symbol = "RIPR";
