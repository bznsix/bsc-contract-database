...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa6a33B15a7CF9E650234857DF380dd8E9c59088f; // owner address
...
contract Pumpkinspepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pumpkin Pepe";
    string private _symbol = "PUMPKIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa6a33B15a7CF9E650234857DF380dd8E9c59088f); // Marketing Address
    address payable private teamWalletAddress = payable(0xa6a33B15a7CF9E650234857DF380dd8E9c59088f); // Team Address
