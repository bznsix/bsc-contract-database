...
//`--'  `--'          '--'   '--'       `-----' `--' '--'`-------'        `--'       `--' `--' `-----'  `-----'  
//
// SPDX-License-Identifier: Never had a license, boy
//
// If you hold this token, you are formally allowed.
...
//muthafuckin contracts an shiieeeeeeeeet
...
//educate yoself at the library fool
...
//we da owners now boi

abstract contract Ownable is Context {
    address private _owner;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0xbf18A1b5b4079b2073523e280093F1E4B6CeD132;
...
contract NWordPass is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbf18A1b5b4079b2073523e280093F1E4B6CeD132;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "N-Word Pass";
    string private _symbol = "NWA";
