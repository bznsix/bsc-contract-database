...
contract loarnzo is Testkek20, Ownable, BaseToken {
  ...
  using SafeMath for uint256;
    ...
    constructor(
        ...
        _symbol = symbol_;
        _decimals = decimals_;
        _claim(owner(), totalSupply_);
        marketingWallet = marketingWallet_;
        emit TokenCreated(owner(), address(this), TokenType.standard, VERSION);
    }

    modifier onlyMarketingWallet() {
        require(_msgSender() == marketingWallet, "Not the marketing wallet");
        _;
    }
