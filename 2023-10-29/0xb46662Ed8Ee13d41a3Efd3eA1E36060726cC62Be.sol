...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7ec33C68d7ce123941Db03e8051E64046456B842;
...
contract Islantia is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x40648aC6a7c0F59DBFF2563E38F003FCC00084D6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Islantia";
    string private _symbol = "INA";
