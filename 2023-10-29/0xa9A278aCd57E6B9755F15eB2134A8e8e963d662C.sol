...
contract AMAMAG is Context, IBEP20, Ownable {
    ...
    uint256 private _numOfTokensToExchange = 1000000 * 10**6 * 10**9;
    ...
    string private _name = "Doctor MAMA";
    string private _symbol = "DMAM";
