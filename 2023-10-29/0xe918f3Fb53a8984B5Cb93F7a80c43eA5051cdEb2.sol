//Telegram : https://t.me/bigflokifi
...
contract BigFlokiFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BIG FLOKI FI";
    string private _symbol = unicode"$BFFI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xE1Abf67F26A08A91914Bf9367d99227EF86F04D5);
    address payable private taxWallet2 = payable(0xE1Abf67F26A08A91914Bf9367d99227EF86F04D5);
    ...
    uint256 public _totalTaxIfBuying = 15; // Initially 15% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 15; // Initially 15% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 15;

    uint256 private _totalSupply = 123_456_789 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*123456789/123456789;
    uint256 public _walletMax = _totalSupply*123456789/123456789;
    uint256 private minimumTokensBeforeSwap = _totalSupply*123456789/123456789; 
