/**
https://t.me/OneDollarPepeBSC
https://Twitter.com/OneDollarPepeBS
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x34CEA5BF8EAb0aB7592c2eee9aBecE133Fe2b451; 
...
contract OneDollarPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ONE DOLLAR PEPE";
    string private _symbol = "ONEDOLLARPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34CEA5BF8EAb0aB7592c2eee9aBecE133Fe2b451); 
    address payable public teamWalletAddress = payable(0x34CEA5BF8EAb0aB7592c2eee9aBecE133Fe2b451); 
    ...
    uint256 public _marketingShare = 24;
    uint256 public _teamShare = 14; 

    uint256 public _totalTaxIfBuying = 6;
    uint256 public _totalTaxIfSelling = 7;  
    uint256 public _totalDistributionShares = 95;  
    uint256 private _totalSupply = 578888888 * 10**_decimals;
    uint256 public _maxTxAmount = 5788888 * 10**_decimals; 
    uint256 public _walletMax = 11577777 * 10**_decimals;
