...
//Telegram: https://t.me/bnbmemenano
...
contract BNBMENO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BNBMemeNANO";
    string private _symbol = unicode"BNBMN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x12BdBe8947e8F864DdcC3f331146237385410Adf);
    address payable private taxWallet2 = payable(0x12BdBe8947e8F864DdcC3f331146237385410Adf);
    ...
    uint256 public _sellMarketingFees = 38;
    uint256 public _sellDevelopmentFees = 0;

    uint256 public _liquidityShares = 0;
    uint256 public _marketingShares = 53;
    uint256 public _developmentShares = 0;

    uint256 public _totalTaxIfBuying = 25; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 38; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 9;

    uint256 private _totalSupply = 200_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*200000000/200000000;
    uint256 public _walletMax = _totalSupply*200000000/200000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*2000000/200000000; 
