...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E1E22CCB3C11f83Ee2A36E44E4f26309f86A39B;
...
contract MaskInuCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa4eaB83fff76bfaea6F85BcD7af030aAB1D02015;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420690000000000* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MaskInu";
    string private _symbol = "MaskInu";
    ...
    uint256 public _maxTxAmount = 420690000000000* 10**18;
    uint256 private numTokensSellToAddToLiquidity = 420690000000000 *10**18;
