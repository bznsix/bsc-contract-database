...
contract test69 is ERC20, Ownable {
    ...
    constructor () ERC20("test69", "test69") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xB1162A99EfC43EE83249ee18D04f7Fa6229063ca;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; //pinklock
         _isExcludedFromFees[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true; //pancakeswap mainnter router


        _mint(owner(), 500000000000000000000000000);
    ...
    function setSwapEnabled(bool _enabled) private {
