/**
BUSD BAKED CATS
 Hire CATS, Gather Beans, Harvest Beans and Sell for BUSD. 
  15% daily daily Rate
  10% Referral Bonus, will go directly to referrer wallet.
  3% stacking compound bonus every 12 hrs, max of 7 days.
  48 hours cut off time.
  10 BUSD minimum investment.
  15,000 BUSD max deposits per wallet.
  50% feedback TAX for withdrawals that will be done not after 5 consecutive compounds.
...
contract BakedCats {
    ...
    uint256 public EGGS_TO_HIRE_1MINERS = 53000; //15% REWARDS
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public REFERRAL = 80;
    uint256 public TAX = 18;
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 15000 * 1e18; /** 15000 BUSD  **/
    ...
    function PRC_EGGS_TO_HIRE_1MINERS(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value >= 540000 && value <= 2592000); /** min 3% max 15%**/
        EGGS_TO_HIRE_1MINERS = value;
    }

    function PRC_TAX(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 200); /** 20% max **/
        TAX = value;
    }    
