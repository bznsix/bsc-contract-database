...
// telegram: https://t.me/babyBNBtigerchat
...
contract babybnbtiger is Context, IERC20 {
    ...
    string private _symbol = "$BBTIGER";

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    uint256 public _Tax_On_Buy = 17;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xc456291785625abbadA995c307E5f678B3541e23);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x0daD882551bF0b260B257Ad7860A4cAf08544A6E); // Testnet
        ...
        _isExcludedFromMaxTx[Wallet_Burn] = true;
        _isExcludedFromMaxWallet[Wallet_Burn] = true;
