...
/**
                    Diamond Hand || Fair Launch

 Tokenomics : 
    - 10% Tax (3% Reward, 1% liquidity, 6% Marketing)
    - LP will be locked
    - Ownership will be renounced and dev wallet will be unauthorized. 100% Safe!
    - Launching in pinksale.

https://t.me/world_diamondhands*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //BNB
...
contract DiamondHands is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Diamond Hands";
    string constant _symbol = "DMH";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //BNB

    uint256 _totalSupply = 5* 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 690 * 10**6 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 5 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0DDBB738BBD52a3ca36f96eAAF0E56595bDc1347;
        marketingWallet = 0x0DDBB738BBD52a3ca36f96eAAF0E56595bDc1347;
        devWallet = 0x0DDBB738BBD52a3ca36f96eAAF0E56595bDc1347;
