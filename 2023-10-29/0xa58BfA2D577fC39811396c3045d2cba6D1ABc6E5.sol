...
contract SpookyPepe is Context, IERC20, Ownable {
    ...
    string private _name = "SpookyPepe";
    string private _symbol = "SPePe";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x2FAbea47382B7Ab042e771c50FC31CD67e22A8BF;
    address public developerWallet = 0xea616985FE13dEa1971A13D52362297e3683851D;
    ...
    uint256 private _totalSupply = 5000_000_000 * 10**_decimals;  

    uint256 public minimumTokensBeforeSwap = 100 * 10**_decimals;

    uint256 public _maxTxAmount =  _totalSupply.mul(20).div(denominator);     //3%
    uint256 public _walletMax = _totalSupply.mul(20).div(denominator);    //3%
