...
contract Mint is Ownable {
    ...
    uint256 public mintingFee = 0.1 ether;  // set the default fee to 0.1 BNB
    ...
    mapping(address => bool) public whitelist; // 白名单mapping
    ...
    function startMint(address refer) public payable {
