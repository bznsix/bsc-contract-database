...
contract USDT_REWARDER is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x611c2DbF96217891fF1339306E145B7659861553;

    string constant _name = "USDT REWARDER";
    string constant _symbol = "USDTRE";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2000000000000000 * 10**6 * 10**_decimals;
