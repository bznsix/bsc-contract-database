...
*/
 ...
 /** Euro Coin Inu €
    ...
    We aim to to mantain the unity, freedom and justice in Europe.

    LETS MAKE THE EURO GREAT AGAIN
    ...
    Max Trn   :     3% (3,000,000,000)

// TG: https://EuroCoinInu
...
contract EuroCoinInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Euro Coin Inu";
    string private constant _symbol = "EuroCoin";
    ...
    address private marketingWallet = address(0x51b6470632441Cf545a514eAc6B053F452a25Ddc);
    address private liquidityReceiver = address(0x4D2b1201F9955a5dAA1B61e6F620a04F2134Bdc7);
