...
contract ProfitBank is Context, IERC20, Ownable {
    ...
    uint256[2] public _taxFee = [30,50]; // [Before, after]
    uint256[2] private _previousTaxFee = _taxFee;
    
    uint256[2] public _liquidityFee = [70,50]; // [Before, after]
    uint256[2] private _previousLiquidityFee = _liquidityFee;
    
    uint256[2] public marketingDivisor = [25,15]; // [Before, after]
    uint256[2] public devDivisor = [25,15] ; // [Before, after]
