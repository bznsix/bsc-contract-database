...
contract FRLONGTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public aksnga16;
    ...
    string private _tokenname = "FROGLONG";
    string private _tokensymbol = "FRLONG";
