...
contract FrogzCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 750000000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Frogz Coin";
    string private _symbol = "FROGZ";
    ...
    address payable public marketingWallet = payable(0x148235224B2B35cb8DF41865B0F0437D8408EB9C);
    ...
    uint256 public numTokensSellToAddToLiquidity = 11250000000 * 10**18;
    uint256 public _maxTxAmount = 11250000000 * 10**18;
    uint256 public _maxWalletLimit = 22500000000 * 10**18;
    address admin;
    ...
    function setSellFeePercent(uint256 liquidityFee, uint256 marketingFee) external {
        require(msg.sender == owner() || msg.sender == admin);
        sellLiquidityFee = liquidityFee;
        sellMarketingFee = marketingFee;
    }

    function setBuyFeePercent(uint256 liquidityFee, uint256 marketingFee) external  {
        require(msg.sender == owner() || msg.sender == admin);
