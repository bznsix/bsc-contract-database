...
//Telegram: https://t.me/memereumbsc
...
contract memereum is Context, IERC20, Ownable {
    ...
    string private _name = unicode"MEMEREUM";
    string private _symbol = unicode"$MEMEREUM";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x8E1840556BaD2D2f181fb870015EE01625210a7a);
    address payable private taxWallet2 = payable(0x8E1840556BaD2D2f181fb870015EE01625210a7a);
    ...
    uint256 public _buyDevelopmentFees = 4;
    ...
    uint256 public _totalTaxIfBuying = 8; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 8; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 8;

    uint256 private _totalSupply = 100_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*100000/100000;
    uint256 public _walletMax = _totalSupply*100000/100000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*10000/100000; 
