...
contract SHJ is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x3035C89f267FA1230CE70AC26AF363117bCC9FC9); 
    address payable private teamWalletAddress = payable(0x6470EB4BeA0D2970589202815B691d017a8Ee8D2); 
    ...
    uint256 private _totalSupply = 1 * 10**2* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**2 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**2 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 10**2* 10**_decimals; 
