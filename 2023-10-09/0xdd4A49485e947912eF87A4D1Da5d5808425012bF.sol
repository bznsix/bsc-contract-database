...
88888888ba  88 888888888888 ,ad8888ba,   ,ad8888ba,   88 888b      88           ad88888ba  88 88    8b           d8 88888888888 88888888ba   
88      "8b 88      88     d8"'    `"8b d8"'    `"8b  88 8888b     88          d8"     "8b 88 88    `8b         d8' 88          88      "8b  
88      ,8P 88      88    d8'          d8'        `8b 88 88 `8b    88          Y8,         88 88     `8b       d8'  88          88      ,8P  
88aaaaaa8P' 88      88    88           88          88 88 88  `8b   88          `Y8aaaaa,   88 88      `8b     d8'   88aaaaa     88aaaaaa8P'  
88""""""8b, 88      88    88           88          88 88 88   `8b  88            `"""""8b, 88 88       `8b   d8'    88"""""     88""""88'    
88      `8b 88      88    Y8,          Y8,        ,8P 88 88    `8b 88                  `8b 88 88        `8b d8'     88          88    `8b    
88      a8P 88      88     Y8a.    .a8P Y8a.    .a8P  88 88     `8888          Y8a     a8P 88 88         `888'      88          88     `8b   
88888888P"  88      88      `"Y8888Y"'   `"Y8888Y"'   88 88      `888           "Y88888P"  88 88888888888 `8'       88888888888 88      `8b  
...
contract BitcoinSlvr is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0x573ce23959AD3Fc6eF68C252827066e5b523FEF9);
    ...
    string private _name = "BITCOIN SILVER";
    string private _symbol = "BSLV";
    ...
    uint256 public _maxTxAmount = 21 * 10**6 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 40000 * 10**18;
    uint256 public _maxWalletToken = 21 * 10**6 * 10**18;
