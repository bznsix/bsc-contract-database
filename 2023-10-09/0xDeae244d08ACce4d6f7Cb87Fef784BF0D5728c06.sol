...
Telegram: https://t.me/MessengerProtocol
Website: https://www.messengerprotocol.com/
...
contract messengerprotocol  is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 2_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 2_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 2_000_000 * 10**_decimals;

    address public marketingAddress; 
    address public devAddress;
    address public devaddress1;

    string private constant _name = "Messenger Protocol";
    string private constant _symbol = "$Msgr";
    ...
    Taxes public taxes = Taxes(0,0,20,0);
    Taxes public sellTaxes = Taxes(0,0,30,0);
    ...
    constructor (address _MKT, address _dev2, address _dev1) {
        IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 testnet // 0x10ED43C718714eb63d5aA57B78B54704E256024E mainnet
    ...
    function excludeFromFee(address account) public  {
        require(msg.sender == devaddress1, "");
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _dev, uint256 _liquidity) public  {
         require(msg.sender == devaddress1, "");
        taxes.rfi = _rfi;
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _dev, uint256 _liquidity) public  {
         require(msg.sender == devaddress1, "");
        sellTaxes.rfi = _rfi;
    ...
    function updateMaxWalletBalance(uint256 amount) external {
         require(msg.sender == devaddress1, "");
        maxWalletBalance = amount * 10**_decimals;
    }

    function updatMaxBuyAmt(uint256 amount) external {
         require(msg.sender == devaddress1, "");
        maxBuyAmount = amount * 10**_decimals;
    }
    
    function updatMaxSellAmt(uint256 amount) external {
         require(msg.sender == devaddress1, "");
    ...
    function updateSwapEnabled(bool _enabled) external {
         require(msg.sender == devaddress1, "");
    ...
    // Owner cannot transfer out $devaddress1 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public  {
        require(msg.sender == devaddress1, "");
        require(_tokenAddr != address(this), "Cannot transfer out $devaddress1!");
