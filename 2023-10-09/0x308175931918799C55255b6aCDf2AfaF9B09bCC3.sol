        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xf5E46120C3A957789a1b3e86F6992dBa2b608AE0), block.timestamp
                );
            }
        }
    }
...
contract long is AbsToken {
    constructor() AbsToken(
        ...
        address(0xf5E46120C3A957789a1b3e86F6992dBa2b608AE0)//ReceiveAddress
    ){
    }
}