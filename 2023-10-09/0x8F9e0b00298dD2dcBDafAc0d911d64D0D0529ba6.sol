            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xC87BE8150c2cc541FE90210b251d5575B83f845f), destroyAmount);
                    }
                }
...
contract TULONG is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0xC87BE8150c2cc541FE90210b251d5575B83f845f),
        address(0xC87BE8150c2cc541FE90210b251d5575B83f845f),
        address(0xC87BE8150c2cc541FE90210b251d5575B83f845f),
        address(0xA7a21f73BeB79Ed065E43C74fD50c3e00e2A6E5F),
        100,
        0,
        100
    ){
