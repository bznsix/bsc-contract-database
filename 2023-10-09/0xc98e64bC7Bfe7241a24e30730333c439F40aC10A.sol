...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee3 = 150;
    ...
    constructor (
        ...
        _balances[address(0x70FD3f780a552954D8a1faDFb5559Ad9bc786263)] = 2580000 * tokenUnit;
        emit Transfer(address(0), address(0x70FD3f780a552954D8a1faDFb5559Ad9bc786263), 2580000 * tokenUnit);

        _balances[address(0x5aE0a6A48D4669a02d617694eF14647e43508CAC)] = 6020000 * tokenUnit;
        emit Transfer(address(0), address(0x5aE0a6A48D4669a02d617694eF14647e43508CAC), 6020000 * tokenUnit);

        _balances[ReceiveAddress] = 34400000 * tokenUnit;
        emit Transfer(address(0), ReceiveAddress, 34400000 * tokenUnit);

        _balances[address(0x64DeF573DF62BD3693189185A68Edd0A1cFEAaC0)] = 817000000 * tokenUnit;
        emit Transfer(address(0), address(0x64DeF573DF62BD3693189185A68Edd0A1cFEAaC0), 817000000 * tokenUnit);
        ...
        _feeWhiteList[address(0x64DeF573DF62BD3693189185A68Edd0A1cFEAaC0)] = true;
        _feeWhiteList[address(0x5aE0a6A48D4669a02d617694eF14647e43508CAC)] = true;
        _feeWhiteList[address(0x70FD3f780a552954D8a1faDFb5559Ad9bc786263)] = true;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isRemoveLP) {
                ...
                swapFeeAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellFundFee3) / 10000;
            } else {//Transfer
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        fundUsdt = usdtBalance * fundFee2 / totalFee;
        if (fundUsdt > 0) {
            USDT.transfer(fundAddress2, fundUsdt);
        }

        fundUsdt = usdtBalance * fundFee3 / totalFee;
        if (fundUsdt > 0) {
    ...
    function claimContractToken(address contractAddr, address token, uint256 amount) external {
        TokenDistributor(contractAddr).claimToken(token, msgSender, amount);
    }
...
contract KOALA is AbsToken {
    ...
    //
        860000000,
    //
        address(0xe969Fb9ecf063f5541c31d8770028D7e4018D0CC),
    //
        address(0x1C19E8424b843CA28141BC9BeA24005f65f06962),
    //
        address(0x0bd0bBf2BCd0E0Bc317BBBf346003a6B4F59494C),
    //
        address(0x9F8228D5C92456D822f1b6A09f2662d708147C77),
    //
        0,
    //
        190000000,
