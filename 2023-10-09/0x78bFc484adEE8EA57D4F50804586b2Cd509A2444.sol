...
contract HuskyTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public taxcs56;
    ...
    string public _tokenname = "Husky inu";
    string public _tokensymbol = "Husky";
