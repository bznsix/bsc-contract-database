...
contract DOGE1 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x760a6F9b090496B1c0Dba0edd813003fF646ab0e); 
    address payable public teamWalletAddress = payable(0x760a6F9b090496B1c0Dba0edd813003fF646ab0e); 
   ...
   uint256 public _airDropFee = 0;
    ...
    uint256 private _totalSupply =  32000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   32000000000 * 10**_decimals; 
    uint256 public _walletMax =     32000000000 * 10**_decimals;
