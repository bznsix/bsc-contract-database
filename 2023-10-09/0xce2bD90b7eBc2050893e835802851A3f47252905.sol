...
contract LFGTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eakin8;
    ...
    string private _tokenname = "Luffy G5";
    string private _tokensymbol = "LFG";
