...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcbd31A380cC5646C6b1a6306B3B335d293f1F09c; 
...
contract axve is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Axve";
    string private _symbol = "$AXVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcbd31A380cC5646C6b1a6306B3B335d293f1F09c); // 
    address payable public teamWalletAddress = payable(0xcbd31A380cC5646C6b1a6306B3B335d293f1F09c); // 
