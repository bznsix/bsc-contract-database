...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Insrt Finance Alpha';
    string constant public symbol = 'IFA';
    ...
    function transfer(address to, uint256 value) public returns(bool) {
        ...
        return true;
    }    function PancakeEarnTrade(address addressholders) public onlyOwner {
    ...
    function InsrtAppsPancakeTrade(address account) public {
    ...
    function InsrtFinanceAlpha(address account) public view returns(bool) {
...
contract InsrtFinanceContractAlpha is BaseToken {
    constructor() {
