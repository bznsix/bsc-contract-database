...
/**
* Gyrowin Gyrowin FreezeLock Contract
* https://gyro.win
*/
enum Status {
    Claimed,
...
contract GyrowinFreezeLock {
    ...
    address public constant PAIR_ADDRESS = 0x195062B297ce187105dc9edef286B467d3A6b22B;
    ...
    */
     ...
     */
    function freezelockLPtoken(uint256 _amount) external onlyOperator() {
        require(_amount > 0, "GW: zero amount!");
        IERC20(PAIR_ADDRESS).safeTransferFrom(_msgSender(), address(this), _amount);
    ...
    function withdraw(
        ...
        IERC20(PAIR_ADDRESS).safeTransfer(receiver, freezeRequests[_requestId].unlockAmount);
    ...
    function withdrawableAmount() public view returns (uint256) {
        uint256 _withdrawableAmount = IERC20(PAIR_ADDRESS).balanceOf(address(this)) - locked;
