/**
// https://t.me/Dogeriumbscofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEeec5Ea617857D2f9bC56Fc17DF25c31e4C64e5B; // owner address
...
contract Dogerium is Context, IERC20, Ownable {
    ...
    string private _symbol = "DOGERIUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xEeec5Ea617857D2f9bC56Fc17DF25c31e4C64e5B); // Marketing Address
    address payable private teamWalletAddress = payable(0xEeec5Ea617857D2f9bC56Fc17DF25c31e4C64e5B); // Team Address
