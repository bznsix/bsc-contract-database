...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8240d4473CF6a05c3a6D97996414E0cd8ef97327; // owner address
...
contract XILONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XILONG";
    string private _symbol = "DRAGON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8240d4473CF6a05c3a6D97996414E0cd8ef97327); // Marketing Address
    address payable private teamWalletAddress = payable(0x8240d4473CF6a05c3a6D97996414E0cd8ef97327); // Team Address
