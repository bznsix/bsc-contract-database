...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8aeD75cA6fd57fBF862C60f50e1CEC4F856ABcf3; // owner address
...
contract MOONERIUMBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOONERIUM BSC";
    string private _symbol = "$MOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47216D47156E1572441A9a2211CE1b8Cd12f4FfA); 
    address payable public teamWalletAddress = payable(0x8aeD75cA6fd57fBF862C60f50e1CEC4F856ABcf3);
