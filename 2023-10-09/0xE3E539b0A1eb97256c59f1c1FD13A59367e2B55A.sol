...
contract BitHotelCollection is IBitHotelCollection, AccessControl, ERC721Enumerable, ERC721URIStorage, ERC2981PerTokenRoyalties {
    struct Collection {
        bool locked;
    }
    ...
    */
    function mint(
        ...
        // solhint-disable-next-line reason-string
        require(totalSupply() < replicas(),"BitHotelCollection: all tokens already minted.");
    ...
    function bulkSafeMint(
        ...
        // solhint-disable-next-line reason-string
        require(mTokenIds.length == tos.length, "BitHotelCollection: tokenIds length mismatched");
...
interface IBitHotelCollection is IERC721 {
