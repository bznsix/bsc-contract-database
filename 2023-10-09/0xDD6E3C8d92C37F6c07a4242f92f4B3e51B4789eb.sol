...
contract DYBTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public omfns24;
    ...
    string private _tokenname = "DYB";
    string private _tokensymbol = "DYB";
