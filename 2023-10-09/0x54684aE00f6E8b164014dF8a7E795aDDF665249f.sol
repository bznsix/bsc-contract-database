...
library Address{
 ...
 contract GOD is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf19ECA9ee8Da7F9fc151fF9Ef02D90389277d3F6;
    address public donationWallet = 0xf19ECA9ee8Da7F9fc151fF9Ef02D90389277d3F6;



    string private constant _name = "GOD SAVE THE KING";
    ...
    Taxes public taxes = Taxes(0, 8, 3, 0);
    Taxes public sellTaxes = Taxes(0, 8, 3, 0);
