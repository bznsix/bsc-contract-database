...
contract WhiteFox is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBD01C3f632a29948E53Ba2e6B6143577649B7Ac9); 
    address payable public Wallet_Dev = payable(0x40699fe9319ef47BB9c69f2F9c199bccc0Fe1c47);
    ...
    string private constant _name = "WhiteFox"; 
    string private constant _symbol = unicode"WFX"; 
    ...
    constructor () {
        ...
        _owner = 0xdd67a4a29b28d0da88b0A63435237D6E1550C2D5;
