...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb47eF2aDE40e40269267FA9AFdB3F8f0A53dF72d;
...
contract SHOCKSUPPLYFROGGY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SHOCK SUPPLY FROGGY";
    string public _symbol = "FROGGY";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb47eF2aDE40e40269267FA9AFdB3F8f0A53dF72d); 
    address payable private developmentWalletAddress = payable(0xb47eF2aDE40e40269267FA9AFdB3F8f0A53dF72d);
