...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0xa01bb25159E85F885Cb493e57f21181cEa49D6f0;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0xB304b7AF640532D2ceeF3f7e34FD4F4364ea91A9;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0xcCE87568F3A740F0E3239A264F2bc2997449f584;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "IGUANAPATH";
  string private _symbol = "IGUNPATH";
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "PATH: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "PATH: transfer from the zero address");
    require(recipient != address(0), "PATH: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "EPATHRC20: transfer amount exceeds balance");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "PATH: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "PATH: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "PATH: approve from the zero address");
    require(spender != address(0), "PATH: approve to the zero address");
