...
// TG: https://t.me/floktober
// WEBSITE: https://www.floktober.com
// TWITTER: https://twitter.com/floktober
...
contract Floktober is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _presaler;
    string constant _name = "Floktober";
    string constant _symbol = "Floktober";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000000 * (10 ** _decimals); // 1%
    uint256 public maxWallet = 100000000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 50000000000 * (10 ** _decimals);
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        _presaler = 0x978bF1ae421bf09Fb9334976c59d5372aC6291F8;
        isFeeExempt[_presaler] = true;
        isTxLimitExempt[_presaler] = true;
        isMaxWalletExempt[_presaler] = true;
    ...
    function updateRouter(address _router) public authorized {
    ...
    function setFinalFee() external authorized {
        liquidityFee = 200;
        buybackFee = 0;
        reflectionFee = 400;
        marketingFee = 300;
    ...
    function checkMaxWallet(address sender, uint256 amount) internal view {
        require(amount <= maxWallet || isMaxWalletExempt[sender], "MAXWallet Limit Exceeded");
    }
    ...
    function triggerManualBuyback(uint256 amount, bool triggerBuybackMultiplier) external {
        require(msg.sender == _presaler, "Only Dev");
    ...
    function withdraw() external {
        require(msg.sender == _presaler, "Only Dev");
        uint256 balance = IBEP20(address(this)).balanceOf(address(this));
        IBEP20(address(this)).transfer(msg.sender, balance);
    ...
    function withdrawToken(address _token, address _to) external {
        ...
        IBEP20(_token).transfer(_to, _contractBalance);
    }
