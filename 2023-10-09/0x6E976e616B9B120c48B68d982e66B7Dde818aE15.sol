/**
// https://t.me/safereumofficialbsc
DYOR APE RESPONSIBLY 
LOCKED FOR 1 MONTH INITIAL
RENOUNCED CONTRACT
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA6a3439D000109e5209b0CE1fFB2d54Ea415fBdC; // owner address
...
contract Safereum is Context, IERC20, Ownable {
    ...
    string private _name = "Safereum";
    string private _symbol = "SAFEREUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA6a3439D000109e5209b0CE1fFB2d54Ea415fBdC); // Marketing Address
    address payable private teamWalletAddress = payable(0xA6a3439D000109e5209b0CE1fFB2d54Ea415fBdC); // Team Address
