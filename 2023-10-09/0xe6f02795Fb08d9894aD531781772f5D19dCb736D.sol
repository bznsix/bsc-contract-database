...
contract megamaninu is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 40; // 2.5% of supply
    ...
    string private constant _name = "Megaman Inu";
    string private constant _symbol = "MEGAINU";
