...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36E822d3Bdba31C066EB835F9c32Da3d7e6549ED; // owner address
...
contract DOGEREUMBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogereum Bsc";
    string private _symbol = "DGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0CC345e6aD41F9C1eAb55727F39552F2C5F6E634); 
    address payable public teamWalletAddress = payable(0x36E822d3Bdba31C066EB835F9c32Da3d7e6549ED);
    ...
    uint256 public _marketingShare = 26;
    ...
    uint256 private _totalSupply = 220000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 220000000000000 * 10**_decimals; 
    uint256 public _walletMax =   220000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 30000 * 10**3; 
