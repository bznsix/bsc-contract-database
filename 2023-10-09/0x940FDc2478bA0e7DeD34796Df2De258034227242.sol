...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        emit Transfer(address(0), ReceiveAddress, total - 1);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyFundFee + _sellFundFee - _markFee - _funFee) * 2 / swapFee;
        ...
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAmount - markAmount - funTAmount);
    }
...
contract Titan is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0x07B5Ebca3Ede16CD239577DeB2b54177A605e7B8),
        address(0xDE5F46e0e746aB6A03913f60bc7205a999168692),
        address(0x42E97D41C68c38878A1E4AD26835Cc477722121B),
