...
contract zAIChain is Context, IERC20 {
    ...
    string private constant _name = unicode"zAI Chain";
    ...
    uint256 public forBuyTax = 10;
    uint256 public forSellTax = 12;
    uint256 public forTotalTax = 24;
    ...
    function setMaxWallet (uint256 maxWalletNow)public onlyOwner {
        _maxWalletSize = maxWalletNow * 10e9;
    }
