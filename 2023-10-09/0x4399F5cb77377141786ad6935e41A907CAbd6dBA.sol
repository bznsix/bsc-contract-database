...
telegram: https://t.me/SuperDogeTether
Website:https://superdogetether.com/
Twitter:https://twitter.com/superdogetether
Join us and reach the moons with us! Swap, Launchpad, Staking SOON!
*/
...
contract Superdogetether is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    //address public immutable BUSDToken = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);//usdt testnet
   address public immutable BUSDToken = address(0x55d398326f99059fF775485246999027B3197955);//usdt Mainnet
    address private _marketingWallet = address(0x97601c8B3e7031fee1E5A9872100B6AB87d68Bf9);

    bool private swapping;
    bool public airdrop;

    SuperdogetetherDividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 50000000000000 * (10**9); // 5.0% of total supply
    ...
    constructor() ERC20("Super Doge Tether", "SDT") {
        ...
        dividendTracker = new SuperdogetetherDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Superdogetether: The dividend tracker already has that address");

        SuperdogetetherDividendTracker newDividendTracker = SuperdogetetherDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Superdogetether: The new dividend tracker must be owned by the BabyTether token contract");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TEST: The liquidity wallet is already this address");
...
contract SuperdogetetherDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    uint256 public _maxWalletToken = 10000000000000 * (10**9); // 1.0% of total supply
    ...
    constructor() DividendPayingToken("SuperDogetether_Dividend_Tracker", "SuperDogetether_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**9); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "Superdogetether_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "Superdogetether_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyTether contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Superdogetether_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Superdogetether_Dividend_Tracker: Cannot update claimWait to same value");
