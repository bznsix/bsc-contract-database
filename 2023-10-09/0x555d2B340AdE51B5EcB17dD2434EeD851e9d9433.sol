...
// File contracts/StrategyV3_PlanetF_V2.sol
...
contract StrategyV3_PlanetF_V2 is StrategyV3 {
    ...
    constructor(
        ...
        address[] memory _WBNBToNATIVEPath,
        ...
        WBNBToNATIVEPath = _WBNBToNATIVEPath;
        ...
        returns (uint256)
    {
        ...
        // update wantLockedTotal (should be higher because of external auto-compounding)
        wantLockedTotal = IPlanetFarm(farmContractAddress).stakedWantTokens(pid, address(this));
    ...
    function earn() public override virtual nonReentrant whenNotPaused {
        require(isAutoComp, "!isAutoComp");
        ...
        if (token0Amt > 0 && token1Amt > 0) {
            ...
            IXRouter02(lpRouterAddress).addLiquidity(
                token0Address,
                token1Address,
                token0Amt,
                token1Amt,
