...
Website : https://connectedcoin.cloud

Telegram : https://t.me/connectedcoin

Twitter : https://twitter.com/Connectedbsc

Medium : https://medium.com/@connectedabcd
...
contract CONNECTED is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CONNECTED";
    string private _symbol = "CONNECT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6B3Efe09A9740C094adbBFB780780886993569D9);
    address payable public liqWalletAddress = payable(0x6B3Efe09A9740C094adbBFB780780886993569D9);
    ...
    uint256 public _totalTaxIfBuying = 16;
    uint256 public _totalTaxIfSelling = 26;
    ...
    uint256 public _walletMax =     9000000 * 10**_decimals;
