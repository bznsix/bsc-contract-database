...
contract TRUCKTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ybxsa2;
    ...
    string private _tokenname = "TRUCK";
    string private _tokensymbol = "TRUCK";
