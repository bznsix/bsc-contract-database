...
contract DraerTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ekndh21;
    ...
    string private _tokenname = "DragonHunter";
    string private _tokensymbol = "DragonHunter";
