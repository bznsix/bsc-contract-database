...
contract DobbyBNB is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 10 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 90 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xE0058e51f9aF400247B7aBef87a2275dAF295a82; //

    string private constant _name = "DobbyBNB"; //
