...
/* contacts let = "name dragontraining" id =1000000000000000 
getAmountOut(dragontraining)
...
// File: contracts\dragontraining.sol

contract DRAGONTRAINING is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "DRAGON TRAINING";
	...
	uint256 private constant _totalTokens = 100000000000 * 10**_decimals;	//100 billion total supply
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0x326aE9676a6FFb1F2618403b8357E46d48F6D0aD); // A percentage of the BNB pool will go to the charity address
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0xD22E49e87a44D8e7Cbef20eb00B20B2a4415b91e); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM
	address payable private constant _teamAddress = payable(0xD22E49e87a44D8e7Cbef20eb00B20B2a4415b91e);
	...
	constructor (address routerAddress) {
		...
		setClaimRewardGasFeeOptions(_totalTokens / 10000, 100000000000);
