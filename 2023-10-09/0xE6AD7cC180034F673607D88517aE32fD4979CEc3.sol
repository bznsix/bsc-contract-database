/**
 *Submitted for verification at BscScan.com on 2023-09-9
*/

//Telegram: https://t.me/sixtyninebsc
...
contract sixtynine69 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"69";
    string private _symbol = unicode"69";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x733ACfe2CADD8936d9aa7a458E952AdB90678E76);
    address payable private taxWallet2 = payable(0x733ACfe2CADD8936d9aa7a458E952AdB90678E76);
    ...
    uint256 public _sellDevelopmentFees = 5;

    uint256 public _liquidityShares = 0;
    uint256 public _marketingShares = 13;
    uint256 public _developmentShares = 8;

    uint256 public _totalTaxIfBuying = 6; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 15; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalDistributionShares = 20;

    uint256 private _totalSupply = 69_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*69000/69000;
    uint256 public _walletMax = _totalSupply*69000/69000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*6900/69000; 
