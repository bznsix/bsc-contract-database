...
Telegram: https://t.me/Cognetixportal
Twitter: https://twitter.com/Cognetixchain
Website: https://cog-netix.com/
...
contract COGNETIX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x10DF1eeA460961Ae22DEebbfA21a3166501F2e2B;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Cognetix";
    string constant _symbol = "CGX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300000000 * 10**0 * (10 ** _decimals);
    ...
    uint256 public buybackFeeBuy = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x10DF1eeA460961Ae22DEebbfA21a3166501F2e2B;
