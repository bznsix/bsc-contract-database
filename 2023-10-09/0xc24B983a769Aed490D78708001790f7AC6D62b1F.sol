...
contract BarbieCat is Context, IERC20, Ownable {
    ...
    string private _name = "Barbie Cat";
    string private _symbol = "BGCAT";
    ...
    address payable public marketingWallet = payable(0x8C057BE8C4Ee6e096Fadff4d29eD586b2AddcF83);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 20, "tax too high");
        _taxFee = taxFee;
