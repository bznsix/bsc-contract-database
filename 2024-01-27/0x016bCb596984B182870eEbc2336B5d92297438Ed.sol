...
contract TrendingTool is IERC20 {
    ...
    string constant private _name = "Trending Tool";
    ...
    address payable public marketingWallet = payable(0x5E9D75e07Cd0DD3fE2dB8Cb9ebfa04d893FF6D92);
    ...
    uint256 private _maxTxAmount = (_tTotal * 5) / 100;
