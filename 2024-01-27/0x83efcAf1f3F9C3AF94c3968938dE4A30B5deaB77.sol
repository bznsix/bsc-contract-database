...
/*
    ...
    NO ANALYST CAN PREDICT (NACP) TAKE IT OR LEAVE IT ,ALL COIN IN ,HOT CAKE TO TAKE.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9ee4614F3e82D78199008Fd2911C3164aBceE646;
...
contract NACP is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x3ae3CdFF2502F5A9e2eE46741308F8a3c58d64e3);
    address payable private Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_zero = payable(0x3ae3CdFF2502F5A9e2eE46741308F8a3c58d64e3); 


    string private _name = "NACP"; 
    string private _symbol = "NACP";  
