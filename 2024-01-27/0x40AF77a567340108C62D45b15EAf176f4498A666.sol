...
contract moonAirdrop is Context {
    ...
    uint256 private constant _singleValue = 0.003 * 10**18;
    uint256 public totalDroped;
    uint256 public threshold;
    uint256 private constant _deployAmount = 40 * 10 ** 18;
    ...
    address public addressProjector = 0x5D107F3C0403f6542dB0F67D8f7537A9254D72B3; //to be modified
...
contract BabyBurn is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    constructor() ERC20("BabyBurn", "BabyBurn") {
    ...
    uint256 public percentForLPBurn = 100; // 100 = 1% each hour，24% each day
