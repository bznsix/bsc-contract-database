...
🌏Website | www.babychow.xyz
🖥Telegram | https://t.me/babychow
✖️Twitter | https://twitter.com/BabyChow_BSC
...
contract $BabyChow is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby Chow";
    string private _symbol   = "$BabyChow";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 5e11 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0x2b0Ee50B3AaAE1DcA36a758d1E0329957a0A1fb0;
        ...
        _isExcluded[address(0x2b0Ee50B3AaAE1DcA36a758d1E0329957a0A1fb0)] = true; //Marketing
