...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("bian", "bian") {
        address recieve = msg.sender;
        if (block.chainid == 56) {  
            recieve = 0x39b75d8C69429d503843Ca6a05e4B4CBd4aDA9EA;
            _NFT = 0x39b75d8C69429d503843Ca6a05e4B4CBd4aDA9EA;
        ...
        transferOwnership(0x8a7e005D95e004772ce12072dC813B5Fe5fDfB5a);
    }
