...
contract GONKE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gonke";
    string private _symbol = "GONKE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x99Ef7F787e28394EE761ff6e3B20B6a9D2cA8D35);
    address payable private DevelopmentWalletAddress = payable(0x37AEb1Be63E099B6489D634BBf76aFae65CFe163);
