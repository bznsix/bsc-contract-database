...
contract Token is BaseToken {
    ...
    address public feeReceive = address(0x9c85DEdfa27D30F3b900Ed0240bD2603DeaA82a9);
    ...
    uint256 public _airdropAmount = 250 * 10 ** 18;
    function setAirdropAmount(uint256 newValue) public onlyOwner{
        _airdropAmount = newValue;
    }

    mapping(address=>uint256) public tC;
    uint256 public tL = 10;
    function setTL(uint256 newValue) public onlyOwner{
        tL = newValue;
    }

    uint256 public startTradeBNBAmount = 30 ether;
