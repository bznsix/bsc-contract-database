...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public feeReceive = address(0x5C1d80d5CC680540F77c95196B743E50623f049e);
    function setFeeReceive(address _a) public onlyOwner{
        feeReceive = _a;
    }

    uint256 public _airdropBNB = 0.025 ether;
    function setAirdropBNB(uint256 newValue) public onlyOwner{
        _airdropBNB = newValue;
    }

    uint256 public _airdropAmount = 500000 * 10 ** 18;
    ...
    receive() external payable {
        ...
        if (BNB_Balance >= tB){
            // add liquidity
            _swapRouter.addLiquidityETH{value: tB / 2}(
                address(this),
        ...
        if (startTradeBNBAmount != 0 && IERC20(_swapRouter.WETH()).balanceOf(_mainPair) >= startTradeBNBAmount){
            startTime = block.timestamp;
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        3000000000,
        address(0x81cE066b88154F71971179122174A9656956FA65),
        address(0x81cE066b88154F71971179122174A9656956FA65),
        address(0x5C1d80d5CC680540F77c95196B743E50623f049e)
    ){}
}