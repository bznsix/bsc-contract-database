...
/**
TELEGRAM : https://t.me/dragonballbsc0
TWITTER : https://twitter.com/DragonBallBSC0
WEBSITE : 
*/
...
contract DragonBall is Context, IERC20, Ownable {
    ...
    string private constant _name = "DRAGONBALL";
    string private constant _symbol = "DB";
    uint256 private _tTotal = 1_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 public swapTokensAtAmount = 1_000_000 * 10**_decimals; // Should be between 0.03% to 0.2%  of the total supply
    ...
    Taxes public Buytaxes = Taxes(2,10,3);
    Taxes public sellTaxes = Taxes(2,15,3);
