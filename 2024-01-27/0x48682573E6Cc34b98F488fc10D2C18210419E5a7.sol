...
contract Trump2024 is ERC20, Ownable {
    ...
    constructor() ERC20("TRUMP2024", "TRUMP2024") Ownable(msg.sender) {
        uint256 totalSupply = 420_000_000_000_000_000 * 10**6; // decimals: 6
    ...
    {
        require(
            _swapTokensAtAmount <= (totalSupply() * 8) / 10000,
            "Swap amount cannot be higher than 0.08% total supply."
        );
        require(
