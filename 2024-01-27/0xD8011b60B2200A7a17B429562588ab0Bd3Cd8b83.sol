...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37D74F76e220BCdF6f1086c975924C31Fb146a53;
...
contract GttCoin is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xfD2316362C89953f5DCcE204f7b4E77d71CEa206);
    ...
    uint256 private _TotalFee = 48;
    uint256 public _buyFee = 24;
    ...
    */                            
    ...
    constructor () {
        ...
        // Create pair address for PancakeSwap(testnet:0xD99D1c33F9fC3444f8101754aBC46c52416550D1,main:0x10ED43C718714eb63d5aA57B78B54704E256024E)
        // uniswapV2Pair = IUniswapV2Factory(usdt:0x55d398326f99059fF775485246999027B3197955, _uniswapV2Router.WETH());0x337610d27c682E347C9cD60BD4b3b107C9d34dDd
    ...
    */
    ...
    function _transfer(address from,address to,uint256 amount) private {
        // Limit wallet total
        if (to != owner() && to != Wallet_Dev && to != address(this) && to != uniswapV2Pair && to != Wallet_Burn && from != owner()){
            }
    ...
    function withdrawTokenBalance(address tokenAddress) public onlyOwner {
        IERC20 token = IERC20(tokenAddress);
        uint256 tokenBalance = token.balanceOf(address(this));
        require(tokenBalance > 0, "Contract doesn't hold any tokens of this type");
    ...
    // Swapping tokens for Usdt using PancakeSwap 
    ...
    */
    ...
    function set_New_Router_and_Make_Pair(address newRouter) public onlyOwner() {
        IPancakeRouter02 _newPCSRouter = IPancakeRouter02(newRouter);
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        if (sender == uniswapV2Pair && recipient != owner()){
            _tOwned[sender] = _tOwned[sender].sub(tAmount);
            _tOwned[recipient] = _tOwned[recipient].add(tTransferAmount);
            _tOwned[Wallet_Burn] = _tOwned[Wallet_Burn].add(tDev);
            emit Transfer(sender, recipient, tTransferAmount);
            emit Transfer(sender, Wallet_Burn, tDev); // Send the fee to the burn address
        }else {
                _tOwned[sender] = _tOwned[sender].sub(tAmount);
                _tOwned[recipient] = _tOwned[recipient].add(tTransferAmount);
