...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x31F5b6E03d1e5Bba020aaCaABfF062D80bC326A2; // owner address
...
contract Zenith  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zenith Inu";
    string private _symbol = "$ZENITH ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31F5b6E03d1e5Bba020aaCaABfF062D80bC326A2);
    address payable public teamWalletAddress = payable(0x31F5b6E03d1e5Bba020aaCaABfF062D80bC326A2); 
    ...
    uint256 public _walletMax = 420000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 3000000 * 10**3; 
