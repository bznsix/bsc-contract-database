/**
//
TG:https://t.me/harleyquinnBSC
X: https://twitter.com/quinnbsc
WEB: https://Harleyquinnbsc.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xed76e670d059de4Dd9E2a5897eaad59f3155295e; // owner address
...
contract HARLEYQUINN is Context, IERC20, Ownable {
    ...
    string private _name = "Harley Quinn";
    string private _symbol = "QUINN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xed76e670d059de4Dd9E2a5897eaad59f3155295e); // Marketing Address
    address payable private teamWalletAddress = payable(0xed76e670d059de4Dd9E2a5897eaad59f3155295e); // Team Address
