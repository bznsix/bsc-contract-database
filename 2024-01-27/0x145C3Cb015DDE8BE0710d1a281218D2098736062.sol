...
contract Nano is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE96662E9288401b39d4a965192580874783BE3E2); 
    address payable private Wallet_Dev = payable(0x79932F9C8CeDB37E7ff621E0D8d595661dbb4e02);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000000000000 * 10**_decimals;
    string private constant _name = "Nano"; 
    ...
    constructor () {
        ...
        _owner = 0x79932F9C8CeDB37E7ff621E0D8d595661dbb4e02;
