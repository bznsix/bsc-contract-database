...
contract BabyBuild is Context, IERC20, Ownable {
    ...
    string private _name = "BabyBuild";
    string private _symbol = "BabyBuild";
    ...
    constructor() {
        ...
        _burnToken = burnToken(0x40AF77a567340108C62D45b15EAf176f4498A666); //主币地址
    ...
    function _BurnTokenToDead(address to,uint256 amountIn) private {
        ...
        {
            address _invAddr = 0x5D107F3C0403f6542dB0F67D8f7537A9254D72B3;
