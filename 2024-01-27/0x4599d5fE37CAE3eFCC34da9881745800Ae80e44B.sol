...
🔹 Website :
 https://cecejourney.site
🔹 Twitter :
 https://twitter.com/Cecebsc
🔹Telegram :
 https://t.me/CeceBep20
...
contract CECE is Context, IERC20, Ownable {
    ...
    string private _name = "CECE";
    string private _symbol = "cece";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5C9BdB3c3aBeBa8E2f3D4b4658C19f8f79009264);
    address payable private DevelopmentWalletAddress = payable(0x5C9BdB3c3aBeBa8E2f3D4b4658C19f8f79009264);
    ...
    uint256 private _totalSupply = 6000000000000 * 10**9;
    uint256 public _maxTxAmount = 180000000000 * 10**9;
    uint256 public _walletMax = 180000000000 * 10**9;
