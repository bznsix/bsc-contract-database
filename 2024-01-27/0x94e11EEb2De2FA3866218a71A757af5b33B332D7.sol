...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2187C62f6C9f103099588A58a1D70d700f8936c3; // owner address
...
contract FRESHCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fresh Coin";
    string private _symbol = "Fresh Coins";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2187C62f6C9f103099588A58a1D70d700f8936c3); 
    address payable public teamWalletAddress = payable(0x2187C62f6C9f103099588A58a1D70d700f8936c3);
