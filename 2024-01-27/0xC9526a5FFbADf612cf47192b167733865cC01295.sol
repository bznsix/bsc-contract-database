...
contract NFTmint is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("DreamX Revenue NFT", "DX") {
    }
    ...
    function Mintforholders(address _to, uint256 _count) external onlyOwner {
       require(_totalSupply() <= MAX_NFT, "All NFTs are minted");
