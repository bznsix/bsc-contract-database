/**
🐩 Baby CHIRO 🐩| BSC |$CHIRO

🔥NEW TOKEN FAIRLAUNCH 18.00 UTC, TODAY!
         
  🥇DONT MISS IT🥇
🐩Contract Verified                           
🐩LP locked & Renounced
...
✨Telegram: https://t.me/+TAZhFNPa6PFmODg1
**/
...
contract BABYCHIRO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BABY CHIRO";
    string private constant _symbol = unicode"$CHIRO";
    ...
    address payable public DevWallet = payable(0x64606bf94F28cCB3bA0337C2755C9989F8D31Bea);
    address payable public MarketingWallet = payable(0x49BF32814dDe6DaaDEF62822A125F77C56d04739);
