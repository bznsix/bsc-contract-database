...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0x732f54D12EAf821c6749C5F87657673f28645689);
...
contract LiquidityLockToken is Ownable, IBEP20 {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;

    uint256 public _decimals = 18;
    uint256 public _totalSupply = 10 * 10**9 * 10**_decimals;
    string private _name = "LiquidityLockToken";
    string private _symbol = "LCT";

    address public immutable DeadWalletAddress =
        0x772CD395406783B15De948B4765C4BFbd7fE9D52;
    address payable public MarketingWalletAddress =
        payable(0x79A3477BC741DD02Ad5ee1Bef8d102B43243E32e);   
    address payable public DevelopmentWalletAddress =
        payable(0x79A3477BC741DD02Ad5ee1Bef8d102B43243E32e);

    uint256 internal _liquidityFee = 0;
    uint256 internal _DevelopmentFee = 0;
