...
contract Shibbabonk is Context, IERC20, Ownable {
    
    string private constant _name = "Shibbabonk";
    string private constant _symbol = "Sbonk";
    uint256 private constant _totalSupply = 1_000_000_000_000_000 * 10**18;
    uint256 public minSwap = 1_000_000_000 * 10**18;
    ...
    constructor() {
        ...
        marketingWallet = payable(0xfe034C03eECfe8dC8404f1ddb01B65E398960B72);
