...
abstract contract DividendsTokenCustom is ERC20Decimals, Ownable {
    ...
    function _customTransfer(
        ...
        if (taxAmount > 0) _transfer(from, address(this), taxAmount);
...
// 
contract DividendsTokenCustomAntiBotLaunchBlockBurn is
    MaxWallet,
    MaxTransaction,
    BlockList,
    ERC20LaunchMode,
    ERC20Burnable,
    DividendsTokenCustom
{
    constructor(
        ...
        MaxTransaction(_periodInSec, _maxTx)
        DividendsTokenCustom(_args)
    {
    ...
    function transfer(
        address recipient,
        uint256 amount
    ) public virtual override(ERC20, DividendsTokenCustom) returns (bool) {
        return DividendsTokenCustom.transfer(recipient, amount);
    }
    ...
    function transferFrom(
        ...
        return DividendsTokenCustom.transferFrom(sender, recipient, amount);
    }
    ...
    function _afterTokenTransfer(
        ...
        internal
        virtual
        override(DividendsTokenCustom, MaxWallet, MaxTransaction, ERC20)
    {
        ERC20._afterTokenTransfer(from, to, amount);
        DividendsTokenCustom._afterTokenTransfer(from, to, amount);
        MaxWallet._afterTokenTransfer(from, to, amount);
        MaxTransaction._afterTokenTransfer(from, to, amount);
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(BlockList, ERC20LaunchMode, ERC20) {
        ERC20._beforeTokenTransfer(from, to, amount);
        BlockList._beforeTokenTransfer(from, to, amount);
        ERC20LaunchMode._beforeTokenTransfer(from, to, amount);
    }
}