...
contract BURN2024 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 20242024 * 10**9;
    ...
    string private constant _name = "BURN2024";
    string private constant _symbol = "BURN2024";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x2343B4fA1b73700b081b10879d7755327Df1d8E7);
    address payable private _marketingAddress = payable(0x2343B4fA1b73700b081b10879d7755327Df1d8E7);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 100, "Redis cannot be more than 100.");
	    require(redisFeeOnSell < 100, "Redis cannot be more than 100.");
	    require(taxFeeOnBuy < 100, "Tax cannot be more than 100.");
	    require(taxFeeOnSell < 100, "Tax cannot be more than 100.");
