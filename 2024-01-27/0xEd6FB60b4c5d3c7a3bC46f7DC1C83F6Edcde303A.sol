...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _removeLPFee = 1500;
    ...
    function setBuyFee(uint256 dividendFee, uint256 fundFee, uint256 lpFee,uint256 deFee) external onlyOwner {
        _buyDividendFee = dividendFee;
        _buyFundFee = fundFee;
        _buyLPFee = lpFee;
        _buyDestroyFee =deFee;
    }

    function setSellFee(uint256 dividendFee, uint256 fundFee, uint256 lpFee,uint256 deFee) external onlyOwner {
        _sellDividendFee = dividendFee;
        _sellFundFee = fundFee;
        _sellLPFee = lpFee;
        _sellDestroyFee = deFee;
    }
...
contract CNY is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0xCB3d03c0Ad96c9d3Aa4Fdf7497D7f56Db9F36f81),
        address(0x2238a9e9eADc4d6CEa2BFc67cD47161F74C0DBCc)
    ){
