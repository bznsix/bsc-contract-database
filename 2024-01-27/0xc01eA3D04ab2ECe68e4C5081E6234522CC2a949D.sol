...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public feeReceive = address(0x0d8007D142fCF893A866E347526081E2022C6FF6);
    function setFeeReceive(address _a) public onlyOwner{
        feeReceive = _a;
    }

    uint256 public _airdropBNB = 0.02 ether;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0x2331A4bb84e4f889e7EAF67CEa7A24b04d6Ceb8C),
        address(0x2331A4bb84e4f889e7EAF67CEa7A24b04d6Ceb8C),
        address(0x0d8007D142fCF893A866E347526081E2022C6FF6)
    ){}
}