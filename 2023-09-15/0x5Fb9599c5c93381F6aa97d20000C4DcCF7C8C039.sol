...
contract OpBNBTheOriginStandard is Ownable, ERC721AQueryable, ReentrancyGuard {
    ...
    ) ERC721A("The Origin(standard)", "The Origin(standard)") {
    ...
    function mint() external nonReentrant isNotContract checkMintTimes {
        require(!isMinted(msg.sender), "You have reached the claim limit.");
        _safeMint(msg.sender, 1);
    }

    function isMinted(address account) view public returns (bool) {
