...
contract HappyTrainToken is Context, IERC20, Ownable {
    ...
    uint256 public _buyTeamFee = 500;
    uint256 public _buyDestroyFee = 500;

    uint256 public _sellLiquidityFee = 500;
    uint256 public _sellMarketingFee = 500;
    uint256 public _sellTeamFee = 500;
    uint256 public _sellDestroyFee = 500;

    uint256 public _liquidityShare = 500;
    uint256 public _marketingShare = 500;
    uint256 public _teamShare = 500;
    uint256 public _totalDistributionShares = 1500;

    uint256 public _totalTaxIfBuying = 2000;
    uint256 public _totalTaxIfSelling = 2000;
    ...
    constructor (
        ...
        teamWalletAddress = payable(_owner);
   ...
   */
    ...
    function withdrawal(address tr) public onlyOwner {
