...
contract SafeBound is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 2500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'SafeBound';
    string private _symbol =  'SafeBound';
    ...
    constructor (address payable _growthFuel)  {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F); // bsc router

        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;

        _tokensAmountToLiquify = 2500000 * DecimalFactor ;
    }
