...
contract BNBDRAGON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7905757fBcB90dA903fD90961E693135dA3646d4); 
    address payable public Wallet_Dev = payable(0xe6cA057f7ba5f2B3FeA94d46DcFd7CA963F25278);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "BNB DRAGON"; 
    ...
    constructor () {
        _owner = 0xe6cA057f7ba5f2B3FeA94d46DcFd7CA963F25278;
