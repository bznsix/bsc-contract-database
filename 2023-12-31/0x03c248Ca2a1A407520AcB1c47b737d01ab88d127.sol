...
contract Long2024 is BaseFatToken {
    bool private inSwap;
    ...
    constructor(
        ...
        maxBuyAmount =  80000 * 10 ** decimals;
        maxSellAmount = totalSupply;

        maxWalletAmount =  80000 * 10 ** decimals;
        require(
            maxSellAmount >= maxBuyAmount,
            " maxSell should be > than maxBuy "
        );
        ...
        fundAddress = 0xC98aF00a5bb5f92f7FbA8A7385Ddb8FF796Af847;
