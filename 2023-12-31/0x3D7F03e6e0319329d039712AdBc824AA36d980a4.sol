...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2beBbf41D3360E298FDa8f016569d887f8683AB7; // owner address
...
contract TOOTHLESS is Context, IERC20, Ownable {
    ...
    string private _name = "TOOTHLESS";
    string private _symbol = "TNFURRY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2beBbf41D3360E298FDa8f016569d887f8683AB7); // Marketing Address
    address payable private teamWalletAddress = payable(0x2beBbf41D3360E298FDa8f016569d887f8683AB7); // Team Address
