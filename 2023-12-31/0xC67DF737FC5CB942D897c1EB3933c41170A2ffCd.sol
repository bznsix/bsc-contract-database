...
contract TsukiInu is BEP20, Ownable {
    ...
    bool public MOONING = true;

    uint256 public constant totSupply =  210000000000000000 * 10**9;
    uint256 public tokenLiquidityThreshold = totSupply / 200; 
    ...
    Taxes public transferTaxes = Taxes(2, 2);
    ...
    constructor() BEP20("Tsuki Inu", "TSUKI") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= (1 * 10**8) / 200, "Swap threshold amount should be lower or equal to 1");
