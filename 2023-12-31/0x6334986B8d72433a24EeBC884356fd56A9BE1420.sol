...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb6F1d95C230A4D3CEff81cc693B744B6Dcd156A0; // owner address
...
contract GROKDRAGON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grok Dragon";
    string private _symbol = "GD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb6F1d95C230A4D3CEff81cc693B744B6Dcd156A0); // Marketing Address
    address payable private teamWalletAddress = payable(0xb6F1d95C230A4D3CEff81cc693B744B6Dcd156A0); // Team Address
