...
contract DailyFinance is ERC20, Ownable {
    uint256 public buyTax = 5;
    uint256 public sellTax = 5;

    address public marketingWallet = 0x1b39e97123Df3957A19FdC24f783cDa6ba4303C4;
    ...
    constructor () ERC20("Daily Finance", "DLY") 
    {   
    ...
    function setBuyTax(uint256 _persentage) external onlyOwner{
        require(_persentage <= 25, "must be smaller than 25");
        buyTax = _persentage;  
    }

    function setSellTax(uint256 _persentage) external onlyOwner{
        require(_persentage <= 25, "must be smaller than 25");
        sellTax = _persentage;  
    }
