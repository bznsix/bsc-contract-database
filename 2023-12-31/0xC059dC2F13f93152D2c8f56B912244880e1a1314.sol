...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        address RouterAddress, address UsdtAddress, address LPDividendToken,
        ...
        _feeWhiteList[address(0xC3970B528c46fC8300884CF323f9bF5444Fa467A)] = true;

        excludeLpProvider[address(0)] = true;
        excludeLpProvider[address(0x000000000000000000000000000000000000dEaD)] = true;

        lpRewardCondition = 20 * 10 ** IERC20(LPDividendToken).decimals();
    }
...
contract BACZ is AbsToken {
    ...
    //CTA
        address(0xB33b34cafb0172569A013a74Edc0C70Aa1844E15),
    //Name，
        "BACZ",
    //Symbol，
        "BACZ",
    ...
    //Total，
        111333444,
    //Receive，
        address(0xa8a596645d6d9D640454AA82306EB4EBF4F7A23b),
    //Fund，
        address(0xe3e516e3c3f164182aCdda2d341bA6B723fbbB9D),
    //LPFund，
        address(0x03aCCFC6166F63F8aBbaE50eeb10cfF6e653c44A)
    ){
