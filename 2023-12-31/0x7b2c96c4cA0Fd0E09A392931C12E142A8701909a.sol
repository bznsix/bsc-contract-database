...
contract BABY is ERC20, Ownable {
    ...
    constructor() ERC20("BABY", " BABY") {
        marketingWallet = payable(0xd013Ed55D048Dbd137eE032fa0f550F7Bd1BE133);
        devWallet = payable(0x2a79e02cE37786D97c4BEf269eDa68C689afa280);
...
contract BABYDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        defaultToken = token;
        BABYContract = BABY(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "BABY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABY contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BABYContract);

            uint256 prevBalance = BABYContract.balanceOf(address(this));
            ...
            {
                uint256 received = BABYContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BABYContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
