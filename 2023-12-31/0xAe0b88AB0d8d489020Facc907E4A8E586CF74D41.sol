...
contract Welcome2024Bsc is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Welcome 2024";
    string private constant _symbol = unicode"2024";
    uint256 public _maxTxAmount =   204 * 10**_decimals;
    uint256 public _maxWalletSize = 204 * 10**_decimals;
