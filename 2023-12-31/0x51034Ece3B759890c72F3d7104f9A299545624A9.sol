//    This token is protected by copyright, and any use outside of the genuine developers on https://tsukiinu.vercel.app/ can result in potential loss of funds for the project owners or those providing liquidity for this token pair.
    ...
    //    Anyone on your team who deployed this token without approval from https://tsukiinu.vercel.app/ renounces any type of refund from https://tsukiinu.vercel.app in case of any losses.


/*

Website | https://tsukiinu.vercel.app/

Telegram | https://t.me/TsukiInuOfficial
...
contract TKINU is Context, IBEP20, Ownable {
    ...
    uint256 public maxTxAmount = 1000000000 * (10 ** 18); // Assuming 18 decimals
   ...
   constructor() public {
    ...
    _symbol = "TKINU";
    _decimals = 18;
    _totalSupply = 1000000000000 * (10 ** uint256(_decimals)); // Total supply set to 1 trillion with 18 decimals
