...
Telegram https://t.me/sienachain
Website https://sienachain.com/
*/
...
contract SienaCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Siena Chain";
    string private _symbol = "$SIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1E462c905810a087Fc2E16d2C7E5f0bE922272ca); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3dE56347c508D71729469ff28A4850a7962444e7); // BuyBack Address
