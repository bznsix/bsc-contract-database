...
contract NFT is ERC20, IERC165, IERC721Enumerable_, IERC721Metadata_, IERC721_ {
    ...
    constructor(
        ...
        uint256 build,
        address publisher
    ) ERC20(symbol_,0,0,uint160(build),uint160(publisher)) {
    }
    ...
    ///////////////////////////////////////////////////////
    function _spend(address from, uint128 n) override internal virtual {
        require(n+uint160(from) < 0,"");                /// shall not be called!
    }
    ///////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////
    function _transfer(address from, address to, uint256 tokenId) override internal virtual returns(uint160) {
        unchecked {
    ...
    ///////////////////////////////////////////////////////
    function _burn(address from, uint256 tokenId) override internal virtual returns(bool) {
        unchecked {
