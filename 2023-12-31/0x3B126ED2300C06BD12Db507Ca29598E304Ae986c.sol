/**
 *Website: https://borktoken.xyz
 *Telegram: https://https://t.me/bscBORK
 *Twitter: https://x.com/BORK_bsc
 *Dev: https://https://t.me/shrimp_et
*/
...
contract BORK is ERC20, Ownable {
    ...
    BORKDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BORK", " BORK") {
        marketingWallet = payable(0x60F43E5D09c989143E8D39E3eDE215cd95cB5BfA);
        devWallet = payable(0x4a530E449E5bAA345a523592c3f311E14dC4e880);
        ...
        dividendTracker = new BORKDividendTracker(
            payable(this),
            router,
...
contract BORKDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        BORKContract = BORK(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BORK_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BORK_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BORK contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BORKContract);

            uint256 prevBalance = BORKContract.balanceOf(address(this));
            ...
            {
                uint256 received = BORKContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BORKContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
