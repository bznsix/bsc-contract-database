...
contract EMOJI is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("MOMOJI", "EMOJI") {
        _initializeMainnet();
        ...
        marketingWallet = 0x7735FbcB21F0832aE1A4b5590C2DEE683A5464F3;
        marketingBuyFee = 10;
        marketingSellFee = 10;
        ...
        _mint(owner(), 360_000_000_000 * (10 ** 18));
        swapEnabled = true;
    ...
    function _initializeMainnet() internal {
        ...
        if(id == 56 || id == 1){
            transferOwnership(0x8248d79115A50825fe54ebC694d9CF6284A9fce1);
        }
    }
