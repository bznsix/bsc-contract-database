...
abstract contract QJStarToken is IERC20, Ownable {
    ...
    uint256 public _buyFee = 100;     //营销
    uint256 public _sellFee = 100;   //营销
    uint256 public _sellLPDividendFee = 100;  //lp分红
    uint256 public _secondsellFee = 100;   //开盘后1小时后卖出30税
...
contract lkk is QJStarToken {
    constructor() QJStarToken(
        ...
        address(0xC75c164145c64b9896104127f07A1b7f21716704)
    ){
