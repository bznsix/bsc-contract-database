...
contract Troll is IERC20, DeployEvent, LogData, Ownable {
    ...
    */
    function ceng(address account) public view returns (uint256) {
        return _msk[account];
    }
