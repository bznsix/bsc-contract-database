...
Welcome to XMILADY BSC

https://xmiladybsc.xyz
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x607240Ece265fBF32C2C6143e6335910b604abB4; // owner address
...
contract XMilady is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XMilady";
    string private _symbol = "$XM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x607240Ece265fBF32C2C6143e6335910b604abB4); // Marketing Address
    address payable private teamWalletAddress = payable(0x607240Ece265fBF32C2C6143e6335910b604abB4); // Team Address
    ...
    uint256 public _sellMarketingFee = 93;
