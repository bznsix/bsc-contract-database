...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42677440D5C1DB9222c25C3E6aca566B4f9CA7b7; 
...
contract BUFFPEPE20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUFF PEPE 2.0";
    string private _symbol = "BUFFPEPE 2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x62211134D75307D27943bF8338D6F1092c9eF5EC); // 
    address payable public teamWalletAddress = payable(0x42677440D5C1DB9222c25C3E6aca566B4f9CA7b7); // 
