...
contract X_MARIO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAb412d9dDDb44b15A4f2C22C0f8C87e3af6E93d1); 
    address payable public Wallet_Dev = payable(0x94023874C5a6Ac103d9bBa9FCd36a5BF04DAAeee);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**9 * 10**_decimals;
    string private constant _name = "X-MARIO"; 
    string private constant _symbol = unicode"XMARIO"; 
    ...
    constructor () {
        _owner =0x94023874C5a6Ac103d9bBa9FCd36a5BF04DAAeee;
