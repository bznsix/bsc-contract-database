...
contract testlon is Context, IERC20 { 
   using SafeMath for uint256;
    ...
    address payable public Wallet_Marketing = payable(0xd209C765C8639BAb74E704B553b8919315b26004); 
    address payable public Wallet_Dev = payable(0xd209C765C8639BAb74E704B553b8919315b26004);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 8;
    uint256 private _tTotal = 900000000000000;
    string private constant _name = "teslon"; 
    ...
    constructor () {
        _owner = 0x9710904CFF302e0DEc0A3F425AB9651db951b384;
