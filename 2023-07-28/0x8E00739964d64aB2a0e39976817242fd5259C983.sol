...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xA9B0Ba715a6E70791363C9832EBE5f8c34e2B7d8;//
...
contract x is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        210000000000,//Supply
        address(0x9C78b6628A238DbeA20CE9BFB6Ad348Fec52fFf3),//FundAddress
        address(0xA9B0Ba715a6E70791363C9832EBE5f8c34e2B7d8)//ReceiveAddress
    ){
    }
}