...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.01 * (10 ** 2);
...
contract SFLIX is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x18588c3B600abFAEdf7082236ee98D1f5b35B4F8;

    string constant _name = "StreamFlix";
    string constant _symbol = "SFLIX";
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 100000;
    bool inSwap;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/3, "Fees cannot be more than 99%");
    }
