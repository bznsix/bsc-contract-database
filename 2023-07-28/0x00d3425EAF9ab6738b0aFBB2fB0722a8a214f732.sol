...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09F938E606EC006f47D658Cd563dadb5B82D7211; // owner address
...
contract XPRO is Context, IERC20, Ownable {
    ...
    string private _name = "XPRO 2.0";
    string private _symbol = "XPRO2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09F938E606EC006f47D658Cd563dadb5B82D7211); // Marketing Address
    address payable public teamWalletAddress = payable(0x09F938E606EC006f47D658Cd563dadb5B82D7211); // Team Address
    ...
    uint256 private _totalSupply = 66000000 * 10**_decimals;
