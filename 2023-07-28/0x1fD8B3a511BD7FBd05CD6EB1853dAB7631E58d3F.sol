/*
  group official  :  https://t.me/x_dollar_bsc
*/
...
contract Babytoken is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "XDR";
    string private constant _name = "X dollar";

    uint256 public Max_Buy_Limit = 20000000 * 10**9;
    uint256 public Max_Sell_Limit = 10000000 * 10**9;

    address private Marketing_Wallet = 0x9b96dB1Ac2ad3ff5d065E4B4F6643E5594c6C3eb;
    address private Team_Wallet = 0x37A6ED67Bc7EbD68dd0A6dD50dD09fb995D95604;

    uint256 public Max_Wallet_Holding = 30000000  * 10**9;
    uint256 private swapTokensAtAmount = 3000000 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 5, 5, 0);
    Taxes public taxes = Taxes(0, 5, 5, 0);
