...
Welcome to Spyro Coin BSC

TG: https://t.me/spyrobsc
WEBSITE: https://spyrobsc.lol/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32F0Cd53B8Cb1CD87A621d008338A4141DE31419; // owner address
...
contract Spyro is Context, IERC20, Ownable {
    ...
    string private _name = "Spyro";
    string private _symbol = "$SPYRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x72e45ffC04990cDD6286F7328c1b4856413b6083); // Marketing Address
    address payable private teamWalletAddress = payable(0x72e45ffC04990cDD6286F7328c1b4856413b6083); // Team Address
    ...
    uint256 public _sellMarketingFee = 92;
