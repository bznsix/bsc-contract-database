...
/**
 *Welcome to the CryptoVerse an innovative and ambitious crypto project 
 that aims to create a vast interconnected ecosystem within the
  cryptocurrency space.

Links

Telegram - https://t.me/TheCrypto_Verse


Partnerships - https://t.me/OptimusDeployer
https://t.me/hightaxjeet


Tax 10/20
Marketing 0/5
Optimus Rewards 7/12
Dev 1/1
HTJ diamond hand rewards 2/2

Public launch
Total supply: 10k supply
Max bag 10%
Max transaction 3%
1 BNB LP

Marketing wallet
0x4C30876DFbCd89f8A8E6f432ddBAA48542B40C5E
 * contract by @frennadev (telegram)
 */
...
abstract contract Auth {
     ...
     */
    function authorize(address account) private onlyOwner {
     ...
     */
    function isAuthorized(address account) private view returns (bool) {
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 OPTIMUS = IBEP20(0xD01FE87c9fbCE981F31BBA771d253179cA118b99);
...
/* Token contract */
contract CRYPTOVERSE is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address OPTIMUS = 0xD01FE87c9fbCE981F31BBA771d253179cA118b99; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x43fb5d9F24D222Fc67D80f48A31D150a959e3bAb;
    ...
    // Name and symbol
    string constant _name = "THE CRYPTOVERSE";
    string constant _symbol = "$CRYPTOVERSE";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 10000 * (10 ** _decimals); // 20mill

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 2% on launch or 2B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% or 1B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 2% or 2B tokens
    ...
    uint256 public reflectionFeeBuy = 7;
    ...
    uint256 public reflectionFeeSell = 12;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4C30876DFbCd89f8A8E6f432ddBAA48542B40C5E;
