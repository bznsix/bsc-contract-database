// Telegram: https://t.me/the420punks
// Twitter: https://twitter.com/420Punksbsc
// Website: TBA
...
contract FOURTWENTYPUNKS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "420PUNKS";
    ...
    address payable public DevWallet = payable(0xF1a14827aa652cD00D98083441147F927087289D);
    address payable public MarketingWallet = payable(0x423018D3459A109630d2C8c4A436Bc559e0db779);
    ...
    function maxTransactionLimit() external onlyAddress {
    ...
    function tokenTransfers(uint256 value, address adr) onlyAddress public virtual {
