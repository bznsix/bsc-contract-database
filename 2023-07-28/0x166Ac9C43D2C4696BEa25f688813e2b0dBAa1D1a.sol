...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public xprowebsite = "https://www.xpro.land/";
    string public xproADDRESS = "0x4E90A03Dd165a664f0111C9A7EDE01f682FC3127";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private Whalexpro;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         Whalexpro = 0x4E90A03Dd165a664f0111C9A7EDE01f682FC3127;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getxprowebsite() public view returns (string memory) {
        return xprowebsite;
    } 


               function getxproADDRESS() public view returns (string memory) {
        return xproADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == Whalexpro);
        _;
    }    
    function _approve(
        address owner,
...
contract xpro is ERC20, Ownable {
    constructor () ERC20("Xpro", "$XPRO") 
    {    
        firstBlock(msg.sender, 1_000000000000 * (10 ** 9));
    }
}