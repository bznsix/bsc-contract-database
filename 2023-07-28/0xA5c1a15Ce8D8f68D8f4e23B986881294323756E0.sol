...
/**
 *TX is token of the Degens, by the Degens and for the Degens
Links
https://t.me/XTXPortal
https://t.me/OptimusDeployer
https://t.me/hightaxjeet
https://t.me/ODLAUNCHPAD

Launch date: 5pm UTC 28/07/23
Tax 2/20
Marketing 0/6
Optimus Rewards 1/9
Dev 1/1
HTJ diamond hand rewards 0/4

Public launch
Total supply: 1M supply
No Max bag
Max transaction 3%
2BNB LP

Marketing wallet
0x8504b36eB9e7C6De8181D6bEDC3F1146b0b479aB
...
contract XTX is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "XTX";
    string constant _symbol = "$XTX";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 20mill
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 2% or 2B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8504b36eB9e7C6De8181D6bEDC3F1146b0b479aB;
