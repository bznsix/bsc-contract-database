...
https://t.me/Noenemiesportal

LETS SPREAD PEACE WHILE WE GAIN BE A PART OF this project and MOOON
...
contract NoEnemiesToken is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NoEnemiesToken"; // 
    string constant _symbol = "NETK"; // 
    ...
    uint256 public BuydevFee          = 1;//buyback
    ...
    uint256 public SelldevFee          = 1;//buyback
    ...
    // Fees receivers
    address private autoLiquidityReceiver = 0xbf7B292A8C03136E3D5BFb3c9eE5EFdC0797aCEd; //LP receiver
    address private marketingFeeReceiver = 0xbf7B292A8C03136E3D5BFb3c9eE5EFdC0797aCEd; //mkt
    address private devFeeReceiver = 0xbf7B292A8C03136E3D5BFb3c9eE5EFdC0797aCEd; //31 BuyBack
    address private teamFeeReceiver = 0xbf7B292A8C03136E3D5BFb3c9eE5EFdC0797aCEd; //32 
