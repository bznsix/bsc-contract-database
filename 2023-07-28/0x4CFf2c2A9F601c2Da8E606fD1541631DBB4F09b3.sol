...
contract FuckPauly is Context, IERC20, Ownable {
    ...
    string private _name = "Fuck Pauly";
    string private _symbol = "FkPauly";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4785239EcB02Ce14d070abC7399Ed716a5f4Fa1a); // Marketing Address
    address payable public teamWalletAddress = payable(0x4785239EcB02Ce14d070abC7399Ed716a5f4Fa1a); // Team Address
    ...
    function transfer_token(address _to, uint256 _amount) public {
        require(msg.sender == owner(), "not success");
