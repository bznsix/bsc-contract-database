...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x64520C29D38206dD61aE5E842434Db08E44F1F9b; 
...
contract TAXZERO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TAX ZERO";
    string private _symbol = "TAXZERO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64520C29D38206dD61aE5E842434Db08E44F1F9b);
    address payable public teamWalletAddress = payable(0x64520C29D38206dD61aE5E842434Db08E44F1F9b); 
