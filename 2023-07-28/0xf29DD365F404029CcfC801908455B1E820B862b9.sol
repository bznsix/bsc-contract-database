...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XproInuwebsite = "https://XPROI.com/";
    string public XproInuADDRESS = "0x44AD7583cEA6e421bd395E2Db48f8eB0d9DE4c47";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXproInu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXproInu = 0x44AD7583cEA6e421bd395E2Db48f8eB0d9DE4c47;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXproInuwebsite() public view returns (string memory) {
        return XproInuwebsite;
    } 


               function getXproInuADDRESS() public view returns (string memory) {
        return XproInuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXproInu);
        _;
    }    
    function _approve(
        address owner,
...
contract XproInu is ERC20, Ownable {
    constructor () ERC20("Xpro Inu", "XPROI") 
    {    
