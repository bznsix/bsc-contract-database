...
// Welcome to The Echo Network - www.echonetwork.social

// https://t.me/TheEchoNetwork
...
contract echonetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF13b1EBff254e40DA5C626DfD571146e34Bb3964); 
    address payable public Wallet_Dev = payable(0x05EC71FCb309902401d0Cfb17Bfef35842a1a1d0);
    ...
    string private constant _name = "Echo Network"; 
    string private constant _symbol = unicode"ECHOBSC"; 
    ...
    constructor () {
        ...
        _owner = 0xF553e870ddB87aA1cf13675478A34cEe29afC297;
