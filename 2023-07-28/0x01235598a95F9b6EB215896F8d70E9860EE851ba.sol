...
contract BARTESTT is ERC20, Ownable {
    ...
    constructor () ERC20("Barbieque", "BARTESTT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xE70DC5a48692Fb4b5D1eb8cB7538dd2C9EbcBC2d;
    ...
    function isExcludedFromFees(address account) public view returns(bool) {
     ...
     function setMarketingFees(uint256 buyFee, uint256 sellFee) external onlyOwner {
        require(buyFee <= 10, "Buy fee cannot exceed 10%");
        require(sellFee <= 10, "Sell fee cannot exceed 10%");
