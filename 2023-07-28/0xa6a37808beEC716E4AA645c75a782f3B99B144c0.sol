...
contract kento is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kento";
    string private _symbol = "KNTO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x02f4011AFD1E351f6E4FeDA403188e8d9C7c5086);
    address payable private DevelopmentWalletAddress = payable(0x02f4011AFD1E351f6E4FeDA403188e8d9C7c5086);
