...
contract MemePump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xE803FaCecF7C63F8098Cd474dD43E246CB288910;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Meme Pump";
    string constant _symbol = "$MP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; 
    ...
    uint256 public liquidityFeeSell = 8;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x43A38D59f6fcc3596FE3C3163f05D0B8F2386C61;
