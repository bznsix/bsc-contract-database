...
abstract contract DexBaseUSDT {
    ...
    uint256 internal constant distributefee = 25; 
    uint256 internal constant liquidityFee = 4;
    uint256 internal constant burnFee = 10; 

    uint256 constant minHoldtoDividend = 1000 ether; 
    modifier isSwap() {
        inisSwap = true;
        _;
        inisSwap = false;
...
abstract contract LiquidityFeeUSDT is Ownable, DexBaseUSDT, ERC20 {
    ...
    address public lpRec = 0xF0798662A650286209341Fdf6313209E7D215D2c;
...
abstract contract MaxHave is Ownable {
    ...
    constructor(uint256 _maxHav) {
        ...
        isHavLimitExempt[address(0xf89124FA37249cf4B48562a52fa7EA6ae276F699)] = true;
...
contract BTC99 is
    ...
    BlackList
{
    uint256 private constant _totalSupply = 21000_000 ether;
    string private constant tokenName = "Bitcoin99";
    string private constant tokenSymbol = "BTC99";
    uint256 private constant maxhaveAmount = 21000_000 ether;

    bool public trading = false;
    
    constructor()
        ERC20("Bitcoin99", "BTC99", 18)
        DividendFee(1 ether, true)
        LiquidityFeeUSDT(1_000 ether, true)
        MaxHave(maxhaveAmount)
    {
