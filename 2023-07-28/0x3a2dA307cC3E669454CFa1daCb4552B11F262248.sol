...
Telegram :
https://t.me/X_MARIOTOKEN

Twitter : 
https://twitter.com/X_MarioToken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf81b42F143dc946B756a73a25dCaf125090a27ab; // owner address
...
contract XMARIO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"X-MARIO";
    string private _symbol = unicode"X-MARIO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf81b42F143dc946B756a73a25dCaf125090a27ab); 
    address payable public teamWalletAddress = payable(0xf81b42F143dc946B756a73a25dCaf125090a27ab);
    ...
    uint256 private _totalSupply = 375000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 11250000000 * 10**_decimals; 
    uint256 public _walletMax =   11250000000 * 10**_decimals;
