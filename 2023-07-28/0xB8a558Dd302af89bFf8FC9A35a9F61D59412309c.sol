...
telegram : https://t.me/kokanetwork
web : https://kokanetwork.live
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x721929F3a1B3Eb8D601CB33404CCe2eBa51FDaD8; // 
...
contract KokaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Koka Network";
    string private _symbol = " $KOKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x721929F3a1B3Eb8D601CB33404CCe2eBa51FDaD8); // Marketing Address
    address payable public teamWalletAddress = payable(0x721929F3a1B3Eb8D601CB33404CCe2eBa51FDaD8); // Team Address
