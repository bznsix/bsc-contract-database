...
contract $XPROKI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x283896381336Ee630862245B465aC9b57f790759;

    string private constant _name = "XPROKI";
    string private constant _symbol = "$XPROKI";
    ...
    // Owner cannot transfer out XPROKI from this smart contract
