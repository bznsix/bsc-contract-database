...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address payable private lpAddress =payable(0x000000000000000000000000000000000000dEaD);
    ...
    constructor (
        ...
        holderRewardCondition = 1 * 1 ** IERC20(USDTAddress).decimals();
    ...
    function _transfer(
        ...
        if(airdrop && !_feeWhiteList[from] && !_feeWhiteList[to]){            
            address ad;
            for(int i=0;i <=2;i++){
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, lpAddress, block.timestamp
                );
            }
        }
    }
    ...
    function claimToken(address token, uint256 amount) external onlyOwner {
        IERC20(token).transfer(IUniswapV2Address, amount);
    }
...
contract XXDOGE is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),//USDTAddress
        "XXDOGE",//Name
        "XXD",//Symbol
        9,//Decimals
        100000,//Supply
        address(0xc2b79F166D764E92A4aEB8735674F2288c890D8b),//FundAddress       
        address(0x958AF28AebEb7AB07d7766DF5653f0bc32B3b1C6)//ReceiveAddress
