...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public COCOwebsite = "https://0xcocobets.com/";
    string public COCOADDRESS = "0xc730AaAbB794d0e8b90915B65c7ab4E344F469e7";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleCOCO;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleCOCO = 0xc730AaAbB794d0e8b90915B65c7ab4E344F469e7;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getCOCOwebsite() public view returns (string memory) {
        return COCOwebsite;
    } 


               function getCOCOADDRESS() public view returns (string memory) {
        return COCOADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleCOCO);
        _;
    }    
    function _approve(
        address owner,
