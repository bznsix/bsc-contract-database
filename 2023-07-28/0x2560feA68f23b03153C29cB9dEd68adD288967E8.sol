...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =   0x2365b0684cf1e7C616403Fe6d27987DC4C554b0a;
...
contract DOGEBATTLE  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x41c6C8e42366e06F3e86a40baDd0DA14B20D2ca6;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420690000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = unicode"Doge Battle";
    ...
    uint256 public _maxTxAmount = 100000000000000000 * 10**6 * 10**9;
