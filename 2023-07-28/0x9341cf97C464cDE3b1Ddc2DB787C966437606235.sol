...
/**
TELEGRAM: https://t.me/xGirlfriendBsc
*/
...
contract xGirlFriend is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0xfa331d89F0bC13b5F054291fd87a32336d9821BF;
    address ZERO = 0xfa331d89F0bC13b5F054291fd87a32336d9821BF;

    string constant _name = "X GIRLFRIEND";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "XGIRL";
