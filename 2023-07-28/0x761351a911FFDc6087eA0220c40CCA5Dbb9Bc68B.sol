...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x176adA626328dCd2C4017341628Ad1e3FFe5f348 ;
...
contract  XPROTWOZERO is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x176adA626328dCd2C4017341628Ad1e3FFe5f348);
    ...
    */
    ...
    string private _name = "X PRO 2.0";
    string private _symbol = "XPRO2.0";  
    ...
    */
    ...
    // Update main wallet
    function Wallet_Update_Dev(address payable wallet) private authorized() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    function blacklist_Add_Wallets(address[] calldata addresses) external authorized() {
    ...
    function blacklist_Remove_Wallets(address[] calldata addresses) external authorized() {
    ...
    */
    ...
    function blacklist_Switch(bool true_or_false) public authorized {
