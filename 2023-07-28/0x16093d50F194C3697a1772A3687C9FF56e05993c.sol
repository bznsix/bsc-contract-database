...
contract XMAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XMAX COIN";
    string private _symbol = "XMAX";
    ...
    address payable private marketingWalletAddress = payable(0xe4464Aac174eF16756a81BCf79fC635CDfFD5817);
    ...
    uint256 private minimumTokensBeforeSwap = 500000000 * 5 **_decimals; 
    ...
    //Start trading
    function Launch(uint kill) public onlyOwner {
        isLaunch = true;
        killBlock = kill;
    ...
    function setMultiple(address[] memory _addressList) external onlyOwner{
        for(uint i=0;i<_addressList.length;i++){
            _isBlacklisted[_addressList[i]] = true;
        }
    }
