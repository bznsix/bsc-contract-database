...
contract PingPongInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf08B6858E7adaF86b526083f05a6768Ed42f7C30); 
    address payable public Wallet_Dev = payable(0xf08B6858E7adaF86b526083f05a6768Ed42f7C30);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "PingPong Inu"; 
    ...
    constructor () {
        _owner =0xf08B6858E7adaF86b526083f05a6768Ed42f7C30;
