...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x220b21Dd62302743Ee0228b36e59Ae7d506d80C4; // owner address
...
contract XLUIGI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-Luigi";
    string private _symbol = "$XLUIGI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x220b21Dd62302743Ee0228b36e59Ae7d506d80C4); // Marketing Address
    address payable private teamWalletAddress = payable(0x220b21Dd62302743Ee0228b36e59Ae7d506d80C4); // Team Address
