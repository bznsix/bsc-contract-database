...
// telegram : https://t.me/XProDogebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBfC0CE0Ba77CDB51517EB34989F01a3653a07599 ; // owner address
...
contract XPRODOGE is Context, IERC20, Ownable {
    ...
    string private _name = "X PRO DOGE";
    string private _symbol = "XPRODOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBfC0CE0Ba77CDB51517EB34989F01a3653a07599); 
    address payable public teamWalletAddress = payable( 0xBfC0CE0Ba77CDB51517EB34989F01a3653a07599);
    ...
    uint256 private _totalSupply = 100654321987654321 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply / 100; 
    uint256 public _walletMax =   _totalSupply / 100;
    uint256 private minimumTokensBeforeSwap = _totalSupply / 180; 
