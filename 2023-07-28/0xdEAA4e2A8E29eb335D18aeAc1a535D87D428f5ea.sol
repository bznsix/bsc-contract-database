// ❌TELEGRAM : https://t.me/+bg6v5psNASUzMDhk
// ◾️LOCKED 
// ◾️RENOUNCED
// ◾️LOW TAX
// ❌ THE REAPER 
...
contract REAPERX is Context, IERC20, Ownable {
    ...
    uint256 private _tB = 10;
    
    uint256 private _rfS = 0;
    uint256 private _tS = 10;
    
    uint256 private _rf;
    uint256 private _t;
    
    string private constant _name = "X The Reaper"; 
    string private constant _symbol = "ReaperX";
    uint8 private constant _decimals = 9;

    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    
    address payable private _devAddress = payable(0xa102eB0EBda2262a788Ee77Db0B2f61e3fbc0dD7);
    address payable private _marAddress = payable(0xa102eB0EBda2262a788Ee77Db0B2f61e3fbc0dD7);
