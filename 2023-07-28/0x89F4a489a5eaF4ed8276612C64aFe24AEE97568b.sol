...
contract DogeXPRO is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x411b77C93294eA139C3198A8fb85b839036D1516;
    address public devAddress = 0x27B273a2BdB36d4E1C4F241BbA465A4eF5F154CA;

    string private constant _name = "DogeXPRO";
    string private constant _symbol = "DogeXPRO";
    ...
    Taxes public taxes = Taxes(0,0,90,0);
    Taxes public sellTaxes = Taxes(0,0,90,9);
