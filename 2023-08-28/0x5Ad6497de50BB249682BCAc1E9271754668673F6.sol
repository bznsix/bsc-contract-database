...
contract SinVesting is AccessProtected {
    ...
    function createClaim(
        ...
        _createClaim(_beneficiary, _totalAmount, _startTime, _endTime);
    }
   ...
   function createBatchClaim(
       address[] memory _beneficiary,
        ...
        for(uint256 j = 0; j<_beneficiary.length; j++){
            _createClaim(_beneficiary[j], _totalAmount[j], _startTime, _endTime);
        }
    }
