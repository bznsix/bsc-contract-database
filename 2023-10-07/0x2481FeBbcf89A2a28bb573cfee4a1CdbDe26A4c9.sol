...
pragma solidity ^0.8.0;
contract USDTRADE is ERC20, Ownable {
    ...
    constructor() ERC20("USDTRADE", "UTRADE") {
        _mint(msg.sender, 205800*10**decimals());
        _mint(address(this), 480200*10**decimals());
        startSale(block.number, 999999999, 0,7500*10**decimals(), 2000000000000);
