...
contract CAN is IBEP20, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "Cannacoin";
    string private _symbol = "CAN";
    uint8 private _decimals = 18;

    uint256 private _totalSupply;
    uint256 private _maxSupply = 1000000000 * 10**_decimals;
    uint256 private _initialSupply = 1000000000 * 10**_decimals;
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(    
            ...
            "You can't mint more than 22 Billion"
        );
