...
contract WSBTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public fxcds41;
    ...
    string private _tokenname = "WSB";
    string private _tokensymbol = "WSB";
