...
contract PUMPSHIBA is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xAe1fc6bA87d62FC03092a920649d550831652E45;

    string private constant _name = "PUMP SHIBA";
    string private constant _symbol = "$PUSHIB";
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 1e9, "Cannot set swap threshold amount higher than 1% of tokens");
