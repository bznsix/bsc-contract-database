...
contract SphogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sphoge Inu";
    string private _symbol = "Sphoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0D8E14d3307bca7C4Aa3432ECfb2C25272040C72); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x97Bd9A7aF19B16d507fbD39e8D9d172e4cF6274c); // Buyback Address
