...
contract FRMPEPETOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ybbcvd47;
    ...
    string private _tokenname = "FarmerPepe";
    string private _tokensymbol = "FRMPEPE";
