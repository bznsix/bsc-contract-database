...
contract SpookyFloki is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Spooky Floki";
    string private _symbol = unicode"SPKY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xF0526f8a86980370A6362d63c9c1Ff258370a5bD);
    address payable public teamWalletAddress =
        payable(0x8B0aA8a620d14B819C57451175EB28E72199359e);
