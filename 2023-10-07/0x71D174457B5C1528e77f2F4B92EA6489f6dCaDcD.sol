...
contract amen is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4206900000000 * 10 ** _decimals;

    string private _name = "AME ESPORTS NIGHT";
    ...
    address public MKAddress = address(0x76BD6c2a4f909DBF369aA6D223EF6458f652AdEF);
