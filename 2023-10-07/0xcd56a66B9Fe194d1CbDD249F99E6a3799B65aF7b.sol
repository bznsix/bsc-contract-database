/*
   #LIQ+#RFI+#SHIB+#DOGE = #TZU

   #Shih Tzu features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee auto distribute to all holders
   There's a black hole so #TZU token will deflate itself in supply with every transaction
...
contract Shih is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 4000 * 10**6 * 10**9;
