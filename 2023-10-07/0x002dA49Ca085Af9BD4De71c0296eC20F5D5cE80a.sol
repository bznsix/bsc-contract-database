...
contract Ownable is Context {
    address private _owner = 0x1ccb0aadbbAD72a89Fdb9fF4F6d31F0c68b18E2A;
...
contract BABYK0 is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0xf574E9C9dfEb2B221fe099d868BF1Af2a1A6c681); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "BABYK0"; 
    string private _symbol = "BABYK0";
    ...
    uint256 public _minTokensSwapToAndTransferTo = 2400 * 10**6 * 10**_decimals; 
