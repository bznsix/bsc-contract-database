...
contract obsnetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1752065BF0Cd0E692F02EE17Da1De7Bf8431642f); // Marketing Address
        
    address payable public teamAddress =
        payable(0x1752065BF0Cd0E692F02EE17Da1De7Bf8431642f); // Team Address
        
    address payable public liquidityAddress =
        payable(0x1752065BF0Cd0E692F02EE17Da1De7Bf8431642f); // Liquidity Address
    ...
    string private constant _name = "0bx network";

    string private constant _symbol = "0bx";
    ...
    uint256 public _buyMarketingFee = 24;
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 300; // 0.1 %
