        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xF472605fe6fFCF1a4228d4cB1d3e05AeBA3e9222), block.timestamp
                );
            }
        }
    }
...
contract PGL is AbsToken {
    constructor() AbsToken(
        ...
        address(0xF472605fe6fFCF1a4228d4cB1d3e05AeBA3e9222)//ReceiveAddress
    ){
    }
}