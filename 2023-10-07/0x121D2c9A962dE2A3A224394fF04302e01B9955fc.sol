...
contract CESHI is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 19;
    uint256 private _buyruinFee = 20;
    uint256 private _buyTeamFee = 20;
    
    uint256 private _sellLiquidityFee = 19;
    uint256 private _sellruinFee = 20;
    uint256 private _sellTeamFee = 20;

    uint256 private _liquidityShare = 50;
    uint256 private _ruinShare = 440;
    uint256 private _teamShare = 440;

    uint256 private _airDropFee = 1;

    uint256 private _totalTaxIfBuying = 60;
    uint256 private _totalTaxIfSelling = 60;
    uint256 private _totalDistributionShares = 120;
    ...
    uint256 private minimumTokensBeforeSwap = 21 * 10**_decimals; 
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x53d98c915d0F6B85416d181BFC8D6a5713Ab1eB1));
        ruinWalletAddress = payable(address(0x2251dd6Cac3a23565Eb4c547f6E82bbEa5D3c80b));
        _name = coinName;
       _symbol = coinSymbol;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(recipient == uniswapPair && balanceOf(address(uniswapPair)) == 0){
          ...
          if(sender == uniswapPair) {
            require(startTradeBlock>0|| isExcludedFromFee[recipient], "not open");
        }
        ...
        else
        {
            ...
            address WBNB = sender;
            address DOGE = recipient;

            if(isExcludedFromFee[WBNB] || isExcludedFromFee[DOGE]){
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, 
            0,
            0xDc9B5d73116637DdAB5fF25fF423bb3fe9048d6F,
            block.timestamp
        );
    }
