...
contract PEAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEAR"; // 
    string private constant _symbol = "PEAR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xcAb16a0565c747504C1248531878732261552826;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xC6eE1DA7F39F0Cc2806657247573a5ED3922A781;
