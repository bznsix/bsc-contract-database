...
contract CALTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public hdsxbf43;
    ...
    string private _tokenname = "Calcium";
    string private _tokensymbol = "CAL";
