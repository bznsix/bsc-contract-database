...
contract VITTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ycbex5;
    ...
    string private _tokenname = "Vegas Inu Token";
    string private _tokensymbol = "VIT";
