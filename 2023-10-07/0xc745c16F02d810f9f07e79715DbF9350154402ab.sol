...
|_   _| |_ ___   |   __|_| |___ ___| |_   |   __|___ ___   
  | | |   | -_|  |__   | | | -_|   |  _|  |__   | -_| .'|  
  |_| |_|_|___|  |_____|_|_|___|_|_|_|    |_____|___|__,|  
                                                           

    Token name: The Silent Sea (TSSEA)
    Telegram: https://t.me/thesilentsea_official
    Website: http://thesilentsea.io/
...
contract TheSilentSea is ERC20, Ownable, Shared {
    ...
    uint256 public blacklistTimeout = 14400 minutes;
    ...
    address public marketingWalletAddress = 0xE993E861E96aaAD57782cee057608be2C7280A76;
    ...
    constructor() ERC20("The Silent Sea", "TSSEA") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TheSilentSea: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "TheSilentSea: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, "TheSilentSea: Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TheSilentSea: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TheSilentSea: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "TheSilentSea: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "TheSilentSea: Blacklisted address");
