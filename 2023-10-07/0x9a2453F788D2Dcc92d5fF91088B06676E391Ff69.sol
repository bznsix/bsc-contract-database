...
contract Fil2SBT is ERC20,WhiteList {
    
    uint256 private constant preMineSupply = 2000000000 * 1e18;

    constructor() ERC20("Fil2SBT", "Fil2SBT"){
        _mint(msg.sender, preMineSupply);
    }
  
    function mint(address _to, uint256 _amount) public  returns (bool) {
        require(isWhiteListed[msg.sender]==true,"minter caller is not owner nor approved");
        _mint(_to, _amount);
        return true;
    }
