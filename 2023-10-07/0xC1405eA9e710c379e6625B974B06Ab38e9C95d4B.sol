...
contract testESRFIlms is Context, IERC20, Ownable {
    ...
    uint256 public coolDownLMS = 3600;
    uint256 public minimumTokenBalanceForLastManStanding = 10000000 * (10**18);
    ...
    address public rewardToken = 0x55d398326f99059fF775485246999027B3197955; //USDT BSC Mainnet
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function _setRewardToken(address token) external onlyOwner {
		rewardToken = token;
	}
