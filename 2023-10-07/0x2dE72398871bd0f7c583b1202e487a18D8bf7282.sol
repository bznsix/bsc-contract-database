...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19A56d8215610768116aa226242996d80399B0bD; // owner address
...
contract BNBLONG is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x19A56d8215610768116aa226242996d80399B0bD); // Marketing Address
    address payable private teamWalletAddress = payable(0x19A56d8215610768116aa226242996d80399B0bD); // Team Address
    ...
    uint256 public _maxTxAmount = 98 * 10**_decimals; 
    uint256 public _walletMax = 98 * 10**_decimals;
