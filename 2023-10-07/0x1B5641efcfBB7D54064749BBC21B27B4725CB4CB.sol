...
contract DanaNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      _wallet = 0x56d2142B03f2f4220eBBd921400660B56DD3B825;
  }
...
function setmintReward(uint256 _newmintReward) public onlyOwner {
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    ...
    require(_winner != address(0), "DanaNFT: zero address");
    require(_amount > 0, "DanaNFT: you have to mint at least one");
    require(lastSupply != 0,  "DanaNFT: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"DanaNFT: URI query for nonexistent token");
