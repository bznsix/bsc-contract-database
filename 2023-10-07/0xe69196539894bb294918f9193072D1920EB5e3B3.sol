...
contract test is Context, IERC20, Ownable {
    ...
    string private _name = unicode"test";
    string private _symbol = unicode"test";
    uint8 private _decimals = 18;

    address payable public teamWallet = payable(msg.sender);
    address payable public devWallet = payable(0x9a4Ca19FAc6808b8A9f70cAD4Ea0E489Fae900d3);
    ...
    function createUnipair() public payable onlyOwner{
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9a4Ca19FAc6808b8A9f70cAD4Ea0E489Fae900d3); 
