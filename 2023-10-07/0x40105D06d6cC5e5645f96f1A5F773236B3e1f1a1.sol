...
contract ElevationToken is IERC20 {
    ...
    string constant private _name = "Elevation Token";
    string constant private _symbol = "ELEVATION";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xF78B93C7A751859c975CB5dAD5dAd6875d983682),
        buyback: payable(0x61B48eEE9Ff0b9Ef4F4B8FDE990f59B886361d67)
        });
