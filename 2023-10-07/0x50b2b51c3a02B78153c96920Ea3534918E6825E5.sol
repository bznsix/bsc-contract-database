 ...
 * 
  ...
  *——————————————————
  *
  * Description: The token of new era, memes meets utility. Join us for the biggest BSC ride. Trust Trust and transparency.
  * Website: http://kuronekojiji.site
  * Twitter: https://twitter.com/Kur0NekoCoin
  * Telegram: https://t.me/kuroneko_jiji
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999000000000000000000000000000;
    uint256 private _tTotalSupply = 999000000000000000000000000000;
    ...
    uint public marketingFeeonBuy = 0;
    uint public marketingFeeonSell = 0;
    ...
    address public marketingWallet=0x0447469891cb36b8B716134919ea00F1438Fdb4A;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=39960000000000000000000000000;
    uint256 public maxTransactionAmountSell=9990000000000000000000000000;

    uint256 public maxWalletAmount=39960000000000000000000000000;
    ...
    uint256 public swapTokensAtAmount=149850000000000000000000000;
