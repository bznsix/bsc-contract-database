...
contract UPTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public unyhn67;
    ...
    string private _tokenname = "UPTOBER";
    string private _tokensymbol = "UP";
