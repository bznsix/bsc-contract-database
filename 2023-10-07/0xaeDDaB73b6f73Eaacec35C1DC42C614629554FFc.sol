...
contract ALLin {
    ...
    constructor(address allocationsContract) public
    {
        ...
        totalSupply = 100000000000000*10**18;                // initialSupply
        name = "ALLin";                         // Set the name for display purposes
        symbol = "ALLin";                            // Set the symbol for display purposes
    ...
    /**
     * @dev Notifies ALLin contract about a new rebase cycle.
    ...
    function transferFrom(address from, address to, uint256 value) public returns (bool) {
        require(to != address(0),"Invalid address.");
        require(to != address(this),"Molecules contract can't receive ALLin.");
