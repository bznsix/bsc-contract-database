...
contract ShibaCyborg is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Cyborg";
    string private _symbol = "SHICY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48102475Ce26E17208FF9a43ec6F7187A01a08C7); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x48102475Ce26E17208FF9a43ec6F7187A01a08C7); // Development Address
    ...
    uint256 public _walletMax = 1 * 10**9 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**9 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
