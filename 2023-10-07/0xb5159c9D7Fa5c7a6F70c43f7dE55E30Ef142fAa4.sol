...
contract Token is ERC20 ,Ownable{
    ...
    TaxRates public buyTax = TaxRates(100, 200, 100, 100);
    TaxRates public sellTax = TaxRates(100, 200, 100, 100);
    ...
    constructor() ERC20("TEST", "TEST") {
        ...
        marketingWallet = 0xEDd91d63a21EAb0d262e7759d0968F38ec595a82;
        ...
        maxWalletBalance = 100 * 10 ** decimals();
