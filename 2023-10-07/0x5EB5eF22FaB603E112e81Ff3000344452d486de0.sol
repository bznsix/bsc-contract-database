...
contract UniXcite is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"UniXcite", unicode"UXC") 
    {
        address supplyRecipient = 0x4d35D9403E798B1214E3Bfe4A10097D27D5476A1;
        
        autoBurnFeesSetup(500, 500, 700);

        updateSwapThreshold(2000000000 * (10 ** decimals()) / 10);

        lpTokensReceiverSetup(0x4d35D9403E798B1214E3Bfe4A10097D27D5476A1);
        liquidityFeesSetup(700, 700, 0);

        excludeFromFees(supplyRecipient, true);
        excludeFromFees(address(this), true); 

        _mint(supplyRecipient, 4000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x4d35D9403E798B1214E3Bfe4A10097D27D5476A1);
    }
