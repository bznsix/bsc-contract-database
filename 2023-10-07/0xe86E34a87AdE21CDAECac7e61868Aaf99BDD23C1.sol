...
https://t.me/smeagolsafu
Baby Smeagol paying Smeagol rewards.
...
contract BabySmeagol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabySmeagolDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby Smeagol", "BSMGO") {
        marketingWallet = payable(0x30D7ECCCf048230317F9DA2AB63B091C98EF7B2B);
        devWallet = payable(0x6727a131453496f7Ae99e22E980A031FDA23e81c);
        ...
        dividendTracker = new BabySmeagolDividendTracker(
            payable(this),
            router,
            0x94A7470B305F11B15E360d98E9206Cfd37078498,
            "BabySmeagolTRACKER",
            "BabySmeagolTRACKER"
        );
        ...
        swapTokensAtAmount = totalTokenSupply / 200; // 0.05%;
...
contract BabySmeagolDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabySmeagol public BabySmeagolContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabySmeagolContract = BabySmeagol(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabySmeagol_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabySmeagol_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabySmeagol contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabySmeagolContract);

            uint256 prevBalance = BabySmeagolContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabySmeagolContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabySmeagolContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
