...
contract WSMGTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tgbvxty5;
    ...
    string private _tokenname = "wall street memes games";
    string private _tokensymbol = "WSMG";
