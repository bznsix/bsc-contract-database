...
contract huskkyinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x75DbC9C5dA826168F9c76d490c0d6Dfd1A64E32f); // Marketing Address
        
    address payable public teamAddress =
        payable(0x75DbC9C5dA826168F9c76d490c0d6Dfd1A64E32f); // Team Address
        
    address payable public liquidityAddress =
        payable(0x75DbC9C5dA826168F9c76d490c0d6Dfd1A64E32f); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10 * 1e15 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    string private constant _name = "huskky inu";

    string private constant _symbol = "huskky";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 300; // 0.333 %
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      ...
      require(_walletMax >= _tTotal * 1 / 3000 , "Must keep above 0.3%");
        }
