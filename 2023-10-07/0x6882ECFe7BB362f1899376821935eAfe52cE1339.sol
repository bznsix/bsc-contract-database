...
/**
   ...
   Welcome to COIN SAVIOUR
   
   This is a community token. If you want to create a telegram I suggest to name it to @COINSAVIOURBSC
   ...
   I will renounce the ownership to burn addresses to transfer #COINSAVIOUR to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #COINSAVIOUR 10000X? 
   ...
   it's the best part of the #COINSAVIOUR idea, increasing the liquidity pool automatically, 
...
contract COINSAVIOUR is Context, IERC20, Ownable {
    ...
    string private _name = "COINSAVIOUR";
    string private _symbol = "COINSAVIOUR";
