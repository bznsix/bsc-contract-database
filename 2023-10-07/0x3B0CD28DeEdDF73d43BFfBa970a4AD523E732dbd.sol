...
contract LuffyG5 is ERC20, Ownable, ReentrancyGuard {
    ...
    event SendPreSaleTokens(address receiver,uint256 amountTokens,uint256 valueBNBgwei);
    ...
    event SettedPercent(uint256 newPercent0, uint256 newPercent1, uint256 newPercent2);
    ...
    constructor() ERC20("LUFFY G5", "LG5") {
        ...
        percent.percent1    = 300;
        percent.percent2    = 300;

        projectWallets.marketingWallet = 0xe9A1F26655786524002F0A15b1AEa59A14D9B52E;
        projectWallets.developmentWallet1 = 0x0BD5f1f2681f18423f87C934d224A1B91C3D31bd;
        projectWallets.developmentWallet2 = 0x8F9fefFD4E2437FcB3ACFDCf0c923702D58bE0B2;
        projectWallets.developmentWallet3 = 0xc873eFd5ae6d7e249fAE1C816e373AB9926e5f91;
    ...
    */
    ...
    function setProjectAdresses (
        ...
        emit SettedProjectWallets(
            _marketingWallet, _developmentWallet1, _developmentWallet2,_developmentWallet3
            );
    }
