...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x133ed3b00C9D8eD1107cb0b52E15C3736092c9Ec; // owner address
...
contract BLACKPANDA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Black Panda";
    string private _symbol = "BPanda";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF864A54960bD953983bEddca87f3C29Db91C8d1A);
    address payable public teamWalletAddress = payable(0xF864A54960bD953983bEddca87f3C29Db91C8d1A);
