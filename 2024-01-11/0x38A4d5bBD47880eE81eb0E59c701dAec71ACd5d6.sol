...
contract Rabbit_Grok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Grok";
    string private _symbol = "RGK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA6C88593Adc01Cf9bee193212037EbA971d756e0);
    address payable private DevelopmentWalletAddress = payable(0x483bD063aD3756783696C4afCE172A37dD6d0806);
    ...
    uint256 private _totalSupply = 4200000000000000* 10**9;
    uint256 public _maxTxAmount = 4200000000000000 * 10**9;
    uint256 public _walletMax =  4200000000000000 * 10**9;
