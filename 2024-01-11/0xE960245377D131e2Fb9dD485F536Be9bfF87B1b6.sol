// $IBIT - A BEP20 token on BNB Smart Chain

// Website: https://ibitbnb.com

// Telegram: https://t.me/iBiTBNB

// X (Formerly Twitter): https://x.com/IBITBNB
...
contract IBITBNB is ERC20, Ownable {
    using SafeMath for uint256;

    IDexRouter private immutable dexRouter;
    address public immutable dexPair;
    address private newOwner = 0xAfB075a573CdE3C17cB2749063c967758D1b0A87;
    ...
    constructor() ERC20("IBIT", "IBIT") {
        ...
        mktReceiver = address(0x99005741052D30f4CB1B8941Ba49aa3d86B04032);
        devReceiver = address(0x847350262e943393f3b1F819279b3dbb54517329);
