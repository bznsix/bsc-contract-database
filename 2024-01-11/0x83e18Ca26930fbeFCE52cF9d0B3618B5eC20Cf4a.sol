...
contract RapidchaintOKEN is IERC20, Auth {
    ...
    string constant _name = "Rapidchain";
    string constant _symbol = "Rapidchain";
    ...
    uint256 public swapThreshold = 70000000000 * (10 ** _decimals); // 0.1%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }
    //Contract Update Information
    string public constant Contract_Version = "0.8.23";
    string public constant Contract_Dev = "Team Rapidchain SAFU DEV || NFA,DYOR";
    string public constant Contract_Edition = "Contract For 1M";
    string public constant RapidchainTGNEWS = "https://t.me/Rapidchain";
