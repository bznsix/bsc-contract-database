...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) private killList;
    ...
    constructor (
        ...
        holderRewardCondition = 10 * 10 ** 18;
            ...
            if (_swapPairList[sender]){
                ...
                if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            ...
                            uint256 numTokensSellToFund = tAmount * swapFee / 50;
...
contract  ZWOIAN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000,
        address(0xAff405D4caD67118063cA52c9Ca277353dA26823),
        address(0x68Fa761B96f69a645b6AD8DfAc4952725e00374e)
    ){
