/**
  Telegram: https://t.me/bullishSEC
...
contract BullishSec is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bullish Sec";
    string private constant _symbol = "Bullish Sec";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x91024Bd8A3FCA49eFF78ec382B7015690634e490);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x91024Bd8A3FCA49eFF78ec382B7015690634e490] = true;
    ...
    function changeTax(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
        require(newBuyTax <= 5 && newSellTax <= 5, "ERC20: wrong tax value!");
        buyTax = newBuyTax;
        sellTax = newSellTax;
    }
