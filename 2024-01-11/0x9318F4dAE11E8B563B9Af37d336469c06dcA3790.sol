/**
Telegram : https://t.me/aikoncloud
Website :https://aikon.cloud
*/
...
contract AIKONCLOUD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x96C0a209C3C9a6cDDee462BbA17A4684B9D75f7C); 
    address payable private Wallet_Dev = payable(0x96C0a209C3C9a6cDDee462BbA17A4684B9D75f7C);
    ...
    string private constant _name = "Aikon Cloud "; 
    string private constant _symbol = unicode"AIKON"; 
    ...
    constructor () {
        ...
        _owner = 0x96C0a209C3C9a6cDDee462BbA17A4684B9D75f7C;
