...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x258c5995c5AEcAbF85f2bAF8b3052A44D3eF2e29; // owner address
...
contract BabyDejitaruTsuka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Dejitaru Tsuka";
    string private _symbol = "BBYDJT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x096b2de5a9B18C434c2473Ad252Fe798E88B8E27); // Marketing Address
    address payable private teamWalletAddress = payable(0x096b2de5a9B18C434c2473Ad252Fe798E88B8E27); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 20;  // original 12
