...
contract GraspRiches is Context, Ownable, IERC20 {
    ...
    uint256 private swapAllocation = 80;
...
//--- Allocations by Freddy analytixaudit.com ---//
    ...
    constructor (
        ...
        _balances[liquidityAddress] = (_totalSupply * 60) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 60) / 100);
        _balances[AddressParams[2]] = (_totalSupply * 40) / 100;
        emit Transfer(address(0), AddressParams[2], (_totalSupply * 40) / 100);
