...
Telegram https://t.me/BitConnectify
Website https://bitconnectify.com/
*/
...
contract Bitconnectify is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BiTconnectify";
    string private _symbol = "$BCT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98Cb3Eadf845478DA8B71592F75ED5dCCA3e8774); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x270B49520c78e5678716F53CA6da550cd00FF99E); // BuyBack Address
