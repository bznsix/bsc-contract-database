//SPDX-License-Identifier: MIT
 ...
 /* 
  * JFF AKA Jeff - Jeet For Free
  * Telegram : https://t.me/j4fbsc
  * Twitter/X: https://x.com/JeetforFree
  * Website:   https://j4f.xyz
  *
  * Jeet for Free is a well thought out zero tax protocol.
  * With only a 6% Entry tax and 0% Sell Tax, those who want to snipe and jeet are welcome.
  * Holders will get great benefits due to the fullstack team behind JFF.
  * Make sure to join telegram and see if you've won our Jackpot, automatically played every buy!
  *
*/
...
contract jeetforfreeStandard is ERC20, Ownable {
    ...
    constructor(address _developmentWallet) ERC20("JEETFORFREE", "JFF") {
