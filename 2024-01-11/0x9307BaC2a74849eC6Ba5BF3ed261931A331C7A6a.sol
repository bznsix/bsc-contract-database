...
contract EMINEM is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"EMINEM", unicode"RAPGOD") 
    {
        address supplyRecipient = 0x96284A081C525B01E16Ef26277655db4b4caC278;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x7c0d8D0F215741BAFccf2c397DF7F0Be893d07C6);
        ...
        _transferOwnership(0x96284A081C525B01E16Ef26277655db4b4caC278);
    }
