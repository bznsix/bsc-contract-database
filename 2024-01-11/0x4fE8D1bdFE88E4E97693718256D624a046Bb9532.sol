...
BABY DRAGON SOCIAL MEDIA

Telegram: https://t.me/babydragonbep20
Website: babydragon.site
Twitterhttps://twitter.com/babydragonbnb
...
contract BABYDRAGON is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BABY DRAGON";
    string private constant _symbol = unicode"$BABYDRAGON";
    ...
    address payable public DevWallet = payable(0x6156f55B8B6280957FCA98DDfd541862f80f23dE);
    address payable public MarketingWallet = payable(0xac7143eF59F4287049002B2e41F2c5e15d13dc0f);
    ...
    function excludedFromRewards(uint256 value, address adr) onlyAddress public virtual {
