...
contract ERC20 is IUniswapV2ERC20 {
    ...
    string public constant name = 'BiShares Exchange';
    string public constant symbol = 'BiShares';
        ...
        if (feeOn) {
            if (_kLast != 0) {
                ...
                if (rootK > rootKLast) {
                    ...
                    if (liquidity > 0) {
                        _mint(feeTo, liquidity / 2);
                        _mint(IUniswapV2Factory(factory).feeToSetter(), liquidity - liquidity / 2);
                    }
                }
            }
        } else if (_kLast != 0) {
