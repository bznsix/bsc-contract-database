...
contract MoonBase is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor (
        ...
        _rOwned[0x20275069824eCceDB5452Eb7b262EA3D4725960b] = _rTotal;
        ...
        emit Transfer(address(0), 0x20275069824eCceDB5452Eb7b262EA3D4725960b, _tTotal);
    }
    ...
    // Innovation for protocol by MoonBase Team
