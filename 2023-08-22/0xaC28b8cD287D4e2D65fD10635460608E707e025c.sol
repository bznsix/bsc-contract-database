...
contract BasicWallet {
    ...
    function handleOps(
        ...
        if (GFALProxy.checkAdmin(msg.sender) && preGas != usedGas) {
            postOp(preGas, gasPrice);
        }
    ...
    function postOp(uint256 preGas, uint256 gasPrice) internal {
        ...
        ISwapBNBGFAL(SwapperBNB_GFAL).swapGFALforBNB(GFALFee, 1); // todo! IMPORTANT!!!!!!!!!! May we need to reduce the gasReceipt
