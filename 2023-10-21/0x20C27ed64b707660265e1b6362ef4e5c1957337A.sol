    ...
    function addDistributor(
        ...
        require(
            !distributorsMapping[_BEP_TOKEN].exists,
             "T60/Distributor already exists"
        );
...
contract T60 is IBEP20, Auth {
    ...
    string constant _name = "T60";
    string constant _symbol = "T60";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200_000_000_000 * (18**_decimals);
    ...
    uint256 buybackMultiplierLength = 10 minutes;
    ...
    uint256 public swapThreshold = _totalSupply / 10000; // 0.005%
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
