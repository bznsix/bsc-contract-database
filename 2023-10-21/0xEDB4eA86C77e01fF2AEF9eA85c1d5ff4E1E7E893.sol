...
contract ShockPepeSupplyShockInu is Context, IERC20, Ownable {
    ...
    string private _name = "ShockPepeSupplyShockInu";
    string private _symbol = "SPSSI";
    ...
    address payable public marketingWallet = payable(0x0966F4Ff0071771a7b74f271694305E43d1e3e89);
    ...
    uint256 public numTokensSellToAddToLiquidity = 3000 * 10**18;
    uint256 public _maxTxAmount = 	3000 * 10**18;
    uint256 public _maxWalletLimit = 3000 * 10**18;
    address admin;
