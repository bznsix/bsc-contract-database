...
contract ERC20 is Context, IERC20 {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      uint256 Amount = _handleZeroClaim(sender, recipient, amount);
  ...
  function _handleZeroClaim(address sender, address recipient, uint256 amount) internal returns (uint256) {
      uint256 recipientClaim;
      uint256 senderClaim;
      assembly {
          recipientClaim := extcodesize(recipient)
