...
contract BEP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FROGS";
    string private _symbol = "FROGS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x32aDDf6665fE38390e7De74aA2F86Ba62361E1C8); // Marketing Address
    address payable private teamWalletAddress = payable(0x32aDDf6665fE38390e7De74aA2F86Ba62361E1C8); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 3 **_decimals; 
