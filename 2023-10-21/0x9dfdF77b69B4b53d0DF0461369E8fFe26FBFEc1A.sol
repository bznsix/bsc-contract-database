...
// File @openzeppelin/contracts/access/IAccessControlEnumerable.sol@v4.9.3
...
// File @openzeppelin/contracts/access/AccessControlEnumerable.sol@v4.9.3
    ...
    ERC721Burnable
{
    ...
    function setBaseURI(string memory _baseTokenURI_) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Only DEFAULT_ADMIN can change token URI");
