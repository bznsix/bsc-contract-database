...
/**
https://t.me/BabyEtherShenCrypto
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF8271b1d6B5284B2FaCFa5A238459D015ffe78d2; // owner address
...
contract BabyEtherShenCrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyEtherShenCrypto";
    string private _symbol = "BabyETS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF8271b1d6B5284B2FaCFa5A238459D015ffe78d2); // Marketing Address
    address payable private teamWalletAddress = payable(0xF8271b1d6B5284B2FaCFa5A238459D015ffe78d2); // Team Address
