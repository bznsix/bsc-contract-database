...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0x6E8DdF8CA2e326A6677F2363edE03A27428C8EFE;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0x810E1d64E50A9136E5681Db177Be156dC7f72F0F;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0x0DBa0D49228d3D5aF01F3ADDB12812860EA8df61;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "KUWAKUWI";
  string private _symbol = "KWKW";
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "VCG: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "VCG: transfer from the zero address");
    require(recipient != address(0), "VCG: transfer to the zero address");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "VCG: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "VCG: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "VCG: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "VCG: approve from the zero address");
    require(spender != address(0), "VCG: approve to the zero address");
