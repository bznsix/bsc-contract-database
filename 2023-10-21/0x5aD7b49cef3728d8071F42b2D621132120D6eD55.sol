        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xf19231e8D019dACE109C5d8647aa5804257b85f8), block.timestamp
                );
            }
        }
    }
...
contract CSRoadDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xFfAe14Fad43590787275908B0b3B8205df7CaA51),//FundAddress
        address(0xf19231e8D019dACE109C5d8647aa5804257b85f8)//ReceiveAddress
    ){
    }
}