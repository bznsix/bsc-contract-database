/*
#####################################
Token generated with ❤️ on Rango.lol
#####################################
*/
...
contract Rango is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"Rango", unicode"RANGO") 
    {
        address supplyRecipient = 0x7645cf10a9AbC5D2365fc5cBAD9a68D2aebfb42f;
        
        updateSwapThreshold(500000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0xeC965c7adf678C58CD5704C021bBdeF8075Fe1c7);
        ...
        _transferOwnership(0x7645cf10a9AbC5D2365fc5cBAD9a68D2aebfb42f);
    }
