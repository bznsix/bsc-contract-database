/**
 Telegram : https://t.me/letsplay_official
 Website : https://playmeme.fun/
 Twitter : https://twitter.com/letsplaymeme
*/
...
contract PlayMeme is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "PLAY";
    string private _symbol = "PLAY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6e21b7E22B768150712f7Aaf38868046FF743ead);
    address payable public burnedWalletAddress = payable(0x6e21b7E22B768150712f7Aaf38868046FF743ead);
    ...
    uint256 private _totalSupply = 100000000 * 10**8 * 10**_decimals;
    uint256 public maximumTransferAmount = 1000000 * 10**8 * 10**_decimals;
    ...
    function _transfer(
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");
            // Check if the transfer amount exceeds the maximumTransferAmount
        if (amount > maximumTransferAmount) {
            // Allow transfers exceeding maximumTransferAmount for specific recipients
            require(
                recipient == owner() ||
    ...
    function setMaximumTransferAmount(uint256 amount) external onlyOwner {
    maximumTransferAmount = amount;
    }
    ...
    function setTaxFee(
        ...
        require(
            newBuyLiquidityFee <= 35 && newBuyMarketingFee <= 35 &&
            newSellLiquidityFee <= 35 && newSellMarketingFee <= 35,
            "Fee cannot exceed 35% SAFE FOR investor"
        );
