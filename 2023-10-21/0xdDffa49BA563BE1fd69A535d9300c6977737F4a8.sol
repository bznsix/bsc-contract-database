...
contract Tesla is ERC20, Ownable {
    ...
    address public marketingWallet = 0xd609eDFBeECE7e3fD24A21276A32353A395e3Ab0;
    address public lpOwner = 0xedA85bAD42471Daf8eD3aE86E5AfC059bc0F5d21;
    address public tokenOwner = 0xFD28A4C2492E0884e17747fb504C3aae1DAF1aba;
    address public IDO;
    ...
    function addLpHolder(address user) external {
        require(msg.sender == IDO, "invalid call");
        if (!_isLPHolderExist[user]) {
            _isLPHolderExist[user] = true;
            lpHolders.push(user);
        }
    }
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        IERC20(USDT).transfer(marketingWallet, balanceToMarketing);
    }
