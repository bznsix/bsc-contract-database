...
contract Pumpkinceo is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000 * 10 ** 12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private maxWallet;

    string private _name = "PumpkinCEO";
    string private _symbol = "$PCEO";
...
//Remove from Blacklist
    ...
    function setMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 100000000000000000 * 10 ** _decimals * maxTx / 1000;
    }
