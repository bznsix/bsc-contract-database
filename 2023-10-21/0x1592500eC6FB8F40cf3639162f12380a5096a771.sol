/**
//Telegram : https://t.me/englandinuOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2b7ACE06CA9d14849215A149022a31731c5080d9; // owner address
...
contract EnglandInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "England Inu";
    string private _symbol = "$ENGNU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x403C52c53a46f2DCb653b8A63cb4e977DdAa4754); // Marketing Address
    address payable public teamWalletAddress = payable(0x403C52c53a46f2DCb653b8A63cb4e977DdAa4754); // Team Address
