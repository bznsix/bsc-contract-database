/*
  Ready for the absolute moonshot ShibCoin?  The final boss of all the Shiba's?

  Introducing ShibFaced, The ShitFaced Shiba!
  
  This token is a community coin whos goal is to Devastate the Shiba Economy with MASSIVE pumps!
  
  Tons of marketing on the way you know the drill , TikTok, Youtube, Influencers and maybe even a potential billboard!
  
  Join the community where the hype is!
  
  Telegram: https://t.me/ShibFaced
...
contract ShibFaced is Context, IERC20, Ownable {
    ...
    string private _name = "ShibFaced";
    string private _symbol = "SHIBFACED";
    ...
    uint256 private _marketingPercentageOfLiquidity = 60;
