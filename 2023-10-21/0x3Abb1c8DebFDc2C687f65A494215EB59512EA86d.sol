...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D4427cEBc9148fdEE0820d7B585E3DB7A2Bf1Df; // owner address
...
contract BLUEWHALES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blue Whales";
    string private _symbol = "Blue Whales";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D4427cEBc9148fdEE0820d7B585E3DB7A2Bf1Df); 
    address payable public teamWalletAddress = payable(0x6D4427cEBc9148fdEE0820d7B585E3DB7A2Bf1Df);
