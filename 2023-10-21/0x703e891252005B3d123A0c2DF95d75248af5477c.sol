//Porsche Paramera （TRX） CHAIN King's return Co-created by （ALEX）+（LISA）
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x636179688949364f6a0469F184A8Dd12606aE4e6), block.timestamp
                );
            }
        }
    }
...
contract  PORSCHE is AbsToken {
    constructor() AbsToken(
        ...
        "Porsche Paramera",//Name
        "PORSCHE",//Symbol
        9,//Decimals
        100000,//Supply
        address(0xF642DCDd88D2da5159B1693744b3893EA04968b0),//FundAddress
        address(0x636179688949364f6a0469F184A8Dd12606aE4e6)//ReceiveAddress
    ){
    }
}