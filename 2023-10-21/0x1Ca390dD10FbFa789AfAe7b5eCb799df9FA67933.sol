...
contract twelvemonkeyscoin is IERC20, Ownable {
    using Address for address;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Twelve Monkeys coin ";
    string constant _symbol = "TMC";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 154_000_000_000 * (10 ** _decimals);
