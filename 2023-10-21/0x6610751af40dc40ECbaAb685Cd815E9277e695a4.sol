...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfF6220F70381adBa2Af7fEf0CFa8EaE696A84173; // owner address
...
contract OneDollarCostAveraging is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "One Dollar Cost Averaging";
    string private _symbol = "ODCA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfF6220F70381adBa2Af7fEf0CFa8EaE696A84173); // Marketing Address
    address payable private teamWalletAddress = payable(0xfF6220F70381adBa2Af7fEf0CFa8EaE696A84173); // Team Address
    ...
    uint256 public _walletMax = 1 * 10**_decimals;
