...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellPoolDestroyRate = 22000;
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                if (poolDestroyAmount > 0) {
                    _standTransfer(mainPair, address(0x000000000000000000000000000000000000dEaD), poolDestroyAmount);
...
contract DAW is AbsToken {
    ...
    //USDT
        ...
        address(0xE4e2e6c5A14c5758B1c473343A6cDc2E6B9c4213),
    
        address(0xd1aaaDAF7C43e3911515398343Fd53FCB5A439da)
    ){
