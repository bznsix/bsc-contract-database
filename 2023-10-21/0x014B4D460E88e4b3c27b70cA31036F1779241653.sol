...
/*
   MonkeFlip: Apes Together Strong
   
   Token contract contains strong tokenomics as well as a marketing wallet which will fund marketing efforts.
   
   Ownership Renounced
   
   Tokenomics
   4% fee auto add to the liquidity pool to locked forever when selling
   6% fee auto add to marketing wallet
   1% fee auto distribute to all holders
   
   
   Telegram: https://t.me/MonkeFlipOfficial
...
contract MonkeFlip is Context, IERC20, Ownable {
    ...
    string private _name = "MonkeFlip";
    string private _symbol = "MFLIP";
