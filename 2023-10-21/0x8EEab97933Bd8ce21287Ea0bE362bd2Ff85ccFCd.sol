/**
--------- Project Blockchain Kardus ---------
Tidak ada ajakan membeli Token ini.
No one asking you to buy this token.
Token ini adalah nano LP token.
This is nano lp token.

Tujuan token ini adalah pembuktian bahwa BSC market sedang tidak baik2 saja dan sangat berbahaya untuk orang awam.
The purpose of this token is just for fun and only to give proof that BSC market condition is very difficult for newbie or non degen player. 

Tax 8% beli dan jual 4% Reflection buat holder 4% marketing.
8% buy and sell tax. 4% Reflection for holder and 4% for marketing.

Website dan Testnet akan di buat setelah dana marketing terkumpul.
Website and testnet will be make once the funds is collected. 

// TELEGRAM : tidak ada tg karena banyak orang sirik
// WEBSITE  : belom ada dana buat bikin website.

Ingat tidak ada paksaan membeli. token ini hanya for fun only. hanya untuk pembuktian kalo semua orang bisa bikin project blockchain kardus.
Launch jam 6 sore WIB. 12.00 UTC
...
contract BlockchainKardus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Blockchain Kardus";
    string private _symbol = "KARDUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xdeadfacE0f5C187320b3D7c7B91EF607D66933b9);
