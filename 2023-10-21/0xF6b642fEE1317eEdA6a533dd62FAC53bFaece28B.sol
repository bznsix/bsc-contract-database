...
/**The newest viral charity token in BSC.
$PLAY collaborates directly with professional athletes and entertainers to send children from low income families to clubs and sports camps. 
Helping all children meet their full potential. Giving the youth of the world the ability to meet their full potential. 
In collaboration with professional athletes from NBA,NFL,MLB,FIFA, etc. Play is THE defining Charity Token on the Binance Smart Chain. 
Our team has enormous goals, as a result we have decided not to limit our charity to one cause.
Telegram:https://t.me/PlayOfficialGroup
*/
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x758bb7862A4D0b958c05506f14A5c4530fA771CF ;
...
contract PLAY is Context, IERC20, Ownable {
    ...
    string private constant _name = "PLAY"; // 
    string private constant _symbol = "$PLAY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x758bb7862A4D0b958c05506f14A5c4530fA771CF);
