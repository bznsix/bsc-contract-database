...
contract HIBATOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public rjansk81;
    ...
    string public _tokenname = "Halloween Shiba";
    string public _tokensymbol = "HIBA";
