...
contract M188 is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x6E0A32D3453cD95388eea7B97D1e3bDE84e34818); //
        ...
        super.setSurprise(
            9000,
            0,
            address(0x6E0A32D3453cD95388eea7B97D1e3bDE84e34818)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x6E0A32D3453cD95388eea7B97D1e3bDE84e34818);
        feeEarn = 0;
        isLiquified = true;
    }
}