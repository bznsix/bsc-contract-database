...
contract StatueOfLiberty is Context, IERC20, Ownable {
    ...
    string private constant _name = "Statue Of Liberty";
    string private constant _symbol = "Liberty";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0xa724184aA32C43339E8414f582d0f61d71c6AC8D);
    address payable private _marketing2Address = payable(0xa4914C5371CBA366ab93eA10b02f213aCFbCfD4F);
    address payable private _marketing3Address = payable(0xa72B06c9256afF11c0957B965E2008b49eA2e575);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        uint256 mkt2Amount = amount.mul(2).div(7);
