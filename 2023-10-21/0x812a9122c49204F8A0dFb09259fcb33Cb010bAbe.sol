...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 13140000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function _transfer(
        ...
        require(!isBot[from] && !isBot[to], "Account is bot");
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xC1C26D985Bf01f5766B8461B14Fcc51d6210E1fa;    
   ...
   function setBot(address[] calldata _account, bool newValue) external onlyOwner {
        for (uint i = 0; i < _account.length; i++){
            isBot[_account[i]] = newValue;
        }
    }
...
contract LuckyToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x6C64b803AD93d850cAC7924b16396fE3F0DFaf93) //开发
    ){
