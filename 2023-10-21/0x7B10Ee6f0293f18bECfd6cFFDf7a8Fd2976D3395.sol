...
// Telegram Group : https://t.me/jeetfamily
...
contract JEETFAMILY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JEETFAMILY";
    string private _symbol = "$JEET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x998392b28CC00c39fAAAbc60f0cC68bE59e17674); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xcCB2A332897a3AFF8736280A33Da85Ef00918DaB); // Development Address
