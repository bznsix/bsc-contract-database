...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x902529e86cB29d3F3680C2f0A8125268A235AF19; 
...
contract XiaoLong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "XiaoLong";
    string private constant _symbol = unicode"XIAOLONG";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0xDB16eC8B7F0DFF48f5880f7d283AC7e2a6578aA2); // Marketing Address
    address payable public teamWalletAddress = payable(0x902529e86cB29d3F3680C2f0A8125268A235AF19); // Team Address
    ...
    uint256 private _totalSupply = 200000000000000000000 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(inSwapAndLiquify || recipient == deadAddress)
        { 
