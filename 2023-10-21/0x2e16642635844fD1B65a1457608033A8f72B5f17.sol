...
contract Safemoon_Satellite is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon-1 Satellite"; // 
    string private constant _symbol = "$SM1S"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xB9a7A4Df6CFAd2F56903f646aC08D39a8582e575;
