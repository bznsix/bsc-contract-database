/*
   Official Community: https://t.me/The_Soldier_BSC
   Website : https://revolutionize-the-soldier.framer.ai/
*/
...
contract TheSoldier is IERC20, Context, Ownable {
    ...
    string private constant _name = "TheSoldier";

    uint256 public Max_Buy_Limit = 10000000000000 * 10**9;
    uint256 public Max_Sell_Limit = 10000000000000 * 10**9;

    address private Marketing_Wallet = 0x0B21Cf31B7A09eECC36Aca2288A8d4593cc80301;
    address private Team_Wallet = 0x0B21Cf31B7A09eECC36Aca2288A8d4593cc80301;

    uint256 public Max_Wallet_Holding = 20000000000000  * 10**9;
    uint256 private swapTokensAtAmount = 3000000000000 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 10, 5, 0);
    Taxes public taxes = Taxes(0, 10, 5, 0);
