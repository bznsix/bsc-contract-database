...
contract DiamondHands is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress =0x018dDA6f5A137628BC7964Ef6836917E7B01d20B;
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**18; //No much effect on bsc
    ...
    constructor() public {
        ...
        //address _uniswapV2RouterAddr=0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //testnet
        address _uniswapV2RouterAddr = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // mainnet
    ...
    function setMaxTrxAmount(uint256 _maxTrxAmount) public onlyOwner() {
        _maxTxAmount = _maxTrxAmount;
    }
    ...
    function _takeCharity(uint256 tCharity) private {
        ...
        if(_isExcludedFromReward[_charityWalletAddress])
