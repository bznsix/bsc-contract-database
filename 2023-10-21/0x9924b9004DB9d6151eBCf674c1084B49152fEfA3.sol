...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2D5456449ba1196b257e8bCbF59034fF3F2B34bA; // owner address
...
contract DogeBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge BNB";
    string private _symbol = "$DogeBNB";
    ...
    uint256 private _airdropToken = 500000000000;
    ...
    uint256 private salePrice = 120000;
