...
abstract contract ERC20TaxCustomERC20 is ERC20Decimals, Ownable {
    ...
    constructor(TaxConstructorArgs memory _args) {
        ...
        // approve max the main LP token for the router
...
abstract contract ERC20TaxCustomERC20Votes is ERC20VotesDecimals, Ownable {
    uint256 public constant PERCENT_DENOMINATOR = 1000;
    uint256 public constant MAX_TAX = 200; // 20%
...
// 
contract TaxERC20CustomBlockAntibotLaunchBurn is
    Ownable,
    MaxTransaction,
    MaxWallet,
    BlockList,
    ...
    ERC20TaxCustomERC20
{
        ...
        MaxTransaction(_periodInSec, _maxTransaction)
    {
        ...
        _excludeFromMaxWallet(address(uniswapV2Router), true);
    ...
    function transfer(
        address recipient,
        uint256 amount
    ) public override(ERC20, ERC20TaxCustomERC20) returns (bool) {
        return ERC20TaxCustomERC20.transfer(recipient, amount);
    }
    ...
    function transferFrom(
        ...
        return ERC20TaxCustomERC20.transferFrom(sender, recipient, amount);
    }
    ...
    function _beforeTokenTransfer(
        ...
        address _to,
        uint256 _amount
    ) internal virtual override(BlockList, ERC20, ERC20LaunchMode) {
        ERC20._beforeTokenTransfer(_from, _to, _amount);
        BlockList._beforeTokenTransfer(_from, _to, _amount);
        ERC20LaunchMode._beforeTokenTransfer(_from, _to, _amount);
    }
    ...
    function _afterTokenTransfer(
        ...
        address _to,
        uint256 _amount
    ) internal virtual override(MaxWallet, MaxTransaction, ERC20) {
        ERC20._afterTokenTransfer(_from, _to, _amount);
        MaxWallet._afterTokenTransfer(_from, _to, _amount);
        MaxTransaction._afterTokenTransfer(_from, _to, _amount);
    }
}