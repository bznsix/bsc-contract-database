...
/**
Openfabric AI Ecosystem–The Foundation for the new AI Revolution.

Openfabric AI
https://t.me/OpenFabricAI
@openfabricai
Openfabric lets anyone create, share, and monetize AI services at scale. 
http://discord.gg/GsbXgUgFVC
...
// Dependency file: @openzeppelin/contracts/access/OpenfabricAIdad.sol
 ...
 * the owner.
 */
abstract contract OpenfabricAIdad is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OpenfabricAIdad: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OpenfabricAIdad: new owner is the zero address");
        _setOwner(newOwner);
    }
...
contract OpenfabricAI is IERC20, OpenfabricAIdad, IERC20Metadata {
