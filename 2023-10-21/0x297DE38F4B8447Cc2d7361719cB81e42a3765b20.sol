...
contract IRNTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public rajnsh15;
    ...
    string public _tokenname = "IRN";
    string public _tokensymbol = "IRN";
