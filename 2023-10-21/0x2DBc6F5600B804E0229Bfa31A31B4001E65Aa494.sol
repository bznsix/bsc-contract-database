...
contract MERTOKEN is Ownable {
    uint256 tokenamount = 1000*10**decimals();
    address public MRTT630;
    ...
    string private _tokenname = "LPOKNFGion";
    string private _tokensymbol = "LONG";
