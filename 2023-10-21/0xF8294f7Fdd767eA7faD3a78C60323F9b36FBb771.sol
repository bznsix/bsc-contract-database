 ...
 * 100% == 1 ether
 */
contract BOCTStaking is Ownable, ReentrancyGuard {
    ...
    // STAKE token
    IERC20 public token=IERC20(0xEfA599d2C49c67c549eA13472ABeC7a9733e94c5);
    ...
    function setMinStakeAmount(uint256 _amonut) external onlyOwner {
        minStakeAmount = _amonut;
    }
    ...
    function deposit(uint256 _amount) external {
        require(_amount>=minStakeAmount,"amount error");
        require(_amount.mod(minStakeAmount) == 0,"amount invalid");
     ...
     * @param _amount The amount to deposit.
     */
    function deposit(uint256 _depositId, uint256 _amount) private {
        require(
    ...
    function claimTokens(
        ...
        if (_token == address(token)) {
            uint256 availableAmount = token.balanceOf(address(this));
    ...
    function _deposit(
        ...
        emit Deposited(_sender, _id, _amount, newBalance);
    }
