/**
    ...
    TG: https://t.me/bsctelegramofficial
    Twitter: https://twitter.com/bsctelegram
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x32629EdA5Fd2f44F65cd8771A68B85EE5B152E1b; // owner address
...
contract TELEGRAM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TELEGRAM";
    string private _symbol = "TELEGRAM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x32629EdA5Fd2f44F65cd8771A68B85EE5B152E1b); // Marketing Address
    address payable private teamWalletAddress = payable(0x32629EdA5Fd2f44F65cd8771A68B85EE5B152E1b); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**3; 
