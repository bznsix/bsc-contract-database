// https://t.me/Pikadefi
// https://twitter.com/Pikadefi_global
...
contract PIKADF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PIKADF";
    string private constant _symbol = unicode"PIKADF";
    ...
    function getBuyCounts() public view returns (uint256) {
    return _buyCount;
    }
