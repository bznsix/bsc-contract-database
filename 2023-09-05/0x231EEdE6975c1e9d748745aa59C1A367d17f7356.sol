...
contract CyberInu is Context, IERC20, Ownable {
  ...
  address payable public marketingAddress = payable(0x0e340046AB54f21fb3B66b5D2AC79e094512B61F); // Marketing Address
  address payable public teamAddress      = payable(0x0e340046AB54f21fb3B66b5D2AC79e094512B61F); // Team Address
  address payable public liquidityAddress = payable(0x0e340046AB54f21fb3B66b5D2AC79e094512B61F); // Liquidity Address
  ...
  uint256 private constant _tTotal = 100_000_000_000_000_000 * 1e18;
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tTotalFee;

  bool public limitsInEffect = true;
  
  string private constant _name = "Cyber Inu";
  ...
  event SwapLiquifyEnabledUpdated(bool enabled);
  ...
  constructor() {
    _lastBuyBlockEnabled = true;

    _rOwned[_msgSender()] = _rTotal;

    maxTxAmount = _tTotal * 10 / 1000; 
  ...
  function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
    ...
    emit SwapLiquifyEnabledUpdated(_enabled);
  }
