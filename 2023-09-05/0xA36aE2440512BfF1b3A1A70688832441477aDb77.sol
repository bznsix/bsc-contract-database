...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8dEE68339e29FB2c75779C482c12Be70A4023e4B;
...
contract PapaPepe  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x36BE23d63e5E2fDDb312C4Cd88eCe965B28e45b9;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PapaPepe";
    string private _symbol = "PapaPepe";
    ...
    uint256 public numTokensSellToAddToLiquidity = 4000000 * 10**6 * 10**9;
