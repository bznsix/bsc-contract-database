...
contract Moose is ERC20, Ownable {
    struct Tax {
        uint256 marketingTax;
        uint256 liquidityTax;
    }

    uint256 private constant _totalSupply = 5_000_000_000 * 1e9;
    ...
    //Wallets
    address public marketingWallet = 0x12c654f2A1983c8254F1B42CC4210D6A7978BA52;
    ...
    constructor() ERC20("Moose BSC", "Moose") {
        ...
        address newOwner = 0xa16e16451A24fb63a6B9A8249D4b292f7ffd91bF;
    ...
    function setSwapTokensAtAmount(uint256 _newAmount) external onlyOwner {
        require(
            _newAmount > 10 ** decimals() &&
                _newAmount <= (_totalSupply * 1) / 100,
