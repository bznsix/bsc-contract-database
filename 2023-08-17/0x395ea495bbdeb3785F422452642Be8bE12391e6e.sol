 ...
 * @author Enjinstarter
 */
contract LaunchpadWhitelist is ILaunchpadWhitelist {
    ...
    function addWhitelistedBatch(
        ...
        require(accounts.length > 0, "LaunchpadWhitelist: empty");
        require(
    ...
    {
        require(account != address(0), "LaunchpadWhitelist: zero account");
    ...
    function _addWhitelisted(address account, uint256 amount) internal {
        require(account != address(0), "LaunchpadWhitelist: zero account");
        require(amount > 0, "LaunchpadWhitelist: zero amount");
        require(
