...
contract gspccontract is owned, gspcTokenContract{


    constructor() gspcTokenContract(
        96000000000 * 1 ** uint256(decimals),"Googloplex Smiles Party Coin","GSP") 
        {
    }
