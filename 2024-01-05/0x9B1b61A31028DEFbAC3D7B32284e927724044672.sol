...
Telegram : https://t.me/LexicaChannel
Twitter : https://twitter.com/lexicabsc
Website : https://thelexica.tech
...
contract LEXICA is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 35 *10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 7e10 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x1973c3a942F2d78c5119D618b3996Faabb9045fe;

    string private constant _name = "L E X I C A";
    string private constant _symbol = "$LEXC";
