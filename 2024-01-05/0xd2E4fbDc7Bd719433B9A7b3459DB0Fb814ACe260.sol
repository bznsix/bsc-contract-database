...
contract OxFi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("0xFi", "0xFi") {

        address _owner = msg.sender;

        _decimals = 18;

        uint256 totalSupply = 10000000 * (10**_decimals);
        ...
        marketingWallet = address(0x5952b83aD4187c1F49bC2E1Dac1BdeF888607869); // set as marketing wallet
