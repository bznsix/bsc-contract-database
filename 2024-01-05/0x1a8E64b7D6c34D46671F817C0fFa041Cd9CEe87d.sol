 ...
 * @title 0VM
 * 
 * @notice This is a SAFU smart contract developed by Revoluzion for 0VM.
 * 
 ...
 *
 * @custom:SAFU Owner 0x2C1342bE878c943EDE8A6dD47003171387915AFE
 */
...
/**
 * @title 0VM Token Contract
 *
 * @notice 0VM is an extended version of ERC-20 standard token that
 ...
 */
contract ZEROVM is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    Fee public buyFee = Fee(300);
    Fee public sellFee = Fee(300);
    ...
    string private constant NAME = "0VM";
    string private constant SYMBOL = "ZEROVM";
    ...
    address public constant SAFU_OWNER = 0x2C1342bE878c943EDE8A6dD47003171387915AFE;

    address public projectOwner = 0x94F544107643316e75CAD0CB2Afdad60B5185b74;
    address public marketingReceiver = 0x94F544107643316e75CAD0CB2Afdad60B5185b74;
    ...
    /**
     * @notice Constructs the 0VM contract and initializes both owner
     * and project owner addresses. Deployer will receive 5,000,000 tokens after
