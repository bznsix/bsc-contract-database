...
contract MagicKitty is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Magic Kitty", "MAG") {

        uint256 totalSupply = 100_000_000_000 * 1e18;

        maxTransactionAmount = 3_000_000_000 * 1e18;
        maxWallet = 3_000_000_000 * 1e18;
        swapTokensAtAmount =  10000000 * 1e18;

        rewardsBuyFee = 5;  
        marketingBuyFee = 2;
       
        totalBuyFees = rewardsBuyFee + marketingBuyFee ;
        
        rewardsSellFee = 5;
        marketingSellFee = 2;
       
        totalSellFees = rewardsSellFee + marketingSellFee ;

    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0x47398eD9f75A0997332BfcF787e995EeDF64FA58); // set as marketing wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee) external onlyOwner {
        marketingBuyFee = _marketingFee;
        rewardsBuyFee = _rewardsFee;
   
        totalBuyFees = marketingBuyFee + rewardsBuyFee ;
  
    }
    
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee) external onlyOwner {
        marketingSellFee = _marketingFee;
        rewardsSellFee = _rewardsFee;
       
        totalSellFees = marketingSellFee + rewardsSellFee ;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
     ...
     function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForMarketing + tokensForRewards;
