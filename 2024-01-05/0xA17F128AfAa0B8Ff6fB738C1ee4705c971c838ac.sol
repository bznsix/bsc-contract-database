...
contract GenesisCore is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletPer = 4;
    
    uint256 private _redisFee;
    uint256 private _taxFee;
    
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable private _dev = payable(0xF56ba85777152Cdb21c57278CCaFe16cBB0AF4be);
    address payable private _marketing = payable(0xF56ba85777152Cdb21c57278CCaFe16cBB0AF4be);
    
    string private constant _name = "Genesis";
    string private constant _symbol = "AGORA";
