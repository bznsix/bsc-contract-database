...
contract SPARKStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        mainToken = IBEP20(0x20497E0B05784f8C3971aEA774645e0c9f8B8833);
        stakingToken = IBEP20(0x20497E0B05784f8C3971aEA774645e0c9f8B8833);
        rewardToken = stakingToken;

        apy = 320; // 14% rewards 14 days 
    ...
    function updatelockduration(uint256 newlockDuration) external onlyOwner {
        require(newlockDuration <= 2678400, "Duration must be below 31 days");
