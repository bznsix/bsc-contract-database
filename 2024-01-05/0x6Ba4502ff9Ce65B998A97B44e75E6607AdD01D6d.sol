...
// telegram:https://t.me/longxingdadad
...
contract DA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"龘";
    string private _symbol = unicode"龘";
    ...
    uint256 private _buyMarketingFee = 30;
    ...
    function setTaxes(
        ...
        external onlyOwner() {
        require(newbuyLiquidityTax.add(newbuyMarketingTax) <= 10, "Total tax cannot exceed 10%");
        require(newsellLiquidityTax.add(newsellMarketingTax) <= 10, "Total tax cannot exceed 10%");
        require(newLiquidityShare.add(newMarketingShare) <= 20, "Total tax cannot exceed 20%");
    ...
    function SetBlacklisted(address account, bool newValue) public onlyOwner {
        _isBlacklisted[account] = newValue;
    }
