...
contract Ownable is Context {
    ...
    function HYPEOwnership() public virtual onlyOwner {
...
contract HYPE is ERC20, Ownable {
    ...
    HYPEDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HYPE", "ATH") {
        marketingWallet = payable(0xaCB2528D10b075d7E920005A6034E5ae521c4566);
        devWallet = payable(0x16D3c72a58210caA2C309554156C276dD958A1Dd);
        ...
        dividendTracker = new HYPEDividendTracker(
            payable(this),
            router,
...
contract HYPEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        HYPEContract = HYPE(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HYPE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HYPE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HYPE contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HYPEContract);

            uint256 prevBalance = HYPEContract.balanceOf(address(this));
            ...
            {
                uint256 received = HYPEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HYPEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
