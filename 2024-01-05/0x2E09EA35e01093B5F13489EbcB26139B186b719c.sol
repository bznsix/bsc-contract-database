// https://t.me/AnitaMaxWynnBSC
// https://twitter.com/ANITAMAXWYNN___
// https://anitamaxwynn.meme/
...
contract ANITA is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 420_000_000_000_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    address public marketingAddress = 0x0f5bD0173CF90838518E6612c2c7531eFBC2F7dc;
    address public TeamAddress = 0xA6addB4040f302e1E23d4cd96372ca23d07ce995;

    string private constant _name = "ANITA MAX WYNN";
    string private constant _symbol = "ANITA";
