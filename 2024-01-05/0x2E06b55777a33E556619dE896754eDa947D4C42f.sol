...
/*
    ...
    💎MyBabyShiba💎🚀FAIRLAUNCH 26 Oct 2021 at 15:00UTC
    
    🦈Website: http://www.mybabyshiba.space
    🔎 Telegram : t.me/MyBabyShibaBSC
    🔎Twitter: https://twitter.com/MyBabyShibaBSC
    ...
    Whenever any transactions happen, a percentage of MBS tokens will be burned to LP in turn to increase the evaluation of the token
    
    We will add 3 bnb to liqiudity and lock it for 1 years.

    TOKENOMICS
    
    Total Supply: 69,000,000,000,000,000,000,000
    3 BNB will be added on liquidity pool.
    70% supply will be burnt after launch
    25% liquidity pool will be locked for 3 months
...
contract MyBabyShiba is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "MyBabyShiba";
    string private constant _symbol   = "BABY";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 50;
    uint256 public _liquidityFee = 0;
    uint256 public _marketingFee = 650;

    uint256 private _previousTaxFee       = _taxFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _maxTxAmount                   = 1150000000000000000000 * 10**9;
    uint256 public _numTokensSellToAddToLiquidity = 1150000000000000000000 * 10**9;
