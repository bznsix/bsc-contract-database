// https://t.me/DragonFinanceBscOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E67004f1A6AB8Ef5aF5068e462A00Ad2534AD57; // owner address
...
contract DragFin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dragon Finance";
    string private _symbol = "DragFin";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4E67004f1A6AB8Ef5aF5068e462A00Ad2534AD57); // Marketing Address
    address payable private teamWalletAddress = payable(0x4E67004f1A6AB8Ef5aF5068e462A00Ad2534AD57); // Team Address
