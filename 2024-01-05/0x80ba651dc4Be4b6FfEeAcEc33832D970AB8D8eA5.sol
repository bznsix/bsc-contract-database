...
//TELEGRAM: https://t.me/chittigerofficial
...
contract ChittigerRelive is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 30000000 * 10**_decimals;
    ...
    address public marketingAddress = 0x862c5946e7962Ad090519382aeA5D3287007f703;
    address public devAddress = 0x862c5946e7962Ad090519382aeA5D3287007f703;

    string private constant _name = "Chittiger Relive";
    string private constant _symbol = "$CHITTIGER";
    ...
    Taxes public taxes = Taxes(3,0,0,0);
