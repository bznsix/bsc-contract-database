...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF22DF8e61146bAe9C902fFa26E989527a57c80b8; // owner address
...
contract DISNEYPIXARINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DisneyPixarInu";
    string private _symbol = "DPI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF22DF8e61146bAe9C902fFa26E989527a57c80b8); // Marketing Address
    address payable private teamWalletAddress = payable(0xF22DF8e61146bAe9C902fFa26E989527a57c80b8); // Team Address
