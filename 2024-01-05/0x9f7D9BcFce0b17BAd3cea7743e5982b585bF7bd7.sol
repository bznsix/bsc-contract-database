...
contract White_Lion is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xE5Edc054f46FD0e810DAa7e3ce402bbA1c508592);

    string public _name = "White Lion";
    string public _symbol = "WLN";
