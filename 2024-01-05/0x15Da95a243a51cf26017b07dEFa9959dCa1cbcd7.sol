...
//--- Contract v3 ---//
contract GrokKitty is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 888_000_000_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0xF8D92C754E8779F6DFbBE6E871fD813E68F024B1); // build: 0xF8D92C754E8779F6DFbBE6E871fD813E68F024B1
    address payable private devWallet = payable(0xc6E2BDdC007cCb69dD9fbF3cce5885d6513B0C28); // build: 0xc6E2BDdC007cCb69dD9fbF3cce5885d6513B0C28
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok Kitty";
    string constant private _symbol = "GrokKitty";
