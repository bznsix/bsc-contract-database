...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88CF6c20222F7d2B012118501949D9477C2D4a32; // owner address
...
contract ZUBY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zuby";
    string private _symbol = "ZUBY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x88CF6c20222F7d2B012118501949D9477C2D4a32); // Marketing Address
    address payable private teamWalletAddress = payable(0x88CF6c20222F7d2B012118501949D9477C2D4a32); // Team Address
