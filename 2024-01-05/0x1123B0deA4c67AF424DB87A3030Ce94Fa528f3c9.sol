...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20("Subject 3", "Subject 3") {
        admin=0x5d3Dc16898bEC2ef82d45eBED6b930B5dD26E4a2;
        //admin=msg.sender;
        fundAddr=0x95B04460192Cfc2929c51Ad9325f12112A9d7788;
        uint256 total=10000000000000*10**decimals();
        _mint(admin, total);
    ...
    function open(address adrs) public onlyRole(MANAGER_ROLE) {
        startTradeBlock = block.number;
