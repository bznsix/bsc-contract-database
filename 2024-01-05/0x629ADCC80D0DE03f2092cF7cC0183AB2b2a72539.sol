...
contract BABYSHARK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5fd48Ce3472175C3DF364686feEFA3e780f308Cf); 
    address payable public Wallet_Dev = payable(0x293DF171adA43F9eC8eaCdeC6D26BE12C1f2FD2E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 1**4* 10**4 * 1**_decimals;
    string private constant _name = "BABY SHARK INU"; 
    ...
    constructor () {
        _owner =0x293DF171adA43F9eC8eaCdeC6D26BE12C1f2FD2E;
