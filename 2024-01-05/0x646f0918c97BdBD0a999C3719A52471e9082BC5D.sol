...
contract Amway is IERC20, Ownable {
    ...
    address ReceiveAddress = address(0x6b2B902169f3bAE84d58a828e084781f6884128d);
    address FoundAddress = address(0x342f58Bc8D848c7015F6410Af2CdC4f57116179F);
    ...
    function _swapAndAddLiquidity(uint stakeAmount) internal lockTheSwap returns (bool) {
        uint foundAmount = stakeAmount / 8;
