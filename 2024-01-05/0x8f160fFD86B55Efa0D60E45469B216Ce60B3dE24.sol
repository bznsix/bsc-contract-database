...
*TELEGRAM:https://t.me/AlphaLaunch1
*/
...
contract EmiliaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Emilia Coin"; 
    string private _symbol = "EMILIO"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x421fda86108476Fb132B5A9ECe98De8a71c3571D); 
    address payable public teamWalletAddress = payable(0xF8dCE6dCF9E594d684a3337358a3129D0F0e15C0); 
    ...
    uint256 public _walletMax = 50000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 3123443215 * 10**_decimals;
