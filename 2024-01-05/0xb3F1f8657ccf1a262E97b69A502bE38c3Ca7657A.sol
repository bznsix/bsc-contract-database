...
contract LullabyDragon is Context, IERC20, Ownable {
    ...
    string private _name     = "Lullaby Dragon";
    string private _symbol   = "DULLABY";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 999_000_000_000 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xfB9D7296E5b5dF7F3F560668F33c51EE2fD9AE1c;
        
        swapEnabled = true;
        swapTokensAtAmount = _tTotal / 20000;
