...
//Eternal Reflections - Get Paid Holding ERS in Desired Reflections via community vote once per month
...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "ERS/Distributor already exists"
        );
...
contract ERS is IBEP20, Auth {
    ...
    string constant _name = "Eternal Reflections";
    string constant _symbol = "ERS";
    ...
    uint256 public swapThreshold = _totalSupply / 12500; // 0.008%
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 200000000000);
        _maxTxAmount = amount;
    }
    ...
    function permit(
        ...
        require(holder != address(0), "ERS/invalid-address-0");
        require(
        ...
        require(nonce == nonces[holder]++, "ERS/invalid-nonce");
