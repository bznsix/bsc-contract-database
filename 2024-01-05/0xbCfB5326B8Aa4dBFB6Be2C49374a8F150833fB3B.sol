// Telegram: https://t.me/GENESIssblockchain
...
contract GenesisCore is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Genesis";
    string constant _symbol = "AGORA"; 
    ...
    // Fees Receivers
    address public DevFee = 0xCF9F401860Da27A85E7E8E49eFf5407568a75c77;
    address public MrktingFee = 0xCF9F401860Da27A85E7E8E49eFf5407568a75c77;
    address public LiqFee = 0xCF9F401860Da27A85E7E8E49eFf5407568a75c77;
    ...
    function swapBack() internal swapping {
        ...
        (bool devSucess,) = payable(DevFee).call{value: amountETHDev, gas: 30000}("");
        require(devSucess, "receiver rejected ETH transfer");
        (bool marketingSucess,) = payable(MrktingFee).call{value: amountETHMarketing, gas: 30000}("");
        require(marketingSucess, "receiver rejected ETH transfer");
        (bool liquiditySucess,) = payable(LiqFee).call{value: amountETHLiquidity, gas: 30000}("");
    ...
    function setFeeReceivers(address _devFeeReceiver, address _marketingFeeReceiver, address _liquidityFeeReceiver) external onlyOwner {
        DevFee = _devFeeReceiver;
        MrktingFee = _marketingFeeReceiver;
        LiqFee = _liquidityFeeReceiver;
    }
