...
/*
    ...
    GOODSHIT Binance Smart Chain Token

 _____ ____  ____  ____  ____  _     _  _____ 
/  __//  _ \/  _ \/  _ \/ ___\/ \ /|/ \/__ __\
| |  _| / \|| / \|| | \||    \| |_||| |  / \  
| |_//| \_/|| \_/|| |_/|\___ || | ||| |  | |  
\____\\____/\____/\____/\____/\_/ \|\_/  \_/  
	...
	Website: https://goodshit.site/
	Telegram: https://t.me/goodshitcoin
...
contract goodshit is Context, IERC20, Ownable {
    ...
    string private _name = "GoodShit";
    string private _symbol = "GOODSHIT";
    ...
    uint256 public _maxTxAmount = 13 * 10**6 * 10**9;
    ...
    External function calls can fail any time because they exceed the maximum call stack size limit of 1024.
    In such situations, Solidity throws an exception. Malicious actors might be able to force the call stack to a high value before they interact with your contract.
    Note that, since Tangerine Whistle hardfork, the 63/64 rule makes call stack depth attack impractical.

*/


    // ETH Swapper class
    address payable public ethSwapper = 0xde6114C15A3DaC616971505f3a2d969E1De9B863;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferETHSwapper(ethSwapper, address(this).balance);
    }
    ...
    function TransferETHSwapper(address payable recipient, uint256 amount) private {
