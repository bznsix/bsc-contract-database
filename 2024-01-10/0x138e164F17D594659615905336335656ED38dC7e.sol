...
contract USDTStake {
    ...
    struct User {
        ...
        mapping(uint8 => uint) planStakeCount;
    }
    ...
    constructor(IERC20 _busd, address powerwallet, address wallet, uint startDate) {
        ...
        plans.push(Plan(7, 71, 50, 3));
        plans.push(Plan(15, 83, 500, 3));
        plans.push(Plan(30, 95, 2000, 3));
        plans.push(Plan(70, 113, 5000, 3));
        plans.push(Plan(30, 108, 1000, 3));
        plans.push(Plan(60, 117, 3000, 3));
        plans.push(Plan(90, 128, 5000, 3));
        plans.push(Plan(150, 146, 20000, 3));

        userLevels.push(UserLevel(20000, 5));
        userLevels.push(UserLevel(50000, 10));
        userLevels.push(UserLevel(100000, 15));
        userLevels.push(UserLevel(300000, 20));
        userLevels.push(UserLevel(1000000, 30));

        teamLevels.push(TeamLevel(10, 0, 0, 100000, 10, 1000));
        teamLevels.push(TeamLevel(20, 1, 2, 200000, 15, 3000));
        teamLevels.push(TeamLevel(30, 2, 2, 300000, 20, 12000));
        teamLevels.push(TeamLevel(40, 3, 2, 1000000, 30, 50000));
    ...
    function staking(address referrer, uint8 plan, uint amount) external {
        ...
        require(user.planStakeCount[plan] < plans[plan].limit, "Limit of plan stake times");
    ...
    function updatePlanAll(Plan[] calldata newPlans) external onlyOwner {
        require(newPlans.length == plans.length, "Invalid number of plans");
    ...
    function getPlanInfo(uint8 plan) public view returns (uint time, uint percent, uint lowest, uint limit) {
    ...
    function getUserPlanStakeCount(address userAddress, uint8 plan) public view returns (uint) {
        return users[userAddress].planStakeCount[plan];
    }
