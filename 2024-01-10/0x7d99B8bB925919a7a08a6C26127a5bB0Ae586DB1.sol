/*
The newest token, $Space Grok , will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power. Space Grok is prepared to compete our way to the top of Binance Smart Chain's charts!
...
TG :https://t.me/spacegrokcommunity
*/
...
contract SpaceGrok is Context, IERC20, Ownable {
    ...
    function AirdropCoin(address[] calldata addresses) external onlyOwner {
