...
// Telegram: https://t.me/BabyBunnyPortal
...
contract BabyBunny is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BabyBunny";
    string private constant _symbol = unicode"$BUNNY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 5000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x0CDC5ecd6EcABDf7f7e2bDEa1b2980dfd16Ae355);
    address payable public MarketingWallet = payable(0xFA696cf9185F69C65C2D34A5cf9348c2F591792f);
    ...
    function setTxFee(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function removeTxFee() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
