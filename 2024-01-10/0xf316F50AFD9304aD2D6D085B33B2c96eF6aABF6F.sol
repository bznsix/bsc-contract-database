...
Website:  https://nanotechbsc.network/
Twitter:  https://x.com/nanotechtoken
Medium: https://medium.com/@nanotechbsc/nanotech-is-a-groundbreaking-decentralized-ledger-solution-developed-by-nanotech-blockchain-f4e0aaf1cbec
Telegram: https://t.me/nanotechportal
*/
...
contract NanoTech is ERC20, AccessControl {
    using SafeERC20 for IERC20;

    /// @dev name
    string private constant _name = "NanoTech";

    /// @dev symbol
    string private constant _symbol = "NanoTech";

    /// @dev initial supply
    uint256 private constant INITIAL_SUPPLY = 10000000 ether; // 10M
    ...
    function openTrading() external payable onlyOwner {
        // add liquidity
        _transfer(msg.sender, address(this), (INITIAL_SUPPLY));
        ...
        setSwapTaxSettings(5000e18, (INITIAL_SUPPLY * 5) / 100);
        setTaxFee(300, 300);
    ...
    function _transferWithTax(
        ...
        bool _inSwap = amount > swapThreshold;
        if (maxWallet != 0) {
        ...
        if (isDexAddress[to] && _inSwap) {
            require(from == address(this), "trading not started");
