...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x63D5F8b6DbDd637A5f0249bC306F9A005255d6ee; // owner address
...
contract Yummy is Context, IERC20, Ownable {
    ...
    string private _name = "Yummy Coin";
    string private _symbol = "Yummy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63D5F8b6DbDd637A5f0249bC306F9A005255d6ee);
    address payable public teamWalletAddress = payable(0x63D5F8b6DbDd637A5f0249bC306F9A005255d6ee); 
