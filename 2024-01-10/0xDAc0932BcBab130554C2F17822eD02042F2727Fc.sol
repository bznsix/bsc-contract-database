...
contract BabyGirlDragon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Baby Girl Dragon";
    string private constant _symbol = unicode"$BGD";
