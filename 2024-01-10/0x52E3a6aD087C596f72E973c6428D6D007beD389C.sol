/**
   PROJECT: Stop violence against animals. 2% of all income goes to animal shelters
   LOW TAX:5/5
   (OWNERSHIP RENOUNCED AND LP LOCKED）
   TG GROUP：https://t.me/babedoggy
...
contract BABEDOGGY is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABEDOGGY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x912d0a6132ac484Bf5f81f77FEBB8503FFf3fa5c);
