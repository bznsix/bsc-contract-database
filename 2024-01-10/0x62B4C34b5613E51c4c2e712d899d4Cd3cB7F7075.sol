...
contract PEPESCHARITY is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x38cbD475C4a1Fe1CE35611A05a700650e976A860);
    address payable private _twdmkt = payable(0x38cbD475C4a1Fe1CE35611A05a700650e976A860);
    
    string private constant _name = "PePe's Charity";
