...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA899E18FCcCfFFcaa00bEec6289E62e207978F2f;
...
contract NVAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBa64a328FB92Ab6bcD38091e0F1b97B798a4077c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NebulaVault AI";
    string private _symbol = "NVAI";
