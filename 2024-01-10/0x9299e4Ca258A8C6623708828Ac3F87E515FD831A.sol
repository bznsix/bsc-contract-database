...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0xc836d8dC361E44DbE64c4862D55BA041F88Ddd39);
...
contract TROY is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   TROYDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("TROY", "TROY") {
        ...
        _maxBuy = 2000000000 * (10**18);
        _maxSell = 2000000000 * (10**18);
    	...
    	dividendTracker = new TROYDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xf3bFB5804BF4298955B293D06Cde7c8FfBd3E446);
        _devWallet = payable(0x938CE19f1D8b496046361B5b3C8dDB0C16e6274D);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TROY: The dividend tracker already has that address");

        TROYDividendTracker newDividendTracker = TROYDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TROY: The new dividend tracker must be owned by the TROY token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "TROY: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TROY: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TROY: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "TROY: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TROY: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TROY: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TROY: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "TROY: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TROY: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TROY: Cannot update gasForProcessing to same value");
	...
	function letsGoLive() external onlyOwner() {
        updateBuyFees(5,5,2,0);
        updateSellFees(5,5,3,0);
...
contract TROYDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("TROY_Dividend_Tracker", "TROY_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "TROY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TROY contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "TROY_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TROY_Dividend_Tracker: Cannot update claimWait to same value");
