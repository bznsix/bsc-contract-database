...
contract HALVING2024 is ERC20, Ownable {

    mapping(address => bool) public liquidityPool;


    address public rewardsPool;
    address public developmentWallet = 0x8F32A35F7a0781816CE5a3A1AFa08B6fe0a09471;
    uint public constant PERCENT_DIVIDER = 100;
    uint public constant BUYTAX = 0;
    uint public constant SELLTAX = 10;


    event changeLiquidityPoolStatus(address lpAddress, bool status);


    constructor() ERC20("HALVING2024", "HLVN24") {
