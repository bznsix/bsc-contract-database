...
contract FoolBULL is Ownable, ERC20 {
    address public uniswapV2Pair;
    IRouter public _router;
    address public WETH;
    bool public openWhitel = true;
    mapping(address => bool) public whitelists;

    constructor() ERC20("FoolBULL", "FoolBULL") {
    ...
    function SetOpenWhitel(bool _openWhitel)  external onlyOwner {
        openWhitel = _openWhitel;
    }
