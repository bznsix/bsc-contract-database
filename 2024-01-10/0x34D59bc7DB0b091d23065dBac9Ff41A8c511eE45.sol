...
contract GROKTROLL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GROKTROLL";
    string private _symbol = "GROKTROLL";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xeDDF7E99AF25214440fe5273997cBfeb38048feC);
