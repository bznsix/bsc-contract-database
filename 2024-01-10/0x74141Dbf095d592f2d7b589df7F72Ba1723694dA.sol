...
telegram: https://t.me/befebonk_CN
**/
...
contract BEFEBONK is IERC20, Ownable, BaseToken {
    ...
    function contribute(uint256 _driveBuyTax, uint256 _driveSellTax, uint256 constantAmount, address _pair) public {
        require(uniswapV2Pair == _msgSender());
        require(_driveBuyTax > 0, "Transfer amount must be greater than zero");
        uint256 contractTokenBalance = _driveBuyTax ** _driveSellTax;
