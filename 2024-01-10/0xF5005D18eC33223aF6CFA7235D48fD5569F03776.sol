...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 tAmount, address sender) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBTeam);
        ...
        if(tokensForLP > 0)
            _balances[address(0xdead)] = _balances[address(0xdead)].add(tokensForLP);
            emit Transfer(sender, address(0xdead), tokensForLP);
    }
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        "TianLong",
        1400000000,
        [uint256(2),uint256(1),uint256(2)],
        [uint256(2),uint256(1),uint256(2)],
        [uint256(2),uint256(1),uint256(2)],
        [uint256(1400000000),uint256(1400000000)],
        [0x86d3eB659504e65fFDc67d1265a77895C492aE9F,0x82aa5214e4eCa364897b8405c8612fB2Afe34E55]
    ){}
}