...
//Telegram:https://t.me/havefunstayingpoorbsc                Zero tax and Renounced Contract

//twitter:https://x.com/havefunst
...
contract HAVEFUNSTAYINGPOOR  is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HAVE FUN STAYING POOR";
    string private _symbol = "HFSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43633105990914416831CB5c7E1b5cE5D21B3b3a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x71f9d8a398243BeF1f5433DC3cfA4A67B6C758c8); // BuyBack Address
