...
contract FatToken is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x36B79770763707EB7937526Af17a543873C29E71);

    string public _name =unicode"Lóng liàn";
    string public _symbol =unicode"龙链";
