...
contract Eggys is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xdd41ff58920A566672Fb292dB36350CeA2B842ab);

    string public _name = "Eggy's";
    string public _symbol = "EGY";
