...
//--- Contract v3 ---//
contract GrokBitcoinETF is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable( 0xA75721e6A53ECbA726B9498d7fDb2e2b9de74942); // build: 0xccc9Eb205e6227E1f3e0feD504c9b693177Cc3b0
    address payable private devWallet = payable(0x309D502c9A02B8eEA422c8539D53caf7612D4C33); // build: 0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok Bitcoin ETF";
    string constant private _symbol = "GrokBitcoinETF";
