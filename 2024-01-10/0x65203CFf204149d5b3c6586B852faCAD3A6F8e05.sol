/*
   ...
   /      \                                     |       \ |  \  |  \|       \       |  \     /  \|  \                              
  |  $$$$$$\  ______   __    __  __    __       | $$$$$$$\| $$\ | $$| $$$$$$$\      | $$\   /  $$ \$$ _______    ______    ______  
  | $$___\$$ /      \ |  \  /  \|  \  |  \      | $$__/ $$| $$$\| $$| $$__/ $$      | $$$\ /  $$$|  \|       \  /      \  /      \ 
   \$$    \ |  $$$$$$\ \$$\/  $$| $$  | $$      | $$    $$| $$$$\ $$| $$    $$      | $$$$\  $$$$| $$| $$$$$$$\|  $$$$$$\|  $$$$$$\
   _\$$$$$$\| $$    $$  >$$  $$ | $$  | $$      | $$$$$$$\| $$\$$ $$| $$$$$$$\      | $$\$$ $$ $$| $$| $$  | $$| $$    $$| $$   \$$
  |  \__| $$| $$$$$$$$ /  $$$$\ | $$__/ $$      | $$__/ $$| $$ \$$$$| $$__/ $$      | $$ \$$$| $$| $$| $$  | $$| $$$$$$$$| $$      
   \$$    $$ \$$     \|  $$ \$$\ \$$    $$      | $$    $$| $$  \$$$| $$    $$      | $$  \$ | $$| $$| $$  | $$ \$$     \| $$      
    ...
    - 5% daily rate of return
    - 8% Referral Bonus, goes directly to referrer wallet.
    ...
    - 1000 BNB max deposit per wallet.
    - 60% feedback for withdrawals that will be done before the user has compounded 4 times.
        * Feedback Tax will stay in the contract.
    - Withdrawals will reset daily compound count back to 0.
    

    Website: https://sexybnb.cash
    Telegram: https://t.me/sexybnbminer
    Twitter: https://twitter.com/sexybnbminer
...
contract SexyBNBMiner {
    ...
    uint256 public COMPOUND_FOR_NO_TAX_WITHDRAWAL = 4; // compound times, for no tax withdrawal. 
    ...
    constructor() {
        ...
        dev = payable(0xD26d26FEBc580A279B795cC9174bF2981F8bC5ad);
    }
