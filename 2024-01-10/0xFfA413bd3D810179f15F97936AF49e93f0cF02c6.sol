...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcf77f1ff4bD76f55BB6a733C18b14949Ef4620a1; // owner address
...
contract PEPEMUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepemus";
    string private _symbol = "PEPEMUS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcf77f1ff4bD76f55BB6a733C18b14949Ef4620a1); // Marketing Address
    address payable private teamWalletAddress = payable(0xcf77f1ff4bD76f55BB6a733C18b14949Ef4620a1); // Team Address
