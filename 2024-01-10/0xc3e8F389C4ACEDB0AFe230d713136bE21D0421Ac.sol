...
contract SPACEDRAGON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9aFa40c00Eb2C4034FF6f9482D2258EdE9258B03); 
    address payable public Wallet_Dev = payable(0x7C3a3DedC8bAe571eebE5Ab27bACEA99002a1Ac1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SPACE DRAGON"; 
    ...
    constructor () {
        _owner = 0x7C3a3DedC8bAe571eebE5Ab27bACEA99002a1Ac1;
