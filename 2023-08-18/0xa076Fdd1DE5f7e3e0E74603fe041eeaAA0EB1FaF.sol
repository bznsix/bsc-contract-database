...
contract SCToken is ExcludedFromFeeList, LpDividendBNB, BlackList, FirstLaunch, MaxHave {
    ...
    address public lpReceiver = address(0xecee);

    address constant marketAddr = address(0xaea); //1%
    ...
    constructor() Owned(msg.sender) ERC20("MOON", "MOON", 18, 10_000 ether) {
