...
contract DUCK is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "DUCK";
        _decimals = 18;
        _owner = 0x466a41f77A9Bd1B9852E94d089605a64aC30FFC9;
        _totalSupply = 6900000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 6900 * 10**_decimals;
        marketingWalletAddress = payable(0x809f5D53A21002308E298A6657888A38b9D0BF27);
        teamWalletAddress = payable(0x1DD37132453AE25fB5a27C2D6A2e7B40A7Ceab92);
