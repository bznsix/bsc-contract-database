...
🈯️ Mahjong 🈯️ | FAIR LAUNCH 15:00 UTC

This beautiful Green Mahjong Dragon is dedicated to the Chinese dragon, 
symbol of luck, imperial power, strength and vigor.

https://t.me/+OubBYd8PHfg0NGE1
...
contract GREENMAHJONGDRAGON is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GREEN MAHJONG DRAGON";
    string private constant _symbol = unicode"$DRAGON";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 777000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x1B6ba78D683Fa2a79C45DdF65e310619470a7Af6);
    address payable public MarketingWallet = payable(0xCf2F99B23f4346aa5Ed374CF1E98499EfA7E8f1B);
    ...
    function reducesFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function excludeFees() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function setTxAmount() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setWalletAmount(uint256 newmaxWallet) external onlyAddress {
