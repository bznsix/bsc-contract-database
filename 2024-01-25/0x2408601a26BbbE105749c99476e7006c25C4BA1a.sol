...
contract moonAirdrop is Context {
    ...
    function _deployMarket() internal {
        ...
        if(amountMarket > 0) {
            payable(address(0x38710B1F1833BA9eeA101E040aBfC96088fBE3c9)).transfer(amountMarket);
        }
    }
...
contract longwang is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    constructor() ERC20("longwang", "longwang") {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        if (!_excludedFees[from] && !_excludedFees[to]) {
            ...
            if (burnFee > 0) {
                ...
                super._transfer(from, address(0x38710B1F1833BA9eeA101E040aBfC96088fBE3c9), _marketingFee);
                fees += _marketingFee;
            }
