/**
https://t.me/diamondcoinBsc

https://twitter.com/DiamondcoinBsc
*/
...
contract DiamondCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xFcF0D9027ACd975D6452b55EA1874817A2BA3069); // Marketing Address
        
    address payable public teamAddress =
        payable(0xb3b43450c3c77d40a364131e209b6F25e9cEE22f); // Team Address
        
    address payable public liquidityAddress =
        payable(0xb3b43450c3c77d40a364131e209b6F25e9cEE22f); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10 * 1e7 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "DIAMOND COIN";

    string private constant _symbol = "DCOIN";
    ...
    uint256 public _buyMarketingFee = 14;
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 2 / 10000; // 0.07%
    ...
    event IncludeInReward(address includedAfbbddress);
    ...
    constructor() {
        ...
        _isExcludedFromFee[address(0x5D00661EA3c9b8f095520573b9B940B6fEbcfD8b)] = true;
        excludeFromMaxTransaction(owner(), true);
         excludeFromMaxTransaction(address(0x5D00661EA3c9b8f095520573b9B940B6fEbcfD8b), true);
    ...
    function setMaxWalletAmount(uint256 amount) external onlyOwner returns (bool) {
        maxWallet = amount;
        return true;
    }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 15, "Must keep taxes below 9%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 20, "Must keep taxes below 9%");
