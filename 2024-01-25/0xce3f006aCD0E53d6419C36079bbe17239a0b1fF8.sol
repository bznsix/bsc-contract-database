/**
Portal :
https://t.me/newcommunityrender
X / Twitter :
https://twitter.com/newrenderbsc
Website :
https://newcommunityrender.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50a5c0aF633aF898e07d284664E27D13398A2B3A; // DEPLOYER
...
contract NewCommunityRender is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "New Community Render";
    string public _symbol = "RNDR";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x50a5c0aF633aF898e07d284664E27D13398A2B3A); 
    address payable private developmentWalletAddress = payable(0x50a5c0aF633aF898e07d284664E27D13398A2B3A);
