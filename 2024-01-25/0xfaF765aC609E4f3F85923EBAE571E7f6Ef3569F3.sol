...
contract moonBuild is Context, IERC20, Ownable {
    ...
    string private _name = "MOON Build";
    string private _symbol = "MOOB";
    ...
    constructor() {
        ...
        _burnToken = burnToken(0xb964CE057373249f1d486E4fC17Ef619dAC7A888); //主币地址
    ...
    function _BurnTokenToDead(address to,uint256 amountIn) private {
        ...
        {
            address _invAddr = 0xeefE9Df379DE3a0bffa30184C48d9d837e823828;
