...
contract BabyTrump is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Trump", "BabyTrump") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xfaB168A2bF7719c8745C4377B553D77afaF3cb5D);
        ...
        feeReceiver = 0xfaB168A2bF7719c8745C4377B553D77afaF3cb5D;
        ...
        _mintOnce(owner(), 420_000_000_000_000_000 * (10 ** decimals()));
