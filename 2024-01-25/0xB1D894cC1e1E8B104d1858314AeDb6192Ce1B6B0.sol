...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x452A2e402EF06C88a67c59Fc44fE47Ed729971f8;
...
contract Palw is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x452A2e402EF06C88a67c59Fc44fE47Ed729971f8); //add marketing wallet
    ...
    string private _name = "PALW";  //set name
    string private _symbol = "palw";  // set symbol
    ...
    uint256 public _sellFee = 5; //set sell fee
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(2).div(100); //set max buy 
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(2).div(100);  // set max tx currently both are at 2%
