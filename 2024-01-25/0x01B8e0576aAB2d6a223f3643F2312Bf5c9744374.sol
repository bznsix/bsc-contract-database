...
contract Mumuinu is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x971e2bfbB92dC1BDd76A90FAfbAD0Ba5aAdBa2Ae);
    address payable private _twdmkt = payable(0x76fA565b347D9374D145d9EDAd76AfD6faaC7017);
    
    string private constant _name = "Mumu Inu";
