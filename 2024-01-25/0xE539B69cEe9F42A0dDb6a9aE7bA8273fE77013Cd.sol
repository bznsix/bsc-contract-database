...
contract MstDeposit is Ownable {
    ...
    address private immutable dividendContract;
    ...
    uint256 private totalIssuance = 10000 * 10**6;
    uint256 private timesAmount = 15 ether;
    ...
    function getPlatform() external view returns (uint256 _presidentRadio, uint256 _directorRadio, uint256 _bossRadio, uint256 _wholeRadio, uint256 _boleRadio, uint256 _relationProfitRaido, uint256 _cooProfitRadio, uint256 _serviceProfitRadio, uint256 _deductRadio, uint256 _releaseRadio, uint256 _totalIssuance) {
