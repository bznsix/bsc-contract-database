...
contract BlueFi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlueFi";
    string private _symbol = "BFI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7EC206A8705Dd59C7C20bf024b5De836B4805F8d);
    address payable private DevelopmentWalletAddress = payable(0x405AB5eB0fB8E445E594ABD6C716F511DEf06B46);
