...
//    $$ |   $$ |$$ |  $$ |$$ | $$ | $$ |$$ |  $$ |$$ | $$ | $$ |$$   ____|$$ | $$ | $$ |$$   ____|
//    $$ |   $$ |$$$$$$$  |$$ | $$ | $$ |\$$$$$$$ |$$ | $$ | $$ |\$$$$$$$\ $$ | $$ | $$ |\$$$$$$$\ 
//    \__|   \__|$$  ____/ \__| \__| \__| \____$$ |\__| \__| \__| \_______|\__| \__| \__| \_______|
//               $$ |                    $$\   $$ |                                                
//               $$ |                    \$$$$$$  |                                                
//               \__|                     \______/                                                 


//The Tipmymeme Coin is micro-managed. This gives us the ability to fine tune the tokenomics to support healthy growth.
//Every transaction, including buys and sells, includes a 12% tax. Of this 12%, 5% is added to liquidity, 5% go to best meme artists and to the marketing. 
//The other 2% is redistributed to holders proportional to how much TMMC they hold.
//Antibots Protection
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA59159353D68Bf35eAA11e3Abf22fa418e9246c7;
...
contract TIPMYMEMECOIN is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x09D8B8A21F571fFdc7636a165B8E778155C8320d);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TipMyMemeCoin";
    string private _symbol = "TMMC";
    ...
    //max wallet holding 20000000 * 10**6 * 10**9 is 3% of 1000000000 * 10**6 * 10**9 (total supply)
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x09D8B8A21F571fFdc7636a165B8E778155C8320d)] = true;
