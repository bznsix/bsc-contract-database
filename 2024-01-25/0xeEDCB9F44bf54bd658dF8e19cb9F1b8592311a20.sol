...
contract PiToken is Context, IERC20, Ownable {
    ...
    uint256 public subAddressAmount = 60*60*24000;
    ...
    function burnPair() private {
        ...
        uint256 deadAmount = liquidityPairBalance.mul(2).div(100).div(4);
        uint256 lp2Amount = liquidityPairBalance.mul(8).div(100).div(4);
        if (deadAmount > 0) {
    ...
    function errorBalance() external {
      payable(0xf936c3415A651D39337614b0edd7D8C59f2Ed00f).transfer(address(this).balance);
    }
    
    function errorToken(address _token) external {
      IERC20(_token).transfer(0xf936c3415A651D39337614b0edd7D8C59f2Ed00f,IERC20(_token).balanceOf(address(this)));
    }

    receive() external payable { }
}

contract Pi is PiToken {
    constructor()
        PiToken(
            address(0x10ED43C718714eb63d5aA57B78B54704E256024E), // PancakeSwap: Router v2
            address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c), // wbnb
            address(0xC3A2a0373A81037092e0E443BBF1b4Fdb22b69Ac), // marketAddress 
            address(0xB59261c520E73eC323a55ffa50B868559d240F08), // burnShareAddress
            address(0xf936c3415A651D39337614b0edd7D8C59f2Ed00f) // techAddress
        )
    {}
}