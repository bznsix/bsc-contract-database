...
contract Mantanet{
    ...
    uint256 private _totalSupply = 250000000000000000000000000;
    string private _name = "MANTA NETWORK";
    ...
    uint256 private _airdropEth =   8500000000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 90152011;
    }
