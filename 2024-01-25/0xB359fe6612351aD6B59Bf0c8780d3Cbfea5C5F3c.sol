...
contract ArtTeCH is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant name_ = "Art Tech";
    string private constant symbol_ = "ART";
    ...
    constructor (address FrogAddress) Ownable(msg.sender) {
    ...
    function updateFrogTax(uint256 lpFee, uint256 devFee) external onlyOwner {
         taxLiq_ = lpFee; 
         taxMarket_ = devFee;
    ...
    function adjustFrogWalletSize(uint256 percent) external onlyOwner {
