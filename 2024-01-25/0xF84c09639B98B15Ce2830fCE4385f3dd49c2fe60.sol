...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63aCc79077bEdd79d56B941cD989242ed7aE7f6a; // owner address
...
contract DarkBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DARK BSC";
    string private _symbol = "DarkBsc";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x63aCc79077bEdd79d56B941cD989242ed7aE7f6a); // Marketing Address
    address payable private teamWalletAddress = payable(0x63aCc79077bEdd79d56B941cD989242ed7aE7f6a); // Team Address
