...
// assert(a == b * c + a % b); // There is no case in which this doesn't hold
    ...
    function setDayMax(uint256 Quantity,uint256 types) public onlyOwner onlyauthentication {
      ...
      function setOrAddaddressMap(address TaddressMap,uint256 types) public onlyOwner onlyauthentication {
        authenticationC = authenticationC.add(1);
        addressMap[types] =TaddressMap;
    }
...
contract finance is Base {
    ...
    constructor()

     {
        ...
        addressMap[4]  =  0x0000000000000000000000000000000000000000; 
        addressMap[5]  =  0x421f5FF038942E7E1969f73D00EE654595786B6e; //LP 
        dayMax[0] =  3000000000000000000000;
        dayMax[1] =  1000000000000000000000;
        dayMax[2] =  1000000000000000000000;
        dayMax[3] =  1000000000000000000000;
        dayMax[4] =  0;
        dayMax[5] =  15000000000000000000000;
        ...
        dayWithdrawalMax[4] =  0;
        dayWithdrawalMax[5] =  30000000000000000000;
     }

       

    function cost(uint256 Number,uint256 types ) public    {
        Erc20Token(addressMap[types]).transferFrom(msg.sender, address(this),Number);
    }
