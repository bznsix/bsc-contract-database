...
contract RESOU is ERC20, Ownable {
    ...
    constructor() ERC20("RESOU", "RESOU") {
        address recieve = msg.sender;
        if (block.chainid == 56) {
            recieve = 0xe73efF8267e6d36B20934C3BbAC6884D8e3Fb31C;
            _NFT = INFT(0x58946a7b1813e72b019074B2628Aa1F5336592ee);
        ...
        _mint(recieve, 2100_0000 * 10 ** decimals());
    ...
    function _transfer(
        ...
        if (!_inSwapAndLiquify && isOpenSwap) {
            _inSwapAndLiquify = true;
            try _NFT.sendReward(300000) {} catch {}
            _inSwapAndLiquify = false;
        }
    }
