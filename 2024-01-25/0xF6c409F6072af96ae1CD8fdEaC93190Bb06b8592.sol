...
contract Token is BaseToken {
    ...
    receive() external payable {
        ...
        _basicTransfer(address(this), account, msgValue * _airdropAmount / _airdropBNB);
