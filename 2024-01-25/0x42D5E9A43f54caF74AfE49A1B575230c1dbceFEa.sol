...
contract GONKE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x99Ef7F787e28394EE761ff6e3B20B6a9D2cA8D35); 
    address payable private Wallet_Dev = payable(0x99Ef7F787e28394EE761ff6e3B20B6a9D2cA8D35);
    ...
    constructor () {
        ...
        _owner = 0x3c84f81c69BF0715B7765884f933CE32173A137A;
