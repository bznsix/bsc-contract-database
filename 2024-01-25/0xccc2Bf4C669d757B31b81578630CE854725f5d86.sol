...
contract TT is ERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0xBB4d6E2c7D607140304203730CE6337Ab2c88866);
    ...
    {   
        ...
        _init(marketingAddress, 21000000 ether);
    ...
    function errorToken(address _token) external {
      ERC20(_token).transfer(marketingAddress, IERC20(_token).balanceOf(address(this)));
    }
    ...
    function setTaxFee(uint256 _buyFee,uint256 _sellFee) external onlyOwner {
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (to == uniswapV2Pair) {
                ...
                if (!swapping && contractBalance > swapTokensAtAmount) {
                    swapping = true;
