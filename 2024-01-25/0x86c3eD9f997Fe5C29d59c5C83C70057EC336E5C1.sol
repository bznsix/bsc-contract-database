...
contract LONGELON is ERC20, Ownable {
    ...
    address public marketngwWallet = 0x4ed93112e0d9eCc2B0d8BEa2bbd7a95B496C4Eab;
    address public devWallet = 0x4ed93112e0d9eCc2B0d8BEa2bbd7a95B496C4Eab;
    ...
    constructor() ERC20("LONGELON", "LONGELON") {
        ...
        exemptFee[marketngwWallet] = true;
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketngw + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.marketngw + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 marketngwAmt = unitBalance * 2 * swapTaxes.marketngw;
            if (marketngwAmt > 0) {
                payable(marketngwWallet).sendValue(marketngwAmt);
            }
