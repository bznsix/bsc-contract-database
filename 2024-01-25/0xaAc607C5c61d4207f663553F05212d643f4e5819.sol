...
contract SRVS is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "SRVS";
        _decimals = 18;
        _owner = 0x63AD98e8FA64ac51A29FB5C61E51DA72037fB937;
        _totalSupply = 21000000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 21000 * 10**_decimals;
        marketingWalletAddress = payable(0x2fbF1f6BCC43Be6ED3A8740C6d9C94cC0D54C75b);
        teamWalletAddress = payable(0x1e02Be2468C235e09708D3037e44337635106592);
