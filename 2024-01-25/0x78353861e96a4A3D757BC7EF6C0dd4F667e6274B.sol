...
contract ERC20 is Context, IERC20 {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_totalSupply <= _maxSupply, "ERC20: exceeded maximum limit");
...
contract ChaingeWrappedInscription is ERC20 {
    address public owner;
    address public controller;
    constructor(string memory name,string memory symbol,uint8 decimal,uint256 maxSupply) ERC20(name,symbol,decimal,maxSupply) {
        owner = msg.sender;
