...
contract WrappedAminoToken is IBurnMintERC20, ERC677, IERC165, ERC20Burnable, ConfirmedOwnerWithProposal {
  using EnumerableSet for EnumerableSet.AddressSet;
  ...
  constructor(string memory name, string memory symbol, uint8 decimals_, uint256 maxSupply_) ERC677(name, symbol) ConfirmedOwnerWithProposal(msg.sender, address(0)) {
