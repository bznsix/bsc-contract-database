...
contract SwapBlock is Ownable {
    ...
    //Функция % ставки на продажу токенов
    ...
    uint256 private percentWalletLimit = 3;
...
contract SimpleToken is Context, Ownable, IERC20, SwapBlock, Wallet {
    using SafeMath for uint256;
