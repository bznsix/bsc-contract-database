...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8A18C1A6778ECf8CB7126a50f652Efe557CDde28; // owner address
...
contract XPRO_AI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XPRO AI";
    string private _symbol = "XPROAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8A18C1A6778ECf8CB7126a50f652Efe557CDde28); // Marketing Address
    address payable private teamWalletAddress = payable(0x8A18C1A6778ECf8CB7126a50f652Efe557CDde28); // Team Address
    ...
    uint256 public _teamShare = 50; // original 12
