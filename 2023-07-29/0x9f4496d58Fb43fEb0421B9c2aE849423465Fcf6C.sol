...
$Capricorn , 
Capricorn is the name of the constellation whose arrangement is considered to resemble the goat. Then where did the word Capricorn come from? It is thought that the word 'Capricorn' in English was invented in the late 1300's. While the word 'Capricorn' actually comes from the Latin 'Capricornus', which means horned goat. Along the way, Capricorn was also adopted as the name of one of the zodiac signs in astrology. That is the reason why the Capricorn zodiac sign is shown with a Goat with horns.

Website: https://Capricornbsc.com/

Telegram: https://t.me/capricornportal

Twitter: https://twitter.com/capricornbsc
*/
...
contract CAPRICORN is ERC20, Ownable {
    ...
    constructor() ERC20("CAPRICORN COIN", "$CAPRICORN") {
