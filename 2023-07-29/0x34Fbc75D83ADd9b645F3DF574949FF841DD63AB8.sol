...
contract ElfinKingdomToken is Context, ElfinKingdomECO, Ownable {
    ...
    string private _name = 'ElfinKingdom';
    string private _symbol = 'ElfinKingdom';
    uint8 private _decimals = 9;
    string public ElfinKingdomwebsite = "https://ElfinKingdom.io/";
    string public Communitytoken = "Official Community Token";
    
    function getElfinKingdomwebsite() public view returns (string memory) {
        return ElfinKingdomwebsite;
    }
