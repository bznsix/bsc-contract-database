...
contract CosmoCorgi is Context, IERC20 { 
   using SafeMath for uint256;
    ...
    address payable public Wallet_Marketing = payable(0x68b806A79c876B54eF07C8012E31e88B8Fb329Ec); 
    address payable public Wallet_Dev = payable(0x68b806A79c876B54eF07C8012E31e88B8Fb329Ec);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 8;
    uint256 private _tTotal = 900000000000000;
    string private constant _name = "CosmoCorgi"; 
    ...
    constructor () {
        _owner = 0x37eA107F246dDa64C3B73b9cD62021d633436f82;
