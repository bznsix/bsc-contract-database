...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 3300 * 10**18;
    string private _name = "MXJ";
    string private _symbol = "MXJ";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x4423bbD05E0f65a5E04E364fa7DF940B309EB3bD);
    address public pointAddress = address(0x7C51df0587903677979b294ca8C32f339549766E);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 3300 * 10**18;
