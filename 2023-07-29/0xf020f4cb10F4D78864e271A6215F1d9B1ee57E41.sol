...
contract RIPPAULY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RIPPAULY";
    string private _symbol = "RIPPAULY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE895ec04166AfB05e963A86a6d6107260bb17BFa); // Marketing Address
    address payable public buybackWalletAddress = payable(0xE895ec04166AfB05e963A86a6d6107260bb17BFa); // Buyback Address
    ...
    uint256 public _maxTxAmount = 30 * 10**6 * 10**9; // 3%
    uint256 public _walletMax = 30 * 10**6 * 10**9; // 3%
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**9; // 1%
