...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
/* Token contract */
contract XDoge is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb646e5c7044f6400df7bFdA34C8E4A90310604CD;
    ...
    // Name and symbol
    string constant _name = unicode"𝕏Ðoge";
    string constant _symbol = unicode"𝕏Ð";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 5M tokens
    ...
    uint256 public reflectionFeeBuy = 4;
    ...
    uint256 public reflectionFeeSell = 13;
    uint256 public marketingFeeSell = 13;
    uint256 public devFeeSell = 0;
    uint256 public totalFeeSell = 30;
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // 1% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA8938d38aabcbaaf68BCe617559864138A29f731;
