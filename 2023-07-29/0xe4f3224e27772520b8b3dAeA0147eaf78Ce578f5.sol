...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeA25e713F4AcBB5965208aca6201B4A7cc8182CF; // owner address
...
contract DefiXApes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEFI X APES";
    string private _symbol = "$DXA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xeA25e713F4AcBB5965208aca6201B4A7cc8182CF); // Marketing Address
    address payable private teamWalletAddress = payable(0xeA25e713F4AcBB5965208aca6201B4A7cc8182CF); // Team Address
