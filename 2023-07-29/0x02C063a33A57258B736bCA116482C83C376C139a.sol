...
//https://t.me/XcurrencyBsc
//https://twitter.com/XCurrencyBsc
interface IERC20 {
...
contract Xcurrency is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7dd2F3402b847F8aF1B71D0Ab63631e3E522A2c4); 
    address payable public Wallet_Dev = payable(0x7dd2F3402b847F8aF1B71D0Ab63631e3E522A2c4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "X-Currency"; 
    ...
    constructor () {
        _owner =0x7dd2F3402b847F8aF1B71D0Ab63631e3E522A2c4;
