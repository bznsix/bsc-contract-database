...
library Address{
 ...
 contract XLuigi is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf7F1E93cfA7e7F77591Be7F89777748fd71Fc246;
    address public devWallet = 0xf7F1E93cfA7e7F77591Be7F89777748fd71Fc246;

    string private constant _name = unicode"Xluigi";
    string private constant _symbol = "XL";
    ...
    Taxes public taxes = Taxes(0, 4, 0, 6);
    Taxes public sellTaxes = Taxes(0, 7, 0, 8);
