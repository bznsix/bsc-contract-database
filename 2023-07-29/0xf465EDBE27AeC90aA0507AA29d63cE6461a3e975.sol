...
contract XERXES is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    XERXESDividendTracker public dividendTracker;
    ...
    constructor() ERC20("XERXES", "XES") {
        marketingWallet = payable(0x5484cF99D5A8009B3E56F027d66990864657ccC7);
        devWallet = payable(0x3E8d027135E6B9628c5D36E8CD4D670FC92bFD06);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 6;
        sellMarketingFees = 13;
        buyLiquidityFee = 1;
        sellLiquidityFee =1;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new XERXESDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 20000000; // 2%
        swapTokensAtAmount = totalTokenSupply / 3500000; // 0.0035%;
...
contract XERXESDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        XERXESContract = XERXES(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XERXESContract);

            uint256 prevBalance = XERXESContract.balanceOf(address(this));
            ...
            {
                uint256 received = XERXESContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XERXESContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
