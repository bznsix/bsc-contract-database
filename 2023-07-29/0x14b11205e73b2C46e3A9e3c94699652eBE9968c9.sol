...
contract GALAXYX is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'GALAXYX: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'GALAXYX: incorrect fee percent');
        require(owner != address(0), 'GALAXYX: incorrect owner address');
        require(mintToAddr != address(0), 'GALAXYX: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'GALAXYX: transfer from the zero address');
        require(recipient != address(0), 'GALAXYX: transfer to the zero address');
