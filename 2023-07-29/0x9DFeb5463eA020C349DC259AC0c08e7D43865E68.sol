...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // TEST : 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    IBEP20 RewardToken = IBEP20(0x55d398326f99059fF775485246999027B3197955);
...
contract XALIEN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "X_ALIEN THE INVADER";
    string constant _symbol = "$X_ALIEN";
    ...
    uint256 _totalSupply = 75* 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = 75 * 10**12 * (10 ** _decimals); 
    uint256 public _walletMax = 75 * 10**12 * (10 ** _decimals); 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x05E6d50E0A3E98e681bB8F695ca392CD6E30b7D9;
        marketingWallet = 0x05E6d50E0A3E98e681bB8F695ca392CD6E30b7D9;
        devWallet = 0x05E6d50E0A3E98e681bB8F695ca392CD6E30b7D9;
