/**/
// https://t.me/TwixxerBEP20 
//  website https://twixxer.cloud/
...
contract twixxer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xD9d008f1527e2987d2b83cb9D899f68A583bCFe4); // Marketing Address
        
    address payable public teamAddress =
        payable(0xD9d008f1527e2987d2b83cb9D899f68A583bCFe4); // Team Address
        
    address payable public liquidityAddress =
        payable(0xD9d008f1527e2987d2b83cb9D899f68A583bCFe4); // Liquidity Address
    ...
    uint256 private constant _tTotal = 69 * 1e13 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "twixxer";

    string private constant _symbol = "Twixxer";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 10 / 2000; // 0.5%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1000 / 1000; 
        maxWallet = _tTotal * 1000 / 1000; 
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 15, "Must keep taxes below 15%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 15, "Must keep taxes below 15%");
