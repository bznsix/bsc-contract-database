...
contract REVENGERSINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x405cA305A2B077E6ae7B8B0BAfE8fBc582391919); 
    address payable public Wallet_Dev = payable(0x405cA305A2B077E6ae7B8B0BAfE8fBc582391919);
    ...
    string private constant _name = "Revengers Inu"; 
    ...
    uint256 public Percent_AutoLP = 8; 
    ...
    constructor () {
        ...
        _owner = 0x405cA305A2B077E6ae7B8B0BAfE8fBc582391919;
