...
contract PNDX is Context, IBEP20, Ownable {
    ...
    uint256 public do_amount = (1 * 10 ** _decimals);
    uint256 public launchedAt = 0;

    uint256 public numTokensSellToAddToLiquidity = 20000000 * 10 ** _decimals;

    address public _market = 0x9deCd151BC618fb0b64309538092914Bf9F5B97d;
    ...
    function setSwapPairList(address _uniswapV2Pair, bool _val) public onlyOwner{
    ...
    function withdrawToken(
        ...
        unchecked {
            for (uint256 index = 0; index < tokenAddr.length; ++index) {
                ...
                if (balance > 0) bep20.transfer(_creator, balance);
            }
        }
    }
