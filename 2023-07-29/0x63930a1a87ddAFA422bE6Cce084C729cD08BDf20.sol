...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0x4B1342080D3DdfAee208565dEE97cA10c602E52d);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DZ.balanceOf(address(this));
        ...
        uint256 amount = DZ.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DZ.transfer(shareholder, amount);
...
contract SonOfZilla is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0x4B1342080D3DdfAee208565dEE97cA10c602E52d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Son of Zilla";
    string constant _symbol = "SoZ";
    uint8 constant _decimals = 4;

    //Total Supply: 100.000.000.000
    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);

    //max wallet holding of 5% (5.000.000.000 Tokens per Wallet)
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 5% of total Supply (5.000.000.000)
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xF75d39fDCfeB019dAdD1E5B2488b2C2c61FE7F3C;
  
        devDeployReceiver = 0xF75d39fDCfeB019dAdD1E5B2488b2C2c61FE7F3C;
        marketingFeeReceiver = 0xF75d39fDCfeB019dAdD1E5B2488b2C2c61FE7F3C;
