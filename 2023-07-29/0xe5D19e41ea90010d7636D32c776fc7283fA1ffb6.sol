...
contract RadioSwag is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RadioSwag";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "RSWAG";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100;  // 3 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xfDc11c285377059223Ff5A0aBE4B503d435081cf;
        marketingFeeReceiver = 0xEbfB69F21F7AFD60e3B73A5956b201A60c96E484;
