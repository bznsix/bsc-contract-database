/**
TG: https://t.me/DOGE69OFFICIALBSC
Twitter: https://twitter.com/Doge_69Bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x585A11918812CF9677967C76A1761d09b1e8b70C; // owner address
...
contract DOGE69OFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE69";
    string private _symbol = "$DOGE69";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x585A11918812CF9677967C76A1761d09b1e8b70C); // Marketing Address
    address payable private teamWalletAddress = payable(0x585A11918812CF9677967C76A1761d09b1e8b70C); // Team Address
    ...
    uint256 public _buyMarketingFee = 40;
    ...
    uint256 public _totalTaxIfBuying = 40;  // original 12
