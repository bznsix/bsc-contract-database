...
contract ElonXpro is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON XPRO"; // 
    string private constant _symbol = "$EXPRO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4B8dF14dd282FE45E3e2C847ffd9D0C2A7ab92F8;
