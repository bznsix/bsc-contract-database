...
contract HamaJingToken is Context, HamaJingECO, Ownable {
    ...
    string private _name = 'Hama Jing';
    string private _symbol = 'Hama';
    uint8 private _decimals = 9;
    string public HamaJingwebsite = "https://HamaJing.io/";
    string public Communitytoken = "Official Community Token";
    
    function getHamaJingwebsite() public view returns (string memory) {
        return HamaJingwebsite;
    }
