...
contract CoinFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0x05f4Cd78671347eAddf11DC26BDc31a70b3478C7);
    uint8 public _houseFeePercentage = 30; // In 0.1% increments

    address public _devFeeReceiver = address(0x05f4Cd78671347eAddf11DC26BDc31a70b3478C7);
    ...
    uint32 public _queueResetSize = 0; // How many games we want to queue before finalizing a game
    uint256 public _blockWaitTime = 0; // How many blocks we want to wait before finalizing a game
    ...
    function setDevFeePercentage(uint8 newPercentage) external onlyOwner {
        ...
        require(newPercentage <= 50, "Cannot set dev fee percentage higher than 50 percent");
