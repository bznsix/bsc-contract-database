...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 1600 * 10**18;
    string private _name = "KENDY";
    string private _symbol = "KENDY";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xb31a628502FE2f8300bb0BdacBe5c358dF01f529);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 1600 * 10**18;
