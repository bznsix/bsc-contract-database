...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD090c877100Af74a50e2a78d1EBB2a275BAbf2fd;
...
contract Xking is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xD090c877100Af74a50e2a78d1EBB2a275BAbf2fd);
    ...
    */
    ...
    string private _name = "X King"; 
    string private _symbol = "XKG";  
    ...
    */
    ...
    // Max wallet holding (0.6% at launch)
    uint256 public _maxWalletToken = _tTotal.mul(6).div(1000);
