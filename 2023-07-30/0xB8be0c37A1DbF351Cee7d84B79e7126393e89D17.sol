...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x7FDcE87432862f3250D0cF45d58827b7cfe9C776; 
...
contract DOGEBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE BURN";
    string private _symbol = "$DOBU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7FDcE87432862f3250D0cF45d58827b7cfe9C776);
    address payable public teamWalletAddress = payable(0x7FDcE87432862f3250D0cF45d58827b7cfe9C776); 
