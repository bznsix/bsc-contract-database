...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x227a65d632E030C2b268C07dC6Ec6109DBE17e4D; // owner address
...
contract PUMPX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUMP X";
    string private _symbol = "PUMPX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f008dF8121F6a366a41F11eFFd2Acd3fC8979Cf); 
    address payable public teamWalletAddress = payable(0x3779a78F53b6f44f611d8973efb7B84DC4D4922c);
