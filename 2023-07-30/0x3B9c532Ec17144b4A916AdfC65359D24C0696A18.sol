...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6973D04CF0cabd726d0158670b39Cc094DE05681; // owner address
...
contract FROG is Context, IERC20, Ownable {
    ...
    string private _name = unicode"FROG Community";
    string private _symbol = unicode"FROG Community";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6973D04CF0cabd726d0158670b39Cc094DE05681); 
    address payable public teamWalletAddress = payable(0x6973D04CF0cabd726d0158670b39Cc094DE05681);
