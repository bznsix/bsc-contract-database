...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x475856bEd83d03cc1798C0Ae7da137Fc103ec8ec; // owner address
...
contract CokeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CokeInu";
    string private _symbol = "Coke";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xAAE60e75D8f0bFE3421C6A30039e67452d6c0cC0); // Marketing Address
    address payable private teamWalletAddress = payable(0xAAE60e75D8f0bFE3421C6A30039e67452d6c0cC0); // Team Address
