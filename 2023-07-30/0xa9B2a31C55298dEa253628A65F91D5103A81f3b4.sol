...
contract XFLOKI  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x599818B0a00D9Cf7e549b9B3FCC2959417451d9e); 
    address payable public Wallet_Dev = payable( 0x599818B0a00D9Cf7e549b9B3FCC2959417451d9e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 18* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner = 0x599818B0a00D9Cf7e549b9B3FCC2959417451d9e;
