...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC244eb1048b2E395AD5E61Af69A4f13140676961;
...
contract InvaderToken is Context, IERC20, Ownable {
    ...
    string private _name = "Space Invader";
    string private _symbol = "INVDR";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
		require(taxFee <= 50, "Tax fee percentage exceeds the maximum limit of 5%");
		_taxFee = taxFee;
	}

	function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
		require(developmentFee <= 50, "Development fee percentage exceeds the maximum limit of 5%");
		_developmentFee = developmentFee;
	}

	function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
		require(liquidityFee <= 50, "Liquidity fee percentage exceeds the maximum limit of 5%");
