...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9FD15B1a2032f70A64396592Fb237D32F9b9c5b7; // owner address
...
contract BobtwopointzeroBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOB 2.0";
    string private _symbol = "$BOB2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x073fFCA48De40b22f266199Ca10f53dB380B1bb4); // Marketing Address
    address payable private teamWalletAddress = payable(0x073fFCA48De40b22f266199Ca10f53dB380B1bb4); // Team Address
