...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x450f5842AC96AEd8aF1Fe27C973e32a780F9083b; // owner address
...
contract Freg is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"FREG THE FROG";
    string private _symbol = unicode"FREG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x450f5842AC96AEd8aF1Fe27C973e32a780F9083b); 
    address payable public teamWalletAddress = payable(0x450f5842AC96AEd8aF1Fe27C973e32a780F9083b);
