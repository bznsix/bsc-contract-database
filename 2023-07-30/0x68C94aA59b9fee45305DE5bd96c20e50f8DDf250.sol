...
contract Bald is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 477777e9 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 477_777_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 477_777_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 477_777_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 477_777_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x27D515e06F009859b74301408515AfFD6CD67A61;
    address public devAddress = 0x27D515e06F009859b74301408515AfFD6CD67A61;
    ...
    // Owner cannot transfer out SHIB2.0 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SHIB2.0!");
