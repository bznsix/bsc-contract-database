/**
*/
// XCHAIN DOGE (XCHAIN) IS MEME TOKEN IN SMARTCHAIN 
...
// SAFE DEV
// t.me/XchainDogeBsc
// https://twitter.com/XchainDogeBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xbD22E22746F2E13415B98928BB8D63359D5211ED; // owner address
...
contract XCHAINDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X CHAIN DOGE";
    string private _symbol = "XCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8b5C7c8F8174B07f68FE7cea8A9f8D68Ef2358a9); 
    address payable public teamWalletAddress = payable(0x28EA319833895626a778ec909C97B3E90f837C3C);
    ...
    uint256 private minimumTokensBeforeSwap = 300000000 * 10**3; 
