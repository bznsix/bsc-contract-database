...
contract PancakeV3LPTest is IERC721Receiver, ReentrancyGuard {
    ...
    function getAmountsFromLiquidity(uint256 tokenId) public view returns (uint256, uint256) {
        ...
        uint256 amount0 = SqrtPriceMath.getAmount0Delta(priceLower, priceUpper, liquidity, false);
        uint256 amount1 = SqrtPriceMath.getAmount1Delta(priceLower, priceUpper, liquidity, false);
