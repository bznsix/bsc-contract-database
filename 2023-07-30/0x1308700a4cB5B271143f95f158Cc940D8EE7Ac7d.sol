...
contract BULLONAIRE is Context, IERC20 { 
   using SafeMath for uint256;
    ...
    address payable public Wallet_Marketing = payable(0x7A080661A6A1689Bc99d8f3a1EB9c04Ab47e34a2); 
    address payable public Wallet_Dev = payable(0x7A080661A6A1689Bc99d8f3a1EB9c04Ab47e34a2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 8;
    uint256 private _tTotal = 900000000000000;
    string private constant _name = "BULLONAIRE"; 
    string private constant _symbol = unicode"$BULLO"; 
    ...
    constructor () {
        _owner = 0x6fDe94Feda2Cf68A251922469367C734eB1aC52a;
