...
contract Xdone is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xdone";
    string private constant _symbol = "Xdone";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xCAA2E6E78Ed0911D945d702fc72624D777135f97)] = true; //uniswap router liquidity
