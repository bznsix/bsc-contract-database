...
contract XytrixAlgo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0x82e872C12F83607797446008Dac0489626173156); 
    address payable public developmentAddress = payable(0x82e872C12F83607797446008Dac0489626173156); 
    address payable public charityAddress = payable(0x82e872C12F83607797446008Dac0489626173156); 
    address payable public vaultRewardAddress = payable(0x82e872C12F83607797446008Dac0489626173156); 
    ...
    string private constant _name = "XytrixAlgo Token";
    string private constant _symbol = "XYALG";
    ...
    uint256 private _trigger = 1000000000  * 10**9;
    ...
    //Create additional liquidity using NAME tokens in contract
