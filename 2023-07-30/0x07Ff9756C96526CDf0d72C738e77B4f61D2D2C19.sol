...
contract Worldshiba is Context, IERC20, Ownable {
    ...
    string private _name = "Worldshiba";
    string private _symbol = "WLDS";
    ...
    address payable public marketingWallet = payable(0x5cA9ced4ABe7957267d24B5e16aEEad3393Ec46b);
