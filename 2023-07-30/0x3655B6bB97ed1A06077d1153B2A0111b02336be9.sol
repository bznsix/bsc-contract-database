/* 
    ...
    APE COIN DESTROYER!
    Tokenomics : tax 10% for buy and sell, 20% tax for liquidity 50% Marketing, 30% Development.
    NFT Minting on coming
    Telegram : https://t.me/apeworld
    Website  : https://www.basedape.world
...
contract BASEDAPEWORLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDdE6FEB62642626e24f7A3D7899BBa596469d4E4); 
    address payable public Wallet_Dev = payable(0x8f5E97D37c2AE0B410469aA4Da745f49e03BDC13);
    ...
    string private constant _name = "Based Ape World"; 
    string private constant _symbol = unicode"$BASEDAPE"; 
    ...
    constructor () {
        ...
        _owner = 0x5B82EDd0F9F3CBD7B4feA3F4EEaeE8B20d57F035;
