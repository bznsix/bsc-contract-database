...
//https://t.me/PenguInuCommunity

//https://twitter.com/PenguInu2023
...
contract PENGUINU  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x180e0C984a5C582b4A63e2B1a6e52017F01781d0); 
    address payable public Wallet_Dev = payable( 0x180e0C984a5C582b4A63e2B1a6e52017F01781d0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 15* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PENGU INU"; 
    string private constant _symbol = unicode"$PENGUINU"; 
    ...
    uint256 public Percent_Reflection = 30;
    ...
    constructor () {
        _owner = 0x180e0C984a5C582b4A63e2B1a6e52017F01781d0;
