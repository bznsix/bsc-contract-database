...
Claim Aspecta ID now!
https://aspecta.id/
https://news.aspecta.id/
...
contract AspectaToken is Context, AspectaECO, Ownable {
    ...
    string private _name = 'Aspecta';
    string private _symbol = 'Aspecta';
    uint8 private _decimals = 9;
    string public Aspectawebsite = "https://Aspecta.io/";

    function getAspectawebsite() public view returns (string memory) {
        return Aspectawebsite;
    }
