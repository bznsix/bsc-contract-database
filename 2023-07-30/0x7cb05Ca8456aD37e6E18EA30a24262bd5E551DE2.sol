/**
Our platform is purpose-built to tackle the long-standing scalability challenges faced by traditional blockchain networks 
while prioritizing top-notch security through the integration of cutting-edge artificial intelligence (AI) technology.

Trinitarium envisions a future where seamless, rapid, and secure transactions are made accessible to all, 
paving the way for a new era of financial empowerment and innovation

// Telegram Community : https://t.me/Trinitarium
// Twitter: https://twitter.com/trinitariumOrg
*/ 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82EFc7b11C7c4A8F8f33166356Fe2118fC989931; // DEPLOYER
...
contract TRINITARIUM  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Trinitarium";
    string public _symbol = "TRIUM";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7e8F6C0823956D46aE90978179E9d855bD63E52f); 
    address payable private developmentWalletAddress = payable(0x7e8F6C0823956D46aE90978179E9d855bD63E52f);
    ...
    uint256 public _walletMax =   16000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 30 * 10**3; 
