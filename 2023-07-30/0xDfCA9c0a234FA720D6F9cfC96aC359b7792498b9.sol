...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xa98b116A096e5032d0d70232cC4d5d87B37b7fD0; 
...
contract CUPATKAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CU PAT KAI";
    string private _symbol = "$PATKAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa98b116A096e5032d0d70232cC4d5d87B37b7fD0);
    address payable public teamWalletAddress = payable(0xa98b116A096e5032d0d70232cC4d5d87B37b7fD0); 
