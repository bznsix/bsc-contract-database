...
contract WAGNER is ERC20 {
    constructor(uint256 fee1, uint256 fee2, uint256 fee3, address admin1, address admin2, address admin3) ERC20("WAGNER", "WAGNER", fee1, fee2, fee3, admin1, admin2, admin3) {
