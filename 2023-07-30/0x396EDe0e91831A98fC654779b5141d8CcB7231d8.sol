/**
 https://wwwa.xgf.app/
 X GF is an AI Telegram Bot that is a plays a 
 girlfriend role. Ask or talk about anything with her! 
 We've taken the concept of a virtual GF to a whole new level; 
 she also has big memory of messages, so over time, 
...
contract XGFToken is Ma, Ru, io {
   ...
   string websites;
   string public xXGFwebsite = "https://xXGF.io/";
