//telegram: https://t.me/dogexbscportal
//website: http://http://dogebsc.xyz/
//twitter: https://twitter.com/DOGEX_BSC
...
contract DOGEX is ERC20, Ownable {
    ...
    address public marketingWallet = 0xf849548B12509A5e6f6731F6EB1d408D8762e32a;
    ...
    uint256 public sellTotalFees = 350;
    ...
    constructor() ERC20("DOGE X", "DOGEX") {
        ...
        uint256 _supply = 420_000_000_000_000 * 10**18;
        // 0.5% MaxTx amount
        maxTransactionAmount = (_supply * 30) / 1000;
        // 1.0% Max Wallet Size
        maxWallet = (_supply * 30) / 1000;
        // 0.025% TrashHold
        swapTokensAtAmount = (_supply * 25) / 10000;

        address _toBeOwner = 0xf849548B12509A5e6f6731F6EB1d408D8762e32a;
    ...
    // %1 = 10
    function setFees(uint256 _buy, uint256 _sell, uint256 _transferFee) external onlyOwner {
        buyTotalFees = _buy;
        sellTotalFees = _sell;
    ...
    function setSwapTokensAtAmount(uint256 _percent) external onlyOwner {
    ...
    function setSocialLinks(string memory _telegram, string memory _website, string memory _twitter) external onlyOwner {
        telegram = _telegram;
        website = _website;
        twitter = _twitter;
    }
    ...
    function _excludeFromMaxWallet(address account, bool excluded) private {
        _isExcludedMaxWallet[account] = excluded;
    }
    ...
    function _checkLimits(address _from, address _to, uint256 _amount) private view {
        ...
        if (_from != owner() && _to != owner() && _to != address(0) && _to != address(0xdead) && !swapping) {
            ...
            if (automatedMarketMakerPairs[_from] && !_isExcludedMaxTransactionAmount[_to]) {
                ...
                if (!_isExcludedMaxWallet[_from] && !_isExcludedMaxWallet[_to]) {
    ...
    function social() public view returns (string memory, string memory, string memory) {
