...
contract EletroExpresso is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 1000000 * _decimalFactor; // Supply Token
    uint256 public buyFee = 12; // Taxa de Compra
    ...
    uint256 private limitBurn = 1000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 1000000 * _decimalFactor; // 1% do Supply
    uint256 public maxBuyAmount = 1000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 1000000 * _decimalFactor; // 1% do Supply
    ...
    /*=== Strings ===*/
    string private _name = "Eletro Expresso";
    ...
    constructor(uint256 _fee) {
        ...
        address pairCreated = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH()); // Gera o Par TOKEN/BNB
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool) {
        ...
        require(currentAllowance >= subtractedValue, "reducao do subsidio abaixo de zero");
