...
// b e c o m e   a   b e a n   t o d a y

// Join the Telegram: t.me/BeanBuilder
// Follow the Twitter: https://twitter.com/BeanBuilderBSC
...
library Address{
 ...
 contract BeanBuilder is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf6C3b2D02F2a4E4Fba4951b99A570DCfB61A60fA;
    address public donationWallet = 0x22360283dE6eae295d00a116581E4b79268F77a2;

    string private constant _name = "BeanBuilder";
    string private constant _symbol = "BEAN";
    ...
    Taxes public taxes = Taxes(0, 0, 5, 5);
    Taxes public sellTaxes = Taxes(0, 15, 0, 15);
