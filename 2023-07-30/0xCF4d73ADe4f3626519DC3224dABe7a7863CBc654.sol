...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public maxHold = 50000 * 1e18;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (swapBackEnabled){
            ...
            USDT.transfer(fundAddress, swapBackAmount);
        }
    }
...
contract BSCToken is AbsToken {
    constructor() AbsToken(
        ...
        18,
        20000000000,
        address(0x9092Db0a296AB835014bDb3EeFb9d67eC5b4B5F9),  //market1
        address(0xF1741F618ed552A6Ae348C32A6500f10BFad603A),  //market2
        address(0xc637a21255005Eb0439f7698645D29aBee946FE0),  //receive
        address(0x20e802B6110B1b6ff08e3F72fd894FC0f7546d27)   //LP
    ){}
}