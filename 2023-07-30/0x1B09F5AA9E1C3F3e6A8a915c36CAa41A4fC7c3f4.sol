...
contract ShibXPro is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ShibXProDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ShibXPro", "SXP") {
        marketingWallet = payable(0xF829d40736260D200D2eD45BbE5dEeF5C05Bbedf);
        devWallet = payable(0xbE6485946c063C86c5bE397e54F57D788D8F6fB6);
        ...
        dividendTracker = new ShibXProDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 2000000; // 2%
        swapTokensAtAmount = totalTokenSupply / 350000; // 0.0035%;
...
contract ShibXProDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ShibXPro public ShibXProContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ShibXProContract = ShibXPro(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ShibXProContract);

            uint256 prevBalance = ShibXProContract.balanceOf(address(this));
            ...
            {
                uint256 received = ShibXProContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ShibXProContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
