// Telegram:   https://t.me/xspace1996
...
contract XSpace1996 is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public buyFee = 8; // Taxa de Compra
    uint256 private previousBuyFee; // Armazena Taxa de Compra
    uint256 public sellFee = 8; // Taxa de Venda
    ...
    uint256 public numberOfTokensToSwapToLiquidity = 20000000000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "XSpace 1996";
    string private _symbol = "XS1996";
    /*=== Modifiers ===*/
