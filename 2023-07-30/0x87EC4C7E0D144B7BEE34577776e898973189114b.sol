/**
https://t.me/GrimaceTwoPointZeroBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5BE4C7Fd919798bcBEa4f9f959Ea263E0344bd4F; // owner address
...
contract GrimaceTwoPointZeroBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grimace 2.0";
    string private _symbol = "$GRIMACE 2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x52a00808Dc14e096C81B6428e1377dc1A1062Fc5); // Marketing Address
    address payable private teamWalletAddress = payable(0x52a00808Dc14e096C81B6428e1377dc1A1062Fc5); // Team Address
