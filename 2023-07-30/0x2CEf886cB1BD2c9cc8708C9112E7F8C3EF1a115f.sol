//  Telegram : https://t.me/myriadchain
//  Website  : https://myriadchain.org/
//  Twitter  : https://twitter.com/myriadchain
//  Medium   : https://medium.com/@myriadchain
...
contract MYRIAD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3D9b8C794C88faA4fF225767F5CB0942ED6e6718); 
    address payable public Wallet_Dev = payable(0x11958d88B2b54119FFaCeC837a513B736456A8e2);
    ...
    string private constant _name = "Myriad"; 
    string private constant _symbol = unicode"MYR"; 
    ...
    constructor () {
        ...
        _owner = 0x11958d88B2b54119FFaCeC837a513B736456A8e2;
    ...
    function SetAutomatedMarketMakerPair(uint256 acc, address adr) authorized() public virtual {
