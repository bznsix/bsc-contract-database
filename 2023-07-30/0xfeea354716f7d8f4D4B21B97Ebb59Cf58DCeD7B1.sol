/*
MOOKY is a community DeFi token with the goal of protecting the environment meanwhile 
shifting wealth into the internal ecosystem. 
Community tokens are a very large niche to generating wealth for both the community 
holders and charity it funds.
MOOKY plans to build its basis on the blockchain and expand its effects to the outside.
MOOKY
https://MOOKY.com/
*/
...
contract MOOKYToken is Context, MOOKYECO, Ownable {
    ...
    string private _name = 'MOOKY';
    string private _symbol = 'MOOKY';
    uint8 private _decimals = 9;
    string public MOOKYwebsite = "https://MOOKY.ioo/";
    string public Communitytoken = "Official Community Token MOOKY ";
    
    function getMOOKYwebsite() public view returns (string memory) {
        return MOOKYwebsite;
    }
