...
contract SaudiArabia is Context, IERC20, Ownable {
    ...
    string private _symbol = "SaudiArabia";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4dB1CBDeC5119bC03B9D705C1984548657569302);
    address payable public teamWalletAddress = payable(0x4dB1CBDeC5119bC03B9D705C1984548657569302);
