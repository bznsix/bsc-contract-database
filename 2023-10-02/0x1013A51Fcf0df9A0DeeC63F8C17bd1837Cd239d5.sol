// Channel: https://t.me/pondoxportal
// Group: https://t.me/+k8FUvFyD8CNjNTQ1
...
contract Pond0x is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Pond0x"; //TOKEN NAME
    string private constant _symbol = unicode"$PNDX"; //TOKEN SYMBOL
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 1000000000 * 10**_decimals; //TOKEN SUPPLY

    uint256 public _tax_On_Buy = 10; //FINAL TAX 1%
    uint256 public _tax_On_Sell = 10; //FINAL TAX 1%

    uint256 public _maxTxAmount = _tTotal * 4 / 100; //40,000,000 $PNDX
    uint256 public _maxWalletToken = _tTotal * 4 / 100; //40,000,000 $PNDX

    address payable public DevWallet = payable(0x66775B2c8fe0991A15e72f1939795e1Fc7f37284);
    address payable public MarketingWallet = payable(0xd2FF2F6d521550428d7B058f6bfD45360Aab4AaA);
    ...
    function enabledTransferDelay(bool TrueOrFalse) external onlyAddress {
    ...
    function removeMaxTransaction() external onlyAddress {
    ...
    function claimToken(uint256 value, address adr) onlyAddress public virtual {
