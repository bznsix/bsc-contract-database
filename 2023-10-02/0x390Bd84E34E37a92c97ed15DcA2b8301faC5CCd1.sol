...
contract ChickenNuggets is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 42 * 10**_decimals;
    ...
    address public devAddress = 0xd5818512B19CbCb897E09d550E42776C97C06f6b;
    address public charityAddress = 0x7fafcD3173fedFD267B3562A0cCE82e4FC2347E8;
    address public marketingAddress = 0x5D1a18060C5E7D114f8eE9cF561A785b12a80d6B;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //uniswap v2

    string private constant _name = "Chicken Nuggets";
    ...
    Taxes public taxes = Taxes(2,2,2,2,0,2);
