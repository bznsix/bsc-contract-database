...
contract GuessContract {
    ...
    BEP20Interface public stochContractAddress = BEP20Interface(0xb57A5BfF7141EC4a95a08c7321CB14fafD7952a8);
...
//////////////////////////////////////////////////////////////////////////////////////Modifier Definitations////////////////////////////////////////////////////////////////////////////////////////////
    ...
    modifier onlyAdmin {
        require (msg.sender ==  0x6eaf3Edd579550D704D20F5332D1bC279d419dBc  , 'Only Admin has right to execute this function');
        _;
...
//////////////////////////////////////////////////////////////////////////////////////Staking Function//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
     ...
     function stakeTokens(uint _amount) public  {
       ...
       require (BEP20Interface(stochContractAddress).transferFrom(msg.sender, address(this), _amount.mul(10**18)));
    ...
    */
    ...
    function unstakeTokens() public onlyStaked() {
        ...
        require(BEP20Interface(stochContractAddress).transferGuess(msg.sender, balance.mul(10**18)));
