...
contract MadBee is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "MadBee";
    string private constant _symbol = "BMAD";
    ...
    address payable private _devWallet =
        payable(address(0x605b6E825463E4fd723F85595a924417D88D108d));
    ...
    event SwapThresholdChange(uint256 threshold);
    ...
    function setSwapTreshold(uint256 newSwapTresholdPermille)
        public
        onlyOwner
    {
    ...
    function setFees(
        ...
        require(buy_tax + buy_marketing + buy_liquidity + buy_dev <= 15);
        require(
            sell_tax + sell_marketing + sell_liquidity + sell_dev <= 15
        );
        buyFee.tax = buy_tax;
