...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46d0e61bd056430f954949bc75412D790526D1F3; // owner address
...
contract BURNTOBER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BURNTOBER";
    string private _symbol = "BTB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x46d0e61bd056430f954949bc75412D790526D1F3); // Marketing Address
    address payable private teamWalletAddress = payable(0x46d0e61bd056430f954949bc75412D790526D1F3); // Team Address
