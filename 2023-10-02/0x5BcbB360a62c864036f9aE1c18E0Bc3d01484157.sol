...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 3000 * 10 ** Decimals;
        walletLimit = 3000 * 10 ** Decimals;
    ...
    function multi_WhiteList(address[] calldata addresses, bool status) public onlyOwner {
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
...
contract QAtarZilla is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000,
        address(0x6553BdA3c50938E4337661Ff8EBC468E58aaf53C),
        address(0x389C80B526b0777Ce6451eCe8e8F4d98BEa0E47f)
    ){
