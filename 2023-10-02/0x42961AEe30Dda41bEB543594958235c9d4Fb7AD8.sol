...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd1Ed38AabC9e986D1D3C88a1beE63f156Cdf57FA; // owner address
...
contract BlocksoftNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blocksoft Network";
    string private _symbol = "BSNet";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd1Ed38AabC9e986D1D3C88a1beE63f156Cdf57FA); // Marketing Address
    address payable private teamWalletAddress = payable(0xd1Ed38AabC9e986D1D3C88a1beE63f156Cdf57FA); // Team Address
