...
contract Rapidz_Token is ERC20, ERC20Burnable, Ownable, Pausable, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"Rapidz Token", unicode"RPZX") 
    {
        address supplyRecipient = 0xFB85B52871Bba1D7422d73420687AabEEaEF3f06;
        
        updateSwapThreshold(2500000 * (10 ** decimals()) / 10);

        _deployDividendTracker(86400, 200000 * (10 ** decimals()) / 10);

        gasForProcessingSetup(500000);
        rewardsFeesSetup(100, 100, 50);
        ...
        _transferOwnership(0xFB85B52871Bba1D7422d73420687AabEEaEF3f06);
    }
