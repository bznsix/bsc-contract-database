/*
*TG: https://t.me/BoredApeHouseBSC
*/
...
contract BoredApeHouseBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bored Ape House"; 
    string private _symbol = "$BAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d4dCa5567B52EaB8AbB379B68061584CED83d90); 
    address payable public teamWalletAddress = payable(0x5f297A17C89f57701BCd6B1BB0E662acc06397d7); 
