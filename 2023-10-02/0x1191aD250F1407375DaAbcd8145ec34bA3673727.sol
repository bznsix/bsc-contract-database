...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8b340cbE3a3B63EAB7fB36B43d5e2Bf259489F03; // owner address
...
contract DIABLO is Context, IERC20, Ownable {
    ...
    string private _name = "Diablo IV Dungeon";
    string private _symbol = "DIABLO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8b340cbE3a3B63EAB7fB36B43d5e2Bf259489F03); // Marketing Address
    address payable private teamWalletAddress = payable(0x8b340cbE3a3B63EAB7fB36B43d5e2Bf259489F03); // Team Address
