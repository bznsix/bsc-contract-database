...
contract BLOCKCONNECTOR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOCK CONNECTOR"; 
    string private _symbol = "B-CONNECT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3E155c844776c15c3F3c756aE810F1fcB21801CB); 
    address payable public teamWalletAddress = payable(0x956B8be1FcC2c1e45A73735214E0532122544686); 
