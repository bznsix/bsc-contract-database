...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6382E7Eb0dDD21bccdDB4AD79ca5EDB9424a4d43;
...
contract MYBUSINESSLINKUPRANK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x47a8c25e9eCC9Cd0fFA09992457e62a1C498aDa9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 700000000000  * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MYBUSINESSLINKUP RANK";
    ...
    uint256 public _maxTxAmount = 700000000000  * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 700000000000  * 10**18;
