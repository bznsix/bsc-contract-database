...
| | __| '__/ _ \/ _ \ '_ \| ___ \ | | | |    
| |_\ \ | |  __/  __/ | | | |_/ / | | | \__/\
 \____/_|  \___|\___|_| |_\____/  \_/  \____/
...
Tokenomics:
*Max 15000000000000000000000 per wallet.
*Fees:
    -2% Goes to LP.
    -7% Is redistributed to holders (included dead address).
...
contract GreenBTC is Context, IERC20, Ownable {
    ...
    string private _name = "GreenBTC";
    string private _symbol = "GreenBTC";
    ...
    address public devWallet = 0x15039e590a81DBEaF02304E345E117960a775211;
    ...
    uint256 public _maxTxAmount = 100000 * 10**9 * 10**9; //1% of total supply
