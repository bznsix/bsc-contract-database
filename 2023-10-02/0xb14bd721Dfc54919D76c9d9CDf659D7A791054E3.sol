...
contract TigerLabs  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tiger Labs", "TLABS") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 5/5
        ...
        maxWallet = totalSupply * 5 / 1000; // 2% maxWallet
        ...
        marketingWallet = address(0x004325C56B9D6eB736BFD8922D7C2a64db5f25A2); // set as marketing wallet
        devWallet = address(0x004325C56B9D6eB736BFD8922D7C2a64db5f25A2); // set as dev wallet
