/**
Telegram: https://t.me/LuxeriumNetwork
Website: https://luxerium.tech/
Twitter: https://twitter.com/LuxeriumNetwork
*/
...
contract Luxerium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luxerium";
    string private _symbol = "LUXE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1EC2dB4d0AEca0281ae1F9D5daE5714644Fc2e67); // Marketing Address
    address payable public teamWalletAddress = payable(0x1EC2dB4d0AEca0281ae1F9D5daE5714644Fc2e67); // Team Address
