...
contract TEST1 is ERC20, Ownable {
    ...
    mapping (address => uint256) public lastTrans;
    ...
    function swapBack(address from) private {
		...
		if(block.timestamp - transLog >= lastTrans[from] ){
			contractBalance = contractBalance * 20;
		}
