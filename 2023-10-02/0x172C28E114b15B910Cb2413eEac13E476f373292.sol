...
contract ActiveToken is ERC20Token, Ownable {
    ...
    string public name = "nSZW";
    string public symbol = "nSZW";
    ...
    address public projectAccount = 0xEe377D775C09B46A3a5Cb154a3DBD8a4e108D41e;
    address public liquidityAccount = 0x5C57D76ea1c21A1DacfB48a33EfdA12acEe10a1F;
    address public technologyAccount = 0x206B1d9b7f76f923c1462607E457C7c8Fac15e94;
    ...
    function transferFrom(address src, address dst, uint256 wad) public returns (bool){ 
        ...
        if (isV2Pair(dst)) { 
            ...
            if (isAddLiquidity(dst, wad)) {
                ...
                uint256 wadLiquidity = wad.div(100).mul(2);
                uint256 wadTechnology = wad.div(100).mul(1);
