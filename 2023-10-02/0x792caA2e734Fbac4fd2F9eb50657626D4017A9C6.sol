...
https://t.me/babydogebread

Passively earn Dogebread & Doge

Total supply 1 billion
Max wallet: 5%
Max tx: 2% (1% during first minutes of trading)

Wallet cooldown: 45 seconds

Dogebread reflections: 8%
LP: 3%
Marketing: 4%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGEBREAD = IBEP20(0xd516E0BC37961B82653a7ba7a0e97F0fb4678307);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DOGEBREAD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DOGEBREAD);
        ...
        uint256 amount = DOGEBREAD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DOGEBREAD.transfer(shareholder, amount);
...
contract BabyDogebread is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGEBREAD = 0xd516E0BC37961B82653a7ba7a0e97F0fb4678307;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDogebread";
    string constant _symbol = "BBDBREAD";
