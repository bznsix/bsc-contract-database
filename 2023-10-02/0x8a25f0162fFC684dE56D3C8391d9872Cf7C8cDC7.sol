/**
  ...
  //telegram: https://t.me/realshibahood
  //twitter : https://twitter.com/realshibahood
  //website : https://shibahood.net
*/
...
contract ShibaHood is IBEP20, Auth {
    ...
    string constant _name = "ShibaHood";
    string constant _symbol = "SHOOD";
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0xCCA7b51a3B65BA417597660543c0d0f127EcA9C6; 
        ...
        marketingFeeReceiver = 0xCCA7b51a3B65BA417597660543c0d0f127EcA9C6;
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver) external authorized {
