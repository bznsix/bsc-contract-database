...
contract BNBsongoku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA76459CD963FFcAE0804f7439eA7116CF5bd3CA5); 
    address payable public Wallet_Dev = payable(0xf3aeD7e7b11758e376539ba8c293cb5E8c74Fa08);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "BNBsongoku"; 
    string private constant _symbol = unicode"BNBsongoku"; 
    ...
    constructor () {
        _owner =0xf3aeD7e7b11758e376539ba8c293cb5E8c74Fa08;
