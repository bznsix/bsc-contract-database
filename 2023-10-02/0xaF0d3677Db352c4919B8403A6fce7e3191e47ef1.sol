...
contract TrabasArnyCapital is Context, IERC20, Ownable {
    ...
    uint256 public maxWallet = _tTotal * 1 / 50 ; // 0.5% at launch
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      ...
      require(_walletMax >= _tTotal * 1 / 30 , "Must keep above 0.3%");
        }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 55, "Must keep taxes below 25%");
