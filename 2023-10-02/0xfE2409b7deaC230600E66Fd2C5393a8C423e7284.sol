...
9️⃣ The name "999 FOUNDATION" and the abbreviation "$NINE" reflect the project's main theme, 
which is the number 9. The number 9 symbolizes luck, success, and 
perfection in the cultures of many communities worldwide.

9️⃣ Telegram : https://t.me/+shumGyKOX9wxMzhl
**/
...
contract NINE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "999 FOUNDATION";
    string private constant _symbol = unicode"$NINE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 39960000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x392f1a0c92a97762E36Fa424A2Fe56636a7696cb);
    address payable public MarketingWallet = payable(0xf32675efaF046F14fFCcEBb9623cDB339b41402D);
    ...
    function getxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function getxWallet(uint256 newmaxWallet) external onlyAddress {
