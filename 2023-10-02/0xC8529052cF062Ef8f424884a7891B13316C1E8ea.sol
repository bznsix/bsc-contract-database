/*
The unique & Official $BREAD Group

Have a test of the new Diving Dough Dynamics: Ancient Recipe, Modern Rebase 🍞

Official telegram: https://t.me/BreadBSCPortal
Official twitter: https://twitter.com/HolyBreadBSC
*/
...
contract $BREAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Holy Bread";
    ...
    address payable private devfee = payable(0xbb0c442c781f1A3789962Fcd9e73D6fc8a3854b3);
    address payable private marketingfee = payable(0xbb0c442c781f1A3789962Fcd9e73D6fc8a3854b3);
    ...
    function setBuyFees(uint256 newBuyFee, uint256 newRedisBuyFee) public onlyOwner {
        ...
        require(_taxFeeOnBuy <= 10, "Tax can't be set more than 10%");
        require(_taxFeeOnSell <= 10, "Tax can't be set more than 10%");
    }
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        devfee.transfer(dAmount);
        marketingfee.transfer(mAmount);
    }
