...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3B981444c11336736413d1Da067e4749549B9aFd;
...
contract PepeTomato is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe Tomato"; // 
    string private constant _symbol = "$PEMATO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x3B981444c11336736413d1Da067e4749549B9aFd);
