...
contract WSP is Context, IERC20, Ownable {
    ...
    address payable marketingWalletAddress = payable(0x4aF5C10CF6f93527f61a56B6f6072B8bfc5ee293); // Marketing Wallet Address
    address payable reserveWalletAddress = payable(0x4aF5C10CF6f93527f61a56B6f6072B8bfc5ee293); // Marketing Wallet Address
    address payable charityWalletAddress = payable(0x4aF5C10CF6f93527f61a56B6f6072B8bfc5ee293); // charity Wallet Address
    address payable devWalletAddress = payable(0x4aF5C10CF6f93527f61a56B6f6072B8bfc5ee293); // dev Wallet Address
    ...
    string private constant _name = "Wall Street Pepes";
    ...
    {   
        ...
        uint256 totalTokensToSwap = liquidityTokensCollected + devTokensCollected + marketingTokensCollected + charityTokensCollected + reserveTokensCollected;
        bool success;
        ...
        uint256 ethForCharity = (ethBalance * charityTokensCollected) / (totalTokensToSwap);
        uint256 ethForReserve = (ethBalance * reserveTokensCollected) / (totalTokensToSwap);
        
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDev - ethForCharity - ethForReserve;
        ...
        (success,) = address(charityWalletAddress).call{value: ethForCharity}("");
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _charityFee + _reserveFee; 
    }
    ...
    function restoreAllFee() private {
        ...
        function setAllFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 devFee, uint256 marketingFee, uint256 reserveFee, uint256 charityFee) 
    external onlyOwner() 
    {
    ...
    function setSaleFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 devFee, uint256 marketingFee, uint256 reserveFee, uint256 charityFee) 
    external onlyOwner() 
    {
