...
contract foreveruptoken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x674C150Dbd88C00fae088C115Fc164F75DAeDeEB); 
    address payable public Wallet_Dev = payable(0x674C150Dbd88C00fae088C115Fc164F75DAeDeEB);
    ...
    string private constant _name = "FOR EVER UP TOKEN"; 
    string private constant _symbol = unicode"FUT"; 
    ...
    constructor () {
        ...
        _owner = 0x674C150Dbd88C00fae088C115Fc164F75DAeDeEB;
