...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_,
     string memory symbol_, address _routeControllerAddress) {
        _name = name_;
        _symbol = symbol_;
    ...
    function balanceOf(address accaukt) public view virtual override returns (uint256) {
      ...
      function transfer(address to, uint256 ammoudnt) public virtual override returns (bool) {
        address owner = _msgSender(); _transfer(owner, to, ammoudnt);
        return true;
    }
...
contract DDDToken is ERC20, Ownable {
    uint256 private constant INITIAL_SUPPLY = 440000000 * 10**18;
