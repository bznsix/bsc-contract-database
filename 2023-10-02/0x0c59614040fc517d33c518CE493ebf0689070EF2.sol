...
* .   .       .      :  .   .: ::/  .  .::\                                                                                                                                                                                            
*                                                                                                                                                                                                                                                                                                                                                                                                                                  
* Inspired by the old little coins, it's time for LittleGalaxy.
* There is a fixed max buy/sell.
*
* Are we truely alone out here? Let's find out together. 
*
* Tokenomics
* 1% Burn 
* 5% Reflections
* 9% LP Tax
*
* Supply          = 1000000000000000  ALIENS   
* Max Wallet (3%) = 300000000000000   ALIENS
* Max TX (1%)     = 100000000000000   ALIENS
*
* Contract is renounced and lp is locked.
* There is no Telegram group made yet, make one and explore the galaxy together!
*
* Good luck, travelers.
*
*/
 ...
 * COIN
 */
contract LittleGalaxy is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    // Token
    string private _name = "LittleGalaxy";
    string private _symbol = "ALIENS";
    ...
    // Max TX in tokens
    uint256 public _maxSellTxAmount = 10000000000000 * 10**18;
    uint256 public _maxBuyTxAmount = 10000000000000 * 10**18;
    ...
    uint256 private liquidityFeeBuy = 9;
    uint256 private burnFeeBuy = 1;
    uint256 private taxFeeBuy = 5;
    uint256 private marketingFeeBuy = 0; 
    uint256 private totalFeeBuy = 15;

    // Sell tax in percentage
    uint256 private liquidityFeeSell = 9;
    uint256 private burnFeeSell = 1;
    uint256 private taxFeeSell = 5;
    uint256 private marketingFeeSell = 0;
    uint256 private totalFeeSell = 15;
