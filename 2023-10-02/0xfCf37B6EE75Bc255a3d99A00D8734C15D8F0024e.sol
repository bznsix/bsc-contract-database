//Telegram: https://t.me/ProteinToken
//Twitter: https://x.com/Proteinbnb
...
contract PROTEIN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PROTEIN";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x4928FE8896a165d96B42716b447c3957B395C416);
    address payable private _marketingAddress = payable(0x46c96E64eD5c3D76B66F8CFf24BE617f6492a186);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 25, "Redis cannot be more than 25.");
	    require(redisFeeOnSell < 25, "Redis cannot be more than 25.");
