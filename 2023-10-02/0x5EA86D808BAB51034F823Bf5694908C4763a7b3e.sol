...
//Telegram: https://t.me/realbeaglerise
...
library Address{
 ...
 contract BeagleRise is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 20000000000 * 10**9;
    uint256 public maxSellLimit = 20000000000 * 10**9;
    uint256 public maxWalletLimit = 20000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xf9bf61D7ba618c23109686a26c99293aA8D8616d;
    address public developmentWallet = 0xf9bf61D7ba618c23109686a26c99293aA8D8616d;

    string private constant _name = "BeagleRise";
    string private constant _symbol = "BGRISE";
    ...
    Taxes public taxes = Taxes(0, 5, 3, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 10) {
    ...
    function airdropTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
        ...
        for(uint256 i = 0; i < accounts.length; i++){
            _tokenTransfer(msg.sender, accounts[i], amounts[i], true, true);
        }
    }
