...
contract MsiToken is ERC20, Ownable {
    ...
    function initialize() public initializer {
        ...
        ERC20.__ERC20_init("MSI Token", "MSI");

		// 0.4M for initial liquidity provider, 1.6M for the liquidity farm.
        _mint(msg.sender, 400000 * 1e18);
    }

    function mintOnceForFarm(address _address) external onlyOwner {
        require(!doOnce, "only can mint once");
        require(_address != address(0), "!_address");
        doOnce = true;
        _mint(_address, 1600000 * 1e18);
    }
