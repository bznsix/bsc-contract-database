...
contract USDTStake {
    ...
    constructor(IERC20 _busd, address powerwallet, address wallet, uint startDate) {
        ...
        plans.push(Plan(7, 145, 30));
        plans.push(Plan(14, 162, 1000));
        plans.push(Plan(28, 187, 5000));
        plans.push(Plan(42, 199, 10000));
        plans.push(Plan(45, 221, 5000));
        plans.push(Plan(60, 239, 12000));
        plans.push(Plan(90, 268, 20000));
        plans.push(Plan(120, 291, 35000));
        
        userLevels.push(UserLevel(20000, 10));
        userLevels.push(UserLevel(50000, 15));
        userLevels.push(UserLevel(100000, 20));
        userLevels.push(UserLevel(200000, 25));
        userLevels.push(UserLevel(500000, 30));

        teamLevels.push(TeamLevel(5, 0, 0, 50000, 10, 500));
        teamLevels.push(TeamLevel(10, 1, 2, 100000, 15, 1000));
        teamLevels.push(TeamLevel(15, 2, 2, 200000, 20, 2000));
        teamLevels.push(TeamLevel(20, 3, 2, 400000, 25, 4000));
        teamLevels.push(TeamLevel(50, 4, 2, 800000, 30, 8000));
    }
