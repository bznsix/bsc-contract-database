/**
🚀Come and join $FlokiCat Inu, the next 1000x in Binance.
...
contract FlokiCatInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiCat Inu"; // 
    string private constant _symbol = "FLOKICAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xEE86c2269ca1d85f85BC949E2926ace2de6c40fD;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xB11751806401e3Cc683e8D88444Aca7fCdf6e7d6;
