...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62691D91015e103d925d231bBFDf2fe21C179f23;
...
contract QlitevTWOToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0e21689A3819aAF54F2CA5F9b1c083a2692778Ad;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 330000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Qlite2.0";
    string private _symbol = "QL2";
    ...
    string public QlitevTWOwebsite = "https://QlitevTWO.io/";
            function getQlitevTWOwebsite() public view returns (string memory) {
        return QlitevTWOwebsite;
    }
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public _maxTxAmount = 330000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 330000000000 * 10**18;
