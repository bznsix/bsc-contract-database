...
contract PANDORASHOCK is ERC20, Ownable {

    uint256 public transactionFeeRate = 2; // 2% transaction fee on buy and sell
    ...
    constructor() ERC20("PANDORASHOCK", "PSHOCK") {
