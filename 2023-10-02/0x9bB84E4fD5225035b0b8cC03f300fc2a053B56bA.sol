...
contract $OCTOBULL is Context, IERC20, Ownable {
    ...
    address public mwOCTOBULL = 0xF13De35e153D5b6a60235644a5E2d2A6E11E3563;

    string private constant _name = "OCTOBULL";
    string private constant _symbol = "OCTOBULL";
    ...
    constructor () {
        ...
        _isExcludedFromFee[mwOCTOBULL]=true;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        if(marketingAmt > 0){
            payable(mwOCTOBULL).sendValue(marketingAmt);
        }
    ...
    // Owner cannot transfer out OCTOBULL from this smart contract
