...
//TELEGRAM: https://t.me/HPOPM9I_portal
interface IERC20 {
...
contract HarryPotterObamaMario9Inu is Context, IERC20, Ownable {
    ...
    string private constant _name = "HarryPotterObamaMario9Inu";
    string private constant _symbol = "HPOPM9I";
    ...
    Taxes public taxes = Taxes(0,0,35,0);
    Taxes public sellTaxes = Taxes(0,0,55,0);
