/*
    ...
    $$ |  $$ |$$ |      $$   ____|$$  __$$ |$$  _$$<  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |  $$ |   $$ |  $$ |
    $$$$$$$  |$$ |      \$$$$$$$\ \$$$$$$$ |$$ | \$$\ $$ |$$ |  $$ |\$$$$$$$ |$$ |  $$ |  $$ |   $$ |  $$ |
    \_______/ \__|       \_______| \_______|\__|  \__|\__|\__|  \__| \____$$ |\__|  \__|  \__|   \__|  \__|
                                                                    $$\   $$ |                             
                                                                    \$$$$$$  |                             
                                                                     \______/                 
    ...
    5% automatically redistributed as BUSD, no need to claim.
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract BreakingATH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable token = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
    ...
    constructor() ERC20("BreakingATH", "BREAK") {
        uint256 _rewardsFee = 5;
        uint256 _operationsFee = 3;
        uint256 _liquidityFee = 3;
        uint256 _buybackFee = 2;
        
        uint256 totalSupply = 100 * 1e12 * 1e18; // 1 Billion total supply
    	...
    	operationsWallet = address(0x8eb6f38Bb68d8d8b3a8a29158889DFBfb1234A63);
    	buybackWallet = address(0x17f7A40D8d87401d285b2240BE44C6Bc02f19F6c);
        devWallet1 = address(0x22d3B96a9614B12670367F4eBFe133afCb00B461);
		devWallet2 = address(0x6d5C44c01470B86925f02133070D709e4BF92674);
