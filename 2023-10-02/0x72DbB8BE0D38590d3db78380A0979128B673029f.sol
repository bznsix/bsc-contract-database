...
contract OCTOINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "OCTO-INU";
    ...
    address payable public DevWallet = payable(0xeF9c00EcFeD5482b3AcBD41A16a0f7FD9CF03B9c);
    address payable public MarketingWallet = payable(0xCE352fdcaC68F0cCAFfB7Bab14862743CD3B52BB);
    ...
    function octonewFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function octomaxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function octomaxWallet(uint256 newmaxWallet) external onlyAddress {
