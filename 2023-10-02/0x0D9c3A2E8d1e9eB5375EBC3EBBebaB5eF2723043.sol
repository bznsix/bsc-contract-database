...
contract Doge1X is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDoge1Excluded;
    mapping (address => bool) private _isDoge1XExcluded;
    mapping (address => bool) private _isDOGEExcluded;
    ...
    constructor() payable ERC20 ("Doge-1", "DOGE-1") {

        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        ...
        marketingWallet =  0x977432Db249E7b52FC5e94dC78f1c791Faa963E2;

        dividendTracker = new DividendTracker(1 * 10**5, rewardToken);
        ...
        _isWalletExcluded[0x977432Db249E7b52FC5e94dC78f1c791Faa963E2] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000000000 * 777777;
    }
