...
Bamidele is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 3% tax is collected and distributed to holders for HODLing
2) 7% of it is sent for marketing fund
...
contract Bamidele is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x183Ef91E435658D83ABe00C593C99cEC14F65778); // Marketing Address
    ...
    string private _name = "Bamidele";
    string private _symbol = "Bamidele";
    ...
    uint256 private buyBackUpperLimit = 10000000 * 10**9;
