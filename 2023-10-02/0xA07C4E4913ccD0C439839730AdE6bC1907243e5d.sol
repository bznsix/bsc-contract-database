...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x33DDA0D498A65E06170Ce2caD34b9E40AD7E455E; 
...
contract ILIKEOCTOBER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "I LIKE OCTOBER";
    string private _symbol = "BULLISH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33DDA0D498A65E06170Ce2caD34b9E40AD7E455E);
    address payable public teamWalletAddress = payable(0x33DDA0D498A65E06170Ce2caD34b9E40AD7E455E); 
    ...
    uint256 private _totalSupply = 8000000* 10**_decimals;
    uint256 public _maxTxAmount = 8000000* 10**_decimals; 
    uint256 public _walletMax = 8000000* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = _totalSupply * 10 / 10000;
