...
#STARLINE
   ...
   I make this #STARLINE to hand over to the community.
   Create the community by yourself if you are interested.  
   I suggest TG name to create https://t.me/starlinebsc
   ...
   I will renounce the ownership to burn addresses to transfer #STARLINE to the community, make sure it's 100% safe.

   I will add 0.25 BNB and all the left 49% total supply to the pool
   Can you make #STARLINE 1000X? 

   1,000,000,000 total supply
   5000000 tokens limitation for trade, which is 0.5% of the total supply
   1% tokens for Dev
   ...
   it's the best part of the #STARLINE idea, increasing the liquidity pool automatically, 
...
contract STARLINE is Context, IERC20, Ownable {
    ...
    string private _name = "STARLINE";
    string private _symbol = "SLINE";
