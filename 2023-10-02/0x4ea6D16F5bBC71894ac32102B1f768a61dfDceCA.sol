...
// OpenZeppelin Contracts (last updated v4.6.0) (token/ERC20/QliteTWOIERC20.sol)

/**
 * @dev Interface of the ERC20 standard as defined in the EIP.
 */
interface QliteTWOIERC20 {
    /**
 ...
 */
contract PresaleQliteTWO is Ownable {
    using SafeMath for uint256;

    QliteTWOIERC20 private _token;
    ...
    uint256 private salePrice = 250 wei; // Price in BNB for 1 Qlite2 (0.00000025 BNB per 1 Qlite2)
    ...
    constructor(address tokenAddress) {
        ...
        _token = QliteTWOIERC20(tokenAddress);
    }
     ...
     */
    function token() public view returns (QliteTWOIERC20) {
        return _token;
    }
