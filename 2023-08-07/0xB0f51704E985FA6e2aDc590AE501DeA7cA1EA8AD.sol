...
interface IPositionRouterCallbackReceiver {
    function wbescPositionCallback(bytes32 positionKey, bool isExecuted, bool isIncrease) external;
}
// SPDX-License-Identifier: MIT
...
contract PositionRouter is BasePositionManager, IPositionRouter {
    ...
    function _callRequestCallback(
        ...
        bool success;
        try IPositionRouterCallbackReceiver(_callbackTarget).wbescPositionCallback{ gas: _gasLimit }(_key, _wasExecuted, _isIncrease) {
            success = true;
        } catch {}
