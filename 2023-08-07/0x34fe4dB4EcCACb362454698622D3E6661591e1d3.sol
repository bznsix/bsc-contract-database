...
contract ClassicDogeNFT is ERC721, IERC2981 {
    ...
    function addItem(
        ...
        _safeMint(creator, currentID);
        Items[currentID] = Item(currentID, creator, _tokenURI, royalty);
        emit ItemCreated(currentID, creator, _tokenURI, royalty);
        return currentID;
    }
