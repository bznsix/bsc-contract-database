...
contract Presale {
    ...
    address public owner; // New variable to track the contract owner
    ...
    // List of addresses that made deposits
    ...
    function withdrawTokensAndBNB() external onlyAdmin {
        ...
        (bool success, ) = owner.call{value: totalBNBBalance}("");
