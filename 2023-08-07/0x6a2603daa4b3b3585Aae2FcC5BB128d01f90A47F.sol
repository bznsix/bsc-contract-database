...
contract LCHS is ERC20, Ownable {
    ...
    address public marketingWallet0 = 0xB0c304C82b062bF39909b3BDf3057c5ddbb99ca3;
    address public marketingWallet1 = 0x792591C5eDf2e63C226Ca03389Ee155ECdf5ce09;
    address public lpOwner = address(0);
    address public tokenOwner = 0xB0c304C82b062bF39909b3BDf3057c5ddbb99ca3;

    uint256 public numTokensSellToSwap = 2 * 1e18;
    ...
    constructor() ERC20("LCHS", "LCHS") {
        ...
        isExcludedFromFees[marketingWallet0] = true;
        isExcludedFromFees[marketingWallet1] = true;
    ...
    function setMarketing0Addr(address account) external onlyOwner { 
        marketingWallet0 = account;
    }

    function setMarketing1Addr(address account) external onlyOwner { 
        marketingWallet1 = account;
    }
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        IERC20(USDT).transferFrom(address(tokenReceiver), marketingWallet0, balanceToMarketing/2);
        IERC20(USDT).transferFrom(address(tokenReceiver), marketingWallet1, balanceToMarketing/2);
