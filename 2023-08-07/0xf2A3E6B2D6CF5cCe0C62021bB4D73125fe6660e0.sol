/**
Telegram: https://t.me/chibicatofficial
...
contract CHIBICAT is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 200000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 2500000000 * 10**_decimals;
    uint256 public maxBuyAmount = 2500000000 * 10**_decimals;
    uint256 public maxWalletBalance = 2500000000 * 10**_decimals;

    address public marketingAddress = 0x466822FCc3699271cF79FaC4F28bdF96725061AD;
    address public devAddress = 0x1463aD5A1AB3719A73aFd837d389C5fF8034ae7A;

    string private constant _name = "Chibi Cat";
    string private constant _symbol = "CHIBI";
    ...
    Taxes public taxes = Taxes(0,0,9,0);
    Taxes public sellTaxes = Taxes(0,0,9,0);
