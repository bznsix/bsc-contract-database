...
contract RngHistory is VRFV2WrapperConsumerBase, AccessControlEnumerable {
    ...
    constructor()
        VRFV2WrapperConsumerBase(
            ...
            address(0x699d428ee890d55D56d5FC6e26290f3247A762bd) //vrf v2
        )
    {
    ...
    function requestRandomWord() external payable {
        ...
        requestsSinceLastRequest = requestsSinceLastRequestPrev;
        requestsSinceLastRequestPrev = 0;
        requestRandomness(
            250000, //callbackGasLimit,
    ...
    function convertContractBnbToLink() external {
        ...
        PCS_ROUTER.swapExactETHForTokens{value: address(this).balance}(
            (95 * linkPerBnbWad * address(this).balance) / 100 ether, //amountOutMin, 5% slippage max
            path,
            address(this),
            block.timestamp
        );
