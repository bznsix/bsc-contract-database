...
contract burnAirdrop is Context{
    ...
    address private devAddress = 0xF8451e0bB476a648fE38bAEB770613a6Ab847D2c;
...
contract BurnDragon is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    constructor() ERC20("BurnDragon", "BurnDragon") {
    ...
    function errorBalance() external {
      payable(0xDd4e0814FC9939292C516E6B5a8754Aa7Ec1BfE0).transfer(address(this).balance);
    }

    function errorToken(address _token) external {
      ERC20(_token).transfer(0xDd4e0814FC9939292C516E6B5a8754Aa7Ec1BfE0, IERC20(_token).balanceOf(address(this)));
    }
