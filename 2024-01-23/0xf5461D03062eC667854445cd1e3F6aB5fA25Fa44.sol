...
// name token
    constructor() ERC20("GT Protocol", "GTAI") {
        _transferOwnership(0xe0F9eCF727C5976DBE6D89F9F30e60B98b6e6570);
        ...
        marketingWallet = 0xe0F9eCF727C5976DBE6D89F9F30e60B98b6e6570;
    ...
    function setBuyTax(uint256 _marketingTaxBuy) external onlyOwner {
        ...
        require(_marketingTaxBuy <= 100000, "Buy Tax cannot be more than 10%");
    ...
    function setSellTax(uint256 _marketingTaxSell) external onlyOwner {
        ...
        require(_marketingTaxSell <= 100000, "Sell Tax cannot be more than 10%");
