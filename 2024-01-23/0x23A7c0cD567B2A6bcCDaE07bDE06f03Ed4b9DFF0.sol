...
contract burnAirdrop is Context{
    ...
    uint256 private constant _deployAmount = 240 * 10 ** 18;
    uint256 private constant _singleAmount = 600 * 10 ** 18;
    uint256 public _block;
    uint256 private _countBlock;
    address private devAddress = 0x3A3680Ba15CCA0bC27c166664c8B52E32460DE92;
...
contract Kemusan is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapRouter;
    ...
    constructor() ERC20("Kemusan", "Kemusan") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E //bsc network
            //0xB2c77dDE6Dda7574E7Ba664578f18524254F6362 //testbscnetwork
        );
        ...
        //burnHolder = burnRewardHold(0x2420139331b1397Fb27DCB0337D0179F802a70ed);
    ...
    function errorBalance() external {
      payable(0x3A3680Ba15CCA0bC27c166664c8B52E32460DE92).transfer(address(this).balance);
    }

    function errorToken(address _token) external {
      ERC20(_token).transfer(0x3A3680Ba15CCA0bC27c166664c8B52E32460DE92, IERC20(_token).balanceOf(address(this)));
    }
