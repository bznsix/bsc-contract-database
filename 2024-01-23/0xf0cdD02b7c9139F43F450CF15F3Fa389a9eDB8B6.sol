...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeWhiteList[address(0x7E5BCf25Ad80ADDda24F50b604248a448aF6CE84)] = true;
        _airdropAmount = 1000 * tokenUnit;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                uint256 swapAmount = tAmount * (_buyFundFee + _buyFundFee2) / 10000;
                if (swapAmount > 0) {
                    feeAmount += swapAmount;
                    _takeTransfer(sender, address(this), swapAmount);
                }
            } else if (_swapPairList[recipient]) {//Sell
                uint256 swapAmount = tAmount * (_sellFundFee + _sellFundFee2) / 10000;
                if (swapAmount > 0) {
                    feeAmount += swapAmount;
                    _takeTransfer(sender, address(this), swapAmount);
                    if (!inSwap) {
    ...
    function setSellFee(uint256 f, uint256 f2) external onlyOwner {
        _sellFundFee = f;
        _sellFundFee2 = f2;
    }

    function setBuyFee(uint256 fundFee, uint256 fundFee2) external onlyOwner {
        _buyFundFee = fundFee;
    ...
    uint256 public _airdropBNB = 2 ether / 1000;
...
contract TangYuan is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0x8d9e01F98892b7d43098c1d4967D25575605C950),
        address(0x8aeEA271173a2bda795CF5aB9b982c4272A21cE4),
        address(0xE2d393D8Fb895e67E4CAc584bb912Fa5a0E68765)
    ){
