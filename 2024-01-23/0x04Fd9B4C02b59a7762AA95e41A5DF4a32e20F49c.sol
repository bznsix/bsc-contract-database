...
pragma solidity ^0.6.2;
contract longzl is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    uint256 public swapTokensAtAmount = 20000 * (10**18);
    address public _marketingWalletAddress = 0x2A2b3C0b0355a354012A00571996E697F837E29C;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public _airdropAmount = 2400 * (10**18);
    uint256 public _airdropBNB = 4 * (10**15);
    uint256 public _airdropNumber = 0;
    bool public  lpBurnEnabled = true;
    uint256 public times;
    constructor() public ERC20("longzl", "longzl") {
