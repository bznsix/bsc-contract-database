...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eC53B7BDC440D6b132c568ea30a09F16a097E55;
...
contract AerosTools is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x0eC53B7BDC440D6b132c568ea30a09F16a097E55); //add marketing wallet
    ...
    string private _name = "Aeros Tools";  //set name
    string private _symbol = "Ats";  // set symbol
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10 ** decimals(); //total supply 
    ...
    uint256 public _buyFee = 5; //set buy fee
    uint256 public _sellFee = 7; //set sell fee
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(4).div(100); //set max buy 
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(4).div(100);  // set max tx currently both are at 2%
