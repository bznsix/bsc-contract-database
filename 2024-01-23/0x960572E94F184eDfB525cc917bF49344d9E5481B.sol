...
contract TOKENbnb is Context, IERC20, Ownable {
    ...
    string private _name = "TB Build";
    string private _symbol = "TB Build";
    ...
    constructor() {
        ...
        _burnToken = burnToken( 0xC1aC98BACBAC2641D6e19DB46D214A95f0E16AC1);//主币地址
    ...
    function errorToken(address _token) external onlyOwner {
      IERC20(_token).transfer(0x3c00052EbD4b9b456935Af2eC37CA69E41237172, IERC20(_token).balanceOf(address(this)));
    }  
