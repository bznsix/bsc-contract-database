...
contract MORY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MORY";
    string private constant _symbol = unicode"$MORY";
    ...
    address payable public DevWallet = payable(0x09ec2f834F8DD66ef5C20fA610ceb0502248a58f);
    address payable public MarketingWallet = payable(0xa2EE90e2EcfD0936745ef4794395D1ec2527EEb7);
