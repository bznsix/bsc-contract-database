...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee2 = 140;
    ...
    constructor (
        ...
        holderCondition = 100000000 * 10 ** Decimals;
        holderRewardCondition = 80 * 10 ** IERC20(RewardToken).decimals();
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {
                swapFee = _buyFundFee + _buyFundFee2 + _buyFundFee3 + _buyDividendFee + _buyLPFee;
                current = recipient;
            } else {
                swapFee = _sellFundFee + _sellFundFee2 + _sellFundFee3 + _sellDividendFee + _sellLPFee;
                current = sender;
            }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = lpFee + fundFee + fundFee2 + fundFee3 + _buyDividendFee + _sellDividendFee;
        ...
        uint256 rewardUsdt = usdtBalance - fundUsdt - fundUsdt2 - fundUsdt3 - lpUsdt;
    ...
    function setBuyFee(uint256 dividendFee, uint256 fundFee, uint256 fundFee2, uint256 fundFee3, uint256 lpFee) external onlyOwner {
    ...
    function setFee(uint256 dividendFee, uint256 fundFee, uint256 fundFee2, uint256 fundFee3, uint256 lpFee) external onlyOwner {
...
contract LF is AbsToken {
    constructor() AbsToken(
        ...
        address(0x25e77e758d6640aB9f0e48a44b9dc7Ae4e5b33e5),
        address(0x8aeEA271173a2bda795CF5aB9b982c4272A21cE4),
        address(0x97Bf2Ed7e75790F0fd81DA6b929Ea760b7616AC2)
    ){
