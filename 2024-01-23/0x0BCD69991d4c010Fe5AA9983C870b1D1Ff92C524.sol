...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3B93c9DFFFCd5f56A4aDbE6EE241C8df721432da;
...
contract ORC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBf0bEf4140B3fb7905431D56f274f47bd9bcBc3a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Orange Coin";
    string private _symbol = "ORC";
