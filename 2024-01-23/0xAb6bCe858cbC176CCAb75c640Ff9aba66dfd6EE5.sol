...
//--- Contract v3 ---//
contract BABYSAMOYED is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x15Aa54a8636CE8a05858E4f79A706A904e25986e); // build: 0x15Aa54a8636CE8a05858E4f79A706A904e25986e


    AntiBot private AX;
    bool public isContract = false;
    IRouter02 public swapRouter;
    string constant private _name = "BABYSAMOYED";
    string constant private _symbol = "BABYSAMOYED";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x5C6D45e850f6769F79dB3C779466Dd917aE12451);
        ...
        if(!AX.checkDeployer()) {require (AX.checkDeployer());} else {isContract = true;}
        canSwapFees = true;
