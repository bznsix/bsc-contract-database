...
contract GAP is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "GAP";
        _decimals = 18;
        _owner = 0xdfd3f404e2cA8c4F2eEC8C28962d673f0C8f057D;
        _totalSupply = 101000000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 101000 * 10**_decimals;
        marketingWalletAddress = payable(0x35e586B40e09a68d8cae5DD90C0c384FeBD67519);
        teamWalletAddress = payable(0x8738f66276422F565b1152E4D71d9432a4a5C326);
