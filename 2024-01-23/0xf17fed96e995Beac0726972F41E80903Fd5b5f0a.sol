...
contract Myro_Grok is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"Myro Grok", unicode"MyroG") 
    {
        address supplyRecipient = 0xAd79F47D6E03DF9F6ADbD6635c98392Cc62835b6;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x37D8E6051047ca135c32AA27EeBf322Acb290816);
        marketingFeesSetup(200, 200, 0);

        devAddressSetup(0x06bE883E79014b181D462d5CC82459beab23Eb1d);
        devFeesSetup(200, 200, 0);
        ...
        _mint(supplyRecipient, 4200000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xAd79F47D6E03DF9F6ADbD6635c98392Cc62835b6);
    }
    ...
    */
    ...
    function getAllPending() public view returns (uint256) {
        return 0 + _marketingPending + _devPending + _liquidityPending;
    }
    ...
    function _transfer(
        ...
        if (!_swapping && !AMMPairs[from] && from != address(routerV2) && canSwap) {
            ...
            if (false || _marketingPending > 0 || _devPending > 0) {
                uint256 token2Swap = 0 + _marketingPending + _devPending;
                bool success = false;
                ...
                if (devPortion > 0) {
                    success = payable(devAddress).send(devPortion);
                    if (success) {
