...
contract LongCheng is ERC20 {
    ...
    address payable _fundAddress = payable(address(0x4Df70D0f96a97FdE93498fC49F149D52F287C497));
    ...
    constructor(address tokenOwner) ERC20("2024\u5E74\u6625\u665A\u5409\u7965\u7269\u9F99\u8FB0\u8FB0", "\u9F99\u8FB0\u8FB0") {
		//require(_baseToken < address(this),"LongCheng small");
        ...
        _isExcludedFromFees[0x3Ac62a7180d501fCc17dB23AbfFBa60FD0E74886] = true;
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
			if (
				...
				swapAndLiquify(amount.div(100).mul(97));
			}
		}
		
        
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            require(startTime - 3 < block.timestamp,"startTime");
			...
			if(_isPairs[from]){
                ...
                amount = amount.div(100).mul(97);
                _takeInviterFeeKt(amount.div(10000));//1
			}else if(_isPairs[to]){
				require(startTime < block.timestamp,"startTime");
