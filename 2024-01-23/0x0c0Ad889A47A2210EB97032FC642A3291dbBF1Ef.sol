 ...
 * @title Tif Protocol
 * 
 * @notice This is a SAFU smart contract developed by Revoluzion for Tif Protocol.
 * 
 ...
 *
 * @custom:SAFU Owner 0x8b342fccDBd104eF906b5609795cE26d165e5AFE
 */
...
/**
 * @title Tif Protocol Token Contract
 *
 * @notice Tif Protocol is an extended version of ERC-20 standard token that
 ...
 */
contract TifProtocol is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    string private constant NAME = "Tif Protocol";
    string private constant SYMBOL = "TIF";
    ...
    address public constant SAFU_OWNER = 0x8b342fccDBd104eF906b5609795cE26d165e5AFE;

    address public projectOwner = 0xE76e566bEF1127e2D659da7AFC2B4ba6AC11FCb3;
    address public marketingReceiver = 0xE76e566bEF1127e2D659da7AFC2B4ba6AC11FCb3;
    ...
    /**
     * @notice Constructs the Tif Protocol contract and initializes both owner
