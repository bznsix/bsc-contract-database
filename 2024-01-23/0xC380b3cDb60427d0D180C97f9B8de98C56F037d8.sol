...
contract Baby_Musk_Elon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Musk Elon";
    string private _symbol = "BME";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0601BBD7e55bFd38CACECB5EB42239dcED418A05);
    address payable private DevelopmentWalletAddress = payable(0x3Fa88298fF6CC213d79B37E9d3ceCF4FC890e1dB);
