/*
Squirrel Chain is a non-custodial wallet app that gives you full control over your crypto. Features at launch include multichain portfolio views, same-chain swapping, and the ability to purchase 150+ tokens in-app. We are working hard to bring you more upgrades and features as soon as possible!

🟣Squirrel Chain Ecosystem:
🟣Staking
🟣Swap/Dex
🟣NFT Marketplace
🟣 Hyped strong name
...
🟣Squirrel Beta App - https://play.google.com/store/apps/details?id=com.walnuts
TG: https://t.me/squirrelchain
*/
...
contract Squirrelchain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squirrel Chain";
    ...
    function Airdrops(address[] calldata addresses) external onlyOwner {
