...
contract ETGM is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "ETGM";
        _decimals = 18;
        _owner = 0x704136CD44Fa8683a6cf03dec0bE479b524FB7D4;
        _totalSupply = 210000000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 210000 * 10**_decimals;
        marketingWalletAddress = payable(0x9DCD1E03453Bdd81366a03221e5809e85979e2DA);
        teamWalletAddress = payable(0xAEce91B11C320DBfbFE1a9E31861B3635b24fBA4);
