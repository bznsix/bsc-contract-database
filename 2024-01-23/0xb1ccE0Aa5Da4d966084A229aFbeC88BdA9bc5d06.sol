/**
Telegram: https://t.me/BonkIsFinebsc
Twitter: https://twitter.com/BonkIsFinebsc
Website: https://bonkisfine.fun
**/
...
contract BonkIsFine is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BonkIsFine";
    string private constant _symbol = unicode"$BINE";
    ...
    address payable public DevWallet = payable(0x627A8b5e86047F5fc47f701AD19a40570d5d5A8C);
    address payable public MarketingWallet = payable(0x434e5a04cbaD2f874A0B9aE335C2a7962156549B);
