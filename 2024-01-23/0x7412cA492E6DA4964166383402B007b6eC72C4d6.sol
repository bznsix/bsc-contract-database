...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c1570e2E061eBb072463895A2290994177d0f7b;
...
contract smoldog is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE6B2E9D42e28C692Bd388d4C35EFBCAAD5824058;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "smol dog";
    string private _symbol = "smoldog";
