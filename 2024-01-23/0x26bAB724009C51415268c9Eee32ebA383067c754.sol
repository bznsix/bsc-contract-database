...
contract ETHS is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "ETHS";
        _decimals = 18;
        _owner = 0x1d17A048484F2B60d6FccEc3f4b86a014F608103;
        _totalSupply = 1000000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 10000 * 10**_decimals;
        marketingWalletAddress = payable(0xDf41949169Bd9eD31C6Ac5988f794a618efC4a9c);
        teamWalletAddress = payable(0x48feB549A101b726121A0944BAf1A1721b459db4);
