/**
Telegram : https://t.me/RealWorldAssetsRWA
Website :https://realworldassets.website
*/
...
contract REALWORLDASSETS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x71700597161792aDB51e05BbE6b8871e115dc8A5); 
    address payable private Wallet_Dev = payable(0x71700597161792aDB51e05BbE6b8871e115dc8A5);
    ...
    string private constant _name = "Real World Assets "; 
    ...
    constructor () {
        ...
        _owner = 0x71700597161792aDB51e05BbE6b8871e115dc8A5;
