...
contract SHABINAKAMOTO is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"SHABINAKAMOTO", unicode"SBN") {
        ...
        maxBuyAmount = totalSupply * 7 / 100;
            ...
            if (from != owner() && to != owner() && to != address(0) && to != address(0xdead) && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
                ...
                if (transferDelayEnabled){
                    if (to != address(dexRouter) && to != address(lpPair)){
                        require(_holderLastTransferTimestamp[tx.origin] < block.number - 60 && _holderLastTransferTimestamp[to] < block.number - 60, "_transfer:: Transfer Delay enabled.  Try again later.");
