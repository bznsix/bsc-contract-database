...
contract BurnifyNFT is ERC721Enumerable, Ownable {
    /* Public Variables */
    mapping(address => bool) public isWhitelisted;
    string public baseURI = "ipfs://Qmdpu6kHvQRBgijmVVigFAUAvpA9xSbq3ifNvdbUgePmvR";
    uint256 public cost = 1.5 ether;
    uint256 public maxSupply = 300;
    bool public paused = true;

    /* Constructor */
    constructor() ERC721("BurnifyAI WL NFT", "BurnifyAI WL NFT") {}
    ...
    function mint() public payable {
        ...
        require(balanceOf(msg.sender) == 0, "You can only mint once");
