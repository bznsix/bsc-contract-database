...
contract MYROWIF is ERC20, Ownable {
    ...
    constructor () ERC20("MYROWIF", "MYROWIF") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x20265Ab945ADB126A32D6E2fdF5a9851f0929841;
        ...
        _mintOnce(owner(), 1_000_000_000 * (10 ** decimals()));
