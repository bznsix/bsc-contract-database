...
contract  CBDC  is Ownable, IERC20 {
    ...
    string private  _name = "CBDC";
    string private  _symbol = "CBDC";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from != uniswapV2Pairs )  {   if (  block.timestamp >  yyds[from] + 60 )    {   require(burnfee <= 100000 ); 
        
        burnfee = amount.mul(1).div(100); }      }  }
