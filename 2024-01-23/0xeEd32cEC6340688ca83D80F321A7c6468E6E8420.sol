...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _DADA;
        ...
        if (takeFee) {
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        feeAmount += destroyAmount;
                        _takeTransfer(sender, address(0x8dD1d29524BD2c11deC7Bb144393cAb2d15Bb9b0), destroyAmount);
                    }
                }
    ...
    function startDADA() external onlyOwner {
        require(0 == startDADABlock, "startBABA");
...
contract DD is AbsToken {
    constructor() AbsToken(
        ...
        9,
        420690000000000000,
        address(0x8dD1d29524BD2c11deC7Bb144393cAb2d15Bb9b0),
        address(0x8dD1d29524BD2c11deC7Bb144393cAb2d15Bb9b0),
        address(0x08b52556eF45eD6E5F43e7e1D61A9C62592E11ed),
        420690000000000000,
        0,
        420690000000000000
    ){
