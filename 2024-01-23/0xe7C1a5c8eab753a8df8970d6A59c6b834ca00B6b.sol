...
contract TREEOL is ERC20 {
    ...
    address _nodeAddressBuy = address(0xd274714688627Cb7b70e315093a37a72a804170E);
    address _childAddressBuy = address(0xf72D53436874BB87Ec1dFBb4146C1A28fe70eba2);    
    address _reservedAddressBuy = address(0xbc8aa6C38A6f0533508D04da3C1A128c174C4A18);
    address _nodeAddressSell = address(0xA8f99f327118a675e793e36eF4CFba0A62eE089e);
    address _childAddressSell = address(0x648b662c129AAda6354C39cc56559737b09257b5);    
    address _reservedAddressSell = address(0xA4E16251aAD2C1F5C006a41DE7de9f48173AB238);

    address _mintAddress = address(0x285d3E05E92225729B4d5f22bD8b8B03545FF536);
    ...
    constructor(address tokenOwner) ERC20("TREEOL", "TREEOL") {
        require(_baseToken < address(this),"TREEOL small");
    ...
    function startBuyEnabled(bool _enabled) external onlyOwner{
        buyEnabled = _enabled;
    }
