...
contract FhToken is ERC20, Ownable {
    ...
    constructor(
        ...
        maxBuyAmount = numberParams[0] * 10**18;
        maxSellAmount = numberParams[1] * 10**18;
        require(
            maxSellAmount >= maxBuyAmount,
            " maxSell should be > than maxBuy "
        );
        maxWalletAmount = numberParams[2] * 10**18;
        ...
        require(buy_totalFees + buy_burnFee <= 9900, "buy fee too high");
        require(sell_totalFees + sell_burnFee <= 9900, "sell fee too high");

        uint256 __totalSupply = numberParams[11] * 10**18;

        fundAddress = address(addressParams[0]);
        ETH = addressParams[1];
        _swapRouterAddress = addressParams[2];

        mushHoldNum = numberParams[12] * 10**18;
        kb = numberParams[13];
        ...
        swapTokensAtAmount = 1125000 * 10**18;
    ...
    function setTransferFee(uint256 newValue) public onlyOwner {
        require(newValue <= 9900, "transfer > 99 !");
