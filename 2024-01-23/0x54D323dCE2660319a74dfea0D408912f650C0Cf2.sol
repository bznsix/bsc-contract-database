...
contract ANONGROK is Context, Ownable, IERC20 {
    ...
    mapping (address => bool) private isStealthlaunchAddress;
    mapping (address => uint256) private balance;



    uint256 constant public _totalSupply = 369_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0x34584C33b2354f7D56610bac0451E94C8b7b7F24); // build: 0x34584C33b2354f7D56610bac0451E94C8b7b7F24
    address payable private devWallet = payable(0x6193Cab8Fd9F09073d5683A457F6e4E6813249E4); // build: 0x6193Cab8Fd9F09073d5683A457F6e4E6813249E4
    ...
    string constant private _name = "Anon Grok";
    string constant private _symbol = "$GROK";
    string constant public copyright = "0x.anongrok.com";
    ...
    event _setStealthlaunchAddress(address account, bool enabled);
    ...
    function canSwap(address ins, address out) internal view returns (bool) {
        bool canswap = canSwapFees && !isStealthlaunchAddress[ins] && !isStealthlaunchAddress[out];
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function setStealthlaunchAddress(address stealthlaunch, bool yesno) external onlyOwner {
            require(isStealthlaunchAddress[stealthlaunch] != yesno,"Same bool");
            isStealthlaunchAddress[stealthlaunch] = yesno;
            _noFee[stealthlaunch] = yesno;
            liquidityAdd[stealthlaunch] = yesno;
            emit _setStealthlaunchAddress(stealthlaunch, yesno);
        }
