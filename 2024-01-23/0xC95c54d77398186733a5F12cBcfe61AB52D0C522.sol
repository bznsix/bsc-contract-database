 ...
 * 
  ...
  *——————————————————
  *
  * Description: The ASH Token is a platform for funding sustainable business initiatives that aim to eliminate pollution from the global environment and drive the adoption of renewable energy sources.
  * Website: ashtoken.io
  * Twitter: @Ashtoken
  * Telegram: @Ashtokennews
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="Ash Token Test";
    string private _symbol="ASHT";
    uint8 private _decimals=18;

    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 10000000000000000000000000000000;
    uint256 private _tTotalSupply = 10000000000000000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint public ReflectionFeeonBuy=10;
    uint public ReflectionFeeonSell=10;

    uint public liquidityFeeonBuy=10;
    uint public liquidityFeeonSell=10;

    uint public marketingFeeonBuy=80;
    uint public marketingFeeonSell=80;
    ...
    address public marketingWallet=0x2Cf04C71Ba06290F9CA630f398Fa3A89e10c1DC1;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=400000000000000000000000000000;
    uint256 public maxTransactionAmountSell=100000000000000000000000000000;

    uint256 public maxWalletAmount=400000000000000000000000000000;
    ...
    uint256 public swapTokensAtAmount=100000000000000000000000000;
