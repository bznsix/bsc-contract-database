...
contract BabyBlock is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Block";
    string private _symbol = "BLOCK ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1D4A1b46Ae49bf8f9039b3D6693B953d339BAa6b); // Marketing Address
    address payable public teamWalletAddress = payable(0x1D4A1b46Ae49bf8f9039b3D6693B953d339BAa6b); // Team Address
