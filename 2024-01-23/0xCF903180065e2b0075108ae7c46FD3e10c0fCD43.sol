...
//--- Contract v3 ---//
contract WinBitz is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x4a33c334EB6016CF6a22faf61Cb3D2De7BA49567);
    address payable private devWallet = payable(0xFc97383950839943b6484Bf161839D1dA311c980);
    ...
    string constant private _name = "WinBitz Casino";
    string constant private _symbol = "WBITZ";
    string constant public copyright = "winbitz.io";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"WinBitz: Must equals to 100%");
    ...
    function changeWallets(address newBuy, address newDev) external onlyOwner {
        require(newBuy != address(0),"WinBitz: Address Zero");
        require(newDev != address(0),"WinBitz: Address Zero");
