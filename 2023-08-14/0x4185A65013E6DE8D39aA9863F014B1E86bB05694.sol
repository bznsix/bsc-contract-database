...
contract TapTap_Coin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TapTap Coin", "TapC") {
        uint256 _rewardsFee = 0;
        uint256 _marketingFee = 2;
        uint256 _liquidityFee = 0;
        
        uint256 totalSupply = 150 * 1e7 * 1e18;
        
        address newOwner = address(0x20BD9eb6524Caf2839e91127ed37797A426aB1A7);
    	...
    	marketingWallet = address(0xBCb2C3Eaa886579c079bA7045dB82e8f77b36cab);
        ...
        */
        ...
        _mint(newOwner, totalSupply); // 1.5 Billion total supply
