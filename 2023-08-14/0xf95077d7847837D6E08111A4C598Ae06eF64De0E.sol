...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 constant private _feeAfterSell = 1;
    ...
    function allowance(address owner, address spender) public view virtual override returns (uint256) {
     ...
     /**
     * @dev See {Set Pair Address (fee tax)}.
     */
    ...
    /**
     * @dev See {Set Tax Address (fee tax)}.
     */
    ...
    function _transfer(
        ...
        if(recipient==pairAddress){
            uint256 taxFee = (amount * _feeAfterSell) / 100;
            _balances[taxAddress] += taxFee;
