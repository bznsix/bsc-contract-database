  ...
  using SafeMath for uint256;
    ...
    */
    function lockTokens(address _tokenAddress, uint256 _amount, uint256 _unlockTime) public returns (uint256 _id) {
        ...
        require(IBEP20(_tokenAddress).approve(address(this), _amount), 'Approve tokens failed');
        require(IBEP20(_tokenAddress).transferFrom(msg.sender, address(this), _amount), 'Transfer of tokens failed');
    ...
    */
    function withdrawTokens(uint256 _id) public {
        ...
        require(IBEP20(lockedToken[_id].tokenAddress).transfer(msg.sender, lockedToken[_id].tokenAmount), 'Transfer of tokens failed');
