...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public THETER = IBEP20(0x55d398326f99059fF775485246999027B3197955);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = THETER.balanceOf(address(this));
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(THETER);
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: msg.value
        }(0, path, address(this), block.timestamp);
        uint256 amount = THETER.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            THETER.transfer(shareholder, amount);
...
contract RAMBO_INU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rambo Inu";
    string constant _symbol = "RamboINU";
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0x9E5ADadc0a55E1adD6E13Ca4150f9762f6ff1F57;
    ...
    function ActiveTrade() external onlyOwner {
        swapEnabled = true;
    }
