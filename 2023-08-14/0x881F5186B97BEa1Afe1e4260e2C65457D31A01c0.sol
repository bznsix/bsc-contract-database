...
contract PepeXelon is IERC20, Ownable {
    string constant _name = "PepeXelon";
    string constant _symbol = "PEXEL";
    ...
    uint256 public swapThreshold = (_totalSupply * 1) / 100000; // 0.0001% of supply
    ...
    constructor() {
        ...
        marketingWallet = 0x967a06f951976e022FdE2eE8B16D88a4BB5E7c64;

        address deployer = 0x81Db07bb9D2388713EE8a3C2b3609d8f57dFF277;
