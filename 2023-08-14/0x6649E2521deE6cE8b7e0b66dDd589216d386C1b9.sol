...
contract Vault is ERC20, IVault, Pausable, ReentrancyGuard {
    ...
    function initializeVault(
        ...
        INonfungiblePositionManager.MintParams memory params = INonfungiblePositionManager
            .MintParams({
                ...
                token1: token1,
                fee: fee,
                tickLower: tickLower, //-887272//-58200, //TickMath.MIN_TICK,
                tickUpper: tickUpper, //887272//-44200, //,TickMath.MAX_TICK
    ...
    function harvest(
        ...
        (uint256 amount0, uint256 amount1) = IMCV3(masterchefV3).collect(
            collectParams
        );
        uint256 amountOut = _swap(token0, token1, amount0, 0);
