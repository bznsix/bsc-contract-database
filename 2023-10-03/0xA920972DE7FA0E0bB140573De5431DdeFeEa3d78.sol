...
contract BabySmurf9000 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x059775ae04E11487dd0cF00E253e4D677A52a781); 
    address payable private Wallet_Dev = payable(0x5d58BafE354E2f8FACcbD3Bb7E39eE31cc1770dc);
    address payable public constant Wallet_Burn = payable(0x059775ae04E11487dd0cF00E253e4D677A52a781); 
    ...
    constructor () {
        ...
        _owner = 0x5d58BafE354E2f8FACcbD3Bb7E39eE31cc1770dc;
