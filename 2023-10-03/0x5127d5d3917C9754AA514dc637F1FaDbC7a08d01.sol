...
Telegram: 
https://t.me/UniverseEcosystem

Website:
https://universe-ecosystem.com

Twitter:
https://twitter.com/UniEcosytem
...
contract UniverseEcosystem is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 1_000 * 10**9;

    uint256 public genesis_block;

    address public marketingWallet = 0xb15a09C467c42e1EcF6292278a673a259C36d748;
    address public teamWallet = 0xb15a09C467c42e1EcF6292278a673a259C36d748;

    string private constant _name = "Universe Ecosystem";
    string private constant _symbol = "$Universe";
    ...
    Taxes public taxes = Taxes(1, 7, 2, 0);
    Taxes public sellTaxes = Taxes(1, 7, 2, 0);
