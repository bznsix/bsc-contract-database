...
// telegram : https://t.me/oktoberBSChunt
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7265B0896BF8d53a7De5f9B1774Ca51d35B98835 ; // owner address
...
contract OctoberHunt  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OctoberHunt";
    string private _symbol = "$HUNT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b023D6A8597970BB472bBfb86567419E0c0B8A3); 
    address payable public teamWalletAddress = payable(0x6b023D6A8597970BB472bBfb86567419E0c0B8A3);
