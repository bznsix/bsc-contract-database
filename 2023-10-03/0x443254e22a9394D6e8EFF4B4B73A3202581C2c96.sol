...
contract PepeWallstreet is IERC20 {
    ...
    string private constant _name = "Pepe Wallstreet";
    string private constant _symbol = "PEW";
    uint8 private constant _decimals = 6;

    uint256 private constant _totalSupply =
        24_000_000_000_000_000 * 10**_decimals;

    uint256 public taxFeeOnBuy = 30;
    uint256 public taxFeeOnSell = 30;
    uint256 public numTokensSellToSwap = 12_000_000_000_000 * 10**_decimals;
    ...
    function finalizeTransfer(
        ...
        if (overMinTokenBalance && !inSwap && from != lpPair && swapEnabled) {
