...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        uint256 feeAmount;
        if (takeFee) {
            feeAmount = tAmount * (lpFee + fundFee) / 10000;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalUsdtFee = lpFee / 2 + fundFee;
...
contract DDZ is AbsToken {
    constructor() AbsToken(
        "Fight the landlord",
        "DDZ",
        18,
        10000 * 10 ** 5,
        address(0x30cE171fD854079BE248a3c31C89b0A3C8d91952)
    ){

    }
    function transferAirport(address[] memory _to, uint256 _value) public {
