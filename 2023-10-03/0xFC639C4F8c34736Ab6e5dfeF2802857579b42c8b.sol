...
contract JHCB is ERC20 {
    ...
    address _fundAddress = address(0x822C542f8D65F092E3465b7764306B1C44a0aF49);
    ...
    constructor(address tokenOwner) ERC20("JHCB", "JHCB") {
        require(_baseToken < address(this),"JHCB small");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(30) > block.timestamp){amount = amount.div(100);}
                _splitUsdtLdxToken();
				super._transfer(from, address(this), amount.div(1000).mul(45));
				amount = amount.div(1000).mul(955);
                ...
                }else if(startTime.add(2400) > block.timestamp){
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount >= 10**19){
            ...
            if(afterAmount > beforeAmount){
                ...
                USDT.transfer(_fundAddress, newAmount.div(9).mul(5));
            }
		}
    }
