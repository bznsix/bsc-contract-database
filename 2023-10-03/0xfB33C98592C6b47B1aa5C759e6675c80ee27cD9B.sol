/**
// tg : https://t.me/vistanetworkportal
// X : https://twitter.com/vista_networks
// Website : https://vista-network.tech
*/
...
contract VistaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vista Network";
    string private _symbol = "VSNT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03fB8a0D9D5a52eD251fedde791540f2331bcC8b); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x03fB8a0D9D5a52eD251fedde791540f2331bcC8b); // Development Address
    ...
    uint256 public _maxTxAmount = 3 * 10**4 * 10**9;
    uint256 public _walletMax = 3 * 10**4 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (3 * 10**4 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
