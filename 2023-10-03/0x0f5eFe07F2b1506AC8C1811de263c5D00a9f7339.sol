...
contract CPEPE is ERC20, Ownable {
    ...
    constructor () ERC20("Coyote Pepe", "CPEPE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingFeeOnTransfer = 10;

        marketingWallet = 0xb5E0b2B224e77E72d31f7A89aAFb83504Cd0abdD;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnTransfer) external onlyOwner {
        ...
        require(marketingFeeOnBuy <= 15, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnSell <= 15, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnTransfer <= 10, "Total Fees cannot exceed the maximum");
