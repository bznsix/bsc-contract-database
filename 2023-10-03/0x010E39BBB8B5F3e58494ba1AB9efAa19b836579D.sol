...
contract test is Context, IERC20, Ownable {
    ...
    address payable public marketing = payable(0xCfA8029B659F0440a42285aAC877C2e8D8274Af9);
    address payable public treasury = payable(0xb27aaeC13775eD4401C854A077985f03E4abEeE4);
