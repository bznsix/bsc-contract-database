...
contract MyToken is ERC20, Ownable{
    ...
    uint256 public totalSuply = 100000000000000;

    uint256 public swapThreshold = totalSuply / 20000 * 10e9; // 1/10000 thredshold
    
    address public marketingWallet = 0x30baf076Eb3B4822b08659399DA6013e1b57B5E7;
    ...
    constructor() ERC20("QIXI", "QIXI") {
        _mint(msg.sender, totalSuply * 10 ** decimals());
