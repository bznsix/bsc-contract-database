...
Crypto Charms Token
Community Token
Rewards ETH for Holding - 10%
 1% Buy Back | 3% Liquidity | 4% Marketing
 0.75% Max Tax | 1.5% Max Wallet
 
 TG: https://t.me/cryptocharmstoken
 Twitter: https://twitter.com/charms_crypto
...
contract CryptoCharms2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CryptoCharms";
    string constant _symbol = "CC2";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 75 / 10000; // 0.75%

    uint256 public _maxWalletToken = ( _totalSupply * 15 ) / 1000; // 1.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xa052c2284e8DcA88D8418561D86450B83eCB1D64;
