/**
Telegram    :https://t.me/Xpepedaochannel
Twitter     :https://twitter.com/xpepedao_news
Website     :https://xpepedao.site
**/
...
contract XPEPEDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XPEPEDAO";
    string private _symbol = "XPEDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0286Bc6acFA8cAA2513155698f2275c858951B32); // Marketing Address
    address payable public teamWalletAddress = payable(0x0286Bc6acFA8cAA2513155698f2275c858951B32); // Team Address
