...
contract ShootEveryone is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 100000000 * _decimalFactor; // Supply Token
    ...
    uint256 private limitBurn = 10000000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 50000000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 50000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 50000000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 5000000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Shoot Everyone";
