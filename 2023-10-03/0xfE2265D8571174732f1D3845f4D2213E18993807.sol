...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdeDBcE8f79786356aF659dE145aE2146e45907f0; // owner address
...
contract OneDollarLong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OneDollarLONG";
    string private _symbol = "1$LONG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xdeDBcE8f79786356aF659dE145aE2146e45907f0); // Marketing Address
    address payable private teamWalletAddress = payable(0xdeDBcE8f79786356aF659dE145aE2146e45907f0); // Team Address
