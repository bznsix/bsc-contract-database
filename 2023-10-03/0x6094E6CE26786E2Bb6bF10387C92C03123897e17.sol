...
contract Balls is IERC20 {
    mapping(address => uint256) private _tOwned;
    mapping(address => bool) lpPairs;
    uint256 private timeSinceLastPair = 0;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _liquidityHolders;
    mapping(address => bool) private isTradingExempt;
    mapping(address => bool) private isFeeExempt;

    uint256 constant private startingSupply = 1_000_000_000;
    string private _name = "Balls";
    string private _symbol = "BALLS";
    ...
    address payable public marketingWallet = payable(0x5eEf2e00D344F2eD83c6310014f5156dB8a50691);
    ...
    function setBlacklistEnabled(address account, bool enabled) public onlyOwner {
        ...
        isTradingExempt[account] = enabled;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        require(!isTradingExempt[from] && !isTradingExempt[to], "Blacklisted.");
        bool buy = false;
        bool sell = false;
        bool other = false;
        if (lpPairs[from]) {
