...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6FD006B527E566881f5bd20eed9AD203237eE156; // owner address
...
contract LOOOOOOOOOONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOOOOOOOOOONG";
    string private _symbol = "LOOOOOOOOOONG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6FD006B527E566881f5bd20eed9AD203237eE156); // Marketing Address
    address payable private teamWalletAddress = payable(0x6FD006B527E566881f5bd20eed9AD203237eE156); // Team Address
