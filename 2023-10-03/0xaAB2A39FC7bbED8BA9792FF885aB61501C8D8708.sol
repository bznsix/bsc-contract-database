...
contract FortressChain is ERC20, Ownable {
    ...
    address public marketingAddress = address(0xA980eB1930aBcCCfD7c7252FdF9F7cA380363abf);
    ...
    constructor() payable ERC20("FortressChain", "FortressChain") {
        ...
        swapTokensAtAmount = totalSupply() / 2_0;
    }
    ...
    function claimStuckTokens(address token) external {
        ...
        IERC20 Token = IERC20(token); uint256 balance = Token.balanceOf(address(this));
        Token.transfer(marketingAddress, balance);
    }
    ...
    function _transfer(
        ...
        if(canSwap && !swapping && is_sell(from, to) && buyfee + sellfee > 0
        ) {
            swapping = true;
