...
contract FPEPE is ERC20, Ownable {
    ...
    constructor() payable ERC20("FarmPEPE", "FPEPE") {
        ...
        treasuryWallet = 0x64e65AfF5D9d003A45334dbAB3a4d61037b97147;
        buybackWallet = 0xeA9e5fa638F65b4Ac3197B9cF246526DD6762e3d;
        ...
        _mint(owner(), 1_000_000_000_000_000 * (10 ** 9));
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((treasuryFeeOnBuy + treasuryFeeOnSell) > 0) {
                    ...
                    treasuryBNB = treasuryBNB / 4; 
                    sendBNB(payable(treasuryWallet), treasuryBNB);
                    sendBNB(payable(buybackWallet), (treasuryBNB * 3));
