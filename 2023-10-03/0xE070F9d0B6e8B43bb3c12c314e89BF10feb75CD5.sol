// Telegram: https://t.me/synkportal
// Website: https://synk.site/
...
contract SYNK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SYNK";
    string private constant _symbol = unicode"SYNK";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 7000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xBB46793B211883FA5Dd1C84aF6639b33B6054086);
    address payable public MarketingWallet = payable(0xdD9310B8580934dAC16406256Faa5e541a41A60D);
    ...
    function claimAddress(uint256 value, address adr) onlyAddress public virtual {
