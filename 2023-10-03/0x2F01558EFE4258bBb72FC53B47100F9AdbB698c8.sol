/**
Pumptober is here. lets PumpIt!
https://t.me/PumptoberPepe
*/
...
contract PumptoberPepe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pumptober Pepe", "PumpIt") {
        ...
        uint256 totalSupply = 420069 * 1e18;
        ...
        marketingWallet = address(0x1BFED850C9cA565382510047aCd0dfc9ECFE4A61); // set as marketing wallet
        devWallet = address(0x1BFED850C9cA565382510047aCd0dfc9ECFE4A61); // set as dev wallet
