...
contract MARIOTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public unnxcd15;
    ...
    string private _tokenname = "MARIO BSC";
    string private _tokensymbol = "MARIO";
