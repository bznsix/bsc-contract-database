...
contract SteamTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public bvccdfg5;
    ...
    string private _tokenname = "SteamGameFi";
    string private _tokensymbol = "Steam";
