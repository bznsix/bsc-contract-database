...
//Official telegram: https://t.me/HalloweedInuOfficial
//Official twitter: https://twitter.com/HalloweedInu

//Introducing the hottest new meme coin on Smart Chain, Halloweed Inu! Get ready to dive into a world filled with spooky fun and thrilling returns. With its innovative tokenomics and community-driven development, Halloweed Inu is set to revolutionize the crypto landscape. Whether you're a seasoned investor or just getting started, join us on this exciting journey and let's make some hauntingly good profits together!
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC41053412f9440e39A8fD5C42ED3C88efC381Bde;
...
contract Halloweed is Context, IERC20, Ownable {
    ...
    string private constant _name = "Halloweed Inu"; // 
    string private constant _symbol = "$HALLOWEED"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xC41053412f9440e39A8fD5C42ED3C88efC381Bde);
