...
BlocX is a Layer 1 Blockchain focusing on speed, low gas fee's and the secureness of its network. Constructing an expansive and dynamic ecosystem designed to cater to the diverse needs of developers and users, Through the robust infrastructure and innovative solutions, BlocX is paving the way for a new era of seamless interaction, offering developers a versatile playground to create groundbreaking applications and services while ensuring users experience a fluid and user-centric environment
*/
...
contract BLXStaking2 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xE9da86435265477BCdE46c7E9aa7AcE5aa7e2d18);
        rewardToken = IBEP20(0xE9da86435265477BCdE46c7E9aa7AcE5aa7e2d18);
    ...
    function updateExitPenalty(uint256 newPenaltyPerc) external onlyOwner {
        require(newPenaltyPerc <= 10, "Max Penalty is set at 10% cannot be increased!");
