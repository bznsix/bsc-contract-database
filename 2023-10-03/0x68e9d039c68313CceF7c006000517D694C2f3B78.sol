        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xEADdDeA1Ec63a928e0f61705dCDDDC0Ef96b1Eec), block.timestamp
                );
            }
        }
    }
...
contract LONG is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        10000,//Supply
        address(0x8F10813E9A55688B67B9D6841D36C30F3d726604),//FundAddress
        address(0xB42c6245a23aC8F71D912CD4De6059AfE1bB7DA3)//ReceiveAddress
    ){
    }
}