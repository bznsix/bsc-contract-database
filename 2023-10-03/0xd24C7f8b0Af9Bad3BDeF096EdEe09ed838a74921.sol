...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB4D8d9db31f86B80816218C69bbfbD622C66730a; // owner address
...
contract Pepepredator is Context, IERC20, Ownable {
    ...
    string private _symbol = "Croco";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB4D8d9db31f86B80816218C69bbfbD622C66730a); // Marketing Address
    address payable private teamWalletAddress = payable(0xB4D8d9db31f86B80816218C69bbfbD622C66730a); // Team Address
