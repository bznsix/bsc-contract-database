...
/**
    After the success of $BHIBA on ETH, we believe that BABY Ethereum needs to be born on BSC! 🚀🚀🚀
...
contract BETH is IBEP20 {
    ...
    string public override name = "BABY Ethereum";
    string public override symbol = "BETH";
