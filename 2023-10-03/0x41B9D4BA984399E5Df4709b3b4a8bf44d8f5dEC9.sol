...
contract TheMoneyFrog is ERC20, Ownable { 
    ...
    event UpdateFees(uint256 sellMarketingFees, uint256 buyMarketingFees,
                    uint256 buyDeadFees, uint256 sellDeadFees,
    ...
    constructor() ERC20("TheMoneyFrog", "TMF") { 
        marketingWallet = payable(0x6cb7b878cc456E8741604964B6F40032357996D9); 
        devWallet = payable(0x6cb7b878cc456E8741604964B6F40032357996D9); 
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 devBuy, uint256 devSell,
                        uint256 deadBuy, uint256 deadSell, uint256 liquidityBuy, uint256 liquiditySell) public onlyOwner {
        ...
        emit UpdateFees(sellMarketingFees, sellDevFee, sellLiquidityFee, buyDeadFees, sellDeadFees,
                        buyMarketingFees, buyDevFee, buyLiquidityFee);
    }
