...
contract ElonBeGone is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name     = "ElonBeGone";
    string private constant _symbol   = "EBG";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 300; // 3% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 600; // 3% of every transaction is kept for liquidity
    uint256 public _marketingFee = 100; // 4% of every transaction is sent to marketing wallet
