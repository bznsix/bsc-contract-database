...
contract ALFAECAPITALToken is IBEP20 {
...
contract ALFAECAPITALUSDT {
    address payable admin;
    ALFAECAPITALToken public tokenContract;
    ...
    constructor(ALFAECAPITALToken _tokenContract, uint256 _tokensSold)  {
