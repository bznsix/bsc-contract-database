...
contract Halloween2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Halloween2049";
    string private _symbol = "HLW2049";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x18C50e8fe011fE463d8E902643966F724bEad8A0); // Marketing Address
    address payable public teamWalletAddress = payable(0x18C50e8fe011fE463d8E902643966F724bEad8A0); // Team Address
