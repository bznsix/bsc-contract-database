/**
 Baby Changer Official Contract https://t.me/BabyChanger
*/
...
contract BabyChanger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyChanger";
    string constant _symbol = "BabyC";
