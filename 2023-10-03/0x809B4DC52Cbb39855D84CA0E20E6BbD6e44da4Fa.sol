...
contract PepeJoker is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Joker", "PEPEJOKER") {
        ...
        maxWallet = 2_000_000_000 * 1e18; // 1.2% 
        ...
        marketingWallet = address(0xcFD7B0E9bdC74D48CEde4a668EF3Fa8742E54Cb6); // set as marketing wallet
        devWallet = address(0xcFD7B0E9bdC74D48CEde4a668EF3Fa8742E54Cb6); // set as dev wallet
