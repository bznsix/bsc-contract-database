...
contract CatsVSDogsTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public jsnne46;
    ...
    string private _tokenname = "CatsVSDogs";
    string private _tokensymbol = "CatsVSDogs";
