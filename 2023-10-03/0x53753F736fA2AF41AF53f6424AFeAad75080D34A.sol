...
The Memecoin project will revolutionize the memecoin market from now on, 
buy your tokens $GHOST now 👻🎃

👻 Tax Buy 10% / Sell 12%
👻 Reward Holder 2%
👻 Competition Buy 0.05 Get 0.45 BNB
🔥 BSC Trends | CMC&CG | Big Pump X100

👻🎃: https://t.me/+LBZXjpChWr9mYTVl
**/
...
contract HUNGRYGHOST is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HUNGRYGHOST";
    string private constant _symbol = unicode"$GHOST";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 666000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x8dEd5AA753A5f2bFe881b67D227AAFf494686E41);
    address payable public MarketingWallet = payable(0x0d5e6343B35d59Ef7678f4844b3e960610bC315a);
