...
contract H is Context, IERC20, Ownable {
    ...
    string private _name = unicode"H";
    string private _symbol = unicode"l";
    uint8 private _decimals = 9;

    address payable public marketing = payable(0xec198Fe19B0EcF042a397AC63bCA0b3Fc404A70A);
    address payable public vault = payable(0x8EEaC336714cC72ddFB8735026742Ff9069E0e2e);
