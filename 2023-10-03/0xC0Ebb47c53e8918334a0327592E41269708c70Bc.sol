...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x587DB7E17383A7591E5aE7be860a2b011fce58e8; 
...
contract OCTOBER is Context, IERC20, Ownable {
    ...
    string private _name = "OCTOBER";
    string private _symbol = "2049";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x587DB7E17383A7591E5aE7be860a2b011fce58e8);
    address payable public teamWalletAddress = payable(0x587DB7E17383A7591E5aE7be860a2b011fce58e8); 
