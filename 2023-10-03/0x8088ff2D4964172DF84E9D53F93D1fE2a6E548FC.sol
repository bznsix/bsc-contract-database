...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdEE67ef8DC201a5898963b5Bb9a9C7216c787523;
...
contract OCTOPUMP  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "OCTOPUMP";
    string public _symbol = "OCTO";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2D69AE3BaDE44DEEB95F8EcD88A2BE51057E05f7); 
    address payable private developmentWalletAddress = payable(0x2D69AE3BaDE44DEEB95F8EcD88A2BE51057E05f7);
