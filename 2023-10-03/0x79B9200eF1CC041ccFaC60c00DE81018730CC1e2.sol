...
//*      stealth launch https://t.me/+PlxzvOg_GgEzZjY9
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x3A36a83A1374A41129e1E3B3F15e7Db5e43B5902; 
...
contract PrePumpOCTOBER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PrePump OCTOBER";
    string private _symbol = "PUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3A36a83A1374A41129e1E3B3F15e7Db5e43B5902);
    address payable public teamWalletAddress = payable(0x3A36a83A1374A41129e1E3B3F15e7Db5e43B5902); 
    ...
    uint256 private _totalSupply = 999999999* 10**_decimals;
    uint256 public _maxTxAmount = 999999999* 10**_decimals; 
    uint256 public _walletMax = 999999999* 10**_decimals;
