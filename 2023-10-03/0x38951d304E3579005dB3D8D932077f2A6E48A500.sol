    ...
    ERC2981 
{
    ...
    uint256 public constant EARLY_ACCESS_PRICE = 0.15 ether;
    ...
    constructor(
        ...
        uint256 gen_
    ) ERC721rPass("Cryptoflats-Gen1", "CNRS-1", MAX_SUPPLY) {
        gen = gen_;
    ...
    function mint(
        ...
        if (isUserFreePurchaseWhitelist(whitelistFreePurchaseProof, msg.sender) == true) {
            ...
            require(isPublicSaleActive == true, "CNRS: Public sale inactive");
