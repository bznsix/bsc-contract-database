...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfD468f44d272A2a624b3F306810acE11aF19218b;
...
contract AVRII is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Avatar II";
    string private _symbol = "AVR-II";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfD468f44d272A2a624b3F306810acE11aF19218b);
    address payable public teamWalletAddress = payable(0xfD468f44d272A2a624b3F306810acE11aF19218b);
    ...
    uint256 private minimumTokensBeforeSwap = 350000000 * 10**_decimals; 
