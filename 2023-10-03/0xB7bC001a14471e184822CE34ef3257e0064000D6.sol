...
Portal: https://t.me/BitCubeFinance
...
contract BitCubeFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BitCubeFinance";
    string private _symbol = "BITC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D72B5d6E78E24b5B3Eb2508F302619Ca0D41745); 
    address payable public buyBackWalletAddress = payable(0x7D72B5d6E78E24b5B3Eb2508F302619Ca0D41745); 
    ...
    uint256 private _totalSupply = 500000000 * 10**9;
