...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  200000 * 10** Decimals;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"LONG2024",//Name
        unicode"LONG2024",//Symbol
        9,//Decimals
        20240000,//Supply
        address(0xee3567dF1B6e18c77786A8Ab62Aa3fDda051C15A),//FundAddress
        address(0xee3567dF1B6e18c77786A8Ab62Aa3fDda051C15A)//ReceiveAddress
    ){
    }
}