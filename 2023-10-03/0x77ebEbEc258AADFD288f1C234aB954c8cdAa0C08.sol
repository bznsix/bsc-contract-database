...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = 0x27a0D8cb6976aFdA82D381aeDec11Ade50e02A34;
...
contract PretiumMargin is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev =
        payable(0x27a0D8cb6976aFdA82D381aeDec11Ade50e02A34);
    ...
    string private _name = "Pretium Margin";
    string private _symbol = "PMT";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 200000 * 10 ** 18;
    uint256 private _tFeeTotal;

    // Counter for liquify trigger
    uint8 private txCount = 1;
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(1).div(1);
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(1).div(800);
    ...
    */
    ...
    function blacklist_Remove_Wallets(
        address[] calldata addresses
    ) external onlyOwner {
        uint256 startGas;
        uint256 gasUsed;
