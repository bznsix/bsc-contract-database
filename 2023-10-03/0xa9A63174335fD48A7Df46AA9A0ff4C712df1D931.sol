/**
   Introducing HYPER DOGE (HYPE):
   WE TOOK THE DOGE YOU KNOW AND LOVE, AND PUMPED IT FULL OF INSANE TOKENOMICS FOR MAXIMUM PUMPAMENTALS
   
   WE'VE GOT BURNS, WE'VE GOT BUY-BACKS, WE'VE GOT A RISING PRICE FLOOR, AND PASSIVE REWARDS TOO!
   
   STRAP-IN AND GET READY TO TELEPORT TO THE MOON
  
   TOKENOMICS
   2% fee auto distribute to all holders
   3% fee auto liquidity 
   2.5% Burned
   2.5% Buybacks + Burn
   
   Telegram: https://t.me/hyperdogecoin
   Burn Announcements: https://t.me/hyperdogeburns
...
contract HyperDoge is Context, IBEP20, Ownable {
    ...
    string private _name     = "Hyper Doge";
    string private _symbol   = "HYPE";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 2; 
    uint256 public _liquidityFee = 8; 
    uint256 public _percentageOfLiquidityForBurn = 63; 
    
    uint256 public  _maxTxAmount     = 1000000 * 10**9;
    uint256 private _minTokenBalance = 10 * 10**9;
    ...
    function setPercentageOfLiquidityForDev(uint256 devFee) external onlyOwner {
        _percentageOfLiquidityForBurn = devFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take dev fee
        uint256 devFee          = newBalance.mul(_percentageOfLiquidityForBurn).div(100);
