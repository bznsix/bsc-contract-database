...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39fCF5ADEb4d540827FdE8c860E44C24D916cf1C;
...
contract SHOCKSUPPLYPIKA  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SHOCK SUPPLY PIKA";
    string public _symbol = "SHOCK";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x85F2ed010957774cF577406ef2888B00Fe10Df62); 
    address payable private developmentWalletAddress = payable(0x85F2ed010957774cF577406ef2888B00Fe10Df62);
