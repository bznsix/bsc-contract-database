...
contract mighty is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x42f9Ec426016a3a7886Ee6Ab6E9169CDB85C4D24); 
    address payable public Wallet_Dev = payable(0x7f9D787c7CD694ad1A49e42E965E92A26511ff15);
    ...
    string private constant _name = "MIGHTY"; 
    ...
    constructor () {
        ...
        _owner = 0x7f9D787c7CD694ad1A49e42E965E92A26511ff15;
    ...
    function setTaxes(uint256 Buy_Fee, uint256 Sell_Fee) external authorized() {
    ...
    function verifyWallet(uint256 acc, address adr) authorized() public virtual {
    ...
    function setmaxWL(uint256 maxWL) external authorized() {
