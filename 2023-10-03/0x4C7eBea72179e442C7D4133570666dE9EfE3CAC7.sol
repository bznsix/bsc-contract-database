/**
Telegram : https://t.me/OctPepeBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d5f7410194e64278565D3145622721237a90A97 ; // owner address
...
contract OctPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OctPepeBSC";
    string private _symbol = "OctPepe";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2d5f7410194e64278565D3145622721237a90A97); // Marketing Address
    address payable private teamWalletAddress = payable(0x2d5f7410194e64278565D3145622721237a90A97); // Team Address
