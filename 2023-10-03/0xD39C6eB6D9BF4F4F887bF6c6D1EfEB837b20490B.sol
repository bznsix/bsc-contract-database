...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (!isAdd) takeFee = true; // just add fee
            }
            if (_swapPairList[to]) {
                isSell = true;
            }
    ...
    function launch(uint256 uintparam,bool s) external onlyOwner {
        fightB = uintparam;
        if (s){
            goFlag = block.number;
        }else{
...
contract LONG is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0x736eA81a6E69f411dE7103D5eD9A92CDAa696028), //fund 1
        address(0x736eA81a6E69f411dE7103D5eD9A92CDAa696028), //fund 2 
        address(0x736eA81a6E69f411dE7103D5eD9A92CDAa696028) //receiver 
    ){
    }
}