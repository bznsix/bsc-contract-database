...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLpReflectionFee = 0;
    ...
    uint256 public _sellLpReflectionFee = 0;
    ...
    constructor (
        ...
        fundAddress = address(0x1A378ebfA6281A2a58D357EA4C85bb2358dE38F9);
        fundAddress_2 = address(0x8a73EA5c010D7b15D949eea49719DbE49c8F2077);
    ...
    uint256 public rewardUSDTPercentage = 50;// 分红税的50%分U
    function setRewardUSDTPercentage(uint256 newValue) public onlyOwner{
        require(newValue <= 100);
        rewardUSDTPercentage = newValue;
    }
    ...
    uint256 public airDropCount = 10;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
                ...
                } else if (block.number < startTradeBlock + 28800) {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 newBal = USDT.balanceOf(address(this)) - beforeBal;
        uint256 rewardETHAmount = newBal * (100-rewardUSDTPercentage) / 100;
        if (rewardETHAmount > 0){
            address[] memory rewardETHpath = new address[](2);
            rewardETHpath[0] = _usdt;
            rewardETHpath[1] = _eth;
            ...
            if (!excludeLpProvider[shareHolder]) {
                ...
                if (pairBalance >= holdCondition) {
                    ...
                    if (balanceOf(shareHolder) >= tokenHoldContdition){
                        ...
                        ETHAmount = ETHbalance * pairBalance / totalPair;
                        if (ETHAmount > 0) {
                            try ETH.transfer(shareHolder, ETHAmount) {} catch {}
                        }
...
contract LONG is AbsToken {
    ...
    //USDT
        ...
        address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8),// 多分eth
    //Receive
        address(0x388ec3d3C639AbE1D353130D79dCb70209a87427)
    ){
