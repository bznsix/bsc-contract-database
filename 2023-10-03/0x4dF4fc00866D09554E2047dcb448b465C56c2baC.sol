...
contract Octoberhunt is Context, IERC20 {
    string private _name = "OCTOBERHUNT";
    string private _symbol = "$HUNTS";
    ...
    address payable public MarketingWallet = payable(0x3Fe858BfA4A2EEaB6f0F4F83E0314c60391EA090);
