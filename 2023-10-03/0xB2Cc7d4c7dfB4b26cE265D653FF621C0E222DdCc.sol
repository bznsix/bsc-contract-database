...
// File contracts/IUniswapRouterETH.sol
...
// File contracts/CakeStrategy.sol
 ...
 * Rewards from providing farmed every few minutes
 ...
 */
contract CakeStrategy is Ownable, Pausable {
     ...
     * {output} - Token generated by staking our funds.
     * {ramen} - Ramen token, used to buyback and burn to dead address.
     * {cake} - Cake token.
     */
    ...
    /**
     * @dev Contracts:
     * {burnAddress} - Buyback Ramen and straight goes to BURN
     ...
     * It deposits in the MasterChef to earn rewards.
     */
    ...
    /**
     * @dev It withdraws from the MasterChef and sends it to the vault.
     */
    ...
    function chargeFees() internal {
        ...
        uint256 buybackburnFee = wbnbBal.mul(BUYBACKBURN_FEE).div(MAX_FEE);
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(buybackburnFee, 0, wbnbToRamenRoute, burnAddress, now.add(600));
    }
     ...
     */
    function retireStrat() public onlyOwner {
        require(msg.sender == vault, "!vault");
