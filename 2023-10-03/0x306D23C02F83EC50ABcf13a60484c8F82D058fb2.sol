...
// telegram : https://t.me/Roaring_Kitty_BSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39c394d1535b015494DaacE9Db100c58fC0656B2 ; // owner address
...
contract RoaringKitty  is Context, IERC20, Ownable {
    ...
    string private _name = "RoaringKitty";
    string private _symbol = "RKITTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39c394d1535b015494DaacE9Db100c58fC0656B2); 
    address payable public teamWalletAddress = payable(0x39c394d1535b015494DaacE9Db100c58fC0656B2);
