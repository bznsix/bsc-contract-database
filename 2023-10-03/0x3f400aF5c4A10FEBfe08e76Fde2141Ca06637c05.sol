...
contract CLOWNINUTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public jkkas6;
    ...
    string private _tokenname = "CLOWNINU";
    string private _tokensymbol = "CLOWNINU";
