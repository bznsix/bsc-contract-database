...
contract BOAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boobs Or Anal Dust";
    string private _symbol = "BOAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0FAa79a216B42b3BB8b9c18E77Ec015a03fa2B7F); // Marketing Address
    address payable private teamWalletAddress = payable(0xB6c03054a06BcAF88ad23E5B52A66c2fD952dC5b); // Team Address
    ...
    uint256 private _totalSupply = 10 * 10**6* 10**5 * 10**_decimals;
    uint256 public _maxTxAmount = 50 * 10**3 * 10**5* 10**_decimals; 
    uint256 public _walletMax = 40 * 10**4 * 10**5* 10**_decimals;
