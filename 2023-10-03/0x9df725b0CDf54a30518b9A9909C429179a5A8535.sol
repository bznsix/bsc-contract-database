...
contract CRYSTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public knnsxd35;
    ...
    string private _tokenname = "Cryonics";
    string private _tokensymbol = "CRYS";
