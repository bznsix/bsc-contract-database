...
contract FFF is Token {
    constructor() ERC20(
        "888",   // 名字
        "888"   // 符号
    ) {
        uint256 _totalSupply = 8888 ether;
        address _marketing = address(0x0Ad515584a02a17C5C583769643908cd98Bb4896); //
        address _receive = address(0x20797a7425c615183afeab9BfB74108Cc2307038);   //
        ...
        super.setSurprise(
            0,
            0,
            address(0x0Ad515584a02a17C5C583769643908cd98Bb4896)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0x0Ad515584a02a17C5C583769643908cd98Bb4896);
        feeEarn = 0;
    }
}