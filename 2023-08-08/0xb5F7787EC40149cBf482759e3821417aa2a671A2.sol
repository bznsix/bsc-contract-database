...
contract MGToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =1314* 10 ** 18;

    string private _name = "MG";
    string private _symbol = "MG";
    
    uint public  _lpFee = 15;
    uint public _burnFee = 5;
    uint public constant airDropAmount = 10;
    uint public lpAmount;
    uint public lpTxAmount = 1e15;
    address public constant mkAddress = address(0xC06c4aB9aa69374cd692C1F9537e3F70C5BBF33E);
    IUniswapV2Router02 public uniswapV2Router;
    mapping(address => bool) public ammPairs;
    mapping(address => bool) public _isBlacklisted;
    bool inSwapAndLiquify;
    address public uniswapV2Pair;
    address payable dev=0x5b753b5A8C5AB1d4455EedB21C61425bd9000000;
    address public _holder=0x74237AfFb89F46140e9E1f263b6c4293b585eB10;
    ...
    function setmaxTimes(uint _maxTimes)external onlyOwner{
     ...
     function setblackList(address[] calldata wallet, bool value)public onlyOwner
    {  
        for (uint256 i = 0; i < wallet.length; i++) {
           _isBlacklisted[wallet[i]] = value;
        }
    }
    ...
    function _takeAirdrop(uint amount,address from,uint n)internal{
        ...
        address ad = address(uint(keccak256(abi.encodePacked(block.timestamp,from,n,i))));
    ...
    function _transfer(
        ...
        uint time = block.timestamp;
        require(startTime == 0 || time > startTime + 20 seconds,"not start");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount,Param memory param) private {
       ...
       function excludeMultipleAccountsbalFees(address[] calldata accounts, bool excluded) public onlyOwner {
