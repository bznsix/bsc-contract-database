/**
 *Submitted for verification at Etherscan.io on 2023-07/25/2023
*/

// SPDX-License-Identifier: NOLICENSE
pragma solidity ^0.8.10;
//TELEGRAM: https://t.me/PEPE_X_PORTAL
//WEBSITE: https://twitter.com/PEPE_X_BSC
interface IERC20 {
...
contract PEPEX is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 2000000 * 10**_decimals;
    uint256 public maxBuyAmount = 2000000 * 10**_decimals;
    uint256 public maxWalletBalance = 2000000 * 10**_decimals;

    address public marketingAddress = 0xDE1D872ae4D06D106C5167D8C4b806DD558359b2;
    address public LP = 0xffa7B8814DcB62e83C949d0D1D3576cDC3Bf2eCd;
    ...
    Taxes public taxes = Taxes(0,4,12,2);
    Taxes public sellTaxes = Taxes(0,4,12,2);
