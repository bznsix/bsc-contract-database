...
contract rapTokenSale {
    address public admin; // Make admin variable public
    RapToken public tokenContract;
    uint256 public tokenPrice;
    uint256 public tokensSold;

    event Sell(address _buyer, uint256 _amount);

    constructor(RapToken _tokenContract, uint256 _tokenPrice) {
        admin = msg.sender;
    ...
    function buyTokens(uint256 _numberOfTokens) public payable {
        require(msg.value == multiply(_numberOfTokens, tokenPrice), "Incorrect value");
...
contract RapToken is ERC20, Ownable {
