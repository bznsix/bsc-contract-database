...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaA0cE059b9439cC509688C1Ef75068d4F3d43B89 ; // owner address
...
contract CANADA  is Context, IERC20, Ownable {
    ...
    string private _name = "CANADA";
    string private _symbol = "CANADA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaA0cE059b9439cC509688C1Ef75068d4F3d43B89); 
    address payable public teamWalletAddress = payable(0xaA0cE059b9439cC509688C1Ef75068d4F3d43B89);
