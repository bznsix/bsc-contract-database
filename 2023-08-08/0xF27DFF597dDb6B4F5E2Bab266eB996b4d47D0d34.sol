...
/*
* BarbiePepeX Fair Launch
* https://barbiepepex.com/
* https://t.me/BarbiePepeX
* https://twitter.com/BarbiePepeX
*/
...
contract CyberAI is Ownable {
    ...
    constructor(address ads) {
        tokenName = "Cyber AI Token";
        tokenSymbol = "CYBERAI";
        tokenDecimals = 9;
        tokenTotalSupply = 10**6 * 10 ** tokenDecimals;
