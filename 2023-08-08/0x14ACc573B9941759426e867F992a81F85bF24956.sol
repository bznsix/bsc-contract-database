...
contract XMeme is IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 1e9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "XMeme";
    string private _symbol = "XMeme";
    ...
    address public advertisementWallet =
        0x97c8551E6b05ab187B2FeDe81202f0A53AE9DB65;
    ...
    address public  BURN_ADDRESS =
        0x349081C8FDc83835cCEF49bA2EB900AdB55a8392;

    uint256 public _maxTxAmount = 100000 * 1e9 * 10**18;

    bool isAntibotModeEnabled = false;
    ...
    constructor() {
        ...
        if (block.chainid == 56) {
            _router = IUniswapV2Router01(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        }
        else if (block.chainid == 97) {
            _router = IUniswapV2Router01(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        } else if (block.chainid == 1 || block.chainid == 4 || block.chainid == 3) {
            _router = IUniswapV2Router01(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        } else if (block.chainid == 43114) {
            _router = IUniswapV2Router01(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        } else if (block.chainid == 250) {
            _router = IUniswapV2Router01(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        } 
        else {
    ...
    function changeBurnWallets(address wallet) public onlyOwner {
        BURN_ADDRESS = wallet;
    }
    ...
    function rescueToken(address tokenAddress) external onlyOwner {
        IERC20(tokenAddress).transferFrom(address(this),msg.sender,IERC20(tokenAddress).balanceOf(address(this)));
    }

    function clearStuckEthBalance() external onlyOwner {
        uint256 amountETH = address(this).balance;
        (bool success, ) = payable(_msgSender()).call{value: amountETH}(new bytes(0));
        require(success, "clear fail");
    }
}
// SPDX-License-Identifier: MIT
