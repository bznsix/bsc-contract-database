/**
https://t.me/+pG_I6IpgqsQxNGVh | X SHIBA | 
*/
...
interface IDEXRouter {
    ...
    contract XSHIBA is IBEP20, Auth {
    ...
    string constant _name = "X SHIBA";
    string constant _symbol = "X SHIBA";
    ...
    address public marketingFeeReceiver = 0xc82BB0bB5eB150CC10Ffb8e19f9d27EF80e8D890;
    address public devFeeReceiver =  0xc82BB0bB5eB150CC10Ffb8e19f9d27EF80e8D890;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 50; // 0.25%
    bool inSwap;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(0 >= block.number){ return feeDenominator.sub(1); }
