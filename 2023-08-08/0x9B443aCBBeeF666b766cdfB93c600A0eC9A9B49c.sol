/*
TELEGRAM:https://t.me/bnbxmixer_portal 
TWITTER:https://twitter.com/bnbxmixer
WEBSITE:https://www.bnbmixer.network
BOT:@BnbX_Mixer_bot
*/
...
contract BnbXMixer is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2000000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 20000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 20000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 20000000000 * 10**_decimals;

    address public marketingAddress = 0xD339bCAfd26eE2F08d1444665671086fF5AD7BE3;
    address public devAddress = 0xD339bCAfd26eE2F08d1444665671086fF5AD7BE3;

    string private constant _name = unicode"Bnb𝕏 Mi𝕏er";
    string private constant _symbol = unicode"BMi𝕏er";
