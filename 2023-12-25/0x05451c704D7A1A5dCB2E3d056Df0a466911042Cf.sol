...
contract GROKWOMAN is ERC20, Ownable {
    ...
    constructor () ERC20("Grok Woman", "GROKWOMAN") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x545b80D2198e5021b9F4f1DFd122F6CE5D49d284);
        ...
        marketingWallet = 0x03A89175B964E59410B906F7F341F4f8D01E8D0C;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy <= 9, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_totalFeesOnSell <= 9, "Total Fees cannot exceed the maximum");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 9, "Wallet to Wallet Transfer Fee cannot exceed the maximum");
