...
contract GROKSHIB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0AA3e7FFbfB7123a599f5ea3c7aeE27F03d5EFD9); // Marketing Address
    address payable public marketingAddress1 = payable(0xAd1A2474915eA7D958633e8c1072A7908E257825);
    ...
    uint256 public market1 = 7;
    uint256 public market2 = 1;
    uint256 public totalMarket = market1.add(market2);
    uint256 public minimumTokensBeforeSwap = 1*10**9 * 10**18;
