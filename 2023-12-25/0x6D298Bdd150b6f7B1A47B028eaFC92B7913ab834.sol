...
contract BaseToken is IERC20, Context {
        ...
        onlyOwner
    {
        ...
        require(_buyFundFee + _buyBurnFee + _buyLPFee + _sellFundFee + _sellLPFee + _sellBurnFee > 0, "fee must > 0");
    }
...
contract FeeTokenV2Sniper is BaseToken {
    bool private _inSwapAndLiquify;

    TokenDistributor public tokenDistributor;

    event FailedSwap(uint256 _id); //0x83644ada
