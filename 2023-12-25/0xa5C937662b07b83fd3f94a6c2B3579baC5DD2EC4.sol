...
contract GrokFund is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xb1d19Ed2C19405d1de427F5bDF9387fE05fa3138);

    string public _name = "Grok Fund";
    string public _symbol = "GrokFund";
