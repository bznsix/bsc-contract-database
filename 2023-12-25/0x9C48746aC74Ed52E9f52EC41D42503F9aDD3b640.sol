...
/**
 TELEGRAM :https://t.me/OriginSynch
 WEBSITE  :https://originsync.org
...
contract OriginSynch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Origin Synch";
    string private _symbol = "ORSYNCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xEF73D83f6C0FbD5BBadb94b2409b8A2Fd3640B03);
    ...
    uint256 private minimumTokensBeforeSwap = 15000 * 10**_decimals;
