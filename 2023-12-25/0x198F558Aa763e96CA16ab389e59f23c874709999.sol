...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    uint256 public _feeMarket = 5;

    mapping(address => bool) public _blackList;
    address public _projectorAddress;

    constructor() {
        _projectorAddress = 0x8e5CA0Ca6A0e1f398F63F20eDD979e35dCcB6567;
        _marketAddr = 0xD9ce1c6812066e721616349976a910a60914D14e;
        address router;
//        if(block.chainid == 56) {
...
*/
        ...
        _tOwned[_projectorAddress] =  50000000* (10**uint256(_decimals));
        _tOwned[address(this)] = 160000000* (10**uint256(_decimals));
