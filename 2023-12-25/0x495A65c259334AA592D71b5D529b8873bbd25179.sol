...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private constant _buyFundFee = 0;
    uint256 private constant _buyFundFee2 = 0;
    uint256 private constant _buyDestroyFee = 200;
    uint256 private constant _sellFundFee = 0;
    uint256 private constant _sellFundFee2 = 0;
    ...
    constructor (
        ...
        _feeWhiteList[address(0xAE693dA0FabD857B5bE6d473Ff8EB54d0407E4c6)] = true;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                swapAmount = tAmount * (_buyFundFee + _buyFundFee2) / 10000;
                destroyAmount = tAmount * _buyDestroyFee / 10000;
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                swapAmount = tAmount * (_sellFundFee + _sellFundFee2) / 10000;
                destroyAmount = tAmount * _buyDestroyFee / 10000;
            }
            if (block.number < startTradeBlock + _preFeeDuration) {
                swapAmount = swapAmount * 5;
                destroyAmount = destroyAmount * 5;
            }
            if (destroyAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 fundBalance = balance * fundFee / (fundFee + fundFee2);
        if (fundBalance > 0) {
            payable(fundAddress).transfer(fundBalance);
        }
        fundBalance = balance - fundBalance;
        if (fundBalance > 0) {
    ...
    uint256 public _airdropBNB = 4 ether / 1000;
    ...
    uint256 private constant _rebaseDuration = 24 hours;
...
contract SAT is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0xAE693dA0FabD857B5bE6d473Ff8EB54d0407E4c6),
        address(0xAE693dA0FabD857B5bE6d473Ff8EB54d0407E4c6),
        address(0xAE693dA0FabD857B5bE6d473Ff8EB54d0407E4c6)
    ){
