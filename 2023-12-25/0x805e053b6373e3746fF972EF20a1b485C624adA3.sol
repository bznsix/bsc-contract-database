...
contract SANTAELON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xebb366cf74397BE8B3E40D86514eE85B9F8e32F6); 
    address payable public Wallet_Dev = payable(0xebb366cf74397BE8B3E40D86514eE85B9F8e32F6);
    address payable public constant Wallet_Burn = payable(0xebb366cf74397BE8B3E40D86514eE85B9F8e32F6); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "Santa Elon"; 
    string private constant _symbol = unicode"SANTAELON"; 
    ...
    constructor () {
        _owner =0x5644402Bb5A39b88a9ef7Cd7cBc7400472c7DE31;
