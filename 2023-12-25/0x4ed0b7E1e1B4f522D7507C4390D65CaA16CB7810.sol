/**
Telegram: https://t.me/Grinch_BSC
Twitter: https://x.com/TheGrinch_BSC
*/
...
contract TheGrinch is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 20000000 * 10**_decimals; //2% from supply
    ...
    constructor() {
        ...
        marketingWallet = payable(0x34080fCeA6277f5BA911fa72B70721fefCae943E);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x34080fCeA6277f5BA911fa72B70721fefCae943E] = true;
