...
contract AlitaInu is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xbC3A2ba94741B9A7Ab7B61f28FbCcEf18B5377D2);

    string public _name = "Alita Inu";
    string public _symbol = "AlitaInu";
