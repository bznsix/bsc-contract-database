        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x6fcc2F56B6cC6db4b5512A6472F435609748A5A5), block.timestamp
                );
            }
        }
    }
...
contract Bnuwax is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x6fcc2F56B6cC6db4b5512A6472F435609748A5A5),//FundAddress
        address(0x6fcc2F56B6cC6db4b5512A6472F435609748A5A5)//ReceiveAddress
    ){
    }
}