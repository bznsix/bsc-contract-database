...
/* 
BoredNaki: The Chill Side of Memecoins on the Binance Smart Chain. 🐶🥱
Drift through the crypto space with our laid-back token. We've got a 5% tax on buys and sells, 
but hey, it's for keeping our community stable and kinda growing. Find us yawning on Twitter https://twitter.com/BoredNaki, 
lounging in our Telegram https://t.me/BoredNakiPortal, 
and occasionally updating our website https://www.borednaki.com/ – when we're not too bored, of course. 😴💤 #BoredNaki #RelaxedCrypto
*/
...
contract BoredNaki is BEP20, Ownable {
    ...
    address public marketingWallet = (0xCb7dc1aC7e61714555eD6d0b4e29110fA034a436);
    address public developmentWallet = (0xe30e6275a7608b16810346189C8Ec714dBf907A5);
   ...
   //event
    ...
    constructor() BEP20("Bored Naki", "NAKI") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= swapTokens) {
            ...
            uint256 marketing1Amt = unitBalance * 2 * swapTaxes.marketing;
            if (marketing1Amt > 0) {
                payable(marketingWallet).sendValue(marketing1Amt);
            }
            
            uint256 marketing2Amt = unitBalance * 2 * swapTaxes.development;
             if (marketing2Amt > 0) {
                payable(developmentWallet).sendValue(marketing2Amt);
            }
   ...
   function recoverERC20FromContract(address _tokenAddy, uint256 _amount) external onlyOwner {
    ...
    function recoverETHfromContract() external {
        ...
        payable(address(developmentWallet)).transfer(contractETHBalance);
