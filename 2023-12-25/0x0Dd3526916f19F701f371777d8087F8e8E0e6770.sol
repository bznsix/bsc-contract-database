...
contract Fruits_Christmas is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x8A50360f1C67Fdd783509aa202363A4F6FBBEe47);

    string public _name = "FRUITS CHRISTMAS";
    string public _symbol = "FCS";
