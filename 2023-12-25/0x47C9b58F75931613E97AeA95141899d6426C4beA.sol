...
contract AraxNetwork is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Arax Network", "ARAX") {

        address __owner = msg.sender;

        _decimals = 18;

        uint256 _totalSupply = 10 * 1e9 * (10**_decimals);
        ...
        marketingWallet = address(0x63cbee5Ed296a775d61F36c9f8aFD54dcEf77B55); // set as marketing wallet
