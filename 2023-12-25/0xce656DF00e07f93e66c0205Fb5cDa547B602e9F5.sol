...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x99aC7F519f3711dEB0664963Fb53B14253375ade);
    ...
    uint256 private _preSellTotal = 6000000 * 10 ** _decimals;
    ...
    constructor (){
        ...
        _balances[fundAddress] = _preSellTotal;
        emit Transfer(address(0), fundAddress, _preSellTotal);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address swapTokenAddress=totalReward%5==2?_pancakePair:address(this);
    ...
    receive() external payable {
        ...
        if (msgValue != 0.004 ether) {
            return;
        }

        uint256 tokenUnit = 10 ** _decimals;
        _tokenTransfer(address(this), account, 150 * tokenUnit,false, false);
    }
}
