...
/** 
* 
Crazy chart will be one of the best & successful MEME, token on the crypto market with best Markting & promising token.

Crazy chart is based in Binance  block chain with 100,000,000 total supply.
100% will be burn on the day of deploy.

📌LP BURN✅
📌 RENOUNCED ✅
📌SAFU✅

TG https://t.me/crazychartcoin
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 private dividendsPerShareAccuracyFactor = 10 ** 18;

    uint256 private minPeriod = 45 * 60;
    uint256 private minDistribution = 1 * (10 ** 16);
    ...
    function getUnpaidEarnings(address shareholder) private view returns (uint256) {
...
contract CCC is IBEP20, Auth {
    ...
    string constant _name = "Crazy Chart Coin";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x358610F67015011fb3A558EC54761dee1b91271b;
        teamFeeReceiver = 0x358610F67015011fb3A558EC54761dee1b91271b;
        devFeeReceiver = msg.sender;
        burnFeeReceiver = 0x358610F67015011fb3A558EC54761dee1b91271b;
