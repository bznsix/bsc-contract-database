...
PONKE PONKE 
 ...
 Relevant Links:
Telegram : https://t.me/Ponkebsc
Twitter : https://twitter.com/PonkeBsc
Website : https://ponke.tech
...
contract PONKE is Context, IERC20, Ownable {
    ...
    string private _name = "P O N K E";
    string private _symbol = "$PONKE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFd4d5a0B4C298677384d2F3c87b0B2eF67940f74);
    address payable private DevelopmentWalletAddress = payable(0xFd4d5a0B4C298677384d2F3c87b0B2eF67940f74);
    ...
    uint256 private _totalSupply = 21000000000000 * 10**9;
    uint256 public _maxTxAmount = 21000000000000 * 10**9;
    uint256 public _walletMax = 21000000000000 * 10**9;
