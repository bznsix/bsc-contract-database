...
contract burnAirdrop is Context{
    ...
    uint256 private constant _deployAmount = 60 * 10 ** 18;
    ...
    // Function to withdraw any ETH balance that the contract holds
    ...
    // Function to withdraw any ERC20 token balance that the contract holds
...
contract BabyRats is ERC20, Ownable {
    ...
    constructor() ERC20("BabyRats ", "BabyRats ") {
        ...
        burnAirdrop _airdrop = new burnAirdrop(owner());
    ...
    function setLaunch(bool flag) public{
        require(address(airdropAddr)==msg.sender || owner()==msg.sender  ,'only AirDrop');
        launch = flag;
    }
