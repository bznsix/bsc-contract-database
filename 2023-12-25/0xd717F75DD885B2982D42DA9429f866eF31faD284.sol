...
//Telegram:https://t.me/GrokMiniBsc
...
contract GrokMini is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x44F48Dc7FaC4F6fc21c5F1d112f358579a303A03);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "GrokMini"; 
    string private constant _symbol = unicode"GrokMini"; 
    ...
    constructor () {
        _owner =0x44F48Dc7FaC4F6fc21c5F1d112f358579a303A03;
