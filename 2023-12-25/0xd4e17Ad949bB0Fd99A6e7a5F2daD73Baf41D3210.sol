...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20 (0xBe96fcF736AD906b1821Ef74A0e4e346C74e6221); //NIX
...
contract WinZone is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WinZone";
    string constant _symbol = "WZM";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xBe96fcF736AD906b1821Ef74A0e4e346C74e6221; // NIX
...
uint256 liquidityTransferFee = 0;
    ...
    uint256 public swapThreshold = _totalSupply * 2 /400000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x6E7343b266E450Ba3c5edF5C08504A311198368D;  //marketingwallet
        teamWallet = 0x6E7343b266E450Ba3c5edF5C08504A311198368D; //backup wallet
