...
contract SPACEDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x28cB0c0D5D93f547D1Fce0c191c2E3AA42fdae44); 
    address payable public Wallet_Dev = payable(0xdd6b73AC00601584F8A2BA25625fa4426144d719);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SPACE DOGE"; 
    ...
    constructor () {
        _owner = 0xdd6b73AC00601584F8A2BA25625fa4426144d719;
