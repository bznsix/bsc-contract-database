...
// telegram : https://t.me/virginmarybsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17bfdC4ff1132A325e0293e250FA17beF0Ac61cC ; // owner address
...
contract VirginMary  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VirginMary";
    string private _symbol = "VRGMRY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17bfdC4ff1132A325e0293e250FA17beF0Ac61cC); 
    address payable public teamWalletAddress = payable(0x17bfdC4ff1132A325e0293e250FA17beF0Ac61cC);
    ...
    uint256 public _totalDistributionShares = 36;
