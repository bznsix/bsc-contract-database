...
contract BridgeRecolor is SwapRecolor, Ownable {
    ...
    uint16 public userRewardBps = 9; // 9 bps reward to user
    uint16 public toleranceBps = 10;

    constructor(address _lp, uint32 _color, address _recolorHelper, address _usdv) SwapRecolor(_recolorHelper, _usdv) {
        lp = IToUSDVLp(_lp);
        color = _color;
    }
