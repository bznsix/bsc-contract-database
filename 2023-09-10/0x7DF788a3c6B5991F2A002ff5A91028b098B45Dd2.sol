...
//TELEGRAM: https://t.me/coinmoonshotbsc
...
contract CoinMoonShot is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 3000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 3000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 3000000000 * 10**_decimals;

    address public marketingAddress = 0x8842c612501C72A537FCb10Ca15cAB472CA56014;
    address public devAddress = 0x8842c612501C72A537FCb10Ca15cAB472CA56014;

    string private constant _name = "Coin Moon Shot";
    ...
    Taxes public taxes = Taxes(1,0,8,0);
    Taxes public sellTaxes = Taxes(1,0,19,0);
