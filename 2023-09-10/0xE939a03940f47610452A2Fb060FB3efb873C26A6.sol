...
contract Manilla is IERC20Metadata, Ownable {
    ...
    */
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowancee(address spender, uint256 addedValue) public virtual returns (bool) {
        address owner = _msgSender();
     ...
     * `subtractedValue`.
     */
    function decreaseAllowancee(address spender, uint256 subtractedValue) public virtual returns (bool) {
        address owner = _msgSender();
