...
contract RATSINU is ERC20, Ownable {
    ...
    constructor() payable ERC20("RATS INU", "RATSInu") {
        rewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // BNB
        ...
        marketingWallet = 0xFD96dfbe4C87b6a6241e51e42f7783b74f749b4d;

        dividendTracker = new DividendTracker(100 * 10 ** 5, rewardToken);
    ...
    function _transfer(
        ...
        if (
            ...
            if (burnFeeOnBuy + burnFeeOnSell > 0) {
                burnTokens =
                    (contractTokenBalance * (burnFeeOnBuy + burnFeeOnSell)) /
                    100;
            ...
            if (contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if ((marketingFeeOnBuy + marketingFeeOnSell) > 0) {
                    uint256 marketingBNB = (newBalance *
                        (marketingFeeOnBuy + marketingFeeOnSell)) / bnbShare;
