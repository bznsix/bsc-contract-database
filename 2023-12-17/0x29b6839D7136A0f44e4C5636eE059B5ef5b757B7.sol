...
contract PP is IERC20, Ownable {
    ...
    uint256 public _buyRewardFee = 390;

    uint256 public _sellFundFee = 390;
    ...
    constructor() {
        ...
        fundAddress = address(0x82f7763Fa4cAF54A0736589d80Ed97c39B760230);
        _swapRouter = ISwapRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        address ReceiveAddress = address(0xce4F35837510Dff67B1f0A11DD336661381a40Af);
        _owner = msg.sender;
