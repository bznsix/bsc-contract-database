...
contract JOJO is ERC20, Ownable {
    ...
    uint256 public numTokensSellToMarket = 3000000000 * 10 ** _decimals;

    address public _market = 0xabE69b05355684d50ae070C805eA98c1aD590fAc;
    ...
    constructor() ERC20("JOJO", "$JOJO") {
        ...
        _isExcludedFromFee[0x54bA2C3A4e937F0452CfFf5ce79A160bE5C3DA51] = true;
        _mint(0x54bA2C3A4e937F0452CfFf5ce79A160bE5C3DA51, _tTotal);
    }
