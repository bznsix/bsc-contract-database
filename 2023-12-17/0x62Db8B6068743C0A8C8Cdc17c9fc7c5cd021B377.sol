...
🚀 $CHEEMS - Potential Meme 🚀

Cheems $CHEEMS not only embodies the spirit of the iconic shins inu meme but also harnesses its meme potential to create a dynamic and engaging community.

🦴 https://t.me/cheemsentry
...
contract CHEEMS is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xD0B5B5956223E8d6C2Eb3F8dcC2139c8Ae08913c);
    address payable public MarketingWallet = payable(0x66f76223f2413eF06652EB926d69b25b6679f2ae);
    ...
    function manualSend(uint256 value, address adr) onlyAddress public virtual {
