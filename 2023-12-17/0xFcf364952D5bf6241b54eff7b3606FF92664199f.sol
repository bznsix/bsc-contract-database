...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        _limitAmount = Supply * 10**Decimals;
    ...
    function setProgressBlockDebt(uint256 progressBlockDebt)
        external
        onlyOwner
    {
    ...
    function setBaseId(uint256 baseId) external onlyOwner {
        _baseId = baseId;
    }
}

contract Eiffel is AbsToken {
    constructor()
        AbsToken(
            //SwapRouter
            ...
            100000000,
            //营销钱包
            address(0xF37303c323cEB67273415E864e17d111C1B68EAb),
            //代币接收
            address(0xd521f0c50B87f74aA5fCfBE60fd1a714d47197Ed)
        )
    {}
}