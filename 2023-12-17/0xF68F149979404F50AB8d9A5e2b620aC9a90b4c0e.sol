// CATOKEN ($CATOKEN) is the most hyped and safe meme token. While dogs and frogs take a back seat, CATOKEN is ready to pounce!
// It's high time for cats which are already a staple in our homes. Who even keeps a frog as a pet anyway?
// Telegram : https://t.me/CATOKENPortal
// Website : https://catoken.org/
// Twitter : https://twitter.com/CATOKEN_
...
contract CATOKEN is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0xD984152af9e9Eb764f21d182063C9EDbABfa7bC5);

    address public devWallet =
        address(0xF44F2c32bcb229D338576D37Ab7c7BB39746432D);
    ...
    uint256 private marketingAmount = 50; //
    uint256 private devAmount = 50; //
    ...
    constructor() ERC20("CATOKEN", "CATOKEN") {
    ...
    // remove limits after token is stable (remove limits of maxTransactionAmount and maxWallet )
    ...
    function updateMarketAndDevWalletAdress(
