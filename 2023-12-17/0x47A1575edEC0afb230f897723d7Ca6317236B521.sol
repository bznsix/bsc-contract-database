...
contract TEDDYGROK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "(Teddy Grok)";
    string private _symbol = "$TGROK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xBbe78Cee06f994C99f3A94B59C6078a11E93c8Fd);
    address payable private DevelopmentWalletAddress = payable(0xC1D125cA248b1c95115877576ed6de5cd459eb38);
    ...
    uint256 private _totalSupply = 420000* 10**9;
    uint256 public _maxTxAmount = 12600 * 10**9;
    uint256 public _walletMax = 12600 * 10**9;
