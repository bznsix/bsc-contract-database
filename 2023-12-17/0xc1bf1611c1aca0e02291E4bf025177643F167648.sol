...
contract TSTS is IERC20, Ownable {
    ...
    uint256 public _buyRewardFee = 600;
    ...
    constructor() {
        ...
        _symbol = "TSTS";
        _decimals = 18;
        _tTotal = 210_000_000 * 10**_decimals;

        fundAddress = address(0xf0a474aF5F55984384C707dB6b8D7914133C49bb);
        _swapRouter = ISwapRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        address ReceiveAddress = address(0xBE17fccD64F46E229a17618Aec2038fB489A45c5);
        _owner = msg.sender;
