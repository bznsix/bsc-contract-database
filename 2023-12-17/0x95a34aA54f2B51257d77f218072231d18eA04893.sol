...
contract TheterX is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0xD1f3b959d51cBd7f9926ed85D40818d643fDF67F;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[pinkLock] = true; //pinklock

        _mint(owner(), 40e6 * (10 ** decimals()));
