/*
❄️*zzz*OLANA❄️   ▶️  $zOLANA

☀️For the BNB enjoyer
#Renounced  #1/1Tax  #lpLocked  #Bonk

☀️ For all the Binance enjoyers who are waiting for a never-to-arrive Binance chain-shitcoin-cycle.
☀️Let's make this one to remember


✔️🌐 https://t.me/zzzOLANA
✔️🌐  https://twitter.com/zzzOLANA
✔️🌐  https://www.zzolana.com
*/
...
contract zOLANA is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "*zzz*OLANA";
    string private _symbol = "zOLANA";
    string public constant zOLANAChat = "https://t.me/zzzOLANA";
