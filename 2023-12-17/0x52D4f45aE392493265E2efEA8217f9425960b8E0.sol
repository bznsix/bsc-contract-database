// YANG MANUSIA JANGAN BELI
// YANG BISA BACA JANGAN BELI
// INI CUMA BUAT NANGKEPIN DOANK
// GAK ADA REFUND 
// BACA WOI BACAAAAAAAA
// JANGAN DI BELI KALO LO BISA BACA
...
contract BACAWOI is ERC20, Ownable {
    ...
    constructor() ERC20("CONTEK AJA TRUS", "CONTEK") {
        ...
        maxTransactionAmount = 50 * 1e13 * 1e18; 
        maxWallet = 50 * 1e13 * 1e18; 
        ...
        devWallet = address(0x04EC322bA8f0b044C40B7528203DDBf48B38A168); 
        ...
        returns (bool)
    {
        ...
        require(
            newAmount <= (totalSupply() * 50) / 100,
            "Swap amount cannot be higher than 50% total supply."
        );
