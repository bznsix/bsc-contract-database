...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3aE08Af4987F9ad0c351c52985DC09FD1b206B78; // owner address
...
contract PAPAGROK is Context, IERC20, Ownable {
    ...
    string private _symbol = "$PGROK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x492a3cc7ac79567f9f64eC9755658d6D377fc440); 
    address payable public teamWalletAddress = payable(0x492a3cc7ac79567f9f64eC9755658d6D377fc440);
