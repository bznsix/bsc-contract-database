...
contract YlangGrctoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YlangGrc";
    string private _symbol = "YLANGGRC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCFAf8336958b983A0E6F8C3aF95430EB5CadfbbE); // Marketing Address
    address payable public teamWalletAddress = payable(0xCFAf8336958b983A0E6F8C3aF95430EB5CadfbbE); // Team Address
