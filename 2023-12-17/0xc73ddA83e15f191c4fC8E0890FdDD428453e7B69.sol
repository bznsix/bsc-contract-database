...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB41357e7c9BE35d1e0feF05d736c72c0d99a69B1; // owner address
...
contract BONKGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonk Grow";
    string private _symbol = "$BG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB41357e7c9BE35d1e0feF05d736c72c0d99a69B1); // Marketing Address
    address payable private teamWalletAddress = payable(0xB41357e7c9BE35d1e0feF05d736c72c0d99a69B1); // Team Address
