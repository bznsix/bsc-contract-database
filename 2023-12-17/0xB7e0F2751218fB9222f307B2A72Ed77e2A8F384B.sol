// https://t.me/bnbBonkInu
// https://x.com/bonk_inu_bsc
// https://bonkinubnb.com/
...
contract BonkInu is ERC20, Ownable {
    ...
    constructor () ERC20("Bonk Inu", "Bonkinu")
    {  
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x4a35942C12b7Ce3dfdC2Ea7af0a2A755429feEeb;
