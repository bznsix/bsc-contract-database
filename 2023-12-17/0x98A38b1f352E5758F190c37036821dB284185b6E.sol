...
contract wedy is IERC20, Ownable {
    struct UserInfo {
        uint256 lpAmount;
        bool preLP;
    }
    ...
    uint256 public _buyFundDestroyFee = 50;
    ...
    uint256  public  _sellDestoryFee = 50;
    uint256  public _sellFundDestroyFee = 50;
    ...
    address ReceiveAddress = address(0xcA964bDACD71Fa668F2E4A19Cc2FB1118e448887);
    ...
    address NFTAddress = address(0xeF3d85294C46B2832663650A544ED96E9389F46F);
    ...
    function _transfer(
        ...
        require(open || _feeWhiteList[from] || !_feeWhiteList[to], "can't send");
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (removeLPLiquidity > 0) {
                ...
                fundFeeAmount  = tAmount * _buyNFTFee / 20000;
                ...
                nftFeeAmount  = tAmount * _sellNFTFee / 20000;
            ...
            if (swapFeeAmount > 0) {
                ...
                _takeTransfer(sender, address(this), swapFeeAmount + fundFeeAmount + fundDestoryAmount + nftFeeAmount);
            }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalSwapFee = fundFee + fundDestroyFee + _buyLpshareFee + _buyNFTFee;
        ...
        uint256 nftUsdt = usdtBalance * _buyNFTFee / totalSwapFee;
        if (fundDestroyUsdt > 0) {
            USDT.transfer(NFTAddress, nftUsdt);
        }
    }
    ...
    function setOpen(bool enable) public onlyOwner {
        open = enable;
    }
