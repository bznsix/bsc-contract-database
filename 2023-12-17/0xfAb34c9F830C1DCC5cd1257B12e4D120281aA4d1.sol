...
⭐️ Galoy ⭐️
Bitcoin-native banking infrastructure powering ⚡️ payments, wallets and banks. 

💲 Welcome to Bitcoin-native
...
✖️ Twitter-X: https://twitter.com/galoymoney
✈️ Community: https://t.me/BitcoinForCommunities
🛒 Dashboard: https://galoy.io/
⚡️Chat Galoy https://chat.galoy.io/
✅ Audit: https://github.com/GaloyMoney
*/
...
contract GaloyToken is GaloyDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GaloyTeam;
    address private CharityGaloy;
    ...
    string public override name = "Galoy";
    string public override symbol = "Galoy";
    ...
    constructor(uint totalSupplyValue, address GaloyTeamAddress, address CharityGaloyAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GaloyTeam = GaloyTeamAddress;
        CharityGaloy = CharityGaloyAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GaloyTeam] =  totalSupply * 1 / 100;
        balances[CharityGaloy] = totalSupply * 1 / 100;
    ...
    // Get the address of the token's GaloyTeam pot
