...
contract SPACECAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xac22d6877fAde4C4dE730698d05a54FD8Ca18517); 
    address payable public Wallet_Dev = payable(0x47b3AA8d61cC060e746FdCF6C882Ea5a78e58A27);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SPACE CAT "; 
    ...
    constructor () {
        _owner = 0x47b3AA8d61cC060e746FdCF6C882Ea5a78e58A27;
