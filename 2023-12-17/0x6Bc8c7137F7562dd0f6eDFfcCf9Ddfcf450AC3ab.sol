...
contract sun is StandardToken, BurnableToken, Ownable {
 
    string  public constant name = "齐天大圣孙悟空";
    string  public constant symbol = "孙悟空";
    uint8   public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY      = 210000000000  * (10 ** uint256(decimals));
    uint256 public constant FREE_SUPPLY         = 170000000000  * (10 ** uint256(decimals));
