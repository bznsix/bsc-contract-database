/*
0xyield
On-chain lending without the need for collateral,
maximizing capital efficiency for borrowers while also enabling lenders to earn competitive interest rates.
https://t.me/Oxyieldchannel

On-chain lending without the need for collateral,
maximizing capital efficiency for borrowers while also enabling lenders to earn competitive interest rates.
https://www.0xyield.xyz/
*/
...
contract Oxyield is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "0xyield";
    string private _symbol = "0xyield";
    string public constant OxyieldWebsite = "https://www.0xyield.xyz/";
