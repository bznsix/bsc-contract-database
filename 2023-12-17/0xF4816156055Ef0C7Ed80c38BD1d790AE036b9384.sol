...
contract PowPepeERC20 is ERC20 {
    ...
    function mine(uint256 nonce) public payable {
        ...
        require(msg.value >= 0.04269 ether);
        managerAddress.call{value : msg.value}("");
...
contract POPE is PowPepeERC20 {
    constructor() PowPepeERC20("PoWPepe", "POPE", 69420, 18, 10, 10, 1, address(0x66387601134E414D4BeCFAD9964A69000c852c7C)) {}
}