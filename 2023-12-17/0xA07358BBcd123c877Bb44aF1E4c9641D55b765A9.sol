...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7219Ae69A2Ad2BB961D23931687C205D0CD24d92; // owner address
...
contract StakerAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StakerAI";
    string private _symbol = "$STAKER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7219Ae69A2Ad2BB961D23931687C205D0CD24d92); // Marketing Address
    address payable private teamWalletAddress = payable(0x7219Ae69A2Ad2BB961D23931687C205D0CD24d92); // Team Address
