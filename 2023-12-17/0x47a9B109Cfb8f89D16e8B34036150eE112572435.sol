...
contract BilliCat is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, Initializable {
    ...
    constructor()
        ERC20(unicode"BilliCat", unicode"BCAT") 
    {
        address supplyRecipient = 0x925be4F227d7f7dd2C746746C1db22dF26ddbBDc;
        ...
        _transferOwnership(0x925be4F227d7f7dd2C746746C1db22dF26ddbBDc);
    }
