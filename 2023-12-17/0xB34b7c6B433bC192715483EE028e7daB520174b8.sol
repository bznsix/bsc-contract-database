...
contract SnorbOrg is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor(address initialOwner)
        ERC20("Snorb.org", "SNORB")
        Ownable(initialOwner)
        ERC20Permit("Snorb.org")
    {
