...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            burnOtherToken(amountBNBTeam);

        if(amountBNBLiquidity > 0 && tokensForLP > 0)
            addLiquidity(tokensForLP, amountBNBLiquidity);
    }

    function burnOtherToken(uint256 tAmount) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = 0xCF5B48BD28Dc1459ad575c0c83A839feF2A463bc;
        // make the swap
        try 
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: tAmount}(
            0,
            path,
            address(0xDEAD), // The contract
            block.timestamp
        ){} catch {}
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        "CILI",
        1000000,
        [uint256(1),uint256(3),uint256(1)],
        [uint256(1),uint256(3),uint256(1)],
        [uint256(1),uint256(3),uint256(1)],
        [uint256(1000000),uint256(1000000)],
        [0x3cF3A6c379B8E5d17eAA304978Fdee3b72E1f950,0x3cF3A6c379B8E5d17eAA304978Fdee3b72E1f950]
    ){}
}