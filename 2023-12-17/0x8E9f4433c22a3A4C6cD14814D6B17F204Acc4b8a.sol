...
contract Cosmic is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x2bF4238D9682bFBD0D1A8943464b3474DD4fb941);
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    address constant private liquidityAddress = 0xA03be98084ceF2926Fb0Bbb36c51828242Ed3223;
    ...
    constructor () {
        ...
        balance[0xa360138D2E17F4f45735CdA21C72E5B63F4108ca] = (_totalSupply * 20) / 100;
        balance[0x9003280a501Ea21972294Bc1e6A55fa0a0064815] = (_totalSupply * 10) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 70) / 100);
        emit Transfer(address(0), 0xa360138D2E17F4f45735CdA21C72E5B63F4108ca, (_totalSupply * 20) / 100);
        emit Transfer(address(0), 0x9003280a501Ea21972294Bc1e6A55fa0a0064815, (_totalSupply * 10) / 100);
