/**
"Algorithium; EMPOWERING FINANCIAL SOVEREIGNTY ON LAYER 2."

Within Algorithium's Layer 2 architecture, 
ALG provides exceptional transactional efficiency, allowing for swift confirmations and minimized latency.

Its robust security protocols, derived from advanced encryption and secure transaction frameworks, 
safeguard user data and assets within the network.

Comprehensive Utility Overview;
• Holistic DeFi Ecosystem
• Layer 2 Efficiency
• Algorithm-Driven Crypto Solutions
• Low Fees, High Accessibility
• Interoperability Beyond Boundaries

TELEGRAM: https://t.me/Algorithium
WEBSITE: https://algorithium.io
...
contract Algorithium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Algorithium";
    string private _symbol = "ALG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0xCE27fA5DbE8114ad5f740bB07eFe2A0b7fFE8f28);
    ...
    uint256 private _totalSupply = 350000000 * 10**_decimals;
    uint256 public _maxTxAmount = 3500000 * 10**_decimals;
    uint256 public _walletMax = 7000000 * 10**_decimals;
    ...
    constructor() {
        ...
        //0x10ED43C718714eb63d5aA57B78B54704E256024E PCS MAINNET
