...
contract KOKOToken is ERC20,Ownable {
    ...
    constructor() ERC20("KOKO-BSC","KOKO"){
        lpHolder=0x944030d2eea6E54bf96989ED599599241E4704A6;
        foundationAddress=0x1c36317ff48944CCdb45D5a5D834fEEDd98F86cc;
        ...
        _mint(foundationAddress, 1000000000000000e18);
    ...
    function process() internal  swapping {
        ...
        uint256 labAmount=WETHBalance.div(3);
        
        IERC20(WETH).transfer(labAddress,labAmount);
        IERC20(WETH).transfer(foundationAddress,WETHBalance.sub(labAmount));
    ...
    function setFees(uint8 sell,uint256 buy,bool enable) external onlyOwner{
        sellFee=sell;
        buyFee=buy;
        if(enable&&!enabled){
            enabled=true;
