...
contract TRIPLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TRIPLE", "TRIPLE") {

        address _owner = msg.sender;

        _decimals = 18;

        uint256 totalSupply = 20000000 * (10**_decimals);
        ...
        marketingWallet = address(0xA0ac9f18f7C6E1efD83c726d58017f43AE1D97d5); // set as marketing wallet
