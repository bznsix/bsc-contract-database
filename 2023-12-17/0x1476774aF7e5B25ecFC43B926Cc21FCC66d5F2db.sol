...
contract GrokBoy is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Grok Boy";
    string private _symbol = "GrokBoy";
    uint8 private _decimals = 9;
    uint256 private _supply = 720_000_000_000;
    uint256 public _taxBuyForMarketing = 5;
    uint256 public _taxSellForMarketing = 5;
    address public marketingWallet = 0x932E7468f910Ed0C3BCf7f592c5c2d42FB47AD6c;
    // TOKENOMICS END ============================================================>
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // PCS Router
        }
    ...
    function _transfer(
        ...
        if (
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                if (from == uniswapV2Pair) {
                    _totalFee += _taxBuyForMarketing;
                } else if (to == uniswapV2Pair) {
                    _totalFee += _taxSellForMarketing;
                }

                uint256 marketingShare = ((amount * _totalFee) / 100);
    ...
    function changeThreshold(
        uint256 _numTokensSell
    ) public onlyOwner returns (bool) {
        _numTokensSellToAddToETH = _numTokensSell;
        return true;
    }
