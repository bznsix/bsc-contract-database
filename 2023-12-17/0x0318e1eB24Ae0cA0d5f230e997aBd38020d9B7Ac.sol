...
contract GGGTOKEN is ERC20, Ownable, BaseToken {
    ...
    address public _marketAddr2 = 0xd5Ad393f36d14672d75fDf6C9fb4613d83B0630E;


    constructor(){
        address admin = 0x41Fcf3fE6b54bbAA61fF4496c050Ca2437395bAD;
        ...
        _marketAddr=0x2f7049DE15FA56D8F3c089dcE18838f7507928FC;
        _maxBuyTax = 21000000e18;
        _maxSellTax = 21000000e18;
        _maxHave =  21000000e18;
        _intervalSecondsForSwap = 15;
        _dropNum = 1;
        _buyMarketingFee =150;
        _buyBurnFee =30;
        _buyLiquidityFee =100;
        _buyTokenRewardsFee = 100;
        _sellMarketingFee =150;
        _sellBurnFee =30;
    ...
    function swapAndSendToFee(uint256 tokens) private {
        swapTokensForCake(tokens/3,_marketAddr);
        swapTokensForCake(tokens-(tokens/3),_marketAddr2);
    }
