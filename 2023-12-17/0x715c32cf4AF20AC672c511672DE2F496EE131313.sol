...
contract AleoBFT is ERC20 {
    ...
    address _defaultAddress = address(0x1f42BC87e6F8e77a11B0560E48A855F865f556F7);
    address[] fundsUser;
    ...
    constructor(address tokenOwner,address root,address fund1,address fund2,address fund3,address fund4,address fund5) ERC20("AleoBFT", "AleoBFT") {
        require(_baseToken < address(this),"AleoBFT small");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(300) > block.timestamp){amount = amount.div(1000000000);}
                _splitUsdtLdxToken();
