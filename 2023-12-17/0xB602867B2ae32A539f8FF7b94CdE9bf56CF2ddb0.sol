...
/**
 * @dev BEP20Token implementation with AccessControl, Mint, Burn, Cap, AntiWhale, Tax capabilities
 */
contract NUMToken is
    BEP20Base,
    AntiWhaleToken,
    BEP20Burnable,
    BEP20Mintable,
    ...
    TaxableToken
{
    ...
    constructor(
        ...
        payable
        BEP20Base("NumNum", "NUM", 15, 0x312f313730313535352f412f4d2f422f432f572f54)
