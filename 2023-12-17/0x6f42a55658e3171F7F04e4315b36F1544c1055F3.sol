...
contract ProjectSale is AbstractProjectSale, ReentrancyGuard, Pausable, Ownable {
    ...
    uint8 private constant PUBLIC_ROUND_FEE = 5; // 10%
    ...
    constructor(
        ...
        saleDetails.publicSaleDepositCap = 250000000000000000000;
        ...
        vestingContract = Vesting(0x53E38d6dFD6c2542C531445fA31349A3Ec6932AE);
