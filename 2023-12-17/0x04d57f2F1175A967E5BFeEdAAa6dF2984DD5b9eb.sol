...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setBuy(uint256 newFundFee, uint256 newLpFee) public onlyOwner{
            require(_buyFundFee <= 2000, "Buy Fee cannot be more than 20%");
            require(_buyLPFee <= 2000, "Buy Fee cannot be more than 20%");
        _buyFundFee = newFundFee;
        _buyLPFee = newLpFee;
    }

    function setSell(uint256 newFundFee, uint256 newLpFee) public onlyOwner{
            require(_sellFundFee <= 2000, "Buy Fee cannot be more than 20%");
            require(_sellLPFee <= 2000, "Buy Fee cannot be more than 20%");
...
contract GROKAI is AbsToken {
    constructor() AbsToken(
        ...
        18,
        6900000000,
        address(0x3c00052EbD4b9b456935Af2eC37CA69E41237172),//ReceiveAddress
        address(0x92E4bd9Ddb966365eF4617c07DbC91825787A4EE) //FundAddress
    ){
    }
}