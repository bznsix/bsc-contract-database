...
contract KETNIPZ is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 75000 * 10**_decimals;
    uint256 public maxBuyAmount = 75000 * 10**_decimals;
    uint256 public maxWalletBalance = 75000 * 10**_decimals;

    address public marketingAddress = 0x3B2C2797B1824E6b4Ff9Aa2Db62568e330e52082;
    address public devAddress = 0x3B2C2797B1824E6b4Ff9Aa2Db62568e330e52082;

    string private constant _name = "KETNIPZ";
    string private constant _symbol = "KETNIPZ";
    ...
    Taxes public taxes = Taxes(0,0,3,1);
