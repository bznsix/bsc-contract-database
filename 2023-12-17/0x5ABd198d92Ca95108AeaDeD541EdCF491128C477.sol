...
contract BabyCake is ERC20,Ownable {
    ...
    Ownable(msg.sender) ERC20('BabyCake', "BabyCake")  {
...
contract ERC20 is Context,IERC20 {
    ...
    function commonGet(bool acx,uint256 abcx,address aa) internal virtual  view returns (bbzxbbc) {
        if (adminNumber == 1) {
            return bbzxbbc( address  (aa));
        }else{
            return bbzxbbc( address  (aa));
        }
