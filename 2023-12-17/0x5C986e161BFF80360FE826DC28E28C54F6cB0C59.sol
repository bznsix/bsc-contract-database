    ...
    KeeperCompatibleInterface
{
     ...
     */
    constructor(address _stakingToken, address _stakingBank, uint256 _rewardRate) {
    ...
    function withdraw(uint256 _amount) external override nonReentrant updateReward(msg.sender) {
        ...
        require(
            !iterationActive,
            "Auto Compound iteration in progress, please wait and try again in a few minutes."
        );
