...
//--- Contract v3 ---//
contract GROKolaus is Context, Ownable, IERC20 {
    ...
    string constant private _name = "GROKolaus";
    string constant private _symbol = "$GROKolaus";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x0D3a05E185B8be59BA72676001C9C40042CD61DF);
