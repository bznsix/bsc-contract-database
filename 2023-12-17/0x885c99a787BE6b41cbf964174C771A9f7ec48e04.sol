...
twitter: https://twitter.com/PhoenixToken0
*/
...
contract PhoenixToken is ERC20, Ownable {
    ...
    PhoenixTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Phoenix Token", "PHT") {
        marketingWallet = payable(0x1D282C158038149f703aFb9237842FdD5139abD3);
        devWallet = payable(0xF73CDec6497a643332a88A0cECaC0CAdD1E998B7);
        ...
        dividendTracker = new PhoenixTokenDividendTracker(
            payable(this),
            router,
...
contract PhoenixTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PhoenixToken public PhoenixTokenContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PhoenixTokenContract = PhoenixToken(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PhoenixToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PhoenixToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PhoenixTokenContract);

            uint256 prevBalance = PhoenixTokenContract.balanceOf(address(this));
            ...
            {
                uint256 received = PhoenixTokenContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PhoenixTokenContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
