...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _checkPecReward() private  {
        ...
        uint256 value; 
        value = (balanceOf(address(this))/1e18)*(r0/r1);
        if(value > 200*1e18){
            uint256 rewardGas = _rewardGas;
            processReward(rewardGas, value);
        }
    }
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (!excludeHolder[shareHolder]) {
                ...
                if (lpBalance >= holdCondition) {
                    amount = (rewardCondition * 76 / 100) * lpBalance / holdTokenTotal;
                    if (amount > 0) {
    ...
    function processNftReward(uint256 rAmount) private {
        ...
        for (uint i = 0; i < 500; i++) {
            ...
            address sender = address(this);
            uint256 sendAmount = (rewardCondition * 24 / 100) / 500;
...
contract PECToken is AbsToken {
    constructor() AbsToken( 
        ...
        10,
        10,
        address(0x08b9276705aA0590E7Ac2907Ed6ECddA1Cf3Ca58),
