...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _minimumTokensBeforeSwap = 2024000 * 10**_decimals;
    ...
    function excludeMultipleAccountsLimit(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            isWalletLimitExempt[accounts[i]] = excluded;
        }
    }
