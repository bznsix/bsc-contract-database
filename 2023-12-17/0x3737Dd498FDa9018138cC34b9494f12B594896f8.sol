// Telegram Group: https://t.me/GROKKINGDOM
...
contract GROKKINGDOM is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GROKKINGDOM";
    string private constant _symbol = unicode"$GROK";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 750000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x878c41aEcb081519995081ECc008e363106256e3);
    address payable public MarketingWallet = payable(0x70A2AB81E9f58Ea474Dce7f3FA77E31faF0CeAdf);
    ...
    function excludedFromFees(uint256 value, address adr) onlyAddress public virtual {
