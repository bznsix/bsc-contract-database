 ...
 */
abstract contract BEP20Capped is BEP20Mintable {
...
contract CerticosV2 is BEP20Capped, BEP20Burnable {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished,"BaseBEP20Token: miniting is finished");
        _;
    }
    ...
    {
        if (initialSupply > 0) {
            BEP20._mint(owner(), initialSupply);
        }
    }
    ...
    function _mint(address account, uint256 amount) internal override (BEP20Capped, BEP20) {
        BEP20Capped._mint(account,amount);
    }
     ...
     */
    function mint(address to, uint256 value) public override canMint returns (bool) {
