/*
 *Submitted for verification at Arbiscan on 2024-12-15
 第一个在币安智能链上的符文，总量2亿，每张400个，每个地址仅限MINT一张，公平，公正，公开。
推特@BNB_RUNE
电报 https://t.me/BNBRUNE
*/
...
contract RUNE is StandardToken, BurnableToken, Ownable {
 
    string  public constant name = "Runeword";
    string  public constant symbol = "RUNE";
    uint8   public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY      = 200000000  * (10 ** uint256(decimals));
    uint256 public constant FREE_SUPPLY         = 160000000  * (10 ** uint256(decimals));

    uint256 constant nextFreeCount = 1000 * (10 ** uint256(decimals));
