...
contract NANOCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NANO Coin";
    string private _symbol = "$NANO";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x99d5202935A4Aa787965F7FF8D04A4776a47FacC;
    address public developerWallet = 0x5a2473B4947B1b42B9ed040cf60868F7d4c64a64;
