...
GRONK is here to kill all the meme coins.

Join in the ride for 1000x. 
https://t.me/GronkBep20
...
contract GRONK is Context, IERC20, Ownable {
    ...
    string private _name = "G R O N K";
    string private _symbol = "$GRONK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x678F303772086E3829A2CF5455F7b5ebfb7d3dcA);
    address payable private DevelopmentWalletAddress = payable(0x678F303772086E3829A2CF5455F7b5ebfb7d3dcA);
    ...
    uint256 private _totalSupply = 42000000000 * 10**9;
    uint256 public _maxTxAmount = 42000000000 * 10**9;
    uint256 public _walletMax = 42000000000 * 10**9;
