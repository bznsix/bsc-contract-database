...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6698F20B090587362c2049edf696aeF492Ffeb2e; // owner address
...
contract LADYGROK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LADY GROK";
    string private _symbol = "$LG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6698F20B090587362c2049edf696aeF492Ffeb2e); // Marketing Address
    address payable private teamWalletAddress = payable(0x6698F20B090587362c2049edf696aeF492Ffeb2e); // Team Address
