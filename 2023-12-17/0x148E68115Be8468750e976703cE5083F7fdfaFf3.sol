...
contract JESUSMARYJOSEPH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    JESUSMARYJOSEPHDividendTracker public dividendTracker;
    ...
    constructor() ERC20("JESUSMARY&JOSEPH", "JMJ") {
        marketingWallet = payable(0xc14F9E6AEE0204eA802a9F2CaB99d7c9faE9202e);
        devWallet = payable(0x04C60EDEb5BeC1b6994a78e62ca4D6cF147A1FEC);
        ...
        dividendTracker = new JESUSMARYJOSEPHDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "JESUSMARYJOSEPHTRACKER",
            "JMJTRACKER"
        );
...
contract JESUSMARYJOSEPHDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    JESUSMARYJOSEPH public JESUSMARYJOSEPHContract;
    ...
    constructor(
        ...
        defaultToken = token;
        JESUSMARYJOSEPHContract = JESUSMARYJOSEPH(mainContract);
    ...
    function _transfer(
        ...
        require(false, "JESUSMARYJOSEPH_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "JESUSMARYJOSEPH_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(JESUSMARYJOSEPHContract);

            uint256 prevBalance = JESUSMARYJOSEPHContract.balanceOf(address(this));
            ...
            {
                uint256 received = JESUSMARYJOSEPHContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    JESUSMARYJOSEPHContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
