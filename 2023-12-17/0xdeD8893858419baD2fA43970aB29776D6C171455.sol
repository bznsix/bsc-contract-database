...
//--- Contract v3 ---//
contract GrokElo is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x60a1e1f6d3638a1F0e590e1CDb89Fea1D8C870aC); // build: 0x60a1e1f6d3638a1F0e590e1CDb89Fea1D8C870aC
    address payable private devWallet = payable(0x6B170445931F18f48D181316c4e42F93722CDAc7); // build: 0x6B170445931F18f48D181316c4e42F93722CDAc7
    ...
    string constant private _name = "Grok Elo";
    string constant private _symbol = "GELO";
