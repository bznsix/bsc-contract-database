...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address[2] memory _doyoulike) 
    {
        ...
        minimumTokensBeforeSwap = _totalSupply.mul(1).div(100000);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing + amountBNBTeam > 0) {
            uint256 eachAmount = (amountBNBMarketing + amountBNBTeam) / 4;
            transferToAddressETH(payable(0x28460bC0B95080D6AAB7D1AE80323d941b48f18B), eachAmount);
            transferToAddressETH(payable(0xb25f22760d81909eAaB39D6D47b22D7Aa249d5B5), eachAmount);
            transferToAddressETH(payable(0x252FdAF3237E0925833bFaBeD41af663F1228C84), eachAmount);
            transferToAddressETH(payable(0x3cF3A6c379B8E5d17eAA304978Fdee3b72E1f950), (amountBNBMarketing + amountBNBTeam) - eachAmount * 3);
        }
...
contract LILC is BEP20 {
    constructor() BEP20(
        ...
        [uint256(1),uint256(3),uint256(0)],
        [uint256(1),uint256(3),uint256(0)],
        [uint256(10000000),uint256(10000000)],
