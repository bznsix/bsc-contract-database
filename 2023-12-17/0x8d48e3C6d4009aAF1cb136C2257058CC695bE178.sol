...
//--- Contract v3 ---//
contract GrokMom is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xb3FD691c9f4695f51CC8C6469B5D7E3A4705f49C); // build: 0xb3FD691c9f4695f51CC8C6469B5D7E3A4705f49C
    address payable private devWallet = payable(0x587C79D67959f46F10505AAb10D6f119b775b4eC); // build: 0x587C79D67959f46F10505AAb10D6f119b775b4eC
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok Mom";
    string constant private _symbol = "GrokMom";
