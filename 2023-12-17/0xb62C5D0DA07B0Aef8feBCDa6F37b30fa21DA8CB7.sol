...
contract Bingo is Context, IERC20, Ownable {
    ...
    string private  constant _symbol = unicode"CATBINGOLOLItwillMakeyourichBuysoicanbuyacutecatformywifeThankyoudontworryimdoxxedsoicantrugandineedtodomarketinglolimtrappedhelpme";
