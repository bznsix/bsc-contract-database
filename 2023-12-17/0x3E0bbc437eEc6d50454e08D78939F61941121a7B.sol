 ...
 * 
  ...
  *——————————————————
  *
  * Description: Committed to developing an open source AI algorithm that will bridge gap between AI and Blockchain.
  * Website: https://Pandagbt.com
  * Twitter: https://twitter.com/PandaGBT
  * Telegram: https://t.me/PandaGBTOfficial
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="PandaGBT";
    string private _symbol="PGBT";
    ...
    address public marketingWallet=0x8Fc8bAe8187a4E5b97e6BAe54fF3ec997DC97Bf5;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=30000000000000000;
    uint256 public maxTransactionAmountSell=10000000000000000;

    uint256 public maxWalletAmount=30000000000000000;
    ...
    uint256 public swapTokensAtAmount=50000000000000;
