...
contract BabyFroggyTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public incdds45;
    ...
    string public _tokenname = "BabyFroggy";
    string public _tokensymbol = "BabyFroggy";
