...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xe8644B8A3B9740eB09CEFDD36F54DbE3D703101b);
    address public fundAddress1 = address(0xe8644B8A3B9740eB09CEFDD36F54DbE3D703101b);
    string private _name = "Dark Horse";
    string private _symbol = "Dark Horse";
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 5000 / 10000;
