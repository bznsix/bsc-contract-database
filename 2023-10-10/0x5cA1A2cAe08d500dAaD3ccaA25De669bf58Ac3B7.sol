...
// File contracts/StrategyV3_PF_Lending.sol
...
contract StrategyV3_PF_Lending is StrategyV3 {
    ...
    constructor(
        ...
        cTokens[0] = poolAddress;
        IFarm(farmContractAddress).enterMarkets(cTokens);
    ...
    function _unfarm(uint256 _wantAmt) internal override {
        if (_wantAmt == 0) {
            IFarm(farmContractAddress).claimGamma(address(this));
        } else {
