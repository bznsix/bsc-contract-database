...
contract LEAPTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ybfdxc51;
    ...
    string public _tokenname = "LEAP";
    string public _tokensymbol = "LEAP";
