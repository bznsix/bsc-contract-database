...
contract xESxTestv1 is Context, IBEP20, Ownable {
    ...
    uint256 public maxSellAmount = 5000000 * 10**_decimals;
    uint256 public maxBuyAmount = 10000000 * 10**_decimals;
    uint256 public maxWalletBalance = 864834758 * 10**_decimals;
    ...
    address public nftWallet = 0x95dbD2a02Ab38c575E701ED36a4FD26714FF1893;
    address private treasuryWallet = 0x036e995024aCe105D9DF801801fb7957936bc512;
    address private dlcsWallet = 0x0Af8447Dd1758245f320b67F7Af2164f8B36B3ca;

    string private constant _name = "xESxTestv3";
    string private constant _symbol = "xESxTv3";
