...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 470;
    uint256 public _buyLPDividendFee = 20;
    uint256 public _buyLPFee = 10;

    uint256 public _sellDestroyFee = 0;
    uint256 public _sellFundFee = 470;
    uint256 public _sellLPDividendFee = 20;
    ...
    uint256 public _removeLPFee = 9000;
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xEd111bbC5232A6c4b9C05e0533C35E766bd421c2), destroyAmount);
                    }
                }
...
contract JXL is AbsToken {
    constructor() AbsToken(
        ...
        18,
        6000,
        address(0x1c81F12314D7bDa7644860412eFE17e9D8009218),
        address(0xEd111bbC5232A6c4b9C05e0533C35E766bd421c2),
        6000,
        0,
        6000
    ){
