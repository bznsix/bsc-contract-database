...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _transferFeeAddress = address(0x8aeEA271173a2bda795CF5aB9b982c4272A21cE4);
    ...
    constructor (
        ...
        holderRewardCondition = 60 * usdtUnit;

        _limitAmount = 3 * 10 ** Decimals;
    ...
    function setBuyFee(
        uint256 fundFee, uint256 fundFee2, uint256 fundFee3, uint256 lpDividendFee, uint256 lpFee
    ) external onlyOwner {
        _buyFundFee = fundFee;
    ...
    function setSellFee(
        uint256 sellFundFee, uint256 sellFundFee2, uint256 sellFundFee3, uint256 lpDividendFee, uint256 lpFee
    ) external onlyOwner {
...
contract JXL is AbsToken {
    constructor() AbsToken(
        ...
        address(0x68e8F892Bc18f929bC9318A29c47b9e58cc35C61),
        address(0x93d2e4FbCD7eF91784A88b58518482f95fe95f27)
    ){
