...
contract MemePresale is OwnerWithdrawable {
    ...
    modifier saleEnabled() {
        require(saleStatus == true, "Meme: is not enabled");
        _;
    }

    modifier saleStoped() {
        require(saleStatus == false, "Meme: is not stopped");
        _;
    }
    ...
    function addPayableTokens(
        ...
        require(
            ...
            "Meme: tokens & prices arrays length mismatch"
        );
    ...
    function transferETH() private {
        uint256 teamAmount = msg.value.mul(90).div(100);
    ...
    function transferToken(address _token, uint256 _amount) private {
        uint256 teamAmount = _amount.mul(90).div(100);
    ...
    function buyMeme(
        ...
        if (_token != address(0)) {
            ...
            require(payableTokens[_token] == true, "Presale: Token not whitelisted");
