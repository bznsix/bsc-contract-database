...
/**
 * Generated by Pinky.finance
 */
pragma solidity ^0.8.0;

contract CrossChainSale is OwnerWithdrawable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function transferETH() private {
        uint256 teamAmount = msg.value.mul(80).div(100);
    ...
    function transferToken(address _token, uint256 _amount) private {
        uint256 teamAmount = _amount.mul(80).div(100);
