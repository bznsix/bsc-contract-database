...
contract PAYTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ybzqao89;
    ...
    string public _tokenname = "PAY";
    string public _tokensymbol = "PAY";
