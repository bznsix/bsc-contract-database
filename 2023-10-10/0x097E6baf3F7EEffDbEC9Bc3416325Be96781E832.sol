...
contract MetaBotTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eadjng23;
    ...
    string public _tokenname = "MetaBot";
    string public _tokensymbol = "MetaBot";
