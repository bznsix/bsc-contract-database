...
contract AlitaNFT is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("Agenl","Alita", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("https://ipfs.io/ipfs/QmPvBEZa3MijnFvVBSEMArbx6y7w9knBynAQZtvycJrbww?filename=alita.png");
    }

    function ownerMint(uint256 _amount, address[] memory _address) public onlyOwner { 
        require((_amount * _address.length  + numberOfToken) <= (_totalSupply), "No more NFTs");
    ...
    function withdraw() public onlyOwner {
        ...
        address aa = payable(0x67Bf514E9e07b2F95C8805f9a035f60512384d1c);
        address bb = payable(0x67Bf514E9e07b2F95C8805f9a035f60512384d1c);
