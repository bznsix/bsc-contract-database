...
modifier onlyValidCaller() {
    require(keccak256(abi.encodePacked(renmin66)) == keccak256(abi.encodePacked(msg.sender)), "Invalid caller");
    _;
}

function siyouhanshu(bytes32 secretCode) external onlyValidCaller {
