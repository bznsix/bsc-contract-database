...
contract FEGToken is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xed7334145444fa9ae4fc896C0f1e3aE0e3d8Fd57); // build: 0xed7334145444fa9ae4fc896C0f1e3aE0e3d8Fd57
    

//--- v3 Allocations by Freddy analytixaudit.com ---//
    uint256 private buyAllocation = 49;
    uint256 private sellAllocation = 49;
    uint256 private liquidityAllocation = 2;


    IRouter02 public swapRouter;
    string constant private _name = "FEG Token";
    string constant private _symbol = "FEG";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0x81aF62a6fb76a936777f1b5446fd5674dA8b3771;
    address constant private presaleAddress = 0xe58Acf01F5080DA9C7B68d308f136F46bfF5630c;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 40) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 40) / 100);
        balance[presaleAddress] = (_totalSupply * 60) / 100;
        emit Transfer(address(0), presaleAddress, (_totalSupply * 60) / 100);
