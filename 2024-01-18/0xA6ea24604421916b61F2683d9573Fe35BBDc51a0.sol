...
contract UNICORN is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"UNICORN 🦄 BSC", unicode"UNICORN 🦄") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x0F29F10dFFAF818d3230a8Ea68620f33e67D7bB8;
        ...
        _mintOnce(owner(), 1e15 * (10 ** decimals()));
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _burnFeeOnBuy, uint256 _burnFeeOnSell, uint256 _feeOnTransfer) external onlyOwner {
        feeOnBuy = _feeOnBuy;
        ...
        require(feeOnBuy + burnFeeOnBuy <= 10, "CSLT: Total Fees cannot exceed the maximum");
        require(feeOnSell + burnFeeOnSell<= 10, "CSLT: Total Fees cannot exceed the maximum");

        require(feeOnTransfer <= 10, "CSLT: Total Fees cannot exceed the maximum");
