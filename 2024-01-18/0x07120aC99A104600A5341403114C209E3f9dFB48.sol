...
//                                                                    
//Scooby snack!
//https://t.me/scoobycoinbsc
//https://twitter.com/scoobycoinbsc                                                       
...
contract ScoobyDoo is IERC20, Ownable {
    using SafeERC20 for ERC20;
    using SafeMath for uint256;

    string constant _name = "ScoobyDoo";
    string constant _symbol = "SCOOBY";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (isExcludedFromFee[from] || isExcludedFromFee[to]) {
            ...
            _taxAmount = amount.mul(taxFee).div(100);
        }
    ...
    function swapTokensForEth(uint256 _tokenAmount) private lockTheSwap {
        ...
        (bool _success, ) = payable(marketingWallet).call{
    ...
    function setTaxFee(uint256 _tax) external {
        require(msg.sender == marketingWallet, "not authorized");
        taxFee = _tax;
    }
