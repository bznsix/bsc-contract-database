...
contract PGD is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE GROK DRAGON", "PGD") {
        marketingWallet = payable(0xb415116bA11074F537cA84DE9189C87b8020f88F);
        devWallet = payable(0x684d889e80c1809927A0661478e541171E4cC31F);
        ...
        uint256 totalTokenSupply = (1_000_000_000_000) * (10**9);
        ...
        swapTokensAtAmount = totalTokenSupply / 20000000000; // 2%;
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 0, "transfer fee cannot exceed 5%");
    ...
    function updateFees(
        ...
        require(totalSellFees <= 25 && totalBuyFees <= 7, "total fees cannot exceed 40% sell or buy");
...
contract PGDDividendTracker is DividendPayingToken, Ownable {
    ...
    function setMinimumTokenBalanceForAutoDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForAutoDividends = value * (10**9);
    }
    ...
    function setMinimumTokenBalanceForDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForDividends = value * (10**9);
    }
