...
/*
Website : https://beonechain.com/
Telegram : https://t.me/salmonation
Twitter : https://twitter.com/beone_chain
Discord : https://discord.com/invite/beonechain
Whitepaper: https://beonechain.com/documents/WhitePaper_BeOne_2024.pdf
Mail : support@beonechain.com
 */
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x615F1D38aD7F2B2DfB8fceA8Efe631cc5503d5b1; // owner address
...
contract BeOne is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x615F1D38aD7F2B2DfB8fceA8Efe631cc5503d5b1); // Marketing Address
    address payable public developmentWalletAddress = payable(0x615F1D38aD7F2B2DfB8fceA8Efe631cc5503d5b1); // development Address
    ...
    uint256 public _maxTxAmount = 1000000 * 10**_decimals; //1%
    uint256 public _walletMax = 1000000 * 10**_decimals; //1%
    uint256 private minimumTokensBeforeSwap = 50000 * 10**_decimals; //0.05%
    uint256 public _maxTaxPercentage = 25;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        ...
        require( _buyLiquidityFee + _buyMarketingFee + _buyDevelopmentFee <= _maxTaxPercentage, "Max set tax is 25"); 
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyDevelopmentFee);
    }
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        ...
        require( _sellLiquidityFee + _sellMarketingFee + _sellDevelopmentFee <= _maxTaxPercentage, "Max set tax is 25"); 
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellDevelopmentFee);
    }
