// Contract has been created by SPARKTOKEN Ecosystem. Visit https://t.me/SparkTokenBSC
...
contract SnailEcosystemToken is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xE0e95efd1e986Cded894189304AE49E38a039154);
    address payable public devAddress = payable(0xE0e95efd1e986Cded894189304AE49E38a039154);
    address public newOwner = 0xE0e95efd1e986Cded894189304AE49E38a039154;
    ...
    string private _name = "SNAILECOSYSTEMTOKEN";
    ...
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(1000).mul(30); //x% of total supply
    ...
    external onlyOwner()
    {
        ...
        require(totalFee<=610, "Too High Fee");
    }
    ...
    external onlyOwner()
    {
        ...
        require(totalFee<=910, "Too High Fee");
    }
