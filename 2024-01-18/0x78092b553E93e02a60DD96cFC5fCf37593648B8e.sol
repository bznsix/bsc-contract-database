/**
 * IDO Binance Labs Incubator : $MXPO
 *
 * IDO launch and price : 15.01.2024 / at 0.04$ per token $MXPO
 *
 * BINANCE CEX launch (listing) expected to occur on : 12.02.2024 / at 35.00$ per token $MXPO
 *
 * REWARDS for every 1,000.00$ worth of $MXPO bought during IDO : 2.000 FDUSD will be distributed for each 1 month-old holder.
 * REWARDS for every 10,000.00$ worth of $MXPO bought during IDO : 30.000 FDUSD will be distributed for each 1 month-old holder.
 * REWARDS for every 100,000.00$ worth of $MXPO bought during IDO : 500.000 FDUSD will be distributed for each 1 month-old holder.
 * 
 * REWARDS CONDITIONS : $MXPO holders will deposit their tokens bought during IDO on their Binance account when listed, and hold them for 1 month.
 */
