//TG: https://t.me/ThebeevengerBsc
//WWW: https://www.beevenger.xyz/
//TWITTER: https://twitter.com/beevenger
...
contract TheBeevenger is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 64000000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "The Beevenger";
    string private _symbol = "BVGR";
    ...
    address payable public marketingWallet = payable(0xE0234bdB26929f3dD7f3cdcd5a5Bd8dde2DAF202);
    ...
    uint256 public numTokensSellToAddToLiquidity = 1280000000 * 10**18;
    uint256 public _maxTxAmount = 320000000 * 10**18;
    uint256 public _maxWalletLimit = 1920000000 * 10**18;
    address admin;
    ...
    function setMaxTxLimits(uint256 maxTxAmount, uint256 maxWalletLimit) external onlyOwner {
