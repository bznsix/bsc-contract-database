...
Telegram https://t.me/ekfkkkfk
Website https://errfmj
*/
...
contract tiwi_ECO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "tiwi";
    string private _symbol = "$tiwi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7961502f60D65BE104c77D73BaBb163F551025e1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xdc580A2ce28C39Ce0ec6FeC981a852D09f89d818); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**6;
    uint256 public _maxTxAmount = 20 * 10**6;
    uint256 public _walletMax = 20 * 10**6;
    uint256 private minimumTokensBeforeSwap = 200 * 10**3; 
