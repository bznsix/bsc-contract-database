...
contract BTC_Dragon is ERC20, ERC20Burnable, Ownable2Step, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"BTC Dragon", unicode"BTCDragon") 
    {
        address supplyRecipient = 0x6D1827f8d94b76442e2915c508bf5ccE116756A9;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x4B2A841135e5d1b819eB34d4BB52A1E7aB006bC1);
        marketingFeesSetup(600, 600, 0);

        autoBurnFeesSetup(100, 100, 0);

        liquidityFeesSetup(100, 100, 0);

        _deployDividendTracker(7200, 10000000 * (10 ** decimals()) / 10);
        ...
        updateMaxWalletAmount(50000000000 * (10 ** decimals()) / 10);

        updateMaxBuyAmount(50000000000 * (10 ** decimals()) / 10);
        updateMaxSellAmount(50000000000 * (10 ** decimals()) / 10);

        excludeFromTradingRestriction(supplyRecipient, true);
        excludeFromTradingRestriction(address(this), true);

        _mint(supplyRecipient, 5000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x6D1827f8d94b76442e2915c508bf5ccE116756A9);
    }
