...
contract MJToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Micheal Jackson";
    string private _symbol = "MJ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66547078791387B00A51aE213021e7756A4cFdBd); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x8830069f6Fda985Cc0C5cF67D4ae41eE262F72C2); // Development Address
