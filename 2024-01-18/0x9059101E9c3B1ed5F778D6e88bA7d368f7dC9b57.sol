...
//--- Contract v3 ---//
contract KingBonk is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xB418aCb4a227079ec9b31387B47a3dc1dF192B4D); // build: 0xB418aCb4a227079ec9b31387B47a3dc1dF192B4D
    address payable private devWallet = payable(0x4CE734bAb1381580eF7a8A7ca4E5a3F07cB8D132); // build: 0x4CE734bAb1381580eF7a8A7ca4E5a3F07cB8D132
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "King Bonk";
    string constant private _symbol = "KingBonk";
