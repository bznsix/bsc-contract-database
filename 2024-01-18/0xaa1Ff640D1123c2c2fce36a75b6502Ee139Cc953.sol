// TG: t.me/babyshibainu_bsc

// X (Twitter): https://twitter.com/BabyShib_bsc

// Website: https://babyshibainu.xyz/
...
contract BabyShibaInu is Context, IERC20 { 
    ...
    string private constant _name = "BABYSHIBAINU";
    ...
    address payable public DevWallet = payable(0x56e16aDCC8CED317CAda891075aC51Ac112E28c0);
    address payable public MarketingWallet = payable(0x91e1173C8dc1581b276ABA9c0Dff7E17D978EBaB);
