...
abstract contract DividendFee is Ownable, DexBaseUSDT, ERC20 {
    ...
    uint256 public numTokenToDividend = 1* 1e27;
...
abstract contract LiquidityFeeUSDT is Ownable, DexBaseUSDT, ERC20 {
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 1e26;
    address public lpRec = 0x3d7Ee104730E98100Ac1bAB532a12E968Fa076a7;
...
abstract contract MaxHave is Ownable {
    ...
    constructor(uint256 _maxHav) {
        ...
        isHavLimitExempt[address(0x3d7Ee104730E98100Ac1bAB532a12E968Fa076a7)] = true;
        isHavLimitExempt[address(0x0Bf483d9511e16a7ba89421323FFE73044Db2dEb)] = true; 
    }
    ...
    BlackList
{
    ...
    string private constant tokenName = "FBTC";
    string private constant tokenSymbol = "FBTC";
    ...
    constructor()
        ERC20("FBTC", "FBTC", 18)
        DividendFee(1*1e9 ether, true)
        LiquidityFeeUSDT(5*1e8 ether, true)
