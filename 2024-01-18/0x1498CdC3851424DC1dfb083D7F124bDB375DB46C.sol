...
contract BNBGROK is ERC20, Ownable {
    ...
    constructor() payable ERC20("BNBGROK", "BNBGROK") {

        transferOwnership(0xE4f276993aBb6e2A3A7393e64Bfbe56e71CbB88C);
        ...
        treasuryWallet = 0xcB6275bEFF7855f73060352BdD1Ac6AaE70fC26F;
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if (_burnFees > 0) {
                uint256 _burnFeesAmount = _amount * _burnFees / 100;
                amount = amount - fees;
                super._transfer(from, address(0xdead), _burnFeesAmount);
            }
        }
