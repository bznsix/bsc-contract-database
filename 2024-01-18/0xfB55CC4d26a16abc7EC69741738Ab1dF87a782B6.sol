...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0862917E58D0fbA4DCB327645FB822ecd908938D;
...
contract TanssiNetwork is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF9a2083169F2d70eC66E231356E258B47D2A9ED7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TanssiNetwork";
    string private _symbol = "Tanssi";
