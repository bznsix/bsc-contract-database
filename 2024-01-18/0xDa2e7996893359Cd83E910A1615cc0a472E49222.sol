...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAb4EEDB26F7ccDEF5bE526695218620660DE4d62;
...
contract TELLORTRIBUTESv2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4C31c4fBe5f2c3aAF2b1499163833ACD0E29CA09;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TELLOR TRIBUTES V2";
    string private _symbol = "TRB 2.0";
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.01 * 10**18;
