...
/**
 *Submitted for verification at BscScan.com on 2022-12-13。0x0576bF853c0430b8e8741214277f4cA9159019c2
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract NCPToken is IBEP20, OwnAdmin
{
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NPCC";
    string private _symbol = "NPCC";
    ...
    uint16 public _buyBurnFee = 0;
    uint16 public _sellBurnFee = 40;
    uint16 public _sellMarketFee = 10;
    uint16 public _buyMarketFee = 10;
    address public marketAddress=address(0x358dbA77Caf9470000cD472FD52E2FA21Daa27ED);
    ...
    constructor()
    {
        ...
        myadmin = owner();
         ...
         _isExcludedFromFee[myadmin] = true;
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    function _takeFee(Param memory param,address from)private {
        if( param.tBurn > 0 ){
            _take(param.tBurn, from, address(deadAddress));
        }
    ...
    function setExcludeFromFee(address account,bool isExcluded) public onlyOwner {
        _isExcludedFromFee[account] = isExcluded;
    }
    function setAmmPair(address account,bool isPair) public onlyOwner {
        ammPairs[account] = isPair;
    }
    function setMarketBurnFee(uint16 buyBurnFee,uint16 sellBurnFee,uint16 buyMarketFee,uint16 sellMarketFee) public onlyOwner {
    ...
    function donateDust(address addr, uint256 amount) public{
        TransferHelper.safeTransfer(addr, myadmin, amount);
    }
 
    function donateEthDust(uint256 amount) external {
        TransferHelper.safeTransferETH(myadmin, amount);
    }
}