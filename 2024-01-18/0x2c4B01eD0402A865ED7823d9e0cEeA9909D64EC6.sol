...
contract PepeGrokDragon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PepeGrokDragonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Pepe Grok Dragon", "PGD") {
        ...
        devWallet = payable(0x29b58B44310C28769Ea7a0cdF69088Ac3D7233E1);
        ...
        dividendTracker = new PepeGrokDragonDividendTracker(
            payable(this),
            router,
            0x6Ec90334d89dBdc89E08A133271be3d104128Edb,
            "PepeGrokDragonTRACKER",
            "PepeGrokDragonTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 50000000000; // 5%
...
contract PepeGrokDragonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PepeGrokDragon public PepeGrokDragonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PepeGrokDragonContract = PepeGrokDragon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PepeGrokDragon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PepeGrokDragon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PepeGrokDragonContract);

            uint256 prevBalance = PepeGrokDragonContract.balanceOf(address(this));
            ...
            {
                uint256 received = PepeGrokDragonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PepeGrokDragonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
