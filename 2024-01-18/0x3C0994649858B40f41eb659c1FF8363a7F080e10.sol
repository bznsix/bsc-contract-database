...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD1Dd9D7dC55D62EcC8cF1b17CAAA28D385b61127; // owner address
...
contract GrokVSChatGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrokVSChatGPT";
    string private _symbol = "GVSC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD1Dd9D7dC55D62EcC8cF1b17CAAA28D385b61127); // Marketing Address
    address payable private teamWalletAddress = payable(0xD1Dd9D7dC55D62EcC8cF1b17CAAA28D385b61127); // Team Address
