...
contract BTC_Dragon is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, DividendTrackerFunctions, Initializable {
        ...
        ERC20(unicode"BTC Dragon", unicode"BTCDragon") 
    {
        ...
        _deployDividendTracker(3600, 10000000 * (10 ** decimals()) / 10);
