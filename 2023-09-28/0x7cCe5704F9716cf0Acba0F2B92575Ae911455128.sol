...
import "./CustomBillFixedMigrationFactoryBase.sol";

contract CustomBillFixedMigrationFactory is CustomBillFixedMigrationFactoryBase {
    constructor(
        BillDefaultConfig memory _billDefaultConfig,
        ICustomBillFixedPriceMigration.BillAccounts memory _defaultBillAccounts,
        ...
        CustomBillFixedMigrationFactoryBase(
            _billDefaultConfig,
    ...
    /**
        @notice deploys ICustomTreasury and ICustomBillFixedPriceMigration contracts and returns address of both
        @param _billCreationDetails ICustomBillFixedPriceMigration.BillCreationDetails
        @param _billTerms ICustomBillFixedPriceMigration.BillTerms
     */
    function createBillAndTreasury(
        ICustomBillFixedPriceMigration.BillCreationDetails calldata _billCreationDetails,
        ICustomBillFixedPriceMigration.BillTerms calldata _billTerms,
        uint256 _totalRewards
    )
        external
        onlyRole(BILL_CREATOR_ROLE)
        returns (ICustomTreasury _customTreasury, ICustomBillFixedPriceMigration _bill)
    {
    ...
    /**
        @notice deploys ICustomBillFixedPriceMigration contract
        @param _billCreationDetails ICustomBillFixedPriceMigration.BillCreationDetails
        @param _billTerms ICustomBillFixedPriceMigration.BillTerms
    ...
    function createBill(
        ...
        external
        onlyRole(BILL_CREATOR_ROLE)
        returns (ICustomTreasury _treasury, ICustomBillFixedPriceMigration _bill)
    {
        return
            _createBillWithDefaults(
                _billCreationDetails,
    ...
    /**
        @notice deploys ICustomTreasury and ICustomBillFixedPriceMigration contracts
        @param _billCreationDetails ICustomBillFixedPriceMigration.BillCreationDetails
        @param _billTerms ICustomBillFixedPriceMigration.BillTerms
    ...
    function createBillAndTreasury_CustomConfig(
        ICustomBillFixedPriceMigration.BillCreationDetails calldata _billCreationDetails,
        ICustomBillFixedPriceMigration.BillTerms calldata _billTerms,
        ICustomBillFixedPriceMigration.BillAccounts calldata _billAccounts,
    ...
    function createBillAndTreasury_Explorer(
        ...
        returns (ICustomTreasury _customTreasury, ICustomBillFixedPriceMigration _bill)
    {
        ICustomBillFixedPriceMigration.BillCreationDetails
    ...
    /**
     * @notice helper function to create an ICustomBillFixedPriceMigration.BillCreationDetails tuple for CustomTreasury
    ...
    function getBillCreationDetails(
        ...
        uint256 _startVestingTimestamp,
        bool _feeInPayout
    ) public pure returns (ICustomBillFixedPriceMigration.BillCreationDetails memory) {
        return
            ICustomBillFixedPriceMigration.BillCreationDetails({
    ...
    /**
     * @notice helper function to create an ICustomBillFixedPriceMigration.BillTerms tuple 
    ...
    ) public pure returns (ICustomBillFixedPriceMigration.BillTerms memory) {
        return
            ICustomBillFixedPriceMigration.BillTerms({
...
import "../interfaces/IFactoryFixedMigrationStorage.sol";
import "../interfaces/ICustomBillFixedPriceMigration.sol";
import "../interfaces/ICustomTreasury.sol";
import "../interfaces/IBillNft.sol";

contract CustomBillFixedMigrationFactoryBase is
    PendingOwnable,
    AccessControlEnumerable
{
    /* ======== STATE VARIABLES ======== */
    ...
    ICustomBillFixedPriceMigration.BillAccounts public getBillDefaultAccounts;

    IFactoryFixedMigrationStorage public immutable factoryStorage;
    ICustomBillFixedPriceMigration public billImplementationAddress;
    ICustomTreasury public treasuryImplementationAddress;
    ICustomBillFixedPriceMigration[] public deployedBills;
    ...
    event CreatedBill(
        ICustomBillFixedPriceMigration.BillCreationDetails billCreationDetails,
        ICustomTreasury customTreasury,
        ICustomBillFixedPriceMigration bill,
        address billNft
    );
    ...
    event SetBillImplementation(
        ICustomBillFixedPriceMigration newBillImplementation
    );
    ...
    constructor(
        ...
        require(
            ...
            "payoutAddress not 0 address"
        );
        billDefaultConfig = _billDefaultConfig;

        require(_factoryStorage != address(0), "factoryStorage not 0 address");
        factoryStorage = IFactoryFixedMigrationStorage(_factoryStorage);
        require(
            _billImplementationAddress != address(0),
            "billImplementation not 0 address"
        );
        billImplementationAddress = ICustomBillFixedPriceMigration(
            _billImplementationAddress
        );
        require(
            _treasuryImplementationAddress != address(0),
            "treasuryImplementa not 0 address"
        );
    ...
    function setBillImplementation(
        ICustomBillFixedPriceMigration _billImplementation
    ) external onlyOwner {
    ...
    function _createBillWithDefaults(
        ICustomBillFixedPriceMigration.BillCreationDetails
            memory _billCreationDetails,
        ICustomBillFixedPriceMigration.BillTerms memory _billTerms,
        ICustomTreasury _customTreasury,
        uint256 _totalRewards
    )
        internal
        returns (
            ICustomTreasury _treasury,
            ICustomBillFixedPriceMigration _bill
        )
    {
        return
            _createBill(
    ...
    function _createBill(
        ICustomBillFixedPriceMigration.BillCreationDetails
            memory _billCreationDetails,
        ICustomBillFixedPriceMigration.BillTerms memory _billTerms,
        ICustomBillFixedPriceMigration.BillAccounts memory _billAccounts,
        ICustomTreasury _customTreasury,
        uint256 _totalRewards
    )
        internal
        ...
        )
    {
        ...
        ICustomBillFixedPriceMigration bill = ICustomBillFixedPriceMigration(
        ...
        IFactoryFixedMigrationStorage(factoryStorage).pushBill(
            _billCreationDetails,
        ...
        return (_customTreasury, ICustomBillFixedPriceMigration(bill));
    }
}
// SPDX-License-Identifier: GPL-3.0
pragma solidity 0.8.17;
...
interface ICustomBillFixedPriceMigration {
...
// SPDX-License-Identifier: GPL-3.0
pragma solidity 0.8.17;
import "./ICustomBillFixedPriceMigration.sol";

interface IFactoryFixedMigrationStorage {
    struct BillDetails {
        address payoutToken;
        address principalToken;
