...
contract OverBabyApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OverBabyApe";
    string private _symbol = "OverBabyApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd71d6E00180A1b69be23f644b5bccdDF473Bb418);
    address payable public teamWalletAddress = payable(0xd71d6E00180A1b69be23f644b5bccdDF473Bb418);
