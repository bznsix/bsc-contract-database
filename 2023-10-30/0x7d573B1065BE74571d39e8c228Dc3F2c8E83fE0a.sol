...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d7D012a018eCeD55431e95CbE978864da834dF7; // owner address
...
contract OxBlox is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "0xBlox";
    string private _symbol = "$OxBlox";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6d7D012a018eCeD55431e95CbE978864da834dF7); // Marketing Address
    address payable private teamWalletAddress = payable(0x6d7D012a018eCeD55431e95CbE978864da834dF7); // Team Address
