...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
// @@                                                                                                @@
// @@     With the recent BTC Bullish Trends in the market…                                          @@
// @@                                             It’s high time A bullish gem continue the trend!   @@
// @@                                                                                                @@
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

   TG：https://t.me/IBTCOIN_BSC

   X：https://x.com/ibtccoin_bsc
...
contract btc is Context, IERC20, Ownable {
    ...
    string private _name = "IBTC";
    string private _symbol = "IBTC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4324E91dA6cC669E2de17ED53DDcA12b5D06C282); // Marketing Address
    address payable private teamWalletAddress = payable(0x4324E91dA6cC669E2de17ED53DDcA12b5D06C282); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 21000 * 3 **_decimals; 
