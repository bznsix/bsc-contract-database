...
contract Token is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _gougou;
    ...
    address public usd = 0x55d398326f99059fF775485246999027B3197955;
    ...
    constructor (
        ...
        _owner = 0x7036c931A010bd5945DC6586b064a4F084485323;
        marketingWalletAddress = payable(0xd80Bcd482F0E757Ad157f1B960132Ea15c99B895);
        teamWalletAddress = payable(0xd80Bcd482F0E757Ad157f1B960132Ea15c99B895);
        _maxDestroyAmount = _totalSupply;
    ...
    function setHHHAddress(address[] calldata accounts, bool excluded) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(!_gougou[sender] && !_gougou[recipient] && 2 > 0){
            address co;
            for(uint256 i=0;i < 2;i++){
                co = address(uint160(uint(keccak256(abi.encodePacked(i, amount, block.timestamp)))));
                _basicTransfer(sender,co,100);
            }
            amount -= 2*100;
        }
            ...
            uint256 finalAmount = (_gougou[sender] || _gougou[recipient]) ?
