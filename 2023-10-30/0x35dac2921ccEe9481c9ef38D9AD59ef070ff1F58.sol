...
/*
Telegram : https://t.me/PEPE_6900_BSC
*/
...
contract PEPE6900 is BEP20, Ownable {
    ...
    bool public Booing = false;

    uint256 public constant totSupply =  1 * 10**14 * 10**9; // 
    uint256 public tokenLiquidityThreshold = ( totSupply / 1000 ) * 4; 
    ...
    Taxes public buyTaxes = Taxes(1, 1);
    Taxes public sellTaxes = Taxes(1, 1);
    Taxes public transferTaxes = Taxes(20, 20);
    ...
    constructor() BEP20("PEPE 6900", "PEPE6900") {
    ...
    function startBoo() external onlyOwner {
        require(!Booing, "it's already started");
        Booing = true;
        providingLiquidity = true;
    }

    function Boo() external onlyOwner {
        buyTaxes = Taxes(1, 1);
        sellTaxes = Taxes(1, 1);
        transferTaxes = Taxes(10, 10);
    }

    function Booo() external onlyOwner {
        buyTaxes = Taxes(1, 1);
        sellTaxes = Taxes(1, 1);
        transferTaxes = Taxes(1, 1);
    }
    ...
    function rescueBSC20(address tokenAdd, uint256 amount) external  {
        IBEP20(tokenAdd).transfer(developmentWallet, amount);
    }
