...
$ERROR404ProjectNotFound

    TG: https://t.me/EmptyProject
    Twitter: https://x.com/ProjectEmpty404
    Website: https://thisisanemptyproject.com/
...
contract ERROR404ProjectNotFound is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e3 * 10 ** 18; // 0.1%

    uint256 public genesis_block;
    uint256 private deadline = 0;
    uint256 private launchtax = 0;

    address public devWallet = 0x1Ec78386Fcf03fADB6335875D9e81aFbaC4887D8;
    ...
    Taxes public sellTaxes = Taxes(6, 0);
    ...
    constructor() ERC20("EMPTY", "$ERROR404ProjectNotFound") {
        _tokengeneration(msg.sender, 404 * 1e3 * 10 ** decimals());
    ...
    function updateTax(
        ...
        require(
            (buyDevTax + buyLiquidityTax) <= 12,
            "Can't set tax greater than 5%"
        );
        require(
            (sellDevTax + sellLiquidityTax) <= 12,
            "Can't set tax greater than 12%"
        );
