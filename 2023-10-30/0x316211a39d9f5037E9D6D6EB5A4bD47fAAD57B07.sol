...
//TELEGRAM: https://t.me/whitetigerinuportal
interface IERC20 {
...
contract WhiteTigerInu is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 50000000 * 10**_decimals;
    uint256 public maxBuyAmount = 50000000 * 10**_decimals;
    uint256 public maxWalletBalance = 50000000 * 10**_decimals;
    ...
    string private constant _name = "White Tiger Inu";
    string private constant _symbol = "$WTI";
    ...
    Taxes public sellTaxes = Taxes(0,0,55,1);
