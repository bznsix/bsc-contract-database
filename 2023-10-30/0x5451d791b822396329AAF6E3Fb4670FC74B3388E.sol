...
Telegram: https://t.me/TGRQTOKEN
Website: https://TigerQueen.app
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
contract TGRQ is Context, IERC20, Ownable {
    ...
    string private constant _name = "TGRQ Chain";
    string private constant _symbol = "TGRQ";
