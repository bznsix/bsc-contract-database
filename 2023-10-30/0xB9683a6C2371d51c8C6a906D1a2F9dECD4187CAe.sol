...
abstract contract Project {
    address public marketingWallet = 0x28cD74Fc7dc023e750c572a1C81ab0ac2Ad15feD;
    address public treasuryWallet = 0x28cD74Fc7dc023e750c572a1C81ab0ac2Ad15feD;

    string constant _name = "UPVEMBER";
    string constant _symbol = "UPV";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; // (_totalSupply * 5) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 5; //
...
contract UPVEMBER is Project, IBEP20, Auth {
    using SafeMath for uint256;
