...
contract Token is IERC20, Ownable {
    ...
    uint256 public _sellHeightFee = 1500; 
    uint256 public _heightFeeTime = 300; 
    uint256 public _buyBaseFee = 500; 
    uint256 public _sellBaseFee = 500; 
    uint256 public _traFee = 9900; 
    uint256 public limitBlock = 300; 
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (block.timestamp < limitBlock + starBlock) {
                require(
                    (getETHout(tAmount - swapAmount) < 2 * 1e17), 
...
contract lkTOKEN is Token {
    constructor()
        Token(
            ...
            10000000,
            1698411600, 
            address(0x9B7aFfC0eeDd66771074DBF563F751d65767bA30), 
            address(0x79C306a1029891e48B911CF65226567FEB77aF9E) 
        )
    {}
}