...
Telegram: https://t.me/Pepe9900bsc
...
contract PEPE9900 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500e15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 5_000_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 500_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 500_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 500_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xc2511FfBea79e913140Bd9723108f7F9556F1D68;
    address public devAddress = 0xc2511FfBea79e913140Bd9723108f7F9556F1D68;

    string private constant _name = "PEPE9900";
    string private constant _symbol = "PEPE9900";
    ...
    Taxes public taxes = Taxes(0,0,15,5);
    Taxes public sellTaxes = Taxes(0,0,15,5);
