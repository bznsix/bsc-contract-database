...
//TELEGRAM: https://t.me/bnbblacktigerinuportal
interface IERC20 {
...
contract BnbBlackTigerInu is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xCe463c261696833d84AdFc4f31D80c61A2879839;
    address public devAddress = 0x423C3019803De00471D9d4F0aFCc3C9E5f848443;

    string private constant _name = "Bnb Black Tiger Inu";
    string private constant _symbol = "$BBTGI";
    ...
    Taxes public taxes = Taxes(0,0,32,2);
    Taxes public sellTaxes = Taxes(0,0,50,1);
