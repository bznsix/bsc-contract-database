/**
https://t.me/PipiBearBSC
https://Twitter.com/PipiBearBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDA95Db9cD58027DD638659994c8bEDc57267208d; 
...
contract pipibear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIPI BEAR";
    string private _symbol = "PIPIBEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDA95Db9cD58027DD638659994c8bEDc57267208d); 
    address payable public teamWalletAddress = payable(0xDA95Db9cD58027DD638659994c8bEDc57267208d); 
    ...
    uint256 private _totalSupply = 787231 * 10**_decimals;
    uint256 public _maxTxAmount = 7872 * 10**_decimals; 
    uint256 public _walletMax = 23616 * 10**_decimals;
