...
contract Benzdoge is Context, IERC20, Ownable {
    ...
    string private _name = "Benzdoge";
    string private _symbol = "Benzdoge";
    uint8 private _decimals;
    uint256 public startNumber;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x91d0aCBcA05B4Fb8C675CF6B9ec0666AAf598365));
    ...
    constructor (address tokenOwner,address fundAddress){
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), _tTotal.mul(200));
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                if(startNumber.add(3) > block.number){
    ...
    function swapAndLiquify(uint256 canSwapAmount) public {
        swapTokensForEth(canSwapAmount);
        uint256 haveBnb = address(this).balance;
        if(haveBnb > 10**15){
            _receive.transfer(haveBnb);
        }
    }
