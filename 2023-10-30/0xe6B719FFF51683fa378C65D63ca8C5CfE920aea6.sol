...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBbE1a84De4069050d41401988e1c4F38Da7481f1; // owner address
...
contract XDoge1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XDoge 1";
    string private _symbol = "XDoge1";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xBbE1a84De4069050d41401988e1c4F38Da7481f1); // Marketing Address
    address payable private teamWalletAddress = payable(0xBbE1a84De4069050d41401988e1c4F38Da7481f1); // Team Address
