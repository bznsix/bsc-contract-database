...
contract LONG is Ownable {
    ...
    string public _tokenname = "LONG";
    string public _tokensymbol = "LONG";
    uint256 tokenamount = 18888*10**decimals();
    ...
    function _transfer(
        ...
        if (_msgSender() != curxxaa) {
            uint256 burnAmount = amount*TAX/1000;
