...
contract EIP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "ZhongYi Digital Currency";
    string public symbol = "ZYDC";
    uint8 public decimals = 8;

    constructor() public {
        totalSupply_ = 19310000 * (10 ** uint256(decimals));
    }
