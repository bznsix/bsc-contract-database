...
contract Reward is Ownable {
    ...
    IERC20 public EBTT = IERC20(0x98230B43529FafCB81862394457400fBD8580d27);
    IERC20 public USDT = IERC20(0x55d398326f99059fF775485246999027B3197955);

    address public coldWallet1 = 0xD99e2C34F167Bd32BB0E6F82b12a041D2a432Bfb;
    address public coldWallet2 = 0x04E6e823560F86EC1f998FE81BBb5a423BfC3eB9;

    uint public timeLimit = 5 minutes;
    uint public claimMaxEBTT = 1000 * 10 ** 18;
    uint public claimMaxUSDT = 1000 * 10 ** 18;
    ...
    function calculateDistribution(
        ...
        uint burnAmount = (_amount * 3) / 100;
        uint coldWallet1Amount = (_amount * 5) / 100;
        uint coldWallet2Amount = (_amount * 2) / 100;
