/**
*Name; GRIMACE SHIBA INU 
*SYM:GRIMACEINU
*SUPPLY:  1TRILLION 
*BURNED 50% 🔥

*6%Marketing for future development 
*3%Liquidity pool 🎱
*1%REFLECTIONS 
  TELEGRAM : https://t.me/grimaceshibainu
*/
...
contract GRIMACESHIBAINU is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress =  0xb3d653FED10f92c172444f0dB4bBdE6f47320850
; 
    ...
    string private _name = "GRIMACE SHIBA INU";
    string private _symbol = "GRIMACEINU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**8 * 10**18;
