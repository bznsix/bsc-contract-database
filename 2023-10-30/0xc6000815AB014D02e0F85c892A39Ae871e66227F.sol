...
contract THENUN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "VALAK";
    ...
    address payable private _twddev = payable(0x89FB06B5B996709CBD080fe48ec34Ac4DBdEFf78);
    address payable private _twdmkt = payable(0x89FB06B5B996709CBD080fe48ec34Ac4DBdEFf78);
