...
contract TIGERKING is Context, IERC20, Ownable {
    ...
    string private _name = "TIGERKING";
    string private _symbol = "TIGERKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDAf15780c028cb696BB1863fdDBbc3Cac333a033);
    address payable public teamWalletAddress = payable(0xDAf15780c028cb696BB1863fdDBbc3Cac333a033);
    address public immutable deadAddress = 0xDAf15780c028cb696BB1863fdDBbc3Cac333a033;
