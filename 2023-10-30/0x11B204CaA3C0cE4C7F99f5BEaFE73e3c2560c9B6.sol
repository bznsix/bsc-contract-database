...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BITCHIP is Context, IERC20, Ownable {
     ...
     address public ownerWallet = 0x3Cd700decF29ce7c0aCbC895A5352Ae44602bD49;
    ...
    function excludeFromReward(address account) public onlyOwner() {
       ...
       // require(account != 0x72aD77045ca8fC3b86Cc227B416Ea8d465182c26,, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x3Cd700decF29ce7c0aCbC895A5352Ae44602bD49, 'We can not blacklist Uniswap router.');
