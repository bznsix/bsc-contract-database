...
contract BSCDEVSMASHEDHISKEYBOARD is ERC20, Ownable {
    ...
    constructor () ERC20("BSC DEV SMASHED HIS KEYBOARD", "ghjwrfhqefhjlacjlvadnsjlvsdjnslhjkqwefghl") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x453E772c2a9B467e1238c0BF34fb979FCdf9Db1F;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_totalFeesToken > 0) {
            uint256 fees = (amount * _totalFeesToken) / 100;
            amount = amount - fees;
