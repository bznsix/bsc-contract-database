...
Telegram: https://t.me/moebsclowtax
...
contract MOE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100e15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 1_000_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 100_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 100_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 100_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0xcc9403252381178C8bedA0f40AA6c83f08e5969a;
    address public devAddress = 0xcc9403252381178C8bedA0f40AA6c83f08e5969a;

    string private constant _name = "MOE TOKEN";
