/**
Telegram: https://t.me/CREEPYCOINBSC
*/
...
contract CREEPYCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "CREEPY HALLOWEN";
    string private constant _symbol = "CREEPY";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x379C51237C5C911E0a526EeDCc9bcbf83D110Ba1);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x379C51237C5C911E0a526EeDCc9bcbf83D110Ba1] = true;
