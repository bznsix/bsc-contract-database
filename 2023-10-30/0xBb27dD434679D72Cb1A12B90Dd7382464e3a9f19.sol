...
contract SShiba is ERC20, Ownable {
    ...
    constructor() payable ERC20("Sheikh Shiba", "SShiba") {
        ...
        rewardToken = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // SHIBA
        ...
        treasuryWallet = 0x74d92be656407D551A089d1Eb838bCF0764470d8;

        transferOwnership(0x81De0C8B542bbC295DF9FF42AA52440587B795c1);

        dividendTracker = new DividendTracker(10e3, rewardToken);
        ...
        dividendTracker.excludeFromDividends(address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE));

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[DEAD] = true;
        _isExcludedFromFees[treasuryWallet] = true;
        _isExcludedFromFees[address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE)] = true;
        _isExcludedFromFees[address(this)] = true;

    
        _mint(owner(), 100e6 * (10 ** 9));
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 25, "Buy fee cannot be more than 25%");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 25, "Sell fee cannot be more than 25%");
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((treasuryFeeOnBuy + treasuryFeeOnSell) > 0) {
                    uint256 treasuryBNB = address(this).balance - initialBalance;
