...
contract NewTigerINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Tiger Inu";
    string private _symbol = "NewTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23cd15aA95128AE89bce5b2c0e7271b922732859); 
    address payable public teamWalletAddress = payable(0x23cd15aA95128AE89bce5b2c0e7271b922732859); 
    ...
    uint256 public _totalTaxIfBuying = 20;  //Final at 3
    uint256 public _totalTaxIfSelling = 20; //Final at 3
