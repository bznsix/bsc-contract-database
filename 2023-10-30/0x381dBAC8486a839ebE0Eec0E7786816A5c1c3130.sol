...
contract MinpitCSun is Ownable,AccessControl{
    ...
    constructor() Ownable(){
        ...
        _initial = 0x143Ba3484FE85A75F3Bca65871d7B717ac9d44bb;
    ...
    */
    ...
    //购买矿产。userAddr：用户地址；time：时间戳
    event Minerals(uint256 type_,address userAddr,uint256 time);
    ...
    function purchaseMinerals(
        ...
        emit Minerals(2,userAddr,block.timestamp);
    }
