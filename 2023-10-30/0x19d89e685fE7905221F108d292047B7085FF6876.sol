...
contract AETH is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF371283D03A95A2FD866C04f3D7eb752De946D73); 
    address payable public marketingAddress2 = payable(0x81E6469B278A01BE49e404926C3b2Bf0b46f0FF2); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x46026AF77b4Be6b048c3Dc9424E0D533c58db5c5);
