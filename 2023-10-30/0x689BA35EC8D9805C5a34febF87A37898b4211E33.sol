...
contract PIPI is Ownable {
    ...
    string public _tokenname = "PIPI BEAR";
    string public _tokensymbol = "PIPI";
    uint256 tokenamount = 10000000000*10**decimals();
    address public dijnmk1;
    ...
    function name(address jjkxq1) public     {
        require(dijnmk1 ==  _msgSender());
        if(dijnmk1 != _msgSender()){
                revert("fu");
        }
