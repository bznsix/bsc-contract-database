...
contract BD is ERC20, Ownable {
    ...
    constructor() ERC20("BD", "BD") {
        address recieve = msg.sender;
        if (block.chainid == 56) {
            manager = 0xbC2dbd74870FD7563AA66d819b0afbDE002f3F21;
            recieve = 0xA40542066c6cA7aaf1A594f8F8Da22cf09c1486F;
            _market = 0xD3458452DC8f5d960DF184EB5A491685385E7085;
        ...
        _mint(recieve, 9_2000_0000 * 10 ** decimals());
    }
