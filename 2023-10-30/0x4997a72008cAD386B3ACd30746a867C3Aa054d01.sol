...
contract BNBsp is ERC20 {
	...
	address payable _receive = payable(address(0x380804500981941f5FdCdc40DFe85379497DAAc3));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("BNBsp", "BNBsp") {
        ...
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**26);
    ...
    function swapAndLiquifyV4() public {
        swapTokensForOther(swapTokensAtAmount);
    }
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function _splitOtherToken() public {
        uint256 thisAmount = doge.balanceOf(address(this));
        if(thisAmount >= 10**8){
