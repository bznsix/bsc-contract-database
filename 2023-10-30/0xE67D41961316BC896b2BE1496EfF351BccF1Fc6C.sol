...
contract ZINTECH_CHAIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xfC822f472103564f4965dAfB8af41b91b73D44eB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD60A30f997Ba2156aC72d1E146E003aeFd4C20Ec); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 200 * 10**5 * 10**9;
    uint256 public _walletMax = 100 * 10**7 * 10**9;
