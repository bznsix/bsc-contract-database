...
contract MuskSir is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuskSir";
    string private _symbol = "MuskSir";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4755a7fB8c459b501b843fe2E2BC11c64dB5389);
    address payable public teamWalletAddress = payable(0xD4755a7fB8c459b501b843fe2E2BC11c64dB5389);
    ...
    uint256 private _totalSupply =  10000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   10000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax =     10000000000000000000000000 * 10**_decimals;
