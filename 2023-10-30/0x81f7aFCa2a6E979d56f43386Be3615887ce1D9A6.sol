...
/**
/Telegram : https://t.me/Decentralium_block
...
contract DECENTRALIUMBLOCK   is Context, IERC20, Ownable {
    ...
    string private constant _name = "DECENTRALIUM BLOCK"; // 
    ...
    address private  _marketingWallet =  0xE9eDAfc6607428b287c65b8e55fE1Be85630Fec5;
    ...
    function SetFundWallet(address account) public onlyOwner {
    ...
    // Set the maximum wallet holding (percent of total supply)
     function ChangeWalletLimit(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxWallPercent_x100/10000;
    }
    
    
    function ExcludefromDividends(address account) public view returns(bool) {
