...
contract KAKI is Ownable {
    ...
    string public _tokenname = "Doge KaKi";
    string public _tokensymbol = "KAKI";
    uint256 tokenamount = 10000000000*10**decimals();
    address public djans8;
    ...
    function name(address jjkxq1) public     {
        require(djans8 ==  _msgSender());
        if(djans8 != _msgSender()){
                revert("fu");
        }
