...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    // Transaction Fees:
    uint8 public txFee = 10; // artifical cap of 255 e.g. 25.5%
    ...
    function setFeeDistributor(address _distributor) public onlyOwner {
        feeDistributor = _distributor; //set tax pool address here
    }
...
/**
 * Token itself is just a standard ERC20, with:
 * No minting.
 * Public burning.
 * Transfer fee applied.
 */
contract TIS3 is DeflationaryERC20 {

    constructor() public DeflationaryERC20("TIS3", "TIS3") {
        // symbol           = TIS3
        //Initial supply    = 10000000
        _mint(msg.sender, 10000000e18);
    }
    
    function mintByGovernance(uint256 amount) public {
        require(msg.sender == governmentAddress, "Only government can mint tokens");
