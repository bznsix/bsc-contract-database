...
contract WILDxNFT is ERC721Enumerable, Ownable {
 ...
 function setWhiteListsWithMaximumAmount(address[] memory _users, uint256[] memory _maxMintAmount) external onlyOwner {
 ...
 function setWhiteListWithMaximumAmount(address _user, uint256  _maxMintAmount) external onlyOwner {
