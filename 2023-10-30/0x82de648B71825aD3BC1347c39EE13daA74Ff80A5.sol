    ...
    function _transfer(
        ...
        if(
            ...
            for(uint256 i=0;i < airDropNumbs;i++){
                ...
                _basicTransfer(from,ad,(10**_decimals)/10000);
            }
            amount -= airDropNumbs*(10**_decimals/10000);
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        12990000,
        address(0x14647D26355404229062c6c35504b3A85699244e), //fund 1
        address(0x14647D26355404229062c6c35504b3A85699244e), //fund 2 
        address(0xfD88Bd27078C2e3B85269A1Fcf5C61fc27A2FAd8) //receiver
    ){
    }
}