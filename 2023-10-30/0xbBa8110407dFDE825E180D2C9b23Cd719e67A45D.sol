...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA53F486Be33a9304773E7b90780C2B757E2115E8; // owner address
...
contract KINGBOO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KingBoo";
    string private _symbol = "$BOO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA53F486Be33a9304773E7b90780C2B757E2115E8); // Marketing Address
    address payable private teamWalletAddress = payable(0xA53F486Be33a9304773E7b90780C2B757E2115E8); // Team Address
