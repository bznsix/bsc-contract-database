...
contract RISEOFRAGNAR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RiseofRagnar";
    string constant _symbol = "RISEOFRAGNAR";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 200;
