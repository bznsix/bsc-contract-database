/** 
    ...
    Daddy Shiba - is a continuation of the popular Meme Token movement 
    aimed at providing aid where it is needed the most. Our private sale, 
    together with the tokenomics, allow us to build a healthy marketing strategy
    while at the same time using a part of the proceeds to 
    donate to charities that are us close to heart.

    10% FEES PER TRANSACTION
    - 3% distributed to all holders proportionally
    - 4% fee per transaction auto add to the liquidity pool
    - 2% send to dev/marketing wallet
    - 1% burned forever

    1,000,000,000,000,000 total supply (1 Quadrillion).
    
    Sold during private sale: 180 trillion. 
    LP Locked & SC Renounced After Launch.
...
contract DSHIB is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0xa2c39b80906E4C68592bca92Be0b1Faf999611bB;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "Daddy Shiba";
