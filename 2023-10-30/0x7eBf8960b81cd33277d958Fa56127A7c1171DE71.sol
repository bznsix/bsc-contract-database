...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x960b93E027949bbcfd02779F336825b12f8D2C89; // owner address
...
contract PUSHTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUSH";
    string private _symbol = "PUSH";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x960b93E027949bbcfd02779F336825b12f8D2C89); // Marketing Address
    address payable private teamWalletAddress = payable(0x960b93E027949bbcfd02779F336825b12f8D2C89); // Team Address
