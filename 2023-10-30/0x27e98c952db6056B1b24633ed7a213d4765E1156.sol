...
contract MCDONALDSWojak is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 210 *10**15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e14 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x85F9bb76A2c7B2871cc32da0a4d6f59E3af270B3;

    string private constant _name = "MCDONALD'S Wojak";
    string private constant _symbol = "MCWojak";
