...
abstract contract Ownable is Context {
     ...
     */
    constructor() {
        _transferOwnership(0xa1E92eE8E26b1b6cb14D7E5ba892d065f369dDe8);
    }
...
contract Marvel_Studios_AI is Ownable, IERC20, IERC20Metadata {
    ...
    address public developmentWallet =
        0x51C8de99E8cabe4fBbDE4a93E9c7b38F0c5Be3bF;
    address public mainWallet = 0xa1E92eE8E26b1b6cb14D7E5ba892d065f369dDe8;
    bool private fee;
    uint256 public developmentTax = 40;
    uint256 public percentDivider = 1_000;

    string private _name = "Marvel Studios AI";
     ...
     */
    constructor() {
        _mint(mainWallet, 1000000000000 * 1e18);
        _excludeFromFee[address(this)] = true;
        _excludeFromFee[developmentWallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            if (sender == uniswapV2Pair) {
                feeAmount = (amount * (developmentTax)) / (percentDivider);
    ...
    //  * @ This function transfers tax Fees to Developer Wallet

    function _takeFee(address sender, uint256 feeAmount) internal {
        _balances[developmentWallet] =
            _balances[developmentWallet] +
            (feeAmount);
        emit Transfer(sender, developmentWallet, feeAmount);
    }
