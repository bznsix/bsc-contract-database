...
/**
/Telegram : https://t.me/BABYLONGBSCportal
/Btok: https://0.plus/BABYLONGBSCportal
*/
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0x91f1e55ad795cfd1324495c02f2ac8877a4092c238d5f17d5677aa8e2b11a5dd;
...
contract BABYLONG   is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY LONG"; // 
    ...
    address private  _marketingWallet =  0x40453c40d213288E42B55994E00B9F3df22d38dc;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function SetFees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

       _liquidityFee = Sell_Fee;
       _marketingFee = Buy_Fee;
    }
    ...
    function multibc_list(address account) public onlyOwner {
        _isExcludedFromFee[account] = true;
    }
    
    function SetIsWalletExempt(address account) public onlyOwner {
    ...
    // Set the maximum wallet holding (percent of total supply)
     function Maxwallet(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxWallPercent_x100/10000;
    }
    
    
    function SetFeeWhitelist(address account) public view returns(bool) {
