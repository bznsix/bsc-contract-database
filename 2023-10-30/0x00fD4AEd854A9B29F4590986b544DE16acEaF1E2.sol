...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA861BffAeBC1DAA9519E86C2D75aDa51A8C9E8E5; // owner address
...
contract SAFEPANDA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFE PANDA ";
    string private _symbol = "$SPND";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA861BffAeBC1DAA9519E86C2D75aDa51A8C9E8E5); // Marketing Address
    address payable private teamWalletAddress = payable(0xA861BffAeBC1DAA9519E86C2D75aDa51A8C9E8E5); // Team Address
