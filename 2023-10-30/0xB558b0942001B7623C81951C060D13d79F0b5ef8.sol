/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @Vypedoge
   ...
   I will renounce the ownership to burn addresses to transfer #Vypedoge to the community, make sure it's 100% safe.

   I will add .1 BNB and all the left 10% total supply to the pool
   Can you make #Vypedoge 10000X? 
   ...
   it's the best part of the #Vypedoge idea, increasing the liquidity pool automatically, 
...
contract Vypedoge is Context, IERC20, Ownable {
    ...
    string private _name = "Vypedoge";
    string private _symbol = "Vyp";
