...
|  $$/ $$/|_  $$           | $$  | $$  \ $$| $$ /$$/ | $$      | $$$$| $$
 ...
 /$$/\  $$  | $$           | $$  | $$  | $$| $$\  $$ | $$      | $$\  $$$
| $$  \ $$ /$$$$$$         | $$  |  $$$$$$/| $$ \  $$| $$$$$$$$| $$ \  $$
|__/  |__/|______/         |__/   \______/ |__/  \__/|________/|__/  \__/
*/                                                                         
...
pragma solidity 0.8.18;
contract x1 is Ownable, ERC20 {

    //Initial Definition of variables and events
    mapping(address => bool) public poolAddress;

    address public constant TAXWALLET = 0x64E6591B6c5C0671B4d4bCed5563e709D52A8299;

    uint private constant DIVISOR = 1000;
    //Using 1000 instead of 100 as divisor to enable fractional tax changes, Please note this makes sellTax 50 = 5% & MAXTAX 150 = 15%
    uint private constant MAXTAX = 150; //establishes a maximun tax of 15%
    uint public sellTax = 50; //Initial 5% tax

    event SetPool(address poolAddress, bool status);
    event TaxUpdated(uint256 selltaxt);


    constructor() ERC20("x1", "x1") {
