...
contract UATWin is UATWinAccessControl {
    ...
    function play(address _ref,uint256 value) public {
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transferFrom(msg.sender,address(address(this)),value*1000000000000000000);
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transfer(ownerWallet1,value*80000000000000000);
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transfer(ownerWallet2,value*20000000000000000);
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transfer(ownerWallet3,value*80000000000000000);
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transfer(_ref,value*200000000000000000);
    ...
    function getPrize(uint _blockNum) public {
        ...
        t.executed = true;
        tokenTransfer(0x7171C4E9F1C76e769d371c0262e1582eFAf464A2).transfer(msg.sender,winValue*1000000000000000000);
