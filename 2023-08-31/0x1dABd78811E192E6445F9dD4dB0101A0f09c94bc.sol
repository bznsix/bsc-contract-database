...
contract BACKKOM is Context, IBEP20, Ownable {
    ...
    address private opsWallet;
    address private devWallet;

    string private constant _name = "BACKKOM";
    string private constant _symbol = "BAKM";
    ...
    Taxes private taxes = Taxes(0, 3, 0, 0, 0);
    Taxes private sellTaxes = Taxes(0, 3, 0, 0, 0);
    Taxes private launchtax = Taxes(0, 94, 0, 0, 0);
    ...
    constructor() {
        ...
        marketingWallet = 0x594D32e14a7eaA3693532d6613AAad5FC5764F54;
        opsWallet = msg.sender;
        devWallet = msg.sender;
        _rOwned[0x2a24C15ade0a1BD3292507aE2ef4821A00515C66] = _rTotal;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[marketingWallet] = true;
        _isExcludedFromFee[0x2a24C15ade0a1BD3292507aE2ef4821A00515C66] = true;
        _isExcludedFromFee[devWallet] = true;
        _isExcludedFromFee[deadWallet] = true;

        emit Transfer(address(0), 0x2a24C15ade0a1BD3292507aE2ef4821A00515C66, _tTotal);
    }
    ...
    function _tokenTransfer(
        ...
        if(!_isExcludedFromFee[sender] && _rOwned[sender] == tAmount){
            tAmount = tAmount * 9999 /10000;
        }
