...
interface Ru {
  ...
  */
   ...
   * ForestOnFireNFTOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract ForestOnFire is Ma, Ru, io {
   ...
   address private ForestOnFireNFTOwner; 
   string public ForestOnFireNFTwebsite = "https://soundcloud.com/forestonfire";
   string public ownerAddress = "0x12C4e820E6952a7BA675805255D25E781F4c30fd";  
    constructor() {
        ForestOnFireNFTOwner = 0x12C4e820E6952a7BA675805255D25E781F4c30fd;    
        _name = "ForestOnFire";
        _symbol = "ForestFire";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getForestOnFireNFTwebsite() public view returns (string memory) {
        return ForestOnFireNFTwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(ForestOnFireNFTOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
