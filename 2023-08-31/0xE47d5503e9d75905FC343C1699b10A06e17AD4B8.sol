...
// https://t.me/bitcoin100k_btc100k
...
contract BTC100K is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bitcoin 100k";
    string private constant _symbol = "BTC100K";
    ...
    address payable private _twddev = payable(0x81853f43dF429478D54005cF9B57cF128905Db5C);
    address payable private _twdmkt = payable(0x81853f43dF429478D54005cF9B57cF128905Db5C);
