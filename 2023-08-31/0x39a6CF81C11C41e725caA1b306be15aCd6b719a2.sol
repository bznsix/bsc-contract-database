 ...
 *  Telegram: https://t.me/DevVSJeetsBSC
 *  Website : https://www.dejeetscoin.fun/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04C923D6DC40Dac41b48f48413168c3BA18Eb531; // owner address
...
contract DevVsJeets is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev VS Jeets";
    string private _symbol = "DEJEETS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04C923D6DC40Dac41b48f48413168c3BA18Eb531); // 
    address payable public teamWalletAddress = payable(0x04C923D6DC40Dac41b48f48413168c3BA18Eb531); // 
    ...
    uint256 public _totalDistributionShares = 52;  
    uint256 private _totalSupply = 1000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 20000000 * 10**_decimals; 
    uint256 public _walletMax = 20000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100070 * 10**_decimals; 
