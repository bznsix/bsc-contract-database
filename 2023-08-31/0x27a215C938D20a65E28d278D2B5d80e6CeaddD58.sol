...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x517C17Ea80e3Fd22BDC3De12A97943D3cefCded0;
...
contract RexusXX70Poseidon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x00f4Df87ee105762A509B78CE2E764CC253D18ee;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RexusXX70Poseidon";
    string private _symbol = "RXP";
