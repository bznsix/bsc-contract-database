...
// Reflection Smart Contract (Rewards holders the native token)
// Custom contract created by GEN (tokensbygen.com) for Martian Protocol 
...
contract Martian_Protocol is Context, IERC20 { 


    // Contract Wallets
    address public _owner = 0x874FE12aCf40ffE21f53cF143EFfe268ab17Fbf6;
    address public Wallet_Liquidity = 0x874FE12aCf40ffE21f53cF143EFfe268ab17Fbf6;
    address payable public Wallet_Marketing = payable(0x874FE12aCf40ffE21f53cF143EFfe268ab17Fbf6);
    ...
    // Token Info
    string constant private _name = "Martian_Protocol";
    string constant private  _symbol = "$MPL";
    uint256 constant private _decimals = 18;
    uint256 constant private _tTotal = 1_000_000_000 * 10 ** _decimals;
    ...
    uint8 public _fee__Buy_Liquidity = 2;
    uint8 public _fee__Buy_Marketing = 6;
    uint8 public _fee__Buy_Reflection = 2;

    uint8 public _fee__Sell_Contract = 1;
    uint8 public _fee__Sell_Liquidity = 2;
    uint8 public _fee__Sell_Marketing = 6;
    uint8 public _fee__Sell_Reflection = 2;

    // Total Fee for Swap
    uint8 private _SwapFeeTotal_Buy = 11;
    uint8 private _SwapFeeTotal_Sell = 11;
    ...
    event updated_Buy_fees(uint8 Marketing, uint8 Liquidity, uint8 Reflection, uint8 Contract_Fee);
    event updated_Sell_fees(uint8 Marketing, uint8 Liquidity, uint8 Reflection, uint8 Contract_Fee);
    ...
    function F_02_Set_Fees(
        ...
        require (Marketing_on_BUY + Liquidity_on_BUY + Reflections_on_BUY + _fee__Buy_Contract <= 15, "SF1");  // Max fee 15%

        // Buyer Protection: Max Fee 15% 
        require (Marketing_on_SELL + Liquidity_on_SELL + Reflections_on_SELL + _fee__Sell_Contract <= 15, "SF2");  // Max fee 15%
        ...
        emit updated_Buy_fees(_fee__Buy_Marketing, _fee__Buy_Liquidity, _fee__Buy_Reflection, _fee__Buy_Contract);
        emit updated_Sell_fees(_fee__Sell_Marketing, _fee__Sell_Liquidity, _fee__Sell_Reflection, _fee__Sell_Contract);
    ...
    */
    ...
    function _Remove_Contract_Fee() external payable {
        ...
        require(msg.value == 3*10**18, "REQ_3BNB"); // Need to enter 3, and pay 3 BNB to remove the 1% contract fee
    ...
    */
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool Fee) private {
        ...
        uint256 tTransferAmount = tAmount - (tReflect + tSwapFeeTotal);
...
/*
    ...
    Created by GEN (tokensbygen.com) for Martian Protocol 
