/**
 Thanks Clown @ClownDaddy @AlphabetCalls
*/
...
contract FUCKBOTS {
    address payable public feeRecipient = 0xB1Af819F9dF22D2042421A0ef3dE3a7cdfeed771;
    uint256 public feeAmount = 0.05 ether;  // 0.05 BNB fee, using the ether unit for simplicity in Solidity.
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function FUCK_BOTS(address _tokenA, uint256 _amountTokenA) external payable {
