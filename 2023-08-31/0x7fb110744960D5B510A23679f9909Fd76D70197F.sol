...
contract BOSSToken is IERC20, Ownable {
    ...
    constructor(address tokenOwner) {
        ...
        _lpFee = 4; 
        _nodeFee = 2;
        _nodeAddress = 0x83cacfF673830B048Dc3e35330a90d469eefCd38;
        _destroyFee =2;
        _destroyAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function setNodefee(uint256 nodeFee) public {
        require(msg.sender == owner(), "fail");
        _nodeFee = nodeFee;
    }

    function setNodeAddress(address newAddress) public {
        require(msg.sender == owner(), "fail");
        _nodeAddress = newAddress;
    }

     function setDestroyFee(uint256 destroyFee) public {
        require(msg.sender == owner(), "fail");
        _destroyFee = destroyFee;
    }

    function setDestroyAddress(address newAddress) public {
        require(msg.sender == owner(), "fail");
        _destroyAddress = newAddress;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate =  _lpFee + _destroyFee + _nodeFee;
        }
