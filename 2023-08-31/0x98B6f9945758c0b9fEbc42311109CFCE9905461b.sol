...
contract King is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xE232Fde6c081F3B989AB675961303f591eFD255d;
    bool private liquidityAdded = false;  // 用于追踪是否已添加流动性
    ...
    constructor () ERC20("King", "K") 
    {   
        address newOwner = 0x327Feffaa861f83653E5e4674C1D488885868802;
...
function addInitialLiquidity(uint256 tokenAmount) external payable onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (
            ...
            from != uniswapV2Pair && 
            to == uniswapV2Pair &&
            block.timestamp < tradingStartTime + 30
        ) {
            require(false, "Selling is disabled for the first 30 seconds after trading is enabled.");
        }
