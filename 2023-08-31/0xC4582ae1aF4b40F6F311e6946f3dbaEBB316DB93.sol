...
contract AmetaNft is Ownable, ReentrancyGuard, ERC721Enumerable, ICollection {
    ...
    modifier onlyMinter() {
        require(
            ...
            "AmetaNft: account not role minter"
        );
        _;
    }

    constructor(string memory _baseUrl) ERC721("Ameta NFT", "AmetaNFT") {
        baseUrl = _baseUrl;
    ...
    function mint(address _to) external override onlyMinter returns (uint256) {
