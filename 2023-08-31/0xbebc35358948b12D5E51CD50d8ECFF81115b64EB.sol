...
contract CTToken is ERC20, Ownable {
    ...
    //
    constructor(address _usdtAddress, address _iUniswapV2Router02Add, address _feeAddress1, address _feeAddress2) public ERC20("CT", "CT") {
        ...
        _mint(msg.sender, 1000 * 10000 * 10 ** uint256(decimals()));
