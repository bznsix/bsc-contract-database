        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x2c8878Ab1de8617E109B6064F214A9F7ee7c4b9F), block.timestamp
                );
            }
        }
    }
...
contract Ehereum is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000,//Supply
        address(0xcc8039EE14aB8817E8e8BACe8708Fa465e4decCa),//FundAddress
        address(0x2c8878Ab1de8617E109B6064F214A9F7ee7c4b9F)//ReceiveAddress
    ){
    }
}