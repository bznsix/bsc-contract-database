/**
Portugal Fan Token
Confie em nós - nunca falharemos com você
📄Contract Address :
0x6FE9b6BdEF1C9B318b2d3916c0372EAb900A8209
CHARTS 👍
https://poocoin.app/tokens/0x6FE9b6BdEF1C9B318b2d3916c0372EAb900A8209
DEXTOOLs 👍
https://www.dextools.io/app/en/bnb/pair-explorer/0x6FE9b6BdEF1C9B318b2d3916c0372EAb900A8209
✅ LP Locked 1 Year 🔒
💯 Renounced 💯 SAFU

⚡ https://t.me/Portugal_5 ⚡
...
contract Portugal is PortugalDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PortugalTeam;
    address private CharityPortugal;
    ...
    string public override name = "Portugal Fan Token";
    string public override symbol = "Portugal Fan Token";
    ...
    constructor(uint totalSupplyValue, address PortugalTeamAddress, address CharityPortugalAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PortugalTeam = PortugalTeamAddress;
        CharityPortugal = CharityPortugalAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PortugalTeam] =  totalSupply * 4 / 100;
        balances[CharityPortugal] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's PortugalTeam pot
