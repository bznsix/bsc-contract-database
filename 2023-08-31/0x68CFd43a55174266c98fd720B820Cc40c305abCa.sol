...
contract KAIJU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "KAIJU";
    string private constant _symbol = unicode"$KAIJU";
    ...
    address payable public DevWallet = payable(0x5b290028045a2DA8003730E316873610C70040AD);
    address payable public MarketingWallet = payable(0x98e98477805F7625d366457f0bD852Bc800c4B6C);
