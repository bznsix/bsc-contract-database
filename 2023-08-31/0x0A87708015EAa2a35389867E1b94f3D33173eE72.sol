...
import './BabylonSwapV2ERC20.sol';
import './libraries/Math.sol';
import './libraries/UQ112x112.sol';
import './interfaces/IERC20.sol';
import './interfaces/IBabylonSwapV2Factory.sol';
import './interfaces/IBabylonSwapV2Router01.sol';
import './interfaces/IBabylonSwapV2Callee.sol';
import './BabylonSwapFeeTransfer.sol';
...
contract BabylonSwapV2Pair is BabylonSwapV2ERC20 {
    ...
    function initialize(address _token0, address _token1, address _router) external {
        require(msg.sender == factory, 'BabylonSwapV2: FORBIDDEN'); // sufficient check
        token0 = _token0;
        token1 = _token1;
        router = _router;
    }
