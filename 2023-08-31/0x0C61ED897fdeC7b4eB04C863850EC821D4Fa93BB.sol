...
contract CflatsBox is ERC721, Ownable {
    using Strings for uint256;
    ...
    {
        return "ipfs://QmZk81mCN2hg8RmnpAXettKFvHETy458nHaqCgqqhZuyEA/";
    }
    ...
    function mintAll(address account, uint256 idFrom, uint256 idTo) external onlyOwner
    {
