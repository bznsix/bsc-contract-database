...
// TG : https://t.me/PhosChainOfficial
// X:  https://twitter.com/phoschain
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 185 days");
...
contract PhosChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PHOSCHAIN";
    string private _symbol = "$C";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0485B640a830676C581F28f045912442DD777050); // Marketing Address
    address payable public teamWalletAddress = payable(0x38F51E80B4a189ED2d76d160742d2f207bddDE01); // Team Address
