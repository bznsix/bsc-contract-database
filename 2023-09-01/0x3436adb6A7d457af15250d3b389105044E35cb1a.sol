...
contract AtomicSwap is Ownable, Pausable, ReentrancyGuard {
  ...
  function _sellToken(address _from, uint256 _amount, address _token) internal {
    ...
    bool res2 = ERC20(_token).transferFrom(address(this), _from, value);
  ...
  function _calculateReward(
    ...
    return
      (amount *
        ...
        ((end - start) / calculateRewardPeriod)) / 100;
  }
...
contract MultiMetaLife is ERC20, Ownable {
  ...
  uint public swapShare = (MAX_SUPPLY * 3) / 10;
  uint public ownerShare =
    MAX_SUPPLY - swapShare - stakeShare - reserveShare - advisorShare;
