...
contract GasToken is ReentrancyGuard, AccessControlEnumerable, ERC20Burnable {
    ...
    constructor() ERC20("USD Gas", "USDG") {
        _grantRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _grantRole(OPERATOR_ROLE, _msgSender());
    }

    uint256 public swapBase = 1;
    address public lp = 0xBf98a7784Ab9E7f785e6a0A1bEc0FCE2c4266A8f;
    address public token = 0x13F92878562B7826BECB2569066571813094dd07;
    address public lpStake = 0x506C291cC48cF7d620233Ebce1CC5E16f495df6E;
    address public constant usdt = 0xD6e6f3E18Dd89D51128F36761fd2FF447822257A;
