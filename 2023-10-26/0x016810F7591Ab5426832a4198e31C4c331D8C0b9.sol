/**
    ## SHAGGY DOGE INU ($SHINU) 毛むくじゃらの犬 ##
    WEBSITE             : "SOON AFTER LAUNCH AND NEW ATH "
    TWITTER             : https://twitter.com/ShaggyDogeInu
    MEDIUM              : https://medium.com/@shaggydogeinu
    TELEGRAM CHANNEL    : https://t.me/ShaggyDogeInuPortal
    TELEGRAM COMMUNITY  : https://t.me/ShaggyDogeInuChat
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x71CbddE4A8BCf100A90432106e8Ddac166227Dc0; // owner address
...
contract SHAGGYDOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHAGGY DOGE INU";
    string private _symbol = "SHINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0BA3fa19297d12B27B0b0cdDdf1519D5E344f762); 
    address payable public teamWalletAddress = payable(0x71CbddE4A8BCf100A90432106e8Ddac166227Dc0);
