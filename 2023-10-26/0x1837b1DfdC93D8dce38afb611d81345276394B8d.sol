...
contract dddddddd is Context, IERC20, Ownable {
    ...
    address payable private Marketing_Wallet = payable(0x83CFa713526f8E2F2c8e1B3a388054aE85bF25bC);

    string private constant _name = unicode"asdasd";
    string private constant _symbol = unicode"asdddd";
    ...
    constructor () {
        ...
        _projectWallets[Marketing_Wallet] = true;
    ...
    function _swapTokens(uint256 amount) private {
        Marketing_Wallet.transfer(amount);
    }
