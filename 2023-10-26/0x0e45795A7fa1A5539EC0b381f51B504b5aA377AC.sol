...
contract DoGe is ERC20, Ownable {
    ...
    constructor() ERC20("DoGe", "DoGe") {
        ...
        marketingWallet = address(0xB2624f5Ab0D41c71a86C7B393b43Be84b479C11B); // set as marketing wallet
        devWallet = address(0xB2624f5Ab0D41c71a86C7B393b43Be84b479C11B); // set as dev wallet
