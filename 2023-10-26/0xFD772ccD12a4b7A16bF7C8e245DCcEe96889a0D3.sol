/**
Telegram: https://t.me/Fereneum
Website: Coming Soon

From Blockify Chain team. 55k ATH

check out @cillianlaunches for private sale
...
contract Fereneum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fereneum";
    string private _symbol = "FRNM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE60e34d1B498ec654879d784ff6DDEa1CA6FCE10); // Marketing Address
    address payable public teamWalletAddress = payable(0xE60e34d1B498ec654879d784ff6DDEa1CA6FCE10); // Team Address
    ...
    uint256 public _walletMax =     500000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 1000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
