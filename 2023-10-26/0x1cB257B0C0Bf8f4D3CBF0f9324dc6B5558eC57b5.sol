// miniSAFEREUM - BSC is Calling

// https://minisafereum.io
// https://t.me/MiniSafereumBsc
// https://twitter.com/MiniSafereum
...
contract miniSAFEREUM is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 0;
    uint256 public marketingFeeOnSell = 0;
    address public marketingWallet = 0xe8222921A07B931986045Fd880af4c3032A3A937;
    ...
    constructor () ERC20("miniSAFEREUM", "miniSAFEREUM") 
    {   
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 3, "Marketing fee on buy cannot be more than 3%");
        require(_marketingFeeOnSell <= 3, "Marketing fee on sell cannot be more than 3%");
