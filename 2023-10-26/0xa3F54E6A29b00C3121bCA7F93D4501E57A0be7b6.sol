...
Dive in with #CryptoNessie and discover a new world of trading prowess! 

Twitter/X: https://twitter.com/NessieBSC
Telegram: @NessieBsc
...
contract NESSIE is Context, IERC20, Ownable {
    ...
    string private _name = "LOCH NESS MONSTER";
    string private _symbol = "$NESSIE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x505Fbd87Ae7d827157fE638C4cfB3baaee80d5F9); // Marketing Address
    address payable private teamWalletAddress = payable(0x505Fbd87Ae7d827157fE638C4cfB3baaee80d5F9); // Team Address
