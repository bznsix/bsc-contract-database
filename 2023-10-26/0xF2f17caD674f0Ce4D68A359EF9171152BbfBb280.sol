...
contract BUYBURN is ERC20, Ownable {
    ...
    uint256 public transferBuybackFee;
    ...
    constructor() ERC20("BUYBURN", "BB") {
        ...
        uint256 _transferBuybackFee = 0;

        uint256 totalSupply = 69420000 * 1e18;

        maxTransactionAmount = (totalSupply * 10) / 1000; // 1.5% of total supply
        maxWallet = (totalSupply * 10) / 1000; // 2.5% of total supply
        ...
        totalFeesBuy = buyMarketingFee + buyLiquidityFee + buyBuybackFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellBuybackFee = _sellBuybackFee;
        totalFeesSell = sellMarketingFee + sellLiquidityFee + sellBuybackFee;
        ...
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferBuybackFee;

        marketingWallet = address(0x17B91bFcBDEC8700eae421Dc83c238Dca378d45F); 
        buybackWallet = address(0x855cD589178d9466771f78c3380a95955052C414);
        lpWallet = msg.sender;
    ...
    /// @param _buybackFee The fee for the buyback wallet
    ...
    function updateTransferFees(
        ...
        transferBuybackFee = _buybackFee;
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferBuybackFee;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && totalFeesSell > 0) {
                ...
                tokensForBuyback += (fees * sellBuybackFee) / totalFeesSell;
            ...
            // on buy
                ...
                tokensForBuyback += (fees * buyBuybackFee) / totalFeesBuy;
            ...
            // on transfer
                ...
                tokensForBuyback += (fees * transferBuybackFee) / totalFeesTransfer;
