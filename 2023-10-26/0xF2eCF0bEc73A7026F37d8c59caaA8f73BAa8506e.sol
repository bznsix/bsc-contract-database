...
contract DIVIDENYIELD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Dividen Yield ";
    string constant _symbol = "DYIELD";
    ...
    uint256 public _maxTxAmount = 3 * 10**4 * (10 ** _decimals);
    uint256 public _walletMax = 3 * 10**4 * (10 ** _decimals);
    ...
    uint256 public extraFeeOnSell = 9;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x111502fa4C83731D05B44cAae78b856ea01E434d;
        marketingWallet = 0x111502fa4C83731D05B44cAae78b856ea01E434d;
        devWallet = 0x111502fa4C83731D05B44cAae78b856ea01E434d;
