...
// telegram : https://t.me/hypepebsc
// website : https://hypepe.online
// twitter : https://x.com/hypepebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe236084C1B936793D67909291Acb0967995521e8 ; // owner address
...
contract HYPEPE  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HYPEPE";
    string private _symbol = "HYPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE05Bc12F1b042888BB8Fb3702FD515EB6A8D4cC2); 
    address payable public teamWalletAddress = payable(0xE05Bc12F1b042888BB8Fb3702FD515EB6A8D4cC2);
    ...
    uint256 public _marketingShare = 29;
