...
contract SUHUToken is Context, IERC20, Ownable {
    ...
    string private _name = "TestSUHU Token";
    string private _symbol = "SUHU";
    uint8 private _decimals = 9;
    address public marketWallet = 0xfA09F14053a08C9e8efd13A2998756A50AD74C33;
    ...
    function checkForWhale(uint256 amount) private view returns (bool) {
        uint256 maxTransferAmount = _tTotal * 3 / 100;
        return amount <= maxTransferAmount;
    }

    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        require(checkForWhale(amount), "Transfer amount exceeds the 3% of the total supply");
