...
contract NwodToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0xA4f1C387F25c47E36f399786459c09D0A254DC9A;
    address public awardWallet =  0xe0b6877A0D9f300F84Bf27B7c1cfCA2868d0c3A4;
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public ownerAddress = 0x0d0Dcd4E56Af013e697f7232e7a0234BEe72e586;

    uint256 public awardFee = 200;
    uint256 public marketingFee = 200;
    uint256 public deadFee = 100;
    
    uint256 public awardBuyFee = 200;
    uint256 public marketingBuyFee = 200;
    uint256 public deadBuyFee = 100;
    ...
    function takeBuyFee(address from, uint256 amount) private returns (uint256 amountAfter) {
        ...
        uint256 BFee = amount.mul(marketingBuyFee.add(awardBuyFee).add(deadBuyFee)).div(10000);
        if (BFee > 0) {
    ...
    function takeSellFee(address from, uint256 amount) private returns (uint256 amountAfter) {
        ...
        uint256 SFee = amount.mul(marketingFee.add(awardFee).add(deadFee)).div(10000);
        if (SFee > 0) {
    ...
    function setDaedFee(uint256 fee_) public onlyOwner {
        deadFee = fee_;
    }
