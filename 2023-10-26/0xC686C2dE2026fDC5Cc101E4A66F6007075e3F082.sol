...
/**
$MISSY bsc is a meme utility token in the cryptocurrency space, representing the internet culture's love for feline friends.
https://t.me/missyBSC
https://twitter.com/MissyCatBsc
*/
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE43A4dD3919641D8d8a5aEcd5B1Ea1B21A6315df ;
...
contract MissyCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Missy Cat"; // 
    string private constant _symbol = "$MISSY"; //    
