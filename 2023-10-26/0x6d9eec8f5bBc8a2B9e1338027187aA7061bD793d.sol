...
/**
https://t.me/Onedollarkabosutomillionaire
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8B70557B0880eE7646fb209335F4b02aC1BA794; // owner address
...
contract OneDollarKabosuToMillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "One Dollar Kabosu to Millionaire";
    string private _symbol = "$1KABOSU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa8B70557B0880eE7646fb209335F4b02aC1BA794); // Marketing Address
    address payable private teamWalletAddress = payable(0xa8B70557B0880eE7646fb209335F4b02aC1BA794); // Team Address
