...
Cannon is a DevOps tool for Binance Smart Chain. It manages protocol and smart contract deployments for local development and live networks.
Only Portal: https://t.me/usecannonbsc
...
contract $CANNON is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = _tTotal * 10**_decimals;
    uint256 public maxWalletAmount = 30000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x461c42693064C900e1f5E0739e4Cb6613A8df0e3;

    string private constant _name = "Cannon";
    string private constant _symbol = "$CANNON";
    ...
    Taxes public taxes = Taxes(1,6,1,1);
    ...
    // Owner cannot transfer out $CANNON from this smart contract
