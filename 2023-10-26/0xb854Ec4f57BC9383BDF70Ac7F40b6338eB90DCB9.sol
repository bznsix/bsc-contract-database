...
contract KabosuCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kabosu CEO"; // 
    string private constant _symbol = unicode"$KCEO";  //    
