...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3630D12f1E280A4F30DC58eb74B3dE2f6dDf49c5; // owner address
...
contract PepeWojakTrumpCzDisasterShibaINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeWojakTrumpCzDisasterShiba INU";
    string private _symbol = "$PWTCDSINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3630D12f1E280A4F30DC58eb74B3dE2f6dDf49c5); 
    address payable public teamWalletAddress = payable(0x3630D12f1E280A4F30DC58eb74B3dE2f6dDf49c5);
