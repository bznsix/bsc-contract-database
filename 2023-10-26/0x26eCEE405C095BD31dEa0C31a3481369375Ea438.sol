...
// Telegram: https://t.me/CortexEcosystem
// Website: https://cortexnetwork.org/
// Twitter: https://twitter.com/CRTXNetwork
...
contract CRTX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cortex Network";
    string private constant _symbol = unicode"CRTX";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 300000000 * 10**_decimals;

    uint256 public _maxTransaction = 15000000 * 10**_decimals;
    uint256 public _maxWalletLimit = 15000000 * 10**_decimals;
    uint256 public _taxSwapTrigger = 300000 * 10**_decimals;
    ...
    uint256 private _buyTaxAfterReduce = 5;
    uint256 private _sellTaxAfterReduce = 5;
    ...
    function setTaxes(
        ...
        public onlyOwner {
        _buyTaxAfterReduce = taxesBuy;
        _sellTaxAfterReduce = taxesSell;
