...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf618e17e28806eFd7a11b7d2f8e917540A8Bff53 ; // owner address
...
contract LongHold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "LONG HOLD";
    string private _symbol = "LHD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf618e17e28806eFd7a11b7d2f8e917540A8Bff53); // Marketing Address
    address payable private teamWalletAddress = payable(0xf618e17e28806eFd7a11b7d2f8e917540A8Bff53); // Team Address
