...
contract Longrock is ERC20, Ownable {
    ...
    address public _market = 0xe7A46552D00015E3BAccea44b8365E31604CD0f0;
     event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Longrock", "Longrock") {
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_market] = true;
        _isExcludedFromFee[0x993877FFaA2d11AAE332356D2A9f007c40467e63] = true;
        _mint(0x993877FFaA2d11AAE332356D2A9f007c40467e63, _tTotal);
