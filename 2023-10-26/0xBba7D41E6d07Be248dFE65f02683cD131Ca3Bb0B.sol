...
contract LockTokenBSCS is Ownable {
    ...
    uint256 public constant totalAmount = 300_000 * 10 ** 18;

    uint256 public constant UnLockEachMonth = 15_000 * 10 ** 18;
    struct PrivateSaler {
        uint256 withdrawTimeUser;
        uint256 amount;
        bool isWithdraw;
    }
    address constant addressClaim = 0x44151dcd83f7230fE3a96739862013891826014F;

    mapping(uint256 => PrivateSaler) private withdrawTime;
    mapping(uint256 => bool) private setOne;
    ...
    function initWithdrawTime(
        ...
        yearsss[0] = _years;
        months[0] = _month;
        require(setOne[0] == false, "You only set time once");
