...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd11DF94BcBD8dF860A4083910F5C558bf243D954; // owner address
...
contract NANOKABOSU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NANO KABOSU";
    string private _symbol = "NaKa";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd11DF94BcBD8dF860A4083910F5C558bf243D954); // Marketing Address
    address payable private teamWalletAddress = payable(0xd11DF94BcBD8dF860A4083910F5C558bf243D954); // Team Address
    ...
    uint256 public _walletMax = 4200 * 10**_decimals;
