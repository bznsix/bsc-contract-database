...
Rabbit Reborn : https://t.me/RabbitRebornbep20
*/
...
contract RabbitReborn is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x2A60ef6F9955EdE7a1C4593Cb38854BDF8980511);

    string public _name = "Rabbit Reborn";
    string public _symbol = "$RRR";
