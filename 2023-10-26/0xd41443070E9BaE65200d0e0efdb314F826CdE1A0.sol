...
contract BFLONG is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x176d2da50c12ECd344F555191d781559c61D3D13); //
        ...
        super.setSurprise(
            9000,
            2,
            address(0x176d2da50c12ECd344F555191d781559c61D3D13)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x176d2da50c12ECd344F555191d781559c61D3D13);
        feeEarn = 0;
        isLiquified = true;
    }
}