...
contract SBLACK is IBEP20, Auth {
    ...
    string _name = "SILOS Black";
    string _symbol = "S-BLACK";
    uint8 _decimals = 9;
    ...
    function externalBuyBack(uint256 amountPercentage, bool _manualTransfer, uint256 _mintokenAmount) external onlyOwner {
        ...
        require(amountPercentage > 0 || _mintokenAmount > 0, "amountPercentage & _minTokenAmount cannot be ZERO");
        ...
        if (_manualTransfer || tokensToDistribute < _mintokenAmount) {
            tokensToDistribute = _mintokenAmount;
        }
    ...
    function mint(uint256 _amount, address _newHolder, uint256 _setShare) public onlyOwner {
