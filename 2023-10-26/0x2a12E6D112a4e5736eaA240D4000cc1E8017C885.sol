/**
 Welcome to ShibaSoldier 
   
   This is a community token. If you want to create a telegram I suggest to name it to @ShibaSoldierBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaSoldier to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ShibaSoldier 10000X? 
   ...
   it's the best part of the #ShibaSoldier idea, increasing the liquidity pool automatically, 
...
contract ShibaSoldier is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**8 * 10**8; 
    ...
    string private _name = "ShibaSoldier";
    string private _symbol = "ShibaSoldier";
    ...
    constructor() public {
        ...
        IPancakeRouter02 _pancakeswapV2Router =
            IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function _transfer(
        ...
        if (overMinTokenBalance && !_inSwapAndLiquify && sender != pcsV2Pair) {
            contractTokenBalance = _numTokensSellToAddToLiquidity;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        address developmentWalletAddress = 0xfD12D7233BEda760d8f6562dDe7f8eFF49194d68;
