/**
   ...
   Welcome to PAJEETDOG
   
   This is a community token. If you want to create a telegram I suggest to name it to @PAJEETDOGBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PAJEETDOG to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #PAJEETDOG 10000X? 
   ...
   it's the best part of the #PAJEETDOG idea, increasing the liquidity pool automatically, 
...
contract PAJEETDOG is Context, IERC20, Ownable {
    ...
    string private _name = "PAJEETDOG";
    string private _symbol = "PAJEETDOG";
