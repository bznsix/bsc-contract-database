...
//Telegram :https://t.me/Defi_Cat                  

// Twitter :https://x.com/_DEFICAT
...
contract DefiCat is Context, IERC20, Ownable {
    ...
    string private _name = "DefiCat";
    string private _symbol = "DCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2311b736d3CB16dcBC29919F1f70073D8f531d67); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2311b736d3CB16dcBC29919F1f70073D8f531d67); // BuyBack Address
