...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "HEILONG";
    string private _symbol = "HEILONG";
    ...
    uint256 public _maxHavAmount = 20 * 10**_decimals;
    ...
    address payable public _market = payable(0x00525becaeC6B0b161FD8073Cb8d21E1F451D289);
