...
contract XDoge is ERC20, Ownable {
    ...
    constructor() ERC20("XDoge", "XD") {

        address _owner = 0x23c7D54411b1e30fAc755479A7A214dD0d084629;

        _decimals = 18;

        uint256 totalSupply = 5000000000000 * (10**_decimals);
        ...
        marketingWallet = address(0x0F06f6912e4cAA0F7dd8083F1fD650b3F3a6eA78); // set as marketing wallet
    	devWallet = address(0x0F06f6912e4cAA0F7dd8083F1fD650b3F3a6eA78); // set as dev wallet
    	buyBackWallet = address(0x0F06f6912e4cAA0F7dd8083F1fD650b3F3a6eA78); // set as buyBackWallet
