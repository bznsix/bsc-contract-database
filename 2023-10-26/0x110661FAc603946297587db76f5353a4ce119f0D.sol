...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xad19a990011972e19fcCb743B9b77Bb516cc3f50 ; // owner address
...
contract MAESTROCLASSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MAESTRO CLASSIC";
    string private _symbol = "MAESTRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xad19a990011972e19fcCb743B9b77Bb516cc3f50); // Marketing Address
    address payable private teamWalletAddress = payable(0xad19a990011972e19fcCb743B9b77Bb516cc3f50); // Team Address
