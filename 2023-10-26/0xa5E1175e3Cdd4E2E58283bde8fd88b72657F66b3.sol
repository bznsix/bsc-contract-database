// BabyUnicrypt  @ https://t.me/BabyUnicryptBSC
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also BabyUnicrypted.
...
// File: contracts/BabyUnicryptDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x0E8D5504bF54D9E44260f8d153EcD5412130CaBb);
...
// File: contracts/BabyUnicrypt.sol
...
contract BabyUnicrypt is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private _devWallet = address(0x0e343f3866F1740Bc191F3F9d6220606c4D36a57);
    ...
    BabyUnicryptDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("BabyUnicrypt", "BabyUnicrypt") {
    	...
    	dividendTracker = new BabyUnicryptDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyUnicrypt: The dividend tracker already has that address");

        BabyUnicryptDividendTracker newDividendTracker = BabyUnicryptDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyUnicrypt: The new dividend tracker must be owned by the BabyUnicrypt token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyUnicrypt: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyUnicrypt: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyUnicrypt: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyUnicrypt: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyUnicrypt: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyUnicrypt: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyUnicryptBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BabyUnicrypt: This account cannot send tokens until trading is enabled");
        }
...
contract BabyUnicryptDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyUnicrypt_Dividend_Tracker", "BabyUnicrypt_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "BabyUnicrypt_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BabyUnicrypt_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyUnicrypt contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyUnicrypt_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyUnicrypt_Dividend_Tracker: Cannot update claimWait to same value");
