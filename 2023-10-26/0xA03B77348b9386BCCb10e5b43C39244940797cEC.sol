...
contract pandin is IERC20, Ownable {
    using Address for address;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Pandin";
    string constant _symbol = "PAND";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 19_000_000_000_000 * (10 ** _decimals);
