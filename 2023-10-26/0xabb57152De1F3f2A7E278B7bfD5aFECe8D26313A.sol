/**
Telegram: https://t.me/TokyoShiba
Twitter: https://twitter.com/TokyoShibaBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38169207116CC056f1Ab5dA83bd3b41e7c60c6b3; // owner address
...
contract TokyoShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tokyo Shiba";
    string private _symbol = "TOSHIB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x38169207116CC056f1Ab5dA83bd3b41e7c60c6b3); // Marketing Address
    address payable private teamWalletAddress = payable(0x38169207116CC056f1Ab5dA83bd3b41e7c60c6b3); // Team Address
