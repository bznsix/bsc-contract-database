...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Token_Dividend_Tracker", "Token_Dividend_Tracker") {
        ...
        minimumTokenBalanceForDividends = 15000 * (10**18); //must hold 15.000+ tokens
    }
...
contract CryptoTravel is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxTransactionLimit = 1_000_000 * (10**18); // 1% Max Transaction
    uint256 public MaxWalletLimit = 1_000_000 * (10**18); // 1% Max Waallet limit
    uint256 public swapTokensAtAmount = 50_000 * (10**18); // Should be Between 0.05 to 0.5% of the total supply
    ...
    constructor() ERC20("CryptoTravel", "CRT") { // Name and Symbol
        BNBRewardsFee = 0;
        liquidityFee = 1;
        extraFeeOnSell = 15; // extra fee on sell
        marketingFee = 7;
        marketingWallet = payable(0x204b296c6Bd1545dF49aa249368cBbF8DD9B30BF); // Marketing Wallet
