...
contract XTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XTiger";
    string private _symbol = "XTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0646dB6989F7C80B938E0f56c74F66703982e735); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0646dB6989F7C80B938E0f56c74F66703982e735); // Development Address
