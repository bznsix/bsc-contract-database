...
contract  ELETROEPRESSO  {
    DividendDistributor public distributor;
    IDEXRouter public router =
   // IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //rede teste
    IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    string constant _name = " ELETRO EXPRESSO V2 ";
    string constant _symbol = "ELE ";
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0xadc2C195f8bBc5F4346b20e321EfE32aD23377e0;
...
function setFeesBuy(
        ...
        buyTax =
            ...
            _burnFee;
             require(
            (buyTax + sellTax) <= 2000,
            "Buy+Sell tax cannot be more than 20%"
        );
