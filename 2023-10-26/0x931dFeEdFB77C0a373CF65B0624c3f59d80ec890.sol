...
contract OGGY3 is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = address(0xbE65BC069D8075E3A0236Ab54e8089bBa634A989);

    string private constant _name = "Oggy Inu 3.0";
    string private constant _symbol = "OGGY3";
    ...
    Taxes public taxes = Taxes(2, 3); // 2% reflection 3% marketing
