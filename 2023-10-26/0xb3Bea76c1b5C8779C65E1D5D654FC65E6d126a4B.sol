...
contract RealSmurfCat is IBEP20, Auth {
    ...
    string constant _name = "Real Smurf Cat";
    string constant _symbol = unicode"шайлушай";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 99) / 100; 
    ...
    address public marketingFeeReceiver = 0x9a0E1Ee41B3a6d9170939c363BDCB27ba72b5c64;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 35; // 0.35%
    bool inSwap;
