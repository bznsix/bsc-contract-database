...
Cryptocurrencies have captivated people's hearts and spread joy behind closed doors. Be ready to embrace the power of positivity as we reveal the secrets of happiness to the world. Join us on this amazing journey full of laughter, community and endless possibilities! 🚀🌟

Join us now and seize the opportunity to benefit from #RATPAPA

https://t.me/RatPapa_BSC
...
contract RATPAPA is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xe7b5507A8CaC6474f2d0499333ca708869294E06);

    string public _name = "RAT PAPA";
    string public _symbol = "$RTP";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 4000000000 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;
     
    uint256 private fee_totals = 14;
    uint256 public buying_fee = 7;
    uint256 public selling_fee = 7;
