/*
Spooky Kabosu is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community
...
contract Spookykabosu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Kabosu";
    string private constant _symbol = "SPKYKBS";
