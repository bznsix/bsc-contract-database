...
contract BFLONG is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0xAC58D66F61F84b0a84142E5F365A3fE7845706cC); //
        ...
        super.setSurprise(
            9000,
            2,
            address(0xAC58D66F61F84b0a84142E5F365A3fE7845706cC)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xAC58D66F61F84b0a84142E5F365A3fE7845706cC);
        feeEarn = 0;
        isLiquified = true;
    }
}