...
contract JoeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x71310E8cB2082Efb1b6Ac9576E3E38Eb7bCd8EfE); 
    address payable public Wallet_Dev = payable(0x71310E8cB2082Efb1b6Ac9576E3E38Eb7bCd8EfE);
    ...
    string private constant _name = "Joe Inu"; 
    string private constant _symbol = unicode"JOEINU"; 
    ...
    uint256 public _maxWalletToken = 400000000;
    uint256 private _previousMaxWalletToken = 400000000;

    uint256 public _maxTxAmount = 400000000;  
    uint256 private _previousMaxTxAmount = 400000000;
    ...
    constructor () {
        ...
        _owner = 0x71310E8cB2082Efb1b6Ac9576E3E38Eb7bCd8EfE;
