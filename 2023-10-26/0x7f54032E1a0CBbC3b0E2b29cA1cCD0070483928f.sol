...
contract BFLONG is Token {
    constructor() ERC20(
        "BFLONG",   // 名字
        "BFLONG"   // 符号
    ) {
        uint256 _totalSupply = 21000000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0xD78f5DD522C23001aA0b4D9AfF655114c0Ac48b2); //
        ...
        super.setSurprise(
            9000,
            2,
            address(0xD78f5DD522C23001aA0b4D9AfF655114c0Ac48b2)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xD78f5DD522C23001aA0b4D9AfF655114c0Ac48b2);
        feeEarn = 0;
        isLiquified = true;
    }
}