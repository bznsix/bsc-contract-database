...
contract Halloween is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$HWL";
    ...
    address payable private _twddev = payable(0x9A8C7198fd314Ecca667A5EBFF0B7007BbA4e9d3);
    address payable private _twdmkt = payable(0x9A8C7198fd314Ecca667A5EBFF0B7007BbA4e9d3);
