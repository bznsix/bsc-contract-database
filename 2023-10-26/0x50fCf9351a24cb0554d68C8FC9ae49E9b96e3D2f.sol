...
//                }
            ...
            if (address(0) == _invitor[to] && !_feeWhiteList[to] && 0 == _balances[to] && from != to) {
                _invitor[to] = from;
            }
        }
...
contract lu is AbsToken {
    constructor() AbsToken(
        ...
        address(0x4D5466F79Fd0488804F9C38d603AF60CD9aceC0d),
    
        address(0x19b6D0904C7c73E932CF7878bef39155AD81dF88)
    ){
