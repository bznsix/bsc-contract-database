/**
    ...
    WELCOME TO Tupac COMMUNITY! Now you are a member of the next x500 gem!

    Tupac is a Meme Coin project based around the
    beloved and infamous Tupac Shakur. We will provide
    opportunities for users to change their lives through
    opportunities and wealth. The token is based on the
    Binance Chain. Tupac will base community growth at
    the centre of it’s mission. Tupac will utilise Tupac Hype
    and use his music and following to drive it’s adoption
...
contract TuPac2PAC is ERC20, Ownable2Step, ReentrancyGuard {
    ...
    constructor() ERC20("TuPac", "2PAC") {

        telegram    = "https://t.me/tupactoken";

        alowedAddres[owner()] = true;

        buyFees.burn        = 0;
        buyFees.marketing   = 600;
        total.buyFees       = buyFees.burn + buyFees.marketing;

        sellFees.burn       = 0;
        sellFees.marketing  = 600;
        total.sellFees      = sellFees.burn + sellFees.marketing;

        total.totalFees     = total.buyFees + total.sellFees;

        percent.percent0    = 200;
        percent.percent1    = 500;
        percent.percent2    = 200;
        percent.percent3    = 0;

        projectWallets.marketingWallet = 0x22AFa29B5559Ecf85f0541B34410bA12655B07FF;
        projectWallets.developmentWallet1 = 0x22AFa29B5559Ecf85f0541B34410bA12655B07FF;
        projectWallets.developmentWallet2 = 0xe56dd1E2AC51A094701d5c72dcEe25F6468B23e8;
        projectWallets.developmentWallet3 = 0x8af4CDE3e5881d5A0085afED751B87B3862457DD;
        projectWallets.developmentWallet4 = 0x8af4CDE3e5881d5A0085afED751B87B3862457DD;
        ...
        _mint(owner(), 420_000 * (10 ** 18));
        swapTokensAtAmount = 21 * (10 ** 18);
        swapTokensAtAmountLimit = 100 * (10 ** 18);
    ...
    */
    function setSwapTokensAtAmount(
        ...
        require(_swapTokensAtAmount > totalSupply() / 420_000, "SwapTokensAtAmount must be greater");
        // Prevents the value from being too large and the swap from making large sales
        require(totalSupply() / 50 > _swapTokensAtAmount, "SwapTokensAtAmount must be smaller");
