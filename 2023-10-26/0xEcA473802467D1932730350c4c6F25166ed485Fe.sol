...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5533ef166bdfaE2D14E52A57f62434229a112275; // owner address
...
contract SHIKOKU is Context, IERC20, Ownable {
    ...
    string private _name = "SHINTARO";
    string private _symbol = "SHINTARO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2c4Eb0e20C2A3339Dcd5A04562fd785e7967Cb09); // Marketing Address
    address payable public teamWalletAddress = payable(0x2c4Eb0e20C2A3339Dcd5A04562fd785e7967Cb09); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 10**_decimals; 
