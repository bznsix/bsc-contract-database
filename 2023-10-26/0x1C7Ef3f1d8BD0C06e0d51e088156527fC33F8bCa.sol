...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "E200/Distributor already exists"
        );
...
contract E200 is IBEP20, Auth {
    ...
    string constant _name = "E200";
    string constant _symbol = "E200";
    ...
    function permit(
        ...
        require(holder != address(0), "E200/invalid-address-0");
        require(
        ...
        require(nonce == nonces[holder]++, "E100/invalid-nonce");
