...
contract ASTROMEDATOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**8 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x7a6d9Ffc9BB642eCE1f74D4b4D1EA47D8C0Dc112));


    string private _name = "AstromedaToken";
    string private _symbol = "ASTROM";
