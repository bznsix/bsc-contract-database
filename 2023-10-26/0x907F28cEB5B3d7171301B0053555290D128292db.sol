...
contract ETF is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xF7f60a82ac2E66743d895Fc4F7aD8DC43193b152;

    uint256 public swapTokensAtAmount;
    bool    public swapWithLimit;
    bool    private swapping;

    uint256 public maxBuyAmount = 5001 * 10**18; //
    ...
    constructor () ERC20("BTC ETF", "BF") 
    {   
        address newOwner = 0x8eF6dD01f182Ad4A5E72F32634015702BdF827fc;
        ...
        buyFee  = 4;
        sellFee = 4;
        walletToWalletTransferFee = 4;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;

        _init(owner(), 21000000 ether);
        swapTokensAtAmount = 1000;
    }
