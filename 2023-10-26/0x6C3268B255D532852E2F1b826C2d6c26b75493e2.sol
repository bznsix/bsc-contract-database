...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI-1SATELLITE";
    string private _symbol = "FLOKI-1SAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x94C1aD627621232361dd0926443B34A3e8A7cC1b); // Marketing Address
    address payable public teamWalletAddress = payable(0x94C1aD627621232361dd0926443B34A3e8A7cC1b); // Team Address
