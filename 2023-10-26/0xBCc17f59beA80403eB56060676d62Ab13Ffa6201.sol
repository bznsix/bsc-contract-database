/**
  #Bitzlato
   ...
   #DOJ Takes Enforcement Action Against Russian Exchange Bitzlato.
   #I knew I shouldn't have kept funds on Bitzlato
   #DOJ caught a big one today, excellent work.

   #Bitzlato will list on #BSC.

   I make this #Bitzlato  to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/BitzlatoChat

   Great features:
   2% fee auto add to the marketing Wallet 
 
   I will burn 50% liquidity LPs to burn addresses to lock the pool forever.
   I will burn 500% liquidity LPs to burn addresses，When the holder reaches 3000.


   I will renounce the ownership to burn addresses to transfer #Bitzlato to the community and ensure it's 100% safe.

   I will add 1 bnb and 100% of the total supply to the pool.
   Can you make #Bitzlato " 10000000000X"? 
...
contract Bitzlato is Context, IERC20, Ownable {
    ...
    string private _name = "Bitzlato";
    string private _symbol = "Bitzlato";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD096b1E2d9cA5d095Bb88931621a19130e37B371);
    address payable public liqWalletAddress = payable(0xD096b1E2d9cA5d095Bb88931621a19130e37B371);
