...
//TELEGRAM: https://t.me/HalloPooh
//TWITTER:  https://twitter.com/HalloPooh

//In the enchanting realm of internet culture, there emerges a meme that brilliantly fuses the heartwarming 
//nostalgia of a childhood favorite with the spooky charm of Halloween. Say hello to the "Hallo-Pooh Meme," 
//a delightful internet sensation that brings together the iconic Winnie the Pooh and the playful spirit of All Hallows' Eve.
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7bA2bEB3998C8c035ac205bb97633C494d0B165a ;
...
contract HALLOPOOH is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLO-POOH"; // 
    string private constant _symbol = "$HPOOH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x7bA2bEB3998C8c035ac205bb97633C494d0B165a);
