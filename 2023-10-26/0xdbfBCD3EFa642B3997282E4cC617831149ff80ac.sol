/**
       ...
       Welcome to #Tokyo Floki Inu
       
       //Fair launching @50 members
       // Tg : t.me/Tokyofloki
       ...
       I will renounce the ownership to burn addresses to transfer #TokyoflokiInu to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 10% total supply to the pool
       Can you make #TokyoFlokiInu 10000X? 
       ...
       it's the best part of the #TokyoFlokiInu idea, increasing the liquidity pool automatically, 
...
contract Tokki is Context, IERC20, Ownable {
    ...
    string private _name = "Tokyo Floki Inu";
    string private _symbol = "TOKKI";
    ...
    constructor (address payable addr1) {
        _charityWalletAddress = addr1;
        _rOwned[owner()] = _rTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD4F04999AaE93c8EcaFA68047ca022f13fA201f9); //TEST
    ...
    address private burnAccount = 0x000000000000000000000000000000000000dEaD;
