...
contract COWshitToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable ETH=0x55d398326f99059fF775485246999027B3197955;

    uint256 public swapTokensAtAmount;

    mapping(address => bool) public _rewardList;

    uint256 public buy_marketingFee = 200;
    uint256 public buy_liquidityFee = 0;
    uint256 public buy_ETHRewardsFee= 300;
    uint256 public buy_totalFees = 500;
    uint256 public buy_burnFee = 0;

    uint256 public sell_marketingFee = 200;
    uint256 public sell_liquidityFee = 0;
    uint256 public sell_ETHRewardsFee = 300;
    uint256 public sell_totalFees = 500;
    uint256 public sell_burnFee = 0;

    bool public enableOffTrade = true;
    bool public enableKillBlock = true;
    bool public enableRewardList =true;
    bool public enableSwapLimit = false;
    bool public enableWalletLimit = false;
    bool public enableChangeTax = true;

    address public fundAddress =0xee1dA95De87677D7E53A27Ac7D6f7CEEadbdEc2c;
    address public _swapRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    uint256 public kb = 3;
    uint256 public maxSellAmount = 10000*10**18;
    uint256 public maxBuyAmount = 10000*10**18;
    uint256 public maxWalletAmount = 10000*10**18;
    uint256 public startTradeBlock;
    uint256 public mushHoldNum = 5000000*10**18;
    ...
    ) ERC20("COWshit", "COWshit") {
    

        uint256 __totalSupply = 100000000*10**18;
