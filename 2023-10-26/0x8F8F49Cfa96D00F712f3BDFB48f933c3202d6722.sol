...
contract PRiNCE is LpDividendUSDT, ExcludedFromFeeList, FirstLaunch, MaxHave {
    uint256 total_supply = 2100 ether;
    address constant marketAddr = 0xbEA11BD7Eca657cEb0bA19C8468F5F3f574c3C3B;

    bool public presale;
    uint256 public lastSwapTime;
    uint256 public numTokensSellToAddToLiquidity = 0.01 ether;

    constructor() Owned(msg.sender) MaxHave(3 ether) ERC20(unicode"PRiNCE", unicode"PRiNCE", 18, total_supply) {
        excludeFromFee(msg.sender);
        excludeFromFee(address(this));
        isHavLimitExempt[uniswapV2Pair] = true;
        isHavLimitExempt[marketAddr] = true;
    ...
    function swapTokensForUSDT(uint256 tokenAmount) internal {
        ...
        uint256 toMarket = amount * 4 / 5;
        uint256 toLp = amount - toMarket;

        IERC20(USDT).transferFrom(address(distributor), marketAddr, toMarket);
    ...
    function killBot(address sender, address recipient, uint256 amount) private {
        ...
        super._transfer(sender, 0xD7156D0De7f8C3DCf0967D11be87261E5316107c, fee);
