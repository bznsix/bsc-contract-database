...
contract WoddyBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "WoddyBear";
    string private constant _symbol = "$WBEAR";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x3f1b5d7EbEF57fc652d0AF1D7e3d6fcd32F51715);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x3f1b5d7EbEF57fc652d0AF1D7e3d6fcd32F51715] = true;
