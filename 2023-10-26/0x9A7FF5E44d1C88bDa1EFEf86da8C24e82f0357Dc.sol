...
contract BTCETF is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x4419EC9263A8c20d6275De7CCea029d7cD805F37);
    address payable private _twdmkt = payable(0x4419EC9263A8c20d6275De7CCea029d7cD805F37);
    
    string private constant _name = "BTC ETF";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (to != deadAddress &&
            ...
            uint256 maxWalletTokens = _maxWallet.mul(_tTotal).div(100);
