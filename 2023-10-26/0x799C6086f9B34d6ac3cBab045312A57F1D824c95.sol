...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x322f784b33E95b3Cea40fF80b3433637b22A604c ;
...
contract BAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "B-APE"; // 
    string private constant _symbol = "$BAPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x322f784b33E95b3Cea40fF80b3433637b22A604c);
