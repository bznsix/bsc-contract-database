/**
                    BABY ETH || Stealth Launch

 Tokenomics : 
    - 10% Tax (2% Reward, 3% Team, 5% Marketing)
    - LP will be locked
...
contract BABYETH is IBEP20, Auth {
    ...
    string constant _name = "BABY ETH";
    string constant _symbol = "BET";
    ...
    uint256 _totalSupply = 690* 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 690 * 10**9 * (10 ** _decimals);
    uint256 public _walletMax = 690 * 10**9 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 10 * 10**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0022dE670F58cEf50537235ec727756Fa5E1C5A3;
        marketingWallet = 0x0022dE670F58cEf50537235ec727756Fa5E1C5A3;
        devWallet = 0x0022dE670F58cEf50537235ec727756Fa5E1C5A3;
