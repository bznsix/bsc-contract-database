/**
// https://X.com/Spooky_drag2023
// https://t.me/SpookyDragon
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0932C4814406F8415319AC4D72D854DB1c08482d; // owner address
...
contract SPOOKYDRAGON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPOOKY DRAGON";
    string private _symbol = "SD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0932C4814406F8415319AC4D72D854DB1c08482d); // Marketing Address
    address payable private teamWalletAddress = payable(0x0932C4814406F8415319AC4D72D854DB1c08482d); // Team Address
