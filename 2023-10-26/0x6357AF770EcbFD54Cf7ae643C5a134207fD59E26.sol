...
// File contracts/access/DeployerOwnable.sol
...
/**
 * @title DeployerOwnable
 * @dev Ownable contract with deployer set as initial owner.
 */
abstract contract DeployerOwnable is Ownable {
    /**
...
// File contracts/access/BEP20DeployerOwnable.sol
...
/**
 * @title BEP20DeployerOwnable
 * @dev Use DeployerOwnable and adds the required `getOwner` method for BEP20.
 */
abstract contract BEP20DeployerOwnable is DeployerOwnable {
    /**
 ...
 */
contract HelloBEP20 is ERC20, BEP20DeployerOwnable, TokenGeneratorLink, ServicePayer {
    constructor(
        string memory name_,
        ...
        super._mint(_msgSender(), 10000e18);
    }
}
