...
contract FatToken is BaseFatToken {
    ...
    constructor(
        ...
        fundAddress = 0x51bC34Eff13cB049bADA3c165dCd9096C179dfCE;
    ...
    function setAirDropEnable(bool status) public onlyOwner {
      ...
      function buyFundFee(uint256 buyFundFee) external onlyOwner {
        _buyFundFee =  buyFundFee;
    }

      function sellBurnFee(uint256 sellFundFee) external onlyOwner {
        _sellBurnFee=  sellFundFee;
    }
    ...
    uint256 public transferFee = 3000;
