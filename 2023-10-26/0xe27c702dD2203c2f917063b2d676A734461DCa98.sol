...
contract BQUS is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 600000 * 10**18;
    address public marketingWallet = (0xaB3dcD6Efc50868Ae70918f856e92EA5aeDf67bD);
    ...
    constructor() BEP20("BLOQUS OFFICIAL", "BQUS") {
        ...
        exemptFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; // BSC PinkSale Lock
        exemptFee[0x5E5b9bE5fd939c578ABE5800a90C566eeEbA44a5] = true; // Tesnet PinkSale Lock
        exemptFee[0xeBb415084Ce323338CFD3174162964CC23753dFD] = true; // Arbitrum PinkSale Lock
        exemptFee[0x71B5759d73262FBb223956913ecF4ecC51057641] = true; // ETH PinkSale Lock
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= 2000000, "Swap threshold amount should be lower or equal to 1% of tokens");
        tokenLiquidityThreshold = new_amount * 10**decimals();
    }

   
     function SetBuyTaxes(uint256 _marketing, uint256 _liquidity, uint256 _burn) external onlyOwner {
        buytaxes = Taxes(_marketing, _liquidity, _burn);
