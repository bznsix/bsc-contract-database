...
abstract contract ABCToken is ERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeSwapFee) {
            uint256 fundFees = tAmount.mul(25).div(1000);
            uint256 repoFees = tAmount.mul(15).div(1000);
...
contract LuckyLONG is ABCToken {
    constructor()
        ABCToken(
            ...
            "Lucky LONG", //Name
            "LL", //Symbol
            20240000 * 10**18, //Supply
            address(0x514E1959e0dBbE4F47B315A9afD59aB216f9A0cD), //LPAddress
            address(0x97434BF1edD8A57F6bdc7FA45148D756c9a9Cf93), //FundAddress
            address(0x7ee128bc110A1A8f4C165D0825c3Fd8becAC1a5b), //RepoPoolAddress
