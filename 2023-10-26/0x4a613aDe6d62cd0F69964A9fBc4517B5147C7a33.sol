...
contract GLORYHOLE is AccessControl, Context, IBEP20, Ownable {
    ...
    string private _name = "Gloryhole";
    string private _symbol = "GLORYHOLE";
    uint8 private _decimals = 8;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _total = 1 * 10**10 * 10**8; // 10 billion
    uint256 public _baseLineLiqFee = 8;
    uint256 public _liquidityFee = _baseLineLiqFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _burnAmount = 20; // 2%
    ...
    address private immutable liquidityWallet = 0xe5051093b7CDCB0C122A80Ec9773bd4Bf4B058c8;
    bool inSwapAndLiquify;

    uint256 public _maxTxAmount = _total.div(10**2).mul(1); // 1% of total supply 
    uint256 public _numTokensSellToAddToLiquidity = _total.div(10**4).mul(5); // 0.25% total supply
    uint256 private _lastLiquidifyTimeStamp = 0;
    uint256 public _maxWalletToken = _total.div(10**2).mul(2); // 2% total supply
    ...
    function _transfer(
        ...
        if (
            ...
            !inSwapAndLiquify &&
            _whoSends != pcsV2Pair &&
            block.timestamp - _lastLiquidifyTimeStamp > 20
        ) {
            _lastLiquidifyTimeStamp = block.timestamp;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquidtyPortion = contractTokenBalance.div(10**2).mul(5);
    ...
    function liquidify() external {
        ...
        swapTokensForBNB(balanceOf(address(this)), address(this));
