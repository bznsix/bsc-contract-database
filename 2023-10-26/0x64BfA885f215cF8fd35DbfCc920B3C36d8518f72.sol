...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    // Used as the URI for all token types by relying on ID substitution, e.g. https://coffee-casual-seahorse-765.mypinata.cloud/ipfs/Qmb1kYiaAGhRk3nCy667wycfZCh6RPRm6Uz1d1JPRRHkon?_gl=1*a79p00*_ga*NjQ0ODI4NzY4LjE2OTgxNTQzODQ.*_ga_5RMPXG14TE*MTY5ODE1NDM4NS4xLjEuMTY5ODE1NDY5OC41NC4wLjA.json
    string public _uri;
