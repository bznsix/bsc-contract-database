...
contract Nothing404 is Context, IERC20, Ownable {
    ...
    string private _name = "Nothing404.com";
    string private _symbol = "4️⃣0️⃣4️⃣";
...
// Bot End here
    ...
    // Nothing404 Fixed SSL- | Incorrect error message error
    ...
    // Nothing404 Fixed the condition
