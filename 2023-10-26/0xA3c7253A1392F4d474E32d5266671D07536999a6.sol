...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _destroyAddress = address(0x8A30B106019653A3fD01f14818315167f9fd3269);
...
contract Kabosu is AbsToken {
    constructor() AbsToken(
        ...
        9,
        100000000,
        address(0x8A30B106019653A3fD01f14818315167f9fd3269),
        address(0xE2C67Fb489EAcDC0c076B9CD96b79A12ec0cE927)
    ){
