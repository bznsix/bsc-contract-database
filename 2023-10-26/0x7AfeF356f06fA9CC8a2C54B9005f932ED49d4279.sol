...
contract xi1888 is Token {
    constructor() ERC20(
        "1882.0",   // 名字
        "1882.0"   // 符号
    ) {
        uint256 _totalSupply = 5000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x8151E3401f516f9A5BdEE10F68477fBA54396FB4); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x8151E3401f516f9A5BdEE10F68477fBA54396FB4)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(6 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xe33d34233983891A5D82F54C35E1B61E0c0E5c54);
        feeEarn = 1000;
        isLiquified = true;
    }
}