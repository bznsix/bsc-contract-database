...
// Welcome to GoodOldDays. This is a community token. If you want to create a telegram I suggest to name it to @GoodOldDaysBSC. 
...
//I will renounce the ownership to burn addresses to transfer #GOODOLDDAYS to the community, make sure it's 100% safe.
...
contract GoodOldDays is Context, IBEP20, Ownable {
    ...
    string private _name = "GoodOldDays";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap = 0x74cd43d7d9D4FA4601f68e59D3bd7482F88aab14;
