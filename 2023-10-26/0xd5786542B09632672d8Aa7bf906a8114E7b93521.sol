/**
    TELEGRAM : https://t.me/xflokibep20
    WEBSITE : https://xflokibep20.com
*/
...
contract xFLOKI is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5000000 * 10**_decimals; //
    
    uint256 public maxSellAmount = 20000000 * 10**_decimals; //
    uint256 public maxBuyAmount = 20000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 20000000 * 10**_decimals; //

    address public marketingAddress = 0x432E66de6eee74740F05973be5a649633f0d3944; //
    address public devAddress = 0x432E66de6eee74740F05973be5a649633f0d3944; //
