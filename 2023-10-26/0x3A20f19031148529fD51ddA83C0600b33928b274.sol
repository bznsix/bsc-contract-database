...
contract RipMaestro is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Maestro";
    string private constant _symbol = "RipMaestro";
    uint8 private constant _decimals = 18;

    
    address payable public marketingAddress =
        payable(0xEF9E74778DB90D810587AA85f97900b720b28d3A); // Marketing Address
        
    address payable public teamAddress =
        payable(0xEF9E74778DB90D810587AA85f97900b720b28d3A); // Team Address
        
    address payable public liquidityAddress =
        payable(0xEF9E74778DB90D810587AA85f97900b720b28d3A); // Liquidity Address
        ...
        onlyOwner
    {
        ...
        function updateMaxes(uint256 amount) external onlyOwner {
