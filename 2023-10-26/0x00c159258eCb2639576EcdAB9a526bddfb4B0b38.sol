//Telegram: https://t.me/flokitwozerobsc
...
contract FlokiTwoZero is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Floki2.0";
    string private _symbol = unicode"Flo2.0";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3E564e775434f135D44c169ae23155149C1787a4);
    address payable private taxWallet2 = payable(0x3E564e775434f135D44c169ae23155149C1787a4);
    ...
    uint256 private _totalSupply = 20_202_020 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*20202020/20202020;
    uint256 public _walletMax = _totalSupply*20202020/20202020;
    uint256 private minimumTokensBeforeSwap = _totalSupply*20202020/20202020; 
