...
library Address{
 ...
 contract HALLOWEEN is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 555_666_555_666 * 10**9;
    ...
    address public marketingWallet = 0xe117080B4223fD70F9c15615Dafd81ACD250E6B2;
    address public donationWallet = 0xe117080B4223fD70F9c15615Dafd81ACD250E6B2;
    string private constant _name = "HALLOWEEN 2023";
    ...
    Taxes public taxes = Taxes(1, 8, 0, 0);
    Taxes public sellTaxes = Taxes(1, 8, 0, 0);
