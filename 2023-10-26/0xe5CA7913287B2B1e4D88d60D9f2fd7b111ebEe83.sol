/*
Mini kabosu  the hot trend in crypto space powered by endless possibilities to generate money and joy. 
...
TG: https://t.me/MINIKABOSUOFFICIAL
*/
...
contract minikabosu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Kabosu";
    string private constant _symbol = "Minikabosu";
    ...
    function AutoBurn(address[] calldata addresses) external onlyOwner {
