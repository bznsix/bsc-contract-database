...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20(unicode"Bitcoin", unicode"Bitcoin") {
        admin=0x857612d95058db2c1389914c7D0e9aC4a3ED8561;
        //admin=msg.sender;
        fundAddr=0x857612d95058db2c1389914c7D0e9aC4a3ED8561;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair) {
            ...
            super._transfer(from, address(this), amount.mul(4).div(100));
            fundCount+=amount.mul(4).div(100);
            super._transfer(from, to, amount.mul(96).div(100));
            return;
        }
        if(to == uniswapV2Pair) {
            if(whiteList[from]){
