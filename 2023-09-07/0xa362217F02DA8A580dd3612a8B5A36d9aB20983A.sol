...
/*
TG : https://t.me/babyminakoo
Twitter : https://twitter.com/babyminako
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xcF75B10C331E54707b1E0932Bb24CB0E0bD5fB1d); //Pinta cripto
...
contract babyminako is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "baby minako 2.0";
    string constant _symbol = "BBM2.0";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xcF75B10C331E54707b1E0932Bb24CB0E0bD5fB1d; //pinta cripto

    uint256 _totalSupply = 46000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100;
    uint256 public _walletMax = _totalSupply * 6 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[address(0xb06F86A7f39C4ce34754120FE14016C92A2EEAd9)] = true;


        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[pair] = true;
        isTxLimitExempt[address(0xb06F86A7f39C4ce34754120FE14016C92A2EEAd9)] = true;
        ...
        // NICE!
        autoLiquidityReceiver = 0xCB709d94730dFbaa304f69c8F3f0b1d58e778DE0;
        marketingWallet = 0xfdFc796cae12f421ec377281EAcC9fBAf4db232c;
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(devFee));
        totalFeeIfSelling = totalFee + 4;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 extraSellFee) external authorized {
