...
contract USERToken is Context, IERC20, MultiSignWallet, ReentrancyGuard {
    ...
    */
    ...
    constructor (address routerAddress, address[] memory _owners, uint256 _requiredWallet) MultiSignWallet(_owners, _requiredWallet) {
    ...
    function claimHODLRewards(address forUser, address outToken) public onlyWhenHodlRewardEnabled nonReentrant{
    ...
    function spinovation() external nonReentrant{
    ...
    function claimUsdtRewards() external onlyWhenUsdtRewardEnabled nonReentrant{
        address owner = _msgSender();
    ...
    function claimNFT_F_rewards() public nonReentrant{
        address owner = _msgSender();
    ...
    function claimNFT_L2_rewards() public nonReentrant{
        address owner = _msgSender();
    ...
    function claimNFT_L3_rewards() public nonReentrant{
        address owner = _msgSender();
