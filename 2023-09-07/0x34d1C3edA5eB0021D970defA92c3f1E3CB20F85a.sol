...
contract PEPETHE4TH is ERC20, Ownable {
    ...
    address public devWallet = 0x2A2a22Ca799fF85CdfB8f6bD39673Ff60Ad9D4CC;
    ...
    constructor() ERC20("PEPEthe4TH", "PEPETHE4TH") {
    ...
    function updateTax(
        ...
        require(
            (buyDevTax + buyLiquidityTax) <= 10,
            "Can't set tax greater than 10%"
        );
        require(
            (sellDevTax + sellLiquidityTax) <= 10,
            "Can't set tax greater than 10%"
        );
