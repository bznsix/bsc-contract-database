...
contract Richie_Rich is ERC20, ERC20Burnable, Ownable, DividendTrackerFunctions {
    ...
    constructor()
        ERC20(unicode"Richie Rich", unicode"RICHIE") 
    {
        address supplyRecipient = 0x669ACf46050d40c78946768BBe99bb8A6044d1B6;
        
        updateSwapThreshold(5000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0xe62BFD4805732E8ccC01B8cD056002DabdfBc059);
        marketingFeesSetup(300, 200, 0);

        autoBurnFeesSetup(0, 100, 0);

        lpTokensReceiverSetup(0x669ACf46050d40c78946768BBe99bb8A6044d1B6);
        liquidityFeesSetup(200, 300, 0);

        _deployDividendTracker(21600, 1000 * (10 ** decimals()) / 10, 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);

        gasForProcessingSetup(300000);
        rewardsFeesSetup(500, 400, 0);
        ...
        _transferOwnership(0x669ACf46050d40c78946768BBe99bb8A6044d1B6);
    }
