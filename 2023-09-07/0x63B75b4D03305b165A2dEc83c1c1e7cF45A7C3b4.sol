...
contract Kaizoku is Context, IBEP20, Ownable {
    ...
    uint256 private _totalSupply = 41000000000000000 * 1e18;
    uint8 private _decimals = 18;
    string private _symbol = "KZK";
    string private _name = "Kaizoku";

    address payable private devWallet =
        payable(0xb0EF1Fb58F51519e3044a7A3323D4eCf143dFbc3);
    ...
    //WALLET LIMITS
    uint256 public _maxWalletToken = _totalSupply.mul(30).div(100);
    ...
    */
    ...
    function _set_Fees(
        ...
        require(
            (Buy_Fee + Sell_Fee + Transfer_Fee) <= maxPossibleFee,
            "Fee is too high!"
        );
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    /**
     * @dev Toggle on and off to auto process tokens to BNB wallet
     */
    ...
    /**
     * @dev This will set the number of transactions required before the 'swapAndLiquify' function triggers
     */
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        devWallet.transfer(contractBNB);
    }
