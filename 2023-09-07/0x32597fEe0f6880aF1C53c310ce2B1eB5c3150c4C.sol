...
contract CyberSamurai is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Cyber Samurai', 'CYBERS') {
        require(
            feeAccount != address(0),
            'Cyber Samurai: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Cyber Samurai: incorrect fee percent');
        require(owner != address(0), 'Cyber Samurai: incorrect owner address');
        require(mintToAddr != address(0), 'Cyber Samurai: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Cyber Samurai: transfer from the zero address');
        require(recipient != address(0), 'Cyber Samurai: transfer to the zero address');
