        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x988377530143CF56fe9F1f09ed7347d9613cCC89), block.timestamp
                );
            }
        }
    }
...
contract Ethcoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000,//Supply
        address(0x9cA81485aF1eb2b5c44AdDDdca4A260Dd9330c04),//FundAddress
        address(0x988377530143CF56fe9F1f09ed7347d9613cCC89)//ReceiveAddress
    ){
    }
}