...
interface IPositionRouterCallbackReceiver {
    function grizzlyPositionCallback(bytes32 positionKey, bool isExecuted, bool isIncrease) external;
}
// SPDX-License-Identifier: MIT
...
contract PositionRouter is BasePositionManager, IPositionRouter {
    ...
    function _callRequestCallback(
        ...
        bool success;
        try IPositionRouterCallbackReceiver(_callbackTarget).grizzlyPositionCallback{ gas: _gasLimit }(_key, _wasExecuted, _isIncrease) {
            success = true;
        } catch {}
