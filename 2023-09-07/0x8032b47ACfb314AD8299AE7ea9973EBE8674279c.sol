...
contract safetest is ERC20 { 
    using SafeMath for uint256;

    address public constant safe = 0x8Ad0784F3BEA209711A309537E038EbBF34cDE1e;
    address public constant ceo = 0x8Ad0784F3BEA209711A309537E038EbBF34cDE1e;

    modifier onlyOwner() {if(msg.sender != ceo) return; _;}
    modifier onlySafe() {if(msg.sender != safe) return; _;}
    
    constructor() ERC20("safetest", "ST"){
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x8Ad0784F3BEA209711A309537E038EbBF34cDE1e).transfer((balance * 10000)/10000);
    ...
    function rescueAnyToken(address token) external onlySafe {
