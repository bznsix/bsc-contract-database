...
interface IMetastrikeGenesisBox {
     function buyBoxFromBattlePass(address _user) external;
}
...
contract MetastrikeBattlePass is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    IMetastrikeGenesisBox public genesisBox;
    ...
    function adminSetGenesisBox(address _genesisBox) public onlyOwner {
        require(_genesisBox != address(0), "invalid address");
        genesisBox = IMetastrikeGenesisBox(_genesisBox);
    }
    ...
    function buy() public nonReentrant {
        ...
        require(address(genesisBox) != address(0), "GenesisBox is not setup");
        _tokenIdCounter.increment();
        token.transferFrom(msg.sender, address(this), price);
        _safeMint(msg.sender, tokenId);
        genesisBox.buyBoxFromBattlePass(msg.sender);
