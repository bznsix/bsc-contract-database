...
// File: contracts/VibeSoGroovy.sol
/*
...
contract VibeSoGroovy is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxMintAmountPerTx = 32;
  ...
  constructor(
  ) ERC721A("Vibe So Groovy - Bamboo", "VIBE") {
      setHiddenUri("ipfs://QmNxYVhRQH9DtoqS8kudGpoj8vPxigoyCnec2EmMsnftdd/VibeSoGroovy.json");
      payments = payable(0x53913c4c381403ac6a1fa14A86e49473d43b98ad);
  }
...
function resetFinalMaxSupply() public onlyOwner {
  ...
  function updateMetadata(string memory _uriPrefix) public onlyOwner {
  ...
  function setPaused(bool _state) public onlyOwner {
    ...
    function withdrawToken(IERC20 token) public onlyOwner {
        require(token.transfer(payments, token.balanceOf(address(this))));
    }
