...
/**
 * @dev Token with mintable token creation only during the deployement of the token contract */
...
contract DeepRootsContract is Ownable{
 ...
 function setBNBDecimal(uint8 _value) onlyAuthorized public returns (bool){
    bnbdecimals =  _value;
    return true;
  }
...
function buy(address referralAddress, uint256 reflag) public payable {
         ...
         */
         ...
         uint256 amountTobuy = SafeMath.div(msg.value*_TOKEN_PRICE,10**bnbdecimals);
