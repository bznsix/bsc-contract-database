...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x8Cc51c61F26864A8862214b9e68030FC079280Bc; // owner address
...
contract XPRO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb12307b29af8Bc7F7D30c6e2796C8cD2efb993d1); 
    address payable public teamWalletAddress = payable(0xb12307b29af8Bc7F7D30c6e2796C8cD2efb993d1);
    ...
    uint256 private _totalSupply = 3000000000000000000 * 10**_decimals;
