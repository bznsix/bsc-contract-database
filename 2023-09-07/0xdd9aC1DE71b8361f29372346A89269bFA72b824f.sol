...
contract RevExoticVehicles is BEP20Feeable, ERC20Burnable {
    string private _name = "RevExoticVehicles";
    string private _symbol = "REV";
    ...
    function _beforeTokenTransfer(
        ...
        if (_shouldTakeFee(from, to)) {
            ...
            require(
                ...
                "REV: transfer amount with fees exceeds balance"
            );
            // vault fees
    ...
    function setVault(address newVault) external onlyOwner {
        require(vault != newVault, "REV: vault address cannot be the same");
    ...
    function setDividend(address newDividend) external onlyOwner {
        require(
            ...
            "REV: dividend address cannot be the same"
        );
