...
//--- Contract v2 ---//
contract xAIBOT is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xBD8176c53c7294dC27b65e1bDD08edB95da2e81E);


    IRouter02 public swapRouter;
    string constant private _name = "xAIBOT";
    string constant private _symbol = "xAIBOT";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        event updateFees(uint256 buy, uint256 sell, uint256 newTransfer);
        function changeFees(uint256 buy, uint256 sell, uint256 newTransfer) external onlyOwner {
            require(buy <= 10);
            require(sell <= 10);
            require(newTransfer <= 10);

            buyfee = buy * 10;
            sellfee = sell * 10;
            transferfee = newTransfer * 10;
            
            emit updateFees(buyfee, sellfee, transferfee);
        }
}