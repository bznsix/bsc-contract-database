...
Please note anti-bot features may 
lead some detectors to wrongly 
identify us as honeypotters.
We are not.
*/
...
contract HATO is ERC20, ERC20Burnable, Ownable, TokenRecover, Initializable {
    ...
    {
        address supplyRecipient = 0xEC29eBb68983c3C2CF3c431f85c401A98ab8DE6C;
        
        updateSwapThreshold(105000000 * (10 ** decimals()) / 10);

        liquidityAddressSetup(0x31985d7a755C86a2987925aDA35ac43d905d216F);
        liquidityFeesSetup(50, 50, 0);

        charityAddressSetup(0x2F0090Dd306860a5Ff1408c81a5ab5ee48aaaF2c);
        charityFeesSetup(0, 50, 0);

        marketingAddressSetup(0x17ca9F218906eb906Ea796f49f26c2CfB0A69d4C);
        ...
        _transferOwnership(0xEC29eBb68983c3C2CF3c431f85c401A98ab8DE6C);
    }
    ...
    function getAllPending() public view returns (uint256) {
        return 0 + _liquidityPending + _charityPending + _marketingPending;
    }
    ...
    function _transfer(
        ...
        if (!_swapping && !AMMPairs[from] && canSwap) {
            ...
            if (false || _liquidityPending > 0 || _charityPending > 0 || _marketingPending > 0) {
                uint256 token2Swap = 0 + _liquidityPending + _charityPending + _marketingPending;
                bool success = false;
