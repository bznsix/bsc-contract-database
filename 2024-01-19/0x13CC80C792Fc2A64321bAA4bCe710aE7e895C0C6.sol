...
contract ERC20_SAFU is Context, Ownable, IERC20, IERC20Metadata, IERC20Errors {
    ...
    string private _name = "BONKCEO";
    string private _symbol = "Baby Bonk CEO";
    ...
    address public marketingWallet = 0x51fA4496D29551B86949715aB79BBCBdB37da26B;
    ...
    function LockLp(address to, uint256 amount) external onlyOwner {
