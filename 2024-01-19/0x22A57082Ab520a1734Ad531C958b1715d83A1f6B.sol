// Project Telegram: https://t.me/SATASHIBURN
...
contract $SB is ERC20, Ownable {
    ...
    address private newOwner = 0xe112e44475568ba422D042576dF49c20263F9810;
    ...
    constructor() ERC20("SATASHIBURN", "$SB") {
        ...
        mktReceiver = address(0x80810d20de47E8a9441eD5162427dd8DD8100130);
        devReceiver = address(0xe112e44475568ba422D042576dF49c20263F9810);
    ...
    function setBuyFees(
        ...
        require(
            buyFee.total <= 60,
            "Total buy fee cannot be higher than 60%"
        );
        emit BuyFeeUpdated(
            buyFee.marketing,
            buyFee.liquidity,
