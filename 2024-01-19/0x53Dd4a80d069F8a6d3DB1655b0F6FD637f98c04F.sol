...
contract SnailStake2 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        apy = 244; // 244% rewards 244 days 
        lockDuration = 244 days;
        exitPenaltyPerc = 10;
    ...
    function updatelockduration(uint256 newlockDuration) external onlyOwner {
        require(newlockDuration <= 21799615, "Duration must be below 252 days");
