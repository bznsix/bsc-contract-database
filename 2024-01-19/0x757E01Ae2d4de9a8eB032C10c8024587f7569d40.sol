...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public tofund = 60;
    function setTofun(uint256 newValue) public onlyOwner{
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAndBuyBack = fistBalance * (_buyFundFee + _sellFundFee) * 2 / swapFee;
        uint256 fundAmount = fundAndBuyBack * tofund / 100;
        uint256 toBuyBack = fundAndBuyBack - fundAmount;
        if (fundAmount > 0){
        ...
        if (toBuyBack > 0){
            FIST.transferFrom(address(_tokenDistributor), address(this), toBuyBack);
            address[] memory buyBackPath = new address[](2);
            buyBackPath[0] = address(_usdt);
            buyBackPath[1] = address(0xCF5B48BD28Dc1459ad575c0c83A839feF2A463bc);
            try _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                toBuyBack,
                0,
                buyBackPath,
        ...
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAndBuyBack);
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        888000000000000,
        address(0x3cF3A6c379B8E5d17eAA304978Fdee3b72E1f950),
        address(0x252FdAF3237E0925833bFaBeD41af663F1228C84),
        address(msg.sender)
    ){}
}