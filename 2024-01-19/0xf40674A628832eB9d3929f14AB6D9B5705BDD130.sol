 ...
 * manner, since when dealing with GSN meta-transactions the account sending andw
...
contract WorldOfDypians is ERC721A, Ownable {
     ...
     */
    function initialWODTest(address to) public onlyOwner {        
        _safeMint(to, 10);
    }

     function restWOD(address to) public onlyOwner {        
        _safeMint(to, 495);
    }
