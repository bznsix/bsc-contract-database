...
abstract contract SpaceToken is IERC20, Ownable {
    ...
    uint256 public _hotFee = 100;
    uint256 public _maxBuyTax = 500;
    ...
    constructor (
        ...
        address FundAddress, address MarkAddress,address HotAddress, address ReceiveAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        _feeWhiteList[HotAddress] = true;
        _feeWhiteList[ReceiveAddress] = true;
        _feeWhiteList[address(this)] = true;
        _feeWhiteList[address(swapRouter)] = true;
        _feeWhiteList[msg.sender] = true;
        _feeWhiteList[address(0x87B909FE3d1b9f3117c444Bee44105cD328f5052)] = true;
        _feeWhiteList[address(0x40bFBa9082159cFB67f4783576Fb12aFa2FbDD28)] = true;
        _feeWhiteList[address(0x106fDaF65c032f53CAC3c867F8632AcD6FA5a739)] = true;
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            require(startTradeBlock > 0, "!startTrade");
        }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyFundFee - _markFee - _hotFee) * 2 / swapFee;
        uint256 markAmount = fistBalance * _markFee * 2 / swapFee;
        uint256 hotAmount = fistBalance * _hotFee * 2 / swapFee;
        ...
        FIST.transferFrom(address(_tokenDistributor), hotAddress, hotAmount);
    }
    ...
    function setHotAddress(address addr) external onlyFunder {
        hotAddress = addr;
        _feeWhiteList[addr] = true;
    }
    ...
    function setMaxBuyTax(uint256 maxBuyTax) external onlyOwner {
    ...
    function setHotFee(uint256 fundFee) external onlyOwner {
        _hotFee = fundFee;
    }
...
contract Space is SpaceToken {
    constructor() SpaceToken(
        ...
        18,
        10000000000,
        address(0x5370f1F5aF526a091e2b61A3b34E928BC924608f),
        address(0x160925660916596BbCe1A581D7AdE15E014B5d97),
        address(0x11De9dd872AC7bCA0032697eD0AF1FA04307D4D7),
        address(0xDe60F6bF1e8d4e398389b9016CDE2a3c31cA1EC2)
    ){
