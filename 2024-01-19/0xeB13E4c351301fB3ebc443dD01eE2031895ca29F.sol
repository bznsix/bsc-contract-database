...
contract The_New_Meta_Boy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The New Meta Boy";
    string private _symbol = "MBOY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x676d0f796Dd4B7CF470373b3d9028572686C5d74);
    address payable private DevelopmentWalletAddress = payable(0x48d9a8C9a18a00308cB1Bfe854c0d85ee2EE663e);
    ...
    uint256 private _totalSupply = 420000000000000000* 10**9;
    uint256 public _maxTxAmount = 420000000000000000 * 10**9;
    uint256 public _walletMax =  420000000000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 5 * 10**9; 
