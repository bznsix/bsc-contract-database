// Telegram: https://t.me/ChainwavePortal
// X         https://x.com/ChainWaveToken
...
contract ChainWave is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CHAIN WAVE";
    string private _symbol = unicode"WAVE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xd29F193d5DD2EAa9D20Ec42bd6765Bc05C2d8823);
    address payable private taxWallet2 = payable(0xd29F193d5DD2EAa9D20Ec42bd6765Bc05C2d8823);
