...
contract KekiFinance is ERC20, Ownable {
    ...
    constructor () ERC20("Keki Finance", "KEKI") 
    {   
        address router;
        address pinkLock;
        ...
        marketingWallet = 0xdF8744c32e72deB898690a313839b7c9e78695c3;
        ...
        _mint(owner(), 750e9 * (10 ** decimals()));
        swapTokensAtAmount = totalSupply() / 5_000;
	
        maxTransactionAmountBuy     = totalSupply() * 15 / 1000;
        maxTransactionAmountSell    = totalSupply() * 15 / 1000;
