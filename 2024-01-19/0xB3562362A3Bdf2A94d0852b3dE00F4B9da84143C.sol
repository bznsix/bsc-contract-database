...
BSC's favourite pup - Mylo the prodigy of Myro


$MYLO Token Community:
https://t.me/mylo_bsc

$MYLO Token Twitter:
https://twitter.com/mylo_bsc
...
contract BABYMYRO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BABY MYRO";
    string private constant _symbol = unicode"$MYLO";
    ...
    address payable public DevWallet = payable(0x59d5f163909b9Bdee2Ef7230b4D425cFB9eAFE5d);
    address payable public MarketingWallet = payable(0xF5D9F448597E7906A14aa75b8030b6258c7911Fb);
