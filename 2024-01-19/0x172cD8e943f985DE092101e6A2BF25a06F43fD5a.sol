...
contract CRAZYLION is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC4ba803EAC054bd486DBd8F6eb39B013607c95A3); 
    address payable public Wallet_Dev = payable(0x8DfF995dac95b25a734Bd76Ea30eeEE98f1100de);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "CRAZY LION"; 
    string private constant _symbol = unicode"CRAZYLION"; 
    ...
    constructor () {
        _owner = 0x8DfF995dac95b25a734Bd76Ea30eeEE98f1100de;
