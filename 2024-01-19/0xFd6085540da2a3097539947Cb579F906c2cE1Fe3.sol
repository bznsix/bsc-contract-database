...
contract BABYMANTA is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 1000000000000000000000000000; // Wei
    string internal _name = "BABYMANTA";
    string internal _symbol = "BABYMANTA";
