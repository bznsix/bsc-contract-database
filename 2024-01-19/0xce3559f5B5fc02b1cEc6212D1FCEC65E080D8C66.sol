...
contract GrokLabs is ERC20, Ownable {
    ...
    constructor () ERC20("GrokLabs", "GrokLabs") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x4ae6193c29651318E7220e66142a433Cc8c5f698;
  ...
  _mintOnce(owner(), 1e6 * (10 ** decimals())); //  1 million tokens
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy) external onlyOwner {
        ...
        require(feeOnBuy <= 3, "CSLT: Total Fees cannot exceed the maximum");
        require(feeOnSell <= 3, "CSLT: Total Fees cannot exceed the maximum");
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 10_000_000, "CSLT: SwapTokensAtAmount must be greater than 0.0001% of total supply");
