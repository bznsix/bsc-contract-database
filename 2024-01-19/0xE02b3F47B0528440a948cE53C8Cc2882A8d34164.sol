...
/**
 *  Contract: Appreciating Stable Asset - Powered by XUSD
 ...
 */
contract NexusToken is IERC20, Ownable, ReentrancyGuard {
    // token data
    ...
    // Flash Loan Provider
    uint256 public flashLoanFee = 25;
    ...
    // Fee Percentage
    uint256 public feeReceiverPercentage = 25;
    ...
    constructor(
        ...
        require(goodAddress(feeRecipient_) == true, "Invalid Address");
        require(goodAddress(promiseUSD_) == true, "Invalid Address");

        // set Promise USD
        PROMISE_USD = promiseUSD_;
        ...
        isTransferFeeExempt[feeRecipient_] = true;
        isTransferFeeExempt[PROMISE_USD] = true;
    ...
    */
    ...
    function flashLoan(
        ...
        uint256 fee = (_amount * flashLoanFee) / feeDenominator;
    ...
    function requestPromiseTokens(
        ...
        underlying.transfer(PROMISE_USD, amountUnderlyingToDeliver);
    ...
    function _mintTo(
        ...
        if (hasFee) {
            uint256 nTokensToMintNoTax = (nTokensToMint * feeDenominator) /
                mintFee;
    ...
    function _takeFee(uint mFee) internal {
        ...
        // take remaining fee and divvy it up
        uint256 remainingFee = mFee - fee;

        // cut for fee receiver
        uint256 feeReceiverCut = (remainingFee * feeReceiverPercentage) / 100;
        ...
        if (feeReceiverCut > 0) {
            unchecked {
                _balances[feeReceiver] += feeReceiverCut;
                _totalSupply += feeReceiverCut;
            }
            emit Transfer(address(0), feeReceiver, feeReceiverCut);
        }
    }
    ...
    */
        ...
        return
            _totalSupply == 0
                ...
                : (((_totalSupply * received) /
                    (totalBacking + mintFeeTaken(received))) * mintFee) /
                    feeDenominator;
    }
    ...
    function viewAllPriceChangeTimestamps()
        external
        view
    ...
    */
    ...
    function setPermissions(
        ...
        require(Contract != PROMISE_USD, "Cannot Include Promise_USD In Fees");
    ...
    function setFeeReceiver(address newReceiver) external onlyOwner {
        require(goodAddress(newReceiver), "Invalid Address");
        feeReceiver = newReceiver;
        isTransferFeeExempt[newReceiver] = true;
    }

    function setFeeReceiverPercentage(
    ...
    function setFeeTo(address newFeeTo) external {
        ...
        require(goodAddress(newFeeTo) == true, "Invalid Address");
        feeTo = newFeeTo;
