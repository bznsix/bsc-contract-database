...
$EMI is launching by the Baby Aetherius (1 million marketcap) and Elon100m (500k) dev. 


Previous projects did good, $EMI is a 0/0 tax memecoin on the BSC network!

Let’s bring Elon Musk Inu to greatness! 🚘

Telegram: Https://t.me/Elonmuskinubsc
...
contract emi  is IBEP20, Auth {
    ...
    string constant _name = "Elon Musk Inu";
    string constant _symbol = "EMI";
    ...
    address private developmentFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        if (contractTokenBalance >= swapThreshold * 3)
            contractTokenBalance = swapThreshold * 3;
