...
contract JurassicBone is ERC20, Ownable {
    ...
    constructor() ERC20("Jurassic Bone", "PJB") {
    ...
    function multiSendToWallets(address[] memory wallets, uint256[] memory amountsInTokens) external onlyOwner {
    ...
    // withdraw BNB if stuck or someone sends to the address
    function withdrawStuckBNB() external onlyOwner {
        bool success;
        (success,) = address(msg.sender).call{value: address(this).balance}("");
    }

    function setOperationAddress(address _operationsAddress) external onlyOwner {
