...
contract Franklin is ERC20, Ownable {
    ...
    event MarketingWalletChangedTwo(address marketingWalletTwo);
    event SwapAndLiquify(uint256 tokensSwapped,uint256 bnbReceived,uint256 tokensIntoLiqudity);
    event SwapAndSendMarketing(uint256 tokensSwapped, uint256 bnbSend);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("Franklin Bull", "Franklin") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xABa5B1BcFE9Ee330A903162CfF8BBB454D2B2c9F);
        ...
        marketingWallet = 0xaC331cD3860aa3bf2A64E0Ce6Ae61Bc221C22524;
        marketingWalletTwo = 0xABa5B1BcFE9Ee330A903162CfF8BBB454D2B2c9F;
        ...
        _mintOnce(owner(), 420e12 * (10 ** decimals()));
    ...
    function changeMarketingWalletTwo(address _marketingWalletTwo) external onlyOwner{
        require(_marketingWalletTwo != marketingWalletTwo,"Marketing wallet is already that address");
        require(_marketingWalletTwo != address(0),"Marketing wallet cannot be the zero address");
        marketingWalletTwo = _marketingWalletTwo;

        emit MarketingWalletChangedTwo(marketingWalletTwo);
    }
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(marketingWalletTwo).sendValue(address(this).balance);
