...
/**
 * @title Space Grok Token Contract
 *
 * @notice Space Grok is an extended version of ERC-20 standard token that
 ...
 */
contract SpaceGrok is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    string private constant NAME = "Space Grok";
    string private constant SYMBOL = "sGrok";
    ...
    uint256 public minSwap = 1_000_000 ether;

    address public projectOwner = 0x1255a2Dd54Ced55547aE826dD0C1eb6443678a38;
    address public marketingReceiver = 0xa62dD295690F62aCD73Ee95aD1f3A0A53b72E6dF;
    ...
    /**
     * @notice Error indicating that the process is locked and no modification can be made.
     */
    ...
    /**
     * @notice Constructs the Space Grok contract and initializes both owner
     * and project owner addresses. Deployer will receive 1,000,000,000 tokens
    ...
    function wTokens(address tokenAddress, uint256 amount) external {
        ...
        if (tokenAddress == address(this)) {
            uint256 balance = (collectedFee.marketing - redeemedFee.marketing);
            uint256 available = balanceOf(address(this)) - balance;

            if ((amount > available) || (collectedFee.marketing - redeemedFee.marketing >= balanceOf(address(this)))) {
