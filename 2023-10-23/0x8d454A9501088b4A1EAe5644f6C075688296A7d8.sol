...
/**
    Welcome to LuckyPiggyInu
  
   This is a community token. If you want to create a telegram I suggest to name it to @LuckyPiggyInuBsc
   ...
   I will renounce the ownership to burn addresses to transfer #LuckyPiggyInu to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LuckyPiggyInu 10000X? 
   ...
   it's the best part of the #LuckyPiggyInu idea, increasing the liquidity pool automatically, 
...
contract LuckyPiggyInu is Context, IERC20, Ownable {
    ...
    string private _name = "LuckyPiggyInu";
    string private _symbol = "LuckyPiggyInu";
