...
contract BoredApeBuyCoinnManage is Ownable, ReentrancyGuard {
    ...
    constructor(){
        coinToken = IERC20(0xbbe493c701d8717ff3185B4cd89E3A00943c9330);
   ...
   function balanceOf(address account) external view  returns (uint256) {
    ...
    function swapTokensForToken(uint256 amountIn) public {
        ...
        //coinToken.transferFrom(address(this), address(0),  amounts[1]);
    }
    //---write onlyOwner---//
