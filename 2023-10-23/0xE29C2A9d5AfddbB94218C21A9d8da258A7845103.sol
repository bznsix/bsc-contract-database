...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC8D7F1437eFbFe5b5e5931a1eA854eE3E3392417; 
...
contract REKTIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rektium";
    string private _symbol = "REKT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC8D7F1437eFbFe5b5e5931a1eA854eE3E3392417); 
    address payable public teamWalletAddress = payable(0xC8D7F1437eFbFe5b5e5931a1eA854eE3E3392417); 
    ...
    uint256 public _walletMax = 630000 * 10**_decimals;
