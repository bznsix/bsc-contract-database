...
contract Coin666 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 666666 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e2 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x75646Ef0986119b75d8C8DdDAe7972554C428233;

    string private constant _name = "666 Coin";
