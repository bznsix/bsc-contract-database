/**
 *Coming Soon list on CMC and Hotbit
...
contract FLOKICHAIN is Context, IBEP20, Ownable {
    ...
    string public constant name     = "Floki Chain";
    string public constant symbol   = "FLOKIC";
    ...
    uint256 public _liquidityFeeSell = 350; 
    uint256 public _marketingFeeSell = 350; 
