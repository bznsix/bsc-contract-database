...
contract Token is Context , IERC20, Ownable {
    ...
    address public devWallet = 0xb2b6EBA92ff089f2969390b5A832D808D5069330;
    ...
    uint256 public _maxTxAmount = 1 * 10**13 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2500 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**13 * 10**9; //3% of total supply
