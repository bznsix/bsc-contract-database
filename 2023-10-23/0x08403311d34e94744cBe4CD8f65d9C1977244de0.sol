...
contract Queryloop is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e7 * 10**18; // 0.1%

    uint256 public genesis_block;
    uint256 private deadline = 2;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x8b8c7B931d30be4488211aa710377BBeEA51e48F;
    address public devWallet = 0x8b8c7B931d30be4488211aa710377BBeEA51e48F;
    ...
    constructor() ERC20("Queryloop", "QUERYLOOP") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount >= 1e6,"Swap threshold amount should be lower or equal to 0.01% of tokens");
