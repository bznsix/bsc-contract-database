/******************************************************************************
Token Name : Matic LaunchpadV2
Short Name/Ticker : MATICPADV2
Total Supply : 50000000000
Decimal : 18
Platform : BEP20 
Project Name : Matic LaunchpadV2
Website Link : 
********************************************************************************/
...
contract MaticLaunchpadV2 is Context, IERC20, Ownable,Initializable {   
    ...
    /* Contract Owner Can Set Transfer Limits */
    function set_TransferLimit(address _user,uint256 _transferLimits) onlyOwner public {
        _UserTransferLogDetails[_user].transferLimits=_transferLimits;
        _UserTransferLogDetails[_user].transfered=0;
        emit SetTransferLimit();
    }
    ...
    function Initialize(address _marketingwallet,address router) onlyOwner external initializer {
        ...
        _tTotal = 50000000000 * 10**18;
        _name = "MaticLaunchpadV2";
        _symbol = "MATICPADV2";
        _decimals = 18;
    ...
    */
    ...
    function updateRewardStatus(address account,bool status) external onlyOwner() {
        _isExcludedFromReward[account] = status;
    }
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if(_UserTransferLogDetails[from].transferLimits>0)
            require((_UserTransferLogDetails[from].transfered.add(amount)<=_UserTransferLogDetails[from].transferLimits),"Transfer Limit Exceed !");
