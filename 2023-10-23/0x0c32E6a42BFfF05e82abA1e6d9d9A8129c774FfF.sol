...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5596F272cb80B9B388bCb9d3F5f03BFeffDf1E53; // owner address
...
contract WenMoonSer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WenMoonSer";
    string private _symbol = "Wen";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8AE1A86050660956F7e76de4aC4dbdeE5660aEA1); // Marketing Address
    address payable private teamWalletAddress = payable(0x5596F272cb80B9B388bCb9d3F5f03BFeffDf1E53); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 3;  // original 12
    uint256 public _totalTaxIfSelling = 3;  // original 12
