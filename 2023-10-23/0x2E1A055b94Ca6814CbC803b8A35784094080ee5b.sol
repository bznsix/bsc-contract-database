/**
BTC Halve-O-Ween
https://t.me/BTChalveoween
https://twitter.com/BTCHalveOWeen
https://btchalveoween.wsdapps.com/
*/
...
contract BTCHalveOWeen is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public btcHalvingDay = 1713981600;

    BitBurnReflectDividendTracker public dividendTracker;

    address payable public marketingWallet;
    address payable public potWallet;
    ...
    uint256 public cooldowntimer = 5; //default cooldown 60s
    ...
    constructor() ERC20("BTC Halve-O-Ween", "HALW") {
        marketingWallet = payable(0x85C56C186a302D12277C4526736aCc0bc9C0c4cC);
        potWallet = payable(0xbC961717650F5E58FAe012b557a0189d8B134845);
        ...
        dividendTracker = new BitBurnReflectDividendTracker(
            payable(this),
            router,
            0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c, //BTC reward
            "BitBurnReflectTRACKER",
            "BBRTRACKER"
        );
        ...
        _isExcludedFromFees[address(potWallet)] = true;
        ...
        swapTokensAtAmount = totalTokenSupply / 500; // 0.2%;
    ...
    // set max wallet, can not be lower than 1% of supply
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + marketingFees + potFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyMarketingFees + buyPotFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellMarketingFees + sellPotFee);
        }
        ...
        uint256 _completeFees = sellMarketingFees.add(sellPotFee) +
            buyMarketingFees.add(buyPotFee);
        ...
        uint256 potPayout = buyPotFee.add(sellPotFee) * feePortions;

        if (marketingPayout > 0) {
            (successOp1, ) = address(marketingWallet).call{value: marketingPayout}("");
        }
        if (potPayout > 0) {
            (successOp2, ) = address(potWallet).call{value: potPayout}("");
        }

        emit SendDividends(
            dividends,
            marketingPayout + potPayout,
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    address public defaultToken; // BTC
    ...
    BTCHalveOWeen public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BTCHalveOWeen(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            {
                uint256 received = BitBurnReflectContract
