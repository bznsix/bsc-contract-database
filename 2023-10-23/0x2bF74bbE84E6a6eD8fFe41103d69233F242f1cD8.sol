...
contract Harmoverse is ERC20, Pausable, ERC20Permit {
    ...
    uint256 public minClaim = 10000000000000; 

    constructor(uint256 _price, uint256 _bonus)
        ERC20("Harmoverse", "HAR")
        ERC20Permit("Harmoverse")
    {
        isIDO = false;
        isIco = false;
        uint256 maxSupply = 2_000_000_000 * 10**decimals();
    ...
    function sale(bool state) public onlyOwner {
        isIco = state;
    }
