...
contract ATTSToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0xF3ee165ac12b2c60B491C24836B84d5B06922a05;
    ...
    address public ownerAddress = 0x95A6E6Cf824E118b7eb9C7802E45163617382045;
    ...
    function launchCheck(address sender, address recipient) internal {
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient] || block.timestamp > launchedAtTime + _protectTime) {
            return;
        }
    ...
    function updateTransferWhiteBatch(address[] calldata accounts, bool isWhite) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
