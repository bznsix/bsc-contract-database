...
// Community: https://t.me/BtcDragon_Portal 
// TWITTER:   https://x.com/BtcDragonbsc             
...
contract BITCOIN_DRAGON is Context, IERC20, Ownable {
    ...
    string private constant _name = "BITCOIN DRAGON";
    string private constant _symbol = "BTC DRAGON";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0efD455A4ae596d4598056996fbc2786d2990e1e);
    address payable private _marketingAddress = payable(0x0efD455A4ae596d4598056996fbc2786d2990e1e);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 15, "Redis cannot be more than 15.");
	    require(redisFeeOnSell < 15, "Redis cannot be more than 15.");
	    require(taxFeeOnBuy < 5, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 38, "Tax cannot be more than 38.");
