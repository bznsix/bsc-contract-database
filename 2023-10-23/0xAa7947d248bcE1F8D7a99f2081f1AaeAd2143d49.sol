...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20 (0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //ETH
...
contract RICKINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Rick Inu";
    string constant _symbol = "rickinu";
    uint8 constant _decimals = 9;

    address DEAD = 0x1e3e2C62766E5CC4e40801028A411bA304554e09;
    address BURN = 0x1e3e2C62766E5CC4e40801028A411bA304554e09;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; // ETH

    uint256 _totalSupply = 20000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 1;
    uint256 public _walletMax = _totalSupply * 1 / 1;
    
    bool private restrictWhales = false;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[address(0xb2fB21519104EfD53Ee334E7fFf7350c6f0310E1)] = true;
        ...
        // NICE!
        autoLiquidityReceiver = msg.sender; //LP wallet
        marketingWallet = 0xb2fB21519104EfD53Ee334E7fFf7350c6f0310E1;  //marketingwallet
        teamWallet = 0xb2fB21519104EfD53Ee334E7fFf7350c6f0310E1; //backup wallet
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(DEAD)).sub(balanceOf(BURN));
    }
