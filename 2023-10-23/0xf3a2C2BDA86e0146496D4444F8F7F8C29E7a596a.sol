...
contract Token is ERC20 ,Ownable{
    ...
    TaxRates public buyTax = TaxRates(0, 100, 0, 300);
    TaxRates public sellTax = TaxRates(0, 100, 0, 300);
    ...
    constructor() ERC20("322", "322") {
        require(usdt < address(this), "usdt must be token0");
        marketingWallet = 0xf9745Bf4cb4058Ebe4948c337EAE5d3C9FE7e30f;
        ...
        maxWalletBalance = 200000 * 10 ** decimals();
