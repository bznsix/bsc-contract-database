...
contract DividendDistributor is IDividendDistributor {
   ...
   constructor() {
    ...
    function initialize(
        ...
        require(msg.sender == _token, "FORBIDDEN"); // sufficient check
...
contract distributorFactory {
    ...
    {
        bytes memory bytecode = type(DividendDistributor).creationCode;
        ...
        IDividendDistributor(distributor).initialize(
            address(router),
            msg.sender
        );
