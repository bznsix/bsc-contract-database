...
/**
   ...
   Welcome to SHIBAPUMP
   
   This is a community token. If you want to create a telegram I suggest to name it to @SHIBAPUMPBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SHIBAPUMP
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SHIBAPUMP 10000X? 
   ...
   it's the best part of the #SHIBAPUMP idea, increasing the liquidity pool automatically, 
...
contract SHIBAPUMP is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAPUMP";
