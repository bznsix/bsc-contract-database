    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                swapAmount = tAmount * (_buyFundFee + _buyLPDividendFee) / 10000;
            } else {
                swapAmount = tAmount * (_sellFundFee + _sellLPDividendFee) / 10000;
                isSell = true;
            }
...
contract lk is AbsToken {
    ...
    //总量
        1968,
    //营销钱包
        address(0xd3e93a534dBE8Dc5E441BAdf3B33b275D28aCB26),
    //代币接收
        address(0x9182D188531fDfaf798C4AafcA0173E51326F523)
    ){
