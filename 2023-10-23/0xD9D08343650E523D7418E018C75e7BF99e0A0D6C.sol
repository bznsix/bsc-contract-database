...
contract ETHKING is Context, IERC20, Ownable {
    ...
    address public MKAddress = address(0x1fdDc871a4c04f472131B0D9a11032612153b6E6);

    address public usdt_address = address(0x55d398326f99059fF775485246999027B3197955);
    ...
    function _initParam(uint256 tAmount,Param memory param) private view  {
        ...
        param.tBrun = tAmount * _brunFee / 1000;
    ...
    function _takeFee(Param memory param,address from) private {
      ...
      if( param.tBrun > 0 ){
        _take(param.tBrun, from, deadWallet);
      } 
    }
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if( 
            ...
            swapAndMK(contractTokenBalance);
