...
/**
	@title Paysenger ERC721
	@author OIS Solutions <https://www.ois.dev/>
	@author Barinov Nikita
	
	This contract is a cross-chain ERC721 token.
*/
contract ERC721Paysenger is
    AxelarExecutable,
    IERC721CrossChain,
    ERC721,
    ERC721Enumerable,
    ...
    ERC2981
{
    ...
    constructor(
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, address(0x8910Ba6F1e84Dca7785401B6A51838fa0C141768));
        _grantRole(VALIDATOR_ROLE, address(0x2Bf27710d42F965679Eb70D16B4FDF060829cB2f));
        _grantRole(ADMIN_ROLE, address(0x7A695C4bB1F356FA3Ba21F7Ab87C5b98107dB655));
        _grantRole(MINTER_ROLE, address(0x6D10165b5F21d2d27b4BdEd35F3e0CAB145c5EE6));
        _grantRole(MODERATOR_ROLE, address(0x83ddCE8779515656d30Eb96ACB92F8Fb59293dE4));
    ...
    function safeMintWithSignature(
...

        {
            ...
            require(
                hasRole(MINTER_ROLE, message.toEthSignedMessageHash().recover(v, r, s)),
                "Minter address is invalid"
            );
     ...
     */
    function lockToken(uint256 tokenId) external onlyRole(MODERATOR_ROLE) {
