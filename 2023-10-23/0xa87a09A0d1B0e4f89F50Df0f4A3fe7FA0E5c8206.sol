...
/**
    Telegram : https://t.me/chimerabsc 
    Website  : SOON 
    Twitter. : SOON
*/
...
contract Chimera is ERC20, Ownable {
    ...
    constructor() ERC20("Chimera", unicode"$CHI") {
        ...
        uint256 _buyMarketingFee = 25; //Final 7

        uint256 _sellLiquidityFee = 0;
        uint256 _sellMarketingFee = 25; //Final 7

        uint256 totalSupply = 1000 * 1e3 * 1e18;

        maxTransactionAmount = 2000 * 1e1 * 1e18; //Final No Max
        maxWallet = 2000 * 1e1 * 1e18;  //Final No Max
        ...
        devWallet = address(0x41b05340bC1Dc947a562237422abe0Fb57995541); //DEV&MARKETING
