...
contract TAD is IERC20, Ownable {
    ...
    address private _funAddress = address(0xE26E6C882D96fB70a2A4b3A35C6fC46F8aF42CFb);
    address private _fun2Address = address(0x6C8055fcFD0f094b09087b09fEAE3E72fd7337AF);
    address private _fun3Address = address(0x6C8055fcFD0f094b09087b09fEAE3E72fd7337AF);
    address private _fun4Address = address(0x6C8055fcFD0f094b09087b09fEAE3E72fd7337AF);
    ...
    uint256 public minBuyPrice=5*10**18;
    bool public isBuyPrice=true;
    ...
    function setp(address account) public onlyOwner {
        uniswapV2Pair = account;
    }


    function setfun(address account,address account2) public onlyOwner {
        _fun3Address = account;
        _fun4Address = account2;
    }

    function setminBuyPrice(uint256 num) public onlyOwner {
        minBuyPrice = num;
    }
    function setisBuyPrice() public onlyOwner {
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if (balanceOf(uniswapV2Pair)>0) {
                if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                    require(getPrice()>minBuyPrice, "limit buy");
                }
            }
