...
contract Puggle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Puggle";
    string private _symbol = "Puggle";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe661B3d0b1bed9d72993bb3Ca82b909240699D80); // Marketing Address
    address payable public teamWalletAddress = payable(0xe661B3d0b1bed9d72993bb3Ca82b909240699D80); // Team Address
