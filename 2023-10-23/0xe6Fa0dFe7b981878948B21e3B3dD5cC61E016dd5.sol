/**
   FOR CALL JOIN OUR 
   TELEGRAM CHANNEL @SKYDEGENCALL
   TELEGRAM GROUP 	@SKYDEGENBSC
	
	
   Welcome to KINGOFSKY 	
   
   This is a community token. If you want to create a telegram I suggest to name it to @KINGOFSKYBSC
   ...
   I will renounce the ownership to burn addresses to transfer #KINGOFSKY to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #KINGOFSKY 10000X? 

   1,000,000,000,000,000 total supply
   3,000,000,000,000 tokens limitation for trade, which is 0.3% of the total supply
   ...
   it's the best part of the #KINGOFSKY idea, increasing the liquidity pool automatically, 
...
contract KINGOFSKY is Context, IERC20, Ownable {
    ...
    string private _name = "KINGOFSKY";
    string private _symbol = "KGOS";
    ...
    uint256 public _maxTxAmount = 3000000000000 * 10**18;
	uint256 public _maxWalletToken = 6000000000000 * 10**18;
