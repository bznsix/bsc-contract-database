...
--|-/|-/-----_---/------------------------/-------_------
  |/ |/    /_) /   /   ' /   ) / /  ) /_)     /      /   )     
_/|_(_ /_(_ _(_////(_ __/__(_/o_o


=== 'SwisBlue Token' Token contract with following features ===
    => BEP20 Compliance
...
contract SwisBlue_token is owned {
    
    using SafeMath for uint256;

    string constant private _name = "SwisBlue Token";
    string constant private _symbol = "SBT";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 10000000000 * (10**_decimals);                     
    uint256 private maxSupply = 10000000000 * (10**_decimals);
