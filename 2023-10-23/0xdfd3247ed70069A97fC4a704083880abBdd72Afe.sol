...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0413d5be3958785Cb187cC5A04106720703Eb01F; // owner address
...
contract DRAGONPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "Dragon Pepe";
    string private _symbol = "DP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0413d5be3958785Cb187cC5A04106720703Eb01F); // Marketing Address
    address payable private teamWalletAddress = payable(0x0413d5be3958785Cb187cC5A04106720703Eb01F); // Team Address
