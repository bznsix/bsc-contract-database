...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9F51DA92FAfAcBF4011f4e50e97b88abACD0FFDd;
...
contract AtomicBTC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9F51DA92FAfAcBF4011f4e50e97b88abACD0FFDd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Atomic Bitcoin";
    string private _symbol = "ABTC";
