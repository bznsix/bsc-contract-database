...
contract BNBLongCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "BNBLong Coin";
    string private _symbol = "$LONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1c5e7c6Ae7b98B4534469781A9f4742924aEC161); // Marketing Address
    address payable public teamWalletAddress = payable(0x1c5e7c6Ae7b98B4534469781A9f4742924aEC161); // Team Address
