...
// virtu chain the next gen layer1 on the blockhain

   // https://t.me/Virtuchain
   // https://www.VirtuChain.org
...
contract virtuBlockchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Virtu Chain";
    string private _symbol = "VIRTU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa129362E8157823BF3b6C7A32822d54CBaB33A8B); // Marketing Address
    address payable private teamWalletAddress = payable(0xa129362E8157823BF3b6C7A32822d54CBaB33A8B); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2100000 * 10**3; 
