        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x3eB46Dbed52f19980d678252990429D0d0007D50), block.timestamp
                );
            }
        }
    }
...
contract  QJLONG is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3eB46Dbed52f19980d678252990429D0d0007D50)//ReceiveAddress
    ){
    }
}