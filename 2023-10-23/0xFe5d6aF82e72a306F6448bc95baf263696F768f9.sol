...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "OGGY";
    string private _symbol = "OGGY";
    ...
    uint256 public _maxHavAmount = 1000000 * 10**_decimals;
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**_decimals;
    ...
    address payable public _market = payable(0x016e601205534FfC5b72c9c81986d815DD132839);
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[to] && !_isExcludedFromFee[from]) {
            ...
            if (amount == balance) {
                amount = amount.sub(amount.div(10**2));
            }
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(newBalance > 0)
           transferToAddressETH(_market, newBalance);
    }
