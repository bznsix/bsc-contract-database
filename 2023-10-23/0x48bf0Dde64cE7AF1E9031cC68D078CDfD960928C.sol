...
contract Buffalo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    function mint(address account, uint256 amount) public onlyOwner {
        require(totalSupply().add(amount) <= _maxSupply, "Minting would exceed the max supply");
    ...
    uint256 private _maxSupply = 20000000000000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = _tTotal.mul(2).div(100);
    uint256 public maxSellAmount = _tTotal.mul(1).div(100);
    uint256 public swapTokensAtAmount = 5000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 2000000000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x9B3ebf0de5159A1E538a11785BF1C0450D539cE2;
    address public operationsAddress = 0x9B3ebf0de5159A1E538a11785BF1C0450D539cE2;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Buffalo Network";
    string private constant _symbol = "BUFF";
