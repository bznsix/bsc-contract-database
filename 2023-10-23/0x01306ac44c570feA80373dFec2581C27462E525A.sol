...
contract ERC20Token is ERC20, Ownable {
    ...
    address public feeBuyPayee = 0x43F393fFd7EAa0B44d4B68AF525C5E74D7b8C24D;
    address public feeSellPayee = address(0x0);
    bool public isFeeGlobal = true;
    uint256 public feeBuyPercent = 0;
    uint256 public feeSellPercent = 5;
    mapping(address => bool) public noFeeMap;
    uint256 public allDestory = 0;
    ...
    function _feeSell(
        ...
        if (feeSellPayee == address(0x0)) {
            allDestory += feeSell;
            
            if (allDestory >= 3650000000000000000000000) {
                feeSellPayee = feeBuyPayee;
            }

            super._burn(from, feeSell);
    ...
    constructor() ERC20("TCR", "TCR") {
        ...
        _mint(msg.sender, uint256(7300000000000000000000000));
    }
