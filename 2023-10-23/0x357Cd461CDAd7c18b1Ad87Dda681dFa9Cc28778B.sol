...
contract btctradingforex is Ownable, ReentrancyGuard, ERC20 {
    ...
    address public immutable PinkSaleRouter;
    ...
    constructor() ERC20("BTCTradingForex", "BTF") {
        _transferOwnership(0xeD6a3baB14C46F09f32708E044d017b2ce00c64a);
        _mint(owner(), 50_000_000 * (10 ** 9));
        ...
        marketingWallet = 0x4B0E0a24EE31761462509bdde2F69C31Da1E9FC4;
        
        PinkSaleRouter = 0x4D874ddd599c58e64001B4e0e882B0E39340b1ab;
        ...
        _isExcludedFromFees[address(PinkSaleRouter)] = true;
    }
