...
contract ETSL is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 210000000000 * 10**9; // 
    uint256 public _maxWalletAmount = 210000000000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"ETSL"; // 
    string private constant _symbol = unicode"ETSL"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    uint256 public gas = 6 * 1 gwei;
    address public  _marketingWallet = 0x09649eB445080677B96Ca7E30c113Dc612068Eb1;
    ...
    function setWalletLimit(uint256 amountPercent) external onlyOwner {
        _maxWalletAmount = (_tTotal * amountPercent ) / 1000; // 10 for 1%
    }

    function setTxLimit(uint256 amountPercent) external onlyOwner {
        _maxTxAmount = (_tTotal * amountPercent ) / 1000; // 10 for 1%
    }    

    

    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 1, "Max gas should be higher than 1 gwei");
        gas = newGas * 1 gwei;
    }
