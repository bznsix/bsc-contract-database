...
contract BRTTOKEN00 is Ownable, ERC20 {

    bool public startTrading= true;
    address public burnAddress;
    address public feeAddress;
    uint256 public buyFeeRate;
    uint256 public sellFeeRate;
    mapping (address => bool) public swapPool;
    mapping (address => bool) public dutyFree;
    mapping (address => uint256) public lastTradingBlock;

    event FeeAddressSet(address indexed owner, address indexed account);
    ...
    constructor() ERC20("BRTtest2", "BRTtest2") {

        buyFeeRate = 0.01 ether;
        sellFeeRate = 0.01 ether;

        burnAddress = address(0);
        feeAddress = 0x0ff1A9FB9712DaD271dE16C2fCFD82AC89b7BE57;

        dutyFree[msg.sender] = true;
        dutyFree[address(this)] = true;

        _mint(msg.sender, 1000000000*10000*10**18);
    }
    ...
    function setPool(address account) public  onlyOwner {
        swapPool[account] = !swapPool[account];
        emit PoolSet(msg.sender, account, swapPool[account]);
    }
    ...
    function setFeeAddress(address newFeeAddress) external onlyOwner {
        ...
        emit FeeAddressSet(msg.sender, newFeeAddress);
    }
