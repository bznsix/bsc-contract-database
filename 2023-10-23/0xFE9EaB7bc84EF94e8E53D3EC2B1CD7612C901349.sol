...
/**
TELEGRAM : https://t.me/Hell_Coin
TWITTER : https://twitter.com/HellCoin_BSC
WEBSITE : https://hellcoinbsc.com/
*/
...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Token_Dividend_Tracker", "Token_Dividend_Tracker") {
        ...
        minimumTokenBalanceForDividends = 1500000 * (10**18); //must hold 1.500.000+ tokens
    }
...
contract HellCoin is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxTransactionLimit = 13_333_333 * (10**18); // 2% Max Transaction
    uint256 public MaxWalletLimit = 13_333_333 * (10**18); // 2% Max Waallet limit
    uint256 public swapTokensAtAmount = 1_000_000 * (10**18); // Should be Between 0.05 to 0.5% of the total supply
    ...
    constructor() ERC20("HellCoin", "HELL") { // Name and Symbol
        BNBRewardsFee = 2;
        liquidityFee = 1;
        extraFeeOnSell = 15; // extra fee on sell
        marketingFee = 7;
