// Katang Lingga Resort - Giving travelers and crypto enthusiasts a futureproof digital asset backed by real assets in katang lingga island, Build on Binance Smartchain.
...
contract KatangLinggaResort is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 555555 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress = //KatangLinggaResortMarketing
        payable(address(0xfd2Bd21887679651AFd67551474f9B77fa8452AB));


    string private _name = "Katang Lingga Resort";
    string private _symbol = "KLGR";
