/**
   ...
   Welcome to BabyFlokiAkita
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyFlokiAkitaBsc
   ...
   I will renounce the ownership to burn addresses to transfer #BabyFlokiAkita to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BabyFlokiAkita 10000X? 
   ...
   it's the best part of the #BabyFlokiAkita idea, increasing the liquidity pool automatically, 
...
contract BabyFlokiAkita is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFlokiAkita";
    string private _symbol = "BabyFlAkita";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000000000000000000000000000000 * 10**18;
