...
contract KINGFROGGY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KING FROGGY";
    string private _symbol = "KING FROGGY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x84645C17b9E4cBd4D909F0518190326BB9A7BdEA);
    address payable private DevelopmentWalletAddress = payable(0x84645C17b9E4cBd4D909F0518190326BB9A7BdEA);
