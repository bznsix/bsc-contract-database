...
contract SPIDERMAN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa877A9FB1104D4C1Bab477F735CCc271583025ef); 
    address payable public Wallet_Dev = payable(0x3A3a9bC51ba22530738FeC41fb29637F017a6294);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SPIDERMAN BITCOIN "; 
    string private constant _symbol = unicode"SPIDERMAN"; 
    ...
    constructor () {
        _owner = 0x3A3a9bC51ba22530738FeC41fb29637F017a6294;
