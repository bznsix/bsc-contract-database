...
contract NBABSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA5C6fB27B7257EEB0A6aa59fb456FC73811135A4); 
    address payable public Wallet_Dev = payable(0x1711aC4F01FEB9b62B023b4b3BB8c8586202744E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000000000 * 1**6* 10**6 * 1**_decimals;
    string private constant _name = "NBA BSC"; 
    string private constant _symbol = unicode"NBABSC"; 
    ...
    constructor () {
        _owner =0x1711aC4F01FEB9b62B023b4b3BB8c8586202744E;
