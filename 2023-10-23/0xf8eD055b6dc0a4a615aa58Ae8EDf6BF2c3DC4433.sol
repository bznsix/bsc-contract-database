...
contract SwapRouter is Ownable {
    ...
    mapping(address => address) public sellOtherFeeToOf;
    mapping(address => uint256) public sellOtherFeeRateOf;
    ...
    function createPair(CreatePairParams calldata paras,address sellOtherFeeTo, uint sellOtherFeeRate) external {
        ...
        _setPairConfigs(pair,paras.sellBurnRate,paras.sellStopBurnSupply,paras.sellUserRate,paras.sellLpRate,sellOtherFeeTo,sellOtherFeeRate);
    ...
    function _distributeForSell(address[] calldata path,uint amountOut,address user) internal {
        ...
        _distributeTo(path[1],sellOtherFeeToOf[pair],amountOut.mul(sellOtherFeeRateOf[pair]) / RATE_PERCISION);
    }
    ...
    function setPairConfigs(
        ...
        _setPairConfigs(pair,sellBurnRate,sellStopBurnSupply,sellUserRate,sellLpRate,sellOtherFeeTo,sellOtherFeeRate);
