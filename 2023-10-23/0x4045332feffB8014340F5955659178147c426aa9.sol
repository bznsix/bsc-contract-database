...
abstract contract yanToken is IERC20, Ownable { 
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_swapPairList[from] || _swapPairList[to]) { 
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 6) {
 ...
 function swapTokenForFund(
        ...
        address secFundAddress = 0x9873ceD937acD106967A2d555525aDD872DA434a;
        address threeFunAddress = 0xc6F97F86b2cD46a19FfB43db83d4596351960623;
        // 1%
        YANZO.transferFrom(
            address(_tokenDistributor),
            fundAddress,
...
contract SHPTOKEN is yanToken {
    constructor()
        yanToken(
            ...
            18,
            12000000000,
            address(0x10C8B0363662308aB5E5bF0E9cbc8f88366dE6b2), 
            msg.sender  
        )
    {}
}