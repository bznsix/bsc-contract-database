...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        fundAddress = address(0x3585a5523F40C354993aF3221a5620d4BC5aa574);
        marketAddress = address(0x93A5903F57Df7813381A9A8895958912E40a8b43);
        ...
        _isExcludedFromFees[address(0x5338247273b9Faa26763E90a5FEb3614407994be)] = true;
        _isExcludedFromFees[address(0xf355555AFe04C640B4C35c51D2E5cf94aB4ABf99)] = true;
        ...
        _preFeeConfigs.push(PreFeeConfig(5000, 10000 days));
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                marketFeeAmount = tAmount * _buyMarketFee / 10000;
...
contract QL is AbsToken {
    ...
    //Receive
        address(0x8389229128A491d4C80406ba74ae8D492e881036)
    ){
