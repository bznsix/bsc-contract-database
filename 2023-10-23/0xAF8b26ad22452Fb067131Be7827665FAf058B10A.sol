...
// Telegram : https://t.me/Hallowenbullish
// Twitter : https://twitter.com/Hallowenbullish
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf330B98441F4E822C588af984492C9BCcb73A789;
...
contract HallowenBullish  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Hallowen Bullish";
    string public _symbol = "BULLISH";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf330B98441F4E822C588af984492C9BCcb73A789); 
    address payable private developmentWalletAddress = payable(0xf330B98441F4E822C588af984492C9BCcb73A789);
