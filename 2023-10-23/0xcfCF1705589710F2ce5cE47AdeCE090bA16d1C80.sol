...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        uint256 total = 50000000 * tokenUnit;
        _tTotal = total;
        ...
        fundAddress = address(0x722e1EA8219861F470b5144F19D309b2beF4CB2D);
        fundAddress_2 = address(0x0F3BEc3c8C6dD45c6584FF2f32Db06C023B53e8C);
    ...
    uint256 public rewardUSDTPercentage = 20;// 分红税的50%分U
...
contract BitCoin is AbsToken {
    constructor() AbsToken(
    //SwapRouter
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
    //USDT
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c),// 多分eth
    //Receive
        address(0x5305bEe026D20f3b1f27F892CAf705009d657f62)
    ){
