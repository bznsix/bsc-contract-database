/*
    Title: OPYx OPPORTUNITY CRYPTO "OPYx (OPX)" 
    Website: https://opportunitycrypto.net/
    Telegram: https://t.me/OPYxprojectofficial
    Discord: https://discord.gg/pQRAGUTxmE
    Instagram: https://www.instagram.com/opportunitycryptoopyx/
    Twitter: https://twitter.com/Opportu10520911
    -<->--<->--<->--<->--<->--<->--<->--<->--<->-
    @Author Telegram: @Th3nD
*/
...
contract Opyx is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 52_500 * 10**18;
    uint256 public maxSellLimit = 52_500 * 10**18;
    uint256 public maxWalletLimit = 420_000 * 10**18;

    uint256 public genesis_block;

    address public marketingWallet = 0x2b44Cb101AE9dB1Ff2D371351cffe922975A55EB;
    address public devWallet = 0x0847f06E7204A7C6A7Da8446d23CB1aA1c8036F0;
    ...
    function _transfer(
        ...
        if(block.number < genesis_block + 50 && sender == pair) {
        ...
        //set fee to zero if fees in contract are handled or exempteds
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity +  _developer) <= 99, "Must keep fees at 99% or less");
    }
    ...
    function removeNonCustodialWallets(address _account) external onlyOwner {
        nonCustodial[_account] = false;
    }
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxWallet >= 105_000, "Cannot set max wallet amount lower than 0.5%");
