...
=== 'Boltyx' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2023 onwards Boltyx
-------------------------------------------------------------------
*/ 
...
contract Boltyx is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Boltyx";
    string constant private _symbol = "BOLTYX";
