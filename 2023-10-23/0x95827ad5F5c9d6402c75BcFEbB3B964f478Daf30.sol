...
contract MGBA is Context, IERC20, Ownable {
    ...
    string private _name     = "MBGA";
    string private _symbol   = "MBGA Community Edition";
    ...
    {        
        ...
        marketingWallet = 0x93521f72d8818cf7E7D19a7e2d3d60f6F83D7295;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _liquidityFeeonBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees <= 35, "Buy fees cannot be greater than 10%");
    ...
    function setSellFeePercentages(uint256 _taxFeeonSell, uint256 _liquidityFeeonSell, uint256 _marketingFeeonSell) external onlyOwner {
        ...
        require(totalSellFees <= 60, "Sell fees cannot be greater than 10%");
    ...
    function setMaxTransactionAmounts(uint256 _maxTransactionAmountBuy, uint256 _maxTransactionAmountSell) external onlyOwner {
        require(
            ...
            "Max Transaction limis cannot be lower than 1% of total supply"
        ); 
