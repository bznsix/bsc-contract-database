...
✅https://new-gold.com
✅https://t.me/newgoldoficial

 🔥 massive burn 3% in buy 3% in sell 🔥


 💥 Get ready for our EXPLOSIVE LAUNCH on PancakeSwap - Today 00:00 UTC
...
contract newgold is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() ERC20("New Gold", "NGD") {
        ...
        maxTransactionAmount = (tTotal * 1000) / 1000; // 5% maxTransactionAmountTxn
        maxWallet = (tTotal * 1000) / 1000; // 1% maxWallet
        swapTokensAtAmount = (tTotal * 2) / 1000; // 1% swap wallet
        ...
        marketingWallet = address(0x960Eb4b5148A52d72D43451230236fD6dAcc79F8); // set as marketing wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(address(0x960Eb4b5148A52d72D43451230236fD6dAcc79F8), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x27531dC330B07E335971851479361b38C03068ba), true);
        excludeFromFees(address(0x2cEffc8A7E1132F424a7E8A57B8930c988F30cA5), true);
        excludeFromFees(address(0xb06F86A7f39C4ce34754120FE14016C92A2EEAd9), true);
        excludeFromFees(address(0x6b60A528B9E7C7dECFc67Aec6BF837478883Bc88), true);



        excludeFromMaxTransaction(address (0x960Eb4b5148A52d72D43451230236fD6dAcc79F8), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x2cEffc8A7E1132F424a7E8A57B8930c988F30cA5), true);
        excludeFromMaxTransaction(address(0x27531dC330B07E335971851479361b38C03068ba), true);
        excludeFromMaxTransaction(address(0xb06F86A7f39C4ce34754120FE14016C92A2EEAd9), true);
        excludeFromMaxTransaction(address(0x6b60A528B9E7C7dECFc67Aec6BF837478883Bc88), true);
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 1000) / 1000) / 1e9,
