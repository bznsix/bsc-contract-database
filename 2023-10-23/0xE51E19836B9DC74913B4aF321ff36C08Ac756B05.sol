        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x4D64De6DD2C7eE6311147C26F76c213216ccfbc9), block.timestamp
                );
            }
        }
    }
...
contract HappyBee is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10500000,//Supply
        address(0xba978c33B792F094E50D949C3E027f8f95F8589c),//FundAddress
        address(0x4D64De6DD2C7eE6311147C26F76c213216ccfbc9)//ReceiveAddress
    ){
    }
}