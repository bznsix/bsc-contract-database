...
contract CRAZYMUSK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC280805E41E06e73d5e0D54D87bDe27513972A76); 
    address payable public Wallet_Dev = payable(0x8b978CA237Bb6D16708cdF28EAb6845DD4142925);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "CRAZY MUSK"; 
    string private constant _symbol = unicode"CRAZYMUSK"; 
    ...
    constructor () {
        _owner =0x8b978CA237Bb6D16708cdF28EAb6845DD4142925;
