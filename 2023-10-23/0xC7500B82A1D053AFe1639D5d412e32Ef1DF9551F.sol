...
Say hello to my little cat!

🐈‍ 10% tax - I work hard for this. I want you to know that (4% LP 6% mkt)
🐈‍ 2% max wallet - 3 things to know in life: never beg anyone never trust no one never expect anything from anybody
🐈 Contract renounced - I always tell the truth. Even when I lie
🐈 LP locked - You fuck with me you are fuckin' with the best!

https://t.me/thecatface
 */
...
contract Catface is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**_decimals;
    string private constant _name = "Catface";
    string private constant _symbol = "CATFACE";
    uint8 private constant _decimals = 9;

    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address private  _marketingWallet = 0x98A4EE16cDF73BE9eB77C14547EDA7e5CA41F249;
