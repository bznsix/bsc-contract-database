...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xc5363080a331e612E6273a32B04Ba73769bC3A46; // owner address
...
contract SIXTYNINE is Context, IERC20, Ownable {
    ...
    string private _name = "Sixty Nine";
    string private _symbol = "69";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe885774b58D56b301D6EB1C8Ddf6F87bc9102642);
    address payable public teamWalletAddress = payable(0x6710c21D1F426Ad615e2442d739E49616d40AeF8);
    ...
    uint256 public _marketingShare = 72;
    uint256 public _teamShare = 18;

    uint256 public _totalTaxIfBuying = 6;
    uint256 public _totalTaxIfSelling = 6;  
    uint256 public _totalDistributionShares = 100;
    uint256 private _totalSupply = 6969 * 10**_decimals;
    uint256 public _maxTxAmount = 69 * 10**_decimals;
    uint256 public _walletMax = 69 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 34 * 10**_decimals;
