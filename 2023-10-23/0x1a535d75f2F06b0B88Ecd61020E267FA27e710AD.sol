...
contract Cognetix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cognetix";
    string private _symbol = "CGX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x357C0E524F67cBb841356f0dED611B747DD998C1);
