...
contract Token is ERC20 {
    ...
    address _baseToken = address(0x660dAd42f64205375eB252ABD7930306C36B15c3);

    address private _destroyAddress =
        address(0x000000000000000000000000000000000000dEaD);

    address _lpAddress = address(0x26E787943BCE944D055572f1110281B83Fbc232F);
    ...
    constructor() ERC20("888", "888") {
        ...
        USDT = IERC20(0x660dAd42f64205375eB252ABD7930306C36B15c3);
        ...
        _isExcludedFromFeesVip[
            0xbE437Cc6909981f4a10455f98e3b1142245b5565
        ] = true;
