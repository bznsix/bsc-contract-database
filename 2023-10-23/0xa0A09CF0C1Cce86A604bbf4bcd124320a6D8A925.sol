...
contract BFarm {
    ...
    uint256 constant public marketingFee = 50;
    uint8[BonusLinesCount] public referralBonus = [50, 30, 10, 5,5];
    ...
    event FeePayed(address indexed user, uint256 totalAmount); 
        ...
        constructor(address payable ceoAddr,address payable marAddr,uint256 startDate) {
        require(!isContract(ceoAddr));
        ceoWallet = ceoAddr;
        marketingWallet = marAddr;
	    startUNIX = startDate;
    ...
    function deposit(uint8 _lockUp, address _upline) external payable{ 
        ...
        require(investor.totalInvested < 50 ether, "Max 50 Bnb deposits per address");
        // ceoFee 
