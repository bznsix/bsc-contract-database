...
contract Starium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starium";
    string private _symbol = "STAR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xa698B38Ed001025134C9A48a9ba3072fD963a752); // Marketing Address
    address payable public teamWalletAddress = payable(0x9722da231e8985a383A90bE0C2600e566551E452); // Team Address
