/*
    Title: State1 Metaverse "GoldBrick (GBK) Presale" 
    Metaverse: https://metaverse.state1.io/
    Website: https://www.state1.io/
    🇬🇧 Telegram: https://go.state1.io/telegram-global
    🇮🇹 Telegram: https://go.state1.io/telegram-ita
    Discord: https://go.state1.io/discord
    Instagram: https://go.state1.io/instagram
    TikTok: https://go.state1.io/tiktok
    Youtube: https://go.state1.io/youtube
    Twitter: https://go.state1.io/twitter
*/
...
contract GoldBrickPresale is OwnerWithdrawable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
