...
contract  ZQTOKEN is IERC20, Ownable {
    ...
    constructor(){
            address admin;
            address router;
            admin = 0x1CBe88AEa642D3b8dDcfEC219dc4c11687eE9D4e;
            ...
            _symbol = "ZQ";
            _decimals= uint8(18);
            _tTotal = 490000 * (10**uint256(_decimals));
            
            _tOwned[admin] =  50000* (10**uint256(_decimals));
            _tOwned[address(this)] = 440000* (10**uint256(_decimals));
            _uniswapV2Router = IUniswapV2Router02(
                router
            );
        
            //exclude owner and this contract from fee
            _isDividendExempt[0x1CBe88AEa642D3b8dDcfEC219dc4c11687eE9D4e]=true;//The pink lock address
    ...
    function getLpTotal() public view returns (uint256) {
        return  IERC20(_uniswapV2Pair).totalSupply() - IERC20(_uniswapV2Pair).balanceOf(0x1CBe88AEa642D3b8dDcfEC219dc4c11687eE9D4e)
