...
contract FL2049 is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x6251E1b2eFeB5890D464Ef9b646148947611313b); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x6251E1b2eFeB5890D464Ef9b646148947611313b)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(3 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x115560DF5bBc61ab092BbB1dEeFDf165d9f0F902);
        feeEarn = 0;
        isLiquified = true;
    }
}