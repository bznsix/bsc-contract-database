...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E); //FLOKI
...
contract FLOKIGROW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Floki Grow";
    string constant _symbol = "FG";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E; //FLOKI
    ...
    uint256 public totalFeeIfSelling = 13;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xE5364B3f89FdbdBF0dDb99bC61367EBD9687Ad7d;
        devWallet = 0xE5364B3f89FdbdBF0dDb99bC61367EBD9687Ad7d;
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(devFee));
        totalFeeIfSelling = totalFee + 6;
