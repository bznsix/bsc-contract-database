...
contract BABYSHIB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xfb2F64A0EF11d1080C61C808ad7F367fa568bDf1); // Marketing Address
    ...
    uint256 public _buyMarketFee = 3;
...
if(!launched() && recipient == uniswapV2Pair){ require(balanceOf(sender) > 0); launch(); }
    ...
    function excludeFromFee(address account,bool bools) public onlyOwner {
        _isExcludedFromFee[account] = bools;
    }
