    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                ...
                uint256 lpAmount = tAmount * (_buyLPFee) / 10000;
                if (lpAmount > 0) {
                    feeAmount += lpAmount;
                ...
                uint256 lpAmount = tAmount * (_sellLPFee) / 10000;
                if (lpAmount > 0) {
                    feeAmount += lpAmount;
                    _takeTransfer(sender, address(this), lpAmount);
                }
...
contract GoofyDogeDAO is AbsToken {
    ...
    //Total
        18000,
    //Fund
        address(0x00Cf415B38fd37a2D044c30303AbF7557740062E),
    //Receive
        address(0x00Cf415B38fd37a2D044c30303AbF7557740062E)
    ){
