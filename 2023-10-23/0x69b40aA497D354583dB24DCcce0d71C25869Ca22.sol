...
contract IdealToken is IERC20, Ownable {
    ...
    constructor() {
        ...
        fundAddress = 0xb2b5a04e848B7a400202F860fbBe0Ab93aF9d3c3;
        currency = address(0x55d398326f99059fF775485246999027B3197955);
        _swapRouter = ISwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        receiveAddress = 0x3AB0F34fD4DB164B802F464beDb3709B806c5ce6;
        rewardToken = address(0x55d398326f99059fF775485246999027B3197955);

        address fundAddress2 = address(0x695c1e041E1e957f41C08c51A6E53470CdffBbE1);
        ...
        require(
            _buyFundFee + _buyLPFee + _buyRewardFee < 2500 && 
            _sellFundFee + _sellLPFee + _sellRewardFee < 2500
