...
//The bull market is coming and Bulge, The Bullish Doge
//is here to kickstart it and become the top project of 2k23!
//TG - https://t.me/BullishDoge
...
contract TheBullishDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bullish Doge";
    string private _symbol = unicode"$BULGE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x43186aD701cDd4510777fc0F5249D076b6Fb2D7E);
    address payable private taxWallet2 = payable(0x43186aD701cDd4510777fc0F5249D076b6Fb2D7E);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*100/100000; 
