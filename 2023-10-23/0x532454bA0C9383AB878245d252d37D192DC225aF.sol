 ...
 *Submitted for verification at BscScan.com on 2023-09-25
  *TELEGRAM GROUP: https://t.me/+xETwlG-7S8FiZWVh 
  *GETUX MEME COIN
*/
...
pragma solidity 0.8.19;
contract GETUX is Ownable, ERC20 {

    //Initial Definition of variables and events
    mapping(address => bool) public poolAddress;

    address public taxWallet = 0xcDE593EAdA6142fc2E8Ccbd5d5e50d6866Ba83cb;
    ...
    uint private constant MAXTAX = 10; //establishes a maximun tax of 10%
    uint public sellTax = 5; //Initial 5% tax
    uint public buyTax = 5; //Initial 5% tax
    ...
    function updateTax(uint256 _sellTax, uint256 _buyTax) external onlyOwner {
        sellTax = _sellTax;
        buyTax = _buyTax;
        require(_sellTax < MAXTAX && _buyTax < MAXTAX, "'Tax can't excede 9%");
