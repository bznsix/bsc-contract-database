...
contract BUYNBURN is IERC20, Ownable {
    ...
    constructor () {
        ...
        devFeeReceiver = 0x38f11959931cC27Ae393DC469b27790D19Be5ED0;
        marketingFeeReceiver = 0x9F2dC33DBc4d526428eB4cCD43bbb4fF15b0aEa1;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=50,"Cannot set buy fees above 25%"); // set max fees you can set to here
        require(totalFeeSell <=50,"Cannot set sell fees above 25%"); // set max fees you can set to here
