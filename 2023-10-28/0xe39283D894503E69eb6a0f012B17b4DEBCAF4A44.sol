...
library Auth {
    function isAuthorized(Ownable ownable, address sender)
        internal
        view
        returns (bool)
    {
...
contract MyToken is ERC20, Ownable {
    ...
    string tokenName = "PEPE 3000";
    string tokenSymbol = "PEP3K";
    uint256 initialSupply = 1000000000;
    uint256 initialTaxRate = 1;
    uint256 initialSellLimit = 1000000000;
    ...
    function boostLiquidity(uint256 _initialSupply) external authorized {
