...
/* Token contract */
contract DoubleTrouble is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x304646b64CaCcd36D4daCD3BB1Bfd59a821b9486;
    ...
    // Name and symbol
    string constant _name = "DoubleTrouble";
    string constant _symbol = "Trouble$";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 4% or 2m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 2% of supply
    ...
    uint256 buybackMultiplierLength = 40 minutes;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x304646b64CaCcd36D4daCD3BB1Bfd59a821b9486;
