...
/**
/Telegram : https://t.me/GODZILLA_BSC
*/
...
contract GODZILLA   is Context, IERC20, Ownable {
    ...
    string private constant _name = "GODZILLA"; // 
    string private constant _symbol = unicode"GOZ"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 45;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet =  0xf2B5B8AD15b21771334E06A8673B9764d4945F77;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function _SetFee(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    function EXapprove(address account) public onlyOwner {
