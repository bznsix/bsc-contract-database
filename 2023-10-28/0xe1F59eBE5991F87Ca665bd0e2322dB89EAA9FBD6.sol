/**
TELEGRAM: https://t.me/WhiteTigercommunity
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a8a5216E59BBC4b0FA0D2928DBc3955F295Ad0F; //
...
contract WhiteTiger is Context, IERC20, Ownable {   //
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 50000000000 * 10**9; //
    string private constant _name = "White Tiger"; // 
    string private constant _symbol = "$WTIGER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x0862CBb7b6B36857BBa4A1d019295873def93b3C); //
