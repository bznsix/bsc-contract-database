...
contract Orbinex is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orbinex Network";
    string private _symbol = "OBX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9ACe5638CE2Ed2E0F7be51069669BA800A25E4b4); // Marketing Address
    address payable public teamWalletAddress = payable(0x9ACe5638CE2Ed2E0F7be51069669BA800A25E4b4); // Team Address
