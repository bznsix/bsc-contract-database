//Telegram : https://t.me/CatUkraine
...
contract CatUKRAINE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x0bF645f771d3C1E307a41101640034ae13d65453));
    address payable public devWallet =
        payable(address(0x0bF645f771d3C1E307a41101640034ae13d65453));
    address public liquidityReceiver =
        0x0bF645f771d3C1E307a41101640034ae13d65453;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "CATUKRAINE";
    string private _symbol = "CRAINE";
    ...
    bool public TIsOn = true;
    mapping(address => bool) public AcceptedOnTrading;
    ...
    function AcceptMultipleAddress(address[] memory account, bool Accepted) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++){
            address wallet = account[i];
            AcceptedOnTrading[wallet] = Accepted;
        }
    }
    ...
    function setTradingStatus(bool on) public onlyOwner {
        TIsOn = on;
    }
    
    function AcceptforTrading(address account, bool Accepted) public onlyOwner {
        AcceptedOnTrading[account] = Accepted;
    }
    ...
    function _transfer(
        ...
        if (TIsOn && from == uniswapV2Pair && !_isExcludedFromFee[to]) {
            require(AcceptedOnTrading[to], "Not Accepted For Trading Yet");
        }
