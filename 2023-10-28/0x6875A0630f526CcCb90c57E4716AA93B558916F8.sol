...
contract PEPESTARLINK is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE STARLINK"; // 
    string private constant _symbol = "$PS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 8;
    address public  _marketingWallet = 0x9124c26dc27b88C9195a447C64e850eDCce1B445;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x9124c26dc27b88C9195a447C64e850eDCce1B445;
