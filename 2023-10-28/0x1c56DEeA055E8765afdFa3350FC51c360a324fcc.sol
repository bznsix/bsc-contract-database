...
contract InternalSwap is Ownable {
    ...
    mapping(address => ListSwapData) addressBuyTokenData;
    mapping(address => ListSwapData) addressSellTokenData;
    ...
    function setLimitValue(uint256 _valueToLimit) external checkOwner {
    ...
    function setTaxAddress(address taxAddress_) external checkOwner {
        _taxAddress = taxAddress_;
    }

    function setAddressSellHasTaxFee(address account, bool hasFee) external checkOwner {
    ...
    function setAddressBuyHasTaxFee(address account, bool hasFee) external checkOwner {
    ...
    function setAddressBuyExcludeTaxFee(address account, bool hasFee) external checkOwner {
        _addressBuyExcludeTaxFee[account] = hasFee;
    }

    function setAddressSellExcludeTaxFee(address account, bool hasFee) external checkOwner {
        _addressSellExcludeHasTaxFee[account] = hasFee;
    }

    function calculateSellTaxFee(uint256 _amount) private view returns (uint256) {
        return (_amount * _taxSellFee) / 10000;
    }

    function calculateBuyTaxFee(uint256 _amount) private view returns (uint256) {
        return (_amount * _taxBuyFee) / 10000;
    }
    ...
    function checkCanSellToken(address _wallet, uint256 _value) internal view returns (bool) {
        ...
        InfoSwapData[] memory listSellToken = addressSellTokenData[_wallet].childList;
        bool canSell = true;
    ...
    function recoverLostBNB(uint256 _amount) public checkOwner {
