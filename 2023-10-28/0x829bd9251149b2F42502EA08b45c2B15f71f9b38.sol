...
contract MoonCheems2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x09cB5fC5fd21F550FeEdcE8C79561eB3bc070AB3); // Marketing Address
    address payable public devWalletAddress = payable(0xEcD4D7d1107325dcAd8040722FC1c96F9f63633B); // Dev Address
    ...
    string private _name = "MoonCheems2022";
    string private _symbol = "$MCheems";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 7500000 * 10**9;
