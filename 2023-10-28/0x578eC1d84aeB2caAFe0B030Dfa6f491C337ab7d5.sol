...
contract MegaDodge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MegaDodge";
    string private _symbol = "MODGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF685f98ec25F1214F6596ff404c77e52C2CBFC09);
    address payable private DevelopmentWalletAddress = payable(0xE62c1E2E2278BB1ff68C0EAAc89cc39CdA448C8b);
    ...
    uint256 private _totalSupply = 131000000000 * 10**9;
    uint256 public _maxTxAmount = 131000000000 * 10**9;
    uint256 public _walletMax = 131000000000 * 10**9;
