...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
		...
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmUfHRevotqjSA6RRazUREbQVm16s7uQ3wB4Mdyy95aTeX");
        return true;
    }
}
...
contract OSKNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("OSK NFT", "OSK NFT") {
