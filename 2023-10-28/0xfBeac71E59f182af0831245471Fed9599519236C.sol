...
contract GokuCheems2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GokuCheems2K22";
    string constant _symbol = "GOKU";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 100; // 0.1% of supply
    bool inSwap;
