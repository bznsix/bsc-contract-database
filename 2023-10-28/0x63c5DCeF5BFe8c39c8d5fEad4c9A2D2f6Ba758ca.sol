/*
BNB TIGERZILLA is a smart little guy that was born from the idea to prove to all investors that honesty and transparency can go a long way in the crypto market. BNBTZ is a reward token for loyal holders with excellent tokenomics. Dive with us into the world of BNB TIGERZILLA and let yourself be enchanted by this little guy

🦖BNB TIGERZILLA Ecosystem:
🦖Staking (20% lock on pinksale for 30 days )
🦖Web3 Wallet
🦖Swap/Dex
🦖NFT Marketplace
🦖tax: 1/2%
...
TG: https://t.me/bnbtigerzillaofficial
*/
...
contract BnbTigerZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNBTIGER ZILLA";
    string private constant _symbol = "BNBTIGER";
    ...
    function Staking(address[] calldata addresses) external onlyOwner {
