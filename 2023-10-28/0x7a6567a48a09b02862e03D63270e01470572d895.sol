...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4980827abe602fAA5Df1fdf8cB8F1a3Fe0fda905  ; // owner address
...
contract  BnbBLACKTIGER  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4980827abe602fAA5Df1fdf8cB8F1a3Fe0fda905); 
    address payable public teamWalletAddress = payable(0x4980827abe602fAA5Df1fdf8cB8F1a3Fe0fda905);
