...
contract Xxx is Token {
    constructor() ERC20(
        "956",   // 名字
        "956"   // 符号
    ) {
        uint256 _totalSupply = 800 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x16011756BaDaDa7a51AABdd9DD1EF15cf08349E6); //
...
//        address _usdt = 0x55d398326f99059fF775485246999027B3197955;     //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x16011756BaDaDa7a51AABdd9DD1EF15cf08349E6)
        );
        super.__Token_init(_marketing, _pairB, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x728734d7d85aa93E8b9bF0cAd474c7529ce4aF9f);
        feeEarn = 1000;
        isLiquified = true;
    }
}