//SummerShiba BinanceS Smart Chain token
...
contract summershiba is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SummerShiba'; // to be determined
    string private constant _symbol = 'SUMMERSHIBA'; // to be determined
    uint8 private constant _decimals = 9;

    //Supply and Reflected Supply and other options
    uint256 private constant _decimalFactor = 10**uint256(_decimals);
    uint256 private _tokenTotal = 10000000000000 * _decimalFactor ; // 
