...
contract  HalloweenFloki is ERC20 {
    using SafeMath for uint256;
    ...
    address public market = 0x3Ea0d8B81650918C6F571002BEf7347826aC2ECa;
    uint256 private txone = 2;
    uint256 private txtwo = 2;
     uint256 private swapTokensAtAmount = 1 * 10**10 * 10**18;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;

    constructor() public ERC20("HalloweenFloki", "HalloweenFloki",18) {
