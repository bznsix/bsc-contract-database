/**
Telegram: https://t.me/LUNARECLIPSETOKEN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a166c6a6264FE189E0e745420F23A2a5F213e14; // owner address
...
contract LUNARECLIPSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunar Eclipse";
    string private _symbol = "LE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a166c6a6264FE189E0e745420F23A2a5F213e14); // Marketing Address
    address payable public teamWalletAddress = payable(0x1a166c6a6264FE189E0e745420F23A2a5F213e14); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 20 * 10**_decimals; 
