...
contract Rollex is IBEP20, Ownable {
  ...
  constructor(address token_address) {
    ...
    levelCondition[2] = 0.0000001 ether;
    levelCondition[3] = 0.0000002 ether;
    levelCondition[4] = 0.0000003 ether;
    levelCondition[5] = 0.0000004 ether;
    levelCondition[6] = 0.0000005 ether;
    levelCondition[7] = 0.0000006 ether;
    levelCondition[8] = 0.0000007 ether;
    levelCondition[9] = 0.0000008 ether;
  ...
  function BuyRolex () payable public returns (uint256 id) {
    ...
    rollex_rate = getBnbBalance().div(_totalSupply);
