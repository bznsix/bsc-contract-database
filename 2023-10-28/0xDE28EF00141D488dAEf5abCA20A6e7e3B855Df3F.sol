...
contract TBTCS is IBEP20, Auth {
    ...
    string constant _name = "TBT-CryptoSolutions";
    string constant _symbol = "TBTcs";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; //5,000,000.00
    
    //max wallet holding of 5%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; //50,000,000.00
    ...
    uint256 marketingdevelopmentFee = 200;
    ...
    uint256 public swapThreshold = _totalSupply / 2000; //500,000.00
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xa7b186E41e17930F2FEb21F316C0bAd36cB45Ba8;
        isFeeExempt[_inicial] = true;
        isTxLimitExempt[_inicial] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        developmentReceiver = DEAD;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingdevelopmentFee, uint256 _feeDenominator) external authorized {
