...
contract PEPEM is Context, IERC20, Ownable {
    using Address for address;

    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x19D8565C6c5a11FCC34e524eC77CB875c5EAaDb9);
    address payable public ecosystemWallet =
        payable(0xbE4c486BD4A1ec6A1ba919316b951506e96834aA);
    ...
    //Token Definition.
    string public constant name = "Pepe Miner";
     ...
     * @param _ecosystemFee The ecosystem share of all the fees
    ...
    function setDistribution(
        ...
        emit Log("We have updated the ecosystem fee to:", ecosystemFee);
