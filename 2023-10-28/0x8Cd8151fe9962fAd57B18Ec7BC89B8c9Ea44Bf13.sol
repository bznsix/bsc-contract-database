...
| $$  \ $$| $$ \____  $$| $$_____/      | $$            | $$  \ $$ /$$__  $$| $$       /$$__  $$
| $$  | $$| $$ /$$$$$$$/|  $$$$$$$      | $$$$$$$$      | $$  | $$|  $$$$$$$|  $$$$$$$|  $$$$$$$
|__/  |__/|__/|_______/  \_______/      |________/      |__/  |__/ \_______/ \_______/ \_______/
Rise2Raca - R2R || t.me/Rise2Raca 
do you want to earn unlimited $RACA by holding some token?
introducing to you Rise2Raca the first $RACA rewads token 
earn $RACA hourly by holdings $R2R
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x12BB890508c125661E03b09EC06E404bc9289040) ; //RACA
...
contract Rise2Raca is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Rise2Raca";
    string constant _symbol = "R2R";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x12BB890508c125661E03b09EC06E404bc9289040; //RACA
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf5Ed92f620B409C3966AF2819bEbda34F91f09Ca;  // 4 marketingwallet 1 EVEROWN and 1 TEAM
    ...
    function removeStuckBNB() external authorized {
        payable(msg.sender).transfer(address(this).balance);
    }
    
    function removeForeignTokens(address token) external authorized {
