/**
https://t.me/pepetothemoonbsc
https://Twitter.com/pepetothemoonx
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C01CeBF4164B0Fd4aaB3d2014Ac5787220C2286; 
...
contract PepetotheMoon is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe to the MOON";
    string private _symbol = "PEPETOTHEMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3C01CeBF4164B0Fd4aaB3d2014Ac5787220C2286); 
    address payable public teamWalletAddress = payable(0x3C01CeBF4164B0Fd4aaB3d2014Ac5787220C2286); 
    ...
    uint256 public _walletMax = 199999999 * 10**_decimals;
