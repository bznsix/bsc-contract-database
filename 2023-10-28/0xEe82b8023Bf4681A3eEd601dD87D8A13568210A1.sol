/*
Kabosu Zilla Token Information
✅ Total Supply: 1,000,000 KabosuZill

 Tax
—  1% on Buy Transactions—
— 2% on Sell transactions —
🦖 1% Marketing and Development
🦖 1% Liquidity Pool
🦖 LP LOCK 3 Months
🦖 Renounce Ownership
🦖 20% Supply Lock for 2 weeks Will be used for (Staking,Cex Listing,Etc)

website : Soon
TG:https://t.me/kabosuzilla
*/
...
contract Kabosuzilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kabosu Zilla";
    string private constant _symbol = "Kabosuzill";
