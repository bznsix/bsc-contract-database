...
contract TYSONFURY is ERC20, Ownable {
    ...
    constructor() ERC20("Tyson Fury", "TysonFury") {
        ...
        marketingWallet = address(0xc862525E7A65535a1F3031c1fE11b156949636B8); 
        devWallet = address(0x146E8893f42a8A9801a01C6f6EeDEdd1fF67Edac);
        lpWallet = msg.sender;
