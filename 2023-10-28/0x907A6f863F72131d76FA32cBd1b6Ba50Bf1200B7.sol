...
contract Test is ERC20, Ownable {
    ...
    uint256 public taxOnBuy;
    uint256 public taxOnSell;
    ...
    constructor() ERC20("YesAnotherTest", "Test") {
        address router;
        if (block.chainid == 56) {
        ...
        liquidityTaxOnBuy  = 0;
        liquidityTaxOnSell = 0;

        taxOnBuy = 10;
        taxOnSell = 10;

        _totalFeesOnBuy = liquidityTaxOnBuy  + taxOnBuy;
        _totalFeesOnSell = liquidityTaxOnSell + taxOnSell;

        marketingWallet = 0xC84E370914E6a98D5b0dB230d5E17FBc16F3DDd1;
        teamWallet = 0xC84E370914E6a98D5b0dB230d5E17FBc16F3DDd1;
        ...
        maxTransactionAmountBuy = 200001 * (10**uint256(decimals()));
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 marketingShare = taxOnBuy + taxOnSell;



            if (marketingShare > 0) {
            uint256 marketingTokens = (contractTokenBalance * totalFee) / 100;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 newBalance = address(this).balance - initialBalance;
        uint256 marketing = newBalance / 1;
