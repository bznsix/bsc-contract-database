...
/**
Micro TIGER INU🐯🐯🐯  will sweeping the whole bsc space of meme coins. Join on our army and Don't miss a gem like this🐯🐯🐯 next BNBTIGER HYPE
https://t.me/microtigerinu
https://twitter.com/microtigerinu2023
*/
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4e3a6151a142F395d789C0CaC296e2d8F615E4f1 ;
...
contract MicroTigerInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Micro Tiger Inu"; // 
    string private constant _symbol = "Micro Tiger"; //    
