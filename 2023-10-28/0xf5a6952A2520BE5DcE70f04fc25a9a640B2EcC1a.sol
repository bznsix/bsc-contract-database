...
contract Superfist is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "fistzillacoin";
    string private _symbol = "fistzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB5d440733b3d309c0d8E7C81fF120A6707625B3A); // Marketing Address
    address payable public teamWalletAddress = payable(0xB5d440733b3d309c0d8E7C81fF120A6707625B3A); // Team Address
