...
contract MEMEETF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MEME ETF"; // 
    string private constant _symbol = unicode"METF";  //    
