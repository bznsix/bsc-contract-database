...
contract MiniLONG is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 10000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"MiniLONG"; // 
    string private constant _symbol = unicode"MiniLONG"; //    
    ...
    address public  _marketingWallet = 0x0D4cBA1b02a07FDb3eCced74A042797392Ec4496;
