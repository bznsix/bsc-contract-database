...
interface IERC20 {
  ...
  event Approval(address indexed owner, address indexed spender, uint256 value);
    ...
    contract Three_D_International  {
    ...
    constructor(address _usdtaddr)   {
        USDT = IERC20(_usdtaddr);
           ...
           feeReceivers[0] = address(0x03F9b8086B3d88e0cf58D3B5C8d3a8aE37B98d1A);   //// Creater Fund 2
           feeReceivers[1] = address(0x50A76e2e24be132c7ae5B5175951E63dC0F9ee2d);   //// Developer Fund  1.5
           feeReceivers[2] = address(0x35bFbBDdb641b880FF7C44535FB94B81235dF683);   //// Reserve fund 1.5
