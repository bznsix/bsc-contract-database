...
contract Pandass is ERC20, Ownable {
    ...
    uint256 public minswapamount = 10000e18;
    ...
    constructor () ERC20("Pandass", "PANDA") 
    {   
        ...
        marketingWallet = address(0xd330E486eA01eB333f64997D57dA28F32A07f5d1);
        ...
        _mint(0xd811112CAA40d8fbf729BE685C6294e7d8596443, 1000000000e18);

        swapTokensAtAmount = 20000e18;
        maxWallet = totalSupply() / 10000000; // 1% maxWallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        liquidityFeeOnBuy = _marketingFee;
        marketingFeeOnBuy = _liquidityFee;
        _totalFeesOnBuy = liquidityFeeOnBuy  + marketingFeeOnBuy;
        require(_totalFeesOnBuy <= 30, "Must keep fees at 30% or less");
    }
 
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        liquidityFeeOnSell = _marketingFee;
        marketingFeeOnSell = _liquidityFee;
        _totalFeesOnSell = liquidityFeeOnSell + marketingFeeOnSell;
        require(_totalFeesOnSell <= 30, "Must keep fees at 30% or less");
    }
    ...
    function updateMaxWalletAmount(uint256 newAmount) external onlyOwner {
        require(newAmount >= (totalSupply() * 5 / 1000), "Cannot set maxWallet lower than 0.5%");
        maxWallet = newAmount;
    }

     function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > minswapamount, "SwapTokensAtAmount must be greater than min swap amount");
