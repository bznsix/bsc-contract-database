...
contract RIOTCOIN is BEP20, Ownable {
    ...
    bool public Jeffing = false;

    uint256 public constant totSupply =  1 * 10**5 * 10**9; // 100 MIO
    ...
    constructor() BEP20("RIOT Coin", "RIOT") {
    ...
    function startJeff() external onlyOwner {
        require(!Jeffing, "it's already started");
        Jeffing = true;
        providingLiquidity = true;
    }

    function afterJeffWakes() external onlyOwner {
        buyTaxes = Taxes(0, 0);
        sellTaxes = Taxes(0, 0);
