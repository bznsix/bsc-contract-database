...
contract FLOKICULA is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x9Dc2e62AA7c1008bE5EA6c80dC9Af02E1453BD10);

    string public _name = "FLOKICULA ";
    string public _symbol = "$FLOCULA";
    ...
    uint256 private fee_totals = 9;
    uint256 public buying_fee = 0;
    uint256 public selling_fee = 9;
