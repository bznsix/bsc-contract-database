...
contract Dogectober is Context, IERC20, Ownable {
    ...
    string private _name = "Dogectober";
    ...
    address payable public marketingWallet = payable(0x29e5776e6Ed0Fb28F92aF7cB9fea140EB53bF051);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2500000 * 10**18;
    uint256 public _maxTxAmount = 25000000 * 10**18;
    uint256 public _maxWalletLimit = 25000000 * 10**18;
    address admin;
