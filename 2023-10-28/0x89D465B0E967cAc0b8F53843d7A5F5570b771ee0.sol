...
contract HYDRAGON is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2024 * 1e10 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    string private constant _name = "HYDRAGON";

    string private constant _symbol = "HYDRAGON";
    ...
    uint256 public maxWallet = _tTotal * 1 / 100 ; // 1% at launch
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      ...
      require(_walletMax >= _tTotal * 1 / 500 , "Must keep above 0.2%");
        }
