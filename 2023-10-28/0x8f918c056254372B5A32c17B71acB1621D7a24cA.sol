...
//instagram:        https://instagram.com/iasolutionsofc?igshid=OGQ5ZDc2ODk2ZA==
//Telegram :        https://t.me/IAsolutionsPro
//Twitter:          https://x.com/IASolutionsofc?t=5o8ctQnOvPpfLInM8_nfHQ&s=09
...
contract IASOLUTIONS {
    DividendDistributor public distributor;
    IDEXRouter public router =
        IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    BEP20 MTK = BEP20(0xa2D5A2b91CF649Fa470f3dbC5D40398743Afc523);
    string constant _name = "IASOLUTIONS";
    string constant _symbol = "IAS";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 2000000000000000000000000000000;
    ...
    uint256 public transferMarketingFee = 500;
    uint256 public transferPoolFee = 0;
    uint256 public transferReflectionFee = 500;
    ...
    function _isSell(bool a, bool b) internal view returns (uint256) {
        if (a) {
            return sellTax;
        } else {
            if (b) {
    ...
    function BURNFEE(bool a, bool b) internal view returns (uint256) {
        if (a) {
            return sellBurnFee;
        } else {
            if (b) {
                ...
                return transferBurnFee;
            }
        }
    }

    function MKTFEE(bool a, bool b) internal view returns (uint256) {
        if (a) {
            ...
            if (b) {
                ...
                return transferMarketingFee;
            }
        }
    }

    function LIQUIFYFEE(bool a, bool b) internal view returns (uint256) {
        if (a) {
            ...
            if (b) {
                ...
                return transferLiquidityFee;
            }
        }
    

    function STAKEPOOLFEE(bool a, bool b) internal view returns (uint256) {
        if (a) {
            return sellPoolFee;
        } else {
            if (b) {
                ...
                return transferPoolFee;
            }
    }

    function REFPOOLFEE(bool a, bool b) internal view returns (uint256) {
        if (a) {
    ...
    function _transferFrom(
        ...
        if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
            ...
            uint256 liquidifyFeeAmount = value(
                amount,
                LIQUIFYFEE(pair[recipient], pair[sender])
            );
            uint256 stkpoolFeeAmount = value(
                amount,
                STAKEPOOLFEE(pair[recipient], pair[sender])
            );
            uint256 marketingFeeAmount = value(
                amount,
                MKTFEE(pair[recipient], pair[sender])
            );
            uint256 refFeeAmount = value(
                amount,
                REFPOOLFEE(pair[recipient], pair[sender])
            );
            uint256 burnFeeAmount = value(
                amount,
                BURNFEE(pair[recipient], pair[sender])
            );
            ...
            feeAmount = value(amount, _isSell(pair[recipient], pair[sender]));
