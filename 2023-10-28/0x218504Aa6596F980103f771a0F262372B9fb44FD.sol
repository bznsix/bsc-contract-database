/*
   Official Community: https://t.me/only_network
*/
...
contract ONLYNETWORK is IERC20, Context, Ownable {
    ...
    uint256 private _tTotal = 450000000  * 10 **_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 private genesis_block;
    
    string private constant _symbol = "ONLY";
    string private constant _name = "ONLY NETWORK";

    uint256 public Max_Buy_Limit = 4500000 * 10**9;
    uint256 public Max_Sell_Limit = 4500000 * 10**9;

    address private Marketing_Wallet = 0x4CDe141cA1AF04AF6E951DAC99acCFA5cfA886f3;
    address private Team_Wallet = 0x4CDe141cA1AF04AF6E951DAC99acCFA5cfA886f3;

    uint256 public Max_Wallet_Holding = 4500000  * 10**9;
    uint256 private swapTokensAtAmount = 2250000 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 25, 0, 0);
    Taxes public taxes = Taxes(0, 40, 0, 0);
