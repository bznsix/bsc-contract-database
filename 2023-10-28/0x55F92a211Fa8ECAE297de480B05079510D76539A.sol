/*
Icarus and Keith saving one calf at a time! 
*/
...
contract Calf is ERC20, ERC20Burnable, Ownable, Pausable, TokenRecover, DividendTrackerFunctions, Initializable {
    ...
    constructor()
        ERC20(unicode"Calf", unicode"CALF") 
    {
        address supplyRecipient = 0x5baE1F5d5Ba8eF8466370F6cf083560aAa139C23;
        
        updateSwapThreshold(50);

        _deployDividendTracker(7200, 1000 * (10 ** decimals()) / 10);

        gasForProcessingSetup(300000);
        rewardsFeesSetup(800, 800, 0);
        ...
        _transferOwnership(0x5baE1F5d5Ba8eF8466370F6cf083560aAa139C23);
    }
