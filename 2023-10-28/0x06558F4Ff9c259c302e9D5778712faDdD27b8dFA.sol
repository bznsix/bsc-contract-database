...
contract BNBMEME is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB Meme";
    string private _symbol = "BNB Meme";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d054F613073683D32Dc1F7Dd2E1f637889bf12C); 
