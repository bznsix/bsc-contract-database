...
contract SMURF is ERC20, Ownable {
    ...
    constructor() ERC20("Real Smurf Cat", "SMURF") {
        ...
        maxTransactionAmount = 3 * 1e13 * 1e18; 
        maxWallet = 3 * 1e13 * 1e18; 
        ...
        devWallet = address(0xeE9e3cac7361F0FdD2D3c58C2a0782E5650a1f08); 
