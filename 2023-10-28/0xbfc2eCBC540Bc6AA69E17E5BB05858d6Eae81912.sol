...
contract Fractal1k is Ownable, ReentrancyGuard {
    address payable principalWallet = payable(0xc3D2A7673Ba20305bDd9CFac16f884daAbD69eBb); 
    ...
    uint256 priceStaking = 2*10**26; // precio decimal USD
    ...
    constructor() {
        ...
        totalWallets = 200;
        maxEarn = 3333333*10**18;
        earnPerSecond= 535800000 * 10 ** 8;
       
    }

    // Token FTR Address
    IERC20 public token = IERC20(0xa2575197D2b5853A62307023bF6bd4797270F21C);
