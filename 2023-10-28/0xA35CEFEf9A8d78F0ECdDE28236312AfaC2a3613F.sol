...
contract AppleWeen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AppleWeen";
    string private _symbol = "APEN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x27b8Fb0E2FF0BD665b9FcfdAFCd4e85159264AB3);
    address payable private DevelopmentWalletAddress = payable(0x217DEA1b889962D3a17Fc7ce77528e224Ac83b8c);
    ...
    uint256 private _totalSupply = 36000000000 * 10**9;
    uint256 public _maxTxAmount = 1080000000 * 10**9;
    uint256 public _walletMax = 1080000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10000000 * 10**9; 
