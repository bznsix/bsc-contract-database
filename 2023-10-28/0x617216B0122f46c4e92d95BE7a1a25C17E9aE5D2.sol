...
// File: contracts/AnimalNFT.sol


pragma solidity ^0.8.0;


contract CAPNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    mapping(address => bool) private _minters;

    string public _baseUri = "https://metadata.com/"; 
    ...
    constructor() ERC721("capsss", "capsss") {
