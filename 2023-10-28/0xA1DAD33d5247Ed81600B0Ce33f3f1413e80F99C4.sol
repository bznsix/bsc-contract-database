    ...
    GovernorVotesQuorumFractionUpgradeable
{
    ...
    // Address of GOVERNANCE NFT for executing functions
    NFTContractInterface public nftContract;
    ...
    constructor(
        ...
        nftContract = NFTContractInterface(_token);
    ...
    function swapOSEANForBNB(uint256 amount) external onlyGovernance {
        ...
        oseanToken.approve(address(uniswapRouter), 0);
    } 

     function updateClaimConditions(NFTContractInterface.ClaimCondition[] calldata conditions, bool resetClaimEligibility) 
        external 
        onlyGovernance {

        nftContract.setClaimConditions(conditions, resetClaimEligibility);
    }
}
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
interface NFTContractInterface {
    ...
    function setClaimConditions(ClaimCondition[] calldata conditions, bool resetClaimEligibility) external;
}// SPDX-License-Identifier: MIT
