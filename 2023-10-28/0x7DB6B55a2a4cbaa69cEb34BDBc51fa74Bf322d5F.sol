...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x40703E2665Ac4eb205828Ebe846d99E26F988ace ; // owner address
...
contract  BABYMAKEBNBGREATAGAIN  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Make BNB Great Again";
    string private _symbol = "BABYMBGA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40703E2665Ac4eb205828Ebe846d99E26F988ace); 
    address payable public teamWalletAddress = payable(0x40703E2665Ac4eb205828Ebe846d99E26F988ace);
