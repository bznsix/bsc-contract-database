...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA6E0Bd5D910647e0e4Bc07E9c7C99819b9bD2caC; 
...
contract chro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "C H R O CHAIN";
    string private _symbol = "$C H R O";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6E0Bd5D910647e0e4Bc07E9c7C99819b9bD2caC); // 
    address payable public teamWalletAddress = payable(0xA6E0Bd5D910647e0e4Bc07E9c7C99819b9bD2caC); // 
