...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8A2e43583A528277E96515c13d5DF17f3b90b747; 
...
contract GuineaPigBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Guinea Pig Bsc";
    string private _symbol = "GPB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x085D1938EE6fF39bD6382A7D0fAE4F27E827E48a);
    address payable public teamWalletAddress = payable(0x085D1938EE6fF39bD6382A7D0fAE4F27E827E48a); 
