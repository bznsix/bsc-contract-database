...
/*
Kill All Zeros - $KT0
Aim of the project is to achieve a $1 price per token.  

10% sell and buy fees
...
Website: kill-the-zeros.com
TG: t.me/killthezeros
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 20_000 * 10**9;
    ...
    address public marketingWallet = 0xF497a015e81e1bE3cDAFd6CCeC50E5AfEc90852c;
    address public devWallet = 0x23e5276E2aD0f631559735490be5216c60E170aF;
    address public buybackWallet = 0x8a6D7E98995eB5Cfa8db6b17221a1A6B58390410;

    string private constant _name = "Kill The Zeros";
    string private constant _symbol = "KT0";
    ...
    Taxes public taxes = Taxes(2, 3, 1, 1, 3);
    Taxes public sellTaxes = Taxes(2, 3, 1, 1, 3);
