...
contract GTG is Context, IERC20, Ownable {
    ...
    string private _name = "GTG";
    string private _symbol = "GTG";
    ...
    address public constant marketAddress = address(0x97D1aB5d142227c0F68dc393B4094E89076703A6);

    constructor (address _route) public {
        _tOwned[address(0x1122DA8eb411e53E45F590826f7EA0a1C2Ad10c3)] = _tTotal;
        ...
        _isExcludedFromFees[address(0x1122DA8eb411e53E45F590826f7EA0a1C2Ad10c3)] = true;
        _isExcludedFromFees[address(0x97D1aB5d142227c0F68dc393B4094E89076703A6)] = true;
        _isExcludedFromFees[address(0x9d8E0d221dA5D223db8E98343eDEF3fCaCe89093)] = true;
        _isExcludedFromFees[address(0x000000000000000000000000000000000000dEaD)] = true;
        _isExcludedFromFees[address(this)] = true;

        emit Transfer(address(0), address(0x1122DA8eb411e53E45F590826f7EA0a1C2Ad10c3), _tTotal);
    }
