...
contract XSIMPSONS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "XSIMPSONS";
    string private constant _symbol = unicode"$XSIM";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 789000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xd642BE8e740b39f7528039330A52254dc3450ab2);
    address payable public MarketingWallet = payable(0x08A57aAf7dD85F91c77438F9053e33b328de7ef1);
