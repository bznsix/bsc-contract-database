...
Luffy Gear 5 (LUFFYGEAR5) is a BEP-20 token on the Binance Smart Chain (BSC) network. It is a fan token inspired by the anime One Piece and its main character Monkey D. Luffy. The token claims to have a 10% tax on every transaction, distributed as follows: 6.5% to the marketing wallet, 1.5% to the liquidity pool, and 2.5% to the development wallet. The token also claims to have anti-whale and anti-bot features. The token's contract address will be announced soon.

The team aims to hold the floor and push slowly to this Sunday, August 6, 2023. This is the time for us to the moon when Gear 5 is released.

https://t.me/LuffyGear5BSC
...
contract LuffyGear5 is Context, IERC20, Ownable {
    ...
    string private _name = "Luffy Gear 5";
    string private _symbol = "LUFFYGEAR5";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xA2bd98B3038bAc9bbdc042bB1e25b7a376d16a38);
    address payable public teamWalletAddress =
        payable(0xE89F9246601B945A55e603F0d3AE0D9cF7b43073);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply / 1000;
