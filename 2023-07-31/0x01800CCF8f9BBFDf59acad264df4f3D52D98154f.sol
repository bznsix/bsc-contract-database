...
contract Xpoocoin is Context, IERC20 {
    string private _name = "XPooCoin";
    string private _symbol = "$XPC";
    ...
    address payable public MarketingWallet = payable(0xa092b6016152160f8B33aDD2808284ad22515226);
