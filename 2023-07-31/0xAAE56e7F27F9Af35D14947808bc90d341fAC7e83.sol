...
Binance Liq
- BL
This token will be used as the game currency and transaction fees may vary, it was created just for the game.
This contract was created by a freelancer developer. 
He has no relationship with this project and this project has been deployed for game currency.
...
contract BinanceEsaste is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Binance Zone";
    string private _symbol = "BZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9c4DC4E34d441e5a09AAeb34cA3a32B17e392156);
    address payable public liqWalletAddress = payable(0x9c4DC4E34d441e5a09AAeb34cA3a32B17e392156);
    ...
    constructor () {
        //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 TEST
        //0x10ED43C718714eb63d5aA57B78B54704E256024E Main
