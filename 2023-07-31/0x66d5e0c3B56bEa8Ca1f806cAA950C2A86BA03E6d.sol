...
contract KISSDUST is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd4679248996678f6f6965843435f89f6a1C1BF50); 
    address payable public Wallet_Dev = payable(0xd4679248996678f6f6965843435f89f6a1C1BF50);
    ...
    string private constant _name = "KISS DUST"; 
    string private constant _symbol = unicode"KISS DUST"; 
    ...
    constructor () {
        ...
        _owner = 0xd4679248996678f6f6965843435f89f6a1C1BF50;
