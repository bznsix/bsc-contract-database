...
contract Coco is Context, IERC20, Ownable {
    ...
    string private _name = "0xCoco";
    string private _symbol = "COCO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xE288C7128bc876217da6E6C5ad3e1bcF069805D7); // Marketing Address
    address payable public BuyBackWalletAddress =
        payable(0xE288C7128bc876217da6E6C5ad3e1bcF069805D7); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(
            maxTxAmount <= (60 * 10**6 * 10**9),
            "Max wallet should be less or euqal to 6% totalSupply"
        );
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBLiquidity = amountReceived
            ...
            .div(totalBNBFee)
            .div(2);
        uint256 amountBNBBuyBack = amountReceived.mul(_BuyBackShare).div(
            totalBNBFee
        );
