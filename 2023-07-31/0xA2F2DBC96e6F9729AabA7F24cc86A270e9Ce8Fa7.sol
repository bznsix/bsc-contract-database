...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7154736Cc94D24ac16719D101BAAE65b588CFB3f; // owner address
...
contract BaseInu is Context, IERC20, Ownable {
    ...
    string private _name = "Base Inu";
    string private _symbol = "Base";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7154736Cc94D24ac16719D101BAAE65b588CFB3f); // Marketing Address
    address payable private teamWalletAddress = payable(0x7154736Cc94D24ac16719D101BAAE65b588CFB3f); // Team Address
