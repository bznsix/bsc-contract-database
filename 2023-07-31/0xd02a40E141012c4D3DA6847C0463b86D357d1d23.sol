...
contract xinu is Context, IERC20, Ownable { 
    ...
    address payable public _TEAM_MARKETING_ = payable(0x5ff33BF088433558f19291d5D199a6A29b57cCB6);

    string public _name = "X INU";
    string public _symbol = "X INU";
