...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63f64fF4a655228C53ce944de068A91857C12dC3; 
...
contract PEPEXBIGBRAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEXBIGBRAIN";
    string private _symbol = "PXBB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x63f64fF4a655228C53ce944de068A91857C12dC3); // 
    address payable public teamWalletAddress = payable(0x63f64fF4a655228C53ce944de068A91857C12dC3); // 
