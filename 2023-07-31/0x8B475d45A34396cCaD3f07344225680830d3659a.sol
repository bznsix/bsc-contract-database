...
/**
Twitter + squid = Twuid Inu
tg:https://t.me/TwuidInuOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF392C09693971fb96678f886d926ed2A4bF5BA56; // owner address
...
contract TwuidInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twuid Inu";
    string private _symbol = "$Twuid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF392C09693971fb96678f886d926ed2A4bF5BA56); // Marketing Address
    address payable public teamWalletAddress = payable(0xF392C09693971fb96678f886d926ed2A4bF5BA56); // Team Address
