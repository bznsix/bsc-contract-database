/**
TG: https://t.me/Alveychaintwopointzerobsc
Twitter: https://twitter.com/Alvechain2
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3F2880A6b5832e4ff5C9254771674347E359b3d; // owner address
...
contract Alveychaintwopointzerobsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvey Chain 2.0";
    string private _symbol = "$AC2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x75a28f8Dda3af0EbfBb0E3FC437e038013be2BBb); // Marketing Address
    address payable private teamWalletAddress = payable(0xb3F2880A6b5832e4ff5C9254771674347E359b3d); // Team Address
