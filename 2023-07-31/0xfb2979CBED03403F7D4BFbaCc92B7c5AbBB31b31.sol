...
Twitter: https://twitter.com/ELONSSON_
WEBSITE :https://babyelon.static.app/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAEd2611cB3BEb7f39E44B0bd47E720EBc80472Cb; // owner address
...
contract LILXELONSSONOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LIL X ELON SON";
    string private _symbol = "$LILX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x65f174eDd4e2E500c22D71183dE9e2Ba4E90a680); // Marketing Address
    address payable private teamWalletAddress = payable(0xAEd2611cB3BEb7f39E44B0bd47E720EBc80472Cb); // Team Address
