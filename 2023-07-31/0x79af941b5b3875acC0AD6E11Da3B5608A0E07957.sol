...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _startRewardTime = 1690527850;
    ...
    uint256 public _startLPRewardTime = 1690527997;
    ...
    constructor (
        ...
        uint256 receiveTotal = total * 40 / 100;
       ...
       // emit Transfer(address(0), tokenDistributor, receiveTotal);
        ...
        _dogeLPRewardCondition = 164380 * tokenDecimals;
        _dogeLPInviteRewardCondition = 164380 * tokenDecimals;
...
contract ArbToken  is AbsToken {
    constructor() AbsToken(
    //SwapRouter
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955), 
        address(0x92aFE6Fe6EF0BDdeC283070C7197B2fEfe7c5982),
        "ARB1",
        "ARB1",
        18,
        10000000000,
    //Receive
        address(0x7D311bf505540E003B1320b76844Af613D370772),
    //Fund
        address(0x801fb11E8a9d2E11076056468840cd16b369D631)
    ){
