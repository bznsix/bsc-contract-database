...
//telegram : https://t.me/NeXtComunnityBSC
//Twitter  : https://twitter.com/NEXT_Community
...
contract NEXTCOIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NEXT COIN";
    string constant _symbol = "$NEXT";
    ...
    //Mainnet
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 20000000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9e2af89a9C1779ea7efE3b1210b46db1a65d1748;
        buybackWallet = 0x9e2af89a9C1779ea7efE3b1210b46db1a65d1748;
