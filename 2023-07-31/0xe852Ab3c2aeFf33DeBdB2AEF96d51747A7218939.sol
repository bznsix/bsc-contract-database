/** 
    ...
    This project was launched with a 5% Pre-Own
    See https://coolshiba.carrd.co/ for more detail.

    15% FEES PER TRANSACTION
    - 5% distributed to all holders proportionally
    - 5% fee per transaction auto add to the liquidity pool
    - 3% send to dev/marketing wallet
    - 2% burned forever
...
contract COSHI is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0x0A990E287Fd96bafcCC1318A0Ea9B4df46d1DBa6;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "Cool Shiba (t.me/CoolShiba)";
