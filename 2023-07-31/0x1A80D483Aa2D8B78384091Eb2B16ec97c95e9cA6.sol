...
contract MetaKongGorilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaKongGorilla";
    string private _symbol = "MKG";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x36e153a27DfFFc46D3E24747e187AC136729e70A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x32c2AffCD0195b5AC5F242285fcC4Ef9A42C9429); // BuyBack Address
