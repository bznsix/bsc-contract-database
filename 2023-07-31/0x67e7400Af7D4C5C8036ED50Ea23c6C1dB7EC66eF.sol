...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdBccBfAc6B3f0bc6E26d3F0E1FF254e2310DE686; // owner address
...
contract KukuBSCofficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KuKu";
    string private _symbol = "$KUKU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x553d6Cf4EEB4136F409Ab080e50b0DEda4d736Bf); // Marketing Address
    address payable private teamWalletAddress = payable(0xdBccBfAc6B3f0bc6E26d3F0E1FF254e2310DE686); // Team Address
