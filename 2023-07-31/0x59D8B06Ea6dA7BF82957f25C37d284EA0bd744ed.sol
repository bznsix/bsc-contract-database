...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73d21AeabE8c13c2c4F00715F627b88025C80026;
...
contract ANAL  is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x17F76321ac696Ff610D2060ABe1e856008230f82;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "I LOVE ANAL";
    string private _symbol = "I love Canada";
