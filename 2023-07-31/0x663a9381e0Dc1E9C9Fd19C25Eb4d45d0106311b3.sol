...
contract BaseBinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Base Binance";
    string private constant _symbol = "$BASEBNB";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 100000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 100000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        _isIncludedFromFee[0x6702d5b1Ee026a9d5ac26E792029b1F19e121175] = true;
        ...
        _isIncludedFromFee[0x69E3Fae042fb8De75eF777412Da23e2AD575256E] = true;
        _isIncludedFromFee[0xfC06091498Cb8C28A9291FA0B9CA406A6Fa09552] = true;
