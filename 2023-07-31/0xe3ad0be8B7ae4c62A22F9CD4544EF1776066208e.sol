...
contract XFactor is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"X Factor";
    string private _symbol = unicode"XFACTOR";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC1e7428C11cdDF648966eE00Fa7d4aa43E2Ec776);
    address payable private taxWallet2 = payable(0xC1e7428C11cdDF648966eE00Fa7d4aa43E2Ec776);
    ...
    uint256 public _sellMarketingFees = 9;
    ...
    uint256 public _walletMax = _totalSupply*300/10000;
