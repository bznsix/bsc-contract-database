...
contract DIEGO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB8784462Da86b430fc4B8a7f5A3Fdd8f130726cE); 
    address payable public Wallet_Dev = payable(0xB8784462Da86b430fc4B8a7f5A3Fdd8f130726cE);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =3000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "DIEGO"; 
    string private constant _symbol = unicode"$DIEGO"; 
    ...
    constructor () {
        _owner =0xB8784462Da86b430fc4B8a7f5A3Fdd8f130726cE;
