...
/**
elon tweet about matrix
https://t.me/ElonReevesOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x022Db9794491A1Ec0753E41bE1206c4A21FcF1Fc; // owner address
...
contract ElonReeves is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Reeves";
    string private _symbol = "$MATRIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F5Bfa78B090b543686630BD21eD89d8529776A5); // Marketing Address
    address payable public teamWalletAddress = payable(0x4F5Bfa78B090b543686630BD21eD89d8529776A5); // Team Address
    ...
    uint256 public _liquidityShare = 10; // original 5
    ...
    uint256 public _totalDistributionShares = 80;  // original 12
