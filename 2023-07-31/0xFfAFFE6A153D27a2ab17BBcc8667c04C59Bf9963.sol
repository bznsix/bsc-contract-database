...
contract HAMA20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "HAMA2.0";
    string private _symbol = "HAMA2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x783291025EF995dBF95B622cD26e6a529FD78674);
