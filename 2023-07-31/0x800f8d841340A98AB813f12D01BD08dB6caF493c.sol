...
contract XDolphin is Context, IERC20, Ownable {
    ...
    uint256 public _maxTokenHolder = 5000 * 10**3 * 10**18;
    uint256 public maxBuyAmount = 5000 * 10**3 * 10**18;
    uint256 public maxSellAmount = 5000 * 10**3 * 10**18;
    uint256 public swapTokensAtAmount = 1000000 * 10**3 * 10**18;
    ...
    string private constant _name = "XDolphin ";
    string private constant _symbol = "XD";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0x50acBE247F8b77a814DA917727d4E38CabbCA715);
    address payable private _marketingAddress = payable(0x50acBE247F8b77a814DA917727d4E38CabbCA715);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 5);
	    require(redisFeeOnSell < 5);
