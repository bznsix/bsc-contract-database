...
contract Woody is Context, IERC20 {
    string private _name = "WOODY";
    string private _symbol = "$WOODY";
    ...
    uint256 public _buy_free = 0;
    uint256 public _sell_free = 0;
    ...
    address payable public MarketingWallet = payable(0xd008bbB3f8CA7E0aCA53cB5f41653558FBA68155);
