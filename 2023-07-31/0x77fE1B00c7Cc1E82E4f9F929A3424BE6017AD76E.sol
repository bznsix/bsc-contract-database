...
contract XBarbie is Context, IERC20, Ownable {
    ...
    string private _name = unicode"X BARBIE";
    string private _symbol = unicode"$XBARBIE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x09D2A30E50015E9386a6A337143Cea40F9540ee4);
    address payable private taxWallet2 = payable(0x09D2A30E50015E9386a6A337143Cea40F9540ee4);
