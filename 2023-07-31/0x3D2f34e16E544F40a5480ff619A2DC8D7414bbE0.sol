...
contract MafiaBear is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xb87979E325981c572CA9B6eb0ACFae6a1e709553);
    address payable private _twdmkt = payable(0xb87979E325981c572CA9B6eb0ACFae6a1e709553);
    
    string private constant _name = "MAFIA BEAR";
    string private constant _symbol = "MAFIABEAR";
