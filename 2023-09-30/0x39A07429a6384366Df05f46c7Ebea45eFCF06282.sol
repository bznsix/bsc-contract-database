...
contract BaoBeyToken is ERC20, Ownable {
    address public constant mint_wallet = 0x380F3734C32F0ef998955E5d57BA1E69f7a5DD4f;
    
    constructor() ERC20("BaoBey", "BeBe", 9)  {
        _mint(mint_wallet, (9*10**8) * (10 ** uint256(decimals())));
    }
