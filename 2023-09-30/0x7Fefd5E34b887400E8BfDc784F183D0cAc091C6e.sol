...
contract AbrahamSonsToken is ERC20, Ownable {
    bool public channelState = true;

    constructor() ERC20("Abraham Sons Token", "ABST") {
    ...
    function _transfer(
        ...
        if(shouldCheckChannel){
            require(channelState, "ABST: Channel is closed");
        }
