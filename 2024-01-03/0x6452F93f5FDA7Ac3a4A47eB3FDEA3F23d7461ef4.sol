//telegram：https://t.me/PEPEGROKMOON
...
contract PEPEGROK is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketAddress = payable(0xF51b4085322E53143Be885af4f31015d6D893703);
        ...
        _airdropAmount = 1000000 * 10 ** _decimals;
        _airdropBNB = 0.5 * 1e18;
        maxDrop = 2000;
        dropLimit = 10;

        _totalSupply = 42069000000000 * 10**_decimals;
