...
/**
 Welcome to DIGINET, an innovative crypto project focusing on the development of a Layer 1 blockchain. Our inaugural launch is set to take place on the BSC network.

DIGINET is dedicated to redefining decentralized technologies through the construction of a robust Layer 1 blockchain. Our commitment to excellence encompasses scalability, security, and efficiency, setting the stage for a new epoch of blockchain innovation.

As we embark on this groundbreaking venture, we invite you to join us in shaping the future of Layer 1 blockchain technology.


/**
 TELEGRAM :https://t.me/DiginetAnnouncement
 WEBSITE  :
...
contract DIGINET is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DIGINET";
    string private _symbol = "DIGINET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xb1ba9c63d97DF69D4794349298FbbbAb849B0fa9);
