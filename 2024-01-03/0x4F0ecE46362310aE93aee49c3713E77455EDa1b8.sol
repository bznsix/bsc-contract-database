...
/// @title Callback for ISquadV3PoolActions#mint
/// @notice Any contract that calls ISquadV3PoolActions#mint must implement this interface
interface ISquadV3MintCallback {
    /// @notice Called to `msg.sender` after minting liquidity to a position from ISquadV3Pool#mint.
    ...
    /// @param data Any data passed through by the caller via the ISquadV3PoolActions#mint call
...
import '@squadswap/v3-core/contracts/interfaces/callback/ISquadV3MintCallback.sol';
...
/// @notice Internal functions for safely managing liquidity in SquadSwap V3
abstract contract LiquidityManagement is ISquadV3MintCallback, PeripheryImmutableState, PeripheryPayments {
        ...
        )
    {
        ...
        pool = ISquadV3Pool(PoolAddress.computeAddress(deployer, poolKey));
...
/// @notice Provides validation for callbacks from SquadSwap V3 Pools
library CallbackValidation {
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (ISquadV3Pool pool) {
...
import '@squadswap/v3-core/contracts/libraries/FixedPoint96.sol';
