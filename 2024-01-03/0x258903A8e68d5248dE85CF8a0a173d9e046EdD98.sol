...
//--- Contract v3 ---//
contract BabyElon is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(address(0x23Ab94860168D5817B5000Cf0a62b009059dDafC));


    IRouter02 public swapRouter;
    string constant private _name = "Baby Elon";
    string constant private _symbol = "BabyElon";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x03eD568bb6e426881392f411F4cfe766Fe2fc43A);
