...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc7d8eB0665C5548EeB39fcc4027Df5EE23f0E00d; // owner address
...
contract SILLY is Context, IERC20, Ownable {
    ...
    string private _name = "Silly Dragon";
    string private _symbol = "SILLY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc7d8eB0665C5548EeB39fcc4027Df5EE23f0E00d); // Marketing Address
    address payable private teamWalletAddress = payable(0xc7d8eB0665C5548EeB39fcc4027Df5EE23f0E00d); // Team Address
