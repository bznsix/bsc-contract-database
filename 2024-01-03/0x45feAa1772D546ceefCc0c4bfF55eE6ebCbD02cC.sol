...
/**
* website: https://babydoge-reflection-doge.my.canva.site/
* Telegram: https://t.me/Babydogerewarddoge
* X: https://x.com/babydogreward
*/
...
contract GGGTOKEN is ERC20, Ownable, BaseToken {
    ...
    string public website = "https://babydoge-reflection-doge.my.canva.site/";
    string public Telegram = "https://t.me/Babydogerewarddoge";
    string public X = "https://x.com/babydogreward";
    ...
    function initialize ( bytes memory _data) public {
        ...
        _rewardToken = addrP[5];
        _token = addrP[3];
        _marketAddr=addrP[1];
        _maxBuyTax =  uintP[2]* (10**uint256(18));
        _maxSellTax =  uintP[12]* (10**uint256(18));
        _maxHave =  uintP[3] * (10**uint256(18));
        _intervalSecondsForSwap = uintP[4];
        _dropNum = uintP[5];
        _buyMarketingFee =uintP[6];
        _buyBurnFee =uintP[7];
        _buyLiquidityFee =uintP[8];
        _buyTokenRewardsFee = uintP[14];
        _sellMarketingFee =uintP[9];
        _sellBurnFee =uintP[10];
        _sellLiquidityFee =uintP[11];
        _sellTokenRewardsFee = uintP[15];
        _enabOwnerAddLiq = boolP[0];
        _tranFee = boolP[1];
        dividendTracker = BABYTOKENDividendTracker(
            payable(Clones.clone(addrP[4]))
        );
        dividendTracker.initialize(
            _rewardToken,
            uintP[13]* (10**uint256(18))
        );

        _uniswapV2Router = IUniswapV2Router02(addrP[2]);
        uniswapV2Router = addrP[2];
        ...
        */
        uint256 _tTotal = uintP[1]* (10**uint256(18));
