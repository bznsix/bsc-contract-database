// BSC SERIE OF POKER (BSOP)

// Telegram https://t.me/+E8XwllMzUmljMTZk
// Youtube https://www.youtube.com/@BSOPBscSeriesOfPoker
// Tiktok https://www.tiktok.com/@bsopbsc?_t=8ihAqqbk3mK&_r=1
// Twitter https://twitter.com/BscOfPOKER
// Facebook https://www.facebook.com/profile.php?viewas=100000686899395&id=61555333675280
// Instagram https://www.instagram.com/activejackpot?igsh=dHQwdThuN2t4cWl5
...
//--- Contract v3 ---//
contract BSOP is Context, Ownable, IERC20 {
    ...
    uint256 constant public buyfee = 100;
    uint256 constant public sellfee = 100;
    uint256 constant public transferfee = 0;
    uint256 constant public fee_denominator = 1_000;
    bool private canSwapFees = true;
    address payable private marketingAddress = payable(0x7CBBAc9DBE3b1B4C9c0C2540aae9706cdf2322aC); // build: 0x7CBBAc9DBE3b1B4C9c0C2540aae9706cdf2322aC
    address payable private devWallet = payable(0x7CBBAc9DBE3b1B4C9c0C2540aae9706cdf2322aC); // build: 0x7CBBAc9DBE3b1B4C9c0C2540aae9706cdf2322aC
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "BSC Series of Poker";
