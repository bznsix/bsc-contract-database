...
contract BlueBird is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xF98a60E6d524a4a642688d5930FF0cd1a38b5519);

    string public _name = "BlueBird";
    string public _symbol = "BBD";
