...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 30;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5e57ac722311d9B8CC8920075Adcbb925f8d7300), block.timestamp
                );
            }
        }
    }
...
contract BabyAnyInu is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x8da382AB54E1Bd2F2bc3d295E0346d61536d550D),//FundAddress
        address(0x5e57ac722311d9B8CC8920075Adcbb925f8d7300)//ReceiveAddress
    ){
    }
}