...
contract EvoNFTsSmall is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) public walletMints;

    address reserveWallet = payable(0xdddD90AAb8C2792807fd2a4D9F1F33bF4F19203E);

    string public uriPrefix = "";
    string public uriSuffix = "";

    uint256 public constant maxWalletMint = 222;
