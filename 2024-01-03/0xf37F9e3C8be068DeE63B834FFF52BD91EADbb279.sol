...
contract GROKPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "GROKPEPE";
    string private _symbol = "GROKPEPE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD06d153a74c7598EAaeBe3e29b01ac20D3996cd9); // Marketing Address
    address payable public teamWalletAddress = payable(0xD06d153a74c7598EAaeBe3e29b01ac20D3996cd9); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xD06d153a74c7598EAaeBe3e29b01ac20D3996cd9),
            block.timestamp
        );
    }
