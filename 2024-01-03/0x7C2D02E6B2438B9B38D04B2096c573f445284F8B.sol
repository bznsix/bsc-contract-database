...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfacB72dee092465a01827C6f3D34dc50EAbd88D4; // owner address
...
contract DRAGONCAT is Context, IERC20, Ownable {
    ...
    string private _name = "DRAGON CAT";
    string private _symbol = "$DC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfacB72dee092465a01827C6f3D34dc50EAbd88D4); // Marketing Address
    address payable private teamWalletAddress = payable(0xfacB72dee092465a01827C6f3D34dc50EAbd88D4); // Team Address
