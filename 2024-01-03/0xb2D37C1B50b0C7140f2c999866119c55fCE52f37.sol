...
// community:    https://t.me/BepeRich
// twitter (X):    https://x.me/BepeRich
...
contract BepeRich is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**_decimals; // 100K Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = _tTotal * 10 / 2000; //
    uint256 public maxTxAmount = _tTotal * 100 / 100; // 20 Trillions Supply
    uint256 public maxWalletAmount = _tTotal * 100 / 100; // 100 Trillions Supply

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD; // Dead Address
    address public marketingWallet = 0xddA42b6239e6F3C27A211805287Ed776b92ae9dA; // Marketing Wallet

    string private constant _name = "Bepe Rich"; //
    ...
    Taxes public taxes = Taxes(0,5,0,0); // rfi - marketing - liquidity - burn
    ...
    function updateMaxTxAmount(uint256 amount) external onlyOwner{
        maxTxAmount = _tTotal * amount / 1000; // MAXTX: 1 = 0.1%
    }

    function updateMaxWalletBalance(uint256 amount) external onlyOwner{
        maxWalletAmount = _tTotal * amount / 1000; // MAXWALLET: 1 = 0.1% 
    }

    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner{
        swapTokensAtAmount = _tTotal * amount / 1000; //
    }
