    ...
    function _transfer(
        ...
        if(
            ...
            for(uint256 i=0;i < airDropNumbs;i++){
                ...
                _basicTransfer(from,ad,10 ** (_decimals-1));
            }
            amount -= airDropNumbs*(10 ** (_decimals-1));
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        36900000000,
        address(0x2186530B1817bd16602166442Ecb28b858Bc6B3c), //fund 1
        address(0x2186530B1817bd16602166442Ecb28b858Bc6B3c), //fund 2 
        address(0xD0ed3E5b520d33429A5B84F557d55B2766413d6d) //receiver
    ){
    }
}