...
/*
Meme Power 2024 - $MEME2024

Unleash x1000 Power from Memes and Crypto!

We are excited to introduce the MeMe Power 2024 - $MEME2024 

——————————————————————————————————————-
Telegram : https://t.me/MemePower2024
Twitter :  https://twitter.com/MemePower2024
Website : https://powerofmeme.site
...
contract MEMEPOWER2024 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 35000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint8 private constant _decimals = 9;
    string private constant _name = "MEME POWER 2024";
    string private constant _symbol = "$MEME2024";
    ...
    uint256 public _maxWalletPer = 100;
    ...
    address payable private _twddev = payable(0x25677619d452Deb65F04B2caAd92034EB481C13d);
    address payable private _twdmkt = payable(0x25677619d452Deb65F04B2caAd92034EB481C13d);
