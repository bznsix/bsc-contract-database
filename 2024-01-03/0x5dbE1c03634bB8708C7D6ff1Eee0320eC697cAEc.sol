...
//--- Contract v3 ---//
contract Possessions is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 10_000_000_000 * 10**18;//10 000 000 000
    ...
    address payable private marketingAddress = payable(0x306852c0512808923effdFEFE9dC6B9Cd0e05acF); // build: 0x58d73e0A09594b32BCc851c722c97D9fdEF652Ea
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Possessions";
    string constant private _symbol = "POS";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0x854d5b6B8fC1F8786ebC21d8d4CDC5882D2622Fa;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 77) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 77) / 100);
        balance[0xdAeD995aa1B6B0C1Ee802bc5D4CcF6B86B035E1B] = (_totalSupply * 23) / 100;
        emit Transfer(address(0), 0xdAeD995aa1B6B0C1Ee802bc5D4CcF6B86B035E1B, (_totalSupply * 23) / 100);
