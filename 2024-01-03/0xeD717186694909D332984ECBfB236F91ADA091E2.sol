/**
The tg discussion group is open now! 

Join Here
https://t.me/calicoportal

Follow X
https://twitter.com/CalicTokenBsc
**/
...
contract CALICO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CALICO";
    string private constant _symbol = unicode"$CALIC";
    ...
    address payable public DevWallet = payable(0xf3149f9AF8db4e2eEF7a1419308eD63D490044ff);
    address payable public MarketingWallet = payable(0x2ec389B1b97aA9c0e40Ff01c410570D7E0E1Ec32);
    ...
    function newMaxWalletAmount(uint256 newmaxWallet) external onlyAddress {
