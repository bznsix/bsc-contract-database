...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46a97f7ea501948861A9890E7e1Df43566946cD4; // owner address
...
contract NEZHA is Context, IERC20, Ownable {
    ...
    string private _name = "Ne Zha Dragon Gods";
    string private _symbol = "NEZHA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x46a97f7ea501948861A9890E7e1Df43566946cD4); // Marketing Address
    address payable private teamWalletAddress = payable(0x46a97f7ea501948861A9890E7e1Df43566946cD4); // Team Address
