...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96942F038F951372dBb026660D398c6B6A71313F; // owner address
...
contract BSCCITY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC CITY 2024";
    string private _symbol = "BC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x96942F038F951372dBb026660D398c6B6A71313F); // Marketing Address
    address payable private teamWalletAddress = payable(0x96942F038F951372dBb026660D398c6B6A71313F); // Team Address
