...
contract GROKDOGE is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "GROK DOGE";
        _decimals = 18;
        address ReceiveAddress = 0xa87848ad2c44B413FC2Aa9b60d21c1A3f93d4A32;
        address FundAddress = 0xa87848ad2c44B413FC2Aa9b60d21c1A3f93d4A32;
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                if (blockNum - goMoonBlock <= highTax) {
                    swapFeeAmount = (tAmount * 2000) / 10000;
                } else {
                    swapFeeAmount =
                        (tAmount *
                            (_sellFundFee +
