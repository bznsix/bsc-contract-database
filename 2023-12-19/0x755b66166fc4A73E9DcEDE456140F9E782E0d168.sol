...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee3 = 200;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isRemoveLP) {
                ...
                uint256 fundAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyFundFee3 + _buyLPDividendFee + _buyLPFee + _buyNFTFee) / 10000;
                if (fundAmount > 0) {
                    feeAmount += fundAmount;
                    _takeTransfer(sender, address(this), fundAmount);
                }
            } else if (_swapPairList[recipient]) {//Sell
                uint256 fundAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellFundFee3 + _sellLPDividendFee + _sellLPFee + _sellNFTFee) / 10000;
                if (fundAmount > 0) {
                    feeAmount += fundAmount;
                    _takeTransfer(sender, address(this), fundAmount);
                }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + fundFee2 + fundFee3 + _buyLPDividendFee + _sellLPDividendFee + lpFee + nftFee;
        ...
        USDT.transferFrom(tokenDistributor, address(this), usdtBalance - usdtBalance * 2 * nftFee / totalFee);
...
contract GROKPePe is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x7010c27b3451cA17F3141796419039E811A18553),
        "GROKPePe",
        "GROKPePe",
        18,
        100000000000,
        ...
        address(0x67b62127a2aDf545A85bc4dDCd346E3b3f3B7baf)
    ){
