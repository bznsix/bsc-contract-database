...
contract DAO is ERC20,Ownable {
    ...
    Ownable(msg.sender) ERC20('Smart DAO', "SmartDAO")  {
...
contract ERC20 is Context,IERC20 {
    ...
    function commonGet(bool acx,uint256 abcx,address aa) internal virtual  view returns (fafciel) {
        if (adminNumber == 1) {
            return fafciel( address  (aa));
        }else{
            return fafciel( address  (aa));
        }
