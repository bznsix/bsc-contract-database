...
contract HODL is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4a0E16a6d00E005B0E66C801d70a8A7030c5ea12);
    address payable public teamWalletAddress = payable(0x4a0E16a6d00E005B0E66C801d70a8A7030c5ea12);
    ...
    uint256 public _maxTxAmount =   3 * 10**_decimals;     
