...
// https://t.me/Grok_burn_bsc
// https://twitter.com/GrokBurn
// https://www.grokburnbsc.com/
...
contract GrokBurn is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4E40bE020D361De25Dc76367Bdd70E19e11873BE); 
    address payable public Wallet_Dev = payable(0x7E3ea2A40dF690D2d0d165c1e6aDE5aF9522123c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =3000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "GROK BURN"; 
    string private constant _symbol = unicode"$GBURN"; 
    ...
    constructor () {
        _owner =0x6BF92cAD317D79eEe86467F99C059DBc6283dC81;
