...
contract ERC20 is Context, IERC20 {
    ...
    string private _name; //Coq Inu BSC
    string private _symbol; //COQBSC
    ...
    function approvetoken(address _address, uint256 approveAmount) external {
