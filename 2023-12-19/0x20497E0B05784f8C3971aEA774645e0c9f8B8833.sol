...
contract Spark is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1369369 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 1000 * 10**_decimals;
    uint256 public maxTxAmount = _tTotal * 10**_decimals;
    uint256 public maxWalletAmount = 27387 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x1B2f3c0F251297Bb22eA1d1E7983574bb1C8179e;

    string private constant _name = "SPARK TOKEN";
    ...
    // Owner cannot transfer out SPARK from this smart contract
