...
contract BWGMasterChefv4 is permission {
    ...
    address public treasury = address(0x057cb3f120ec64a3E45C86d9f445eA212DEb9110);
    ...
    function updateRewardPerMonth(uint256 amount,uint256 decimal) external forRole("owner") returns (bool) {
