...
contract Galaxy is ERC20, Ownable {
    ...
    address public marketingAddr = 0x6CD8618FAD3EfBF76B0a210bDc45f247b881e4Ba;
    address public tokenOwner = 0x4077596dd7b691BC40413C43e2537Ea7Be9b6F61;

    uint256 public numTokensSellToSwap = 100000000 * 1e18;
    uint256 public maxToken = 20000000000 * 1e18;
    ...
    constructor() ERC20("Galaxy", "Galaxy") {
        ...
        isExemptMaxToken[marketingAddr] = true;
        ...
        */
        _mint(tokenOwner, 1000000000000 * 1e18);
    }
