...
contract PandaToken is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "BTB";
        _decimals = 18;
        _tTotal = 99900000000000000000000;

        fundAddress = 0xf76dd3435Ba911D8bdd2d9F19637d3e3DEA988aE;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!(isAdd || isRemove)){
                require(swapEnable,'can not swap');
            }
    ...
    function setSwapEnable(bool enable) external onlyOwner {
        swapEnable = enable;
    } 
