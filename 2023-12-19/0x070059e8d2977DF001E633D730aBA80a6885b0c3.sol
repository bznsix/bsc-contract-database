...
contract OrbitalProtocol is ERC20, Ownable {
    ...
    constructor () ERC20("Orbital Protocol", "ORB") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xBB48224aBB75cB2B8ec79C58feb8a07a1Df0816A;
        DevelopmentWallet = 0xe2A84A985fC5817870F287F06700298f0FA304eB;
