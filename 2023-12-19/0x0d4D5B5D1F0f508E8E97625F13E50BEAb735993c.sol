...
contract CATS is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "CATS";
        _decimals = 18;
        _owner = 0xE7e5a19842EB2b503DE74EfaA42f10a634661106;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 210000 * 10**_decimals;
        marketingWalletAddress = payable(0x927E0DE058f57D45ab7b4984b0C96d3405cC5504);
        teamWalletAddress = payable(0x6239502142E9b738C9C510d61C33b2B6775B82cC);
