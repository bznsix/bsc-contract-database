...
contract SANTACHRISTMASINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE95b54E65365214FD272ba6697f6a1E02cD7bA32); 
    address payable public Wallet_Dev = payable(0xA1Dd68C353941071fF4fC840CD68b6b13DEffd90);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "SANTA CHRISTMAS INU"; 
    ...
    constructor () {
        _owner = 0xA1Dd68C353941071fF4fC840CD68b6b13DEffd90;
