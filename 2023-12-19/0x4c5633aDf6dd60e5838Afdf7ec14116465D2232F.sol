/**
* Cointacted.com - #1 Real Social Blockchain
*/
...
contract Cointacted is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0x00A1D766406908af91bdDCC1576166DBb3911fA4;
    ...
    constructor() {
        ...
        _symbol = "CTED";
        _decimals = 18;
        MaxSupply = 1_000_000_000 * 10**_decimals;
    ...
    function _transfer(
        ...
        require(sender != address(0), "Cointacted: Transfer from the zero address");
        require(recipient != address(0), "Cointacted: Transfer to the zero address");
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                require(amount <= _maxTxAmount, "Cointacted: Transaction limit Exceeded!");
        ...
        require(
            ...
            "Cointacted: Transfer amount exceeds balance"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "Cointacted: You cannott set fee more than 25%"
        );
    ...
    onlyOwner
    {
        require(Account != address(0), "Cointacted: You can't exclude zero address!");
    ...
    function setMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
        require(
            maxTxPercentage >= 1,
            "Cointacted: Percentage should be greater or equal to 1!"
        );
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(
            ...
            "Cointacted: You can't mint more than MaxSupply"
        );
        require(account != address(0), "Cointacted: mint to the zero address");
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(account != address(0), "Cointacted: burn from the zero address");

        _beforeTokenTransfer(account, address(0), Amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= Amount, "Cointacted: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "Cointacted: approve from the zero address");
        require(spender != address(0), "Cointacted: approve to the zero address");
