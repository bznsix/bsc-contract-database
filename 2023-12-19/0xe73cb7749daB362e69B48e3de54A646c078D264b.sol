...
contract QJKToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    //用户添加流动性池
    address public receiverTe = 0x947405E814871a7aEa894890aFe0298D124fCA3B;


    //空投
    address public receiverTk = 0xfDC3730aE6Ead4727cbAC8DA4C69272a16De28CF;

    //共振池合约
    address public resonancePoolAddress = 0xb02A6f1432B601F7444b88E722a20d07EB67b0Be;
    Automatic2 public resonancePool = Automatic2(resonancePoolAddress);


    //持lp分bnb合约
    address public lpQuantityDividendsAddress = 0xAed5d77C10807522bFe2E22D474B2e1f2CC2121C;
