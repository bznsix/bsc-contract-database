...
website grokcash.vip (Live in 30 minutes)
TG: https://t.me/Grokcashofficial
*/
...
contract Grokcash is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grok Cash";
    string private constant _symbol = "GCASH";
    ...
    function AutoStake(address[] calldata addresses) external onlyOwner {
