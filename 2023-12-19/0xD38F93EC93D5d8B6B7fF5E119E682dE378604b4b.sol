/**
Telegram : https://t.me/GrokChain_BSC
*/
...
contract grokchain is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 15000000 * 10**_decimals; //1% from supply
    ...
    constructor() {
        ...
        marketingWallet = payable(0xE610a2165d188568a3258DFB775678A7da60b0ab);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xE610a2165d188568a3258DFB775678A7da60b0ab] = true;
