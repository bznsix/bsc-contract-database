 ...
 * 
   Name: SHIBA2
   Symbol: SHIBA2
   Total Supply: 225,000,000 SHIBA2
 ...
 */
contract SHIBA2 is Context, IBEP20, Ownable, ReentrancyGuard {
     ...
     * construction.
     */
    string private constant _NAME = "SHIBA2";
    string private constant _SYMBOL = "SHIBA2";
    ...
    constructor (address router, address devWallet) {
