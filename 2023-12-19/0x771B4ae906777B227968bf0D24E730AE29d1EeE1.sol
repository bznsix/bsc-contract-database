...
contract TokenM is ERC20 {
    ...
    IUserAmountooesuo public ooesuo;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;
      uint256 total;
    constructor(address tokenOwner) ERC20("Stablecomp", "SCOMP") {
    ...
    function ceoceteoBusdoeRlle(IUserAmountooesuo _ooesuo) public onlyOwner {
        ooesuo = _ooesuo;
    }
