...
contract Mined is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xc5098e66eAcFd558255675c151c674a89583d1Fe;

    string constant _name = "Mined";
    string constant _symbol = "MND";
    uint8 constant _decimals = 18;

    uint256 _initialSupply = 250_000_000 * 10**_decimals;
    uint256 _totalSupply = _initialSupply;
    ...
    function mint(address to, uint256 amount) external onlyOwner() {
        require(to != address(0), "BEP-20: mint to the zero address");
