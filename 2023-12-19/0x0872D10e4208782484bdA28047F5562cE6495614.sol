...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f6cC0f235563Cea53396ddCE2f751De39467EDB; // owner address
...
contract SHEIKHGROK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHEIKH GROK";
    string private _symbol = "$SG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8f6cC0f235563Cea53396ddCE2f751De39467EDB); // Marketing Address
    address payable private teamWalletAddress = payable(0x8f6cC0f235563Cea53396ddCE2f751De39467EDB); // Team Address
