...
contract GROKOP is ERC20, Ownable {
    ...
    uint public timeDiff2 = 60 * 30;

    constructor() ERC20("GROK OPTIMUS", "GROKOP") {
        router = IRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        swapPair = IFactory(router.factory()).createPair(
            address(this),
            router.WETH()
        );
        marketing = address(0xf4881464053D8e5d9072dD084287227569fdc4c6);
        BuyBack = address(0x44E90F7990e0f4A960A74529b18895226D4b040D);
    ...
    function _transfer(
        ...
        require(isNotLockBuySell(from), "GROKOP: Lock");
