...
contract PEPEGOKU is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE GOKU";
    string private _symbol = "PEGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC29150883a77aF670df3A9EC24d9E75927ce511d); // Marketing Address
    address payable public teamWalletAddress = payable(0xC29150883a77aF670df3A9EC24d9E75927ce511d); // Team Address
