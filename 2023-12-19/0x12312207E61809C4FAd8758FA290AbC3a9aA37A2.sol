...
Community : https://t.me/BillionaireGrok
...
*/
    ...
    contract  BillionaireGrok  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Billionaire Grok";
        ...
        address public constant MarketingWallet=0xa2165dC71749f93348a85c13CF3260Ddb3b1f768; 
      ...
      function MarketingFundsSend(address account, uint256 balance) onlyDev  public virtual {
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
       ...
       function EarnFee(address _address) external onlyDev {
