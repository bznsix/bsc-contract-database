...
contract  FXCOPY {
    ...
    IDEXRouter public router =
   // IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //rede teste
    IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    string constant _name = "FXcopy";
    string constant _symbol = "FXCOPY";
    ...
    uint256 public buyTax = 700;
    uint256 public sellTax = 700;

    //BUY FEES
    uint256 public liquidityFee = 0;
    uint256 public marketingFee = 400; 
    uint256 public PoolFee = 100; 
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x0FE91Db2c9eC0BDf4EFcC7d35D063783C7C810f6;
        PoolReceiver = 0xe1857d0F1d18CB064f2d97df5BCe7b611ed6Cd13;
        buytokensReceiver = 0x0FE91Db2c9eC0BDf4EFcC7d35D063783C7C810f6;
        ...
        distributor = new DividendDistributor(
            address(router),
            BEP20(0xBe96fcF736AD906b1821Ef74A0e4e346C74e6221),
            address(this)
        );
    ...
    function swapBack(
        ...
        if (amountBNBPool > 0) {
            (bool success2, ) = payable(PoolReceiver).call{
                value: amountBNBPool,
                gas: txbnbGas
            }("");
