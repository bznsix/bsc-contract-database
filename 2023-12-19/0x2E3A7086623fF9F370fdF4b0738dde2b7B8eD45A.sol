...
contract QJLegion is IERC20, Ownable {
    ...
    string Name = "QJ-Legion";
    string Symbol = "QJ-Legion";
    uint8 Decimals = 9;
    uint256 Supply = 3943;
    address ReceiveAddress = address(0xC9De22B7269cEe0A7D7E3fa607deB71b2d34e1e6);
    ...
    function processLPReward(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (!excludeLpProvider[shareHolder] && balanceOf(shareHolder) >= 2 * 10 ** 8) {
                ...
                if (balanceOf(_mainPair) * tokenBalance / holdTokenTotal >= 1 * 10 ** 8) {
