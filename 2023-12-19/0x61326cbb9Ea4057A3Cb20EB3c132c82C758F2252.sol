/**
Telegram: https://t.me/jinglegemportal
*/
...
contract JINGLEGEM is Context, IERC20, Ownable {
    ...
    string private constant _name = "JINGLE GEM";
    string private constant _symbol = "$JINGLE";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x64F51Fe5569859B2573F95Cb21Db5C38F5974a34);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x64F51Fe5569859B2573F95Cb21Db5C38F5974a34] = true;
