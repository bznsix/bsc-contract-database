...
contract AilpToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private _name = "AilpToken";
    string private _symbol = "AILP";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 20240000 * 10 ** uint256(_decimals);
    uint256 public _burnSupply  = 10240000 * 10**uint256(_decimals);
    ...
    constructor ()  {
        ...
        isExcludedFee[address(0x48E58aa61EDA3B778B1223706F1229e97F286998)] = true;
        isExcludedFee[address(0x2586906423a251D2Ee1004650D738362f878b3cB)] = true;
    ...
    function setFee(uint256 _bfee,uint256 _sFee)external onlyOwner{
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
       ...
       feeAmount = _calculateBurn(feeAmount);
        if(feeAmount>0){
