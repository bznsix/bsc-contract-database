...
contract FLAFI is Context, IERC20, Ownable {
    ...
    string private _name = "FLAFI INU";
    string private _symbol = "FLAFI";
    ...
    address payable public marketingWallet = payable(0x277dBb7C127711296D21732B2e8d3Dbfc8687657);
