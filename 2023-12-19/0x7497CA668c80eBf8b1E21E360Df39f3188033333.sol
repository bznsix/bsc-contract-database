...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    constructor(){
        ...
        _symbol = "GrokDragon";
        _decimals= uint8(18);
        address admin = 0x85165281fF434E7971fA6e41d3EE03353AD2Cf0F;
        _tTotal = 33300000000e18;
        ...
        _buyMarketingFee = 400;
        _buyLiquidityFee = 100;
        _buyLpFee = 100;
        _sellMarketingFee = 400;
        _sellLiquidityFee = 100;
        _sellLpFee = 100;
        addLiquidityFee = _sellMarketingFee.add(_sellBurnFee).add(_sellLiquidityFee).add(_sellLpFee);
        _marketAddr =  0xDC1B2cFB6A59dB7c8e4ab70FACf2D64522f4535d;
        ...
        _isExcludedFromFee[0x1d0073F21879Ce8Fd5cf5CF83905ce4962Bf9B13] = true;
        ...
        _rewardToken = 0x88DA9901B3A02fE24E498e1eD683D2310383E295;
   ...
   function getExcludedFromFee(address account) public view returns (bool) {
    ...
    uint256 public removeLiquidityFee = 2000;
