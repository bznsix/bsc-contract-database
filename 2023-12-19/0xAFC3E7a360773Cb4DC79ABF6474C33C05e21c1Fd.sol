...
contract QuantumX is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    mapping(address => bool) public blacklisted;
    mapping(address => uint256) public lastTransferTimestamp; // Add this line
    uint256 public cooldownTime = 10; // 10 seconds cooldown period

    constructor() ERC20("QuantumX", "QTX") ERC20Permit("QuantumX") {
    ...
    {
        require(block.timestamp >= lastTransferTimestamp[from] + cooldownTime, "Cooldown period not met"); // Add this line
        super._beforeTokenTransfer(from, to, amount);
        lastTransferTimestamp[from] = block.timestamp; // Update the last transfer timestamp
    }
