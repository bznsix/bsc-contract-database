...
contract PPBOSS is IERC20, Ownable {
    ...
    constructor() {
        ...
        fundAddress = address(0xDFaFC5D6ef1708129dB425Af278d7A83726B5b4a);
        fundAddress2 = address(0x90f718Ab569b94FD38a9E2e707F3BDd91d92C678);
        _swapRouter = ISwapRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        address ReceiveAddress = address(0x203786e9d3E8c4a6A8ed83875d10eAd80B7EC697);
                ...
                if (_swapPairList[to]) {
                    if (!inSwap && !isAdd) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyRewardFee + _buyFundFee +_sellFundFee;
    ...
    function swapTokenForFund(
        ...
        uint256 buyFundAmount = (tokenAmount *_buyFundFee)  / swapFee;
        ...
        uint256 sellFundAmount = tokenAmount - rewardAmount - buyFundAmount;
        try
                _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                    sellFundAmount,
                    0,
