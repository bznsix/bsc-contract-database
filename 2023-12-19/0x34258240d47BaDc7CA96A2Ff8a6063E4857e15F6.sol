...
contract UwU is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xB1d062c03526229Fa5a55170756Ad316c03F28Dd); // build: 0xB1d062c03526229Fa5a55170756Ad316c03F28Dd
    AntiBot private AX;
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0xdCd940E8B5bfAB3DD5137d0E3194F84D7a65f272);
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        event editTaxes(uint256 newBuy, uint256 newSell);
        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            require(buy <= 10,"Freddy: SAFU Rules");
            require(sell <= 10,"Freddy: SAFU Rules");

            buyfee = buy * 10;
            sellfee = sell * 10;
            emit editTaxes(buyfee, sellfee);
        }
}