...
contract DividendDistributor is IDividendDistributor {
        ...
        returns (bool)
    {
        return
            ...
            getEarnings(shareholder) > minDistribution;
    }
    ...
    function distributeDividend(address shareholder) internal {
        ...
        uint256 amount = getEarnings(shareholder);
        if (amount > 0) {
    ...
    function getEarnings(address shareholder) public view returns (uint256) {
        if (shares[shareholder].amount == 0) {
            return 0;
        }
...
contract VIPERKING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "VIPER KING";
    string constant _symbol = "Viper King";
    ...
    uint256 marketingBuyFee = 600;
    uint256 projectBuyFee = 300;
    uint256 totalBuyFee = 1000;
    uint256 buyFeeDenominator = 10000;
    uint256 buyfeeburn = 0;
    uint256 reflectionBuyFee = 100;
    ...
    address public pair;
    address ownerRSupply = 0x5Cb16aF65F493c00f4d29d1863580d49c98aB1A9;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0x5Cb16aF65F493c00f4d29d1863580d49c98aB1A9;
        ...
        _balances[ownerRSupply] = ((_totalSupply * 100) / 100);
        emit Transfer(address(0), ownerRSupply, ((_totalSupply * 100) / 100));
    }
    ...
    function getEarnings(address shareholder) public view returns (uint256) {
        return distributor.getEarnings(shareholder);
    }
