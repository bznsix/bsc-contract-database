...
contract BabyAce is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xD78378B13D837bea4f5f64E15b084Cd7c6B0975a;

    string private constant _name = "Baby Ace";
    string private constant _symbol = "$BabyAce";
    ...
    Taxes public taxes = Taxes(100, 400);
