...
contract StandardTokenMT is ERC20, WhiteList {
    mapping(address => bool) private _isExcludedFromTrans;
    bool public IS_OPEN_TRANS = false;

    constructor() ERC20("MT", "MT", 18) {
        address _owners = 0xB6B343C71813C3A475f7095a3D55b293D7b6E19B;
        uint256 _amount = 21000000;
    ...
    function leftSupply() external pure override returns (uint256) {
        return 0;
    }
