...
contract RATS is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "RATS";
        _decimals = 18;
        _owner = 0x2024E510d07C58f52fF14FC540E4c00659f57614;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 72000 * 10**_decimals;
        marketingWalletAddress = payable(0xe549b5662b64fB67EB7F7FCe17cE5B6FDBbcA8D1);
        teamWalletAddress = payable(0x83BB490c4A4Ea6658cDF3E01B90A5ad9c984006b);
