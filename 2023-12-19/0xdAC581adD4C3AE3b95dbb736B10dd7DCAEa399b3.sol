...
contract DOGECOINX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa32eD11D7d1d30735503382F497C86eaCc0A9FBB); 
    address payable public Wallet_Dev = payable(0x776744920706b5Bec5DcceABCA189D0609526B80);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "DOGECOIN X"; 
    ...
    constructor () {
        _owner =0x776744920706b5Bec5DcceABCA189D0609526B80;
