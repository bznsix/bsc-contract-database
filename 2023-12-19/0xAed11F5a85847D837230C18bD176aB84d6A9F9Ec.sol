...
contract GGGTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(){
        ...
        uint256 _tTotal = 1000 * (10**uint256(18));
        ...
        address admin = 0xa5859844a6EF727D5C7F31c00fa8843FcAD21285;
        _rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        _token = 0x55d398326f99059fF775485246999027B3197955;
        _marketAddr= 0x6294A63c4859Df6D0F8E4d3351369385bB6A8f66;
        address divToken = 0x8e268141DaF54aA1fcdB5574A72feB0eC2fC3970;
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        _nft = 0x3f01547B8809af46B0870aEc5167985B41256C6e;
    ...
    function _transfer(
        ...
        if (
            ...
            if (_buyNftFee > 0 || _sellNftFee > 0) {
                uint256 nftAmount = contractTokenBalance
                    .mul((_buyNftFee.add(_sellNftFee)))
                    .div(getFeeDeno());
               swapTokenToNft(nftAmount);
                takeNFTDivi();
            }
    ...
    function takeNFTDivi() public {
        ...
        for (uint256 i; i < everyD; i++) {
            ...
            if (tokenIdDivi == 0 || tokenIdDivi<1e18 ) {
                continue;
            }
            uint256 balance = super.balanceOf(NFT(_nft).ownerOf(_nftIndex));
            if(balance < _nftDivAmount) {
                continue;
            }

            IERC20(_token).transferFrom(_nftRouter, NFT(_nft).ownerOf(_nftIndex),tokenIdDivi);
    ...
    function swapTokenToNft(uint256 tokens) private {
        _nftAllDivi += tokens;
    ...
    function getFeeDeno() public view returns (uint deno) {
        ...
        .add(_buyNftFee).add(_sellNftFee);
    }
