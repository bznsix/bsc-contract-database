...
contract XYL is Token {
    constructor() ERC20(
        "XYL",   // 名字
        "XYL"   // 符号
    ) {
        uint256 _totalSupply = 30000     ether; 
        address _marketing = address(0x6bd7c2C8147deEe3d3c23512BdC27068d3f3262b); // 
        address _receive = address(0x3dA47f644deABB618CcBFb252d12947a2C506E15);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x6bd7c2C8147deEe3d3c23512BdC27068d3f3262b)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x270af23F7F282E5398203FA23B95442D84538688);   
        feeEarn = 500; 
    }
}