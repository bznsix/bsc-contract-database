// https://t.me/bnbMonopoly
// https://twitter.com/MonopolyBSC
// https://monopolytoken.vip/
...
contract Monopoly is ERC20, Ownable {
    ...
    constructor () ERC20("Monopoly", "$MONOPOLY")
    {  
        address router;
        if (block.chainid == 56) {
