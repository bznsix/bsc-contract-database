...
contract Token is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("BITT", "BITT") {
        _mint(0x21Cb84De43e41655394402f825BC179fB6D15608, 50000000 * 10 ** decimals());
    }
    ...
    function withdraw(address receiver, uint256 amount) public payable onlyOwner {
