...
// OPTIDRACO (OPTIDRACO), this is the same code as the official baby grok code

// Telegram https://t.me/+eur4SsFuxpI5ZTIx
...
//--- Contract v3 ---//
contract OPTIDRACO is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xc8f8363f57826780C1CF54105a93CB64805d3A7B); // build: 0xc8f8363f57826780C1CF54105a93CB64805d3A7B
    address payable private devWallet = payable(0xc8f8363f57826780C1CF54105a93CB64805d3A7B); // build: 0xc8f8363f57826780C1CF54105a93CB64805d3A7B
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "OPTIDRACO";
    string constant private _symbol = "OPTIDRACO";
