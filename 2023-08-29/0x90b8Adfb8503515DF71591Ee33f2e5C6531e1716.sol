...
//赠送积分
        if(zengsong[msg.sender]==0){
            ...
            if (tj_amount < pool1_balance){
                ...
                _balances[msg.sender] = _balances[msg.sender] +  tj_amount;
                emit Transfer(first_reward_address, msg.sender, tj_amount);
            }else if(tj_amount < pool2_balance){
                _balances[second_reward_address] = _balances[second_reward_address] -  tj_amount / 2;
                _balances[msg.sender] =  _balances[msg.sender] + tj_amount / 2;
                emit Transfer(second_reward_address, msg.sender, tj_amount / 2); 
            }
            ...
            if (tj_amount2 < pool1_balance){
                ...
                _balances[msg.sender] = _balances[msg.sender] +  tj_amount2;
                ...
                _balances[msg.sender] =  _balances[msg.sender] + tj_amount2 / 2;
                emit Transfer(second_reward_address, msg.sender, tj_amount2 / 2); 
            }
