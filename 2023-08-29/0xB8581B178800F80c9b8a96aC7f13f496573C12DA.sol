...
// Telegram     : https://t.me/pepegrayscalebsc
...
contract PEPEGrayscale is Context, IERC20, Ownable {
    ...
    uint256 private _redisFeeOnBuy = 29;
    uint256 private _taxFeeOnBuy = 1;
    
    uint256 private _redisFeeOnSell = 29;
    uint256 private _taxFeeOnSell = 1;

    uint256 private _devPer = 5;
    ...
    address payable private _twddev = payable(0x3406601627b081777c4B76056284e2D7aD6bC7Cb);
    address payable private _twdmkt = payable(0x3406601627b081777c4B76056284e2D7aD6bC7Cb);
    
    string private constant _name = "Pepe Grayscale";
    string private constant _symbol = "$pepeScale";
