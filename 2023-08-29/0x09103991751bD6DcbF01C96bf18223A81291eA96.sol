...
/**
   Daddy Pig (DADDYPIG) Tokenomics
   3% fee auto add to the liquidity pool 
   3% distribute to the Marketing Wallet 
   3% of transaction fee will go to Holders
   ttl supply = 100000000000
   decimals 9
*/
...
contract DADDYPIG is Context, IERC20, Ownable {
    ...
    string private _name = "Daddy Pig";
    string private _symbol = "DADDYPIG";
    ...
    function setCharityWalletAddress(address team) public onlyOwner {
        _charityWalletAddress = team;
    }
