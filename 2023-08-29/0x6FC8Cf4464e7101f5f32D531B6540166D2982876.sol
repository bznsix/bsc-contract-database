...
contract TESTRUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESTRUN TOKEN";
    string private _symbol = "$TEST";
    uint8 private _decimals = 18;

    address payable private marketingWalletAddress = payable(0xfCD3a31942944A6bb3906268cd2Ce1cF3DB2F755);
    address payable private teamWalletAddress = payable(0xfCD3a31942944A6bb3906268cd2Ce1cF3DB2F755);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        //Trade start check
        if (!tradingOpen) {
            require(recipient == owner(), "TOKEN: This account cannot send tokens until trading is enabled");
        }
