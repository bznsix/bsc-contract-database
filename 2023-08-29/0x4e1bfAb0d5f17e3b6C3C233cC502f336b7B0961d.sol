...
contract Product is ERC721Tradable,ERC721Votes {
    ...
    function baseTokenURI() override public pure returns (string memory){
        return "ipfs://bafybeig5j75oukm7c32isma3bzakeqqgee6rq4mphztpjvaq56ibtuibom/";
    }
 ...
 * account.
 */
abstract contract ERC721Data is ERC721{
    ...
    function tokenByIndex(uint256 index) public view virtual  returns (uint256) {
        require(index < ERC721Data.totalSupply(), "ERC721Enumerable: global index out of bounds");
...
contract EIP712Base is Initializable {
        ...
        initializer
    {
        ...
        bytes32 hashedVersion = keccak256(bytes(ERC712_VERSION));
 ...
 */
abstract contract ERC721Votes is IVotes {
    /**
