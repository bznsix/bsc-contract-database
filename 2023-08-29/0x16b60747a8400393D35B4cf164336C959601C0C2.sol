...
interface IERC20 {
    ...
    /**
     * @dev Moves `amount` tokens from the caller's account to `recip ient`.
     *
...
contract Dogo_Inu is IERC20, Ownable {
    ...
    constructor () {
        ...
        devFeeReceiver = 0xf3dd736ac85C73d24597DecE329CB90869A951c1;
        marketingFeeReceiver = 0xf3dd736ac85C73d24597DecE329CB90869A951c1;
