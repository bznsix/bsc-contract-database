...
contract LotteryContract is VRFV2WrapperConsumerBase {
    ...
    address LinkToken = 0x404460C6A5EdE2D891e8297795264fDe62ADBB75;
    address VRFV2Wrapper = 0x721DFbc5Cfe53d32ab00A9bdFa605d3b8E1f3f42;
    ...
    uint256 public endTime; // Added state variable for end time
    ...
    /*
        Chain link VRF related functions
    */
    ...
    function fulfillRandomWords(
        ...
        //This is the callback function used by the chainlink VRF
        require(s_requests[_requestId].paid > 0, "request not found");
        s_requests[_requestId].fulfilled = true;
        s_requests[_requestId].randomWords = _randomWords;

        //Winner selection logic below 
        uint256 randomNumber = _randomWords[0];
        uint256 index = randomNumber % playerSelector.length; //Get a random index
    ...
    /*
        Chain link VRF related functions end here
    */
    function setEndTime(uint256 duration) public onlyAdmin {
        endTime = block.timestamp + duration;
    }

    // Get the time remaining for the countdown
    ...
    function startLottery(address _nftContract, uint256 _tokenId)
        public
        onlyAdmin
    {
    ...
    function pickWinner() public onlyAdmin {
        ...
        /* **request for random numbers from the chainlink**
           The winner selection logic will be automaticall called
           Using the callback fulfillrandomWords() function
           This function will be called by the chainlink automatically
