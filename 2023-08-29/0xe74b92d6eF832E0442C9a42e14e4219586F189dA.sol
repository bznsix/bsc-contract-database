...
contract NoMoreSEC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0313F2D330c67d20f5682cd2Bec5c8F36C274ED4;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "No More SEC";
    string constant _symbol = "NOSEC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * 10**0 * (10 ** _decimals);
    ...
    uint256 public liquidityFeeSell = 6;
    uint256 public buybackFeeSell = 0;
    uint256 public reflectionFeeSell = 0;
    uint256 public marketingFeeSell = 18;
    uint256 public devFeeSell = 6;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x0313F2D330c67d20f5682cd2Bec5c8F36C274ED4;
