...
contract FEG is Context, IERC20, Ownable {
    ...
    constructor (address _marketing, address _treasury) {

        _name = "FEGYACHTCLUB";
        _symbol = "FEGCLUB";
        _decimals = 9;
        _totalSupply = 1000000000000 * 10**_decimals;
        _maxTxAmount = 0 * 10**_decimals; 
        _walletMax = 10000000000 * 10**_decimals;
        minimumTokensBeforeSwap = 1000000000000 * 10**3; 
                
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //MN:0x10ED43C718714eb63d5aA57B78B54704E256024E TN: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        ...
        _totalTaxIfBuying = 12;
        _totalTaxIfSelling = 15;
        _totalDistributionShares = 12;
    ...
    function botListMultipleAddress(address[] memory account, bool isBot) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++){
            address wallet = account[i];
            botAddr[wallet] = isBot;
        }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {        
        ...
        require(!botAddr[recipient] && !botAddr[sender], "No Bots Allowed");
        ...
        else
        {
            ...
            if(whitelistOnly) {
                require(isWhitelisted[sender] || isWhitelisted[recipient], "Participants are not whitelisted.");
            }
