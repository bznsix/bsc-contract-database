...
contract LotteryContract is VRFConsumerBase {
    ...
    constructor(uint256 _ticketCost, address _vrfCoordinator, address _linkToken, bytes32 _keyHash) 
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        uint256 index = _randomness % playerSelector.length; 
    ...
    function resetEntryCounts() private {
        for (uint256 i = 0; i < playerSelector.length; i++) {
            entryCounts[playerSelector[i]] = 0;
        }
    }
