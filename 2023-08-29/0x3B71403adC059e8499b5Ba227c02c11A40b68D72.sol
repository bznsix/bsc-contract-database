...
//绑定关系
        if(first_invite_address[msg.sender] == address(0)){
            first_invite_address[msg.sender] = baba;
        }
        if(first_invite_address[baba] != address(0)){
            address second_address =  first_invite_address[baba];
            if(second_invite_address[msg.sender] == address(0)){
                second_invite_address[msg.sender] = second_address;
            }
        }
//赠送积分
        if(zengsong[msg.sender]==0){
            ...
            if (tj_amount2 < pool1_balance){
                _balances[first_reward_address] =  _balances[first_reward_address] -  tj_amount2;
                _balances[second_invite_address[msg.sender]] = _balances[second_invite_address[msg.sender]] +  tj_amount2;
                ...
                _balances[second_invite_address[msg.sender]] =  _balances[second_invite_address[msg.sender]] + tj_amount2 / 2;
                emit Transfer(second_reward_address, second_invite_address[msg.sender], tj_amount2 / 2); 
            }
