...
contract Akamaru is ERC20, Ownable {
    ...
    constructor() payable ERC20("X Akamaru Inu", "AKA") {
        ...
        developmentWallet3 = 0x34b9dDd0c46988266a7EdA4C2a065A744592f66c;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            payable(marketingWallet).transfer(newBalance * 80 / 100);
