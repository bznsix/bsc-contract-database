...
contract brotherofpepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brother of Pepe";
    string private _symbol = "$BOP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8982eF4a895b167B1D6Dbd9c8B39C3Aac80d930B);
    address payable private DevelopmentWalletAddress = payable(0x8982eF4a895b167B1D6Dbd9c8B39C3Aac80d930B);
    ...
    uint256 public _walletMax = 100000000000000 * 10**9;
