 ...
 * Powered By BlazeX Contract Creator - This Contract is safe has no hidden malfunctions - Create your own Contract with blazex.org 
  ...
  *——————————————————
  *
  * Description: This Token is fully decentralized with a 5% buy/sell tax - lets burn!
  * Website: N/A
  * Twitter: N/A
  * Telegram: N/A
  *
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="FireX";
    string private _symbol="FireX";
    ...
    uint public burnFeeOnBuy=50;
    uint public burnFeeOnSell=50;
    ...
    uint256 public maxTransactionAmountBuy=40000000000000000;
    uint256 public maxTransactionAmountSell=40000000000000000;

    
    uint256 public maxWalletAmount=40000000000000000;
    ...
    uint256 public swapTokensAtAmount=10000000000000;
    ...
    require(msg.value >= 0.3 ether, "Insufficient value for fee receiver");
        ...
        referralWallet = 0x8674D6F529c703F4395765B2F53cBDC3Fa8E1369;
