...
contract PEPENFTPool is AdminRole {
    ...
    address public lpAddress = 0xBfBcc57dB1F32fBF626E830DCf86fEd367e9973d;
    ...
    function active(uint256 tokenId) public  checkStart {
        ...
        IERC20(omni).transferFrom(msg.sender,lpAddress,activeAmount[lvl]*10**18);
    ...
    function setLpAddress(address lp_) external onlyAdmin{
