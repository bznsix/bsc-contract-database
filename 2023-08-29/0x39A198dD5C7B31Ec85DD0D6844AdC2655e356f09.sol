...
contract Addlp {
    address payable public feeRecipient = 0xAC3F877DbB562d86E22e466030424c98a339ffcd;
    uint256 public feeAmount = 0.01 ether;  // 0.01 BNB fee, using the ether unit for simplicity in Solidity.
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function Addliquidity(address _tokenA, uint256 _amountTokenA) external payable {
