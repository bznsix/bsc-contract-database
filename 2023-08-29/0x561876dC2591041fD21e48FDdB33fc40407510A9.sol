...
contract PEPESONIC is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe Sonic";
    string private _symbol = "PONIC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x39236414b5bddeDebd80e2A7C484057a9e6e224C);
    address payable private DevelopmentWalletAddress = payable(0x39236414b5bddeDebd80e2A7C484057a9e6e224C);
    ...
    uint256 public _marketingShare = 67;
    uint256 public _DevelopmentShare = 23;

    uint256 public _totalTaxIfBuying = 8;
    uint256 public _totalTaxIfSelling = 30;
    uint256 public _totalDistributionShares = 100;

    uint256 private _totalSupply = 444000000000000 * 10**9;
    uint256 public _maxTxAmount = 444000000000000 * 10**9;
    uint256 public _walletMax = 444000000000000 * 10**9;
