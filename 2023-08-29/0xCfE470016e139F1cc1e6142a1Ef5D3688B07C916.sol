...
contract FixLP {
    address payable public feeRecipient = 0x1D8c326D2deC56Eb01d5bd4f21b002d15bA5929d;
    uint256 public feeAmount = 0.005 ether;  // 0.03 BNB fee, using the ether unit for simplicity in Solidity.
