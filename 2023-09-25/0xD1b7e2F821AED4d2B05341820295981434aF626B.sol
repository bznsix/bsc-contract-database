...
contract ERC721STRM is ERC721Base {
    ...
    function __ERC721STRM_init_unchained(
        string memory _name,
        string memory _symbol,
        string memory baseURI,
        string memory contractURI,
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2, IERC2981 {
    function getSTRMV2Royalties(uint256 id)
        external
        view
        override
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, IERC721EnumerableUpgradeable {
    ...
    */
    ...
    function _burned(uint256 tokenId) view internal returns (bool) {
