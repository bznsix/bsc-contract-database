...
contract FOMO is Context, IBEP20, Ownable {
    ...
    Taxes public taxes = Taxes(2000, 4000, 4000);
    ...
    function updateTaxes(
        ...
        require(
            refTax + burnTax + marketing <= 10000,
            "Can not set sum of reflection and burn taxes more than 10%"
        );
        taxes.burn = refTax;
