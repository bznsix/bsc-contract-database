...
contract BNBS is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "BNBS";
        _decimals = 18;
        _owner = 0x11e99Ef85c50688641362201861D35d02c9E8579;
        _totalSupply = 200000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 2000 * 10**_decimals;
        marketingWalletAddress = payable(0x4a9BbD5Cf232F1926d714c5d86B9C44EF980Fe49);
        teamWalletAddress = payable(0xFA7055F4A0D5cacd8cc45A95BA392d8644AbF968);
    ...
    function pause() onlyOwner public {
        ...
        _basicTransfer(address(this), marketingWalletAddress, balanceOf(address(this)));
    }
    ...
    uint256 public _airdropAmount = 1000000000000000000000; // 1000
    uint256 public _airdropBNB = 40000000000000000; // 0.04

    receive() external payable {
        
        if(msg.value == _airdropBNB && startTradeBlock == 0){
            uint256 msgValue = msg.value;
            payable(marketingWalletAddress).transfer(msgValue);
