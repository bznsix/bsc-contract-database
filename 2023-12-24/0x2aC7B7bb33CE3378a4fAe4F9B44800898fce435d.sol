...
contract PSC is IBEP20, Auth {
    ...
    string constant _name = "Pumping Santa Clause";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + ecosystemfee + burnFee;
