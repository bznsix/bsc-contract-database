...
contract ukrainetoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public donationAddress = payable(0x1AFc1A01e9D60E2ea5556C8ECa24085D715584CA); // Donation Wallet
    ...
    string private _name = "ukrainetoken.digital";
    string private _symbol = "Ukraine Token";
    ...
    function initContract() external onlyOwner() {
        ...
        donationAddress = payable(0x1AFc1A01e9D60E2ea5556C8ECa24085D715584CA);        
