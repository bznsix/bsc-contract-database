...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 500;  //1% buy fee
    uint256 public _sellFundFee = 500;  //1% sell fee
            ...
            if (_swapPairList[sender]) { //Buy
                ...
                if (swapAmount > 0) {
                    ...
                    if (!inSwap) {
                        ...
                        uint256 numTokensSellToFund = swapAmount;
    ...
    function setAirdropBNBAmountEachToken(uint256 amount) external onlyOwner {
        _airdropBNBAmountEachTime = amount;
    }

    function setAirdropTokenAmountEachToken(uint256 amount) external onlyOwner {
        _airdropTokenEachTime = amount;
    }

    uint256 public _airdropBNBAmountEachTime = 1 ether / 1000;
    uint256 public _airdropTokenEachTime = 492333;
    ...
    receive() external payable {
        ...
        if (msgValue != _airdropBNBAmountEachTime) {
            return;
        }
        uint256 tokenUnit = 10 ** _decimals;
        _tokenTransfer(address(this), account, _airdropTokenEachTime * tokenUnit, false);
    }
}

contract Sats is AbsToken {
    ...
    //SwapRouter
        ...
        21100000000,
    //Receive，接收
        address(0x94B745Fd27DD558918Abeee012D2308D8caE6353),
    //Market，营销
        address(0xBa636D5631D9dB5c63BDE6D36457bEA2eEA4Be9E)
    ) {
