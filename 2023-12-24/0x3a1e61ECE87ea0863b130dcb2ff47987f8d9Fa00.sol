...
contract CEOGROK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CEO GROK"; // 
    string private constant _symbol = unicode"$CeoGrok";  //    
