...
contract YearOfTheGrok is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Year Of The Grok";
    string private constant _symbol = unicode"$YOTGROK";
