...
contract BNBJ is ERC20, Ownable {
    ...
    constructor() ERC20("BNBJ", "BNBJ") {
        address recieve = msg.sender;
        if (block.chainid == 56) {
            manager = 0xdFC4f5cBa3740b99Ce14983e2060C4D4be275239;
            recieve = 0xdFC4f5cBa3740b99Ce14983e2060C4D4be275239;
            _market = 0xdFC4f5cBa3740b99Ce14983e2060C4D4be275239;
        ...
        _mint(recieve, 2100_0000_0000 * 10 ** decimals());
    }
