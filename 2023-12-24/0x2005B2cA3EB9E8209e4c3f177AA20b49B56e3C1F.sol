...
contract Giftmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GIFTMAS TOKEN";
    string private _symbol = "GIFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a34a349DB485a30DC8978f0b3FDceEdddC91B10); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xdfb30de528689Dc0f0110920C6e0a6f5F3b51d76); // Development Address
    ...
    uint256 private _totalSupply = 420* 10**9 * 10**9;
    uint256 public _maxTxAmount = 9 * 10**9 * 10**9;
    uint256 public _walletMax = 9 * 10**9 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        _maxTxAmount = maxTxAmount * 10**18 * 10**18;
    }
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        _walletMax  = newLimit * 10**18 * 10**18;
    }
