...
contract GROK is ERC20, Ownable {
    ...
    constructor() ERC20("Prince GROK", "GROK") {
        ...
        uint256 totalSupply = 100000000000000000;
 
        maxTransactionAmount = totalSupply * 200 / 1000; // 2.5%
        maxWallet = totalSupply * 200 / 1000; // 2.5% 
