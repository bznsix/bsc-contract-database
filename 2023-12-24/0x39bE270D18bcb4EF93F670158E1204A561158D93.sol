...
contract SHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x18D52D8716Acc8cD45cbc7402c12B2c6119c1Dc2); 
    address payable public Wallet_Dev = payable(0xdd3b8D05a651BF68045e1d5681FF1AdD86e9b97a);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 1**4* 10**4 * 1**_decimals;
    string private constant _name = "SHIBA INU X"; 
    ...
    constructor () {
        _owner =0xdd3b8D05a651BF68045e1d5681FF1AdD86e9b97a;
