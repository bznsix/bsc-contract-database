...
contract ZJZ is ERC20, Ownable {
    ...
    constructor() ERC20("ZJZ", "ZJZ") {
        address recieve = msg.sender;
        if (block.chainid == 56) {
            manager = 0xCD0A540B48190bd14F6f51Ab47aA020f931c6aBA;
            recieve = 0xdEA70e8D699ff70FdaC0f94F3e90019760830007;
            _market = 0x6EF0B54db004b29561873b85cdB7dA3deE43B135;
