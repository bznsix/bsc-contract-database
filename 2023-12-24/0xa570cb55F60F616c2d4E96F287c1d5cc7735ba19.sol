...
contract ChristMasSnow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Snow";
    string private _symbol = "snowmas";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4c494AC1B2ef83f0c9DF7a44061D169254b45879);
    address payable private DevelopmentWalletAddress = payable(0x4c494AC1B2ef83f0c9DF7a44061D169254b45879);
