        ...
        if (takeFee) {
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        feeAmount += destroyAmount;
                        _takeTransfer(sender, address(0x8C08061394252905da95330f3960134783434251), destroyAmount);
                    }
                }
...
contract CESHI is AbsToken {
    constructor() AbsToken(
        ...
        18,
        420000000000000,
        address(0xa6F1ccE7C804Cb1D06Fb2180ec42b709A7c3953E),
        address(0xa6F1ccE7C804Cb1D06Fb2180ec42b709A7c3953E),
        address(0x8C08061394252905da95330f3960134783434251),
        420000000000000,
        0,
        420000000000000
    ){
