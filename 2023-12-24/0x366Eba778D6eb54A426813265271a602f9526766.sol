...
contract GROKDOGE is ERC20, Ownable {
    ...
    constructor () ERC20("GrokDoge", "GROKDOGE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xB1a136403238016fE09484C635E822359c0ED1CF;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;

        _mint(owner(), 25e6 * (10 ** decimals()));
