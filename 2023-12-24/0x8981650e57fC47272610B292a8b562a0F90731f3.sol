...
contract FIST is ERC20 {
    ...
    address _fundAddress = address(0x714F0f277e975Fc82EeCa42fE2FD6C87076d427b);
    ...
    constructor(address tokenOwner) ERC20("FIST", "FIST") {
        require(_baseToken < address(this),"FIST small");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                _splitUsdtLdxToken();
                super._transfer(from, address(this), amount.div(10000).mul(398));
				super._transfer(address(this), _destroyAddress, amount.div(10000).mul(18));
                ...
                if(startTime.add(1800) > block.timestamp){
					...
					super._transfer(from, address(this), amount.div(100).mul(10));
