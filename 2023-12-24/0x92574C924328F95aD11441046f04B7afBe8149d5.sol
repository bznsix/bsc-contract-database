...
contract BaoLong is ERC20 {
    ...
    address _fundAddress = address(0xa3849aBEd7bFeAD58FA6F815a9adcC108383D07d);
    address _marketAddress = address(0x0dF8d6E69dc2406f8dD30E2195d5cd9975c2D28E);
    address _nftUsdtAddress = address(0xEB2C20790AC848a214636b1f4E455D5aaCfF9f01);
    ...
    constructor(address tokenOwner) ERC20("BaoLong", "BaoLong") {
    ...
    function _transfer(
        ...
        super._transfer(from, to, amount);
        if(to == uniswapV2Pair && pair.balanceOf(from) > 0){
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount >= 10**20){
            ...
            if(afterAmount > beforeAmount){
                ...
                USDT.transfer(_fundAddress, newAmount.div(5));
                USDT.transfer(_marketAddress, newAmount.div(5));
                USDT.transfer(_nftUsdtAddress, newAmount.div(5));
            }
		}
    }
