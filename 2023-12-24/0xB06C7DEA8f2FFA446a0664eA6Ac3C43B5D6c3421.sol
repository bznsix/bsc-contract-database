...
contract Token is IERC20, Ownable {
    ...
    address public Token_1688 = 0x9b9Ea2161b480CF85dFB84137eA9882127cB5772;
    ...
    constructor() {
        ...
        _symbol = "burnBTNB";
        _decimals = 18;
        uint256 total = 38000000 * 10 ** _decimals;
        _tTotal = total;

        fundAddress = payable(0x00809c289Da65aB11B0E17017ea1a3F3A4E43f5C);
        ...
        address ReceiveAddress = 0x00809c289Da65aB11B0E17017ea1a3F3A4E43f5C;
        ...
        buyBackPath = [currency,Token_1688];
        // if (currency != ETH) {
        ...
        //invitor
        beInvitorThreshold = 10 ** _decimals / 100000;
        // require(numberParams[17] <= 7, "length should be <= 7");
        invitorRewardPercentList = new uint256[](2);
        invitorRewardPercentList[0] = 130;
        invitorRewardPercentList[1] = 70;
        ...
        holderRewardCondition = 10 ** IERC20(ETH).decimals() / 100000;
    ...
    uint256 public fundPercentage = 33;
    function setFundPercentage(uint256 newValue) public onlyOwner{
        require(newValue <= 100,"too high");
        fundPercentage = newValue;
    }
    ...
    function swapTokenForFund(
        ...
        if (fundAndBuyBackAmount > 0) {
            uint256 fundAmount = fundAndBuyBackAmount * fundPercentage / 100;
            FIST.transferFrom(
                address(_tokenDistributor),
                fundAddress,
                fundAmount
            );
            if (fundAndBuyBackAmount > fundAmount){
                FIST.transferFrom(
                    address(_tokenDistributor),
                    address(this),
                    fundAndBuyBackAmount - fundAmount
                );
                try
                    _swapRouter
                        .swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    uint256 public canRemoveTime = 3 * 24 * 60 * 60;
