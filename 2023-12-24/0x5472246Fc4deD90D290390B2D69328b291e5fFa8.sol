...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 SOLANA = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = SOLANA.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(SOLANA);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = SOLANA.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           SOLANA.transfer(shareholder, amount);
...
contract GetSOolana is IBEP20, Auth {
   using SafeMath for uint256;
 
   address SOLANA = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "GET SOLANA TOKEN";
   string constant _symbol = "$GSOL";
...
uint256 reflectionFee = 3;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xA1b58f59297bDF2C681ddbAf003660b6281B8ddc; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xA1b58f59297bDF2C681ddbAf003660b6281B8ddc; //Can be change to any wallet you want
       marketingFeeReceiver = 0xA1b58f59297bDF2C681ddbAf003660b6281B8ddc; //Can be change to any wallet you want
