...
contract BHUP is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x1Fb29E5Ccc7f6D596F1b120cf32f24a004F87F5c);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0xcf7859E225153CfFfA2c04f5e7b101f355288C5C;
    ...
    string private _name = "BonkHub";
    string private _symbol = "BHUP";
    ...
    uint256 private minimumTokensBeforeSwap = 2500000000 * 10**_decimals;
