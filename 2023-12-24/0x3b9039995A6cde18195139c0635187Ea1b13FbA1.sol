...
contract WEBDD is CfoTakeableV2, IERC20Metadata {
    using Address for address;
    using SafeMath for uint256;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    string private constant _name = "WEBDD";
    string private constant _symbol = "WEBDD";
    uint256 private constant _totalSupply = 10000000 * 1e18;
    mapping(address => bool) private otherSwapFactory;
    ISwapFactory public   CCSwapFactory;
    address public   usdt;
    ...
    constructor(
              address _CCSwapFactory,
        address _usdt
    ) {
         require(_CCSwapFactory != address(0),"did swap factory can not be address 0");
        CCSwapFactory = ISwapFactory(_CCSwapFactory);
         usdt = _usdt;
    ...
    function isSwapPair(address pair) public view returns(bool){
        ...
        return CCSwapFactory.getPair(address(this), usdt) == pair || otherSwapFactory[pair];
    }
    ...
    function transferFrom(
        ...
        require(isSwapPair(sender)||isSwapPair(recipient),"Can only be traded on CCSwap");
