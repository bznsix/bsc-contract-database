...
contract ChristmasGrok is ERC20, Ownable {
    ...
    uint256 public numTokensSellToMarket = 3000 * 10 ** _decimals;

    address public _market = 0xebe9AAfc47CD4504FD760cB385c99B760963d4A2;
    event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Christmas Grok", "Christmas Grok") {
