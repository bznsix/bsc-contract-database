...
// ~~~~~~~~~~~~~~~~~~~~~~~~
// BitCoinPepeInu – $BTC
// http://bitcoinpepeinu.com
// https://t.me/BitcoinPepeInu
// https://twitter.com/BitCoinPepeInu
// ~~~~~~~~~~~~~~~~~~~~~~~~
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eA15FB49198D882E4501f01af2159BbFCeB5C02;
...
contract $BTC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFC11E116C9c8D30c37187B3197c692E1f0A149B2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BitCoinPepeInu";
