...
contract SUNSHINE is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) public _buySum;
    mapping(address => uint256) public _sellSum;
    mapping(address => uint256) public _sellSumETH;

    uint256 public _totalSupply = (10 ** 8) * (10 ** _DECIMALS);
    uint256 public _theNumber = ~uint256(0);
    uint256 public _theRemainder = 0;
    ...
    constructor(address routerAddress) {
        ...
        _pair = IPancakePair(IPancakeFactory(_router.factory()).createPair(address(this), address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)));
    ...
    function _getETHEquivalent(uint256 amountTokens) private view returns (uint256) {
        (uint256 reserve0, uint256 reserve1,) = _pair.getReserves();
        if (_pair.token0() == address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)) {
