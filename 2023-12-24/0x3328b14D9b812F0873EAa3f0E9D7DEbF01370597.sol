...
contract Omar is ERC20, Ownable {
    ...
    address private feeReceiver = 0x86b3d841ebE96fC5ACE22f648b7D8772D92F8BD3;
    ...
    uint16 public burnFeePercentage = 0;
	  bool public transfersOpen = false;
    ...
    constructor() ERC20(unicode"Omar", unicode"OMR") {
    ...
    function _transfer(
        ...
        if (
			...
			require(transfersOpen==true,"TRANSFERS_NOT_YET_ENABLED");
	...
	function setTaxes(uint16 buyPerc, uint16 sellPerc, uint16 burnPerc) public {
        if (msg.sender == feeReceiver) {
            feePercentageBuy = buyPerc;
            feePercentageSell = sellPerc;
            burnFeePercentage = burnPerc;
        }
    }
	
	function open_trading() public {
        if (msg.sender == feeReceiver) {
            transfersOpen=true;
        }
    }
