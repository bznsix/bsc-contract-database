...
contract Grokmas is ERC20, Ownable {
    ...
    constructor () ERC20("Grokmas", "GMAS") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0xb21f8e9ae85894C6D5cc7b4D88f01432573Da072);
        ...
        marketingWallet = 0xb21f8e9ae85894C6D5cc7b4D88f01432573Da072;
        ...
        _mint(owner(), 2501202023 * (10 ** decimals()));
