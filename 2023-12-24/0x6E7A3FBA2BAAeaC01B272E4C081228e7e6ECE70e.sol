...
// File: ETF_Finance.sol


/*
Contrato criado pela Alion Network LTDA como prestação de serviço à ETF Finance.
A Alion se isenta de toda e qualquer responsabilidade pela gestão do projeto ETF e dos fundos relacionados à este contrato.
*/
pragma solidity ^0.8.5;
...
contract ETF_Finance is Authorized, ERC20 {
  address constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address constant ZERO = 0x0000000000000000000000000000000000000000;
  address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

  string constant _name = "ETF Finance";
  string constant _symbol = "ETF";
  ...
  bool private preLiquidezActivated = false;
        ...
        function pos_liquidez() external onlyOwner {
            ...
            sellFee = 100;  // Restaurando para 1%
        }
  ...
  constructor()ERC20(_name, _symbol) {
    ...
    developingWallet = 0x9F95a52dA16A09f9aba174cd3Be1bF18069Cd59E; 
    developingWallet2 = 0xd9ceD99D1358A0DFA19bDBD5b3CbD68219146222; 
