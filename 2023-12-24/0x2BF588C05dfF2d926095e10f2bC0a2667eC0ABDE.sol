...
*/
// Telegram : https://t.me/miniSantaGROK
// X : https://twitter.com/miniSantaGROK
...
contract MINISANTAGROK is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500000000000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x44Ebe4bfBC092511e4409E3485422D59F3665525;
    address private opsWallet = 0xCfe0Afc66bc0Fd885C6e6CE31f5c2Db16C234c6E;
    address private devWallet = 0xCfe0Afc66bc0Fd885C6e6CE31f5c2Db16C234c6E;

    string private constant _name = "Mini Santa Grok";
    string private constant _symbol = "$MINISANTAGROK";
    ...
    Taxes public taxes = Taxes(0, 5, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 0, 0, 0);
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0xCfe0Afc66bc0Fd885C6e6CE31f5c2Db16C234c6E] = true;
        _isExcludedFromFee[0xCfe0Afc66bc0Fd885C6e6CE31f5c2Db16C234c6E] = true;
