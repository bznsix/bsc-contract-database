...
contract AivcToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private _name = "AivcToken";
    string private _symbol = "AIVC";
    ...
    constructor ()  {
        ...
        isExcludedFee[address(0x02939425ddB196Aec353b4e98CeD5cCa7606bfEb)] = true;
