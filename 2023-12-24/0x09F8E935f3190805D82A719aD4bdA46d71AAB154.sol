...
contract GRINCH is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 450_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0xB764B5d1Dc51D52137C99Ba2c068FDC0b428F29A); // build: 0xB764B5d1Dc51D52137C99Ba2c068FDC0b428F29A
    address payable private devWallet = payable(0xeB965b5bFA0001E39A342A39b36cb6Ce8ecC7abC); // build: 0xeB965b5bFA0001E39A342A39b36cb6Ce8ecC7abC
...
//--- v3 Allocations ---//
    ...
    string constant private _name = "Grinch Stole Christmas";
    string constant private _symbol = "GRINCH";
