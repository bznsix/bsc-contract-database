...
contract SantaToken    is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xbC58B20c36d263e210D54BeacbA0724A71bb24a9;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Santa Token  ";
    ...
    uint256 private _maxTxAmount = 10000000000 * 10**6 * 10**9;
