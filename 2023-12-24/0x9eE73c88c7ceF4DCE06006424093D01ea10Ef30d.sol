/*       
    https://santapeter.online/
    https://t.me/santapetercoin
...
contract SANTAPETER is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x3FCabC23b26c5e6cE30842A262377c0fF0e0EfEC);
    ...
    string private _name = "SANTAPETER"; 
    string private _symbol = "SPETER";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 25_000_000_000 * 10**_decimals;
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent() external onlyOwner() {
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            require(_tradingOpen, "Trading is not available yet");       
        }
