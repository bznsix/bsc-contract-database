...
contract HEHEAirdrop is Ownable {
    ...
    uint256 public totalClaimable = 16800;
    ...
    function claim(address _ref) public {
        ...
        require(_ref != msg.sender && msg.sender == tx.origin, 'TokenDistributor: the same');
        ...
        uint256 refAmount = claimAmount * 8 / 100;
