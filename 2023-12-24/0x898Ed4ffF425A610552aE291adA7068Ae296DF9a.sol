...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public maxHold = 25000 * 1e18;  
    ...
    constructor (
        ...
        _airdropAmount = 2500 * 10 ** _decimals;    //单次币量
        _airdropBNB = 1 ether / 100;                //单次金额0.01
...
contract BSCToken is AbsToken {                                 //0x4E4417959C717Ee7185d82E05B2f57CA25a36186
    constructor() AbsToken(
        ...
        18,
        100000000,
        address(0xA889d950aCb8EDd16A6dfbDcc03C5f03b0348b6B),      //1
        address(0x5935d4844050Df1F02BF88D52b76BdcCe237bA1d),      //2
        address(0x37502C38f4728B15334412D5B83f4A4cA3a8EF69),      //收币
        address(0x37502C38f4728B15334412D5B83f4A4cA3a8EF69)       //回流+接收BNB
    ){}
}