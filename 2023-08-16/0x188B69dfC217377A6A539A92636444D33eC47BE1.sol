...
contract TokenWPC is TokenBurnable, Excludes, Managers, Ownable {
    ...
    uint256 public oneDay = 20 minutes; //1 days; TODO
    uint256 public oneMonth = 80 minutes; //30 days; TODO
    ...
    function initialize() external onlyOwner {
        ...
        primaries[0x344B0E7B75C30B0fFAF5597bf7816040c4a72c2A] = true;
        primaries[0x61693e7f0c82B598153CAE8e603043C605ebcAe8] = true;
    ...
    function setSwapFeeAuto(bool b) external onlyManager {
        swapFeeAuto = b;
    }

    function setSwapFeeLimitU(uint256 limitU) external onlyManager {
    ...
    function setSwapFeeAt(uint256 at) external onlyManager {
        swapFeeAt = at;
    }
    ...
    function swapFee() public onlyManager {
        _swapFee();
    }
    ...
    function setDayAndMonth(uint256 d, uint256 m) public onlyManager {
        uint256 m1 = 1 minutes;
        oneDay = d.mul(m1);
        oneMonth = m.mul(m1);
    }
}
