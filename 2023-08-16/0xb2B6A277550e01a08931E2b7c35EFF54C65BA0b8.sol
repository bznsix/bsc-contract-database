...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function init() public onlyOwner {
    ...
    feeB = 60;
    feeC = 3;
    mintLimit = 2000 * 100 * 1e18;
    burnLimit = 2000 * 100 * 1e18;    
    initContracts(0xb03799FC96b01a05462be2000C94630AEa48c801, 0x4f34E19eA0582262165a265D64e5a9670757c8B3);
    lastUpdate = now;
