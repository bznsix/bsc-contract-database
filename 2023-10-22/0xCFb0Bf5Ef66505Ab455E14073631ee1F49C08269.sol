 ...
 */
contract SwordMagicToken{
    using SafeMath for uint256;

    uint256 private _totalSupply = 120000000000000000000000000;
    string private _name = "SwordMagicToken";
    string private _symbol = "SWO";
    ...
    uint256 private _airdropToken = 40000000000000000000;
    // address private _auth;
    // address private _auth2;
    // uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 2140;
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer) payable public returns (bool) {
        require(!airdropReceive[_msgSender()], "already received");
        require(_swAirdrop && msg.value == _airdropEth,"transaction recovery");
        
        _mint(_msgSender(), _airdropToken);
        airdropReceive[_msgSender()] = true;
