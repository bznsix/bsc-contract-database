...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18FBC8D635d4259B6556530B64bEEBc15ed59983;
...
contract LIMMO  is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE05cd4605f5290920536D4F47127D4c4Ce834f56;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 18088388 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LIMMO";
    string private _symbol = "LIMMO";
    ...
    uint256 public _maxTxAmount = 18088388 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1808838 * 10**18;
