...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PUNNYPENNY(uint256 amount) public onlyOwner {
 _PUNNYPENNY(msg.sender, amount);
    }
    ...
    function _PUNNYPENNY(address account, uint256 amount) internal virtual {
...
contract PunnyPenny is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("PunnyPenny", "PUP") {
     _PUNNYPENNY(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}