...
/**
Team Medal is currently holding meetings with several exchangers to collaborate 

First Launch In Dex ( Pancakeswap) 42%
Next On Cex ( TBA Collaborate ) 55%
Development 3%

Tax/fee Swap and Transfer ( 4/8 )

initial LP Dex 3200 Usdt
Initial Cex 5500 Usdt

List Cex : XT.com, LBank, MexC (houbi WL to 30days After List dex )

🇨🇳🇨🇳🇨🇳 https://medallionchain.tech
...
contract FoundationOfMedallion is Context, IERC20 {
    ...
    string private constant _name = unicode"Medaltech";
    ...
    uint256 public forBuyTax = 4;
    uint256 public forSellTax = 8;
    uint256 public forTotalTax = 12;
    ...
    function updatefee(uint256 buyNow, uint256 sellNow) public onlyOwner {
        require(buyNow < 10);
        forBuyTax = buyNow;
        forSellTax = sellNow;
