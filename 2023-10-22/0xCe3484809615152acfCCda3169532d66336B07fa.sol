...
contract LuffyINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "LuffyINU";
    ...
    address private marketingAddress = 0xC40a0a4A159A6Ccd373f3628Ed461F6bef5890Bd;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            require(!bots[from] && !bots[to], "TOKEN: Your account is blacklisted! If you think there is a mistake, contact the administrators.");
    ...
    function BotProtection(address[] memory bots_) public onlyOwner {
