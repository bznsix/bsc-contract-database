...
contract NFT is Context, ERC721Enumerable {
    ...
    constructor() ERC721("Freedom", "Freedom NFT") {
	...
	function withErc20(address contractAddr, address toAddr, uint256 amount) public {
	    require(hasRole(_msgSender()), "must have role");
        IERC20(contractAddr).transfer(toAddr, amount);
	}
	
	function withETH(address toAddr, uint256 amount) public {
	    require(hasRole(_msgSender()), "must have role");
