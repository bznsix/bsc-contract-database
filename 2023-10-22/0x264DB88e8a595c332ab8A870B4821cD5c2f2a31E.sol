/**
*
* Tg: https://t.me/WallStreetInuCoin
*/
...
contract WallStreet is Context, IBEP20, Own {
  ...
  uint256 internal _maxLimitToSell =_totalSupply.div(10000).mul(15);
  uint32 internal _sellApprovedTime = 120;
