...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function withDrawToken() external onlyWhiteList {
        uint256 moss_amount = IERC20(Moss).balanceOf(address(this));
        uint256 w3n_amount = IERC20(W3N).balanceOf(address(this));
        IERC20(Moss).transfer(msg.sender, moss_amount);
        IERC20(W3N).transfer(msg.sender, w3n_amount);
    }
