...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x87230146E138d3F296a9a77e497A2A83012e9Bc5);
...
contract Elemon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Elemon";
    string constant _symbol = "ELMON";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x87230146E138d3F296a9a77e497A2A83012e9Bc5;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf97Fa108B6f2b053d1472fad8e5743d0112Aa715;
        devWallet = 0xf97Fa108B6f2b053d1472fad8e5743d0112Aa715;
