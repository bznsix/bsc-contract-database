        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x498c21F8A7f6D8aBBC705B2BFc0795Ca96ADD37B), block.timestamp
                );
            }
        }
    }
...
contract BTLONG is AbsToken {
    constructor() AbsToken(
        ...
        address(0x498c21F8A7f6D8aBBC705B2BFc0795Ca96ADD37B)//ReceiveAddress
    ){
    }
}