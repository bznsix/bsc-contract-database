...
contract YYDS is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x05c9144b1fb971253b6AFd13ec683886e8a43b74);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;
    
    address public fund1Address = address(0x05c9144b1fb971253b6AFd13ec683886e8a43b74);
    ...
    constructor(address tokenOwner) {
        ...
        uint256 leftAmount = 200000 * 10**_decimals;
