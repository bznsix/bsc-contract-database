...
contract NEO is ERC20, Ownable {
    ...
    address public developmentWallet = 0x9dBfd13d0c0df87DDA22fF51aA70C10cb00010E4;
    uint public constant PERCENT_DIVIDER = 100;
    uint public constant BUYTAX = 0;
    uint public constant SELLTAX = 2;


    event changeLiquidityPoolStatus(address lpAddress, bool status);


    constructor() ERC20("Neo Artificial Intelligence", "NEO-AI") {
