...
contract ASHIBA is ERC20, Ownable {
    ...
    constructor () ERC20("AnonShiba", "ASHIBA") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        transferOwnership(0x819285D81a07c20c2b05d9EB21A6686864b3e8E1);
        ...
        marketingWallet = 0xC99Fd1338ffe7C2Be41a72193055B1e33B4A1a31;
