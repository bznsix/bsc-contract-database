...
https://twitter.com/PeopleTokenBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3153896d397fceB2aD9F09e396cBb0E51C2bf8C4; 
...
contract PeopleDevelopment89 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEOPLE TOKEN";
    string private _symbol = "PEOPLE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3153896d397fceB2aD9F09e396cBb0E51C2bf8C4); 
    address payable public teamWalletAddress = payable(0x3153896d397fceB2aD9F09e396cBb0E51C2bf8C4); 
    ...
    uint256 private _totalSupply = 75000 * 10**_decimals;
    uint256 public _maxTxAmount = 1500 * 10**_decimals; 
    uint256 public _walletMax = 2250 * 10**_decimals;
