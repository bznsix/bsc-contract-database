...
contract  LongS is Token {
    constructor() ERC20(
        " LongS",   // 名字
        " LongS"   // 符号
    ) {
        uint256 _totalSupply = 10000 ether; 
        address _marketing = address(0x2441BacCa9eF96ADcd4B9321cb202E18D618161E); // 
        address _receive = address(0x2441BacCa9eF96ADcd4B9321cb202E18D618161E);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x2441BacCa9eF96ADcd4B9321cb202E18D618161E)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x20B66EED653b3d305540C5313B73e44607260687);   
        feeEarn = 500; 
    }
}