...
contract TOKEN is Context, IERC20 { 
    ...
    address payable public constant Wallet_DevFee = payable(0x9F49470578a38FF090d2AAE6d75e274736F1fAe1);
    address public constant Wallet_Burn = 0x9F49470578a38FF090d2AAE6d75e274736F1fAe1;

    // GEN address (for affiliate commission level tracking)
    IERC20 GEN = IERC20(0x9F49470578a38FF090d2AAE6d75e274736F1fAe1); 
    ...
    function Project_Information() external view returns(address Owner_Wallet,
        ...
        string memory Creator = "www.fusion-swap-1.dexkit.app";
    ...
    */
    ...
    function Process_Remove_Contract_Fee() external payable {
        ...
        require(msg.value > (contractFee - contractPaidAmount), "REQ_2BNB"); // Payment too low. Total Contract fee is 2 BNB 
...
/*
    ...
    Token Created at www.fusion-swap-1.dexkit.app    This contract is not open source - Can not be used or forked without permission.
