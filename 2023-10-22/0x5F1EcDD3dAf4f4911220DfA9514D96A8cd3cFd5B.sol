...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shank Inu"; // 
    string private constant _symbol = "$SHANK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x83d26c3728a5a72A5d2B8fC3aeB4adC36dAFB48A;
