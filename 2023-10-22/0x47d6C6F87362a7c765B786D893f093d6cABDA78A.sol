// Telegram: https://t.me/McDogeBurger
...
contract McDogeBurger is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x43f41879EED4ee44Cf3fbfe281BCB831Ca2292A7); // Marketing Address
        
    address payable public teamAddress =
        payable(0xdd33640DcCd29f842f68b0850d4B20334bD113D8); // Team Address
    ...
    uint256 private constant _tTotal = 1000000 * 1e9 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "McDogeBurger";
    string private constant _symbol = "McDogeBurger";
