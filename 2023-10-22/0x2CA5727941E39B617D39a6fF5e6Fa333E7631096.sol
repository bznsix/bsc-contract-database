...
/* USDGOLD -  A Digital assets for a stable currency with Binance Smart Chain Network
website: https://usdgold.online
...
contract USDGold is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF53Eb1513aEc08c221A5D56AeecAAbA7f2ddc823); // Marketing Address
    address payable public charityAddress = payable(0xF53Eb1513aEc08c221A5D56AeecAAbA7f2ddc823); // Charity/Dev Address
    ...
    string private _name = "USDGold";
    string private _symbol = "USDG";
