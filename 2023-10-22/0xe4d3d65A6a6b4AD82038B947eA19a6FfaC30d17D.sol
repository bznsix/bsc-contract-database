...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFC1d473E2475099324ac3E2f948ea8A9f2894756; // owner address
...
contract Wikipedia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wikipedia";
    string private _symbol = "WIKI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFC1d473E2475099324ac3E2f948ea8A9f2894756); // Marketing Address
    address payable private teamWalletAddress = payable(0xFC1d473E2475099324ac3E2f948ea8A9f2894756); // Team Address
