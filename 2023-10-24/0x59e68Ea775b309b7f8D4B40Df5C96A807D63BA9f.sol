...
// ############################################################
// ||                                                        ||
// ||    This Contract Was Created by tg.me/coinsult_tg	     ||
// ||                                                        ||
// ############################################################
...
contract OXIX is ERC20, Ownable {
    ...
    {   
        ...
        marketingFeeOnTransfer = 2;

        marketingWallet = 0x6307d5D3669C9F070b2772dC98769CaD0ee9D522;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnTransfer) external onlyOwner {
        ...
        require(marketingFeeOnBuy <= 2, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnSell <= 2, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnTransfer <= 2, "Total Fees cannot exceed the maximum");
