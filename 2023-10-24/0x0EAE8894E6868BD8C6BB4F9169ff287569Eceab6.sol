...
contract SANTASAFU is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Santa #Safu";
    ...
    uint256 public _maxTxAmount = _totalSupply * 499 / 1000; 
    uint256 public _walletMax = _totalSupply * 499 / 1000; 
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0xfDb9AE496eA885C91150f90f9c74da774e2a496b; //LP receiver
        marketingWallet = 0xFa9c124a555d43DB72468ca01e5eCB7bD42f57a0;  //marketing wallet
        taxMan = msg.sender;  
