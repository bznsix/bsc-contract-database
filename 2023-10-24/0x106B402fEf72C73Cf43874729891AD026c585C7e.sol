 ...
 *Submitted for verification at BscScan.com on 2021-05-29
 * 
 * With partnership of @theoscall telegram channel for promotion
*/
...
/*
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BEAMMOONBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BEAMMOON to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BEAMMOON 10000X? 
   ...
   it's the best part of the #BEAMMOON idea, increasing the liquidity pool automatically, 
...
contract BEAMMOON is Context, IERC20, Ownable {
