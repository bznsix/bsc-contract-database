...
contract Bromance is Context, IERC20, Ownable {
    ...
    string private _name = "Bromance";
    string private _symbol = "Bromance";
    ...
    uint256 internal _tokenTotal = 10000 *10**16; // 100M total supply
    ...
    uint256 public _liquidityFee = 300; // 100 = 1%
    //variables
    ...
    //addresses
    address public charityAddress = 0x4e7Ada28Ee7826c52032c11BDEB5339942498a20; // Charity Address
    address public liquidityAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // PancakeSwapRouterV2
 ...
 /**
    ...
    */
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'BROMANCE: The contract it self cannot be excluded');
        require(!_isExcluded[account], "BROMANCE: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "BROMANCE: Account is already included");
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(0), "BROMANCE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BROMANCE::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "BROMANCE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "BROMANCE::getPriorVotes: not yet determined");
