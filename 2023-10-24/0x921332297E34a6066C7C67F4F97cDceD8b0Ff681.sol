...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xa3dACCc7e2C07e60bD1A21Fe2b739D53226cD48D; // owner address
...
contract M4INU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "M4a1INU";
    string private _symbol = "M4A1INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3dACCc7e2C07e60bD1A21Fe2b739D53226cD48D); 
    address payable public teamWalletAddress = payable(0xa3dACCc7e2C07e60bD1A21Fe2b739D53226cD48D);
    ...
    uint256 private _totalSupply = 1200000000000000 * 10**_decimals;
