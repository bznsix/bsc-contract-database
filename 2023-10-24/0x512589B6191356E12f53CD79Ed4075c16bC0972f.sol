...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public USDC = IBEP20(0x4DB5a66E937A9F4473fA95b1cAF1d1E1D62E29EA);
...
/* Token contract */
contract Binancereum is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address USDC = 0x4DB5a66E937A9F4473fA95b1cAF1d1E1D62E29EA; 
    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Binancereum.org";
    string constant _symbol = "BINANCEREUM";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 2%
    ...
    // Buy Fees
    uint256 liquidityFeeBuy = 50;
    uint256 devFeeBuy = 100;
    uint256 reflectionFeeBuy = 500;
    uint256 marketingFeeBuy = 350;
    uint256 totalFeeBuy = 1000;      

    // Sell fees
    uint256 liquidityFeeSell = 50;
    uint256 devFeeSell = 100;
    uint256 reflectionFeeSell = 500;
    uint256 marketingFeeSell = 350;
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 0.2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[0x34aae8E3080F052aDe2374D889aC6dBC70B3Bf67] = true;
        isFeeExempt[0x34aae8E3080F052aDe2374D889aC6dBC70B3Bf67] = true;
        
        // No timelock for these people
        isTimelockExempt[msg.sender] = true;
        isTimelockExempt[DEAD] = true;
        isTimelockExempt[address(this)] = true;
        isTimelockExempt[0x34aae8E3080F052aDe2374D889aC6dBC70B3Bf67] = true;
        
        // Exempt from dividend
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        isDividendExempt[0x34aae8E3080F052aDe2374D889aC6dBC70B3Bf67] = true;

        // Set the marketing and liq receiver to the owner as default
        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver = 0x5B362789C248C65EbA1780C7d2900CCeE7D02F6e;
        devFeeReceiver = 0x036d3fB02f3f2212736f0B6849420504f8038a21;
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _devFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _feeDenominator) external onlyOwner {
    ...
    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _devFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _feeDenominator) external onlyOwner {
