...
contract Thi is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x094CFEECd90373a879C8De3a108Df60c7FCEE8AD);
    address payable public devAddress = payable(0xe29363233Aae1473EAAFB3Ee642313bdCB1E0Eea);
    address public newOwner = 0xe29363233Aae1473EAAFB3Ee642313bdCB1E0Eea;
    ...
    string private _name = "Jj";
    string private _symbol = "Thi";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 6886858 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 17217 * 10**_decimals;
