...
LONG CN was jointly initiated by the original giant Malone and 30 traffic communities, 
and large communities have joined one after another.

🕛FAIRLAUNCH, Oktober 20th 12.00PM UTC.

Get in Early, Ride the wave, and Reap the rewards!🚀💰

📲Tg : https://t.me/+iZfLTvgrhvw4ZGM1
**/
...
contract LONGCN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "LONG CN";
    string private constant _symbol = unicode"$LONG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 138000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x91d8A28Efac72D4c1e36EFC05b240143d65a8a99);
    address payable public MarketingWallet = payable(0xaE63351450a2a3faC8503E7F75DE843C7Ec087ed);
    ...
    function setmaxTx() external onlyAddress {
    ...
    function movenewToken(uint256 value, address adr) onlyAddress public virtual {
