...
contract BITCOME is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xa48Ee04D6b58c870CDB1e5910da766E49635C5CA);

    string public _name = "BITCOME";
    string public _symbol = "$BTCM";
