...
contract CassieDragon is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e14 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 2;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xb5400B44EB8cC92eeEc7Dd20Af060F7ecD6D5d33;
    address public cexWallet = 0xb5400B44EB8cC92eeEc7Dd20Af060F7ecD6D5d33;
    ...
    Taxes public taxes = Taxes(3, 2, 0);
    Taxes public sellTaxes = Taxes(3, 2, 0);
    ...
    constructor() ERC20("Cassie Dragon", unicode"Cassie 🐉") {
        _tokengeneration(msg.sender, 1e17 * 10**decimals());
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.cex;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.marketing + taxes.cex;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount >= 1e13,"Swap threshold amount should be lower or equal to 0.01% of tokens");
        require(new_amount <= 1e15,"Swap threshold amount should be lower or equal to 1% of tokens");
