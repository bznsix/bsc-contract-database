...
contract LeapFrog is Ownable, ERC20 {
    ...
    constructor() ERC20("LeapFrog", "LEAPFROG") {
        _transferOwnership(0xF8359785761779db1091AF924e00c3fC5d4C34B7);
        _mint(owner(), 450_000_000_000 * (10 ** 18));
        ...
        marketingWallet = 0x96E7ADFC8cBB60d76Ed2eA2EE74539C53De52459;

        swapTokensAtAmount = totalSupply() / 1_000_000;
        isSwapBackEnabled = true;

        maxTransferAmount = 10_000_000_000 * (10 ** 18); // Set your desired max transfer amount
        maxGlobalBalance = 45_000_000_000 * (10 ** 18); // Set your desired max global balance
    ...
    function setMaxGlobalBalance(uint256 balance) external onlyOwner {
        maxGlobalBalance = balance;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            require(balanceOf(to) + amount <= maxGlobalBalance, "Recipient balance exceeds the maximum allowed");
        }
    ...
    function manualSwapBack() external {
        ...
        require(contractTokenBalance > 0, "Can't Swap Back 0 Token!");
