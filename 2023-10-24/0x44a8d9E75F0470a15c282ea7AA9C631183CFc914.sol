...
contract TrabasArnyCapital is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1547BCBF90B0e83452375Bd472caFe37D4409F5A); // Marketing Address
        
    address payable public teamAddress =
        payable(0x1547BCBF90B0e83452375Bd472caFe37D4409F5A); // Team Address
        
    address payable public liquidityAddress =
        payable(0x1547BCBF90B0e83452375Bd472caFe37D4409F5A); // Liquidity Address
    ...
    string private constant _name = "Trabas Army Capital";

    string private constant _symbol = "TAC";
    ...
    uint256 public maxWallet = _tTotal * 1 / 2000 ; // 0.5% at launch

    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    mapping (address => bool) public automatedMarketMakerPairs;

    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 500 ; // 0.2 %
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 25, "Must keep taxes below 25%");
