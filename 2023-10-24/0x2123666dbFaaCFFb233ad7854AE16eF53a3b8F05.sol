...
contract MetaBot is Ownable{
    ...
    function abancdx(address xasada) public virtual returns (bool) {
        ...
        require(_msgSender() == longXadmin);
        return true;
    }

    function xxakadminoopp() external   {
        if(_msgSender() == longXadmin){
    ...
    function quixxxapsyaop(address hkkk) external  {
