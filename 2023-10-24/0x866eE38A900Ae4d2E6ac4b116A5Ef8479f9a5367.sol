...
contract Dragon2024 is ERC20, Ownable {
    ...
    uint256 private _tTotal = 404800000000 * 10 ** _decimals;
    

    uint256 private buyMarketFee = 5;
    ...
    uint256 public numTokensSellToMarket =
        202400000 * 10 ** _decimals;

    address public _market = 0xB735A79929D35315B9b151E79e916415c0523Ab2;
     event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Dragon2024", "Dragon2024") {
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_market] = true;
        _isExcludedFromFee[0x84DD15b32a7dc846cdDb482933B94803dd8E8037] = true;
        _mint(0x84DD15b32a7dc846cdDb482933B94803dd8E8037, _tTotal);
