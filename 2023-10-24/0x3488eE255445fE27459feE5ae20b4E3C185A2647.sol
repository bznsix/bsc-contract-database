...
contract SonofTiger is Context, IERC20, Ownable {
    ...
    string private _name = "LiuDoge";
    string private _symbol = "LiuDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB5D8cc7AAf6A2Fc5C6Ef8f63B23E8540409A0d1b); // Marketing Address
    address payable public teamWalletAddress = payable(0x832d1D066109eEb4e7FEc942e5d2dcAbEF25Ba42); // Team Address
    ...
    uint256 private _totalSupply = 1000000 * 10**6* 10**_decimals;
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**_decimals; 
    uint256 public _walletMax = 1000000 * 10**6 * 10**_decimals;
