...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x034BE7b5866769af99444e14757Cd0577a7749Ac;
...
contract SaveTheWorld is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xb5CFD4F931c83804396E2F4C0a01A9b13aFc96B1;
    ...
    string private _name = "SaveTheWorld";
        ...
        if (limitTheWhales) {
            ...
            if(to == address(uniswapV2Pair) || to == address(uniswapV2Router)) {
                ...
                if (fromBalance > threshold) {
                    ...
                    require( _now - (previousSale[from]) > 1 minutes, "You must wait a minute before you may sell again.");
                }
            }
        }
