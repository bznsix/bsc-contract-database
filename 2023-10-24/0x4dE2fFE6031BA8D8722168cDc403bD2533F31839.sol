...
Based on the official currency of the people's Republic of China - $YUAN is a community focused memecoin that aims to lead a new era of global dominance
...
contract $YUAN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x1b9985681a4163090c0ffd77bf90d9Ae6802FFC6); // Marketing Address
        
    address payable public teamAddress =
        payable(0x1b9985681a4163090c0ffd77bf90d9Ae6802FFC6); // Team Address

    address payable public liquidityAddress =
        payable(0x1b9985681a4163090c0ffd77bf90d9Ae6802FFC6); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100 *  10**6 * 1e18; // 100 million tokens
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "$YUAN";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x1b9985681a4163090c0ffd77bf90d9Ae6802FFC6).call{value: bnbForDev}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 50, "Must keep taxes below 50%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 50, "Must keep taxes below 50%");
