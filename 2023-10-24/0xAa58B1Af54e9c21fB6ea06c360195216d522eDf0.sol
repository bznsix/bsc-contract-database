/**
   LOW TAX:4/4
   (MOON）
   TG GROUP：https://t.me/BNBLONGMOON
   */
...
contract BNBLONG is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0xCefde4DBcb04A2Cb310995dEc349859c111aa870);
    address payable public BurnedWalletAddress =
        payable(0xf642722C0AeCB5f683747dee016AD4435D4B00ec);
    ...
    uint256 private minimumTokensBeforeSwap = 4 * 1**_decimals;
