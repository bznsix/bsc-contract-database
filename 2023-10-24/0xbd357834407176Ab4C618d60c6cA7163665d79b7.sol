//Telegram: https://t.me/BOOLISHBSCPORTAL
...
contract SCAMREUMNANO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SCAMREUMNANO";
    string private _symbol = unicode"$SCMRNN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x732716d68CCe52597a63c8C4B13aBf16B6dF4FE7);
    address payable private taxWallet2 = payable(0x732716d68CCe52597a63c8C4B13aBf16B6dF4FE7);
    ...
    uint256 public _totalTaxIfBuying = 10; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 10; // Initially 10% Dropped to 5% After Launch
