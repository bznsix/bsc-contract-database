...
/**Light Token warmly welcomes crypto enthusiasts to experience its revolutionary platform. 
With lightning-fast charting tools and the "Ape-Safe Score" feature, it invites users to navigate the crypto landscape with confidence,
ensuring both efficiency and security during the exciting crypto bull run.
Total Supply: 600,000
Tax:9/9 utility,development,marketing
Renounce
Lock Liquidity
Initial LP: .2bnb liquidity
LIGHT CHART UTILITY! ! !
Telegram: https://t.me/LightUtilityProject
Twitter: https://twitter.com/Lightproj
Website: TBA
*/
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eF59770EB6dbB9Eb6f15952a450af809905369f ;
...
contract LightUtility is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600000 * 10**9;
    uint256 public _maxTxAmount = 600000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT =  100* 10**9; //
    string private constant _name = "Light Utility Project"; // 
    string private constant _symbol = "$LIGHT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x54386735aa6194e93b686D2DA306ce62110A7d07);
