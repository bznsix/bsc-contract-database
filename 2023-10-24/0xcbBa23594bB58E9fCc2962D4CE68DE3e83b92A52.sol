/*
* MELONMUSK, taking you to the MOON in a HEALTHY fashion! Who doesn't love melons?
* MELONMUSK (MELONMUSK) -> Renouncing Ownership + Burning Liquidity
* Tokenomics: 10% Burn (9% Back to the Liquidity Pool, 1% Redistributed to Holders)
* 
* Total Supply: 10 Billion
* Max Hold: 100 Million (1% of Total Supply)
*/
...
contract MelonMusk is Context, IBEP20, Ownable {
    ...
    string private _name = 'MelonMusk';
    string private _symbol = 'MELONMUSK';
