...
contract BTTG is IERC20, Ownable {
    ...
    address public fund1Address = address(0x1dd9402fd1FB40E61814908559945dF44A1B186c);
    
    address public fund2Address = address(0x1dd9402fd1FB40E61814908559945dF44A1B186c);
    ...
    constructor(address tokenOwner) {
        ...
        _mintTotal = 189000000 * 10**_decimals;
    ...
    function _tokenOlnyTransfer(
        ...
        if (_isExcludedFromFee[recipient] || _isExcludedFromFee[sender]) {
            ...
            _rOwned[recipient] = _rOwned[recipient].add(rAmount.div(100).mul(99));
