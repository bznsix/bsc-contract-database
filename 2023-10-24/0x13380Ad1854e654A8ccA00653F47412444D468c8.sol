...
// LINK GROUP: https://t.me/SpookyPepeChannel
...
contract SpookyPepe is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SPOOKYPEPE";
    string private constant _symbol = unicode"$SPKYP";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 31000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x63B5Cae22AB66D3b100354742b9543f384708cb6);
    address payable public MarketingWallet = payable(0x50A068c3BE94983906F8f174734E435f04D3E7A8);
    ...
    function removeMax() external onlyAddress {
