...
contract ETSDAO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " etsdao";
    string private _symbol = "ETS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x9b5054cFC8D014FB0d83b2f4488d77197C3f6249);
