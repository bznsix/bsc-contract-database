...
//Telegram: https://t.me/halloweenbep20
...
contract hallbnb is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Halloween bnb";
    string private _symbol = unicode"$Hbnb";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xfd3D579A7a30920565505A08A25fa9638973F535);
    address payable private taxWallet2 = payable(0xfd3D579A7a30920565505A08A25fa9638973F535);
    ...
    uint256 public _buyMarketingFees = 7;
    ...
    uint256 public _marketingShares = 14;
    uint256 public _developmentShares = 0;

    uint256 public _totalTaxIfBuying = 7; // Initially 10% Dropped to 5% After Launch
    uint256 public _totalTaxIfSelling = 7; // Initially 10% Dropped to 5% After Launch
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*1000000/10000000; 
