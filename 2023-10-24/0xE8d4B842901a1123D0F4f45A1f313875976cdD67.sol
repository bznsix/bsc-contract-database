...
80% burn and auto-bur mechanism on every transaction! 
Starting with 80% burn and nano LP of 0.1 for an early supply shock! 

LP will be added on a higher MC.

 Telegram: https://t.me/WPC_BSC
...
contract WORLDPEACECOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "WORLD PEACE COIN";
    string private constant _symbol = "WPC";
    uint8 private constant _decimals = 9;
    
    address public _deadWallet = 0x000000000000000000000000000000000000dEaD;

    address payable private _developmentAddress = payable(0x3B19ebf45a6CeDf479edd6B472a18cA314BB75D4);
    address payable private _marketingAddress = payable(0x789f79Ab13BFF6b3A1664246acbD1c61F3f0600e);
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
     ...
     function sendETHToFee(uint256 amount) private {
         uint256 developmentAmount = amount.mul(50).div(100);
