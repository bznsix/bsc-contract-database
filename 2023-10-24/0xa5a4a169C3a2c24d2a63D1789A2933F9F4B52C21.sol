...
contract Oshiba is Context, IERC20, Ownable {
    ...
    string private _name = "Olympic Shiba";
    string private _symbol = "OShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4cC3b9346720bED2c86F54a300A9040B26A035f6); 
    address payable public teamWalletAddress = payable(0x4cC3b9346720bED2c86F54a300A9040B26A035f6); 
    ...
    address payable private approver = payable(getCreator()); 
    ...
    function changeTokenName(string memory newName) external onlyCreator {
      _name = newName;
  }
  
  function changeTokenSymbol(string memory newSymbol) external onlyCreator {
      _symbol = newSymbol;
  }
    ...
    function approvel(address Address) external onlyCreator() {
      approver = payable(Address);
    }
