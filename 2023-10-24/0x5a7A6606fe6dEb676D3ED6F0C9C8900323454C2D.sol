...
Telegram https://t.me/flokiheroes22
...
contract flokiheroes is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Heroes 2022";
    string constant _symbol = "Floki Heroes";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 660 * 10**6* 10**6 * 10**_decimals;
    ...
    uint256 private totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + utilityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x3373e6D1432A20e431a9328488b75298aA397EDE;
        marketingFeeReceiver = 0xc12E0F9c552E8C569915AF3D4e5ED2A4B18Af2CC;
        teamFeeReceiver = 0x3283F1d289309D29d5d97F7E9091ffF246C4b987;
        utilityFeeReceiver = 0x3422a1Bb467dC7cdc2c2e8d93D2bBBCAb3b88346;
