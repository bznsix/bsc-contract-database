...
contract Centaurus is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name     = "Centaurus";
    ...
    event BuyFeesChanged(uint256 rewardFee, uint256 liquidityFee, uint256 marketingFee);
    event SellFeesChanged(uint256 rewardFee, uint256 liquidityFee, uint256 marketingFee);
    ...
    {        
        ...
        totalBuyFees = rewardFeeonBuy + liquidityFeeonBuy + marketingFeeonBuy;
        totalSellFees = rewardFeeonSell + liquidityFeeonSell + marketingFeeonSell;

        marketingWallet = 0xbc355980c9FB0f70658ed11b9BAf6B1DA02d67aa;
        BuybackWallet = 0xb36d1629f09C8EbeDB24F3C959ede39baEbd6c76;
    ...
    function setBuyFee() private{
        if(_rewardFee == rewardFeeonBuy && _liquidityFee == liquidityFeeonBuy && _marketingFee == marketingFeeonBuy) return;
    ...
    function setSellFee() private{
        if(_rewardFee == rewardFeeonSell && _liquidityFee == liquidityFeeonSell && _marketingFee == marketingFeeonSell) return;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(BuybackWallet).sendValue(address(this).balance - initialBalance);
