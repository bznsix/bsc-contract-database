...
Introducing Joe Coin - $JOE to the Binance Smart Chain Network

JOE is famous for being the one & only yellow M&M.  And now is a global meme going viral on social media!

$JOE on Ethereum network just hit a 6 million dollar market cap. So naturally, our team will promote our BSC token to members of the ETH community.  
Since we have also been stealth marketing the ETH version since it was a bite-sized 38k market cap; we believe this can be the next "Pepe."  

Networking is key in De-Fi. Partnership anyone? Bring it on!! 

The ETH side Launched less then 48 hours ago. The communities behind this new memecoin do NOT seem to be slowing down anytime soon...

$JOE on BSC will fully support and follow in the success of $JOE on ETH. 

With a supportive and bullish community working together, any market cap is achievable!

Come rock the Binance Smart Chain Network with us. 
...
将 Joe Coin - $JOE 引入币安智能链网络

JOE 因其唯一的黄色 M&M 而闻名。现在，全球模因在社交媒体上疯传！

以太坊网络上的 $JOE 市值刚刚达到 600 万美元。因此，我们的团队自然会向 ETH 社区的成员推广我们的 BSC 代币。
因为我们也一直在秘密营销 ETH 版本，因为它的市值只有 38k；我们相信这可能是下一个“佩佩”。

网络是 De-Fi 的关键。有人合伙吗？来吧！！

ETH 方在不到 48 小时前启动。这个新模因币背后的社区似乎不会很快放缓......

BSC 上的 $JOE 将全力支持并追随 ETH 上 $JOE 的成功。

通过支持和看涨的社区的共同努力，任何市值都是可以实现的！
...
contract JOE is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Joe Coin";
    string constant _symbol = unicode"JOE";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 15, // development fee in %
            Marketing: 15, // Marketing fee in %
            lp: 1, // lp rate in %
            toSwap: 31 // Marketing + dev + lp
        });

    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 25, // development fee in %
            Marketing: 25, // Marketing fee in %
            lp: 1, // lp rate in %
            toSwap: 51 // Marketing + dev + lp
        });
