...
contract PIKACHU20 is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xDD0cE5c7B18945A420C3bc2363F5d28B551f6f60);

    string public _name = "PIKACHU 2.0";
    string public _symbol = "$PIKACHU";
