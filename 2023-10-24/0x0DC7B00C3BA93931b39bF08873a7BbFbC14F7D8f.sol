...
contract lazymintFactoryV2 is AccessControl {
    ...
    address public admin = 0x771B0DA7066777a93cf6e0b0d1eAB4d35F3bF4E1; //change in mainnet
...
contract NFTWMistery is AccessControl, ERC721URIStorage, ERC2981, ReentrancyGuard {
    ...
    constructor(
        ...
        admin = _admin;
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
        _setupRole(DEFAULT_ADMIN_ROLE, 0x4833D87BEb4D738E58fcDa786964d0061b3BaB56);
    ...
    function burnMyNFT(address burner, uint256 _tokenid) public nonReentrant returns(uint256) {
        require(!paused, "is paused");
        require(hasRole(MINTER_ROLE, msg.sender), "caller is not a minter");
        require(ownerOf(_tokenid) == burner, "not your NFT");
        _burn(_tokenid);
