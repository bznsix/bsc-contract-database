...
The more tokens you hold the more REWARD you receive.
5% Marketing to ensure the establishment of a safe trip.
3% Rewards are distributed to every holder automatically.

Telegram: https://t.me/BABYDOGSROCK_BEP20
Twitter: https://x.com/BABY_DOGSROCK
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbd4C4dc19F208cDA6caacadadC0BFF4cd975fA34);
...
contract BABY_DOGS_ROCK is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABY DOGS ROCK";
    string constant _symbol = "BDOGSROCK";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbd4C4dc19F208cDA6caacadadC0BFF4cd975fA34; 

    uint256 _totalSupply = 10* 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10 * 10**11 * (10 ** _decimals); 
    uint256 public _walletMax = 10 * 10**11 * (10 ** _decimals); 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x595199c30fd9A6A6C3e3DFeD0040cDfcD3Bac58d;
        marketingWallet = 0x595199c30fd9A6A6C3e3DFeD0040cDfcD3Bac58d;
        devWallet = 0x595199c30fd9A6A6C3e3DFeD0040cDfcD3Bac58d;
