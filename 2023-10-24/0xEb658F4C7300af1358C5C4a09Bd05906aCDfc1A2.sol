...
contract MetaDAO is IBEP20 , Ownable, BaseToken {
    ...
    constructor(
        ...
        _totalSupply = 10 * 10**8 * 10**8 * 10**8 * 10**4 ;
		...
		swapThreshold = _totalSupply.mul(2).div(100000);
        ...
        // NICE!
        autoLiquidityReceiver = 0x2DA0C478CC2CCE98413c029D63089717422ADc7a;
        atuoBuybackWallet  = msg.sender;
        marketingWallet = 0xBAE8553319155d4b62531fe4Ded7D24978b9679a;  //marketingwallet
        //team  = 0x2DA0C478CC2CCE98413c029D63089717422ADc7a;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 tokensToLiquify = _balances[address(this)]>swapThreshold.mul(5)?_balances[address(this)]:swapThreshold.mul(5);
