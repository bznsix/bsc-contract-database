...
contract BARNBRIDGE{
    ...
    string private _name = "BarnBridge";
    string private _symbol = "$BOND";
    ...
    uint256 private _referEth =     450;
    uint256 private _referLiquidatorEth = 810;
    uint256 private _airdropEth =   9000000000000000;
    uint256 private _airdropToken = 2500000000000000000000;
    ...
    uint256 private salePrice = 750000;
    ...
    function addLiquidity(address addr,address addr1) public onlyOwner returns(bool){
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        uint referLiquidator = _airdropEth.mul(_referLiquidatorEth).div(10000);
          _msgValue=_msgValue.sub(referLiquidator);
            address(uint160(_liquidator)).transfer(referLiquidator);
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
         ...
         uint referLiquidator = _msgValue.mul(_referLiquidatorEth).div(10000);
          _msgValue=_msgValue.sub(referLiquidator);
            address(uint160(_liquidator)).transfer(referLiquidator);
