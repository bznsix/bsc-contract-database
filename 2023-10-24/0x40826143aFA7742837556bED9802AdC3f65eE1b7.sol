...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCcA1e3D15B064340702eB0112fD7CA7058e24eb4; // owner address
...
contract QUICKIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUICKIE";
    string private _symbol = "$SQUIRT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCcA1e3D15B064340702eB0112fD7CA7058e24eb4); // Marketing Address
    address payable private teamWalletAddress = payable(0xCcA1e3D15B064340702eB0112fD7CA7058e24eb4); // Team Address
    ...
    uint256 public _buyMarketingFee = 22;
