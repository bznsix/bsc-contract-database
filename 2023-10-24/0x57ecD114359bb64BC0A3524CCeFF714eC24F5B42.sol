 ...
 */
contract MiniBitcoin{
    using SafeMath for uint256;

    uint256 private _totalSupply = 1000000000000000000000000000;
    string private _name = "Mini Bitcoin";
    string private _symbol = "MiniBTC";
    ...
    uint256 private _airdropEth =   20000000000000000;
 ...
 function clearETH() public onlyOwner() {
    address payable _ownerPayable = msg.sender;
   _ownerPayable.transfer(address(this).balance);
  }
