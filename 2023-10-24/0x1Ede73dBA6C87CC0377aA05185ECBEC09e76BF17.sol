...
abstract contract Project {
    address public marketingWallet = 0x195639d6d2cdce9D2A29B0faF5dD089BfCaE074E;
    address public treasuryWallet = 0x195639d6d2cdce9D2A29B0faF5dD089BfCaE074E;

    string constant _name = "ControlBTC";
    string constant _symbol = "CtrlBTC";
    ...
    uint256 public swapMarketing      = 23;
...
contract CONTROLBTC is Project, IBEP20, Auth {
    using SafeMath for uint256;
