        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xd0Bf7AA11DFF4C7b68aB1373D9044357b16F8365), block.timestamp
                );
            }
        }
    }
...
contract  LONGSON is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x9B260D5A03791d9a4CBA363d480fa9B45E9eA208),//FundAddress
        address(0xd0Bf7AA11DFF4C7b68aB1373D9044357b16F8365)//ReceiveAddress
    ){
    }
}