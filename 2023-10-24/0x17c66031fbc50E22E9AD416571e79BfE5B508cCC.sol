...
interface UniCryptUtilityLockerBEP20 {
...
contract UniCryptUtilityLockerV4 {

  string private _name; 
   event TokensLocked(address indexed sender, uint256 amount);
     address public owner;
      UniCryptUtilityLockerBEP20 customtoken;
    ...
    function withdrawCustomToken(address _address) public isOwner {
        customtoken = UniCryptUtilityLockerBEP20(_address);
