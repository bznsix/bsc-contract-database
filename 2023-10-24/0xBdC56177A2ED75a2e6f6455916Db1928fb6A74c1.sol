/**
Telegram: https://t.me/EtherSync
Website: https://ethersync.tech/
Twitter: https://twitter.com/EtherSyncOFC
*/
...
contract EtherSync is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EtherSync";
    string private _symbol = "ETS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB5185c2F915986939730C86137447f9B79887641); // Marketing Address
    address payable public teamWalletAddress = payable(0xB5185c2F915986939730C86137447f9B79887641); // Team Address
    ...
    uint256 public _teamShare = 20;

    uint256 public _totalTaxIfBuying = 15;
    uint256 public _totalTaxIfSelling = 30;
    uint256 public _totalDistributionShares = 45;

    uint256 private _totalSupply =  100000000 * 10**_decimals;
    uint256 public _maxTxAmount =   2000000 * 10**_decimals;     
    uint256 public _walletMax =     2000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 10000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
