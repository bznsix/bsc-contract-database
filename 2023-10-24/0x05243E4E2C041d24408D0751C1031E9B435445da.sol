...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    uint256 _distributorGas = 1000000 ;
    uint256 public _minPeriod ;
    uint256 public _lpDiv;

    constructor(){
            address admin = 0x6Df593dEF0fd04f2cDF10889118a0B96723Ca04F;
         ...
         //   _tOwned[address(this)] = 1600000000* (10**uint256(_decimals));
    ...
    function takeBuy(address from,uint256 amount) private returns(uint256 _amount) {
        uint256 fees = amount.mul(2500).div(10000);
    ...
    function process(uint256 gas) private {
        if( (block.timestamp-_startTimeForSwap)/_minPeriod< lastClaimTime||theDayMint[getC()]== getMintNum()||(block.timestamp-_startTimeForSwap)<=3600 ){
            return;
        }
