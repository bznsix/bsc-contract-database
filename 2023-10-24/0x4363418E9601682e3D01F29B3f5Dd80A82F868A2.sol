...
*/
contract CONETCOIN is Ownable, Stakeable,Stakeable_wo{
  ...
  */
  function _mint(address account, uint256 amount) internal {
    ...
    require(account != address(0), "CONETCOIN: cannot mint to zero address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "CONETCOIN: cannot burn from zero address");
    require(_balances[account] >= amount, "CONETCOIN: Cannot burn more than the account owns");
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "CONETCOIN: transfer from zero address");
    require(recipient != address(0), "CONETCOIN: transfer to zero address");
    require(_balances[sender] >= amount, "CONETCOIN: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "CONETCOIN: approve cannot be done from zero address");
      require(spender != address(0), "CONETCOIN: approve cannot be to zero address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, "CONETCOIN: You cannot spend that much on this account");
      // Transfer first
...
/**
    ...
    *
    ...
    function stake(uint256 _amount,uint256 _from,uint256 _rate) public {
      ...
      require(_amount < _balances[msg.sender], "CONETCOIN: Cannot stake more than you own");
...
/**
    ...
    *
    ...
    function holdAddress(address hld_address,uint256 _amount) public onlyOwner returns(bool)   {
      // Make sure staker actually is good for it
      require(hld_address != address(0), "CONETCOIN: cannot hold to zero address");
      // Set the allowance of the spender address at the Owner mapping over accounts to the amount
      require(_amount < _balances[hld_address], "CONETCOIN: Cannot stake more than you own");
