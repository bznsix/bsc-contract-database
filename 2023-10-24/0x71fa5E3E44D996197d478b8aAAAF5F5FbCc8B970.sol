...
contract SCAMREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ScamreumBecauseSafereum";
    string private _symbol = "$SCMRM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x732716d68CCe52597a63c8C4B13aBf16B6dF4FE7); // Marketing Address
    address payable public teamWalletAddress = payable(0x732716d68CCe52597a63c8C4B13aBf16B6dF4FE7); // Team Address
