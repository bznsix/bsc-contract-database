...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbE52549Cb410B537AEedDDCf1b4679a9A198B752;
...
contract XDswap is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7e6919a6E77d07D6c63ECdcFC535714b19102C76;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "XDswap";
    string private _symbol = "XDT";
