/**
Cheems-1 Satellite |BSC
Cheems-1 Satellite Token where holders will earn passive Income in our Token Just by holding! Based on Hypes! Missed out Doge1 satellite ? We're here to give you the 2nd Chance to bring you to the moon with us

Supply : 1 Quadrillion
Liquidity 96% (Pancakeswap v2)
CEX:4%

NO PRESALE - NO TEAM TOKENS - 2% TAX(trending,marketing,calls)- NO BULLSHIT
TG: https://t.me/cheems1satellitebsc
*/
...
contract CHEEMS1SATELLITE is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHEEMS-1 SATELLITE"; // 
    string private constant _symbol = "CHEEMSLITE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6AFc8360B3E6b0400d742604011685c9F5A01556;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xd4F5f5822cacE11F211766134ac0F4410743Efc2;
