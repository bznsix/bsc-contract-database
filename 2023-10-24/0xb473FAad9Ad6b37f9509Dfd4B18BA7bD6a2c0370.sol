...
/**
   ...
   Welcome to COIN BOMB
   
   This is a community token. If you want to create a telegram I suggest to name it to @COINBOMBBSC
   ...
   I will renounce the ownership to burn addresses to transfer #COINBOMB to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #COINBOMB 10000X? 
   ...
   it's the best part of the #COINBOMB idea, increasing the liquidity pool automatically, 
...
contract COINBOMB is Context, IERC20, Ownable {
    ...
    string private _name = "COINBOMB";
    string private _symbol = "COINBOMB";
