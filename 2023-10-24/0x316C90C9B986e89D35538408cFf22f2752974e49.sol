...
contract TokenContract is ERC20,  ERC20Burnable, ERC20Pausable, Ownable {
  ...
  string public constant symbol = "INVI";
  string public constant name = "INVITREE";
  uint8  public constant decimals = 18;
  uint256 constant TOTAL_SUPPLY = 300000000;
    ...
    function transfer(address _to, uint256 _value)  public returns (bool success) {
        require(!addresslock[msg.sender]);
        return super.transfer(_to, _value);
    }

    // transfer tokens from one address to another
    function transferFrom(address _from, address _to, uint256 _value)  public returns (bool success) {
        require(!addresslock[_from]);
