        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xc654F4f052e98Fb759d42c35D7B75C9d31677830), block.timestamp
                );
            }
        }
    }
...
contract long is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        8000,//Supply
        address(0xf5E46120C3A957789a1b3e86F6992dBa2b608AE0),//FundAddress
        address(0xc654F4f052e98Fb759d42c35D7B75C9d31677830)//ReceiveAddress
    ){
    }
}