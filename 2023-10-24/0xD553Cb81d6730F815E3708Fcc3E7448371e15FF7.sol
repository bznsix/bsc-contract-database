...
contract Cryptostrich_USDT {
    address usdt = 0x55d398326f99059fF775485246999027B3197955; 
    uint256 public EGGS_TO_HATCH_1MINERS=950400;
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x6e18d6FBC0Fc0Aa9efe1ec5EEb062Afb3F512fDa);
    }
    function hatchEggs(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]]=SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed,9));
    ...
    function devFee(uint256 amount) public pure returns(uint256){
        return SafeMath.div(SafeMath.mul(amount,9),100);
    }
    function seedMarket(uint256 amount) public {
        ERC20(usdt).transferFrom(address(msg.sender), address(this), amount);
        require(marketEggs==0);
        initialized=true;
        marketEggs=95040000000;
    }
