...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 1400;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xf9e31a847C72828165Ce29C666AF6FC75687F12D), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xCA5f71E963cF60d2c0379E94C22E2B6D72e8432C),//FundAddress
        address(0x4e95E6C1AE0617EA5Ec641F4e3f2b62B2F2e0599)//ReceiveAddress
    ){
    }
}