...
// TG : https://t.me/harryfatterbsc
// X : https://twitter.com/harryfatterbsc
// WEBSITE : https://harryfatterbsc.online/
...
contract HARRYFATTER is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x59dd2dfC764ed501c97432766a03f9d7eC79FC8D);
    address payable private _twdmkt = payable(0x71299115d5b3b8FF6eD0B7bdA895E11f347D0806);
    
    string private constant _name = "HARRY FATTER";
    string private constant _symbol = "HRYFTR";
