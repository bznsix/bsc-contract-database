...
contract SSX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 210_000_000_000 * 10 ** _decimals;
    string private constant _name = "SSX";
    string private constant _symbol = "SSX";
