...
interface MetaproReferral {
    ...
    function setMyReferral(address _referred) external;
...
contract MetaproReferralV2 is Ownable {
    ...
    SpacePadReferral public referral;
    ...
    constructor(address _referralAddress) {
        referral = SpacePadReferral(_referralAddress);
    }
    ...
    function saveReferralDeposit(
        ...
        address mainReferrer = referral.getReferral(_referrer);
    ...
    {
        (uplineReferrer, level1, level2, level3) = referral
            .getReferralStructure(_refferal);
        return (uplineReferrer, level1, level2, level3);
    }
    ...
    function setReferralProviderAddress(
        address _referralAddress
    ) external onlyOwner {
        referral = SpacePadReferral(_referralAddress);
    }
