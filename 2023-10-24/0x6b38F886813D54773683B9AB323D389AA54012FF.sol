...
contract USAG is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x7972337E685C47bcdb8A43fE04f88932616c4A26);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0xa3Dd8a6E9cFbbC0f816e5E5c6Ed4E90E625869EC;
    ...
    string private _name = "America Greed";
    string private _symbol = "USAG";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 444111444111444 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 1110278610279 * 10**_decimals;
