...
/* Token contract */
contract AkinuInu2_0 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1a2FE8EEC9758ecd1BE7B56cd894DEf4A3047E3E;
    ...
    // Name and symbol
    string constant _name = "Akinu INU 2.0";
    string constant _symbol = "AKI2.0";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 2% or 2M tokens
