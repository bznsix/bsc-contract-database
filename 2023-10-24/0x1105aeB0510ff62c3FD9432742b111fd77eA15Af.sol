...
/* Token contract */
contract CatPrince is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe2e39520830509F4ee2Da324CE64f5A46321ed21;
    ...
    // Name and symbol
    string constant _name = "Cheems Cat";
    string constant _symbol = "CHEEMSCAT";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 1b 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 4% 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 4% 
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 4% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe2e39520830509F4ee2Da324CE64f5A46321ed21;
