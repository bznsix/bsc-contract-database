...
contract WDCTOKEN is Ownable {
    uint256 tokenamount = 1000*10**decimals();
    address public WDC200;
    ...
    string private _tokenname = "WDCion";
    string private _tokensymbol = "WDC2.0";
