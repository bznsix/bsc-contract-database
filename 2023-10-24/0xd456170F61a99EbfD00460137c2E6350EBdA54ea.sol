...
contract LONGPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x63bf7E1490B329dC551723a0F454EC073cf91643); 
    address payable public Wallet_Dev = payable(0x63bf7E1490B329dC551723a0F454EC073cf91643);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**1* 10**1 * 10**_decimals;
    string private constant _name = "LONG PEPE"; 
    string private constant _symbol = unicode"LONG PEPE"; 
    ...
    constructor () {
        _owner =0x63bf7E1490B329dC551723a0F454EC073cf91643;
