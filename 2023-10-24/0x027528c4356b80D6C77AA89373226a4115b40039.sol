...
/* Asterisk Chain first launch on Binance Smart Chain

Asterisk Chain PoA Private Blockchain 
Launch October 2023

https://t.me/asteriskchain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62Ffab7f1dAdB0E199C3613E8f88122eF0121622; // AsteriskChain Dev Wallet
...
contract AsteriskChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Asterisk Chain";
    string private _symbol = "AST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62Ffab7f1dAdB0E199C3613E8f88122eF0121622); // Dev and Marketing Address
    address payable public teamWalletAddress = payable(0xC38bA78CAEf0BE4aA4dDf3B7921586F86e04B132); // Team Address
