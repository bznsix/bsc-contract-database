...
/**
   ...
   Welcome to COINMASTER
   
   This is a community token. If you want to create a telegram I suggest to name it to @COINMASTERBSC
   ...
   I will renounce the ownership to burn addresses to transfer #COINMASTER to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #COINMASTER 10000X? 
   ...
   it's the best part of the #COINMASTER idea, increasing the liquidity pool automatically, 
