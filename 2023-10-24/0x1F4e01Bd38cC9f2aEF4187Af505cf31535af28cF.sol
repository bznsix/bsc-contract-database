...
// https://cakebot.net
// https://t.me/cakebotcryptocommunity
// https://x.com/cakebotcrypto      

// Lightning fast, snipe & swap, trading bot. Submit your trades 10x faster and get an edge on the market with our free to use trading bot, available now on BSC.
// Trading bot LIVE NOW: https://t.me/CakeBotTelegramBot
...
contract CakeBot is IERC20, Ownable {
    ...
    constructor(
        ...
        require(
            taxFeeBps_ + liquidityFeeBps_ + marketingFeeBps_ <= MAX_FEE,
    ...
    function _transfer(
        ...
        require(from == owner() || tradingEnabled, "Trading not yet enabled!");
