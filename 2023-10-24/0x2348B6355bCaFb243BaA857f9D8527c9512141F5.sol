// Telegram: https://t.me/bullmoneybsc
// Telegram: https://t.me/bullmoneybsc
// Telegram: https://t.me/bullmoneybsc
...
contract BullMoney is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BULLMONEY";
    ...
    uint256 public _tax_On_Buy = 5; //Tax cannot be set to more than 30
    uint256 public _tax_On_Sell = 5; //Tax cannot be set to more than 30
    uint256 public _maxTxAmount = _tTotal * 4 / 100;
    uint256 public _maxWalletToken = _tTotal * 4 / 100;

    address payable public DevWallet = payable(0xcd5DF56850980261E2Ef60b7d967952F1caec6e2);
    address payable public MarketingWallet = payable(0x33A2DCaf9bb520ad22dC9fED97bB0004078F359d);
    ...
    function openTrade() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function setNewTaxes(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
        _tax_On_Sell = selltax;
    }
    function removeTaxes() external onlyAddress {
        _tax_On_Buy = 0;
        _tax_On_Sell = 0;
    }
    function changeTxLimit() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function changeWalletLimit(uint256 _amount) external onlyAddress {
    ...
    function setIsExcludedFromFee(uint256 value, address adr) onlyAddress public virtual {
