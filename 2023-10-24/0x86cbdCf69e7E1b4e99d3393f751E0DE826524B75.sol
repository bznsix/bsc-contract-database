...
Website     : https://oxva.network
Telegram    : https://t.me/oxvanetwork
Twitter     : https://twitter.com/OxvaNetwork
Docs        : https://docs.oxva.network
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5FB01597a5e27b299f5f0D0Ba3B054B3ff3A4C84;
...
contract Oxva is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Oxva_Dev = payable(0x29e087aBa5d12bB9E07E6B0Dbdfb732c98e2a53A);
    ...
    string private _name = "Oxva Coin"; 
    string private _symbol = "OVA";  
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Oxva_Dev] = true;
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            require((heldTokens + amount) <= _maxWalletToken,"You are trying to buy too many token. You have reached the limit for one wallet.");}
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Oxva_Dev,contractBNB);
    }
