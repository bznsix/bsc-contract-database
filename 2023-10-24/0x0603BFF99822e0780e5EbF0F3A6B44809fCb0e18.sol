...
contract HappyTrain is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Happy Train";
    string private constant _symbol = unicode"HTR";
