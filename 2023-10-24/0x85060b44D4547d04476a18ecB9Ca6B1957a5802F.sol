/**
   ...
   Welcome to SHIBAVAULT
   
   This is a community token. If you want to create a telegram I suggest to name it to @SHIBAVAULTBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SHIBAVAULT to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SHIBAVAULT 10000X? 
   ...
   it's the best part of the #SHIBAVAULT idea, increasing the liquidity pool automatically, 
...
contract SHIBAVAULT is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAVAULT";
    string private _symbol = "SV";
