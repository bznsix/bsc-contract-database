...
contract GTFUTU is ERC20, AccessControl, SupportToken {
    constructor() ERC20("GTFUTU", "GTF") {
    ...
    function _beforeTokenTransfer(
        ...
        require(enableTransfer, "ERC20: can not transfer right now");
        ...
        if (checkInvestment && from != address(0)) {
...
abstract contract SupportToken is AccessControl {
    bytes32 public constant SET_BOT_ROLE = keccak256("SET_BOT_ROLE");
    bytes32 public constant SET_BLACKLIST_ROLE =
        keccak256("SET_BLACKLIST_ROLE");
    ...
    bool public checkInvestment = true;
    ...
    function setEnableWhiteListBot(bool _result) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, msg.sender) ||
                hasRole(SET_BOT_ROLE, msg.sender),
            "not have permission"
        );
	...
	*/
    function setCheckInvestment(bool _result) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "not have permission");
        checkInvestment = _result;
    }
	...
	*/
    function setBlackListWallet(address[] memory _address, bool result) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, msg.sender) ||
                hasRole(SET_BLACKLIST_ROLE, msg.sender),
            "not have permission"
        );
