...
contract NXC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NXC";
    string private constant _symbol = unicode"NXC";
    ...
    function setO() external onlyOwner {
        o = !o;
    }
