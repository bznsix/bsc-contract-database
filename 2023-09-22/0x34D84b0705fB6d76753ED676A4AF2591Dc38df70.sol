...
contract IclickInueStore is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    IERC20 private token;

    // Operations
    address private constant systemOps = 0x47eD0bA5a611198ed6A71Ea924596349f437Eb26;
    ...
    function makePayment(uint _amount) public {
        ...
        require(
            token.transferFrom(msg.sender, systemOps, _amount),
            "TransferFailed"
        );
