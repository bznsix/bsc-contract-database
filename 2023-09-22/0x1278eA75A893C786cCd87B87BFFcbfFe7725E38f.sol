...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  5000000 * 10** Decimals;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"XMoonShot",//Name
        unicode"XMoonShot",//Symbol
        9,//Decimals
        5000000,//Supply
        address(0xDE63b5CC3f650d15cE821e50DD15d196FD332802),//FundAddress
        address(0xDE63b5CC3f650d15cE821e50DD15d196FD332802)//ReceiveAddress
    ){
    }
}