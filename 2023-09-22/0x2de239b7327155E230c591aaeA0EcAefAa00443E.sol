...
contract AderloMetaversePremiumClub is ERC721Enumerable, ERC2981, Ownable {
    using Strings for uint256;

    constructor() ERC721("Aderlo Metaverse PREMIUM Club", "AMPC") Ownable() {
        // _mintConsecutive(msg.sender, 100);
        _setDefaultRoyalty(msg.sender, 700);
        for (uint256 i = 1; i <= 100; i++) {
            _mint(0x0c13e4eA3E2fbb26E386BCdfd3FcbDfeEc607A8c, i);
        }
    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://xvrm.parlour.construction/ampc/";
    }
