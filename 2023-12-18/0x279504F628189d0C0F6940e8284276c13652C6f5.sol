...
contract BTCH is Context, IERC20, IERC20Metadata {
    ...
    function setFees(uint8 buy_fee_, uint8 sell_fee_) public onlyOwner {                
        buy_fee  = buy_fee_;
        sell_fee = sell_fee_; 
    }
