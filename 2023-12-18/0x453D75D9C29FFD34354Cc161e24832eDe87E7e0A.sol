...
contract KingGrokXToken is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWallet =
        payable(0xE4363F4dd0A6571D4baEb08ae35937727b1AF149);
    ...
    string public constant name = "King Grok X";
    string public constant symbol = "KingGrokX";
    ...
    function setTransferFee(uint256 _transferFee) external onlyOwner {
        require(_transferFee <= 0, "Sell Fee cannot be more than 5%");
