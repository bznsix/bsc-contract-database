...
//anti-snipe for first 50 blocks after launch
...
contract CICCA  is ERC20, Ownable {
    uint256 public maxTransactionAmount;
    uint256 public maxWallet;

    address public marketingWallet = 0xb943A3AecC79103fEaFc0573Ea978916cFd5d547;
    ...
    constructor() ERC20("Cicca Defi Network", "CICCA") {
        ...
        swapTokensAtAmount = 1 * 1e4 * (10**18);
   ...
   // once enabled, can never be turned off
    ...
    function _transfer(
        ...
        // anti-snipe logic
        if (to != uniswapV2Pair && to != address(uniswapV2Router) && !whitelisted[to]) {
         
            require(block.number >= (launchedAt + 50), "Bot detected!!");
            emit BoughtEarly(to);
        }
