...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public airDropNumbs = 6; //自动空投数量
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 1 / 100;
            if (burnAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xE79AC6Eca3fFe30fA1E65D1BF8164B85D72d4B1b;
...
contract JBP is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE79AC6Eca3fFe30fA1E65D1BF8164B85D72d4B1b),
