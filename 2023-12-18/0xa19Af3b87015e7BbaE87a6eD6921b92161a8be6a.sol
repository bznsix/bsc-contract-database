/**
    TELEGRAM : https://t.me/XBlue_token
    WEBSITE : https://xbluetoken.io
*/
...
contract xBLUE is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 100000000000 * 10**_decimals; //
    uint256 public maxBuyAmount = 100000000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 100000000000 * 10**_decimals; //

    address public marketingAddress = 0xEcb5AB6Fb76A7391550a1045f136f52031908083; //
    address public devAddress = 0xEcb5AB6Fb76A7391550a1045f136f52031908083; //

    string private constant _name = "xBLUE"; //
    string private constant _symbol = "xBLUE"; //
    ...
    Taxes public sellTaxes = Taxes(5,0,4,1); //
