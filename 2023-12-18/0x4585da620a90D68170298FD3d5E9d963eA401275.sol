...
contract BabyOptimusX  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x1bdFD5cA193fa2535bBeD2770388f23D3c14fAeA;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Optimus X";
    string private _symbol = "BOPX";
