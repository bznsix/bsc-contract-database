...
//--- Contract v3 ---//
contract GrokLovers is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xc64C6684650D64441cB5E681e3c48d27AB2352c5); // build: 0xccc9Eb205e6227E1f3e0feD504c9b693177Cc3b0
    address payable private devWallet = payable(0x80A259B38C389Aa0008E887c0Eb3138384460f54); // build: 0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok Lovers";
    string constant private _symbol = "GrokLo";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function changeFees(uint256 _buyfee, uint256 _sellfee) external onlyOwner {
            require(_buyfee  <= 20, "Buy fees exceed maximum limit");
            require(_sellfee <= 20, "Sell fees exceed maximum limit");
