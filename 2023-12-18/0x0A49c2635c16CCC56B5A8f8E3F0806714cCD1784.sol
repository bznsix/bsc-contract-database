...
contract PEPEXMAS is Context, IERC20, Ownable {
    
    string private constant _name = "Christmas pepe";
    string private constant _symbol = "PEPEXMAS";
    uint256 private constant _totalSupply = 1_000_000_000_000_000 * 10**18;
    uint256 public minSwap = 400_000_000_000 * 10**18;
    uint8 private constant _decimals = 18;

    IUniswapV2Router02 immutable uniswapV2Router;
    address immutable uniswapV2Pair;
    address immutable WETH;
    address payable public marketingWallet = payable(0x97F4E579b76F0AFd3746687272C3AA92e3eB6Ddd);
