...
/*
FIND US. YOU WILL HAVE TO SEARCH DEEP, BUT ONCE YOU FIND US, YOUR IN!

WELCOME TO UNLOCKED. WHERE WE DONT BELIEVE IN LOCKS!
*/
...
contract UNLOCKED is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UNLOCKED";
    string constant _symbol = "UNLOCKED";
