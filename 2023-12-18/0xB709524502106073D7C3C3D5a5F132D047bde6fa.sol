...
contract DIGITWEBCOIN is Context, IERC20 {   

    using SafeMath for uint256;
    using Address for address;
   
    // Contract Wallets
    address private _owner = payable(0xdF989166397AF3e6878986b346f368B3A15b75aE);
    ...
    // Token Info
    string private  _name = "DIGITWEBCOIN";
    string private  _symbol = "DIGIT";
    uint256 private _decimals = 18;
    uint256 private _tTotal = 1_000_000 * 10**_decimals;
    uint256 private _iTotal = 1_000_000 * 10**_decimals;
    ...
    uint256 private max_Hold = _iTotal;
    uint256 private max_Tran = _iTotal;
    ...
    function Token_Information() external view returns(address Owner_Wallet,
        ...
        string memory Creator = "https://digitwebcoin.org";
    ...
    address payable public constant feeCollector = payable(0xdF989166397AF3e6878986b346f368B3A15b75aE);
    ...
    function Contract_SetUp_4__Set_Limits(
        ...
        // Buyer protection - Transaction limit must be greater than 0.1% of initial supply
        require(Max_Tokens_Per_Transaction >= _iTotal / 1000 / 10**_decimals, "E03"); // Must be greater than 0.1% of initial supply

        // Buyer protection - Wallet limit must be greater than 0.5% of initial supply
        require(Max_Total_Tokens_Per_Wallet >= _iTotal / 200 / 10**_decimals, "E04"); // Must be greater than 0.5% of initial supply
