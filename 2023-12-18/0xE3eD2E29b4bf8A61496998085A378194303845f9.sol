...
contract OC is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0x25ce589ca0DD72D14F4F684FcD4f2DC729429783;

    uint256 public swapTokensAtAmount;  
    bool    public swapWithLimit;
    bool    private swapping;
    uint256 public maxBuyAmount = 20001 * 10**18; //
    ...
    constructor () ERC20("OCAI", "OC") 
    {   
        address newOwner = 0x73CB595175b92A311542a1B8f0774551B00F67A2;
    ...
    function enableTrading(uint256 Amount) public onlyOwner {
    ...
    function setSellFee(uint256 _sellFee) external onlyOwner {
        ...
        sellFee = _sellFee;
        walletToWalletTransferFee = _sellFee;
