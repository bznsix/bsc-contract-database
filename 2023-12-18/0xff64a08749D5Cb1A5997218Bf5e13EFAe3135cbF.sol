// https://t.me/TrollXbsc
// https://x.com/TrollXProject?t=q2lriHtRzGiiQmTI0fXHZA&s=09
// https://www.trollxproject.com/
...
contract TrollX is ERC20, Ownable {
    ...
    constructor () ERC20("Troll X", "TROLL")
    {  
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0xE80C12C7A91ec7d7604aCa53449bFDA9db4aEf0e;
