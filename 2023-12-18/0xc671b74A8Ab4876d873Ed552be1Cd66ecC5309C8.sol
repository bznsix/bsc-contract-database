/* The dog's day has passed, it's time for the $HEMULE cat takeover 🐱

🟫 Low taxes 3/3
🟫 LP locked
🟫 Renounced ownership

The beloved family cat of vitalik buterin $HEMULE is live on BSC, trade now on pancakeswap!

Contract: 
Website: hemulebsc.fun
Telegram: @HemuleBSC
X: x.com/@HemulE_BSC */
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B1BEB7cA98bB25Ae889C64E8410F16abb3C7a8e; // owner address
...
contract HEMULE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x76439c3982284Df6b0f0E1f2fD9fD6810EB79Fdf); 
    address payable public teamWalletAddress = payable(0x76439c3982284Df6b0f0E1f2fD9fD6810EB79Fdf);
