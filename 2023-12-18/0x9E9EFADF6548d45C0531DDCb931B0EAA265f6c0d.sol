...
contract SNOWBALL is Context, IERC20, Ownable {
    ...
    string private constant _name = "SNOWBALL";
    string private constant _symbol = "$SNOWBALL";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xE4CfbAAFAdD97159580675382d2DA7804A13c29C);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xE4CfbAAFAdD97159580675382d2DA7804A13c29C] = true;
