/**
 TELEGRAM :https://t.me/voltadex
 WEBSITE  :https://www.voltadex.net
*/
...
contract Voltadex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "VOLTADEX";
    string private _symbol = "$VOLT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xb1422aB55Bedf3D7d4406441bDC7073E69dAfF9D);
