 ...
 * 
  ...
  *——————————————————
  *
  * Description: 🎅❄️ Welcome to GrokXmas Family, where our token supply is like Santa's gifts – abundant, but with a twist! 🌨☃️ 
  * Website: https://linktr.ee/grokxmas
  * Twitter: https://x.com/grokxmas?s=21&t=YETYVYEtdhtK4d6ecF3j4Q
  * Telegram: https://t.me/GrokXmas_Official
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="GrokXmas";
    string private _symbol="GXM";
    ...
    uint public marketingFeeonBuy=10;
    ...
    address public marketingWallet=0xC6ec527BFf942B9aFeff2008231d8BEa88839dc4;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=100000000000000000000000000;
    uint256 public maxTransactionAmountSell=100000000000000000000000000;

    uint256 public maxWalletAmount=100000000000000000000000000;
    ...
    uint256 public swapTokensAtAmount=1000000000000000000000;
