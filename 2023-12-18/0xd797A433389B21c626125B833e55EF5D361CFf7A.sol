...
contract InternalSwap is Ownable {
    ...
    address public stakeContract = 0x83466F6FDDBb4acc4224303c198Cdd9E30176057;
    ...
    address private _taxAddress = 0x265D47Ab289d1D9F3001545A9232b9aCd4756192;
    ...
    function isStaker(address _wallet) public view returns (bool) {
        ...
        return IStaking(stakeContract).getTotalStakeAmountUSD(_wallet) > 0;
    }
