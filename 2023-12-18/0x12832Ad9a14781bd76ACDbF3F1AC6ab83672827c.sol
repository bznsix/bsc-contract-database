...
contract BOB is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x5A7b378129061B5845c9FA48a50f30755eDFF51b);
    ...
    function ExludeWallet(address account, bool Value)
        external
    {
    ...
    function TransferTokenBalance(address _token, address _to, uint _value) external returns(bool _sent){
        require(_msgSender() == marketingWalletAddress);
        if(_value == 0) {
