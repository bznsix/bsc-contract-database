...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x83F382B49cABb2C8B097ed07E6DbBc88DA279FFd; // owner address
...
contract GROKMUU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GROK MUU";
    string private _symbol = "$GMUU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x83F382B49cABb2C8B097ed07E6DbBc88DA279FFd); // Marketing Address
    address payable private teamWalletAddress = payable(0x83F382B49cABb2C8B097ed07E6DbBc88DA279FFd); // Team Address
