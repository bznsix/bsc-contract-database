...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public buy_burnFee = 50;
    uint256 public sell_burnFee = 50;
    ...
    uint256 public freeRemoveTime = 2 * 30 * 24 * 60 * 60;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundAmount > 0){
            uint256 half_fund = fundAmount * 2 / 5;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                try _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xA984bd47F2863d147193C0ceef7B7b1D2619977B), block.timestamp
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000000000000,
        address(0xA420b2Bc6c170ab7afc2E03B59d7066089573e7A),
        address(0xFB151DCF985998C9A28dAB329923D137e84FA380),
        address(0x34b40aDda64C992c1e7072b026cF20839b13beD7) //receiver
    ){
    }
}