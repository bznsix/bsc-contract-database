...
/**
   ...
   ╚██████╗██║ ╚████║   ██║          ██║   ╚██████╔╝██║  ██╗███████╗██║ ╚████║
    ...
    Confinamento Token Launch 11/01 AT 15UTC 
    
    Confinamento Token (CNT/WBNB)
    ...
    50x and 120x Previous
    Contest and Competitions incoming

    ✅Website: https://confinamento-token.com/
    ✅Telegram: https://t.me/ConfinamentoTokenOficial
    ✅Twitter: https://twitter.com/Confinamentoken
    ✅Instagram: https://www.instagram.com/confinamentotoken/



    @dev https://t.me/HenriqueLA
...
contract CONFINAMENTOTOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("CONFINAMENTO TOKEN", "CNT") {
        ...
        buyFees.burn            = 0;
        buyFees.marketing       = 2500;

        totalBuyFees            = buyFees.burn + buyFees.marketing;

        sellFees.burn           = 0;
        sellFees.marketing      = 2500;
        ...
        projectWallets.marketingWallet = 0x4B441b91F88011007043d1E3D3766d73dd47Af81;
        projectWallets.developmentWallet1 = 0x065e066DEa9137551823EB11852cD656aacC421C;
        projectWallets.developmentWallet2 = 0x1b3EB1C6703bF4792802983Fb436069afE59bAf3;
        projectWallets.developmentWallet3 = 0x219c75Cfe4472a697D68A45F7365A721cF4a031e;
