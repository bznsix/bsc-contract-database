...
https://twitter.com/InuCoq

https://medium.com/@inucoq

https://github.com/coqinu

https://t.me/coqinubnb
...
contract COQ is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 69_420_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = _tTotal / 5_000;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = address(0xE1413a0B95BD3f3A7154C17Ad6C046D8a276425e);

    string private constant _name = "COQ INU";
    ...
    Taxes public taxes = Taxes(5, 5); // 5% reflection 5% marketing
