...
//--- Contract v3 ---//
contract Cosmic is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x6a8eeB619DC72a6943Ca01fe325805F7e9f34485);
    


//--- v3 Allocations by Freddy analytixaudit.com ---//
    uint256 private buyAllocation = 42;
    uint256 private sellAllocation = 42;
    uint256 private liquidityAllocation = 16;


    IRouter02 public swapRouter;
    string constant private _name = "Cosmic";
    string constant private _symbol = "CSC";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0xdff8612Fd7E9B47e53A5AF3956CacA1c9d230390;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 70) / 100;
        balance[0xc07844F2Cb78b5Cfe6d2f35C02A8d80ca3F0Ce92] = (_totalSupply * 20) / 100;
        balance[0x2E85375A162Ac0f109b1D10F643999681481f911] = (_totalSupply * 10) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 70) / 100);
        emit Transfer(address(0), 0xc07844F2Cb78b5Cfe6d2f35C02A8d80ca3F0Ce92, (_totalSupply * 20) / 100);
        emit Transfer(address(0), 0x2E85375A162Ac0f109b1D10F643999681481f911, (_totalSupply * 10) / 100);
