// File: contracts/WAGORA.sol

// File @openzeppelin/contracts/utils/math/SafeMath.sol@v4.4.2

// OpenZeppelin Contracts v4.4.1 (utils/math/SafeMath.sol)

// Genesis, Wrapped AGORA, Genesis and any affiliated abbreviations or names including but not limited to Genesis, WAGORA, AGORA, and so on are not in any form the sale of a security 
...
// Genesis (AGORA) is strictly for use within the Genesis ecosystem and is not an investment in a company or companies management.
// Genesis (AGORA) has managers but has no owner and is decentralized.
...
// purchasing Genesis(AGORA). It is the users own duediligence to know if they are in a restricted territory or region and Genesis (AGORA), Genesis, and any of their
// affiliated names or abbreviations are not responsible for any unlawful actions or misrepresentations.
// Genesis (AGORA), Genesis, and any of their affiliated names or abbreviations or services are not responsible for any loss of funds or digital assets due to
// any of it's services or technologies as they are published as is. 
// Whomever purchases Genesis (AGORA) or any digital assets on the Genesis platform has undeniably agreed to these terms and conditions and cannot subject
// Genesis, Genesis, AGORA (or any affiliated name or abbreviation) to any wrong doings or unlawful practices.
...
// to be viewed as such. There is no liability or expectations of profits or losses when purchasing Genesis (AGORA) or its affiliated tokens Wrapped AGORA (WAGORA).
// When purchasing Genesis (AGORA) you fully and undeniably agree to the terms set forth that Genesis and any affiliated names, services, or abbreviations such as AGORA, WAGORA,
// and Genesis but not limited to just those are not an investment of money, funds, or assets in a company, individual, management team. 
// Any participating party in purchasing Genesis (AGORA) or Wrapped AGORA (WAGORA) also fully and undeniably agrees to all of the above terms and conditions.
...
// SPDX-License-Identifier: MIT
 ...
 contract GenesisPresale is OwnerWithdrawable {
     using SafeMath for uint256;
