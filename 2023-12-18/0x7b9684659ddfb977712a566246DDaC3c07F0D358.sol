...
contract FairplayFactory is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
        ...
        if (isExclude(from) || isExclude(to)){
            ...
            if (from == pair && pancakeBuyFeeRate > 0){
                ...
                if (pancakeSellFeeBurnRate > 0){
                    ...
                    super._transfer(from,address(1),burn);
                }
                uint256 income = fee - burn;
                if(income > 0){
                    super._transfer(from,pancakeFeeReceiver,income);
                }
                amount -= fee;
