...
contract Grok is ERC20 {
    ...
    address public  _lockAddress = address(0x000000000000000000000000000000000000dEaD);
    ...
    address public marketAddr = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    constructor(address tokenOwner) ERC20("Grok", "Grok") {
    ...
    function _splithToken() private {
        ...
        for(uint256 i=0;i<num;i++){
            ...
            if(user != _destroyAddress &&_lockAddress != user){
