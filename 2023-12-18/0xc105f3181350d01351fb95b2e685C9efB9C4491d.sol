...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc9B8b95CaDfE0D105Bf73e445CBb0a45C8f6217e; // owner address
...
contract ZUZU is Context, IERC20, Ownable {
    ...
    string private _name = "ZuZu";
    string private _symbol = "ZuZu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc9B8b95CaDfE0D105Bf73e445CBb0a45C8f6217e); // Marketing Address
    address payable private teamWalletAddress = payable(0xc9B8b95CaDfE0D105Bf73e445CBb0a45C8f6217e); // Team Address
