...
//   IBEP20 RWRD = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
  ...
  function deposit() external payable override onlyToken {
    ...
    uint256 amount = IWBNB(WBNB).balanceOf(address(this)).sub(balanceBefore);
  ...
  function distributeDividend(address shareholder) internal {
    ...
    if (amount > 0) {
      ...
      IWBNB(WBNB).transfer(shareholder, amount);
...
contract HerToken is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "Her Token";
  string constant _symbol = "HER";
  ...
  uint256 public swapMultiplier = 400;
  ...
  uint256 public _maxTxAmount = rSupply.div(1000).mul(100);
  uint256 public _maxWalletToken = rSupply.div(1000).mul(100);
