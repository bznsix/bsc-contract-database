...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x667973F7F13E9c512EAc3DB30151c91b7fA8809d; // owner address
...
contract DEDETHEGROKKILLER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEDE THE GROK KILLER";
    string private _symbol = "DTGK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x667973F7F13E9c512EAc3DB30151c91b7fA8809d); // Marketing Address
    address payable private teamWalletAddress = payable(0x667973F7F13E9c512EAc3DB30151c91b7fA8809d); // Team Address
