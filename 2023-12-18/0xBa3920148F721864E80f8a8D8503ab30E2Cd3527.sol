...
contract TerAppCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TerApp";
    string private _symbol = "TERAPP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78a972277f039324159c80ec3C4D6EbED14170e4); // Marketing Address
    address payable public teamWalletAddress = payable(0x78a972277f039324159c80ec3C4D6EbED14170e4); // Team Address
