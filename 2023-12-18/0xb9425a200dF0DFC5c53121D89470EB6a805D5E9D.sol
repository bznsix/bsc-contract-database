/**
Introducing LUMA is a small star-shaped species that gives Mario additional powers. Luma also has the ability to change the shape of various objects in the galaxy.
https://t.me/LUMABSC_Announcement
*/
...
contract LUMA is ERC20, Ownable {
    IRouter public uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "LUMA";
    string private constant _symbol = "LUMA";
    ...
    // taxes
    CustomTax private _fees = CustomTax(2,2,6,6);
    ...
    constructor() ERC20(_name, _symbol) {
        marketingWallet = 0x338c114c2310491637C5E79494D2bA4A45549C8F;
