/**
    ...
    WELCOME TO Apolo COMMUNITY! Now you are a member of the next x500 gem!
    ...
    https://twitter.com/projeto_apolo
    https://instagram.com/apolo.projeto
    https://t.me/projetoapologlobal
...
contract ApoloProjeto is ERC20, Ownable2Step, ReentrancyGuard {
    ...
    constructor() ERC20("Apolo", "APO") {

        webSite     = "https://projetoapolo.com";
        telegram    = "https://t.me/projetoapologlobal";
        twitter     = "https://twitter.com/projeto_apolo";
        ...
        percent.percent0    = 550;
        percent.percent1    = 170;
        percent.percent2    = 110;

        projectWallets.marketingWallet = 0xddD95063C5c00f3658cFfCa4D7F10240dbABb2E0;
        projectWallets.developmentWallet1 = 0xba833c238608264D5C47d8F14Acf9AD92831cF72;
        projectWallets.developmentWallet2 = 0x37384bcE8198244f27b447D29555363C23AeE6a5;
        projectWallets.developmentWallet3 = 0x286d89e8247adf51A29bC9A7fb14BB6cacca1966;
        ...
        swapTokensAtAmount = 1_000 * (10 ** 18);
    ...
    function sendTokens (
        ...
        for (i; i < addressesLength; i = uncheckedI(i)) { 
            super._transfer(owner(),addresses[i],amountTokens[i]);
