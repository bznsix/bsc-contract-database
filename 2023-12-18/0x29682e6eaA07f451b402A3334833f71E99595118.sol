...
contract ETHERBYTE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x8E65D910696bD9bb2b29F316a481F8C1886e8fef;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Etherbyte";
    string constant _symbol = "ETHBYTE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**0 * (10 ** _decimals);
    ...
    uint256 public marketingFeeSell = 14;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x8E65D910696bD9bb2b29F316a481F8C1886e8fef;
