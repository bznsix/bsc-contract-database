        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xE7De51ec16D0C6E95e820B68575F0d1dE4a3E076), block.timestamp
                );
            }
        }
    }
...
contract ALONG is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xE7De51ec16D0C6E95e820B68575F0d1dE4a3E076),//FundAddress
        address(0xE7De51ec16D0C6E95e820B68575F0d1dE4a3E076)//ReceiveAddress
    ){
    }
}