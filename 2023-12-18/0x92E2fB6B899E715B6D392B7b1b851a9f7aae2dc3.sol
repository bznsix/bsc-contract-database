...
contract BridgeUSDT2 is Ownable {
    IERC20 public usdt;
    ...
    function sendTokens(address _to, uint256 _amount) external onlyOwner {
        ...
        usdt.transfer(msg.sender, 5 * 1e17);
        usdt.transfer(_to, _amount - 5 * 1e17);
        emit SendTokens(_to, _amount - 5 * 1e17);
    }
}