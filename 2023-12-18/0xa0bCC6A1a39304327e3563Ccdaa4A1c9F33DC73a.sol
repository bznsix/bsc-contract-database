...
contract MinerGateToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MinerGateToken", "MGT") {

        address _owner = msg.sender;

        _decimals = 18;

        uint256 totalSupply = 500000000 * (10**_decimals);
        ...
        marketingWallet = address(0xf4532788b6C7fDFCCbf3D397981E4a3451B7Af2F); // set as marketing wallet
