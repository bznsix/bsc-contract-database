...
contract Silverstonks is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1740000000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Silver Stonks";
    string private _symbol = "SSTK";
    ...
    constructor (address treasuryWallet) {
        ...
        IUniswapV2Router02 _pancakeswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ...
        _isWhiteListed[_treasuryWalletAddress] = true;
    ...
    function updateTokenLimit(uint256 newLimit) public onlyOwner() returns (bool) {
    ...
    function addToWhiteList(address safeAddress) external onlyOwner(){
        _isWhiteListed[safeAddress] = true;
    }

    function removeFromWhiteList(address safeAddress) external onlyOwner(){
        _isWhiteListed[safeAddress] = false;
    }
    ...
    function _transfer(
        ...
        // Check for address to be in whitelist
        if(whiteListEnabled){
          require(_isWhiteListed[from] && _isWhiteListed[to], "Address not WhiteListed");
        }
