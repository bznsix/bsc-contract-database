...
contract PAWPATROLINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x512DE9A2c57554DD53F698f835ABf9f4FAD796C8); 
    address payable public Wallet_Dev = payable(0x187587Cc7f76A9F829AcCbfDa66a915F5873EDED);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "PAW PATROL INU"; 
    ...
    constructor () {
        _owner = 0x187587Cc7f76A9F829AcCbfDa66a915F5873EDED;
