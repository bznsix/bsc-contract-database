...
contract DNC is ERC20PresetFixedSupply {
    uint256 constant TOTAL_SUPPLY = 2100000000 * 10 ** 18;
    constructor() ERC20PresetFixedSupply("DNC", "DNC", TOTAL_SUPPLY, msg.sender) {}
}
// SPDX-License-Identifier: MIT
