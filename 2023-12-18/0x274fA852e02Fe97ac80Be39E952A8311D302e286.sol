...
contract PerseidFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Perseid Finance";
    string private constant _symbol = "$PED";
