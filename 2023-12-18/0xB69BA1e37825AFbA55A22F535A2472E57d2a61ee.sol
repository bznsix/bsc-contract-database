/**
Telegram: https://t.me/SantaShiba_Bep20
*/
...
contract SANTASHIBA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SANTA SHIBA";
    string private constant _symbol = "$SANTASHIBA";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xCD2699ea4b6BFFEd61a3ecBcB6bB48ed462d8884);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xc0980AD97C9006ED2069DAbAd152c1959F10a384] = true;
