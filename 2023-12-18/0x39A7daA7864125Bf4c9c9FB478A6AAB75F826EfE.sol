/**
 *Submitted for verification at testnet.bscscan.com on 2023-11-22
*/
...
/**/
    ...
    function a_set_token(IERC20 _USDT,IERC20 _Token,IERC20 _Arb  ) public {
    ...
    function get_price() external view returns(uint256 _price) {
        ...
        _price = (_priceu_a*_pricea_t)/1000000000000000000;
    }
    ...
    function  sir_set_huiliunum(uint256 amount ) public onlyOwner{
        //require(guanli[msg.sender]==1,"no sir");
        huiliu = amount;
    } 
}