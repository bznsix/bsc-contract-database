...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe4dAB18d67c3da3323d25c4B91F91054B26a1029; // owner address
...
contract xogrok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "xogrok";
    string private _symbol = "XGR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe4dAB18d67c3da3323d25c4B91F91054B26a1029); // Marketing Address
    address payable private teamWalletAddress = payable(0xe4dAB18d67c3da3323d25c4B91F91054B26a1029); // Team Address
