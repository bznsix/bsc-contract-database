...
contract RealWorldAssets is Context, IERC20, BlackList {
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0xF5E283C1Ae5A4B4aE377935f4656540088CEb646));
        ruinWalletAddress = payable(address(0xf326f213Aa4f49A9d38C846ce78d0f4Ee9436D8c));
        _name = coinName;
       _symbol = coinSymbol;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, 
            0,
            0x7955Ac728af326ac610A4a9B8dD5560b07488AF7,
            block.timestamp
        );
    }
