...
contract PAYCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "PAYCAT";
    string private constant _symbol = "PCT";
    uint256 private _minSwapTokens = 1e5 * 10**_decimals; 
    uint256 private _maxSwapTokens = 1e6 * 10**_decimals; 
    uint256 public buyTaxes = 2;
    uint256 public sellTaxes = 4; 
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0xB3B37F9E4d5D03Cd3224A3332e1384f62600eb1A);
        _isExcludedFromFee[_msgSender()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[MarketingWallet] = true;
        _isExcludedFromFee[deadWallet] = true;
        _isExcludedFromFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; // BSC PinkSale Lock
        _isExcludedFromFee[0x8a65e7D59093CD5B3727bB800Cb58d7e9Ee0e9a8] = true; // Staking Reward Wallet
        _isExcludedFromFee[0xCEf63143585a0Cd12CBA88c79d607f3E25cbB281] = true; // Dapp Development Wallet
        _isExcludedFromFee[0x36Ea870c3d91A929F7CD1188F4a08D6fd59F6719] = true; // Community Airdrop Wallet
        _isExcludedFromFee[0x7Daf372A861E0524A21742fe38eB40F369ED1806] = true; // Cex Listings Wallet
