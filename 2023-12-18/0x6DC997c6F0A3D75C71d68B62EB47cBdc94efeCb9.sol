...
NEKO BONK The one and only MEME coin for 2023, that allows you to run free with your imagination. 

Twitter : https://twitter.com/NekoBonkCoin
Telegram : https://t.me/NekobonkPortal
...
contract NEKOBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEKO BONK";
    string private _symbol = "$NEBONK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x163e8003aeE081E79664868Ee17D406ed5e6abD4);
    address payable private DevelopmentWalletAddress = payable(0x163e8003aeE081E79664868Ee17D406ed5e6abD4);
