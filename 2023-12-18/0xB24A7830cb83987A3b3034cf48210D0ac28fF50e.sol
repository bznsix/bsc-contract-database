...
contract USRToken is Ownable {
    ...
    uint256 private _totalSupply = 1597925025384398 * 10** 13;
    ...
    event TradeStatus(bool tradeOpen);
    event BurnStatus(bool burnStatus);
