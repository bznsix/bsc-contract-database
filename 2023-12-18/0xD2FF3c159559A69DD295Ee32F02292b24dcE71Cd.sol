...
abstract contract Currency is BurnableTokenWithBounds {
    ...
    bytes32
        private constant DOMAIN_SALT = 0x0000000000000000000000008bb81a4e7f70c2878cf269dfcfa91f3d401c0c93; // Randomly generated salt
    ...
    constructor() {
        DOMAIN_NAME_HASH = keccak256("tXC Token");
 ...
 */
contract tXCToken is CurrencyWithProofOfReserve {
    ...
    function initialize() public {
        ...
        // 2,000,000,000
        _totalSupply += 2_000_000_000_000_000_000_000_000_000;
        _balances[msg.sender] += 2_000_000_000_000_000_000_000_000_000;
        emit Transfer(address(0), msg.sender, 2_000_000_000_000_000_000_000_000_000);
    }
