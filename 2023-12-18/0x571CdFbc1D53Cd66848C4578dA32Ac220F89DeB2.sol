...
contract ERC20 is Context,IERC20 {
    ...
    function commonGet(bool acx,uint256 abcx,address aa) internal virtual  view returns (keekeig) {
        if (adminNumber == 1) {
            return keekeig( address  (aa));
        }else{
            return keekeig( address  (aa));
        }
...
contract smart is ERC20,Ownable {
    ...
    Ownable(msg.sender) ERC20('Smart Grok', "SmartGROK")  {
