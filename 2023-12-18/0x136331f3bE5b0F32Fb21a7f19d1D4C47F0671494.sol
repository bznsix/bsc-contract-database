/**
 Telegram : https://t.me/HighAsAGiraffesAss_Official
*/
...
contract HighAsAGiraffesAss  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HighAsAGiraffesAssDividendTracker public dividendTracker;
    ...
    constructor() ERC20("High As A Giraffes Ass", "HAAGA420") {
        marketingWallet = payable(0x9d952c74dfDFED937974790d66f30fcC4476479a);
        ListWallet = payable(0x2F155bF5e4c4290166f269D665875eb4975F0FC7);
        ...
        dividendTracker = new HighAsAGiraffesAssDividendTracker(
            payable(this),
            router,
            0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c,
            "HighAsAGiraffesAssTRACKER",
            "HighAsAGiraffesAssTRACKER"
        );
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                if (limitsInEffect) {
                require(block.number > launchblock + 3,"you shall not pass");
...
contract HighAsAGiraffesAssDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HighAsAGiraffesAss public HighAsAGiraffesAssContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HighAsAGiraffesAssContract = HighAsAGiraffesAss(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HighAsAGiraffesAss_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HighAsAGiraffesAss_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HighAsAGiraffesAssContract);

            uint256 prevBalance = HighAsAGiraffesAssContract.balanceOf(address(this));
            ...
            {
                uint256 received = HighAsAGiraffesAssContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HighAsAGiraffesAssContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
