...
contract CrachBlack is ReentrancyGuard {
    using SafeERC20 for IERC20;
    address private TokenAddress = 0x3171dB990953f4A96989B1d134fA14d3afbe2900;
    IERC20 public Token;
    ...
    uint256 public MAX_PROFIT_LIMIT = 1 days;
    ...
    constructor() {
        ...
        manager = 0xEFe53A73bEc067424fBDEa131279e414A8AEA8d2;
        adminWallet = 0xa863a86487D993a51e3d96484BFF77Fd20CD3fBc;
        marketingWallet = 0xA8767564e636a8729Ff1D4ae1f335f43bF7AC8E1;

        startDate = 1697112000; //Thu Oct 12 2023 12:00:00 GMT+0000
    }
        ...
        if (ref != address(0)) {
            ...
            for (uint256 i = 0; i < REFERRAL_PERCENTS.length; i++) {
                if (upline != address(0)) {
                    ...
                    garages[upline].tools += (commission / 5);
                    garages[upline].cash += ((commission / 5) * 100);
    ...
    function syncGarage(address user) internal {
        ...
        for (uint256 i = 0; i < MAX_GARAGE_COUNT; i++) {
            if (garages[user].garageBuyAmount[i] > 0) {
                ...
                totalProfit += (profitAmount * duration) / TIME_STEP;
            }
        }
