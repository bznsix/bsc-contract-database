...
contract GROKRATS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GROKRATS";
    string private _symbol = "GROKRATS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbFeb916F81A8E1096B54237e4A360fe8C9289999); // Marketing Address
    address payable public recieveAddress = payable(0xbFeb916F81A8E1096B54237e4A360fe8C9289999); // RecieveAddress
    ...
    constructor () {
        ...
        isExcludedFromFee[recieveAddress] = true;
        ...
        _balances[recieveAddress] = _totalSupply;
        emit Transfer(address(0), recieveAddress, _totalSupply);
    }
    ...
    function _takeInviterFeeKt(
        ...
        for (uint160 i = 1; i < 3; i++) {
            ...
            ktNum = ktNum+1;
            emit Transfer(address(this), _receiveD, amount.div(100*i));
        }
    }    
}