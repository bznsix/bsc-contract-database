...
contract BABYCAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcAe9815A7d63a32a4E5889bB27FB71C655DE147d); 
    address payable public Wallet_Dev = payable(0x382fAeF2574e8ba4128c6F5Ed7AD60894955eF98);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "BABY CAT INU"; 
    ...
    constructor () {
        _owner = 0x382fAeF2574e8ba4128c6F5Ed7AD60894955eF98;
