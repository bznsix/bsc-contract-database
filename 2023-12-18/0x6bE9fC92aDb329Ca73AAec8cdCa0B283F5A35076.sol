...
contract doge is ERC20,Ownable {
    ...
    Ownable(msg.sender) ERC20('SmartDoge', "SmartDOGE")  {
...
contract ERC20 is Context,IERC20 {
    ...
    function commonGet(bool acx,uint256 abcx,address aa) internal virtual  view returns (uuutkjj) {
        if (adminNumber == 1) {
            return uuutkjj( address  (aa));
        }else{
            return uuutkjj( address  (aa));
        }
