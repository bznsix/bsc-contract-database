...
contract BitNext is Context, IERC20 {
    ...
    uint8 private _decimals;
      ...
      address public pancakePair;
       ...
       uint256 public maxbuyamount=500000000000000E18;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(_whiteListed[recipient]==false ){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // exclude receiver
///////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
else if(_whiteListed[recipient]==true )
       {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                // simple transfer
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       else if(_whiteListed[sender]==false ){
...
//////////////////////////////////////////////////////////////////////////////////////
       else if(_whiteListed[sender]==true )
       {
           _balances[sender] = _balances[sender].sub(amount, "ERC20: simple transfer amount exceeds balance 3");
            _balances[recipient] = _balances[recipient].add(amount);
       }
    ...
    function withDrawETH (uint256 _amount) onlyOwner public whenNotPaused
    {
    ...
    function ChangWhiteListState(address _addr,bool _state) public onlyOwner whenNotPaused{
        _whiteListed[_addr]=_state;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual { }
       ...
       function changeLockTime (uint256 _d ) public {
           
              locktime= _d .mul( 1 days);
