/**
      GROK OPTIMUS ( $GROP )      
 WEBSITE : https://grokoptimus.tech
 CHANNEL : t.me/GrokOptimusChannel
 CHAT    : t.me/GrokOptimusChat
 TWITTER : https://twitter.com/Grok_Optimus
 MEDIUM  : https://medium.com/@grokoptimus
 LINKTREE: https://link.tree/@grokoptimus
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x4b38d67e22537f2ca7BDeF49947d4b509584FFe0; // owner address
...
contract GROKOPTIMUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GROK OPTIMUS";
    string private _symbol = "GROP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x282B4bB98cfc56200589D3B96d9705dF3A67117d); 
    address payable public teamWalletAddress = payable(0x4b38d67e22537f2ca7BDeF49947d4b509584FFe0);
    ...
    uint256 private minimumTokensBeforeSwap = 200000000000 * 10**3; 
