...
contract PTSToken is IBEP20, ReentrancyGuard {
    using SafeMath for uint256;
    address _owner;

    string constant _name = 'PTSToken';
    string constant _symbol = 'PTS';
    ...
    address private immutable _feeowner = 0x0000000000000000000000000000000000000000; // Marketing Address
