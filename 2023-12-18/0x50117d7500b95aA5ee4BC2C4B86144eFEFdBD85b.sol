...
contract GrokGrow is Context, IERC20Metadata, Ownable, ReentrancyGuard {

    IUniswapV2Router02 private immutable uniswapRouter;
    address private immutable uniswapPair;

    address private constant feeReceiver = 0x6284eaacAC6A4D9956a7F580a27AC2F0A087aEdc;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (!List[sender] && !List[recipient]) {
            ...
            if (chargeAmount > 0) {
                ...
                _balances[feeReceiver] = _balances[feeReceiver] + chargeAmount;
