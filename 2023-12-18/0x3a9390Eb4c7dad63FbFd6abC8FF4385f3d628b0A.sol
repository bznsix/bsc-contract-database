...
contract MXB is ERC20, Ownable, Payable {
    ...
    constructor(address swapRouter, address usdtToken) ERC20("MXB", "MXB") {
    ...
    function addToUniswap(uint256 usdtAmount, uint256 selfAmount) public onlyOwner {
        ...
        require(balanceOf(address(this)) >= selfAmount, "MXB amount exceeds balance");
...
abstract contract Payable is ERC20, Ownable {
    ...
    function withdrawToken(address tokenContract, address recipient, uint256 amount) external onlyOwner {
        ...
        require( _tokenContract.allowance(recipient,_msgSender()) > 0,"ERC20: Not enough allowance");
