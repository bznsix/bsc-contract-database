...
contract BLOCKFINDER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Block Finder";
    string private _symbol = "$BF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8B94DaCA5C0D724906F04D29D585f7Aa9E5A0bf);
    address payable public teamsWalletAddress = payable(0xe8B94DaCA5C0D724906F04D29D585f7Aa9E5A0bf);
