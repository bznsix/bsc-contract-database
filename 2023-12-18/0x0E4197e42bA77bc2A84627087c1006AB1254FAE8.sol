...
//--- Contract v3 ---//
contract BabyGrokX is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xB789E0b260193A26aA00cCEA3d38F5dF75d71269); // build: 0xB789E0b260193A26aA00cCEA3d38F5dF75d71269
    address payable private devWallet = payable(0x8e2E1BB3E9c934640ecAf4B89c32544dC0A8ac9c); // build: 0x8e2E1BB3E9c934640ecAf4B89c32544dC0A8ac9c
    AntiBot private AX;
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "BabyGrok X";
    string constant private _symbol = "BabyGrok X";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x921751cF10b483bd3a2C361Cda7daB6e0F83adC3);
