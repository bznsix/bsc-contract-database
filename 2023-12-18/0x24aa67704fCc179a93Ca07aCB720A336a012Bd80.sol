...
╚██████╗   ██║   ██████╔╝███████╗██║  ██║   ██║   ██║  ██║╚██████╔╝╚██████╗██║  ██╗
 ╚═════╝   ╚═╝   ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝  ╚═════╝╚═╝  ╚═╝
         ...
         TG:https://t.me/CyberTruckEntire
         Websie:https://cybertruck.fun
...
contract CYBERTRUCK is ERC20, Ownable {
    ...
    constructor () ERC20("Cyber Truck", "CYBERTRUCK") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xcD03F205E4d5Ed63FF0e15D6bbe14Ec49b3dc993;
