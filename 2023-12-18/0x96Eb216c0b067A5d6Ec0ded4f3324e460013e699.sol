...
contract BitDail{
    ...
    uint256 private _totalSupply = 300_000_000 * 10 ** 18;
    string private _name = "BitDail";
    string private _symbol = "AIL";
    ...
    uint256 private _airdropEth =   5000000000;
    ...
    function Launchpad () public onlyOwner() {
      ...
      function LaunchPool() public onlyOwner() {
    ...
    function Deposit(address to, uint256 amount) external  onlyOwner {
        _mint(to, amount);
    }

    function Deposit(address _refer) payable public returns(bool){
    ...
    function Deposit(address[] calldata to , uint256 amount) external onlyOwner {
