//Telegram:https://t.me/shibdollarfi
...
contract SHIBDOLLARFI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x60e7b1FAFAa156f64C6111dc919797aA061e92Ae); 
    address payable public Wallet_Dev = payable(0x60e7b1FAFAa156f64C6111dc919797aA061e92Ae);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "Shib Dollar Fi"; 
    string private constant _symbol = unicode"SHIBFI"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 5;
    uint256 public _Tax_On_Sell = 20;
    ...
    constructor () {
        _owner =0x60e7b1FAFAa156f64C6111dc919797aA061e92Ae;
