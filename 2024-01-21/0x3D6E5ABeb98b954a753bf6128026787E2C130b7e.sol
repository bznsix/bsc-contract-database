//TG: https://t.me/babyzuzalubsc
//WEB: https://babyzuzalubsc.xyz
//X: https://twitter.com/BabyZuzaluBsc
...
contract BabyZuzalu is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby Zuzalu";
    string private _symbol   = "BabyZuzalu";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 7e12 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xA864E3b17343ac7005c002cc86f6433B8477C301;
        ...
        _isExcluded[address(0xA864E3b17343ac7005c002cc86f6433B8477C301)] = true; //Marketing
    ...
    function setSellFeePercentages(uint256 _taxFeeonSell, uint256 _liquidityFeeonSell, uint256 _marketingFeeonSell) external onlyOwner {
        ...
        require(totalSellFees <= 30, "Sell fees cannot be greater than 30%");
