...
/*   PIXEL - Make your home in a world of unlimited adventure. Master skills and play with friends. Build new communities.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://buypixel.fun                                       │
 *   │                                                                       │
 *   │                                                                       │
 *   │   Telegram Portal: https://t.me/portal_pixel                          │
 *   │                                                                       │
 *   │                                                                       │
 *   │   E-mail: admin@buypixel.fun                                          │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 */
...
//--- Contract v3 ---//
contract PIXEL is Context, Ownable, IERC20 {
    ...
    uint256 private maxWallet = _totalSupply / 200;
    bool private canSwapFees = true;
    address payable private marketingAddress = payable(address(0xD1079EBB59520D1b8b022F8c5b3443DBBb59FB64));


    IRouter02 public swapRouter;
    string constant private _name = "PIXEL";
    string constant private _symbol = "PIXEL";
    string constant public copyright = "PIXEL";
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            AX = AntiBot(0x92885394556C0beE0d4C4D901C952F3F1CECdDF4);
