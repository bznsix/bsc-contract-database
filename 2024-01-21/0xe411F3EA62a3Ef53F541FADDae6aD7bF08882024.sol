...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xdE54eB5392182ECE53B95F7C6Df5E91D184f12cA);
    address public ownerAddress = address(0xda1F5C083C6F41696654c9310bffBaAa1d421726);
    string private _name = "TangYuan";
    string private _symbol = "TangYuan";
    ...
    uint256 public _buyDeadFee = 50;
    uint256 public _sellFundFee = 1900;
    uint256 public _sellLPFee = 50;
    uint256 public _sellDeadFee = 50;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.timestamp < startTradeTime + 9 && !_swapPairList[to]) {
                    _blackList[to] = true;
                }
                if (_swapPairList[to]) {
                    if (!inSwap) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 marketDiv=7;
        bool swapMarket=_totalMarket%marketDiv==(marketDiv-path.length);
