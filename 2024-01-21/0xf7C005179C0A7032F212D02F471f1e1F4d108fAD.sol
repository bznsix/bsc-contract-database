...
contract TOKENMIX is ERC20, Ownable {
    ...
    constructor () ERC20("TOKEN MIX", "TMX") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingFeeOnBuy  = 99;
        marketingFeeOnSell = 99;

        marketingWallet = 0x0FaFbee6F9Ad015830CA2DD18c89302dbf407DF2;
