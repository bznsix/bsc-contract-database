...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public totalMinted; // total minted tokens from receive callback function
    ...
    constructor (
        ...
        uint256 amountReceiver = 4200000000 * tokenUnit;
    ...
    uint256 public _airdropBNBEachToken = uint256(1 ether) / 21000000;
    ...
    receive() external payable {
        ...
        totalMinted += tokenAmount * tokenUnit;
...
contract BER is AbsToken {
    ...
    //SwapRouter
        ...
        21000000000,
    //Receive，
        address(0x7B5AdF4819cC8c687108Ce79a65AdD649336366C),
    //Market，
        address(0xc62618872fcDc740d2578dFabc642ea962Dd1895)
    ) {
