...
contract BabyKingBonk is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2100000000000000 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x835c18f2B422D6707ABB994E38a0e53A8d600485;

    string private constant _name = "Baby King Bonk";
    string private constant _symbol = "BabyKingBonk";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 3% reflections, 3% marketing
    Taxes public taxes = Taxes(3, 3);
