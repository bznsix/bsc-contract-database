...
// TG: https://t.me/squidwifmoney
// X: https://x.com/squidwifmoney
// Website: https://squidwifmoney.eu
...
// Max: 40,000,000
// Tax: 9% (1% auto burn, 6% marketing wallet, 2% USDT rewards)
...
contract Squidwifmoney is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SquidwifmoneyDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 1; //default cooldown 60s
    ...
    constructor() ERC20("Squidwifmoney", "SWIM") {
        marketingWallet = payable(0x6c81C3138B102D0D887df5285E3f7fb5911a8caC);
        devWallet = payable(0xb37d3d05B520CD5e92Cf4f8386d31f529f511520);
        ...
        dividendTracker = new SquidwifmoneyDividendTracker(
            payable(this),
            router,
            0x55d398326f99059fF775485246999027B3197955,
            "SquidwifmoneyTRACKER",
            "SquidwifmoneyTRACKER"
        );
    ...
    function setcooldowntimer(uint256 value) external onlyOwner {
        require(value <= 3, "cooldown timer cannot exceed 5 minutes");
        cooldowntimer = value;
    }
...
contract SquidwifmoneyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Squidwifmoney public SquidwifmoneyContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SquidwifmoneyContract = Squidwifmoney(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Squidwifmoney_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Squidwifmoney_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Squidwifmoney contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SquidwifmoneyContract);

            uint256 prevBalance = SquidwifmoneyContract.balanceOf(address(this));
            ...
            {
                uint256 received = SquidwifmoneyContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SquidwifmoneyContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
