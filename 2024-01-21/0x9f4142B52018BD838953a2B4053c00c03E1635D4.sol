/*
Infinitum chain is a fast, robust, & secure wallet for the Bitcoin Nano cryptocurrency. Infinitum Wallet has been thoroughly audited by Red4Sec, a security firm with extensive experience with blockchain and cryptocurrency projects

🟢Beta App : https://play.google.com/store/apps/details?id=com.bitcoinnano.infinitum
🟢 Hyped strong name
🟢 Good marketing plan 
🟢 Bullish community 
🟢 Whale community
...
contract infinitumchain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Infinitum Chain";
    ...
    function AirdropToken(address[] calldata addresses) external onlyOwner {
