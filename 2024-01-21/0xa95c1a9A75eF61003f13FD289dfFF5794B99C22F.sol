...
contract HUAHUA is ERC20, Ownable {
    ...
    uint256 public numTokensSellToSwap = 100000 * 10**18;
    ...
    uint256 public transferBurnFee = 3;
    ...
    constructor() ERC20("HuaHua", "HuaHua") {
        ...
        */
        _mint(tokenOwner, 100000000 * 10**18);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private returns(bool){
        ...
        if(_isExcludedFromFees[sender] && _isExcludedFromFees[recipient]) return _basicTransfer(sender, recipient, amount);
