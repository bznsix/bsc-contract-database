...
contract TheNewMetaBonk is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "The New Meta Bonk";
    string private constant _symbol = unicode"Meta Bonk";
