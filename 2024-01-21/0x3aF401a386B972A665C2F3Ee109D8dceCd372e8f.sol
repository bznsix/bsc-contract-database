 ...
 *HIDDEN TROLL, WITH HIDDEN TEAM, HIDDEN MARKETING, PLANS, COMMUNITY
 *BUT THIS COIN NOT TROLL YOU, WE HAVE STRATEGY FOR THIS GEM
*/
...
//--- Contract v3 ---//
contract HiddenTroll is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x13E14bA04753dfCF5420c695a82BF6882F5A104d); // build: 0x13E14bA04753dfCF5420c695a82BF6882F5A104d
    address payable private devWallet = payable(0x22c1D0232078E2222669FCb365e5EA74161C3Cd3); // build: 0x22c1D0232078E2222669FCb365e5EA74161C3Cd3
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "HIDDEN TROLL";
    string constant private _symbol = "HiddenTroll";
