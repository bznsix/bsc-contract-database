...
contract BabyWally is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Wally", "BabyWally") 
    {   
        address router;
        address pinkLock;
        
        if (block.chainid == 56) {
            router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancake Mainnet 
            pinkLock = 0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE; // PinkLock Testnet
        } else if (block.chainid == 97) {
            router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancake Testnet 
            pinkLock = 0x5E5b9bE5fd939c578ABE5800a90C566eeEbA44a5; // PinkLock Testnet
        } else if (block.chainid == 1 || block.chainid == 5) {
            router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap Mainnet 
            pinkLock = 0x71B5759d73262FBb223956913ecF4ecC51057641; // PinkLock Testnet
        } else {
            revert();
        }

        transferOwnership(0x8052aD33d8b6b291c7E3B1Ff4D3901d69AEBE6f9);
    ...
    function creator() public pure returns (string memory) {
        return "www.wallybsc.com";
    }

    function stuckClaimTokens(address token) external onlyOwner {
        require(token != address(this), "Contract's balance of it own tokens");
