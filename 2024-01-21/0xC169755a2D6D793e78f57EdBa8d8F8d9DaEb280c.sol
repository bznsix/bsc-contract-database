...
//--- Contract v3 ---//
contract XPaymentsCEO is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 69_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0xFc97383950839943b6484Bf161839D1dA311c980); // build: 0xccc9Eb205e6227E1f3e0feD504c9b693177Cc3b0
    address payable private devWallet = payable(0xFc97383950839943b6484Bf161839D1dA311c980); // build: 0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "XPayments CEO";
    string constant private _symbol = "XPC";
