...
contract ERC20 is IERC20 {
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        require(!_isBlacklisted[recipient], "To/from address is blacklisted!");
 ...
 */
contract BABYMUSK20 is Context, ERC20, Ownable {
    ...
    constructor () {
      _name = "BABYMUSK 2.0";
      _symbol = "BABYMUSK 2.0";
      _decimals = 18;
      uint256 totalSupply = 420000000000000000000000000;
