...
contract BTXJStaking {
    ...
    uint256 public dailyInterestRate1 = uint256(11000);
    uint256 public dailyInterestRate2 = uint256(12000);
    uint256 public dailyInterestRate3 = uint256(13000);
    ...
    uint256 public referralRewardPool; // 推荐奖励池
	...
	function withdrawReferral(uint256 _amt) public {
		...
		require((ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= _amt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((_amt > uint256(0))){
			ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transfer(msg.sender, _amt);
		}
	}
    ...
    // 计算15天挖矿推荐收益
	function addReferral2(uint256 stakeEarnings) internal returns (uint256) {
		address referringAddress = referralRecordMap[msg.sender].referringAddress;
		address level2Referrer = address(0);
        address level3Referrer = address(0);
        address level4Referrer = address(0);
    ...
    // 计算30天挖矿推荐收益
	function addReferral3(uint256 stakeEarnings) internal returns (uint256) {
		address referringAddress = referralRecordMap[msg.sender].referringAddress;
		address level2Referrer = address(0);
        address level3Referrer = address(0);
        address level4Referrer = address(0);
    ...
    function stake1(uint256 _stakeAmt) public {
		...
		ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transferFrom(msg.sender, address(this), _stakeAmt);
    ...
    function unstake1(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if (((((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))) > uint256(0))){
			ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transfer(msg.sender, (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))));
		}
    ...
    function unstake2(uint256 _unstakeAmt) public {
        ...
        addReferral2(interestToRemove); // 更新推荐奖励
    ...
    function unstake3(uint256 _unstakeAmt) public {
        ...
        addReferral3(interestToRemove); // 更新推荐奖励
    ...
    function withdrawInterestWithoutUnstaking1(uint256 _withdrawalAmt) public {
		...
		require((ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transfer(msg.sender, ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
    ...
    function withdrawInterestWithoutUnstaking2(uint256 _withdrawalAmt) public {
        ...
        addReferral2(_withdrawalAmt); // 更新推荐奖励
    }
    ...
    function withdrawInterestWithoutUnstaking3(uint256 _withdrawalAmt) public {
        ...
        addReferral3(_withdrawalAmt); // 更新推荐奖励
    }
	...
	function principalTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= principalAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((principalAmtInBank > uint256(0))){
			ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transfer(msg.sender, principalAmtInBank);
		}
		principalAmtInBank  = uint256(0);
	}

	function interestTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= interestAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((interestAmtInBank > uint256(0))){
			ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).transfer(msg.sender, interestAmtInBank);
		}
		interestAmtInBank  = uint256(0);
	}

	function withdraw_coin_TokenERC20(uint256 _amount) public onlyOwner {
		require((ERC20(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772).balanceOf(address(this)) >= _amount), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772).transfer(msg.sender, _amount);
	}

    // 允许管理员向 referralRewardPool 充值
    function addFundsToReferralRewardPool(uint256 amount) public onlyOwner {
        require(ERC20(address(0x5387768e2cFB9Bd29bEf2B1679E588324BbF0772)).balanceOf(address(this)) >= amount, "Insufficient balance in contract");
