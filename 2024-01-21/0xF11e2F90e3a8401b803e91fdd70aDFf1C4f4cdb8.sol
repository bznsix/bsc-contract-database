...
contract PEACHY is Context, IERC20, Ownable,ReentrancyGuard {
    ...
    event TaxEnabled(bool);	
        event TaxDisabled(bool);	
    ...
    string public constant name = " PEACHY";
    string public constant symbol = "PEACHY";
    uint8 public constant decimals = 18;
    //Supply Definition.
	//change _tTotal = to the customer supply.
    uint256 private _tTotal = 69_000_000_000 ether;
	//Marketing Wallet Definition, Change wallet to Customer Marketing Wallet.
    address payable public marketingWallet =
        payable(0x0580Fc95d0531E8e45Cfa30b910cB4cc5374540b);
    //Taxes Definition.
    ...
    require(taxStatus != true,"Tax Already enabled.");
     buyFee = 2;
    transferFee = 0;
    sellFee = 2;
    taxStatus = true;
    emit TaxEnabled(true);
    }
    function disableTax () external onlyOwner {
    require(taxStatus != false,"Tax Already disable.");
    buyFee = 0;
    transferFee = 0;
    sellFee = 0;
    taxStatus = false;
    emit TaxDisabled(true);
    }
