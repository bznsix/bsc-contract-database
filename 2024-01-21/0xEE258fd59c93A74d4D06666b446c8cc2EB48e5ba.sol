...
contract MINECRAFT is ERC20, Ownable {
    ...
    constructor () ERC20("TESTMINECRAFT", "TMINECRAFT") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x1641b649965B375d1b78F8465B23C4923bAE2085);
        ...
        feeReceiver = 0xc6268795775262A5E7eDF46c64DaCCA725F4b303;
        ...
        swapTokensAtAmount = 50_000 * (10 ** decimals());
