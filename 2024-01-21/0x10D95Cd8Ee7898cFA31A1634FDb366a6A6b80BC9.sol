...
contract XPayments is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x8EDCbCeA32d7bEb28578a5A2544Abc89aD8C1263);
    address payable private devWallet = payable(0x8EDCbCeA32d7bEb28578a5A2544Abc89aD8C1263);
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "XPayments";
    string constant private _symbol = "XPays";
