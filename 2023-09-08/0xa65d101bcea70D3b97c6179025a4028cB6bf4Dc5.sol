/* 
    ...
    Website : www.sphinxtoken.finance
    Telegram : https://t.me/SphinxTokenBSC

    Tokenomics : tax 5% for buy and sell, 30% tax for liquidity 70% Marketing.
...
contract SphinxTokenBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3cf2f97D7338729Fe2f21a24Ddd5a4b8fB6a6f90); 
    address payable public Wallet_Dev = payable(0x3cf2f97D7338729Fe2f21a24Ddd5a4b8fB6a6f90);
    ...
    string private constant _name = "Sphinx Token"; 
    ...
    constructor () {
        ...
        _owner = 0xd3F3b2d6A5F1B63355Cd0530C8eedb72be2aDDAd;
