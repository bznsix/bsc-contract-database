...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "STMDO";
    string private _symbol = "STMDO";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress =
        payable(0x74009525d54B4D6A1a6C3Cc647B37A71D3201EbA); // Marketing Address
    address payable public teamWalletAddress =
        payable(0xCD52122C046f87Fb07B1764B9bE03f21C6Fb274a); // Team Address
    address payable public businessWalletAddress =
        payable(0x6c64fC2A848d2BE5B072Ae4186041930bB132d7f); // Team Address
    ...
    uint256 private _totalSupply = 99 * 10**21 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 99 * 10**18;
    ...
    constructor() {
        ...
        isExcludedFromFee[businessWalletAddress] = true;
        ...
        isWalletLimitExempt[businessWalletAddress] = true;
        ...
        isTxLimitExempt[businessWalletAddress] = true;
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if (!isTxLimitExempt[sender] && !isTxLimitExempt[recipient]) {
                require(
                    amount <= _totalSupply,
                    "Transfer amount exceeds the totalSupply."
                );
            }
