...
contract COW is ERC20, ERC20Burnable, Ownable, AccessControl {
    ...
    function mint(address receiver, uint256 amount) external onlyMinter returns (bool){
    ...
    function adminBurn(address from, uint256 amount) external onlyBurner {
        _burn(from, amount);
    }
