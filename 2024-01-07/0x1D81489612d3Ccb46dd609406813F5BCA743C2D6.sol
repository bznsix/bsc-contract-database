...
contract Baby_Grok_Girl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Grok Girl";
    string private _symbol = "BGG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x935452b8d3540baB56E846eBce39ED5629b3cC0C);
    address payable private DevelopmentWalletAddress = payable(0x68973967dd6560f385DaBD7D4Cc529A83370C711);
