...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xe9703bE8766a556fc58fD202ABb2C4517FEE8123; // owner address
...
contract  ShenlongShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShenlongShiba";
    string private _symbol = "$SHEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe9703bE8766a556fc58fD202ABb2C4517FEE8123);
    address payable public teamWalletAddress = payable(0xe9703bE8766a556fc58fD202ABb2C4517FEE8123); 
