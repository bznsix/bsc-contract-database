...
contract Burnaby is Context, IERC20, Ownable {
    ...
    string private _name = "Burnaby";
    string private _symbol = "BURNABY";
    ...
    address payable public marketingWallet = payable(0xfB9D7296E5b5dF7F3F560668F33c51EE2fD9AE1c);
    ...
    uint256 public numTokensSellToAddToLiquidity = 200000000 * 10**18;
    uint256 public _maxTxAmount = 200000000 * 10**18;
    uint256 public _maxWalletLimit = 200000000 * 10**18;
    address admin;
    ...
    function setSellFeePercent(uint256 liquidityFee, uint256 marketingFee) public onlyOwner {
        sellLiquidityFee = liquidityFee;
        sellMarketingFee = marketingFee;
    }

    function setBuyFeePercent(uint256 liquidityFee, uint256 marketingFee) public onlyOwner {
