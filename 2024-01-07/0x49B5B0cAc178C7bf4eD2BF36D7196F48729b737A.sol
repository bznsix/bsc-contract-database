...
/**
 * This contract will reward DragonFire to holders. It will also burn DragonFire and itself.
*/
...
contract DragonFireDividends is IDragonFireDividends {
    ...
    constructor() {
        ...
        DragonFire = 0x43F8d9d63241c31d50a5Dd81dDa695B31c9e8501;
    }
...
contract BtcRizz is IERC20, Auth {
    using SafeMath for uint256;

    address public DragonFire = 0x43F8d9d63241c31d50a5Dd81dDa695B31c9e8501; // DragonFire

    string private constant _name = "BtcRizz";
    string private constant _symbol = "BtcRizz";
