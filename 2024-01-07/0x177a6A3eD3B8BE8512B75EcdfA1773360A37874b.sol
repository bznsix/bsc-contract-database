...
Website : https://gokuzilla.tech
Telegram : https://t.me/Gokuzilla
Twitter : https://twitter.com/Gokuzillabsc
...
contract Gokuzila is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goku Zilla";
    string private _symbol = "$GKZL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9663137537A0B498415Ab7dF7A6fef2AfFc3b7F8);
    address payable private DevelopmentWalletAddress = payable(0x9663137537A0B498415Ab7dF7A6fef2AfFc3b7F8);
    ...
    uint256 private _totalSupply = 42060000000 * 10**9;
    uint256 public _maxTxAmount = 42060000000 * 10**9;
    uint256 public _walletMax = 42060000000 * 10**9;
