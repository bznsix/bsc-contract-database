...
contract Groksonic is ERC20, Ownable {
    ...
    uint256 public numTokensSellToMarket = 300000 * 10 ** _decimals;

    address public _market = 0xE556118A77e8d31BFa899102DAc09e8F478A50ed;
    event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Grok sonic", "$Grok sonic") {
