...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9eFF83ab7c2be2F0dB767b87Eb8cb836DC30856a;
...
contract Blockgame is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x9eFF83ab7c2be2F0dB767b87Eb8cb836DC30856a); //add marketing wallet
    ...
    string private _name = "Block Game";  //set name
    string private _symbol = "BLGAME";  // set symbol
    uint8 private _decimals = 9;
    uint256 private _tTotal = 4000000000 * 10 ** decimals(); //total supply 
