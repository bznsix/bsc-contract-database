...
import { Router, IRouter } from "@thirdweb-dev/dynamic-contracts/src/core/Router.sol";
import { IRouterState } from "@thirdweb-dev/dynamic-contracts/src/interface/IRouterState.sol";
import { IRouterStateGetters } from "@thirdweb-dev/dynamic-contracts/src/interface/IRouterStateGetters.sol";
import { BaseRouterStorage } from "@thirdweb-dev/dynamic-contracts/src/lib/BaseRouterStorage.sol";
import { ExtensionManager } from "@thirdweb-dev/dynamic-contracts/src/presets/ExtensionManager.sol";
import { StringSet } from "@thirdweb-dev/dynamic-contracts/src/lib/StringSet.sol";
import "@thirdweb-dev/dynamic-contracts/lib/sstore2/contracts/SSTORE2.sol";
...
//  __                               ____    __                  
// /\ \                             /\  _`\ /\ \                 
// \ \ \      __  __    ___      __ \ \,\L\_\ \ \/'\   __  __    
//  \ \ \  __/\ \/\ \ /' _ `\  /'__`\\/_\__ \\ \ , <  /\ \/\ \   
//   \ \ \L\ \ \ \_\ \/\ \/\ \/\ \L\.\_/\ \L\ \ \ \\`\\ \ \_\ \  
//    \ \____/\ \____/\ \_\ \_\ \__/.\_\ `\____\ \_\ \_\/`____ \ 
//     \/___/  \/___/  \/_/\/_/\/__/\/_/\/_____/\/_/\/_/`/___/> \
//                                                         /\___/
//                                                         \/__/ 
...
//  ==========  Internal imports    ==========
import { BaseRouter, IRouter, IRouterState } from "./BaseRouter.sol";
    ...
    ERC165
{
    ...
    function initialize(
        ...
        _setupPlatformFeeInfo(_platformFeeRecipient, _platformFeeBps, _discountCurrency, _discountBps);
...
library PlatformFeeStorage {
    ...
    struct Data {
        ...
        /// @dev The currency that can have a special platform fee.
        address discountCurrency;
        /// @dev The % of primary sales collected as platform fees if sale is in discountCurrency.
        uint16 discountBps;
    }
...
abstract contract PlatformFee is IPlatformFee {
    ...
    function getPlatformFeeInfo(address _currency) public view override returns (address, uint16) {
        if (_currency == _platformFeeStorage().discountCurrency) {
            return (_platformFeeStorage().platformFeeRecipient, uint16(_platformFeeStorage().discountBps));
        }
     ...
     *  @param _discountCurrency       Address to be set as new discountCurrency.
     *  @param _discountBps            Updated discountBps.
     */
    function setPlatformFeeInfo(address _platformFeeRecipient, uint256 _platformFeeBps, address _discountCurrency, uint256 _discountBps) external override {
    ...
    function _setupPlatformFeeInfo(address _platformFeeRecipient, uint256 _platformFeeBps, address _discountCurrency, uint256 _discountBps) internal {
        ...
        _platformFeeStorage().discountCurrency = _discountCurrency;
        _platformFeeStorage().discountBps = uint16(_discountBps);

        emit PlatformFeeInfoUpdated(_platformFeeRecipient, _platformFeeBps, _discountCurrency, _discountBps);
    }
