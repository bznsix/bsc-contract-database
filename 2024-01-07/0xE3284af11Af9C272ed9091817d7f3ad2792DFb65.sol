...
contract GrokLongX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf442A83c2633C7b1C67384cDE1Ffa26a074AC995); 
    address payable public Wallet_Dev = payable(0xf442A83c2633C7b1C67384cDE1Ffa26a074AC995);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "GrokLongX"; 
    string private constant _symbol = unicode"GrokLongX"; 
    ...
    constructor () {
        _owner =0x780C79d8179a47F319eB3D4334c21bc8AB34eb48;
