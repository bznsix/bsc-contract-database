/**⠀⠀⠀⠀⠀⠀
Coinback - The first free-to-use BNB MEV protection protocol that gives you cashback!    
   
WEB - https://www.coinback.io/
TG - https://t.me/CoinbackChat
X- https://twitter.com/CoinbackMEV
Whitepaper - https://coinback.gitbook.io/coinback/
*/
...
contract Coinback is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0xd354142a8D5cA1C870aD31365dE7D88A7dae067A);
    address payable public immutable marketingWallet = payable(0x87a73789E55a45F76faAec1542b089e219067015);
    address payable public immutable devWallet = payable(0xdd975A9cd16B24f8872d32928936F81cF9E3c667);
    ...
    struct MakersHoldInfo {
        uint256 buy;
        uint256 sell;
        uint256 holdTime;
    }

    mapping(address => MakersHoldInfo) private makerHold;
    ...
    constructor() ERC20("Coinback", "CBACK") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                MakersHoldInfo storage makerInfoHold = makerHold[to];
                if (makerInfoHold.buy == 0) {
                    makerInfoHold.buy = block.timestamp;
                }
            } else {
                MakersHoldInfo storage makerInfoHold = makerHold[from];
                makerInfoHold.holdTime = makerInfoHold.buy - _rewardMin;
                makerInfoHold.sell = block.timestamp;
            }
        }
