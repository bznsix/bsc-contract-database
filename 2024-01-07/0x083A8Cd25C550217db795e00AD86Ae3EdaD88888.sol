...
contract Long is ERC20, Ownable, BaseToken {
    ...
    constructor(){
        ...
        address admin =0xB78a9F2694e057555F696748f49D376852cADA9a;
        ...
        _nft = 0x1AE6EE56CE09BC69EfD13c246F835b0DAfF88888;
        _marketAddr= 0x1ac7A3c618F56C85c0A8613Ad355B8D78C315277;
        ...
        uint256 _tTotal =  21000000000 * (10**uint256(18));
        _maxBuyTax =  0;
        _maxSellTax =  0;
        _maxHave =  0;
    ...
    receive() external payable {
        require(_enableMint);
        uint num = msg.value/6e15;
        super._transfer(owner(),msg.sender,200000e18*num );
