/**
   ...
   TG GROUP：https://t.me/CAISHENLONGMEME
   */
...
contract CaiShenLong is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CaiShenLong";
    string private _symbol = "CaiShenLong";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x0d7Daa24983F0e7524A5Aea5E9Ce3BC60B4F4677);
