...
/** The LUXEREUM blockchain is the only blockchain that
     provides real-time transaction validation with Low Fee transaction fees. Where other blockchain fees
     transaction fees for writing data on the LUXEREUM
     blockchain is free to use to build real-time DeFi
/**
 TELEGRAM :https://t.me/Luxereum
 WEBSITE :https://luxereum.net/
 TWITTER :https://twitter.com/luxereumcoin
*/
...
contract LUXEREUM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " LUXEREUM";
    string private _symbol = "LREUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x00A0f1CDA2fba0f4bC4272D0e210468B708C03B5);
