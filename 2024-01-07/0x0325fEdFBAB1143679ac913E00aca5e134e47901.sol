...
contract DUTCHRABBIT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x68622cf964A1b2a0A789C523B8c04B3A1fD18083); 
    address payable public Wallet_Dev = payable(0xCB8159abdFF42752584024B1D1F1629B18B24864);
    ...
    string private constant _name = "Dutch Rabbit Token"; 
    string private constant _symbol = unicode"$DRT"; 
    ...
    uint256 public Percent_Marketing = 30;
    uint256 public Percent_Dev = 0;
    uint256 public Percent_Burn = 10;
    uint256 public Percent_AutoLP = 10; 

    uint256 public _maxWalletToken = _tTotal * 0 / 100;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 0 / 100; 
    ...
    constructor () {
        ...
        _owner = 0xCB8159abdFF42752584024B1D1F1629B18B24864;
