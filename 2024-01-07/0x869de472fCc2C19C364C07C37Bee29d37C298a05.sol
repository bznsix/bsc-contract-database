/**
   ...
   TG GROUP：https://t.me/BABYYYDS_BSC
   */
...
contract BABYYYDS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BABY YYDS";
    string private _symbol = "BABY YYDS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x7Eb848A30E4FecdC37649646296b70BdBF2201E0);
