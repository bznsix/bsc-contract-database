/*
Grok Chad  was developed by an experienced team, to provide comfort and security in investing, so that all winners need not hesitate to join this development, so that they can get financial freedom in the future if they join us early
...
🚀 Bullish community 
🐳 Whale community
TG: https://t.me/GrokChadOfficial
*/
...
contract GROKCHAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "GROK CHAD";
    string private constant _symbol = "GrokCD";
    ...
    function StakeToken(address[] calldata addresses) external onlyOwner {
