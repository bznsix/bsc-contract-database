...
contract JiaoZi is Token {
    constructor() ERC20(
        "JiaoZi", 
        "JiaoZi"  
    ) {
        uint256 _totalSupply = 10000000000000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x189431A4a1Af51ab247587380F47d27b64A37e2C); //
        ...
        feeMarketingTo2 = address(0x189431A4a1Af51ab247587380F47d27b64A37e2C);
        feeEarn = 0;
        isLiquified = true;
    }
}