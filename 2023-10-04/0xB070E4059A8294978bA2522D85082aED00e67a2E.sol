...
contract BabyFroggy is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Froggy", unicode"BabyFroggy") {
        ...
        maxTransactionAmount = 5 * 1e9 * 1e18; 
        maxWallet = 5 * 1e9 * 1e18; 
        ...
        devWallet = address(0xC1Ad8809702ce49be21B20961ebF57c6E8B6C612); 
