...
contract Chihuahua is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x9744b6CC12F4915d60f4c791D08585A907730215;
    address public devAddress = 0x1E235dd932B131FE23d3DE74951d7Ea916Ee6121;

    string private constant _name = "Chihuahua";
    string private constant _symbol = "CHIH";
    ...
    Taxes public taxes = Taxes(2,0,30,4);
    Taxes public sellTaxes = Taxes(2,0,32,4);
    ...
    // Owner cannot transfer out Chihuahua from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out CHIH!");
