...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37A9d64E9f8b10421299714667FEB13375A8c049; // owner address
...
contract BNBLONGINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBLONGINU";
    string private _symbol = "BLI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x37A9d64E9f8b10421299714667FEB13375A8c049); // Marketing Address
    address payable private teamWalletAddress = payable(0x37A9d64E9f8b10421299714667FEB13375A8c049); // Team Address
