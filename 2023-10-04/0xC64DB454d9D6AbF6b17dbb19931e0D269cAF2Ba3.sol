...
contract Vesting is Ownable, ReentrancyGuard{
    ...
    */
    function createVestingSchedule(
        ...
        VestingSchedule storage vs = vestingSchedules[_beneficiary];
        require(vs.amountTotal == 0, "TokenVesting: vesting schedule for this addres already created");
    ...
    /**
    * @notice Creates a new vesting schedule for multiple beneficiaries.
    * @param _addresses addresses of the beneficiaries to whom vested tokens are transferred
    * @param _start start time of the vesting period
    * @param _duration duration in seconds of the period in which the tokens will vest
    * @param _slicePeriodSeconds duration of a slice period for the vesting in seconds
    * @param _amount total amount of tokens to be released at the end of the vesting
    */
    function createVestingSchedules(
        ...
        require(_duration > 0, "TokenVesting: duration must be > 0");
        require(_start > block.timestamp, "TokenVesting: duration must be > 0");
        require(_amount > 0, "TokenVesting: amount must be > 0");
        require(_slicePeriodSeconds >= 1, "TokenVesting: slicePeriodSeconds must be >= 1");
    ...
    */
    ...
    function getTotalAmountClaimed(address addr)
        public
        view
        returns(uint256){
