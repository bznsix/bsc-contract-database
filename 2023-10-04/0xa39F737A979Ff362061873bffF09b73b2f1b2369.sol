...
contract CATSTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public unncfd7;
    ...
    string private _tokenname = "CATCOIN";
    string private _tokensymbol = "CATS";
