/**
 *Submitted for verification at Arbiscan.io on 2023-9-1
 */

/**
 *Submitted for verification at BscScan.com on 2023-09-1
 */

/**
 *Submitted for verification at Etherscan.io on 2023-01-1
 */
...
/**
 *Submitted for verification at Etherscan.io on 2022-1-1
 */

/**
 *Submitted for verification at BscScan.com on 2022-1-1
 */
...
contract XFunderToken is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;
    uint256 private _maxCap = 2_300_000_000 * 10 ** decimals();

    bool public isAntiBot;
    uint256 public maxBuy = 100_000_000_000 * 10 ** decimals();
    uint256 public maxSell = 100_000_000_000 * 10 ** decimals();
    uint256 public antiBotStart;
    uint256 public antiBotEnd;
    uint256 public constant PER_DIVI = 10_000;
    ...
    mapping(address => bool) public isOnce;
    ...
    constructor() ERC20("XFunder Token", "XE") {}

    function mint() external onlyOwner returns (bool) {
        require(isOnce[msg.sender] == false, "Only mint once");
        _mint(msg.sender, _maxCap);
        isOnce[msg.sender] = true;
        return true;
    }
