...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c)); // ETH - 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
...
contract PepeBTC is ERC20, Ownable {
    ...
    constructor() ERC20("PepeBTC", "Pepe") {
    	...
    	operationsWallet = address(0xfE797f579FCbD8aA127b8CaE4968A33efe1cDEd5); // set as operations wallet
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 30) / 100);
