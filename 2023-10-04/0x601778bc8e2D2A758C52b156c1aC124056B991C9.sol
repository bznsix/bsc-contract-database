...
contract XPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "XPEPE";
    string private _symbol = "XPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e4581E7b261AD8Bf68d4c67fd68434449F56D6f); // marketing Address
    address payable public developmentWalletAddress = payable(0x8e4581E7b261AD8Bf68d4c67fd68434449F56D6f); // development Address
    ...
    uint256 private _totalSupply = 420690000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 8413800 * 10**6 * 10**9;
    uint256 public _walletMax = 8413800 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 441380000000 * 10**9; 
...
//create a mapping to keep track of who is blacklist
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(developmentWalletAddress, amountBNBBuyBack);
