...
contract PLUS is Context, IERC20, Ownable {
	...
	// fee list end
	address public ownerAddress = address(0x51E9ac62Fe8Ee7205f723Ee283D58e2689adF741);
	
	address public inviteBurnAddress = address(0x51E9ac62Fe8Ee7205f723Ee283D58e2689adF741);
	...
	function _takeInviterFee(
		...
		if (doType == 1 || doType == 2) {
			giveAllFee(sender, tAmount);
		} else if (doType == 3){
            giveAllFee(recipient, tAmount);
		}
    }
    ...
    function _transfer(
        ...
        bool shouldSetInviter = inviter[to] == address(0) && !isContract(from) && !isContract(to) && (amount >= 1 * 10 ** 16);
