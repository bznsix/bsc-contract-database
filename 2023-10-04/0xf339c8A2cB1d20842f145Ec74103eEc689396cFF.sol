/**
 minerBTC joke to facts and facts to millions and millions to fomo
 easy microLP easy microGem
 ape share shill and we will be 1000X in 24 hours
 https://t.me/BTCminerToken
*/
...
contract minerBTC {
    string public name = "minerBTC";
    string public symbol = "minerBTC";
    uint8 public decimals = 18; // Assuming 18 decimals for consistency
    uint256 public totalSupplyCap = 2100000000000 * 10**uint256(decimals); // Total supply capped at 21 million tokens
    uint256 public initialSupply = 50000000000 * 10**uint256(decimals); // Initial supply of 5 million tokens
    uint256 public halvingInterval = 20; // Halving every 2100 blocks
