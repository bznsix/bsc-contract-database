...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75fF00103362B0660993A4a1Aba9dB410500c218; // owner address
...
contract LONGNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LONG Network";
    string private _symbol = "LNet";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x75fF00103362B0660993A4a1Aba9dB410500c218); // Marketing Address
    address payable private teamWalletAddress = payable(0x75fF00103362B0660993A4a1Aba9dB410500c218); // Team Address
