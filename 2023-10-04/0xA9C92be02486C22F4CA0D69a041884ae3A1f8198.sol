...
/**
TG: https://t.me/TeleswapBsc

MAX TX : 3%
initail LP : 2BNB

TELE Swap-Bot: TeleSwap is a bot that facilitates token 
swaps on the Binance Smart Chain (BSC)
network directly within Telegram and also rewards its users 
for swapping their BSC tokens within the bot.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7348a475874ec4c4b2aBb8e9F3051b47aE36F5B5;
...
contract TeleSwap is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7348a475874ec4c4b2aBb8e9F3051b47aE36F5B5);
    address payable private Wallet_Burn = payable(0x7348a475874ec4c4b2aBb8e9F3051b47aE36F5B5); 
    address payable private Wallet_zero = payable(0x7348a475874ec4c4b2aBb8e9F3051b47aE36F5B5); 
    ...
    */
    ...
    string private _name = "TELE SWAP"; 
    string private _symbol = "TEL";  
