...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd0a1DA286A686449460B930625bFb6e95B2E5823 ; // owner address
...
contract MajinBooinu  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MajinBooinu";
    string private _symbol = "BOO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd0a1DA286A686449460B930625bFb6e95B2E5823); 
    address payable public teamWalletAddress = payable(0xd0a1DA286A686449460B930625bFb6e95B2E5823);
