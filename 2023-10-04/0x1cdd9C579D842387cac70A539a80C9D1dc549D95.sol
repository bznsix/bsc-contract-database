...
contract ShootEveryone is ERC20, Ownable {
    ...
    constructor() ERC20("ShootEveryone", "SvE") {

        webSite     = "https://shooteveryone.com";
        telegram    = "https://t.me/shooteveryonee";
        twitter     = "https://twitter.com/shoot_everyonee";

        blockchainDev   = "https://t.me/weslehv";
        ...
        percent.percent2 = 250;
        percent.percent3 = 200;

        projectWallets.marketingWallet = 0xF26be31f4C382258D8F0a16D1E7BaD99B6EE44E7;
        projectWallets.developmentWallet1 = 0x83A6526036B932598ABc687Ac35BC97fDEb07E99;
        projectWallets.developmentWallet2 = 0x0100ABb552907EB2E4C88f59B0539ED224730277;
        projectWallets.developmentWallet3 = 0x280787F3Ce86609800afe5865e4D632924B1713D;
        ...
        _isExcludedFromFees[address(0xF719372c2c7786CD68E52b9267C2371A2CAFCb7e)] = true;
        

    
        _mint(owner(), 100_000_000 * (10 ** 18));
        swapTokensAtAmount = 500_000 * (10 ** 18);
                maxWallet = 100_000_000 * (10 ** 18) * 1/ 100; //2%
    ...
    function excludeFromFees(address account, bool excluded) external onlyOwner {
     ...
     function setMax(uint256 _maxWallet) external onlyOwner() {
