...
contract MoonTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tbbdx45;
    ...
    string private _tokenname = "DarkMoon";
    string private _tokensymbol = "Moon";
