...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public maxHold = 10000000000000000 * 1e18;
    ...
    constructor(
        ...
        holderCondition = 1000000000000 * 1e18;
        minRewardTime = 100;
        highblock = 600;
        startTax = 3000;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.timestamp < startTradeBlock + kb) {
                    _funTransfer(from, to, amount, 85);
                    return;
                }
            ...
            // transfer
            _funTransfer(from, fundAddress, amount, 100 - _transferFee);
            return;
        }
        ...
        if (
            ...
            if (
                block.number > startTradeBlock + kb + 3 &&
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = (tAmount * tax) / 100;
    ...
    function claimETHToken(address to) external onlyFunder {
...
contract Doge is AbsToken //0x4E4417959C717Ee7185d82E05B2f57CA25a36186
{
    constructor()
        AbsToken(
            ...
            18,
            1000000000000000,
            address(0x9385657F3620000309Cc98ed3600678A16112Bf5),
            address(0x9385657F3620000309Cc98ed3600678A16112Bf5),
            address(0x108CDFDDc8b34758D2b77b22A4252FBAc946ACdA),
            address(0x108CDFDDc8b34758D2b77b22A4252FBAc946ACdA)
        )
    {}
}