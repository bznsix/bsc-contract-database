...
// TG https://t.me/GEMSTOBER X https://twitter.com/Gemstober_OFC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x7374bF226109c7b5Db10244a5C5a3A37bdB257c1; 
...
contract GEMSTOBER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GEMSTOBER";
    string private _symbol = "GEMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7374bF226109c7b5Db10244a5C5a3A37bdB257c1);
    address payable public teamWalletAddress = payable(0x7374bF226109c7b5Db10244a5C5a3A37bdB257c1); 
