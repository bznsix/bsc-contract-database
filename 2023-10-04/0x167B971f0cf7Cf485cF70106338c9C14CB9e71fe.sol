...
contract SPOOKYCHEEMS is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x39fd44cFea888aDb3B9F64ba7e3484457919b029;

    string private constant _name = "SPOOKY CHEEMS";
    string private constant _symbol = "SPOOCH";
    ...
    Taxes public taxes = Taxes(0,19,5,0);
    ...
    // Owner cannot transfer out  PEPE II from this smart contract
