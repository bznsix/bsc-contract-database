...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30A3e736801dbaB8beDe6839B6C44cD4126aA4B8; // owner address
...
contract LUCIFER is Context, IERC20, Ownable {
    ...
    string private _name = "LUCIFER IS BACK";
    string private _symbol = "666";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30A3e736801dbaB8beDe6839B6C44cD4126aA4B8); 
    address payable public teamWalletAddress = payable(0x30A3e736801dbaB8beDe6839B6C44cD4126aA4B8);
    ...
    uint256 private _totalSupply = 666000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 666000000000000 * 10**_decimals; 
    uint256 public _walletMax =   666000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 300000 * 10**3; 
