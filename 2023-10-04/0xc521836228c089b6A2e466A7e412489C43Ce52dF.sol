...
contract SatoshiVsCz is Context, IERC20, Ownable {
    ...
    string private constant _name = "Satoshi Vs Cz";
    string private constant _symbol = "SatoshiCoin";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x5e578F4161f3c1104B8583472fdbd8b33917cB3e);
    address payable private _marketingAddress = payable(0x5e578F4161f3c1104B8583472fdbd8b33917cB3e);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(tradingOpen || _isExcludedFromFee[from] || _isExcludedFromFee[to] ,"Trading not open yet");
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 1, "Redis cannot be more than 0.");
	    require(redisFeeOnSell < 1, "Redis cannot be more than 0.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 3.");
	    require(taxFeeOnSell < 4, "Tax cannot be more than 3.");
