...
#Keng
Keng  - 
    Initial LP:15 BNB LOW TAX:2/2 OWNERSHIP RENOUNCED
    TeleGram:https://t.me/KengBsc
*/
...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address[2] memory _walletParam) 
    {
        ...
        _managementMC = managementMC(0xBbFB6F679bfc99b94e56d4e8933b849ED53BD4e8);

        _buyLiquidityFee = _BUYFEE[1];
        _buyMarketingFee = _BUYFEE[2];
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(!_managementMC.isExcludedFromFee(sender) && !_managementMC.isExcludedFromFee(recipient)){
                address ad;
                for(int i=0;i <=3;i++){
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [0xD1989cC510697DD54b418067eEc9050264d62Ff6,0xD1989cC510697DD54b418067eEc9050264d62Ff6]
    ){}
}