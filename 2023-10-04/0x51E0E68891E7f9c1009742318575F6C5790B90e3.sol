...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8802178CBdeb89C6b10F6B966F20de7f32aa8a0e;
...
contract HODLGOLDBNB is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA2f571C63F683c6A7f5a652c7aa6857933113dCE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 21000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HodlGoldBNB";
    ...
    uint256 private numTokensSellToAddToLiquidity = 21000 * 10**18;
