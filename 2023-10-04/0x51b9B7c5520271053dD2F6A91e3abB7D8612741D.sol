...
contract CustomToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 333333333333333000000000000000000;
    uint256 private _tTotalSupply = 333333333333333000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint public ReflectionFeeonBuy=30;
    uint public ReflectionFeeonSell=30;

    uint public liquidityFeeonBuy=30;
    uint public liquidityFeeonSell=30;
    ...
    address public marketingWallet=0x992aEC22Ed3e42bb95a2Efa69D2786e62521543E;

    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=13333333333333320312500000000000;
    uint256 public maxTransactionAmountSell=13333333333333320312500000000000;

    uint256 public maxWalletAmount=13333333333333320312500000000000;
    ...
    uint256 public swapTokensAtAmount=33333333333333301544189453125;
