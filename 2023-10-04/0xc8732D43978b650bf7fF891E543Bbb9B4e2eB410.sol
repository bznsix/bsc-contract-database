...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA235c87c30b4d297C273B7bDBD7aFE53e644723e; // owner address
...
contract FableOfTheLONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fable Of The LONG";
    string private _symbol = "TYRANT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA235c87c30b4d297C273B7bDBD7aFE53e644723e); // Marketing Address
    address payable private teamWalletAddress = payable(0xA235c87c30b4d297C273B7bDBD7aFE53e644723e); // Team Address
