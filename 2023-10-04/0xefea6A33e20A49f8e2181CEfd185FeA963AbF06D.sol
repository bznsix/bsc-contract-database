...
contract DoraemonCEO is ERC20, Ownable {
    ...
    constructor () ERC20("DORAEMON CEO", "DORAEMON CEO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xF70b781fa93d6673Bb840453e2a74DB1CF47cBa7;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0xA5932f1a7C071155BB6a25aCbB49A6D86d5EE00f] = true; //pinklock
