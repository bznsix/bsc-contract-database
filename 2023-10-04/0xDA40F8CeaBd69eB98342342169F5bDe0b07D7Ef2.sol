...
contract CPEPETOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public hhfcvd56;
    ...
    string private _tokenname = "Coyote Pepe";
    string private _tokensymbol = "CPEPE";
