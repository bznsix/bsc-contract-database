...
contract ABJS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ABJS";
    string private _symbol = "ABJS";
    ...
    uint256 private _totalSupply =125000000 * 10**_decimals;
    uint256 public _maxTxAmount = 125000000 * 10**_decimals; 
    uint256 public _walletMax = 125000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x63471b66b9de06eA70F6Dac936157874108575AA));
        marketingWalletAddress = payable(address(0x63471b66b9de06eA70F6Dac936157874108575AA));
