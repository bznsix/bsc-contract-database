/**
https://t.me/PepePredatorBSC
https://x.com/PepePredatorOFC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf634F21b7896f5883530b74babFF28275C2f4563; 
...
contract PepePredator is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE PREDATOR";
    string private _symbol = "PEPEP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf634F21b7896f5883530b74babFF28275C2f4563); 
    address payable public teamWalletAddress = payable(0xf634F21b7896f5883530b74babFF28275C2f4563); 
