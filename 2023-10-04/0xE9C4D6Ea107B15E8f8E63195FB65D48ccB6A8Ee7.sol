...
contract ZeroPointFour is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ZeroPointFour";
    string private _symbol = "DONUTS";
    ...
    address payable public marketingWallet = payable(0x398e3cd947E8507ea8d703836a261a49Fc4EFAe5);
    ...
    uint256 public numTokensSellToAddToLiquidity = 0.1 * 10**18;
    uint256 public _maxTxAmount = 0.4 * 10**18;
    uint256 public _maxWalletLimit = 0.4 * 10**18;
    address admin;
