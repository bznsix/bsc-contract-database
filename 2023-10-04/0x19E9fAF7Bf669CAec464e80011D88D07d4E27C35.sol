...
/**
Telegram: https://t.me/CyberAiBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF4D2588666de5868C9423A3257A51A8C1C0A3076; 
...
contract CYBERAI is Context, IERC20, Ownable {
    ...
    string private _name = "CYBER AI";
    string private constant _symbol = unicode"CYBERAI";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0xF4D2588666de5868C9423A3257A51A8C1C0A3076); // Marketing Address
    address payable public teamWalletAddress = payable(0xF4D2588666de5868C9423A3257A51A8C1C0A3076); // Team Address
