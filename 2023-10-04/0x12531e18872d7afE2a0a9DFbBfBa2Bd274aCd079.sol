...
contract GamerTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public hbbaw23;
    ...
    string private _tokenname = "Gamer";
    string private _tokensymbol = "Gamer";
