...
contract BitLong is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0efFa155B27CacFFB561f2835D056aFc28Dba168); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0efFa155B27CacFFB561f2835D056aFc28Dba168); // Team Address
        
    address payable public liquidityAddress =
        payable(0x0efFa155B27CacFFB561f2835D056aFc28Dba168); // Liquidity Address
    ...
    uint256 private constant _tTotal = 21 * 1e12 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    string private constant _name = "Bitlong";

    string private constant _symbol = "Bitlong";
    ...
    uint256 public maxTransactionAmount = _tTotal * 100 / 100;
    uint256 public maxWallet = _tTotal * 1 / 200 ; // 0.5% at launch

    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    mapping (address => bool) public automatedMarketMakerPairs;

    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 400; // 0.25 %
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      maxWallet = _walletMax;
      require(_walletMax >= _tTotal * 1 / 300 , "Must keep above 0.3%");
        }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 25, "Must keep taxes below 25%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 45, "Must keep taxes below 45%");
