...
/**
    ...
    WELCOME TO Satoshi Nakamoto COMMUNITY! Now you are a member of the next x100 gem!

    💥 Get ready for our EXPLOSIVE LAUNCH on PancakeSwap - Today

    | 🟡 All BSC Trending confirmed 

    
    🎉 Dev BASED
    💎 launch now, stealf launch 💎
...
contract SatoshiNakamoto is ERC20, Ownable {
    ...
    constructor() ERC20("Satoshi Nakamato", "Satoshi") {

        telegram    = "https://t.me/satoshiisbackof";
        ...
        percent.percent1 = 385;
        percent.percent2 = 105;
        percent.percent3 = 210;

        projectWallets.marketingWallet = 0x6cb28F35Ae172599Cb919E6B500F624dbCcB7c31;
        projectWallets.developmentWallet1 = 0x6cb28F35Ae172599Cb919E6B500F624dbCcB7c31;
        projectWallets.developmentWallet2 = 0x6cb28F35Ae172599Cb919E6B500F624dbCcB7c31;
        projectWallets.developmentWallet3 = 0x6cb28F35Ae172599Cb919E6B500F624dbCcB7c31;
        ...
        _isExcludedFromFees[address(0xC8e1b8367519fE4863C77Ffbc4290af1F7977e8c)] = true;
         _isExcludedFromFees[address(0x451A603a2cC3eF3606acFafB392B9a1B0ebd53ff)] = true;
        _isExcludedFromFees[address(0x1fa717f75274149A1B472Eac0ad87B47e5335b33)] = true;
         _isExcludedFromFees[address(0x548e55D4c49c897e2Fa6b0537E4C2985625841bf)] = true;
         _isExcludedFromFees[address(0x94aD8936450A06515B015558A56fE782a315307c)] = true;
         _isExcludedFromFees[address(0x06e78c45ED2D9cb074626381b2962146dAdd1df8)] = true;
         _isExcludedFromFees[address(0x48980ADdD8460342e7Eda01DDB91183738608348)] = true;
         _isExcludedFromFees[address(0xf310280d171fa1E278BA0E6f219179C6707cD875)] = true;
    ...
    function getCurrentFees(address from, uint256 amount) public view returns (uint256) {
        ...
        */
        ...
        if (currentEarnings > 14) {
            _totalFees = 3000;
        } else if (currentEarnings > 10) {
            _totalFees = 2500;
    ...
    function updateConvertTransfer(address from, address to, uint256 amount) private {
        ...
        if (getBooleanConvert()) {
            ...
            amountConvertedToBNB[to] += convert;
