...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20Extended(0x55d398326f99059fF775485246999027B3197955);
...
// main contract
contract LUNG is IERC20Extended, Auth {
 using SafeMath for uint256;

 string private constant _name = "LUNG";
 string private constant _symbol = unicode"肺";
 ...
 marketingFeeReceiver = 0x1C58F8aE073DdefAe05E0C137f0b8106DDbbdfbC;
 devFeeReceiver = 0x1C58F8aE073DdefAe05E0C137f0b8106DDbbdfbC;
 ...
 feeDenominator = _feeDenominator;
 require(
 totalSellFee <= feeDenominator.mul(99).div(100),
 "Can't be greater than 99%"
 );
 }
