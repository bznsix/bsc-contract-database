...
contract Millionaire2049 is ERC20, Ownable {
    ...
    constructor () ERC20("Millionaire2049", "Millionaire2049") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingFeeOnTransfer = 6;

        marketingWallet = 0xcEF70bE7129E5c8B47ce5b635a1a0469D73cE630;
