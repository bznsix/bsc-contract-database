...
contract froggys is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Froggy'S";
    string private _symbol = "$FGS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD73B2481a9BB928cb93Af36222ab2f048D416105);
    address payable private DevelopmentWalletAddress = payable(0xD73B2481a9BB928cb93Af36222ab2f048D416105);
    ...
    uint256 public _walletMax = 50000 * 10**9;
