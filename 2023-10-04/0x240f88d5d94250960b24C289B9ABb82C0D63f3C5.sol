...
contract InosukeBNB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("InosukeBNB", "IBNB")  {
        rewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;// put reward token address here
        _marketingWalletAddress = 0x95D3DE1316f3b4f2B6Bb3eB7879Ed1E9B79f9a02;// put marketing wallet here

        buyTokenRewardsFee = 2;
        buyLiquidityFee = 2;
        buyMarketingFee = 4;
        buyDeadFee = 0;

        sellTokenRewardsFee = 2;
        sellLiquidityFee = 2;
        sellMarketingFee = 4;
        sellDeadFee = 0;
        ...
        uint256 totalSupply = 1000000000* (10**18);// total supply
