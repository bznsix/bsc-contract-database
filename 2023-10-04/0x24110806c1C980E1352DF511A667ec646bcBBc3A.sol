...
contract Bnbtest is IERC20, Ownable {
    ...
    string private constant NAME = "Bnbtest";
    string private constant SYMBOL = "Bnbtest";
    ...
    Wallets public wallets =
        Wallets({
            marketingWallet: payable(
                0x24ec6281f6CfDCaC20fe245EBEC4c960057B8A0d
            ),
            utilityWallet: payable(
                0x24ec6281f6CfDCaC20fe245EBEC4c960057B8A0d
            ),
            teamWallet: payable(0x24ec6281f6CfDCaC20fe245EBEC4c960057B8A0d)
        });
    ...
    if (settings.presaleModeEnabled ==true && (sender==owner() || recipient==owner()|| recipient ==uniswapV2Pair ))
    {
