...
contract USDTB is ERC20, Ownable {
    ...
    constructor() payable ERC20("USDTB", "$USDTB") {
        ...
        marketingWallet = 0x202eE56624C55bF236915fD648EE6A88eD73dd57;

        dividendTracker = new DividendTracker(27 * 10**5, rewardToken);
