...
contract LongGrow is IERC20, Ownable {
    ...
    string _name = "Long Grow";
    string _symbol = "LONGGROW";
    ...
    constructor () {
        ...
        devFeeReceiver = 0xA72A1e7555EAc9801D4d1E9dA5Ce116D5ecE7d7A;
        marketingFeeReceiver = 0xA72A1e7555EAc9801D4d1E9dA5Ce116D5ecE7d7A;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=50,"Cannot set buy fees above 50%"); // set max fees you can set to here
        require(totalFeeSell <=70,"Cannot set sell fees above 70%"); // set max fees you can set to here
