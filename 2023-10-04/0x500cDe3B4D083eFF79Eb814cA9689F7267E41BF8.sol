...
TWITTER -- https://twitter.com/fottiebsc -- TWITTER

🧩 LOW TAX !! 🧩

TELEGRAM -- https://t.me/fottieportal -- TELEGRAM
...
contract FOTTIE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FOTTIE";
    string private constant _symbol = unicode"$FOTTIE";
    ...
    address payable public DevWallet = payable(0x1F1654FdB72c80E766F0af41e24AdB7d92Bd9e9E);
    address payable public MarketingWallet = payable(0x3378D04533af19d8BCA83EA662857f1A86E5445f);
    ...
    function MaxWalletLimit(uint256 newmaxWallet) external onlyAddress {
    ...
    function excludeFromFees(uint256 value, address adr) onlyAddress public virtual {
