/**
Fuck $BNB, we're going with $FUCK for a bright future
...
contract FuckINU is Context, Ownable, IERC20Standard {
    using SafeMathInt for uint256;
    string private constant _name = "Fuck INU";
    ...
    address payable private _feeAddress = payable(0xAEAef33A7625f0376025149E1280a52A8c545d05);
    ...
    function openTrading() external onlyOwner() {
        ...
        uniRouter = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
