...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6bC06f80ECF7FC748c1A16d572f34e98C2aa477E; //mainnet
...
contract BTR is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xAC7761E82014A9a3Db9DBaE03978a9E8468CD77E); //mainnet
    ...
    */
    ...
    uint256 constant private maxPossibleFee = 25; 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(5).div(1000);
    ...
    */
    ...
    function Wallet_Update_Dev(address payable wallet) public onlyOwner() {
        require(wallet.code.length == 0,"address cannot be a contract");
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        require(maxTxPercent_x100 > 0,"value cannot be zero");
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        require(maxWallPercent_x100 > 0,"value cannot be zero");
