...
contract OxyO2founders is Ownable {
    uint256 public amount = 60000e18;
    ...
    function addPartner(address member,uint value) public onlyOwner {
        uint timestamp = block.timestamp;
    ...
    function subtractPartner(address member) public onlyOwner {
    ...
    function founderReward() public onlyOwner {
        uint timestamp = block.timestamp;
