...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 290;
    ...
    constructor (
        ...
        maxBuyAmount = 10 * 10** Decimals;
        maxSellAmount = 10 * 10** Decimals;
        walletLimit =  10 * 10** Decimals;
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),//FISTAddress
        unicode"FH",//Name
        unicode"FH",//Symbol
        18,//Decimals
        10000,//Supply
        address(0x55AAFec1Fce1dD895140b8ebeD79B634E45DE063),//FundAddress
        address(0x55AAFec1Fce1dD895140b8ebeD79B634E45DE063)//ReceiveAddress
    ){
    }
}