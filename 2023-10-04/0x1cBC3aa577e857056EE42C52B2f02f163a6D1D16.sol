...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x46D16c9A521808dD14709108cF85c102bC905b16; 
...
contract BuffFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Buff Floki";
    string private _symbol = "BuffFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46D16c9A521808dD14709108cF85c102bC905b16);
    address payable public teamWalletAddress = payable(0x46D16c9A521808dD14709108cF85c102bC905b16); 
