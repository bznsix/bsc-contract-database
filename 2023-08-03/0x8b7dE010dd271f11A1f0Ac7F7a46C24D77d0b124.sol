...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE867313F2D45793d054022c6f39339F2C640624C; // owner address
...
contract Wagmi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1515e49AbfF1012A62f0575fBC739637aAE6B1Ab); // Marketing Address
    address payable public teamWalletAddress = payable(0xfAA03B2927E9876BAE7F7ca06ce58f2aE25478cD); // Team Address
