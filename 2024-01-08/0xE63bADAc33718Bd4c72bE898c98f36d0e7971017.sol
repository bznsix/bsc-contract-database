...
contract DragonMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x314FddC756594344269069CCA746c0286DF00fed); // Marketing Address
    address payable public teamWalletAddress = payable(0x314FddC756594344269069CCA746c0286DF00fed); // Team Address
