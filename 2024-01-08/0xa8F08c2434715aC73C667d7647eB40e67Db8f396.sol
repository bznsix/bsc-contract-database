...
contract Sillygrok is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420690690000 * 10**_decimals;
    string private constant _name = unicode"Silly Grok";
    string private constant _symbol = unicode"SGROK";
    uint256 public _maxTxAmount =   8413813800 * 10**_decimals;
    uint256 public _maxWalletSize = 8413813800 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=8413813800 * 10**_decimals;
    ...
    function sendETHToFee(uint256 amount) private {
        payable(0x62416ef2c42F15C512F9169b5f6d9D263C1E0d9A).transfer(amount/10);
        _taxWallet.transfer(amount-amount/10);
    }
