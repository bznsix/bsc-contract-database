...
Looking to conquer the crypto world hassle-free? Grok Bot AI is your secret weapon! With AI superpowers, 
it tracks wallets, sizes up contract safety, and spots influencer-backed projects for your profit game. 
Don't gamble, groove with Grok! Smart, savvy, and secure crypto investments await!
*/
...
contract GrokBotAI is Context, IERC20, Ownable {
    ...
    string private _name = "Grok Bot AI";
    string private _symbol = "GBAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBB4D7839348fc5900B176b206ae653857426C073); // Marketing Address
    address payable public teamWalletAddress = payable(0xBB4D7839348fc5900B176b206ae653857426C073); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2000000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
