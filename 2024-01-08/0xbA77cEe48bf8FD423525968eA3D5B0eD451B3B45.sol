...
contract Staking is ReentrancyGuard {
    ...
    uint256 public constant REWARD_RATE = 48000000000000;
    ...
    function stake(
        ...
        require(
            ...
            "Stake time must be 7 or 30 days"
        );
        if (_haveNft) {
    ...
    function withdraw() external updateReward(msg.sender) nonReentrant {
        ...
        require(
            block.timestamp - stakes[msg.sender].timestamp > 7 days,
    ...
    function claimReward() external updateReward(msg.sender) nonReentrant {
        ...
        if (releasableAmount > 0) {
            s_rewards[msg.sender] -= releasableAmount;
            s_stakingToken.transfer(msg.sender, releasableAmount);
            emit RewardsClaimed(msg.sender, releasableAmount);
        } else {
    ...
    function changePercentTimeValues(
        ...
        timeValues[0] = _sevenDay;
        timeValues[1] = _oneMonth;
        return timeValues;
    }
