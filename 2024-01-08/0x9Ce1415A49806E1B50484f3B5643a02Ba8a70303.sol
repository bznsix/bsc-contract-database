...
contract LlamaPresale is Ownable {
    ...
    address public wallet = payable(0xaF86dfe92193a7849197d3c5BB5e4D017e86DE0b);

    // How many token units a buyer gets per BNB & USDT
    uint256 private bnbRate = 25200000;
    uint256 private usdtRate = 100000;
    ...
    function buyTokens() public payable {
        ...
        require(msg.value >= 0.005 ether, "cant buy less with than 0.005 ETH");
        require(15 ether >= msg.value, "cannot buy with more than 15 ETH");
