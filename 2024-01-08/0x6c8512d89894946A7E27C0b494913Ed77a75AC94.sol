...
contract Token is _BaseToken {
    ...
    constructor() {
        ...
        maxBuyAmount = 21000000 * 10**decimals;
        maxSellAmount = 21000000 * 10**decimals;

        maxWalletAmount = 21000000 * 10**decimals;
        ...
        address fundAddress2 = 0x3235d9e16Bdebefb043C0D17c4ABaEC480Bb0153;
        address ReceiveAddress = 0x3235d9e16Bdebefb043C0D17c4ABaEC480Bb0153;
        fundAddress = payable(0x3235d9e16Bdebefb043C0D17c4ABaEC480Bb0153);

        _balances[fundAddress2] = totalSupply;
        emit Transfer(address(0), fundAddress2, totalSupply);
        _basicTransfer(fundAddress2,ReceiveAddress,totalSupply * 1000/1000);
