...
//telegram-https://t.me/GrokGenesis
...
//--- Contract v3 ---//
contract GROKG$N is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xBFB5CBFD16C43BAb3dE206582E400c961585a1a3); // build: 0xBFB5CBFD16C43BAb3dE206582E400c961585a1a3
    address payable private devWallet = payable(0xBFB5CBFD16C43BAb3dE206582E400c961585a1a3); // build: 0xBFB5CBFD16C43BAb3dE206582E400c961585a1a3
//(DONAT HERE PLS)
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = " Grok Genesis";
    string constant private _symbol = "GROKG$N";
