...
contract ICO is Ownable {
    ...
    function buyByBnb(address _referrer) external payable {
        ...
        uint256 stablePerBnb = uint256(getLatestPrice()); // STABLE/COIN
...
contract Token is ERC20PresetMinterPauser, Ownable {
    ...
    mapping(address => bool) public transferLockRoles;
    using SafeMath for uint256;
    ...
    constructor() ERC20PresetMinterPauser("SHIBAINU DAO", "SHIBA") {
        unlockTime    = 1730422861;
        unlockPercent = 1;
        duration      = 2592000;

        transferLockRoles[msg.sender] = true;
    ...
    function setTransferLockRole(address _wallet) onlyOwner external {
        require(_wallet != address (0), "Wallet Invalid");
        transferLockRoles[_wallet] = true;
    }
    ...
    function transferLockToken(address _wallet, uint256 _amount) external {
        require(transferLockRoles[_msgSender()], "Role Invalid");
