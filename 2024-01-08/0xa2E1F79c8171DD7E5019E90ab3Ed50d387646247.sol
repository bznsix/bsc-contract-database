...
contract muso is Ownable, ReentrancyGuard {
    ...
    event Upgrade(  uint256 amount);
     constructor(
        ...
        MUSO  = IERC20(0x0193825e5AE7821C3BD55eac5B748f436D71e8F2);
        MUSOL = IERC20(0x6d0e5E0b9d716dE44DacD9E62386D91095A36c02);
        
        router = ISwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        pair = IUniswapV2Pair(
            IPancakeFactory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73).getPair(0x55d398326f99059fF775485246999027B3197955, 0x0193825e5AE7821C3BD55eac5B748f436D71e8F2)
        );
