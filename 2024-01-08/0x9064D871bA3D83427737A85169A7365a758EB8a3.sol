/**
** PROJECT INFORMATION: 
** This project was developed by a Dutch Developer. 
** The project is a crypto coin that focuses on violence against animals. 
** By buying this coin you support the animal fund. 
** 2% of all income is donated to the national dog shelter.
** Telegram: https://t.me/babedoggy
** Telegram Developer: @teamhuts
** Twitter: https://twitter.com/BabeDoggys
** Launched Project 2024 BabeDoggy.
*/
...
contract BabeDoggy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabeDoggy";
    string private _symbol = "BBDOG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x912d0a6132ac484Bf5f81f77FEBB8503FFf3fa5c);
    address payable private DevelopmentWalletAddress = payable(0x912d0a6132ac484Bf5f81f77FEBB8503FFf3fa5c);
    ...
    uint256 public _buyDevelopmentFee = 15;
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 0;
    uint256 public _sellDevelopmentFee = 15;
    ...
    uint256 private _totalSupply = 750000000 * 10**9;
    uint256 public _maxTxAmount = 3000000 * 10**9;
    uint256 public _walletMax = 3000000 * 10**9;
