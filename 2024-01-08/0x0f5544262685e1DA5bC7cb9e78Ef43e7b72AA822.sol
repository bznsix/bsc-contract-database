/**
 ...
 ________   ______    ______   ________  ______   _______   ______   ______  
/        | /      \  /      \ /        |/      \ /       \ /      | /      \ 
$$$$$$$$/ /$$$$$$  |/$$$$$$  |$$$$$$$$//$$$$$$  |$$$$$$$  |$$$$$$/ /$$$$$$  |
    /$$/  $$ |  $$ |$$ |  $$ |   $$ |  $$ |  $$ |$$ |__$$ |  $$ |  $$ |__$$ |
   /$$/   $$ |  $$ |$$ |  $$ |   $$ |  $$ |  $$ |$$    $$/   $$ |  $$    $$ |
...
Twitter: https://twitter.com/ZootopiaToken
...
contract Zootopia_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Zootopia";
    string private _symbol = "$ZOO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x8b9e60a1432241DD4603DbE968CF022B7fC47934);
