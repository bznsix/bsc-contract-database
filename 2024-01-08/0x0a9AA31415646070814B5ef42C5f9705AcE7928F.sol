...
contract BonkGirl is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 600000 * 10**18; // 0.3%
    address public marketingWallet = 0x87baB3Baf6DA9D12C8C69eaa1e5A4f6e5d711D4b;
    ...
    Taxes public sellTaxes = Taxes(6, 1);
    ...
    constructor() BEP20("BonkGirl BSC", "BonkGirl") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= 2e6,"Swap threshold amount should be lower or equal to 1% of tokens");
    ...
    function updateMarketingWallet(address newWallet) external onlyOwner {
     ...
     function SetBuyTaxes(uint256 _marketing, uint256 _liquidity) external onlyOwner {
        ...
        require((_marketing + _liquidity) <= 12,"Must keep fees at 12% or less");
    }
    ...
    function rescueBSC20(address tokenAdd, uint256 amount) external onlyOwner {
        ...
        IBEP20(tokenAdd).transfer(marketingWallet, amount);
    }
