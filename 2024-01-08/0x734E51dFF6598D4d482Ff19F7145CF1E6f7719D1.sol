...
contract BULLBONK is ERC20, Ownable {
    ...
    address public marketingtWallet = 0x771fbC7593E317d7f5Bca2369068603FdD754458;
    address public devWallet = 0x771fbC7593E317d7f5Bca2369068603FdD754458;
    ...
    constructor() ERC20("BULLBONK", "BULLBONK") {
        ...
        exemptFee[marketingtWallet] = true;
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketingt + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.marketingt + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 marketingtAmt = unitBalance * 2 * swapTaxes.marketingt;
            if (marketingtAmt > 0) {
                payable(marketingtWallet).sendValue(marketingtAmt);
            }
    ...
    function updateMarketingtWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0), "Fee Address cannot be zero address");
        marketingtWallet = newWallet;
    }
