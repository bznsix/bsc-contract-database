...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C662510D79B13337d7d81b180e90919174847aC; // owner address
...
contract WOOD is Context, IERC20, Ownable {
    ...
    string private _name = "Wood Dragon";
    string private _symbol = "WOOD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9C662510D79B13337d7d81b180e90919174847aC); // Marketing Address
    address payable private teamWalletAddress = payable(0x9C662510D79B13337d7d81b180e90919174847aC); // Team Address
