...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfBc5B6cf358DfD07a82273bA9B31D501B28176E2; // owner address
...
contract Catrium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catrium";
    string private _symbol = "CATRIUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3B536c3c9fD472Ac4C5c9dC9Af6A2bd407010780); // Marketing Address
    address payable private teamWalletAddress = payable(0x3B536c3c9fD472Ac4C5c9dC9Af6A2bd407010780); // Team Address
