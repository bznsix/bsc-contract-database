...
contract EarlyChain is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x8d4b68CED67B04f80a032109737536b24FfB7453);

    string public _name = "Early Chain";
    string public _symbol = "ECN";
