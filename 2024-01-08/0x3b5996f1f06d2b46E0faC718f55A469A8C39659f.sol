...
/**
OutDID (Blockchain Service)
OutDID is an end-to-end private ID verification leveraging ZK Proofs.

https://www.outdid.io/
https://twitter.com/getoutdid
https://t.me/outdid_io
...
contract OutDID is Context, IBEP20, Ownable {
    ...
    string private constant _name = unicode"OutDID";
    string private constant _symbol = unicode"OUTDID";
    uint256 public _maxTxAmount = 601000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 601000000000 * 10**_decimals;
    ...
    constructor () {
        taxWallet = payable(0x6f5250b9B8673Eec6Fb3305E000dEE2e63890359);
