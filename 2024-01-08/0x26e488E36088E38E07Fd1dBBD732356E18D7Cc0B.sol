...
// without further ado Wolf Black, a meme coin at its birth and a great project in the future...
 
// TAX 5/5, NO TAX TRANSFER

// Telegram https://t.me/+G8srUWYKruZlZWYx
...
//--- Contract v3 ---//
contract WOLFMOON is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xa3A2F4c17A8deaA93e70F0f4eFd107AE114CC536); // build: 0xa3A2F4c17A8deaA93e70F0f4eFd107AE114CC536
    address payable private devWallet = payable(0xa3A2F4c17A8deaA93e70F0f4eFd107AE114CC536); // build: 0xa3A2F4c17A8deaA93e70F0f4eFd107AE114CC536
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "WOLF MOON";
    string constant private _symbol = "WOLFM";
