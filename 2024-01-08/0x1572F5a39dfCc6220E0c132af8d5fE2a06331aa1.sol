...
contract AIX is IERC20, Ownable {
    ...
    constructor(
        ...
        fundAddress = address(0x96bE9a52C82977208717697c9C1847aAc78632Fa);
        _swapRouter = ISwapRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        currency = _swapRouter.WETH();
        address ReceiveAddress = address(0x96bE9a52C82977208717697c9C1847aAc78632Fa);
        _owner = address(0xE61E9aA2cCfc9d1632F77AAc9bdeEebb26849F0C);
