...
contract SANTAFLOKI is Context, IBEP20, Ownable {
    ...
    string public constant name     = "SANTA FLOKI INU";
    string public constant symbol   = "SFLOKI";
    ...
    // sell fee
    uint256 public _taxFeeSell       = 500; 
    uint256 public _liquidityFeeSell = 500; 
