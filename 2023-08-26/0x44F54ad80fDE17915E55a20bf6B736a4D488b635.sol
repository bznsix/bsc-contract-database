...
contract CircaV2 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB37Ced54E97E394944983904b004bd6f0E71acE1; 
    ...
    uint256 public _maxTxAmount = 10 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2.40 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 30 * 10**9 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 devAmt = amount.mul(_marketingFee).div(100);
        ...
        _transferStandard(sender, marketingWallet , devAmt);
