 ...
 * Powered By BlazeX Contract Creator - This Contract is safe has no hidden malfunctions - Create your own Contract with blazex.org 
  ...
  *——————————————————
  *
  * Description: We are developing the ultimate trading bot for Telegram to trade your favorite BSC tokens on Pancakeswap
  * Website: https://venom-bsc-bot.carrd.co/
  * Twitter: https://twitter.com/realvenombsc
  * Telegram: https://t.me/real_VENOM_BSC
  *
  *—————
  */
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="VENOM BSC BOT";
    string private _symbol="VENOM";
    ...
    address public marketingWallet=0xf92c35033620C1B2BAb061bBbed71151dbdBa499;
    
    address public referralWallet;
    uint256 public serviceFee;
    uint256 public referralCommission;

    uint256 public maxTransactionAmountBuy=4000000000000000;
    uint256 public maxTransactionAmountSell=4000000000000000;
