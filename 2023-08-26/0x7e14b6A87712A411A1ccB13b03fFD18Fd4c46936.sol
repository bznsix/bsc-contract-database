...
contract SafeOneChain is Ownable, IERC20 {
    ...
    address payable public MarketingWalletAddress =
        payable(0x66be6714D4d6faD58b847A07b76236251C719101);
    address payable public TeamWalletAddress =
        payable(0xd683Ded3f04eb20931775b2dC5D9c75cE918558C);
    address payable public SeedWalletAddress =
        payable(0xCB2e29D9c5478D53a7B7c41945d3d0F8bd739027);
    ...
    function excludeFromMaxWalletHoldingLimit(
        address account
    ) external onlyOwner {
        _isExcludedFromWalletHoldingLimit[account] = true;
    }

    function includeInMaxWalletHoldingLimit(
        address account
    ) external onlyOwner {
        require(
    ...
    function UpdateMaxWalletHoldingLimit(
        uint256 maxWalletHoldingAmount
    ) external onlyOwner {
        require(
