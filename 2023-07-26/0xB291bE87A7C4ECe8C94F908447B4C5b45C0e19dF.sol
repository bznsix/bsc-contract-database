...
/// @author ApeSwap
/// @dev Zap Contract Extension which allows for zapping into Lending T-Bills
contract ApeSwapZapTBillsExtended is ApeSwapZap, ApeSwapZapTBills, ApeSwapZapLending {
    constructor(IApeRouter02 _router) ApeSwapZap(_router) ApeSwapZapLending() {}
    ...
    function _zapLendingMarketTBill(
        ...
        require(
            principalToken == address(market),
            "ApeSwapZapTBillsExtended: principalToken must be the same as cToken"
        );
