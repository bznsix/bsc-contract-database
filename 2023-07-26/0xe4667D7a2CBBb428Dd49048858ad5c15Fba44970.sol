//https://t.me/viratalik

//As the founder of Ethereum, we are proud to announce the launch of a commemorative token in honor of Vitalik, the visionary behind Ethereum. This token will serve as a tribute to his contributions and impact in the world of blockchain technology.
...
contract token is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 3e8 * 5e18;
    
    address public marketingWallet = 0xe6C06Be43B495080a1E11F4A93Eddd237b05df33;
    ...
    Taxes public taxes = Taxes(9,1,0);
    Taxes public sellTaxes = Taxes(9,1,0);
    ...
    constructor() ERC20("Viratalik Bugarin", "Viratalik") {
