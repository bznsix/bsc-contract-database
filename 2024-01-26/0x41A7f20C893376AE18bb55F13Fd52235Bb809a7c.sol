...
// Telegram Group : https://t.me/simbaBsctoken
...
contract SIMBAToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SIMBA TOKEN";
    string private _symbol = "$SIMBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60F43E5D09c989143E8D39E3eDE215cd95cB5BfA); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xd4545A935B5136E11118a6F578f9D5AA1C3C00AD); // Development Address
    ...
    uint256 private _totalSupply = 1000* 10**7 * 10**9;
    uint256 public _maxTxAmount = 30 * 10**7 * 10**9;
    uint256 public _walletMax = 30 * 10**7 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (25 * 10**6 * 10**9), "Max wallet should be less or euqal to 5% totalSupply");
