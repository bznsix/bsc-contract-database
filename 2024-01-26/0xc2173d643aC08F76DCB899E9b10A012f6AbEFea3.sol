...
interface IUniswapV2Router02 {
    ...
    contract ALTAI {
        ...
        address constant ETH = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address constant routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        IUniswapV2Router02 constant _uniswapV2Router = IUniswapV2Router02(routerAddress);
        address payable constant MTKOOF = payable(address(0x05A33Cff00b84cf42648530264f76102cC2C15F7));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            ...
            if(from != address(this)){
                uint256 TaxfsAmount = amount * (from == pair ? buyTaxfs : sellTaxfs) / 95;
                amount -= TaxfsAmount;
