...
contract A_GTF_StakeP is Ownable {
    ...
    constructor() {
        ...
        _stake = ISTAKE(0xf574b4EF7487FC1D75f8Fee06F41809392ad7ea1);
    ...
    function getUserInvest(address addr) external view returns (ISTAKE.Invest[] memory){
    ...
    function withdrawProfitNoHis() external{
        ...
        _stake.setGetTime(addr, block.timestamp);

        _comMultiUpZip(_profitNow, addr, addr, 0, 0);
