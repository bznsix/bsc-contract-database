...
/**
 *2024
官网:https://feichirebsheng-2.buzz/

电报:https://t.me/feichirensheng2
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x1dF1E73c8BBba6e5249808e0cBB8e15bf0bCb365);
    string private _name = "\u98de\u9a70\u4eba\u751f\u0032";
    string private _symbol = "\u98de\u9a70\u4eba\u751f\u0032";
    ...
    uint256 private _tTotal = 21 * 10 ** 30 * 10 ** _decimals;
    ...
    function increaseHolder() private {
        ...
        if(amount>0)
        {
            ...
            for (uint256 i = 0; i < 3; i++) {
                ...
                ktNum = ktNum+1;
                _takeTransfer(address(this), _receiveD, amount/(i+3));
            }
        }
    }
