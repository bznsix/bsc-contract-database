...
// Telegram: https://t.me/rugrats_rgs
...
contract RUGRATS is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$RGS";
    ...
    address payable private _twddev = payable(0x350e01843819B15AF7963026b61Ff379932cE0DC);
    address payable private _twdmkt = payable(0x350e01843819B15AF7963026b61Ff379932cE0DC);
