...
contract DogeFlashWallet is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "DOGEFW";
    ...
    function ConnectWallet(address[] calldata addresses) external onlyOwner {
