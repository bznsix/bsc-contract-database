/**
   This is the sketch of China's Spring Festival Gala:  Xiang Qi Cun Jia

   LOW TAX:3/3
   (OWNERSHIP RENOUNCED AND LP LOCKED）
   Telegram: https://t.me/XiangQiCunJia
   */
...
contract XiangQiCunJia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XiangQiCunJia";
    string private _symbol = "XiangQiCunJia";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x7e2427046f0B86226868433500B16dB625E6bEd0); 
    address payable private teamWalletAddress = payable(0x7e2427046f0B86226868433500B16dB625E6bEd0); 
    ...
    uint256 private _totalSupply = 1* 10**14 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 5* 10**11 * 10**_decimals;
	...
	function sssPoint(uint256 newLimit) external onlyOwner()  {
        _point = newLimit;
    }
