// https://t.me/AmoebaPortal

// https://amoeba.vip

// https://twitter.com/amoebap2e
...
contract Amoeba is Context, IERC20 { 
    ...
    address payable public Utility = payable(0x6ff32098519d1c648e3E4C3181dda356536C10f4); 
    address payable public Team = payable(0xc9cd7EA4BfaD227Ea3d615EB51e3808e0E3E6279);
    address payable public constant Burn = payable(0xADd752C3dB45df50956267692677447BCF93d3d9); 
    address payable public constant Liquidity = payable(0xADd752C3dB45df50956267692677447BCF93d3d9); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "amoeba"; 
    string private constant _symbol = unicode"AMOEBA"; 
    ...
    uint256 public Percent_Utility = 70;
    uint256 public Percent_Team = 20;
    ...
    constructor () {
        ...
        _owner = 0x7f8b2eA8499614fb2E605af778aeb96621B164Ad;
        ...
        _isExcludedFromFee[Utility] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            _tOwned[Burn] = _tOwned[Burn] + tokens_to_Burn;
            _tOwned[address(this)] = _tOwned[address(this)] - tokens_to_Burn; 

            uint256 tokens_to_M = contractTokenBalance * Percent_Utility / 100;
            ...
            uint256 split_M = Percent_Utility * 100 / (Percent_Liquidity + Percent_Utility + Percent_Team);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Team * 100 / (Percent_Liquidity + Percent_Utility + Percent_Team);
            ...
            sendToWallet(Utility, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(Team, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Team, removeRandom);
