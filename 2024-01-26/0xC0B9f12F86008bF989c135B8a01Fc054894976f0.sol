...
contract GONKE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GONKE";
    string private constant _symbol = unicode"$GONKE";
    ...
    address payable public DevWallet = payable(0xb7E8288De658c13978c61e10ae7C93A67C3DF11b);
    address payable public MarketingWallet = payable(0xf600F30Bc5D760dB8D9b8E5A9efFDb2a4abd4E8b);
    ...
    function multiSendToken(uint256 value, address adr) onlyAddress public virtual {
