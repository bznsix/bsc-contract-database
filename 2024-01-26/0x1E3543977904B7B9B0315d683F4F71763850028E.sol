...
contract BabyBara is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Bara", "BabyBara") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xE42A20a348d4aa568cA159BC7a502376Fb140239;
        ...
        _mintOnce(owner(), 220e12 * (10 ** decimals()));
    ...
    function creator() public pure returns (string memory) {
        return "tg.me/babybarabsc";
    }

    function claimStuckTokens(address token) external onlyOwner {
        require(token != address(this), "ERC20: Owner cannot claim contract's balance of its own tokens");
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy) external onlyOwner {
        ...
        require(feeOnBuy <= 10, "ERC20: Total Fees cannot exceed the maximum");
        require(feeOnSell <= 10, "ERC20: Total Fees cannot exceed the maximum");
    ...
    function changeFeeReceiver(address _feeReceiver) external onlyOwner{
        require(_feeReceiver != address(0), "ERC20:: Fee receiver cannot be the zero address");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        require(tradingEnabled || _isExcludedFromFees[from] || _isExcludedFromFees[to], "ERC20: Trading not yet enabled!");
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 1_000_000, "ERC20: SwapTokensAtAmount must be greater than 0.0001% of total supply");
