...
contract TangYuan is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public constant treasury = 0x95c3887Caf265943384291a413C901bD8120075F;
    address public marketingAddr = 0x95c3887Caf265943384291a413C901bD8120075F;

    mapping(address => bool) public exemptFee;
    mapping(address => bool) public blclist;

    uint public mintFee = 5 * 1e15;
    ...
    constructor() ERC20("TangYuan", "tanyuan") {
        ...
        uint totalSupply_ = 30000000 * 1e18;
    ...
    receive() external payable {
        ...
        super._transfer(address(this), msg.sender, 3000000 * 1e18);
    }
