...
contract LiquiFi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x467D8bA84b78490b34D2307C7a2027ce8c2EFA15); 
    address payable private Wallet_Dev = payable(0x92827337045d342779Fe788fC0bD155D3878dE53);
    ...
    string private constant _name = "LiquiFi"; 
    string private constant _symbol = "liquiFi"; 
    ...
    uint256 private Percent_Marketing = 66;
    uint256 private Percent_Dev = 1;
    uint256 public Percent_Burn = 1;
    uint256 private Percent_AutoLP = 32; 
    ...
    constructor () {
        ...
        _owner = 0x92827337045d342779Fe788fC0bD155D3878dE53;
