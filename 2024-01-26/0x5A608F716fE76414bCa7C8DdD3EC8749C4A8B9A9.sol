...
contract SAFEMOONFI is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x63dFd3C750D9c5251f389cc6d58456Ed9eb2C942);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 3;
    uint256 private _tTotal =1 * 10**3* 10**3 * 10**_decimals;
    ...
    uint256 public Percent_Burn = 30;
    ...
    constructor () {
        _owner =0x63dFd3C750D9c5251f389cc6d58456Ed9eb2C942;
