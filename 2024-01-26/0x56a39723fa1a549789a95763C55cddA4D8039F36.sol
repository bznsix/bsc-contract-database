...
contract cnm is ERC20, Ownable{
    ...
    address public marketingWallet = 0x5D9499d6a336d6fE8c2731b24CF798c5Ec943fc4;
    ...
    constructor() ERC20("Grok Father", "Grok Father") {
    ...
    function setTaxes(uint256 _marketing, uint256 _liquidity, uint256 _burn) external onlyOwner{
        require( _burn + _marketing + _liquidity <= 10, "Tax too high");
