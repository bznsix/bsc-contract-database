...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B928db9062a7cFc54bb3dd7fE66598be3C751BA; // owner address
...
contract BEBE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x6B928db9062a7cFc54bb3dd7fE66598be3C751BA); // Marketing Address
    address payable private teamWalletAddress = payable(0x6B928db9062a7cFc54bb3dd7fE66598be3C751BA); // Team Address
