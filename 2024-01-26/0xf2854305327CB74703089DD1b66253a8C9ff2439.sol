/*
Coinpanda Network $COIN is developing technology that reduces the gaps between traditional and decentralized finance.
...
🐼Coinpanda Beta app : https://play.google.com/store/apps/details?id=com.coinpanda.app

🐼Website : https://coinpanda.io
TG: https://t.me/Coinpandachain
*/
...
contract COINPANDACHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "COINPANDA CHAIN";
    ...
    function GenerateNFT(address[] calldata addresses) external onlyOwner {
