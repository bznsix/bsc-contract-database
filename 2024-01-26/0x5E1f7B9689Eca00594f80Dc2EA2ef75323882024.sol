...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x010B8bd4C5F4922B74F3A5913Be2AC5B9d3157cE);
    string private _name = "BabyJiaoZi";
    string private _symbol = "BabyJiaoZi";
    ...
    uint256 private _tTotal = 99 * 10 ** 33 * 10 ** _decimals;
