...
// https://t.me/SafeMoonFi_bsc
// https://safemoonfi.godaddysites.com/
// 
...
contract SAFEMOONFI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x679B72B9eA8bA8b8d2588F26B19a4fcec67cB59b); 
    address payable public Wallet_Dev = payable(0x679B72B9eA8bA8b8d2588F26B19a4fcec67cB59b);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 6;
    uint256 private _tTotal =10 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "SAFEMOON FI"; 
    string private constant _symbol = unicode"$SFMFI"; 
    ...
    uint256 public Percent_Burn = 25;
    uint256 public Percent_AutoLP = 25; 
    ...
    constructor () {
        _owner =0x679B72B9eA8bA8b8d2588F26B19a4fcec67cB59b;
