/**
//
https://t.me/BabyWifhatdogOfficialBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Fc00d6b6c2627e9e7e0653ec7B73A1F4ea36fEA; // owner address
...
contract BABYWIFHATDOG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Wifhatdog";
    string private _symbol = "BWHF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0Fc00d6b6c2627e9e7e0653ec7B73A1F4ea36fEA); // Marketing Address
    address payable private teamWalletAddress = payable(0x0Fc00d6b6c2627e9e7e0653ec7B73A1F4ea36fEA); // Team Address
