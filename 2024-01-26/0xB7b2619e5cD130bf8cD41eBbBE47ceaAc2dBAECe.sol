 ...
 * @title COURAGE TOKEN
 * 
 * @notice This is a SAFU smart contract developed by Revoluzion for COURAGE TOKEN.
 * 
 ...
 *
 * @custom:SAFU Owner 0x3320070f8829d0Ba2Cff89680fadAb12c7b55AFE
 */
...
/**
 * @title COURAGE TOKEN Token Contract
 *
 * @notice COURAGE TOKEN is an extended version of ERC-20 standard token that
 ...
 */
contract COURAGETOKEN is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    Fee public buyFee = Fee(800);
    Fee public sellFee = Fee(800);
    ...
    string private constant NAME = "COURAGE TOKEN";
    string private constant SYMBOL = "COURAGE";
    ...
    uint256 public minSwap = 100_000_000_000 gwei;

    address public constant SAFU_OWNER = 0x3320070f8829d0Ba2Cff89680fadAb12c7b55AFE;

    address public projectOwner = 0x33cb13dDE7D07ac5F659516F035713F5B5f99777;
    address public marketingReceiver = 0x33cb13dDE7D07ac5F659516F035713F5B5f99777;
    ...
    /**
     * @notice Constructs the COURAGE TOKEN contract and initializes both owner
     * and project owner addresses. Deployer will receive 100,000,000,000,000 tokens after
    ...
    function autoRedeem(uint256 amountToRedeem) public swapping {
        if (amountToRedeem > circulatingSupply() * 100 / FEEDENOMINATOR) {
            revert CannotRedeemMoreThanAllowedTreshold(amountToRedeem, circulatingSupply() * 100 / FEEDENOMINATOR);
        }
