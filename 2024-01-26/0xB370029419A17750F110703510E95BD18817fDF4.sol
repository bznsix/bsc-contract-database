...
//--- Contract v3 ---//
contract KingWif is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x9714a4B82B966a1bE647D09F3a7A1814F688B956); // build: 0x9714a4B82B966a1bE647D09F3a7A1814F688B956
    address payable private devWallet = payable(0xd6653EfD6d8Eb17512614E4A319193F44AE596aC); // build: 0xd6653EfD6d8Eb17512614E4A319193F44AE596aC
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "King WIF";
    string constant private _symbol = "KINGWIF";
