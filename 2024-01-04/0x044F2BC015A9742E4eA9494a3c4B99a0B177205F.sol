...
contract DOGESATELLITE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb6edac945dFF91C2840f8157125B9c1BD285ee37); 
    address payable public Wallet_Dev = payable(0xAd96a770C5068673A5F97CAcFea31dc595709819);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "DOGE SATELITTE INU"; 
    ...
    constructor () {
        _owner =0xAd96a770C5068673A5F97CAcFea31dc595709819;
