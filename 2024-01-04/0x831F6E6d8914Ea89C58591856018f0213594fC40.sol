...
// Escanor Buy
// USDT Rewards
// Whitepaper: https://escanorbuy.gitbook.io/escanorbuy/
// Telegram: https://t.me/escanorbuy
...
contract Escanor is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    EscanorDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Escanor Buy", "ESBU") {
        marketingWallet = payable(0x43733a342797f3484576859f59626EcbCfA9cd76);
        devWallet = payable(0x24e6Eae04A48E47C7298D124214561AF29ec68E2);
        ...
        dividendTracker = new EscanorDividendTracker(
            payable(this),
            router,
        ...
        swapTokensAtAmount = totalTokenSupply / 20000; // 0.05%;
...
contract EscanorDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Escanor public EscanorContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EscanorContract = Escanor(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Escanor_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Escanor_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Escanor contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EscanorContract);

            uint256 prevBalance = EscanorContract.balanceOf(address(this));
            ...
            {
                uint256 received = EscanorContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EscanorContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
