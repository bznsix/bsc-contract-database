...
TELEGRAM: https://t.me/IncorgnitoAnn
TWITTER: https://twitter.com/Incorgnitobsc
*/
...
contract CORGI is Context, IERC20, Ownable {
    ...
    string private _name = "Wrapped Corgi";
    string private _symbol = "$Wcorgi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD848D317d067B38B1BC2DDE05e75b4385ff7b5ac); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xD848D317d067B38B1BC2DDE05e75b4385ff7b5ac); // Development Address
    ...
    uint256 public _sellDevelopmentFee = 10;
    ...
    uint256 private minimumTokensBeforeSwap = 25 * 10**9; 
