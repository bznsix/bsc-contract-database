...
//--- Contract v3 ---//
contract GrokCoin is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x5A3DE504ec3780F8cD085A4d273ac4E0838F2fb4); // build: 0x5A3DE504ec3780F8cD085A4d273ac4E0838F2fb4
    address payable private devWallet = payable(0xB49440549CaB4dD7315B8A5592Ba2244Fb7eAb95); // build: 0xB49440549CaB4dD7315B8A5592Ba2244Fb7eAb95
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Grok Coin";
    string constant private _symbol = "GrokCoin";
