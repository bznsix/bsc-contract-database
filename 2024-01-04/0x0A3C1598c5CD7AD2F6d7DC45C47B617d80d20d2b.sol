...
contract PlaybuxStampClaimVPR is Ownable, ReentrancyGuard {
    ...
    uint256 public constant FIRST_CLAIM_UNLOCK = 34947600; // 34947600

    // Time period for the second claim unlock (in seconds)
    uint256 public constant SECOND_CLAIM_UNLOCK = 35811600; // ((30*24*60*60)/3) + 34947600;
