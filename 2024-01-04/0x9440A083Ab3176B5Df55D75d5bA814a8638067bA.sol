...
/**
Website: https://www.worldrecordtoken.xyz/
Twitter: https://twitter.com/worldrecordbsc
Telegram:  https://t.me/worldrecordtokenportal
*/
...
contract WorldRecordToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x54b5272b8939c6C9726af5805263e004eEAc159a); // Marketing Address
        
    address payable public teamAddress =
        payable(0xfA6F9Cb1F4C5F1B2Fd1123bD8653FAdcfFb40507); // Team Address
        
    address payable public liquidityAddress =
        payable(0x54b5272b8939c6C9726af5805263e004eEAc159a); // Liquidity Address
    ...
    string private constant _name = "World Record Token";

    string private constant _symbol = "RECORD";
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 20, "Must keep taxes below 9%");
