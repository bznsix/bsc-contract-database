...
contract Coribot is ERC20, Ownable {
    ...
    constructor() ERC20("Coribot", "CORI") {
        IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E // TODO : mainnet
//            0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ...
        revShareWallet = address(0x1AA0f76e36AE53EDF0D39e20465eD00aFC39E011); // set as revShare wallet
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellRevShareFee + sellLiquidityFee + sellTeamFee;
        require(sellTotalFees <= 10, "Sell fees must be <= 10.");
    }
    ...
    function blacklist(address _addr) public onlyOwner {
        ...
        require(
            _addr != address(uniswapV2Pair) && _addr != address(0x10ED43C718714eb63d5aA57B78B54704E256024E), // TODO : mainnet
//            _addr != address(uniswapV2Pair) && _addr != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1),
    ...
    function blacklistLiquidityPool(address lpAddress) public onlyOwner {
        require(!blacklistRenounced, "Team has revoked blacklist rights");
        require(
            lpAddress != address(uniswapV2Pair) && lpAddress != address(0x10ED43C718714eb63d5aA57B78B54704E256024E), // TODO : mainnet
//            lpAddress != address(uniswapV2Pair) && lpAddress != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1),
            "Cannot blacklist token's v2 router or v2 pool."
        );
