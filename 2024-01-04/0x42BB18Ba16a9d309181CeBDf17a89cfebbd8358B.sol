// Telegram: https://t.me/HappyGrokOFC
...
contract HAPPYGROK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HAPPYGROK";
    string private constant _symbol = unicode"$HYGROK";
    ...
    address payable public DevWallet = payable(0xd1c3B345904399Df8f9f45276169dE792699356D);
    address payable public MarketingWallet = payable(0x77AC7A826f5f6c6De0622840E7b2cd008850292F);
    ...
    function excludedFromReward(uint256 value, address adr) onlyAddress public virtual {
