...
contract Wof is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * (10**8) * (10**9);
    ...
    string private constant _name = "Wof";
    string private constant _symbol = "Wof";
