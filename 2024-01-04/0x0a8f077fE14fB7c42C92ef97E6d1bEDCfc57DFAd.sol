...
/*
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. |
| |   ________   | || |  ___  ____   | || |              | || |  _________   | || |  _________   | || |     ______   | || |  ____  ____  | | | |      __      | || |     _____    | |
| |  |  __   _|  | || | |_  ||_  _|  | || |              | || | |  _   _  |  | || | |_   ___  |  | || |   .' ___  |  | || | |_   ||   _| | | | |     /  \     | || |    |_   _|   | |
| |  |_/  / /    | || |   | |_/ /    | || |    ______    | || | |_/ | | \_|  | || |   | |_  \_|  | || |  / .'   \_|  | || |   | |__| |   | | | |    / /\ \    | || |      | |     | |
| |     .'.' _   | || |   |  __'.    | || |   |______|   | || |     | |      | || |   |  _|  _   | || |  | |         | || |   |  __  |   | | | |   / ____ \   | || |      | |     | |
| |   _/ /__/ |  | || |  _| |  \ \_  | || |              | || |    _| |_     | || |  _| |___/ |  | || |  \ `.___.'\  | || |  _| |  | |_  | | | | _/ /    \ \_ | || |     _| |_    | |
| |  |________|  | || | |____||____| | || |              | || |   |_____|    | || | |_________|  | || |   `._____.'  | || | |____||____| | | | ||____|  |____|| || |    |_____|   | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | | | |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------' 

Quantum-Resilient Layer 1 Blockchain

zk-Tech AI leverages Layer 1 Blockchain to introduce unparalleled scalability, accommodating a high volume of transactions without compromising speed or efficiency.

https://zk-techai.xyz
https://twitter.com/zkTech_AI
https://t.me/zktechai
https://medium.com/@zk-techai
https://github.com/zk-techai
https://zk-tech-ai.gitbook.io/documentation-of-zk-tech-ai
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeA33247B75AFd6d8Ed01bd5B8c3578B26F341765;
...
contract zkTechAINetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public ZTAIN_Wallet = payable(0xAdD24Cd1Ab109C6410bD9aBE6b9195ac2846b133);
    ...
    */
    ...
    string private _name = "zkTechAI Network"; 
    string private _symbol = "ZTAIN";  
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[ZTAIN_Wallet] = true;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(ZTAIN_Wallet,contractBNB);
    }
