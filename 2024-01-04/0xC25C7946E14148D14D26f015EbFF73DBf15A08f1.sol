...
//--- Contract v3 ---//
contract BestNew is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 10_000_000_000_000 * 10**18;
    ...
    address payable private marketingAddress = payable(0x4e51d850Ed68730C67583Ff20083060e70e5e026); // build: 0x15cBC24c15e7a6e35b1125E7A453c71C7bE7fFcF
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Best New";
    string constant private _symbol = "BSN";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0x8F0794b0aE1B9e57312ca3cEabCA255E248a9966;
    ...
    constructor () {
        ...
        balance[0x8014Be007090e99fd7F96AC00b1F5cE4B398388D] = (_totalSupply * 30) / 100;
        emit Transfer(address(0), 0x8014Be007090e99fd7F96AC00b1F5cE4B398388D, (_totalSupply * 30) / 100);
