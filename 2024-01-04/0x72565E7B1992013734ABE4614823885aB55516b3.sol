...
contract LILIS is ERC20Base, ReentrancyGuard {
    uint256 public initialSupply = 10000000000 * (10 ** uint256(decimals())); //initial amount of tokens to be minted

    constructor() payable ERC20Base("LILIS", "LILI") {
