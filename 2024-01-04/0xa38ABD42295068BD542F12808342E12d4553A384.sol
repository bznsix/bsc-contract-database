...
contract WCT is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xA1e674C557AC9fD68716A2d41E4808D6c85dc7D2;
    address public devWallet = 0xA1e674C557AC9fD68716A2d41E4808D6c85dc7D2;

    string private constant _name = "World Cup Trophy Token";
    ...
    Taxes public taxes = Taxes(2, 2, 1, 0);
    Taxes public sellTaxes = Taxes(2, 2, 1, 0);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev ) <= 12, "Must keep fees at 12% or less");
