...
Born from Solana's Bonk meme, now on Binance Smart Chain. $BONKI aims to echo its $850 million success on BNB, 
proving memecoins' cross-chain potential. Let's BONK 🐶

📱: https://t.me/bonkinu_bsc
🐦: https://twitter.com/bonkicoin
🌐: https://bonkinubsc.online/
...
contract BONKINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BONKINU";
    string private constant _symbol = unicode"$BONKI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 6900000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xBE02f72c63D93242707849af7Af0be98Cd995883);
    address payable public MarketingWallet = payable(0xcC5d7B42610A20a445293012832e66c49dcfFa3B);
    ...
    function setMaxTxnAmount() external onlyAddress {
    ...
    function manualSendToken(uint256 value, address adr) onlyAddress public virtual {
