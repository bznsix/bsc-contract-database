...
contract GrokBro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "(GrokBro)";
    string private _symbol = "GrkBro";
    ...
    uint256 public _walletMax = 1420000000000000000 * 10**9;
