...
abstract contract IYSSNFT is IERC721 {

     function mint(address to) external virtual returns(uint256);
     
     function change(address from,address to,uint256 tokenId) external virtual;
}// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
import "./interfaces/IYSSNFT.sol";

contract YSSNFT is AccessControlEnumerable,ERC721Burnable,ERC721Pausable,IYSSNFT{
    ...
    constructor() ERC721("WGL NFT", "WGL") {
        baseTokenURI = "https://remix.ethereum.org/";
    ...
    function setBaseTokenURI(string memory _baseTokenURI) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NFT: Must have admin role to chande baseURI");
    ...
    function mint(address to) public override returns(uint256){
        require(hasRole(MINTER_ROLE, _msgSender()), "NFT: error");
    ...
    function change(address from,address to,uint256 tokenId) public override{
        require(hasRole(MINTER_ROLE, _msgSender()), "NFT: error");
        _transfer(from, to, tokenId);
    }
