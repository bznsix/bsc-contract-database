...
contract GaiaSwap is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IERC20 public immutable NewToken = IERC20(0x37063b2730dE3eEEDC760b9C1C9c8C84A37f8143);
    IERC20 public immutable NewLP = IERC20(0x5dd4F52287b6FD031C8b8409C7A9A0395f9Dde87);
    IERC20 public immutable OldToken = IERC20(0x72A350D47e899793218d8afdA1aA834b6Fc042c6);
    IERC20 public immutable OldLP = IERC20(0x64bb261E626aF28F9A0f794d2E70178701B04138);
