/**
https://t.me/SHIBAINU2024OFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD00e1BBBE0064A469Aa43C1703149004457868a; // owner address
...
contract SHIBAINU2024 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Inu 2024";
    string private _symbol = "SI24";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcD00e1BBBE0064A469Aa43C1703149004457868a); // Marketing Address
    address payable private teamWalletAddress = payable(0xcD00e1BBBE0064A469Aa43C1703149004457868a); // Team Address
