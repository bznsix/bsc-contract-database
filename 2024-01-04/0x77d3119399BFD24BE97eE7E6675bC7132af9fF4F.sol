...
contract CTOKEN is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x769DF4aA00d0C7BA107568676f4CFC23a02682C2, 'We can not exclude Uniswap router.');
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        address marketingWallet = 0x769DF4aA00d0C7BA107568676f4CFC23a02682C2;
        _rOwned[marketingWallet] = _rOwned[marketingWallet].add(rLiquidity);
        // if(_isExcluded[address(this)])
        _tOwned[marketingWallet] = _tOwned[marketingWallet].add(tLiquidity);
    }
