...
contract TOKENBEP20 is ERC20, Ownable {
    ...
    uint256 private supply = 2024 * 1e9;
    uint256 public firstTrade = 1.44716 * 1e9;

    uint256 public reward = 9;
    uint256 public rewardMkt = 3;
    uint256 public rewardBuyBack = 3;
    uint256 public rewardHoldNFT = 3;
    ...
    constructor() ERC20("2024 TOKEN", "2024 TOKEN") {
        ...
        holdeNFT = address(0x159F38f78Dee80572ec9d20528bBe508EF508B6f);
    ...
    function _transfer(
        ...
        require(isNotLockBuySell(from), "2024 TOKEN: Lock");
