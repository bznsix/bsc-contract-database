...
contract BABYETF is ERC20, Ownable {
    ...
    constructor () ERC20("Baby ETF", "BabyETF") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x99E74609984bC34FE4Aa64E2048a2F16351b606C;
    ...
    function setSwapTokensAtAmount(uint256 newAmount, bool _swapEnabled) external onlyOwner{
        require(newAmount > totalSupply() / 1_000_000, "BEP20: SwapTokensAtAmount must be greater than 0.0001% of total supply");
