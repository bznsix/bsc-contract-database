...
contract TokenWPC is TokenBurnable, Excludes, Ownable {
    ...
    function setSwapFeeLimit(uint256 limit) external onlyOwner {
        swapFeeLimit = limit;
    }
    ...
    function _swapFee() private lockSwap {
        ...
        if (totalFee > swapFeeAt) {
            ...
            if (swapFeeLimit > 0) {
                uint256 currentPrice = getPrice4USDT(1 ether);
                canSell = swapFeeLimit.mul(1 ether).div(currentPrice);
