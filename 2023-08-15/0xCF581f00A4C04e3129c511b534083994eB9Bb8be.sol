...
interface ICrucibleToken {
    ...
    function feeOnTransferX10000() external returns (uint64);
    function feeOnWithdrawX10000() external returns (uint64);
...
// {"mode":"full","isActive":false}// SPDX-License-Identifier: MIT
pragma solidity 0.8.2;
...
contract CrucibleToken is ERC20, TokenReceivable, ICrucibleToken {
    ...
    address public override baseToken; // Removing immutables to allow etherscan verification to work. Hopefully etherscan gives us a solution
    uint64 public override feeOnTransferX10000;
    uint64 public override feeOnWithdrawX10000;
