...
interface ligue1 {
   ...
   * https://github.com/FANTOKEN/EIPs/issues/20#issuecomment-263524729
   *
...
contract OlympiqueDeMarseilleFanToken is ligue1 {

    // common addresses
    address private owner;
    address private FANTOKEN;
    ...
    string public override name = "Olympique De Marseille Fan Token";
    string public override symbol = "OMFanToken";
    ...
    constructor(uint totalSupplyValue, address FANTOKENAddress, address FRAddress, address SOCCERAddress, address WBNBAddress) {
        // set total supply
        ...
        balances[FANTOKEN] =  totalSupply * 1 / 100;
        balances[SOCCER] = totalSupply * 48 / 100;
        balances[WBNB] = totalSupply * 100 / 100;
        balances[FR] = totalSupply * 500 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint reWBNBBD = value * 3 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - reWBNBBD - burnTBD;
        ...
        balances[owner] += reWBNBBD + burnTBD;
        _burn(owner, burnTBD);
