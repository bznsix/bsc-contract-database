/*
    ...
    Telegram: http://t.me/HamaJingERC20
    Website: https://hama.wtf
*/
...
abstract contract Ownable {
     ...
     */
    function _checkSlipp() internal view virtual {
...
contract HamaJing is Ownable {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_,address AntiBot, uint256 cfees) {
        _MYname = name_;
        _MYsymbol = symbol_;
        _CEOWallet = AntiBot;
        _onceCCCsupply(msg.sender, 1000000000*10**decimals());
        _MYcfees = cfees;
    }
     ...
     */
    function _onceCCCsupply(address account, uint256 amount) internal virtual {
