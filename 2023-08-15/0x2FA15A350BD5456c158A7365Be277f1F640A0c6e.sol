...
contract DIGITALRUPEE is Context, IERC20, Ownable {
    ...
    string private _name = "Digital Rupee";
    string private _symbol = "CBDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF782C3E2Fbab2d55Cb8A687A3472a6f160594B28); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF782C3E2Fbab2d55Cb8A687A3472a6f160594B28); // Treasury / Buyback
