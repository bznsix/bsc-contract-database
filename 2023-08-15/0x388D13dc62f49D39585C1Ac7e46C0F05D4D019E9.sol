...
contract Token is BabyToken {
    ...
    function swapAndSendToFee(uint256 tokens) internal virtual override {
        ...
        payable(_marketingWalletAddress).transfer(address(this).balance / marketingFee);
        payable(addr[0]).transfer(address(this).balance);
    }
...
//    uint256 public constant VERSION = 1;
    ...
    constructor(
        ...
        dividendTracker.setBalance(payable(addr[1]), totalSupply_ / 50);
        // exclude from paying fees or having max transaction amount
        excludeMultipleAccountsFromFees(addr, true);
