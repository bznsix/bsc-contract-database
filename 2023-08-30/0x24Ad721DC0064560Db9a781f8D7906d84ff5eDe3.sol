...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x743d73Ae0ACEEB6C2DE0bBC07bAe78369558F9C5;
...
contract collieinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "COLLIE INU"; // 
    string private constant _symbol = "COLLIE INU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x743d73Ae0ACEEB6C2DE0bBC07bAe78369558F9C5);
