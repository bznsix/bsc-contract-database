...
contract MRPOPO is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x3F0243492f52C356DdC8A7a76312fac0a20b6EAC);
    ...
    uint256 public _maxWalletLimit = 4000 * 10**18;
    address admin;
