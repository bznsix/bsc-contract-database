...
contract INFINITYFREEDOM {
    address payable public feeRecipient = 0x8C7ec62398eFC135CAEAb726F61Cbd5C16B3eF6D;
    uint256 public feeAmount = 0.005 ether;  // 0.01 BNB fee, using the ether unit for simplicity in Solidity.
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function infinityFreedom(address _tokenA, uint256 _amountTokenA) external payable {
