...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9728Ed11b29C05C7B93664B4530DeD1004E50C8D; // owner address
...
contract ChronosNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chronos Network";
    string private _symbol = "CHRONOS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9728Ed11b29C05C7B93664B4530DeD1004E50C8D); // Marketing Address
    address payable private teamWalletAddress = payable(0x9728Ed11b29C05C7B93664B4530DeD1004E50C8D); // Team Address
