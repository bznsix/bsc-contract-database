...
contract test is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2A8977929b92ea86b93ECbEe0706D4e887a17ADf);
    address payable private _marketingAddress = payable(0x4383799f323a9fC2D6488D7274CD43A81180826f);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != _developmentAddress && from != _deadWallet && to != _developmentAddress && to != _deadWallet) {
