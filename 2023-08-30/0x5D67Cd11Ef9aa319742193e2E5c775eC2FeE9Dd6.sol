...
contract FarmerCryptoLock is Ownable {
    struct Lock {
    ...
    function lockToken(
        ...
        // privateSale
        lockProfile[privateSale][tokenContract].lockedAmount = 1_000_000 ether;
        lockProfile[privateSale][tokenContract].initialAmount = 250_000 ether;
        lockProfile[privateSale][tokenContract].unlockPeriod = 30 days;
        lockProfile[privateSale][tokenContract].unlockedAmountPerPeriod = [250_000 ether];

        // marketing
        lockProfile[marketing][tokenContract].lockedAmount = 2_400_000 ether;
        lockProfile[marketing][tokenContract].initialAmount = 720_000 ether;
        lockProfile[marketing][tokenContract].unlockPeriod = 30 days;
        lockProfile[marketing][tokenContract].unlockedAmountPerPeriod = [720_000 ether, 480_000 ether];

        // team
        lockProfile[team][tokenContract].lockedAmount = 2_000_000 ether;
        lockProfile[team][tokenContract].unlockPeriod = 365 days;
        lockProfile[team][tokenContract].unlockedAmountPerPeriod = [2_000_000 ether];

        // 1_000_000 + 2_400_000 + 2_000_000 = 5_400_000
        tokenContract.transferFrom(msg.sender, address(this), 5_400_000 ether);
    }
    ...
    function lockLiquidity() public onlyOwner {
        ...
        lockProfile[msg.sender][liquidityContract].unlockPeriod = 365 days;
