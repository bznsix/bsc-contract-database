...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x875bA6aAd29fD63E05f450823b9Aadbb2680f67E;
    uint8 public marketingTax = 13;
    ...
    {
        require(tax <=15,"Cannot set the fee more than 15%");
        marketingTax = tax;
    }
...
contract Pepe5G is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Pepe 5G", "PEPE5G", 9) {
    _owner = msg.sender;
