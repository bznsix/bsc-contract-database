...
//////
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(0.01 ether, 1, 2));
        plans.push(Plan(0.02 ether, 1, 4));
        plans.push(Plan(0.03 ether, 1, 10));
        plans.push(Plan(0.04 ether, 1, 500));
        plans.push(Plan(0.05 ether, 1, 500));
        plans.push(Plan(0.06 ether, 1, 500));
        plans.push(Plan(0.07 ether, 1, 500));
        plans.push(Plan(0.08 ether, 1, 500));
        plans.push(Plan(0.09 ether, 1, 500));
        plans.push(Plan(0.10 ether, 1, 500));
        plans.push(Plan(0.11 ether, 1, 500));
        plans.push(Plan(0.12 ether, 1, 500));
...
if (user.referrer == address(0))
 ...
 //if(block.timestamp >= plans[plan].time)
