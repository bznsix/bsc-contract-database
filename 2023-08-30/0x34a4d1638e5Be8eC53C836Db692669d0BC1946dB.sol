// Telegram: https://t.me/SHIBAvsPEPEbsc
...
contract $SHEPE is Context, IERC20, Ownable {
    ...
    address payable private shepedev = payable(0xc8FB8812325Cce57d41C77b1D9838bc5FE051F8B);
    address payable private shepemkt = payable(0xc8FB8812325Cce57d41C77b1D9838bc5FE051F8B);
    ...
    constructor () {
        ...
        _isExcludedFromFee[shepedev] = true;
        _isExcludedFromFee[shepemkt] = true;
    ...
    function setBuyFees(uint256 newBuyFee, uint256 newRedisBuyFee) public onlyOwner {
        ...
        require(_taxFeeOnBuy < 7, "Tax can't be set more than 7%");
        require(_taxFeeOnSell < 7, "Tax can't be set more than 7%");
    }
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        shepedev.transfer(dAmount);
        shepemkt.transfer(mAmount);
    }
