...
contract Tic is Context,IERC20Metadata {

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    //mainnet: 
    string private constant _name = "TUSDT";
    //mainnet: 
    string private constant _symbol = "TUSDT";
    
    uint256 private _totalSupply = 1200000000 * 1e18;
