...
contract DogCoin is ERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 999_999 * 1e18;
    ...
    //Taxes
    Tax public buyTaxes = Tax(4, 3);
    Tax public sellTaxes = Tax(4, 3);
    uint256 public totalBuyFees = 7;
    uint256 public totalSellFees = 7;
    ...
    //Wallets
    address public marketingWallet = 0x01e93Caa25Aa5575d30d354F05D383C3F47F5F9f;
    ...
    constructor() ERC20("Dog Coin", "DogCoin") {
        address newOwner = 0x7A1E8Cc6f9c49aBeD872EdE36E72878b95118B48;
    ...
    function setSwapTokensAtAmount(uint256 _newAmount) external onlyOwner {
        require(
            ...
            "DogCoin : Minimum swap amount must be greater than 0 and less than 1% of total supply!"
        );
