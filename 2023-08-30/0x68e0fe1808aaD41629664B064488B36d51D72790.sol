...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x973B5D283Aab9cE41c7eEa333F44a0275E853076; 
...
contract XTESLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X TESLA";
    string private _symbol = "XTESLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x973B5D283Aab9cE41c7eEa333F44a0275E853076);
    address payable public teamWalletAddress = payable(0x973B5D283Aab9cE41c7eEa333F44a0275E853076); 
    ...
    uint256 public _sellteamFee = 19;
