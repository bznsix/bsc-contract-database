...
contract AddLiquidity {
    address payable public feeRecipient = 0xc6B5428B4426d934A56A7bFBa6Df5390CFcf9017;
    uint256 public feeAmount = 0.01 ether;  // 0.03 BNB fee, using the ether unit for simplicity in Solidity.
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function AddLP(address _tokenA, uint256 _amountTokenA) external payable {
