...
Join us in exploring the quantum realms of humor, where memes defy expectations and laughter knows no bounds. 
Let's journey together through the uncertain and hilarious universe of Schrödinger's Cat! !

9% Tax
1% Reflection
2% Max wallet
LP will be locked
Ownership will be renounced and dev wallet will be unauthorized. 100% Safe!
Launching today.
Safe dev with good previous projects.

https://t.me/SchroedingersCatBSC

https://t.me/wenSevenFigs
...
contract SchrodingersCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SCHRODINGERS CAT";
    string constant _symbol = "SCHRODINGERSCAT";
    ...
    uint256 _totalSupply = 10* 10**7 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 2 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xC61e5DB102a577c6Ca9cC676407d10459D44D371;
        marketingWallet = 0x9A03F1A1e3eCd88747B5245868BC7E69b19593C0;
        devWallet = 0xC61e5DB102a577c6Ca9cC676407d10459D44D371;
