/**
   welcome to NothingCoin, $4 inital MC
   0.1% lp tax
   no marketing
   no dev fee
   no rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Shiba
...
contract NothingCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Shiba
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Nothing";
    string constant _symbol = "No";
    ...
    uint256 public totalFee = 1; //Total Fee
    ...
    uint256 public totalFeeBuy = 1; //Total Fee
    uint256 feeDenominatorBuy  = 1000;
    ...
    uint256 public totalFeeSell = 1; //Total Fee
