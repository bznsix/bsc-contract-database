...
contract SchrdingersCat is Context, IERC20 {
    string private _name = unicode"Schrödingers Cat";
    string private _symbol = "DINGERSCAT";
    ...
    uint256 public _maxTransactionAmt = _tTotal * 3 / 100;
    uint256 public _maxWalletToken = _tTotal * 3 / 100;

    uint256 public _buy_free = 15;
    uint256 public _sell_free = 30;
    ...
    address payable public MarketingWallet = payable(0x0Bc938A3e0c8b17FaEEE665fdDc49e86Eb76fA73);
