...
contract BurnaBurna is Context, IERC20, Ownable {
    ...
    string private _name = "Burnaburna";
    string private _symbol = "BBURNA";
    ...
    uint256 public _maxWalletBalance = 10000000000 * 10**18;
    ...
    if (to != address(uniswapV2Pair) && !_isExcludedFromFee[to]) {
