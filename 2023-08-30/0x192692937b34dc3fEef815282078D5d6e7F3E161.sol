...
/**
https://t.me/fiveium
Fiveium is an innovative platform that harnesses the power of blockchain to revolutionize the way projects are build, managed and scaled
...
contract Fiveium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fiveium";
    string private _symbol = "FVM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFEda1730CB2f1cB64A82E5BFbb41AE03400937B2);
    address payable private DevelopmentWalletAddress = payable(0xFEda1730CB2f1cB64A82E5BFbb41AE03400937B2);
    ...
    uint256 public _walletMax = 30000 * 10**9;
