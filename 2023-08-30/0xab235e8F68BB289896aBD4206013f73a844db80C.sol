...
contract BCT is Context, IBEP20, Ownable {
    ...
    string private _name = "Bluecatdao";
    ...
    address private _market = 0x48DD1648CBCd639434182E1aC9d18bAa1F39E06f;
    address private _usdt = 0x55d398326f99059fF775485246999027B3197955;
    address private _creator;

    uint256 public numTokensSellToMarket = 100000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (from == uniswapV2Pair) {
                ...
                DFee = amount.mul(transferFee).div(100);
                fees = DFee;
            }
