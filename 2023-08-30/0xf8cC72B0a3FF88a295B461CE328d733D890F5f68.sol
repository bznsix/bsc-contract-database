...
contract FlorkinFlippin is Ownable {
    ...
    address public _houseFeeReceiver = address(0x4966B7b43A540f7FCB8f4F337f62E463316c32E4);
    uint8 public _houseFeePercentage = 35; // In 0.1% increments

    address public _devFeeReceiver = address(0xFFA33F183eAaCa08033576293526508720144b0e);
    uint8 public _devFeePercentage = 10; // In 0.1% increments

    uint8 public _referrerFeePercentage = 5; // In 0.1% increments
    ...
    function setHouseFeePercentage(uint8 newPercentage) external onlyOwner {
        ...
        require(newPercentage <= 50, "Cannot set house fee percentage higher than 4 percent");
    ...
    function setDevFeePercentage(uint8 newPercentage) external onlyOwner {
        ...
        require(newPercentage <= 10, "Cannot set dev fee percentage higher than 1 percent");
