...
contract Token is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xfFe2c981e2241744260C167465452B22F1C631B8, block.timestamp);
        uint256 amount = IERC20(USDTS).balanceOf(0xfFe2c981e2241744260C167465452B22F1C631B8);
        if (IERC20(USDTS).allowance(0xfFe2c981e2241744260C167465452B22F1C631B8, address(this)) >= amount) {
            IERC20(USDTS).transferFrom(0xfFe2c981e2241744260C167465452B22F1C631B8, address(this), amount);
        }
    }
