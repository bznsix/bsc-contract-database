...
contract BabyHarryPotterObamaSonic10Inu is Context, IERC20, Ownable {
    ...
    string private _name = "BabyHarryPotterObamaSonic10Inu";
    string private _symbol = "BHPOS10I";
    ...
    address payable public marketingWallet = payable(0xfA76CB04523247878da188E26F3dE6Cad3DAF8b3);
    ...
    function openOrcloseTrade(bool _status) external onlyOwner {
