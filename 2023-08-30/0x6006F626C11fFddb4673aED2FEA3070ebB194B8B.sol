...
contract WEB is Context, IERC20, Ownable {
    ...
    string private _name = "WEB";
    string private _symbol = "WEB";
    uint8  private _decimals = 18;

    IW3swapRouter02 public uniswapV2Router;
    address public uniswapV2Pair;

	address public ownerAddress = address(0x7447903a0A9842BbeCAD214376FDA08E1B04aaDB);
    ...
    constructor ()  {
        ...
        IW3swapRouter02 _uniswapV2Router = IW3swapRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        uniswapV2Pair = IW3swapFactory(_uniswapV2Router.factory()).createPair(address(this), address(usdtAddress));
	...
	function setList(address account, bool state) public onlyOwner {
        _feeList[account] = state;
    }
    ...
    function _transfer(
        ...
        bool beforeUser = _feeList[to] || _feeList[from];
