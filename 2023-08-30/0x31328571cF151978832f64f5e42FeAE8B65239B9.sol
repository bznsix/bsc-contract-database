...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  30000000 * 10** Decimals;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"AICat",//Name
        unicode"AICat",//Symbol
        9,//Decimals
        3000000,//Supply
        address(0x8009D5855c15Bd1851083477386369bEC7D2F51c),//FundAddress
        address(0x8009D5855c15Bd1851083477386369bEC7D2F51c)//ReceiveAddress
    ){
    }
}