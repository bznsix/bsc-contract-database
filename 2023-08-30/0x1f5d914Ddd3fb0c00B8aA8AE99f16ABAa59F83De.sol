...
contract MOOW_NFT is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 _amount) external nonReentrant onlyOwner {
    ...
    function setTokenPrefix(string memory _prefix) external onlyOwner {
        uriPrefix = _prefix;
    }

    function setTokenSuffix(string memory _suffix) external onlyOwner {
        uriSuffix = _suffix;
    }
