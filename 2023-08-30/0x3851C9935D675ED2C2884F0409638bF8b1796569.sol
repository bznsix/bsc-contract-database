...
contract JG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8009D5855c15Bd1851083477386369bEC7D2F51c); 
    address payable public Wallet_Dev = payable(0x8009D5855c15Bd1851083477386369bEC7D2F51c);
    ...
    string private constant _symbol = unicode"AIPEPE"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 5; 

    uint256 public _Tax_On_Buy = 1;
    uint256 public _Tax_On_Sell = 99;
    ...
    constructor () {
        ...
        _owner = 0x8009D5855c15Bd1851083477386369bEC7D2F51c;
