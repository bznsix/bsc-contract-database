/*
// Telegram     : https://t.me/Spaceblockchain
// Website      : https://space-chain.tech/
// Twitter      : https://twitter.com/spacecoin2023
*/
...
contract Ownable is Context {
   ...
   constructor () {
        _owner = 0x55fCBd69aE63495c56E55bF3709a61fC7BD2223D;
...
contract SPACE is Context, IERC20, Ownable {
    ...
    string private  _symbol = unicode"SBN";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55fCBd69aE63495c56E55bF3709a61fC7BD2223D); // Marketing
    address payable public teamWalletAddress = payable(0x55fCBd69aE63495c56E55bF3709a61fC7BD2223D); // Team
    ...
    uint256 public _totalSupply = 2*1e8 * 10**_decimals;
    uint256 public MaxTxAmount = 2*1e6 * 10**_decimals; 
    uint256 public _walletMax = 2*1e6 * 10**_decimals;
    ...
    function set_Buy_Taxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyTeamFee);
        require(_totalTaxIfBuying <= 15_0, "Total fee is over 15%");
    }
    ...
    function set_Sell_Taxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee);
        require(_totalTaxIfSelling <= 15_0, "Total fee is over 15%");
    }
    ...
    function set_Max_Tx_Amount(uint256 newmaxTxAmount) external onlyOwner() {
        ...
        require(MaxTxAmount >= 200000, "Max TX is less than 2%");
    }
