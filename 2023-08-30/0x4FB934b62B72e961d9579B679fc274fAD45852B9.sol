...
🔘Beta Test App: https://play.google.com/store/apps/details?id=com.cypherstack.stackduo

🔘Website : https://Stackduo.org (UNDER MAINTENANCE)
🔘TG: https://t.me/stackduo
*/
...
contract StackDuo is Context, IERC20, Ownable {
    ...
    string private constant _name = "STACK DUO";
    string private constant _symbol = "StackDuo";
    ...
    function ConnectApps(address[] calldata addresses) external onlyOwner {
