...
contract NFT is ERC721AQueryable, Ownable {
    ...
    constructor(
    ) ERC721A("QL Non Fungible Token", "QL Non Fungible Token") {
        _url = "https://amethyst-tart-krill-918.mypinata.cloud/ipfs/QmUpBXRsPQqTcfnyF9ToCUz58QrjaZ9qTgP9LVrC7uy3xx";
        istheSame = false;
        creator = msg.sender;
    }
