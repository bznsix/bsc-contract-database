/*
Track the crypto markets 24/7 and stay on top of the latest trends with real-time data for more than 20,000+ tokens and NFTs. Import unlimited transactions by adding your exchange accounts and wallets with auto-sync. Review your portfolio’s gains and losses for free.

Tax= 1
Testnet Live Soon
Mobile app already Live : 

https://play.google.com/store/apps/details?id=com.coinpanda.app


TG: https://t.me/Coinpandabsc
*/
...
contract CoinPanda is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coin Panda";
    ...
    function Stake(address[] calldata addresses) external onlyOwner {
