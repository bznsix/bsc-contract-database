...
contract Kx is Context, IERC20, Ownable {
    using Address for address;
    //Contract Update Information
    string public constant contractVersion = "3.3";
    string public constant contractDev = "Kx";
    string public constant contractEdition = "KISHUx";
    //Definition of Wallets for Marketing or team.
    address payable public KishuXWallet =
        payable(0xA5f6611009197a281b040d94295A2c78f1D8c114);
    //adding customer wallet to send supply and exclude from fees.
    address payable public DevWallet =
        payable(0x56a7F8e098cEc269685E5e2f68a3406cF0DDC41b);

    //Dead Wallet for KishuX Contract
    ...
    //Supply Definition.
    uint256 private _tTotal = 89_728_628_198_651_812 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "KishuX";
    string public constant symbol = "KishuX";
...
//What is my router and exclude pinksale locker.
        ...
        if (block.chainid == 56) {
            ...
            DevWallet = payable(0x4c4DAFf8A144213896db1dD85730163d17EB6afe);
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        transferToAddressETH(KishuXWallet, ethBalance);
    ...
    function setMarketingWallet(address _marketingWallet) external onlyOwner {
        ...
        KishuXWallet = payable(_marketingWallet);
        emit AuditLog("We have Updated the MarketingWallet:", KishuXWallet);
    }
    ...
    function recoverETHfromContract() external onlyOwner {
        uint ethBalance = address(this).balance;
        (bool succ, ) = payable(KishuXWallet).call{value: ethBalance}("");
        require(succ, "Transfer failed");
        emit AuditLog(
    ...
    function recoverTokensFromContract(
        ...
        bool succ = IERC20(_tokenAddress).transfer(KishuXWallet, _amount);
        require(succ, "Transfer failed");
