/**
   X obtaining license required for crypto 
   payments and trading which most likely 
   means that DOGE will be the first one.
  TELEGRAM: https://t.me/XOGE_BSC
*/
...
contract XOGE is Context, IBEP2022, Ownable {
