...
contract GeneralStake is ReentrancyGuardUpgradeable, GovernanceUpgradeable {
    ...
    function initialize(
        ...
        _teamWallet = 0x9a53382d738e7f7a6F2D0a1DeDb9E867A1324ABd;
        _rewardPool = 0x9a53382d738e7f7a6F2D0a1DeDb9E867A1324ABd;
        _harvestInterval = 10;
        _teamRewardRate = 200;
        _poolRewardRate = 200;
        _baseRate = 10000;
    ...
    ) public updateReward(msg.sender) checkStart nonReentrant {
        uint256 tAmount;
    ...
    function notifyReward(
        uint256 reward
    ) external onlyGovernance updateReward(address(0)) {
