...
contract BUSDDRAGON is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUSD DRAGON";
    ...
    uint256 public _maxTxAmount =  _totalSupply * 6 / 200;
    uint256 public _walletMax = _totalSupply * 6 / 200;
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 5000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xc33da462DfC86317E7341C09F48d244550075420;
        buybackWallet = 0xc33da462DfC86317E7341C09F48d244550075420;
