...
// Telegram : https://t.me/avengersmemebsc
...
contract SpidermanHulkIronManThorCaptainAmericaBlackPanther is Context, IERC20, Ownable {
    ...
    uint256 private _redisFeeOnBuy = 24;
    uint256 private _taxFeeOnBuy = 1;
    
    uint256 private _redisFeeOnSell = 24;
    ...
    address payable private _twddev = payable(0x202a8dAd39885A7547b5135C6d1c778AC438149F);
    address payable private _twdmkt = payable(0x202a8dAd39885A7547b5135C6d1c778AC438149F);
    
    string private constant _name = "Spiderman Hulk Iron Man Thor Captain America BlackPanther";
    string private constant _symbol = "$AVENGERS";
