...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0x31322E5c581585E0BDbec6f3Af2df809D20466a5);
    address public  deadAddress = address(0xAB9f88214812402DBE9335bC9146326D44070127);
    ...
    uint256 private _marketShare = 50;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.mul(50).div(100));
        USDT.transferFrom(address(_tokenDistributor), teamAddress, fundAmount.mul(50).div(100));
...
contract FISTTT is AbsToken {
    constructor() AbsToken(
        ...
        18,
        210000,
        address(0xf8570b13FD1BF4Bf3149895236988Dc526896c7e),
        address(0xAecebe44b5D30FA7488AB7c36A711F28B15D8ef2),
        0
    ){
