...
contract catchus is ERC20Base, ReentrancyGuard {
    uint256 maxSupply = 1000000000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted

    constructor() payable ERC20Base("catchus ", "CATUS") {
        mint(msg.sender, 500000000000 * (10 ** uint256(decimals())));
    }
