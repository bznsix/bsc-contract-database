...
contract GOW39 is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("God Of Wealth", "GOW39") {
        ...
        reflectionTaxTransfer = 200;

        denominator = 10_000;

        devWallet = 0xD5cbcd1Fc9Ac65359492ea55FDd9BBb2b709BA3E;
        marketingWallet = 0x8742e493143cE2F484C32359Ee500c1203D36c7e;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 contractTax = devTax + marketingTax;
    ...
    function swapBack() internal inSwap {
        ...
        uint256 marketingBNB = newBalance - devBNB;
