...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0x71aB850DcA9Ec24171eE837642C9Dbf99E01018E);
...
contract BTCETF is Ownable, IBEP20 {
    ...
    uint256 public constant _totalSupply = 100 * 10**6 * 10**_decimals;
    ...
    address payable public marketingWalletAddress =
        payable(0x71aB850DcA9Ec24171eE837642C9Dbf99E01018E);

    uint256 public _buyingMarketingFee = 0;
    uint256 public _sellingMarketingFee = 5;
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**4 * 10**_decimals;
    uint256 public _maxWalletHoldingLimit = 2 * 10**6 * 10**_decimals;
    ...
    function isContractAddress(address wallet) internal view returns (bool) {
        uint32 size;
        assembly {
        ...
        onlyOwner
    {
        ...
        require(
            !isContractAddress(newMarketingWallet),
            "Wallet address shouldn't be contract address"
        );
    ...
    function updateSellingTaxFees(uint256 newMarketingSellFee)
        ...
        onlyOwner
    {
        require(newMarketingSellFee <= 5, "You can't set more than 5%");
