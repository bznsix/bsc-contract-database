...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5013d3D8874b5C8e1d97753238ee43f36fdfFD1; // owner address
...
contract GROKFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrokFi";
    string private _symbol = "GROKFI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF5013d3D8874b5C8e1d97753238ee43f36fdfFD1); // Marketing Address
    address payable private teamWalletAddress = payable(0xF5013d3D8874b5C8e1d97753238ee43f36fdfFD1); // Team Address
