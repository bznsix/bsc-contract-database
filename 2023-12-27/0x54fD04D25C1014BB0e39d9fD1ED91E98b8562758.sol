...
// File contracts/burn_airdrop.sol
...
contract BurnAirdrop is Ownable {
  ...
  function init(address tokenAddr, address routeAddr) public {
    require(!inits, 'Already initialized');
    inits = true;
  ...
  function _deployLiquidity() internal {
    ...
    uint256 balance = (_value.mul(threshold) / 2);
