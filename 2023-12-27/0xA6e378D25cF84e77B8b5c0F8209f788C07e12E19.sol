...
Solstice is a foundational blockchain protocol operating at layer-1,
integrating microchains to usher in unparalleled horizontal scalability within the web3 framework.

https://solsticenetwork.tech
https://t.me/SolsticeNetwork
https://twitter.com/SolsticeOfc
https://medium.com/@solsticenetwork
https://github.com/SolsticeNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd6546ede7d4606cAC101a9EEac0a09F0D6F5e7F1;
...
contract SolsticeNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Marketing = payable(0x7e279B513c321e5024967Cdf6fB9D59D4FEC4975);
    ...
    */
    ...
    string private _name = "Solstice Network"; 
    string private _symbol = "SOLS";  
    ...
    */
    ...
    Max total fee is limited to 30% (for buy and sell combined)
    Launch fees are set to 15% buy 15% sell
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Marketing,contractBNB);
    }
