...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xceB2A49B03698D0393fc6829dF813e44A98B0664; 
...
contract ponkeyfinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ponkey Finance";
    string private _symbol = "$PONFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xceB2A49B03698D0393fc6829dF813e44A98B0664); // 
    address payable public teamWalletAddress = payable(0xceB2A49B03698D0393fc6829dF813e44A98B0664); // 
