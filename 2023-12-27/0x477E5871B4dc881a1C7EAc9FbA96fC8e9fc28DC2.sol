...
contract Umicoin is Ownable {   
    ...
    function buyTokenWithUMI(uint busdAmount) external { 
            require( (busdAmount >= (MIN_DEPOSIT_BUSD*1000000000000000000)), "Minimum limit is 0");
           BEP20 receiveToken = BEP20(0xF915CA5CD277c5F21eBe7dB3A6547C345b6FE53c);/// mainnet 
