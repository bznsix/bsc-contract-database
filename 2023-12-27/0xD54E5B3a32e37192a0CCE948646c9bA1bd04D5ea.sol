...
/**
Welcome to Baby Satellite Doge-1 Mission !

Baby Satellite Doge-1 is a community-driven token on BSC. This idea is brought to life through an Elon Musk tweet, and mission – to send Satellite Doge-1 into space. Satellite Doge- 1 is around 10m mc and climbing. This is the Baby! Join us as Baby Satellite Doge-1 cryptocurrency aims to be used for space related trading in the future, just as the OG Dogecoin is being used today to fund the Satellite Doge-1 mission.
...
TG: TG Portal : https://t.me/babysatellitedoge1
Twitter: https://x.com/babysatdoge1
Website: Will be launched after going live
*/
...
contract bdoge1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Satellite Doge-1 Mission";
    string private constant _symbol = "BDoge-1";
