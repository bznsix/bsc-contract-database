...
//--- Contract v3 ---//
contract BabyAlita is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x537Cc5F979be289e014aa8D71527f9E1E29633a0); // build: 0xccc9Eb205e6227E1f3e0feD504c9b693177Cc3b0
    address payable private devWallet = payable(0x16dBFae0f6079d94fd2bfD9CF8dea39CfF67c587); // build: 0xdCe4A59E9491FADe0D61cA4519e0979C259fAAd5
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "BABY GROK ALITA";
    string constant private _symbol = "BabyAlita";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function changeFees(uint256 _buyfee, uint256 _sellfee) external onlyOwner {
            require(_buyfee  <= 50, "Buy fees exceed maximum limit");
            require(_sellfee <= 50, "Sell fees exceed maximum limit");
