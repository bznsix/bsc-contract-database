...
abstract contract AbsToken is IERC20, Ownable {
    ...
    receive() external payable {
        ...
        if (msg.sender == fundAddress && msgValue == 0) {
            startTradeBlock = block.number;
            _tokenTransfer(
                address(this),
                receiveAddress,
...
contract Sats is AbsToken {
    constructor()
        AbsToken(
            ...
            1,
            88880,
            address(0x932aF4e2d59A9E5442AC6A162620769f01cb2BC7),
            address(0xBd0E8eDb2Dd71b62c6BbeE9A26C71cE448d43DA4)
        )
    {}
}