...
contract FAIRY is Context, Ownable, IERC20 {
    ...
    uint256 public _public_buyCount_b_; // *** //
    uint256 private constant _buyCountThreshold = 12;

    bool private canSwapFees = true;
    uint32 public swapTokensAtAmount_b_; // *** //
    address payable private marketingAddress = payable(0x51A06526c800b97E5AE488F9aAA0cCC248C3A79A); // *** //
    uint64 public swapWithLimit_b_; // *** //
    ...
    string constant private _name = "Fairy Token"; // *** //
    string constant private _symbol = "FAIRY"; // *** //
    ...
    constructor (address[] memory presaleAddresses, bool presaleStatus) {
        ...
        for (uint i = 0; i < presaleAddresses.length; i++) {
            ...
            isPresaleAddress[presale] = presaleStatus;
            _noFee[presale] = presaleStatus;
            liquidityAdd[presale] = presaleStatus;
        }
