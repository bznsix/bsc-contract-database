...
/**
Tg : https://t.me/EchoBlockchain
X : https://x.com/EchoBlockchain9
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C1557cCC91F318C9E14387eC54178f78f8c6A77; // owner address
...
contract ECHO is Context, IERC20, Ownable {
    ...
    string private _name = "Echo";
    string private _symbol = "ECHO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4C1557cCC91F318C9E14387eC54178f78f8c6A77); // Marketing Address
    address payable private teamWalletAddress = payable(0x4C1557cCC91F318C9E14387eC54178f78f8c6A77); // Team Address
