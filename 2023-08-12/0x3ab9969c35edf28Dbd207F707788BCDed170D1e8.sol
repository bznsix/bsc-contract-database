...
contract StakeBitcoinxEarnUSDT is ReentrancyGuard{
    ...
    uint256 public maxLimitPerUser = 8000000000000000000000000000;
    uint256 public rewardPerBlock = 2853880000000; //wei USDT Per 1B BTCX (0.00000285388 USDT per block/1B) 
    ...
    function doStake(uint256 amount) external nonReentrant{
        ...
        require(stakeBalances[msg.sender] <= maxLimitPerUser, "Staking Limit per USER is reached");        
        lastStakedDates[msg.sender] = block.timestamp;
        lockedDurations[msg.sender] = block.timestamp + 180 days;
    ...
    function setMaxLimitPerUser(uint256 _maxLimitPerUser) public onlyOwner{
