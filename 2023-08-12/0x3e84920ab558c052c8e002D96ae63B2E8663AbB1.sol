...
abstract contract Ownable {
    ...
    constructor () {
        address msgSender = 0x161a32B0882FCfA358391ACb293fFc65147B85d5;
        _owner = msgSender;
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _destructionFee = 50;
    ...
    constructor (
        ...
        lpRewardCondition = 100 * tokenDecimals;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 destructionAmount = tAmount * _destructionFee / 10000;
            ...
            if (destructionAmount > 0) {
                feeAmount += destructionAmount;
                _takeTransfer(sender, 0x000000000000000000000000000000000000dEaD, destructionAmount);
            }
        }
...
contract HPGL is AbsToken {
    ...
    //USDT
        ...
        100000000,
    //Receive
        address(0x6d631DD75b29A3D7C077177255948f4465bCF707),
    //Fund
        address(0x3AF75Fe737FC0dcfb73d47E643f5568ECD352Ac1)
    ){
