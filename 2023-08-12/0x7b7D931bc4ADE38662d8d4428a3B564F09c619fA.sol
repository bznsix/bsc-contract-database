...
contract BtcBot is Ownable {
    ...
    mapping(address => uint256) public botAllTimeProfit;
    ...
    function generateAndUpdateProfit() external onlyOwner {
        ...
        uint256 currentRandomNumber = randomNumber;
        IERC20 token = IERC20(allowedToken);
        botDailyEarnings = (currentRandomNumber * token.balanceOf(address(this))) / 10000; // Declare botDailyEarnings // Declare and assign the currentRandomNumber here
        ...
        botAllTimeProfit[address(this)] += profit;
    ...
    function getBotAllTimeProfit() external view returns (uint256) {
    return botAllTimeProfit[address(this)];
    }
