/**
Telegram: https://t.me/yuppiecoin
Website: https://www.yuppiecoin.xyz
*/
...
contract YuppieCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 30000000 * 10**_decimals;
    uint256 public maxBuyAmount = 30000000 * 10**_decimals;
    uint256 public maxWalletBalance = 30000000 * 10**_decimals;

    address public marketingAddress = 0xE6f4B686Aa69795845a8AcC0B463c0dc5bf7Aa23;
    address public devAddress = 0xE6f4B686Aa69795845a8AcC0B463c0dc5bf7Aa23;

    string private constant _name = "Yuppie Coin";
    string private constant _symbol = "YUPPIE";
    ...
    Taxes public taxes = Taxes(5,0,3,2);
    Taxes public sellTaxes = Taxes(5,0,3,2);
    ...
    // Owner cannot transfer out Pepe Race from this smart contract
