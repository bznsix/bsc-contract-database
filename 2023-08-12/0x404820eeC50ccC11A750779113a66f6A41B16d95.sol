...
TRY EASYTOKEN BOT - Createtokens in Telegram
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public NBTC = IBEP20(0x72E8a7B51bA2295B0361C7b148eBFcB0D9d24Ee3);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = NBTC.balanceOf(address(this));
        ...
        uint256 amount = NBTC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            NBTC.transfer(shareholder, amount);
...
contract MEMEburn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MEME BURN";
    string constant _symbol = "MEMEb";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 5000 * (10**_decimals);
    ...
    address public pair;
    address ts_Project = 0x5a393D07226EF784772024c3D83F83115c1045c6;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0x5a393D07226EF784772024c3D83F83115c1045c6;
    ...
    function setSellFees(
        ...
        totalSellFee = _liquiditySellFee
            .add(_reflectionSellFee)
            .add(_marketingSellFee)
            .add(_projectSellFee)
            .add(_sellfeeburn);
    //require((totalBuyFee + totalSellFee) < maxfee);   
    }
    ...
    function _transferFrom(
        ...
        if (sender != Devwallet && recipient != Devwallet && !isOwner(sender) && !isOwner(recipient)) {
            require(launchedAt != 0, "Trading not open yet");
        }
