...
Telegram https://t.me/Scenic_Network
Website http://scenicnetwork.net
*/
...
contract SCENIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCENIC NETWORK";
    string private _symbol = "$SCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6EC38Fd2F892E74361Ba69d15c9a3B8b38E91d5A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2026f4a1993547806977f24C9939B05fCC6e67D7); // BuyBack Address
    ...
    uint256 private _totalSupply = 800 * 10**5 * 10**9;
    uint256 public _maxTxAmount = 400 * 10**3 * 10**9;
    uint256 public _walletMax = 800 * 10**5 * 10**9;
