...
contract FlyingDragon is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "Fiy Dragon";
        _decimals = 18;
        uint256 total = 199 * 10 ** _decimals;
        _tTotal = total;

        fundAddress = payable(0x5bA1aeB7EC3bDbE827633E8eCEffc9AF63a2fF45);
        ...
        address ReceiveAddress = 0x9cC3D8769A087DBc083559e54C9bCD067565ecf2;
    ...
    bool public waitFirstBuy;
    function setWaitFirstBuy(
        bool status
    ) public onlyOwner{
        waitFirstBuy = status;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (startTradeBlock == 0 && waitFirstBuy && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            if (!_swapPairList[to]){
    ...
    uint256 public canRemoveTime = 7 * 24 * 60 * 60;
