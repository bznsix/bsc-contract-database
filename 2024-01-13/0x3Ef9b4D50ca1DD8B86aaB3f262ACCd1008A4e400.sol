...
// https://twitter.com/MicroMyroBsc                
// https://t.me/micro_Myro 
// 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA4dEc1DFB3BdBcf7795cB5F62aa24150eDcDf2e7; // owner address
...
contract Micro_Myro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICRO MYRO";
    string private _symbol = "$MYRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x07afA9650A4D160f5D8eb588A738BA817B572e44); // Marketing Address
    address payable private teamWalletAddress = payable(0xA4dEc1DFB3BdBcf7795cB5F62aa24150eDcDf2e7); // Team Address
