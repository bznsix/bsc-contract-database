...
contract Pool is Owned, VerifySignature {
    ...
    address public signer = 0x1b278591a331138892d1e68064106182A1De0dD3;
    ...
    function withdraw(Request calldata request, uint8 v, bytes32 r, bytes32 s) external {
        ...
        uint256 burn_amount = request.amount / 10;
        IERC20(request.token).transfer(address(0xdead), burn_amount);
        IERC20(request.token).transfer(recipient, request.amount - burn_amount);
