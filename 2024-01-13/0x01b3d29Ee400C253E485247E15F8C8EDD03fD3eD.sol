...
/**
XREX (Blockchain Service)
XREX is a blockchain TradeTech company, helps merchants in emerging economies accelerate international 
transaction by providing SaaS that facilitate digital asset transfer, banking and trading.

https://www.xrex.io/
https://twitter.com/xrexinc
https://t.me/xrexofficial
https://medium.com/xrexio
...
contract XREX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x600b54e26450E7920e49c41E2F53Ef16bc41C993); 
    address payable public Wallet_Dev = payable(0x600b54e26450E7920e49c41E2F53Ef16bc41C993);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420_000_000_000_000_000 * 10**_decimals;
    string private constant _name = unicode"XREX"; 
    string private constant _symbol = unicode"XREXI"; 
    ...
    constructor () {
        _owner =0x600b54e26450E7920e49c41E2F53Ef16bc41C993;
