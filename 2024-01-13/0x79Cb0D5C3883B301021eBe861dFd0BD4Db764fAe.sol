...
contract DullBullPresale is Ownable {
    ...
    IERC20 public immutable token = IERC20(0x23C9799c143E3AfcB316D1090d4CEFe36F744b4f);
    ...
    address public wallet = payable(0xFD8B13E1edF1cDfAb675B24C712F033Bf91A4008);

    // How many token units a buyer gets per BNB & USDT
    uint256 public tokenPriceUSD = 1;
    uint256 public bnbDivider = 10;
    ...
    function buyTokens() public payable {
        ...
        require(msg.value >= 0.001 ether, "cant buy less with than 0.001 BNB");
