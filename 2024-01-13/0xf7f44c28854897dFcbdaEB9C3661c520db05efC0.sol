/*
BabyGrok ETF is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future.
...
contract BabyGrokETF is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyGrok ETF";
    string private constant _symbol = "BYGROK";
