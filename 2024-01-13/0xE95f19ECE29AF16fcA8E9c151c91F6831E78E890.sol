...
/**
Get ready for a ribbiting good time with HobbyFrog Memes! Dive into a world of hilarity, creativity, 
and froggy fun as we take the internet by storm with our whimsical and entertaining memes.

#HobbyFrog #BSC #MemeToken

🌐 Website  : https://www.HobbyFrog.lol/
📱 Telegram : https://t.me/HobbyFrog
*/
...
contract HobbyFrog is Context, IBEP20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE2f0D1ca6F0Ff66Da567c11561F2351c674C7BaC); 
    address payable public Wallet_Dev = payable(0xE2f0D1ca6F0Ff66Da567c11561F2351c674C7BaC);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420_000_000_000_000_000 * 10**_decimals;
    string private constant _name = unicode"HobbyFrog"; 
    string private constant _symbol = unicode"HOBBYFR"; 
    ...
    constructor () {
        _owner =0xE2f0D1ca6F0Ff66Da567c11561F2351c674C7BaC;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 totalRandom = IBEP20(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = IBEP20(random_Token_Address).transfer(Wallet_Dev, removeRandom);
    }
