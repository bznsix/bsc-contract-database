...
//--- Contract v3 ---//
contract LoopToken is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 1_000_000_000 * 10**18;//1 000 000 000
    ...
    address payable private marketingAddress = payable(0xee7eCEfD4A8Dd76a14Df727b1C126b0B943F7F11); // build: 0xee7eCEfD4A8Dd76a14Df727b1C126b0B943F7F11
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "Loop Token";
    string constant private _symbol = "LOOP";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0xC4C1811302cA325A15C816162290A3C43652B92B;
    address constant private presaleAddress = 0x2BF86aaD601A018be70100888E615247d53b792f;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 60) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 60) / 100);
        balance[presaleAddress] = (_totalSupply * 40) / 100;
        emit Transfer(address(0), presaleAddress, (_totalSupply * 40) / 100);
