...
contract FbPresale is Ownable {
    ...
    modifier unlockStoped() {
        require(
            ...
            "Presale: unlocking token is not stoped"
        );
        _;
    }
    ...
    // this function it will stop sales and enable unlocking
    function enableUnlocking() external onlyOwner {
        saleStatus = false;
        unlockingStatus = true;
    }
    ...
    function withdrawToken() external unlockEnabled {
        require(
    ...
    // Method to unlock all Funbit Casinos
