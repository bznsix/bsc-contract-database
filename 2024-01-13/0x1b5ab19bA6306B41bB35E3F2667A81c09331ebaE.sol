/**
🚀Baby Myro Inu  is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the BMI arrived on the BSC and is ready to claim his throne as the pet of the galaxy
...
contract BabyMyroInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Myro Inu"; // 
    string private constant _symbol = "BMI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd50A7ea7875895F1C264ec05E1DBE06479a2E7E7;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x91D33A50336EC926b2c5b6a175C8FA4aA9f9FBf6;
