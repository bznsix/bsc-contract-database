...
0% buy / 15% sell | 0-15 minute
0% buy / 10% sell | 16-30 minute
5% Buy / 5% sell | 31-eternal
...
contract ElonDragon is ERC20, Ownable {
    ...
    constructor () ERC20("ElonDragon", "ElonDragon") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x30a1916532F2c5cC2e64e8E1d484B741C8c4C56e);
        ...
        feeReceiver = 0xCa1A0DC22D469d3Bc2Da2d4B8E5fc6717e0D858f;
