// https://t.me/BabySillyBSC
// https://twitter.com/Babysilydragon?t=xm59c7mqYxeuJc3ptwmUDw&s=09
// https://babysillydragon.xyz/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _transfer(_msgSender(), recipient, amount);
         require(amount >= minimumLimit, "Transfer amount is below minimum limit");
        return true;
    }
...
contract BabySilly is ERC20, Ownable {
    ...
    constructor () ERC20("Baby Silly Dragon", "$BabySilly")
    {  
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x5017d9BD5A5798f05b7E8497E48837Cc1836bc31;
        marketingWallet =0xA6addB4040f302e1E23d4cd96372ca23d07ce995;  
