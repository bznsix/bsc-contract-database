...
Telegram: https://t.me/mobywhaleofficial

Twitter: https://x.com/mobywhalebtc

Website: https://mobywhale.website
...
Initial LP: 1 BNB
Supply: 1,000,000
Max wallet/tx: 40,000
Tax: 9/9 (2% rewards BTC - 7% marketing wallet) 
...
contract MobyWhale is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MobyWhaleDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Moby Whale", "Whale") {
        marketingWallet = payable(0x16f8365E7F8055761D3f6E4dC89358B0DE81bB95);
        ...
        dividendTracker = new MobyWhaleDividendTracker(
            payable(this),
            router,
...
contract MobyWhaleDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MobyWhale public MobyWhaleContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MobyWhaleContract = MobyWhale(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MobyWhale_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MobyWhale_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MobyWhale contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MobyWhaleContract);

            uint256 prevBalance = MobyWhaleContract.balanceOf(address(this));
            ...
            {
                uint256 received = MobyWhaleContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MobyWhaleContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
