...
🌐 Website  : https://www.dragondoge.io/
📱 Telegram : https://t.me/DragonDogeChannel
*/
...
contract DragonDoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6Fdd94A3361a3D442baf93ad595EEa4Ed0d0A584); 
    address payable public Wallet_Dev = payable(0x6Fdd94A3361a3D442baf93ad595EEa4Ed0d0A584);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420_000_000_000_000_000 * 10**_decimals;
    string private constant _name = unicode"DragonDoge"; 
    string private constant _symbol = unicode"DRAGONDOGE"; 
    string constant public copyright = "dragondoge.io";
    ...
    constructor () {
        _owner =0x6Fdd94A3361a3D442baf93ad595EEa4Ed0d0A584;
