...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 340;
    ...
    constructor (
        ...
        holderRewardCondition = 1 * 10 ** IERC20(RewardToken).decimals();
...
contract BtcLong is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3d5E8425861148DD1A9CF0cEFa6186818adAb324),
        address(0xc48358A8a09D082b313c7Ae7A7B20c417BA934dB),
        address(0x477304E13A6CadA25D5dE9293fe79Be52D9eB305)
    ){
