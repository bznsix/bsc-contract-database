/**
	...
	💎 FTX Classic Features:
		⭐️Total tax of 5% will be applied for every buy and sell: 3% BNB rewards, 2% LP.
		⭐️The tax can not be changed.
		⭐️Reward Holders are Receive BNB rewards (dividends) passively and automatically. Rewards are paid in BNB every hour.
	✅website: https://ftxclassic.net/
	✅Telegram Group: https://t.me/FTTCToken
	✅Telegram Channel: https://t.me/FTTCTokenVerificationPortal
	✅Twitter: https://twitter.com/fttctoken
*/
...
contract FTTC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    FTTCDividendTracker public dividendTracker;

    address public constant liquidityWallet = 0x6c6d5A9E8e3f54EE4dCbfaF57F157fe7eA1f280A;
    ...
    uint256 public constant BNBRewardsFee = 3;
    ...
    constructor() ERC20("FTX Classic", "FTTC") {
        dividendTracker = new FTTCDividendTracker();
        ...
        */
        ...
        _mint(0x6c6d5A9E8e3f54EE4dCbfaF57F157fe7eA1f280A, 1000000000 * (10**9));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FTTCDividendTracker newDividendTracker = FTTCDividendTracker(
            payable(newAddress)
        );
...
contract FTTCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("FTTC_Dividend_Tracker", "FTTC_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**9); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "FTTC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "FTTC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FTTC contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FTTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "FTTC_Dividend_Tracker: Cannot update claimWait to same value");
