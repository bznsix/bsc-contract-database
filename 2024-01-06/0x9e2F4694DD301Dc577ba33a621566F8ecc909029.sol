        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x428fD65409Bdd11F0F604dcEff1Af1e3801627d9), block.timestamp
                );
            }
        }
    }
...
contract coin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x428fD65409Bdd11F0F604dcEff1Af1e3801627d9)//ReceiveAddress
    ){
    }
}