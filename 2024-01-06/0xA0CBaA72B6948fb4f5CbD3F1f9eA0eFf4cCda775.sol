...
contract CRAZYDRAGON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x124b6D95a9c84D0B0F4626027F051001f604784C); 
    address payable public Wallet_Dev = payable(0xF7ff40B8e90a345C19c8A6e32EFd039788F88D37);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "CRAZY DRAGON"; 
    string private constant _symbol = unicode"CRAZYDRAGON"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 97;
    ...
    constructor () {
        _owner = 0xF7ff40B8e90a345C19c8A6e32EFd039788F88D37;
