        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdB4087b698Fb98E314a06a5b2bdFC9EF2bd7398b), block.timestamp
                );
            }
        }
    }
...
contract coin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        2024,//Supply
        address(0xd182f2187CC3ae23B4Dd6841ea6dfCf3763d5463),//FundAddress
        address(0xdB4087b698Fb98E314a06a5b2bdFC9EF2bd7398b)//ReceiveAddress
    ){
    }
}