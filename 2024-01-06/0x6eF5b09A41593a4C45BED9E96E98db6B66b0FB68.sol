...
Stealth Launch Today 19.00 - 19.30 UTC! If you are here, you are early. The tg discussion group is open now!

Tax Code : 5/5
Supply 777.000.000.000

📲 : https://t.me/+v3qJw7gKYnwzMDM1
**/
...
contract BabydogeGROK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Babydoge GROK";
    string private constant _symbol = unicode"$BABY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 777000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x301d0fDD9a4E96870687652193e8ef48DBE8365f);
    address payable public MarketingWallet = payable(0xb86E7745ba1a239b758726b9b01D895fADF3c994);
