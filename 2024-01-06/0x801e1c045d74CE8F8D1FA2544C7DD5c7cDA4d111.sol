...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE851BA89B61564d9798D83065520001b0A639206; // owner address
...
contract GROKMICKEY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grok Mickey";
    string private _symbol = "GM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE851BA89B61564d9798D83065520001b0A639206); // Marketing Address
    address payable private teamWalletAddress = payable(0xE851BA89B61564d9798D83065520001b0A639206); // Team Address
