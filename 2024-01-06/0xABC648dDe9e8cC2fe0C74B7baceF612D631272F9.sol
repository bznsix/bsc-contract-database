...
/*
   ...
   Welcome to JUICYPUMP
   
   This is a community token. If you want to create a telegram I suggest to name it to @JUICYPUMPBSC
   ...
   I will renounce the ownership to burn addresses to transfer #JUICYPUMP to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #JUICYPUMP 10000X? 
   ...
   it's the best part of the #JUICYPUMP idea, increasing the liquidity pool automatically, 
...
contract JUICYPUMP is Context, IERC20, Ownable {
    ...
    string private _name = "JUICYPUMP";
    string private _symbol = "JP";
