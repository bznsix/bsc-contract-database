...
// Twitter      : https://twitter.com/netronprotocol/

// Netron Protocol — the groundbreaking Layer 1 EVM Blockchain championing unparalleled security and scalability.
...
contract NetronProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Netron Protocol";
    string private _symbol = "NETRON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCc827b40F09d0F01B80cCb52eE93d4D736Fb8CFC); // Marketing Address
    address payable public teamWalletAddress = payable(0xCc827b40F09d0F01B80cCb52eE93d4D736Fb8CFC); // Team Address
