...
contract PopSmoke is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x9DEf523dC55F30A0B9fffA2503DA5c9AF403a40C);

    string public _name = "PopSmoke";
    string public _symbol = "PSE";
