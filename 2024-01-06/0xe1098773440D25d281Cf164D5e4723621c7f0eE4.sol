    ...
    function MigrateOldUser(uint256 limit) public{
        ...
        for (uint i = 0; i < limit; i++) {
            ...
            if(olduser1.joinDate > 0 && users[oldusers].joinDate == 0){
                ...
                users[oldusers].checkpoint = (launchTime + TIME_STEP) + (olduser1.joinDate % TIME_STEP);
                ...
                if(oldInstantGain.getUserTotalReferralCommission(oldusers) >= ACTIVATE_PRICE || !oldInstantGain.isUserActive(oldusers)){
