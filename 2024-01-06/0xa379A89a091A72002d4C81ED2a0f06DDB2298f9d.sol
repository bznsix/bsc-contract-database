...
contract AnyNetwork is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x5A818819cDB3739EA16eDd9cce80EBCe14281392);

    string public _name = "Any Network";
    string public _symbol =unicode"A🧬";
