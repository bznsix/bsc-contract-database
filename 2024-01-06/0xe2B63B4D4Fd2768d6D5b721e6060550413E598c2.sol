...
//Telegram :https://t.me/PromptIDEPortal     

//Twitter :https://x.com/PromptIdeBscX
...
contract PROMPTIDE is Context, IERC20, Ownable {
    ...
    string private _name = "PromptIDE";
    string private _symbol = "PROMPTIDE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80A50A860722AB0af487b421a2C9be953095891E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x80A50A860722AB0af487b421a2C9be953095891E); // BuyBack Address
