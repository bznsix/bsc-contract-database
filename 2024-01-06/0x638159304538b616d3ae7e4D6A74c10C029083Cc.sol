...
// Website  :https://Tabaluga.xyz/
// Tg       :https://t.me/TabalugaToken
// Twitter  :https://twitter.com/TabalugaToken
...
contract Tabaluga is Context, IERC20, Ownable {
    ...
    string private _name     = "Tabaluga";
    string private _symbol   = "TABAL";
    ...
    uint256 public ataxFeeonBuy;
    uint256 public ataxFeeonSell;

    uint256 public abuybackBurnFeeOnBuy;
    uint256 public abuybackBurnFeeOnSell;

    uint256 public amarketingFeeonBuy;
    uint256 public amarketingFeeonSell;

    uint256 public _taxFee;
    uint256 public _buybackBurnFee;
    uint256 public _marketingFee;

    uint256 public atotalBuyFees;
    uint256 public atotalSellFees;
    ...
    {        
        ...
        abuybackBurnFeeOnBuy = 0;
        abuybackBurnFeeOnSell = 0;

        amarketingFeeonBuy = 3;
        amarketingFeeonSell = 3;

        atotalBuyFees = ataxFeeonBuy + abuybackBurnFeeOnBuy + amarketingFeeonBuy;
        atotalSellFees = ataxFeeonSell + abuybackBurnFeeOnSell + amarketingFeeonSell;

        marketingWallet = 0x659D2cacd373E81cCDE18C497734F99FB990d2A7;
    ...
    function setBuyFee() private{
        if(_taxFee == ataxFeeonBuy && _buybackBurnFee == abuybackBurnFeeOnBuy && _marketingFee == amarketingFeeonBuy) return;

        _taxFee = ataxFeeonBuy;
        _marketingFee = amarketingFeeonBuy;
        _buybackBurnFee = abuybackBurnFeeOnBuy;
    }

    function setSellFee() private{
        if(_taxFee == ataxFeeonSell && _buybackBurnFee == abuybackBurnFeeOnSell && _marketingFee == amarketingFeeonSell) return;

        _taxFee = ataxFeeonSell;
        _marketingFee = amarketingFeeonSell;
        _buybackBurnFee = abuybackBurnFeeOnSell;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 marketingShare = amarketingFeeonBuy + amarketingFeeonSell;
            uint256 buybackShare = abuybackBurnFeeOnBuy + abuybackBurnFeeOnSell;
    ...
    function setBuyFeePercentages(uint256 _ataxFeeonBuy, uint256 _abuybackBurnFeeOnBuy, uint256 _amarketingFeeonBuy) external onlyOwner {
        ataxFeeonBuy = _ataxFeeonBuy;
        abuybackBurnFeeOnBuy = _abuybackBurnFeeOnBuy;
        amarketingFeeonBuy = _amarketingFeeonBuy;
        atotalBuyFees = _ataxFeeonBuy + _abuybackBurnFeeOnBuy + _amarketingFeeonBuy;
        require(atotalBuyFees <= 3, "Buy fees cannot be greater than 3%");
        emit BuyFeesChanged(ataxFeeonBuy, abuybackBurnFeeOnBuy, amarketingFeeonBuy);
    }

    function setSellFeePercentages(uint256 _ataxFeeonSell, uint256 _abuybackBurnFeeOnSell, uint256 _amarketingFeeonSell) external onlyOwner {
        ataxFeeonSell = _ataxFeeonSell;
        abuybackBurnFeeOnSell = _abuybackBurnFeeOnSell;
        amarketingFeeonSell = _amarketingFeeonSell;
        atotalSellFees = _ataxFeeonSell + _abuybackBurnFeeOnSell + _amarketingFeeonSell;
        require(atotalSellFees <= 7, "Sell fees cannot be greater than 7%");
        emit SellFeesChanged(ataxFeeonSell, abuybackBurnFeeOnSell, amarketingFeeonSell);
    }
