...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD9638480A4F840a551915cE6bC69890EEEDEF212; // owner address
...
contract OnigiriTsuka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Onigiri Tsuka";
    string private _symbol = "ONITSUKA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC984d30A1d20a863f88AD630cD67EFB86e19C666); // Marketing Address
    address payable private teamWalletAddress = payable(0xC984d30A1d20a863f88AD630cD67EFB86e19C666); // Team Address
