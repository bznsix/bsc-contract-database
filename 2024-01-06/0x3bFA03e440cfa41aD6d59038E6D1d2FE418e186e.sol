...
/* please go to: https://earnbnb.top/ */
...
contract EARNBNB {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.001 ether; // 0.001 bnb
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(10, 170)); // 10 days 17% daily // 170%
        plans.push(Plan(20, 150)); // 20 days 15% daily // 300%
	}

	
	function checkReferrer() external onlyOwner {
