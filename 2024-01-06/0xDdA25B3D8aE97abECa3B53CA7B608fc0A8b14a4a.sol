...
contract Myro is ERC20, Ownable {
    ...
    constructor() ERC20("Myro", "$MYRO") {
        ...
        treasuryWallet = address(0xca1275390d2B9b2Bc0767CA6987B7c2FFBa35907); // set as treasury wallet
        devWallet = address(0xca1275390d2B9b2Bc0767CA6987B7c2FFBa35907); // set as dev wallet
