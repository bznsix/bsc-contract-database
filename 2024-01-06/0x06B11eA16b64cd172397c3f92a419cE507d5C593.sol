...
//--- Contract v3 ---//
contract GROKBot is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 100_000_000_000_000 * 10**18;
    ...
    address payable private marketingAddress = payable(0x4A8acA4E4CE66EFb86492527838d41Da60288940); // build: 0x4A8acA4E4CE66EFb86492527838d41Da60288940
...
//--- v3 Allocations by Freddy analytixaudit.com ---//
    ...
    string constant private _name = "GROK Bot";
    string constant private _symbol = "XBOT";
    string constant public copyright = "analytixaudit.com";
    uint8 constant private _decimals = 18;
    address constant private liquidityAddress = 0xf26Bcc83E1bDa9ECb9B5446cC042142a015D93c5;
    ...
    constructor () {
        ...
        balance[liquidityAddress] = (_totalSupply * 80) / 100;
        emit Transfer(address(0), liquidityAddress, (_totalSupply * 80) / 100);
        balance[0x64AB1b11fFCB384CDa9A478890AC8eb8bC6a73a7] = (_totalSupply * 20) / 100;
        emit Transfer(address(0), 0x64AB1b11fFCB384CDa9A478890AC8eb8bC6a73a7, (_totalSupply * 20) / 100);
