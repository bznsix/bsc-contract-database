...
contract IntegerERC20 is ERC20, Ownable {
    ...
    bool public AutoNukeLPEnabled = false;
    ...
    constructor() ERC20("Integer Token", "NODC", 0) {
    ...
    function enableAutoNukeLPEnabled(bool _status) external onlyOwner {
        AutoNukeLPEnabled = _status;
    }
