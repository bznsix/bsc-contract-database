...
//TELEGRAM: https://t.me/mulongwoodendragon
...
contract MuLong is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mu Long";
    ...
    Taxes public taxes = Taxes(0,0,0,1);
    Taxes public sellTaxes = Taxes(0,0,0,1);
