...
contract KIDCATBSC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "KIDCATBSC";
    string private constant _symbol = unicode"$KIDCAT";
    ...
    address payable public DevWallet = payable(0x55bBc9B254506626C07767164f5712B80beE2A8c);
    address payable public MarketingWallet = payable(0xA4D2e1Ba07b220C38c63589ecDCca93Afc172F65);
