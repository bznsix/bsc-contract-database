/**
https://t.me/GROKCITYOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58345C0bc28761b095107cFF1b00e1EEdfD807d8; // owner address
...
contract GROKCITY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grok City";
    string private _symbol = "GC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x58345C0bc28761b095107cFF1b00e1EEdfD807d8); // Marketing Address
    address payable private teamWalletAddress = payable(0x58345C0bc28761b095107cFF1b00e1EEdfD807d8); // Team Address
