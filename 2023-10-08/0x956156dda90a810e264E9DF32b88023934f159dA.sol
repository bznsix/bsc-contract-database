/**
   ...
   Welcome to INDIANDOGE
   
   This is a community token. If you want to create a telegram I suggest to name it to @INDIANDOGE
   ...
   I will renounce the ownership to burn addresses to transfer #INDIANDOGE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #INDIANDOGE 10000X? 
   ...
   it's the best part of the #INDIANDOGE idea, increasing the liquidity pool automatically, 
...
contract INDIANDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "INDIANDOGE";
    string private _symbol = "INDIANDOGE";
