/* 
Telegram : https://t.me/fantechsocisalfi
Website :  www.fan.tech
Twitter :  https://x.com/joinfantech
*/
...
contract FANTECH is Context, IERC20, Ownable {
    ...
    string private _name = "Fan Tech Social";
    string private _symbol = "Fan Tech";
    uint8 private _decimals = 9;

    address public marketingWallet =0x9eA2850b58B2F0452bB100DC590bafc18e2cff0f;
    address public developerWallet = 0xdC6A48a3F95dC4083d0727EEF082eDD6622D3BEe;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(50).div(denominator);     //3%
    uint256 public _walletMax = _totalSupply.mul(50).div(denominator);    //3%
