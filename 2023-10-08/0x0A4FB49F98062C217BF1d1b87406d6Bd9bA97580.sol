/**
Telegram: https://t.me/GoldPandaBSC
*/
...
contract GoldPanda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldPanda";
    string private _symbol = "GOLD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x616b976d9709312AfdaEDaD4D25645d6F6C2284c); // Marketing Address
    address payable public teamWalletAddress = payable(0x616b976d9709312AfdaEDaD4D25645d6F6C2284c); // Team Address
