...
// File contracts/ape/ApeItemV4.sol
...
contract ApeItemV4 is Ownable {
    ...
    constructor() {
        collect = 0x71506F189E1e7724Fe390f20ffb77E49bEaC7b91;
    ...
    function setCollect(address _collect) public onlyOwner {
        require(_collect != address(0), "Wrong address");
        collect = _collect;
    }

    function recharge(address token, uint256 amount) public {
        ...
        uint256 wethBalance = IWETH9(wbnb).balanceOf(address(this));
        if (wethBalance > 0) {
            IWETH9(wbnb).withdraw(wethBalance);
            collect.call{value: wethBalance}("");
        }
    }
}