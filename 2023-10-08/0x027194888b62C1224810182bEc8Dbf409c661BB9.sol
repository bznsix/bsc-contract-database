// Telegram: https://t.me/boredapeyachtclubOFFICIAL
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //reward ca can be changed any
...
contract BoredApeYachtClub is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Bored Ape Yacht Club";
   string constant _symbol = "BYACHT";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 100; // 0.5%
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xF86A499b2dD1F69edb7a98A342Ba7a4Ff34CC9cb; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xF86A499b2dD1F69edb7a98A342Ba7a4Ff34CC9cb; //Can be change to any wallet you want
       marketingFeeReceiver = 0x6f8Db0641Ec1FF15126409CEf3c67FF931882d16; //Can be change to any wallet you want
