...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd23b8cE553B96e2B9CB1F591118c32cc703FB1B; // owner address
...
contract BULLDRAGON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BULLDRAGON";
    string private _symbol = "BULLDRAGON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCd23b8cE553B96e2B9CB1F591118c32cc703FB1B); // Marketing Address
    address payable private teamWalletAddress = payable(0xCd23b8cE553B96e2B9CB1F591118c32cc703FB1B); // Team Address
