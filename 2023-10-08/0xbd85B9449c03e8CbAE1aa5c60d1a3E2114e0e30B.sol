...
contract CrazyToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2F12d5b06d0683bbe3d1D2378cb64342347F835f); 
    address payable public Wallet_Dev = payable(0x2F12d5b06d0683bbe3d1D2378cb64342347F835f);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Crazy Token"; 
    string private constant _symbol = unicode"Crazy"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 150;
    ...
    constructor () {
        _owner =0x2F12d5b06d0683bbe3d1D2378cb64342347F835f;
