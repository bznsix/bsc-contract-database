...
contract Penguin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x0B9d7a7B54E4996A37C31fe35CA67DD04534ac6C); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0B9d7a7B54E4996A37C31fe35CA67DD04534ac6C); // Team Address
        
    address payable public liquidityAddress =
        payable(0x0B9d7a7B54E4996A37C31fe35CA67DD04534ac6C); // Liquidity Address
