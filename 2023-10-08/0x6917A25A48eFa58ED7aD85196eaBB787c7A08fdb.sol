...
/**
   ...
   3% fee to relief wallet
   
   0.2 will be the initial liquidity
   
   this is a community token and I suggest to create a TG group with this link https://t.me/LIONbsc
   
   FAIRLAUNCH @9:00 AM UTC
   
   If you try to put a bot in my token, i will put it on blacklist. 
   Godbless and HAPPY TRADING
*/
...
contract KINGOFTHEJUNGLE is Context, IERC20, Ownable {
    ...
    string private _name = "KINGOFTHEJUNGLE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 15000000 * 10**1 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 halfOfLiquify = contractTokenBalance.div(3);
        uint256 otherHalfOfLiquify = contractTokenBalance.div(3);
