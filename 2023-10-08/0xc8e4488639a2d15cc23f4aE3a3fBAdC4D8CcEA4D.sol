...
contract OrdinalX is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x98387388a3cfBDAA07627d00fA89622eb58a4F60);
    address payable public devWallet =
        payable(0xeeFEFf1D037d1CbdA2727d641B08E08dB5e4Cb2B);
    ...
    //Supply Definition.
    uint256 private _tTotal = 420_069_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "Ordinal-X";
    string public constant symbol = "ORDX";
    uint8 public constant decimals = 18;
    //Taxes Definition.
    uint public buyFee = 0;

    uint256 public sellFee = 5;
    uint256 public combinedTax = buyFee + sellFee;
    uint public devFee = 2;
    uint public marketingFee = 3;
    uint public totalDist = devFee + marketingFee;
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        uint totalFees = devFee + marketingFee;
        if (totalFees == 0) totalFees = 1;
        uint ecosystemAmount = (ethBalance * devFee) / totalFees;
        if (ecosystemAmount > 0) ethBalance -= ecosystemAmount;
        transferToAddressETH(devWallet, ecosystemAmount);
    ...
    function setDevWallet(address _devWallet) external onlyOwner {
        ...
        emit AuditLog("We have Updated the setDevWallet:", devWallet);
    }
    ...
    /**
     * @notice sets the distribution share of all fees
     * @param _devFee The dev share of all the fees
     * @param _marketingFee The marketing Share of all fees
     */
    function setDistribution(
        ...
        totalDist = devFee + marketingFee;
        require(totalDist <= combinedTax, "TotalDist cannot be more than combined fees.");
        emit Log("We have updated the dev fee to:", devFee);
        emit Log("We have updated the marketing fee to:", marketingFee);
    }
