...
contract SingerDAO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Singer DAO";
    string private _symbol = "Singer";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x79e5A75652Ea62119F9383eD64EbaA50017090C2);
    address payable public liqWalletAddress = payable(0x79e5A75652Ea62119F9383eD64EbaA50017090C2);
