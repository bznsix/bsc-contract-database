...
contract PEPECOLATOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eolmh67;
    ...
    string private _tokenname = "PEPE COLAa";
    string private _tokensymbol = "PEPECOLA";
