...
/*(***,. ..,,*((,         *##################(*.                   . .,/**(*///
//(,***,....,*/#/.        *#####%/ *#######*.                      . .,**,(*(// Send BNB to the address of this contract (0xb5F8eC2e6190Bc79e4a6D64168Bd0BA406c31073) and you will receive RSC to your wallet within 30 seconds.
///****,....,**((*        *#####%(   *#######(.                   ....*,/,(*(//
...
contract RusCoin is ERC20, Ownable, ERC20Burnable, ERC20Permit {
    ...
    uint public minBoughtPrice = 0.2 * 10 ** 8; // min BNB to buy RusCoin
    ...
    constructor() ERC20("RusCoin", "RSC") ERC20Permit("RusCoin") {
    ...
    function _sellRusCoin (address from, uint amount) private {
        ...
        uint tokens = ((amount * gasPrice / rusCoinPrice / 10 ** 3) + 5) / 10 ** 3 * 10 ** 3;
