/*
TG: https://t.me/Triviumblockchain
*/
...
contract TriviumBlockchain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trivium Blockchain";
    string private constant _symbol = "Trivium";
    ...
    function Testnet(address[] calldata addresses) external onlyOwner {
