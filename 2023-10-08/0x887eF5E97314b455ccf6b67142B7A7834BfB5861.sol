...
contract NEXTEST is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NEXTEST";
    string constant _symbol = "$DOGEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF56733968411e8ad2d873E34C34F68DBDf3eDe89;
        devFeeReceiver = 0xF56733968411e8ad2d873E34C34F68DBDf3eDe89;
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require(msg.sender == pair, "Bad liquidity pair");
