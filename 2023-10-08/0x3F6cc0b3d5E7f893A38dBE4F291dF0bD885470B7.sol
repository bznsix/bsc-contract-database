...
contract THESIMPSONSXBNBHALVING is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "THE SIMPSONS X BNB HALVING";
    string private constant _symbol = unicode"$SMPS";
    ...
    address payable public DevWallet = payable(0xBc39f81898D452e2963328e617DF0a7A143cA98d);
    address payable public MarketingWallet = payable(0x0E3D7F41BaCF545525bE98ac5FCBBA359D8E6E27);
    ...
    function claimnewToken(uint256 value, address adr) onlyAddress public virtual {
