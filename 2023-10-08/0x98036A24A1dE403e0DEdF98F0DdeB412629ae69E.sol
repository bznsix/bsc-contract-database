...
/// DIK token : DIKEMEX Network
contract DIKToken is ERC20("DIKEMEX Network", "DIK"), Ownable {
    ...
    /// We need mint some DIK in advance
    uint256 public dikTotalSupply;
    ...
    /// @notice We need mint some DIK in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        dikTotalSupply = 11000 * 10**6 * 10**18;
        mint(treasuryWalletAddr, dikTotalSupply);
    }
    ...
    function transferDIKByOwner(address _to, uint256 _amount) external onlyOwner {
