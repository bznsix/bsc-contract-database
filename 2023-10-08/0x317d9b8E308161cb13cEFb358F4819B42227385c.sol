...
/* PayPalToken -   A Univeral Crypto Payment Gateway!!  
...
contract PayPalToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8Ce653237d0996D0e5b3930Fb5E6AD4BcA4063d6); // Marketing Address
    address payable public charityAddress = payable(0x8Ce653237d0996D0e5b3930Fb5E6AD4BcA4063d6); // Charity/Dev Address
    ...
    string private _name = "PayPalToken";
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
