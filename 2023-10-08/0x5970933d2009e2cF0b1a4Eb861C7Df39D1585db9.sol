...
/**
   ...
   7% fee auto liquidity and marketing
...
contract BEYBLADE is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 700000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "ANIMEFOX";
    string private _symbol   = "AFOX";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 3; 
    uint256 public _liquidityFee = 7; 
    uint256 public _percentageOfLiquidityForDev = 57; 
