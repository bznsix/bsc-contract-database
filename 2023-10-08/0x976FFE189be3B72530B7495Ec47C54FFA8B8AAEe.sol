...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x034a996c924D3c4872ecD79Cf34F860a448e8448; 
...
contract CrazyFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crazy Floki";
    string private _symbol = "CrazyFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x034a996c924D3c4872ecD79Cf34F860a448e8448);
    address payable public teamWalletAddress = payable(0x034a996c924D3c4872ecD79Cf34F860a448e8448); 
