...
/**
   ...
   Welcome to ELONSHIBA
   
   
   
   This is a community token. If you want to create a telegram I suggest to name it to @ELONSHIBABSC
   ...
   I will renounce the ownership to burn addresses to transfer #ELONSHIBA to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ELONSHIBA 10000X? 
   ...
   it's the best part of the #ELONSHIBA idea, increasing the liquidity pool automatically, 
...
contract ELONSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "ELONSHIBA";
    string private _symbol = "ElonShib";
