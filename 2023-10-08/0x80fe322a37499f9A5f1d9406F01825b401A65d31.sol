...
contract Ak47Floki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5d11cd2988F13ee5e5a843Ff1dedD0B0F95Dfbe8); // Marketing Address
        
    address payable public teamAddress =
        payable(0xBda8e56da18dE4Ed1082e1A40649d0855C68d635); // Team Address
        
    address payable public liquidityAddress =
        payable(0x5d11cd2988F13ee5e5a843Ff1dedD0B0F95Dfbe8); // Liquidity Address
    ...
    string private constant _name = "AK47 Floki";
    string private constant _symbol = "Floki47";
