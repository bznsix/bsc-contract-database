...
// File: contracts/interfaces/IBNBDogeBonusPool.sol


pragma solidity >=0.5.0;

interface IBNBDogeBonusPool {
...
// File: contracts/token/BNBDoge.sol
...
contract TokenTest is ERC20, Ownable {
    ...
    function setReferrer(address _user, address _referrer) external {
        require(distributor != address(0) && msg.sender == distributor, "Only Distributor can set referrer");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountDogBurn = (taxAmount * burnFee) / (_totalFee);
        uint256 amountDogLp = (taxAmount * liquidityFee) / (_totalFee);
        uint256 amountDogBonus = (taxAmount * bonusFee) / (_totalFee);
        ...
        IBNBDogeBonusPool(bonusWallet).injectRewards(amountDogBonus);
