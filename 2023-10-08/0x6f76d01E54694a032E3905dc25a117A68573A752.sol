...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaB72bA4944554924Ef42152c268C886F37E6DbdD; // owner address
...
contract DRAGON2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DRAGON2049";
    string private _symbol = "DRAGON2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xaB72bA4944554924Ef42152c268C886F37E6DbdD); // Marketing Address
    address payable private teamWalletAddress = payable(0xaB72bA4944554924Ef42152c268C886F37E6DbdD); // Team Address
