/**
   ...
   I make this #RoadsterToken
 to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/RoadsterToken
   ...
   I will renounce the ownership to burn addresses to transfer #RoadsterToken
 to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #RoadsterToken
 1000X? 
   ...
   it's the best part of the #RoadsterToken
...
contract RoadsterToken
 is Context, IERC20, Ownable {
    ...
    string private _name = "Roadster Token";
    string private _symbol = "Roadster";
