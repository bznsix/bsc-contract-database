...
contract FixLP {
    address payable public feeRecipient = 0xE01c8E6ea953D3a07cDE5Ab458067Bc146097b3D;
    uint256 public feeAmount = 0.00000000001 ether;  // 0.00000000001 BNB fee, using the ether unit for simplicity in Solidity.
