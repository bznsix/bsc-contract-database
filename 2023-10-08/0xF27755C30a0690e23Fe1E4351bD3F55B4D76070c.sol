...
ガトモン) is an Animal Digimon. It has a very healthy curiosity, 
so it loves pranks. Although its body is small, it is a precious Holy-species Digimon, 
and its appearance does not match the true strength it possesses



Telegram :https://t.me/Gatomontoken
...
contract GATOMON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x052B0a0f5392ec4E67ea06De04cAe6f910738840); 
    address payable public Wallet_Dev = payable(0x7E26Df080C881fc1cf6d9e657e8089a84c68DfBd);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "GATOMON"; 
    string private constant _symbol = unicode"$GMON"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 95;
    uint256 public Percent_Dev = 0;
    uint256 public Percent_Burn = 4;
    ...
    constructor () {
        _owner =0x7E26Df080C881fc1cf6d9e657e8089a84c68DfBd;
