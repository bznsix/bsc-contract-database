...
contract BASYOPTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eakkcn23;
    ...
    string private _tokenname = "Baby Psyop";
    string private _tokensymbol = "BABYPSYOP";
