...
contract CAPOTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ranfbzx5;
    ...
    string private _tokenname = "CAPO";
    string private _tokensymbol = "CAPO";
