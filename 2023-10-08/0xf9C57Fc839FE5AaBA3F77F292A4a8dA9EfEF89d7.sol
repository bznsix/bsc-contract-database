...
//                           `..-::::::::::-----------------------------------..`                     
//                               ``..------------------------------------..``                         
// mannnnnnnn im high as fuck - happy 4 fucking 200000 mannnnnnnnn kokoadadkokakdoakdok
...
contract INGENUITY is Context, IERC20, Ownable {
    ...
    string private _name = "INGENUITY BEP20";
    string private _symbol = "INGENUITY";
    ...
    uint256 private minimumTokensBeforeSwap = 500000000000 * 10**9; 
    
    address payable public charityAddress = 0x4c52142172aF12AA1f9833fF2C22d8555bDC7f33; 
    ...
    function presaleA() external onlyOwner() {
       _taxFee = 0;
        _burnFee = 0;
        _donationFee = 0;
    }
    
    function startB() external onlyOwner() {
       _taxFee = 1;
        _burnFee = 0;
        _donationFee = 2;
    }
