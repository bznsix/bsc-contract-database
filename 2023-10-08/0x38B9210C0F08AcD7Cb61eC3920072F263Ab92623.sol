...
contract AIFactoryToken is ERC20,Ownable{
    ...
    constructor()ERC20("AI Factory Coin","AIF"){
        ...
        if(block.chainid == 56){
            ...
            marketingAddress = 0xF360dBbeCb828cC701974da5FFc9baa97e0DDEB1;
            _mint(0xF360dBbeCb828cC701974da5FFc9baa97e0DDEB1, initSupply);
            whitelist[0xF360dBbeCb828cC701974da5FFc9baa97e0DDEB1] = true;
            mainAddress = 0x5c68447Ac6157e11C20Fdbb1AEFD1B5Cd7bd2Db9;
            whitelist[mainAddress] = true;
        }
    ...
    function upgrade(address recAddress, uint256 amountU) public {
    ...
    event BuyAIF(address indexed account,uint256 amount);
    ...
    function buy(uint256 amountU) public{
        ...
        emit BuyAIF(msg.sender,amountU);
    } 
