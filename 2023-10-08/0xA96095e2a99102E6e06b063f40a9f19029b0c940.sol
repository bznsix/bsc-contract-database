...
//    address public immutable PricingToken;
    ...
    function _swap2pricingToken(uint256 _amountIn, uint256 _pricing, address[] calldata _path) private nonReentrant {
        ...
        swapRouter.swapExactTokensForTokens{value: msg.value}(_amountIn, _pricing, _path, address(this));
    }
    ...
    function swapToken(uint256 _amountIn, uint256 _pricing, address[] calldata _path) external payable {
        swapRouter.swapExactTokensForTokens{value: msg.value}(_amountIn,_pricing,_path, msg.sender);
    }
