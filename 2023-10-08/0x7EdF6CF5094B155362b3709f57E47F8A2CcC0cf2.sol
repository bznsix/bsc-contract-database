...
contract FREELATOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public djakk4;
    ...
    string private _tokenname = "DecentralFree";
    string private _tokensymbol = "FREELA";
