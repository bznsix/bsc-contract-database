...
contract memereum is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xeD1C25242c2F96Cf8a80806EbcbF7420fF41b0fB); // Marketing Address
    
    address payable public teamAddress =
        payable(0xeD1C25242c2F96Cf8a80806EbcbF7420fF41b0fB); // Team Address
        
    address payable public liquidityAddress =
        payable(0xeD1C25242c2F96Cf8a80806EbcbF7420fF41b0fB); // Liquidity Address
    ...
    string private constant _name = "memereum";

    string private constant _symbol = "memereum";
    ...
    uint256 public maxTransactionAmount = _tTotal * 1 / 200; // max buy sell is 0,5% on trade or transfer.
    uint256 public maxWallet = _tTotal * 1 / 50 ; // 2% at launch
    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    mapping (address => bool) public automatedMarketMakerPairs;

    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 1000; // 0.1 %
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      ...
      require(_walletMax >= _tTotal * 1 / 1000 , "Must keep above 0.1%");
        } 
    function setmaxTransactionAmount (uint256 newmaxTransactionAmount) external onlyOwner {
      ...
      require(newmaxTransactionAmount >= _tTotal * 1 / 1000 , "Must keep above 0.1%");
        }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 20, "Must keep taxes below 20%");
