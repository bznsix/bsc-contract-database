...
contract Token is ERC20 {
    ...
    uint256 public lpTokensAtAmount;

    address _baseToken = address(0x60Aaf0037E84abed9990bd0380de52894Ad8ED78);

    address private _destroyAddress =
        address(0x000000000000000000000000000000000000dEaD);

    address _lpAddress = address(0xA44637A9FF4F2Ce904db8aD6C73da8C3a1c2E8ea);
    ...
    constructor() ERC20("18888", "18888") {
        ...
        USDT = IERC20(0x60Aaf0037E84abed9990bd0380de52894Ad8ED78);
        ...
        _isExcludedFromFeesVip[
            0x50B16b287DCd0Dfce7aA68D1F1d3D2c064373220
        ] = true;

        total = 18888 * 10 ** 18;
        swapTokensAtAmount = total.div(1000);
        lpTokensAtAmount = 1 ether;
    ...
    function setLPTokensAtAmount(uint256 _lpTokensAtAmount) public onlyOwner {
        lpTokensAtAmount = _lpTokensAtAmount;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
            if (_isPairs[from] || _isPairs[to]) {
                require(startBlock > 0, "startTime");
                _splitUsdtLdxToken();
                uint256 fee = (amount * 35) / 1000;
    ...
    function swapTokensForUsdt(uint256 tokenAmount) private {
        // 买卖滑点3.5％，其中1.5％LP值分红TX，1％回流底池，1％自动销毁TX
        uint256 totalFee = 7;
        ...
        if (lpAmount > 0) {
            ...
            USDT.approve(address(uniswapV2Router), lpUSDT);
        ...
        uint256 lpDividends = (usdtBalance * 3) / (totalFee - 1);
        IERC20(_baseToken).transferFrom(
            address(_tokenDistributor),
            address(this),
            lpDividends
    ...
    function _splitUsdtLdxToken() private {
        ...
        if (allTokenAmount >= lpTokensAtAmount) {
