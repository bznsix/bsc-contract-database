...
contract jeethereum is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 25_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "JEEThereum Network"; // 
    string private constant _symbol = "JEET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x354c7DFd35090308e2bb7d8CB19e4eA90038197B;
