...
contract whitepanda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "White Panda";
    string private _symbol = "$WHIPA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x095fE60197A528d41594f8B7FC8014D6B0FE08fe);
    address payable private DevelopmentWalletAddress = payable(0x095fE60197A528d41594f8B7FC8014D6B0FE08fe);
    ...
    uint256 public _walletMax = 20000 * 10**9;
