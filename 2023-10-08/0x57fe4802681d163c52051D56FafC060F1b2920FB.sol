...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BIMBYBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BIMBY to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BIMBY 10000X? 
   ...
   it's the best part of the #BIMBY idea, increasing the liquidity pool automatically, 
...
contract BIMBY is Context, IERC20, Ownable {
    ...
    string private _name = "BIMBY";
    string private _symbol = "BMB";
