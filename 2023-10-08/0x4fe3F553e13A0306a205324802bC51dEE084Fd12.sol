...
✴️ Telegram  https://t.me/netherlandscoin
...
/* Token contract */
contract Netherlands is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x02B8b5a4d28e24D7D73a8Eb5e3f32B1166742157;
    ...
    // Name and symbol
    string constant _name = "Netherlands";
    string constant _symbol = "Netherlands";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000;  // 1% max or 1M
    uint256 public _maxWalletToken = _totalSupply * 100 / 10000; // 2% or 2M tokens
    ...
    uint256 devFeeBuy = 250;
    uint256 totalFeeBuy = 300;
    ...
    uint256 devFeeSell = 250;
    uint256 totalFeeSell = 300;
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 2000.000 tokens or 0.2% of supply
