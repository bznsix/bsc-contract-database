...
contract RICHBTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ealmun57;
    ...
    string private _tokenname = "Rich Banana";
    string private _tokensymbol = "RICHB";
