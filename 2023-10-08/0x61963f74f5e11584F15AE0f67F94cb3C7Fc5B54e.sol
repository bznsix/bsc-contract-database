...
contract LORIUM is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "LORIUM";
    string private constant _symbol = unicode"$LORIUM";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 2023000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x13518d901ceaDD15705AF6060Aba05638fA3D750);
    address payable public MarketingWallet = payable(0xF18DcF2d0D89d1dfb09D4c5010Dd717A7d38c74b);
    ...
    function loriumnewFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
