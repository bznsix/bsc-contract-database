...
contract VoltShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Volt Shiba";
    string private _symbol = "VSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf6a2a340eB8Fe8c01bf507074f06C30EAb1eAE0a); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xf6a2a340eB8Fe8c01bf507074f06C30EAb1eAE0a); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
