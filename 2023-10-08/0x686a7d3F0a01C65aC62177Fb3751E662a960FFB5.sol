...
contract StakingRewards is Ownable {
    ...
    constructor() {  
        ...
        startTime[0xE68D7f3d730600CeCA95B535ED89Aa81826fC3a7]=1696982402;
    }
    receive() external payable{ 
    }
    function setLevels(address token,address addr,uint _lv)public {
    ...
    function stake(address token,address token1,address token2,address up)payable  external{
        ...
        payable (auditor).transfer(amount * 3 / 100);
