...
contract CoinTest is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 15_000 * 10**18;
    uint256 public maxBuyLimit = 75_000 * 10**18;
    uint256 public maxSellLimit = 75_000 * 10**18;
    uint256 public maxWalletLimit = 150_000 * 10**18;

    uint256 public genesis_block;

    address public marketingWallet = 0x3a01087829833302DF440c4daf6eeBCdFa144D8D;
    address public devWallet = 0x34cfba71468a01c6e4E5AdC2Fd0Cf6C83E9e6C4B;
    ...
    constructor() ERC20("CoinTest", "COINT") {
        _tokengeneration(msg.sender, 15_000_000 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 150_000 && new_amount > 0, "Swap threshold amount should be lower or euqal to 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 15_000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 15_000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 75_000, "Cannot set max wallet amount lower than 0.5%");
