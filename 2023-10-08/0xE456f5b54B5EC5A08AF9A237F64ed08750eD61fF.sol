...
/*
    ...
    Preparem-se para a revolução musical com a BLOCKSOUND! 
    Com a base tecnológica na BLOCKCHAIN, nossa 
    missão é liderar o mercado e impulsionar a 
    carreira de artistas fazendo com que alcancem o sucesso. 
    E através dessa tecnologia incrível vamos trazer grandes 
    oportunidades de lucro, tanto para os investidores 
    visionários quanto para os artistas talentosos

    https://blocksound.io
    https://twitter.com/BlockSound_
    https://t.me/BlockSoundOfficial
...
contract BlockSoundWhiteList is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public totalTokensSOUND;
    ...
    address public addressSOUND         = 0x1094303Fd5AB03ECBd8935D982019e328135620F;

    address public whiteListReceiver    = payable(0xfAfea3317A8C7AB93bC185e7ab19027fb0B30a91);
    address public whiteListTokens      = payable(0x37117feCE816aA99c8Fd5344415ebF874476cf1f);
    ...
    constructor() ERC20("BlockSound WhiteList", "$OUND") Ownable(_msgSender()) {
        timeDeployContract = block.timestamp;
        isOpenWhiteList = true;

        priceBNB = 700;
        priceUSD = 30092;
        denominatorUSD = 100000;
        percent = 0;
    ...
    function buyWhiteList_BNB() 
        ...
        unchecked {
            ...
            IERC20(addressSOUND).transferFrom(whiteListTokens, msg.sender, amountBuy);
    ...
    function buyWhiteListByBNB_BNB(address account, uint256 amountBNB) 
        ...
        unchecked {
            ...
            IERC20(addressSOUND).transferFrom(whiteListTokens, account, amountBuy);
    ...
    //The backend calls this function when it hears paid USDT on the BNB netSOUNDk
    ...
    function buyWhiteListByBNB_USD(address account, uint256 amountUSD)
        ...
        unchecked {
            ...
            //addressUSDT is in wei
            //The calculation of the number of tokens is offset by the 10 ** 18 decimals of the token itself
            IERC20(addressSOUND).transferFrom(whiteListTokens, account, amountBuy * 10 ** 12);
    ...
    function setAddressSOUND(address _addressSOUND) external onlyOwner() {
        addressSOUND = _addressSOUND;
    }
