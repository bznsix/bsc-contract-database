/**
// https://t.me/SafenanceOfficialBSC
...
contract Safenance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safenance";
    string private _symbol = "SAFENANCE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE6Eaee42CfD421834292FFF48717e9eB3d65A230); // Marketing Address
    address payable private teamWalletAddress = payable(0xE6Eaee42CfD421834292FFF48717e9eB3d65A230); // Team Address
