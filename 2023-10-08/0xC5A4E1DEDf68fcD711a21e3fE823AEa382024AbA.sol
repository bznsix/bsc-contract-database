/**
   ...
   Welcome to SpaceLambo
   
   This is a community token. If you want to create a telegram I suggest to name it to @SpaceLamboBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SpaceLambo to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SpaceLambo 10000X? 
   ...
   it's the best part of the #SpaceLambo idea, increasing the liquidity pool automatically, 
...
contract SpaceLambo is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceLambo";
    string private _symbol = "SLambo";
