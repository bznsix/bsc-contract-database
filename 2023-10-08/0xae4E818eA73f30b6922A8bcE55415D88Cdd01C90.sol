...
contract BENZEMA is IBEP20, Ownable {

    address WBNB = 0x7E5E021CfEB415404CEE5992C63074c1c07bE7c4;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Benzema Coin"; // 
    string constant _symbol = "BENZEMA"; // 
    ...
    uint256 public BuytotalFee        = BuybuybackFee + BuycharityFee + BuymarketingFee;

    uint256 public SellbuybackFee   = 1;
    uint256 public SellmarketingFee    = 2;
    uint256 public SellcharityFee      = 0;
    uint256 public SelltotalFee        = SellbuybackFee + SellcharityFee + SellmarketingFee;
    ...
    // Fees receivers
    address public marketingFeeReceiver = 0x45b0eB911A527a45f8F620AdE1F28e327B473485;
    address public buybackFeeReceiver = 0x2bAbc5d5af26A00A66A186D4560B388bD8625F9A;
    address public charityFeeReceiver = 0x2bAbc5d5af26A00A66A186D4560B388bD8625F9A;
    ...
    function swapBack() internal swapping {
        ...
        (bool charitySuccess,) = payable(charityFeeReceiver).call{value: amountBNBcharity, gas: 30000}("");
    ...
    // Only Owner allowed
    function setBuyFees(uint256 _charityFee, uint256 _marketingFee, uint256 _buybackFee) external onlyOwner {
        BuycharityFee = _charityFee;
        BuymarketingFee = _marketingFee;
        BuybuybackFee = _buybackFee;
        BuytotalFee = (_charityFee) + (_marketingFee) + (_buybackFee);
    }

    function setSellFees(uint256 _charityFee, uint256 _marketingFee, uint256 _buybackFee) external onlyOwner {
        SellcharityFee = _charityFee;
        SellmarketingFee = _marketingFee;
        SellbuybackFee = _buybackFee;
        SelltotalFee = (_charityFee) + (_marketingFee) + (_buybackFee);
    }
    
    function setFeeReceivers(address _marketingFeeReceiver, address _charityFeeReceiver, address _buybackFeeReceiver) external onlyOwner {
