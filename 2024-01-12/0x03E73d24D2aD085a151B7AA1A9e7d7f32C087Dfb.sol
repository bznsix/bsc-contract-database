...
contract BonkHypeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonk Hype Coin ";
    string private _symbol = "BHC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3d52FaEAaCeE41C22a176616B4d0e5E6bF599A1c); // Marketing Address
    address payable public teamWalletAddress = payable(0x3d52FaEAaCeE41C22a176616B4d0e5E6bF599A1c); // Team Address
