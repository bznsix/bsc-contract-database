/**
Telegram: https://t.me/BurnifyToken
...
contract BurnifyToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Burnify Token";
    string private _symbol = "BURNIFY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE0523c086C6194a29Fc3c7A12858424684791A34); // Marketing Address
    address payable public teamWalletAddress = payable(0xE0523c086C6194a29Fc3c7A12858424684791A34); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 5000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
