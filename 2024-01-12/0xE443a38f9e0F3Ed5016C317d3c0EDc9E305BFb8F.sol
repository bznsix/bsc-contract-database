...
// File: CRE/interfaces/IPancakeFactory.sol
...
// File: CRE/interfaces/IPancakeRouter.sol
...
contract CryptoRealEstate is ERC20, Ownable {
  ...
  constructor(
    ...
    require(address(_pancakeRouter) != address(0), "Invalid pancakeRouter address");
