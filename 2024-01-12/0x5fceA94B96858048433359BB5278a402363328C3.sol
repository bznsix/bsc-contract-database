...
/**
 * @title Segments's seBNB Contract
 * @notice seToken which wraps BNB
 */
contract SeBNB is SeToken {
    /**
     * @notice Construct a new seBNB money market
    ...
    /**
     * @notice Send BNB to SeBNB to mint
     */
    ...
    function liquidateBorrow(address borrower, SeToken seTokenCollateral) external payable {
        (uint err, ) = liquidateBorrowInternal(borrower, msg.value, seTokenCollateral);
