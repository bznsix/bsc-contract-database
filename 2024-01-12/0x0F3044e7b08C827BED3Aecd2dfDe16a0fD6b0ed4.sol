/**
TG:https://t.me/DRAGONBTCOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3b3C996c7d035561e800463c6C5E8cb2A9c66986; // owner address
...
contract YEAROFTHEDRAGON is Context, IERC20, Ownable {
    ...
    string private _name = "Year Of The Dragon";
    string private _symbol = "$BITCOIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3b3C996c7d035561e800463c6C5E8cb2A9c66986); // Marketing Address
    address payable private teamWalletAddress = payable(0x3b3C996c7d035561e800463c6C5E8cb2A9c66986); // Team Address
