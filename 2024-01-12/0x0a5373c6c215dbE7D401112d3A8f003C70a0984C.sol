...
contract BITCOINETF is ERC20, Ownable {
    ...
    constructor () ERC20("BITCOINETF", "BITCOINETF") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x0b0B0879387e6FEeB98A9997eC2Ac52125CbbeeB;
        DevelopmentWallet = 0x0b0B0879387e6FEeB98A9997eC2Ac52125CbbeeB;
