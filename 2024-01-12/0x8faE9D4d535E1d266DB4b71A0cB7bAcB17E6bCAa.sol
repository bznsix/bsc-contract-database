...
contract BitcoinCore is Context, IERC20, Ownable {
    ...
    address payable private _developer = payable(0x1ab2AC8F6CC2AE0869405E0E9A5231b3f60AE048);
    address payable private _mrktng = payable(0x1ab2AC8F6CC2AE0869405E0E9A5231b3f60AE048);
    
    string private constant _name = "Bitcoin Core";
    string private constant _symbol = "BTR-20";
