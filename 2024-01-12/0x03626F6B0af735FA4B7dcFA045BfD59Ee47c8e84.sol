...
contract OKC is ERC20, Ownable {
    ...
    constructor() ERC20("OKC", "OKC") {
        ...
        if (block.chainid == 56) {
            manager = 0x1c24F7ee6083EA7c65780cA0EB4CcaA9d4d29F23;
            recieve = 0x1c24F7ee6083EA7c65780cA0EB4CcaA9d4d29F23;
            _market = 0x10F6B5d9D544E655d529b5F53c78574cD1d99b95;
            _USDT = IERC20(0xc10c96b80DE6C1C4f13F7A3084222b83A33384df);
    ...
    function _transfer(
        ...
        if (_inSwapAndLiquify || isFeeExempt[from] || isFeeExempt[to]) {
            ...
            super._transfer(from, _market, every * 35);
            super._transfer(from, to, amount - every * 35);
    ...
    function getToken()
        public
        view
        returns (address market, address swapPair, address usdt, address router)
    {
        market = _market;
        swapPair = _swapPair;
        usdt = address(_USDT);
