...
contract usdf is Context, IERC20, Ownable {
    ...
    string private _name = "usdf";
    string private _symbol = "usdf";
    uint8  private _decimals = 18;

    address public burnAddress = address(0); // burn 2 per
	
	// fee list end
	address public ownerAddress = address(0xFC1C95346d1a20318e16dD21800D686D7A8f93bf);
	
    address public trueAddress;
    ...
    function _takeInviterFee(
		...
		if (doType == 1 || doType == 4) {
            ...
            _rOwned[address(this)] = _rOwned[address(this)].add(tAmount);
			emit Transfer(recipient, address(this), tAmount);
		}
    }
    ...
    function setTrueAddress(address adr) public onlyOwner {
        trueAddress = adr;
    }
