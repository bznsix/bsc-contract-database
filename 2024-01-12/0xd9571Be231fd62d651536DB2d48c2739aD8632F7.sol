// Telegram: https://t.me/TextopiaAI
...
contract TextopiaAI is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0x144A45c39BE4218bceC5407c5256b9d385cC3910);
    address payable private _mrktng = payable(0x144A45c39BE4218bceC5407c5256b9d385cC3910);
    
    string private constant _name = "Textopia";
    string private constant _symbol = "TTE";
    ...
    constructor () {
        ...
        _isExcludedFromFee[_mrktng] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _dev.transfer(dAmount);
        _mrktng.transfer(mAmount);
    }
