...
// Symbol      : M2E
// Decimals    : 18
// InitialSupply : 10,000,000,000 M2E
// ----------------------------------------------------------------------------
contract M2EToken is ERC20, Ownable, ERC20Burnable {
    uint constant _initial_supply = 10_000_000_000 * (10**18);

    bool private _tokenLock;
    mapping (address => bool) private _personalTokenLock;

    constructor() ERC20("M2E", "M2E") {
    ...
    function removePersonalTokenLock(address _who) onlyOwner public {
        require(_personalTokenLock[_who] == true, "already lock false");
    ...
    function addPersonalTokenLock(address _who) onlyOwner public {
        require(_personalTokenLock[_who] == false, "already lock true");
