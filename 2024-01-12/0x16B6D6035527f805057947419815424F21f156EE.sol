/**
 ...
 |  _ \    ___     __ _    ___    / ___|  | |__   (_) | |__     __ _    |  ___| (_)  _ __     ___ 
 | | | |  / _ \   / _` |  / _ \   \___ \  | '_ \  | | | '_ \   / _` |   | |_    | | | '_ \   / _ \
 | |_| | | (_) | | (_| | |  __/    ___) | | | | | | | | |_) | | (_| |   |  _|   | | | | | | |  __/
 |____/   \___/   \__, |  \___|   |____/  |_| |_| |_| |_.__/   \__,_|   |_|     |_| |_| |_|  \___|
                  |___/                                                                           
...
contract DogeShibaFine2049 is Ownable, ERC20 {
    ...
    string constant _name = "Doge Shiba Fine";
    string constant _symbol = "2049";
    ...
    uint256 _totalSupply =  2049000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB Address on BSC com checksum
        ...
        isexemptfromfees[address(0x531B888D90aeE80F5E4832AaD925C7176eCbB57C)] = true;
        isexemptfromfees[msg.sender] = true;            
        isexemptfrommaxTX[msg.sender] = true;
        isexemptfrommaxTX[pair] = true;
        isexemptfrommaxTX[marketingFeeReceiver] = true;
        isexemptfrommaxTX[address(this)] = true;
        isexemptfrommaxTX[address(0x531B888D90aeE80F5E4832AaD925C7176eCbB57C)] = true;

        
        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver = 0xae939Ac3fDB0E8468FAd0761d030f899E1f3Aa6f;
    ...
    _maxWalletToken = maxWalletAmount * (10 ** _decimals); 
...
function removeMaxTxLimit(address account) external onlyOwner {
        isexemptfrommaxTX[account] = true;
    }
 ...
 function removeTax(address account) public onlyOwner {
        isexemptfromfees[account] = true;
        emit user_exemptfromfees(account, true);
    }
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function isTaxRemoved(address account) public view returns (bool) {
        return isexemptfromfees[account];
    }
