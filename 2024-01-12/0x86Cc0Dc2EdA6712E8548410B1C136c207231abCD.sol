...
contract POW is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "POW";
        _decimals = 18;
        _owner = 0x883c7b52c5ED0163Ec11E20685B6e90b14b8D017;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 5000 * 10**_decimals;
        marketingWalletAddress = payable(0xd28fF08B04fF69F6d958A6e0176010541bCAe23f);
        teamWalletAddress = payable(0x29Add891EbCD7F5818dAd12640EF22d9E7dc42eA);
    ...
    function pause(bool _flag) onlyOwner public {
        startTx = _flag;
    }
