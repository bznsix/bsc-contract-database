/* 
BTCwin   The bullRun Began 

https://t.me/BTCwinToken

Bitcoin win the battele of 2024 as SEC approves rule changes that pave the way for bitcoin ETFs.

official link for Statement on the Approval of Spot Bitcoin Exchange-Traded Products
https://www.sec.gov/news/statement/gensler-statement-spot-bitcoin-011023

●Fees 10%
●refelction 10%  $BTCwin  to holders 
...
contract BTCwin is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'BTCwin';
    string private _symbol = 'BTCwin';
    uint8 private _decimals = 9;
       //Contract Update Information
    string public constant Contract_Version = "0.8.23";
    string public constant Contract_Dev = "Team BTCwin SAFU DEV || NFA,DYOR";
    string public constant Contract_Edition = "Contract For 1M";
    string public constant BTCwinTGNEWS = "https://t.me/BTCwin";
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    string public constant BTCwinaudited = "BTCwin will be audited by: https://www.certik.com/";
