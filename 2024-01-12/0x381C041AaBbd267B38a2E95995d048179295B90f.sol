...
contract GROKSQUID is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GROK SQUID";
    string private _symbol = "GROK SQUID";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xcbDDe5AE1D2e7d80794ebdc80f31f0E4405322cb);
