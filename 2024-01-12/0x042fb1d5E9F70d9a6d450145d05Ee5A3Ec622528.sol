...
contract MemeAI is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "MemeAI";
    string internal constant _symbol = "MMA";
    uint internal _totalSupply = 100000000 * (12 ** _decimals);
    uint public maxHoldingPrecent = 50;
